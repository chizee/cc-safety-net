#!/usr/bin/env node
import{b as li,c as ci,d as q,e as di,f as mr,g as ot,h as Fe,i as $r,j as he,k as vs,l as Ur,m as pn,n as bs,o as Ls,p as fn}from"../chunks/index-7r9n883m.js";import{$a as Dr,A as tt,Aa as ks,Ab as At,B as me,Ba as ge,Bb as xs,C as Pa,Ca as Et,D as Vi,Da as Mr,E as Se,Ea as jr,F as cn,Fa as ts,G as wt,Ga as ns,H as vr,Ha as hi,I as $e,Ia as nt,J as xe,Ja as rs,K as Oe,Ka as os,L as te,La as Sr,M as br,Ma as Rr,Na as zi,O as re,Oa as kr,P as Ne,Pa as fe,Qa as Ki,R as oe,Ra as Ni,S as Dt,Sa as Fi,T as Id,Ta as Xd,U as De,Ua as vi,V as U,Va as bi,W as Ce,Wa as Tt,Xa as Li,Y as ve,Ya as dn,Z as W,Za as wi,_ as Is,_a as B,aa as He,ab as Ir,ba as mn,bb as _r,ca as $t,cb as K,da as Ci,db as Qd,ea as Si,eb as Pe,fa as Pt,fb as eu,ga as Me,gb as tn,ha as Or,hb as tu,ia as Ri,ib as nu,ja as Di,jb as ru,ka as ye,kb as un,la as ws,lb as we,ma as Gr,mb as ou,na as Cs,nb as iu,oa as Ss,ob as is,pa as Nr,pb as ss,qa as Zi,qb as as,ra as mi,rb as ls,s as _t,sa as Xi,sb as kt,t as Yi,ta as Qi,tb as Re,u as M,ua as es,ub as J,v as wr,va as Fr,vb as Ji,w as x,wa as gi,wb as Cr,x as Lt,xa as Pi,xb as St,y as w,ya as C,yb as V,z as ne,za as Hr,zb as It}from"../chunks/index-s8h8p9va.js";var pu=["-h","--help"];function E(e,t){let n=Object.entries(e.booleans??{}),r=Object.entries(e.values??{}),o=Object.entries(e.lists??{}),i=Object.fromEntries(n.map(([g])=>[g,!1])),s={},a=Object.fromEntries(o.map(([g])=>[g,[]])),l=[],c=[],d=!1,m=-1;for(let[g,u]of t.entries()){if(g<=m)continue;if(u==="--"){l.push(...t.slice(g+1));break}if(pu.includes(u)){d=!0;continue}let p=n.find(([,L])=>L.includes(u));if(p){i[p[0]]=!0;continue}let f=r.find(([,L])=>L.includes(u));if(f){let L=t[g+1];if(L===void 0||L.startsWith("-")){c.push(`${u} requires a value`);continue}s[f[0]]=L,m=g+1;continue}let b=o.find(([,L])=>L.includes(u));if(b){let L=t.slice(g+1),h=L.findIndex((v)=>v.startsWith("-")),S=L.slice(0,h===-1?L.length:h);if(S.length===0){c.push(`${u} requires at least one value`);continue}a[b[0]]=[...a[b[0]]??[],...S],m=g+S.length;continue}if(u.startsWith("-")){c.push(`Unknown option for ${e.label}: ${u}`);continue}if(e.positionals==="tail"){l.push(...t.slice(g));break}l.push(u)}if(e.positionals!=="list"&&e.positionals!=="tail")c.push(...l.map((g)=>`Unexpected argument for ${e.label}: ${g}`));return{flags:i,values:s,lists:a,positionals:l,help:d,errors:c}}function ue(e){for(let t of e)console.error(t);return e.length>0}import{readdirSync as up,statSync as ds,unlinkSync as pp}from"node:fs";import{basename as us,dirname as fp,join as mp,resolve as gp}from"node:path";function N(e){return Array.from(e,(t)=>{let n=t.charCodeAt(0);if(n<=31||n>=127&&n<=159)return`\\x${n.toString(16).padStart(2,"0")}`;return t}).join("")}var dr=(e)=>{let t=Date.now()-new Date(e).getTime();if(!Number.isFinite(t))return"";let n=Math.floor(t/60000),r=Math.floor(n/60),o=Math.floor(r/24);if(o>0)return`${o}d ago`;if(r>0)return`${r}h ago`;if(n>0)return`${n}m ago`;return"just now"},Qe=(e)=>{let t=(e??"").trim().split(/\s+/).filter((o)=>o&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(o)),n=t[0]?.split("/").pop();if(!n)return null;let r=t[1];return r&&/^[a-z][a-z0-9-]*$/.test(r)?`${n} ${r}`:n};import{existsSync as fu,readdirSync as mu,readFileSync as gu}from"node:fs";import{join as hu}from"node:path";function ke(e,t){try{return mu(e,{withFileTypes:!0,encoding:"utf8"}).flatMap((n)=>{let r=hu(e,n.name);if(n.isDirectory())return ke(r,t);if(n.name.endsWith(".jsonl"))return[r];return[]})}catch{if(t&&fu(e))t.count++;return[]}}function ur(e){let t=(o)=>`${o.sessionId}
${Qe(o.segment||o.command)}`,n=e.filter((o)=>o.decision!=="allow"),r=n.filter((o)=>o.sessionId).reduce((o,i)=>o.set(t(i),(o.get(t(i))??0)+1),new Map);return new Set(n.filter((o)=>o.failureStage||(r.get(t(o))??0)>=2))}var yu=["segment","reason","sessionId","decision","agent","ruleId","failureStage"];function vu(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e;if(typeof t.ts!=="string"||typeof t.command!=="string")return!1;return yu.every((n)=>t[n]===void 0||typeof t[n]==="string")}function _e(e,t){try{return gu(e,"utf-8").split(`
`).filter(Boolean).flatMap((n)=>{try{let r=JSON.parse(n);if(!vu(r)){if(t)t.count++;return[]}return[r]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as rp}from"node:path";var bu=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function ui(e){let t=0,n={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(r){e.record({kind:"step",scope:"global",step:r})},recordSegment(r,o=n.currentSegmentIndex){if(o===void 0)return;e.record({kind:"step",scope:"segment",segmentIndex:o,step:r})}};return n}function pi(e={}){let t=[],n=e.maxEvents??512,r={maxTextLength:e.maxTextLength??2048,maxListLength:e.maxListLength??128,maxObjectProperties:e.maxObjectProperties??e.maxListLength??128,maxDepth:e.maxDepth??16},o=0,i,s=new Set;return{record(a){if(i)return;try{if(!a||t.length>=n){o++;return}t.push(fr(Lu(a,r,s)))}catch{o++}},finish(a){if(i)return i;try{i=fr({events:Object.freeze(t),droppedEvents:o,terminal:wu(a,r,s)})}catch{o++,i=Object.freeze({events:Object.freeze(t),droppedEvents:o,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,r.maxTextLength),segment:"trace unavailable".slice(0,r.maxTextLength)})})}return i}}}function Lu(e,t,n){if(e.kind!=="step")throw TypeError("invalid trace event");let{scope:r,step:o}=e;rn(o,n,t);let i=et(o,t,n);if(r==="global")return{kind:"step",scope:"global",step:i};if(r!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:e.segmentIndex,step:i}}function wu(e,t,n){let r=e.result;if(r==="allowed")return Object.freeze({result:"allowed"});if(r!=="blocked")throw TypeError("invalid trace terminal");let o=e.ruleId;return Object.freeze({result:"blocked",reason:et(e.reason,t,n),segment:et(e.segment,t,n),...o?{ruleId:et(o,t,n)}:{}})}function rn(e,t,n,r=0,o=new WeakSet){if(typeof e==="string"){let a=e.slice(0,n.maxTextLength);if(!mr(a))return;for(let l of di(a))for(let c of l.match(/[^\s"'()$]+/g)??[])t.add(fi(c));return}if(!e||typeof e!=="object"||r>=n.maxDepth||o.has(e))return;if(o.add(e),Array.isArray(e)){let a=Math.min(e.length,n.maxListLength);for(let l=0;l<a;l++)rn(e[l],t,n,r+1,o);return}let i=0,s=new Set;for(let a in e){if(!Object.hasOwn(e,a))continue;if(i>=n.maxObjectProperties)break;i++,rn(a,t,n);let l=pr(a,n,t);if(s.has(l))continue;s.add(l),rn(e[a],t,n,r+1,o)}}function et(e,t,n,r=0,o=new WeakSet){if(typeof e==="string")return pr(e,t,n);if(!e||typeof e!=="object")return e;if(r>=t.maxDepth)return;if(o.has(e))return;if(o.add(e),Array.isArray(e)){let a=[],l=Math.min(e.length,t.maxListLength);for(let c=0;c<l;c++)a.push(et(e[c],t,n,r+1,o));return a}let i={},s=0;for(let a in e){if(!Object.hasOwn(e,a))continue;if(s>=t.maxObjectProperties)break;s++;let l=pr(a,t,n);if(Object.hasOwn(i,l))continue;Object.defineProperty(i,l,{value:et(e[a],t,n,r+1,o),enumerable:!0,configurable:!0,writable:!0})}return i}function pr(e,t,n){let r=e.slice(0,t.maxTextLength),o=mr(r)?ci(r):r,i=n.size>0?xu(o,n):o;return(ku(i)?li(i):i).slice(0,t.maxTextLength)}function ku(e){return e.includes("PRIVATE KEY")||e.includes("://")||e.includes("eyJ")||e.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(e)||e.length>=14&&bu.some((t)=>e.includes(t))||e.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(e)}function xu(e,t){return e.replace(/[^\s"'()$]+/g,(n)=>t.has(fi(n))?"<redacted>":n)}function fi(e){let t=2166136261,n=2166136261;for(let r=0;r<e.length;r++)t=Math.imul(t^e.charCodeAt(r),16777619),n=Math.imul(n^e.charCodeAt(e.length-r-1),16777619);return`${t>>>0}:${n>>>0}:${e.length}`}function fr(e){if(e&&typeof e==="object"&&!Object.isFrozen(e)){for(let t of Object.values(e))fr(t);Object.freeze(e)}return e}function yi(e,t,n){let r=n??mi(),o=r.getCommandProgram(e,t.shell??"auto"),i=pi(),s=ui(i),a=o.dialect==="powershell"?r.getCommandProgram(e,"posix"):o,l=gi(a);s.recordGlobal({type:"parse",input:e,segments:l.map((m)=>[...m])});let c=hi(e,{...t,analyzePartialProgram:!0,trace:s},o,r),d=s.getNextSegmentIndex();if(c&&d>0&&d<l.length)s.recordSegment({type:"segment-skipped",index:d,reason:"prior-segment-blocked"},d);return Object.freeze({decision:c,trace:i.finish(c?{result:"blocked",reason:c.reason,segment:c.evidence.find((m)=>m.kind==="command")?.segment??e,...c.ruleId?{ruleId:c.ruleId}:{}}:{result:"allowed"}),program:o})}import{resolve as Cu}from"node:path";function gr(e){let t=vi().safeParse(e);return{errors:t.success?[]:Li(t.error.issues),ruleNames:new Set(bi(e).map((n)=>n.toLowerCase()))}}function hr(e){let t=ki(e);if(!t.ok)return t.result;return gr(t.parsed)}function ki(e){let t=[],n=new Set;try{let r=typeof e==="string"?Lt(e):e,o=w(r);if(o===null)return t.push(`File not found: ${r.path}`),{ok:!1,result:{errors:t,ruleNames:n}};if(!o.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:n}};return{ok:!0,parsed:JSON.parse(o)}}catch(r){if(r instanceof M)return t.push(r.message),{ok:!1,result:{errors:t,ruleNames:n}};let o=r instanceof Error?r.message:String(r);return t.push(r instanceof SyntaxError?"Invalid JSON":o),{ok:!1,result:{errors:t,ruleNames:n}}}}function xi(e){return Cu(e??process.cwd(),".safety-net.json")}function pe(e){let t=ki(e);if(!t.ok)return t.result;let n=wi(t.parsed);return{errors:n.errors,ruleNames:n.sources}}import{join as Pr,resolve as Nu}from"node:path";import{dirname as sn}from"node:path";var Su="custom.";function on(e){if(e.rulebook_version!==2)return[];let t=e.rules.map((n)=>({name:n.name,command:n.command,block_args:[],match:n.match,reason:n.reason,intent:n.intent}));return(e.tests??[]).flatMap((n,r)=>{let o=yr(Di(n.command));if(o.length===0)return[`tests[${r}]: could not parse fixture command: ${n.command}`];let i=o.reduce((s,a)=>s??Pi(a,t)?.id.slice(Su.length),void 0);if(n.expect==="blocked"){if(i===n.rule)return[];let s=i?`"${i}" matched first`:"no rule matched";return[`tests[${r}]: expected "${n.rule}" to block "${n.command}" but ${s}`]}return i?[`tests[${r}]: expected "${n.command}" to be allowed but "${i}" matched`]:[]})}function yr(e){return e.nodes.flatMap((t)=>{if(t.kind==="group"||t.kind==="function")return yr(t.body);if(t.kind!=="command")return[];let n=Ri(Si(t.dialect,t.words)).words.map(Ci);return[...n.length>0?[n]:[],...t.nested.flatMap((r)=>yr(r))]})}var Ru=/^([A-Za-z0-9_.-]+)\/([A-Za-z0-9_.-]+)#(.+)$/;function Ai(e,t){let n=Ii(e.rules,t);if(n.length>0)return{ok:!0,specs:n};return Ti(e.rules,t)}function Ei(e,t){let n=Ii(e,t);if(n.length>0)return{ok:!0,specs:n};let r=Pu(e,t);if(r.length>0)return{ok:!0,specs:r};let o=Au(e,t);if(!o.ok)return o;if(o.specs.length>0)return{ok:!0,specs:o.specs};return Ti(e,t)}function Ti(e,t){let n=e.filter((r)=>Lr(r)?.name===t);if(n.length===1)return{ok:!0,specs:n};return Du(t,n)}function Du(e,t){return{ok:!1,result:{ok:!1,errors:t.length===0?[`No configured rulebook matches ${e}`]:[`Ambiguous rulebook match ${e}: ${t.join(", ")}`],warnings:[],entries:[]}}}function Ii(e,t){return e.filter((n)=>n===t)}function Pu(e,t){let n=t.match(Ru),r=n?.[1],o=n?.[2],i=n?.[3];if(!r||!o||!i||!Oe(i))return[];return _i(e,(s)=>s.owner===r&&s.repo===o&&s.ref===i)}function Au(e,t){if(!xe(t))return{ok:!0,specs:[]};let[n,r]=t.split("/"),o=_i(e,(s)=>s.owner===n&&s.repo===r);if(new Set(o.map((s)=>Lr(s)?.ref).filter((s)=>!!s)).size<2)return{ok:!0,specs:o};return{ok:!1,result:{ok:!1,errors:[`Multiple refs are configured for ${t}. Use an explicit ref:`,`  cc-safety-net rule remove ${t}#<ref>`],warnings:[],entries:[]}}}function Lr(e){try{return $e(e)}catch{return null}}function _i(e,t){return e.filter((n)=>{let r=Lr(n);return r?t(r):!1})}var Hi=Object.freeze({timeoutMs:15000,metadataBytes:524288,commitBytes:262144,treeBytes:16777216,rawBytes:4194304});async function $i(e,t,n,r=wr(sn(sn(t)),"rules policy"),o=fe()){if(te(e))return _u(e,o);return Iu(e,t,n,r)}async function Mi(e,t,n,r,o,i,s){if(!te(e))return $i(e,t,n,r,o);let a=i?null:Eu(e,t,r);if(a)return a;if(!i&&!s)throw Error(`${e} is not vendored; run rule update ${e} to vendor it`);return $i(e,t,n,r,o)}function Eu(e,t,n=wr(sn(sn(t)),"rules policy")){let r=$e(e),o=Ce(t,r.name),i=w(x(n,o));if(i===null)return null;let s=kt(xr(i,`Invalid rulebook ${o}.`));if(s.name!==r.name)throw Error(`rulebook name "${s.name}" in ${o} must match "${r.name}"`);return{spec:e,rulebook:s,content:i}}async function ji(e,t={}){if(!xe(e))throw Error(`Invalid GitHub repository source: ${e}`);let[n,r]=e.split("/");if(!n||!r)throw Error(`Invalid GitHub repository source: ${e}`);if(t.ref!==void 0&&!Oe(t.ref))throw Error(`GitHub rulebook refs must use valid path segments: ${t.ref}`);let o=t.operation??fe(),i=t.ref??await Tu(n,r,e,o),s=await Gi(n,r,i,e,o),a=await an(`https://api.github.com/repos/${n}/${r}/git/trees/${s}?recursive=1`,"tree",o),l=a.response;if(!l.ok)throw Error(`Failed to inspect ${e}: GitHub tree returned ${l.status}`);let c=JSON.parse(a.content);if(!Array.isArray(c?.tree))throw Error(`Failed to inspect ${e}: unexpected GitHub tree response`);let d=c.tree,m=[...new Set(d.flatMap((g)=>{if(!g||typeof g!=="object")return[];let u=g;if(u.type!=="blob"||typeof u.path!=="string")return[];let p=u.path.match(vr);return p?.[1]?[p[1]]:[]}))].sort();if(m.length===0)throw Error(`No rulebooks found in ${e} under ${wt}/`);return{source:e,owner:n,repo:r,ref:i,commit:s,names:m}}async function Tu(e,t,n,r){let o=await an(`https://api.github.com/repos/${e}/${t}`,"metadata",r),i=o.response;if(!i.ok)throw Error(`Failed to inspect ${n}: GitHub returned ${i.status}`);let a=JSON.parse(o.content)?.default_branch;if(typeof a!=="string"||a==="")throw Error(`Failed to inspect ${n}: missing default branch`);if(!Oe(a))throw Error(`GitHub returned an invalid default branch: ${a}`);return a}function Iu(e,t,n,r){br(e);let o=Ce(t,e),i=w(x(r,o));if(i===null)throw Error(`Rulebook source not found: ${e}`);let s=Ui(xr(i,"Invalid local rulebook source."));if(s.name!==e)throw Error(`rulebook name "${s.name}" must match local source "${e}"`);return{spec:e,rulebook:s,content:i}}async function _u(e,t){let n=$e(e),r=await Gi(n.owner,n.repo,n.ref,e,t),o=await an(`https://raw.githubusercontent.com/${n.owner}/${n.repo}/${r}/${n.path}`,"raw",t),i=o.response;if(!i.ok)throw Error(`Failed to fetch ${e}: GitHub raw returned ${i.status}`);let s=o.content,a=Ui(xr(s,"Invalid GitHub rulebook response."));if(a.name!==n.name)throw Error(`rulebook name "${a.name}" must match GitHub source "${n.name}"`);return{spec:e,rulebook:a,content:s}}function Ui(e){let t=kt(e),n=on(t);if(n.length>0)throw Error(n.join("; "));return t}function xr(e,t){try{return JSON.parse(e)}catch{throw Error(t)}}async function Gi(e,t,n,r,o){let i=await an(`https://api.github.com/repos/${e}/${t}/commits/${encodeURIComponent(n)}`,"commit",o),s=i.response;if(!s.ok)throw Error(`Failed to resolve ${r}: GitHub returned ${s.status}`);let a=JSON.parse(i.content);if(typeof a?.sha!=="string"||a.sha==="")throw Error(`Failed to resolve commit for ${r}`);return a.sha}async function $u(e,t,n={}){if(n.signal?.aborted)throw n.signal.reason;let r=n.budget??kr(),o=new AbortController,i=()=>o.abort(n.signal?.reason);n.signal?.addEventListener("abort",i,{once:!0});let s=!1,a=setTimeout(()=>{if(o.signal.aborted)return;s=!0,o.abort()},n.timeoutMs??Hi.timeoutMs);try{if(n.signal?.aborted)throw n.signal.reason;Ni(r);let l=await(n.fetch??fetch)(e,{signal:o.signal,redirect:"error"});if(!l.ok)return Bi(l),{response:l,content:""};return{response:l,content:await Ou(l,t,r,()=>o.abort())}}catch(l){if(s)throw Error("GitHub request timed out",{cause:l});if(n.signal?.aborted)throw n.signal.reason;throw l}finally{clearTimeout(a),n.signal?.removeEventListener("abort",i)}}function an(e,t,n){return $u(n.resolveUrl?.(e)??e,t,{budget:n.budget,signal:n.controller.signal})}async function Ou(e,t,n=kr(),r){let o=Hi[`${t}Bytes`],i=Number(e.headers.get("content-length"));if(Number.isFinite(i)&&i>o)throw Bi(e),Error(`GitHub ${t} response exceeds ${o} bytes`);if(!e.body)return"";let s=e.body.getReader(),a=[],l=0;while(!0){let c=await s.read();if(c.done)break;try{Fi(n,c.value.byteLength)}catch(d){throw r?.(),Oi(s),d}if(l+=c.value.byteLength,l>o)throw r?.(),Oi(s),Error(`GitHub ${t} response exceeds ${o} bytes`);a.push(Buffer.from(c.value))}return Buffer.concat(a,l).toString("utf-8")}function Bi(e){if(!e.body)return;qi(()=>e.body?.cancel())}function Oi(e){qi(()=>e.cancel())}function qi(e){try{Promise.resolve(e()).catch(()=>{})}catch{}}async function Rt(e={}){let t=Er(e);return Fu(t,await ln(t,fe()))}function Fu(e,t){if(!t.ok)return t;let n=U(e),r=[...new Set(J(n.configPath,n.filesystemScope))];if(r.length===0)return t;return{ok:!1,errors:r,warnings:t.warnings,entries:t.entries}}async function ln(e,t,n={},r=new Set,o=new Set){try{let i=U(e),s=Dr(i.configTarget);if(!s.ok)return s.result;let a=s.config;if(e.check)return Qu(a,i,e);let l=e.only?Ai(a,e.only):{ok:!0,specs:a.rules};if(!l.ok)return l.result;let c=new Set([...e.refresh?l.specs:[],...r]),d=(v)=>Mi(v,i.configDir,e,i.filesystemScope,t,c.has(v),!e.refresh||c.has(v)),m=await Ju(a.rules,e.refresh?(v)=>d(v).then((R)=>({ok:!0,item:R})).catch((R)=>{if(Ki(R))throw R;return{ok:!1,spec:v,message:R instanceof Error?R.message:String(R)}}):async(v)=>({ok:!0,item:await d(v)}),t),g=m.filter((v)=>!v.ok),u=m.filter((v)=>v.ok).map((v)=>v.item),p=u.flatMap((v)=>Hu(v,a.rules)),f=u.flatMap((v)=>Mu(v,o,i)),b=new Set([...p,...f].map((v)=>v.spec)),L=[...g,...p,...f],h=[],S=Uu(h,()=>u.flatMap((v)=>b.has(v.spec)||L.length>0&&o.has(v.spec)?[]:ju(v,i,n,h)));return{ok:L.length===0,errors:L.map((v)=>`Failed to update ${v.spec}: ${v.message}`),warnings:[],entries:u.map(Bu),changes:S}}catch(i){return Ct(i)}}function Hu(e,t){if(!te(e.spec))return[];let n=Cr(e.spec),r=t.filter((o)=>o!==e.spec&&Cr(o).toLowerCase()===n.toLowerCase());if(r.length===0)return[];return[{ok:!1,spec:e.spec,message:`rulebook name "${n}" is also claimed by ${r.join(", ")}; rename one of them`}]}function Mu(e,t,n){if(!t.has(e.spec)||!te(e.spec))return[];let r=Ce(n.configDir,e.rulebook.name),o=w(x(n.filesystemScope,r));if(o===null||o===e.content)return[];return[{ok:!1,spec:e.spec,message:`${r} already exists and no configured source claims it; remove or rename the file, then re-run rule add`}]}function ju(e,t,n,r){if(!te(e.spec))return[];let o=Ce(t.configDir,e.rulebook.name),i=x(t.filesystemScope,o),s=w(i);if(s===e.content)return[];return r?.push({target:i,previous:s}),ne(i,e.content,void 0,n._testAfterPolicyRename),Gu(e,s)}function Uu(e,t){try{return t()}catch(n){for(let r of[...e].reverse()){if(r.previous===null){me(r.target);continue}ne(r.target,r.previous)}throw n}}function Gu(e,t){if(t===null)return[`Vendored ${e.spec} (${e.rulebook.version})`];let n=St(t),r="problem"in n?null:n.rulebook,o=new Map(r?.rules.map((s)=>[s.name,JSON.stringify(s)])??[]),i=new Set(e.rulebook.rules.map((s)=>s.name));return[`Updated ${e.spec} (${r?.version??"unreadable"} -> ${e.rulebook.version})`,...[...i].filter((s)=>!o.has(s)).map((s)=>`  + ${s}`),...[...o.keys()].filter((s)=>!i.has(s)).map((s)=>`  - ${s}`),...e.rulebook.rules.filter((s)=>{let a=o.get(s.name);return a!==void 0&&a!==JSON.stringify(s)}).map((s)=>`  ~ ${s.name}`)]}function Bu(e){return{spec:e.spec,name:e.rulebook.name,version:e.rulebook.version,ruleCount:e.rulebook.rules.length}}async function Ar(e,t={}){return qu(e,Yu(t),fe())}async function qu(e,t,n,r={}){let o=null,i=!1;try{let s=U(t),a=w(s.configTarget);o={target:s.configTarget,content:a};let l=Dr(s.configTarget);if(!l.ok)return l.result;let c=l.config,d=xe(e);Vu(e,t,d);let m=d?await ji(e,{ref:t.ref,operation:n}):null,g=m?zu(m,t.rulebooks):[],u=m?g.map((h)=>Ku(c.rules,m,h)??`${e}#${m.ref}/${h}`):[e],p=u.filter((h)=>!c.rules.includes(h)),f=[...c.rules,...p];if(f.length>Sr)return Wu();if(f.length!==c.rules.length)i=!0,K(s.configTarget,{version:1,rules:f,overrides:c.overrides??{},transparent_wrappers:c.transparent_wrappers??[]},void 0,r._testAfterPolicyRename);let b=await ln(t,n,r,new Set(p),new Set(p));if(!b.ok)xt(s.configTarget,a);if(!b.ok||!m)return b;let L=g.filter((h,S)=>p.includes(u[S]??""));return{...b,add:{source:e,ref:m.ref,selected:g,added:L,alreadyConfigured:g.filter((h)=>!L.includes(h)),commits:p.length>0?[m.commit]:[]}}}catch(s){if(i&&o)try{xt(o.target,o.content)}catch(a){return Ct(a)}return Ct(s)}}function Vu(e,t,n){if(!n&&t.rulebooks!==void 0)throw Error("--only can only select rulebooks from an owner/repo source");if(!n&&t.ref)throw Error(`--ref can only select a ref for an owner/repo source: ${e}`);if(t.rulebooks?.length===0)throw Error("--only requires at least one rulebook name");let r=t.rulebooks?.filter((o)=>!Se.test(o))??[];if(r.length>0)throw Error(`Invalid rulebook names: ${r.join(", ")}`)}function zu(e,t){let n=t?[...new Set(t)]:e.names,r=n.filter((o)=>!e.names.includes(o));if(r.length>0)throw Error(`Rulebooks not found in ${e.source} at ${e.ref}: ${r.join(", ")}
Available rulebooks: ${e.names.join(", ")}`);return n}function Ku(e,t,n){let r=`${t.source}#${t.ref}/${n}`;if(e.includes(r))return r;let o=`${t.source}#${t.commit}/${n}`;return e.find((i)=>i===o)}async function Ju(e,t,n=fe()){if(e.length>Sr)throw Error(Rr);let r=Array(e.length),o=0,i,s=Array.from({length:Math.min(e.length,zi.concurrency)},async()=>{while(!i){let a=o;if(a>=e.length)return;o++;try{r[a]=await t(e[a],a,n.controller.signal)}catch(l){if(!i)i={value:l},o=e.length,n.controller.abort(l);return}}});if(await Promise.all(s),i)throw i.value;return r}function Wu(){return{ok:!1,errors:[Rr],warnings:[],entries:[]}}function Er(e){return{cwd:e.cwd,userConfigDir:e.userConfigDir,userConfigPath:e.userConfigPath,projectConfigPath:e.projectConfigPath,global:e.global,check:e.check,only:e.only,refresh:e.refresh}}function Yu(e){return{...Er(e),ref:e.ref,rulebooks:e.rulebooks}}function Zu(e){return{...Er(e),deleteSource:e.deleteSource}}async function Tr(e,t={}){try{return await Xu(e,Zu(t),{})}catch(n){return Ct(n)}}async function Xu(e,t,n){let r=U(t),o=B(r.configTarget);if(o.errors.length>0)return{ok:!1,errors:o.errors,warnings:[],entries:[]};if(!o.config)return{ok:!1,errors:[`No config found at ${r.configPath}`],warnings:[],entries:[]};let i=Ei(o.config.rules,e);if(!i.ok)return i.result;let s=t.deleteSource?ep(r.configDir,i.specs,r.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let a=w(r.configTarget);if(a===null)return Ct(Error("Rules config is unavailable."));try{K(r.configTarget,{version:1,rules:o.config.rules.filter((d)=>!i.specs.includes(d)),overrides:o.config.overrides??{},transparent_wrappers:o.config.transparent_wrappers??[]},void 0,n._testAfterPolicyRename)}catch(d){throw xt(r.configTarget,a),d}let l=await ln(t,fe(),n);if(!l.ok)return xt(r.configTarget,a),l;let c=tp(s.dirs,n,r.filesystemScope);if(!c.ok){xt(r.configTarget,a);let d=await ln(t,fe(),n);if(!d.ok)return{ok:!1,errors:[...c.result.errors,...d.errors],warnings:d.warnings,entries:d.entries};return c.result}return l}async function Qu(e,t,n){let r=Ji(e,t.configDir,n.global?"user":"project",t.filesystemScope);return{ok:r.errors.length===0&&r.warnings.length===0,errors:[...r.errors,...r.warnings],warnings:[],entries:r.entries}}function ep(e,t,n){let r=t.flatMap((a)=>Se.test(a)?[]:["--delete-source can only delete local rulebook sources"]),o=t.map((a)=>Pr(e,a)),i=r.length>0?[]:o.flatMap((a)=>Wi(a,n)),s=[...r,...i];return s.length>0?{ok:!1,result:{ok:!1,errors:s,warnings:[],entries:[]}}:{ok:!0,dirs:o}}function Wi(e,t){let n=Nu(e),r=x(t,n),o=tt(r);if(!o)return[`Local rulebook source directory not found: ${e}`];let i=o.find((s)=>s.name==="rulebook.json");if(!i)return[`Local rulebook source directory is missing rulebook.json: ${e}`];if(i.kind!=="file")throw new M(t.label);if(w(x(t,Pr(n,"rulebook.json"))),o.length>1)return[`Local rulebook source directory contains extra files: ${e}. delete manually if you really want to remove the directory.`];return[]}function tp(e,t,n){let r=e.flatMap((o)=>{try{if(!tt(x(n,o)))return[];let i=Wi(o,n);if(i.length>0)return i;return np(o,t,n),[]}catch(i){return[`Failed to delete local rulebook source ${o}: ${i instanceof Error?i.message:String(i)}`]}});return r.length>0?{ok:!1,result:{ok:!1,errors:r,warnings:[],entries:[]}}:{ok:!0}}function np(e,t,n){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(e);return}me(x(n,Pr(e,cn))),Vi(x(n,e))}function xt(e,t){if(t===null){me(e);return}ne(e,t)}function Ct(e){return{ok:!1,errors:[e instanceof Error?e.message:String(e)],warnings:[],entries:[]}}function rt(e,t){let n=ip(t),r=ts(n),o={effectiveLevel:r.effectiveLevel,selectedPreset:n.policySnapshot.policy.safety.level??"standard",...n.policySnapshot.policyScopes?{safetyPresetScope:n.policySnapshot.policyScopes.levelScope}:{},effectiveCapabilities:r.effectiveCapabilities,destructiveCommandRuleOverrides:n.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:i,configValid:s}=op({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!e||!e.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:i,configValid:s,...o};let a=sp(e,n);if(a)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",rule:a.rule,matched:!0,reason:a.reason}]}]},result:"blocked",reason:q(a.reason),segment:q(a.target),...a.ruleId?{ruleId:q(a.ruleId)}:{},configSource:i,configValid:s,...o};let l=yi(e,n),c=l.decision,d=c?.ruleId??ap(e,n),m=Pt.find((u)=>u.id===d&&u.activationCapability),g=m?r.policy.effectiveDestructiveCommandRules[m.id]:void 0;return{trace:cp(l.trace),result:c?"blocked":"allowed",reason:c?q(c.reason):void 0,segment:c?q(c.evidence.find((u)=>u.kind==="command")?.segment??e):void 0,ruleId:c?.ruleId?q(c.ruleId):void 0,customRule:lp(dp(c?.ruleId,n.policySnapshot)),configSource:i,configValid:s,...o,...m&&g?{ruleActivation:{id:m.id,...g}}:{}}}function op(e){let t=re(e?.cwd),n=e?.userConfigPath??oe(e),r=De({cwd:e?.cwd,userConfigDir:e?.userConfigDir,userConfigPath:e?.userConfigPath});try{if(w(r.projectConfigTarget)!==null){if(pe(r.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(o){if(o instanceof M)return{configSource:t,configValid:!1};throw o}try{if(w(r.userConfigTarget)!==null){let o=pe(r.userConfigTarget);return{configSource:n,configValid:o.errors.length===0}}return{configSource:null,configValid:!0}}catch(o){if(o instanceof M)return{configSource:n,configValid:!1};throw o}}function ip(e){let t=rp(e?.cwd??process.cwd()),n=e?.policySnapshot??V({cwd:t,userConfigDir:e?.userConfigDir}),r=ge(n.policy);return{cwd:t,effectiveCwd:t,policySnapshot:n,environment:Yi(),protectedGitMetadata:es([t]),effectiveCapabilities:r.capabilities,strict:e?.strict??r.strict,paranoidRm:r.paranoidRm,paranoidInterpreters:r.paranoidInterpreters,worktreeMode:r.worktreeMode}}function sp(e,t){let n=t.cwd??process.cwd(),r=Zi(nt("",{command:e},{kind:"command",shell:"posix"},{executionCwd:n,configCwd:n},e)),o=ss(r);if(o)return{reason:is,target:o.target,ruleId:"policy-protection",rule:"policy-protection:findPolicyConfigMutationTargetInSemanticFacts"};let i=os(r);if(i)return{reason:rs,target:i.target,ruleId:"policy-apply-protection",rule:"policy-apply-protection:findPolicyApplyInvocationInSemanticFacts"};let s=Qi(r,t.protectedGitMetadata);if(s)return{reason:Xi,target:s.target,ruleId:"git-metadata-protection",rule:"git-metadata-protection:findGitMetadataMutationTargetInSemanticFacts"};let a=t.policySnapshot.policy,l=a.secretProtection.enabled===!1?null:ls(r,a.secretProtection,{strict:t.strict});if(l)return{reason:as,target:l.target,ruleId:l.ruleId,rule:"secret-protection:findSensitiveTargetInSemanticFacts"};return null}function ap(e,t){let n=t.policySnapshot.policy,r=At({...n,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...n.destructiveCommandRuleOverrides,...Object.fromEntries(Pt.flatMap((o)=>o.activationCapability?[[o.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return ns(e,{...t,policySnapshot:r,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function lp(e){if(!e)return;return{id:q(e.id),...e.rulebook?{rulebook:{name:q(e.rulebook.name),version:q(e.rulebook.version)}}:{},...e.source?{source:q(e.source)}:{},...e.override?{override:{type:"reason",reason:q(e.override.reason)}}:{}}}function cp(e){let t=e.events.flatMap((r)=>r.kind==="step"&&r.scope==="global"?[r.step]:[]),n=new Map;for(let r of e.events){if(r.kind!=="step"||r.scope!=="segment")continue;let o=n.get(r.segmentIndex)??{index:r.segmentIndex,steps:[]};o.steps.push(r.step),n.set(r.segmentIndex,o)}return{steps:t,segments:[...n.values()]}}function dp(e,t){let n=e?.replace(/^custom\./,"");if(!n||!t.policy.rules.some((r)=>r.name===n))return;return t.ruleMetadata[n]??Object.freeze({id:n})}function hp(e){let t=ot(),n=E({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},e);if(ue(n.errors))return null;if(n.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(n.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let r=n.values.limit===void 0?20:cs(n.values.limit);if(r===null)return console.error("--limit must be a positive number"),null;let o=n.values.since===void 0?Math.min(30,t):cs(n.values.since);if(o===null||o>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let i={limit:r,limitExplicit:n.values.limit!==void 0,since:o,sinceExplicit:n.values.since!==void 0,all:n.flags.all,json:n.flags.json,suspect:n.flags.suspect,pruneLegacy:n.flags.pruneLegacy,dryRun:n.flags.dryRun,id:n.values.id,agent:n.values.agent,rule:n.values.rule,session:n.values.session,project:n.values.project===void 0?void 0:gp(n.values.project)};if(i.id&&(i.agent!==void 0||i.rule!==void 0||i.session!==void 0||i.project!==void 0||i.suspect||i.sinceExplicit||i.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(i.pruneLegacy&&(i.id!==void 0||i.agent!==void 0||i.rule!==void 0||i.session!==void 0||i.project!==void 0||i.suspect||i.all||i.sinceExplicit||i.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(i.dryRun&&!i.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return i}async function ps(e,t={}){let n=hp(e);if(!n)return 1;let r=t.logsDir??he();if(n.pruneLegacy)return yp(r,n.json,n.dryRun);if(!r)return console.log(n.json?"[]":n.id?`No retained audit log entry found for id ${N(n.id)}.`:"No audit log entries found."),0;Fe(r);let o={count:0},i=ke(r,o).flatMap((d)=>_e(d,o).map((m)=>({entry:m,file:d})));if(o.count>0)console.error(`warning: ${o.count} audit log ${o.count===1?"source":"sources"} could not be read; these results are incomplete`);if(n.id)return wp(i,n,t.timeZone);let s=Date.now()-n.since*24*60*60*1000,a=i.filter((d)=>kp(d,n,r,s)),l=n.suspect?ur(a.map((d)=>d.entry)):null,c=(l?a.filter((d)=>l.has(d.entry)):a).sort((d,m)=>Date.parse(m.entry.ts)-Date.parse(d.entry.ts)).slice(0,n.limit);if(n.json)return console.log(JSON.stringify(c.map((d)=>d.entry),null,2)),0;if(c.length===0)return console.log("No audit log entries found."),0;for(let d of c)console.log(Sp(d.entry,t.timeZone));return 0}function yp(e,t,n){let r=e?bp(e).map((a)=>mp(e,a)):[];if(n)return vp(r,t);let o=[],i=0,s=0;for(let a of r){let l=ds(a,{throwIfNoEntry:!1})?.size??0,c=Lp(a);if(c){o.push(`${us(a)}: ${c}`);continue}i++,s+=l}if(t)return console.log(JSON.stringify({removedFiles:i,removedBytes:s,failedFiles:o.length})),o.length===0?0:1;console.log(i===0&&o.length===0?"No legacy audit log files found.":`Removed ${i} legacy audit log ${i===1?"file":"files"} (${fs(s)}).`);for(let a of o)console.error(`Could not remove ${N(a)}`);if(console.log("Nested v2 audit logs were not changed."),i>0)console.log("This deletion cannot be undone.");return o.length===0?0:1}function vp(e,t){let n=e.reduce((r,o)=>r+(ds(o,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:e.length,bytes:n})),0;if(console.log(e.length===0?"No legacy audit log files found.":`Would remove ${e.length} legacy audit log ${e.length===1?"file":"files"} (${fs(n)}).`),console.log("Nested v2 audit logs are not included."),e.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function bp(e){try{return up(e,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function Lp(e){try{return pp(e),null}catch(t){return t instanceof Error?t.message:String(t)}}function fs(e){let t=["B","KiB","MiB","GiB"],n=Math.min(Math.floor(Math.log2(Math.max(e,1))/10),t.length-1);return`${Math.round(e/1024**n*10)/10} ${t[n]}`}function wp(e,t,n){let r=e.filter((i)=>i.entry.id===t.id);if(r.length>1)return console.error(`Multiple audit log entries found for id ${N(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(r.map((i)=>i.entry),null,2)),0;let o=r[0];if(!o)return console.log(`No retained audit log entry found for id ${N(t.id??"")}.`),0;return console.log(Rp(o.entry,n)),0}function kp(e,t,n,r){if(!t.all&&e.entry.decision==="allow")return!1;if(Date.parse(e.entry.ts)<r)return!1;if(t.agent!==void 0&&e.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&e.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!xp(e,n,t.session))return!1;if(t.project!==void 0&&!Cp(e.entry.cwd,t.project))return!1;return!0}function xp(e,t,n){if(e.entry.sessionId===n)return!0;return fp(e.file)===t&&us(e.file,".jsonl")===n}function Cp(e,t){if(!e)return!1;return e===t||e.startsWith(`${t}/`)}function Sp(e,t){let n=N(e.id??"-"),r=N(e.decision??"deny"),o=e.cwd?`  [${N(e.cwd)}]`:"",i=e.segment||e.command,s=i===e.command?"":"↳ ",a=i.length>50?`${i.slice(0,50)}…`:i;return`${n.padEnd(16)}  ${N(ms(e.ts,t))}  ${r.padEnd(5)}  ${N(e.agent??"-").padEnd(15)}  ${N(e.ruleId??"-").padEnd(20)}  ${s}${N(a)}${o}`}function Rp(e,t){let n=(o)=>N(o===void 0||o===null||o===""?"-":o),r=e.shape?`${e.agent??"-"} (shape: ${e.shape})`:e.agent??"-";return[`id:        ${n(e.id)}`,`ts:        ${n(ms(e.ts,t))}`,`decision:  ${n(e.decision)}`,`agent:     ${n(r)}`,`level:     ${n(e.level)}`,`tool:      ${n(e.toolName)}`,`rule:      ${n(e.ruleId)}`,`intent:    ${n(e.intent)}`,`stage:     ${n(e.failureStage)}`,`error:     ${n(e.errorCode)}`,`session:   ${n(e.sessionId)}`,`cwd:       ${n(e.cwd)}`,`version:   ${n(e.v)}`,`truncated: ${n(e.truncated===!0?"yes":void 0)}`,`reason:    ${n(e.reason)}`,`command:   ${n(e.command)}`,`segment:   ${n(e.segment)}`].join(`
`)}function ms(e,t){let n=new Date(e);if(Number.isNaN(n.getTime()))return e;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(n)}function cs(e){let t=Number(e);return Number.isFinite(t)&&t>0?t:null}var gs={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var hs={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var ys={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as Rs,join as Fp,relative as Hp}from"node:path";var Dp=8388608;function Pp(e,t){console.log(JSON.stringify(e(bs(t))))}async function Ap(e){let t;try{t=(await Br(process.stdin)).trim()}catch{e({reason:"Failed to parse hook input JSON."});return}if(!t){e({reason:"Missing hook input JSON."});return}return qr(t,e,"Failed to parse hook input JSON.")}async function Br(e){let t=[],n=0;for await(let r of e){let o=typeof r==="string"?Buffer.from(r,"utf-8"):Buffer.from(r.buffer,r.byteOffset,r.byteLength);if(n+=o.byteLength,n>Dp)throw Ep(e),Error("hook input byte limit exceeded");t.push(o)}return Buffer.concat(t,n).toString("utf-8")}function Ep(e){let t=e.destroy??e.cancel;if(!t)return;try{Promise.resolve(t.call(e)).catch(()=>{})}catch{}}function qr(e,t,n){try{return JSON.parse(e)}catch{t({reason:n});return}}function F(e,t){let n=t.get(e);return n?{kind:"command",shell:n}:{kind:ws(e)}}function ie(e,t,n,r){let o=e===void 0?process.cwd():e,i=typeof o==="string"&&o.trim()!==""?W([o]):void 0;if(i)return{configCwd:i,executionCwd:i};return I(r,t,n,$p(o)),null}function I(e,t,n,r){let o;try{o=Gr(t)}catch(i){if(!(i instanceof ye))throw i}e(pn({command:o,segment:r,toolName:n}))}async function Tp(e){let t=await Ap(e.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){I(e.outputDeny);return}if(!e.isSupported(t))return;let n=e.getAgent?.(t)??e.agent,r=e.agent===n?void 0:e.agent,o=Np(t),i=(u,p)=>{vs(u,()=>e.getSessionId(t),{agent:n,shape:r,toolName:p,cwd:o}),e.outputDeny(u)},s=e.getToolName(t);if(typeof s!=="string"||s.trim()===""){I((u)=>i(u),Op(t));return}let a=s,l=(u)=>i(u,a),c;try{c=e.getToolInput(t,a,l)}catch(u){if(!(u instanceof ye))throw u;I(l,void 0,a);return}if(!c.ok)return;let d=e.getContext(t,c.input,a,l);if(!d)return;let m;try{m=Gr(c.input)}catch(u){if(!(u instanceof ye))throw u;I(l,void 0,a);return}let g=nt(a,c.input,c.route,d,m??null);try{let u=fn(g,{guard:{auditAllowed:ks(),dependencies:e.guardDependencies},audit:{agent:n,shape:r,getSessionId:()=>e.getSessionId(t)}}),p=Ur(u,{includeEvidence:!0,toolName:u.stage==="command-analysis"?void 0:a});if(p){e.outputDeny(p);return}e.outputAllow?.()}catch(u){if(!(u instanceof xs))throw u;Ip(u);let p=Ur(u.evaluation,{includeEvidence:!0,toolName:u.evaluation.stage==="command-analysis"?void 0:a});if(p)e.outputDeny(p);return}}function Ip(e){if(!Et(C.debug))return;console.error(`CC Safety Net debug: ${_p(e.stage)}: ${Ls(e.cause)}`)}function _p(e){if(e==="policy-protection")return"hook policy protection failed";if(e==="config-load")return"hook config loading failed";if(e==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function $p(e){return typeof e==="string"?e:void 0}function Op(e){if(!e||typeof e!=="object"||Array.isArray(e))return;if(Object.hasOwn(e,"tool_input"))return e.tool_input;let t=e.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function Np(e){if(!e||typeof e!=="object"||Array.isArray(e))return null;let t=e.cwd;if(typeof t==="string")return t;let n=e.toolCall;if(!n||typeof n!=="object"||Array.isArray(n))return null;let r=n.args;if(!r||typeof r!=="object"||Array.isArray(r))return null;let o=r.Cwd;return typeof o==="string"?o:null}async function H(e){let t=(o)=>Pp(e.createDenyOutput,o),n=e.createAllowOutput;await Tp({...e,outputDeny:t,outputAllow:n?()=>console.log(JSON.stringify(n())):void 0})}function Ot(e){return Fp(e,".gemini","config","hooks.json")}var Mp=new Map([["run_command","auto"]]),jp=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function Ds(e){return F(e,Mp)}async function Ps(){await H({agent:"antigravity-cli",createDenyOutput:(e)=>({decision:"deny",reason:e}),isSupported:()=>!0,getToolName:(e)=>e.toolCall?.name,getToolInput:(e,t)=>({ok:!0,input:Vp(e.toolCall?.args,t),route:Ds(t)}),getContext:Up,getSessionId:(e)=>e.conversationId})}function Up(e,t,n,r){let i=qp(e).flatMap((c)=>{let d=W([c]);return d?[d]:[]});if(!i[0])return je(r,t,n),null;if(n!=="run_command"){let c;try{c=Gp(t,n,i)}catch(d){if(d instanceof ye)return je(r,void 0,n),null;if(!(d instanceof He))throw d;return je(r,t,n),null}if(!c)return je(r,t,n),null;return{configCwd:c,executionCwd:c}}let s=e.toolCall?.args;if(!s||!Object.hasOwn(s,"Cwd"))return{configCwd:i[0],executionCwd:i[0]};let a=s.Cwd;if(typeof a!=="string"||a.trim()==="")return je(r,t,n),null;let l=ve(a,i);if(l){let c=As(l,i);if(!c)return je(r,t,n,a),null;return{configCwd:c,executionCwd:l}}return je(r,t,n,a),null}function Gp(e,t,n){let r=Ds(t),o=[...Cs(e,jp),...r.kind==="patch"?Ss(e):[]].filter(Rs),i=mn(),s=new Set(o.flatMap((a)=>{let l=As($t(a,_t,i),n);return l?[l]:[]}));if(s.size>1)return null;return[...s][0]??n[0]??null}function As(e,t){return t.filter((n)=>Bp(e,n)).reduce((n,r)=>r.length>n.length?r:n,"")||null}function Bp(e,t){let n=Hp(t,e);return n===""||!n.startsWith("..")&&!Rs(n)}function je(e,t,n,r){let o=t&&typeof t==="object"?t.command:void 0;e(pn({command:typeof o==="string"?o:void 0,segment:r,toolName:n}))}function qp(e){if(e.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(e.workspacePaths)?e.workspacePaths.filter((n)=>typeof n==="string"&&n.trim()!==""):[];return W(t)?t:[]}function Vp(e,t){if(!e)return;if(t!=="run_command")return e;return{...e,command:typeof e.CommandLine==="string"&&e.CommandLine!==""?e.CommandLine:void 0}}var Nt=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",artifactKind:"hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",artifactKind:"plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",artifactKind:"plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",artifactKind:"plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",artifactKind:"extension",probeCommand:["gemini","--version"]}},{id:"grok-build",displayName:"Grok Build",doctorOrder:8,runtime:{order:6,flags:["-gb","--grok-build"],description:"Run as Grok Build PreToolUse hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--grok-build",artifactKind:"hook config",probeCommand:["grok","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:9,runtime:{order:7,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--hermes-agent",artifactKind:"plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:10,runtime:{order:8,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:10,flag:"--kimi-code",artifactKind:"hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:11,install:{order:11,flag:"--openclaw",artifactKind:"plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:12,install:{order:12,flag:"--opencode",artifactKind:"plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:13,install:{order:13,flag:"--pi",artifactKind:"package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",artifactKind:"hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",artifactKind:"plugin",probeCommand:["amp","--version"]}}],gn=Nt.slice().sort((e,t)=>e.doctorOrder-t.doctorOrder).map((e)=>e.id),Es=Nt.filter((e)=>("runtime"in e)).slice().sort((e,t)=>e.runtime.order-t.runtime.order).map((e)=>({id:e.id,displayName:"displayName"in e.runtime?e.runtime.displayName:e.displayName,flags:e.runtime.flags,legacyFlags:"legacyFlags"in e.runtime?e.runtime.legacyFlags:[],description:e.runtime.description,legacyTopLevelFlags:e.runtime.legacyTopLevelFlags})),Y=Nt.slice().sort((e,t)=>e.install.order-t.install.order).map((e)=>({id:e.id,...e.install})).map(({order:e,...t})=>t),Av=Object.fromEntries(Nt.map((e)=>[e.id,e.displayName]));function P(e){return Nt.find((t)=>t.id===e)?.displayName??e}import{homedir as zp}from"node:os";import{isAbsolute as Ts,join as Vr}from"node:path";function _s(e){if(e!==void 0&&e!==null&&typeof e!=="string")return"unknown";if(typeof e==="string"&&!Ts(e))return"unknown";try{let t=mn(),n=typeof e==="string"&&e?$t(e,_t,t):void 0,r=process.env.HOME||zp(),o=[["codex",process.env.CODEX_HOME||Vr(r,".codex")],["copilot-cli",process.env.COPILOT_HOME||Vr(r,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||Vr(r,".claude")]],i=n?o.flatMap(([s,a])=>{if(!Ts(a))return[];return Is(n,$t(a,_t,t))?[s]:[]}):[];if(i.length===1)return i[0]??"unknown";if(i.length>1)return"unknown"}catch(t){if(t instanceof He)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var zr="PreToolUse",$s="BeforeTool",Os="pre_tool_call",Kr="PreToolUse";var Kp=new Map([["Bash","posix"],["PowerShell","powershell"]]);function Jp(e){return F(e,Kp)}async function Ns(){await H({agent:"claude-code",getAgent:(e)=>_s(e.transcript_path),createDenyOutput:(e)=>({hookSpecificOutput:{hookEventName:zr,permissionDecision:"deny",permissionDecisionReason:e}}),isSupported:(e)=>e.hook_event_name===zr,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:Jp(t)}),getContext:(e,t,n,r)=>ie(e.cwd,t,n,r),getSessionId:(e)=>e.session_id})}var Wp=new Map([["bash","auto"],["Bash","auto"],["powershell","powershell"],["PowerShell","powershell"]]);function Yp(e){return F(e,Wp)}async function Fs(){await H({agent:"copilot-cli",createDenyOutput:(e)=>({permissionDecision:"deny",permissionDecisionReason:e}),isSupported:()=>!0,getToolName:(e)=>e.toolName,getToolInput:(e,t,n)=>{if(typeof e.toolArgs!=="string")return n({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let r=qr(e.toolArgs,n,"Failed to parse toolArgs JSON.");if(r===void 0)return{ok:!1};return{ok:!0,input:r,route:Yp(t)}},getContext:(e,t,n,r)=>ie(e.cwd,t,n,r),getSessionId:(e)=>typeof e.sessionId==="string"&&e.sessionId.trim()?e.sessionId:void 0})}var Zp=new Map([["Shell","auto"]]);function Xp(e){return F(e,Zp)}async function Hs(){await H({agent:"cursor",createDenyOutput:(e)=>({permission:"deny",user_message:e,agent_message:e}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:Xp(t)}),getContext:Qp,getSessionId:(e)=>e.conversation_id})}function Qp(e,t,n,r){let o=e2(e);if(!o[0])return I(r,t,n),null;let i=ve(n2(e.cwd),o);if(!i)return I(r,t,n,typeof e.cwd==="string"?e.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:i,executionCwd:i};if(!Object.hasOwn(t,"working_directory"))return{configCwd:i,executionCwd:i};let s=t.working_directory;if(typeof s!=="string"||s.trim()==="")return I(r,t,n),null;let a=ve(s,o);if(!a)return I(r,t,n,s),null;return{configCwd:i,executionCwd:a}}function e2(e){return t2(e).flatMap((t)=>{let n=W([t]);return n?[n]:[]})}function t2(e){if(e.workspace_roots===void 0)return typeof e.cwd==="string"&&e.cwd.trim()!==""?[e.cwd]:[];if(!Array.isArray(e.workspace_roots))return[];return e.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function n2(e){return typeof e==="string"&&e.trim()!==""?e:"."}var r2=new Map([["run_shell_command","auto"]]);function o2(e){return F(e,r2)}async function Ms(){await H({agent:"gemini-cli",createDenyOutput:(e)=>({decision:"deny",reason:e,systemMessage:e}),isSupported:(e)=>e.hook_event_name===$s,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:o2(t)}),getContext:(e,t,n,r)=>ie(e.cwd,t,n,r),getSessionId:(e)=>e.session_id})}var i2=new Map([["run_terminal_command","auto"]]);function s2(e){return F(e,i2)}async function js(){await H({agent:"grok-build",createDenyOutput:(e)=>({decision:"deny",reason:e}),createAllowOutput:()=>({decision:"allow"}),isSupported:()=>!0,getToolName:(e)=>e.toolName,getToolInput:(e,t,n)=>{if(e.toolInputTruncated===!0)return I(n,e.toolInput,t),{ok:!1};return{ok:!0,input:e.toolInput,route:s2(t)}},getContext:a2,getSessionId:(e)=>e.sessionId})}function a2(e,t,n,r){let o=W(l2(e));if(!o)return I(r,t,n),null;let i=ve(c2(e.cwd),[o]);if(!i)return I(r,t,n,typeof e.cwd==="string"?e.cwd:void 0),null;return{configCwd:i,executionCwd:i}}function l2(e){let t=e.workspaceRoot===void 0?e.cwd:e.workspaceRoot;return typeof t==="string"&&t.trim()!==""?[t]:[]}function c2(e){return typeof e==="string"&&e.trim()!==""?e:"."}import{resolve as d2}from"node:path";var u2=new Map([["terminal","posix"]]);async function Us(){await H({agent:"hermes-agent",createDenyOutput:(e)=>({action:"block",message:e}),isSupported:(e)=>e.hook_event_name===Os,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:F(t,u2)}),getContext:p2,getSessionId:(e)=>e.session_id})}function p2(e,t,n,r){let o=ie(e.cwd,t,n,r);if(!o)return null;if(!t||typeof t!=="object"||Array.isArray(t))return o;if(!Object.hasOwn(t,"workdir"))return o;let i=t.workdir;if(typeof i!=="string"||i.trim()==="")return I(r,t,n),null;let s=W([d2(o.configCwd,i)]);if(!s)return I(r,t,n,i),null;return{...o,executionCwd:s}}var Gs=new Map([["Bash","posix"]]);function f2(e){return F(e,Gs)}async function Bs(){await H({agent:"kimi-code",createDenyOutput:(e)=>({hookSpecificOutput:{hookEventName:Kr,permissionDecision:"deny",permissionDecisionReason:e}}),isSupported:(e)=>e.hook_event_name===Kr,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:f2(t)}),getContext:(e,t,n,r)=>{let o=ie(e.cwd,t,n,r);if(!o)return null;let i=e.tool_input;if(!Gs.has(n)||!i||!Object.hasOwn(i,"cwd"))return o;let s=i.cwd;if(typeof s!=="string"||s.trim()==="")return I(r,t,n),null;let a=ve(s,[o.configCwd]);if(!a)return I(r,t,n,s),null;return{configCwd:o.configCwd,executionCwd:a}},getSessionId:(e)=>e.session_id})}var m2={"antigravity-cli":Ps,"claude-code":Ns,"copilot-cli":Fs,cursor:Hs,"gemini-cli":Ms,"grok-build":js,"hermes-agent":Us,"kimi-code":Bs},it=Es.map((e)=>({...e,run:m2[e.id]}));function qs(e){let t=E({label:"hook",booleans:Object.fromEntries(it.map((r)=>[r.id,[...r.flags,...r.legacyFlags]]))},e);if(t.errors.length>0)return;let n=it.filter((r)=>t.flags[r.id]);return n.length===1?n[0]:void 0}function Vs(e){return it.find((t)=>t.legacyTopLevelFlags.some((n)=>n===e))}var g2=it.map((e)=>({flags:e.flags.join(", "),description:e.description})),h2=it.flatMap((e)=>e.flags.map((t)=>`cc-safety-net hook ${t}`)),zs={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...g2,{flags:"-h, --help",description:"Show this help"}],examples:h2};var Ks={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...Y.map((e)=>({flags:e.flag,description:`Install ${P(e.id)} ${e.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...Y.map((e)=>`cc-safety-net install ${e.flag}`)]},Js={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...Y.map((e)=>({flags:e.flag,description:`Uninstall ${P(e.id)} ${e.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...Y.map((e)=>`cc-safety-net uninstall ${e.flag}`)]},Ws={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var Ys={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var hn={name:"policy",description:"Check and apply project or user policy proposals",usage:"policy <subcommand>",subcommands:[{usage:"check <file>",description:"Validate a policy proposal and print its diff"},{usage:"apply <file>",description:"Apply a proposal after confirming in a terminal"}],options:[{flags:"-g, --global",description:"Use the user-scope policy instead of the project one"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net policy check proposal.json","cc-safety-net policy apply proposal.json","cc-safety-net policy apply proposal.json --global"]};var Jr=[{flags:"--ref",argument:"<ref>",description:"Use a branch, tag, or commit"},{flags:"--only",argument:"<rulebook...>",description:"Add only these repository rulebooks"},{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"-h, --help",description:"Show this help"}],Wr=["cc-safety-net rule add project-rules","cc-safety-net rule add acme/safety-rules","cc-safety-net rule add acme/safety-rules --only aws gcloud","cc-safety-net rule add acme/safety-rules --ref v2 --only aws"],st={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source> [--ref <ref>] [--only <rulebook...>]",description:"Add rulebook sources and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Re-fetch and vendor remote rulebooks"},{usage:"sync",description:"Deprecated: migrate lock and cache leftovers"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},...Jr.slice(0,2),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk",...Wr,"cc-safety-net rule update","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var Zs={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var Xs={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var yn=[Zs,gs,Ys,hs,st,hn,Ks,Ws,Js,zs,ys,Xs];function y2(e){return e.aliases??[]}function vn(e){let t=e.toLowerCase();return yn.find((n)=>n.name.toLowerCase()===t||y2(n).some((r)=>r.toLowerCase()===t))}import{basename as v2}from"node:path";function bn(e=7,t=he()){let n=Date.now()-e*24*60*60*1000,r=[],o=new Set,i=0,s,a,l,c;if(t)Fe(t);let d={count:0},m=t?ke(t,d):[];for(let u of m)for(let p of _e(u,d)){if(p.decision==="allow")continue;let f=new Date(p.ts).getTime();if(f>=n){if(i++,o.add(p.sessionId??v2(u,".jsonl")),a===void 0||f<=a)s=p.ts,a=f;if(c===void 0||f>c)l=p.ts,c=f;b2(r,p,f)}}let g=r.map((u)=>({timestamp:u.ts,command:u.command,reason:u.reason,relativeTime:dr(new Date(u.ts))}));return{totalBlocked:i,sessionCount:o.size,recentEntries:g,oldestEntry:s,newestEntry:l,unreadable:d.count}}function b2(e,t,n){let r=e.findIndex((o)=>n>new Date(o.ts).getTime());if(r===-1){if(e.length<3)e.push(t);return}if(e.splice(r,0,t),e.length>3)e.pop()}import{dirname as L2}from"node:path";function Qs(e,t,n){let r;try{if(w(t)===null)return{path:e,exists:!1,valid:!1,ruleCount:0};r=pe(t),r.errors.push(...J(e,n))}catch(o){if(!(o instanceof M))throw o;r={errors:[o.message],ruleNames:new Set}}return{path:e,exists:!0,valid:r.errors.length===0,ruleCount:r.ruleNames.size,...r.errors.length>0?{errors:r.errors}:{}}}function w2(e,t){return{source:t,name:e.name,command:e.command,subcommand:e.subcommand,blockArgs:[...e.block_args],reason:e.reason}}function ea(e,t){let n=t?.userConfigPath??oe(),r=t?.projectConfigPath??re(e),o=L2(n),i=Re({cwd:e,userConfigPath:n,projectConfigPath:r,userConfigDir:o}),s=De({cwd:e,userConfigPath:n,projectConfigPath:r,userConfigDir:o}),a=new Map(i.rulebooks.flatMap((l)=>l.rules.map((c)=>[c,l.source])));return{userConfig:Qs(n,s.userConfigTarget,s.userScope),projectConfig:Qs(r,s.projectConfigTarget,s.projectScope),effectiveRules:i.rules.map((l)=>w2(l,a.get(l.name)??"project")),shadowedRules:[]}}var k2=[{flag:C.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:C.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:C.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:C.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:C.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:C.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:C.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:C.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function ta(){return[...k2.map((e)=>({name:e.flag.name,value:Mr(e.flag),isSet:jr(e.flag),legacyName:e.flag.legacyName,legacyValue:e.flag.legacyName?process.env[e.flag.legacyName]:void 0,legacyIsSet:e.flag.legacyName?process.env[e.flag.legacyName]!==void 0:void 0,description:e.description,defaultBehavior:e.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var na={error:0,warning:1,info:2},x2=["policy","config","audit"];function C2(e){return e.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var S2=[{derive:(e)=>e.hooks.length>0&&e.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(e)=>e.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let n=P(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${n} inspection failed`,detail:`Doctor could not verify the ${n} integration configuration.`,fixHint:`Correct the reported ${n} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(e)=>e.userConfig.exists&&!e.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:e.userConfig.path}]:[]},{derive:(e)=>e.projectConfig.exists&&!e.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:e.projectConfig.path}]:[]},{derive:(e)=>e.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${e.configState.reason}`,fixHint:"Fix the file named in the reason, or run `cc-safety-net rule update` to vendor a remote source, then rerun doctor."}]:[]},{derive:(e)=>e.v2Leftovers&&e.v2Leftovers.length>0?[{checkId:"config.v2-leftovers",severity:"info",title:"Rulebook lock and cache leftovers detected",detail:`Files an earlier version left behind are no longer read: ${e.v2Leftovers.join(", ")}.`,fixHint:"Run `cc-safety-net rule sync` (add `--global` for user scope) to migrate them, then rerun doctor."}]:[]},{derive:(e)=>{let t=e.environment.find((n)=>n.name==="CC_SAFETY_NET_AUDIT_SCOPE");return Hr(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...x2.map((e)=>({derive:(t)=>t.posture.directories.filter((n)=>n.kind===e&&n.status==="unsafe").map((n)=>({checkId:`posture.${e}-directory-unsafe`,severity:"error",title:`${e[0]?.toUpperCase()}${e.slice(1)} directory is unsafe`,detail:`The ${e} directory ${C2(n.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...n.path?{path:n.path}:{}}))})),{derive:(e)=>{let t=[...e.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function ra(e){return S2.flatMap((t,n)=>t.derive(e).map((r,o)=>({finding:r,catalogOrder:n,occurrence:o}))).sort((t,n)=>na[t.finding.severity]-na[n.finding.severity]||t.catalogOrder-n.catalogOrder||t.occurrence-n.occurrence).map((t)=>t.finding)}function se(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var R2=(e)=>se()?`\x1B[32m${e}\x1B[0m`:e,D2=(e)=>se()?`\x1B[33m${e}\x1B[0m`:e,P2=(e)=>se()?`\x1B[34m${e}\x1B[0m`:e,A2=(e)=>se()?`\x1B[35m${e}\x1B[0m`:e,E2=(e)=>se()?`\x1B[36m${e}\x1B[0m`:e,T2=(e)=>se()?`\x1B[31m${e}\x1B[0m`:e,I2=(e)=>se()?`\x1B[2m${e}\x1B[0m`:e,_2=(e)=>se()?`\x1B[1m${e}\x1B[0m`:e,y={green:R2,yellow:D2,blue:P2,magenta:A2,cyan:E2,red:T2,dim:I2,bold:_2},$2="\x1B[0m",O2=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function N2(e){let t=e;return()=>(t=(t*1664525+1013904223)%4294967296,t/4294967296)}function F2(e){let t=[...O2],n=N2(e);for(let r=t.length-1;r>0;r--){let o=Math.floor(n()*(r+1)),i=t[r];t[r]=t[o],t[o]=i}return t}function H2(e,t=0){if(!se())return"";let n=F2(t);return`\x1B[38;5;${n[e%n.length]}m`}function oa(e,t,n=0){if(!se())return`"${e}"`;return`${H2(t,n)}"${e}"${$2}`}function Ln(e){return e==="default"?"built-in default":`${e} policy`}var M2=new RegExp("\x1B\\[[0-9;]*m","g"),Yr=(e)=>e.replace(M2,"").length;function Ue(e){let t=(e.headers??e.rows[0]??[]).map((s,a)=>{let l=Math.max(...e.rows.map((c)=>Yr(c[a]??"")));return Math.max(Yr(s),l)}),n=(s,a)=>s+" ".repeat(Math.max(0,a-Yr(s))),r=(s,a)=>a[0]+t.map((l)=>s.repeat(l+2)).join(a[1])+a[2],o=(s)=>`│ ${s.map((a,l)=>n(a,t[l]??0)).join(" │ ")} │`,i=e.headers?[`   ${o(e.headers)}`,`   ${r("─",["├","┼","┤"])}`]:[];return[`   ${r("─",["┌","┬","┐"])}`,...i,...e.rows.map((s)=>`   ${o(s)}`),`   ${r("─",["└","┴","┘"])}`].join(`
`)}function ia(e){let t=[];t.push("Hook Integration"),t.push(j2(e));let n=[],r=[];for(let o of e){let i=P(o.platform);if(o.errors&&o.errors.length>0)for(let s of o.errors)if(o.configured)n.push({platform:i,message:s});else r.push({platform:i,message:s})}for(let o of n)t.push(`   Warning (${o.platform}): ${o.message}`);for(let o of r)t.push(y.red(`   Error (${o.platform}): ${o.message}`));return t.join(`
...
`)}function U2(e){if(e.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],n=e.map((r)=>[r.source,r.name,r.subcommand?`${r.command} ${r.subcommand}`:r.command,r.blockArgs.join(", ")]);return Ue({headers:t,rows:n})}function aa(e){let t=[];if(t.push("Configuration"),t.push(G2(e.userConfig,e.projectConfig)),t.push(""),e.effectiveRules.length>0)t.push(`   Effective rules (${e.effectiveRules.length} total):`),t.push(U2(e.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let n of e.shadowedRules)t.push(""),t.push(`   Note: Project rule "${n.name}" shadows user rule with same name`);return t.join(`
`)}function G2(e,t){let n=["Scope","Status"],r=(i)=>{if(!i.exists)return y.dim("N/A");if(!i.valid)return y.red(`Invalid (${i.errors?.[0]??"unknown error"})`);return y.green("Configured")},o=[["User",r(e)],["Project",r(t)]];return Ue({headers:n,rows:o})}function la(e){let t=[];return t.push("Environment"),t.push(B2(e)),t.join(`
...
${e.findings.length} ${r}: ${n.join(", ")}.`;if(t.error>0)return y.red(o);if(t.warning>0)return y.yellow(o);return y.blue(o)}import{lstatSync as z2}from"node:fs";import{dirname as Zr}from"node:path";function Xr(e,t){try{let n=z2(t);if(n.isSymbolicLink())return{kind:e,path:t,status:"unsafe",issues:["symlink"]};if(!n.isDirectory())return{kind:e,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:e,path:t,status:"unknown",issues:[]};let r=[...n.uid!==process.getuid()?["ownership"]:[],...(n.mode&18)!==0?["permissions"]:[]];return{kind:e,path:t,status:r.length>0?"unsafe":"safe",issues:r}}catch(n){if(typeof n==="object"&&n!==null&&"code"in n&&n.code==="ENOENT")return{kind:e,path:t,status:"not-applicable",issues:[]};return{kind:e,path:t,status:"unknown",issues:[]}}}function ga(e){let t=he();return{directories:[Xr("policy",Zr(Zr(e))),Xr("config",Zr(e)),...t?[Xr("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as K2}from"node:child_process";import{existsSync as ha}from"node:fs";import{delimiter as J2,extname as W2,join as Y2}from"node:path";import{stripVTControlCharacters as ya}from"node:util";var ba="2.2.2",Z2=5000,X2="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function _(){return ba}function Qr(e,t){let n=e[t];if(n)return n;let r=Object.keys(e).find((o)=>o.toLowerCase()===t.toLowerCase()&&!!e[o]);return r?e[r]:n}function Q2(e){return(Qr(e,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function ef(e,t){let n=W2(e)?[e]:[...Q2(t).map((r)=>`${e}${r}`),e];if(e.includes("/")||e.includes("\\"))return n.find((r)=>ha(r))??e;return(Qr(t,"PATH")??"").split(J2).flatMap((r)=>n.map((o)=>Y2(r,o))).find((r)=>ha(r))??e}function va(e){if(!/[\s"&|<>^]/.test(e))return e;return`"${e.replace(/"/g,'""')}"`}function Ge(e,t){let[n,...r]=e,o=t[X2]==="win32"?"win32":process.platform;if(!n||o!=="win32")return{cmd:n??"",args:r};let i=ef(n,t);if(!/\.(?:bat|cmd)$/i.test(i))return{cmd:i,args:r};return{cmd:Qr(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",va(i),...r.map(va)].join(" ")]}}var at=async(e,t=Z2)=>{let n=await tf(e,{timeoutMs:t});if(n.code!==0)return null;return ya(n.stdout).trim()||ya(n.stderr).trim()||null};function tf(e,t){let[n,...r]=e;if(!n)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((o)=>{try{let i=Ge([n,...r],process.env),s=K2(i.cmd,i.args,{stdio:["ignore","pipe","pipe"]}),a=!1,l="",c="";s.stdout.on("data",(g)=>{l+=g.toString()}),s.stderr.on("data",(g)=>{c+=g.toString()});let d=(g)=>{if(a)return;a=!0,clearTimeout(m),o(g)},m=setTimeout(()=>{s.kill(),d({code:null,stdout:l,stderr:c})},t.timeoutMs);s.on("close",(g)=>{d({code:g,stdout:l,stderr:c})}),s.on("error",()=>{d({code:null,stdout:l,stderr:c})})}catch{o({code:null,stdout:"",stderr:""})}})}function kn(e){if(!e)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(e);if(t)return t[1]??null;let n=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(e);if(n)return n[1]??null;return e.split(`
`)[0]?.trim()||null}async function Ft(e=at){let[t,n,r,o,i,s]=await Promise.all([Promise.all(Y.map(async(a)=>[a.id,kn(await e([...a.probeCommand]))])),e(["codex","plugin","list"],30000),e(["amp","plugins","list"],30000),e(["node","--version"]),e(["npm","--version"]),e(["bun","--version"])]);return{version:ba,versions:Object.fromEntries(t),codexPluginListOutput:n,ampPluginListOutput:r,nodeVersion:kn(o),npmVersion:kn(i),bunVersion:kn(s),platform:`${process.platform} ${process.arch}`}}function eo(e,t){if(t==="dev")return!1;let n=e.split(".").map(Number),r=t.split(".").map(Number),[o=0,i=0,s=0]=n,[a=0,l=0,c=0]=r;if(o!==a)return o>a;if(i!==l)return i>l;return s>c}async function Ae(){let e=_(),t=new AbortController,n=setTimeout(()=>t.abort(),3000);try{let r=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!r.ok)return{currentVersion:e,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${r.status}`};let o=await r.json(),i=eo(o.version,e);return{currentVersion:e,latestVersion:o.version,updateAvailable:i}}catch(r){return{currentVersion:e,latestVersion:null,updateAvailable:!1,error:r instanceof Error?r.message:"Network error"}}finally{clearTimeout(n)}}import*as Da from"node:readline";var xa=(e)=>`\x1B[${e}B`,nf=(e)=>`\x1B[${e}A`;var La=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function rf(e){return new Promise((t)=>setTimeout(t,e))}function of(e,t,n){if(!n)return t(e);if(n.aborted)return Promise.resolve();return new Promise((r,o)=>{let i=()=>n.removeEventListener("abort",s),s=()=>{i(),r()};n.addEventListener("abort",s,{once:!0}),t(e).then(()=>{i(),r()},(a)=>{i(),o(a)})})}function Ht(e,t){return e&&e>0?e:t}function xn(e){return Math.max(0,Math.min(1,e))}function lt(e){return Math.max(0,Math.min(255,Math.round(e)))}function to(e){return e<=0.0031308?12.92*e:1.055*e**0.4166666666666667-0.055}function sf(e,t,n){let r=n*Math.PI/180,o=t*Math.cos(r),i=t*Math.sin(r),s=(e+0.3963377774*o+0.2158037573*i)**3,a=(e-0.1055613458*o-0.0638541728*i)**3,l=(e-0.0894841775*o-1.291485548*i)**3;return{blue:lt(to(xn(-0.0041960863*s-0.7034186147*a+1.707614701*l))*255),green:lt(to(xn(-1.2684380046*s+2.6097574011*a-0.3413193965*l))*255),red:lt(to(xn(4.0767416621*s-3.3077115913*a+0.2309699292*l))*255)}}function no(e,t){let n=(t*e*180/Math.PI%360+360)%360;return sf(0.72,0.15,n)}function Ca(e,t=0.1){let n=no(t,e);return`\x1B[38;2;${n.red};${n.green};${n.blue}m`}function af(e,t){return{blue:lt(e.blue+(255-e.blue)*t),green:lt(e.green+(255-e.green)*t),red:lt(e.red+(255-e.red)*t)}}function Sa(e,t,n){let r=Math.imul(e+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(n+374761393,2654435761),o=r^r>>>15,i=Math.imul(o,739982445),s=i^i>>>12,a=Math.imul(s,695872825);return((a^a>>>15)>>>0)/4294967296}function lf(e,t,n){let r=Math.floor(Sa(e,t,n)*La.length);return La[r]??"░"}function wa(e){let t=xn(e);return t*t*t*(t*(t*6-15)+10)}function cf(e){if(e.length===0)return"";let t=[],n=!1,r="";for(let o of e){let i=`${o.red};${o.green};${o.blue}`;if(o.bold!==n)t.push(o.bold?"\x1B[1m":"\x1B[22m"),n=o.bold;if(i!==r)t.push(`\x1B[38;2;${i}m`),r=i;t.push(o.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function df(e,t,n,r,o){return e.map((i,s)=>({...no(n,r+t+s/o),bold:!1,character:i}))}function uf(e,t,n,r,o,i,s,a){let l=Math.max(1,r*0.75),c=Math.min(1,n/l),d=o*wa(c),m=Math.max(0,(n-l)/Math.max(1,r-l)),g=(1-wa(n/r))*a*2,u=0.35*Math.max(0,1-m*2),p=c>=1,f=Math.min(e.length,Math.ceil(d+2+1));return e.slice(0,f).map((b,L)=>{let h=no(i,s+t+L/a+g),S=L+Sa(t,L,7919)*2-1;if(S>d+2)return{...h,bold:!1,character:" "};let v=d-S,R=0.8*Math.exp(-(v*v)/12.5),ee=Math.min(0.9,R+u),nn=!p&&S>d-4;return{...af(h,ee),bold:ee>0.3,character:nn?lf(t,L,n):b}})}function ka(e){return`\x1B[?2026h${e.map((t,n)=>`\x1B8${n>0?xa(n):""}${cf(t)}`).join("")}\x1B[?2026l`}async function ro(e,t={}){if(!e)return;let n=t.output??process.stdout,r=t.sleep??rf,o=Ht(t.frequency,0.1),i=t.seed??0,s=Ht(t.speed,40),a=Ht(t.spread,3),l=Ht(t.frameRate,60),c=Math.max(1,Math.floor(Ht(t.duration,12))),d=e.split(`
...
`.repeat(d.length-1)}${nf(d.length-1)}`:""}\x1B7`);try{for(let f=1;f<=u;f+=1){if(t.signal?.aborted)break;n.write(ka(d.map((b,L)=>uf(b,L,f,u,m,o,i,a)))),await of(p,r,t.signal)}}finally{if(n.write(ka(d.map((f,b)=>df(f,b,o,i,a)))),n.write("\x1B8"),d.length>1)n.write(xa(d.length-1));n.write(`
\x1B[0m\x1B[?25h`)}}var Ra=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function pf(e){return Boolean(e.isTTY)}async function Mt(e={}){let t=e.output??process.stdout;if(!pf(t))return;let n=e.input??process.stdin,r={duration:e.duration,frequency:e.frequency,output:t,seed:e.seed??Math.random()*8192,sleep:e.sleep,speed:e.speed,spread:e.spread};if(!n.isTTY||typeof n.setRawMode!=="function"){await ro(Ra,r);return}let o=new AbortController,i=n.readableFlowing===!0,s=n.isRaw===!0,a=!1,l=(c,d)=>{if(d.ctrl&&d.name==="c")a=!0;if(a||d.name==="return"||d.name==="enter")o.abort()};Da.emitKeypressEvents(n),n.on("keypress",l),n.setRawMode(!0),n.resume();try{await ro(Ra,{...r,signal:o.signal})}finally{if(n.off("keypress",l),n.setRawMode(s),!i)n.pause()}if(!a)return;if(e.onInterrupt){e.onInterrupt();return}process.kill(process.pid,"SIGINT")}import{createHash as ff}from"node:crypto";import{existsSync as Aa}from"node:fs";import{dirname as Cn,join as Ea}from"node:path";var mf="`cc-safety-net rule sync` is deprecated: rulebooks are live files that need no synchronization. This run only migrates the lock and cache an earlier version left behind.",gf="cache",hf="rulebooks";function Ta(e={}){let t=U(e),n=x(t.filesystemScope,_a(t.configDir)),r=w(t.lockTarget);if(console.log(mf),r===null&&!Aa(n.path))return console.log(`No v2 lock or cache leftovers found in ${Cn(t.configDir)}; nothing to migrate.`),0;let o=wf(r),i=B(t.configTarget);if(!i.config&&(w(t.configTarget)!==null||o.size>0))return console.error(`Cannot migrate: the rules config in ${Cn(t.configDir)} is missing or unreadable while v2 leftovers remain. Restore rule.json, then re-run rule sync.`),1;let s=i.config?.rules??[];for(let a of s.flatMap((l)=>yf(l,o,t,n,e.global===!0)))console.log(a);return me(t.lockTarget),Pa(n),console.log(`Removed the v2 lock and cache under ${Cn(t.configDir)}.`),0}function Ia(e){return[...new Set([{cwd:e},{cwd:e,global:!0}].flatMap((t)=>{let n=U(t);return[n.lockPath,_a(n.configDir)]}))].filter((t)=>Aa(t))}function yf(e,t,n,r,o){if(!te(e))return[];let i=$e(e).name,s=x(n.filesystemScope,Ce(n.configDir,i)),a=w(s);if(a!==null&&vf(a,i))return[];let l=t.get(e),c=l?bf(l,i,r.path,n.filesystemScope):null;if(c===null)return[`Could not migrate ${e} from the v2 cache. Run \`cc-safety-net rule update ${e}${o?" --global":""}\` to vendor it.`];if(ne(s,c),a!==null)return[`Restored ${e} from the v2 cache over an invalid file.`];return[`Vendored ${e} from the v2 cache.`]}function vf(e,t){let n=St(e);return!("problem"in n)&&n.rulebook.name===t}function bf(e,t,n,r){let o=Ea(n,hf,`${Lf(e)}--${e.digest.replace("sha256:","").slice(0,12)}`,cn),i=w(x(r,o));if(i===null||Cf(i)!==e.digest)return null;let s=St(i);if("problem"in s||s.rulebook.name!==t)return null;return i}function _a(e){return Ea(Cn(e),gf)}function Lf(e){return([e.owner,e.repo,e.display_ref,e.name].every((r)=>typeof r==="string"&&r!=="")?`${e.owner}/${e.repo}#${e.display_ref}/${e.name}`:e.spec).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"rulebook"}function wf(e){let t=e===null?null:xf(e),n=$a(t)&&Array.isArray(t.rulebooks)?t.rulebooks:[];return new Map(n.filter(kf).map((r)=>[r.spec,r]))}function kf(e){return $a(e)&&typeof e.spec==="string"&&typeof e.digest==="string"}function $a(e){return!!e&&typeof e==="object"}function xf(e){try{return JSON.parse(e)}catch{return null}}function Cf(e){return`sha256:${ff("sha256").update(e).digest("hex")}`}var Oa="\r\x1B[2K",Sf="\x1B[?25l",Rf="\x1B[39m",Df="\x1B[?25h",Pf=100,Af=0.55,Ef=80,Na=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function Tf(e){return new Promise((t)=>setTimeout(t,e))}async function Sn(e,t={}){let n=t.output??process.stdout;if(!n.isTTY)return e;let r=t.sleep??Tf,o=!1,i=e.then((a)=>(o=!0,a),(a)=>{throw o=!0,a});if(await Promise.race([i.then(()=>!0),r(Pf).then(()=>!1)]))return i;n.write(Sf);try{for(let a=0;!o;a+=1)n.write(`${Oa}${Ca(a*Af)}${Na[a%Na.length]}${Rf} ${t.loadingMessage??"Loading…"}`),await Promise.race([i,r(Ef)]);return await i}finally{n.write(`${Oa}${Df}`)}}async function jt(e,t,n,r={}){let o=t();if(e)await n();if(e&&o.ready)await Sn(o.ready,r);return o.finish()}import{homedir as sg}from"node:os";import{stripVTControlCharacters as If}from"node:util";var Rn="amp plugins list",_f=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function Fa(e){if(!e.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=If(e.ampPluginListOutput).split(`
`).map((n)=>_f.exec(n)?.[1]).find((n)=>n!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:Rn,configPath:Rn,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:Rn,configPath:Rn}}import{existsSync as $f,readFileSync as Of}from"node:fs";var Nf=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function Ff(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];return Object.values(e).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t,r=n.PreToolUse;if(!Array.isArray(r))return[];return r.flatMap((o)=>{if(!o||typeof o!=="object"||Array.isArray(o))return[];let i=o.hooks;if(!Array.isArray(i))return[];return i.flatMap((s)=>{if(!s||typeof s!=="object"||Array.isArray(s))return[];let a=s.command;if(typeof a!=="string"||!Nf.test(a))return[];return[{command:a,enabled:n.enabled!==!1}]})})})}function Ha(e){let t=Ot(e.homeDir);if(!$f(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let n;try{n=Ff(JSON.parse(Of(t,"utf-8")))}catch(r){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${r instanceof Error?r.message:String(r)}`]}}if(n.some((r)=>r.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(n.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as Ma}from"node:path";import{existsSync as Hf,lstatSync as Mf,readFileSync as jf}from"node:fs";function ae(e,t=(n)=>n){if(!Hf(e))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(jf(e,"utf-8")))}}catch{return{kind:"unreadable"}}}function T(e){try{return Mf(e)}catch{return}}function Dn(e,t){let n=T(t);if(!n)return{platform:e,status:"n/a",configPath:t};if(!n.isSymbolicLink()&&n.isDirectory())return;return{platform:e,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function k(e,t){return typeof e==="object"&&e!==null?e[t]:void 0}var oo="cc-safety-net@cc-marketplace";function ja(e){return Ma(e,".claude","plugins","installed_plugins.json")}function Ua(e,t){let n=k(k(e,"plugins"),t);return Array.isArray(n)&&n.length>0}function Pn(e,t){let n=ae(ja(e));return n.kind==="ok"&&Ua(n.value,t)}function io(e){let t=ja(e),n=ae(t);if(n.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(n.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!Ua(n.value,oo))return{platform:"claude-code",status:"n/a"};let r=Ma(e,".claude","settings.json"),o=ae(r);if(o.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(o.kind==="ok"&&k(k(o.value,"enabledPlugins"),oo)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:r,errors:[`${oo} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function Ga(e){return io(e.homeDir)}function Ba(e){if(!e.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=e.codexPluginListOutput.split(`
`).find((n)=>n.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed,"))return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as In,readdirSync as Uf,readFileSync as Gf}from"node:fs";import{join as j}from"node:path";var le="cc-safety-net@cc-marketplace",An=["cc-marketplace","cc-safety-net"],qa=["_direct","copilot-safety-net"],Va=["cc-marketplace","safety-net"],za="safety-net@cc-marketplace";function En(e,t){let n=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${n}([^a-z0-9-]|$)`,"m").test(e??"")}function Ka(e){return En(e,"cc-safety-net@cc-marketplace")}function Ja(e){return En(e,"cc-marketplace")}function Wa(e){return En(e,"copilot-safety-net")}function Ya(e){return En(e,"safety-net@cc-marketplace")}function z(e){let t="",n=0,r=!1,o=!1,i=-1;while(n<e.length){let s=e[n],a=e[n+1];if(o){t+=s,o=!1,n++;continue}if(s==='"'&&!r){r=!0,i=-1,t+=s,n++;continue}if(s==='"'&&r){r=!1,t+=s,n++;continue}if(s==="\\"&&r){o=!0,t+=s,n++;continue}if(r){t+=s,n++;continue}if(s==="/"&&a==="/"){while(n<e.length&&e[n]!==`
`)n++;continue}if(s==="/"&&a==="*"){n+=2;while(n<e.length-1){if(e[n]==="*"&&e[n+1]==="/"){n+=2;break}n++}continue}if(s===","){i=t.length,t+=s,n++;continue}if(s==="}"||s==="]"){if(i!==-1){let l=t.slice(i+1);if(/^\s*$/.test(l))t=t.slice(0,i)+l}i=-1,t+=s,n++;continue}if(!/\s/.test(s))i=-1;t+=s,n++}return t}function so(e){if(!e?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(e)}function Xa(e,t){if(!e)return null;let n=e.match(/(\d+)\.(\d+)\.(\d+)/);if(!n)return null;let r=[Number(n[1]),Number(n[2]),Number(n[3])];for(let o=0;o<t.length;o++){let i=r[o]??0,s=t[o]??0;if(i!==s)return i>s}return!0}function Bf(e){return Xa(e,[0,0,422])}function qf(e){return Xa(e,[1,0,8])}function Ut(e){return process.env.COPILOT_HOME||j(e,".copilot")}function ao(e){return(e.hooks?.preToolUse??[]).some((n)=>{if(n.type!=="command")return!1;return so(n.command)||so(n.bash)||so(n.powershell)})}function Tn(e){return e===void 0||typeof e==="string"}function Vf(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e;if(t.disableAllHooks!==void 0&&typeof t.disableAllHooks!=="boolean")return!1;if(t.hooks===void 0)return!0;if(!t.hooks||typeof t.hooks!=="object"||Array.isArray(t.hooks))return!1;let n=t.hooks.preToolUse;if(n===void 0)return!0;return Array.isArray(n)&&n.every((r)=>r!==null&&typeof r==="object"&&!Array.isArray(r)&&Tn(r.type)&&Tn(r.command)&&Tn(r.bash)&&Tn(r.powershell))}function lo(e,t){try{let n=JSON.parse(z(Gf(e,"utf-8")));if(!Vf(n)){t?.push(`Invalid hook config ${e}: hooks.preToolUse must be an array of hook objects`);return}return n}catch(n){t?.push(`Failed to parse ${e}: ${n instanceof Error?n.message:String(n)}`);return}}function Qa(e,t){try{return Uf(e).filter((n)=>n.endsWith(".json")).sort((n,r)=>n.localeCompare(r))}catch(n){return t?.push(`Failed to read ${e}: ${n instanceof Error?n.message:String(n)}`),[]}}function zf(e,t){if(!In(e))return[];let n=[];for(let r of Qa(e,t)){let o=j(e,r),i=lo(o,t);if(i&&ao(i))n.push(o)}return n}function ct(e,t){if(!In(e))return;let n=lo(e,t);if(!n)return;return{path:e,config:n}}function Za(e,t,n,r){if(t){e.push(`GitHub Copilot CLI ${t} does not support ${n}; requires ${r}+`);return}e.push(`GitHub Copilot CLI version unavailable; skipping ${n} because it requires ${r}+`)}function Kf(e){for(let t of e){if(t?.config.disableAllHooks===!0)return t.path;if(t?.config.disableAllHooks===!1)return}return}function Jf(e,t,n,r){let o=Ut(e),i=j(t,".github","hooks"),s=j(o,"hooks"),a=j(t,".github","copilot"),l=j(t,".claude"),c=qf(n),d=c===!0?r:void 0,m=[ct(j(a,"settings.local.json"),d),ct(j(a,"settings.json"),d),ct(j(l,"settings.local.json"),d),ct(j(l,"settings.json"),d)],g=[ct(j(o,"settings.json"),d),ct(j(o,"config.json"),d)];if(c!==!1){let v=Kf([...m,...g]);if(v){if(c===null)r.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${v} as active`);return{activeConfigPaths:[],disabledBy:v}}}let u=zf(i,r),p=Bf(n),f=p===!0?r:void 0,b=In(s)?Qa(s,f):[],L=[];for(let v of b){let R=j(s,v),ee=lo(R,f);if(ee&&ao(ee))L.push(R)}if(p!==!0&&L.length>0)Za(r,n,`user hook files in ${s}`,"0.0.422"),L.length=0;let h=[];for(let v of[...m,...g]){if(!v)continue;if(!ao(v.config))continue;if(c===!0){h.push(v);continue}Za(r,n,"inline hook definitions in Copilot config files","1.0.8");break}let S=(v)=>v.filter((R)=>!!R&&h.includes(R)).map((R)=>R.path);return{activeConfigPaths:[...S(m),...u,...S(g),...L]}}function el(e){let t=[],n=Jf(e.homeDir,e.cwd,e.copilotCliVersion,t);if(n.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:n.disabledBy,configPaths:[n.disabledBy],errors:t.length>0?t:void 0};let r=Ut(e.homeDir),o=j(r,"installed-plugins",...An),i=In(o),s=j(r,"settings.json"),a=ae(s,z);if(i&&a.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(i&&a.kind==="ok"&&k(k(a.value,"enabledPlugins"),le)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:s,errors:[`${le} is installed but not enabled in Copilot CLI`]};if(i||n.activeConfigPaths.length>0){let l=i,c=n.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:l?"plugin config":"hook config",configPath:c??(l?o:void 0),configPaths:n.activeConfigPaths.length>0?n.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as om,readFileSync as im}from"node:fs";import{existsSync as tl,mkdirSync as Zf,readFileSync as Xf}from"node:fs";import{dirname as Qf,join as em}from"node:path";import{renameSync as Wf,writeFileSync as Yf}from"node:fs";function O(e,t){let n=`${e}.${process.pid}.tmp`;Yf(n,t),Wf(n,e)}var Gt="npx -y cc-safety-net hook --cursor",nl=30;function $n(e){return em(e,".cursor","hooks.json")}function Be(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function co(){return{command:Gt,timeout:nl,failClosed:!0}}function _n(e){return Be(e)&&e.command===Gt}function tm(e){return Object.keys(e).length===3&&e.command===Gt&&e.timeout===nl&&e.failClosed===!0}function nm(e){try{return JSON.parse(Xf(e,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${e}: ${t.message}`);throw t}}function rl(e){let t=nm(e);if(!Be(t))throw Error(`Cursor hooks config ${e} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${e} must set "version": 1`);if(t.hooks!==void 0&&!Be(t.hooks))throw Error(`Cursor hooks config ${e} "hooks" must be an object`);let n=Be(t.hooks)?t.hooks.preToolUse:void 0;if(n!==void 0&&!Array.isArray(n))throw Error(`Cursor hooks config ${e} "hooks.preToolUse" must be an array`);return t}function ol(e){let t=Be(e.hooks)?e.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function rm(e){if(!e.some(_n))return[...e,co()];return e.reduce((t,n)=>{if(!_n(n))return t.result.push(n),t;if(!t.inserted)t.result.push(co()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function il(e,t,n){let r=Be(t.hooks)?t.hooks:{},o={...t,hooks:{...r,preToolUse:n}};O(e,`${JSON.stringify(o,null,2)}
`)}function sl(e){let t=$n(e);if(!tl(t))return Zf(Qf(t),{recursive:!0}),O(t,`${JSON.stringify({version:1,hooks:{preToolUse:[co()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let n=rl(t),r=ol(n),o=r.filter(_n);if(Be(n.hooks)&&Array.isArray(n.hooks.preToolUse)&&o.length===1&&o[0]!==void 0&&tm(o[0]))return{path:t,alreadyInstalled:!0};return il(t,n,rm(r)),{path:t,alreadyInstalled:!1}}function al(e){let t=$n(e);if(!tl(t))return{path:t,alreadyInstalled:!1};let n=rl(t),r=ol(n),o=r.filter((i)=>!_n(i));if(o.length===r.length)return{path:t,alreadyInstalled:!1};return il(t,n,o),{path:t,alreadyInstalled:!0}}function sm(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];let t=e.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t.preToolUse;if(!Array.isArray(n))return[];return n.filter((r)=>!!r&&typeof r==="object"&&!Array.isArray(r)&&r.command===Gt)}function am(e){let t=[];if(e.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let n=e[0];if(n&&n.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(n&&n.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function ll(e){let t=$n(e.homeDir);if(!om(t))return{platform:"cursor",status:"n/a",configPath:t};let n;try{n=JSON.parse(im(t,"utf-8"))}catch(i){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=sm(n);if(r.length===0)return{platform:"cursor",status:"n/a",configPath:t};let o=am(r);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{existsSync as lm}from"node:fs";import{join as uo}from"node:path";var po="gemini-safety-net";function fo(e){let t=uo(e,".gemini","extensions"),n=uo(t,po);if(!lm(n))return{platform:"gemini-cli",status:"n/a"};let r=uo(t,"extension-enablement.json"),o=ae(r);if(o.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let i=o.kind==="ok"?k(k(o.value,po),"overrides"):void 0;if(Array.isArray(i)&&i.some((a)=>typeof a==="string"&&a.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:r,errors:[`${po} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:n}}function cl(e){return fo(e.homeDir)}import{existsSync as pm,readFileSync as fm}from"node:fs";import{existsSync as ul,mkdirSync as cm,readFileSync as pl,rmSync as dm}from"node:fs";import{dirname as um,join as dl}from"node:path";var Bt="npx -y cc-safety-net hook --grok-build",Fn=30;function Hn(e){return dl(process.env.GROK_HOME??dl(e,".grok"),"hooks","cc-safety-net.json")}function qe(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function On(){return{hooks:[{type:"command",command:Bt,timeout:Fn}]}}function fl(e){return qe(e)&&e.command===Bt}function ml(e){return e.flatMap((t)=>{if(!qe(t)||!Array.isArray(t.hooks))return[t];let n=t.hooks.filter((r)=>!fl(r));if(n.length===t.hooks.length)return[t];return n.length===0?[]:[{...t,hooks:n}]})}function gl(e){try{let t=JSON.parse(e);return qe(t)?t:null}catch{return null}}function hl(e){let t=qe(e.hooks)?e.hooks.PreToolUse:void 0;return Array.isArray(t)?t:[]}function Nn(e,t,n){let r=qe(t.hooks)?t.hooks:{};O(e,`${JSON.stringify({...t,hooks:{...r,PreToolUse:n}},null,2)}
`)}function yl(e){let t=Hn(e);if(!ul(t))return cm(um(t),{recursive:!0}),Nn(t,{},[On()]),{path:t,alreadyInstalled:!1};let n=gl(pl(t,"utf-8"));if(!n)return Nn(t,{},[On()]),{path:t,alreadyInstalled:!1};let r=hl(n),o=r.filter((i)=>qe(i)&&Array.isArray(i.hooks)&&i.hooks.some(fl));if(o.length===1&&JSON.stringify(o[0])===JSON.stringify(On()))return{path:t,alreadyInstalled:!0};return Nn(t,n,[...ml(r),On()]),{path:t,alreadyInstalled:!1}}function vl(e){let t=Hn(e);if(!ul(t))return{path:t,alreadyInstalled:!1};let n=gl(pl(t,"utf-8"));if(!n)return{path:t,alreadyInstalled:!1};let r=hl(n),o=ml(r);if(JSON.stringify(o)===JSON.stringify(r))return{path:t,alreadyInstalled:!1};let i=qe(n.hooks)?n.hooks:{};if(o.length===0&&Object.keys(n).length===1&&Object.keys(i).length===1)return dm(t),{path:t,alreadyInstalled:!0};return Nn(t,n,o),{path:t,alreadyInstalled:!0}}function qt(e){return!!e&&typeof e==="object"&&!Array.isArray(e)}function mm(e){if(!qt(e)||!qt(e.hooks))return[];let t=e.hooks.PreToolUse;if(!Array.isArray(t))return[];return t.filter((n)=>qt(n)&&Array.isArray(n.hooks)&&n.hooks.some((r)=>qt(r)&&r.command===Bt))}function gm(e){let n=(Array.isArray(e.hooks)?e.hooks.filter(qt):[]).find((r)=>r.command===Bt);return[...e.matcher===void 0||e.matcher===""||e.matcher==="*"?[]:['Managed hook has a "matcher" that narrows coverage; reinstall to repair'],...n?.type==="command"?[]:['Managed hook "type" is not "command"; reinstall to repair'],...n?.timeout===Fn?[]:[`Managed hook "timeout" is not ${Fn}; reinstall to repair`]]}function bl(e){let t=Hn(e.homeDir);if(!pm(t))return{platform:"grok-build",status:"n/a",configPath:t};let n;try{n=JSON.parse(fm(t,"utf-8"))}catch(i){return{platform:"grok-build",status:"n/a",configPath:t,errors:[`Failed to parse Grok Build hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=mm(n)[0];if(!r)return{platform:"grok-build",status:"n/a",configPath:t};let o=gm(r);return{platform:"grok-build",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{readFileSync as Pl}from"node:fs";import{join as Al}from"node:path";var Z="cc-safety-net",Ll="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function wl(e){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${e}
`}function hm(e){return`${wl(e)}name: cc-safety-net
version: "${e}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function ym(e){return`${wl(e)}"""CC Safety Net guard for Hermes Agent.
...
`}function Vt(e){return[{name:"__init__.py",content:ym(e)},{name:"plugin.yaml",content:hm(e)}]}import{mkdirSync as vm,readdirSync as bm,readFileSync as Lm,rmSync as mo}from"node:fs";import{join as Ve}from"node:path";var wm="__pycache__";function go(e){let t=process.env.HERMES_HOME?.trim();return t?t:Ve(e,".hermes")}function ho(e){return Ve(go(e),"plugins",Z)}function yo(e){return e.startsWith(Ll)}function vo(e,t){let n=ho(e),r=T(n);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${n}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return n}function kl(e,t){let n=T(e);if(!n)return;if(n.isSymbolicLink()||!n.isFile())throw Error(`Refusing to ${t} ${e}: not a regular file. Move or remove it.`);let r=Lm(e,"utf-8");if(!yo(r))throw Error(`Refusing to ${t} unmanaged file at ${e}. Move or remove it.`);return r}function xl(e){let t=vo(e,"install"),n=Vt(_());if(n.map((o)=>kl(Ve(t,o.name),"overwrite")).every((o,i)=>o===n[i]?.content))return{path:t,alreadyInstalled:!0};return vm(t,{recursive:!0}),n.forEach((o)=>{O(Ve(t,o.name),o.content)}),{path:t,alreadyInstalled:!1}}function bo(e){let t=vo(e,"remove");if(!T(t))return[];return Vt(_()).filter((n)=>kl(Ve(t,n.name),"remove")!==void 0)}function Cl(e){let t=vo(e,"remove");if(!T(t))return{path:t,alreadyInstalled:!1};let n=bo(e);if(n.forEach((r)=>{mo(Ve(t,r.name))}),mo(Ve(t,wm),{recursive:!0,force:!0}),bm(t).length===0)mo(t,{recursive:!0});return{path:t,alreadyInstalled:n.length>0}}var Mn="hermes-agent",Sl=/^([^\s#][^:]*):/,km=/^\s+([A-Za-z_][\w-]*):/,Rl=/^\s+-\s*(.*)$/;function xm(e){return e.trim().replace(/^(["'])(.*)\1$/,"$2")}function Cm(e){let t=e.split(/\r?\n/),n=t.findIndex((i)=>Sl.exec(i)?.[1]?.trim()==="plugins");if(n===-1)return[];let r=t.slice(n+1),o=r.findIndex((i)=>Sl.test(i));return o===-1?r:r.slice(0,o)}function Dl(e,t){let n=Cm(e),r=n.findIndex((s)=>km.exec(s)?.[1]===t);if(r===-1)return[];let o=n.slice(r+1),i=o.findIndex((s)=>!Rl.test(s));return(i===-1?o:o.slice(0,i)).map((s)=>xm(Rl.exec(s)?.[1]??""))}function Sm(e){try{return Pl(Al(go(e),"config.yaml"),"utf-8")}catch{return}}function Lo(e){let t=Sm(e)??"";return Dl(t,"enabled").includes(Z)&&!Dl(t,"disabled").includes(Z)}function El(e){return/^# version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function Rm(e,t){let n=T(e);if(!n)return{error:`${t.name} is missing from ${e}; run install --hermes-agent`};if(n.isSymbolicLink()||!n.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{let r=Pl(e,"utf-8");if(!yo(r))return{error:`Unmanaged ${t.name} occupies ${e}; move or remove it`};if(El(r)===_()&&r!==t.content)return{error:`Modified ${t.name} occupies ${e}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${e}: ${r instanceof Error?r.message:String(r)}`}}}function Tl(e){let t=ho(e.homeDir),n=Dn(Mn,t);if(n)return n;let r=Vt(_()).map((a)=>Rm(Al(t,a.name),a)),o=r.flatMap((a)=>("error"in a)?[a.error]:[]);if(o.length>0)return{platform:Mn,status:"n/a",configPath:t,errors:o};let i=r.some((a)=>("content"in a)&&El(a.content)!==_()),s=i?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!Lo(e.homeDir))return{platform:Mn,status:"disabled",method:"plugin directory",configPath:t,errors:[`${Z} is not enabled in Hermes; run \`hermes plugins enable ${Z}\``,...s]};return{platform:Mn,status:"configured",method:"plugin directory",configPath:t,errors:i?s:void 0}}import{existsSync as Dm,readFileSync as Pm}from"node:fs";import{join as Il}from"node:path";var Am=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function Em(e){return Il(process.env.KIMI_CODE_HOME||Il(e,".kimi-code"),"config.toml")}function zt(e){let t=Em(e.homeDir);if(!Dm(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!Am.test(Pm(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(n){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${n instanceof Error?n.message:String(n)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as Gl}from"node:fs";import{join as Jt}from"node:path";var A="cc-safety-net",X="index.js",dt="openclaw.plugin.json",ut="package.json";var jn="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as _m,lstatSync as $m,readdirSync as Om,readFileSync as Nm}from"node:fs";import{dirname as Ol,join as Ee}from"node:path";import{fileURLToPath as Fm}from"node:url";import{spawn as Tm}from"node:child_process";function Im(e){return e.join(" ")}function wo(e,t,n){return[`Failed to run ${Im(e)}${t===null?"":` (exit ${t})`}.`,n.trim()].filter(Boolean).join(`
`)}function ko(e){let t={stdout:"",stderr:""};return e.stdout.setEncoding("utf-8"),e.stderr.setEncoding("utf-8"),e.stdout.on("data",(n)=>{t.stdout+=n}),e.stderr.on("data",(n)=>{t.stderr+=n}),t}function ce(e,t){return new Promise((n,r)=>{let o=Ge([...e],process.env),i=Tm(o.cmd,o.args,{stdio:["ignore","pipe","pipe"]}),s=ko(i),a=()=>[s.stdout,s.stderr].filter(Boolean).join(`
...
${a()}`.trim())))}),i.on("close",(d)=>{if(clearTimeout(c),d!==0){r(Error(wo(e,d,a())));return}n(t?.stdoutOnly?s.stdout:a())})})}async function xo(e){for(let t of e)await ce(t)}async function _l(e){for(let t of e)try{await ce(t)}catch(n){console.warn(n instanceof Error?n.message:String(n))}}var $l=Ee("openclaw",A),Hm=[X,dt,ut];function Co(e,t){if(e==="~")return t;if(e.startsWith("~/")||e.startsWith("~\\"))return Ee(t,e.slice(2));return e}function Nl(e){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return Co(t,e);let n=process.env.OPENCLAW_CONFIG_PATH?.trim();return n?Ol(Co(n,e)):Ee(e,".openclaw")}function Fl(e){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?Co(t,e):Ee(Nl(e),"openclaw.json")}function So(e){return Ee(Nl(e),"extensions",A)}function Mm(e){let t=Om(e);if(t.length===0)return!0;if(t.some((o)=>!Hm.includes(o)))return!1;let n=Ee(e,X),r=T(n);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&Nm(n,"utf-8").startsWith(jn)}function Ro(e){let t=So(e),n=T(t);if(!n)return;if(!n.isSymbolicLink()&&n.isDirectory()&&Mm(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function Hl(){let e=Ol(Fm(import.meta.url));return[Ee(e,"..",$l),Ee(e,"..","..","..","dist",$l)]}function Do(e=Hl()){return e.find((t)=>_m(t)&&$m(t).isDirectory())}function jm(e=Hl()){let t=Do(e);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function Ml(e=jm()){return[["openclaw","plugins","install",e,"--force"],["openclaw","plugins","enable",A]]}function Um(e){let t=(()=>{try{return JSON.parse(e)}catch{return}})(),n=k(k(t,"plugin"),"status");return typeof n==="string"?n:void 0}async function jl(){let e=Um(await ce(["openclaw","plugins","inspect",A,"--runtime","--json"],{stdoutOnly:!0}));if(e==="loaded")return;throw Error(`${e===void 0?`The ${A} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${A} plugin with status "${e}".`} Run \`openclaw plugins inspect ${A} --runtime\` for details.`)}var Un="openclaw",Kt=`run \`openclaw plugins enable ${A}\``;function pt(e,t){let n=Jt(e,t),r=T(n);if(!r)return{error:`${t} is missing from ${n}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{return{content:Gl(n,"utf-8")}}catch(o){return{error:`Failed to read ${n}: ${o instanceof Error?o.message:String(o)}`}}}function Bl(e){try{return JSON.parse(z(e))}catch{return}}function Gm(e){let t=pt(e,dt);if("error"in t)return t.error;if(k(Bl(t.content),"id")===A)return;return`${Jt(e,dt)} is not a valid ${A} manifest; run install --openclaw`}function Bm(e){let t=pt(e,ut);if("error"in t)return t.error;let n=k(k(Bl(t.content),"openclaw"),"extensions");if(Array.isArray(n)&&n.includes(`./${X}`))return;return`${Jt(e,ut)} does not point OpenClaw at ${X}; run install --openclaw`}function Ul(e){return Array.isArray(e)?e.filter((t)=>typeof t==="string"):[]}function qm(e){let t=Fl(e);if(!T(t))return`${A} is not enabled; ${Kt}`;let n=(()=>{try{return JSON.parse(z(Gl(t,"utf-8")))}catch{return}})();if(n===void 0)return`Failed to read ${t}; fix it, then ${Kt}`;let r=k(n,"plugins");if(k(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let o=k(k(k(r,"entries"),A),"enabled");if(Ul(k(r,"deny")).includes(A)||o===!1)return`${A} is disabled in ${t}; ${Kt}`;let i=Ul(k(r,"allow"));if(i.length>0&&!i.includes(A))return`plugins.allow in ${t} does not list ${A}; add it, then ${Kt}`;if(i.includes(A)||o===!0)return;return`${A} is not enabled; ${Kt}`}function ql(e){return/^\/\/ version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function Vm(e,t,n){if(n===void 0)return[];let r=pt(n,X);if("error"in r||ql(r.content)!==t)return[];return[X,dt,ut].flatMap((o)=>{let i=pt(e,o),s=pt(n,o);if("error"in i||"error"in s||i.content===s.content)return[];return[`Modified ${o} occupies ${Jt(e,o)}; run install --openclaw to restore it`]})}function Vl(e){let t=So(e.homeDir),n=Dn(Un,t);if(n)return n;let r=pt(t,X),i=["error"in r?r.error:r.content.startsWith(jn)?void 0:`Unmanaged ${X} occupies ${Jt(t,X)}; move or remove it`,Gm(t),Bm(t)].filter((d)=>d!==void 0),s="content"in r?ql(r.content):void 0,a=i.length>0?i:Vm(t,s,Do());if(a.length>0)return{platform:Un,status:"n/a",configPath:t,errors:a};let l=s===_()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],c=qm(e.homeDir);if(c)return{platform:Un,status:"disabled",method:"plugin directory",configPath:t,errors:[c,...l]};return{platform:Un,status:"configured",method:"plugin directory",configPath:t,errors:l.length>0?l:void 0}}import{existsSync as ng,readFileSync as rg}from"node:fs";import{join as og}from"node:path";import{existsSync as Po,readFileSync as Yl,rmSync as Km}from"node:fs";import{join as be}from"node:path";import{pathToFileURL as Jm}from"node:url";function zl(e){return e!==void 0&&/\s/.test(e)}function zm(e,t,n){let r=t+1,o=!1;while(r<e.length){let i=e[r];if(o){o=!1,r++;continue}if(i==="\\"){o=!0,r++;continue}if(i==='"')return r+1;r++}throw Error(n)}function Gn(e,t,n){let r=e[t],o=r==="["?"]":"}",i=0,s=t;while(s<e.length){let a=n.skipComment?.(e,s)??s;if(a!==s){s=a;continue}if(e[s]==='"'){s=zm(e,s,n.stringError);continue}if(e[s]===r)i++;if(e[s]===o){if(i--,i===0)return s}s++}throw Error(n.bracketError)}function Kl(e,t){let n=e.lastIndexOf(`
...
`),o=a.split(`
`).length};return new Promise((a)=>{let l=(d)=>{t.off("keypress",c),t.setRawMode(r),t.pause(),i(),a(d)};function c(d,m){e.onKey(d,m,{finish:l,draw:s})}t.on("keypress",c),s()})}function Dc(e={}){let t=0;return Rc({input:e.input??process.stdin,output:e.output??process.stdout,render:()=>Eg(t,e.globalHookInstalled===!0),onKey:(n,r,o)=>{if(r.ctrl&&r.name==="c"){o.finish(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(r.name==="escape"||n==="q")return o.finish(null);if(r.name==="return"||r.name==="enter")return o.finish(Lc[t]);if(r.name==="up"||r.name==="down"||n==="k"||n==="j")t=(t+1)%Lc.length,o.draw()}})}function Ho(e=process.stdin,t=process.stdout){return Boolean(e.isTTY&&t.isTTY&&typeof e.setRawMode==="function")}function Pc(e,t,n={}){let r=n.output??process.stdout,o=Dg(t);return Rc({input:n.input??process.stdin,output:r,render:()=>Ag(e,t,o),onKey:(i,s,a)=>{let l=Rg(e,i,s);if(!l)return;let c=Pg(o,t,l);if(o=c.state,c.done==="interrupt"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(c.done==="abort")return a.finish(null);if(c.done==="update")return a.finish("update");if(c.done==="confirm"){if(o.selected.length===0){r.write("\x07"),a.draw();return}a.finish([...o.selected]),r.write(`${xg(e)} selected integrations...
`);return}a.draw()}})}import{existsSync as Ec,lstatSync as Ig,mkdirSync as _g,mkdtempSync as $g,readdirSync as Og,readFileSync as ht,rmSync as Jn}from"node:fs";import{tmpdir as Ng}from"node:os";import{basename as Fg,dirname as Hg,join as G}from"node:path";import{fileURLToPath as Mg}from"node:url";var Mo="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp",Ke="cc-safety-net",Je="cc-safety-net/index.ts";import{spawn as Tg}from"node:child_process";var jo=(e,t)=>{let n=Ge([...e],process.env);return new Promise((r)=>{let o=Tg(n.cmd,n.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),i=ko(o),s=!1,a=setTimeout(()=>{s=!0,o.kill()},120000);o.on("error",(l)=>{clearTimeout(a),r({status:null,errorCode:l.code,stdout:i.stdout,stderr:[l.message,i.stderr].filter(Boolean).join(`
`)})}),o.on("close",(l)=>{clearTimeout(a),r({status:s?null:l,errorCode:s?"ETIMEDOUT":void 0,stdout:i.stdout,stderr:i.stderr})})})};var gt="cc-safety-net.ts",Ac=G("amp",Je);function jg(e){return G(e,".config","amp","plugins","cc-safety-net.ts")}function Ug(){let e=Hg(Mg(import.meta.url));return[G(e,"..",Ac),G(e,"..","..","..","dist",Ac)]}function Gg(e=Ug()){let t=e.find((n)=>Ec(n)&&Ig(n).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function Tc(e){try{return JSON.parse(e)}catch{return}}function Wn(e){return e.subarray(0,Buffer.byteLength(Mo)).toString("utf-8")===Mo}async function Zt(e,t,n){let r=await e(t,n);if(r.status===0)return r;throw Error([`Failed to run ${t.join(" ")}${r.status===null?"":` (exit ${r.status})`}.`,[r.stdout,r.stderr].filter(Boolean).join(`
...
`)}`.trim());let n=Tc(t.stdout),r=(Array.isArray(n)?n:[]).filter((o)=>k(o,"scope")==="user"&&k(o,"exists")===!0&&k(o,"viewerCanWrite")===!0).map((o)=>k(o,"cloneRef")).find((o)=>typeof o==="string"&&o.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}async function _c(e,t){let n=$g(G(Ng(),"cc-safety-net-amp-"));try{return await Zt(e,["amp","clone","user-plugins",n]),await t(n)}finally{Jn(n,{recursive:!0,force:!0})}}function Uo(e){return`rerun ${e==="overwrite"?"install":"uninstall"} --amp`}function $c(e,t,n){let r=G(e,t),o=T(r);if(!o)return;if(o.isSymbolicLink()||!o.isFile())throw Error(`Refusing to ${n} ${t} in your Amp personal plugins repository: not a regular file. Remove it there and ${Uo(n)}.`);let i=ht(r);if(Wn(i))return i;throw Error(`Refusing to ${n} unmanaged file ${t} in your Amp personal plugins repository. Remove it there and ${Uo(n)}.`)}function Oc(e,t){let n=G(e,Ke),r=T(n);if(!r)return;if(r.isSymbolicLink()||!r.isDirectory())throw Error(`Refusing to ${t} ${Ke} in your Amp personal plugins repository: not a regular directory. Remove it there and ${Uo(t)}.`);return $c(e,Je,t)}function Bg(e){let t=G(e,gt),n=T(t);if(!n||n.isSymbolicLink()||!n.isFile())return;let r=ht(t);return Wn(r)?r:void 0}async function Nc(e,t,n,r){if(await Zt(e,n,t),(await Zt(e,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await Zt(e,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",r],t),await Zt(e,["git","push","origin","HEAD"],t),!0}function Kn(e,t){qg(e,t),Vg(e,t)}function Fc(e,t){if(t==="keep")return;throw Error(`Local Amp plugin ${e} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function qg(e,t){let n=jg(e),r=T(n);if(!r)return;if(!r.isSymbolicLink()&&r.isFile()&&Wn(ht(n))){Jn(n);return}Fc(n,t)}function Vg(e,t){let n=G(e,".config","amp","plugins",Ke),r=T(n);if(!r)return;if(!r.isSymbolicLink()&&r.isDirectory()&&zg(n)){Jn(n,{recursive:!0});return}Fc(n,t)}function zg(e){let t=Fg(Je);if(Og(e).join("\x00")!==t)return!1;let n=G(e,t),r=T(n);return!!r&&!r.isSymbolicLink()&&r.isFile()&&Wn(ht(n))}function Kg(){let e=Pe();if(!Ec(e))return"";let t=Tc(ht(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(we(t))};
`}async function Hc(e,t=Gg(),n=jo){let r=Buffer.concat([ht(t),Buffer.from(Kg(),"utf-8")]),o=await Ic(n);return _c(n,async(i)=>{let s=`${o}/${Ke}`,a=Oc(i,"overwrite"),l=$c(i,gt,"overwrite");if(a?.equals(r)&&!l)return Kn(e,"fail"),{path:s,alreadyInstalled:!0};if(_g(G(i,Ke),{recursive:!0}),O(G(i,Je),r),l)Jn(G(i,gt));let c=await Nc(n,i,["git","add","--",Je,...l?[gt]:[]],`chore: update cc-safety-net plugin to v${_()}`);return Kn(e,"fail"),{path:s,alreadyInstalled:!c}})}async function Mc(e,t=jo){let n=await Ic(t);return _c(t,async(r)=>{let o=Oc(r,"remove"),i=Bg(r),s=`${n}/${i&&!o?gt:Ke}`;if(!o&&!i)return Kn(e,"keep"),{path:s,alreadyInstalled:!1};return await Nc(t,r,["git","rm","--",...o?[Je]:[],...i?[gt]:[]],`chore: remove cc-safety-net plugin v${_()}`),Kn(e,"keep"),{path:s,alreadyInstalled:!0}})}import{existsSync as jc,mkdirSync as Jg,readFileSync as Wg}from"node:fs";import{dirname as Yg}from"node:path";var Go="npx -y cc-safety-net hook --agy-cli",We="cc-safety-net";function Ye(e){return Boolean(e)&&typeof e==="object"&&!Array.isArray(e)}function Zn(){return{PreToolUse:[{hooks:[{type:"command",command:Go,timeout:30}]}]}}function Uc(e){try{let t=JSON.parse(Wg(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${e}: ${t.message}`);throw t}}function Gc(e){let t=e[We];if(t===void 0){let r=Zn();return e[We]=r,{definition:r,preToolUse:r.PreToolUse??[]}}if(!Ye(t))throw Error(`Antigravity hooks config entry "${We}" must be an object`);let n=Array.isArray(t.PreToolUse)?t.PreToolUse:[];return t.PreToolUse=n,{definition:t,preToolUse:n}}function Bc(e){if(!Array.isArray(e.PreToolUse))return!1;return e.PreToolUse.some((t)=>Ye(t)&&Array.isArray(t.hooks)&&t.hooks.some((n)=>Ye(n)&&n.command===Go))}function Zg(e){return Object.values(e).some((t)=>Ye(t)&&t.enabled!==!1&&Bc(t))}function Xg(e){if(e[We]===void 0)return!1;let t=Gc(e);if(t.definition.enabled!==!1||!Bc(t.definition))return!1;return t.definition.enabled=!0,!0}function Qg(e){if(e[We]===void 0){e[We]=Zn();return}let t=Gc(e);t.definition.enabled=!0,t.preToolUse.push(Zn().PreToolUse?.[0]??{hooks:[]})}function e1(e){let t=!1;for(let n of Object.values(e)){if(!Ye(n)||!Array.isArray(n.PreToolUse))continue;n.PreToolUse=n.PreToolUse.flatMap((r)=>{if(!Ye(r)||!Array.isArray(r.hooks))return[r];let o=r.hooks.filter((i)=>!Ye(i)||i.command!==Go);if(o.length!==r.hooks.length)t=!0;return o.length===0?[]:[{...r,hooks:o}]})}return t}function Yn(e,t){O(e,`${JSON.stringify(t,null,2)}
`)}function qc(e){let t=Ot(e);if(Jg(Yg(t),{recursive:!0}),!jc(t))return Yn(t,{[We]:Zn()}),{path:t,alreadyInstalled:!1};let n=Uc(t);if(Zg(n))return{path:t,alreadyInstalled:!0};if(Xg(n))return Yn(t,n),{path:t,alreadyInstalled:!1};return Qg(n),Yn(t,n),{path:t,alreadyInstalled:!1}}function Vc(e){let t=Ot(e);if(!jc(t))return{path:t,alreadyInstalled:!1};let n=Uc(t);if(!e1(n))return{path:t,alreadyInstalled:!1};return Yn(t,n),{path:t,alreadyInstalled:!0}}import{existsSync as t1,readdirSync as n1,rmSync as r1}from"node:fs";import{join as o1}from"node:path";function zc(e,t=process.platform,n){if(!t1(e))return;let r=t==="win32"?/^bunx-\d+-cc-safety-net@/:new RegExp(`^bunx-${process.getuid?.()??0}-cc-safety-net@`);n1(e).filter((o)=>o!==n&&r.test(o)).forEach((o)=>{r1(o1(e,o),{recursive:!0,force:!0})})}import{spawn as i1}from"node:child_process";var de=Y.map((e)=>({target:e.id,flag:e.flag,label:P(e.id),probeCommand:e.probeCommand}));function Bo(e){let t=new Set(e);return de.map((n)=>n.target).filter((n)=>t.has(n))}async function Kc(e,t){for(let n of e)await t(n)}var s1=5000;function qo(e){return new Promise((t)=>{let n=Ge([...e],process.env),r=i1(n.cmd,n.args,{env:process.env,stdio:"ignore"}),o=!1,i=(a)=>{if(o)return;o=!0,clearTimeout(s),t(a)},s=setTimeout(()=>{r.kill(),i(!1)},s1);r.on("error",()=>i(!1)),r.on("close",(a)=>i(a===0))})}function Jc(e=qo,t={}){let n=new Set(t.configuredTargets??[]);return Promise.all(de.map(async(r)=>({target:r.target,flag:r.flag,label:r.label,...Yc(t.action,await e(r.probeCommand),n.has(r.target))})))}function Wc(e,t){let n=new Set(t.configuredTargets??[]);return e.map((r)=>({...r,...Yc(t.action,r.available,n.has(r.target))}))}function Yc(e,t,n){if(e==="uninstall")return n?{available:!0}:{available:!1,unavailableReason:"not installed"};if(e==="install"&&n)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as Zc,readdirSync as a1,rmSync as l1}from"node:fs";import{join as yt}from"node:path";function Xn(e,t=process.platform){let n=yt(process.env.npm_config_cache||(t==="win32"?yt(process.env.LOCALAPPDATA||yt(e,"AppData","Local"),"npm-cache"):yt(e,".npm")),"_npx");if(!Zc(n))return;a1(n).filter((r)=>Zc(yt(n,r,"node_modules","cc-safety-net"))).forEach((r)=>{l1(yt(n,r),{recursive:!0,force:!0})})}import{existsSync as Qc,mkdirSync as c1,readFileSync as ed}from"node:fs";import{dirname as d1,join as Xc}from"node:path";var Xt="npx -y cc-safety-net hook --kimi-code",Vo=`[[hooks]]
event = "PreToolUse"
command = "${Xt}"`,zo=`{ event = "PreToolUse", command = "${Xt}" }`;function td(e){return Xc(process.env.KIMI_CODE_HOME??Xc(e,".kimi-code"),"config.toml")}function u1(e){return e.split(`
...
`);function A1(e){if(zt({homeDir:e,cwd:process.cwd()}).status!=="configured")return ld;return[ld,"",y.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function cd(e,t){return t.map((n)=>e==="install"&&n.target==="kimi-code"&&n.unavailableReason==="already installed"?{...n,available:!0,unavailableReason:void 0,label:`${n.label} (global hook installed)`}:n)}function E1(e,t){if(e.selectKimiInstallMethod)return e.selectKimiInstallMethod();if(!Ho(e.input,e.output))return Promise.resolve("global-hook");return Dc({input:e.input,output:e.output,globalHookInstalled:zt({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function gd(e,t,n,r=!1,o){return P1[t][e](n,r,o)}function T1(e){let t=E({label:"update"},e).errors[0];if(t)throw Error(t)}async function I1(e,t=at){let n=await md(e,t),r=Ko(Ut(e),"installed-plugins");return{targets:Bo([...n.hooks.filter((i)=>i.platform!=="copilot-cli"&&i.detected).map((i)=>i.platform),...[An,Va,qa].flatMap((i)=>Wo(Ko(r,...i))?["copilot-cli"]:[]),...Pn(e,Jo)?["claude-code"]:[],...Yo(n.codexPluginListOutput)?["codex"]:[]]),codexPluginListOutput:n.codexPluginListOutput}}async function _1(e){let t=er(),n=e.output??process.stdout,r=(e.scriptPath??process.argv[1]??"").split(/[\\/]/),o=r.find((u)=>/^bunx-\d+-/.test(u)),i=o!==void 0||r.includes("_npx")?null:(e.checkLatestVersion??Ae)(),s=async()=>{let u=i&&await i;if(u?.updateAvailable)n.write(`
...
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,qd=[{binary:"zenity",args:["--file-selection","--directory",`--title=${sr}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",sr]}],Vd=(e,t)=>(t.PATH??"").split(qh).some((n)=>{if(n.length===0)return!1;try{let r=Bd(Vh(n,e));return r.isFile()&&(r.mode&73)!==0}catch{return!1}});function zd(e,t){if(e==="darwin"||e==="win32")return!0;if(e!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return qd.some((n)=>Vd(n.binary,t))}function Wh(e,t){if(e==="darwin")return{cmd:"osascript",args:["-e",Kh]};if(e==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",Jh]};let n=qd.find((r)=>Vd(r.binary,t));return n?{cmd:n.binary,args:n.args}:null}function Kd(e=process.platform,t=process.env){let n=Wh(e,t);if(!n)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let o=Gh(n.cmd,n.args,{env:t,stdio:["ignore","pipe","pipe"]}),i="",s=!1,a=(c)=>{if(s)return;s=!0,clearTimeout(l),r(c)},l=setTimeout(()=>{o.kill(),a({error:"The folder dialog timed out"})},zh);o.stdout.on("data",(c)=>{i+=c.toString()}),o.on("error",()=>a({error:`Could not open the folder dialog (${n.cmd})`})),o.on("close",()=>{let c=i.trim().replace(/\/+$/,"");if(!c)return a({cancelled:!0});if(!Bh(c)||!Bd(c).isDirectory())return a({error:"That selection is not a folder on disk"});a({path:c})})})}var Jd=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var Wd='<script id="ccsn-data" type="application/json">';function Yd(e){return Jd.replace(Wd,()=>Wd+JSON.stringify({token:e}).replaceAll("<","\\u003c"))}var lr="kenryu42/cc-safety-net",Qh=`https://github.com/${lr}`,ii=1e4,e0=7;async function au(e,t={}){let n=E({label:"gui",booleans:{noOpen:["--no-open"]}},e),r=t.log??console.log,o=t.error??console.error;if(n.errors.length>0){for(let s of n.errors)o(s);return o("Usage: cc-safety-net gui [--no-open]"),1}let i=await t0(t);if(r(`CC Safety Net policy GUI: ${i.url}`),!n.flags.noOpen)try{await(t.openBrowser??d0)(i.url)}catch(s){o(`Failed to open browser: ${s instanceof Error?s.message:String(s)}`),o(`Open this URL manually: ${i.url}`)}if(t.keepAlive===!1)return await i.close(),0;return await c0(i),0}async function t0(e={}){let t=Yh(24).toString("base64url"),n=Zh((i,s)=>{n0(i,s,t,e)});await new Promise((i,s)=>{n.once("error",s),n.listen(0,"127.0.0.1",()=>{n.off("error",s),i()})});let o=`http://127.0.0.1:${n.address().port}`;return{origin:o,token:t,url:`${o}/?token=${encodeURIComponent(t)}`,close:()=>l0(n)}}async function n0(e,t,n,r){let o=new URL(e.url??"/","http://127.0.0.1");if(e.method==="GET"&&o.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!i0(e,o,n)){D(t,403,{error:"Forbidden"});return}if(e.method==="GET"&&o.pathname==="/"){a0(t,Yd(n));return}if(e.method==="GET"&&o.pathname==="/api/policy"){let i=eu(r),s=V(r);D(t,200,{...i,configState:It(s),...s.policyScopes?{projectPolicy:{path:Ne(r.cwd),weakenings:s.policyScopes.weakenings}}:{},destructiveCommandRules:Pt,secretPatterns:Xd,version:_(),preview:i.errors.length>0?null:nu(i.policy)});return}if(e.method==="POST"&&o.pathname==="/api/policy/preview"){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=tu(i.value);D(t,s.errors.length>0?400:200,s);return}if(e.method==="POST"&&o.pathname==="/api/policy/explain"){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=i.value;if(s===null||typeof s.command!=="string"){D(t,400,{errors:["command must be a string"]});return}let a=Tt(s.policy);if(a.length>0){D(t,400,{errors:a});return}D(t,200,r0(s.command,s.policy,r));return}if(e.method==="POST"&&o.pathname==="/api/policy"){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=tn(i.value,r);D(t,s.errors.length>0?400:200,s);return}if(e.method==="POST"&&o.pathname==="/api/reset"){D(t,200,tn(Qd,r));return}if(e.method==="POST"&&o.pathname==="/api/repair"){D(t,200,ru(r));return}if(e.method==="GET"&&o.pathname==="/api/activity"){let i=ot(r),s=o0(o.searchParams.get("days"),i);if(s===null){D(t,400,{error:`days must be an integer between 1 and ${i}`});return}D(t,200,Gd(s,r.activityLogsDir));return}if(e.method==="POST"&&o.pathname==="/api/rules/choose-directory"){D(t,200,await Kd());return}if(e.method==="GET"&&o.pathname==="/api/rules"){let i=Re(r),s=new Map(i.rules.map((a)=>[a.name,a]));D(t,200,{projectPath:r.cwd??process.cwd(),canPickDirectory:zd(process.platform,process.env),rulebooks:i.rulebooks.map((a)=>({source:a.source,spec:a.spec,name:a.name,version:a.version,rules:a.rules.flatMap((l)=>{let c=s.get(l);if(!c)return[];return[{name:c.name,command:c.command,subcommand:c.subcommand,block_args:c.block_args,reason:c.reason}]})})),errors:i.errors,warnings:i.warnings});return}if(e.method==="GET"&&o.pathname==="/api/star/context"){D(t,200,await(r.fetchStarContext??(()=>g0({logsDir:r.activityLogsDir})))());return}if(e.method==="POST"&&o.pathname==="/api/star"){let i=await(r.starRepo??u0)();D(t,200,i.ok?{ok:!0}:{ok:!1,fallbackUrl:Qh});return}if(e.method==="GET"&&o.pathname==="/api/integrations"){D(t,200,await(r.fetchIntegrations??p0)());return}if(e.method==="GET"&&o.pathname==="/api/health"){D(t,200,await(r.fetchHealth??f0)());return}if(e.method==="POST"&&(o.pathname==="/api/install"||o.pathname==="/api/uninstall")){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=i.value?.target;if(typeof s!=="string"||!de.some((l)=>l.target===s)){D(t,400,{error:"unknown target"});return}let a=o.pathname==="/api/install"?"install":"uninstall";D(t,200,await(r.runIntegration??m0)(a,s));return}D(t,404,{error:"Not found"})}function r0(e,t,n){let r=we(t),o=V(n),i=At({rules:o.policy.rules,transparentWrappers:o.policy.transparentWrappers,safety:iu(r.safety),worktreeMode:r.workflow.worktree_mode,destructiveCommandProtectionEnabled:r.destructive_command_protection.enabled,destructiveCommandRuleOverrides:r.destructive_command_protection.overrides,destructiveCommandAllowPaths:r.destructive_command_protection.allow_paths,secretProtection:{enabled:r.secret_protection.enabled,disabledRules:ou(r.secret_protection.overrides),denyPaths:r.secret_protection.deny_paths,allowPaths:r.secret_protection.allow_paths}});return rt(e,{policySnapshot:i,cwd:n.cwd,userConfigDir:n.userConfigDir})}function o0(e,t){if(e===null)return Math.min(e0,t);let n=Number(e);if(!Number.isInteger(n)||n<1||n>t)return null;return n}function i0(e,t,n){if(t.searchParams.get("token")!==n)return!1;if(e.method!=="POST")return!0;return e.headers["x-cc-safety-net-token"]===n}var s0=1048576;async function ar(e){let t=[],n=0;for await(let r of e){let o=r;if(n+=o.byteLength,n>s0)return{ok:!1,status:413,error:"Request body is too large"};t.push(o)}try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(r){return{ok:!1,status:400,error:`Invalid JSON: ${r instanceof Error?r.message:String(r)}`}}}function a0(e,t){e.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),e.end(t)}function D(e,t,n){e.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),e.end(JSON.stringify(n))}function l0(e){return new Promise((t,n)=>{e.close((r)=>r?n(r):t())})}function c0(e){return new Promise((t)=>{let n=()=>{process.off("SIGINT",r),process.off("SIGTERM",r)},r=()=>{n(),e.close().then(t)};process.once("SIGINT",r),process.once("SIGTERM",r)})}function d0(e){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",n=process.platform==="win32"?["/c","start","",e]:[e];return new Promise((r,o)=>{let i=su(t,n,{detached:!0,stdio:"ignore"}),s=(l)=>{i.off("spawn",a),o(l)},a=()=>{i.off("error",s),i.unref(),r()};i.once("error",s),i.once("spawn",a)})}async function u0(e="gh",t=ii){return{ok:await oi(e,["api","-X","PUT",`/user/starred/${lr}`],t)===0}}async function p0(e={}){let t=await Ft(e.fetcher),n=lu(t,e.homeDir);return{targets:Y.map((r)=>{let o=n.find((i)=>i.platform===r.id);return{target:r.id,label:P(r.id),version:t.versions[r.id]??null,status:o?.configured?"active":o?.detected?"disabled":o?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function lu(e,t){return ft(process.cwd(),{homeDir:t,ampPluginListOutput:e.ampPluginListOutput,codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.versions["copilot-cli"]})}async function f0(e={}){let[t,n]=await Promise.all([Ft(e.fetcher),(e.checkUpdates??Ae)()]);return{hooks:lu(t,e.homeDir).filter((r)=>r.detected).map((r)=>({platform:r.platform,label:P(r.platform),configured:r.configured})),update:{currentVersion:n.currentVersion,latestVersion:n.latestVersion??null,updateAvailable:n.updateAvailable}}}var Zd=Promise.resolve();function m0(e,t,n={}){let r=async()=>{let i=[],s=console.log,a=console.error;console.log=(...l)=>i.push(l.map(String).join(" ")),console.error=console.log;try{return{ok:await en(e,[],{selectTargets:async()=>[t],output:new Xh({write(c,d,m){i.push(String(c).replace(/\n$/,"")),m()}}),...n})===0,output:i.join(`
`)}}finally{console.log=s,console.error=a}},o=Zd.then(r);return Zd=o.then(()=>{return},()=>{return}),o}async function g0(e={}){let[t,n,r]=await Promise.all([h0(e.command),y0(e.fetchRepo),Promise.resolve(bn(ot(),e.logsDir).totalBlocked)]);return{starred:t,starCount:n,blockedTotal:r}}async function h0(e="gh",t=ii){if(await oi(e,["auth","status"],t)!==0)return null;let n=await oi(e,["api",`/user/starred/${lr}`],t);if(n===0)return!0;if(n===null)return null;return!1}function oi(e,t,n){return new Promise((r)=>{let o=su(e,t,{stdio:"ignore",windowsHide:!0}),i=!1,s,a=(l)=>{if(i)return;if(i=!0,s)clearTimeout(s);r(l)};o.once("error",()=>a(null)),o.once("close",a),s=setTimeout(()=>{o.kill(),a(null)},n)})}async function y0(e=fetch){try{let t=await e(`https://api.github.com/repos/${lr}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(ii)});if(!t.ok)return null;let n=await t.json();return typeof n.stargazers_count==="number"?n.stargazers_count:null}catch{return null}}function v0(e){if(e[0]!=="help")return!1;let t=e[1];if(!t)Fo(),process.exit(0);if(Yt(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var b0={hook:async(e)=>{let t=qs(e);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),Yt("hook",console.error),process.exit(1)},install:async(e)=>{process.exit(await en("install",e))},update:async(e)=>{process.exit(await Zo(e))},uninstall:async(e)=>{process.exit(await en("uninstall",e))},rule:async(e)=>{process.exit(await jd(e))},policy:async(e)=>{process.exit(await Ld(e))},status:async(e)=>{if(ue(E({label:"status"},e).errors))process.exit(1);Ud()},statusline:async(e)=>{let t=E({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},e);if(t.errors.length===0&&t.flags.claudeCode){await ni();return}if(ue(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");Yt("statusline",console.error),process.exit(1)},doctor:async(e)=>{let t=Io(e);if(!t)process.exit(1);let n=await lc({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(n)},logs:async(e)=>{process.exit(await ps(e))},gui:async(e)=>{process.exit(await au(e))},explain:async(e)=>{process.exit(await gc(e))}};async function L0(){let e=process.argv.slice(2),t=E({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},e);if(v0(e))return;let n=e[0],r=n?vn(n):void 0;if(t.help&&r&&r.name!=="rule")Yt(r.name),process.exit(0);if(!n||t.help&&!r)Fo(),process.exit(0);if(t.flags.version)vc(),process.exit(0);if(r){await b0[r.name](e.slice(1));return}let o=Vs(n);if(o){await o.run();return}if(n==="--statusline"){await ni();return}console.error(n.startsWith("-")?`Unknown option: ${n}`:`Unknown command: ${n}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}L0().catch((e)=>{console.error("CC Safety Net error:",e),process.exit(1)});
