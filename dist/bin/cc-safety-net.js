#!/usr/bin/env node
import{$ as _t,$a as Wr,A as cn,Aa as qr,B as Hl,Ba as Ot,C as P,Ca as jr,D as U,Da as Fr,E as Ht,Ea as O,F as Ft,Fa as St,G as Zn,Ga as At,H as zt,Ha as Wt,I as V2,Ia as T,J as w2,Ja as id,K as Mt,Ka as Tt,L as s2,La as cd,M as ca,Ma as Lr,N as Et,Na as Ld,O as Qn,Oa as od,P as La,Pa as pd,Q as oa,Qa as ud,R as Yn,Ra as vd,S as Rn,Sa as bd,T as vn,Ta as _r,U as bn,Ua as Pr,V as Vr,Va as Ir,W as Ln,Wa as Nr,X as x2,Xa as Kl,Y as Kt,Ya as Hr,Z as C2,Za as Ar,_ as pa,_a as Zt,aa as ba,ab as Mr,b as br,ba as fa,bb as u2,c as fr,ca as Cr,cb as h2,d as H,da as $r,db as l2,e as yr,ea as Gr,eb as Kr,f as Dt,fa as Ur,fb as A,g as S,ga as Or,gb as un,h as g,ha as Vt,hb as on,i as ln,ia as mr,ib as va,j as m,ja as D,jb as fn,k as y2,ka as Ct,kb as i2,l as Sr,la as ua,lb as Da,m as R2,ma as d2,mb as Xn,n as dn,na as pn,o as Ol,oa as Gt,p as jt,pa as Ut,q as Zr,qa as Tr,r as sn,ra as Er,s as Qr,sa as gr,t as Rt,ta as M2,u as Xr,ua as Bt,v as Yr,va as Jt,w as E,wa as Rr,x as _,xa as X2,y as A2,ya as sd,z as W2,za as kr}from"../chunks/index-mf3j7fqk.js";var $d=["-h","--help"];function F(n,t){let e=Object.entries(n.booleans??{}),r=Object.entries(n.values??{}),a=Object.fromEntries(e.map(([L])=>[L,!1])),l={},d=[],s=[],i=!1,c=-1;for(let[L,p]of t.entries()){if(L<=c)continue;if(p==="--"){d.push(...t.slice(L+1));break}if($d.includes(p)){i=!0;continue}let u=e.find(([,b])=>b.includes(p));if(u){a[u[0]]=!0;continue}let o=r.find(([,b])=>b.includes(p));if(o){let b=t[L+1];if(b===void 0||b.startsWith("-")){s.push(`${p} requires a value`);continue}l[o[0]]=b,c=L+1;continue}if(p.startsWith("-")){s.push(`Unknown option for ${n.label}: ${p}`);continue}if(n.positionals==="tail"){d.push(...t.slice(L));break}d.push(p)}if(n.positionals!=="list"&&n.positionals!=="tail")s.push(...d.map((L)=>`Unexpected argument for ${n.label}: ${L}`));return{flags:a,values:l,positionals:d,help:i,errors:s}}function r2(n){for(let t of n)console.error(t);return n.length>0}import{readdirSync as d3,statSync as ta,unlinkSync as s3}from"node:fs";import{basename as ea,dirname as i3,join as c3,resolve as L3}from"node:path";function z(n){return Array.from(n,(t)=>{let e=t.charCodeAt(0);if(e<=31||e>=127&&e<=159)return`\\x${e.toString(16).padStart(2,"0")}`;return t}).join("")}var xt=(n)=>{let t=Date.now()-new Date(n).getTime();if(!Number.isFinite(t))return"";let e=Math.floor(t/60000),r=Math.floor(e/60),a=Math.floor(r/24);if(a>0)return`${a}d ago`;if(r>0)return`${r}h ago`;if(e>0)return`${e}m ago`;return"just now"},S2=(n)=>{let t=(n??"").trim().split(/\s+/).filter((a)=>a&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(a)),e=t[0]?.split("/").pop();if(!e)return null;let r=t[1];return r&&/^[a-z][a-z0-9-]*$/.test(r)?`${e} ${r}`:e};import{existsSync as md,readdirSync as gd,readFileSync as Dd}from"node:fs";import{join as kd}from"node:path";function p2(n,t){try{return gd(n,{withFileTypes:!0,encoding:"utf8"}).flatMap((e)=>{let r=kd(n,e.name);if(e.isDirectory())return p2(r,t);if(e.name.endsWith(".jsonl"))return[r];return[]})}catch{if(t&&md(n))t.count++;return[]}}function $t(n){let t=(a)=>`${a.sessionId}
${S2(a.segment||a.command)}`,e=n.filter((a)=>a.decision!=="allow"),r=e.filter((a)=>a.sessionId).reduce((a,l)=>a.set(t(l),(a.get(t(l))??0)+1),new Map);return new Set(e.filter((a)=>a.failureStage||(r.get(t(a))??0)>=2))}function an(n,t){try{return Dd(n,"utf-8").split(`
`).filter(Boolean).flatMap((e)=>{try{return[JSON.parse(e)]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as Id}from"node:path";var qd=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function hr(n){let t=0,e={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(r){n.record({kind:"step",scope:"global",step:r})},recordSegment(r,a=e.currentSegmentIndex){if(a===void 0)return;n.record({kind:"step",scope:"segment",segmentIndex:a,step:r})}};return e}function wr(n={}){let t=[],e=n.maxEvents??512,r={maxTextLength:n.maxTextLength??2048,maxListLength:n.maxListLength??128,maxObjectProperties:n.maxObjectProperties??n.maxListLength??128,maxDepth:n.maxDepth??16},a=0,l,d=new Set;return{record(s){if(l)return;try{if(!s||t.length>=e){a++;return}t.push(gt(jd(s,r,d)))}catch{a++}},finish(s){if(l)return l;try{l=gt({events:Object.freeze(t),droppedEvents:a,terminal:Fd(s,r,d)})}catch{a++,l=Object.freeze({events:Object.freeze(t),droppedEvents:a,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,r.maxTextLength),segment:"trace unavailable".slice(0,r.maxTextLength)})})}return l}}}function jd(n,t,e){if(n.kind!=="step")throw TypeError("invalid trace event");let{scope:r,step:a}=n;Bn(a,e,t);let l=Z2(a,t,e);if(r==="global")return{kind:"step",scope:"global",step:l};if(r!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:n.segmentIndex,step:l}}function Fd(n,t,e){let r=n.result;if(r==="allowed")return Object.freeze({result:"allowed"});if(r!=="blocked")throw TypeError("invalid trace terminal");let a=n.ruleId;return Object.freeze({result:"blocked",reason:Z2(n.reason,t,e),segment:Z2(n.segment,t,e),...a?{ruleId:Z2(a,t,e)}:{}})}function Bn(n,t,e,r=0,a=new WeakSet){if(typeof n==="string"){let s=n.slice(0,e.maxTextLength);if(!Dt(s))return;for(let i of yr(s))for(let c of i.match(/[^\s"'()$]+/g)??[])t.add(xr(c));return}if(!n||typeof n!=="object"||r>=e.maxDepth||a.has(n))return;if(a.add(n),Array.isArray(n)){let s=Math.min(n.length,e.maxListLength);for(let i=0;i<s;i++)Bn(n[i],t,e,r+1,a);return}let l=0,d=new Set;for(let s in n){if(!Object.hasOwn(n,s))continue;if(l>=e.maxObjectProperties)break;l++,Bn(s,t,e);let i=mt(s,e,t);if(d.has(i))continue;d.add(i),Bn(n[s],t,e,r+1,a)}}function Z2(n,t,e,r=0,a=new WeakSet){if(typeof n==="string")return mt(n,t,e);if(!n||typeof n!=="object")return n;if(r>=t.maxDepth)return;if(a.has(n))return;if(a.add(n),Array.isArray(n)){let s=[],i=Math.min(n.length,t.maxListLength);for(let c=0;c<i;c++)s.push(Z2(n[c],t,e,r+1,a));return s}let l={},d=0;for(let s in n){if(!Object.hasOwn(n,s))continue;if(d>=t.maxObjectProperties)break;d++;let i=mt(s,t,e);if(Object.hasOwn(l,i))continue;Object.defineProperty(l,i,{value:Z2(n[s],t,e,r+1,a),enumerable:!0,configurable:!0,writable:!0})}return l}function mt(n,t,e){let r=n.slice(0,t.maxTextLength),a=Dt(r)?fr(r):r,l=e.size>0?Bd(a,e):a;return(zd(l)?br(l):l).slice(0,t.maxTextLength)}function zd(n){return n.includes("PRIVATE KEY")||n.includes("://")||n.includes("eyJ")||n.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(n)||n.length>=14&&qd.some((t)=>n.includes(t))||n.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(n)}function Bd(n,t){return n.replace(/[^\s"'()$]+/g,(e)=>t.has(xr(e))?"<redacted>":e)}function xr(n){let t=2166136261,e=2166136261;for(let r=0;r<n.length;r++)t=Math.imul(t^n.charCodeAt(r),16777619),e=Math.imul(e^n.charCodeAt(n.length-r-1),16777619);return`${t>>>0}:${e>>>0}:${n.length}`}function gt(n){if(n&&typeof n==="object"&&!Object.isFrozen(n)){for(let t of Object.values(n))gt(t);Object.freeze(n)}return n}function Dr(n,t,e,r){let a=r??$r(),l=e??a.getCommandProgram(n,t.shell??"auto"),d=wr(),s=hr(d),i=l.dialect==="powershell"?a.getCommandProgram(n,"posix"):l,c=mr(i);s.recordGlobal({type:"parse",input:n,segments:c.map((u)=>[...u])});let L=gr(n,{...t,analyzePartialProgram:!0,trace:s},l,a),p=s.getNextSegmentIndex();if(L&&p>0&&p<c.length)s.recordSegment({type:"segment-skipped",index:p,reason:"prior-segment-blocked"},p);return Object.freeze({decision:L,trace:d.finish(L?{result:"blocked",reason:L.reason,segment:L.evidence.find((u)=>u.kind==="command")?.segment??n,...L.ruleId?{ruleId:L.ruleId}:{}}:{result:"allowed"}),program:l})}import{resolve as Jd}from"node:path";function kt(n){let t=kr().safeParse(n);return{errors:t.success?[]:jr(t.error.issues),ruleNames:new Set(qr(n).map((e)=>e.toLowerCase()))}}function qt(n){let t=zr(n);if(!t.ok)return t.result;return kt(t.parsed)}function zr(n){let t=[],e=new Set;try{let r=typeof n==="string"?ln(n):n,a=m(r);if(a===null)return t.push(`File not found: ${r.path}`),{ok:!1,result:{errors:t,ruleNames:e}};if(!a.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:e}};return{ok:!0,parsed:JSON.parse(a)}}catch(r){return t.push(r instanceof S?r.message:"Invalid JSON"),{ok:!1,result:{errors:t,ruleNames:e}}}}function Br(n){return Jd(n??process.cwd(),".safety-net.json")}function a2(n){let t=zr(n);if(!t.ok)return t.result;let e=Fr(t.parsed);return{errors:e.errors,ruleNames:e.sources}}import{isAbsolute as Sd,join as Jn,relative as Zd,resolve as Jr,sep as Qd}from"node:path";async function H2(n={}){let t=Xt(n);return Xd(t,await Sn(t,X2()))}function Xd(n,t){if(!t.ok)return t;let e=U(n),r=[...new Set(l2(e.configPath,e.lockPath,n,e.filesystemScope))];if(r.length===0)return t;return{ok:!1,errors:r,warnings:t.warnings,entries:t.entries}}async function Sn(n,t,e,r={}){let a=null,l=!1;try{let d=U(n),s=St(d.configTarget);if(!s.ok)return s.result;let i=s.config;if(n.check)return Md(i,d,n);a={target:d.lockTarget,content:m(d.lockTarget)};let c=Zt(d.lockTarget);if(c.errors.some((f)=>f.startsWith("Unable to access ")))return{ok:!1,errors:c.errors,warnings:[],entries:[]};if(n.only&&c.errors.length>0)return{ok:!1,errors:c.errors,warnings:[],entries:[]};let L=c.errors.length>0?null:c.lock,p=n.only?Hr(i,L,n.only):{ok:!0,specs:i.rules};if(!p.ok)return p.result;if(n.only&&!L&&p.specs.length<i.rules.length)return{ok:!1,errors:[`No lockfile available for partial update; run ${Yr}`],warnings:[],entries:[]};let u=(await Rd(p.specs,(f)=>Wr(f,d.configDir,n,L,d.filesystemScope,t),t)).map((f)=>Kd(f,L,e));for(let f of u)Gd(f.content,f.entry,d.configDir,n,d.filesystemScope);let o=n.only?Vd(i,L,u):u.map((f)=>f.entry);l=!0,T(d.lockTarget,{version:1,rulebooks:o},void 0,r._testAfterPolicyRename);let b=new Map(u.map((f)=>[f.entry.spec,f.rulebook.rules.length])),v=Ud(o,d.configDir,n,d.filesystemScope,r);return{ok:!0,errors:[],warnings:v,entries:o.map((f)=>Cd(f,b))}}catch(d){if(l&&a)try{Q2(a.target,a.content)}catch(s){return Y2(s)}return Y2(d)}}async function Qt(n,t={}){return Yd(n,Xt(t),X2())}async function Yd(n,t,e,r={}){let a=null,l=!1;try{let d=U(t),s=m(d.configTarget);a={target:d.configTarget,content:s};let i=St(d.configTarget);if(!i.ok)return i.result;let c=i.config,L=Xr(n)?await Mr(n,e):[{spec:n}],p=L.map((b)=>b.spec),u=[...new Set([...c.rules,...p])];if(u.length>Bt)return Hd();if(u.length!==c.rules.length)l=!0,T(d.configTarget,{version:1,rules:u,overrides:c.overrides??{},transparent_wrappers:c.transparent_wrappers??[]},void 0,r._testAfterPolicyRename);let o=await Sn(t,e,new Map(L.filter((b)=>!!b.display_ref).map((b)=>[b.spec,b.display_ref])),r);if(!o.ok)Q2(d.configTarget,s);return o}catch(d){if(l&&a)try{Q2(a.target,a.content)}catch(s){return Y2(s)}return Y2(d)}}async function Rd(n,t,e=X2()){if(n.length>Bt)throw Error(Jt);let r=Array(n.length),a=0,l,d=Array.from({length:Math.min(n.length,Rr.concurrency)},async()=>{while(!l){let s=a;if(s>=n.length)return;a++;try{r[s]=await t(n[s],s,e.controller.signal)}catch(i){if(!l)l={value:i},a=n.length,e.controller.abort(i);return}}});if(await Promise.all(d),l)throw l.value;return r}function Hd(){return{ok:!1,errors:[Jt],warnings:[],entries:[]}}function Xt(n){return{cwd:n.cwd,cacheConfigDir:n.cacheConfigDir,userConfigDir:n.userConfigDir,userConfigPath:n.userConfigPath,projectConfigPath:n.projectConfigPath,global:n.global,check:n.check,only:n.only,refresh:n.refresh}}function Ad(n){return{...Xt(n),deleteSource:n.deleteSource}}async function Yt(n,t={}){try{return await Wd(n,Ad(t),{})}catch(e){return Y2(e)}}async function Wd(n,t,e){let r=U(t),a=O(r.configTarget);if(a.errors.length>0)return{ok:!1,errors:a.errors,warnings:[],entries:[]};if(!a.config)return{ok:!1,errors:[`No config found at ${r.configPath}`],warnings:[],entries:[]};let l=Zt(r.lockTarget);if(l.errors.length>0)return{ok:!1,errors:l.errors,warnings:[],entries:[]};let d=Ar(a.config.rules,l.lock,n);if(!d.ok)return d.result;let s=t.deleteSource?Od(r.configDir,d.specs,l.lock,r.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let i=m(r.configTarget);if(i===null)return Y2(Error("Rules config is unavailable."));try{T(r.configTarget,{version:1,rules:a.config.rules.filter((p)=>!d.specs.includes(p)),overrides:a.config.overrides??{},transparent_wrappers:a.config.transparent_wrappers??[]},void 0,e._testAfterPolicyRename)}catch(p){throw Q2(r.configTarget,i),p}let c=await Sn(t,X2(),void 0,e);if(!c.ok)return Q2(r.configTarget,i),c;let L=Ed(s.dirs,e,r.filesystemScope);if(!L.ok){Q2(r.configTarget,i);let p=await Sn(t,X2(),void 0,e);if(!p.ok)return{ok:!1,errors:[...L.result.errors,...p.errors],warnings:p.warnings,entries:p.entries};return L.result}return c}async function Md(n,t,e){let r=Kr(n,t.lockPath,t.configDir,e,e.global?"user":"project",t.filesystemScope);return{ok:r.errors.length===0&&r.warnings.length===0,errors:[...r.errors,...r.warnings],warnings:[],entries:r.entries}}function Kd(n,t,e){let r=t?.rulebooks.find((l)=>l.spec===n.entry.spec&&l.kind==="github"),a=e?.get(n.entry.spec)??(r?.kind==="github"?r.display_ref:void 0);if(!a||n.entry.kind!=="github")return n;return{...n,entry:{...n.entry,display_ref:a}}}function Vd(n,t,e){let r=new Set(n.rules),a=new Set(t?.rulebooks.map((d)=>d.spec)??[]),l=new Map(e.map((d)=>[d.entry.spec,d.entry]));return[...(t?.rulebooks.filter((d)=>r.has(d.spec))??[]).map((d)=>l.get(d.spec)??d),...e.filter((d)=>!a.has(d.entry.spec)).map((d)=>d.entry)]}function Cd(n,t){return{...n,ruleCount:t.get(n.spec)}}function Gd(n,t,e,r,a){let l=Ft(t,zt(e,r));y2(g(a,l),n)}function Ud(n,t,e,r,a){let l=zt(t,e),d=Zn(l),s=g(r,d),i=R2(s);if(!i)return[];let c=n.map((p)=>g(r,Ft(p,l))),L=i.filter((p)=>p.kind==="directory").map((p)=>({directory:g(r,Jn(d,p.name)),identity:g(r,Jn(d,p.name,Qr))})).filter((p)=>!c.some((u)=>Sr(p.identity,u))).map((p)=>p.directory);for(let p of L)Zr(p);return L.flatMap((p)=>{try{return _d(p,a),[]}catch{return["Unable to prune rules policy cache safely."]}})}function Od(n,t,e,r){let a=new Map(e?.rulebooks.map((c)=>[c.spec,c])??[]),l=t.flatMap((c)=>{let L=a.get(c);if(!L)return sn.test(c)?[]:["--delete-source can only delete local rulebook sources"];return L.kind==="local-directory"?[]:["--delete-source can only delete local rulebook sources"]}),d=t.map((c)=>{let L=a.get(c);return Jn(n,L?.kind==="local-directory"?L.path:c)}),s=l.length>0?[]:d.flatMap((c)=>Td(n,c,r)),i=[...l,...s];return i.length>0?{ok:!1,result:{ok:!1,errors:i,warnings:[],entries:[]}}:{ok:!0,dirs:d}}function Td(n,t,e){let r=Jr(n),a=Jr(t),l=Zd(r,a);if(l===""||l===".."||l.startsWith(`..${Qd}`)||Sd(l))return[`Refusing to delete local rulebook source outside ${n}: ${t}`];let d=g(e,a),s=R2(d);if(!s)return[`Local rulebook source directory not found: ${t}`];let i=s.find((c)=>c.name==="rulebook.json");if(!i)return[`Local rulebook source directory is missing rulebook.json: ${t}`];if(i.kind!=="file")throw new S(e.label);if(m(g(e,Jn(a,"rulebook.json"))),s.length>1)return[`Local rulebook source directory contains extra files: ${t}. delete manually if you really want to remove the directory.`];return[]}function Ed(n,t,e){let r=n.flatMap((a)=>{try{return Pd(g(e,a),t),[]}catch(l){return[`Failed to delete local rulebook source ${a}: ${l instanceof Error?l.message:String(l)}`]}});return r.length>0?{ok:!1,result:{ok:!1,errors:r,warnings:[],entries:[]}}:{ok:!0}}function _d(n,t){if(t._testPruneRulebookCacheDir){t._testPruneRulebookCacheDir(n.path);return}jt(n)}function Pd(n,t){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(n.path);return}jt(n)}function Q2(n,t){if(t===null){dn(n);return}y2(n,t)}function Y2(n){return{ok:!1,errors:[n instanceof Error?n.message:String(n)],warnings:[],entries:[]}}function K2(n,t){let e=n3(t),r=Tr(e),a={effectiveLevel:r.effectiveLevel,selectedPreset:e.policySnapshot.policy.safety.level??"standard",effectiveCapabilities:r.effectiveCapabilities,destructiveCommandRuleOverrides:e.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:l,configValid:d}=Nd({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!n||!n.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:l,configValid:d,...a};let s=t3(n,e);if(s)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",ruleModule:s.ruleModule,ruleFunction:s.ruleFunction,matched:!0,reason:s.reason}]}]},result:"blocked",reason:H(s.reason),segment:H(s.target),...s.ruleId?{ruleId:H(s.ruleId)}:{},configSource:l,configValid:d,...a};let i=Dr(n,e),c=i.decision,L=c?.ruleId??e3(n,e),p=Ln.find((o)=>o.id===L&&o.activationCapability),u=p?r.policy.effectiveDestructiveCommandRules[p.id]:void 0;return{trace:a3(i.trace),result:c?"blocked":"allowed",reason:c?H(c.reason):void 0,segment:c?H(c.evidence.find((o)=>o.kind==="command")?.segment??n):void 0,ruleId:c?.ruleId?H(c.ruleId):void 0,customRule:r3(l3(c?.ruleId,e.policySnapshot)),configSource:l,configValid:d,...a,...p&&u?{ruleActivation:{id:p.id,...u}}:{}}}function Nd(n){let t=E(n?.cwd),e=n?.userConfigPath??_(n),r=P({cwd:n?.cwd,userConfigDir:n?.userConfigDir,userConfigPath:n?.userConfigPath});try{if(m(r.projectConfigTarget)!==null){if(a2(r.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(a){if(a instanceof S)return{configSource:t,configValid:!1};throw a}try{if(m(r.userConfigTarget)!==null){let a=a2(r.userConfigTarget);return{configSource:e,configValid:a.errors.length===0}}return{configSource:null,configValid:!0}}catch(a){if(a instanceof S)return{configSource:e,configValid:!1};throw a}}function n3(n){let t=Id(n?.cwd??process.cwd()),e=n?.policySnapshot??A({cwd:t,userConfigDir:n?.userConfigDir}),r=d2(e.policy);return{cwd:t,effectiveCwd:t,policySnapshot:e,environment:Vr(),protectedGitMetadata:Or(t),effectiveCapabilities:r.capabilities,strict:n?.strict??r.strict,paranoidRm:r.paranoidRm,paranoidInterpreters:r.paranoidInterpreters,worktreeMode:r.worktreeMode}}function t3(n,t){let e=t.cwd??process.cwd(),r=Cr(M2("",{command:n},{kind:"command",shell:"posix"},{executionCwd:e,configCwd:e},n)),a=Pr(r);if(a)return{reason:_r,target:a.target,ruleId:"policy-protection",ruleModule:"policy-protection",ruleFunction:"findPolicyConfigMutationTarget"};let l=Ur(r,t.protectedGitMetadata);if(l)return{reason:Gr,target:l.target,ruleId:"git-metadata-protection",ruleModule:"git-metadata-protection",ruleFunction:"findGitMetadataMutationTarget"};let d=t.policySnapshot.policy,s=d.secretProtection.enabled===!1?null:Nr(r,d.secretProtection,{strict:t.strict});if(s)return{reason:Ir,target:s.target,ruleId:s.ruleId,ruleModule:"secret-protection",ruleFunction:"findSensitiveTarget"};return null}function e3(n,t){let e=t.policySnapshot.policy,r=on({...e,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...e.destructiveCommandRuleOverrides,...Object.fromEntries(Ln.flatMap((a)=>a.activationCapability?[[a.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return Er(n,{...t,policySnapshot:r,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function r3(n){if(!n)return;return{id:H(n.id),...n.rulebook?{rulebook:{name:H(n.rulebook.name),version:H(n.rulebook.version)}}:{},...n.source?{source:H(n.source)}:{},...n.override?{override:{type:"reason",reason:H(n.override.reason)}}:{}}}function a3(n){let t=n.events.flatMap((r)=>r.kind==="step"&&r.scope==="global"?[r.step]:[]),e=new Map;for(let r of n.events){if(r.kind!=="step"||r.scope!=="segment")continue;let a=e.get(r.segmentIndex)??{index:r.segmentIndex,steps:[]};a.steps.push(r.step),e.set(r.segmentIndex,a)}return{steps:t,segments:[...e.values()]}}function l3(n,t){let e=n?.replace(/^custom\./,"");if(!e||!t.policy.rules.some((r)=>r.name===e))return;return t.ruleMetadata[e]??Object.freeze({id:e})}function o3(n){let t=V2(),e=F({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},n);if(r2(e.errors))return null;if(e.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(e.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let r=e.values.limit===void 0?20:na(e.values.limit);if(r===null)return console.error("--limit must be a positive number"),null;let a=e.values.since===void 0?Math.min(30,t):na(e.values.since);if(a===null||a>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let l={limit:r,limitExplicit:e.values.limit!==void 0,since:a,sinceExplicit:e.values.since!==void 0,all:e.flags.all,json:e.flags.json,suspect:e.flags.suspect,pruneLegacy:e.flags.pruneLegacy,dryRun:e.flags.dryRun,id:e.values.id,agent:e.values.agent,rule:e.values.rule,session:e.values.session,project:e.values.project===void 0?void 0:L3(e.values.project)};if(l.id&&(l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.sinceExplicit||l.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(l.pruneLegacy&&(l.id!==void 0||l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.all||l.sinceExplicit||l.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(l.dryRun&&!l.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return l}async function ra(n,t={}){let e=o3(n);if(!e)return 1;let r=t.logsDir??s2();if(e.pruneLegacy)return p3(r,e.json,e.dryRun);if(!r)return console.log(e.json?"[]":e.id?`No retained audit log entry found for id ${z(e.id)}.`:"No audit log entries found."),0;w2(r);let a={count:0},l=p2(r,a).flatMap((L)=>an(L,a).map((p)=>({entry:p,file:L})));if(a.count>0)console.error(`warning: ${a.count} audit log ${a.count===1?"source":"sources"} could not be read; these results are incomplete`);if(e.id)return f3(l,e,t.timeZone);let d=Date.now()-e.since*24*60*60*1000,s=l.filter((L)=>y3(L,e,r,d)),i=e.suspect?$t(s.map((L)=>L.entry)):null,c=(i?s.filter((L)=>i.has(L.entry)):s).sort((L,p)=>Date.parse(p.entry.ts)-Date.parse(L.entry.ts)).slice(0,e.limit);if(e.json)return console.log(JSON.stringify(c.map((L)=>L.entry),null,2)),0;if(c.length===0)return console.log("No audit log entries found."),0;for(let L of c)console.log(x3(L.entry,t.timeZone));return 0}function p3(n,t,e){let r=n?v3(n).map((s)=>c3(n,s)):[];if(e)return u3(r,t);let a=[],l=0,d=0;for(let s of r){let i=ta(s,{throwIfNoEntry:!1})?.size??0,c=b3(s);if(c){a.push(`${ea(s)}: ${c}`);continue}l++,d+=i}if(t)return console.log(JSON.stringify({removedFiles:l,removedBytes:d,failedFiles:a.length})),a.length===0?0:1;console.log(l===0&&a.length===0?"No legacy audit log files found.":`Removed ${l} legacy audit log ${l===1?"file":"files"} (${aa(d)}).`);for(let s of a)console.error(`Could not remove ${z(s)}`);if(console.log("Nested v2 audit logs were not changed."),l>0)console.log("This deletion cannot be undone.");return a.length===0?0:1}function u3(n,t){let e=n.reduce((r,a)=>r+(ta(a,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:n.length,bytes:e})),0;if(console.log(n.length===0?"No legacy audit log files found.":`Would remove ${n.length} legacy audit log ${n.length===1?"file":"files"} (${aa(e)}).`),console.log("Nested v2 audit logs are not included."),n.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function v3(n){try{return d3(n,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function b3(n){try{return s3(n),null}catch(t){return t instanceof Error?t.message:String(t)}}function aa(n){let t=["B","KiB","MiB","GiB"],e=Math.min(Math.floor(Math.log2(Math.max(n,1))/10),t.length-1);return`${Math.round(n/1024**e*10)/10} ${t[e]}`}function f3(n,t,e){let r=n.filter((l)=>l.entry.id===t.id);if(r.length>1)return console.error(`Multiple audit log entries found for id ${z(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(r.map((l)=>l.entry),null,2)),0;let a=r[0];if(!a)return console.log(`No retained audit log entry found for id ${z(t.id??"")}.`),0;return console.log($3(a.entry,e)),0}function y3(n,t,e,r){if(!t.all&&n.entry.decision==="allow")return!1;if(Date.parse(n.entry.ts)<r)return!1;if(t.agent!==void 0&&n.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&n.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!h3(n,e,t.session))return!1;if(t.project!==void 0&&!w3(n.entry.cwd,t.project))return!1;return!0}function h3(n,t,e){if(n.entry.sessionId===e)return!0;return i3(n.file)===t&&ea(n.file,".jsonl")===e}function w3(n,t){if(!n)return!1;return n===t||n.startsWith(`${t}/`)}function x3(n,t){let e=z(n.id??"-"),r=z(n.decision??"deny"),a=n.cwd?`  [${z(n.cwd)}]`:"",l=n.segment||n.command,d=l===n.command?"":"↳ ",s=l.length>50?`${l.slice(0,50)}…`:l;return`${e.padEnd(16)}  ${z(la(n.ts,t))}  ${r.padEnd(5)}  ${z(n.agent??"-").padEnd(15)}  ${z(n.ruleId??"-").padEnd(20)}  ${d}${z(s)}${a}`}function $3(n,t){let e=(a)=>z(a===void 0||a===null||a===""?"-":a),r=n.shape?`${n.agent??"-"} (shape: ${n.shape})`:n.agent??"-";return[`id:        ${e(n.id)}`,`ts:        ${e(la(n.ts,t))}`,`decision:  ${e(n.decision)}`,`agent:     ${e(r)}`,`level:     ${e(n.level)}`,`tool:      ${e(n.toolName)}`,`rule:      ${e(n.ruleId)}`,`intent:    ${e(n.intent)}`,`stage:     ${e(n.failureStage)}`,`error:     ${e(n.errorCode)}`,`session:   ${e(n.sessionId)}`,`cwd:       ${e(n.cwd)}`,`version:   ${e(n.v)}`,`truncated: ${e(n.truncated===!0?"yes":void 0)}`,`reason:    ${e(n.reason)}`,`command:   ${e(n.command)}`,`segment:   ${e(n.segment)}`].join(`
`)}function la(n,t){let e=new Date(n);if(Number.isNaN(e.getTime()))return n;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(e)}function na(n){let t=Number(n);return Number.isFinite(t)&&t>0?t:null}var da={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var sa={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var ia={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as ya,relative as S3}from"node:path";var m3=8388608;function g3(n,t){console.log(JSON.stringify(n(La(t))))}async function D3(n){let t;try{t=(await Pt(process.stdin)).trim()}catch{n({reason:"Failed to parse hook input JSON."});return}if(!t){n({reason:"Missing hook input JSON."});return}return It(t,n,"Failed to parse hook input JSON.")}async function Pt(n){let t=[],e=0;for await(let r of n){let a=typeof r==="string"?Buffer.from(r,"utf-8"):Buffer.from(r.buffer,r.byteOffset,r.byteLength);if(e+=a.byteLength,e>m3)throw k3(n),Error("hook input byte limit exceeded");t.push(a)}return Buffer.concat(t,e).toString("utf-8")}function k3(n){let t=n.destroy??n.cancel;if(!t)return;try{Promise.resolve(t.call(n)).catch(()=>{})}catch{}}function It(n,t,e){try{return JSON.parse(n)}catch{t({reason:e});return}}function Q(n,t){let e=t.get(n);return e?{kind:"command",shell:e}:{kind:pa(n)}}function I(n,t,e,r){let a=n===void 0?process.cwd():n,l=typeof a==="string"&&a.trim()!==""?i2([a]):void 0;if(l)return{configCwd:l,executionCwd:l};return R(r,t,e,z3(a)),null}function R(n,t,e,r){let a;try{a=_t(t)}catch(l){if(!(l instanceof C2))throw l}n(Qn({command:a,segment:r,toolName:e}))}async function q3(n){let t=await D3(n.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){R(n.outputDeny);return}if(!n.isSupported(t))return;let e=n.getAgent?.(t)??n.agent,r=n.agent===e?void 0:n.agent,a=J3(t),l=(o,b)=>{ca(o,()=>n.getSessionId(t),{agent:e,shape:r,toolName:b,cwd:a}),n.outputDeny(o)},d=n.getToolName(t);if(typeof d!=="string"||d.trim()===""){R((o)=>l(o),B3(t));return}let s=d,i=(o)=>l(o,s),c;try{c=n.getToolInput(t,s,i)}catch(o){if(!(o instanceof C2))throw o;R(i,void 0,s);return}if(!c.ok)return;let L=n.getContext(t,c.input,s,i);if(!L)return;let p;try{p=_t(c.input)}catch(o){if(!(o instanceof C2))throw o;R(i,void 0,s);return}let u=M2(s,c.input,c.route,L,p??null);try{let o=Xn(u,{guard:{auditAllowed:ua(),dependencies:n.guardDependencies},audit:{agent:e,shape:r,getSessionId:()=>n.getSessionId(t)}}),b=Et(o,{includeEvidence:!0,toolName:o.stage==="command-analysis"?void 0:s});if(b){n.outputDeny(b);return}n.outputAllow?.()}catch(o){if(!(o instanceof va))throw o;j3(o);let b=Et(o.evaluation,{includeEvidence:!0,toolName:o.evaluation.stage==="command-analysis"?void 0:s});if(b)n.outputDeny(b);return}}function j3(n){if(!pn(D.debug))return;console.error(`CC Safety Net debug: ${F3(n.stage)}: ${oa(n.cause)}`)}function F3(n){if(n==="policy-protection")return"hook policy protection failed";if(n==="config-load")return"hook config loading failed";if(n==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function z3(n){return typeof n==="string"?n:void 0}function B3(n){if(!n||typeof n!=="object"||Array.isArray(n))return;if(Object.hasOwn(n,"tool_input"))return n.tool_input;let t=n.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function J3(n){if(!n||typeof n!=="object"||Array.isArray(n))return null;let t=n.cwd;if(typeof t==="string")return t;let e=n.toolCall;if(!e||typeof e!=="object"||Array.isArray(e))return null;let r=e.args;if(!r||typeof r!=="object"||Array.isArray(r))return null;let a=r.Cwd;return typeof a==="string"?a:null}async function X(n){let t=(a)=>g3(n.createDenyOutput,a),e=n.createAllowOutput;await q3({...n,outputDeny:t,outputAllow:e?()=>console.log(JSON.stringify(e())):void 0})}var Z3=new Map([["run_command","auto"]]),Q3=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function ha(n){return Q(n,Z3)}async function wa(){await X({agent:"antigravity-cli",createDenyOutput:(n)=>({decision:"deny",reason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolCall?.name,getToolInput:(n,t)=>({ok:!0,input:A3(n.toolCall?.args,t),route:ha(t)}),getContext:X3,getSessionId:(n)=>n.conversationId})}function X3(n,t,e,r){let l=H3(n).flatMap((c)=>{let L=i2([c]);return L?[L]:[]});if(!l[0])return $2(r,t,e),null;if(e!=="run_command"){let c;try{c=Y3(t,e,l)}catch(L){if(L instanceof C2)return $2(r,void 0,e),null;if(!(L instanceof Yn))throw L;return $2(r,t,e),null}if(!c)return $2(r,t,e),null;return{configCwd:c,executionCwd:c,policyConfigCwds:l}}let d=n.toolCall?.args;if(!d||!Object.hasOwn(d,"Cwd"))return{configCwd:l[0],executionCwd:l[0],policyConfigCwds:l};let s=d.Cwd;if(typeof s!=="string"||s.trim()==="")return $2(r,t,e),null;let i=fn(s,l);if(i){let c=xa(i,l);if(!c)return $2(r,t,e,s),null;return{configCwd:c,executionCwd:i,policyConfigCwds:l}}return $2(r,t,e,s),null}function Y3(n,t,e){let r=ha(t),a=[...ba(n,Q3),...r.kind==="patch"?fa(n):[]].filter(ya),l=Rn(),d=new Set(a.flatMap((s)=>{let i=xa(vn(s,bn,l),e);return i?[i]:[]}));if(d.size>1)return null;return[...d][0]??e[0]??null}function xa(n,t){return t.filter((e)=>R3(n,e)).reduce((e,r)=>r.length>e.length?r:e,"")||null}function R3(n,t){let e=S3(t,n);return e===""||!e.startsWith("..")&&!ya(e)}function $2(n,t,e,r){let a=t&&typeof t==="object"?t.command:void 0;n(Qn({command:typeof a==="string"?a:void 0,segment:r,toolName:e}))}function H3(n){if(n.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(n.workspacePaths)?n.workspacePaths.filter((e)=>typeof e==="string"&&e.trim()!==""):[];return i2(t)?t:[]}function A3(n,t){if(!n)return;if(t!=="run_command")return n;return{...n,command:typeof n.CommandLine==="string"&&n.CommandLine!==""?n.CommandLine:void 0}}var G2=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",installLabel:"Antigravity CLI",helpTarget:"Antigravity CLI hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",installLabel:"Claude Code",helpTarget:"Claude Code plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",installLabel:"Codex",helpTarget:"Codex plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",installLabel:"GitHub Copilot CLI",helpTarget:"GitHub Copilot CLI plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",installLabel:"Gemini CLI",helpTarget:"Gemini CLI extension",probeCommand:["gemini","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:8,runtime:{order:6,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--hermes-agent",installLabel:"Hermes Agent",helpTarget:"Hermes Agent plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:9,runtime:{order:7,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--kimi-code",installLabel:"Kimi Code",helpTarget:"Kimi Code hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:10,install:{order:10,flag:"--openclaw",installLabel:"OpenClaw",helpTarget:"OpenClaw plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:11,install:{order:11,flag:"--opencode",installLabel:"OpenCode",helpTarget:"OpenCode plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:12,install:{order:12,flag:"--pi",installLabel:"Pi",helpTarget:"Pi package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",installLabel:"Cursor",helpTarget:"Cursor hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",installLabel:"Amp Code",helpTarget:"Amp Code plugin",probeCommand:["amp","--version"]}}],$a=G2.slice().sort((n,t)=>n.doctorOrder-t.doctorOrder).map((n)=>n.id),ma=G2.filter((n)=>("runtime"in n)).slice().sort((n,t)=>n.runtime.order-t.runtime.order).map((n)=>({id:n.id,displayName:"displayName"in n.runtime?n.runtime.displayName:n.displayName,flags:n.runtime.flags,legacyFlags:"legacyFlags"in n.runtime?n.runtime.legacyFlags:[],description:n.runtime.description,legacyTopLevelFlags:n.runtime.legacyTopLevelFlags})),c2=G2.slice().sort((n,t)=>n.install.order-t.install.order).map((n)=>({id:n.id,...n.install})).map(({order:n,...t})=>t),xp=Object.fromEntries(G2.map((n)=>[n.id,n.displayName]));function v2(n){return G2.find((t)=>t.id===n)?.displayName??n}function m2(n){return G2.find((t)=>t.id===n)?.install.installLabel??n}import{homedir as W3}from"node:os";import{isAbsolute as ga,join as Nt}from"node:path";function ka(n){if(n!==void 0&&n!==null&&!ga(n))return"unknown";try{let t=Rn(),e=n?vn(n,bn,t):void 0,r=process.env.HOME||W3(),a=[["codex",process.env.CODEX_HOME||Nt(r,".codex")],["copilot-cli",process.env.COPILOT_HOME||Nt(r,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||Nt(r,".claude")]],l=e?a.flatMap(([d,s])=>{if(!ga(s))return[];return Da(e,vn(s,bn,t))?[d]:[]}):[];if(l.length===1)return l[0]??"unknown";if(l.length>1)return"unknown"}catch(t){if(t instanceof Yn)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var ne="PreToolUse",qa="BeforeTool",ja="pre_tool_call",te="PreToolUse";var M3=new Map([["Bash","posix"],["PowerShell","powershell"]]);function K3(n){return Q(n,M3)}async function Fa(){await X({agent:"claude-code",getAgent:(n)=>ka(n.transcript_path),createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:ne,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===ne,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:K3(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}var V3=new Map([["bash","auto"],["Bash","auto"]]);function C3(n){return Q(n,V3)}async function za(){await X({agent:"copilot-cli",createDenyOutput:(n)=>({permissionDecision:"deny",permissionDecisionReason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolName,getToolInput:(n,t,e)=>{if(typeof n.toolArgs!=="string")return e({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let r=It(n.toolArgs,e,"Failed to parse toolArgs JSON.");if(r===void 0)return{ok:!1};return{ok:!0,input:r,route:C3(t)}},getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>typeof n.sessionId==="string"&&n.sessionId.trim()?n.sessionId:void 0})}var G3=new Map([["Shell","auto"]]);function U3(n){return Q(n,G3)}async function Ba(){await X({agent:"cursor",createDenyOutput:(n)=>({permission:"deny",user_message:n,agent_message:n}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:U3(t)}),getContext:O3,getSessionId:(n)=>n.conversation_id})}function O3(n,t,e,r){let a=T3(n);if(!a[0])return R(r,t,e),null;let l=fn(_3(n.cwd),a);if(!l)return R(r,t,e,typeof n.cwd==="string"?n.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:l,executionCwd:l,policyConfigCwds:a};if(!Object.hasOwn(t,"working_directory"))return{configCwd:l,executionCwd:l,policyConfigCwds:a};let d=t.working_directory;if(typeof d!=="string"||d.trim()==="")return R(r,t,e),null;let s=fn(d,a);if(!s)return R(r,t,e,d),null;return{configCwd:l,executionCwd:s,policyConfigCwds:a}}function T3(n){return E3(n).flatMap((t)=>{let e=i2([t]);return e?[e]:[]})}function E3(n){if(n.workspace_roots===void 0)return typeof n.cwd==="string"&&n.cwd.trim()!==""?[n.cwd]:[];if(!Array.isArray(n.workspace_roots))return[];return n.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function _3(n){return typeof n==="string"&&n.trim()!==""?n:"."}var P3=new Map([["run_shell_command","auto"]]);function I3(n){return Q(n,P3)}async function Ja(){await X({agent:"gemini-cli",createDenyOutput:(n)=>({decision:"deny",reason:n,systemMessage:n}),isSupported:(n)=>n.hook_event_name===qa,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:I3(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}import{resolve as N3}from"node:path";var ns=new Map([["terminal","posix"]]);async function Sa(){await X({agent:"hermes-agent",createDenyOutput:(n)=>({action:"block",message:n}),isSupported:(n)=>n.hook_event_name===ja,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Q(t,ns)}),getContext:ts,getSessionId:(n)=>n.session_id})}function ts(n,t,e,r){let a=I(n.cwd,t,e,r);if(!a)return null;if(!t||typeof t!=="object"||Array.isArray(t))return a;if(!Object.hasOwn(t,"workdir"))return a;let l=t.workdir;if(typeof l!=="string"||l.trim()==="")return R(r,t,e),null;let d=i2([N3(a.configCwd,l)]);if(!d)return R(r,t,e,l),null;return{...a,executionCwd:d}}var es=new Map([["Bash","posix"]]);function rs(n){return Q(n,es)}async function Za(){await X({agent:"kimi-code",createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:te,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===te,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:rs(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}var as={"antigravity-cli":wa,"claude-code":Fa,"copilot-cli":za,cursor:Ba,"gemini-cli":Ja,"hermes-agent":Sa,"kimi-code":Za},U2=ma.map((n)=>({...n,run:as[n.id]}));function Qa(n){let t=F({label:"hook",booleans:Object.fromEntries(U2.map((r)=>[r.id,[...r.flags,...r.legacyFlags]]))},n);if(t.errors.length>0)return;let e=U2.filter((r)=>t.flags[r.id]);return e.length===1?e[0]:void 0}function Xa(n){return U2.find((t)=>t.legacyTopLevelFlags.some((e)=>e===n))}var ls=U2.map((n)=>({flags:n.flags.join(", "),description:n.description})),ds=U2.flatMap((n)=>n.flags.map((t)=>`cc-safety-net hook ${t}`)),Ya={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...ls,{flags:"-h, --help",description:"Show this help"}],examples:ds};var Ra={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...c2.map((n)=>({flags:n.flag,description:`Install ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...c2.map((n)=>`cc-safety-net install ${n.flag}`)]},Ha={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...c2.map((n)=>({flags:n.flag,description:`Uninstall ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...c2.map((n)=>`cc-safety-net uninstall ${n.flag}`)]},Aa={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var Wa={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var O2={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source>",description:"Add a rulebook source and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Refresh rulebook lock/cache state"},{usage:"sync",description:"Sync configured rulebooks"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk","cc-safety-net rule add project-rules","cc-safety-net rule sync","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var Ma={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var Ka={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var Va=[Ma,da,Wa,sa,O2,Ra,Aa,Ha,Ya,ia,Ka];function ss(n){return n.aliases??[]}function is(n){return!n.hidden}function Hn(n){let t=n.toLowerCase();return Va.find((e)=>e.name.toLowerCase()===t||ss(e).some((r)=>r.toLowerCase()===t))}function Ca(){return Va.filter(is)}import{readFileSync as cs}from"node:fs";import{basename as Ls}from"node:path";function An(n=7,t=s2()){let e=Date.now()-n*24*60*60*1000,r=[],a=new Set,l=0,d,s,i,c;if(t)w2(t);let L={count:0},p=t?p2(t,L):[];for(let o of p)try{let v=cs(o,"utf-8").trim().split(`
`).filter(Boolean);for(let f of v)try{let w=JSON.parse(f);if(w.decision==="allow")continue;let x=new Date(w.ts).getTime();if(x>=e){if(l++,a.add(w.sessionId??Ls(o,".jsonl")),s===void 0||x<=s)d=w.ts,s=x;if(c===void 0||x>c)i=w.ts,c=x;os(r,w,x)}}catch{L.count++}}catch{L.count++}let u=r.map((o)=>({timestamp:o.ts,command:o.command,reason:o.reason,relativeTime:xt(new Date(o.ts))}));return{totalBlocked:l,sessionCount:a.size,recentEntries:u,oldestEntry:d,newestEntry:i,unreadable:L.count}}function os(n,t,e){let r=n.findIndex((a)=>e>new Date(a.ts).getTime());if(r===-1){if(n.length<3)n.push(t);return}if(n.splice(r,0,t),n.length>3)n.pop()}import{dirname as ps}from"node:path";function Ga(n,t,e,r,a){let l;try{if(m(r)===null)return{path:n,exists:!1,valid:!1,ruleCount:0};l=a2(r),l.errors.push(...l2(n,t,{userConfigDir:e},a))}catch(d){if(!(d instanceof S))throw d;l={errors:[d.message],ruleNames:new Set}}return{path:n,exists:!0,valid:l.errors.length===0,ruleCount:l.ruleNames.size,...l.errors.length>0?{errors:l.errors}:{}}}function us(n,t){return{source:t,name:n.name,command:n.command,subcommand:n.subcommand,blockArgs:[...n.block_args],reason:n.reason}}function Ua(n,t){let e=t?.userConfigPath??_(),r=t?.projectConfigPath??E(n),a=ps(e),l=u2({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),d=P({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),s=new Map(l.rulebooks.flatMap((i)=>i.rules.map((c)=>[c,i.source])));return{userConfig:Ga(e,A2({userConfigPath:e}),a,d.userConfigTarget,d.userScope),projectConfig:Ga(r,W2(r),a,d.projectConfigTarget,d.projectScope),effectiveRules:l.rules.map((i)=>us(i,s.get(i.name)??"project")),shadowedRules:[]}}var vs=[{flag:D.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:D.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:D.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:D.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:D.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:D.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:D.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:D.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function Oa(){return[...vs.map((n)=>({name:n.flag.name,value:Gt(n.flag),isSet:Ut(n.flag),legacyName:n.flag.legacyName,legacyValue:n.flag.legacyName?process.env[n.flag.legacyName]:void 0,legacyIsSet:n.flag.legacyName?process.env[n.flag.legacyName]!==void 0:void 0,description:n.description,defaultBehavior:n.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var Ta={error:0,warning:1,info:2},bs=["policy","config","audit"];function fs(n){return n.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var ys=[{derive:(n)=>n.hooks.length>0&&n.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(n)=>n.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let e=v2(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${e} inspection failed`,detail:`Doctor could not verify the ${e} integration configuration.`,fixHint:`Correct the reported ${e} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(n)=>n.userConfig.exists&&!n.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.userConfig.path}]:[]},{derive:(n)=>n.projectConfig.exists&&!n.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.projectConfig.path}]:[]},{derive:(n)=>n.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${n.configState.reason}`,fixHint:"Correct the named source, run `cc-safety-net rule sync` for a rule source, then rerun doctor."}]:[]},{derive:(n)=>{let t=n.environment.find((e)=>e.name==="CC_SAFETY_NET_AUDIT_SCOPE");return Ct(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...bs.map((n)=>({derive:(t)=>t.posture.directories.filter((e)=>e.kind===n&&e.status==="unsafe").map((e)=>({checkId:`posture.${n}-directory-unsafe`,severity:"error",title:`${n[0]?.toUpperCase()}${n.slice(1)} directory is unsafe`,detail:`The ${n} directory ${fs(e.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...e.path?{path:e.path}:{}}))})),{derive:(n)=>{let t=[...n.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function Ea(n){return ys.flatMap((t,e)=>t.derive(n).map((r,a)=>({finding:r,catalogOrder:e,occurrence:a}))).sort((t,e)=>Ta[t.finding.severity]-Ta[e.finding.severity]||t.catalogOrder-e.catalogOrder||t.occurrence-e.occurrence).map((t)=>t.finding)}function N(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var hs=(n)=>N()?`\x1B[32m${n}\x1B[0m`:n,ws=(n)=>N()?`\x1B[33m${n}\x1B[0m`:n,xs=(n)=>N()?`\x1B[34m${n}\x1B[0m`:n,$s=(n)=>N()?`\x1B[35m${n}\x1B[0m`:n,ms=(n)=>N()?`\x1B[36m${n}\x1B[0m`:n,gs=(n)=>N()?`\x1B[31m${n}\x1B[0m`:n,Ds=(n)=>N()?`\x1B[2m${n}\x1B[0m`:n,ks=(n)=>N()?`\x1B[1m${n}\x1B[0m`:n,y={green:hs,yellow:ws,blue:xs,magenta:$s,cyan:ms,red:gs,dim:Ds,bold:ks},qs="\x1B[0m",js=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function Fs(n){let t=n;return()=>{return t=(t*1664525+1013904223)%4294967296,t/4294967296}}function zs(n){let t=[...js],e=Fs(n);for(let r=t.length-1;r>0;r--){let a=Math.floor(e()*(r+1)),l=t[r];t[r]=t[a],t[a]=l}return t}function Bs(n,t=0){if(!N())return"";let e=zs(t);return`\x1B[38;5;${e[n%e.length]}m`}function _a(n,t,e=0){if(!N())return`"${n}"`;return`${Bs(t,e)}"${n}"${qs}`}var Js=new RegExp("\x1B\\[[0-9;]*m","g"),ee=(n)=>n.replace(Js,"").length;function g2(n){let t=(n.headers??n.rows[0]??[]).map((d,s)=>{let i=Math.max(...n.rows.map((c)=>ee(c[s]??"")));return Math.max(ee(d),i)}),e=(d,s)=>d+" ".repeat(Math.max(0,s-ee(d))),r=(d,s)=>s[0]+t.map((i)=>d.repeat(i+2)).join(s[1])+s[2],a=(d)=>`│ ${d.map((s,i)=>e(s,t[i]??0)).join(" │ ")} │`,l=n.headers?[`   ${a(n.headers)}`,`   ${r("─",["├","┼","┤"])}`]:[];return[`   ${r("─",["┌","┬","┐"])}`,...l,...n.rows.map((d)=>`   ${a(d)}`),`   ${r("─",["└","┴","┘"])}`].join(`
`)}function Pa(n){let t=[];t.push("Hook Integration"),t.push(Ss(n));let e=[],r=[];for(let a of n){let l=v2(a.platform);if(a.errors&&a.errors.length>0)for(let d of a.errors)if(a.configured)e.push({platform:l,message:d});else r.push({platform:l,message:d})}for(let a of e)t.push(`   Warning (${a.platform}): ${a.message}`);for(let a of r)t.push(y.red(`   Error (${a.platform}): ${a.message}`));return t.join(`
`)}function Ss(n){let t=["Platform","Discovery","Configuration","Inspection"],e=n.map((r)=>{let a=v2(r.platform);if(r.inspectionStatus==="not-inspected"){let i=y.dim("Not inspected");return[a,i,i,i]}let l=r.detected?y.green("Detected"):r.inspectionStatus==="failed"?y.red("Unknown"):y.dim("Not detected"),d=r.configured?y.green("Configured"):r.detected?y.yellow("Not configured"):r.inspectionStatus==="failed"?y.red("Unknown"):y.dim("Not applicable"),s=r.inspectionStatus==="verified"?y.green("Verified"):r.inspectionStatus==="failed"?y.red("Failed"):y.dim("Not applicable");return[a,l,d,s]});return g2({headers:t,rows:e})}function Ia(n){let e=["Guard Engine Verification",`   Synthetic self-test: ${n.failed>0?y.red(`${n.passed}/${n.total} FAIL`):y.green(`${n.passed}/${n.total} passed`)}`],r=n.results.filter((a)=>!a.passed);if(r.length>0){e.push(""),e.push(y.red("   Failures:"));for(let a of r)e.push(y.red(`   • ${a.description}`)),e.push(y.red(`     expected ${a.expected}, got ${a.actual}`))}return e.join(`
`)}function Zs(n){if(n.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],e=n.map((r)=>[r.source,r.name,r.subcommand?`${r.command} ${r.subcommand}`:r.command,r.blockArgs.join(", ")]);return g2({headers:t,rows:e})}function Na(n){let t=[];if(t.push("Configuration"),t.push(Qs(n.userConfig,n.projectConfig)),t.push(""),n.effectiveRules.length>0)t.push(`   Effective rules (${n.effectiveRules.length} total):`),t.push(Zs(n.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let e of n.shadowedRules)t.push(""),t.push(`   Note: Project rule "${e.name}" shadows user rule with same name`);return t.join(`
`)}function Qs(n,t){let e=["Scope","Status"],r=(l)=>{if(!l.exists)return y.dim("N/A");if(!l.valid)return y.red(`Invalid (${l.errors?.[0]??"unknown error"})`);return y.green("Configured")},a=[["User",r(n)],["Project",r(t)]];return g2({headers:e,rows:a})}function n1(n){let t=[];return t.push("Environment"),t.push(Xs(n)),t.join(`
`)}function t1(n){let t=["Effective Safety",`   Selected preset: ${n.effectiveSafety.selectedPreset}`,`   Effective: ${n.effectiveSafety.level}`],e=[["fail_closed","fail_closed"],["paranoid_rm","paranoid_rm"],["paranoid_interpreters","paranoid_interpreters"]];for(let[r,a]of e){let l=n.effectiveSafety.capabilities[r],d=l.enabled?y.green("ON"):y.dim("OFF"),s=l.sources.length>0?` (${l.sources.join(", ")})`:"";t.push(`   ${a}: ${d} via ${l.source}${s}`)}t.push(`   Stored rule customizations: ${n.effectiveSafety.ruleCounts.stored}`),t.push(`   Effective rule customizations: ${n.effectiveSafety.ruleCounts.effective}`);for(let[r,a]of Object.entries(n.effectiveSafety.ruleOverrides))t.push(`   ${r}: ${a}`);return t.join(`
`)}function e1(n){let t=["Findings"];if(n.length===0)return t.push("   No findings from inspected doctor facts."),t.join(`
...
`)}function Xs(n){let t=["Variable","Status","Legacy"],e=n.map((r)=>{let a=r.isSet?y.green("✓"):y.dim("✗"),l=r.legacyName&&r.legacyIsSet?`${r.legacyName} ${y.green("✓")}`:r.legacyName??"";return[r.name,a,l]});return g2({headers:t,rows:e})}function r1(n){let t=[];if(n.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${n.totalBlocked} blocked / ${n.sessionCount} sessions)`),t.push(Ys(n.recentEntries));if(n.unreadable>0)t.push(`   Warning: ${n.unreadable} audit log ${n.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function Ys(n){let t=["Time","Command"],e=n.map((r)=>{let a=z(r.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),l=a.length>40?`${a.slice(0,37)}...`:a;return[r.relativeTime,l]});return g2({headers:t,rows:e})}function a1(n){let t=[];if(t.push("Update Check"),n.latestVersion===null&&!n.error)return t.push(Wn([["Status",y.dim("Skipped")],["Installed",n.currentVersion]])),t.join(`
`);if(n.error)return t.push(Wn([["Status",`${y.yellow("⚠")} Error`],["Installed",n.currentVersion],["Error",y.dim(n.error)]])),t.join(`
`);if(n.updateAvailable)return t.push(Wn([["Status",`${y.yellow("⚠")} Update Available`],["Current",n.currentVersion],["Latest",y.green(n.latestVersion??"")]])),t.push(""),t.push("   Run: bunx cc-safety-net@latest doctor"),t.push("   Or:  npx cc-safety-net@latest doctor"),t.join(`
`);return t.push(Wn([["Status",`${y.green("✓")} Up to date`],["Version",n.currentVersion]])),t.join(`
`)}function Wn(n){return g2({rows:n})}function l1(n){let t=[];return t.push("System Info"),t.push(Rs(n)),t.join(`
`)}function Rs(n){let t=["Component","Version"],e=(l)=>{if(l===null)return y.dim("not found");return l},a=[{label:"cc-safety-net",value:n.version},{label:"Claude Code",value:n.claudeCodeVersion},{label:"Amp Code",value:n.ampVersion},{label:"Antigravity CLI",value:n.antigravityCliVersion},{label:"Codex",value:n.codexCliVersion},{label:"Cursor",value:n.cursorVersion},{label:"Gemini CLI",value:n.geminiCliVersion},{label:"GitHub Copilot CLI",value:n.copilotCliVersion},{label:"Hermes Agent",value:n.hermesAgentVersion},{label:"Kimi Code",value:n.kimiCodeVersion},{label:"OpenClaw",value:n.openClawVersion},{label:"OpenCode",value:n.openCodeVersion},{label:"Pi",value:n.piCliVersion},{label:"Node.js",value:n.nodeVersion},{label:"npm",value:n.npmVersion},{label:"Bun",value:n.bunVersion},{label:"Platform",value:n.platform}].map((l)=>[l.label,e(l.value)]);return g2({headers:t,rows:a})}function d1(n){if(n.findings.length===0)return y.green(`
...
${n.findings.length} ${r}: ${e.join(", ")}.`;if(t.error>0)return y.red(a);if(t.warning>0)return y.yellow(a);return y.blue(a)}import{lstatSync as Hs}from"node:fs";import{dirname as re}from"node:path";function ae(n,t){try{let e=Hs(t);if(e.isSymbolicLink())return{kind:n,path:t,status:"unsafe",issues:["symlink"]};if(!e.isDirectory())return{kind:n,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:n,path:t,status:"unknown",issues:[]};let r=[...e.uid!==process.getuid()?["ownership"]:[],...(e.mode&18)!==0?["permissions"]:[]];return{kind:n,path:t,status:r.length>0?"unsafe":"safe",issues:r}}catch(e){if(typeof e==="object"&&e!==null&&"code"in e&&e.code==="ENOENT")return{kind:n,path:t,status:"not-applicable",issues:[]};return{kind:n,path:t,status:"unknown",issues:[]}}}function s1(n){let t=s2();return{directories:[ae("policy",re(re(n))),ae("config",re(n)),...t?[ae("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as As}from"node:child_process";import{existsSync as i1}from"node:fs";import{delimiter as Ws,extname as Ms,join as Ks}from"node:path";import{stripVTControlCharacters as c1}from"node:util";var o1="2.0.1",Vs=5000,Cs="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function j(){return o1}function le(n,t){let e=n[t];if(e)return e;let r=Object.keys(n).find((a)=>a.toLowerCase()===t.toLowerCase()&&!!n[a]);return r?n[r]:e}function Gs(n){return(le(n,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function Us(n,t){let e=Ms(n)?[n]:[...Gs(t).map((r)=>`${n}${r}`),n];if(n.includes("/")||n.includes("\\"))return e.find((r)=>i1(r))??n;return(le(t,"PATH")??"").split(Ws).flatMap((r)=>e.map((a)=>Ks(r,a))).find((r)=>i1(r))??n}function L1(n){if(!/[\s"&|<>^]/.test(n))return n;return`"${n.replace(/"/g,'""')}"`}function de(n,t){let[e,...r]=n,a=t[Cs]==="win32"?"win32":process.platform;if(!e||a!=="win32")return{cmd:e??"",args:r};let l=Us(e,t);if(!/\.(?:bat|cmd)$/i.test(l))return{cmd:l,args:r};return{cmd:le(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",L1(l),...r.map(L1)].join(" ")]}}var yn=async(n,t=Vs)=>{let e=await Os(n,{timeoutMs:t});if(e.code!==0)return null;return c1(e.stdout).trim()||c1(e.stderr).trim()||null};function Os(n,t){let[e,...r]=n;if(!e)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((a)=>{try{let l=de([e,...r],process.env),d=As(l.cmd,l.args,{stdio:["ignore","pipe","pipe"]}),s=!1,i="",c="";d.stdout.on("data",(u)=>{i+=u.toString()}),d.stderr.on("data",(u)=>{c+=u.toString()});let L=(u)=>{if(s)return;s=!0,clearTimeout(p),a(u)},p=setTimeout(()=>{d.kill(),L({code:null,stdout:i,stderr:c})},t.timeoutMs);d.on("close",(u)=>{L({code:u,stdout:i,stderr:c})}),d.on("error",()=>{L({code:null,stdout:i,stderr:c})})}catch{a({code:null,stdout:"",stderr:""})}})}function Z(n){if(!n)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(n);if(t)return t[1]??null;let e=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(n);if(e)return e[1]??null;return n.split(`
`)[0]?.trim()||null}async function hn(n=yn){let[t,e,r,a,l,d,s,i,c,L,p,u,o,b,v,f,w]=await Promise.all([n(["claude","--version"]),n(["agy","--version"]),n(["opencode","--version"]),n(["codex","--version"]),n(["codex","plugin","list"]),n(["gemini","--version"]),n(["copilot","--binary-version"]),n(["hermes","--version"]),n(["kimi","--version"]),n(["openclaw","--version"]),n(["pi","--version"]),n(["cursor","--version"]),n(["amp","--version"]),n(["amp","plugins","list"],30000),n(["node","--version"]),n(["npm","--version"]),n(["bun","--version"])]);return{version:o1,claudeCodeVersion:Z(t),antigravityCliVersion:Z(e),openCodeVersion:Z(r),codexCliVersion:Z(a),codexPluginListOutput:l,geminiCliVersion:Z(d),copilotCliVersion:Z(s),hermesAgentVersion:Z(i),kimiCodeVersion:Z(c),openClawVersion:Z(L),piCliVersion:Z(p),cursorVersion:Z(u),ampVersion:Z(o),ampPluginListOutput:b,nodeVersion:Z(v),npmVersion:Z(f),bunVersion:Z(w),platform:`${process.platform} ${process.arch}`}}function se(n,t){if(t==="dev")return!1;let e=n.split(".").map(Number),r=t.split(".").map(Number),[a=0,l=0,d=0]=e,[s=0,i=0,c=0]=r;if(a!==s)return a>s;if(l!==i)return l>i;return d>c}async function T2(){let n=j(),t=new AbortController,e=setTimeout(()=>t.abort(),3000);try{let r=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!r.ok)return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${r.status}`};let a=await r.json(),l=se(a.version,n);return{currentVersion:n,latestVersion:a.version,updateAvailable:l}}catch(r){return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:r instanceof Error?r.message:"Network error"}}finally{clearTimeout(e)}}import*as w1 from"node:readline";var b1=(n)=>`\x1B[${n}B`,Ts=(n)=>`\x1B[${n}A`;var p1=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function Es(n){return new Promise((t)=>setTimeout(t,n))}function _s(n,t,e){if(!e)return t(n);if(e.aborted)return Promise.resolve();return new Promise((r,a)=>{let l=()=>e.removeEventListener("abort",d),d=()=>{l(),r()};e.addEventListener("abort",d,{once:!0}),t(n).then(()=>{l(),r()},(s)=>{l(),a(s)})})}function wn(n,t){return n&&n>0?n:t}function Mn(n){return Math.max(0,Math.min(1,n))}function E2(n){return Math.max(0,Math.min(255,Math.round(n)))}function ie(n){return n<=0.0031308?12.92*n:1.055*n**0.4166666666666667-0.055}function Ps(n,t,e){let r=e*Math.PI/180,a=t*Math.cos(r),l=t*Math.sin(r),d=(n+0.3963377774*a+0.2158037573*l)**3,s=(n-0.1055613458*a-0.0638541728*l)**3,i=(n-0.0894841775*a-1.291485548*l)**3;return{blue:E2(ie(Mn(-0.0041960863*d-0.7034186147*s+1.707614701*i))*255),green:E2(ie(Mn(-1.2684380046*d+2.6097574011*s-0.3413193965*i))*255),red:E2(ie(Mn(4.0767416621*d-3.3077115913*s+0.2309699292*i))*255)}}function ce(n,t){let e=(t*n*180/Math.PI%360+360)%360;return Ps(0.72,0.15,e)}function f1(n,t=0.1){let e=ce(t,n);return`\x1B[38;2;${e.red};${e.green};${e.blue}m`}function Is(n,t){return{blue:E2(n.blue+(255-n.blue)*t),green:E2(n.green+(255-n.green)*t),red:E2(n.red+(255-n.red)*t)}}function y1(n,t,e){let r=Math.imul(n+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(e+374761393,2654435761),a=r^r>>>15,l=Math.imul(a,739982445),d=l^l>>>12,s=Math.imul(d,695872825);return((s^s>>>15)>>>0)/4294967296}function Ns(n,t,e){let r=Math.floor(y1(n,t,e)*p1.length);return p1[r]??"░"}function u1(n){let t=Mn(n);return t*t*t*(t*(t*6-15)+10)}function ni(n){if(n.length===0)return"";let t=[],e=!1,r="";for(let a of n){let l=`${a.red};${a.green};${a.blue}`;if(a.bold!==e)t.push(a.bold?"\x1B[1m":"\x1B[22m"),e=a.bold;if(l!==r)t.push(`\x1B[38;2;${l}m`),r=l;t.push(a.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function ti(n,t,e,r,a){return n.map((l,d)=>({...ce(e,r+t+d/a),bold:!1,character:l}))}function ei(n,t,e,r,a,l,d,s){let i=Math.max(1,r*0.75),c=Math.min(1,e/i),L=a*u1(c),p=Math.max(0,(e-i)/Math.max(1,r-i)),u=(1-u1(e/r))*s*2,o=0.35*Math.max(0,1-p*2),b=c>=1,v=Math.min(n.length,Math.ceil(L+2+1));return n.slice(0,v).map((f,w)=>{let x=ce(l,d+t+w/s+u),h=w+y1(t,w,7919)*2-1;if(h>L+2)return{...x,bold:!1,character:" "};let J=L-h,J2=0.8*Math.exp(-(J*J)/12.5),rn=Math.min(0.9,J2+o),ht=!b&&h>L-4;return{...Is(x,rn),bold:rn>0.3,character:ht?Ns(t,w,e):f}})}function v1(n){return`\x1B[?2026h${n.map((t,e)=>`\x1B8${e>0?b1(e):""}${ni(t)}`).join("")}\x1B[?2026l`}async function Le(n,t={}){if(!n)return;let e=t.output??process.stdout,r=t.sleep??Es,a=wn(t.frequency,0.1),l=t.seed??0,d=wn(t.speed,40),s=wn(t.spread,3),i=wn(t.frameRate,60),c=Math.max(1,Math.floor(wn(t.duration,12))),L=n.split(`
...
`.repeat(L.length-1)}${Ts(L.length-1)}`:""}\x1B7`);try{for(let v=1;v<=o;v+=1){if(t.signal?.aborted)break;e.write(v1(L.map((f,w)=>ei(f,w,v,o,p,a,l,s)))),await _s(b,r,t.signal)}}finally{if(e.write(v1(L.map((v,f)=>ti(v,f,a,l,s)))),e.write("\x1B8"),L.length>1)e.write(b1(L.length-1));e.write(`
\x1B[0m\x1B[?25h`)}}var h1=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function ri(n){return Boolean(n.isTTY)}async function Kn(n={}){let t=n.output??process.stdout;if(!ri(t))return;let e=n.input??process.stdin,r={duration:n.duration,frequency:n.frequency,output:t,seed:n.seed??Math.random()*8192,sleep:n.sleep,speed:n.speed,spread:n.spread};if(!e.isTTY||typeof e.setRawMode!=="function"){await Le(h1,r);return}let a=new AbortController,l=e.readableFlowing===!0,d=e.isRaw===!0,s=!1,i=(c,L)=>{if(L.ctrl&&L.name==="c")s=!0;if(s||L.name==="return"||L.name==="enter")a.abort()};w1.emitKeypressEvents(e),e.on("keypress",i),e.setRawMode(!0),e.resume();try{await Le(h1,{...r,signal:a.signal})}finally{if(e.off("keypress",i),e.setRawMode(d),!l)e.pause()}if(!s)return;if(n.onInterrupt){n.onInterrupt();return}process.kill(process.pid,"SIGINT")}var x1="\r\x1B[2K",ai="\x1B[?25l",li="\x1B[39m",di="\x1B[?25h",si=100,ii=0.55,ci=80,$1=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function Li(n){return new Promise((t)=>setTimeout(t,n))}async function oi(n,t){let e=t.output??process.stdout;if(!e.isTTY){await n;return}let r=t.sleep??Li,a=!1,l=n.then((s)=>{return a=!0,s},(s)=>{throw a=!0,s});if(await Promise.race([l.then(()=>!0),r(si).then(()=>!1)]))return;e.write(ai);try{for(let s=0;!a;s+=1)e.write(`${x1}${f1(s*ii)}${$1[s%$1.length]}${li} ${t.loadingMessage??"Loading…"}`),await Promise.race([l,r(ci)]);await l}finally{e.write(`${x1}${di}`)}}async function Vn(n,t,e,r={}){let a=t();if(n)await e();if(n&&a.ready)await oi(a.ready,r);return a.finish()}import{homedir as mc}from"node:os";import{stripVTControlCharacters as pi}from"node:util";var Cn="amp plugins list",ui=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function m1(n){if(!n.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=pi(n.ampPluginListOutput).split(`
`).map((e)=>ui.exec(e)?.[1]).find((e)=>e!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:Cn,configPath:Cn,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:Cn,configPath:Cn}}import{existsSync as bi,readFileSync as fi}from"node:fs";import{join as vi}from"node:path";function xn(n){return vi(n,".gemini","config","hooks.json")}var yi=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function hi(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];return Object.values(n).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let e=t,r=e.PreToolUse;if(!Array.isArray(r))return[];return r.flatMap((a)=>{if(!a||typeof a!=="object"||Array.isArray(a))return[];let l=a.hooks;if(!Array.isArray(l))return[];return l.flatMap((d)=>{if(!d||typeof d!=="object"||Array.isArray(d))return[];let s=d.command;if(typeof s!=="string"||!yi.test(s))return[];return[{command:s,enabled:e.enabled!==!1}]})})})}function g1(n){let t=xn(n.homeDir);if(!bi(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let e;try{e=hi(JSON.parse(fi(t,"utf-8")))}catch(r){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${r instanceof Error?r.message:String(r)}`]}}if(e.some((r)=>r.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(e.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as D1}from"node:path";import{existsSync as wi,lstatSync as xi,readFileSync as $i}from"node:fs";function n2(n,t=(e)=>e){if(!wi(n))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t($i(n,"utf-8")))}}catch{return{kind:"unreadable"}}}function Y(n){try{return xi(n)}catch{return}}function Gn(n,t){let e=Y(t);if(!e)return{platform:n,status:"n/a",configPath:t};if(!e.isSymbolicLink()&&e.isDirectory())return;return{platform:n,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function $(n,t){return typeof n==="object"&&n!==null?n[t]:void 0}var oe="cc-safety-net@cc-marketplace";function k1(n){return D1(n,".claude","plugins","installed_plugins.json")}function q1(n,t){let e=$($(n,"plugins"),t);return Array.isArray(e)&&e.length>0}function Un(n,t){let e=n2(k1(n));return e.kind==="ok"&&q1(e.value,t)}function pe(n){let t=k1(n),e=n2(t);if(e.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(e.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!q1(e.value,oe))return{platform:"claude-code",status:"n/a"};let r=D1(n,".claude","settings.json"),a=n2(r);if(a.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(a.kind==="ok"&&$($(a.value,"enabledPlugins"),oe)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:r,errors:[`${oe} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function j1(n){return pe(n.homeDir)}function F1(n){if(!n.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=n.codexPluginListOutput.split(`
`).find((e)=>e.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as En,readdirSync as mi,readFileSync as gi}from"node:fs";import{join as M}from"node:path";var t2="cc-safety-net@cc-marketplace",On=["cc-marketplace","cc-safety-net"],z1=["_direct","copilot-safety-net"],B1=["cc-marketplace","safety-net"],J1="safety-net@cc-marketplace";function Tn(n,t){let e=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${e}([^a-z0-9-]|$)`,"m").test(n??"")}function S1(n){return Tn(n,"cc-safety-net@cc-marketplace")}function Z1(n){return Tn(n,"cc-marketplace")}function Q1(n){return Tn(n,"copilot-safety-net")}function X1(n){return Tn(n,"safety-net@cc-marketplace")}function W(n){let t="",e=0,r=!1,a=!1,l=-1;while(e<n.length){let d=n[e],s=n[e+1];if(a){t+=d,a=!1,e++;continue}if(d==='"'&&!r){r=!0,l=-1,t+=d,e++;continue}if(d==='"'&&r){r=!1,t+=d,e++;continue}if(d==="\\"&&r){a=!0,t+=d,e++;continue}if(r){t+=d,e++;continue}if(d==="/"&&s==="/"){while(e<n.length&&n[e]!==`
`)e++;continue}if(d==="/"&&s==="*"){e+=2;while(e<n.length-1){if(n[e]==="*"&&n[e+1]==="/"){e+=2;break}e++}continue}if(d===","){l=t.length,t+=d,e++;continue}if(d==="}"||d==="]"){if(l!==-1){let i=t.slice(l+1);if(/^\s*$/.test(i))t=t.slice(0,l)+i}l=-1,t+=d,e++;continue}if(!/\s/.test(d))l=-1;t+=d,e++}return t}function ue(n){if(!n?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(n)}function R1(n,t){if(!n)return null;let e=n.match(/(\d+)\.(\d+)\.(\d+)/);if(!e)return null;let r=[Number(e[1]),Number(e[2]),Number(e[3])];for(let a=0;a<t.length;a++){let l=r[a]??0,d=t[a]??0;if(l!==d)return l>d}return!0}function Di(n){return R1(n,[0,0,422])}function ki(n){return R1(n,[1,0,8])}function $n(n){return process.env.COPILOT_HOME||M(n,".copilot")}function be(n){return(n.hooks?.preToolUse??[]).some((e)=>{if(e.type!=="command")return!1;return ue(e.command)||ue(e.bash)||ue(e.powershell)})}function fe(n,t){try{return JSON.parse(W(gi(n,"utf-8")))}catch(e){t?.push(`Failed to parse ${n}: ${e instanceof Error?e.message:String(e)}`);return}}function H1(n,t){try{return mi(n).filter((e)=>e.endsWith(".json")).sort((e,r)=>e.localeCompare(r))}catch(e){return t?.push(`Failed to read ${n}: ${e instanceof Error?e.message:String(e)}`),[]}}function qi(n,t){if(!En(n))return[];let e=[];for(let r of H1(n,t)){let a=M(n,r),l=fe(a,t);if(l&&be(l))e.push(a)}return e}function ve(n,t){if(!En(n))return;let e=fe(n,t);if(!e)return;return{path:n,config:e}}function Y1(n,t,e,r){if(t){n.push(`GitHub Copilot CLI ${t} does not support ${e}; requires ${r}+`);return}n.push(`GitHub Copilot CLI version unavailable; skipping ${e} because it requires ${r}+`)}function ji(n){let t=[n.localSettings,n.repoSettings,n.userConfig];for(let e of t){if(e?.config.disableAllHooks===!0)return e.path;if(e?.config.disableAllHooks===!1)return}return}function Fi(n,t,e,r){let a=$n(n),l=M(t,".github","hooks"),d=M(a,"hooks"),s=M(t,".github","copilot"),i=ki(e),c=i===!0?r:void 0,L={userConfig:ve(M(a,"config.json"),c),repoSettings:ve(M(s,"settings.json"),c),localSettings:ve(M(s,"settings.local.json"),c)};if(i!==!1){let x=ji(L);if(x){if(i===null)r.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${x} as active`);return{activeConfigPaths:[],disabledBy:x}}}let p=qi(l,r),u=Di(e),o=u===!0?r:void 0,b=En(d)?H1(d,o):[],v=[];for(let x of b){let h=M(d,x),J=fe(h,o);if(J&&be(J))v.push(h)}if(u!==!0&&v.length>0)Y1(r,e,`user hook files in ${d}`,"0.0.422"),v.length=0;let f=[],w=[L.localSettings,L.repoSettings,L.userConfig];for(let x of w){if(!x)continue;if(!be(x.config))continue;if(i===!0){f.push(x.path);continue}Y1(r,e,"inline hook definitions in Copilot config files","1.0.8");break}return{activeConfigPaths:[...f.filter((x)=>x.endsWith("settings.local.json")),...f.filter((x)=>x.endsWith("settings.json")),...p,...f.filter((x)=>x.endsWith("config.json")),...v]}}function A1(n){let t=[],e=Fi(n.homeDir,n.cwd,n.copilotCliVersion,t);if(e.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:e.disabledBy,configPaths:[e.disabledBy],errors:t.length>0?t:void 0};let r=$n(n.homeDir),a=M(r,"installed-plugins",...On),l=En(a),d=M(r,"settings.json"),s=n2(d,W);if(l&&s.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(l&&s.kind==="ok"&&$($(s.value,"enabledPlugins"),t2)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:d,errors:[`${t2} is installed but not enabled in Copilot CLI`]};if(l||e.activeConfigPaths.length>0){let i=l,c=e.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:i?"plugin config":"hook config",configPath:c??(i?a:void 0),configPaths:e.activeConfigPaths.length>0?e.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as Hi,readFileSync as Ai}from"node:fs";import{existsSync as W1,mkdirSync as Ji,readFileSync as Si}from"node:fs";import{dirname as Zi,join as Qi}from"node:path";import{renameSync as zi,writeFileSync as Bi}from"node:fs";function B(n,t){let e=`${n}.${process.pid}.tmp`;Bi(e,t),zi(e,n)}var mn="npx -y cc-safety-net hook --cursor",M1=30;function Pn(n){return Qi(n,".cursor","hooks.json")}function D2(n){return typeof n==="object"&&n!==null&&!Array.isArray(n)}function ye(){return{command:mn,timeout:M1,failClosed:!0}}function _n(n){return D2(n)&&n.command===mn}function Xi(n){return Object.keys(n).length===3&&n.command===mn&&n.timeout===M1&&n.failClosed===!0}function Yi(n){try{return JSON.parse(Si(n,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${n}: ${t.message}`);throw t}}function K1(n){let t=Yi(n);if(!D2(t))throw Error(`Cursor hooks config ${n} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${n} must set "version": 1`);if(t.hooks!==void 0&&!D2(t.hooks))throw Error(`Cursor hooks config ${n} "hooks" must be an object`);let e=D2(t.hooks)?t.hooks.preToolUse:void 0;if(e!==void 0&&!Array.isArray(e))throw Error(`Cursor hooks config ${n} "hooks.preToolUse" must be an array`);return t}function V1(n){let t=D2(n.hooks)?n.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function Ri(n){if(!n.some(_n))return[...n,ye()];return n.reduce((t,e)=>{if(!_n(e))return t.result.push(e),t;if(!t.inserted)t.result.push(ye()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function C1(n,t,e){let r=D2(t.hooks)?t.hooks:{},a={...t,hooks:{...r,preToolUse:e}};B(n,`${JSON.stringify(a,null,2)}
`)}function G1(n){let t=Pn(n);if(!W1(t))return Ji(Zi(t),{recursive:!0}),B(t,`${JSON.stringify({version:1,hooks:{preToolUse:[ye()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let e=K1(t),r=V1(e),a=r.filter(_n);if(D2(e.hooks)&&Array.isArray(e.hooks.preToolUse)&&a.length===1&&a[0]!==void 0&&Xi(a[0]))return{path:t,alreadyInstalled:!0};return C1(t,e,Ri(r)),{path:t,alreadyInstalled:!1}}function U1(n){let t=Pn(n);if(!W1(t))return{path:t,alreadyInstalled:!1};let e=K1(t),r=V1(e),a=r.filter((l)=>!_n(l));if(a.length===r.length)return{path:t,alreadyInstalled:!1};return C1(t,e,a),{path:t,alreadyInstalled:!0}}function Wi(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];let t=n.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let e=t.preToolUse;if(!Array.isArray(e))return[];return e.filter((r)=>!!r&&typeof r==="object"&&!Array.isArray(r)&&r.command===mn)}function Mi(n){let t=[];if(n.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let e=n[0];if(e&&e.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(e&&e.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function O1(n){let t=Pn(n.homeDir);if(!Hi(t))return{platform:"cursor",status:"n/a",configPath:t};let e;try{e=JSON.parse(Ai(t,"utf-8"))}catch(l){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${l instanceof Error?l.message:String(l)}`]}}let r=Wi(e);if(r.length===0)return{platform:"cursor",status:"n/a",configPath:t};let a=Mi(r);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:a.length>0?a:void 0}}import{existsSync as Ki}from"node:fs";import{join as he}from"node:path";var we="gemini-safety-net";function xe(n){let t=he(n,".gemini","extensions"),e=he(t,we);if(!Ki(e))return{platform:"gemini-cli",status:"n/a"};let r=he(t,"extension-enablement.json"),a=n2(r);if(a.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let l=a.kind==="ok"?$($(a.value,we),"overrides"):void 0;if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:r,errors:[`${we} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:e}}function T1(n){return xe(n.homeDir)}import{readFileSync as r0}from"node:fs";import{join as a0}from"node:path";var K="cc-safety-net",E1="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function _1(n){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${n}
`}function Vi(n){return`${_1(n)}name: cc-safety-net
version: "${n}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function Ci(n){return`${_1(n)}"""CC Safety Net guard for Hermes Agent.
...
`}function gn(n){return[{name:"__init__.py",content:Ci(n)},{name:"plugin.yaml",content:Vi(n)}]}import{mkdirSync as Gi,readdirSync as Ui,readFileSync as Oi,rmSync as $e}from"node:fs";import{join as k2}from"node:path";var Ti="__pycache__";function me(n){let t=process.env.HERMES_HOME?.trim();return t?t:k2(n,".hermes")}function ge(n){return k2(me(n),"plugins",K)}function De(n){return n.startsWith(E1)}function ke(n,t){let e=ge(n),r=Y(e);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${e}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return e}function P1(n,t){let e=Y(n);if(!e)return;if(e.isSymbolicLink()||!e.isFile())throw Error(`Refusing to ${t} ${n}: not a regular file. Move or remove it.`);let r=Oi(n,"utf-8");if(!De(r))throw Error(`Refusing to ${t} unmanaged file at ${n}. Move or remove it.`);return r}function I1(n){let t=ke(n,"install"),e=gn(j());if(e.map((a)=>P1(k2(t,a.name),"overwrite")).every((a,l)=>a===e[l]?.content))return{path:t,alreadyInstalled:!0};return Gi(t,{recursive:!0}),e.forEach((a)=>{B(k2(t,a.name),a.content)}),{path:t,alreadyInstalled:!1}}function qe(n){let t=ke(n,"remove");if(!Y(t))return[];return gn(j()).filter((e)=>P1(k2(t,e.name),"remove")!==void 0)}function N1(n){let t=ke(n,"remove");if(!Y(t))return{path:t,alreadyInstalled:!1};let e=qe(n);if(e.forEach((r)=>{$e(k2(t,r.name))}),$e(k2(t,Ti),{recursive:!0,force:!0}),Ui(t).length===0)$e(t,{recursive:!0});return{path:t,alreadyInstalled:e.length>0}}var In="hermes-agent",n0=/^([^\s#][^:]*):/,Ei=/^\s+([A-Za-z_][\w-]*):/,t0=/^\s+-\s*(.*)$/;function _i(n){return n.trim().replace(/^(["'])(.*)\1$/,"$2")}function Pi(n){let t=n.split(/\r?\n/),e=t.findIndex((l)=>n0.exec(l)?.[1]?.trim()==="plugins");if(e===-1)return[];let r=t.slice(e+1),a=r.findIndex((l)=>n0.test(l));return a===-1?r:r.slice(0,a)}function e0(n,t){let e=Pi(n),r=e.findIndex((d)=>Ei.exec(d)?.[1]===t);if(r===-1)return[];let a=e.slice(r+1),l=a.findIndex((d)=>!t0.test(d));return(l===-1?a:a.slice(0,l)).map((d)=>_i(t0.exec(d)?.[1]??""))}function Ii(n){try{return r0(a0(me(n),"config.yaml"),"utf-8")}catch{return}}function je(n){let t=Ii(n)??"";return e0(t,"enabled").includes(K)&&!e0(t,"disabled").includes(K)}function l0(n){return/^# version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function Ni(n,t){let e=Y(n);if(!e)return{error:`${t.name} is missing from ${n}; run install --hermes-agent`};if(e.isSymbolicLink()||!e.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{let r=r0(n,"utf-8");if(!De(r))return{error:`Unmanaged ${t.name} occupies ${n}; move or remove it`};if(l0(r)===j()&&r!==t.content)return{error:`Modified ${t.name} occupies ${n}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${n}: ${r instanceof Error?r.message:String(r)}`}}}function d0(n){let t=ge(n.homeDir),e=Gn(In,t);if(e)return e;let r=gn(j()).map((s)=>Ni(a0(t,s.name),s)),a=r.flatMap((s)=>("error"in s)?[s.error]:[]);if(a.length>0)return{platform:In,status:"n/a",configPath:t,errors:a};let l=r.some((s)=>("content"in s)&&l0(s.content)!==j()),d=l?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!je(n.homeDir))return{platform:In,status:"disabled",method:"plugin directory",configPath:t,errors:[`${K} is not enabled in Hermes; run \`hermes plugins enable ${K}\``,...d]};return{platform:In,status:"configured",method:"plugin directory",configPath:t,errors:l?d:void 0}}import{existsSync as nc,readFileSync as tc}from"node:fs";import{join as s0}from"node:path";var ec=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function rc(n){return s0(process.env.KIMI_CODE_HOME||s0(n,".kimi-code"),"config.toml")}function i0(n){let t=rc(n.homeDir);if(!nc(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!ec.test(tc(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(e){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${e instanceof Error?e.message:String(e)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as w0}from"node:fs";import{join as kn}from"node:path";var q="cc-safety-net",V="index.js",_2="openclaw.plugin.json",P2="package.json";var Nn="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as dc,lstatSync as sc,readdirSync as ic,readFileSync as cc}from"node:fs";import{dirname as p0,join as q2}from"node:path";import{fileURLToPath as Lc}from"node:url";import{spawnSync as ac}from"node:child_process";function lc(n){return n.join(" ")}function c0(n,t,e){return[`Failed to run ${lc(n)}${t===null?"":` (exit ${t})`}.`,e.trim()].filter(Boolean).join(`
`)}function e2(n,t){let e=ac(n[0],n.slice(1),{encoding:"utf-8",stdio:"pipe"}),r=[e.stdout,e.stderr].filter(Boolean).join(`
`);if(e.error)throw Error(c0(n,null,`${e.error.message}
${r}`.trim()));if(e.status!==0)throw Error(c0(n,e.status,r));return t?.stdoutOnly?e.stdout:r}function Fe(n){n.forEach((t)=>{e2(t)})}function L0(n){n.forEach((t)=>{try{e2(t)}catch(e){console.warn(e instanceof Error?e.message:String(e))}})}var o0=q2("openclaw",q),oc=[V,_2,P2];function u0(n){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return t;let e=process.env.OPENCLAW_CONFIG_PATH?.trim();return e?p0(e):q2(n,".openclaw")}function v0(n){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?t:q2(u0(n),"openclaw.json")}function ze(n){return q2(u0(n),"extensions",q)}function pc(n){let t=ic(n);if(t.length===0)return!0;if(t.some((a)=>!oc.includes(a)))return!1;let e=q2(n,V),r=Y(e);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&cc(e,"utf-8").startsWith(Nn)}function Be(n){let t=ze(n),e=Y(t);if(!e)return;if(!e.isSymbolicLink()&&e.isDirectory()&&pc(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function b0(){let n=p0(Lc(import.meta.url));return[q2(n,"..",o0),q2(n,"..","..","..","dist",o0)]}function Je(n=b0()){return n.find((t)=>dc(t)&&sc(t).isDirectory())}function uc(n=b0()){let t=Je(n);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function f0(n=uc()){return[["openclaw","plugins","install",n,"--force"],["openclaw","plugins","enable",q]]}function vc(n){let t=(()=>{try{return JSON.parse(n)}catch{return}})(),e=$($(t,"plugin"),"status");return typeof e==="string"?e:void 0}function y0(){let n=vc(e2(["openclaw","plugins","inspect",q,"--runtime","--json"],{stdoutOnly:!0}));if(n==="loaded")return;throw Error(`${n===void 0?`The ${q} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${q} plugin with status "${n}".`} Run \`openclaw plugins inspect ${q} --runtime\` for details.`)}var nt="openclaw",Dn=`run \`openclaw plugins enable ${q}\``;function I2(n,t){let e=kn(n,t),r=Y(e);if(!r)return{error:`${t} is missing from ${e}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{return{content:w0(e,"utf-8")}}catch(a){return{error:`Failed to read ${e}: ${a instanceof Error?a.message:String(a)}`}}}function x0(n){try{return JSON.parse(W(n))}catch{return}}function bc(n){let t=I2(n,_2);if("error"in t)return t.error;if($(x0(t.content),"id")===q)return;return`${kn(n,_2)} is not a valid ${q} manifest; run install --openclaw`}function fc(n){let t=I2(n,P2);if("error"in t)return t.error;let e=$($(x0(t.content),"openclaw"),"extensions");if(Array.isArray(e)&&e.includes(`./${V}`))return;return`${kn(n,P2)} does not point OpenClaw at ${V}; run install --openclaw`}function h0(n){return Array.isArray(n)?n.filter((t)=>typeof t==="string"):[]}function yc(n){let t=v0(n);if(!Y(t))return`${q} is not enabled; ${Dn}`;let e=(()=>{try{return JSON.parse(W(w0(t,"utf-8")))}catch{return}})();if(e===void 0)return`Failed to read ${t}; fix it, then ${Dn}`;let r=$(e,"plugins");if($(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let a=$($($(r,"entries"),q),"enabled");if(h0($(r,"deny")).includes(q)||a===!1)return`${q} is disabled in ${t}; ${Dn}`;let l=h0($(r,"allow"));if(l.length>0&&!l.includes(q))return`plugins.allow in ${t} does not list ${q}; add it, then ${Dn}`;if(l.includes(q)||a===!0)return;return`${q} is not enabled; ${Dn}`}function $0(n){return/^\/\/ version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function hc(n,t,e){if(e===void 0)return[];let r=I2(e,V);if("error"in r||$0(r.content)!==t)return[];return[V,_2,P2].flatMap((a)=>{let l=I2(n,a),d=I2(e,a);if("error"in l||"error"in d||l.content===d.content)return[];return[`Modified ${a} occupies ${kn(n,a)}; run install --openclaw to restore it`]})}function m0(n){let t=ze(n.homeDir),e=Gn(nt,t);if(e)return e;let r=I2(t,V),l=["error"in r?r.error:r.content.startsWith(Nn)?void 0:`Unmanaged ${V} occupies ${kn(t,V)}; move or remove it`,bc(t),fc(t)].filter((L)=>L!==void 0),d="content"in r?$0(r.content):void 0,s=l.length>0?l:hc(t,d,Je());if(s.length>0)return{platform:nt,status:"n/a",configPath:t,errors:s};let i=d===j()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],c=yc(n.homeDir);if(c)return{platform:nt,status:"disabled",method:"plugin directory",configPath:t,errors:[c,...i]};return{platform:nt,status:"configured",method:"plugin directory",configPath:t,errors:i.length>0?i:void 0}}import{existsSync as wc,readFileSync as xc}from"node:fs";import{join as g0}from"node:path";function D0(n){let t=[],e=g0(n.homeDir,".config","opencode"),r=["opencode.json","opencode.jsonc"];for(let a of r){let l=g0(e,a);if(wc(l))try{let d=xc(l,"utf-8"),s=W(d);if((JSON.parse(s).plugin??[]).some((p)=>p.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:l,errors:t.length>0?t:void 0}}catch(d){t.push(`Failed to parse ${a}: ${d instanceof Error?d.message:String(d)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as $c}from"node:path";function Se(n){return $c(n,".pi","agent","settings.json")}function Ze(n){if(typeof n!=="string")return!1;return n==="npm:cc-safety-net"||n.startsWith("npm:cc-safety-net@")}function k0(n){let t=Se(n.homeDir),e=n2(t);if(e.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(e.kind==="missing")return{platform:"pi",status:"n/a"};let r=$(e.value,"packages");if(!Array.isArray(r))return{platform:"pi",status:"n/a"};let a=r.find((s)=>Ze(typeof s==="string"?s:$(s,"source")));if(a===void 0)return{platform:"pi",status:"n/a"};let l=$(a,"extensions");if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var gc={amp:m1,"antigravity-cli":g1,"claude-code":j1,codex:F1,"copilot-cli":A1,cursor:O1,"gemini-cli":T1,"hermes-agent":d0,"kimi-code":i0,openclaw:m0,opencode:D0,pi:k0};function N2(n,t){let e={...t,cwd:n,homeDir:t?.homeDir??mc()};return $a.map((r)=>Dc(gc[r](e)))}function Dc(n){if(n.status==="not-inspected")return{platform:n.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:n.platform,detected:n.status!=="n/a",configured:n.status==="configured",inspectionStatus:n.status!=="n/a"?"verified":n.errors&&n.errors.length>0?"failed":"not-applicable",method:n.method,configPath:n.configPath,configPaths:n.configPaths,errors:n.errors}}import{tmpdir as kc}from"node:os";import{join as qc}from"node:path";var jc=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),Fc=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([])})})}),zc={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}},sources:{failClosed:[],paranoidRm:[],paranoidInterpreters:[],worktreeMode:[]}};function q0(){let n=qc(kc(),"cc-safety-net-self-test"),t=jc.map((e)=>{let r=Xn(M2("self-test",{command:e.command},{kind:"command",shell:"auto"},{configCwd:n,executionCwd:n},e.command),{guard:{dependencies:{loadPolicySnapshot:()=>Fc,getModes:()=>zc,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),a=e.expectBlocked?"blocked":"allowed",l=r.decision.kind==="deny"?"blocked":"allowed";return{command:e.command,description:e.description,expected:a,actual:l,passed:a===l,reason:r.decision.kind==="deny"?r.decision.reason:void 0,ruleId:r.decision.kind==="deny"?r.decision.ruleId:void 0}});return{passed:t.filter((e)=>e.passed).length,failed:t.filter((e)=>!e.passed).length,total:t.length,results:t}}function Qe(n){let t=F({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},n);if(r2(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function j0(n={}){let t=await Vn(!n.json,()=>{let e=Bc(n);return{ready:e,finish:()=>e}},()=>Kn(),{loadingMessage:"Checking system status…"});if(n.json)console.log(JSON.stringify(t,null,2));else Sc(t);return Jc(t.hooks,t.engineSelfTest,{userConfig:t.userConfig,projectConfig:t.projectConfig})?1:0}async function Bc(n){let t=n.cwd??process.cwd(),e=await hn(),r=N2(t,{ampPluginListOutput:e.ampPluginListOutput,codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.copilotCliVersion}),a=Ua(t),l=Oa(),d=A({cwd:t}),s=d.policy,i=d2(s),c=x2(s,i.capabilities),L=An(7),p=n.skipUpdateCheck?{currentVersion:j(),latestVersion:null,updateAvailable:!1}:await T2(),u={hooks:r,engineSelfTest:q0(),userConfig:a.userConfig,projectConfig:a.projectConfig,configState:un(d),effectiveRules:a.effectiveRules,shadowedRules:a.shadowedRules,environment:l,effectiveSafety:{selectedPreset:s.safety.level??"standard",level:i.effectiveLevel,capabilities:i.capabilities,ruleOverrides:s.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(c).filter(([,o])=>o.source==="rule_override"&&o.override==="off"&&o.inheritedEnabled&&o.changesInherited).map(([o])=>o),ruleCounts:{stored:Object.keys(s.destructiveCommandRuleOverrides).length,effective:Object.values(c).filter((o)=>o.changesInherited).length}},posture:s1(a.userConfig.path),activity:L,update:p,system:e};return{...u,findings:Ea(u)}}function Jc(n,t,e){return n.length>0&&n.every((r)=>!r.configured)||n.some((r)=>r.inspectionStatus==="failed")||t.failed>0||e.userConfig.exists&&!e.userConfig.valid||e.projectConfig.exists&&!e.projectConfig.valid}function Sc(n){console.log(),console.log(Pa(n.hooks)),console.log(),console.log(Ia(n.engineSelfTest)),console.log(),console.log(Na(n)),console.log(),console.log(n1(n.environment)),console.log(),console.log(t1(n)),console.log(),console.log(e1(n.findings)),console.log(),console.log(r1(n.activity)),console.log(),console.log(l1(n.system)),console.log(),console.log(a1(n.update)),console.log(d1(n))}import{existsSync as Zc}from"node:fs";var Qc=/^[A-Za-z0-9_@%+=:,./-]+$/,F0="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function Xe(n){let t=F({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},n);if(r2(t.errors))return console.error(F0),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!Zc(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let e=t.positionals.length===1?t.positionals[0]:t.positionals.map((r)=>Qc.test(r)?r:`'${r.replaceAll("'","'\\''")}'`).join(" ");if(!e)return console.error("Error: No command provided"),console.error(F0),null;return{json:t.flags.json,cwd:t.values.cwd,command:e}}function z0(n){if(n)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function B0(n,t){let r=t-18;return[`${n.dtl}${n.dh.repeat(t)}${n.dtr}`,`${n.dv}  Command Analysis${" ".repeat(r)}${n.dv}`,`${n.dbl}${n.dh.repeat(t)}${n.dbr}`]}function Ye(n){return JSON.stringify(n)}function J0(n,t=0){return`[${n.map((r,a)=>_a(r,a,t)).join(",")}]`}function tt(n,t,e=70){let r=n.split(" "),a=[],l="";for(let d of r)if(l&&l.length+d.length+1>e)a.push(l),l=d;else l=l?`${l} ${d}`:d;if(l)a.push(l);return a.map((d,s)=>s===0?d:`${t}${d}`)}function S0(n,t,e){let r=[];switch(n.type){case"parse":return null;case"env-strip":{r.push(""),r.push(`STEP ${t} ${e.h} Strip environment variables`);let a=Object.keys(n.envVars);return r.push(`  Removed: ${a.map((l)=>`${l}=<redacted>`).join(", ")}`),r.push(`  Tokens:  ${Ye(n.output)}`),{lines:r,incrementStep:!0}}case"leading-tokens-stripped":return r.push(""),r.push(`STEP ${t} ${e.h} Strip wrappers`),r.push(`  Removed: ${n.removed.join(", ")}`),r.push(`  Tokens:  ${Ye(n.output)}`),{lines:r,incrementStep:!0};case"shell-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Detect shell wrapper`),r.push(`  Wrapper: ${n.wrapper} -c`),r.push(`  Inner:   ${n.innerCommand}`),{lines:r,incrementStep:!0};case"interpreter":{if(r.push(""),r.push(`STEP ${t} ${e.h} Detect interpreter`),r.push(`  Interpreter: ${n.interpreter}`),r.push(`  Code:        ${n.codeArg}`),n.paranoidBlocked)r.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:r,incrementStep:!0}}case"busybox":return r.push(""),r.push(`STEP ${t} ${e.h} Busybox wrapper`),r.push(`  Subcommand: ${n.subcommand}`),{lines:r,incrementStep:!0};case"transparent-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Transparent wrapper`),r.push(`  Wrapper: ${n.wrapper}`),r.push(`  Tokens:  ${Ye(n.output)}`),{lines:r,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{r.push(""),r.push(`STEP ${t} ${e.h} Match rules`);let a=`${n.ruleModule}:${n.ruleFunction}()`;if(r.push(`  Rule:   ${a}`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}case"worktree-relaxation":return r.push(""),r.push(`STEP ${t} ${e.h} Worktree relaxation`),r.push(`  Mode:   ${D.worktree.name}`),r.push(`  Git cwd: ${n.gitCwd}`),r.push("  Result: Allowed local discard in linked worktree"),{lines:r,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(n.embeddedCommandFound)return r.push(""),r.push(`STEP ${t} ${e.h} Fallback scan`),r.push(`  Found: ${n.embeddedCommandFound}`),{lines:r,incrementStep:!0};return null}case"custom-rules-check":{if(n.rulesChecked){if(r.push(""),r.push(`STEP ${t} ${e.h} Custom rules`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(n.matched)return r.push(""),r.push(`STEP ${t} ${e.h} Dangerous text check`),r.push(`  Token:  ${n.token}`),r.push("  Result: MATCHED"),{lines:r,incrementStep:!0};return null}case"strict-unparseable":return r.push(""),r.push(`STEP ${t} ${e.h} Strict mode check`),r.push(`  Command: ${n.rawCommand}`),r.push("  Result:  ✗ UNPARSEABLE"),{lines:r,incrementStep:!0};case"segment-skipped":return null;case"error":return r.push(""),r.push(`ERROR: ${n.message}`),{lines:r,incrementStep:!1};default:return null}}function Re(n,t){let e=z0(t?.asciiOnly??!1),r=58,a=[],l=1;a.push(...B0(e,58)),a.push("");let d=n.trace.steps.find((o)=>o.type==="error");if(d&&d.type==="error"){a.push("ERROR"),a.push(`  ${d.message}`),a.push(""),a.push("RESULT"),a.push(`  Status: ${n.result==="blocked"?y.red("BLOCKED"):y.green("ALLOWED")}`),a.push(""),a.push("CONFIG");let o=n.configSource??"none";return a.push(`  Path: ${o}`),a.join(`
`)}let s=n.trace.steps.find((o)=>o.type==="parse");if(s&&s.type==="parse"){a.push("INPUT"),a.push(`  ${s.input}`),a.push(""),a.push(`STEP ${l} ${e.h} Split shell commands`),l++;for(let o=0;o<s.segments.length;o++){let b=s.segments[o];if(b){let v=Math.random();a.push(`  Segment ${o+1}: ${J0(b,v)}`)}}}let i=n.trace.segments,c=i.length>1;for(let o of i){if(c){a.push("");let w="";if(s&&s.type==="parse"){let wt=s.segments[o.index];if(wt)w=wt.join(" ")}let x=54,h=w,J=` Segment ${o.index+1}: `,J2=" ";if(w){if(J.length+w.length+J2.length>x){let xd=x-J.length-J2.length;h=`${w.substring(0,xd-1)}…`}}let rn=w?`${J}${h}${J2}`:` Segment ${o.index+1} `,ht=w?`${J}${y.cyan(h)}${J2}`:rn,ur=58-rn.length,vr=Math.floor(ur/2),wd=ur-vr;a.push(`${e.sh.repeat(vr)}${ht}${e.sh.repeat(wd)}`)}if(o.steps.find((w)=>w.type==="segment-skipped")){a.push(""),a.push("  (skipped — prior segment blocked)");continue}let v=!1,f=!1;for(let w of o.steps){let x=S0(w,l,e);if(x){if(f=!0,w.type==="recurse"){a.push("");let h=" RECURSING ",J=58-h.length-4;a.push(`  ${e.tl}${e.h}${h}${e.h.repeat(J)}`),a.push(`  ${e.v}`),v=!0;continue}for(let h of x.lines)if(v)a.push(`  ${e.v} ${h}`);else a.push(h);if(x.incrementStep)l++}}if(v)a.push(`  ${e.v}`),a.push(`  ${e.bl}${e.h.repeat(56)}`),v=!1;if(!f)a.push(""),a.push(`  ${y.green("✓")} Allowed (no matching rules)`)}if(a.push(""),a.push("RESULT"),n.result==="blocked"){if(a.push(`  Status: ${y.red("BLOCKED")}`),n.customRule){if(a.push(`  Rule: ${n.customRule.id}`),n.customRule.rulebook)a.push(`  Rulebook: ${n.customRule.rulebook.name} ${n.customRule.rulebook.version}`);if(n.customRule.source)a.push(`  Source: ${n.customRule.source}`);if(n.customRule.override)a.push(`  Override: reason ${n.customRule.override.reason}`)}if(n.reason){let o=tt(n.reason,"          ");a.push(`  Reason: ${o[0]}`);for(let b=1;b<o.length;b++)a.push(o[b]??"")}}else a.push(`  Status: ${y.green("ALLOWED")}`);a.push(""),a.push("CONFIG");let L=n.configSource??"none",p=n.configValid?"":" (invalid)";a.push(`  Path: ${L}${p}`),a.push(`  Safety preset: ${n.selectedPreset??"standard"}`),a.push(`  Effective capabilities: ${n.effectiveLevel}`);let u=Object.entries(n.destructiveCommandRuleOverrides??{});if(a.push(`  Rule customizations: ${u.length}`),n.ruleActivation)a.push(`  Rule activation: ${n.ruleActivation.id} — ${n.ruleActivation.enabled?"on":"off"} via ${n.ruleActivation.source}`);return a.join(`
`)}function He(n){return JSON.stringify(n,null,2)}var Z0="2.0.1",C="  ",j2="cc-safety-net";function Q0(n){return n.argument?`${n.flags} ${n.argument}`:n.flags}function Xc(n){return Math.max(...n.map((t)=>Q0(t).length))}function Yc(n){return Math.max(...n.map((t)=>t.usage.length))}function Rc(n){return Math.max(...n.map((t)=>`${j2} ${t.usage}`.length))}function Hc(n,t){let e=`${j2} ${n.usage}`;return`${C}${e.padEnd(t+2)}${n.description}`}function L2(n,t){return`${C}${n.padEnd(Math.max(40,n.length+2))}${t}`}function et(n,t=console.log){let e=[];if(e.push(`${j2} ${n.name}`),e.push(""),e.push(`${C}${n.description}`),e.push(""),e.push("USAGE:"),e.push(`${C}${j2} ${n.usage}`),e.push(""),n.subcommands&&n.subcommands.length>0){e.push("SUBCOMMANDS:");let r=Yc(n.subcommands);for(let a of n.subcommands)e.push(`${C}${a.usage.padEnd(r+2)}${a.description}`);e.push("")}if(n.options.length>0){e.push("OPTIONS:");let r=Xc(n.options);for(let a of n.options){let l=Q0(a),d=a.default?`${a.description} (default: ${a.default})`:a.description;e.push(`${C}${l.padEnd(r+2)}${d}`)}e.push("")}if(n.examples&&n.examples.length>0){e.push("EXAMPLES:");for(let r of n.examples)e.push(`${C}${r}`)}t(e.join(`
`))}function Ae(){let n=Ca(),t=Rc(n),e=[];e.push(`${j2} v${Z0}`),e.push(""),e.push("Blocks destructive commands and secret access."),e.push(""),e.push("COMMANDS:");for(let r of n)e.push(Hc(r,t));e.push(""),e.push("GLOBAL OPTIONS:"),e.push(`${C}-h, --help       Show help (use with command for command-specific help)`),e.push(`${C}-V, --version    Show version`),e.push(""),e.push("HELP:"),e.push(`${C}${j2} help <command>     Show help for a specific command`),e.push(`${C}${j2} <command> --help   Show help for a specific command`),e.push(""),e.push("ENVIRONMENT VARIABLES:"),e.push(L2(`${D.level.name}=standard|strict|paranoid`,"Set session safety level")),e.push(L2(`${D.worktree.name}=1`,"Allow local git discards in linked worktrees")),e.push(L2(`${D.debug.name}=1`,"Print diagnostic messages to stderr")),e.push(L2(`${D.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),e.push(L2("CC_SAFETY_NET_HOME","Override rule config home directory")),e.push(""),e.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),e.push(L2(`${D.strict.name}=1`,"Force safety.overrides.fail_closed on")),e.push(L2(`${D.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),e.push(L2(`${D.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),e.push(L2(`${D.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),e.push(""),e.push("Documentation:        https://ccsafetynet.com/docs"),console.log(e.join(`
`))}function X0(){console.log(Z0)}function qn(n,t=console.log){let e=Hn(n);if(!e)return!1;if(e.hidden||e.name.toLowerCase()!==n.toLowerCase())return!1;return et(e,t),!0}import{existsSync as tr,readFileSync as jl}from"node:fs";import{homedir as ML}from"node:os";import{join as Ne}from"node:path";import*as b2 from"node:readline";function Ac(n){return n==="install"?"Install":"Uninstall"}function Wc(n){return n==="install"?"Installing":"Uninstalling"}function Mc(n){return n==="install"?"into":"from"}function R0(n){return n?.available===!0}function Kc(n,t){let e=new Set(t);return n.filter((r)=>e.has(r.target)).map((r)=>r.target)}function Y0(n,t,e){if(n.length===0||n.every((r)=>!r.available))return t;return Array.from({length:n.length},(r,a)=>a+1).map((r)=>(t+r*e+n.length)%n.length).find((r)=>R0(n[r]))}function Vc(n,t,e){if(e.ctrl&&e.name==="c")return"interrupt";if(e.name==="escape"||t==="q")return"abort";if(n==="install"&&(t==="u"||t==="U"))return"update";if(e.name==="up"||t==="k")return"up";if(e.name==="down"||t==="j")return"down";if(e.name==="space"||t===" ")return"toggle";if(e.name==="return"||e.name==="enter")return"confirm";return null}function Cc(n){return{cursor:n.findIndex((t)=>t.available),selected:[]}}function Gc(n,t,e){if(e==="confirm"||e==="update"||e==="abort"||e==="interrupt")return{state:n,done:e};if(e==="up")return{state:{...n,cursor:Y0(t,n.cursor,-1)}};if(e==="down")return{state:{...n,cursor:Y0(t,n.cursor,1)}};let r=t[n.cursor];if(!R0(r))return{state:n};let a=n.selected.includes(r.target)?n.selected.filter((l)=>l!==r.target):Kc(t,[...n.selected,r.target]);return{state:{...n,selected:a}}}var Uc="◉",Oc="◯",Tc=">",Ec=" ";function _c(n,t,e,r={}){let a=r.color!==!1,l=a?y.dim:(i)=>i,d=a?y.green:(i)=>i,s=a?y.bold:(i)=>i;return["",`${Ac(n)} CC Safety Net ${Mc(n)}:`,"",...t.map((i,c)=>{let L=e.selected.includes(i.target),p=c===e.cursor,u=L?Uc:Oc,o=p?Tc:Ec,b=i.available?"":` (${i.unavailableReason??"not installed"})`,v=`${u} ${i.label}${b}`,f=!i.available?l(v):L?d(v):p?s(v):v;return`${o} ${f}`}),"",n==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((i)=>i.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${n}. q/Esc: close`].join(`
`)}function H0(n=process.stdin,t=process.stdout){return Boolean(n.isTTY&&t.isTTY&&typeof n.setRawMode==="function")}function A0(n,t,e={}){let r=e.input??process.stdin,a=e.output??process.stdout,l=Cc(t);b2.emitKeypressEvents(r);let d=r.isRaw===!0;r.setRawMode(!0),r.resume();let s=0,i=()=>{if(s===0)return;b2.moveCursor(a,0,-s),b2.cursorTo(a,0),b2.clearScreenDown(a)},c=()=>{i();let L=_c(n,t,l);a.write(`${L}
`),s=L.split(`
`).length};return new Promise((L)=>{let p=()=>{r.off("keypress",o),r.setRawMode(d),r.pause(),i()},u=(b)=>{if(p(),b!=="update"&&b&&b.length>0)a.write(`${Wc(n)} selected integrations...
`);L(b)};function o(b,v){let f=Vc(n,b,v);if(!f)return;let w=Gc(l,t,f);if(l=w.state,w.done==="interrupt"){u(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(w.done==="abort"){u(null);return}if(w.done==="update"){u("update");return}if(w.done==="confirm"){if(l.selected.length===0){a.write("\x07"),c();return}u([...l.selected]);return}c()}r.on("keypress",o),c()})}import{existsSync as Ic,lstatSync as M0,mkdtempSync as Nc,readFileSync as Ke,rmSync as K0}from"node:fs";import{tmpdir as nL}from"node:os";import{dirname as tL,join as F2}from"node:path";import{fileURLToPath as eL}from"node:url";var We="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp";import{spawnSync as Pc}from"node:child_process";var Me=(n,t)=>{let e=de([...n],process.env),r=Pc(e.cmd,e.args,{cwd:t,encoding:"utf-8",stdio:"pipe",timeout:120000});return{status:r.error?null:r.status,errorCode:r.error?.code,stdout:r.stdout??"",stderr:[r.error?.message,r.stderr].filter(Boolean).join(`
`)}};var W0=F2("amp","cc-safety-net.ts"),o2="cc-safety-net.ts";function rL(n){return F2(n,".config","amp","plugins",o2)}function aL(){let n=tL(eL(import.meta.url));return[F2(n,"..",W0),F2(n,"..","..","..","dist",W0)]}function lL(n=aL()){let t=n.find((e)=>Ic(e)&&M0(e).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function V0(n){try{return M0(n)}catch{return}}function dL(n){try{return JSON.parse(n)}catch{return}}function C0(n){return n.subarray(0,Buffer.byteLength(We)).toString("utf-8")===We}function rt(n,t,e){let r=n(t,e);if(r.status===0)return;throw Error([`Failed to run ${t.join(" ")}${r.status===null?"":` (exit ${r.status})`}.`,[r.stdout,r.stderr].filter(Boolean).join(`
`).trim()].filter(Boolean).join(`
`))}function G0(n){let t=n(["amp","plugins","repositories","--json"]);if(t.status===null)throw Error(`${t.errorCode==="ENOENT"?'Amp CLI not found. Install the amp CLI, sign in with "amp login", and rerun install --amp.':`amp plugins repositories --json did not finish (${t.errorCode??"terminated"}). Check that the amp CLI responds and rerun install --amp.`}
...
`)}`.trim());let e=dL(t.stdout),r=(Array.isArray(e)?e:[]).filter((a)=>$(a,"scope")==="user"&&$(a,"exists")===!0&&$(a,"viewerCanWrite")===!0).map((a)=>$(a,"cloneRef")).find((a)=>typeof a==="string"&&a.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}function U0(n,t){let e=Nc(F2(nL(),"cc-safety-net-amp-"));try{return rt(n,["amp","clone","user-plugins",e]),t(e)}finally{K0(e,{recursive:!0,force:!0})}}function O0(n,t){let e=F2(n,o2),r=V0(e);if(!r)return;if(r.isSymbolicLink()||!r.isFile())throw Error(`Refusing to ${t} ${o2} in your Amp personal plugins repository: not a regular file. Remove it there and rerun install --amp.`);let a=Ke(e);if(C0(a))return a;throw Error(`Refusing to ${t} unmanaged file ${o2} in your Amp personal plugins repository. Remove it there and rerun install --amp.`)}function T0(n,t,e,r){rt(n,e,t);let a=n(["git","status","--porcelain"],t);if(a.status===0&&a.stdout.trim()==="")return!1;return rt(n,["git","-c","commit.gpgsign=false","commit","-m",r],t),rt(n,["git","push","origin","HEAD"],t),!0}function at(n){let t=rL(n),e=V0(t);if(!e||e.isSymbolicLink()||!e.isFile())return;if(!C0(Ke(t)))return;K0(t)}function E0(n,t=lL(),e=Me){let r=Ke(t),a=G0(e);return U0(e,(l)=>{let d=`${a}/${o2}`;if(O0(l,"overwrite")?.equals(r))return at(n),{path:d,alreadyInstalled:!0};B(F2(l,o2),r);let s=T0(e,l,["git","add",o2],`chore: update cc-safety-net plugin to v${j()}`);return at(n),{path:d,alreadyInstalled:!s}})}function _0(n,t=Me){let e=G0(t);return U0(t,(r)=>{let a=`${e}/${o2}`;if(!O0(r,"remove"))return at(n),{path:a,alreadyInstalled:!1};return T0(t,r,["git","rm",o2],`chore: remove cc-safety-net plugin v${j()}`),at(n),{path:a,alreadyInstalled:!0}})}import{existsSync as P0,mkdirSync as sL,readFileSync as iL}from"node:fs";import{dirname as cL}from"node:path";var Ve="npx -y cc-safety-net hook --agy-cli",f2="cc-safety-net";function dt(){return{PreToolUse:[{hooks:[{type:"command",command:Ve,timeout:30}]}]}}function I0(n){try{let t=JSON.parse(iL(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${n}: ${t.message}`);throw t}}function N0(n){let t=n[f2];if(t===void 0)return n[f2]=dt(),n[f2];if(!t||typeof t!=="object"||Array.isArray(t))throw Error(`Antigravity hooks config entry "${f2}" must be an object`);if(!Array.isArray(t.PreToolUse))t.PreToolUse=[];return t}function nl(n){if(!Array.isArray(n.PreToolUse))return!1;return n.PreToolUse.some((t)=>Array.isArray(t.hooks)&&t.hooks.some((e)=>e.command===Ve))}function LL(n){return Object.values(n).some((t)=>t.enabled!==!1&&nl(t))}function oL(n){if(n[f2]===void 0)return!1;let t=N0(n);if(t.enabled!==!1||!nl(t))return!1;return t.enabled=!0,!0}function pL(n){if(n[f2]===void 0){n[f2]=dt();return}let t=N0(n);t.PreToolUse??=[],t.enabled=!0,t.PreToolUse.push(dt().PreToolUse?.[0]??{hooks:[]})}function uL(n){let t=!1;for(let e of Object.values(n)){if(!Array.isArray(e.PreToolUse))continue;e.PreToolUse=e.PreToolUse.flatMap((r)=>{if(!Array.isArray(r.hooks))return[r];let a=r.hooks.filter((l)=>l.command!==Ve);if(a.length!==r.hooks.length)t=!0;return a.length===0?[]:[{...r,hooks:a}]})}return t}function lt(n,t){B(n,`${JSON.stringify(t,null,2)}
`)}function tl(n){let t=xn(n);if(sL(cL(t),{recursive:!0}),!P0(t))return lt(t,{[f2]:dt()}),{path:t,alreadyInstalled:!1};let e=I0(t);if(LL(e))return{path:t,alreadyInstalled:!0};if(oL(e))return lt(t,e),{path:t,alreadyInstalled:!1};return pL(e),lt(t,e),{path:t,alreadyInstalled:!1}}function el(n){let t=xn(n);if(!P0(t))return{path:t,alreadyInstalled:!1};let e=I0(t);if(!uL(e))return{path:t,alreadyInstalled:!1};return lt(t,e),{path:t,alreadyInstalled:!0}}import{spawn as vL,spawnSync as bL}from"node:child_process";var G=c2.map((n)=>({target:n.id,flag:n.flag,label:n.installLabel,probeCommand:n.probeCommand})),rl=new Map(G.map((n)=>[n.flag,n.target]));function Ce(n){let t=new Set(n);return G.map((e)=>e.target).filter((e)=>t.has(e))}function al(n,t){n.forEach(t)}var ll=5000;function fL(n){let t=bL(n[0],n.slice(1),{env:process.env,stdio:"ignore",timeout:ll});return!t.error&&t.status===0}function Ue(n){return new Promise((t)=>{let e=vL(n[0],n.slice(1),{env:process.env,stdio:"ignore"}),r=!1,a=(d)=>{if(r)return;r=!0,clearTimeout(l),t(d)},l=setTimeout(()=>{e.kill(),a(!1)},ll);e.on("error",()=>a(!1)),e.on("close",(d)=>a(d===0))})}function yL(n=fL,t={}){let e=new Set(t.configuredTargets??[]);if(t.async)return Promise.all(G.map(async(a)=>({target:a.target,flag:a.flag,label:a.label,...Ge(t.action,await n(a.probeCommand),e.has(a.target))})));let r=n;return G.map((a)=>({target:a.target,flag:a.flag,label:a.label,...Ge(t.action,r(a.probeCommand),e.has(a.target))}))}function dl(n=Ue,t={}){return yL(n,{...t,async:!0})}function sl(n,t){let e=new Set(t.configuredTargets??[]);return n.map((r)=>({...r,...Ge(t.action,r.available,e.has(r.target))}))}function Ge(n,t,e){if(n==="uninstall")return e?{available:!0}:{available:!1,unavailableReason:"not installed"};if(n==="install"&&e)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as il,readdirSync as hL,rmSync as wL}from"node:fs";import{join as nn}from"node:path";function Oe(n,t=process.platform){let e=nn(process.env.npm_config_cache||(t==="win32"?nn(process.env.LOCALAPPDATA||nn(n,"AppData","Local"),"npm-cache"):nn(n,".npm")),"_npx");if(!il(e))return;hL(e).filter((r)=>il(nn(e,r,"node_modules","cc-safety-net"))).forEach((r)=>{wL(nn(e,r),{recursive:!0,force:!0})})}import{existsSync as pl,mkdirSync as $L,readFileSync as ul}from"node:fs";import{dirname as mL,join as ol}from"node:path";function cl(n){return n!==void 0&&/\s/.test(n)}function xL(n,t,e){let r=t+1,a=!1;while(r<n.length){let l=n[r];if(a){a=!1,r++;continue}if(l==="\\"){a=!0,r++;continue}if(l==='"')return r+1;r++}throw Error(e)}function st(n,t,e){let r=n[t],a=r==="["?"]":"}",l=0,d=t;while(d<n.length){let s=e.skipComment?.(n,d)??d;if(s!==d){d=s;continue}if(n[d]==='"'){d=xL(n,d,e.stringError);continue}if(n[d]===r)l++;if(n[d]===a){if(l--,l===0)return d}d++}throw Error(e.bracketError)}function Ll(n,t){let e=n.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(n.slice(e))?.[0]??""}function it(n,t){let{start:e,end:r,end:a}=t;while(cl(n[a]))a++;if(n[a]===","){if(r=a+1,n[r]===`
`)r++;return`${n.slice(0,e)}${n.slice(r)}`}a=t.start-1;while(cl(n[a]))a--;if(n[a]===","){e=a;let l=n.lastIndexOf(`
`,e-1);if(l!==-1&&/^\s*$/.test(n.slice(l+1,e)))e=l}return`${n.slice(0,e)}${n.slice(r)}`}var jn="npx -y cc-safety-net hook --kimi-code",Te=`[[hooks]]
event = "PreToolUse"
command = "${jn}"`,Ee=`{ event = "PreToolUse", command = "${jn}" }`;function vl(n){return ol(process.env.KIMI_CODE_HOME??ol(n,".kimi-code"),"config.toml")}function gL(n){return n.split(`
...
`)}function DL(n,t){if(n[t]!=="#")return t;let e=n.indexOf(`
`,t+1);return e===-1?n.length:e+1}function kL(n,t){return st(n,t,{skipComment:DL,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function bl(n){let t=!1,e=0;while(e<n.length){let r=n.indexOf(`
`,e),a=r===-1?n.length:r,l=n.slice(e,a);if(/^\s*\[/.test(l))t=!0;if(!t){let d=/^(\s*)hooks\s*=\s*\[/.exec(l);if(d){let s=e+d[0].lastIndexOf("[");return{start:s,end:kL(n,s)}}}e=r===-1?n.length:r+1}return}function qL(n,t){let e=n.slice(0,t.end).trimEnd(),r=Ll(n,t.end),a=r===""?"     ":`${r}  `,l=!e.endsWith("[")&&!e.endsWith(",");return`${e}${l?",":""}
${a}${Ee}${n.slice(t.end)}`}function jL(n){let t=bl(n);if(t&&n.slice(t.start+1,t.end).trim())return qL(n,t);let e=gL(n).trimEnd();if(e==="")return`${Te}
`;return`${e}

${Te}
`}function FL(n){return n.split(/(?=^\s*\[)/m).filter((e)=>!/^\s*\[\[hooks]]\s*$/m.test(e)||!e.includes(jn)).join("").trimEnd()}function zL(n,t){let e=n.indexOf(Ee,t.start);if(e===-1||e>t.end)return n;return it(n,{start:e,end:e+Ee.length})}function fl(n){let t=vl(n);if($L(mL(t),{recursive:!0}),!pl(t))return B(t,`${Te}
`),{path:t,alreadyInstalled:!1};let e=ul(t,"utf-8");if(e.includes(jn))return{path:t,alreadyInstalled:!0};return B(t,jL(e)),{path:t,alreadyInstalled:!1}}function yl(n){let t=vl(n);if(!pl(t))return{path:t,alreadyInstalled:!1};let e=ul(t,"utf-8");if(!e.includes(jn))return{path:t,alreadyInstalled:!1};let r=bl(e),a=r?zL(e,r):`${FL(e)}
`;return B(t,a),{path:t,alreadyInstalled:!0}}import{existsSync as hl,readFileSync as BL,rmSync as JL}from"node:fs";import{join as _e}from"node:path";var Pe="cc-safety-net",SL=`${Pe}@latest`,xl=["opencode.json","opencode.jsonc"];function ZL(n){return _e(n,".config","opencode",xl[0])}function QL(n){return xl.map((t)=>_e(n,".config","opencode",t))}function XL(n){return _e(n,".cache","opencode","packages",SL)}function Ie(n){JL(XL(n),{recursive:!0,force:!0})}function ct(n,t){if(n[t]==="/"&&n[t+1]==="/"){let e=n.indexOf(`
`,t+2);return e===-1?n.length:e+1}if(n[t]==="/"&&n[t+1]==="*"){let e=n.indexOf("*/",t+2);return e===-1?n.length:e+2}return t}function wl(n,t){let e=t;while(e<n.length){if(/\s/.test(n[e]??"")){e++;continue}let r=ct(n,e);if(r===e)return e;e=r}return e}function $l(n,t){let e=t+1,r=!1;while(e<n.length){if(r){r=!1,e++;continue}if(n[e]==="\\"){r=!0,e++;continue}if(n[e]==='"')return e+1;e++}throw Error("Unterminated string in OpenCode config")}function ml(n,t,e){return JSON.parse(n.slice(t,e))}function YL(n,t){return st(n,t,{skipComment:ct,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function RL(n){let t=0,e=0;while(e<n.length){let r=ct(n,e);if(r!==e){e=r;continue}if(n[e]==='"'){let a=$l(n,e);if(t===1&&ml(n,e,a)==="plugin"){let l=wl(n,a),d=wl(n,l+1);if(n[l]===":"&&n[d]==="[")return{start:d,end:YL(n,d)}}e=a;continue}if(n[e]==="{"||n[e]==="[")t++;if(n[e]==="}"||n[e]==="]")t--;e++}return}function HL(n,t){let e=[],r=t.start+1;while(r<t.end){let a=ct(n,r);if(a!==r){r=a;continue}if(n[r]==='"'){let l=$l(n,r),d=ml(n,r,l);if(typeof d==="string"&&d.includes(Pe))e.push({start:r,end:l});r=l;continue}r++}return e}function gl(n,t){try{return JSON.parse(W(n))}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${e.message}`);throw e}}function AL(n){if(!n||typeof n!=="object"||Array.isArray(n))return!1;let t=n.plugin;if(!Array.isArray(t))return!1;return t.some((e)=>typeof e==="string"&&e.includes(Pe))}function WL(n,t){let e=RL(n);if(!e)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let r=[...HL(n,e)].reverse().reduce(it,n);return gl(r,t),r}function Dl(n){Ie(n);let t=QL(n),e=t.find((a)=>hl(a)),r=[];for(let a of t){if(!hl(a))continue;try{let l=BL(a,"utf-8");if(!AL(gl(l,a)))continue;return B(a,WL(l,a)),{path:a,alreadyInstalled:!0}}catch(l){r.push(l instanceof Error?l.message:String(l))}}if(r.length>0)throw Error(r.join(`
`));return{path:e??ZL(n),alreadyInstalled:!1}}var nr="safety-net@cc-marketplace",kl=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]);function er(n){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(n??"")}function Fl(n){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(n??"")}function KL(n){return/^Marketplace `cc-marketplace`\s*$/m.test(n??"")}var zl={"claude-code":{installCommands:(n)=>{let t=Un(n,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...pe(n).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:Un(n,nr)?[["claude","plugin","uninstall",nr]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:()=>{let n=e2(["codex","plugin","list"]),t=Fl(n);return{commands:[t||KL(n)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:er(n)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:t}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:()=>{let n=e2(["copilot","plugin","list"]),t=[...Q1(n)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...X1(n)?[["copilot","plugin","uninstall",J1]]:[]];if(S1(n))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",t2]],cleanupCommands:t,update:!0};return{commands:[Z1(e2(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",t2]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(n)=>{let t=xe(n);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:Be,installCommands:()=>({commands:f0()}),uninstallCommands:[["openclaw","plugins","uninstall",q,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:Ie,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function rr(){return process.env.HOME??ML()}function Bl(n,t=(e)=>e){try{let e=JSON.parse(t(jl(n,"utf-8")));if(!e||typeof e!=="object"||Array.isArray(e))throw Error(`Settings file ${n} must be a JSON object`);return e}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse ${n}: ${e.message}`);throw e}}function VL(n){let t=Ne($n(n),"settings.json");if(!tr(t))return;let e=Bl(t,W),r=e.enabledPlugins;if(!r||typeof r!=="object"||Array.isArray(r))return;if(r[t2]!==!1)return;let a=jl(t,"utf-8"),l=a.replace(new RegExp(`("${t2}"\\s*:\\s*)false`),"$1true");r[t2]=!0,B(t,l!==a?l:`${JSON.stringify(e,null,2)}
`),console.log(`Enabled ${t2} plugin in ${t}`)}function CL(n){let t=Se(n);if(!tr(t))return;let e=Bl(t);if(!Array.isArray(e.packages))return;let r=e.packages.find((a)=>!!a&&typeof a==="object"&&!Array.isArray(a)&&Ze(a.source)&&("extensions"in a));if(!r)return;delete r.extensions,B(t,`${JSON.stringify(e,null,2)}
`),console.log(`Enabled npm:cc-safety-net extensions in ${t}`)}function ql(n,t){let e=F({label:t,booleans:Object.fromEntries(G.map((l)=>[l.target,[l.flag]]))},n),r=e.errors[0];if(r)throw Error(r);let a=G.filter((l)=>e.flags[l.target]).map((l)=>l.target);if(a.length!==1)throw Error(`Choose exactly one ${t} target: ${[...rl.keys()].join(", ")}`);return a[0]}async function Jl(n=rr()){let[t,e,r]=await Promise.all([yn(["amp","plugins","list"],30000),yn(["codex","plugin","list"],30000),yn(["copilot","--binary-version"])]);return{codexPluginListOutput:e,hooks:N2(process.cwd(),{homeDir:n,ampPluginListOutput:t,codexPluginListOutput:e,copilotCliVersion:r})}}async function GL(n){let t=await Jl();return t.hooks.filter((e)=>n==="install"?e.configured:e.detected||e.inspectionStatus==="not-inspected").filter((e)=>e.platform!=="codex"||!er(t.codexPluginListOutput)||Fl(t.codexPluginListOutput)).map((e)=>e.platform)}function UL(n,t,e){if(t.length>0)return{finish:async()=>[ql(t,n)]};if(!e.selectTargets&&!H0(e.input,e.output))return{finish:async()=>[ql(t,n)]};let r=e.detectConfiguredTargets??(()=>GL(n)),a=Promise.all([dl(e.probeTargets),r()]);return{ready:a,finish:async()=>{let[l,d]=await a,s=sl(l,{action:n,configuredTargets:d}),i=e.selectTargets?await e.selectTargets(n,s):await A0(n,s,{input:e.input,output:e.output});if(i==="update")return i;if(!i||i.length===0)return null;return Ce(i)}}}function z2(n,t,e=!1){let r=zl[n];r.beforeInstall?.(t);let a=typeof r.installCommands==="function"?r.installCommands(t):{commands:r.installCommands};Fe(a.commands),L0(a.cleanupCommands??[]),console.log([`${a.update||e?"Updated":"Installed"} ${m2(n)} integration`,r.postInstallMessage].filter(Boolean).join(`
`))}function tn(n){let t=zl[n];if(!t.uninstallCommands)throw Error(`${m2(n)} uninstall is not supported`);Fe(t.uninstallCommands),console.log(`Uninstalled ${m2(n)} integration`)}function OL(n){let t=Dl(n);console.log(t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`)}var TL={"antigravity-cli":{install:tl,uninstall:el},cursor:{install:G1,uninstall:U1},"kimi-code":{install:fl,uninstall:yl}};function en(n,t,e,r=!1){if(n==="install")Oe(e);let a=TL[t][n](e),l=m2(t),d=n!=="install"?"Uninstalled":r?"Updated":"Installed";console.log(n==="install"&&a.alreadyInstalled?r?`${l} hook up to date in ${a.path}`:`${l} hook already installed in ${a.path}`:n==="uninstall"&&!a.alreadyInstalled?`${l} hook not installed in ${a.path}`:`${d} ${l} hook ${n==="install"?"in":"from"} ${a.path}`)}var EL={amp:{install:E0,uninstall:_0,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:I1,uninstall:N1,afterInstall:(n)=>{let t=je(n);return e2(["hermes","plugins","enable",K,"--no-allow-tool-override"]),!t},beforeUninstall:(n)=>{qe(n);try{e2(["hermes","plugins","disable",K])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
Removing the plugin files anyway; ${K} may still be listed in the Hermes config.`)}},restartNote:"Restart Hermes to apply the change."}};function Lt(n,t,e,r=!1){let a=EL[t];if(n==="uninstall")a.beforeUninstall?.(e);let l=n==="install"?a.install(e):a.uninstall(e),d=n==="install"&&a.afterInstall?.(e),s=m2(t),i=!d&&(n==="install"&&l.alreadyInstalled||n==="uninstall"&&!l.alreadyInstalled),L=i?n==="install"?`${s} plugin ${r?"up to date":"already installed"} at ${l.path}`:`${s} plugin not installed at ${l.path}`:`${n!=="install"?"Uninstalled":r?"Updated":"Installed"} ${s} plugin ${n==="install"?"at":"from"} ${l.path}`;console.log([L,i?void 0:a.restartNote].filter(Boolean).join(`
`))}var _L={amp:{install:(n,t)=>Lt("install","amp",n,t),uninstall:(n)=>Lt("uninstall","amp",n)},"antigravity-cli":{install:(n,t)=>en("install","antigravity-cli",n,t),uninstall:(n)=>en("uninstall","antigravity-cli",n)},"claude-code":{install:(n,t)=>z2("claude-code",n,t),uninstall:()=>tn("claude-code")},codex:{install:(n,t)=>z2("codex",n,t),uninstall:()=>tn("codex")},"copilot-cli":{install:(n,t)=>{z2("copilot-cli",n,t),VL(n)},uninstall:()=>tn("copilot-cli")},cursor:{install:(n,t)=>en("install","cursor",n,t),uninstall:(n)=>en("uninstall","cursor",n)},"gemini-cli":{install:(n,t)=>z2("gemini-cli",n,t),uninstall:()=>tn("gemini-cli")},"hermes-agent":{install:(n,t)=>{Oe(n),Lt("install","hermes-agent",n,t)},uninstall:(n)=>Lt("uninstall","hermes-agent",n)},"kimi-code":{install:(n,t)=>en("install","kimi-code",n,t),uninstall:(n)=>en("uninstall","kimi-code",n)},openclaw:{install:(n,t)=>{z2("openclaw",n,t),y0()},uninstall:(n)=>{Be(n),tn("openclaw")}},opencode:{install:(n,t)=>z2("opencode",n,t),uninstall:(n)=>OL(n)},pi:{install:(n,t)=>{z2("pi",n,t),CL(n)},uninstall:()=>tn("pi")}};function Sl(n,t,e,r=!1){_L[t][n](e,r)}function PL(n){let t=F({label:"update"},n).errors[0];if(t)throw Error(t)}async function IL(n){let t=await Jl(n),e=Ne($n(n),"installed-plugins");return Ce([...t.hooks.filter((r)=>r.platform!=="copilot-cli"&&r.detected).map((r)=>r.platform),...[On,B1,z1].flatMap((r)=>tr(Ne(e,...r))?["copilot-cli"]:[]),...Un(n,nr)?["claude-code"]:[],...er(t.codexPluginListOutput)?["codex"]:[]])}async function NL(){let n=rr(),t=await IL(n);if(t.length===0)return console.log("No installed integrations found. Run `cc-safety-net install` to set one up."),0;let e=new Set(t),r=new Map(await Promise.all(G.filter((l)=>e.has(l.target)&&kl.has(l.target)).map(async(l)=>[l.target,await Ue(l.probeCommand)])));return t.filter((l)=>{if(kl.has(l)&&!r.get(l))return console.log(`${m2(l)} not found; skipped`),!1;try{return Sl("install",l,n,!0),!1}catch(d){return console.error(lr(d)),!0}}).length>0?1:0}function ar(n){return Promise.resolve().then(()=>PL(n)).then(NL).catch((t)=>{return console.error(lr(t)),1})}async function Fn(n,t,e={}){try{let r=await Vn(!0,()=>UL(n,t,e),()=>Kn({input:e.input??process.stdin,output:e.output??process.stdout}),{loadingMessage:n==="install"?"Checking available integrations…":"Checking installed integrations…",output:e.output??process.stdout});if(!r)return(e.output??process.stdout).write(`Cancelled: nothing was ${n}ed.
`),0;if(r==="update")return(e.runUpdate??(()=>ar([])))();let a=rr();return al(r,(l)=>Sl(n,l,a)),0}catch(r){return console.error(lr(r)),1}}function lr(n){let t=n instanceof Error?n.message:String(n),e=typeof n==="object"&&n!==null&&"code"in n?n.code:null;if(e==="EACCES"||e==="EPERM")return`${t}
...
Check that every parent path component is a directory.`;return t}import{join as Ho}from"node:path";var Zl="# Custom Rules Reference\n\nAgent reference for generating CC Safety Net rulebook configuration.\n\n## Config Locations\n\n| Scope | Config path | Rulebook path | Cache path | Priority |\n|-------|-------------|---------------|------------|----------|\n| User | `~/.cc-safety-net/rules/rule.json` | `~/.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `~/.cc-safety-net/cache/rulebooks/` | First |\n| Project | `.cc-safety-net/rules/rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `.cc-safety-net/cache/rulebooks/` | Second |\n| GitHub source | Listed in a local `rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` in the source repository | Consumer local cache | Source order |\n\nUser scope is evaluated before project scope; within a scope, sources apply in `rules` array order. A duplicate active rulebook name keeps the first claim and ignores the later rulebook with a warning, so a user-scoped name shadows a project-scoped one.\n\nUse `cc-safety-net rule init` to create an inert local config. Use `--global` for user scope. Use `cc-safety-net rule init --example` to also create an inactive example rulebook. `CC_SAFETY_NET_HOME` overrides the `~/.cc-safety-net` user root.\n\nLegacy inline `.safety-net.json` and `~/.cc-safety-net/config.json` files are not loaded at runtime. Convert them with `cc-safety-net rule migrate`.\n\n## rule.json Schema\n\n```json\n{\n  \"version\": 1,\n  \"rules\": [\"project-rules\", \"owner/repo#main/team-rules\"],\n  \"overrides\": {\n    \"project-rules/block-docker-system-prune\": {\n      \"reason\": \"Use targeted Docker cleanup commands.\"\n    },\n    \"team-rules/block-npm-global\": \"off\"\n  },\n  \"transparent_wrappers\": [\"rtk\"]\n}\n```\n\n- `version`: Required. Must be `1`.\n- `$schema`: Optional. `cc-safety-net rule verify` inserts it into a valid `rule.json` that lacks it.\n- `rules`: Optional array of rulebook source strings. Missing `rules` is treated as `[]`.\n- `overrides`: Optional object keyed by `<rulebook-name>/<rule-name>`.\n- `overrides` values are either `\"off\"` to disable a rule or an object with a required `reason` (replacement block reason) and an optional `intent` (one of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain`).\n- A project override cannot target a user-scoped rule: only that override is ignored, the user rule keeps its configured state, and `rule sync`/`rule verify` report the diagnostic as a failure.\n- `transparent_wrappers`: Optional array of command names that transparently execute a visible child command.\n- Transparent wrappers have no built-in defaults. Configure only wrappers you intentionally trust, such as `\"rtk\"`.\n- Use `cc-safety-net rule wrapper add rtk` to configure RTK without manually editing `rule.json`.\n\n## Rulebook Sources\n\n- Local sources are bare rulebook names such as `project-rules`; the rulebook file is `.cc-safety-net/rules/project-rules/rulebook.json`.\n- GitHub sources use `owner/repo#ref/<rulebook-name>`.\n- GitHub refs must be one path segment, such as a tag, SHA, or branch name without `/`.\n- The GitHub source name, the repository directory name, and the rulebook `name` must match exactly.\n- Rulebook source strings must be unique in a config.\n\n## rulebook.json Schema\n\n```json\n{\n  \"rulebook_version\": 1,\n  \"name\": \"project-rules\",\n  \"version\": \"1.0.0\",\n  \"description\": \"Project-specific CC Safety Net rules.\",\n  \"author\": \"project\",\n  \"allowed_commands\": [\"docker\"],\n  \"rules\": [\n    {\n      \"name\": \"block-docker-system-prune\",\n      \"command\": \"docker\",\n      \"subcommand\": \"system\",\n      \"block_args\": [\"prune\"],\n      \"reason\": \"Use targeted cleanup instead.\"\n    }\n  ],\n  \"tests\": [\n    {\n      \"command\": \"docker system prune\",\n      \"expect\": \"blocked\",\n      \"rule\": \"block-docker-system-prune\"\n    },\n    {\n      \"command\": \"docker ps\",\n      \"expect\": \"allowed\"\n    }\n  ]\n}\n```\n\n### Rulebook Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `rulebook_version` | Yes | Must be `1` |\n| `name` | Yes | `^[a-zA-Z][a-zA-Z0-9_-]{0,63}$` |\n| `version` | Yes | Non-empty string |\n| `description` | No | Free text; not type-checked at runtime |\n| `author` | No | Free text; not type-checked at runtime |\n| `allowed_commands` | Yes | Unique command names matching `^[a-zA-Z][a-zA-Z0-9_-]*$` |\n| `rules` | Yes | Array of rule objects |\n| `tests` | No | Array of fixtures |\n\n### Rule Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `name` | Yes | Unique within the rulebook (case-insensitive); same pattern as rulebook `name` |\n| `command` | Yes | Must be listed in `allowed_commands`; basename only, not path |\n| `subcommand` | No | Same pattern as `command`; omit to match any subcommand |\n| `intent` | No | One of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain` |\n| `block_args` | Yes | Non-empty array of non-empty strings |\n| `reason` | Yes | Non-empty string, max 256 chars |\n\n### Test Fixture Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `command` | Yes | Non-empty shell command string |\n| `expect` | Yes | `\"blocked\"` or `\"allowed\"` |\n| `rule` | Required for blocked fixtures | Rule name expected to block the command |\n\nFixtures are optional documentation of intended behavior. Fixtures are shape-validated only; CC Safety Net does not execute them.\n\n## Matching Behavior\n\n- **Command**: Normalized to lowercase basename with any trailing `.exe` removed (`/usr/bin/git` → `git`).\n- **Subcommand**: The first command token after recognized Git and Docker global options and their values; `--` ends option parsing. An unrecognized option without `=` may consume the following token as its value.\n- **Arguments**: Each `block_args` value is compared literally against every command token, including expanded short options. The command is blocked if **any** item matches.\n- **Short options**: Expanded (`-Ap` matches `-A`).\n- **Long options**: Exact match (`--all-files` does not match `--all`).\n- **Execution order**: Built-in rules first, then custom rulebooks. Custom rules only add restrictions.\n- **Transparent wrappers**: A configured wrapper such as `rtk` lets `rtk git commit` be analyzed as `git commit` only when `git` is protected by built-in analyzers or active custom rules. `rtk -- git commit` is also supported.\n\n## Workflow\n\n1. Run `cc-safety-net rule init` or create `rule.json` manually.\n2. Optionally run `cc-safety-net rule init --example` to create an inactive example rulebook.\n3. Use `cc-safety-net rule wrapper add rtk` for trusted transparent wrappers.\n4. Run `cc-safety-net rule add <source>` after creating or choosing a rulebook source; it adds the source and syncs it.\n5. Run `cc-safety-net rule sync` after manual `rule.json` changes or local rulebook edits.\n6. Run `cc-safety-net rule verify` to validate config, lock/cache state, local rulebooks, and shareable GitHub-source rulebook directories in the current repository (it does not fetch remote content).\n7. Run `cc-safety-net rule list` to inspect active rulebooks and transparent wrappers.\n\nAn edited or invalid local rulebook keeps its last synced, digest-verified cached version enforced until `cc-safety-net rule sync` validates the edit. A missing lock entry or cache, a cache digest mismatch, or an invalid cached rulebook makes that source inactive; a missing lockfile or an unreadable or invalid `rule.json` makes every source in its scope inactive. Inactive sources stop applying their rules while other custom rules and all built-in protections stay active. Repair the reported condition, then run `cc-safety-net rule sync`. Run `cc-safety-net status` to see degraded sources.\n";function zn(n,t){if(!n.ok){ro(n);return}ao(n),console.log(t),console.log("Rule config synced."),console.log(""),no(n.entries)}function no(n){if(n.length===0){console.log("Active rulebooks: (none)");return}console.log(`Active rulebooks (${n.length}):`);for(let t of n)console.log(`  - ${t.name} ${t.version} (${to(t.ruleCount??0)})`),console.log(`    Source: ${Ht(t)}`)}function to(n){return`${n} ${n===1?"rule":"rules"}`}function Xl(n,t){B2("Active sources",n.rulebooks,(e)=>[`[${e.source}] ${e.name} ${e.version}`,`  Source: ${t[e.source].get(e.spec)??e.spec}`]),B2("Active rules",n.rules,(e)=>[`[${eo(n,e.name)}] ${e.name}`,`  Command: ${e.subcommand?`${e.command} ${e.subcommand}`:e.command}`,`  Block args: ${e.block_args.join(", ")}`,`  Reason: ${e.reason}`]),B2("Disabled rules",Ql(n,"off"),(e)=>[e.key]),B2("Reason overrides",Ql(n,"reason"),(e)=>[e.key,`  Reason: ${e.value.reason}`]),B2("Transparent wrappers",n.transparent_wrappers,(e)=>[e]),B2("Issues",n.errors,(e)=>[e]),B2("Warnings",n.warnings,(e)=>[e])}function B2(n,t,e){if(t.length===0){console.log(`${n}: (none)`);return}console.log(`${n} (${t.length}):`);for(let r of t){let[a,...l]=e(r);console.log(`  - ${a}`);for(let d of l)console.log(`    ${d}`)}}function eo(n,t){return n.rulebooks.find((e)=>e.rules.includes(t))?.source??"project"}function Ql(n,t){return Object.entries({...n.userConfig?.overrides??{},...n.projectConfig?.overrides??{}}).filter((e)=>{if(t==="off")return e[1]==="off";return!!e[1]&&typeof e[1]==="object"}).map(([e,r])=>({key:e,value:r}))}function ro(n){for(let t of n.errors)console.error(t)}function ao(n){if(!n.warnings||n.warnings.length===0)return;for(let t of n.warnings)console.warn(t)}import{dirname as Yl,join as ot}from"node:path";var lo=".safety-net.json",so="~/.cc-safety-net/config.json";async function Al(n){return[await Rl({legacyPath:Hl({cwd:n.cwd}),configPath:E(n.cwd),defaultRulebookName:"project-rules",migratedFrom:lo,cleanup:n.cleanup,syncOptions:{cwd:n.cwd}}),await Rl({legacyPath:cn(),configPath:_(),defaultRulebookName:"user-rules",migratedFrom:so,cleanup:n.cleanup,syncOptions:{cwd:n.cwd,global:!0}})].every((e)=>e)?0:1}async function Rl(n){let t=U(n.syncOptions),e=g(t.filesystemScope,n.legacyPath),r=m(e);if(r===null)return console.log(`No legacy config found at ${n.legacyPath}`),!0;let a=co(r);if(!a.ok){for(let u of a.errors)console.error(u);return!1}let l=O(t.configTarget);if(l.errors.length>0){for(let u of l.errors)console.error(u);return!1}let d=l.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},s=Lo(Yl(n.configPath),d.rules,n.defaultRulebookName,n.migratedFrom,t.filesystemScope),i=ot(Yl(n.configPath),s,"rulebook.json"),c=g(t.filesystemScope,i),L=[dr(t.configTarget),dr(c),dr(t.lockTarget)],p=await io(n,t.configTarget,c,s,a.config.rules,d.rules.includes(s)?d.rules:[...d.rules,s],d.overrides??{},d.transparent_wrappers??[]);if(!p.ok){uo(L);for(let u of p.errors)console.error(u);return!1}if(!n.cleanup)return console.log(`Migrated legacy config at ${n.legacyPath}. Legacy file is no longer used.`),!0;if(!po(t.configTarget,c,s,n.migratedFrom,a.config.rules))return console.error(`Migration cleanup verification failed for ${n.legacyPath}`),!1;return dn(e),console.log(`Deleted legacy config at ${n.legacyPath}`),!0}async function io(n,t,e,r,a,l,d,s){try{return T(t,{version:1,rules:l,overrides:d,transparent_wrappers:s}),T(e,oo(r,n.migratedFrom,a)),await H2(n.syncOptions)}catch(i){return{ok:!1,errors:[i instanceof Error?i.message:String(i)]}}}function co(n){try{let t=JSON.parse(n),e=kt(t);if(e.errors.length>0)return{ok:!1,errors:e.errors};return{ok:!0,config:{version:1,rules:t.rules??[]}}}catch{return{ok:!1,errors:["Invalid JSON"]}}}function Lo(n,t,e,r,a){let l=t.find((d)=>vo(g(a,ot(n,d,"rulebook.json")))===r);if(l)return l;if(m(g(a,ot(n,e,"rulebook.json")))===null)return e;for(let d=2;;d++){let s=`${e}-${d}`;if(m(g(a,ot(n,s,"rulebook.json")))===null)return s}}function oo(n,t,e){return{rulebook_version:1,name:n,version:"1.0.0",description:"Migrated CC Safety Net rules.",author:"project",migrated_from:t,allowed_commands:[...new Set(e.map((r)=>r.command))],rules:e,tests:e.map((r)=>({command:[r.command,r.subcommand,r.block_args[0]].filter(Boolean).join(" "),expect:"blocked",rule:r.name}))}}function po(n,t,e,r,a){if(!O(n).config?.rules.includes(e))return!1;try{let d=m(t);if(d===null)return!1;let s=JSON.parse(d);return s.migrated_from===r&&JSON.stringify(s.rules)===JSON.stringify(a)}catch{return!1}}function dr(n){return{target:n,content:m(n)}}function uo(n){for(let t of n){if(t.content===null){dn(t.target);continue}y2(t.target,t.content)}}function vo(n){let t=m(n);if(t===null)return null;try{let e=JSON.parse(t);return typeof e.migrated_from==="string"?e.migrated_from:null}catch{return null}}import{mkdir as bo,readFile as fo,writeFile as yo}from"node:fs/promises";import{dirname as ho,join as wo}from"node:path";var xo=86400000,$o=604800000;async function Ml(n=Date.now()){if(process.env.CC_SAFETY_NET_NO_UPDATE_CHECK)return null;let t=Mt();if(!t)return null;let e=wo(t,".cc-safety-net","update-check.json"),r=await mo(e,n);if(!r.lastCheck||n-r.lastCheck>xo){let d=await T2();if(r.lastCheck=n,d.latestVersion)r.latestVersion=d.latestVersion;if(!await Wl(e,r))return null;if(d.error)return null}let a=r.latestVersion,l=j();if(!a||!se(a,l))return null;if(r.notifiedVersion===a&&r.notifiedAt!==void 0&&n-r.notifiedAt<$o)return null;if(r.notifiedVersion=a,r.notifiedAt=n,!await Wl(e,r))return null;return`UPDATE_AVAILABLE: cc-safety-net v${a} is available (running v${l}). Ask the user once whether to run \`npx -y cc-safety-net@latest update\`; continue the current task either way and do not raise this again.`}async function mo(n,t){let e=await fo(n,"utf8").then((l)=>JSON.parse(l)).catch(()=>{return});if(!e||typeof e!=="object"||Array.isArray(e))return{};let r=e,a=(l)=>typeof l==="number"&&Number.isFinite(l)&&l<=t?l:void 0;return{lastCheck:a(r.lastCheck),latestVersion:typeof r.latestVersion==="string"?r.latestVersion:void 0,notifiedVersion:typeof r.notifiedVersion==="string"?r.notifiedVersion:void 0,notifiedAt:a(r.notifiedAt)}}async function Wl(n,t){return bo(ho(n),{recursive:!0,mode:448}).then(()=>yo(n,JSON.stringify(t),{mode:384})).then(()=>!0).catch(()=>!1)}import{dirname as go,join as Do,resolve as sr}from"node:path";var Vl="CC Safety Net Config",ko="═".repeat(Vl.length),qo="https://raw.githubusercontent.com/kenryu42/cc-safety-net/main/assets/cc-safety-net.schema.json",jo=new Set(["rule.json","rule.lock","cache"]);function Cl(n={}){try{return Fo(n)}catch(t){if(t instanceof S)return console.error(t.message),1;throw t}}function Fo(n){let t=n.cwd??process.cwd(),e=n.userConfigPath??_(),r=n.projectConfigPath??E(t),a=n.legacyUserConfigPath??cn(),l=n.legacyProjectConfigPath??Br(t),d=sr(t,Rt),s=go(e),i=P({cwd:t,userConfigPath:e,projectConfigPath:r}),c=P({cwd:t}),L=g(i.userScope,e),p=g(i.projectScope,r),u=n.legacyUserConfigPath?ln(n.legacyUserConfigPath,"user policy"):g(c.userScope,a),o=n.legacyProjectConfigPath?ln(n.legacyProjectConfigPath,"project policy"):g(c.projectScope,l),b=!1,v=!1,f=[],w=[],x=zo(g(c.projectScope,d));if(Jo(),m(L)!==null){let h=a2(L);if(h.errors.push(...l2(e,A2({userConfigDir:s}),{userConfigDir:s},i.userScope)),f.push({scope:"User",path:e,result:h,schema:"rules",sourceDisplayMap:h2(e,i.userScope),target:L}),h.errors.length>0)b=!0}if(m(u)!==null)if(v=!0,m(L)!==null)w.push(pt("user","cleanup"));else{let h=qt(u);if(f.push({scope:"User",path:a,result:h,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:u}),w.push(pt("user",h.errors.length>0?"fix-or-delete":"migrate")),h.errors.length>0)b=!0}if(m(p)!==null){let h=a2(p);if(h.errors.push(...l2(r,W2(r),{userConfigDir:s},i.projectScope)),f.push({scope:"Project",path:sr(r),result:h,schema:"rules",sourceDisplayMap:h2(r,i.projectScope),target:p}),h.errors.length>0)b=!0;if(m(o)!==null)v=!0,w.push(pt("project","cleanup"))}else if(m(o)!==null){v=!0,b=!0;let h=qt(o);f.push({scope:"Project",path:sr(l),result:h,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:o}),w.push(pt("project",h.errors.length>0?"fix-or-delete":"migrate"))}if(x?.result.errors.length)b=!0;if(f.length===0&&!x)return console.log(`
No config files found. Using built-in rules only.`),0;for(let h of f)if(h.inactive)Zo(h.scope,h.path,h.result,h.sourceDisplayMap);else if(h.result.errors.length>0)Qo(h.scope,h.path,h.result.errors);else{if(h.schema==="rules"&&Ro(h.target))console.log(`
Added $schema to ${h.scope.toLowerCase()} config.`);So(h.scope,h.path,h.result,h.schema,h.sourceDisplayMap)}for(let h of w)console.error(`
${y.red(h)}`);if(x)if(x.result.errors.length>0)Yo(x.path,x.result.errors);else Xo(x.path,x.result);if(b)return console.error(`
Config validation failed.`),1;return console.log(v?`
Configs valid with warnings.`:`
All configs valid.`),0}function pt(n,t){let e=`legacy ${n} config`;if(t==="cleanup")return`Warning: Legacy ${n} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${n} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${n} config is no longer supported. Fix or delete the ${e}, then run \`npx -y cc-safety-net rule migrate\`.`}function zo(n){if(R2(n)===null)return null;let t=Bo(n);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:n.path,result:t}}function Bo(n){let t=[],e=new Set,r=(R2(n)??[]).filter((a)=>!jo.has(a.name)).sort((a,l)=>a.name.localeCompare(l.name));if(r.length===0)return{errors:t,ruleNames:e};for(let a of r){if(!sn.test(a.name)){t.push(`rulebook directory names must match ${sn}: ${a.name}`);continue}if(a.kind!=="directory"){t.push(`${a.name} must be a rulebook directory`);continue}let l=g(n.scope,Do(n.path,a.name,"rulebook.json")),d=m(l);if(d===null){t.push(`${a.name}/rulebook.json is required`);continue}try{let s;try{s=JSON.parse(d)}catch{t.push(`${a.name}/rulebook.json: invalid JSON`);continue}let i=Kl(s);if(i.name!==a.name){t.push(`rulebook name "${i.name}" must match folder "${a.name}"`);continue}e.add(a.name)}catch(s){t.push(s instanceof Error?`${a.name}/rulebook.json: ${s.message}`:`${a.name}/rulebook.json: ${String(s)}`)}}return{errors:t,ruleNames:e}}function Jo(){console.log(Vl),console.log(ko)}function So(n,t,e,r,a){if(console.log(`
✓ ${n} config: ${t}`),console.log(`  Schema: ${r==="rules"?"rulebook sources":"legacy inline rules"}`),e.ruleNames.size>0){console.log(`  ${r==="rules"?"Sources":"Rules"}:`);let l=1;for(let d of e.ruleNames)console.log(`    ${l}. ${a.get(d)??d}`),l++}else console.log(`  ${r==="rules"?"Sources":"Rules"}: (none)`)}function Zo(n,t,e,r){if(console.error(`
✗ Legacy ${n.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),e.errors.length>0){console.error("  Errors:");let a=1;for(let l of e.errors)for(let d of l.split("; "))console.error(`    ${a}. ${d}`),a++;return}if(e.ruleNames.size>0){console.error("  Rules:");let a=1;for(let l of e.ruleNames)console.error(`    ${a}. ${r.get(l)??l}`),a++;return}console.error("  Rules: (none)")}function Qo(n,t,e){Gl(`${n} config`,t,e)}function Xo(n,t){console.log(`
✓ GitHub source rules: ${n}`),console.log("  Rulebooks:");let e=1;for(let r of t.ruleNames)console.log(`    ${e}. ${r}`),e++}function Yo(n,t){Gl("GitHub source rules",n,t)}function Gl(n,t,e){console.error(`
✗ ${n}: ${t}`),console.error("  Errors:");let r=1;for(let a of e)for(let l of a.split("; "))console.error(`    ${r}. ${l}`),r++}function Ro(n){try{let t=m(n);if(t===null)return!1;let e=JSON.parse(t);if(e.$schema)return!1;return y2(n,JSON.stringify({$schema:qo,...e},null,2)),!0}catch(t){if(t instanceof S)throw t;return!1}}var Ul=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),Ao=new Set(["add","remove","list"]);async function Tl(n){try{return await Wo(n)}catch(t){if(t instanceof S)return console.error(t.message),1;throw t}}async function Wo(n){let t=Ko(n),e=t.help?Mo(t.positionals):null;if(e)return et(e),0;if(t.errors.length>0){for(let d of t.errors)console.error(d);return 1}let r=t.positionals[0];if(!r)return et(O2,console.error),1;let a=t.positionals[1],l={global:t.global,check:t.check};if(r==="init"){let d=U(l),s=d.configDir;Go(d.configTarget),Ol(g(d.filesystemScope,Zn({...l,cacheConfigDir:s})));let i=Ho(s,"example-rules","rulebook.json"),c=g(d.filesystemScope,i);if(t.example&&m(c)===null)Wt(c,"example-rules");let L=await H2(l);return zn(L,"Rule config initialized."),L.ok?0:1}if(r==="add"){if(!a)return console.error("rule add requires a source"),1;let d=await Qt(a,l);return zn(d,`Added rulebook source: ${a}`),d.ok?0:1}if(r==="remove"){if(!a)return console.error("rule remove requires a source"),1;let d=await Yt(a,{...l,deleteSource:t.deleteSource});return zn(d,`Removed rulebook source: ${a}`),d.ok?0:1}if(r==="update"||r==="sync"){let d=await H2({...l,only:r==="update"?a:void 0});return zn(d,t.check?"Rule config checked.":"Rule config synced."),d.ok?0:1}if(r==="list"){let d=u2(),s=P({});return Xl(d,{user:h2(d.userConfigPath,s.userScope),project:h2(d.projectConfigPath,s.projectScope)}),d.errors.length>0?1:0}if(r==="wrapper")return Uo(t);if(r==="migrate")return Al({cleanup:t.cleanup,cwd:process.cwd()});if(r==="doc"){console.log(Zl);let d=await Ml();if(d)console.error(d);return 0}if(r==="verify")return Cl();return 1}function Mo(n){if(n.length===0)return O2;let t=O2.subcommands.filter((r)=>r.usage.split(" ")[0]===n[0]);if(t.length===0)return null;if(n.length===1&&t.length>1)return{name:`rule ${n[0]}`,description:`Subcommands of rule ${n[0]}`,usage:`rule ${n[0]} <subcommand>`,subcommands:t,options:[]};let e=n.length===1?t[0]:t.find((r)=>r.usage.split(" ")[1]===n[1]);if(!e)return null;return{name:`rule ${n[0]}`,description:e.description,usage:`rule ${e.usage}`,options:[]}}function Ko(n){let t=F({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},positionals:"list"},n),e={...t.flags,help:t.help,positionals:t.positionals,errors:t.errors};return Vo(e),e}function Vo(n){let[t]=n.positionals;if(t&&!Ul.has(t))n.errors.push(`Unknown rule subcommand: ${t}`);if(n.deleteSource&&t!=="remove")if(t&&Ul.has(t))n.errors.push(`Unknown option for rule ${t}: --delete-source`);else n.errors.push("--delete-source is only valid with 'rule remove'");if(n.cleanup&&t!=="migrate")n.errors.push(ut(t,"--cleanup"));if(n.example&&t!=="init")n.errors.push(ut(t,"--example"));if(t==="migrate"){if(n.global)n.errors.push(ut(t,"--global"));if(n.check)n.errors.push(ut(t,"--check"));if(n.positionals.length>1)n.errors.push(`Unexpected rule migrate argument: ${n.positionals[1]}`)}else if(t==="wrapper")Co(n);else if(n.positionals.length>2)n.errors.push(`Unexpected rule argument: ${n.positionals[2]}`);if(t==="list"&&n.global)n.errors.push("Unknown option for rule list: --global")}function ut(n,t){return n?`Unknown option for rule ${n}: ${t}`:`Unknown option for rule: ${t}`}function Co(n){let t=n.positionals[1],e=n.positionals[2];if(!t){n.errors.push("rule wrapper requires add, remove, or list");return}if(!Ao.has(t)){n.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(e)n.errors.push(`Unexpected rule wrapper argument: ${e}`);return}if(!e){n.errors.push(`rule wrapper ${t} requires a command`);return}if(n.positionals.length>3)n.errors.push(`Unexpected rule wrapper argument: ${n.positionals[3]}`)}function Go(n){if(m(n)===null){At(n);return}let t=O(n);if(!t.config)return;T(n,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function Uo(n){let t=n.positionals[1],e=n.positionals[2],r=U({global:n.global}).configTarget;if(t==="list"){let s=O(r);if(s.errors.length>0){for(let i of s.errors)console.error(i);return 1}return Oo(s.config?.transparent_wrappers??[]),0}if(!e||!Kt.test(e))return console.error("transparent wrapper must match command pattern"),1;if(Vt(e))return console.error(`reserved command "${e}" cannot be a wrapper`),1;let a=O(r);if(a.errors.length>0){for(let s of a.errors)console.error(s);return 1}let l=a.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},d=t==="add"?[...new Set([...l.transparent_wrappers??[],e])]:(l.transparent_wrappers??[]).filter((s)=>s!==e);return T(r,{version:1,rules:l.rules,overrides:l.overrides??{},transparent_wrappers:d}),console.log(t==="add"?`Added transparent wrapper: ${e}`:`Removed transparent wrapper: ${e}`),0}function Oo(n){if(n.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${n.length}):`);for(let t of n)console.log(`  - ${t}`)}import{homedir as El}from"node:os";import{existsSync as To,readFileSync as Eo}from"node:fs";import{homedir as _o}from"node:os";import{join as Po}from"node:path";async function Io(){if(process.stdin.isTTY)return null;return(await Pt(process.stdin).catch(()=>null))?.trim()||null}function No(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return Po(_o(),".claude","settings.json")}function ir(){let n=No();if(!To(n))return!1;try{let t=Eo(n,"utf-8"),e=JSON.parse(t);if(!e.enabledPlugins)return!1;let r="cc-safety-net@cc-marketplace";if(!(r in e.enabledPlugins))return!1;return e.enabledPlugins[r]===!0}catch(t){if(pn(D.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${n}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function cr(){let n=ir(),t;if(!n)t="\uD83D\uDEE1️ CC Safety Net ❌";else{let r=A({cwd:process.cwd()}),a=r.policy,l=d2(a),d=Object.values(x2(a,l.capabilities)).some((i)=>i.changesInherited);t=`\uD83D\uDEE1️ CC Safety Net ${{standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[d?"custom":l.effectiveLevel]}${l.worktreeMode?"\uD83C\uDF33":""}${r.state==="degraded"?"⚠️":""}`}let e=await Io();if(e&&!e.startsWith("{"))console.log(`${e} | ${t}`);else console.log(t)}function _l(){let n=A({cwd:process.cwd()}),t=n.policy,e=d2(t),r=!!process.env.NO_COLOR||!process.stdout.isTTY,a=Math.min(process.stdout.columns||80,100),l=r?"ok":"✔",d=r?"OFF":"✘",s=(o,b)=>{let v=`  ${o.padEnd(13)}${b}`;return(v.length>a?`${v.slice(0,a-1)}…`:v).replaceAll(d,y.red(d))},i=Object.values(x2(t,e.capabilities)).some((o)=>o.changesInherited),c=Tt(),L={ready:y.green,degraded:y.yellow}[n.state],p=[...ir()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...n.diagnostics],u=r?"-":"·";console.log([`${r?"":"\uD83D\uDEE1️  "}CC Safety Net — ${L(n.state)}`,"",s("Protection",`destructive ${t.destructiveCommandProtectionEnabled?l:d}   secrets ${t.secretProtection.enabled?l:d}`),s("Level",i?`${e.effectiveLevel} (customised)`:e.effectiveLevel),s("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),s("Policy",c.startsWith(El())?`~${c.slice(El().length)}`:c),...e.worktreeMode?[s("Worktree","relaxations active")]:[],"",...p.length===0?["  Everything configured is active."]:["  Not active",...p.flatMap((o)=>tt(o,"      ",a-6).map((b,v)=>v===0?`    ${u} ${b}`:b)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as fd}from"node:child_process";import{randomBytes as L5}from"node:crypto";import{createServer as o5}from"node:http";import{Writable as p5}from"node:stream";import{homedir as n5}from"node:os";var vt=500;function t5(n){let t=n.filter((a)=>a.decision!=="allow"),e=n.filter((a)=>a.decision==="allow"),r=Math.min(t.length,Math.max(vt-e.length,Math.ceil(vt/2)));return[...t.slice(0,r),...e.slice(0,vt-r)]}function Pl(n,t=s2()){if(t)w2(t);let e=(v)=>new Date(v.getFullYear(),v.getMonth(),v.getDate()).getTime(),r=e(new Date),a=new Date(r);a.setDate(a.getDate()-(n-1));let l=a.getTime(),d=[],s={count:0};for(let v of t?p2(t,s):[])for(let f of an(v,s)){if(!f||typeof f.ts!=="string"||typeof f.command!=="string")continue;let w=new Date(f.ts).getTime();if(!Number.isFinite(w))continue;if(w>=l)d.push(f)}d.sort((v,f)=>new Date(f.ts).getTime()-new Date(v.ts).getTime());let i=Array.from({length:n},()=>0),c=Array.from({length:n},()=>0),L={},p={},u={},o=0,b=0;for(let v of d){let f=v.agent||"unknown";L[f]=(L[f]??0)+1;let w=Math.round((r-e(new Date(v.ts)))/86400000),x=n-1-w,h=w>=0&&w<n;if(h)c[x]=(c[x]??0)+1;if(v.decision!=="allow"){if(o++,v.ruleId)p[v.ruleId]=(p[v.ruleId]??0)+1;let J=S2(v.segment||v.command);if(J)u[J]=(u[J]??0)+1;if(v.failureStage)b++;if(h)i[x]=(i[x]??0)+1}}return{days:n,logsDir:t,homeDir:n5(),totalInWindow:d.length,truncated:d.length>vt,unreadable:s.count,counts:{blocked:o,allowed:d.length-o,agents:L,blockedByDay:i,analyzedByDay:c,rules:p,commands:u,errors:b},entries:t5(d).sort((v,f)=>new Date(f.ts).getTime()-new Date(v.ts).getTime())}}import{spawn as e5}from"node:child_process";import{existsSync as Il,statSync as r5}from"node:fs";import{delimiter as a5,join as l5}from"node:path";var d5=120000,bt="Choose the project folder",s5=`try
  return POSIX path of (choose folder with prompt "${bt}")
on error number -128
  return ""
end try`,i5=`Add-Type -AssemblyName System.Windows.Forms
$dialog = New-Object System.Windows.Forms.FolderBrowserDialog
$dialog.Description = '${bt}'
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,Nl=[{binary:"zenity",args:["--file-selection","--directory",`--title=${bt}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",bt]}],nd=(n,t)=>(t.PATH??"").split(a5).some((e)=>e.length>0&&Il(l5(e,n)));function td(n,t){if(n==="darwin"||n==="win32")return!0;if(n!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return Nl.some((e)=>nd(e.binary,t))}function c5(n,t){if(n==="darwin")return{cmd:"osascript",args:["-e",s5]};if(n==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",i5]};let e=Nl.find((r)=>nd(r.binary,t));return e?{cmd:e.binary,args:e.args}:null}function ed(n=process.platform,t=process.env){let e=c5(n,t);if(!e)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let a=e5(e.cmd,e.args,{env:t,stdio:["ignore","pipe","pipe"]}),l="",d=!1,s=(c)=>{if(d)return;d=!0,clearTimeout(i),r(c)},i=setTimeout(()=>{a.kill(),s({error:"The folder dialog timed out"})},d5);a.stdout.on("data",(c)=>{l+=c.toString()}),a.on("error",()=>s({error:`Could not open the folder dialog (${e.cmd})`})),a.on("close",()=>{let c=l.trim().replace(/\/+$/,"");if(!c)return s({cancelled:!0});if(!Il(c)||!r5(c).isDirectory())return s({error:"That selection is not a folder on disk"});s({path:c})})})}var rd=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var ad='<script id="ccsn-data" type="application/json">';function ld(n){return rd.replace(ad,()=>ad+JSON.stringify({token:n}).replaceAll("<","\\u003c"))}var yt="kenryu42/cc-safety-net",u5=`https://github.com/${yt}`,pr=1e4,v5=7;async function yd(n,t={}){let e=F({label:"gui",booleans:{noOpen:["--no-open"]}},n),r=t.log??console.log,a=t.error??console.error;if(e.errors.length>0){for(let d of e.errors)a(d);return a("Usage: cc-safety-net gui [--no-open]"),1}let l=await b5(t);if(r(`CC Safety Net policy GUI: ${l.url}`),!e.flags.noOpen)try{await(t.openBrowser??g5)(l.url)}catch(d){a(`Failed to open browser: ${d instanceof Error?d.message:String(d)}`),a(`Open this URL manually: ${l.url}`)}if(t.keepAlive===!1)return await l.close(),0;return await m5(l),0}async function b5(n={}){let t=n.token??L5(24).toString("base64url"),e=o5((l,d)=>{f5(l,d,t,n)});await new Promise((l,d)=>{e.once("error",d),e.listen(0,"127.0.0.1",()=>{e.off("error",d),l()})});let a=`http://127.0.0.1:${e.address().port}`;return{origin:a,token:t,url:`${a}/?token=${encodeURIComponent(t)}`,close:()=>$5(e)}}async function f5(n,t,e,r){let a=new URL(n.url??"/","http://127.0.0.1");if(n.method==="GET"&&a.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!w5(n,a,e)){k(t,403,{error:"Forbidden"});return}if(n.method==="GET"&&a.pathname==="/"){x5(t,ld(e));return}if(n.method==="GET"&&a.pathname==="/api/policy"){let l=cd(r);k(t,200,{...l,configState:un(A(r)),destructiveCommandRules:Ln,secretPatterns:sd,version:j(),preview:l.errors.length>0?null:od(l.policy)});return}if(n.method==="POST"&&a.pathname==="/api/policy/preview"){let l=await ft(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=Ld(l.value);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/policy/explain"){let l=await ft(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value;if(d===null||typeof d.command!=="string"){k(t,400,{errors:["command must be a string"]});return}let s=Ot(d.policy);if(s.length>0){k(t,400,{errors:s});return}k(t,200,y5(d.command,d.policy,r));return}if(n.method==="POST"&&a.pathname==="/api/policy"){let l=await ft(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=Lr(l.value,r);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/reset"){k(t,200,Lr(id,r));return}if(n.method==="POST"&&a.pathname==="/api/repair"){k(t,200,pd(r));return}if(n.method==="GET"&&a.pathname==="/api/activity"){let l=V2(r),d=h5(a.searchParams.get("days"),l);if(d===null){k(t,400,{error:`days must be an integer between 1 and ${l}`});return}k(t,200,Pl(d,r.activityLogsDir));return}if(n.method==="POST"&&a.pathname==="/api/rules/choose-directory"){k(t,200,await ed());return}if(n.method==="GET"&&a.pathname==="/api/rules"){let l=u2(r),d=new Map(l.rules.map((s)=>[s.name,s]));k(t,200,{projectPath:r.cwd??process.cwd(),canPickDirectory:td(process.platform,process.env),rulebooks:l.rulebooks.map((s)=>({source:s.source,spec:s.spec,name:s.name,version:s.version,rules:s.rules.flatMap((i)=>{let c=d.get(i);if(!c)return[];return[{name:c.name,command:c.command,subcommand:c.subcommand,block_args:c.block_args,reason:c.reason}]})})),errors:l.errors,warnings:l.warnings});return}if(n.method==="GET"&&a.pathname==="/api/star/context"){k(t,200,await(r.fetchStarContext??(()=>z5({logsDir:r.activityLogsDir})))());return}if(n.method==="POST"&&a.pathname==="/api/star"){let l=await(r.starRepo??D5)();k(t,200,l.ok?{ok:!0}:{ok:!1,fallbackUrl:u5});return}if(n.method==="GET"&&a.pathname==="/api/integrations"){k(t,200,await(r.fetchIntegrations??q5)());return}if(n.method==="GET"&&a.pathname==="/api/health"){k(t,200,await(r.fetchHealth??j5)());return}if(n.method==="POST"&&(a.pathname==="/api/install"||a.pathname==="/api/uninstall")){let l=await ft(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value?.target;if(typeof d!=="string"||!G.some((i)=>i.target===d)){k(t,400,{error:"unknown target"});return}let s=a.pathname==="/api/install"?"install":"uninstall";k(t,200,await(r.runIntegration??F5)(s,d));return}k(t,404,{error:"Not found"})}function y5(n,t,e){let r=ud(t),a=A(e),l=on({rules:a.policy.rules,transparentWrappers:a.policy.transparentWrappers,safety:bd(r.safety),worktreeMode:r.workflow.worktree_mode,destructiveCommandProtectionEnabled:r.destructive_command_protection.enabled,destructiveCommandRuleOverrides:r.destructive_command_protection.overrides,destructiveCommandAllowPaths:r.destructive_command_protection.allow_paths,secretProtection:{enabled:r.secret_protection.enabled,disabledRules:[...vd(r.secret_protection.overrides)],denyPaths:r.secret_protection.deny_paths}});return K2(n,{policySnapshot:l,cwd:e.cwd,userConfigDir:e.userConfigDir})}function h5(n,t){if(n===null)return Math.min(v5,t);let e=Number(n);if(!Number.isInteger(e)||e<1||e>t)return null;return e}function w5(n,t,e){if(t.searchParams.get("token")!==e)return!1;if(n.method!=="POST")return!0;return n.headers["x-cc-safety-net-token"]===e}async function ft(n){let t=[];for await(let e of n)t.push(e);try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(e){return{ok:!1,error:`Invalid JSON: ${e instanceof Error?e.message:String(e)}`}}}function x5(n,t){n.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),n.end(t)}function k(n,t,e){n.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),n.end(JSON.stringify(e))}function $5(n){return new Promise((t,e)=>{n.close((r)=>r?e(r):t())})}function m5(n){return new Promise((t)=>{let e=()=>{process.off("SIGINT",r),process.off("SIGTERM",r)},r=()=>{e(),n.close().then(t)};process.once("SIGINT",r),process.once("SIGTERM",r)})}function g5(n){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",e=process.platform==="win32"?["/c","start","",n]:[n];return new Promise((r,a)=>{let l=fd(t,e,{detached:!0,stdio:"ignore"}),d=(i)=>{l.off("spawn",s),a(i)},s=()=>{l.off("error",d),l.unref(),r()};l.once("error",d),l.once("spawn",s)})}async function D5(n="gh",t=pr){return{ok:await or(n,["api","-X","PUT",`/user/starred/${yt}`],t)===0}}var k5={amp:"ampVersion","antigravity-cli":"antigravityCliVersion","claude-code":"claudeCodeVersion",codex:"codexCliVersion","copilot-cli":"copilotCliVersion",cursor:"cursorVersion","gemini-cli":"geminiCliVersion","hermes-agent":"hermesAgentVersion","kimi-code":"kimiCodeVersion",openclaw:"openClawVersion",opencode:"openCodeVersion",pi:"piCliVersion"};async function q5(n={}){let t=await hn(n.fetcher),e=hd(t,n.homeDir);return{targets:c2.map((r)=>{let a=e.find((l)=>l.platform===r.id);return{target:r.id,label:v2(r.id),version:t[k5[r.id]],status:a?.configured?"active":a?.detected?"disabled":a?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function hd(n,t){return N2(process.cwd(),{homeDir:t,ampPluginListOutput:n.ampPluginListOutput,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.copilotCliVersion})}async function j5(n={}){let[t,e]=await Promise.all([hn(n.fetcher),(n.checkUpdates??T2)()]);return{hooks:hd(t,n.homeDir).filter((r)=>r.detected).map((r)=>({platform:r.platform,label:v2(r.platform),configured:r.configured})),update:{currentVersion:e.currentVersion,latestVersion:e.latestVersion??null,updateAvailable:e.updateAvailable}}}var dd=Promise.resolve();function F5(n,t,e={}){let r=async()=>{let l=[],d=console.log,s=console.error;console.log=(...i)=>l.push(i.map(String).join(" ")),console.error=console.log;try{return{ok:await Fn(n,[],{selectTargets:async()=>[t],output:new p5({write(c,L,p){p()}}),...e})===0,output:l.join(`
`)}}finally{console.log=d,console.error=s}},a=dd.then(r);return dd=a.then(()=>{return},()=>{return}),a}async function z5(n={}){let[t,e,r]=await Promise.all([B5(n.command),J5(n.fetchRepo),Promise.resolve(An(V2(),n.logsDir).totalBlocked)]);return{starred:t,starCount:e,blockedTotal:r}}async function B5(n="gh",t=pr){if(await or(n,["auth","status"],t)!==0)return null;let e=await or(n,["api",`/user/starred/${yt}`],t);if(e===0)return!0;if(e===null)return null;return!1}function or(n,t,e){return new Promise((r)=>{let a=fd(n,t,{stdio:"ignore",windowsHide:!0}),l=!1,d,s=(i)=>{if(l)return;if(l=!0,d)clearTimeout(d);r(i)};a.once("error",()=>s(null)),a.once("close",s),d=setTimeout(()=>{a.kill(),s(null)},e)})}async function J5(n=fetch){try{let t=await n(`https://api.github.com/repos/${yt}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(pr)});if(!t.ok)return null;let e=await t.json();return typeof e.stargazers_count==="number"?e.stargazers_count:null}catch{return null}}function S5(n){if(n[0]!=="help")return!1;let t=n[1];if(!t)Ae(),process.exit(0);if(qn(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var Z5={hook:async(n)=>{let t=Qa(n);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),qn("hook",console.error),process.exit(1)},install:async(n)=>{process.exit(await Fn("install",n))},update:async(n)=>{process.exit(await ar(n))},uninstall:async(n)=>{process.exit(await Fn("uninstall",n))},rule:async(n)=>{process.exit(await Tl(n))},status:async(n)=>{if(r2(F({label:"status"},n).errors))process.exit(1);_l()},statusline:async(n)=>{let t=F({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},n);if(t.errors.length===0&&t.flags.claudeCode){await cr();return}if(r2(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");qn("statusline",console.error),process.exit(1)},doctor:async(n)=>{let t=Qe(n);if(!t)process.exit(1);let e=await j0({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(e)},logs:async(n)=>{process.exit(await ra(n))},gui:async(n)=>{process.exit(await yd(n))},explain:async(n)=>{let t=Xe(n);if(!t)process.exit(1);let e=K2(t.command,{cwd:t.cwd}),r=!!process.env.NO_COLOR||!process.stdout.isTTY;if(t.json)console.log(He(e));else console.log(Re(e,{asciiOnly:r}));process.exit(0)}};async function Q5(){let n=process.argv.slice(2),t=F({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},n);if(S5(n))return;let e=n[0],r=e?Hn(e):void 0;if(t.help&&r&&r.name!=="rule")qn(r.name),process.exit(0);if(!e||t.help&&!r)Ae(),process.exit(0);if(t.flags.version)X0(),process.exit(0);if(r){await Z5[r.name](n.slice(1));return}let a=Xa(e);if(a){await a.run();return}if(e==="--statusline"){await cr();return}console.error(e.startsWith("-")?`Unknown option: ${e}`:`Unknown command: ${e}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}Q5().catch((n)=>{console.error("CC Safety Net error:",n),process.exit(1)});
