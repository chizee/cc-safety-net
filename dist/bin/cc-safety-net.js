#!/usr/bin/env node
import{b as qo,c as Vo,d as G,e as zo,f as er,g as nt,h as Ee,i as hr,j as pe,k as ji,l as Cr,m as Xt,n as Ui,o as Gi,p as Qt}from"../chunks/index-kffv64x7.js";import{$ as me,$a as md,A as De,Aa as kt,B as Ye,Ba as wr,C as Yc,Ca as kr,D as li,Da as Si,E as ci,Ea as Ri,F as di,Fa as Xo,G as ve,Ga as et,H as rr,Ha as sr,I as pr,Ia as ar,J as Jt,Ja as pi,K as Zc,Ka as We,La as fi,M as ui,Ma as ud,N as Q,Na as ei,Oa as ti,P as ee,Pa as xr,Q as Xe,Qa as ni,R as Qe,Ra as ri,S as vt,Sa as Z,T as jc,Ta as lr,U as te,Ua as mr,V as Y,Va as gr,W as fr,Wa as X,X as or,Xa as pd,Y as Yt,Ya as xt,Z as ir,Za as fd,_a as Mo,aa as V,ab as gd,ba as es,bb as hd,cb as On,da as Pe,db as yd,ea as en,eb as Ld,fa as Rt,fb as Di,ga as bt,gb as Ai,ha as Te,hb as Ei,ia as yr,ib as Pi,ja as fe,jb as qc,ka as Bi,kb as mi,la as Sr,lb as gi,ma as zi,mb as Zt,na as Ki,nb as Vc,oa as Lr,ob as hi,pa as wi,pb as yi,qa as Yo,qb as be,ra as ki,rb as Ae,s as St,sa as xi,sb as de,t as bi,ta as Ci,tb as Li,u as M,ua as vr,ub as B,v as C,va as Zo,vb as Ct,w as yt,wa as S,wb as wt,x,xa as br,xb as Vi,y as Re,ya as qi,z as ai,za as ue}from"../chunks/index-jddx0b5t.js";var Cd=["-h","--help"];function _(e,t){let n=Object.entries(e.booleans??{}),r=Object.entries(e.values??{}),o=Object.entries(e.lists??{}),i=Object.fromEntries(n.map(([g])=>[g,!1])),s={},a=Object.fromEntries(o.map(([g])=>[g,[]])),l=[],c=[],u=!1,p=-1;for(let[g,d]of t.entries()){if(g<=p)continue;if(d==="--"){l.push(...t.slice(g+1));break}if(Cd.includes(d)){u=!0;continue}let h=n.find(([,L])=>L.includes(d));if(h){i[h[0]]=!0;continue}let m=r.find(([,L])=>L.includes(d));if(m){let L=t[g+1];if(L===void 0||L.startsWith("-")){c.push(`${d} requires a value`);continue}s[m[0]]=L,p=g+1;continue}let b=o.find(([,L])=>L.includes(d));if(b){let L=t.slice(g+1),w=L.findIndex((v)=>v.startsWith("-")),f=L.slice(0,w===-1?L.length:w);if(f.length===0){c.push(`${d} requires at least one value`);continue}a[b[0]]=[...a[b[0]]??[],...f],p=g+f.length;continue}if(d.startsWith("-")){c.push(`Unknown option for ${e.label}: ${d}`);continue}if(e.positionals==="tail"){l.push(...t.slice(g));break}l.push(d)}if(e.positionals!=="list"&&e.positionals!=="tail")c.push(...l.map((g)=>`Unexpected argument for ${e.label}: ${g}`));return{flags:i,values:s,lists:a,positionals:l,help:u,errors:c}}function le(e){for(let t of e)console.error(t);return e.length>0}import{readdirSync as mu,statSync as Ii,unlinkSync as gu}from"node:fs";import{basename as _i,dirname as hu,join as yu,resolve as Lu}from"node:path";function O(e){return Array.from(e,(t)=>{let n=t.charCodeAt(0);if(n<=31||n>=127&&n<=159)return`\\x${n.toString(16).padStart(2,"0")}`;return t}).join("")}var Yn=(e)=>{let t=Date.now()-new Date(e).getTime();if(!Number.isFinite(t))return"";let n=Math.floor(t/60000),r=Math.floor(n/60),o=Math.floor(r/24);if(o>0)return`${o}d ago`;if(r>0)return`${r}h ago`;if(n>0)return`${n}m ago`;return"just now"},Ve=(e)=>{let t=(e??"").trim().split(/\s+/).filter((o)=>o&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(o)),n=t[0]?.split("/").pop();if(!n)return null;let r=t[1];return r&&/^[a-z][a-z0-9-]*$/.test(r)?`${n} ${r}`:n};import{existsSync as Sd,readdirSync as Rd,readFileSync as Dd}from"node:fs";import{join as Ad}from"node:path";function Le(e,t){try{return Rd(e,{withFileTypes:!0,encoding:"utf8"}).flatMap((n)=>{let r=Ad(e,n.name);if(n.isDirectory())return Le(r,t);if(n.name.endsWith(".jsonl"))return[r];return[]})}catch{if(t&&Sd(e))t.count++;return[]}}function Zn(e){let t=(o)=>`${o.sessionId}
${Ve(o.segment||o.command)}`,n=e.filter((o)=>o.decision!=="allow"),r=n.filter((o)=>o.sessionId).reduce((o,i)=>o.set(t(i),(o.get(t(i))??0)+1),new Map);return new Set(n.filter((o)=>o.failureStage||(r.get(t(o))??0)>=2))}var Ed=["segment","reason","sessionId","decision","agent","ruleId","failureStage"];function Pd(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e;if(typeof t.ts!=="string"||typeof t.command!=="string")return!1;return Ed.every((n)=>t[n]===void 0||typeof t[n]==="string")}function Se(e,t){try{return Dd(e,"utf-8").split(`
`).filter(Boolean).flatMap((n)=>{try{let r=JSON.parse(n);if(!Pd(r)){if(t)t.count++;return[]}return[r]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as su}from"node:path";var Td=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function Ko(e){let t=0,n={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(r){e.record({kind:"step",scope:"global",step:r})},recordSegment(r,o=n.currentSegmentIndex){if(o===void 0)return;e.record({kind:"step",scope:"segment",segmentIndex:o,step:r})}};return n}function Wo(e={}){let t=[],n=e.maxEvents??512,r={maxTextLength:e.maxTextLength??2048,maxListLength:e.maxListLength??128,maxObjectProperties:e.maxObjectProperties??e.maxListLength??128,maxDepth:e.maxDepth??16},o=0,i,s=new Set;return{record(a){if(i)return;try{if(!a||t.length>=n){o++;return}t.push(Qn(Id(a,r,s)))}catch{o++}},finish(a){if(i)return i;try{i=Qn({events:Object.freeze(t),droppedEvents:o,terminal:_d(a,r,s)})}catch{o++,i=Object.freeze({events:Object.freeze(t),droppedEvents:o,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,r.maxTextLength),segment:"trace unavailable".slice(0,r.maxTextLength)})})}return i}}}function Id(e,t,n){if(e.kind!=="step")throw TypeError("invalid trace event");let{scope:r,step:o}=e;Kt(o,n,t);let i=ze(o,t,n);if(r==="global")return{kind:"step",scope:"global",step:i};if(r!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:e.segmentIndex,step:i}}function _d(e,t,n){let r=e.result;if(r==="allowed")return Object.freeze({result:"allowed"});if(r!=="blocked")throw TypeError("invalid trace terminal");let o=e.ruleId;return Object.freeze({result:"blocked",reason:ze(e.reason,t,n),segment:ze(e.segment,t,n),...o?{ruleId:ze(o,t,n)}:{}})}function Kt(e,t,n,r=0,o=new WeakSet){if(typeof e==="string"){let a=e.slice(0,n.maxTextLength);if(!er(a))return;for(let l of zo(a))for(let c of l.match(/[^\s"'()$]+/g)??[])t.add(Jo(c));return}if(!e||typeof e!=="object"||r>=n.maxDepth||o.has(e))return;if(o.add(e),Array.isArray(e)){let a=Math.min(e.length,n.maxListLength);for(let l=0;l<a;l++)Kt(e[l],t,n,r+1,o);return}let i=0,s=new Set;for(let a in e){if(!Object.hasOwn(e,a))continue;if(i>=n.maxObjectProperties)break;i++,Kt(a,t,n);let l=Xn(a,n,t);if(s.has(l))continue;s.add(l),Kt(e[a],t,n,r+1,o)}}function ze(e,t,n,r=0,o=new WeakSet){if(typeof e==="string")return Xn(e,t,n);if(!e||typeof e!=="object")return e;if(r>=t.maxDepth)return;if(o.has(e))return;if(o.add(e),Array.isArray(e)){let a=[],l=Math.min(e.length,t.maxListLength);for(let c=0;c<l;c++)a.push(ze(e[c],t,n,r+1,o));return a}let i={},s=0;for(let a in e){if(!Object.hasOwn(e,a))continue;if(s>=t.maxObjectProperties)break;s++;let l=Xn(a,t,n);if(Object.hasOwn(i,l))continue;Object.defineProperty(i,l,{value:ze(e[a],t,n,r+1,o),enumerable:!0,configurable:!0,writable:!0})}return i}function Xn(e,t,n){let r=e.slice(0,t.maxTextLength),o=er(r)?Vo(r):r,i=n.size>0?$d(o,n):o;return(Od(i)?qo(i):i).slice(0,t.maxTextLength)}function Od(e){return e.includes("PRIVATE KEY")||e.includes("://")||e.includes("eyJ")||e.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(e)||e.length>=14&&Td.some((t)=>e.includes(t))||e.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(e)}function $d(e,t){return e.replace(/[^\s"'()$]+/g,(n)=>t.has(Jo(n))?"<redacted>":n)}function Jo(e){let t=2166136261,n=2166136261;for(let r=0;r<e.length;r++)t=Math.imul(t^e.charCodeAt(r),16777619),n=Math.imul(n^e.charCodeAt(e.length-r-1),16777619);return`${t>>>0}:${n>>>0}:${e.length}`}function Qn(e){if(e&&typeof e==="object"&&!Object.isFrozen(e)){for(let t of Object.values(e))Qn(t);Object.freeze(e)}return e}function Qo(e,t,n){let r=n??Yo(),o=r.getCommandProgram(e,t.shell??"auto"),i=Wo(),s=Ko(i),a=o.dialect==="powershell"?r.getCommandProgram(e,"posix"):o,l=Zo(a);s.recordGlobal({type:"parse",input:e,segments:l.map((p)=>[...p])});let c=Xo(e,{...t,analyzePartialProgram:!0,trace:s},o,r),u=s.getNextSegmentIndex();if(c&&u>0&&u<l.length)s.recordSegment({type:"segment-skipped",index:u,reason:"prior-segment-blocked"},u);return Object.freeze({decision:c,trace:i.finish(c?{result:"blocked",reason:c.reason,segment:c.evidence.find((p)=>p.kind==="command")?.segment??e,...c.ruleId?{ruleId:c.ruleId}:{}}:{result:"allowed"}),program:o})}import{resolve as Nd}from"node:path";function tr(e){let t=ei().safeParse(e);return{errors:t.success?[]:ni(t.error.issues),ruleNames:new Set(ti(e).map((n)=>n.toLowerCase()))}}function nr(e){let t=oi(e);if(!t.ok)return t.result;return tr(t.parsed)}function oi(e){let t=[],n=new Set;try{let r=typeof e==="string"?yt(e):e,o=x(r);if(o===null)return t.push(`File not found: ${r.path}`),{ok:!1,result:{errors:t,ruleNames:n}};if(!o.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:n}};return{ok:!0,parsed:JSON.parse(o)}}catch(r){if(r instanceof M)return t.push(r.message),{ok:!1,result:{errors:t,ruleNames:n}};let o=r instanceof Error?r.message:String(r);return t.push(r instanceof SyntaxError?"Invalid JSON":o),{ok:!1,result:{errors:t,ruleNames:n}}}}function ii(e){return Nd(e??process.cwd(),".safety-net.json")}function ce(e){let t=oi(e);if(!t.ok)return t.result;let n=ri(t.parsed);return{errors:n.errors,ruleNames:n.sources}}import{isAbsolute as Fd,join as Lt,relative as Hd,resolve as si,sep as Md}from"node:path";async function Ze(e={}){let t=dr(e);return jd(t,await Wt(t,We()))}function jd(e,t){if(!t.ok)return t;let n=Y(e),r=[...new Set(de(n.configPath,n.lockPath,e,n.filesystemScope))];if(r.length===0)return t;return{ok:!1,errors:r,warnings:t.warnings,entries:t.entries}}async function Wt(e,t,n,r={}){let o=null,i=!1;try{let s=Y(e),a=lr(s.configTarget);if(!a.ok)return a.result;let l=a.config;if(e.check)return Yd(l,s,e);o={target:s.lockTarget,content:x(s.lockTarget)};let c=Zt(s.lockTarget);if(c.errors.some((f)=>f.startsWith("Unable to access ")))return{ok:!1,errors:c.errors,warnings:[],entries:[]};if(e.only&&c.errors.length>0)return{ok:!1,errors:c.errors,warnings:[],entries:[]};let u=c.errors.length>0?null:c.lock,p=e.only?mi(l,u,e.only):{ok:!0,specs:l.rules};if(!p.ok)return p.result;if(e.only&&!u&&p.specs.length<l.rules.length)return{ok:!1,errors:[`No lockfile available for partial update; run ${ui}`],warnings:[],entries:[]};let g=(f)=>hi(f,s.configDir,e,u,s.filesystemScope,t),d=await Vd(p.specs,e.refresh?(f)=>g(f).then((v)=>({ok:!0,item:v})).catch((v)=>{if(fi(v))throw v;return{ok:!1,spec:f,message:v instanceof Error?v.message:String(v)}}):async(f)=>({ok:!0,item:await g(f)}),t),h=d.filter((f)=>!f.ok),m=d.filter((f)=>f.ok).map((f)=>Zd(f.item,u,n));m.forEach((f)=>{eu(f.content,f.entry,s.configDir,e,s.filesystemScope)});let b=e.only||e.refresh?Xd(l,u,m):m.map((f)=>f.entry);i=!0,X(s.lockTarget,{version:1,rulebooks:b},void 0,r._testAfterPolicyRename);let L=new Map(m.map((f)=>[f.entry.spec,f.rulebook.rules.length])),w=tu(b,s.configDir,e,s.filesystemScope,r);return{ok:h.length===0,errors:h.map((f)=>`Failed to update ${f.spec}: ${f.message}`),warnings:w,entries:b.map((f)=>Qd(f,L))}}catch(s){if(i&&o)try{Ke(o.target,o.content)}catch(a){return Je(a)}return Je(s)}}async function cr(e,t={}){return Ud(e,Kd(t),We())}async function Ud(e,t,n,r={}){let o=null,i=!1;try{let s=Y(t),a=x(s.configTarget);o={target:s.configTarget,content:a};let l=lr(s.configTarget);if(!l.ok)return l.result;let c=l.config,u=Jt(e);Gd(e,t,u);let p=u?await yi(e,{ref:t.ref,operation:n}):null,g=p?Bd(p,t.rulebooks):[],d=p?Zt(s.lockTarget):null,h=d?.errors.length===0?d.lock:null,m=p?g.map((v)=>qd(c.rules,h,p,v)??`${e}#${p.ref}/${v}`):[e],b=m.filter((v)=>!c.rules.includes(v)),L=[...c.rules,...b];if(L.length>sr)return zd();if(L.length!==c.rules.length)i=!0,X(s.configTarget,{version:1,rules:L,overrides:c.overrides??{},transparent_wrappers:c.transparent_wrappers??[]},void 0,r._testAfterPolicyRename);let w=await Wt(t,n,void 0,r);if(!w.ok)Ke(s.configTarget,a);if(!w.ok||!p)return w;let f=g.filter((v,N)=>b.includes(m[N]??""));return{...w,add:{source:e,ref:p.ref,selected:g,added:f,alreadyConfigured:g.filter((v)=>!f.includes(v)),commits:[...new Set(w.entries.filter((v)=>v.kind==="github"&&v.owner===p.owner&&v.repo===p.repo&&g.includes(v.name)&&(v.display_ref??v.ref)===p.ref).map((v)=>v.kind==="github"?v.commit:""))]}}}catch(s){if(i&&o)try{Ke(o.target,o.content)}catch(a){return Je(a)}return Je(s)}}function Gd(e,t,n){if(!n&&t.rulebooks!==void 0)throw Error("--only can only select rulebooks from an owner/repo source");if(!n&&t.ref)throw Error(`--ref can only select a ref for an owner/repo source: ${e}`);if(t.rulebooks?.length===0)throw Error("--only requires at least one rulebook name");let r=t.rulebooks?.filter((o)=>!ve.test(o))??[];if(r.length>0)throw Error(`Invalid rulebook names: ${r.join(", ")}`)}function Bd(e,t){let n=t?[...new Set(t)]:e.names,r=n.filter((o)=>!e.names.includes(o));if(r.length>0)throw Error(`Rulebooks not found in ${e.source} at ${e.ref}: ${r.join(", ")}
Available rulebooks: ${e.names.join(", ")}`);return n}function qd(e,t,n,r){let o=`${n.source}#${n.ref}/${r}`;if(e.includes(o))return o;let i=new Map(t?.rulebooks.map((s)=>[s.spec,s])??[]);return e.find((s)=>{let a=i.get(s);return a?.kind==="github"&&a.owner===n.owner&&a.repo===n.repo&&a.name===r&&(a.display_ref??a.ref)===n.ref})}async function Vd(e,t,n=We()){if(e.length>sr)throw Error(ar);let r=Array(e.length),o=0,i,s=Array.from({length:Math.min(e.length,pi.concurrency)},async()=>{while(!i){let a=o;if(a>=e.length)return;o++;try{r[a]=await t(e[a],a,n.controller.signal)}catch(l){if(!i)i={value:l},o=e.length,n.controller.abort(l);return}}});if(await Promise.all(s),i)throw i.value;return r}function zd(){return{ok:!1,errors:[ar],warnings:[],entries:[]}}function dr(e){return{cwd:e.cwd,cacheConfigDir:e.cacheConfigDir,userConfigDir:e.userConfigDir,userConfigPath:e.userConfigPath,projectConfigPath:e.projectConfigPath,global:e.global,check:e.check,only:e.only,refresh:e.refresh}}function Kd(e){return{...dr(e),ref:e.ref,rulebooks:e.rulebooks}}function Wd(e){return{...dr(e),deleteSource:e.deleteSource}}async function ur(e,t={}){try{return await Jd(e,Wd(t),{})}catch(n){return Je(n)}}async function Jd(e,t,n){let r=Y(t),o=Z(r.configTarget);if(o.errors.length>0)return{ok:!1,errors:o.errors,warnings:[],entries:[]};if(!o.config)return{ok:!1,errors:[`No config found at ${r.configPath}`],warnings:[],entries:[]};let i=Zt(r.lockTarget);if(i.errors.length>0)return{ok:!1,errors:i.errors,warnings:[],entries:[]};let s=gi(o.config.rules,i.lock,e);if(!s.ok)return s.result;let a=t.deleteSource?nu(r.configDir,s.specs,i.lock,r.filesystemScope):{ok:!0,dirs:[]};if(!a.ok)return a.result;let l=x(r.configTarget);if(l===null)return Je(Error("Rules config is unavailable."));try{X(r.configTarget,{version:1,rules:o.config.rules.filter((p)=>!s.specs.includes(p)),overrides:o.config.overrides??{},transparent_wrappers:o.config.transparent_wrappers??[]},void 0,n._testAfterPolicyRename)}catch(p){throw Ke(r.configTarget,l),p}let c=await Wt(t,We(),void 0,n);if(!c.ok)return Ke(r.configTarget,l),c;let u=ru(r.configDir,a.dirs,n,r.filesystemScope);if(!u.ok){Ke(r.configTarget,l);let p=await Wt(t,We(),void 0,n);if(!p.ok)return{ok:!1,errors:[...u.result.errors,...p.errors],warnings:p.warnings,entries:p.entries};return u.result}return c}async function Yd(e,t,n){let r=Li(e,t.lockPath,t.configDir,n,n.global?"user":"project",t.filesystemScope);return{ok:r.errors.length===0&&r.warnings.length===0,errors:[...r.errors,...r.warnings],warnings:[],entries:r.entries}}function Zd(e,t,n){let r=t?.rulebooks.find((i)=>i.spec===e.entry.spec&&i.kind==="github"),o=n?.get(e.entry.spec)??(r?.kind==="github"?r.display_ref:void 0);if(!o||e.entry.kind!=="github")return e;return{...e,entry:{...e.entry,display_ref:o}}}function Xd(e,t,n){let r=new Set(e.rules),o=new Set(t?.rulebooks.map((s)=>s.spec)??[]),i=new Map(n.map((s)=>[s.entry.spec,s.entry]));return[...(t?.rulebooks.filter((s)=>r.has(s.spec))??[]).map((s)=>i.get(s.spec)??s),...n.filter((s)=>!o.has(s.entry.spec)).map((s)=>s.entry)]}function Qd(e,t){return{...e,ruleCount:t.get(e.spec)}}function eu(e,t,n,r,o){let i=or(t,ir(n,r));Re(C(o,i),e)}function tu(e,t,n,r,o){let i=ir(t,n),s=Yt(i),a=C(r,s),l=De(a);if(!l)return[];let c=e.map((p)=>C(r,or(p,i))),u=l.filter((p)=>p.kind==="directory").map((p)=>({directory:C(r,Lt(s,p.name)),identity:C(r,Lt(s,p.name,rr))})).filter((p)=>!c.some((g)=>ai(p.identity,g))).map((p)=>p.directory);for(let p of u)di(p);return u.flatMap((p)=>{try{return ou(p,o),[]}catch{return["Unable to prune rules policy cache safely."]}})}function nu(e,t,n,r){let o=new Map(n?.rulebooks.map((c)=>[c.spec,c])??[]),i=t.flatMap((c)=>{let u=o.get(c);if(!u)return ve.test(c)?[]:["--delete-source can only delete local rulebook sources"];return u.kind==="local-directory"?[]:["--delete-source can only delete local rulebook sources"]}),s=t.map((c)=>{let u=o.get(c);return Lt(e,u?.kind==="local-directory"?u.path:c)}),a=i.length>0?[]:s.flatMap((c)=>vi(e,c,r)),l=[...i,...a];return l.length>0?{ok:!1,result:{ok:!1,errors:l,warnings:[],entries:[]}}:{ok:!0,dirs:s}}function vi(e,t,n){let r=si(e),o=si(t),i=Hd(r,o);if(i===""||i===".."||i.startsWith(`..${Md}`)||Fd(i))return[`Refusing to delete local rulebook source outside ${e}: ${t}`];let s=C(n,o),a=De(s);if(!a)return[`Local rulebook source directory not found: ${t}`];let l=a.find((c)=>c.name==="rulebook.json");if(!l)return[`Local rulebook source directory is missing rulebook.json: ${t}`];if(l.kind!=="file")throw new M(n.label);if(x(C(n,Lt(o,"rulebook.json"))),a.length>1)return[`Local rulebook source directory contains extra files: ${t}. delete manually if you really want to remove the directory.`];return[]}function ru(e,t,n,r){let o=t.flatMap((i)=>{try{if(!De(C(r,i)))return[];let s=vi(e,i,r);if(s.length>0)return s;return iu(i,n,r),[]}catch(s){return[`Failed to delete local rulebook source ${i}: ${s instanceof Error?s.message:String(s)}`]}});return o.length>0?{ok:!1,result:{ok:!1,errors:o,warnings:[],entries:[]}}:{ok:!0}}function ou(e,t){if(t._testPruneRulebookCacheDir){t._testPruneRulebookCacheDir(e.path);return}li(e)}function iu(e,t,n){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(e);return}Ye(C(n,Lt(e,rr))),ci(C(n,e))}function Ke(e,t){if(t===null){Ye(e);return}Re(e,t)}function Je(e){return{ok:!1,errors:[e instanceof Error?e.message:String(e)],warnings:[],entries:[]}}function tt(e,t){let n=lu(t),r=Si(n),o={effectiveLevel:r.effectiveLevel,selectedPreset:n.policySnapshot.policy.safety.level??"standard",effectiveCapabilities:r.effectiveCapabilities,destructiveCommandRuleOverrides:n.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:i,configValid:s}=au({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!e||!e.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:i,configValid:s,...o};let a=cu(e,n);if(a)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",rule:a.rule,matched:!0,reason:a.reason}]}]},result:"blocked",reason:G(a.reason),segment:G(a.target),...a.ruleId?{ruleId:G(a.ruleId)}:{},configSource:i,configValid:s,...o};let l=Qo(e,n),c=l.decision,u=c?.ruleId??du(e,n),p=bt.find((d)=>d.id===u&&d.activationCapability),g=p?r.policy.effectiveDestructiveCommandRules[p.id]:void 0;return{trace:pu(l.trace),result:c?"blocked":"allowed",reason:c?G(c.reason):void 0,segment:c?G(c.evidence.find((d)=>d.kind==="command")?.segment??e):void 0,ruleId:c?.ruleId?G(c.ruleId):void 0,customRule:uu(fu(c?.ruleId,n.policySnapshot)),configSource:i,configValid:s,...o,...p&&g?{ruleActivation:{id:p.id,...g}}:{}}}function au(e){let t=Q(e?.cwd),n=e?.userConfigPath??ee(e),r=te({cwd:e?.cwd,userConfigDir:e?.userConfigDir,userConfigPath:e?.userConfigPath});try{if(x(r.projectConfigTarget)!==null){if(ce(r.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(o){if(o instanceof M)return{configSource:t,configValid:!1};throw o}try{if(x(r.userConfigTarget)!==null){let o=ce(r.userConfigTarget);return{configSource:n,configValid:o.errors.length===0}}return{configSource:null,configValid:!0}}catch(o){if(o instanceof M)return{configSource:n,configValid:!1};throw o}}function lu(e){let t=su(e?.cwd??process.cwd()),n=e?.policySnapshot??B({cwd:t,userConfigDir:e?.userConfigDir}),r=ue(n.policy);return{cwd:t,effectiveCwd:t,policySnapshot:n,environment:bi(),protectedGitMetadata:Ci([t]),effectiveCapabilities:r.capabilities,strict:e?.strict??r.strict,paranoidRm:r.paranoidRm,paranoidInterpreters:r.paranoidInterpreters,worktreeMode:r.worktreeMode}}function cu(e,t){let n=t.cwd??process.cwd(),r=wi(et("",{command:e},{kind:"command",shell:"posix"},{executionCwd:n,configCwd:n},e)),o=Ai(r);if(o)return{reason:Di,target:o.target,ruleId:"policy-protection",rule:"policy-protection:findPolicyConfigMutationTargetInSemanticFacts"};let i=xi(r,t.protectedGitMetadata);if(i)return{reason:ki,target:i.target,ruleId:"git-metadata-protection",rule:"git-metadata-protection:findGitMetadataMutationTargetInSemanticFacts"};let s=t.policySnapshot.policy,a=s.secretProtection.enabled===!1?null:Pi(r,s.secretProtection,{strict:t.strict});if(a)return{reason:Ei,target:a.target,ruleId:a.ruleId,rule:"secret-protection:findSensitiveTargetInSemanticFacts"};return null}function du(e,t){let n=t.policySnapshot.policy,r=wt({...n,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...n.destructiveCommandRuleOverrides,...Object.fromEntries(bt.flatMap((o)=>o.activationCapability?[[o.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return Ri(e,{...t,policySnapshot:r,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function uu(e){if(!e)return;return{id:G(e.id),...e.rulebook?{rulebook:{name:G(e.rulebook.name),version:G(e.rulebook.version)}}:{},...e.source?{source:G(e.source)}:{},...e.override?{override:{type:"reason",reason:G(e.override.reason)}}:{}}}function pu(e){let t=e.events.flatMap((r)=>r.kind==="step"&&r.scope==="global"?[r.step]:[]),n=new Map;for(let r of e.events){if(r.kind!=="step"||r.scope!=="segment")continue;let o=n.get(r.segmentIndex)??{index:r.segmentIndex,steps:[]};o.steps.push(r.step),n.set(r.segmentIndex,o)}return{steps:t,segments:[...n.values()]}}function fu(e,t){let n=e?.replace(/^custom\./,"");if(!n||!t.policy.rules.some((r)=>r.name===n))return;return t.ruleMetadata[n]??Object.freeze({id:n})}function vu(e){let t=nt(),n=_({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},e);if(le(n.errors))return null;if(n.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(n.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let r=n.values.limit===void 0?20:Ti(n.values.limit);if(r===null)return console.error("--limit must be a positive number"),null;let o=n.values.since===void 0?Math.min(30,t):Ti(n.values.since);if(o===null||o>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let i={limit:r,limitExplicit:n.values.limit!==void 0,since:o,sinceExplicit:n.values.since!==void 0,all:n.flags.all,json:n.flags.json,suspect:n.flags.suspect,pruneLegacy:n.flags.pruneLegacy,dryRun:n.flags.dryRun,id:n.values.id,agent:n.values.agent,rule:n.values.rule,session:n.values.session,project:n.values.project===void 0?void 0:Lu(n.values.project)};if(i.id&&(i.agent!==void 0||i.rule!==void 0||i.session!==void 0||i.project!==void 0||i.suspect||i.sinceExplicit||i.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(i.pruneLegacy&&(i.id!==void 0||i.agent!==void 0||i.rule!==void 0||i.session!==void 0||i.project!==void 0||i.suspect||i.all||i.sinceExplicit||i.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(i.dryRun&&!i.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return i}async function Oi(e,t={}){let n=vu(e);if(!n)return 1;let r=t.logsDir??pe();if(n.pruneLegacy)return bu(r,n.json,n.dryRun);if(!r)return console.log(n.json?"[]":n.id?`No retained audit log entry found for id ${O(n.id)}.`:"No audit log entries found."),0;Ee(r);let o={count:0},i=Le(r,o).flatMap((u)=>Se(u,o).map((p)=>({entry:p,file:u})));if(o.count>0)console.error(`warning: ${o.count} audit log ${o.count===1?"source":"sources"} could not be read; these results are incomplete`);if(n.id)return Cu(i,n,t.timeZone);let s=Date.now()-n.since*24*60*60*1000,a=i.filter((u)=>Su(u,n,r,s)),l=n.suspect?Zn(a.map((u)=>u.entry)):null,c=(l?a.filter((u)=>l.has(u.entry)):a).sort((u,p)=>Date.parse(p.entry.ts)-Date.parse(u.entry.ts)).slice(0,n.limit);if(n.json)return console.log(JSON.stringify(c.map((u)=>u.entry),null,2)),0;if(c.length===0)return console.log("No audit log entries found."),0;for(let u of c)console.log(Au(u.entry,t.timeZone));return 0}function bu(e,t,n){let r=e?ku(e).map((a)=>yu(e,a)):[];if(n)return wu(r,t);let o=[],i=0,s=0;for(let a of r){let l=Ii(a,{throwIfNoEntry:!1})?.size??0,c=xu(a);if(c){o.push(`${_i(a)}: ${c}`);continue}i++,s+=l}if(t)return console.log(JSON.stringify({removedFiles:i,removedBytes:s,failedFiles:o.length})),o.length===0?0:1;console.log(i===0&&o.length===0?"No legacy audit log files found.":`Removed ${i} legacy audit log ${i===1?"file":"files"} (${$i(s)}).`);for(let a of o)console.error(`Could not remove ${O(a)}`);if(console.log("Nested v2 audit logs were not changed."),i>0)console.log("This deletion cannot be undone.");return o.length===0?0:1}function wu(e,t){let n=e.reduce((r,o)=>r+(Ii(o,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:e.length,bytes:n})),0;if(console.log(e.length===0?"No legacy audit log files found.":`Would remove ${e.length} legacy audit log ${e.length===1?"file":"files"} (${$i(n)}).`),console.log("Nested v2 audit logs are not included."),e.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function ku(e){try{return mu(e,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function xu(e){try{return gu(e),null}catch(t){return t instanceof Error?t.message:String(t)}}function $i(e){let t=["B","KiB","MiB","GiB"],n=Math.min(Math.floor(Math.log2(Math.max(e,1))/10),t.length-1);return`${Math.round(e/1024**n*10)/10} ${t[n]}`}function Cu(e,t,n){let r=e.filter((i)=>i.entry.id===t.id);if(r.length>1)return console.error(`Multiple audit log entries found for id ${O(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(r.map((i)=>i.entry),null,2)),0;let o=r[0];if(!o)return console.log(`No retained audit log entry found for id ${O(t.id??"")}.`),0;return console.log(Eu(o.entry,n)),0}function Su(e,t,n,r){if(!t.all&&e.entry.decision==="allow")return!1;if(Date.parse(e.entry.ts)<r)return!1;if(t.agent!==void 0&&e.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&e.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!Ru(e,n,t.session))return!1;if(t.project!==void 0&&!Du(e.entry.cwd,t.project))return!1;return!0}function Ru(e,t,n){if(e.entry.sessionId===n)return!0;return hu(e.file)===t&&_i(e.file,".jsonl")===n}function Du(e,t){if(!e)return!1;return e===t||e.startsWith(`${t}/`)}function Au(e,t){let n=O(e.id??"-"),r=O(e.decision??"deny"),o=e.cwd?`  [${O(e.cwd)}]`:"",i=e.segment||e.command,s=i===e.command?"":"↳ ",a=i.length>50?`${i.slice(0,50)}…`:i;return`${n.padEnd(16)}  ${O(Ni(e.ts,t))}  ${r.padEnd(5)}  ${O(e.agent??"-").padEnd(15)}  ${O(e.ruleId??"-").padEnd(20)}  ${s}${O(a)}${o}`}function Eu(e,t){let n=(o)=>O(o===void 0||o===null||o===""?"-":o),r=e.shape?`${e.agent??"-"} (shape: ${e.shape})`:e.agent??"-";return[`id:        ${n(e.id)}`,`ts:        ${n(Ni(e.ts,t))}`,`decision:  ${n(e.decision)}`,`agent:     ${n(r)}`,`level:     ${n(e.level)}`,`tool:      ${n(e.toolName)}`,`rule:      ${n(e.ruleId)}`,`intent:    ${n(e.intent)}`,`stage:     ${n(e.failureStage)}`,`error:     ${n(e.errorCode)}`,`session:   ${n(e.sessionId)}`,`cwd:       ${n(e.cwd)}`,`version:   ${n(e.v)}`,`truncated: ${n(e.truncated===!0?"yes":void 0)}`,`reason:    ${n(e.reason)}`,`command:   ${n(e.command)}`,`segment:   ${n(e.segment)}`].join(`
`)}function Ni(e,t){let n=new Date(e);if(Number.isNaN(n.getTime()))return e;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(n)}function Ti(e){let t=Number(e);return Number.isFinite(t)&&t>0?t:null}var Fi={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var Hi={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var Mi={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as Wi,join as ju,relative as Uu}from"node:path";var Pu=8388608;function Tu(e,t){console.log(JSON.stringify(e(Ui(t))))}async function Iu(e){let t;try{t=(await Rr(process.stdin)).trim()}catch{e({reason:"Failed to parse hook input JSON."});return}if(!t){e({reason:"Missing hook input JSON."});return}return Dr(t,e,"Failed to parse hook input JSON.")}async function Rr(e){let t=[],n=0;for await(let r of e){let o=typeof r==="string"?Buffer.from(r,"utf-8"):Buffer.from(r.buffer,r.byteOffset,r.byteLength);if(n+=o.byteLength,n>Pu)throw _u(e),Error("hook input byte limit exceeded");t.push(o)}return Buffer.concat(t,n).toString("utf-8")}function _u(e){let t=e.destroy??e.cancel;if(!t)return;try{Promise.resolve(t.call(e)).catch(()=>{})}catch{}}function Dr(e,t,n){try{return JSON.parse(e)}catch{t({reason:n});return}}function F(e,t){let n=t.get(e);return n?{kind:"command",shell:n}:{kind:Bi(e)}}function ne(e,t,n,r){let o=e===void 0?process.cwd():e,i=typeof o==="string"&&o.trim()!==""?V([o]):void 0;if(i)return{configCwd:i,executionCwd:i};return P(r,t,n,Fu(o)),null}function P(e,t,n,r){let o;try{o=Sr(t)}catch(i){if(!(i instanceof fe))throw i}e(Xt({command:o,segment:r,toolName:n}))}async function Ou(e){let t=await Iu(e.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){P(e.outputDeny);return}if(!e.isSupported(t))return;let n=e.getAgent?.(t)??e.agent,r=e.agent===n?void 0:e.agent,o=Mu(t),i=(d,h)=>{ji(d,()=>e.getSessionId(t),{agent:n,shape:r,toolName:h,cwd:o}),e.outputDeny(d)},s=e.getToolName(t);if(typeof s!=="string"||s.trim()===""){P((d)=>i(d),Hu(t));return}let a=s,l=(d)=>i(d,a),c;try{c=e.getToolInput(t,a,l)}catch(d){if(!(d instanceof fe))throw d;P(l,void 0,a);return}if(!c.ok)return;let u=e.getContext(t,c.input,a,l);if(!u)return;let p;try{p=Sr(c.input)}catch(d){if(!(d instanceof fe))throw d;P(l,void 0,a);return}let g=et(a,c.input,c.route,u,p??null);try{let d=Qt(g,{guard:{auditAllowed:qi(),dependencies:e.guardDependencies},audit:{agent:n,shape:r,getSessionId:()=>e.getSessionId(t)}}),h=Cr(d,{includeEvidence:!0,toolName:d.stage==="command-analysis"?void 0:a});if(h){e.outputDeny(h);return}e.outputAllow?.()}catch(d){if(!(d instanceof Vi))throw d;$u(d);let h=Cr(d.evaluation,{includeEvidence:!0,toolName:d.evaluation.stage==="command-analysis"?void 0:a});if(h)e.outputDeny(h);return}}function $u(e){if(!kt(S.debug))return;console.error(`CC Safety Net debug: ${Nu(e.stage)}: ${Gi(e.cause)}`)}function Nu(e){if(e==="policy-protection")return"hook policy protection failed";if(e==="config-load")return"hook config loading failed";if(e==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function Fu(e){return typeof e==="string"?e:void 0}function Hu(e){if(!e||typeof e!=="object"||Array.isArray(e))return;if(Object.hasOwn(e,"tool_input"))return e.tool_input;let t=e.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function Mu(e){if(!e||typeof e!=="object"||Array.isArray(e))return null;let t=e.cwd;if(typeof t==="string")return t;let n=e.toolCall;if(!n||typeof n!=="object"||Array.isArray(n))return null;let r=n.args;if(!r||typeof r!=="object"||Array.isArray(r))return null;let o=r.Cwd;return typeof o==="string"?o:null}async function H(e){let t=(o)=>Tu(e.createDenyOutput,o),n=e.createAllowOutput;await Ou({...e,outputDeny:t,outputAllow:n?()=>console.log(JSON.stringify(n())):void 0})}function Dt(e){return ju(e,".gemini","config","hooks.json")}var Gu=new Map([["run_command","auto"]]),Bu=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function Ji(e){return F(e,Gu)}async function Yi(){await H({agent:"antigravity-cli",createDenyOutput:(e)=>({decision:"deny",reason:e}),isSupported:()=>!0,getToolName:(e)=>e.toolCall?.name,getToolInput:(e,t)=>({ok:!0,input:Wu(e.toolCall?.args,t),route:Ji(t)}),getContext:qu,getSessionId:(e)=>e.conversationId})}function qu(e,t,n,r){let i=Ku(e).flatMap((c)=>{let u=V([c]);return u?[u]:[]});if(!i[0])return Ie(r,t,n),null;if(n!=="run_command"){let c;try{c=Vu(t,n,i)}catch(u){if(u instanceof fe)return Ie(r,void 0,n),null;if(!(u instanceof Pe))throw u;return Ie(r,t,n),null}if(!c)return Ie(r,t,n),null;return{configCwd:c,executionCwd:c}}let s=e.toolCall?.args;if(!s||!Object.hasOwn(s,"Cwd"))return{configCwd:i[0],executionCwd:i[0]};let a=s.Cwd;if(typeof a!=="string"||a.trim()==="")return Ie(r,t,n),null;let l=me(a,i);if(l){let c=Zi(l,i);if(!c)return Ie(r,t,n,a),null;return{configCwd:c,executionCwd:l}}return Ie(r,t,n,a),null}function Vu(e,t,n){let r=Ji(t),o=[...zi(e,Bu),...r.kind==="patch"?Ki(e):[]].filter(Wi),i=en(),s=new Set(o.flatMap((a)=>{let l=Zi(Rt(a,St,i),n);return l?[l]:[]}));if(s.size>1)return null;return[...s][0]??n[0]??null}function Zi(e,t){return t.filter((n)=>zu(e,n)).reduce((n,r)=>r.length>n.length?r:n,"")||null}function zu(e,t){let n=Uu(t,e);return n===""||!n.startsWith("..")&&!Wi(n)}function Ie(e,t,n,r){let o=t&&typeof t==="object"?t.command:void 0;e(Xt({command:typeof o==="string"?o:void 0,segment:r,toolName:n}))}function Ku(e){if(e.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(e.workspacePaths)?e.workspacePaths.filter((n)=>typeof n==="string"&&n.trim()!==""):[];return V(t)?t:[]}function Wu(e,t){if(!e)return;if(t!=="run_command")return e;return{...e,command:typeof e.CommandLine==="string"&&e.CommandLine!==""?e.CommandLine:void 0}}var At=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",artifactKind:"hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",artifactKind:"plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",artifactKind:"plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",artifactKind:"plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",artifactKind:"extension",probeCommand:["gemini","--version"]}},{id:"grok-build",displayName:"Grok Build",doctorOrder:8,runtime:{order:6,flags:["-gb","--grok-build"],description:"Run as Grok Build PreToolUse hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--grok-build",artifactKind:"hook config",probeCommand:["grok","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:9,runtime:{order:7,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--hermes-agent",artifactKind:"plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:10,runtime:{order:8,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:10,flag:"--kimi-code",artifactKind:"hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:11,install:{order:11,flag:"--openclaw",artifactKind:"plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:12,install:{order:12,flag:"--opencode",artifactKind:"plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:13,install:{order:13,flag:"--pi",artifactKind:"package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",artifactKind:"hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",artifactKind:"plugin",probeCommand:["amp","--version"]}}],tn=At.slice().sort((e,t)=>e.doctorOrder-t.doctorOrder).map((e)=>e.id),Xi=At.filter((e)=>("runtime"in e)).slice().sort((e,t)=>e.runtime.order-t.runtime.order).map((e)=>({id:e.id,displayName:"displayName"in e.runtime?e.runtime.displayName:e.displayName,flags:e.runtime.flags,legacyFlags:"legacyFlags"in e.runtime?e.runtime.legacyFlags:[],description:e.runtime.description,legacyTopLevelFlags:e.runtime.legacyTopLevelFlags})),z=At.slice().sort((e,t)=>e.install.order-t.install.order).map((e)=>({id:e.id,...e.install})).map(({order:e,...t})=>t),zh=Object.fromEntries(At.map((e)=>[e.id,e.displayName]));function D(e){return At.find((t)=>t.id===e)?.displayName??e}import{homedir as Ju}from"node:os";import{isAbsolute as Qi,join as Ar}from"node:path";function ts(e){if(e!==void 0&&e!==null&&typeof e!=="string")return"unknown";if(typeof e==="string"&&!Qi(e))return"unknown";try{let t=en(),n=typeof e==="string"&&e?Rt(e,St,t):void 0,r=process.env.HOME||Ju(),o=[["codex",process.env.CODEX_HOME||Ar(r,".codex")],["copilot-cli",process.env.COPILOT_HOME||Ar(r,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||Ar(r,".claude")]],i=n?o.flatMap(([s,a])=>{if(!Qi(a))return[];return es(n,Rt(a,St,t))?[s]:[]}):[];if(i.length===1)return i[0]??"unknown";if(i.length>1)return"unknown"}catch(t){if(t instanceof Pe)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var Er="PreToolUse",ns="BeforeTool",rs="pre_tool_call",Pr="PreToolUse";var Yu=new Map([["Bash","posix"],["PowerShell","powershell"]]);function Zu(e){return F(e,Yu)}async function os(){await H({agent:"claude-code",getAgent:(e)=>ts(e.transcript_path),createDenyOutput:(e)=>({hookSpecificOutput:{hookEventName:Er,permissionDecision:"deny",permissionDecisionReason:e}}),isSupported:(e)=>e.hook_event_name===Er,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:Zu(t)}),getContext:(e,t,n,r)=>ne(e.cwd,t,n,r),getSessionId:(e)=>e.session_id})}var Xu=new Map([["bash","auto"],["Bash","auto"],["powershell","powershell"],["PowerShell","powershell"]]);function Qu(e){return F(e,Xu)}async function is(){await H({agent:"copilot-cli",createDenyOutput:(e)=>({permissionDecision:"deny",permissionDecisionReason:e}),isSupported:()=>!0,getToolName:(e)=>e.toolName,getToolInput:(e,t,n)=>{if(typeof e.toolArgs!=="string")return n({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let r=Dr(e.toolArgs,n,"Failed to parse toolArgs JSON.");if(r===void 0)return{ok:!1};return{ok:!0,input:r,route:Qu(t)}},getContext:(e,t,n,r)=>ne(e.cwd,t,n,r),getSessionId:(e)=>typeof e.sessionId==="string"&&e.sessionId.trim()?e.sessionId:void 0})}var ep=new Map([["Shell","auto"]]);function tp(e){return F(e,ep)}async function ss(){await H({agent:"cursor",createDenyOutput:(e)=>({permission:"deny",user_message:e,agent_message:e}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:tp(t)}),getContext:np,getSessionId:(e)=>e.conversation_id})}function np(e,t,n,r){let o=rp(e);if(!o[0])return P(r,t,n),null;let i=me(ip(e.cwd),o);if(!i)return P(r,t,n,typeof e.cwd==="string"?e.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:i,executionCwd:i};if(!Object.hasOwn(t,"working_directory"))return{configCwd:i,executionCwd:i};let s=t.working_directory;if(typeof s!=="string"||s.trim()==="")return P(r,t,n),null;let a=me(s,o);if(!a)return P(r,t,n,s),null;return{configCwd:i,executionCwd:a}}function rp(e){return op(e).flatMap((t)=>{let n=V([t]);return n?[n]:[]})}function op(e){if(e.workspace_roots===void 0)return typeof e.cwd==="string"&&e.cwd.trim()!==""?[e.cwd]:[];if(!Array.isArray(e.workspace_roots))return[];return e.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function ip(e){return typeof e==="string"&&e.trim()!==""?e:"."}var sp=new Map([["run_shell_command","auto"]]);function ap(e){return F(e,sp)}async function as(){await H({agent:"gemini-cli",createDenyOutput:(e)=>({decision:"deny",reason:e,systemMessage:e}),isSupported:(e)=>e.hook_event_name===ns,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:ap(t)}),getContext:(e,t,n,r)=>ne(e.cwd,t,n,r),getSessionId:(e)=>e.session_id})}var lp=new Map([["run_terminal_command","auto"]]);function cp(e){return F(e,lp)}async function ls(){await H({agent:"grok-build",createDenyOutput:(e)=>({decision:"deny",reason:e}),createAllowOutput:()=>({decision:"allow"}),isSupported:()=>!0,getToolName:(e)=>e.toolName,getToolInput:(e,t,n)=>{if(e.toolInputTruncated===!0)return P(n,e.toolInput,t),{ok:!1};return{ok:!0,input:e.toolInput,route:cp(t)}},getContext:dp,getSessionId:(e)=>e.sessionId})}function dp(e,t,n,r){let o=V(up(e));if(!o)return P(r,t,n),null;let i=me(pp(e.cwd),[o]);if(!i)return P(r,t,n,typeof e.cwd==="string"?e.cwd:void 0),null;return{configCwd:i,executionCwd:i}}function up(e){let t=e.workspaceRoot===void 0?e.cwd:e.workspaceRoot;return typeof t==="string"&&t.trim()!==""?[t]:[]}function pp(e){return typeof e==="string"&&e.trim()!==""?e:"."}import{resolve as fp}from"node:path";var mp=new Map([["terminal","posix"]]);async function cs(){await H({agent:"hermes-agent",createDenyOutput:(e)=>({action:"block",message:e}),isSupported:(e)=>e.hook_event_name===rs,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:F(t,mp)}),getContext:gp,getSessionId:(e)=>e.session_id})}function gp(e,t,n,r){let o=ne(e.cwd,t,n,r);if(!o)return null;if(!t||typeof t!=="object"||Array.isArray(t))return o;if(!Object.hasOwn(t,"workdir"))return o;let i=t.workdir;if(typeof i!=="string"||i.trim()==="")return P(r,t,n),null;let s=V([fp(o.configCwd,i)]);if(!s)return P(r,t,n,i),null;return{...o,executionCwd:s}}var ds=new Map([["Bash","posix"]]);function hp(e){return F(e,ds)}async function us(){await H({agent:"kimi-code",createDenyOutput:(e)=>({hookSpecificOutput:{hookEventName:Pr,permissionDecision:"deny",permissionDecisionReason:e}}),isSupported:(e)=>e.hook_event_name===Pr,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:hp(t)}),getContext:(e,t,n,r)=>{let o=ne(e.cwd,t,n,r);if(!o)return null;let i=e.tool_input;if(!ds.has(n)||!i||!Object.hasOwn(i,"cwd"))return o;let s=i.cwd;if(typeof s!=="string"||s.trim()==="")return P(r,t,n),null;let a=me(s,[o.configCwd]);if(!a)return P(r,t,n,s),null;return{configCwd:o.configCwd,executionCwd:a}},getSessionId:(e)=>e.session_id})}var yp={"antigravity-cli":Yi,"claude-code":os,"copilot-cli":is,cursor:ss,"gemini-cli":as,"grok-build":ls,"hermes-agent":cs,"kimi-code":us},rt=Xi.map((e)=>({...e,run:yp[e.id]}));function ps(e){let t=_({label:"hook",booleans:Object.fromEntries(rt.map((r)=>[r.id,[...r.flags,...r.legacyFlags]]))},e);if(t.errors.length>0)return;let n=rt.filter((r)=>t.flags[r.id]);return n.length===1?n[0]:void 0}function fs(e){return rt.find((t)=>t.legacyTopLevelFlags.some((n)=>n===e))}var Lp=rt.map((e)=>({flags:e.flags.join(", "),description:e.description})),vp=rt.flatMap((e)=>e.flags.map((t)=>`cc-safety-net hook ${t}`)),ms={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...Lp,{flags:"-h, --help",description:"Show this help"}],examples:vp};var gs={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...z.map((e)=>({flags:e.flag,description:`Install ${D(e.id)} ${e.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...z.map((e)=>`cc-safety-net install ${e.flag}`)]},hs={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...z.map((e)=>({flags:e.flag,description:`Uninstall ${D(e.id)} ${e.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...z.map((e)=>`cc-safety-net uninstall ${e.flag}`)]},ys={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var Ls={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var Tr=[{flags:"--ref",argument:"<ref>",description:"Use a branch, tag, or commit"},{flags:"--only",argument:"<rulebook...>",description:"Add only these repository rulebooks"},{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"-h, --help",description:"Show this help"}],Ir=["cc-safety-net rule add project-rules","cc-safety-net rule add acme/safety-rules","cc-safety-net rule add acme/safety-rules --only aws gcloud","cc-safety-net rule add acme/safety-rules --ref v2 --only aws"],ot={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source> [--ref <ref>] [--only <rulebook...>]",description:"Add rulebook sources and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Refresh rulebook lock/cache state"},{usage:"sync",description:"Sync configured rulebooks"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},...Tr.slice(0,2),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk",...Ir,"cc-safety-net rule sync","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var vs={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var bs={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var nn=[vs,Fi,Ls,Hi,ot,gs,ys,hs,ms,Mi,bs];function bp(e){return e.aliases??[]}function rn(e){let t=e.toLowerCase();return nn.find((n)=>n.name.toLowerCase()===t||bp(n).some((r)=>r.toLowerCase()===t))}import{basename as wp}from"node:path";function on(e=7,t=pe()){let n=Date.now()-e*24*60*60*1000,r=[],o=new Set,i=0,s,a,l,c;if(t)Ee(t);let u={count:0},p=t?Le(t,u):[];for(let d of p)for(let h of Se(d,u)){if(h.decision==="allow")continue;let m=new Date(h.ts).getTime();if(m>=n){if(i++,o.add(h.sessionId??wp(d,".jsonl")),a===void 0||m<=a)s=h.ts,a=m;if(c===void 0||m>c)l=h.ts,c=m;kp(r,h,m)}}let g=r.map((d)=>({timestamp:d.ts,command:d.command,reason:d.reason,relativeTime:Yn(new Date(d.ts))}));return{totalBlocked:i,sessionCount:o.size,recentEntries:g,oldestEntry:s,newestEntry:l,unreadable:u.count}}function kp(e,t,n){let r=e.findIndex((o)=>n>new Date(o.ts).getTime());if(r===-1){if(e.length<3)e.push(t);return}if(e.splice(r,0,t),e.length>3)e.pop()}import{dirname as xp}from"node:path";function ws(e,t,n,r,o){let i;try{if(x(r)===null)return{path:e,exists:!1,valid:!1,ruleCount:0};i=ce(r),i.errors.push(...de(e,t,{userConfigDir:n},o))}catch(s){if(!(s instanceof M))throw s;i={errors:[s.message],ruleNames:new Set}}return{path:e,exists:!0,valid:i.errors.length===0,ruleCount:i.ruleNames.size,...i.errors.length>0?{errors:i.errors}:{}}}function Cp(e,t){return{source:t,name:e.name,command:e.command,subcommand:e.subcommand,blockArgs:[...e.block_args],reason:e.reason}}function ks(e,t){let n=t?.userConfigPath??ee(),r=t?.projectConfigPath??Q(e),o=xp(n),i=be({cwd:e,userConfigPath:n,projectConfigPath:r,userConfigDir:o}),s=te({cwd:e,userConfigPath:n,projectConfigPath:r,userConfigDir:o}),a=new Map(i.rulebooks.flatMap((l)=>l.rules.map((c)=>[c,l.source])));return{userConfig:ws(n,Xe({userConfigPath:n}),o,s.userConfigTarget,s.userScope),projectConfig:ws(r,Qe(r),o,s.projectConfigTarget,s.projectScope),effectiveRules:i.rules.map((l)=>Cp(l,a.get(l.name)??"project")),shadowedRules:[]}}var Sp=[{flag:S.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:S.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:S.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:S.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:S.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:S.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:S.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:S.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function xs(){return[...Sp.map((e)=>({name:e.flag.name,value:wr(e.flag),isSet:kr(e.flag),legacyName:e.flag.legacyName,legacyValue:e.flag.legacyName?process.env[e.flag.legacyName]:void 0,legacyIsSet:e.flag.legacyName?process.env[e.flag.legacyName]!==void 0:void 0,description:e.description,defaultBehavior:e.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var Cs={error:0,warning:1,info:2},Rp=["policy","config","audit"];function Dp(e){return e.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var Ap=[{derive:(e)=>e.hooks.length>0&&e.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(e)=>e.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let n=D(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${n} inspection failed`,detail:`Doctor could not verify the ${n} integration configuration.`,fixHint:`Correct the reported ${n} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(e)=>e.userConfig.exists&&!e.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:e.userConfig.path}]:[]},{derive:(e)=>e.projectConfig.exists&&!e.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:e.projectConfig.path}]:[]},{derive:(e)=>e.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${e.configState.reason}`,fixHint:"Correct the named source, run `cc-safety-net rule sync` for a rule source, then rerun doctor."}]:[]},{derive:(e)=>{let t=e.environment.find((n)=>n.name==="CC_SAFETY_NET_AUDIT_SCOPE");return br(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...Rp.map((e)=>({derive:(t)=>t.posture.directories.filter((n)=>n.kind===e&&n.status==="unsafe").map((n)=>({checkId:`posture.${e}-directory-unsafe`,severity:"error",title:`${e[0]?.toUpperCase()}${e.slice(1)} directory is unsafe`,detail:`The ${e} directory ${Dp(n.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...n.path?{path:n.path}:{}}))})),{derive:(e)=>{let t=[...e.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function Ss(e){return Ap.flatMap((t,n)=>t.derive(e).map((r,o)=>({finding:r,catalogOrder:n,occurrence:o}))).sort((t,n)=>Cs[t.finding.severity]-Cs[n.finding.severity]||t.catalogOrder-n.catalogOrder||t.occurrence-n.occurrence).map((t)=>t.finding)}function re(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var Ep=(e)=>re()?`\x1B[32m${e}\x1B[0m`:e,Pp=(e)=>re()?`\x1B[33m${e}\x1B[0m`:e,Tp=(e)=>re()?`\x1B[34m${e}\x1B[0m`:e,Ip=(e)=>re()?`\x1B[35m${e}\x1B[0m`:e,_p=(e)=>re()?`\x1B[36m${e}\x1B[0m`:e,Op=(e)=>re()?`\x1B[31m${e}\x1B[0m`:e,$p=(e)=>re()?`\x1B[2m${e}\x1B[0m`:e,Np=(e)=>re()?`\x1B[1m${e}\x1B[0m`:e,y={green:Ep,yellow:Pp,blue:Tp,magenta:Ip,cyan:_p,red:Op,dim:$p,bold:Np},Fp="\x1B[0m",Hp=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function Mp(e){let t=e;return()=>(t=(t*1664525+1013904223)%4294967296,t/4294967296)}function jp(e){let t=[...Hp],n=Mp(e);for(let r=t.length-1;r>0;r--){let o=Math.floor(n()*(r+1)),i=t[r];t[r]=t[o],t[o]=i}return t}function Up(e,t=0){if(!re())return"";let n=jp(t);return`\x1B[38;5;${n[e%n.length]}m`}function Rs(e,t,n=0){if(!re())return`"${e}"`;return`${Up(t,n)}"${e}"${Fp}`}var Gp=new RegExp("\x1B\\[[0-9;]*m","g"),_r=(e)=>e.replace(Gp,"").length;function _e(e){let t=(e.headers??e.rows[0]??[]).map((s,a)=>{let l=Math.max(...e.rows.map((c)=>_r(c[a]??"")));return Math.max(_r(s),l)}),n=(s,a)=>s+" ".repeat(Math.max(0,a-_r(s))),r=(s,a)=>a[0]+t.map((l)=>s.repeat(l+2)).join(a[1])+a[2],o=(s)=>`│ ${s.map((a,l)=>n(a,t[l]??0)).join(" │ ")} │`,i=e.headers?[`   ${o(e.headers)}`,`   ${r("─",["├","┼","┤"])}`]:[];return[`   ${r("─",["┌","┬","┐"])}`,...i,...e.rows.map((s)=>`   ${o(s)}`),`   ${r("─",["└","┴","┘"])}`].join(`
`)}function Ds(e){let t=[];t.push("Hook Integration"),t.push(Bp(e));let n=[],r=[];for(let o of e){let i=D(o.platform);if(o.errors&&o.errors.length>0)for(let s of o.errors)if(o.configured)n.push({platform:i,message:s});else r.push({platform:i,message:s})}for(let o of n)t.push(`   Warning (${o.platform}): ${o.message}`);for(let o of r)t.push(y.red(`   Error (${o.platform}): ${o.message}`));return t.join(`
`)}function Bp(e){let t=["Platform","Discovery","Configuration","Inspection"],n=e.map((r)=>{let o=D(r.platform);if(r.inspectionStatus==="not-inspected"){let l=y.dim("Not inspected");return[o,l,l,l]}let i=r.detected?y.green("Detected"):r.inspectionStatus==="failed"?y.red("Unknown"):y.dim("Not detected"),s=r.configured?y.green("Configured"):r.detected?y.yellow("Not configured"):r.inspectionStatus==="failed"?y.red("Unknown"):y.dim("Not applicable"),a=r.inspectionStatus==="verified"?y.green("Verified"):r.inspectionStatus==="failed"?y.red("Failed"):y.dim("Not applicable");return[o,i,s,a]});return _e({headers:t,rows:n})}function As(e){let n=["Guard Engine Verification",`   Synthetic self-test: ${e.failed>0?y.red(`${e.passed}/${e.total} FAIL`):y.green(`${e.passed}/${e.total} passed`)}`],r=e.results.filter((o)=>!o.passed);if(r.length>0){n.push(""),n.push(y.red("   Failures:"));for(let o of r)n.push(y.red(`   • ${o.description}`)),n.push(y.red(`     expected ${o.expected}, got ${o.actual}`))}return n.join(`
`)}function qp(e){if(e.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],n=e.map((r)=>[r.source,r.name,r.subcommand?`${r.command} ${r.subcommand}`:r.command,r.blockArgs.join(", ")]);return _e({headers:t,rows:n})}function Es(e){let t=[];if(t.push("Configuration"),t.push(Vp(e.userConfig,e.projectConfig)),t.push(""),e.effectiveRules.length>0)t.push(`   Effective rules (${e.effectiveRules.length} total):`),t.push(qp(e.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let n of e.shadowedRules)t.push(""),t.push(`   Note: Project rule "${n.name}" shadows user rule with same name`);return t.join(`
`)}function Vp(e,t){let n=["Scope","Status"],r=(i)=>{if(!i.exists)return y.dim("N/A");if(!i.valid)return y.red(`Invalid (${i.errors?.[0]??"unknown error"})`);return y.green("Configured")},o=[["User",r(e)],["Project",r(t)]];return _e({headers:n,rows:o})}function Ps(e){let t=[];return t.push("Environment"),t.push(zp(e)),t.join(`
`)}function Ts(e){let t=["Effective Safety",`   Selected preset: ${e.effectiveSafety.selectedPreset}`,`   Effective: ${e.effectiveSafety.level}`],n=[["fail_closed","fail_closed"],["paranoid_rm","paranoid_rm"],["paranoid_interpreters","paranoid_interpreters"]];for(let[r,o]of n){let i=e.effectiveSafety.capabilities[r],s=i.enabled?y.green("ON"):y.dim("OFF"),a=i.sources.length>0?` (${i.sources.join(", ")})`:"";t.push(`   ${o}: ${s} via ${i.source}${a}`)}t.push(`   Stored rule customizations: ${e.effectiveSafety.ruleCounts.stored}`),t.push(`   Effective rule customizations: ${e.effectiveSafety.ruleCounts.effective}`);for(let[r,o]of Object.entries(e.effectiveSafety.ruleOverrides))t.push(`   ${r}: ${o}`);return t.join(`
`)}function Is(e){let t=["Findings"];if(e.length===0)return t.push("   No findings from inspected doctor facts."),t.join(`
...
`)}function zp(e){let t=["Variable","Status","Legacy"],n=e.map((r)=>{let o=r.isSet?y.green("✓"):y.dim("✗"),i=r.legacyName&&r.legacyIsSet?`${r.legacyName} ${y.green("✓")}`:r.legacyName??"";return[r.name,o,i]});return _e({headers:t,rows:n})}function _s(e){let t=[];if(e.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${e.totalBlocked} blocked / ${e.sessionCount} sessions)`),t.push(Kp(e.recentEntries));if(e.unreadable>0)t.push(`   Warning: ${e.unreadable} audit log ${e.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function Kp(e){let t=["Time","Command"],n=e.map((r)=>{let o=O(r.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),i=o.length>40?`${o.slice(0,37)}...`:o;return[r.relativeTime,i]});return _e({headers:t,rows:n})}function Os(e){let t=[];if(t.push("Update Check"),e.latestVersion===null&&!e.error)return t.push(sn([["Status",y.dim("Skipped")],["Installed",e.currentVersion]])),t.join(`
`);if(e.error)return t.push(sn([["Status",`${y.yellow("⚠")} Error`],["Installed",e.currentVersion],["Error",y.dim(e.error)]])),t.join(`
`);if(e.updateAvailable)return t.push(sn([["Status",`${y.yellow("⚠")} Update Available`],["Current",e.currentVersion],["Latest",y.green(e.latestVersion??"")]])),t.push(""),t.push("   Run: bunx cc-safety-net@latest doctor"),t.push("   Or:  npx cc-safety-net@latest doctor"),t.join(`
`);return t.push(sn([["Status",`${y.green("✓")} Up to date`],["Version",e.currentVersion]])),t.join(`
`)}function sn(e){return _e({rows:e})}function $s(e){let t=[];return t.push("System Info"),t.push(Wp(e)),t.join(`
`)}function Wp(e){let t=["Component","Version"],n=(i)=>{if(i===null)return y.dim("not found");return i},o=[{label:"cc-safety-net",value:e.version},...tn.map((i)=>({label:D(i),value:e.versions[i]??null})),{label:"Node.js",value:e.nodeVersion},{label:"npm",value:e.npmVersion},{label:"Bun",value:e.bunVersion},{label:"Platform",value:e.platform}].map((i)=>[i.label,n(i.value)]);return _e({headers:t,rows:o})}function Ns(e){if(e.findings.length===0)return y.green(`
...
${e.findings.length} ${r}: ${n.join(", ")}.`;if(t.error>0)return y.red(o);if(t.warning>0)return y.yellow(o);return y.blue(o)}import{lstatSync as Jp}from"node:fs";import{dirname as Or}from"node:path";function $r(e,t){try{let n=Jp(t);if(n.isSymbolicLink())return{kind:e,path:t,status:"unsafe",issues:["symlink"]};if(!n.isDirectory())return{kind:e,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:e,path:t,status:"unknown",issues:[]};let r=[...n.uid!==process.getuid()?["ownership"]:[],...(n.mode&18)!==0?["permissions"]:[]];return{kind:e,path:t,status:r.length>0?"unsafe":"safe",issues:r}}catch(n){if(typeof n==="object"&&n!==null&&"code"in n&&n.code==="ENOENT")return{kind:e,path:t,status:"not-applicable",issues:[]};return{kind:e,path:t,status:"unknown",issues:[]}}}function Fs(e){let t=pe();return{directories:[$r("policy",Or(Or(e))),$r("config",Or(e)),...t?[$r("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as Yp}from"node:child_process";import{existsSync as Hs}from"node:fs";import{delimiter as Zp,extname as Xp,join as Qp}from"node:path";import{stripVTControlCharacters as Ms}from"node:util";var Us="2.2.2",e2=5000,t2="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function T(){return Us}function Nr(e,t){let n=e[t];if(n)return n;let r=Object.keys(e).find((o)=>o.toLowerCase()===t.toLowerCase()&&!!e[o]);return r?e[r]:n}function n2(e){return(Nr(e,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function r2(e,t){let n=Xp(e)?[e]:[...n2(t).map((r)=>`${e}${r}`),e];if(e.includes("/")||e.includes("\\"))return n.find((r)=>Hs(r))??e;return(Nr(t,"PATH")??"").split(Zp).flatMap((r)=>n.map((o)=>Qp(r,o))).find((r)=>Hs(r))??e}function js(e){if(!/[\s"&|<>^]/.test(e))return e;return`"${e.replace(/"/g,'""')}"`}function Oe(e,t){let[n,...r]=e,o=t[t2]==="win32"?"win32":process.platform;if(!n||o!=="win32")return{cmd:n??"",args:r};let i=r2(n,t);if(!/\.(?:bat|cmd)$/i.test(i))return{cmd:i,args:r};return{cmd:Nr(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",js(i),...r.map(js)].join(" ")]}}var it=async(e,t=e2)=>{let n=await o2(e,{timeoutMs:t});if(n.code!==0)return null;return Ms(n.stdout).trim()||Ms(n.stderr).trim()||null};function o2(e,t){let[n,...r]=e;if(!n)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((o)=>{try{let i=Oe([n,...r],process.env),s=Yp(i.cmd,i.args,{stdio:["ignore","pipe","pipe"]}),a=!1,l="",c="";s.stdout.on("data",(g)=>{l+=g.toString()}),s.stderr.on("data",(g)=>{c+=g.toString()});let u=(g)=>{if(a)return;a=!0,clearTimeout(p),o(g)},p=setTimeout(()=>{s.kill(),u({code:null,stdout:l,stderr:c})},t.timeoutMs);s.on("close",(g)=>{u({code:g,stdout:l,stderr:c})}),s.on("error",()=>{u({code:null,stdout:l,stderr:c})})}catch{o({code:null,stdout:"",stderr:""})}})}function an(e){if(!e)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(e);if(t)return t[1]??null;let n=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(e);if(n)return n[1]??null;return e.split(`
`)[0]?.trim()||null}async function Et(e=it){let[t,n,r,o,i,s]=await Promise.all([Promise.all(z.map(async(a)=>[a.id,an(await e([...a.probeCommand]))])),e(["codex","plugin","list"],30000),e(["amp","plugins","list"],30000),e(["node","--version"]),e(["npm","--version"]),e(["bun","--version"])]);return{version:Us,versions:Object.fromEntries(t),codexPluginListOutput:n,ampPluginListOutput:r,nodeVersion:an(o),npmVersion:an(i),bunVersion:an(s),platform:`${process.platform} ${process.arch}`}}function Fr(e,t){if(t==="dev")return!1;let n=e.split(".").map(Number),r=t.split(".").map(Number),[o=0,i=0,s=0]=n,[a=0,l=0,c=0]=r;if(o!==a)return o>a;if(i!==l)return i>l;return s>c}async function we(){let e=T(),t=new AbortController,n=setTimeout(()=>t.abort(),3000);try{let r=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!r.ok)return{currentVersion:e,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${r.status}`};let o=await r.json(),i=Fr(o.version,e);return{currentVersion:e,latestVersion:o.version,updateAvailable:i}}catch(r){return{currentVersion:e,latestVersion:null,updateAvailable:!1,error:r instanceof Error?r.message:"Network error"}}finally{clearTimeout(n)}}import*as Js from"node:readline";var Vs=(e)=>`\x1B[${e}B`,i2=(e)=>`\x1B[${e}A`;var Gs=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function s2(e){return new Promise((t)=>setTimeout(t,e))}function a2(e,t,n){if(!n)return t(e);if(n.aborted)return Promise.resolve();return new Promise((r,o)=>{let i=()=>n.removeEventListener("abort",s),s=()=>{i(),r()};n.addEventListener("abort",s,{once:!0}),t(e).then(()=>{i(),r()},(a)=>{i(),o(a)})})}function Pt(e,t){return e&&e>0?e:t}function ln(e){return Math.max(0,Math.min(1,e))}function st(e){return Math.max(0,Math.min(255,Math.round(e)))}function Hr(e){return e<=0.0031308?12.92*e:1.055*e**0.4166666666666667-0.055}function l2(e,t,n){let r=n*Math.PI/180,o=t*Math.cos(r),i=t*Math.sin(r),s=(e+0.3963377774*o+0.2158037573*i)**3,a=(e-0.1055613458*o-0.0638541728*i)**3,l=(e-0.0894841775*o-1.291485548*i)**3;return{blue:st(Hr(ln(-0.0041960863*s-0.7034186147*a+1.707614701*l))*255),green:st(Hr(ln(-1.2684380046*s+2.6097574011*a-0.3413193965*l))*255),red:st(Hr(ln(4.0767416621*s-3.3077115913*a+0.2309699292*l))*255)}}function Mr(e,t){let n=(t*e*180/Math.PI%360+360)%360;return l2(0.72,0.15,n)}function zs(e,t=0.1){let n=Mr(t,e);return`\x1B[38;2;${n.red};${n.green};${n.blue}m`}function c2(e,t){return{blue:st(e.blue+(255-e.blue)*t),green:st(e.green+(255-e.green)*t),red:st(e.red+(255-e.red)*t)}}function Ks(e,t,n){let r=Math.imul(e+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(n+374761393,2654435761),o=r^r>>>15,i=Math.imul(o,739982445),s=i^i>>>12,a=Math.imul(s,695872825);return((a^a>>>15)>>>0)/4294967296}function d2(e,t,n){let r=Math.floor(Ks(e,t,n)*Gs.length);return Gs[r]??"░"}function Bs(e){let t=ln(e);return t*t*t*(t*(t*6-15)+10)}function u2(e){if(e.length===0)return"";let t=[],n=!1,r="";for(let o of e){let i=`${o.red};${o.green};${o.blue}`;if(o.bold!==n)t.push(o.bold?"\x1B[1m":"\x1B[22m"),n=o.bold;if(i!==r)t.push(`\x1B[38;2;${i}m`),r=i;t.push(o.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function p2(e,t,n,r,o){return e.map((i,s)=>({...Mr(n,r+t+s/o),bold:!1,character:i}))}function f2(e,t,n,r,o,i,s,a){let l=Math.max(1,r*0.75),c=Math.min(1,n/l),u=o*Bs(c),p=Math.max(0,(n-l)/Math.max(1,r-l)),g=(1-Bs(n/r))*a*2,d=0.35*Math.max(0,1-p*2),h=c>=1,m=Math.min(e.length,Math.ceil(u+2+1));return e.slice(0,m).map((b,L)=>{let w=Mr(i,s+t+L/a+g),f=L+Ks(t,L,7919)*2-1;if(f>u+2)return{...w,bold:!1,character:" "};let v=u-f,N=0.8*Math.exp(-(v*v)/12.5),ye=Math.min(0.9,N+d),Wn=!h&&f>u-4;return{...c2(w,ye),bold:ye>0.3,character:Wn?d2(t,L,n):b}})}function qs(e){return`\x1B[?2026h${e.map((t,n)=>`\x1B8${n>0?Vs(n):""}${u2(t)}`).join("")}\x1B[?2026l`}async function jr(e,t={}){if(!e)return;let n=t.output??process.stdout,r=t.sleep??s2,o=Pt(t.frequency,0.1),i=t.seed??0,s=Pt(t.speed,40),a=Pt(t.spread,3),l=Pt(t.frameRate,60),c=Math.max(1,Math.floor(Pt(t.duration,12))),u=e.split(`
`).map((m)=>Array.from(m)),p=Math.max(...u.map((m)=>m.length)),g=1000*c*u.filter((m)=>m.length>0).length/s,d=p>0?Math.max(1,Math.ceil(g/(1000/l))):0,h=d>0?g/d:0;n.write(`\x1B[?25l${u.length>1?`${`
`.repeat(u.length-1)}${i2(u.length-1)}`:""}\x1B7`);try{for(let m=1;m<=d;m+=1){if(t.signal?.aborted)break;n.write(qs(u.map((b,L)=>f2(b,L,m,d,p,o,i,a)))),await a2(h,r,t.signal)}}finally{if(n.write(qs(u.map((m,b)=>p2(m,b,o,i,a)))),n.write("\x1B8"),u.length>1)n.write(Vs(u.length-1));n.write(`
\x1B[0m\x1B[?25h`)}}var Ws=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function m2(e){return Boolean(e.isTTY)}async function Tt(e={}){let t=e.output??process.stdout;if(!m2(t))return;let n=e.input??process.stdin,r={duration:e.duration,frequency:e.frequency,output:t,seed:e.seed??Math.random()*8192,sleep:e.sleep,speed:e.speed,spread:e.spread};if(!n.isTTY||typeof n.setRawMode!=="function"){await jr(Ws,r);return}let o=new AbortController,i=n.readableFlowing===!0,s=n.isRaw===!0,a=!1,l=(c,u)=>{if(u.ctrl&&u.name==="c")a=!0;if(a||u.name==="return"||u.name==="enter")o.abort()};Js.emitKeypressEvents(n),n.on("keypress",l),n.setRawMode(!0),n.resume();try{await jr(Ws,{...r,signal:o.signal})}finally{if(n.off("keypress",l),n.setRawMode(s),!i)n.pause()}if(!a)return;if(e.onInterrupt){e.onInterrupt();return}process.kill(process.pid,"SIGINT")}var Ys="\r\x1B[2K",g2="\x1B[?25l",h2="\x1B[39m",y2="\x1B[?25h",L2=100,v2=0.55,b2=80,Zs=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function w2(e){return new Promise((t)=>setTimeout(t,e))}async function cn(e,t={}){let n=t.output??process.stdout;if(!n.isTTY)return e;let r=t.sleep??w2,o=!1,i=e.then((a)=>(o=!0,a),(a)=>{throw o=!0,a});if(await Promise.race([i.then(()=>!0),r(L2).then(()=>!1)]))return i;n.write(g2);try{for(let a=0;!o;a+=1)n.write(`${Ys}${zs(a*v2)}${Zs[a%Zs.length]}${h2} ${t.loadingMessage??"Loading…"}`),await Promise.race([i,r(b2)]);return await i}finally{n.write(`${Ys}${y2}`)}}async function It(e,t,n,r={}){let o=t();if(e)await n();if(e&&o.ready)await cn(o.ready,r);return o.finish()}import{homedir as Zf}from"node:os";import{stripVTControlCharacters as k2}from"node:util";var dn="amp plugins list",x2=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function Xs(e){if(!e.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=k2(e.ampPluginListOutput).split(`
`).map((n)=>x2.exec(n)?.[1]).find((n)=>n!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:dn,configPath:dn,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:dn,configPath:dn}}import{existsSync as C2,readFileSync as S2}from"node:fs";var R2=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function D2(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];return Object.values(e).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t,r=n.PreToolUse;if(!Array.isArray(r))return[];return r.flatMap((o)=>{if(!o||typeof o!=="object"||Array.isArray(o))return[];let i=o.hooks;if(!Array.isArray(i))return[];return i.flatMap((s)=>{if(!s||typeof s!=="object"||Array.isArray(s))return[];let a=s.command;if(typeof a!=="string"||!R2.test(a))return[];return[{command:a,enabled:n.enabled!==!1}]})})})}function Qs(e){let t=Dt(e.homeDir);if(!C2(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let n;try{n=D2(JSON.parse(S2(t,"utf-8")))}catch(r){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${r instanceof Error?r.message:String(r)}`]}}if(n.some((r)=>r.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(n.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as ea}from"node:path";import{existsSync as A2,lstatSync as E2,readFileSync as P2}from"node:fs";function oe(e,t=(n)=>n){if(!A2(e))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(P2(e,"utf-8")))}}catch{return{kind:"unreadable"}}}function E(e){try{return E2(e)}catch{return}}function un(e,t){let n=E(t);if(!n)return{platform:e,status:"n/a",configPath:t};if(!n.isSymbolicLink()&&n.isDirectory())return;return{platform:e,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function k(e,t){return typeof e==="object"&&e!==null?e[t]:void 0}var Ur="cc-safety-net@cc-marketplace";function ta(e){return ea(e,".claude","plugins","installed_plugins.json")}function na(e,t){let n=k(k(e,"plugins"),t);return Array.isArray(n)&&n.length>0}function pn(e,t){let n=oe(ta(e));return n.kind==="ok"&&na(n.value,t)}function Gr(e){let t=ta(e),n=oe(t);if(n.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(n.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!na(n.value,Ur))return{platform:"claude-code",status:"n/a"};let r=ea(e,".claude","settings.json"),o=oe(r);if(o.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(o.kind==="ok"&&k(k(o.value,"enabledPlugins"),Ur)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:r,errors:[`${Ur} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function ra(e){return Gr(e.homeDir)}function oa(e){if(!e.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=e.codexPluginListOutput.split(`
`).find((n)=>n.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed,"))return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as hn,readdirSync as T2,readFileSync as I2}from"node:fs";import{join as j}from"node:path";var ie="cc-safety-net@cc-marketplace",fn=["cc-marketplace","cc-safety-net"],ia=["_direct","copilot-safety-net"],sa=["cc-marketplace","safety-net"],aa="safety-net@cc-marketplace";function mn(e,t){let n=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${n}([^a-z0-9-]|$)`,"m").test(e??"")}function la(e){return mn(e,"cc-safety-net@cc-marketplace")}function ca(e){return mn(e,"cc-marketplace")}function da(e){return mn(e,"copilot-safety-net")}function ua(e){return mn(e,"safety-net@cc-marketplace")}function q(e){let t="",n=0,r=!1,o=!1,i=-1;while(n<e.length){let s=e[n],a=e[n+1];if(o){t+=s,o=!1,n++;continue}if(s==='"'&&!r){r=!0,i=-1,t+=s,n++;continue}if(s==='"'&&r){r=!1,t+=s,n++;continue}if(s==="\\"&&r){o=!0,t+=s,n++;continue}if(r){t+=s,n++;continue}if(s==="/"&&a==="/"){while(n<e.length&&e[n]!==`
`)n++;continue}if(s==="/"&&a==="*"){n+=2;while(n<e.length-1){if(e[n]==="*"&&e[n+1]==="/"){n+=2;break}n++}continue}if(s===","){i=t.length,t+=s,n++;continue}if(s==="}"||s==="]"){if(i!==-1){let l=t.slice(i+1);if(/^\s*$/.test(l))t=t.slice(0,i)+l}i=-1,t+=s,n++;continue}if(!/\s/.test(s))i=-1;t+=s,n++}return t}function Br(e){if(!e?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(e)}function fa(e,t){if(!e)return null;let n=e.match(/(\d+)\.(\d+)\.(\d+)/);if(!n)return null;let r=[Number(n[1]),Number(n[2]),Number(n[3])];for(let o=0;o<t.length;o++){let i=r[o]??0,s=t[o]??0;if(i!==s)return i>s}return!0}function _2(e){return fa(e,[0,0,422])}function O2(e){return fa(e,[1,0,8])}function _t(e){return process.env.COPILOT_HOME||j(e,".copilot")}function qr(e){return(e.hooks?.preToolUse??[]).some((n)=>{if(n.type!=="command")return!1;return Br(n.command)||Br(n.bash)||Br(n.powershell)})}function gn(e){return e===void 0||typeof e==="string"}function $2(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e;if(t.disableAllHooks!==void 0&&typeof t.disableAllHooks!=="boolean")return!1;if(t.hooks===void 0)return!0;if(!t.hooks||typeof t.hooks!=="object"||Array.isArray(t.hooks))return!1;let n=t.hooks.preToolUse;if(n===void 0)return!0;return Array.isArray(n)&&n.every((r)=>r!==null&&typeof r==="object"&&!Array.isArray(r)&&gn(r.type)&&gn(r.command)&&gn(r.bash)&&gn(r.powershell))}function Vr(e,t){try{let n=JSON.parse(q(I2(e,"utf-8")));if(!$2(n)){t?.push(`Invalid hook config ${e}: hooks.preToolUse must be an array of hook objects`);return}return n}catch(n){t?.push(`Failed to parse ${e}: ${n instanceof Error?n.message:String(n)}`);return}}function ma(e,t){try{return T2(e).filter((n)=>n.endsWith(".json")).sort((n,r)=>n.localeCompare(r))}catch(n){return t?.push(`Failed to read ${e}: ${n instanceof Error?n.message:String(n)}`),[]}}function N2(e,t){if(!hn(e))return[];let n=[];for(let r of ma(e,t)){let o=j(e,r),i=Vr(o,t);if(i&&qr(i))n.push(o)}return n}function at(e,t){if(!hn(e))return;let n=Vr(e,t);if(!n)return;return{path:e,config:n}}function pa(e,t,n,r){if(t){e.push(`GitHub Copilot CLI ${t} does not support ${n}; requires ${r}+`);return}e.push(`GitHub Copilot CLI version unavailable; skipping ${n} because it requires ${r}+`)}function F2(e){for(let t of e){if(t?.config.disableAllHooks===!0)return t.path;if(t?.config.disableAllHooks===!1)return}return}function H2(e,t,n,r){let o=_t(e),i=j(t,".github","hooks"),s=j(o,"hooks"),a=j(t,".github","copilot"),l=j(t,".claude"),c=O2(n),u=c===!0?r:void 0,p=[at(j(a,"settings.local.json"),u),at(j(a,"settings.json"),u),at(j(l,"settings.local.json"),u),at(j(l,"settings.json"),u)],g=[at(j(o,"settings.json"),u),at(j(o,"config.json"),u)];if(c!==!1){let v=F2([...p,...g]);if(v){if(c===null)r.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${v} as active`);return{activeConfigPaths:[],disabledBy:v}}}let d=N2(i,r),h=_2(n),m=h===!0?r:void 0,b=hn(s)?ma(s,m):[],L=[];for(let v of b){let N=j(s,v),ye=Vr(N,m);if(ye&&qr(ye))L.push(N)}if(h!==!0&&L.length>0)pa(r,n,`user hook files in ${s}`,"0.0.422"),L.length=0;let w=[];for(let v of[...p,...g]){if(!v)continue;if(!qr(v.config))continue;if(c===!0){w.push(v);continue}pa(r,n,"inline hook definitions in Copilot config files","1.0.8");break}let f=(v)=>v.filter((N)=>!!N&&w.includes(N)).map((N)=>N.path);return{activeConfigPaths:[...f(p),...d,...f(g),...L]}}function ga(e){let t=[],n=H2(e.homeDir,e.cwd,e.copilotCliVersion,t);if(n.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:n.disabledBy,configPaths:[n.disabledBy],errors:t.length>0?t:void 0};let r=_t(e.homeDir),o=j(r,"installed-plugins",...fn),i=hn(o),s=j(r,"settings.json"),a=oe(s,q);if(i&&a.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(i&&a.kind==="ok"&&k(k(a.value,"enabledPlugins"),ie)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:s,errors:[`${ie} is installed but not enabled in Copilot CLI`]};if(i||n.activeConfigPaths.length>0){let l=i,c=n.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:l?"plugin config":"hook config",configPath:c??(l?o:void 0),configPaths:n.activeConfigPaths.length>0?n.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as W2,readFileSync as J2}from"node:fs";import{existsSync as ha,mkdirSync as U2,readFileSync as G2}from"node:fs";import{dirname as B2,join as q2}from"node:path";import{renameSync as M2,writeFileSync as j2}from"node:fs";function I(e,t){let n=`${e}.${process.pid}.tmp`;j2(n,t),M2(n,e)}var Ot="npx -y cc-safety-net hook --cursor",ya=30;function Ln(e){return q2(e,".cursor","hooks.json")}function $e(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function zr(){return{command:Ot,timeout:ya,failClosed:!0}}function yn(e){return $e(e)&&e.command===Ot}function V2(e){return Object.keys(e).length===3&&e.command===Ot&&e.timeout===ya&&e.failClosed===!0}function z2(e){try{return JSON.parse(G2(e,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${e}: ${t.message}`);throw t}}function La(e){let t=z2(e);if(!$e(t))throw Error(`Cursor hooks config ${e} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${e} must set "version": 1`);if(t.hooks!==void 0&&!$e(t.hooks))throw Error(`Cursor hooks config ${e} "hooks" must be an object`);let n=$e(t.hooks)?t.hooks.preToolUse:void 0;if(n!==void 0&&!Array.isArray(n))throw Error(`Cursor hooks config ${e} "hooks.preToolUse" must be an array`);return t}function va(e){let t=$e(e.hooks)?e.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function K2(e){if(!e.some(yn))return[...e,zr()];return e.reduce((t,n)=>{if(!yn(n))return t.result.push(n),t;if(!t.inserted)t.result.push(zr()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function ba(e,t,n){let r=$e(t.hooks)?t.hooks:{},o={...t,hooks:{...r,preToolUse:n}};I(e,`${JSON.stringify(o,null,2)}
`)}function wa(e){let t=Ln(e);if(!ha(t))return U2(B2(t),{recursive:!0}),I(t,`${JSON.stringify({version:1,hooks:{preToolUse:[zr()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let n=La(t),r=va(n),o=r.filter(yn);if($e(n.hooks)&&Array.isArray(n.hooks.preToolUse)&&o.length===1&&o[0]!==void 0&&V2(o[0]))return{path:t,alreadyInstalled:!0};return ba(t,n,K2(r)),{path:t,alreadyInstalled:!1}}function ka(e){let t=Ln(e);if(!ha(t))return{path:t,alreadyInstalled:!1};let n=La(t),r=va(n),o=r.filter((i)=>!yn(i));if(o.length===r.length)return{path:t,alreadyInstalled:!1};return ba(t,n,o),{path:t,alreadyInstalled:!0}}function Y2(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];let t=e.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t.preToolUse;if(!Array.isArray(n))return[];return n.filter((r)=>!!r&&typeof r==="object"&&!Array.isArray(r)&&r.command===Ot)}function Z2(e){let t=[];if(e.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let n=e[0];if(n&&n.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(n&&n.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function xa(e){let t=Ln(e.homeDir);if(!W2(t))return{platform:"cursor",status:"n/a",configPath:t};let n;try{n=JSON.parse(J2(t,"utf-8"))}catch(i){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=Y2(n);if(r.length===0)return{platform:"cursor",status:"n/a",configPath:t};let o=Z2(r);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{existsSync as X2}from"node:fs";import{join as Kr}from"node:path";var Wr="gemini-safety-net";function Jr(e){let t=Kr(e,".gemini","extensions"),n=Kr(t,Wr);if(!X2(n))return{platform:"gemini-cli",status:"n/a"};let r=Kr(t,"extension-enablement.json"),o=oe(r);if(o.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let i=o.kind==="ok"?k(k(o.value,Wr),"overrides"):void 0;if(Array.isArray(i)&&i.some((a)=>typeof a==="string"&&a.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:r,errors:[`${Wr} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:n}}function Ca(e){return Jr(e.homeDir)}import{existsSync as nf,readFileSync as rf}from"node:fs";import{existsSync as Ra,mkdirSync as Q2,readFileSync as Da,rmSync as ef}from"node:fs";import{dirname as tf,join as Sa}from"node:path";var $t="npx -y cc-safety-net hook --grok-build",wn=30;function kn(e){return Sa(process.env.GROK_HOME??Sa(e,".grok"),"hooks","cc-safety-net.json")}function Ne(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function vn(){return{hooks:[{type:"command",command:$t,timeout:wn}]}}function Aa(e){return Ne(e)&&e.command===$t}function Ea(e){return e.flatMap((t)=>{if(!Ne(t)||!Array.isArray(t.hooks))return[t];let n=t.hooks.filter((r)=>!Aa(r));if(n.length===t.hooks.length)return[t];return n.length===0?[]:[{...t,hooks:n}]})}function Pa(e){try{let t=JSON.parse(e);return Ne(t)?t:null}catch{return null}}function Ta(e){let t=Ne(e.hooks)?e.hooks.PreToolUse:void 0;return Array.isArray(t)?t:[]}function bn(e,t,n){let r=Ne(t.hooks)?t.hooks:{};I(e,`${JSON.stringify({...t,hooks:{...r,PreToolUse:n}},null,2)}
`)}function Ia(e){let t=kn(e);if(!Ra(t))return Q2(tf(t),{recursive:!0}),bn(t,{},[vn()]),{path:t,alreadyInstalled:!1};let n=Pa(Da(t,"utf-8"));if(!n)return bn(t,{},[vn()]),{path:t,alreadyInstalled:!1};let r=Ta(n),o=r.filter((i)=>Ne(i)&&Array.isArray(i.hooks)&&i.hooks.some(Aa));if(o.length===1&&JSON.stringify(o[0])===JSON.stringify(vn()))return{path:t,alreadyInstalled:!0};return bn(t,n,[...Ea(r),vn()]),{path:t,alreadyInstalled:!1}}function _a(e){let t=kn(e);if(!Ra(t))return{path:t,alreadyInstalled:!1};let n=Pa(Da(t,"utf-8"));if(!n)return{path:t,alreadyInstalled:!1};let r=Ta(n),o=Ea(r);if(JSON.stringify(o)===JSON.stringify(r))return{path:t,alreadyInstalled:!1};let i=Ne(n.hooks)?n.hooks:{};if(o.length===0&&Object.keys(n).length===1&&Object.keys(i).length===1)return ef(t),{path:t,alreadyInstalled:!0};return bn(t,n,o),{path:t,alreadyInstalled:!0}}function Nt(e){return!!e&&typeof e==="object"&&!Array.isArray(e)}function of(e){if(!Nt(e)||!Nt(e.hooks))return[];let t=e.hooks.PreToolUse;if(!Array.isArray(t))return[];return t.filter((n)=>Nt(n)&&Array.isArray(n.hooks)&&n.hooks.some((r)=>Nt(r)&&r.command===$t))}function sf(e){let n=(Array.isArray(e.hooks)?e.hooks.filter(Nt):[]).find((r)=>r.command===$t);return[...e.matcher===void 0||e.matcher===""||e.matcher==="*"?[]:['Managed hook has a "matcher" that narrows coverage; reinstall to repair'],...n?.type==="command"?[]:['Managed hook "type" is not "command"; reinstall to repair'],...n?.timeout===wn?[]:[`Managed hook "timeout" is not ${wn}; reinstall to repair`]]}function Oa(e){let t=kn(e.homeDir);if(!nf(t))return{platform:"grok-build",status:"n/a",configPath:t};let n;try{n=JSON.parse(rf(t,"utf-8"))}catch(i){return{platform:"grok-build",status:"n/a",configPath:t,errors:[`Failed to parse Grok Build hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=of(n)[0];if(!r)return{platform:"grok-build",status:"n/a",configPath:t};let o=sf(r);return{platform:"grok-build",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{readFileSync as Ba}from"node:fs";import{join as qa}from"node:path";var K="cc-safety-net",$a="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function Na(e){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${e}
`}function af(e){return`${Na(e)}name: cc-safety-net
version: "${e}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function lf(e){return`${Na(e)}"""CC Safety Net guard for Hermes Agent.
...
`}function Ft(e){return[{name:"__init__.py",content:lf(e)},{name:"plugin.yaml",content:af(e)}]}import{mkdirSync as cf,readdirSync as df,readFileSync as uf,rmSync as Yr}from"node:fs";import{join as Fe}from"node:path";var pf="__pycache__";function Zr(e){let t=process.env.HERMES_HOME?.trim();return t?t:Fe(e,".hermes")}function Xr(e){return Fe(Zr(e),"plugins",K)}function Qr(e){return e.startsWith($a)}function eo(e,t){let n=Xr(e),r=E(n);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${n}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return n}function Fa(e,t){let n=E(e);if(!n)return;if(n.isSymbolicLink()||!n.isFile())throw Error(`Refusing to ${t} ${e}: not a regular file. Move or remove it.`);let r=uf(e,"utf-8");if(!Qr(r))throw Error(`Refusing to ${t} unmanaged file at ${e}. Move or remove it.`);return r}function Ha(e){let t=eo(e,"install"),n=Ft(T());if(n.map((o)=>Fa(Fe(t,o.name),"overwrite")).every((o,i)=>o===n[i]?.content))return{path:t,alreadyInstalled:!0};return cf(t,{recursive:!0}),n.forEach((o)=>{I(Fe(t,o.name),o.content)}),{path:t,alreadyInstalled:!1}}function to(e){let t=eo(e,"remove");if(!E(t))return[];return Ft(T()).filter((n)=>Fa(Fe(t,n.name),"remove")!==void 0)}function Ma(e){let t=eo(e,"remove");if(!E(t))return{path:t,alreadyInstalled:!1};let n=to(e);if(n.forEach((r)=>{Yr(Fe(t,r.name))}),Yr(Fe(t,pf),{recursive:!0,force:!0}),df(t).length===0)Yr(t,{recursive:!0});return{path:t,alreadyInstalled:n.length>0}}var xn="hermes-agent",ja=/^([^\s#][^:]*):/,ff=/^\s+([A-Za-z_][\w-]*):/,Ua=/^\s+-\s*(.*)$/;function mf(e){return e.trim().replace(/^(["'])(.*)\1$/,"$2")}function gf(e){let t=e.split(/\r?\n/),n=t.findIndex((i)=>ja.exec(i)?.[1]?.trim()==="plugins");if(n===-1)return[];let r=t.slice(n+1),o=r.findIndex((i)=>ja.test(i));return o===-1?r:r.slice(0,o)}function Ga(e,t){let n=gf(e),r=n.findIndex((s)=>ff.exec(s)?.[1]===t);if(r===-1)return[];let o=n.slice(r+1),i=o.findIndex((s)=>!Ua.test(s));return(i===-1?o:o.slice(0,i)).map((s)=>mf(Ua.exec(s)?.[1]??""))}function hf(e){try{return Ba(qa(Zr(e),"config.yaml"),"utf-8")}catch{return}}function no(e){let t=hf(e)??"";return Ga(t,"enabled").includes(K)&&!Ga(t,"disabled").includes(K)}function Va(e){return/^# version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function yf(e,t){let n=E(e);if(!n)return{error:`${t.name} is missing from ${e}; run install --hermes-agent`};if(n.isSymbolicLink()||!n.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{let r=Ba(e,"utf-8");if(!Qr(r))return{error:`Unmanaged ${t.name} occupies ${e}; move or remove it`};if(Va(r)===T()&&r!==t.content)return{error:`Modified ${t.name} occupies ${e}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${e}: ${r instanceof Error?r.message:String(r)}`}}}function za(e){let t=Xr(e.homeDir),n=un(xn,t);if(n)return n;let r=Ft(T()).map((a)=>yf(qa(t,a.name),a)),o=r.flatMap((a)=>("error"in a)?[a.error]:[]);if(o.length>0)return{platform:xn,status:"n/a",configPath:t,errors:o};let i=r.some((a)=>("content"in a)&&Va(a.content)!==T()),s=i?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!no(e.homeDir))return{platform:xn,status:"disabled",method:"plugin directory",configPath:t,errors:[`${K} is not enabled in Hermes; run \`hermes plugins enable ${K}\``,...s]};return{platform:xn,status:"configured",method:"plugin directory",configPath:t,errors:i?s:void 0}}import{existsSync as Lf,readFileSync as vf}from"node:fs";import{join as Ka}from"node:path";var bf=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function wf(e){return Ka(process.env.KIMI_CODE_HOME||Ka(e,".kimi-code"),"config.toml")}function Ht(e){let t=wf(e.homeDir);if(!Lf(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!bf.test(vf(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(n){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${n instanceof Error?n.message:String(n)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as rl}from"node:fs";import{join as jt}from"node:path";var A="cc-safety-net",W="index.js",lt="openclaw.plugin.json",ct="package.json";var Cn="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as Cf,lstatSync as Sf,readdirSync as Rf,readFileSync as Df}from"node:fs";import{dirname as Ya,join as ke}from"node:path";import{fileURLToPath as Af}from"node:url";import{spawn as kf}from"node:child_process";function xf(e){return e.join(" ")}function ro(e,t,n){return[`Failed to run ${xf(e)}${t===null?"":` (exit ${t})`}.`,n.trim()].filter(Boolean).join(`
`)}function oo(e){let t={stdout:"",stderr:""};return e.stdout.setEncoding("utf-8"),e.stderr.setEncoding("utf-8"),e.stdout.on("data",(n)=>{t.stdout+=n}),e.stderr.on("data",(n)=>{t.stderr+=n}),t}function se(e,t){return new Promise((n,r)=>{let o=Oe([...e],process.env),i=kf(o.cmd,o.args,{stdio:["ignore","pipe","pipe"]}),s=oo(i),a=()=>[s.stdout,s.stderr].filter(Boolean).join(`
`),l=t?.timeoutMs??120000,c=setTimeout(()=>{i.kill(),r(Error(ro(e,null,`Timed out after ${l}ms.
${a()}`.trim())))},l);i.on("error",(u)=>{clearTimeout(c),r(Error(ro(e,null,`${u.message}
${a()}`.trim())))}),i.on("close",(u)=>{if(clearTimeout(c),u!==0){r(Error(ro(e,u,a())));return}n(t?.stdoutOnly?s.stdout:a())})})}async function io(e){for(let t of e)await se(t)}async function Wa(e){for(let t of e)try{await se(t)}catch(n){console.warn(n instanceof Error?n.message:String(n))}}var Ja=ke("openclaw",A),Ef=[W,lt,ct];function so(e,t){if(e==="~")return t;if(e.startsWith("~/")||e.startsWith("~\\"))return ke(t,e.slice(2));return e}function Za(e){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return so(t,e);let n=process.env.OPENCLAW_CONFIG_PATH?.trim();return n?Ya(so(n,e)):ke(e,".openclaw")}function Xa(e){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?so(t,e):ke(Za(e),"openclaw.json")}function ao(e){return ke(Za(e),"extensions",A)}function Pf(e){let t=Rf(e);if(t.length===0)return!0;if(t.some((o)=>!Ef.includes(o)))return!1;let n=ke(e,W),r=E(n);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&Df(n,"utf-8").startsWith(Cn)}function lo(e){let t=ao(e),n=E(t);if(!n)return;if(!n.isSymbolicLink()&&n.isDirectory()&&Pf(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function Qa(){let e=Ya(Af(import.meta.url));return[ke(e,"..",Ja),ke(e,"..","..","..","dist",Ja)]}function co(e=Qa()){return e.find((t)=>Cf(t)&&Sf(t).isDirectory())}function Tf(e=Qa()){let t=co(e);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function el(e=Tf()){return[["openclaw","plugins","install",e,"--force"],["openclaw","plugins","enable",A]]}function If(e){let t=(()=>{try{return JSON.parse(e)}catch{return}})(),n=k(k(t,"plugin"),"status");return typeof n==="string"?n:void 0}async function tl(){let e=If(await se(["openclaw","plugins","inspect",A,"--runtime","--json"],{stdoutOnly:!0}));if(e==="loaded")return;throw Error(`${e===void 0?`The ${A} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${A} plugin with status "${e}".`} Run \`openclaw plugins inspect ${A} --runtime\` for details.`)}var Sn="openclaw",Mt=`run \`openclaw plugins enable ${A}\``;function dt(e,t){let n=jt(e,t),r=E(n);if(!r)return{error:`${t} is missing from ${n}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{return{content:rl(n,"utf-8")}}catch(o){return{error:`Failed to read ${n}: ${o instanceof Error?o.message:String(o)}`}}}function ol(e){try{return JSON.parse(q(e))}catch{return}}function _f(e){let t=dt(e,lt);if("error"in t)return t.error;if(k(ol(t.content),"id")===A)return;return`${jt(e,lt)} is not a valid ${A} manifest; run install --openclaw`}function Of(e){let t=dt(e,ct);if("error"in t)return t.error;let n=k(k(ol(t.content),"openclaw"),"extensions");if(Array.isArray(n)&&n.includes(`./${W}`))return;return`${jt(e,ct)} does not point OpenClaw at ${W}; run install --openclaw`}function nl(e){return Array.isArray(e)?e.filter((t)=>typeof t==="string"):[]}function $f(e){let t=Xa(e);if(!E(t))return`${A} is not enabled; ${Mt}`;let n=(()=>{try{return JSON.parse(q(rl(t,"utf-8")))}catch{return}})();if(n===void 0)return`Failed to read ${t}; fix it, then ${Mt}`;let r=k(n,"plugins");if(k(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let o=k(k(k(r,"entries"),A),"enabled");if(nl(k(r,"deny")).includes(A)||o===!1)return`${A} is disabled in ${t}; ${Mt}`;let i=nl(k(r,"allow"));if(i.length>0&&!i.includes(A))return`plugins.allow in ${t} does not list ${A}; add it, then ${Mt}`;if(i.includes(A)||o===!0)return;return`${A} is not enabled; ${Mt}`}function il(e){return/^\/\/ version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function Nf(e,t,n){if(n===void 0)return[];let r=dt(n,W);if("error"in r||il(r.content)!==t)return[];return[W,lt,ct].flatMap((o)=>{let i=dt(e,o),s=dt(n,o);if("error"in i||"error"in s||i.content===s.content)return[];return[`Modified ${o} occupies ${jt(e,o)}; run install --openclaw to restore it`]})}function sl(e){let t=ao(e.homeDir),n=un(Sn,t);if(n)return n;let r=dt(t,W),i=["error"in r?r.error:r.content.startsWith(Cn)?void 0:`Unmanaged ${W} occupies ${jt(t,W)}; move or remove it`,_f(t),Of(t)].filter((u)=>u!==void 0),s="content"in r?il(r.content):void 0,a=i.length>0?i:Nf(t,s,co());if(a.length>0)return{platform:Sn,status:"n/a",configPath:t,errors:a};let l=s===T()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],c=$f(e.homeDir);if(c)return{platform:Sn,status:"disabled",method:"plugin directory",configPath:t,errors:[c,...l]};return{platform:Sn,status:"configured",method:"plugin directory",configPath:t,errors:l.length>0?l:void 0}}import{existsSync as Kf,readFileSync as Wf}from"node:fs";import{join as Jf}from"node:path";import{existsSync as uo,readFileSync as ul,rmSync as Hf}from"node:fs";import{join as ge}from"node:path";import{pathToFileURL as Mf}from"node:url";function al(e){return e!==void 0&&/\s/.test(e)}function Ff(e,t,n){let r=t+1,o=!1;while(r<e.length){let i=e[r];if(o){o=!1,r++;continue}if(i==="\\"){o=!0,r++;continue}if(i==='"')return r+1;r++}throw Error(n)}function Rn(e,t,n){let r=e[t],o=r==="["?"]":"}",i=0,s=t;while(s<e.length){let a=n.skipComment?.(e,s)??s;if(a!==s){s=a;continue}if(e[s]==='"'){s=Ff(e,s,n.stringError);continue}if(e[s]===r)i++;if(e[s]===o){if(i--,i===0)return s}s++}throw Error(n.bracketError)}function ll(e,t){let n=e.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(e.slice(n))?.[0]??""}function Dn(e,t){let{start:n,end:r,end:o}=t;while(al(e[o]))o++;if(e[o]===","){if(r=o+1,e[r]===`
`)r++;return`${e.slice(0,n)}${e.slice(r)}`}o=t.start-1;while(al(e[o]))o--;if(e[o]===","){n=o;let i=e.lastIndexOf(`
`,n-1);if(i!==-1&&/^\s*$/.test(e.slice(i+1,n)))n=i}return`${e.slice(0,n)}${e.slice(r)}`}var An="cc-safety-net",pl=`${An}@latest`,fl=["opencode.json","opencode.jsonc"],cl="CCSafetyNetPlugin";function En(e){return ge(process.env.XDG_CONFIG_HOME||ge(e,".config"),"opencode")}function jf(e){return ge(En(e),fl[0])}function Uf(e){return fl.map((t)=>ge(En(e),t))}function ml(e){return ge(process.env.XDG_CACHE_HOME||ge(e,".cache"),"opencode","packages",pl)}function po(e){Hf(ml(e),{recursive:!0,force:!0})}async function gl(e){let t=ge(ml(e),"node_modules",An),n=ge(t,"package.json");if(!uo(n))throw Error(`The OpenCode plugin cache at ${t} is missing its package, so OpenCode would load nothing and fail open. Run \`opencode plugin -g -f ${pl}\` for details.`);let r=k(JSON.parse(ul(n,"utf-8")),"main");if(typeof r!=="string")throw Error(`The cached OpenCode plugin at ${t} declares no "main" entry.`);let o=ge(t,r);if(typeof(await import(Mf(o).href))[cl]==="function")return;throw Error(`The cached OpenCode plugin at ${o} does not export a callable ${cl}, so OpenCode would load nothing and fail open.`)}function Pn(e,t){if(e[t]==="/"&&e[t+1]==="/"){let n=e.indexOf(`
`,t+2);return n===-1?e.length:n+1}if(e[t]==="/"&&e[t+1]==="*"){let n=e.indexOf("*/",t+2);return n===-1?e.length:n+2}return t}function dl(e,t){let n=t;while(n<e.length){if(/\s/.test(e[n]??"")){n++;continue}let r=Pn(e,n);if(r===n)return n;n=r}return n}function hl(e,t){let n=t+1,r=!1;while(n<e.length){if(r){r=!1,n++;continue}if(e[n]==="\\"){r=!0,n++;continue}if(e[n]==='"')return n+1;n++}throw Error("Unterminated string in OpenCode config")}function yl(e,t,n){return JSON.parse(e.slice(t,n))}function Gf(e,t){return Rn(e,t,{skipComment:Pn,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function Bf(e){let t=0,n=0;while(n<e.length){let r=Pn(e,n);if(r!==n){n=r;continue}if(e[n]==='"'){let o=hl(e,n);if(t===1&&yl(e,n,o)==="plugin"){let i=dl(e,o),s=dl(e,i+1);if(e[i]===":"&&e[s]==="[")return{start:s,end:Gf(e,s)}}n=o;continue}if(e[n]==="{"||e[n]==="[")t++;if(e[n]==="}"||e[n]==="]")t--;n++}return}function qf(e,t){let n=[],r=t.start+1;while(r<t.end){let o=Pn(e,r);if(o!==r){r=o;continue}if(e[r]==='"'){let i=hl(e,r),s=yl(e,r,i);if(typeof s==="string"&&s.includes(An))n.push({start:r,end:i});r=i;continue}r++}return n}function Ll(e,t){try{return JSON.parse(q(e))}catch(n){if(n instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${n.message}`);throw n}}function Vf(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e.plugin;if(!Array.isArray(t))return!1;return t.some((n)=>typeof n==="string"&&n.includes(An))}function zf(e,t){let n=Bf(e);if(!n)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let r=[...qf(e,n)].reverse().reduce(Dn,e);return Ll(r,t),r}function vl(e){po(e);let t=Uf(e),n=t.find((o)=>uo(o)),r=[];for(let o of t){if(!uo(o))continue;try{let i=ul(o,"utf-8");if(!Vf(Ll(i,o)))continue;return I(o,zf(i,o)),{path:o,alreadyInstalled:!0}}catch(i){r.push(i instanceof Error?i.message:String(i))}}if(r.length>0)throw Error(r.join(`
`));return{path:n??jf(e),alreadyInstalled:!1}}function bl(e){let t=[],n=En(e.homeDir),r=["opencode.json","opencode.jsonc"];for(let o of r){let i=Jf(n,o);if(Kf(i))try{let s=Wf(i,"utf-8"),a=q(s);if((JSON.parse(a).plugin??[]).some((p)=>p.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:i,errors:t.length>0?t:void 0}}catch(s){t.push(`Failed to parse ${o}: ${s instanceof Error?s.message:String(s)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as Yf}from"node:path";function fo(e){return Yf(e,".pi","agent","settings.json")}function mo(e){if(typeof e!=="string")return!1;return e==="npm:cc-safety-net"||e.startsWith("npm:cc-safety-net@")}function wl(e){let t=fo(e.homeDir),n=oe(t);if(n.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(n.kind==="missing")return{platform:"pi",status:"n/a"};let r=k(n.value,"packages");if(!Array.isArray(r))return{platform:"pi",status:"n/a"};let o=r.find((a)=>mo(typeof a==="string"?a:k(a,"source")));if(o===void 0)return{platform:"pi",status:"n/a"};let i=k(o,"extensions");if(Array.isArray(i)&&i.some((a)=>typeof a==="string"&&a.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var Xf={amp:Xs,"antigravity-cli":Qs,"claude-code":ra,codex:oa,"copilot-cli":ga,cursor:xa,"gemini-cli":Ca,"grok-build":Oa,"hermes-agent":za,"kimi-code":Ht,openclaw:sl,opencode:bl,pi:wl};function ut(e,t){let n={...t,cwd:e,homeDir:t?.homeDir??Zf()};return tn.map((r)=>Qf(Xf[r](n)))}function Qf(e){if(e.status==="not-inspected")return{platform:e.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:e.platform,detected:e.status!=="n/a",configured:e.status==="configured",inspectionStatus:e.status!=="n/a"?"verified":e.errors&&e.errors.length>0?"failed":"not-applicable",method:e.method,configPath:e.configPath,configPaths:e.configPaths,errors:e.errors}}import{tmpdir as em}from"node:os";import{join as tm}from"node:path";var nm=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),rm=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([]),allowPaths:Object.freeze([])})})}),om={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}}};function kl(){let e=tm(em(),"cc-safety-net-self-test"),t=nm.map((n)=>{let r=Qt(et("self-test",{command:n.command},{kind:"command",shell:"auto"},{configCwd:e,executionCwd:e},n.command),{guard:{dependencies:{loadPolicySnapshot:()=>rm,getModes:()=>om,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),o=n.expectBlocked?"blocked":"allowed",i=r.decision.kind==="deny"?"blocked":"allowed";return{command:n.command,description:n.description,expected:o,actual:i,passed:o===i,reason:r.decision.kind==="deny"?r.decision.reason:void 0,ruleId:r.decision.kind==="deny"?r.decision.ruleId:void 0}});return{passed:t.filter((n)=>n.passed).length,failed:t.filter((n)=>!n.passed).length,total:t.length,results:t}}function go(e){let t=_({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},e);if(le(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function xl(e={}){let t=await It(!e.json,()=>{let n=im(e);return{ready:n,finish:()=>n}},()=>Tt(),{loadingMessage:"Checking system status…"});if(e.json)console.log(JSON.stringify(t,null,2));else sm(t);return t.engineSelfTest.failed>0||t.findings.some((n)=>n.severity==="error")?1:0}async function im(e){let t=e.cwd??process.cwd(),n=await Et(),r=ut(t,{ampPluginListOutput:n.ampPluginListOutput,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.versions["copilot-cli"]}),o=ks(t),i=xs(),s=B({cwd:t}),a=s.policy,l=ue(a),c=Te(a,l.capabilities),u=on(7),p=e.skipUpdateCheck?{currentVersion:T(),latestVersion:null,updateAvailable:!1}:await we(),g={hooks:r,engineSelfTest:kl(),userConfig:o.userConfig,projectConfig:o.projectConfig,configState:Ct(s),effectiveRules:o.effectiveRules,shadowedRules:o.shadowedRules,environment:i,effectiveSafety:{selectedPreset:a.safety.level??"standard",level:l.effectiveLevel,capabilities:l.capabilities,ruleOverrides:a.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(c).filter(([,d])=>d.source==="rule_override"&&d.override==="off"&&d.inheritedEnabled&&d.changesInherited).map(([d])=>d),ruleCounts:{stored:Object.keys(a.destructiveCommandRuleOverrides).length,effective:Object.values(c).filter((d)=>d.changesInherited).length}},posture:Fs(o.userConfig.path),activity:u,update:p,system:n};return{...g,findings:Ss(g)}}function sm(e){console.log(),console.log(Ds(e.hooks)),console.log(),console.log(As(e.engineSelfTest)),console.log(),console.log(Es(e)),console.log(),console.log(Ps(e.environment)),console.log(),console.log(Ts(e)),console.log(),console.log(Is(e.findings)),console.log(),console.log(_s(e.activity)),console.log(),console.log($s(e.system)),console.log(),console.log(Os(e.update)),console.log(Ns(e))}import{existsSync as am}from"node:fs";var lm=/^[A-Za-z0-9_@%+=:,./-]+$/,Cl="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function ho(e){let t=_({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},e);if(le(t.errors))return console.error(Cl),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!am(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let n=t.positionals.length===1?t.positionals[0]:t.positionals.map((r)=>lm.test(r)?r:`'${r.replaceAll("'","'\\''")}'`).join(" ");if(!n)return console.error("Error: No command provided"),console.error(Cl),null;return{json:t.flags.json,cwd:t.values.cwd,command:n}}function Sl(e){if(e)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function Rl(e,t){let r=t-18;return[`${e.dtl}${e.dh.repeat(t)}${e.dtr}`,`${e.dv}  Command Analysis${" ".repeat(r)}${e.dv}`,`${e.dbl}${e.dh.repeat(t)}${e.dbr}`]}function yo(e){return JSON.stringify(e)}function Dl(e,t=0){return`[${e.map((r,o)=>Rs(r,o,t)).join(",")}]`}function Tn(e,t,n=70){let r=e.split(" "),o=[],i="";for(let s of r)if(i&&i.length+s.length+1>n)o.push(i),i=s;else i=i?`${i} ${s}`:s;if(i)o.push(i);return o.map((s,a)=>a===0?s:`${t}${s}`)}function Al(e,t,n){let r=[];switch(e.type){case"parse":return null;case"env-strip":return r.push(""),r.push(`STEP ${t} ${n.h} Strip environment variables`),r.push(`  Removed: ${e.envVars.map((o)=>`${o}=<redacted>`).join(", ")}`),r.push(`  Tokens:  ${yo(e.output)}`),{lines:r,incrementStep:!0};case"leading-tokens-stripped":return r.push(""),r.push(`STEP ${t} ${n.h} Strip wrappers`),r.push(`  Removed: ${e.removed.join(", ")}`),r.push(`  Tokens:  ${yo(e.output)}`),{lines:r,incrementStep:!0};case"shell-wrapper":return r.push(""),r.push(`STEP ${t} ${n.h} Detect shell wrapper`),r.push(`  Wrapper: ${e.wrapper} -c`),r.push(`  Inner:   ${e.innerCommand}`),{lines:r,incrementStep:!0};case"interpreter":{if(r.push(""),r.push(`STEP ${t} ${n.h} Detect interpreter`),r.push(`  Interpreter: ${e.interpreter}`),r.push(`  Code:        ${e.codeArg}`),e.paranoidBlocked)r.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:r,incrementStep:!0}}case"busybox":return r.push(""),r.push(`STEP ${t} ${n.h} Busybox wrapper`),r.push(`  Subcommand: ${e.subcommand}`),{lines:r,incrementStep:!0};case"transparent-wrapper":return r.push(""),r.push(`STEP ${t} ${n.h} Transparent wrapper`),r.push(`  Wrapper: ${e.wrapper}`),r.push(`  Tokens:  ${yo(e.output)}`),{lines:r,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{if(r.push(""),r.push(`STEP ${t} ${n.h} Match rules`),r.push(`  Rule:   ${e.rule}()`),e.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}case"worktree-relaxation":return r.push(""),r.push(`STEP ${t} ${n.h} Worktree relaxation`),r.push(`  Mode:   ${S.worktree.name}`),r.push(`  Git cwd: ${e.gitCwd}`),r.push("  Result: Allowed local discard in linked worktree"),{lines:r,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(e.embeddedCommandFound)return r.push(""),r.push(`STEP ${t} ${n.h} Fallback scan`),r.push(`  Found: ${e.embeddedCommandFound}`),{lines:r,incrementStep:!0};return null}case"custom-rules-check":{if(e.rulesChecked){if(r.push(""),r.push(`STEP ${t} ${n.h} Custom rules`),e.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(e.matched)return r.push(""),r.push(`STEP ${t} ${n.h} Dangerous text check`),r.push(`  Token:  ${e.token}`),r.push("  Result: MATCHED"),{lines:r,incrementStep:!0};return null}case"strict-unparseable":return r.push(""),r.push(`STEP ${t} ${n.h} Strict mode check`),r.push(`  Command: ${e.rawCommand}`),r.push("  Result:  ✗ UNPARSEABLE"),{lines:r,incrementStep:!0};case"segment-skipped":return null;case"error":return r.push(""),r.push(`ERROR: ${e.message}`),{lines:r,incrementStep:!1};default:return e}}function Lo(e,t){let n=Sl(t?.asciiOnly??!1),r=58,o=[],i=1;o.push(...Rl(n,58)),o.push("");let s=e.trace.steps.find((d)=>d.type==="error");if(s&&s.type==="error"){o.push("ERROR"),o.push(`  ${s.message}`),o.push(""),o.push("RESULT"),o.push(`  Status: ${e.result==="blocked"?y.red("BLOCKED"):y.green("ALLOWED")}`),o.push(""),o.push("CONFIG");let d=e.configSource??"none";return o.push(`  Path: ${d}`),o.join(`
`)}let a=e.trace.steps.find((d)=>d.type==="parse");if(a&&a.type==="parse"){o.push("INPUT"),o.push(`  ${a.input}`),o.push(""),o.push(`STEP ${i} ${n.h} Split shell commands`),i++;for(let d=0;d<a.segments.length;d++){let h=a.segments[d];if(h){let m=Math.random();o.push(`  Segment ${d+1}: ${Dl(h,m)}`)}}}let l=e.trace.segments,c=l.length>1;for(let d of l){if(c){o.push("");let L="";if(a&&a.type==="parse"){let Jn=a.segments[d.index];if(Jn)L=Jn.join(" ")}let w=54,f=L,v=` Segment ${d.index+1}: `,N=" ";if(L){if(v.length+L.length+N.length>w){let xd=w-v.length-N.length;f=`${L.substring(0,xd-1)}…`}}let ye=L?`${v}${f}${N}`:` Segment ${d.index+1} `,Wn=L?`${v}${y.cyan(f)}${N}`:ye,Go=58-ye.length,Bo=Math.floor(Go/2),kd=Go-Bo;o.push(`${n.sh.repeat(Bo)}${Wn}${n.sh.repeat(kd)}`)}if(d.steps.find((L)=>L.type==="segment-skipped")){o.push(""),o.push("  (skipped — prior segment blocked)");continue}let m=!1,b=!1;for(let L of d.steps){let w=Al(L,i,n);if(w){if(b=!0,L.type==="recurse"){o.push("");let f=" RECURSING ",v=58-f.length-4;o.push(`  ${n.tl}${n.h}${f}${n.h.repeat(v)}`),o.push(`  ${n.v}`),m=!0;continue}for(let f of w.lines)if(m)o.push(`  ${n.v} ${f}`);else o.push(f);if(w.incrementStep)i++}}if(m)o.push(`  ${n.v}`),o.push(`  ${n.bl}${n.h.repeat(56)}`),m=!1;if(!b)o.push(""),o.push(`  ${y.green("✓")} Allowed (no matching rules)`)}if(o.push(""),o.push("RESULT"),e.result==="blocked"){if(o.push(`  Status: ${y.red("BLOCKED")}`),e.customRule){if(o.push(`  Rule: ${e.customRule.id}`),e.customRule.rulebook)o.push(`  Rulebook: ${e.customRule.rulebook.name} ${e.customRule.rulebook.version}`);if(e.customRule.source)o.push(`  Source: ${e.customRule.source}`);if(e.customRule.override)o.push(`  Override: reason ${e.customRule.override.reason}`)}if(e.reason){let d=Tn(e.reason,"          ");o.push(`  Reason: ${d[0]}`);for(let h=1;h<d.length;h++)o.push(d[h]??"")}}else o.push(`  Status: ${y.green("ALLOWED")}`);o.push(""),o.push("CONFIG");let u=e.configSource??"none",p=e.configValid?"":" (invalid)";o.push(`  Path: ${u}${p}`),o.push(`  Safety preset: ${e.selectedPreset??"standard"}`),o.push(`  Effective capabilities: ${e.effectiveLevel}`);let g=Object.entries(e.destructiveCommandRuleOverrides??{});if(o.push(`  Rule customizations: ${g.length}`),e.ruleActivation)o.push(`  Rule activation: ${e.ruleActivation.id} — ${e.ruleActivation.enabled?"on":"off"} via ${e.ruleActivation.source}`);return o.join(`
`)}function vo(e){return JSON.stringify(e,null,2)}function El(e){return new Promise((t)=>{process.stdout.write(`${e}
`,()=>t())})}async function Pl(e){let t=ho(e);if(!t)return 1;try{let n=tt(t.command,{cwd:t.cwd}),r=!!process.env.NO_COLOR||!process.stdout.isTTY;return await El(t.json?vo(n):Lo(n,{asciiOnly:r})),0}catch(n){if(!(n instanceof Lr)&&!(n instanceof Pe)&&!(n instanceof fe))throw n;if(t.json)return await El(JSON.stringify({error:n.message})),1;return console.error(n.message),1}}var Tl="2.2.2",J="  ",He="cc-safety-net";function Il(e){return e.argument?`${e.flags} ${e.argument}`:e.flags}function cm(e){return Math.max(...e.map((t)=>Il(t).length))}function dm(e){return Math.max(...e.map((t)=>t.usage.length))}function um(e){return Math.max(...e.map((t)=>`${He} ${t.usage}`.length))}function pm(e,t){let n=`${He} ${e.usage}`;return`${J}${n.padEnd(t+2)}${e.description}`}function he(e,t){return`${J}${e.padEnd(Math.max(40,e.length+2))}${t}`}function In(e,t=console.log){let n=[];if(n.push(`${He} ${e.name}`),n.push(""),n.push(`${J}${e.description}`),n.push(""),n.push("USAGE:"),n.push(`${J}${He} ${e.usage}`),n.push(""),e.subcommands&&e.subcommands.length>0){n.push("SUBCOMMANDS:");let r=dm(e.subcommands);for(let o of e.subcommands)n.push(`${J}${o.usage.padEnd(r+2)}${o.description}`);n.push("")}if(e.options.length>0){n.push("OPTIONS:");let r=cm(e.options);for(let o of e.options){let i=Il(o),s=o.default?`${o.description} (default: ${o.default})`:o.description;n.push(`${J}${i.padEnd(r+2)}${s}`)}n.push("")}if(e.examples&&e.examples.length>0){n.push("EXAMPLES:");for(let r of e.examples)n.push(`${J}${r}`)}t(n.join(`
`))}function bo(){let e=um(nn),t=[];t.push(`${He} v${Tl}`),t.push(""),t.push("Blocks destructive commands and secret access."),t.push(""),t.push("COMMANDS:");for(let n of nn)t.push(pm(n,e));t.push(""),t.push("GLOBAL OPTIONS:"),t.push(`${J}-h, --help       Show help (use with command for command-specific help)`),t.push(`${J}-V, --version    Show version`),t.push(""),t.push("HELP:"),t.push(`${J}${He} help <command>     Show help for a specific command`),t.push(`${J}${He} <command> --help   Show help for a specific command`),t.push(""),t.push("ENVIRONMENT VARIABLES:"),t.push(he(`${S.level.name}=standard|strict|paranoid`,"Set session safety level")),t.push(he(`${S.worktree.name}=1`,"Allow local git discards in linked worktrees")),t.push(he(`${S.debug.name}=1`,"Print diagnostic messages to stderr")),t.push(he(`${S.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),t.push(he("CC_SAFETY_NET_HOME","Override rule config home directory")),t.push(""),t.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),t.push(he(`${S.strict.name}=1`,"Force safety.overrides.fail_closed on")),t.push(he(`${S.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),t.push(he(`${S.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),t.push(he(`${S.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),t.push(""),t.push("Documentation:        https://ccsafetynet.com/docs"),console.log(t.join(`
`))}function _l(){console.log(Tl)}function Ut(e,t=console.log){let n=rn(e);if(!n)return!1;if(n.name.toLowerCase()!==e.toLowerCase())return!1;return In(n,t),!0}import{existsSync as Io,readFileSync as Sc}from"node:fs";import{homedir as cg,tmpdir as dg}from"node:os";import{join as Po}from"node:path";import*as xe from"node:readline";function fm(e){return e==="install"?"Install":"Uninstall"}function mm(e){return e==="install"?"Installing":"Uninstalling"}function gm(e){return e==="install"?"into":"from"}function Nl(e){return e?.available===!0}function hm(e,t){let n=new Set(t);return e.filter((r)=>n.has(r.target)).map((r)=>r.target)}function Ol(e,t,n){if(e.length===0||e.every((r)=>!r.available))return t;return Array.from({length:e.length},(r,o)=>o+1).map((r)=>(t+r*n+e.length)%e.length).find((r)=>Nl(e[r]))}function ym(e,t,n){if(n.ctrl&&n.name==="c")return"interrupt";if(n.name==="escape"||t==="q")return"abort";if(e==="install"&&(t==="u"||t==="U"))return"update";if(n.name==="up"||t==="k")return"up";if(n.name==="down"||t==="j")return"down";if(n.name==="space"||t===" ")return"toggle";if(n.name==="return"||n.name==="enter")return"confirm";return null}function Lm(e){return{cursor:e.findIndex((t)=>t.available),selected:[]}}function vm(e,t,n){if(n==="confirm"||n==="update"||n==="abort"||n==="interrupt")return{state:e,done:n};if(n==="up")return{state:{...e,cursor:Ol(t,e.cursor,-1)}};if(n==="down")return{state:{...e,cursor:Ol(t,e.cursor,1)}};let r=t[e.cursor];if(!Nl(r))return{state:e};let o=e.selected.includes(r.target)?e.selected.filter((i)=>i!==r.target):hm(t,[...e.selected,r.target]);return{state:{...e,selected:o}}}var Fl="◉",Hl="◯",Ml=">",jl=" ";function bm(e,t,n,r={}){let o=r.color!==!1,i=o?y.dim:(l)=>l,s=o?y.green:(l)=>l,a=o?y.bold:(l)=>l;return["",`${fm(e)} CC Safety Net ${gm(e)}:`,"",...t.map((l,c)=>{let u=n.selected.includes(l.target),p=c===n.cursor,g=u?Fl:Hl,d=p?Ml:jl,h=l.available?"":` (${l.unavailableReason??"not installed"})`,m=`${g} ${l.label}${h}`,b=!l.available?i(m):u?s(m):p?a(m):m;return`${d} ${b}`}),"",e==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((l)=>l.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${e}. q/Esc: close`].join(`
`)}var $l=["global-hook","plugin"];function wm(e,t,n={}){let r=n.color!==!1?y.bold:(i)=>i;return["","Install the Kimi Code integration as:","",...[`Global hook — ${t?"already installed; selecting it reports the current state":"write the hook into ~/.kimi-code/config.toml now"}`,"Native Kimi plugin — print the steps to run inside Kimi Code"].map((i,s)=>{let a=s===e,l=`${a?Fl:Hl} ${i}`;return`${a?Ml:jl} ${a?r(l):l}`}),"","Enter: confirm  Up/Down: move  q/Esc: cancel"].join(`
`)}function Ul(e){let{input:t,output:n}=e;xe.emitKeypressEvents(t);let r=t.isRaw===!0;t.setRawMode(!0),t.resume();let o=0,i=()=>{if(o===0)return;xe.moveCursor(n,0,-o),xe.cursorTo(n,0),xe.clearScreenDown(n)},s=()=>{i();let a=e.render();n.write(`${a}
`),o=a.split(`
`).length};return new Promise((a)=>{let l=(u)=>{t.off("keypress",c),t.setRawMode(r),t.pause(),i(),a(u)};function c(u,p){e.onKey(u,p,{finish:l,draw:s})}t.on("keypress",c),s()})}function Gl(e={}){let t=0;return Ul({input:e.input??process.stdin,output:e.output??process.stdout,render:()=>wm(t,e.globalHookInstalled===!0),onKey:(n,r,o)=>{if(r.ctrl&&r.name==="c"){o.finish(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(r.name==="escape"||n==="q")return o.finish(null);if(r.name==="return"||r.name==="enter")return o.finish($l[t]);if(r.name==="up"||r.name==="down"||n==="k"||n==="j")t=(t+1)%$l.length,o.draw()}})}function wo(e=process.stdin,t=process.stdout){return Boolean(e.isTTY&&t.isTTY&&typeof e.setRawMode==="function")}function Bl(e,t,n={}){let r=n.output??process.stdout,o=Lm(t);return Ul({input:n.input??process.stdin,output:r,render:()=>bm(e,t,o),onKey:(i,s,a)=>{let l=ym(e,i,s);if(!l)return;let c=vm(o,t,l);if(o=c.state,c.done==="interrupt"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(c.done==="abort")return a.finish(null);if(c.done==="update")return a.finish("update");if(c.done==="confirm"){if(o.selected.length===0){r.write("\x07"),a.draw();return}a.finish([...o.selected]),r.write(`${mm(e)} selected integrations...
`);return}a.draw()}})}import{existsSync as Vl,lstatSync as xm,mkdirSync as Cm,mkdtempSync as Sm,readdirSync as Rm,readFileSync as ft,rmSync as $n}from"node:fs";import{tmpdir as Dm}from"node:os";import{basename as Am,dirname as Em,join as U}from"node:path";import{fileURLToPath as Pm}from"node:url";var ko="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp",Me="cc-safety-net",je="cc-safety-net/index.ts";import{spawn as km}from"node:child_process";var xo=(e,t)=>{let n=Oe([...e],process.env);return new Promise((r)=>{let o=km(n.cmd,n.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),i=oo(o),s=!1,a=setTimeout(()=>{s=!0,o.kill()},120000);o.on("error",(l)=>{clearTimeout(a),r({status:null,errorCode:l.code,stdout:i.stdout,stderr:[l.message,i.stderr].filter(Boolean).join(`
`)})}),o.on("close",(l)=>{clearTimeout(a),r({status:s?null:l,errorCode:s?"ETIMEDOUT":void 0,stdout:i.stdout,stderr:i.stderr})})})};var pt="cc-safety-net.ts",ql=U("amp",je);function Tm(e){return U(e,".config","amp","plugins","cc-safety-net.ts")}function Im(){let e=Em(Pm(import.meta.url));return[U(e,"..",ql),U(e,"..","..","..","dist",ql)]}function _m(e=Im()){let t=e.find((n)=>Vl(n)&&xm(n).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function zl(e){try{return JSON.parse(e)}catch{return}}function Nn(e){return e.subarray(0,Buffer.byteLength(ko)).toString("utf-8")===ko}async function Gt(e,t,n){let r=await e(t,n);if(r.status===0)return r;throw Error([`Failed to run ${t.join(" ")}${r.status===null?"":` (exit ${r.status})`}.`,[r.stdout,r.stderr].filter(Boolean).join(`
`).trim()].filter(Boolean).join(`
`))}async function Kl(e){let t=await e(["amp","plugins","repositories","--json"]);if(t.status===null)throw Error(`${t.errorCode==="ENOENT"?'Amp CLI not found. Install the amp CLI, sign in with "amp login", and rerun install --amp.':`amp plugins repositories --json did not finish (${t.errorCode??"terminated"}). Check that the amp CLI responds and rerun install --amp.`}
...
`)}`.trim());let n=zl(t.stdout),r=(Array.isArray(n)?n:[]).filter((o)=>k(o,"scope")==="user"&&k(o,"exists")===!0&&k(o,"viewerCanWrite")===!0).map((o)=>k(o,"cloneRef")).find((o)=>typeof o==="string"&&o.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}async function Wl(e,t){let n=Sm(U(Dm(),"cc-safety-net-amp-"));try{return await Gt(e,["amp","clone","user-plugins",n]),await t(n)}finally{$n(n,{recursive:!0,force:!0})}}function Co(e){return`rerun ${e==="overwrite"?"install":"uninstall"} --amp`}function Jl(e,t,n){let r=U(e,t),o=E(r);if(!o)return;if(o.isSymbolicLink()||!o.isFile())throw Error(`Refusing to ${n} ${t} in your Amp personal plugins repository: not a regular file. Remove it there and ${Co(n)}.`);let i=ft(r);if(Nn(i))return i;throw Error(`Refusing to ${n} unmanaged file ${t} in your Amp personal plugins repository. Remove it there and ${Co(n)}.`)}function Yl(e,t){let n=U(e,Me),r=E(n);if(!r)return;if(r.isSymbolicLink()||!r.isDirectory())throw Error(`Refusing to ${t} ${Me} in your Amp personal plugins repository: not a regular directory. Remove it there and ${Co(t)}.`);return Jl(e,je,t)}function Om(e){let t=U(e,pt),n=E(t);if(!n||n.isSymbolicLink()||!n.isFile())return;let r=ft(t);return Nn(r)?r:void 0}async function Zl(e,t,n,r){if(await Gt(e,n,t),(await Gt(e,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await Gt(e,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",r],t),await Gt(e,["git","push","origin","HEAD"],t),!0}function _n(e,t){$m(e,t),Nm(e,t)}function Xl(e,t){if(t==="keep")return;throw Error(`Local Amp plugin ${e} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function $m(e,t){let n=Tm(e),r=E(n);if(!r)return;if(!r.isSymbolicLink()&&r.isFile()&&Nn(ft(n))){$n(n);return}Xl(n,t)}function Nm(e,t){let n=U(e,".config","amp","plugins",Me),r=E(n);if(!r)return;if(!r.isSymbolicLink()&&r.isDirectory()&&Fm(n)){$n(n,{recursive:!0});return}Xl(n,t)}function Fm(e){let t=Am(je);if(Rm(e).join("\x00")!==t)return!1;let n=U(e,t),r=E(n);return!!r&&!r.isSymbolicLink()&&r.isFile()&&Nn(ft(n))}function Hm(){let e=xt();if(!Vl(e))return"";let t=zl(ft(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(On(t))};
`}async function Ql(e,t=_m(),n=xo){let r=Buffer.concat([ft(t),Buffer.from(Hm(),"utf-8")]),o=await Kl(n);return Wl(n,async(i)=>{let s=`${o}/${Me}`,a=Yl(i,"overwrite"),l=Jl(i,pt,"overwrite");if(a?.equals(r)&&!l)return _n(e,"fail"),{path:s,alreadyInstalled:!0};if(Cm(U(i,Me),{recursive:!0}),I(U(i,je),r),l)$n(U(i,pt));let c=await Zl(n,i,["git","add","--",je,...l?[pt]:[]],`chore: update cc-safety-net plugin to v${T()}`);return _n(e,"fail"),{path:s,alreadyInstalled:!c}})}async function ec(e,t=xo){let n=await Kl(t);return Wl(t,async(r)=>{let o=Yl(r,"remove"),i=Om(r),s=`${n}/${i&&!o?pt:Me}`;if(!o&&!i)return _n(e,"keep"),{path:s,alreadyInstalled:!1};return await Zl(t,r,["git","rm","--",...o?[je]:[],...i?[pt]:[]],`chore: remove cc-safety-net plugin v${T()}`),_n(e,"keep"),{path:s,alreadyInstalled:!0}})}import{existsSync as tc,mkdirSync as Mm,readFileSync as jm}from"node:fs";import{dirname as Um}from"node:path";var So="npx -y cc-safety-net hook --agy-cli",Ue="cc-safety-net";function Ge(e){return Boolean(e)&&typeof e==="object"&&!Array.isArray(e)}function Hn(){return{PreToolUse:[{hooks:[{type:"command",command:So,timeout:30}]}]}}function nc(e){try{let t=JSON.parse(jm(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${e}: ${t.message}`);throw t}}function rc(e){let t=e[Ue];if(t===void 0){let r=Hn();return e[Ue]=r,{definition:r,preToolUse:r.PreToolUse??[]}}if(!Ge(t))throw Error(`Antigravity hooks config entry "${Ue}" must be an object`);let n=Array.isArray(t.PreToolUse)?t.PreToolUse:[];return t.PreToolUse=n,{definition:t,preToolUse:n}}function oc(e){if(!Array.isArray(e.PreToolUse))return!1;return e.PreToolUse.some((t)=>Ge(t)&&Array.isArray(t.hooks)&&t.hooks.some((n)=>Ge(n)&&n.command===So))}function Gm(e){return Object.values(e).some((t)=>Ge(t)&&t.enabled!==!1&&oc(t))}function Bm(e){if(e[Ue]===void 0)return!1;let t=rc(e);if(t.definition.enabled!==!1||!oc(t.definition))return!1;return t.definition.enabled=!0,!0}function qm(e){if(e[Ue]===void 0){e[Ue]=Hn();return}let t=rc(e);t.definition.enabled=!0,t.preToolUse.push(Hn().PreToolUse?.[0]??{hooks:[]})}function Vm(e){let t=!1;for(let n of Object.values(e)){if(!Ge(n)||!Array.isArray(n.PreToolUse))continue;n.PreToolUse=n.PreToolUse.flatMap((r)=>{if(!Ge(r)||!Array.isArray(r.hooks))return[r];let o=r.hooks.filter((i)=>!Ge(i)||i.command!==So);if(o.length!==r.hooks.length)t=!0;return o.length===0?[]:[{...r,hooks:o}]})}return t}function Fn(e,t){I(e,`${JSON.stringify(t,null,2)}
`)}function ic(e){let t=Dt(e);if(Mm(Um(t),{recursive:!0}),!tc(t))return Fn(t,{[Ue]:Hn()}),{path:t,alreadyInstalled:!1};let n=nc(t);if(Gm(n))return{path:t,alreadyInstalled:!0};if(Bm(n))return Fn(t,n),{path:t,alreadyInstalled:!1};return qm(n),Fn(t,n),{path:t,alreadyInstalled:!1}}function sc(e){let t=Dt(e);if(!tc(t))return{path:t,alreadyInstalled:!1};let n=nc(t);if(!Vm(n))return{path:t,alreadyInstalled:!1};return Fn(t,n),{path:t,alreadyInstalled:!0}}import{existsSync as zm,readdirSync as Km,rmSync as Wm}from"node:fs";import{join as Jm}from"node:path";function ac(e,t=process.platform,n){if(!zm(e))return;let r=t==="win32"?/^bunx-\d+-cc-safety-net@/:new RegExp(`^bunx-${process.getuid?.()??0}-cc-safety-net@`);Km(e).filter((o)=>o!==n&&r.test(o)).forEach((o)=>{Wm(Jm(e,o),{recursive:!0,force:!0})})}import{spawn as Ym}from"node:child_process";var ae=z.map((e)=>({target:e.id,flag:e.flag,label:D(e.id),probeCommand:e.probeCommand}));function Ro(e){let t=new Set(e);return ae.map((n)=>n.target).filter((n)=>t.has(n))}async function lc(e,t){for(let n of e)await t(n)}var Zm=5000;function Do(e){return new Promise((t)=>{let n=Oe([...e],process.env),r=Ym(n.cmd,n.args,{env:process.env,stdio:"ignore"}),o=!1,i=(a)=>{if(o)return;o=!0,clearTimeout(s),t(a)},s=setTimeout(()=>{r.kill(),i(!1)},Zm);r.on("error",()=>i(!1)),r.on("close",(a)=>i(a===0))})}function cc(e=Do,t={}){let n=new Set(t.configuredTargets??[]);return Promise.all(ae.map(async(r)=>({target:r.target,flag:r.flag,label:r.label,...uc(t.action,await e(r.probeCommand),n.has(r.target))})))}function dc(e,t){let n=new Set(t.configuredTargets??[]);return e.map((r)=>({...r,...uc(t.action,r.available,n.has(r.target))}))}function uc(e,t,n){if(e==="uninstall")return n?{available:!0}:{available:!1,unavailableReason:"not installed"};if(e==="install"&&n)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as pc,readdirSync as Xm,rmSync as Qm}from"node:fs";import{join as mt}from"node:path";function Mn(e,t=process.platform){let n=mt(process.env.npm_config_cache||(t==="win32"?mt(process.env.LOCALAPPDATA||mt(e,"AppData","Local"),"npm-cache"):mt(e,".npm")),"_npx");if(!pc(n))return;Xm(n).filter((r)=>pc(mt(n,r,"node_modules","cc-safety-net"))).forEach((r)=>{Qm(mt(n,r),{recursive:!0,force:!0})})}import{existsSync as mc,mkdirSync as eg,readFileSync as gc}from"node:fs";import{dirname as tg,join as fc}from"node:path";var Bt="npx -y cc-safety-net hook --kimi-code",Ao=`[[hooks]]
event = "PreToolUse"
command = "${Bt}"`,Eo=`{ event = "PreToolUse", command = "${Bt}" }`;function hc(e){return fc(process.env.KIMI_CODE_HOME??fc(e,".kimi-code"),"config.toml")}function ng(e){return e.split(`
...
`)}function rg(e,t){if(e[t]!=="#")return t;let n=e.indexOf(`
`,t+1);return n===-1?e.length:n+1}function og(e,t){return Rn(e,t,{skipComment:rg,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function yc(e){let t=!1,n=0;while(n<e.length){let r=e.indexOf(`
`,n),o=r===-1?e.length:r,i=e.slice(n,o);if(/^\s*\[/.test(i))t=!0;if(!t){let s=/^(\s*)hooks\s*=\s*\[/.exec(i);if(s){let a=n+s[0].lastIndexOf("[");return{start:a,end:og(e,a)}}}n=r===-1?e.length:r+1}return}function ig(e,t){let n=e.slice(0,t.end).trimEnd(),r=ll(e,t.end),o=r===""?"     ":`${r}  `,i=!n.endsWith("[")&&!n.endsWith(",");return`${n}${i?",":""}
${o}${Eo}${e.slice(t.end)}`}function sg(e){let t=yc(e);if(t&&e.slice(t.start+1,t.end).trim())return ig(e,t);let n=ng(e).trimEnd();if(n==="")return`${Ao}
`;return`${n}

${Ao}
`}function ag(e){return e.split(/(?=^\s*\[)/m).filter((n)=>!/^\s*\[\[hooks]]\s*$/m.test(n)||!n.includes(Bt)).join("").trimEnd()}function lg(e,t){let n=e.indexOf(Eo,t.start);if(n===-1||n>t.end)return e;return Dn(e,{start:n,end:n+Eo.length})}function Lc(e){let t=hc(e);if(eg(tg(t),{recursive:!0}),!mc(t))return I(t,`${Ao}
`),{path:t,alreadyInstalled:!1};let n=gc(t,"utf-8");if(n.includes(Bt))return{path:t,alreadyInstalled:!0};return I(t,sg(n)),{path:t,alreadyInstalled:!1}}function vc(e){let t=hc(e);if(!mc(t))return{path:t,alreadyInstalled:!1};let n=gc(t,"utf-8");if(!n.includes(Bt))return{path:t,alreadyInstalled:!1};let r=yc(n),o=r?lg(n,r):`${ag(n)}
`;return I(t,o),{path:t,alreadyInstalled:!0}}var To="safety-net@cc-marketplace",bc=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]),wc=new Set(["antigravity-cli","cursor","grok-build","hermes-agent","kimi-code"]);function _o(e){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(e??"")}function Rc(e){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(e??"")}function ug(e){return/^Marketplace `cc-marketplace`\s*$/m.test(e??"")}var Dc={"claude-code":{installCommands:(e)=>{let t=pn(e,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...Gr(e).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:pn(e,To)?[["claude","plugin","uninstall",To]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:async(e,t)=>{let n=t??await se(["codex","plugin","list"]),r=Rc(n);return{commands:[r||ug(n)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:_o(n)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:r}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:async()=>{let e=await se(["copilot","plugin","list"]),t=[...da(e)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...ua(e)?[["copilot","plugin","uninstall",aa]]:[]];if(la(e))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",ie]],cleanupCommands:t,update:!0};return{commands:[ca(await se(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",ie]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(e)=>{let t=Jr(e);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:lo,installCommands:()=>({commands:el()}),uninstallCommands:[["openclaw","plugins","uninstall",A,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:po,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function Un(){return process.env.HOME??cg()}function Ac(e,t=(n)=>n){try{let n=JSON.parse(t(Sc(e,"utf-8")));if(!n||typeof n!=="object"||Array.isArray(n))throw Error(`Settings file ${e} must be a JSON object`);return n}catch(n){if(n instanceof SyntaxError)throw Error(`Failed to parse ${e}: ${n.message}`);throw n}}function pg(e){let t=Po(_t(e),"settings.json");if(!Io(t))return;let n=Ac(t,q),r=n.enabledPlugins;if(!r||typeof r!=="object"||Array.isArray(r))return;if(r[ie]!==!1)return;let o=Sc(t,"utf-8"),i=o.replace(new RegExp(`("${ie}"\\s*:\\s*)false`),"$1true");return r[ie]=!0,I(t,i!==o?i:`${JSON.stringify(n,null,2)}
`),`Enabled ${ie} plugin in ${t}`}function fg(e){let t=fo(e);if(!Io(t))return;let n=Ac(t);if(!Array.isArray(n.packages))return;let r=n.packages.find((o)=>!!o&&typeof o==="object"&&!Array.isArray(o)&&mo(o.source)&&("extensions"in o));if(!r)return;return delete r.extensions,I(t,`${JSON.stringify(n,null,2)}
`),`Enabled npm:cc-safety-net extensions in ${t}`}function kc(e,t){let n=_({label:t,booleans:Object.fromEntries(ae.map((i)=>[i.target,[i.flag]]))},e),r=n.errors[0];if(r)throw Error(r);let o=ae.filter((i)=>n.flags[i.target]).map((i)=>i.target);if(o.length!==1)throw Error(`Choose exactly one ${t} target: ${ae.map((i)=>i.flag).join(", ")}`);return o[0]}async function Ec(e=Un(),t=it){let[n,r,o]=await Promise.all([t(["amp","plugins","list"],30000),t(["codex","plugin","list"],30000),t(["copilot","--binary-version"])]);return{codexPluginListOutput:r,hooks:ut(process.cwd(),{homeDir:e,ampPluginListOutput:n,codexPluginListOutput:r,copilotCliVersion:o})}}async function mg(e,t=it){let n=await Ec(Un(),t);return n.hooks.filter((r)=>e==="install"?r.configured:r.detected||r.inspectionStatus==="not-inspected").filter((r)=>r.platform!=="codex"||!_o(n.codexPluginListOutput)||Rc(n.codexPluginListOutput)).map((r)=>r.platform)}function gg(e,t,n){if(t.length>0)return{finish:async()=>[kc(t,e)]};if(!n.selectTargets&&!wo(n.input,n.output))return{finish:async()=>[kc(t,e)]};let r=n.detectConfiguredTargets??(()=>mg(e,n.fetchVersion)),o=Promise.all([cc(n.probeTargets),r()]);return{ready:o,finish:async()=>{let[i,s]=await o,a=dc(i,{action:e,configuredTargets:s}),l=n.selectTargets?await n.selectTargets(e,Cc(e,a)):await Bl(e,Cc(e,a),{input:n.input,output:n.output});if(l==="update")return l;if(!l||l.length===0)return null;return Ro(l)}}}async function Be(e,t,n=!1,r){let o=Dc[e];o.beforeInstall?.(t);let i=typeof o.installCommands==="function"?await o.installCommands(t,r):{commands:o.installCommands};return await io(i.commands),await Wa(i.cleanupCommands??[]),[`${i.update||n?"Updated":"Installed"} ${D(e)} integration`,o.postInstallMessage].filter(Boolean).join(`
`)}async function gt(e){let t=Dc[e];if(!t.uninstallCommands)throw Error(`${D(e)} uninstall is not supported`);return await io(t.uninstallCommands),`Uninstalled ${D(e)} integration`}function hg(e){let t=vl(e);return t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`}var yg={"antigravity-cli":{install:ic,uninstall:sc},cursor:{install:wa,uninstall:ka},"grok-build":{install:Ia,uninstall:_a},"kimi-code":{install:Lc,uninstall:vc}};function Ce(e,t,n,r=!1){if(e==="install"&&!r)Mn(n);let o=yg[t][e](n),i=D(t),s=e!=="install"?"Uninstalled":r?"Updated":"Installed";return e==="install"&&o.alreadyInstalled?r?`${i} hook up to date in ${o.path}`:`${i} hook already installed in ${o.path}`:e==="uninstall"&&!o.alreadyInstalled?`${i} hook not installed in ${o.path}`:`${s} ${i} hook ${e==="install"?"in":"from"} ${o.path}`}var Lg={amp:{install:Ql,uninstall:ec,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:Ha,uninstall:Ma,afterInstall:async(e)=>{let t=no(e);return await se(["hermes","plugins","enable",K,"--no-allow-tool-override"]),!t},beforeUninstall:async(e)=>{to(e);try{await se(["hermes","plugins","disable",K])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
Removing the plugin files anyway; ${K} may still be listed in the Hermes config.`)}},restartNote:"Restart Hermes to apply the change."}};async function jn(e,t,n,r=!1){let o=Lg[t];if(e==="uninstall")await o.beforeUninstall?.(n);let i=e==="install"?await o.install(n):await o.uninstall(n),s=e==="install"&&await o.afterInstall?.(n),a=D(t),l=!s&&(e==="install"&&i.alreadyInstalled||e==="uninstall"&&!i.alreadyInstalled);return[l?e==="install"?`${a} plugin ${r?"up to date":"already installed"} at ${i.path}`:`${a} plugin not installed at ${i.path}`:`${e!=="install"?"Uninstalled":r?"Updated":"Installed"} ${a} plugin ${e==="install"?"at":"from"} ${i.path}`,l?void 0:o.restartNote].filter(Boolean).join(`
`)}var vg={amp:{install:(e,t)=>jn("install","amp",e,t),uninstall:(e)=>jn("uninstall","amp",e)},"antigravity-cli":{install:(e,t)=>Ce("install","antigravity-cli",e,t),uninstall:(e)=>Ce("uninstall","antigravity-cli",e)},"claude-code":{install:(e,t)=>Be("claude-code",e,t),uninstall:()=>gt("claude-code")},codex:{install:(e,t,n)=>Be("codex",e,t,n),uninstall:()=>gt("codex")},"copilot-cli":{install:async(e,t)=>[await Be("copilot-cli",e,t),pg(e)].filter(Boolean).join(`
`),uninstall:()=>gt("copilot-cli")},cursor:{install:(e,t)=>Ce("install","cursor",e,t),uninstall:(e)=>Ce("uninstall","cursor",e)},"gemini-cli":{install:(e,t)=>Be("gemini-cli",e,t),uninstall:()=>gt("gemini-cli")},"grok-build":{install:(e,t)=>Ce("install","grok-build",e,t),uninstall:(e)=>Ce("uninstall","grok-build",e)},"hermes-agent":{install:(e,t)=>{if(!t)Mn(e);return jn("install","hermes-agent",e,t)},uninstall:(e)=>jn("uninstall","hermes-agent",e)},"kimi-code":{install:(e,t)=>Ce("install","kimi-code",e,t),uninstall:(e)=>Ce("uninstall","kimi-code",e)},openclaw:{install:async(e,t)=>{let n=await Be("openclaw",e,t);return await tl(),n},uninstall:(e)=>(lo(e),gt("openclaw"))},opencode:{install:async(e,t)=>{let n=await Be("opencode",e,t);return await gl(e),n},uninstall:(e)=>hg(e)},pi:{install:async(e,t)=>[await Be("pi",e,t),fg(e)].filter(Boolean).join(`
`),uninstall:()=>gt("pi")}},xc=["Install CC Safety Net as a native Kimi Code plugin:","","  1. Start Kimi Code and run: /plugins install https://github.com/kenryu42/cc-safety-net","     Confirm the trust prompt; it defaults to cancel.","  2. Run /reload, or start a new session.","","Note: Kimi Code hooks are fail-open. When the hook process cannot start, crashes, or times","out, Kimi Code allows the tool call."].join(`
`);function bg(e){if(Ht({homeDir:e,cwd:process.cwd()}).status!=="configured")return xc;return[xc,"",y.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function Cc(e,t){return t.map((n)=>e==="install"&&n.target==="kimi-code"&&n.unavailableReason==="already installed"?{...n,available:!0,unavailableReason:void 0,label:`${n.label} (global hook installed)`}:n)}function wg(e,t){if(e.selectKimiInstallMethod)return e.selectKimiInstallMethod();if(!wo(e.input,e.output))return Promise.resolve("global-hook");return Gl({input:e.input,output:e.output,globalHookInstalled:Ht({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function Pc(e,t,n,r=!1,o){return vg[t][e](n,r,o)}function kg(e){let t=_({label:"update"},e).errors[0];if(t)throw Error(t)}async function xg(e,t=it){let n=await Ec(e,t),r=Po(_t(e),"installed-plugins");return{targets:Ro([...n.hooks.filter((i)=>i.platform!=="copilot-cli"&&i.detected).map((i)=>i.platform),...[fn,sa,ia].flatMap((i)=>Io(Po(r,...i))?["copilot-cli"]:[]),...pn(e,To)?["claude-code"]:[],..._o(n.codexPluginListOutput)?["codex"]:[]]),codexPluginListOutput:n.codexPluginListOutput}}async function Cg(e){let t=Un(),n=e.output??process.stdout,r=(e.scriptPath??process.argv[1]??"").split(/[\\/]/),o=r.find((d)=>/^bunx-\d+-/.test(d)),i=o!==void 0||r.includes("_npx")?null:(e.checkLatestVersion??we)(),s=async()=>{let d=i&&await i;if(d?.updateAvailable)n.write(`
Update available: cc-safety-net ${d.currentVersion} → ${d.latestVersion}. Update this CLI with your package manager, e.g. \`npm i -g cc-safety-net@latest\` for a global install.
`)},a=xg(t,e.fetchVersion??it).then(async(d)=>{let h=new Set(d.targets);return{targets:d.targets,codexPluginListOutput:d.codexPluginListOutput,available:new Map(await Promise.all(ae.filter((m)=>h.has(m.target)&&bc.has(m.target)).map(async(m)=>[m.target,await Do(m.probeCommand)])))}}),l=await It(e.showBanner??!0,()=>({ready:a,finish:()=>a}),()=>Tt({input:e.input??process.stdin,output:n}),{loadingMessage:"Checking installed integrations…",output:n}),c=await Promise.resolve().then(()=>(ac(dg(),process.platform,o),null)).catch((d)=>qt(d));if(l.targets.length===0){if(n.write("No installed integrations found. Run `cc-safety-net install` to set one up.\n"),c!==null)console.error(c);return await s(),c===null?0:1}let u=l.targets.some((d)=>wc.has(d))?await Promise.resolve().then(()=>(Mn(t),null)).catch((d)=>qt(d)):null,p=await cn(Promise.all(l.targets.map((d)=>{if(bc.has(d)&&!l.available.get(d))return Promise.resolve({message:`${D(d)} not found; skipped`,failed:!1});if(u!==null&&wc.has(d))return Promise.resolve({message:u,failed:!0});return Pc("install",d,t,!0,l.codexPluginListOutput).then((h)=>({message:h,failed:!1}),(h)=>({message:qt(h),failed:!0}))})),{loadingMessage:`Updating ${l.targets.length} integration${l.targets.length===1?"":"s"}…`,output:n}),g=c===null?p:[...p,{message:c,failed:!0}];return g.forEach((d)=>{d.failed?console.error(d.message):n.write(`${d.message}
`)}),await s(),g.some((d)=>d.failed)?1:0}function Oo(e,t={}){return Promise.resolve().then(()=>kg(e)).then(()=>Cg(t)).catch((n)=>(console.error(qt(n)),1))}async function Vt(e,t,n={}){try{let r=await It(!0,()=>gg(e,t,n),()=>Tt({input:n.input??process.stdin,output:n.output??process.stdout}),{loadingMessage:e==="install"?"Checking available integrations…":"Checking installed integrations…",output:n.output??process.stdout});if(!r)return(n.output??process.stdout).write(`Cancelled: nothing was ${e}ed.
`),0;if(r==="update")return(n.runUpdate??(()=>Oo([],{fetchVersion:n.fetchVersion,input:n.input,output:n.output,showBanner:!1})))();let o=Un(),i=n.output??process.stdout;return await lc(r,async(s)=>{if(s==="kimi-code"&&e==="install"){let l=await wg(n,o);if(l===null){i.write(`Cancelled: Kimi Code integration was not installed.
`);return}if(l==="plugin"){i.write(`${bg(o)}
`);return}}let a=await cn(Pc(e,s,o),{loadingMessage:`${e==="install"?"Installing":"Uninstalling"} ${D(s)} integration…`,output:i});i.write(`${a}
...
Check that every parent path component is a directory.`;return t}import{join as s1}from"node:path";var Tc="# Custom Rules Reference\n\nAgent reference for generating CC Safety Net rulebook configuration.\n\n## Config Locations\n\n| Scope | Config path | Rulebook path | Cache path | Priority |\n|-------|-------------|---------------|------------|----------|\n| User | `~/.cc-safety-net/rules/rule.json` | `~/.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `~/.cc-safety-net/cache/rulebooks/` | First |\n| Project | `.cc-safety-net/rules/rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `.cc-safety-net/cache/rulebooks/` | Second |\n| GitHub source | Listed in a local `rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` in the source repository | Consumer local cache | Source order |\n\nUser scope is evaluated before project scope; within a scope, sources apply in `rules` array order. A duplicate active rulebook name keeps the first claim and ignores the later rulebook with a warning, so a user-scoped name shadows a project-scoped one.\n\nUse `cc-safety-net rule init` to create an inert local config. Use `--global` for user scope. Use `cc-safety-net rule init --example` to also create an inactive example rulebook. `CC_SAFETY_NET_HOME` overrides the `~/.cc-safety-net` user root.\n\nLegacy inline `.safety-net.json` and `~/.cc-safety-net/config.json` files are not loaded at runtime. Convert them with `cc-safety-net rule migrate`.\n\n## rule.json Schema\n\n```json\n{\n  \"version\": 1,\n  \"rules\": [\"project-rules\", \"owner/repo#main/team-rules\"],\n  \"overrides\": {\n    \"project-rules/block-docker-system-prune\": {\n      \"reason\": \"Use targeted Docker cleanup commands.\"\n    },\n    \"team-rules/block-npm-global\": \"off\"\n  },\n  \"transparent_wrappers\": [\"rtk\"]\n}\n```\n\n- `version`: Required. Must be `1`.\n- `$schema`: Optional. `cc-safety-net rule verify` inserts it into a valid `rule.json` that lacks it.\n- `rules`: Optional array of rulebook source strings. Missing `rules` is treated as `[]`.\n- `overrides`: Optional object keyed by `<rulebook-name>/<rule-name>`.\n- `overrides` values are either `\"off\"` to disable a rule or an object with a required `reason` (replacement block reason) and an optional `intent` (one of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain`).\n- A project override cannot target a user-scoped rule: only that override is ignored, the user rule keeps its configured state, and `rule sync`/`rule verify` report the diagnostic as a failure.\n- `transparent_wrappers`: Optional array of command names that transparently execute a visible child command.\n- Transparent wrappers have no built-in defaults. Configure only wrappers you intentionally trust, such as `\"rtk\"`.\n- Use `cc-safety-net rule wrapper add rtk` to configure RTK without manually editing `rule.json`.\n\n## Rulebook Sources\n\n- Local sources are bare rulebook names such as `project-rules`; the rulebook file is `.cc-safety-net/rules/project-rules/rulebook.json`.\n- Run `cc-safety-net rule add owner/repo` to add every rulebook currently present on the repository's default branch.\n- Use `--only` to select one or more rulebooks while preserving their order: `cc-safety-net rule add owner/repo --only aws gcloud`.\n- Use `--ref` to select a branch, tag, or commit instead of the default branch: `cc-safety-net rule add owner/repo --ref v2 --only aws`.\n- GitHub sources are stored in canonical form as `owner/repo#ref/<rulebook-name>`. That form remains valid in `rule.json` and as direct CLI input.\n- GitHub refs may contain `/`-separated path segments, such as `feature/rulebook-v2`.\n- The GitHub source name, the repository directory name, and the rulebook `name` must match exactly.\n- Rulebook source strings must be unique in a config.\n\n## rulebook.json Schema\n\n```json\n{\n  \"rulebook_version\": 1,\n  \"name\": \"project-rules\",\n  \"version\": \"1.0.0\",\n  \"description\": \"Project-specific CC Safety Net rules.\",\n  \"author\": \"project\",\n  \"allowed_commands\": [\"docker\"],\n  \"rules\": [\n    {\n      \"name\": \"block-docker-system-prune\",\n      \"command\": \"docker\",\n      \"subcommand\": \"system\",\n      \"block_args\": [\"prune\"],\n      \"reason\": \"Use targeted cleanup instead.\"\n    }\n  ],\n  \"tests\": [\n    {\n      \"command\": \"docker system prune\",\n      \"expect\": \"blocked\",\n      \"rule\": \"block-docker-system-prune\"\n    },\n    {\n      \"command\": \"docker ps\",\n      \"expect\": \"allowed\"\n    }\n  ]\n}\n```\n\n### Rulebook Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `rulebook_version` | Yes | Must be `1` or `2` |\n| `name` | Yes | `^[a-zA-Z][a-zA-Z0-9_-]{0,63}$` |\n| `version` | Yes | Non-empty string |\n| `description` | No | Free text; not type-checked at runtime |\n| `author` | No | Free text; not type-checked at runtime |\n| `allowed_commands` | Yes | Unique command names matching `^[a-zA-Z][a-zA-Z0-9_-]*$` |\n| `rules` | Yes | Array of rule objects |\n| `tests` | No | Array of fixtures |\n\n### Rule Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `name` | Yes | Unique within the rulebook (case-insensitive); same pattern as rulebook `name` |\n| `command` | Yes | Must be listed in `allowed_commands`; basename only, not path |\n| `subcommand` | No | Same pattern as `command`; omit to match any subcommand |\n| `intent` | No | One of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain` |\n| `block_args` | Yes | Non-empty array of non-empty strings |\n| `reason` | Yes | Non-empty string, max 256 chars |\n\n### Rule Fields (`rulebook_version` 2)\n\nVersion 2 replaces `subcommand` and `block_args` with an exact-token `match` object. Version 1 rulebooks keep their fields and their behavior; a client that does not support version 2 rejects the rulebook instead of applying broader version 1 semantics.\n\n```json\n{\n  \"name\": \"block-terraform-apply-destroy\",\n  \"command\": \"terraform\",\n  \"match\": {\n    \"command_path\": [\"apply\"],\n    \"any_args\": [\"-destroy\", \"--destroy\"]\n  },\n  \"reason\": \"Review a destroy plan first with 'terraform plan -destroy'.\",\n  \"intent\": \"use_alternative\"\n}\n```\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `name` | Yes | Same as version 1 |\n| `command` | Yes | Same as version 1 |\n| `match.command_path` | Yes | Non-empty array of non-empty command words |\n| `match.any_args` | No | Non-empty array of unique non-empty argument tokens |\n| `match.exclude_args` | No | Non-empty array of unique non-empty argument tokens |\n| `intent` | No | Same as version 1 |\n| `reason` | Yes | Same as version 1 |\n\n### Matching Behavior (`rulebook_version` 2)\n\n- **Command**: Normalized to lowercase basename, as in version 1.\n- **Command path**: After recognized global options and their values are skipped, the next command words must equal `command_path` exactly. AWS, gcloud, and Azure CLI value-taking global options are built in; Terraform's `-chdir=dir` is `=`-joined and is skipped with its own token.\n- **Unrecognized options**: A token starting with `-` that is not a recognized global option is skipped without consuming a value, so an unlisted value-taking option with a separate value (`--newflag value`) makes the rule miss. This fails open deliberately; document such gaps in the rulebook.\n- **`any_args`**: At least one listed token must appear literally among the arguments.\n- **`exclude_args`**: Any listed token appearing literally among the arguments prevents the match, which is how a safe preview such as `aws s3 rm --dryrun` stays allowed.\n- **No short-option expansion**: Arguments compare as exact tokens, so list every accepted spelling (`\"-destroy\"` and `\"--destroy\"`).\n- **Literal and case-sensitive**: No regex, glob, or substring matching. The first matching rule wins.\n- Release channels are separate rules: `gcloud beta compute instances delete` needs its own `command_path`.\n\n### Test Fixture Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `command` | Yes | Non-empty shell command string |\n| `expect` | Yes | `\"blocked\"` or `\"allowed\"` |\n| `rule` | Required for blocked fixtures | Rule name expected to block the command |\n\nFixtures are optional documentation of intended behavior. Version 1 fixtures are shape-validated only. Version 2 fixtures are evaluated against the rulebook's own rules during `rule sync` and `rule verify`; a failing fixture rejects that source before its lock entry is written. CC Safety Net never executes fixture commands; they are analyzer inputs only.\n\n## Matching Behavior\n\nThe subcommand, argument, and option rules below describe `rulebook_version` 1 rules; version 2 rules match as described in Matching Behavior (`rulebook_version` 2). Execution order and transparent wrappers apply to both.\n\n- **Command**: Normalized to lowercase basename with any trailing `.exe` removed (`/usr/bin/git` → `git`).\n- **Subcommand**: The first command token after recognized Git and Docker global options and their values; `--` ends option parsing. An unrecognized option without `=` may consume the following token as its value.\n- **Arguments**: Each `block_args` value is compared literally against every command token, including expanded short options. The command is blocked if **any** item matches.\n- **Short options**: Expanded (`-Ap` matches `-A`).\n- **Long options**: Exact match (`--all-files` does not match `--all`).\n- **Execution order**: Built-in rules first, then custom rulebooks. Custom rules only add restrictions.\n- **Transparent wrappers**: A configured wrapper such as `rtk` lets `rtk git commit` be analyzed as `git commit` only when `git` is protected by built-in analyzers or active custom rules. `rtk -- git commit` is also supported.\n\n## Workflow\n\n1. Run `cc-safety-net rule init` or create `rule.json` manually.\n2. Optionally run `cc-safety-net rule init --example` to create an inactive example rulebook.\n3. Use `cc-safety-net rule wrapper add rtk` for trusted transparent wrappers.\n4. Run `cc-safety-net rule add <source>` after creating or choosing a rulebook source; add `--only <rulebook...>` or `--ref <ref>` for repository selection. The command adds the selected sources and syncs them.\n5. Run `cc-safety-net rule sync` after manual `rule.json` changes or local rulebook edits.\n6. Run `cc-safety-net rule update [source]` to re-resolve remote branch or tag refs to their latest commit; `cc-safety-net rule sync` keeps reusing the locked commit. A source with an ordinary update failure keeps its last good lock entry and cache while the other selected sources still update. Resource-limit failures remain fatal for the whole update.\n7. Run `cc-safety-net rule verify` to validate config, lock/cache state, local rulebooks, and shareable GitHub-source rulebook directories in the current repository (it does not fetch remote content).\n8. Run `cc-safety-net rule list` to inspect active rulebooks and transparent wrappers.\n\nAn edited or invalid local rulebook keeps its last synced, digest-verified cached version enforced until `cc-safety-net rule sync` validates the edit. A missing lock entry or cache, a cache digest mismatch, or an invalid cached rulebook makes that source inactive; a missing lockfile or an unreadable or invalid `rule.json` makes every source in its scope inactive. Inactive sources stop applying their rules while other custom rules and all built-in protections stay active. Repair the reported condition, then run `cc-safety-net rule sync`. Run `cc-safety-net status` to see degraded sources.\n";function zt(e,t){if(!e.ok){Nc(e);return}Fc(e),Oc(e,t)}function _c(e,t){if(!e.add){zt(e,`Added rulebook source: ${t}`);return}if(!e.ok){Nc(e);return}if(Fc(e),e.add.added.length>0){console.log(`Added ${e.add.added.length} ${e.add.added.length===1?"rulebook":"rulebooks"} from ${e.add.source} at ${e.add.ref}:`);for(let n of e.add.added)console.log(`  - ${n}`)}if(e.add.alreadyConfigured.length>0)console.log(`Rulebooks already configured from ${e.add.source} at ${e.add.ref}: ${e.add.alreadyConfigured.join(", ")}`);if(e.add.commits.length===1)console.log(`Locked at ${e.add.commits[0]?.slice(0,7)}.`);else if(e.add.commits.length>1)console.log(`Locked at ${e.add.commits.map((n)=>n.slice(0,7)).join(", ")}.`);Oc(e,"Rule config synced.")}function Oc(e,t){console.log(t),console.log(""),Sg(e.entries)}function Sg(e){if(e.length===0){console.log("Active rulebooks: (none)");return}console.log(`Active rulebooks (${e.length}):`);for(let t of e)console.log(`  - ${t.name} ${t.version} (${Rg(t.ruleCount??0)})`),console.log(`    Source: ${fr(t)}`)}function Rg(e){return`${e} ${e===1?"rule":"rules"}`}function $c(e,t){qe("Active sources",e.rulebooks,(n)=>[`[${n.source}] ${n.name} ${n.version}`,`  Source: ${t[n.source].get(n.spec)??n.spec}`]),qe("Active rules",e.rules,(n)=>[`[${Dg(e,n.name)}] ${n.name}`,`  Command: ${n.subcommand?`${n.command} ${n.subcommand}`:n.command}`,`  Block args: ${n.block_args.join(", ")}`,`  Reason: ${n.reason}`]),qe("Disabled rules",Ic(e,"off"),(n)=>[n.key]),qe("Reason overrides",Ic(e,"reason"),(n)=>[n.key,`  Reason: ${n.value.reason}`]),qe("Transparent wrappers",e.transparent_wrappers,(n)=>[n]),qe("Issues",e.errors,(n)=>[n]),qe("Warnings",e.warnings,(n)=>[n])}function qe(e,t,n){if(t.length===0){console.log(`${e}: (none)`);return}console.log(`${e} (${t.length}):`);for(let r of t){let[o,...i]=n(r);console.log(`  - ${o}`);for(let s of i)console.log(`    ${s}`)}}function Dg(e,t){return e.rulebooks.find((n)=>n.rules.includes(t))?.source??"project"}function Ic(e,t){return Object.entries({...e.userConfig?.overrides??{},...e.projectConfig?.overrides??{}}).filter((n)=>{if(t==="off")return n[1]==="off";return!!n[1]&&typeof n[1]==="object"}).map(([n,r])=>({key:n,value:r}))}function Nc(e){for(let t of e.errors)console.error(t)}function Fc(e){if(!e.warnings||e.warnings.length===0)return;for(let t of e.warnings)console.warn(t)}import{dirname as Hc,join as Gn}from"node:path";var Ag=".safety-net.json",Eg="~/.cc-safety-net/config.json";async function Uc(e){return[await Mc({legacyPath:jc({cwd:e.cwd}),configPath:Q(e.cwd),defaultRulebookName:"project-rules",migratedFrom:Ag,cleanup:e.cleanup,syncOptions:{cwd:e.cwd}}),await Mc({legacyPath:vt(),configPath:ee(),defaultRulebookName:"user-rules",migratedFrom:Eg,cleanup:e.cleanup,syncOptions:{cwd:e.cwd,global:!0}})].every((n)=>n)?0:1}async function Mc(e){let t=Y(e.syncOptions),n=C(t.filesystemScope,e.legacyPath),r=x(n);if(r===null)return console.log(`No legacy config found at ${e.legacyPath}`),!0;let o=Tg(r);if(!o.ok){for(let g of o.errors)console.error(g);return!1}let i=Z(t.configTarget);if(i.errors.length>0){for(let g of i.errors)console.error(g);return!1}let s=i.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},a=Ig(Hc(e.configPath),s.rules,e.defaultRulebookName,e.migratedFrom,t.filesystemScope),l=Gn(Hc(e.configPath),a,"rulebook.json"),c=C(t.filesystemScope,l),u=[$o(t.configTarget),$o(c),$o(t.lockTarget)],p=await Pg(e,t.configTarget,c,a,o.config.rules,s.rules.includes(a)?s.rules:[...s.rules,a],s.overrides??{},s.transparent_wrappers??[]);if(!p.ok){$g(u);for(let g of p.errors)console.error(g);return!1}if(!e.cleanup)return console.log(`Migrated legacy config at ${e.legacyPath}. Legacy file is no longer used.`),!0;if(!Og(t.configTarget,c,a,e.migratedFrom,o.config.rules))return console.error(`Migration cleanup verification failed for ${e.legacyPath}`),!1;return Ye(n),console.log(`Deleted legacy config at ${e.legacyPath}`),!0}async function Pg(e,t,n,r,o,i,s,a){try{return X(t,{version:1,rules:i,overrides:s,transparent_wrappers:a}),X(n,_g(r,e.migratedFrom,o)),await Ze(e.syncOptions)}catch(l){return{ok:!1,errors:[l instanceof Error?l.message:String(l)]}}}function Tg(e){try{let t=JSON.parse(e),n=tr(t);if(n.errors.length>0)return{ok:!1,errors:n.errors};return{ok:!0,config:{version:1,rules:t.rules??[]}}}catch{return{ok:!1,errors:["Invalid JSON"]}}}function Ig(e,t,n,r,o){let i=t.find((s)=>Ng(C(o,Gn(e,s,"rulebook.json")))===r);if(i)return i;if(x(C(o,Gn(e,n,"rulebook.json")))===null)return n;for(let s=2;;s++){let a=`${n}-${s}`;if(x(C(o,Gn(e,a,"rulebook.json")))===null)return a}}function _g(e,t,n){return{rulebook_version:1,name:e,version:"1.0.0",description:"Migrated CC Safety Net rules.",author:"project",migrated_from:t,allowed_commands:[...new Set(n.map((r)=>r.command))],rules:n,tests:n.map((r)=>({command:[r.command,r.subcommand,r.block_args[0]].filter(Boolean).join(" "),expect:"blocked",rule:r.name}))}}function Og(e,t,n,r,o){if(!Z(e).config?.rules.includes(n))return!1;try{let s=x(t);if(s===null)return!1;let a=JSON.parse(s);return a.migrated_from===r&&JSON.stringify(a.rules)===JSON.stringify(o)}catch{return!1}}function $o(e){return{target:e,content:x(e)}}function $g(e){for(let t of e){if(t.content===null){Ye(t.target);continue}Re(t.target,t.content)}}function Ng(e){let t=x(e);if(t===null)return null;try{let n=JSON.parse(t);return typeof n.migrated_from==="string"?n.migrated_from:null}catch{return null}}import{mkdir as Fg,readFile as Hg,writeFile as Mg}from"node:fs/promises";import{dirname as jg,join as Ug}from"node:path";var Gg=86400000,Bg=604800000;async function Bc(e=Date.now()){if(process.env.CC_SAFETY_NET_NO_UPDATE_CHECK)return null;let t=hr();if(!t)return null;let n=Ug(t,".cc-safety-net","update-check.json"),r=await qg(n,e);if(!r.lastCheck||e-r.lastCheck>Gg){let s=await we();if(r.lastCheck=e,s.latestVersion)r.latestVersion=s.latestVersion;if(!await Gc(n,r))return null;if(s.error)return null}let o=r.latestVersion,i=T();if(!o||!Fr(o,i))return null;if(r.notifiedVersion===o&&r.notifiedAt!==void 0&&e-r.notifiedAt<Bg)return null;if(r.notifiedVersion=o,r.notifiedAt=e,!await Gc(n,r))return null;return`UPDATE_AVAILABLE: cc-safety-net v${o} is available (running v${i}). Ask the user once whether to run \`npx -y cc-safety-net@latest update\`; continue the current task either way and do not raise this again.`}async function qg(e,t){let n=await Hg(e,"utf8").then((i)=>JSON.parse(i)).catch(()=>{return});if(!n||typeof n!=="object"||Array.isArray(n))return{};let r=n,o=(i)=>typeof i==="number"&&Number.isFinite(i)&&i<=t?i:void 0;return{lastCheck:o(r.lastCheck),latestVersion:typeof r.latestVersion==="string"?r.latestVersion:void 0,notifiedVersion:typeof r.notifiedVersion==="string"?r.notifiedVersion:void 0,notifiedAt:o(r.notifiedAt)}}async function Gc(e,t){return Fg(jg(e),{recursive:!0,mode:448}).then(()=>Mg(e,JSON.stringify(t),{mode:384})).then(()=>!0).catch(()=>!1)}import{dirname as Vg,join as zg,resolve as No}from"node:path";var zc="CC Safety Net Config",Kg="═".repeat(zc.length),Wg="https://raw.githubusercontent.com/kenryu42/cc-safety-net/main/assets/cc-safety-net.schema.json",Jg=new Set(["rule.json","rule.lock","cache"]);function Kc(e={}){try{return Yg(e)}catch(t){if(t instanceof M)return console.error(t.message),1;throw t}}function Yg(e){let t=e.cwd??process.cwd(),n=e.userConfigPath??ee(),r=e.projectConfigPath??Q(t),o=e.legacyUserConfigPath??vt(),i=e.legacyProjectConfigPath??ii(t),s=No(t,pr),a=Vg(n),l=te({cwd:t,userConfigPath:n,projectConfigPath:r}),c=te({cwd:t}),u=C(l.userScope,n),p=C(l.projectScope,r),g=e.legacyUserConfigPath?yt(e.legacyUserConfigPath,"user policy"):C(c.userScope,o),d=e.legacyProjectConfigPath?yt(e.legacyProjectConfigPath,"project policy"):C(c.projectScope,i),h=!1,m=!1,b=[],L=[],w=Zg(C(c.projectScope,s));if(Qg(),x(u)!==null){let f=ce(u);if(f.errors.push(...de(n,Xe({userConfigDir:a}),{userConfigDir:a},l.userScope)),b.push({scope:"User",path:n,result:f,schema:"rules",sourceDisplayMap:Ae(n,l.userScope),target:u}),f.errors.length>0)h=!0}if(x(g)!==null)if(m=!0,x(u)!==null)L.push(Bn("user","cleanup"));else{let f=nr(g);if(b.push({scope:"User",path:o,result:f,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:g}),L.push(Bn("user",f.errors.length>0?"fix-or-delete":"migrate")),f.errors.length>0)h=!0}if(x(p)!==null){let f=ce(p);if(f.errors.push(...de(r,Qe(r),{userConfigDir:a},l.projectScope)),b.push({scope:"Project",path:No(r),result:f,schema:"rules",sourceDisplayMap:Ae(r,l.projectScope),target:p}),f.errors.length>0)h=!0;if(x(d)!==null)m=!0,L.push(Bn("project","cleanup"))}else if(x(d)!==null){m=!0,h=!0;let f=nr(d);b.push({scope:"Project",path:No(i),result:f,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:d}),L.push(Bn("project",f.errors.length>0?"fix-or-delete":"migrate"))}if(w?.result.errors.length)h=!0;if(b.length===0&&!w)return console.log(`
No config files found. Using built-in rules only.`),0;for(let f of b)if(f.inactive)t1(f.scope,f.path,f.result,f.sourceDisplayMap);else if(f.result.errors.length>0)n1(f.scope,f.path,f.result.errors);else{if(f.schema==="rules"&&i1(f.target))console.log(`
Added $schema to ${f.scope.toLowerCase()} config.`);e1(f.scope,f.path,f.result,f.schema,f.sourceDisplayMap)}for(let f of L)console.error(`
${y.red(f)}`);if(w)if(w.result.errors.length>0)o1(w.path,w.result.errors);else r1(w.path,w.result);if(h)return console.error(`
Config validation failed.`),1;return console.log(m?`
Configs valid with warnings.`:`
All configs valid.`),0}function Bn(e,t){let n=`legacy ${e} config`;if(t==="cleanup")return`Warning: Legacy ${e} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${e} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${e} config is no longer supported. Fix or delete the ${n}, then run \`npx -y cc-safety-net rule migrate\`.`}function Zg(e){if(De(e)===null)return null;let t=Xg(e);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:e.path,result:t}}function Xg(e){let t=[],n=new Set,r=(De(e)??[]).filter((o)=>!Jg.has(o.name)).sort((o,i)=>o.name.localeCompare(i.name));if(r.length===0)return{errors:t,ruleNames:n};for(let o of r){if(!ve.test(o.name)){t.push(`rulebook directory names must match ${ve}: ${o.name}`);continue}if(o.kind!=="directory"){t.push(`${o.name} must be a rulebook directory`);continue}let i=C(e.scope,zg(e.path,o.name,"rulebook.json")),s=x(i);if(s===null){t.push(`${o.name}/rulebook.json is required`);continue}try{let a;try{a=JSON.parse(s)}catch{t.push(`${o.name}/rulebook.json: invalid JSON`);continue}let l=qc(a);if(l.name!==o.name){t.push(`rulebook name "${l.name}" must match folder "${o.name}"`);continue}let c=Vc(l);if(c.length>0){t.push(...c.map((u)=>`${o.name}/rulebook.json: ${u}`));continue}n.add(o.name)}catch(a){t.push(a instanceof Error?`${o.name}/rulebook.json: ${a.message}`:`${o.name}/rulebook.json: ${String(a)}`)}}return{errors:t,ruleNames:n}}function Qg(){console.log(zc),console.log(Kg)}function e1(e,t,n,r,o){if(console.log(`
✓ ${e} config: ${t}`),console.log(`  Schema: ${r==="rules"?"rulebook sources":"legacy inline rules"}`),n.ruleNames.size>0){console.log(`  ${r==="rules"?"Sources":"Rules"}:`);let i=1;for(let s of n.ruleNames)console.log(`    ${i}. ${o.get(s)??s}`),i++}else console.log(`  ${r==="rules"?"Sources":"Rules"}: (none)`)}function t1(e,t,n,r){if(console.error(`
✗ Legacy ${e.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),n.errors.length>0){console.error("  Errors:");let o=1;for(let i of n.errors)for(let s of i.split("; "))console.error(`    ${o}. ${s}`),o++;return}if(n.ruleNames.size>0){console.error("  Rules:");let o=1;for(let i of n.ruleNames)console.error(`    ${o}. ${r.get(i)??i}`),o++;return}console.error("  Rules: (none)")}function n1(e,t,n){Wc(`${e} config`,t,n)}function r1(e,t){console.log(`
✓ GitHub source rules: ${e}`),console.log("  Rulebooks:");let n=1;for(let r of t.ruleNames)console.log(`    ${n}. ${r}`),n++}function o1(e,t){Wc("GitHub source rules",e,t)}function Wc(e,t,n){console.error(`
✗ ${e}: ${t}`),console.error("  Errors:");let r=1;for(let o of n)for(let i of o.split("; "))console.error(`    ${r}. ${i}`),r++}function i1(e){try{let t=x(e);if(t===null)return!1;let n=JSON.parse(t);if(n.$schema)return!1;return Re(e,JSON.stringify({$schema:Wg,...n},null,2)),!0}catch(t){if(t instanceof M)throw t;return!1}}var Jc=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),a1=new Set(["add","remove","list"]);async function Xc(e){try{return await l1(e)}catch(t){if(t instanceof M)return console.error(t.message),1;throw t}}async function l1(e){let t=d1(e),n=t.help?c1(t.positionals):null;if(n)return In(n),0;if(t.errors.length>0){for(let s of t.errors)console.error(s);return 1}let r=t.positionals[0];if(!r)return In(ot,console.error),1;let o=t.positionals[1],i={global:t.global,check:t.check};if(r==="init"){let s=Y(i),a=s.configDir;m1(s.configTarget),Yc(C(s.filesystemScope,Yt({...i,cacheConfigDir:a})));let l=s1(a,"example-rules","rulebook.json"),c=C(s.filesystemScope,l);if(t.example&&x(c)===null)gr(c,"example-rules");let u=await Ze(i);return zt(u,"Rule config initialized."),u.ok?0:1}if(r==="add"){if(!o)return console.error("rule add requires a source"),1;let s=await cr(o,{...i,ref:t.ref,rulebooks:t.only.length>0?t.only:void 0});return _c(s,o),s.ok?0:1}if(r==="remove"){if(!o)return console.error("rule remove requires a source"),1;let s=await ur(o,{...i,deleteSource:t.deleteSource});return zt(s,`Removed rulebook source: ${o}`),s.ok?0:1}if(r==="update"||r==="sync"){let s=await Ze({...i,only:r==="update"?o:void 0,refresh:r==="update"});return zt(s,t.check?"Rule config checked.":"Rule config synced."),s.ok?0:1}if(r==="list"){let s=be(),a=te({});return $c(s,{user:Ae(s.userConfigPath,a.userScope),project:Ae(s.projectConfigPath,a.projectScope)}),s.errors.length>0?1:0}if(r==="wrapper")return g1(t);if(r==="migrate")return Uc({cleanup:t.cleanup,cwd:process.cwd()});if(r==="doc"){console.log(Tc);let s=await Bc();if(s)console.error(s);return 0}if(r==="verify")return Kc();return 1}function c1(e){if(e.length===0)return ot;let t=ot.subcommands.filter((r)=>r.usage.split(" ")[0]===e[0]);if(t.length===0)return null;if(e.length===1&&t.length>1)return{name:`rule ${e[0]}`,description:`Subcommands of rule ${e[0]}`,usage:`rule ${e[0]} <subcommand>`,subcommands:t,options:[]};let n=e.length===1?t[0]:t.find((r)=>r.usage.split(" ")[1]===e[1]);if(!n)return null;return{name:`rule ${e[0]}`,description:n.description,usage:`rule ${n.usage}`,options:e[0]==="add"?Tr:[],examples:e[0]==="add"?Ir:void 0}}function d1(e){let t=_({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},values:{ref:["--ref"]},lists:{only:["--only"]},positionals:"list"},e),n={...t.flags,ref:t.values.ref,only:t.lists.only??[],help:t.help,positionals:t.positionals,errors:t.errors};return u1(n),n}function u1(e){let[t]=e.positionals;if(t&&!Jc.has(t))e.errors.push(`Unknown rule subcommand: ${t}`);if(e.deleteSource&&t!=="remove")if(t&&Jc.has(t))e.errors.push(`Unknown option for rule ${t}: --delete-source`);else e.errors.push("--delete-source is only valid with 'rule remove'");if(e.cleanup&&t!=="migrate")e.errors.push(ht(t,"--cleanup"));if(e.example&&t!=="init")e.errors.push(ht(t,"--example"));if(e.ref&&t!=="add")e.errors.push(ht(t,"--ref"));if(e.only.length>0&&t!=="add")e.errors.push(ht(t,"--only"));if(t==="add")p1(e);if(t==="migrate"){if(e.global)e.errors.push(ht(t,"--global"));if(e.check)e.errors.push(ht(t,"--check"));if(e.positionals.length>1)e.errors.push(`Unexpected rule migrate argument: ${e.positionals[1]}`)}else if(t==="wrapper")f1(e);else if(e.positionals.length>2)e.errors.push(`Unexpected rule argument: ${e.positionals[2]}`);if(t==="list"&&e.global)e.errors.push("Unknown option for rule list: --global")}function p1(e){let t=e.positionals[1];if(!t&&e.only.length>0){e.errors.push("rule add requires owner/repo before --only");return}if(!t)return;if((e.ref||e.only.length>0)&&!Jt(t)){if(e.ref)e.errors.push(`--ref can only select a ref for an owner/repo source: ${t}`);if(e.only.length>0)e.errors.push("--only can only select rulebooks from an owner/repo source");return}if(e.ref&&!Zc(e.ref))e.errors.push(`--ref must use valid path segments: ${e.ref}`);let n=e.only.filter((r)=>!ve.test(r));if(n.length>0)e.errors.push(`Invalid rulebook names: ${n.join(", ")}`)}function ht(e,t){return e?`Unknown option for rule ${e}: ${t}`:`Unknown option for rule: ${t}`}function f1(e){let t=e.positionals[1],n=e.positionals[2];if(!t){e.errors.push("rule wrapper requires add, remove, or list");return}if(!a1.has(t)){e.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(n)e.errors.push(`Unexpected rule wrapper argument: ${n}`);return}if(!n){e.errors.push(`rule wrapper ${t} requires a command`);return}if(e.positionals.length>3)e.errors.push(`Unexpected rule wrapper argument: ${e.positionals[3]}`)}function m1(e){if(x(e)===null){mr(e);return}let t=Z(e);if(!t.config)return;X(e,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function g1(e){let t=e.positionals[1],n=e.positionals[2],r=Y({global:e.global}).configTarget;if(t==="list"){let a=Z(r);if(a.errors.length>0){for(let l of a.errors)console.error(l);return 1}return h1(a.config?.transparent_wrappers??[]),0}if(!n||!yr.test(n))return console.error("transparent wrapper must match command pattern"),1;if(vr(n))return console.error(`reserved command "${n}" cannot be a wrapper`),1;let o=Z(r);if(o.errors.length>0){for(let a of o.errors)console.error(a);return 1}let i=o.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},s=t==="add"?[...new Set([...i.transparent_wrappers??[],n])]:(i.transparent_wrappers??[]).filter((a)=>a!==n);return X(r,{version:1,rules:i.rules,overrides:i.overrides??{},transparent_wrappers:s}),console.log(t==="add"?`Added transparent wrapper: ${n}`:`Removed transparent wrapper: ${n}`),0}function h1(e){if(e.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${e.length}):`);for(let t of e)console.log(`  - ${t}`)}import{homedir as Qc}from"node:os";import{existsSync as y1,readFileSync as L1}from"node:fs";import{homedir as v1}from"node:os";import{join as b1}from"node:path";async function w1(e){if(e.isTTY)return null;return(await Rr(e).catch(()=>null))?.trim()||null}function k1(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return b1(v1(),".claude","settings.json")}function Fo(){let e=k1();if(!y1(e))return!1;try{let t=L1(e,"utf-8"),n=JSON.parse(t);if(!n.enabledPlugins)return!1;let r="cc-safety-net@cc-marketplace";if(!(r in n.enabledPlugins))return!1;return n.enabledPlugins[r]===!0}catch(t){if(kt(S.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${e}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function Ho(e=process.stdin){let t=Fo(),n;if(!t)n="\uD83D\uDEE1️ CC Safety Net ❌";else{let o=B({cwd:process.cwd()}),i=o.policy,s=ue(i),a=Object.values(Te(i,s.capabilities)).some((c)=>c.changesInherited);n=`\uD83D\uDEE1️ CC Safety Net ${{standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[a?"custom":s.effectiveLevel]}${s.worktreeMode?"\uD83C\uDF33":""}${o.state==="degraded"?"⚠️":""}`}let r=await w1(e);if(r&&!r.startsWith("{"))console.log(`${r} | ${n}`);else console.log(n)}function ed(){let e=B({cwd:process.cwd()}),t=e.policy,n=ue(t),r=!!process.env.NO_COLOR||!process.stdout.isTTY,o=Math.min(process.stdout.columns||80,100),i=r?"ok":"✔",s=r?"OFF":"✘",a=(d,h)=>{let m=`  ${d.padEnd(13)}${h}`;return(m.length>o?`${m.slice(0,o-1)}…`:m).replaceAll(s,y.red(s))},l=Object.values(Te(t,n.capabilities)).some((d)=>d.changesInherited),c=xt(),u={ready:y.green,degraded:y.yellow}[e.state],p=[...Fo()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...e.diagnostics],g=r?"-":"·";console.log([`${r?"":"\uD83D\uDEE1️  "}CC Safety Net — ${u(e.state)}`,"",a("Protection",`destructive ${t.destructiveCommandProtectionEnabled?i:s}   secrets ${t.secretProtection.enabled?i:s}`),a("Level",l?`${n.effectiveLevel} (customised)`:n.effectiveLevel),a("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),a("Policy",c.startsWith(Qc())?`~${c.slice(Qc().length)}`:c),...n.worktreeMode?[a("Worktree","relaxations active")]:[],"",...p.length===0?["  Everything configured is active."]:["  Not active",...p.flatMap((d)=>Tn(d,"      ",o-6).map((h,m)=>m===0?`    ${g} ${h}`:h)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as vd}from"node:child_process";import{randomBytes as _1}from"node:crypto";import{createServer as O1}from"node:http";import{Writable as $1}from"node:stream";import{homedir as x1}from"node:os";var qn=500;function C1(e){let t=e.filter((o)=>o.decision!=="allow"),n=e.filter((o)=>o.decision==="allow"),r=Math.min(t.length,Math.max(qn-n.length,Math.ceil(qn/2)));return[...t.slice(0,r),...n.slice(0,qn-r)]}function td(e,t=pe()){if(t)Ee(t);let n=(m)=>new Date(m.getFullYear(),m.getMonth(),m.getDate()).getTime(),r=n(new Date),o=new Date(r);o.setDate(o.getDate()-(e-1));let i=o.getTime(),s=[],a={count:0};for(let m of t?Le(t,a):[])for(let b of Se(m,a)){if(!b||typeof b.ts!=="string"||typeof b.command!=="string")continue;let L=new Date(b.ts).getTime();if(!Number.isFinite(L))continue;if(L>=i)s.push(b)}s.sort((m,b)=>new Date(b.ts).getTime()-new Date(m.ts).getTime());let l=Array.from({length:e},()=>0),c=Array.from({length:e},()=>0),u={},p={},g={},d=0,h=0;for(let m of s){let b=m.agent||"unknown";u[b]=(u[b]??0)+1;let L=Math.round((r-n(new Date(m.ts)))/86400000),w=e-1-L,f=L>=0&&L<e;if(f)c[w]=(c[w]??0)+1;if(m.decision!=="allow"){if(d++,m.ruleId)p[m.ruleId]=(p[m.ruleId]??0)+1;let v=Ve(m.segment||m.command);if(v)g[v]=(g[v]??0)+1;if(m.failureStage)h++;if(f)l[w]=(l[w]??0)+1}}return{days:e,logsDir:t,homeDir:x1(),totalInWindow:s.length,truncated:s.length>qn,unreadable:a.count,counts:{blocked:d,allowed:s.length-d,agents:u,blockedByDay:l,analyzedByDay:c,rules:p,commands:g,errors:h},entries:C1(s).sort((m,b)=>new Date(b.ts).getTime()-new Date(m.ts).getTime())}}import{spawn as S1}from"node:child_process";import{existsSync as R1,statSync as nd}from"node:fs";import{delimiter as D1,join as A1}from"node:path";var E1=120000,Vn="Choose the project folder",P1=`try
  return POSIX path of (choose folder with prompt "${Vn}")
on error number -128
  return ""
end try`,T1=`Add-Type -AssemblyName System.Windows.Forms
$dialog = New-Object System.Windows.Forms.FolderBrowserDialog
$dialog.Description = '${Vn}'
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,rd=[{binary:"zenity",args:["--file-selection","--directory",`--title=${Vn}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",Vn]}],od=(e,t)=>(t.PATH??"").split(D1).some((n)=>{if(n.length===0)return!1;try{let r=nd(A1(n,e));return r.isFile()&&(r.mode&73)!==0}catch{return!1}});function id(e,t){if(e==="darwin"||e==="win32")return!0;if(e!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return rd.some((n)=>od(n.binary,t))}function I1(e,t){if(e==="darwin")return{cmd:"osascript",args:["-e",P1]};if(e==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",T1]};let n=rd.find((r)=>od(r.binary,t));return n?{cmd:n.binary,args:n.args}:null}function sd(e=process.platform,t=process.env){let n=I1(e,t);if(!n)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let o=S1(n.cmd,n.args,{env:t,stdio:["ignore","pipe","pipe"]}),i="",s=!1,a=(c)=>{if(s)return;s=!0,clearTimeout(l),r(c)},l=setTimeout(()=>{o.kill(),a({error:"The folder dialog timed out"})},E1);o.stdout.on("data",(c)=>{i+=c.toString()}),o.on("error",()=>a({error:`Could not open the folder dialog (${n.cmd})`})),o.on("close",()=>{let c=i.trim().replace(/\/+$/,"");if(!c)return a({cancelled:!0});if(!R1(c)||!nd(c).isDirectory())return a({error:"That selection is not a folder on disk"});a({path:c})})})}var ad=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var ld='<script id="ccsn-data" type="application/json">';function cd(e){return ad.replace(ld,()=>ld+JSON.stringify({token:e}).replaceAll("<","\\u003c"))}var Kn="kenryu42/cc-safety-net",N1=`https://github.com/${Kn}`,Uo=1e4,F1=7;async function bd(e,t={}){let n=_({label:"gui",booleans:{noOpen:["--no-open"]}},e),r=t.log??console.log,o=t.error??console.error;if(n.errors.length>0){for(let s of n.errors)o(s);return o("Usage: cc-safety-net gui [--no-open]"),1}let i=await H1(t);if(r(`CC Safety Net policy GUI: ${i.url}`),!n.flags.noOpen)try{await(t.openBrowser??K1)(i.url)}catch(s){o(`Failed to open browser: ${s instanceof Error?s.message:String(s)}`),o(`Open this URL manually: ${i.url}`)}if(t.keepAlive===!1)return await i.close(),0;return await z1(i),0}async function H1(e={}){let t=_1(24).toString("base64url"),n=O1((i,s)=>{M1(i,s,t,e)});await new Promise((i,s)=>{n.once("error",s),n.listen(0,"127.0.0.1",()=>{n.off("error",s),i()})});let o=`http://127.0.0.1:${n.address().port}`;return{origin:o,token:t,url:`${o}/?token=${encodeURIComponent(t)}`,close:()=>V1(n)}}async function M1(e,t,n,r){let o=new URL(e.url??"/","http://127.0.0.1");if(e.method==="GET"&&o.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!G1(e,o,n)){R(t,403,{error:"Forbidden"});return}if(e.method==="GET"&&o.pathname==="/"){q1(t,cd(n));return}if(e.method==="GET"&&o.pathname==="/api/policy"){let i=fd(r);R(t,200,{...i,configState:Ct(B(r)),destructiveCommandRules:bt,secretPatterns:ud,version:T(),preview:i.errors.length>0?null:gd(i.policy)});return}if(e.method==="POST"&&o.pathname==="/api/policy/preview"){let i=await zn(e);if(!i.ok){R(t,i.status,{errors:[i.error]});return}let s=md(i.value);R(t,s.errors.length>0?400:200,s);return}if(e.method==="POST"&&o.pathname==="/api/policy/explain"){let i=await zn(e);if(!i.ok){R(t,i.status,{errors:[i.error]});return}let s=i.value;if(s===null||typeof s.command!=="string"){R(t,400,{errors:["command must be a string"]});return}let a=xr(s.policy);if(a.length>0){R(t,400,{errors:a});return}R(t,200,j1(s.command,s.policy,r));return}if(e.method==="POST"&&o.pathname==="/api/policy"){let i=await zn(e);if(!i.ok){R(t,i.status,{errors:[i.error]});return}let s=Mo(i.value,r);R(t,s.errors.length>0?400:200,s);return}if(e.method==="POST"&&o.pathname==="/api/reset"){R(t,200,Mo(pd,r));return}if(e.method==="POST"&&o.pathname==="/api/repair"){R(t,200,hd(r));return}if(e.method==="GET"&&o.pathname==="/api/activity"){let i=nt(r),s=U1(o.searchParams.get("days"),i);if(s===null){R(t,400,{error:`days must be an integer between 1 and ${i}`});return}R(t,200,td(s,r.activityLogsDir));return}if(e.method==="POST"&&o.pathname==="/api/rules/choose-directory"){R(t,200,await sd());return}if(e.method==="GET"&&o.pathname==="/api/rules"){let i=be(r),s=new Map(i.rules.map((a)=>[a.name,a]));R(t,200,{projectPath:r.cwd??process.cwd(),canPickDirectory:id(process.platform,process.env),rulebooks:i.rulebooks.map((a)=>({source:a.source,spec:a.spec,name:a.name,version:a.version,rules:a.rules.flatMap((l)=>{let c=s.get(l);if(!c)return[];return[{name:c.name,command:c.command,subcommand:c.subcommand,block_args:c.block_args,reason:c.reason}]})})),errors:i.errors,warnings:i.warnings});return}if(e.method==="GET"&&o.pathname==="/api/star/context"){R(t,200,await(r.fetchStarContext??(()=>X1({logsDir:r.activityLogsDir})))());return}if(e.method==="POST"&&o.pathname==="/api/star"){let i=await(r.starRepo??W1)();R(t,200,i.ok?{ok:!0}:{ok:!1,fallbackUrl:N1});return}if(e.method==="GET"&&o.pathname==="/api/integrations"){R(t,200,await(r.fetchIntegrations??J1)());return}if(e.method==="GET"&&o.pathname==="/api/health"){R(t,200,await(r.fetchHealth??Y1)());return}if(e.method==="POST"&&(o.pathname==="/api/install"||o.pathname==="/api/uninstall")){let i=await zn(e);if(!i.ok){R(t,i.status,{errors:[i.error]});return}let s=i.value?.target;if(typeof s!=="string"||!ae.some((l)=>l.target===s)){R(t,400,{error:"unknown target"});return}let a=o.pathname==="/api/install"?"install":"uninstall";R(t,200,await(r.runIntegration??Z1)(a,s));return}R(t,404,{error:"Not found"})}function j1(e,t,n){let r=On(t),o=B(n),i=wt({rules:o.policy.rules,transparentWrappers:o.policy.transparentWrappers,safety:Ld(r.safety),worktreeMode:r.workflow.worktree_mode,destructiveCommandProtectionEnabled:r.destructive_command_protection.enabled,destructiveCommandRuleOverrides:r.destructive_command_protection.overrides,destructiveCommandAllowPaths:r.destructive_command_protection.allow_paths,secretProtection:{enabled:r.secret_protection.enabled,disabledRules:yd(r.secret_protection.overrides),denyPaths:r.secret_protection.deny_paths,allowPaths:r.secret_protection.allow_paths}});return tt(e,{policySnapshot:i,cwd:n.cwd,userConfigDir:n.userConfigDir})}function U1(e,t){if(e===null)return Math.min(F1,t);let n=Number(e);if(!Number.isInteger(n)||n<1||n>t)return null;return n}function G1(e,t,n){if(t.searchParams.get("token")!==n)return!1;if(e.method!=="POST")return!0;return e.headers["x-cc-safety-net-token"]===n}var B1=1048576;async function zn(e){let t=[],n=0;for await(let r of e){let o=r;if(n+=o.byteLength,n>B1)return{ok:!1,status:413,error:"Request body is too large"};t.push(o)}try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(r){return{ok:!1,status:400,error:`Invalid JSON: ${r instanceof Error?r.message:String(r)}`}}}function q1(e,t){e.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),e.end(t)}function R(e,t,n){e.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),e.end(JSON.stringify(n))}function V1(e){return new Promise((t,n)=>{e.close((r)=>r?n(r):t())})}function z1(e){return new Promise((t)=>{let n=()=>{process.off("SIGINT",r),process.off("SIGTERM",r)},r=()=>{n(),e.close().then(t)};process.once("SIGINT",r),process.once("SIGTERM",r)})}function K1(e){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",n=process.platform==="win32"?["/c","start","",e]:[e];return new Promise((r,o)=>{let i=vd(t,n,{detached:!0,stdio:"ignore"}),s=(l)=>{i.off("spawn",a),o(l)},a=()=>{i.off("error",s),i.unref(),r()};i.once("error",s),i.once("spawn",a)})}async function W1(e="gh",t=Uo){return{ok:await jo(e,["api","-X","PUT",`/user/starred/${Kn}`],t)===0}}async function J1(e={}){let t=await Et(e.fetcher),n=wd(t,e.homeDir);return{targets:z.map((r)=>{let o=n.find((i)=>i.platform===r.id);return{target:r.id,label:D(r.id),version:t.versions[r.id]??null,status:o?.configured?"active":o?.detected?"disabled":o?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function wd(e,t){return ut(process.cwd(),{homeDir:t,ampPluginListOutput:e.ampPluginListOutput,codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.versions["copilot-cli"]})}async function Y1(e={}){let[t,n]=await Promise.all([Et(e.fetcher),(e.checkUpdates??we)()]);return{hooks:wd(t,e.homeDir).filter((r)=>r.detected).map((r)=>({platform:r.platform,label:D(r.platform),configured:r.configured})),update:{currentVersion:n.currentVersion,latestVersion:n.latestVersion??null,updateAvailable:n.updateAvailable}}}var dd=Promise.resolve();function Z1(e,t,n={}){let r=async()=>{let i=[],s=console.log,a=console.error;console.log=(...l)=>i.push(l.map(String).join(" ")),console.error=console.log;try{return{ok:await Vt(e,[],{selectTargets:async()=>[t],output:new $1({write(c,u,p){i.push(String(c).replace(/\n$/,"")),p()}}),...n})===0,output:i.join(`
`)}}finally{console.log=s,console.error=a}},o=dd.then(r);return dd=o.then(()=>{return},()=>{return}),o}async function X1(e={}){let[t,n,r]=await Promise.all([Q1(e.command),e0(e.fetchRepo),Promise.resolve(on(nt(),e.logsDir).totalBlocked)]);return{starred:t,starCount:n,blockedTotal:r}}async function Q1(e="gh",t=Uo){if(await jo(e,["auth","status"],t)!==0)return null;let n=await jo(e,["api",`/user/starred/${Kn}`],t);if(n===0)return!0;if(n===null)return null;return!1}function jo(e,t,n){return new Promise((r)=>{let o=vd(e,t,{stdio:"ignore",windowsHide:!0}),i=!1,s,a=(l)=>{if(i)return;if(i=!0,s)clearTimeout(s);r(l)};o.once("error",()=>a(null)),o.once("close",a),s=setTimeout(()=>{o.kill(),a(null)},n)})}async function e0(e=fetch){try{let t=await e(`https://api.github.com/repos/${Kn}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(Uo)});if(!t.ok)return null;let n=await t.json();return typeof n.stargazers_count==="number"?n.stargazers_count:null}catch{return null}}function t0(e){if(e[0]!=="help")return!1;let t=e[1];if(!t)bo(),process.exit(0);if(Ut(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var n0={hook:async(e)=>{let t=ps(e);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),Ut("hook",console.error),process.exit(1)},install:async(e)=>{process.exit(await Vt("install",e))},update:async(e)=>{process.exit(await Oo(e))},uninstall:async(e)=>{process.exit(await Vt("uninstall",e))},rule:async(e)=>{process.exit(await Xc(e))},status:async(e)=>{if(le(_({label:"status"},e).errors))process.exit(1);ed()},statusline:async(e)=>{let t=_({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},e);if(t.errors.length===0&&t.flags.claudeCode){await Ho();return}if(le(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");Ut("statusline",console.error),process.exit(1)},doctor:async(e)=>{let t=go(e);if(!t)process.exit(1);let n=await xl({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(n)},logs:async(e)=>{process.exit(await Oi(e))},gui:async(e)=>{process.exit(await bd(e))},explain:async(e)=>{process.exit(await Pl(e))}};async function r0(){let e=process.argv.slice(2),t=_({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},e);if(t0(e))return;let n=e[0],r=n?rn(n):void 0;if(t.help&&r&&r.name!=="rule")Ut(r.name),process.exit(0);if(!n||t.help&&!r)bo(),process.exit(0);if(t.flags.version)_l(),process.exit(0);if(r){await n0[r.name](e.slice(1));return}let o=fs(n);if(o){await o.run();return}if(n==="--statusline"){await Ho();return}console.error(n.startsWith("-")?`Unknown option: ${n}`:`Unknown command: ${n}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}r0().catch((e)=>{console.error("CC Safety Net error:",e),process.exit(1)});
