#!/usr/bin/env node
import{$ as It,$a as Gr,A as cn,Aa as Jr,B as Nl,Ba as Pt,C as P,Ca as Zr,D as U,Da as Qr,E as Vt,Ea as O,F as Zt,Fa as St,G as Yn,Ga as Kt,H as Qt,Ha as Ct,I as K2,Ia as T,J as x2,Ja as g3,K as Gt,Ka as on,L as s2,La as m3,M as v1,Ma as br,N as Nt,Na as D3,O as Sn,Oa as k3,P as b1,Pa as q3,Q as f1,Qa as st,R as An,Ra as j3,S as Wn,Sa as F3,T as bn,Ta as t1,U as fn,Ua as e1,V as Tr,Va as r1,W as Ln,Wa as a1,X as $2,Xa as e3,Y as Ut,Ya as Kr,Z as C2,Za as Cr,_ as y1,_a as Ht,aa as x1,ab as Ur,b as xr,ba as $1,bb as o2,c as $r,ca as Er,cb as w2,d as A,da as qr,db as l2,e as gr,ea as _r,eb as Or,f as Ft,fa as Pr,fb as W,g as Z,ga as Nr,gb as vn,h as m,ha as Ot,hb as pn,i as ln,ia as jr,ib as w1,j as g,ja as D,jb as yn,k as h2,ka as Tt,kb as c2,l as Hr,la as h1,lb as z1,m as H2,ma as d2,mb as Hn,n as dn,na as un,o as s3,oa as Et,p as Jt,pa as _t,q as Ar,qa as Ir,r as sn,ra as n1,s as Wr,sa as Fr,t as Mt,ta as M2,u as Rr,ua as Xt,v as Mr,va as Yt,w as E,wa as Vr,x as _,xa as Y2,y as W2,ya as $3,z as R2,za as Br}from"../chunks/index-2j1pvwna.js";var X3=["-h","--help"];function F(n,t){let e=Object.entries(n.booleans??{}),r=Object.entries(n.values??{}),a=Object.fromEntries(e.map(([L])=>[L,!1])),l={},d=[],s=[],c=!1,i=-1;for(let[L,u]of t.entries()){if(L<=i)continue;if(u==="--"){d.push(...t.slice(L+1));break}if(X3.includes(u)){c=!0;continue}let v=e.find(([,f])=>f.includes(u));if(v){a[v[0]]=!0;continue}let p=r.find(([,f])=>f.includes(u));if(p){let f=t[L+1];if(f===void 0||f.startsWith("-")){s.push(`${u} requires a value`);continue}l[p[0]]=f,i=L+1;continue}if(u.startsWith("-")){s.push(`Unknown option for ${n.label}: ${u}`);continue}if(n.positionals==="tail"){d.push(...t.slice(L));break}d.push(u)}if(n.positionals!=="list"&&n.positionals!=="tail")s.push(...d.map((L)=>`Unexpected argument for ${n.label}: ${L}`));return{flags:a,values:l,positionals:d,help:c,errors:s}}function r2(n){for(let t of n)console.error(t);return n.length>0}import{readdirSync as wd,statSync as d1,unlinkSync as xd}from"node:fs";import{basename as s1,dirname as $d,join as gd,resolve as md}from"node:path";function z(n){return Array.from(n,(t)=>{let e=t.charCodeAt(0);if(e<=31||e>=127&&e<=159)return`\\x${e.toString(16).padStart(2,"0")}`;return t}).join("")}var Dt=(n)=>{let t=Date.now()-new Date(n).getTime();if(!Number.isFinite(t))return"";let e=Math.floor(t/60000),r=Math.floor(e/60),a=Math.floor(r/24);if(a>0)return`${a}d ago`;if(r>0)return`${r}h ago`;if(e>0)return`${e}m ago`;return"just now"},Z2=(n)=>{let t=(n??"").trim().split(/\s+/).filter((a)=>a&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(a)),e=t[0]?.split("/").pop();if(!e)return null;let r=t[1];return r&&/^[a-z][a-z0-9-]*$/.test(r)?`${e} ${r}`:e};import{existsSync as Y3,readdirSync as S3,readFileSync as H3}from"node:fs";import{join as A3}from"node:path";function u2(n,t){try{return S3(n,{withFileTypes:!0,encoding:"utf8"}).flatMap((e)=>{let r=A3(n,e.name);if(e.isDirectory())return u2(r,t);if(e.name.endsWith(".jsonl"))return[r];return[]})}catch{if(t&&Y3(n))t.count++;return[]}}function kt(n){let t=(a)=>`${a.sessionId}
${Z2(a.segment||a.command)}`,e=n.filter((a)=>a.decision!=="allow"),r=e.filter((a)=>a.sessionId).reduce((a,l)=>a.set(t(l),(a.get(t(l))??0)+1),new Map);return new Set(e.filter((a)=>a.failureStage||(r.get(t(a))??0)>=2))}function an(n,t){try{return H3(n,"utf-8").split(`
`).filter(Boolean).flatMap((e)=>{try{return[JSON.parse(e)]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as pd}from"node:path";var W3=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function mr(n){let t=0,e={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(r){n.record({kind:"step",scope:"global",step:r})},recordSegment(r,a=e.currentSegmentIndex){if(a===void 0)return;n.record({kind:"step",scope:"segment",segmentIndex:a,step:r})}};return e}function Dr(n={}){let t=[],e=n.maxEvents??512,r={maxTextLength:n.maxTextLength??2048,maxListLength:n.maxListLength??128,maxObjectProperties:n.maxObjectProperties??n.maxListLength??128,maxDepth:n.maxDepth??16},a=0,l,d=new Set;return{record(s){if(l)return;try{if(!s||t.length>=e){a++;return}t.push(jt(R3(s,r,d)))}catch{a++}},finish(s){if(l)return l;try{l=jt({events:Object.freeze(t),droppedEvents:a,terminal:M3(s,r,d)})}catch{a++,l=Object.freeze({events:Object.freeze(t),droppedEvents:a,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,r.maxTextLength),segment:"trace unavailable".slice(0,r.maxTextLength)})})}return l}}}function R3(n,t,e){if(n.kind!=="step")throw TypeError("invalid trace event");let{scope:r,step:a}=n;Zn(a,e,t);let l=Q2(a,t,e);if(r==="global")return{kind:"step",scope:"global",step:l};if(r!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:n.segmentIndex,step:l}}function M3(n,t,e){let r=n.result;if(r==="allowed")return Object.freeze({result:"allowed"});if(r!=="blocked")throw TypeError("invalid trace terminal");let a=n.ruleId;return Object.freeze({result:"blocked",reason:Q2(n.reason,t,e),segment:Q2(n.segment,t,e),...a?{ruleId:Q2(a,t,e)}:{}})}function Zn(n,t,e,r=0,a=new WeakSet){if(typeof n==="string"){let s=n.slice(0,e.maxTextLength);if(!Ft(s))return;for(let c of gr(s))for(let i of c.match(/[^\s"'()$]+/g)??[])t.add(kr(i));return}if(!n||typeof n!=="object"||r>=e.maxDepth||a.has(n))return;if(a.add(n),Array.isArray(n)){let s=Math.min(n.length,e.maxListLength);for(let c=0;c<s;c++)Zn(n[c],t,e,r+1,a);return}let l=0,d=new Set;for(let s in n){if(!Object.hasOwn(n,s))continue;if(l>=e.maxObjectProperties)break;l++,Zn(s,t,e);let c=qt(s,e,t);if(d.has(c))continue;d.add(c),Zn(n[s],t,e,r+1,a)}}function Q2(n,t,e,r=0,a=new WeakSet){if(typeof n==="string")return qt(n,t,e);if(!n||typeof n!=="object")return n;if(r>=t.maxDepth)return;if(a.has(n))return;if(a.add(n),Array.isArray(n)){let s=[],c=Math.min(n.length,t.maxListLength);for(let i=0;i<c;i++)s.push(Q2(n[i],t,e,r+1,a));return s}let l={},d=0;for(let s in n){if(!Object.hasOwn(n,s))continue;if(d>=t.maxObjectProperties)break;d++;let c=qt(s,t,e);if(Object.hasOwn(l,c))continue;Object.defineProperty(l,c,{value:Q2(n[s],t,e,r+1,a),enumerable:!0,configurable:!0,writable:!0})}return l}function qt(n,t,e){let r=n.slice(0,t.maxTextLength),a=Ft(r)?$r(r):r,l=e.size>0?K3(a,e):a;return(V3(l)?xr(l):l).slice(0,t.maxTextLength)}function V3(n){return n.includes("PRIVATE KEY")||n.includes("://")||n.includes("eyJ")||n.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(n)||n.length>=14&&W3.some((t)=>n.includes(t))||n.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(n)}function K3(n,t){return n.replace(/[^\s"'()$]+/g,(e)=>t.has(kr(e))?"<redacted>":e)}function kr(n){let t=2166136261,e=2166136261;for(let r=0;r<n.length;r++)t=Math.imul(t^n.charCodeAt(r),16777619),e=Math.imul(e^n.charCodeAt(n.length-r-1),16777619);return`${t>>>0}:${e>>>0}:${n.length}`}function jt(n){if(n&&typeof n==="object"&&!Object.isFrozen(n)){for(let t of Object.values(n))jt(t);Object.freeze(n)}return n}function zr(n,t,e,r){let a=r??qr(),l=e??a.getCommandProgram(n,t.shell??"auto"),d=Dr(),s=mr(d),c=l.dialect==="powershell"?a.getCommandProgram(n,"posix"):l,i=jr(c);s.recordGlobal({type:"parse",input:n,segments:i.map((v)=>[...v])});let L=Fr(n,{...t,analyzePartialProgram:!0,trace:s},l,a),u=s.getNextSegmentIndex();if(L&&u>0&&u<i.length)s.recordSegment({type:"segment-skipped",index:u,reason:"prior-segment-blocked"},u);return Object.freeze({decision:L,trace:d.finish(L?{result:"blocked",reason:L.reason,segment:L.evidence.find((v)=>v.kind==="command")?.segment??n,...L.ruleId?{ruleId:L.ruleId}:{}}:{result:"allowed"}),program:l})}import{resolve as C3}from"node:path";function zt(n){let t=Br().safeParse(n);return{errors:t.success?[]:Zr(t.error.issues),ruleNames:new Set(Jr(n).map((e)=>e.toLowerCase()))}}function Bt(n){let t=Xr(n);if(!t.ok)return t.result;return zt(t.parsed)}function Xr(n){let t=[],e=new Set;try{let r=typeof n==="string"?ln(n):n,a=g(r);if(a===null)return t.push(`File not found: ${r.path}`),{ok:!1,result:{errors:t,ruleNames:e}};if(!a.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:e}};return{ok:!0,parsed:JSON.parse(a)}}catch(r){return t.push(r instanceof Z?r.message:"Invalid JSON"),{ok:!1,result:{errors:t,ruleNames:e}}}}function Yr(n){return C3(n??process.cwd(),".safety-net.json")}function a2(n){let t=Xr(n);if(!t.ok)return t.result;let e=Qr(t.parsed);return{errors:e.errors,ruleNames:e.sources}}import{isAbsolute as G3,join as Qn,relative as U3,resolve as Sr,sep as O3}from"node:path";async function A2(n={}){let t=Wt(n);return T3(t,await Xn(t,Y2()))}function T3(n,t){if(!t.ok)return t;let e=U(n),r=[...new Set(l2(e.configPath,e.lockPath,n,e.filesystemScope))];if(r.length===0)return t;return{ok:!1,errors:r,warnings:t.warnings,entries:t.entries}}async function Xn(n,t,e,r={}){let a=null,l=!1;try{let d=U(n),s=St(d.configTarget);if(!s.ok)return s.result;let c=s.config;if(n.check)return nd(c,d,n);a={target:d.lockTarget,content:g(d.lockTarget)};let i=Ht(d.lockTarget);if(i.errors.some((y)=>y.startsWith("Unable to access ")))return{ok:!1,errors:i.errors,warnings:[],entries:[]};if(n.only&&i.errors.length>0)return{ok:!1,errors:i.errors,warnings:[],entries:[]};let L=i.errors.length>0?null:i.lock,u=n.only?Kr(c,L,n.only):{ok:!0,specs:c.rules};if(!u.ok)return u.result;if(n.only&&!L&&u.specs.length<c.rules.length)return{ok:!1,errors:[`No lockfile available for partial update; run ${Mr}`],warnings:[],entries:[]};let v=(await _3(u.specs,(y)=>Gr(y,d.configDir,n,L,d.filesystemScope,t),t)).map((y)=>td(y,L,e));for(let y of v)ad(y.content,y.entry,d.configDir,n,d.filesystemScope);let p=n.only?ed(c,L,v):v.map((y)=>y.entry);l=!0,T(d.lockTarget,{version:1,rulebooks:p},void 0,r._testAfterPolicyRename);let f=new Map(v.map((y)=>[y.entry.spec,y.rulebook.rules.length])),o=ld(p,d.configDir,n,d.filesystemScope,r);return{ok:!0,errors:[],warnings:o,entries:p.map((y)=>rd(y,f))}}catch(d){if(l&&a)try{X2(a.target,a.content)}catch(s){return S2(s)}return S2(d)}}async function At(n,t={}){return E3(n,Wt(t),Y2())}async function E3(n,t,e,r={}){let a=null,l=!1;try{let d=U(t),s=g(d.configTarget);a={target:d.configTarget,content:s};let c=St(d.configTarget);if(!c.ok)return c.result;let i=c.config,L=Rr(n)?await Ur(n,e):[{spec:n}],u=L.map((f)=>f.spec),v=[...new Set([...i.rules,...u])];if(v.length>Xt)return P3();if(v.length!==i.rules.length)l=!0,T(d.configTarget,{version:1,rules:v,overrides:i.overrides??{},transparent_wrappers:i.transparent_wrappers??[]},void 0,r._testAfterPolicyRename);let p=await Xn(t,e,new Map(L.filter((f)=>!!f.display_ref).map((f)=>[f.spec,f.display_ref])),r);if(!p.ok)X2(d.configTarget,s);return p}catch(d){if(l&&a)try{X2(a.target,a.content)}catch(s){return S2(s)}return S2(d)}}async function _3(n,t,e=Y2()){if(n.length>Xt)throw Error(Yt);let r=Array(n.length),a=0,l,d=Array.from({length:Math.min(n.length,Vr.concurrency)},async()=>{while(!l){let s=a;if(s>=n.length)return;a++;try{r[s]=await t(n[s],s,e.controller.signal)}catch(c){if(!l)l={value:c},a=n.length,e.controller.abort(c);return}}});if(await Promise.all(d),l)throw l.value;return r}function P3(){return{ok:!1,errors:[Yt],warnings:[],entries:[]}}function Wt(n){return{cwd:n.cwd,cacheConfigDir:n.cacheConfigDir,userConfigDir:n.userConfigDir,userConfigPath:n.userConfigPath,projectConfigPath:n.projectConfigPath,global:n.global,check:n.check,only:n.only,refresh:n.refresh}}function N3(n){return{...Wt(n),deleteSource:n.deleteSource}}async function Rt(n,t={}){try{return await I3(n,N3(t),{})}catch(e){return S2(e)}}async function I3(n,t,e){let r=U(t),a=O(r.configTarget);if(a.errors.length>0)return{ok:!1,errors:a.errors,warnings:[],entries:[]};if(!a.config)return{ok:!1,errors:[`No config found at ${r.configPath}`],warnings:[],entries:[]};let l=Ht(r.lockTarget);if(l.errors.length>0)return{ok:!1,errors:l.errors,warnings:[],entries:[]};let d=Cr(a.config.rules,l.lock,n);if(!d.ok)return d.result;let s=t.deleteSource?dd(r.configDir,d.specs,l.lock,r.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let c=g(r.configTarget);if(c===null)return S2(Error("Rules config is unavailable."));try{T(r.configTarget,{version:1,rules:a.config.rules.filter((u)=>!d.specs.includes(u)),overrides:a.config.overrides??{},transparent_wrappers:a.config.transparent_wrappers??[]},void 0,e._testAfterPolicyRename)}catch(u){throw X2(r.configTarget,c),u}let i=await Xn(t,Y2(),void 0,e);if(!i.ok)return X2(r.configTarget,c),i;let L=cd(s.dirs,e,r.filesystemScope);if(!L.ok){X2(r.configTarget,c);let u=await Xn(t,Y2(),void 0,e);if(!u.ok)return{ok:!1,errors:[...L.result.errors,...u.errors],warnings:u.warnings,entries:u.entries};return L.result}return i}async function nd(n,t,e){let r=Or(n,t.lockPath,t.configDir,e,e.global?"user":"project",t.filesystemScope);return{ok:r.errors.length===0&&r.warnings.length===0,errors:[...r.errors,...r.warnings],warnings:[],entries:r.entries}}function td(n,t,e){let r=t?.rulebooks.find((l)=>l.spec===n.entry.spec&&l.kind==="github"),a=e?.get(n.entry.spec)??(r?.kind==="github"?r.display_ref:void 0);if(!a||n.entry.kind!=="github")return n;return{...n,entry:{...n.entry,display_ref:a}}}function ed(n,t,e){let r=new Set(n.rules),a=new Set(t?.rulebooks.map((d)=>d.spec)??[]),l=new Map(e.map((d)=>[d.entry.spec,d.entry]));return[...(t?.rulebooks.filter((d)=>r.has(d.spec))??[]).map((d)=>l.get(d.spec)??d),...e.filter((d)=>!a.has(d.entry.spec)).map((d)=>d.entry)]}function rd(n,t){return{...n,ruleCount:t.get(n.spec)}}function ad(n,t,e,r,a){let l=Zt(t,Qt(e,r));h2(m(a,l),n)}function ld(n,t,e,r,a){let l=Qt(t,e),d=Yn(l),s=m(r,d),c=H2(s);if(!c)return[];let i=n.map((u)=>m(r,Zt(u,l))),L=c.filter((u)=>u.kind==="directory").map((u)=>({directory:m(r,Qn(d,u.name)),identity:m(r,Qn(d,u.name,Wr))})).filter((u)=>!i.some((v)=>Hr(u.identity,v))).map((u)=>u.directory);for(let u of L)Ar(u);return L.flatMap((u)=>{try{return id(u,a),[]}catch{return["Unable to prune rules policy cache safely."]}})}function dd(n,t,e,r){let a=new Map(e?.rulebooks.map((i)=>[i.spec,i])??[]),l=t.flatMap((i)=>{let L=a.get(i);if(!L)return sn.test(i)?[]:["--delete-source can only delete local rulebook sources"];return L.kind==="local-directory"?[]:["--delete-source can only delete local rulebook sources"]}),d=t.map((i)=>{let L=a.get(i);return Qn(n,L?.kind==="local-directory"?L.path:i)}),s=l.length>0?[]:d.flatMap((i)=>sd(n,i,r)),c=[...l,...s];return c.length>0?{ok:!1,result:{ok:!1,errors:c,warnings:[],entries:[]}}:{ok:!0,dirs:d}}function sd(n,t,e){let r=Sr(n),a=Sr(t),l=U3(r,a);if(l===""||l===".."||l.startsWith(`..${O3}`)||G3(l))return[`Refusing to delete local rulebook source outside ${n}: ${t}`];let d=m(e,a),s=H2(d);if(!s)return[`Local rulebook source directory not found: ${t}`];let c=s.find((i)=>i.name==="rulebook.json");if(!c)return[`Local rulebook source directory is missing rulebook.json: ${t}`];if(c.kind!=="file")throw new Z(e.label);if(g(m(e,Qn(a,"rulebook.json"))),s.length>1)return[`Local rulebook source directory contains extra files: ${t}. delete manually if you really want to remove the directory.`];return[]}function cd(n,t,e){let r=n.flatMap((a)=>{try{return Ld(m(e,a),t),[]}catch(l){return[`Failed to delete local rulebook source ${a}: ${l instanceof Error?l.message:String(l)}`]}});return r.length>0?{ok:!1,result:{ok:!1,errors:r,warnings:[],entries:[]}}:{ok:!0}}function id(n,t){if(t._testPruneRulebookCacheDir){t._testPruneRulebookCacheDir(n.path);return}Jt(n)}function Ld(n,t){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(n.path);return}Jt(n)}function X2(n,t){if(t===null){dn(n);return}h2(n,t)}function S2(n){return{ok:!1,errors:[n instanceof Error?n.message:String(n)],warnings:[],entries:[]}}function V2(n,t){let e=od(t),r=Ir(e),a={effectiveLevel:r.effectiveLevel,selectedPreset:e.policySnapshot.policy.safety.level??"standard",effectiveCapabilities:r.effectiveCapabilities,destructiveCommandRuleOverrides:e.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:l,configValid:d}=ud({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!n||!n.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:l,configValid:d,...a};let s=vd(n,e);if(s)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",ruleModule:s.ruleModule,ruleFunction:s.ruleFunction,matched:!0,reason:s.reason}]}]},result:"blocked",reason:A(s.reason),segment:A(s.target),...s.ruleId?{ruleId:A(s.ruleId)}:{},configSource:l,configValid:d,...a};let c=zr(n,e),i=c.decision,L=i?.ruleId??bd(n,e),u=Ln.find((p)=>p.id===L&&p.activationCapability),v=u?r.policy.effectiveDestructiveCommandRules[u.id]:void 0;return{trace:yd(c.trace),result:i?"blocked":"allowed",reason:i?A(i.reason):void 0,segment:i?A(i.evidence.find((p)=>p.kind==="command")?.segment??n):void 0,ruleId:i?.ruleId?A(i.ruleId):void 0,customRule:fd(hd(i?.ruleId,e.policySnapshot)),configSource:l,configValid:d,...a,...u&&v?{ruleActivation:{id:u.id,...v}}:{}}}function ud(n){let t=E(n?.cwd),e=n?.userConfigPath??_(n),r=P({cwd:n?.cwd,userConfigDir:n?.userConfigDir,userConfigPath:n?.userConfigPath});try{if(g(r.projectConfigTarget)!==null){if(a2(r.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(a){if(a instanceof Z)return{configSource:t,configValid:!1};throw a}try{if(g(r.userConfigTarget)!==null){let a=a2(r.userConfigTarget);return{configSource:e,configValid:a.errors.length===0}}return{configSource:null,configValid:!0}}catch(a){if(a instanceof Z)return{configSource:e,configValid:!1};throw a}}function od(n){let t=pd(n?.cwd??process.cwd()),e=n?.policySnapshot??W({cwd:t,userConfigDir:n?.userConfigDir}),r=d2(e.policy);return{cwd:t,effectiveCwd:t,policySnapshot:e,environment:Tr(),protectedGitMetadata:Nr(t),effectiveCapabilities:r.capabilities,strict:n?.strict??r.strict,paranoidRm:r.paranoidRm,paranoidInterpreters:r.paranoidInterpreters,worktreeMode:r.worktreeMode}}function vd(n,t){let e=t.cwd??process.cwd(),r=Er(M2("",{command:n},{kind:"command",shell:"posix"},{executionCwd:e,configCwd:e},n)),a=e1(r);if(a)return{reason:t1,target:a.target,ruleId:"policy-protection",ruleModule:"policy-protection",ruleFunction:"findPolicyConfigMutationTarget"};let l=Pr(r,t.protectedGitMetadata);if(l)return{reason:_r,target:l.target,ruleId:"git-metadata-protection",ruleModule:"git-metadata-protection",ruleFunction:"findGitMetadataMutationTarget"};let d=t.policySnapshot.policy,s=d.secretProtection.enabled===!1?null:a1(r,d.secretProtection,{strict:t.strict});if(s)return{reason:r1,target:s.target,ruleId:s.ruleId,ruleModule:"secret-protection",ruleFunction:"findSensitiveTarget"};return null}function bd(n,t){let e=t.policySnapshot.policy,r=pn({...e,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...e.destructiveCommandRuleOverrides,...Object.fromEntries(Ln.flatMap((a)=>a.activationCapability?[[a.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return n1(n,{...t,policySnapshot:r,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function fd(n){if(!n)return;return{id:A(n.id),...n.rulebook?{rulebook:{name:A(n.rulebook.name),version:A(n.rulebook.version)}}:{},...n.source?{source:A(n.source)}:{},...n.override?{override:{type:"reason",reason:A(n.override.reason)}}:{}}}function yd(n){let t=n.events.flatMap((r)=>r.kind==="step"&&r.scope==="global"?[r.step]:[]),e=new Map;for(let r of n.events){if(r.kind!=="step"||r.scope!=="segment")continue;let a=e.get(r.segmentIndex)??{index:r.segmentIndex,steps:[]};a.steps.push(r.step),e.set(r.segmentIndex,a)}return{steps:t,segments:[...e.values()]}}function hd(n,t){let e=n?.replace(/^custom\./,"");if(!e||!t.policy.rules.some((r)=>r.name===e))return;return t.ruleMetadata[e]??Object.freeze({id:e})}function Dd(n){let t=K2(),e=F({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},n);if(r2(e.errors))return null;if(e.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(e.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let r=e.values.limit===void 0?20:l1(e.values.limit);if(r===null)return console.error("--limit must be a positive number"),null;let a=e.values.since===void 0?Math.min(30,t):l1(e.values.since);if(a===null||a>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let l={limit:r,limitExplicit:e.values.limit!==void 0,since:a,sinceExplicit:e.values.since!==void 0,all:e.flags.all,json:e.flags.json,suspect:e.flags.suspect,pruneLegacy:e.flags.pruneLegacy,dryRun:e.flags.dryRun,id:e.values.id,agent:e.values.agent,rule:e.values.rule,session:e.values.session,project:e.values.project===void 0?void 0:md(e.values.project)};if(l.id&&(l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.sinceExplicit||l.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(l.pruneLegacy&&(l.id!==void 0||l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.all||l.sinceExplicit||l.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(l.dryRun&&!l.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return l}async function c1(n,t={}){let e=Dd(n);if(!e)return 1;let r=t.logsDir??s2();if(e.pruneLegacy)return kd(r,e.json,e.dryRun);if(!r)return console.log(e.json?"[]":e.id?`No retained audit log entry found for id ${z(e.id)}.`:"No audit log entries found."),0;x2(r);let a={count:0},l=u2(r,a).flatMap((L)=>an(L,a).map((u)=>({entry:u,file:L})));if(a.count>0)console.error(`warning: ${a.count} audit log ${a.count===1?"source":"sources"} could not be read; these results are incomplete`);if(e.id)return zd(l,e,t.timeZone);let d=Date.now()-e.since*24*60*60*1000,s=l.filter((L)=>Bd(L,e,r,d)),c=e.suspect?kt(s.map((L)=>L.entry)):null,i=(c?s.filter((L)=>c.has(L.entry)):s).sort((L,u)=>Date.parse(u.entry.ts)-Date.parse(L.entry.ts)).slice(0,e.limit);if(e.json)return console.log(JSON.stringify(i.map((L)=>L.entry),null,2)),0;if(i.length===0)return console.log("No audit log entries found."),0;for(let L of i)console.log(Qd(L.entry,t.timeZone));return 0}function kd(n,t,e){let r=n?jd(n).map((s)=>gd(n,s)):[];if(e)return qd(r,t);let a=[],l=0,d=0;for(let s of r){let c=d1(s,{throwIfNoEntry:!1})?.size??0,i=Fd(s);if(i){a.push(`${s1(s)}: ${i}`);continue}l++,d+=c}if(t)return console.log(JSON.stringify({removedFiles:l,removedBytes:d,failedFiles:a.length})),a.length===0?0:1;console.log(l===0&&a.length===0?"No legacy audit log files found.":`Removed ${l} legacy audit log ${l===1?"file":"files"} (${i1(d)}).`);for(let s of a)console.error(`Could not remove ${z(s)}`);if(console.log("Nested v2 audit logs were not changed."),l>0)console.log("This deletion cannot be undone.");return a.length===0?0:1}function qd(n,t){let e=n.reduce((r,a)=>r+(d1(a,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:n.length,bytes:e})),0;if(console.log(n.length===0?"No legacy audit log files found.":`Would remove ${n.length} legacy audit log ${n.length===1?"file":"files"} (${i1(e)}).`),console.log("Nested v2 audit logs are not included."),n.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function jd(n){try{return wd(n,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function Fd(n){try{return xd(n),null}catch(t){return t instanceof Error?t.message:String(t)}}function i1(n){let t=["B","KiB","MiB","GiB"],e=Math.min(Math.floor(Math.log2(Math.max(n,1))/10),t.length-1);return`${Math.round(n/1024**e*10)/10} ${t[e]}`}function zd(n,t,e){let r=n.filter((l)=>l.entry.id===t.id);if(r.length>1)return console.error(`Multiple audit log entries found for id ${z(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(r.map((l)=>l.entry),null,2)),0;let a=r[0];if(!a)return console.log(`No retained audit log entry found for id ${z(t.id??"")}.`),0;return console.log(Xd(a.entry,e)),0}function Bd(n,t,e,r){if(!t.all&&n.entry.decision==="allow")return!1;if(Date.parse(n.entry.ts)<r)return!1;if(t.agent!==void 0&&n.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&n.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!Jd(n,e,t.session))return!1;if(t.project!==void 0&&!Zd(n.entry.cwd,t.project))return!1;return!0}function Jd(n,t,e){if(n.entry.sessionId===e)return!0;return $d(n.file)===t&&s1(n.file,".jsonl")===e}function Zd(n,t){if(!n)return!1;return n===t||n.startsWith(`${t}/`)}function Qd(n,t){let e=z(n.id??"-"),r=z(n.decision??"deny"),a=n.cwd?`  [${z(n.cwd)}]`:"",l=n.segment||n.command,d=l===n.command?"":"↳ ",s=l.length>50?`${l.slice(0,50)}…`:l;return`${e.padEnd(16)}  ${z(L1(n.ts,t))}  ${r.padEnd(5)}  ${z(n.agent??"-").padEnd(15)}  ${z(n.ruleId??"-").padEnd(20)}  ${d}${z(s)}${a}`}function Xd(n,t){let e=(a)=>z(a===void 0||a===null||a===""?"-":a),r=n.shape?`${n.agent??"-"} (shape: ${n.shape})`:n.agent??"-";return[`id:        ${e(n.id)}`,`ts:        ${e(L1(n.ts,t))}`,`decision:  ${e(n.decision)}`,`agent:     ${e(r)}`,`level:     ${e(n.level)}`,`tool:      ${e(n.toolName)}`,`rule:      ${e(n.ruleId)}`,`intent:    ${e(n.intent)}`,`stage:     ${e(n.failureStage)}`,`error:     ${e(n.errorCode)}`,`session:   ${e(n.sessionId)}`,`cwd:       ${e(n.cwd)}`,`version:   ${e(n.v)}`,`truncated: ${e(n.truncated===!0?"yes":void 0)}`,`reason:    ${e(n.reason)}`,`command:   ${e(n.command)}`,`segment:   ${e(n.segment)}`].join(`
`)}function L1(n,t){let e=new Date(n);if(Number.isNaN(e.getTime()))return n;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(e)}function l1(n){let t=Number(n);return Number.isFinite(t)&&t>0?t:null}var p1={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var u1={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var o1={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as g1,relative as Gd}from"node:path";var Yd=8388608;function Sd(n,t){console.log(JSON.stringify(n(b1(t))))}async function Hd(n){let t;try{t=(await ne(process.stdin)).trim()}catch{n({reason:"Failed to parse hook input JSON."});return}if(!t){n({reason:"Missing hook input JSON."});return}return te(t,n,"Failed to parse hook input JSON.")}async function ne(n){let t=[],e=0;for await(let r of n){let a=typeof r==="string"?Buffer.from(r,"utf-8"):Buffer.from(r.buffer,r.byteOffset,r.byteLength);if(e+=a.byteLength,e>Yd)throw Ad(n),Error("hook input byte limit exceeded");t.push(a)}return Buffer.concat(t,e).toString("utf-8")}function Ad(n){let t=n.destroy??n.cancel;if(!t)return;try{Promise.resolve(t.call(n)).catch(()=>{})}catch{}}function te(n,t,e){try{return JSON.parse(n)}catch{t({reason:e});return}}function X(n,t){let e=t.get(n);return e?{kind:"command",shell:e}:{kind:y1(n)}}function N(n,t,e,r){let a=n===void 0?process.cwd():n,l=typeof a==="string"&&a.trim()!==""?c2([a]):void 0;if(l)return{configCwd:l,executionCwd:l};return H(r,t,e,Vd(a)),null}function H(n,t,e,r){let a;try{a=It(t)}catch(l){if(!(l instanceof C2))throw l}n(Sn({command:a,segment:r,toolName:e}))}async function Wd(n){let t=await Hd(n.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){H(n.outputDeny);return}if(!n.isSupported(t))return;let e=n.getAgent?.(t)??n.agent,r=n.agent===e?void 0:n.agent,a=Cd(t),l=(p,f)=>{v1(p,()=>n.getSessionId(t),{agent:e,shape:r,toolName:f,cwd:a}),n.outputDeny(p)},d=n.getToolName(t);if(typeof d!=="string"||d.trim()===""){H((p)=>l(p),Kd(t));return}let s=d,c=(p)=>l(p,s),i;try{i=n.getToolInput(t,s,c)}catch(p){if(!(p instanceof C2))throw p;H(c,void 0,s);return}if(!i.ok)return;let L=n.getContext(t,i.input,s,c);if(!L)return;let u;try{u=It(i.input)}catch(p){if(!(p instanceof C2))throw p;H(c,void 0,s);return}let v=M2(s,i.input,i.route,L,u??null);try{let p=Hn(v,{guard:{auditAllowed:h1(),dependencies:n.guardDependencies},audit:{agent:e,shape:r,getSessionId:()=>n.getSessionId(t)}}),f=Nt(p,{includeEvidence:!0,toolName:p.stage==="command-analysis"?void 0:s});if(f){n.outputDeny(f);return}n.outputAllow?.()}catch(p){if(!(p instanceof w1))throw p;Rd(p);let f=Nt(p.evaluation,{includeEvidence:!0,toolName:p.evaluation.stage==="command-analysis"?void 0:s});if(f)n.outputDeny(f);return}}function Rd(n){if(!un(D.debug))return;console.error(`CC Safety Net debug: ${Md(n.stage)}: ${f1(n.cause)}`)}function Md(n){if(n==="policy-protection")return"hook policy protection failed";if(n==="config-load")return"hook config loading failed";if(n==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function Vd(n){return typeof n==="string"?n:void 0}function Kd(n){if(!n||typeof n!=="object"||Array.isArray(n))return;if(Object.hasOwn(n,"tool_input"))return n.tool_input;let t=n.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function Cd(n){if(!n||typeof n!=="object"||Array.isArray(n))return null;let t=n.cwd;if(typeof t==="string")return t;let e=n.toolCall;if(!e||typeof e!=="object"||Array.isArray(e))return null;let r=e.args;if(!r||typeof r!=="object"||Array.isArray(r))return null;let a=r.Cwd;return typeof a==="string"?a:null}async function Y(n){let t=(a)=>Sd(n.createDenyOutput,a),e=n.createAllowOutput;await Wd({...n,outputDeny:t,outputAllow:e?()=>console.log(JSON.stringify(e())):void 0})}var Ud=new Map([["run_command","auto"]]),Od=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function m1(n){return X(n,Ud)}async function D1(){await Y({agent:"antigravity-cli",createDenyOutput:(n)=>({decision:"deny",reason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolCall?.name,getToolInput:(n,t)=>({ok:!0,input:Nd(n.toolCall?.args,t),route:m1(t)}),getContext:Td,getSessionId:(n)=>n.conversationId})}function Td(n,t,e,r){let l=Pd(n).flatMap((i)=>{let L=c2([i]);return L?[L]:[]});if(!l[0])return g2(r,t,e),null;if(e!=="run_command"){let i;try{i=Ed(t,e,l)}catch(L){if(L instanceof C2)return g2(r,void 0,e),null;if(!(L instanceof An))throw L;return g2(r,t,e),null}if(!i)return g2(r,t,e),null;return{configCwd:i,executionCwd:i,policyConfigCwds:l}}let d=n.toolCall?.args;if(!d||!Object.hasOwn(d,"Cwd"))return{configCwd:l[0],executionCwd:l[0],policyConfigCwds:l};let s=d.Cwd;if(typeof s!=="string"||s.trim()==="")return g2(r,t,e),null;let c=yn(s,l);if(c){let i=k1(c,l);if(!i)return g2(r,t,e,s),null;return{configCwd:i,executionCwd:c,policyConfigCwds:l}}return g2(r,t,e,s),null}function Ed(n,t,e){let r=m1(t),a=[...x1(n,Od),...r.kind==="patch"?$1(n):[]].filter(g1),l=Wn(),d=new Set(a.flatMap((s)=>{let c=k1(bn(s,fn,l),e);return c?[c]:[]}));if(d.size>1)return null;return[...d][0]??e[0]??null}function k1(n,t){return t.filter((e)=>_d(n,e)).reduce((e,r)=>r.length>e.length?r:e,"")||null}function _d(n,t){let e=Gd(t,n);return e===""||!e.startsWith("..")&&!g1(e)}function g2(n,t,e,r){let a=t&&typeof t==="object"?t.command:void 0;n(Sn({command:typeof a==="string"?a:void 0,segment:r,toolName:e}))}function Pd(n){if(n.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(n.workspacePaths)?n.workspacePaths.filter((e)=>typeof e==="string"&&e.trim()!==""):[];return c2(t)?t:[]}function Nd(n,t){if(!n)return;if(t!=="run_command")return n;return{...n,command:typeof n.CommandLine==="string"&&n.CommandLine!==""?n.CommandLine:void 0}}var G2=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",installLabel:"Antigravity CLI",helpTarget:"Antigravity CLI hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",installLabel:"Claude Code",helpTarget:"Claude Code plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",installLabel:"Codex",helpTarget:"Codex plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",installLabel:"GitHub Copilot CLI",helpTarget:"GitHub Copilot CLI plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",installLabel:"Gemini CLI",helpTarget:"Gemini CLI extension",probeCommand:["gemini","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:8,runtime:{order:6,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--hermes-agent",installLabel:"Hermes Agent",helpTarget:"Hermes Agent plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:9,runtime:{order:7,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--kimi-code",installLabel:"Kimi Code",helpTarget:"Kimi Code hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:10,install:{order:10,flag:"--openclaw",installLabel:"OpenClaw",helpTarget:"OpenClaw plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:11,install:{order:11,flag:"--opencode",installLabel:"OpenCode",helpTarget:"OpenCode plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:12,install:{order:12,flag:"--pi",installLabel:"Pi",helpTarget:"Pi package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",installLabel:"Cursor",helpTarget:"Cursor hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",installLabel:"Amp Code",helpTarget:"Amp Code plugin",probeCommand:["amp","--version"]}}],q1=G2.slice().sort((n,t)=>n.doctorOrder-t.doctorOrder).map((n)=>n.id),j1=G2.filter((n)=>("runtime"in n)).slice().sort((n,t)=>n.runtime.order-t.runtime.order).map((n)=>({id:n.id,displayName:"displayName"in n.runtime?n.runtime.displayName:n.displayName,flags:n.runtime.flags,legacyFlags:"legacyFlags"in n.runtime?n.runtime.legacyFlags:[],description:n.runtime.description,legacyTopLevelFlags:n.runtime.legacyTopLevelFlags})),i2=G2.slice().sort((n,t)=>n.install.order-t.install.order).map((n)=>({id:n.id,...n.install})).map(({order:n,...t})=>t),z6=Object.fromEntries(G2.map((n)=>[n.id,n.displayName]));function v2(n){return G2.find((t)=>t.id===n)?.displayName??n}function b2(n){return G2.find((t)=>t.id===n)?.install.installLabel??n}import{homedir as Id}from"node:os";import{isAbsolute as F1,join as ee}from"node:path";function B1(n){if(n!==void 0&&n!==null&&!F1(n))return"unknown";try{let t=Wn(),e=n?bn(n,fn,t):void 0,r=process.env.HOME||Id(),a=[["codex",process.env.CODEX_HOME||ee(r,".codex")],["copilot-cli",process.env.COPILOT_HOME||ee(r,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||ee(r,".claude")]],l=e?a.flatMap(([d,s])=>{if(!F1(s))return[];return z1(e,bn(s,fn,t))?[d]:[]}):[];if(l.length===1)return l[0]??"unknown";if(l.length>1)return"unknown"}catch(t){if(t instanceof An)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var re="PreToolUse",J1="BeforeTool",Z1="pre_tool_call",ae="PreToolUse";var ns=new Map([["Bash","posix"],["PowerShell","powershell"]]);function ts(n){return X(n,ns)}async function Q1(){await Y({agent:"claude-code",getAgent:(n)=>B1(n.transcript_path),createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:re,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===re,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:ts(t)}),getContext:(n,t,e,r)=>N(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}var es=new Map([["bash","auto"],["Bash","auto"]]);function rs(n){return X(n,es)}async function X1(){await Y({agent:"copilot-cli",createDenyOutput:(n)=>({permissionDecision:"deny",permissionDecisionReason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolName,getToolInput:(n,t,e)=>{if(typeof n.toolArgs!=="string")return e({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let r=te(n.toolArgs,e,"Failed to parse toolArgs JSON.");if(r===void 0)return{ok:!1};return{ok:!0,input:r,route:rs(t)}},getContext:(n,t,e,r)=>N(n.cwd,t,e,r),getSessionId:(n)=>typeof n.sessionId==="string"&&n.sessionId.trim()?n.sessionId:void 0})}var as=new Map([["Shell","auto"]]);function ls(n){return X(n,as)}async function Y1(){await Y({agent:"cursor",createDenyOutput:(n)=>({permission:"deny",user_message:n,agent_message:n}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:ls(t)}),getContext:ds,getSessionId:(n)=>n.conversation_id})}function ds(n,t,e,r){let a=ss(n);if(!a[0])return H(r,t,e),null;let l=yn(is(n.cwd),a);if(!l)return H(r,t,e,typeof n.cwd==="string"?n.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:l,executionCwd:l,policyConfigCwds:a};if(!Object.hasOwn(t,"working_directory"))return{configCwd:l,executionCwd:l,policyConfigCwds:a};let d=t.working_directory;if(typeof d!=="string"||d.trim()==="")return H(r,t,e),null;let s=yn(d,a);if(!s)return H(r,t,e,d),null;return{configCwd:l,executionCwd:s,policyConfigCwds:a}}function ss(n){return cs(n).flatMap((t)=>{let e=c2([t]);return e?[e]:[]})}function cs(n){if(n.workspace_roots===void 0)return typeof n.cwd==="string"&&n.cwd.trim()!==""?[n.cwd]:[];if(!Array.isArray(n.workspace_roots))return[];return n.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function is(n){return typeof n==="string"&&n.trim()!==""?n:"."}var Ls=new Map([["run_shell_command","auto"]]);function ps(n){return X(n,Ls)}async function S1(){await Y({agent:"gemini-cli",createDenyOutput:(n)=>({decision:"deny",reason:n,systemMessage:n}),isSupported:(n)=>n.hook_event_name===J1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:ps(t)}),getContext:(n,t,e,r)=>N(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}import{resolve as us}from"node:path";var os=new Map([["terminal","posix"]]);async function H1(){await Y({agent:"hermes-agent",createDenyOutput:(n)=>({action:"block",message:n}),isSupported:(n)=>n.hook_event_name===Z1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:X(t,os)}),getContext:vs,getSessionId:(n)=>n.session_id})}function vs(n,t,e,r){let a=N(n.cwd,t,e,r);if(!a)return null;if(!t||typeof t!=="object"||Array.isArray(t))return a;if(!Object.hasOwn(t,"workdir"))return a;let l=t.workdir;if(typeof l!=="string"||l.trim()==="")return H(r,t,e),null;let d=c2([us(a.configCwd,l)]);if(!d)return H(r,t,e,l),null;return{...a,executionCwd:d}}var bs=new Map([["Bash","posix"]]);function fs(n){return X(n,bs)}async function A1(){await Y({agent:"kimi-code",createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:ae,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===ae,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:fs(t)}),getContext:(n,t,e,r)=>N(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}var ys={"antigravity-cli":D1,"claude-code":Q1,"copilot-cli":X1,cursor:Y1,"gemini-cli":S1,"hermes-agent":H1,"kimi-code":A1},U2=j1.map((n)=>({...n,run:ys[n.id]}));function W1(n){let t=F({label:"hook",booleans:Object.fromEntries(U2.map((r)=>[r.id,[...r.flags,...r.legacyFlags]]))},n);if(t.errors.length>0)return;let e=U2.filter((r)=>t.flags[r.id]);return e.length===1?e[0]:void 0}function R1(n){return U2.find((t)=>t.legacyTopLevelFlags.some((e)=>e===n))}var hs=U2.map((n)=>({flags:n.flags.join(", "),description:n.description})),ws=U2.flatMap((n)=>n.flags.map((t)=>`cc-safety-net hook ${t}`)),M1={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...hs,{flags:"-h, --help",description:"Show this help"}],examples:ws};var V1={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...i2.map((n)=>({flags:n.flag,description:`Install ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...i2.map((n)=>`cc-safety-net install ${n.flag}`)]},K1={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...i2.map((n)=>({flags:n.flag,description:`Uninstall ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...i2.map((n)=>`cc-safety-net uninstall ${n.flag}`)]},C1={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var G1={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var O2={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source>",description:"Add a rulebook source and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Refresh rulebook lock/cache state"},{usage:"sync",description:"Sync configured rulebooks"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk","cc-safety-net rule add project-rules","cc-safety-net rule sync","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var U1={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var O1={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var T1=[U1,p1,G1,u1,O2,V1,C1,K1,M1,o1,O1];function xs(n){return n.aliases??[]}function $s(n){return!n.hidden}function Rn(n){let t=n.toLowerCase();return T1.find((e)=>e.name.toLowerCase()===t||xs(e).some((r)=>r.toLowerCase()===t))}function E1(){return T1.filter($s)}import{readFileSync as gs}from"node:fs";import{basename as ms}from"node:path";function Mn(n=7,t=s2()){let e=Date.now()-n*24*60*60*1000,r=[],a=new Set,l=0,d,s,c,i;if(t)x2(t);let L={count:0},u=t?u2(t,L):[];for(let p of u)try{let o=gs(p,"utf-8").trim().split(`
`).filter(Boolean);for(let y of o)try{let x=JSON.parse(y);if(x.decision==="allow")continue;let w=new Date(x.ts).getTime();if(w>=e){if(l++,a.add(x.sessionId??ms(p,".jsonl")),s===void 0||w<=s)d=x.ts,s=w;if(i===void 0||w>i)c=x.ts,i=w;Ds(r,x,w)}}catch{L.count++}}catch{L.count++}let v=r.map((p)=>({timestamp:p.ts,command:p.command,reason:p.reason,relativeTime:Dt(new Date(p.ts))}));return{totalBlocked:l,sessionCount:a.size,recentEntries:v,oldestEntry:d,newestEntry:c,unreadable:L.count}}function Ds(n,t,e){let r=n.findIndex((a)=>e>new Date(a.ts).getTime());if(r===-1){if(n.length<3)n.push(t);return}if(n.splice(r,0,t),n.length>3)n.pop()}import{dirname as ks}from"node:path";function _1(n,t,e,r,a){let l;try{if(g(r)===null)return{path:n,exists:!1,valid:!1,ruleCount:0};l=a2(r),l.errors.push(...l2(n,t,{userConfigDir:e},a))}catch(d){if(!(d instanceof Z))throw d;l={errors:[d.message],ruleNames:new Set}}return{path:n,exists:!0,valid:l.errors.length===0,ruleCount:l.ruleNames.size,...l.errors.length>0?{errors:l.errors}:{}}}function qs(n,t){return{source:t,name:n.name,command:n.command,subcommand:n.subcommand,blockArgs:[...n.block_args],reason:n.reason}}function P1(n,t){let e=t?.userConfigPath??_(),r=t?.projectConfigPath??E(n),a=ks(e),l=o2({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),d=P({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),s=new Map(l.rulebooks.flatMap((c)=>c.rules.map((i)=>[i,c.source])));return{userConfig:_1(e,W2({userConfigPath:e}),a,d.userConfigTarget,d.userScope),projectConfig:_1(r,R2(r),a,d.projectConfigTarget,d.projectScope),effectiveRules:l.rules.map((c)=>qs(c,s.get(c.name)??"project")),shadowedRules:[]}}var js=[{flag:D.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:D.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:D.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:D.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:D.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:D.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:D.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:D.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function N1(){return[...js.map((n)=>({name:n.flag.name,value:Et(n.flag),isSet:_t(n.flag),legacyName:n.flag.legacyName,legacyValue:n.flag.legacyName?process.env[n.flag.legacyName]:void 0,legacyIsSet:n.flag.legacyName?process.env[n.flag.legacyName]!==void 0:void 0,description:n.description,defaultBehavior:n.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var I1={error:0,warning:1,info:2},Fs=["policy","config","audit"];function zs(n){return n.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var Bs=[{derive:(n)=>n.hooks.length>0&&n.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(n)=>n.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let e=v2(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${e} inspection failed`,detail:`Doctor could not verify the ${e} integration configuration.`,fixHint:`Correct the reported ${e} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(n)=>n.userConfig.exists&&!n.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.userConfig.path}]:[]},{derive:(n)=>n.projectConfig.exists&&!n.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.projectConfig.path}]:[]},{derive:(n)=>n.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${n.configState.reason}`,fixHint:"Correct the named source, run `cc-safety-net rule sync` for a rule source, then rerun doctor."}]:[]},{derive:(n)=>{let t=n.environment.find((e)=>e.name==="CC_SAFETY_NET_AUDIT_SCOPE");return Tt(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...Fs.map((n)=>({derive:(t)=>t.posture.directories.filter((e)=>e.kind===n&&e.status==="unsafe").map((e)=>({checkId:`posture.${n}-directory-unsafe`,severity:"error",title:`${n[0]?.toUpperCase()}${n.slice(1)} directory is unsafe`,detail:`The ${n} directory ${zs(e.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...e.path?{path:e.path}:{}}))})),{derive:(n)=>{let t=[...n.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function na(n){return Bs.flatMap((t,e)=>t.derive(n).map((r,a)=>({finding:r,catalogOrder:e,occurrence:a}))).sort((t,e)=>I1[t.finding.severity]-I1[e.finding.severity]||t.catalogOrder-e.catalogOrder||t.occurrence-e.occurrence).map((t)=>t.finding)}function I(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var Js=(n)=>I()?`\x1B[32m${n}\x1B[0m`:n,Zs=(n)=>I()?`\x1B[33m${n}\x1B[0m`:n,Qs=(n)=>I()?`\x1B[34m${n}\x1B[0m`:n,Xs=(n)=>I()?`\x1B[35m${n}\x1B[0m`:n,Ys=(n)=>I()?`\x1B[36m${n}\x1B[0m`:n,Ss=(n)=>I()?`\x1B[31m${n}\x1B[0m`:n,Hs=(n)=>I()?`\x1B[2m${n}\x1B[0m`:n,As=(n)=>I()?`\x1B[1m${n}\x1B[0m`:n,b={green:Js,yellow:Zs,blue:Qs,magenta:Xs,cyan:Ys,red:Ss,dim:Hs,bold:As},Ws="\x1B[0m",Rs=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function Ms(n){let t=n;return()=>{return t=(t*1664525+1013904223)%4294967296,t/4294967296}}function Vs(n){let t=[...Rs],e=Ms(n);for(let r=t.length-1;r>0;r--){let a=Math.floor(e()*(r+1)),l=t[r];t[r]=t[a],t[a]=l}return t}function Ks(n,t=0){if(!I())return"";let e=Vs(t);return`\x1B[38;5;${e[n%e.length]}m`}function ta(n,t,e=0){if(!I())return`"${n}"`;return`${Ks(t,e)}"${n}"${Ws}`}var Cs=new RegExp("\x1B\\[[0-9;]*m","g"),le=(n)=>n.replace(Cs,"").length;function m2(n){let t=(n.headers??n.rows[0]??[]).map((d,s)=>{let c=Math.max(...n.rows.map((i)=>le(i[s]??"")));return Math.max(le(d),c)}),e=(d,s)=>d+" ".repeat(Math.max(0,s-le(d))),r=(d,s)=>s[0]+t.map((c)=>d.repeat(c+2)).join(s[1])+s[2],a=(d)=>`│ ${d.map((s,c)=>e(s,t[c]??0)).join(" │ ")} │`,l=n.headers?[`   ${a(n.headers)}`,`   ${r("─",["├","┼","┤"])}`]:[];return[`   ${r("─",["┌","┬","┐"])}`,...l,...n.rows.map((d)=>`   ${a(d)}`),`   ${r("─",["└","┴","┘"])}`].join(`
`)}function ea(n){let t=[];t.push("Hook Integration"),t.push(Gs(n));let e=[],r=[];for(let a of n){let l=v2(a.platform);if(a.errors&&a.errors.length>0)for(let d of a.errors)if(a.configured)e.push({platform:l,message:d});else r.push({platform:l,message:d})}for(let a of e)t.push(`   Warning (${a.platform}): ${a.message}`);for(let a of r)t.push(b.red(`   Error (${a.platform}): ${a.message}`));return t.join(`
`)}function Gs(n){let t=["Platform","Discovery","Configuration","Inspection"],e=n.map((r)=>{let a=v2(r.platform);if(r.inspectionStatus==="not-inspected"){let c=b.dim("Not inspected");return[a,c,c,c]}let l=r.detected?b.green("Detected"):r.inspectionStatus==="failed"?b.red("Unknown"):b.dim("Not detected"),d=r.configured?b.green("Configured"):r.detected?b.yellow("Not configured"):r.inspectionStatus==="failed"?b.red("Unknown"):b.dim("Not applicable"),s=r.inspectionStatus==="verified"?b.green("Verified"):r.inspectionStatus==="failed"?b.red("Failed"):b.dim("Not applicable");return[a,l,d,s]});return m2({headers:t,rows:e})}function ra(n){let e=["Guard Engine Verification",`   Synthetic self-test: ${n.failed>0?b.red(`${n.passed}/${n.total} FAIL`):b.green(`${n.passed}/${n.total} passed`)}`],r=n.results.filter((a)=>!a.passed);if(r.length>0){e.push(""),e.push(b.red("   Failures:"));for(let a of r)e.push(b.red(`   • ${a.description}`)),e.push(b.red(`     expected ${a.expected}, got ${a.actual}`))}return e.join(`
`)}function Us(n){if(n.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],e=n.map((r)=>[r.source,r.name,r.subcommand?`${r.command} ${r.subcommand}`:r.command,r.blockArgs.join(", ")]);return m2({headers:t,rows:e})}function aa(n){let t=[];if(t.push("Configuration"),t.push(Os(n.userConfig,n.projectConfig)),t.push(""),n.effectiveRules.length>0)t.push(`   Effective rules (${n.effectiveRules.length} total):`),t.push(Us(n.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let e of n.shadowedRules)t.push(""),t.push(`   Note: Project rule "${e.name}" shadows user rule with same name`);return t.join(`
`)}function Os(n,t){let e=["Scope","Status"],r=(l)=>{if(!l.exists)return b.dim("N/A");if(!l.valid)return b.red(`Invalid (${l.errors?.[0]??"unknown error"})`);return b.green("Configured")},a=[["User",r(n)],["Project",r(t)]];return m2({headers:e,rows:a})}function la(n){let t=[];return t.push("Environment"),t.push(Ts(n)),t.join(`
`)}function da(n){let t=["Effective Safety",`   Selected preset: ${n.effectiveSafety.selectedPreset}`,`   Effective: ${n.effectiveSafety.level}`],e=[["fail_closed","fail_closed"],["paranoid_rm","paranoid_rm"],["paranoid_interpreters","paranoid_interpreters"]];for(let[r,a]of e){let l=n.effectiveSafety.capabilities[r],d=l.enabled?b.green("ON"):b.dim("OFF"),s=l.sources.length>0?` (${l.sources.join(", ")})`:"";t.push(`   ${a}: ${d} via ${l.source}${s}`)}t.push(`   Stored rule customizations: ${n.effectiveSafety.ruleCounts.stored}`),t.push(`   Effective rule customizations: ${n.effectiveSafety.ruleCounts.effective}`);for(let[r,a]of Object.entries(n.effectiveSafety.ruleOverrides))t.push(`   ${r}: ${a}`);return t.join(`
`)}function sa(n){let t=["Findings"];if(n.length===0)return t.push("   No findings from inspected doctor facts."),t.join(`
...
`)}function Ts(n){let t=["Variable","Status","Legacy"],e=n.map((r)=>{let a=r.isSet?b.green("✓"):b.dim("✗"),l=r.legacyName&&r.legacyIsSet?`${r.legacyName} ${b.green("✓")}`:r.legacyName??"";return[r.name,a,l]});return m2({headers:t,rows:e})}function ca(n){let t=[];if(n.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${n.totalBlocked} blocked / ${n.sessionCount} sessions)`),t.push(Es(n.recentEntries));if(n.unreadable>0)t.push(`   Warning: ${n.unreadable} audit log ${n.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function Es(n){let t=["Time","Command"],e=n.map((r)=>{let a=z(r.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),l=a.length>40?`${a.slice(0,37)}...`:a;return[r.relativeTime,l]});return m2({headers:t,rows:e})}function ia(n){let t=[];if(t.push("Update Check"),n.latestVersion===null&&!n.error)return t.push(Vn([["Status",b.dim("Skipped")],["Installed",n.currentVersion]])),t.join(`
`);if(n.error)return t.push(Vn([["Status",`${b.yellow("⚠")} Error`],["Installed",n.currentVersion],["Error",b.dim(n.error)]])),t.join(`
`);if(n.updateAvailable)return t.push(Vn([["Status",`${b.yellow("⚠")} Update Available`],["Current",n.currentVersion],["Latest",b.green(n.latestVersion??"")]])),t.push(""),t.push("   Run: bunx cc-safety-net@latest doctor"),t.push("   Or:  npx cc-safety-net@latest doctor"),t.join(`
`);return t.push(Vn([["Status",`${b.green("✓")} Up to date`],["Version",n.currentVersion]])),t.join(`
`)}function Vn(n){return m2({rows:n})}function La(n){let t=[];return t.push("System Info"),t.push(_s(n)),t.join(`
`)}function _s(n){let t=["Component","Version"],e=(l)=>{if(l===null)return b.dim("not found");return l},a=[{label:"cc-safety-net",value:n.version},{label:"Claude Code",value:n.claudeCodeVersion},{label:"Amp Code",value:n.ampVersion},{label:"Antigravity CLI",value:n.antigravityCliVersion},{label:"Codex",value:n.codexCliVersion},{label:"Cursor",value:n.cursorVersion},{label:"Gemini CLI",value:n.geminiCliVersion},{label:"GitHub Copilot CLI",value:n.copilotCliVersion},{label:"Hermes Agent",value:n.hermesAgentVersion},{label:"Kimi Code",value:n.kimiCodeVersion},{label:"OpenClaw",value:n.openClawVersion},{label:"OpenCode",value:n.openCodeVersion},{label:"Pi",value:n.piCliVersion},{label:"Node.js",value:n.nodeVersion},{label:"npm",value:n.npmVersion},{label:"Bun",value:n.bunVersion},{label:"Platform",value:n.platform}].map((l)=>[l.label,e(l.value)]);return m2({headers:t,rows:a})}function pa(n){if(n.findings.length===0)return b.green(`
...
${n.findings.length} ${r}: ${e.join(", ")}.`;if(t.error>0)return b.red(a);if(t.warning>0)return b.yellow(a);return b.blue(a)}import{lstatSync as Ps}from"node:fs";import{dirname as de}from"node:path";function se(n,t){try{let e=Ps(t);if(e.isSymbolicLink())return{kind:n,path:t,status:"unsafe",issues:["symlink"]};if(!e.isDirectory())return{kind:n,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:n,path:t,status:"unknown",issues:[]};let r=[...e.uid!==process.getuid()?["ownership"]:[],...(e.mode&18)!==0?["permissions"]:[]];return{kind:n,path:t,status:r.length>0?"unsafe":"safe",issues:r}}catch(e){if(typeof e==="object"&&e!==null&&"code"in e&&e.code==="ENOENT")return{kind:n,path:t,status:"not-applicable",issues:[]};return{kind:n,path:t,status:"unknown",issues:[]}}}function ua(n){let t=s2();return{directories:[se("policy",de(de(n))),se("config",de(n)),...t?[se("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as Ns}from"node:child_process";import{existsSync as oa}from"node:fs";import{delimiter as Is,extname as nc,join as tc}from"node:path";import{stripVTControlCharacters as va}from"node:util";var fa="2.0.1",ec=5000,rc="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function j(){return fa}function ce(n,t){let e=n[t];if(e)return e;let r=Object.keys(n).find((a)=>a.toLowerCase()===t.toLowerCase()&&!!n[a]);return r?n[r]:e}function ac(n){return(ce(n,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function lc(n,t){let e=nc(n)?[n]:[...ac(t).map((r)=>`${n}${r}`),n];if(n.includes("/")||n.includes("\\"))return e.find((r)=>oa(r))??n;return(ce(t,"PATH")??"").split(Is).flatMap((r)=>e.map((a)=>tc(r,a))).find((r)=>oa(r))??n}function ba(n){if(!/[\s"&|<>^]/.test(n))return n;return`"${n.replace(/"/g,'""')}"`}function ie(n,t){let[e,...r]=n,a=t[rc]==="win32"?"win32":process.platform;if(!e||a!=="win32")return{cmd:e??"",args:r};let l=lc(e,t);if(!/\.(?:bat|cmd)$/i.test(l))return{cmd:l,args:r};return{cmd:ce(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",ba(l),...r.map(ba)].join(" ")]}}var hn=async(n,t=ec)=>{let e=await dc(n,{timeoutMs:t});if(e.code!==0)return null;return va(e.stdout).trim()||va(e.stderr).trim()||null};function dc(n,t){let[e,...r]=n;if(!e)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((a)=>{try{let l=ie([e,...r],process.env),d=Ns(l.cmd,l.args,{stdio:["ignore","pipe","pipe"]}),s=!1,c="",i="";d.stdout.on("data",(v)=>{c+=v.toString()}),d.stderr.on("data",(v)=>{i+=v.toString()});let L=(v)=>{if(s)return;s=!0,clearTimeout(u),a(v)},u=setTimeout(()=>{d.kill(),L({code:null,stdout:c,stderr:i})},t.timeoutMs);d.on("close",(v)=>{L({code:v,stdout:c,stderr:i})}),d.on("error",()=>{L({code:null,stdout:c,stderr:i})})}catch{a({code:null,stdout:"",stderr:""})}})}function Q(n){if(!n)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(n);if(t)return t[1]??null;let e=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(n);if(e)return e[1]??null;return n.split(`
`)[0]?.trim()||null}async function wn(n=hn){let[t,e,r,a,l,d,s,c,i,L,u,v,p,f,o,y,x]=await Promise.all([n(["claude","--version"]),n(["agy","--version"]),n(["opencode","--version"]),n(["codex","--version"]),n(["codex","plugin","list"]),n(["gemini","--version"]),n(["copilot","--binary-version"]),n(["hermes","--version"]),n(["kimi","--version"]),n(["openclaw","--version"]),n(["pi","--version"]),n(["cursor","--version"]),n(["amp","--version"]),n(["amp","plugins","list"],30000),n(["node","--version"]),n(["npm","--version"]),n(["bun","--version"])]);return{version:fa,claudeCodeVersion:Q(t),antigravityCliVersion:Q(e),openCodeVersion:Q(r),codexCliVersion:Q(a),codexPluginListOutput:l,geminiCliVersion:Q(d),copilotCliVersion:Q(s),hermesAgentVersion:Q(c),kimiCodeVersion:Q(i),openClawVersion:Q(L),piCliVersion:Q(u),cursorVersion:Q(v),ampVersion:Q(p),ampPluginListOutput:f,nodeVersion:Q(o),npmVersion:Q(y),bunVersion:Q(x),platform:`${process.platform} ${process.arch}`}}function Le(n,t){if(t==="dev")return!1;let e=n.split(".").map(Number),r=t.split(".").map(Number),[a=0,l=0,d=0]=e,[s=0,c=0,i=0]=r;if(a!==s)return a>s;if(l!==c)return l>c;return d>i}async function T2(){let n=j(),t=new AbortController,e=setTimeout(()=>t.abort(),3000);try{let r=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!r.ok)return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${r.status}`};let a=await r.json(),l=Le(a.version,n);return{currentVersion:n,latestVersion:a.version,updateAvailable:l}}catch(r){return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:r instanceof Error?r.message:"Network error"}}finally{clearTimeout(e)}}import*as Da from"node:readline";var xa=(n)=>`\x1B[${n}B`,sc=(n)=>`\x1B[${n}A`;var ya=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function cc(n){return new Promise((t)=>setTimeout(t,n))}function ic(n,t,e){if(!e)return t(n);if(e.aborted)return Promise.resolve();return new Promise((r,a)=>{let l=()=>e.removeEventListener("abort",d),d=()=>{l(),r()};e.addEventListener("abort",d,{once:!0}),t(n).then(()=>{l(),r()},(s)=>{l(),a(s)})})}function xn(n,t){return n&&n>0?n:t}function Kn(n){return Math.max(0,Math.min(1,n))}function E2(n){return Math.max(0,Math.min(255,Math.round(n)))}function pe(n){return n<=0.0031308?12.92*n:1.055*n**0.4166666666666667-0.055}function Lc(n,t,e){let r=e*Math.PI/180,a=t*Math.cos(r),l=t*Math.sin(r),d=(n+0.3963377774*a+0.2158037573*l)**3,s=(n-0.1055613458*a-0.0638541728*l)**3,c=(n-0.0894841775*a-1.291485548*l)**3;return{blue:E2(pe(Kn(-0.0041960863*d-0.7034186147*s+1.707614701*c))*255),green:E2(pe(Kn(-1.2684380046*d+2.6097574011*s-0.3413193965*c))*255),red:E2(pe(Kn(4.0767416621*d-3.3077115913*s+0.2309699292*c))*255)}}function ue(n,t){let e=(t*n*180/Math.PI%360+360)%360;return Lc(0.72,0.15,e)}function $a(n,t=0.1){let e=ue(t,n);return`\x1B[38;2;${e.red};${e.green};${e.blue}m`}function pc(n,t){return{blue:E2(n.blue+(255-n.blue)*t),green:E2(n.green+(255-n.green)*t),red:E2(n.red+(255-n.red)*t)}}function ga(n,t,e){let r=Math.imul(n+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(e+374761393,2654435761),a=r^r>>>15,l=Math.imul(a,739982445),d=l^l>>>12,s=Math.imul(d,695872825);return((s^s>>>15)>>>0)/4294967296}function uc(n,t,e){let r=Math.floor(ga(n,t,e)*ya.length);return ya[r]??"░"}function ha(n){let t=Kn(n);return t*t*t*(t*(t*6-15)+10)}function oc(n){if(n.length===0)return"";let t=[],e=!1,r="";for(let a of n){let l=`${a.red};${a.green};${a.blue}`;if(a.bold!==e)t.push(a.bold?"\x1B[1m":"\x1B[22m"),e=a.bold;if(l!==r)t.push(`\x1B[38;2;${l}m`),r=l;t.push(a.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function vc(n,t,e,r,a){return n.map((l,d)=>({...ue(e,r+t+d/a),bold:!1,character:l}))}function bc(n,t,e,r,a,l,d,s){let c=Math.max(1,r*0.75),i=Math.min(1,e/c),L=a*ha(i),u=Math.max(0,(e-c)/Math.max(1,r-c)),v=(1-ha(e/r))*s*2,p=0.35*Math.max(0,1-u*2),f=i>=1,o=Math.min(n.length,Math.ceil(L+2+1));return n.slice(0,o).map((y,x)=>{let w=ue(l,d+t+x/s+v),h=x+ga(t,x,7919)*2-1;if(h>L+2)return{...w,bold:!1,character:" "};let J=L-h,J2=0.8*Math.exp(-(J*J)/12.5),rn=Math.min(0.9,J2+p),gt=!f&&h>L-4;return{...pc(w,rn),bold:rn>0.3,character:gt?uc(t,x,e):y}})}function wa(n){return`\x1B[?2026h${n.map((t,e)=>`\x1B8${e>0?xa(e):""}${oc(t)}`).join("")}\x1B[?2026l`}async function oe(n,t={}){if(!n)return;let e=t.output??process.stdout,r=t.sleep??cc,a=xn(t.frequency,0.1),l=t.seed??0,d=xn(t.speed,40),s=xn(t.spread,3),c=xn(t.frameRate,60),i=Math.max(1,Math.floor(xn(t.duration,12))),L=n.split(`
`).map((o)=>Array.from(o)),u=Math.max(...L.map((o)=>o.length)),v=1000*i*L.filter((o)=>o.length>0).length/d,p=u>0?Math.max(1,Math.ceil(v/(1000/c))):0,f=p>0?v/p:0;e.write(`\x1B[?25l${L.length>1?`${`
`.repeat(L.length-1)}${sc(L.length-1)}`:""}\x1B7`);try{for(let o=1;o<=p;o+=1){if(t.signal?.aborted)break;e.write(wa(L.map((y,x)=>bc(y,x,o,p,u,a,l,s)))),await ic(f,r,t.signal)}}finally{if(e.write(wa(L.map((o,y)=>vc(o,y,a,l,s)))),e.write("\x1B8"),L.length>1)e.write(xa(L.length-1));e.write(`
\x1B[0m\x1B[?25h`)}}var ma=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function fc(n){return Boolean(n.isTTY)}async function Cn(n={}){let t=n.output??process.stdout;if(!fc(t))return;let e=n.input??process.stdin,r={duration:n.duration,frequency:n.frequency,output:t,seed:n.seed??Math.random()*8192,sleep:n.sleep,speed:n.speed,spread:n.spread};if(!e.isTTY||typeof e.setRawMode!=="function"){await oe(ma,r);return}let a=new AbortController,l=e.readableFlowing===!0,d=e.isRaw===!0,s=!1,c=(i,L)=>{if(L.ctrl&&L.name==="c")s=!0;if(s||L.name==="return"||L.name==="enter")a.abort()};Da.emitKeypressEvents(e),e.on("keypress",c),e.setRawMode(!0),e.resume();try{await oe(ma,{...r,signal:a.signal})}finally{if(e.off("keypress",c),e.setRawMode(d),!l)e.pause()}if(!s)return;if(n.onInterrupt){n.onInterrupt();return}process.kill(process.pid,"SIGINT")}var ka="\r\x1B[2K",yc="\x1B[?25l",hc="\x1B[39m",wc="\x1B[?25h",xc=100,$c=0.55,gc=80,qa=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function mc(n){return new Promise((t)=>setTimeout(t,n))}async function ve(n,t={}){let e=t.output??process.stdout;if(!e.isTTY)return n;let r=t.sleep??mc,a=!1,l=n.then((s)=>{return a=!0,s},(s)=>{throw a=!0,s});if(await Promise.race([l.then(()=>!0),r(xc).then(()=>!1)]))return l;e.write(yc);try{for(let s=0;!a;s+=1)e.write(`${ka}${$a(s*$c)}${qa[s%qa.length]}${hc} ${t.loadingMessage??"Loading…"}`),await Promise.race([l,r(gc)]);return await l}finally{e.write(`${ka}${wc}`)}}async function Gn(n,t,e,r={}){let a=t();if(n)await e();if(n&&a.ready)await ve(a.ready,r);return a.finish()}import{homedir as Xi}from"node:os";import{stripVTControlCharacters as Dc}from"node:util";var Un="amp plugins list",kc=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function ja(n){if(!n.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=Dc(n.ampPluginListOutput).split(`
`).map((e)=>kc.exec(e)?.[1]).find((e)=>e!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:Un,configPath:Un,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:Un,configPath:Un}}import{existsSync as jc,readFileSync as Fc}from"node:fs";import{join as qc}from"node:path";function $n(n){return qc(n,".gemini","config","hooks.json")}var zc=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function Bc(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];return Object.values(n).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let e=t,r=e.PreToolUse;if(!Array.isArray(r))return[];return r.flatMap((a)=>{if(!a||typeof a!=="object"||Array.isArray(a))return[];let l=a.hooks;if(!Array.isArray(l))return[];return l.flatMap((d)=>{if(!d||typeof d!=="object"||Array.isArray(d))return[];let s=d.command;if(typeof s!=="string"||!zc.test(s))return[];return[{command:s,enabled:e.enabled!==!1}]})})})}function Fa(n){let t=$n(n.homeDir);if(!jc(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let e;try{e=Bc(JSON.parse(Fc(t,"utf-8")))}catch(r){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${r instanceof Error?r.message:String(r)}`]}}if(e.some((r)=>r.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(e.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as za}from"node:path";import{existsSync as Jc,lstatSync as Zc,readFileSync as Qc}from"node:fs";function n2(n,t=(e)=>e){if(!Jc(n))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(Qc(n,"utf-8")))}}catch{return{kind:"unreadable"}}}function S(n){try{return Zc(n)}catch{return}}function On(n,t){let e=S(t);if(!e)return{platform:n,status:"n/a",configPath:t};if(!e.isSymbolicLink()&&e.isDirectory())return;return{platform:n,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function $(n,t){return typeof n==="object"&&n!==null?n[t]:void 0}var be="cc-safety-net@cc-marketplace";function Ba(n){return za(n,".claude","plugins","installed_plugins.json")}function Ja(n,t){let e=$($(n,"plugins"),t);return Array.isArray(e)&&e.length>0}function Tn(n,t){let e=n2(Ba(n));return e.kind==="ok"&&Ja(e.value,t)}function fe(n){let t=Ba(n),e=n2(t);if(e.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(e.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!Ja(e.value,be))return{platform:"claude-code",status:"n/a"};let r=za(n,".claude","settings.json"),a=n2(r);if(a.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(a.kind==="ok"&&$($(a.value,"enabledPlugins"),be)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:r,errors:[`${be} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function Za(n){return fe(n.homeDir)}function Qa(n){if(!n.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=n.codexPluginListOutput.split(`
`).find((e)=>e.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as Pn,readdirSync as Xc,readFileSync as Yc}from"node:fs";import{join as M}from"node:path";var t2="cc-safety-net@cc-marketplace",En=["cc-marketplace","cc-safety-net"],Xa=["_direct","copilot-safety-net"],Ya=["cc-marketplace","safety-net"],Sa="safety-net@cc-marketplace";function _n(n,t){let e=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${e}([^a-z0-9-]|$)`,"m").test(n??"")}function Ha(n){return _n(n,"cc-safety-net@cc-marketplace")}function Aa(n){return _n(n,"cc-marketplace")}function Wa(n){return _n(n,"copilot-safety-net")}function Ra(n){return _n(n,"safety-net@cc-marketplace")}function R(n){let t="",e=0,r=!1,a=!1,l=-1;while(e<n.length){let d=n[e],s=n[e+1];if(a){t+=d,a=!1,e++;continue}if(d==='"'&&!r){r=!0,l=-1,t+=d,e++;continue}if(d==='"'&&r){r=!1,t+=d,e++;continue}if(d==="\\"&&r){a=!0,t+=d,e++;continue}if(r){t+=d,e++;continue}if(d==="/"&&s==="/"){while(e<n.length&&n[e]!==`
`)e++;continue}if(d==="/"&&s==="*"){e+=2;while(e<n.length-1){if(n[e]==="*"&&n[e+1]==="/"){e+=2;break}e++}continue}if(d===","){l=t.length,t+=d,e++;continue}if(d==="}"||d==="]"){if(l!==-1){let c=t.slice(l+1);if(/^\s*$/.test(c))t=t.slice(0,l)+c}l=-1,t+=d,e++;continue}if(!/\s/.test(d))l=-1;t+=d,e++}return t}function ye(n){if(!n?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(n)}function Va(n,t){if(!n)return null;let e=n.match(/(\d+)\.(\d+)\.(\d+)/);if(!e)return null;let r=[Number(e[1]),Number(e[2]),Number(e[3])];for(let a=0;a<t.length;a++){let l=r[a]??0,d=t[a]??0;if(l!==d)return l>d}return!0}function Sc(n){return Va(n,[0,0,422])}function Hc(n){return Va(n,[1,0,8])}function gn(n){return process.env.COPILOT_HOME||M(n,".copilot")}function we(n){return(n.hooks?.preToolUse??[]).some((e)=>{if(e.type!=="command")return!1;return ye(e.command)||ye(e.bash)||ye(e.powershell)})}function xe(n,t){try{return JSON.parse(R(Yc(n,"utf-8")))}catch(e){t?.push(`Failed to parse ${n}: ${e instanceof Error?e.message:String(e)}`);return}}function Ka(n,t){try{return Xc(n).filter((e)=>e.endsWith(".json")).sort((e,r)=>e.localeCompare(r))}catch(e){return t?.push(`Failed to read ${n}: ${e instanceof Error?e.message:String(e)}`),[]}}function Ac(n,t){if(!Pn(n))return[];let e=[];for(let r of Ka(n,t)){let a=M(n,r),l=xe(a,t);if(l&&we(l))e.push(a)}return e}function he(n,t){if(!Pn(n))return;let e=xe(n,t);if(!e)return;return{path:n,config:e}}function Ma(n,t,e,r){if(t){n.push(`GitHub Copilot CLI ${t} does not support ${e}; requires ${r}+`);return}n.push(`GitHub Copilot CLI version unavailable; skipping ${e} because it requires ${r}+`)}function Wc(n){let t=[n.localSettings,n.repoSettings,n.userConfig];for(let e of t){if(e?.config.disableAllHooks===!0)return e.path;if(e?.config.disableAllHooks===!1)return}return}function Rc(n,t,e,r){let a=gn(n),l=M(t,".github","hooks"),d=M(a,"hooks"),s=M(t,".github","copilot"),c=Hc(e),i=c===!0?r:void 0,L={userConfig:he(M(a,"config.json"),i),repoSettings:he(M(s,"settings.json"),i),localSettings:he(M(s,"settings.local.json"),i)};if(c!==!1){let w=Wc(L);if(w){if(c===null)r.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${w} as active`);return{activeConfigPaths:[],disabledBy:w}}}let u=Ac(l,r),v=Sc(e),p=v===!0?r:void 0,f=Pn(d)?Ka(d,p):[],o=[];for(let w of f){let h=M(d,w),J=xe(h,p);if(J&&we(J))o.push(h)}if(v!==!0&&o.length>0)Ma(r,e,`user hook files in ${d}`,"0.0.422"),o.length=0;let y=[],x=[L.localSettings,L.repoSettings,L.userConfig];for(let w of x){if(!w)continue;if(!we(w.config))continue;if(c===!0){y.push(w.path);continue}Ma(r,e,"inline hook definitions in Copilot config files","1.0.8");break}return{activeConfigPaths:[...y.filter((w)=>w.endsWith("settings.local.json")),...y.filter((w)=>w.endsWith("settings.json")),...u,...y.filter((w)=>w.endsWith("config.json")),...o]}}function Ca(n){let t=[],e=Rc(n.homeDir,n.cwd,n.copilotCliVersion,t);if(e.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:e.disabledBy,configPaths:[e.disabledBy],errors:t.length>0?t:void 0};let r=gn(n.homeDir),a=M(r,"installed-plugins",...En),l=Pn(a),d=M(r,"settings.json"),s=n2(d,R);if(l&&s.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(l&&s.kind==="ok"&&$($(s.value,"enabledPlugins"),t2)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:d,errors:[`${t2} is installed but not enabled in Copilot CLI`]};if(l||e.activeConfigPaths.length>0){let c=l,i=e.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:c?"plugin config":"hook config",configPath:i??(c?a:void 0),configPaths:e.activeConfigPaths.length>0?e.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as _c,readFileSync as Pc}from"node:fs";import{existsSync as Ga,mkdirSync as Kc,readFileSync as Cc}from"node:fs";import{dirname as Gc,join as Uc}from"node:path";import{renameSync as Mc,writeFileSync as Vc}from"node:fs";function B(n,t){let e=`${n}.${process.pid}.tmp`;Vc(e,t),Mc(e,n)}var mn="npx -y cc-safety-net hook --cursor",Ua=30;function In(n){return Uc(n,".cursor","hooks.json")}function D2(n){return typeof n==="object"&&n!==null&&!Array.isArray(n)}function $e(){return{command:mn,timeout:Ua,failClosed:!0}}function Nn(n){return D2(n)&&n.command===mn}function Oc(n){return Object.keys(n).length===3&&n.command===mn&&n.timeout===Ua&&n.failClosed===!0}function Tc(n){try{return JSON.parse(Cc(n,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${n}: ${t.message}`);throw t}}function Oa(n){let t=Tc(n);if(!D2(t))throw Error(`Cursor hooks config ${n} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${n} must set "version": 1`);if(t.hooks!==void 0&&!D2(t.hooks))throw Error(`Cursor hooks config ${n} "hooks" must be an object`);let e=D2(t.hooks)?t.hooks.preToolUse:void 0;if(e!==void 0&&!Array.isArray(e))throw Error(`Cursor hooks config ${n} "hooks.preToolUse" must be an array`);return t}function Ta(n){let t=D2(n.hooks)?n.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function Ec(n){if(!n.some(Nn))return[...n,$e()];return n.reduce((t,e)=>{if(!Nn(e))return t.result.push(e),t;if(!t.inserted)t.result.push($e()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function Ea(n,t,e){let r=D2(t.hooks)?t.hooks:{},a={...t,hooks:{...r,preToolUse:e}};B(n,`${JSON.stringify(a,null,2)}
`)}function _a(n){let t=In(n);if(!Ga(t))return Kc(Gc(t),{recursive:!0}),B(t,`${JSON.stringify({version:1,hooks:{preToolUse:[$e()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let e=Oa(t),r=Ta(e),a=r.filter(Nn);if(D2(e.hooks)&&Array.isArray(e.hooks.preToolUse)&&a.length===1&&a[0]!==void 0&&Oc(a[0]))return{path:t,alreadyInstalled:!0};return Ea(t,e,Ec(r)),{path:t,alreadyInstalled:!1}}function Pa(n){let t=In(n);if(!Ga(t))return{path:t,alreadyInstalled:!1};let e=Oa(t),r=Ta(e),a=r.filter((l)=>!Nn(l));if(a.length===r.length)return{path:t,alreadyInstalled:!1};return Ea(t,e,a),{path:t,alreadyInstalled:!0}}function Nc(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];let t=n.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let e=t.preToolUse;if(!Array.isArray(e))return[];return e.filter((r)=>!!r&&typeof r==="object"&&!Array.isArray(r)&&r.command===mn)}function Ic(n){let t=[];if(n.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let e=n[0];if(e&&e.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(e&&e.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function Na(n){let t=In(n.homeDir);if(!_c(t))return{platform:"cursor",status:"n/a",configPath:t};let e;try{e=JSON.parse(Pc(t,"utf-8"))}catch(l){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${l instanceof Error?l.message:String(l)}`]}}let r=Nc(e);if(r.length===0)return{platform:"cursor",status:"n/a",configPath:t};let a=Ic(r);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:a.length>0?a:void 0}}import{existsSync as ni}from"node:fs";import{join as ge}from"node:path";var me="gemini-safety-net";function De(n){let t=ge(n,".gemini","extensions"),e=ge(t,me);if(!ni(e))return{platform:"gemini-cli",status:"n/a"};let r=ge(t,"extension-enablement.json"),a=n2(r);if(a.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let l=a.kind==="ok"?$($(a.value,me),"overrides"):void 0;if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:r,errors:[`${me} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:e}}function Ia(n){return De(n.homeDir)}import{readFileSync as c0}from"node:fs";import{join as i0}from"node:path";var V="cc-safety-net",n0="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function t0(n){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${n}
`}function ti(n){return`${t0(n)}name: cc-safety-net
version: "${n}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function ei(n){return`${t0(n)}"""CC Safety Net guard for Hermes Agent.
...
`}function Dn(n){return[{name:"__init__.py",content:ei(n)},{name:"plugin.yaml",content:ti(n)}]}import{mkdirSync as ri,readdirSync as ai,readFileSync as li,rmSync as ke}from"node:fs";import{join as k2}from"node:path";var di="__pycache__";function qe(n){let t=process.env.HERMES_HOME?.trim();return t?t:k2(n,".hermes")}function je(n){return k2(qe(n),"plugins",V)}function Fe(n){return n.startsWith(n0)}function ze(n,t){let e=je(n),r=S(e);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${e}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return e}function e0(n,t){let e=S(n);if(!e)return;if(e.isSymbolicLink()||!e.isFile())throw Error(`Refusing to ${t} ${n}: not a regular file. Move or remove it.`);let r=li(n,"utf-8");if(!Fe(r))throw Error(`Refusing to ${t} unmanaged file at ${n}. Move or remove it.`);return r}function r0(n){let t=ze(n,"install"),e=Dn(j());if(e.map((a)=>e0(k2(t,a.name),"overwrite")).every((a,l)=>a===e[l]?.content))return{path:t,alreadyInstalled:!0};return ri(t,{recursive:!0}),e.forEach((a)=>{B(k2(t,a.name),a.content)}),{path:t,alreadyInstalled:!1}}function Be(n){let t=ze(n,"remove");if(!S(t))return[];return Dn(j()).filter((e)=>e0(k2(t,e.name),"remove")!==void 0)}function a0(n){let t=ze(n,"remove");if(!S(t))return{path:t,alreadyInstalled:!1};let e=Be(n);if(e.forEach((r)=>{ke(k2(t,r.name))}),ke(k2(t,di),{recursive:!0,force:!0}),ai(t).length===0)ke(t,{recursive:!0});return{path:t,alreadyInstalled:e.length>0}}var nt="hermes-agent",l0=/^([^\s#][^:]*):/,si=/^\s+([A-Za-z_][\w-]*):/,d0=/^\s+-\s*(.*)$/;function ci(n){return n.trim().replace(/^(["'])(.*)\1$/,"$2")}function ii(n){let t=n.split(/\r?\n/),e=t.findIndex((l)=>l0.exec(l)?.[1]?.trim()==="plugins");if(e===-1)return[];let r=t.slice(e+1),a=r.findIndex((l)=>l0.test(l));return a===-1?r:r.slice(0,a)}function s0(n,t){let e=ii(n),r=e.findIndex((d)=>si.exec(d)?.[1]===t);if(r===-1)return[];let a=e.slice(r+1),l=a.findIndex((d)=>!d0.test(d));return(l===-1?a:a.slice(0,l)).map((d)=>ci(d0.exec(d)?.[1]??""))}function Li(n){try{return c0(i0(qe(n),"config.yaml"),"utf-8")}catch{return}}function Je(n){let t=Li(n)??"";return s0(t,"enabled").includes(V)&&!s0(t,"disabled").includes(V)}function L0(n){return/^# version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function pi(n,t){let e=S(n);if(!e)return{error:`${t.name} is missing from ${n}; run install --hermes-agent`};if(e.isSymbolicLink()||!e.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{let r=c0(n,"utf-8");if(!Fe(r))return{error:`Unmanaged ${t.name} occupies ${n}; move or remove it`};if(L0(r)===j()&&r!==t.content)return{error:`Modified ${t.name} occupies ${n}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${n}: ${r instanceof Error?r.message:String(r)}`}}}function p0(n){let t=je(n.homeDir),e=On(nt,t);if(e)return e;let r=Dn(j()).map((s)=>pi(i0(t,s.name),s)),a=r.flatMap((s)=>("error"in s)?[s.error]:[]);if(a.length>0)return{platform:nt,status:"n/a",configPath:t,errors:a};let l=r.some((s)=>("content"in s)&&L0(s.content)!==j()),d=l?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!Je(n.homeDir))return{platform:nt,status:"disabled",method:"plugin directory",configPath:t,errors:[`${V} is not enabled in Hermes; run \`hermes plugins enable ${V}\``,...d]};return{platform:nt,status:"configured",method:"plugin directory",configPath:t,errors:l?d:void 0}}import{existsSync as ui,readFileSync as oi}from"node:fs";import{join as u0}from"node:path";var vi=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function bi(n){return u0(process.env.KIMI_CODE_HOME||u0(n,".kimi-code"),"config.toml")}function kn(n){let t=bi(n.homeDir);if(!ui(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!vi.test(oi(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(e){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${e instanceof Error?e.message:String(e)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as m0}from"node:fs";import{join as jn}from"node:path";var q="cc-safety-net",K="index.js",_2="openclaw.plugin.json",P2="package.json";var tt="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as hi,lstatSync as wi,readdirSync as xi,readFileSync as $i}from"node:fs";import{dirname as f0,join as q2}from"node:path";import{fileURLToPath as gi}from"node:url";import{spawn as fi}from"node:child_process";function yi(n){return n.join(" ")}function o0(n,t,e){return[`Failed to run ${yi(n)}${t===null?"":` (exit ${t})`}.`,e.trim()].filter(Boolean).join(`
`)}function Ze(n){let t={stdout:"",stderr:""};return n.stdout.setEncoding("utf-8"),n.stderr.setEncoding("utf-8"),n.stdout.on("data",(e)=>{t.stdout+=e}),n.stderr.on("data",(e)=>{t.stderr+=e}),t}function e2(n,t){return new Promise((e,r)=>{let a=fi(n[0],n.slice(1),{stdio:["ignore","pipe","pipe"]}),l=Ze(a),d=()=>[l.stdout,l.stderr].filter(Boolean).join(`
`);a.on("error",(s)=>{r(Error(o0(n,null,`${s.message}
${d()}`.trim())))}),a.on("close",(s)=>{if(s!==0){r(Error(o0(n,s,d())));return}e(t?.stdoutOnly?l.stdout:d())})})}async function Qe(n){for(let t of n)await e2(t)}async function v0(n){for(let t of n)try{await e2(t)}catch(e){console.warn(e instanceof Error?e.message:String(e))}}var b0=q2("openclaw",q),mi=[K,_2,P2];function y0(n){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return t;let e=process.env.OPENCLAW_CONFIG_PATH?.trim();return e?f0(e):q2(n,".openclaw")}function h0(n){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?t:q2(y0(n),"openclaw.json")}function Xe(n){return q2(y0(n),"extensions",q)}function Di(n){let t=xi(n);if(t.length===0)return!0;if(t.some((a)=>!mi.includes(a)))return!1;let e=q2(n,K),r=S(e);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&$i(e,"utf-8").startsWith(tt)}function Ye(n){let t=Xe(n),e=S(t);if(!e)return;if(!e.isSymbolicLink()&&e.isDirectory()&&Di(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function w0(){let n=f0(gi(import.meta.url));return[q2(n,"..",b0),q2(n,"..","..","..","dist",b0)]}function Se(n=w0()){return n.find((t)=>hi(t)&&wi(t).isDirectory())}function ki(n=w0()){let t=Se(n);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function x0(n=ki()){return[["openclaw","plugins","install",n,"--force"],["openclaw","plugins","enable",q]]}function qi(n){let t=(()=>{try{return JSON.parse(n)}catch{return}})(),e=$($(t,"plugin"),"status");return typeof e==="string"?e:void 0}async function $0(){let n=qi(await e2(["openclaw","plugins","inspect",q,"--runtime","--json"],{stdoutOnly:!0}));if(n==="loaded")return;throw Error(`${n===void 0?`The ${q} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${q} plugin with status "${n}".`} Run \`openclaw plugins inspect ${q} --runtime\` for details.`)}var et="openclaw",qn=`run \`openclaw plugins enable ${q}\``;function N2(n,t){let e=jn(n,t),r=S(e);if(!r)return{error:`${t} is missing from ${e}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{return{content:m0(e,"utf-8")}}catch(a){return{error:`Failed to read ${e}: ${a instanceof Error?a.message:String(a)}`}}}function D0(n){try{return JSON.parse(R(n))}catch{return}}function ji(n){let t=N2(n,_2);if("error"in t)return t.error;if($(D0(t.content),"id")===q)return;return`${jn(n,_2)} is not a valid ${q} manifest; run install --openclaw`}function Fi(n){let t=N2(n,P2);if("error"in t)return t.error;let e=$($(D0(t.content),"openclaw"),"extensions");if(Array.isArray(e)&&e.includes(`./${K}`))return;return`${jn(n,P2)} does not point OpenClaw at ${K}; run install --openclaw`}function g0(n){return Array.isArray(n)?n.filter((t)=>typeof t==="string"):[]}function zi(n){let t=h0(n);if(!S(t))return`${q} is not enabled; ${qn}`;let e=(()=>{try{return JSON.parse(R(m0(t,"utf-8")))}catch{return}})();if(e===void 0)return`Failed to read ${t}; fix it, then ${qn}`;let r=$(e,"plugins");if($(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let a=$($($(r,"entries"),q),"enabled");if(g0($(r,"deny")).includes(q)||a===!1)return`${q} is disabled in ${t}; ${qn}`;let l=g0($(r,"allow"));if(l.length>0&&!l.includes(q))return`plugins.allow in ${t} does not list ${q}; add it, then ${qn}`;if(l.includes(q)||a===!0)return;return`${q} is not enabled; ${qn}`}function k0(n){return/^\/\/ version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function Bi(n,t,e){if(e===void 0)return[];let r=N2(e,K);if("error"in r||k0(r.content)!==t)return[];return[K,_2,P2].flatMap((a)=>{let l=N2(n,a),d=N2(e,a);if("error"in l||"error"in d||l.content===d.content)return[];return[`Modified ${a} occupies ${jn(n,a)}; run install --openclaw to restore it`]})}function q0(n){let t=Xe(n.homeDir),e=On(et,t);if(e)return e;let r=N2(t,K),l=["error"in r?r.error:r.content.startsWith(tt)?void 0:`Unmanaged ${K} occupies ${jn(t,K)}; move or remove it`,ji(t),Fi(t)].filter((L)=>L!==void 0),d="content"in r?k0(r.content):void 0,s=l.length>0?l:Bi(t,d,Se());if(s.length>0)return{platform:et,status:"n/a",configPath:t,errors:s};let c=d===j()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],i=zi(n.homeDir);if(i)return{platform:et,status:"disabled",method:"plugin directory",configPath:t,errors:[i,...c]};return{platform:et,status:"configured",method:"plugin directory",configPath:t,errors:c.length>0?c:void 0}}import{existsSync as Ji,readFileSync as Zi}from"node:fs";import{join as j0}from"node:path";function F0(n){let t=[],e=j0(n.homeDir,".config","opencode"),r=["opencode.json","opencode.jsonc"];for(let a of r){let l=j0(e,a);if(Ji(l))try{let d=Zi(l,"utf-8"),s=R(d);if((JSON.parse(s).plugin??[]).some((u)=>u.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:l,errors:t.length>0?t:void 0}}catch(d){t.push(`Failed to parse ${a}: ${d instanceof Error?d.message:String(d)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as Qi}from"node:path";function He(n){return Qi(n,".pi","agent","settings.json")}function Ae(n){if(typeof n!=="string")return!1;return n==="npm:cc-safety-net"||n.startsWith("npm:cc-safety-net@")}function z0(n){let t=He(n.homeDir),e=n2(t);if(e.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(e.kind==="missing")return{platform:"pi",status:"n/a"};let r=$(e.value,"packages");if(!Array.isArray(r))return{platform:"pi",status:"n/a"};let a=r.find((s)=>Ae(typeof s==="string"?s:$(s,"source")));if(a===void 0)return{platform:"pi",status:"n/a"};let l=$(a,"extensions");if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var Yi={amp:ja,"antigravity-cli":Fa,"claude-code":Za,codex:Qa,"copilot-cli":Ca,cursor:Na,"gemini-cli":Ia,"hermes-agent":p0,"kimi-code":kn,openclaw:q0,opencode:F0,pi:z0};function I2(n,t){let e={...t,cwd:n,homeDir:t?.homeDir??Xi()};return q1.map((r)=>Si(Yi[r](e)))}function Si(n){if(n.status==="not-inspected")return{platform:n.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:n.platform,detected:n.status!=="n/a",configured:n.status==="configured",inspectionStatus:n.status!=="n/a"?"verified":n.errors&&n.errors.length>0?"failed":"not-applicable",method:n.method,configPath:n.configPath,configPaths:n.configPaths,errors:n.errors}}import{tmpdir as Hi}from"node:os";import{join as Ai}from"node:path";var Wi=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),Ri=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([])})})}),Mi={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}},sources:{failClosed:[],paranoidRm:[],paranoidInterpreters:[],worktreeMode:[]}};function B0(){let n=Ai(Hi(),"cc-safety-net-self-test"),t=Wi.map((e)=>{let r=Hn(M2("self-test",{command:e.command},{kind:"command",shell:"auto"},{configCwd:n,executionCwd:n},e.command),{guard:{dependencies:{loadPolicySnapshot:()=>Ri,getModes:()=>Mi,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),a=e.expectBlocked?"blocked":"allowed",l=r.decision.kind==="deny"?"blocked":"allowed";return{command:e.command,description:e.description,expected:a,actual:l,passed:a===l,reason:r.decision.kind==="deny"?r.decision.reason:void 0,ruleId:r.decision.kind==="deny"?r.decision.ruleId:void 0}});return{passed:t.filter((e)=>e.passed).length,failed:t.filter((e)=>!e.passed).length,total:t.length,results:t}}function We(n){let t=F({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},n);if(r2(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function J0(n={}){let t=await Gn(!n.json,()=>{let e=Vi(n);return{ready:e,finish:()=>e}},()=>Cn(),{loadingMessage:"Checking system status…"});if(n.json)console.log(JSON.stringify(t,null,2));else Ci(t);return Ki(t.hooks,t.engineSelfTest,{userConfig:t.userConfig,projectConfig:t.projectConfig})?1:0}async function Vi(n){let t=n.cwd??process.cwd(),e=await wn(),r=I2(t,{ampPluginListOutput:e.ampPluginListOutput,codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.copilotCliVersion}),a=P1(t),l=N1(),d=W({cwd:t}),s=d.policy,c=d2(s),i=$2(s,c.capabilities),L=Mn(7),u=n.skipUpdateCheck?{currentVersion:j(),latestVersion:null,updateAvailable:!1}:await T2(),v={hooks:r,engineSelfTest:B0(),userConfig:a.userConfig,projectConfig:a.projectConfig,configState:vn(d),effectiveRules:a.effectiveRules,shadowedRules:a.shadowedRules,environment:l,effectiveSafety:{selectedPreset:s.safety.level??"standard",level:c.effectiveLevel,capabilities:c.capabilities,ruleOverrides:s.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(i).filter(([,p])=>p.source==="rule_override"&&p.override==="off"&&p.inheritedEnabled&&p.changesInherited).map(([p])=>p),ruleCounts:{stored:Object.keys(s.destructiveCommandRuleOverrides).length,effective:Object.values(i).filter((p)=>p.changesInherited).length}},posture:ua(a.userConfig.path),activity:L,update:u,system:e};return{...v,findings:na(v)}}function Ki(n,t,e){return n.length>0&&n.every((r)=>!r.configured)||n.some((r)=>r.inspectionStatus==="failed")||t.failed>0||e.userConfig.exists&&!e.userConfig.valid||e.projectConfig.exists&&!e.projectConfig.valid}function Ci(n){console.log(),console.log(ea(n.hooks)),console.log(),console.log(ra(n.engineSelfTest)),console.log(),console.log(aa(n)),console.log(),console.log(la(n.environment)),console.log(),console.log(da(n)),console.log(),console.log(sa(n.findings)),console.log(),console.log(ca(n.activity)),console.log(),console.log(La(n.system)),console.log(),console.log(ia(n.update)),console.log(pa(n))}import{existsSync as Gi}from"node:fs";var Ui=/^[A-Za-z0-9_@%+=:,./-]+$/,Z0="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function Re(n){let t=F({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},n);if(r2(t.errors))return console.error(Z0),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!Gi(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let e=t.positionals.length===1?t.positionals[0]:t.positionals.map((r)=>Ui.test(r)?r:`'${r.replaceAll("'","'\\''")}'`).join(" ");if(!e)return console.error("Error: No command provided"),console.error(Z0),null;return{json:t.flags.json,cwd:t.values.cwd,command:e}}function Q0(n){if(n)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function X0(n,t){let r=t-18;return[`${n.dtl}${n.dh.repeat(t)}${n.dtr}`,`${n.dv}  Command Analysis${" ".repeat(r)}${n.dv}`,`${n.dbl}${n.dh.repeat(t)}${n.dbr}`]}function Me(n){return JSON.stringify(n)}function Y0(n,t=0){return`[${n.map((r,a)=>ta(r,a,t)).join(",")}]`}function rt(n,t,e=70){let r=n.split(" "),a=[],l="";for(let d of r)if(l&&l.length+d.length+1>e)a.push(l),l=d;else l=l?`${l} ${d}`:d;if(l)a.push(l);return a.map((d,s)=>s===0?d:`${t}${d}`)}function S0(n,t,e){let r=[];switch(n.type){case"parse":return null;case"env-strip":{r.push(""),r.push(`STEP ${t} ${e.h} Strip environment variables`);let a=Object.keys(n.envVars);return r.push(`  Removed: ${a.map((l)=>`${l}=<redacted>`).join(", ")}`),r.push(`  Tokens:  ${Me(n.output)}`),{lines:r,incrementStep:!0}}case"leading-tokens-stripped":return r.push(""),r.push(`STEP ${t} ${e.h} Strip wrappers`),r.push(`  Removed: ${n.removed.join(", ")}`),r.push(`  Tokens:  ${Me(n.output)}`),{lines:r,incrementStep:!0};case"shell-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Detect shell wrapper`),r.push(`  Wrapper: ${n.wrapper} -c`),r.push(`  Inner:   ${n.innerCommand}`),{lines:r,incrementStep:!0};case"interpreter":{if(r.push(""),r.push(`STEP ${t} ${e.h} Detect interpreter`),r.push(`  Interpreter: ${n.interpreter}`),r.push(`  Code:        ${n.codeArg}`),n.paranoidBlocked)r.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:r,incrementStep:!0}}case"busybox":return r.push(""),r.push(`STEP ${t} ${e.h} Busybox wrapper`),r.push(`  Subcommand: ${n.subcommand}`),{lines:r,incrementStep:!0};case"transparent-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Transparent wrapper`),r.push(`  Wrapper: ${n.wrapper}`),r.push(`  Tokens:  ${Me(n.output)}`),{lines:r,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{r.push(""),r.push(`STEP ${t} ${e.h} Match rules`);let a=`${n.ruleModule}:${n.ruleFunction}()`;if(r.push(`  Rule:   ${a}`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}case"worktree-relaxation":return r.push(""),r.push(`STEP ${t} ${e.h} Worktree relaxation`),r.push(`  Mode:   ${D.worktree.name}`),r.push(`  Git cwd: ${n.gitCwd}`),r.push("  Result: Allowed local discard in linked worktree"),{lines:r,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(n.embeddedCommandFound)return r.push(""),r.push(`STEP ${t} ${e.h} Fallback scan`),r.push(`  Found: ${n.embeddedCommandFound}`),{lines:r,incrementStep:!0};return null}case"custom-rules-check":{if(n.rulesChecked){if(r.push(""),r.push(`STEP ${t} ${e.h} Custom rules`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(n.matched)return r.push(""),r.push(`STEP ${t} ${e.h} Dangerous text check`),r.push(`  Token:  ${n.token}`),r.push("  Result: MATCHED"),{lines:r,incrementStep:!0};return null}case"strict-unparseable":return r.push(""),r.push(`STEP ${t} ${e.h} Strict mode check`),r.push(`  Command: ${n.rawCommand}`),r.push("  Result:  ✗ UNPARSEABLE"),{lines:r,incrementStep:!0};case"segment-skipped":return null;case"error":return r.push(""),r.push(`ERROR: ${n.message}`),{lines:r,incrementStep:!1};default:return null}}function Ve(n,t){let e=Q0(t?.asciiOnly??!1),r=58,a=[],l=1;a.push(...X0(e,58)),a.push("");let d=n.trace.steps.find((p)=>p.type==="error");if(d&&d.type==="error"){a.push("ERROR"),a.push(`  ${d.message}`),a.push(""),a.push("RESULT"),a.push(`  Status: ${n.result==="blocked"?b.red("BLOCKED"):b.green("ALLOWED")}`),a.push(""),a.push("CONFIG");let p=n.configSource??"none";return a.push(`  Path: ${p}`),a.join(`
`)}let s=n.trace.steps.find((p)=>p.type==="parse");if(s&&s.type==="parse"){a.push("INPUT"),a.push(`  ${s.input}`),a.push(""),a.push(`STEP ${l} ${e.h} Split shell commands`),l++;for(let p=0;p<s.segments.length;p++){let f=s.segments[p];if(f){let o=Math.random();a.push(`  Segment ${p+1}: ${Y0(f,o)}`)}}}let c=n.trace.segments,i=c.length>1;for(let p of c){if(i){a.push("");let x="";if(s&&s.type==="parse"){let mt=s.segments[p.index];if(mt)x=mt.join(" ")}let w=54,h=x,J=` Segment ${p.index+1}: `,J2=" ";if(x){if(J.length+x.length+J2.length>w){let Q3=w-J.length-J2.length;h=`${x.substring(0,Q3-1)}…`}}let rn=x?`${J}${h}${J2}`:` Segment ${p.index+1} `,gt=x?`${J}${b.cyan(h)}${J2}`:rn,hr=58-rn.length,wr=Math.floor(hr/2),Z3=hr-wr;a.push(`${e.sh.repeat(wr)}${gt}${e.sh.repeat(Z3)}`)}if(p.steps.find((x)=>x.type==="segment-skipped")){a.push(""),a.push("  (skipped — prior segment blocked)");continue}let o=!1,y=!1;for(let x of p.steps){let w=S0(x,l,e);if(w){if(y=!0,x.type==="recurse"){a.push("");let h=" RECURSING ",J=58-h.length-4;a.push(`  ${e.tl}${e.h}${h}${e.h.repeat(J)}`),a.push(`  ${e.v}`),o=!0;continue}for(let h of w.lines)if(o)a.push(`  ${e.v} ${h}`);else a.push(h);if(w.incrementStep)l++}}if(o)a.push(`  ${e.v}`),a.push(`  ${e.bl}${e.h.repeat(56)}`),o=!1;if(!y)a.push(""),a.push(`  ${b.green("✓")} Allowed (no matching rules)`)}if(a.push(""),a.push("RESULT"),n.result==="blocked"){if(a.push(`  Status: ${b.red("BLOCKED")}`),n.customRule){if(a.push(`  Rule: ${n.customRule.id}`),n.customRule.rulebook)a.push(`  Rulebook: ${n.customRule.rulebook.name} ${n.customRule.rulebook.version}`);if(n.customRule.source)a.push(`  Source: ${n.customRule.source}`);if(n.customRule.override)a.push(`  Override: reason ${n.customRule.override.reason}`)}if(n.reason){let p=rt(n.reason,"          ");a.push(`  Reason: ${p[0]}`);for(let f=1;f<p.length;f++)a.push(p[f]??"")}}else a.push(`  Status: ${b.green("ALLOWED")}`);a.push(""),a.push("CONFIG");let L=n.configSource??"none",u=n.configValid?"":" (invalid)";a.push(`  Path: ${L}${u}`),a.push(`  Safety preset: ${n.selectedPreset??"standard"}`),a.push(`  Effective capabilities: ${n.effectiveLevel}`);let v=Object.entries(n.destructiveCommandRuleOverrides??{});if(a.push(`  Rule customizations: ${v.length}`),n.ruleActivation)a.push(`  Rule activation: ${n.ruleActivation.id} — ${n.ruleActivation.enabled?"on":"off"} via ${n.ruleActivation.source}`);return a.join(`
`)}function Ke(n){return JSON.stringify(n,null,2)}var H0="2.0.1",C="  ",j2="cc-safety-net";function A0(n){return n.argument?`${n.flags} ${n.argument}`:n.flags}function Oi(n){return Math.max(...n.map((t)=>A0(t).length))}function Ti(n){return Math.max(...n.map((t)=>t.usage.length))}function Ei(n){return Math.max(...n.map((t)=>`${j2} ${t.usage}`.length))}function _i(n,t){let e=`${j2} ${n.usage}`;return`${C}${e.padEnd(t+2)}${n.description}`}function L2(n,t){return`${C}${n.padEnd(Math.max(40,n.length+2))}${t}`}function at(n,t=console.log){let e=[];if(e.push(`${j2} ${n.name}`),e.push(""),e.push(`${C}${n.description}`),e.push(""),e.push("USAGE:"),e.push(`${C}${j2} ${n.usage}`),e.push(""),n.subcommands&&n.subcommands.length>0){e.push("SUBCOMMANDS:");let r=Ti(n.subcommands);for(let a of n.subcommands)e.push(`${C}${a.usage.padEnd(r+2)}${a.description}`);e.push("")}if(n.options.length>0){e.push("OPTIONS:");let r=Oi(n.options);for(let a of n.options){let l=A0(a),d=a.default?`${a.description} (default: ${a.default})`:a.description;e.push(`${C}${l.padEnd(r+2)}${d}`)}e.push("")}if(n.examples&&n.examples.length>0){e.push("EXAMPLES:");for(let r of n.examples)e.push(`${C}${r}`)}t(e.join(`
`))}function Ce(){let n=E1(),t=Ei(n),e=[];e.push(`${j2} v${H0}`),e.push(""),e.push("Blocks destructive commands and secret access."),e.push(""),e.push("COMMANDS:");for(let r of n)e.push(_i(r,t));e.push(""),e.push("GLOBAL OPTIONS:"),e.push(`${C}-h, --help       Show help (use with command for command-specific help)`),e.push(`${C}-V, --version    Show version`),e.push(""),e.push("HELP:"),e.push(`${C}${j2} help <command>     Show help for a specific command`),e.push(`${C}${j2} <command> --help   Show help for a specific command`),e.push(""),e.push("ENVIRONMENT VARIABLES:"),e.push(L2(`${D.level.name}=standard|strict|paranoid`,"Set session safety level")),e.push(L2(`${D.worktree.name}=1`,"Allow local git discards in linked worktrees")),e.push(L2(`${D.debug.name}=1`,"Print diagnostic messages to stderr")),e.push(L2(`${D.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),e.push(L2("CC_SAFETY_NET_HOME","Override rule config home directory")),e.push(""),e.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),e.push(L2(`${D.strict.name}=1`,"Force safety.overrides.fail_closed on")),e.push(L2(`${D.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),e.push(L2(`${D.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),e.push(L2(`${D.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),e.push(""),e.push("Documentation:        https://ccsafetynet.com/docs"),console.log(e.join(`
`))}function W0(){console.log(H0)}function Fn(n,t=console.log){let e=Rn(n);if(!e)return!1;if(e.hidden||e.name.toLowerCase()!==n.toLowerCase())return!1;return at(e,t),!0}import{existsSync as dr,readFileSync as Ml}from"node:fs";import{homedir as EL}from"node:os";import{join as ar}from"node:path";import*as f2 from"node:readline";function Pi(n){return n==="install"?"Install":"Uninstall"}function Ni(n){return n==="install"?"Installing":"Uninstalling"}function Ii(n){return n==="install"?"into":"from"}function V0(n){return n?.available===!0}function nL(n,t){let e=new Set(t);return n.filter((r)=>e.has(r.target)).map((r)=>r.target)}function R0(n,t,e){if(n.length===0||n.every((r)=>!r.available))return t;return Array.from({length:n.length},(r,a)=>a+1).map((r)=>(t+r*e+n.length)%n.length).find((r)=>V0(n[r]))}function tL(n,t,e){if(e.ctrl&&e.name==="c")return"interrupt";if(e.name==="escape"||t==="q")return"abort";if(n==="install"&&(t==="u"||t==="U"))return"update";if(e.name==="up"||t==="k")return"up";if(e.name==="down"||t==="j")return"down";if(e.name==="space"||t===" ")return"toggle";if(e.name==="return"||e.name==="enter")return"confirm";return null}function eL(n){return{cursor:n.findIndex((t)=>t.available),selected:[]}}function rL(n,t,e){if(e==="confirm"||e==="update"||e==="abort"||e==="interrupt")return{state:n,done:e};if(e==="up")return{state:{...n,cursor:R0(t,n.cursor,-1)}};if(e==="down")return{state:{...n,cursor:R0(t,n.cursor,1)}};let r=t[n.cursor];if(!V0(r))return{state:n};let a=n.selected.includes(r.target)?n.selected.filter((l)=>l!==r.target):nL(t,[...n.selected,r.target]);return{state:{...n,selected:a}}}var K0="◉",C0="◯",G0=">",U0=" ";function aL(n,t,e,r={}){let a=r.color!==!1,l=a?b.dim:(c)=>c,d=a?b.green:(c)=>c,s=a?b.bold:(c)=>c;return["",`${Pi(n)} CC Safety Net ${Ii(n)}:`,"",...t.map((c,i)=>{let L=e.selected.includes(c.target),u=i===e.cursor,v=L?K0:C0,p=u?G0:U0,f=c.available?"":` (${c.unavailableReason??"not installed"})`,o=`${v} ${c.label}${f}`,y=!c.available?l(o):L?d(o):u?s(o):o;return`${p} ${y}`}),"",n==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((c)=>c.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${n}. q/Esc: close`].join(`
`)}var M0=["global-hook","plugin"];function lL(n,t,e={}){let r=e.color!==!1?b.bold:(l)=>l;return["","Install the Kimi Code integration as:","",...[`Global hook — ${t?"already installed; selecting it reports the current state":"write the hook into ~/.kimi-code/config.toml now"}`,"Native Kimi plugin — print the steps to run inside Kimi Code"].map((l,d)=>{let s=d===n,c=`${s?K0:C0} ${l}`;return`${s?G0:U0} ${s?r(c):c}`}),"","Enter: confirm  Up/Down: move  q/Esc: cancel"].join(`
`)}function O0(n){let{input:t,output:e}=n;f2.emitKeypressEvents(t);let r=t.isRaw===!0;t.setRawMode(!0),t.resume();let a=0,l=()=>{if(a===0)return;f2.moveCursor(e,0,-a),f2.cursorTo(e,0),f2.clearScreenDown(e)},d=()=>{l();let s=n.render();e.write(`${s}
`),a=s.split(`
`).length};return new Promise((s)=>{let c=(L)=>{t.off("keypress",i),t.setRawMode(r),t.pause(),l(),s(L)};function i(L,u){n.onKey(L,u,{finish:c,draw:d})}t.on("keypress",i),d()})}function T0(n={}){let t=0;return O0({input:n.input??process.stdin,output:n.output??process.stdout,render:()=>lL(t,n.globalHookInstalled===!0),onKey:(e,r,a)=>{if(r.ctrl&&r.name==="c"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(r.name==="escape"||e==="q")return a.finish(null);if(r.name==="return"||r.name==="enter")return a.finish(M0[t]);if(r.name==="up"||r.name==="down"||e==="k"||e==="j")t=(t+1)%M0.length,a.draw()}})}function Ge(n=process.stdin,t=process.stdout){return Boolean(n.isTTY&&t.isTTY&&typeof n.setRawMode==="function")}function E0(n,t,e={}){let r=e.output??process.stdout,a=eL(t);return O0({input:e.input??process.stdin,output:r,render:()=>aL(n,t,a),onKey:(l,d,s)=>{let c=tL(n,l,d);if(!c)return;let i=rL(a,t,c);if(a=i.state,i.done==="interrupt"){s.finish(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(i.done==="abort")return s.finish(null);if(i.done==="update")return s.finish("update");if(i.done==="confirm"){if(a.selected.length===0){r.write("\x07"),s.draw();return}s.finish([...a.selected]),r.write(`${Ni(n)} selected integrations...
`);return}s.draw()}})}import{existsSync as P0,lstatSync as N0,mkdtempSync as sL,readFileSync as ct,rmSync as I0}from"node:fs";import{tmpdir as cL}from"node:os";import{dirname as iL,join as F2}from"node:path";import{fileURLToPath as LL}from"node:url";var Ue="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp";import{spawn as dL}from"node:child_process";var Oe=(n,t)=>{let e=ie([...n],process.env);return new Promise((r)=>{let a=dL(e.cmd,e.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),l=Ze(a),d=!1,s=setTimeout(()=>{d=!0,a.kill()},120000);a.on("error",(c)=>{clearTimeout(s),r({status:null,errorCode:c.code,stdout:l.stdout,stderr:[c.message,l.stderr].filter(Boolean).join(`
`)})}),a.on("close",(c)=>{clearTimeout(s),r({status:d?null:c,errorCode:d?"ETIMEDOUT":void 0,stdout:l.stdout,stderr:l.stderr})})})};var _0=F2("amp","cc-safety-net.ts"),p2="cc-safety-net.ts";function pL(n){return F2(n,".config","amp","plugins",p2)}function uL(){let n=iL(LL(import.meta.url));return[F2(n,"..",_0),F2(n,"..","..","..","dist",_0)]}function oL(n=uL()){let t=n.find((e)=>P0(e)&&N0(e).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function nl(n){try{return N0(n)}catch{return}}function tl(n){try{return JSON.parse(n)}catch{return}}function el(n){return n.subarray(0,Buffer.byteLength(Ue)).toString("utf-8")===Ue}async function lt(n,t,e){let r=await n(t,e);if(r.status===0)return;throw Error([`Failed to run ${t.join(" ")}${r.status===null?"":` (exit ${r.status})`}.`,[r.stdout,r.stderr].filter(Boolean).join(`
...
`)}`.trim());let e=tl(t.stdout),r=(Array.isArray(e)?e:[]).filter((a)=>$(a,"scope")==="user"&&$(a,"exists")===!0&&$(a,"viewerCanWrite")===!0).map((a)=>$(a,"cloneRef")).find((a)=>typeof a==="string"&&a.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}async function al(n,t){let e=sL(F2(cL(),"cc-safety-net-amp-"));try{return await lt(n,["amp","clone","user-plugins",e]),await t(e)}finally{I0(e,{recursive:!0,force:!0})}}function ll(n,t){let e=F2(n,p2),r=nl(e);if(!r)return;if(r.isSymbolicLink()||!r.isFile())throw Error(`Refusing to ${t} ${p2} in your Amp personal plugins repository: not a regular file. Remove it there and rerun install --amp.`);let a=ct(e);if(el(a))return a;throw Error(`Refusing to ${t} unmanaged file ${p2} in your Amp personal plugins repository. Remove it there and rerun install --amp.`)}async function dl(n,t,e,r){await lt(n,e,t);let a=await n(["git","status","--porcelain"],t);if(a.status===0&&a.stdout.trim()==="")return!1;return await lt(n,["git","-c","commit.gpgsign=false","commit","-m",r],t),await lt(n,["git","push","origin","HEAD"],t),!0}function dt(n){let t=pL(n),e=nl(t);if(!e||e.isSymbolicLink()||!e.isFile())return;if(!el(ct(t)))return;I0(t)}function vL(){let n=on();if(!P0(n))return"";let t=tl(ct(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(st(t))};
`}async function sl(n,t=oL(),e=Oe){let r=Buffer.concat([ct(t),Buffer.from(vL(),"utf-8")]),a=await rl(e);return al(e,async(l)=>{let d=`${a}/${p2}`;if(ll(l,"overwrite")?.equals(r))return dt(n),{path:d,alreadyInstalled:!0};B(F2(l,p2),r);let s=await dl(e,l,["git","add",p2],`chore: update cc-safety-net plugin to v${j()}`);return dt(n),{path:d,alreadyInstalled:!s}})}async function cl(n,t=Oe){let e=await rl(t);return al(t,async(r)=>{let a=`${e}/${p2}`;if(!ll(r,"remove"))return dt(n),{path:a,alreadyInstalled:!1};return await dl(t,r,["git","rm",p2],`chore: remove cc-safety-net plugin v${j()}`),dt(n),{path:a,alreadyInstalled:!0}})}import{existsSync as il,mkdirSync as bL,readFileSync as fL}from"node:fs";import{dirname as yL}from"node:path";var Te="npx -y cc-safety-net hook --agy-cli",y2="cc-safety-net";function Lt(){return{PreToolUse:[{hooks:[{type:"command",command:Te,timeout:30}]}]}}function Ll(n){try{let t=JSON.parse(fL(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${n}: ${t.message}`);throw t}}function pl(n){let t=n[y2];if(t===void 0)return n[y2]=Lt(),n[y2];if(!t||typeof t!=="object"||Array.isArray(t))throw Error(`Antigravity hooks config entry "${y2}" must be an object`);if(!Array.isArray(t.PreToolUse))t.PreToolUse=[];return t}function ul(n){if(!Array.isArray(n.PreToolUse))return!1;return n.PreToolUse.some((t)=>Array.isArray(t.hooks)&&t.hooks.some((e)=>e.command===Te))}function hL(n){return Object.values(n).some((t)=>t.enabled!==!1&&ul(t))}function wL(n){if(n[y2]===void 0)return!1;let t=pl(n);if(t.enabled!==!1||!ul(t))return!1;return t.enabled=!0,!0}function xL(n){if(n[y2]===void 0){n[y2]=Lt();return}let t=pl(n);t.PreToolUse??=[],t.enabled=!0,t.PreToolUse.push(Lt().PreToolUse?.[0]??{hooks:[]})}function $L(n){let t=!1;for(let e of Object.values(n)){if(!Array.isArray(e.PreToolUse))continue;e.PreToolUse=e.PreToolUse.flatMap((r)=>{if(!Array.isArray(r.hooks))return[r];let a=r.hooks.filter((l)=>l.command!==Te);if(a.length!==r.hooks.length)t=!0;return a.length===0?[]:[{...r,hooks:a}]})}return t}function it(n,t){B(n,`${JSON.stringify(t,null,2)}
`)}function ol(n){let t=$n(n);if(bL(yL(t),{recursive:!0}),!il(t))return it(t,{[y2]:Lt()}),{path:t,alreadyInstalled:!1};let e=Ll(t);if(hL(e))return{path:t,alreadyInstalled:!0};if(wL(e))return it(t,e),{path:t,alreadyInstalled:!1};return xL(e),it(t,e),{path:t,alreadyInstalled:!1}}function vl(n){let t=$n(n);if(!il(t))return{path:t,alreadyInstalled:!1};let e=Ll(t);if(!$L(e))return{path:t,alreadyInstalled:!1};return it(t,e),{path:t,alreadyInstalled:!0}}import{spawn as gL,spawnSync as mL}from"node:child_process";var G=i2.map((n)=>({target:n.id,flag:n.flag,label:n.installLabel,probeCommand:n.probeCommand})),bl=new Map(G.map((n)=>[n.flag,n.target]));function Ee(n){let t=new Set(n);return G.map((e)=>e.target).filter((e)=>t.has(e))}async function fl(n,t){for(let e of n)await t(e)}var yl=5000;function DL(n){let t=mL(n[0],n.slice(1),{env:process.env,stdio:"ignore",timeout:yl});return!t.error&&t.status===0}function Pe(n){return new Promise((t)=>{let e=gL(n[0],n.slice(1),{env:process.env,stdio:"ignore"}),r=!1,a=(d)=>{if(r)return;r=!0,clearTimeout(l),t(d)},l=setTimeout(()=>{e.kill(),a(!1)},yl);e.on("error",()=>a(!1)),e.on("close",(d)=>a(d===0))})}function kL(n=DL,t={}){let e=new Set(t.configuredTargets??[]);if(t.async)return Promise.all(G.map(async(a)=>({target:a.target,flag:a.flag,label:a.label,..._e(t.action,await n(a.probeCommand),e.has(a.target))})));let r=n;return G.map((a)=>({target:a.target,flag:a.flag,label:a.label,..._e(t.action,r(a.probeCommand),e.has(a.target))}))}function hl(n=Pe,t={}){return kL(n,{...t,async:!0})}function wl(n,t){let e=new Set(t.configuredTargets??[]);return n.map((r)=>({...r,..._e(t.action,r.available,e.has(r.target))}))}function _e(n,t,e){if(n==="uninstall")return e?{available:!0}:{available:!1,unavailableReason:"not installed"};if(n==="install"&&e)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as xl,readdirSync as qL,rmSync as jL}from"node:fs";import{join as nn}from"node:path";function Ne(n,t=process.platform){let e=nn(process.env.npm_config_cache||(t==="win32"?nn(process.env.LOCALAPPDATA||nn(n,"AppData","Local"),"npm-cache"):nn(n,".npm")),"_npx");if(!xl(e))return;qL(e).filter((r)=>xl(nn(e,r,"node_modules","cc-safety-net"))).forEach((r)=>{jL(nn(e,r),{recursive:!0,force:!0})})}import{existsSync as Dl,mkdirSync as zL,readFileSync as kl}from"node:fs";import{dirname as BL,join as ml}from"node:path";function $l(n){return n!==void 0&&/\s/.test(n)}function FL(n,t,e){let r=t+1,a=!1;while(r<n.length){let l=n[r];if(a){a=!1,r++;continue}if(l==="\\"){a=!0,r++;continue}if(l==='"')return r+1;r++}throw Error(e)}function pt(n,t,e){let r=n[t],a=r==="["?"]":"}",l=0,d=t;while(d<n.length){let s=e.skipComment?.(n,d)??d;if(s!==d){d=s;continue}if(n[d]==='"'){d=FL(n,d,e.stringError);continue}if(n[d]===r)l++;if(n[d]===a){if(l--,l===0)return d}d++}throw Error(e.bracketError)}function gl(n,t){let e=n.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(n.slice(e))?.[0]??""}function ut(n,t){let{start:e,end:r,end:a}=t;while($l(n[a]))a++;if(n[a]===","){if(r=a+1,n[r]===`
`)r++;return`${n.slice(0,e)}${n.slice(r)}`}a=t.start-1;while($l(n[a]))a--;if(n[a]===","){e=a;let l=n.lastIndexOf(`
`,e-1);if(l!==-1&&/^\s*$/.test(n.slice(l+1,e)))e=l}return`${n.slice(0,e)}${n.slice(r)}`}var zn="npx -y cc-safety-net hook --kimi-code",Ie=`[[hooks]]
event = "PreToolUse"
command = "${zn}"`,nr=`{ event = "PreToolUse", command = "${zn}" }`;function ql(n){return ml(process.env.KIMI_CODE_HOME??ml(n,".kimi-code"),"config.toml")}function JL(n){return n.split(`
...
`)}function ZL(n,t){if(n[t]!=="#")return t;let e=n.indexOf(`
`,t+1);return e===-1?n.length:e+1}function QL(n,t){return pt(n,t,{skipComment:ZL,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function jl(n){let t=!1,e=0;while(e<n.length){let r=n.indexOf(`
`,e),a=r===-1?n.length:r,l=n.slice(e,a);if(/^\s*\[/.test(l))t=!0;if(!t){let d=/^(\s*)hooks\s*=\s*\[/.exec(l);if(d){let s=e+d[0].lastIndexOf("[");return{start:s,end:QL(n,s)}}}e=r===-1?n.length:r+1}return}function XL(n,t){let e=n.slice(0,t.end).trimEnd(),r=gl(n,t.end),a=r===""?"     ":`${r}  `,l=!e.endsWith("[")&&!e.endsWith(",");return`${e}${l?",":""}
${a}${nr}${n.slice(t.end)}`}function YL(n){let t=jl(n);if(t&&n.slice(t.start+1,t.end).trim())return XL(n,t);let e=JL(n).trimEnd();if(e==="")return`${Ie}
`;return`${e}

${Ie}
`}function SL(n){return n.split(/(?=^\s*\[)/m).filter((e)=>!/^\s*\[\[hooks]]\s*$/m.test(e)||!e.includes(zn)).join("").trimEnd()}function HL(n,t){let e=n.indexOf(nr,t.start);if(e===-1||e>t.end)return n;return ut(n,{start:e,end:e+nr.length})}function Fl(n){let t=ql(n);if(zL(BL(t),{recursive:!0}),!Dl(t))return B(t,`${Ie}
`),{path:t,alreadyInstalled:!1};let e=kl(t,"utf-8");if(e.includes(zn))return{path:t,alreadyInstalled:!0};return B(t,YL(e)),{path:t,alreadyInstalled:!1}}function zl(n){let t=ql(n);if(!Dl(t))return{path:t,alreadyInstalled:!1};let e=kl(t,"utf-8");if(!e.includes(zn))return{path:t,alreadyInstalled:!1};let r=jl(e),a=r?HL(e,r):`${SL(e)}
`;return B(t,a),{path:t,alreadyInstalled:!0}}import{existsSync as Bl,readFileSync as AL,rmSync as WL}from"node:fs";import{join as tr}from"node:path";var er="cc-safety-net",RL=`${er}@latest`,Zl=["opencode.json","opencode.jsonc"];function ML(n){return tr(n,".config","opencode",Zl[0])}function VL(n){return Zl.map((t)=>tr(n,".config","opencode",t))}function KL(n){return tr(n,".cache","opencode","packages",RL)}function rr(n){WL(KL(n),{recursive:!0,force:!0})}function ot(n,t){if(n[t]==="/"&&n[t+1]==="/"){let e=n.indexOf(`
`,t+2);return e===-1?n.length:e+1}if(n[t]==="/"&&n[t+1]==="*"){let e=n.indexOf("*/",t+2);return e===-1?n.length:e+2}return t}function Jl(n,t){let e=t;while(e<n.length){if(/\s/.test(n[e]??"")){e++;continue}let r=ot(n,e);if(r===e)return e;e=r}return e}function Ql(n,t){let e=t+1,r=!1;while(e<n.length){if(r){r=!1,e++;continue}if(n[e]==="\\"){r=!0,e++;continue}if(n[e]==='"')return e+1;e++}throw Error("Unterminated string in OpenCode config")}function Xl(n,t,e){return JSON.parse(n.slice(t,e))}function CL(n,t){return pt(n,t,{skipComment:ot,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function GL(n){let t=0,e=0;while(e<n.length){let r=ot(n,e);if(r!==e){e=r;continue}if(n[e]==='"'){let a=Ql(n,e);if(t===1&&Xl(n,e,a)==="plugin"){let l=Jl(n,a),d=Jl(n,l+1);if(n[l]===":"&&n[d]==="[")return{start:d,end:CL(n,d)}}e=a;continue}if(n[e]==="{"||n[e]==="[")t++;if(n[e]==="}"||n[e]==="]")t--;e++}return}function UL(n,t){let e=[],r=t.start+1;while(r<t.end){let a=ot(n,r);if(a!==r){r=a;continue}if(n[r]==='"'){let l=Ql(n,r),d=Xl(n,r,l);if(typeof d==="string"&&d.includes(er))e.push({start:r,end:l});r=l;continue}r++}return e}function Yl(n,t){try{return JSON.parse(R(n))}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${e.message}`);throw e}}function OL(n){if(!n||typeof n!=="object"||Array.isArray(n))return!1;let t=n.plugin;if(!Array.isArray(t))return!1;return t.some((e)=>typeof e==="string"&&e.includes(er))}function TL(n,t){let e=GL(n);if(!e)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let r=[...UL(n,e)].reverse().reduce(ut,n);return Yl(r,t),r}function Sl(n){rr(n);let t=VL(n),e=t.find((a)=>Bl(a)),r=[];for(let a of t){if(!Bl(a))continue;try{let l=AL(a,"utf-8");if(!OL(Yl(l,a)))continue;return B(a,TL(l,a)),{path:a,alreadyInstalled:!0}}catch(l){r.push(l instanceof Error?l.message:String(l))}}if(r.length>0)throw Error(r.join(`
`));return{path:e??ML(n),alreadyInstalled:!1}}var lr="safety-net@cc-marketplace",Hl=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]);function sr(n){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(n??"")}function Vl(n){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(n??"")}function _L(n){return/^Marketplace `cc-marketplace`\s*$/m.test(n??"")}var Kl={"claude-code":{installCommands:(n)=>{let t=Tn(n,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...fe(n).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:Tn(n,lr)?[["claude","plugin","uninstall",lr]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:async()=>{let n=await e2(["codex","plugin","list"]),t=Vl(n);return{commands:[t||_L(n)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:sr(n)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:t}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:async()=>{let n=await e2(["copilot","plugin","list"]),t=[...Wa(n)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...Ra(n)?[["copilot","plugin","uninstall",Sa]]:[]];if(Ha(n))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",t2]],cleanupCommands:t,update:!0};return{commands:[Aa(await e2(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",t2]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(n)=>{let t=De(n);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:Ye,installCommands:()=>({commands:x0()}),uninstallCommands:[["openclaw","plugins","uninstall",q,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:rr,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function cr(){return process.env.HOME??EL()}function Cl(n,t=(e)=>e){try{let e=JSON.parse(t(Ml(n,"utf-8")));if(!e||typeof e!=="object"||Array.isArray(e))throw Error(`Settings file ${n} must be a JSON object`);return e}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse ${n}: ${e.message}`);throw e}}function PL(n){let t=ar(gn(n),"settings.json");if(!dr(t))return;let e=Cl(t,R),r=e.enabledPlugins;if(!r||typeof r!=="object"||Array.isArray(r))return;if(r[t2]!==!1)return;let a=Ml(t,"utf-8"),l=a.replace(new RegExp(`("${t2}"\\s*:\\s*)false`),"$1true");return r[t2]=!0,B(t,l!==a?l:`${JSON.stringify(e,null,2)}
`),`Enabled ${t2} plugin in ${t}`}function NL(n){let t=He(n);if(!dr(t))return;let e=Cl(t);if(!Array.isArray(e.packages))return;let r=e.packages.find((a)=>!!a&&typeof a==="object"&&!Array.isArray(a)&&Ae(a.source)&&("extensions"in a));if(!r)return;return delete r.extensions,B(t,`${JSON.stringify(e,null,2)}
`),`Enabled npm:cc-safety-net extensions in ${t}`}function Al(n,t){let e=F({label:t,booleans:Object.fromEntries(G.map((l)=>[l.target,[l.flag]]))},n),r=e.errors[0];if(r)throw Error(r);let a=G.filter((l)=>e.flags[l.target]).map((l)=>l.target);if(a.length!==1)throw Error(`Choose exactly one ${t} target: ${[...bl.keys()].join(", ")}`);return a[0]}async function Gl(n=cr()){let[t,e,r]=await Promise.all([hn(["amp","plugins","list"],30000),hn(["codex","plugin","list"],30000),hn(["copilot","--binary-version"])]);return{codexPluginListOutput:e,hooks:I2(process.cwd(),{homeDir:n,ampPluginListOutput:t,codexPluginListOutput:e,copilotCliVersion:r})}}async function IL(n){let t=await Gl();return t.hooks.filter((e)=>n==="install"?e.configured:e.detected||e.inspectionStatus==="not-inspected").filter((e)=>e.platform!=="codex"||!sr(t.codexPluginListOutput)||Vl(t.codexPluginListOutput)).map((e)=>e.platform)}function n5(n,t,e){if(t.length>0)return{finish:async()=>[Al(t,n)]};if(!e.selectTargets&&!Ge(e.input,e.output))return{finish:async()=>[Al(t,n)]};let r=e.detectConfiguredTargets??(()=>IL(n)),a=Promise.all([hl(e.probeTargets),r()]);return{ready:a,finish:async()=>{let[l,d]=await a,s=wl(l,{action:n,configuredTargets:d}),c=e.selectTargets?await e.selectTargets(n,Rl(n,s)):await E0(n,Rl(n,s),{input:e.input,output:e.output});if(c==="update")return c;if(!c||c.length===0)return null;return Ee(c)}}}async function z2(n,t,e=!1){let r=Kl[n];r.beforeInstall?.(t);let a=typeof r.installCommands==="function"?await r.installCommands(t):{commands:r.installCommands};return await Qe(a.commands),await v0(a.cleanupCommands??[]),[`${a.update||e?"Updated":"Installed"} ${b2(n)} integration`,r.postInstallMessage].filter(Boolean).join(`
`)}async function tn(n){let t=Kl[n];if(!t.uninstallCommands)throw Error(`${b2(n)} uninstall is not supported`);return await Qe(t.uninstallCommands),`Uninstalled ${b2(n)} integration`}function t5(n){let t=Sl(n);return t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`}var e5={"antigravity-cli":{install:ol,uninstall:vl},cursor:{install:_a,uninstall:Pa},"kimi-code":{install:Fl,uninstall:zl}};function en(n,t,e,r=!1){if(n==="install")Ne(e);let a=e5[t][n](e),l=b2(t),d=n!=="install"?"Uninstalled":r?"Updated":"Installed";return n==="install"&&a.alreadyInstalled?r?`${l} hook up to date in ${a.path}`:`${l} hook already installed in ${a.path}`:n==="uninstall"&&!a.alreadyInstalled?`${l} hook not installed in ${a.path}`:`${d} ${l} hook ${n==="install"?"in":"from"} ${a.path}`}var r5={amp:{install:sl,uninstall:cl,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:r0,uninstall:a0,afterInstall:async(n)=>{let t=Je(n);return await e2(["hermes","plugins","enable",V,"--no-allow-tool-override"]),!t},beforeUninstall:async(n)=>{Be(n);try{await e2(["hermes","plugins","disable",V])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
Removing the plugin files anyway; ${V} may still be listed in the Hermes config.`)}},restartNote:"Restart Hermes to apply the change."}};async function vt(n,t,e,r=!1){let a=r5[t];if(n==="uninstall")await a.beforeUninstall?.(e);let l=n==="install"?await a.install(e):await a.uninstall(e),d=n==="install"&&await a.afterInstall?.(e),s=b2(t),c=!d&&(n==="install"&&l.alreadyInstalled||n==="uninstall"&&!l.alreadyInstalled);return[c?n==="install"?`${s} plugin ${r?"up to date":"already installed"} at ${l.path}`:`${s} plugin not installed at ${l.path}`:`${n!=="install"?"Uninstalled":r?"Updated":"Installed"} ${s} plugin ${n==="install"?"at":"from"} ${l.path}`,c?void 0:a.restartNote].filter(Boolean).join(`
`)}var a5={amp:{install:(n,t)=>vt("install","amp",n,t),uninstall:(n)=>vt("uninstall","amp",n)},"antigravity-cli":{install:(n,t)=>en("install","antigravity-cli",n,t),uninstall:(n)=>en("uninstall","antigravity-cli",n)},"claude-code":{install:(n,t)=>z2("claude-code",n,t),uninstall:()=>tn("claude-code")},codex:{install:(n,t)=>z2("codex",n,t),uninstall:()=>tn("codex")},"copilot-cli":{install:async(n,t)=>[await z2("copilot-cli",n,t),PL(n)].filter(Boolean).join(`
`),uninstall:()=>tn("copilot-cli")},cursor:{install:(n,t)=>en("install","cursor",n,t),uninstall:(n)=>en("uninstall","cursor",n)},"gemini-cli":{install:(n,t)=>z2("gemini-cli",n,t),uninstall:()=>tn("gemini-cli")},"hermes-agent":{install:(n,t)=>{return Ne(n),vt("install","hermes-agent",n,t)},uninstall:(n)=>vt("uninstall","hermes-agent",n)},"kimi-code":{install:(n,t)=>en("install","kimi-code",n,t),uninstall:(n)=>en("uninstall","kimi-code",n)},openclaw:{install:async(n,t)=>{let e=await z2("openclaw",n,t);return await $0(),e},uninstall:(n)=>{return Ye(n),tn("openclaw")}},opencode:{install:(n,t)=>z2("opencode",n,t),uninstall:(n)=>t5(n)},pi:{install:async(n,t)=>[await z2("pi",n,t),NL(n)].filter(Boolean).join(`
`),uninstall:()=>tn("pi")}},Wl=["Install CC Safety Net as a native Kimi Code plugin:","","  1. Start Kimi Code and run: /plugins install https://github.com/kenryu42/cc-safety-net","     Confirm the trust prompt; it defaults to cancel.","  2. Run /reload, or start a new session.","","Note: Kimi Code hooks are fail-open. When the hook process cannot start, crashes, or times","out, Kimi Code allows the tool call."].join(`
`);function l5(n){if(kn({homeDir:n,cwd:process.cwd()}).status!=="configured")return Wl;return[Wl,"",b.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function Rl(n,t){return t.map((e)=>n==="install"&&e.target==="kimi-code"&&e.unavailableReason==="already installed"?{...e,available:!0,unavailableReason:void 0,label:`${e.label} (global hook installed)`}:e)}function d5(n,t){if(n.selectKimiInstallMethod)return n.selectKimiInstallMethod();if(!Ge(n.input,n.output))return Promise.resolve("global-hook");return T0({input:n.input,output:n.output,globalHookInstalled:kn({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function Ul(n,t,e,r=!1){return a5[t][n](e,r)}function s5(n){let t=F({label:"update"},n).errors[0];if(t)throw Error(t)}async function c5(n){let t=await Gl(n),e=ar(gn(n),"installed-plugins");return Ee([...t.hooks.filter((r)=>r.platform!=="copilot-cli"&&r.detected).map((r)=>r.platform),...[En,Ya,Xa].flatMap((r)=>dr(ar(e,...r))?["copilot-cli"]:[]),...Tn(n,lr)?["claude-code"]:[],...sr(t.codexPluginListOutput)?["codex"]:[]])}async function i5(){let n=cr(),t=await c5(n);if(t.length===0)return console.log("No installed integrations found. Run `cc-safety-net install` to set one up."),0;let e=new Set(t),r=new Map(await Promise.all(G.filter((l)=>e.has(l.target)&&Hl.has(l.target)).map(async(l)=>[l.target,await Pe(l.probeCommand)]))),a=[];for(let l of t){if(Hl.has(l)&&!r.get(l)){console.log(`${b2(l)} not found; skipped`);continue}try{console.log(await Ul("install",l,n,!0))}catch(d){console.error(Lr(d)),a.push(l)}}return a.length>0?1:0}function ir(n){return Promise.resolve().then(()=>s5(n)).then(i5).catch((t)=>{return console.error(Lr(t)),1})}async function Bn(n,t,e={}){try{let r=await Gn(!0,()=>n5(n,t,e),()=>Cn({input:e.input??process.stdin,output:e.output??process.stdout}),{loadingMessage:n==="install"?"Checking available integrations…":"Checking installed integrations…",output:e.output??process.stdout});if(!r)return(e.output??process.stdout).write(`Cancelled: nothing was ${n}ed.
`),0;if(r==="update")return(e.runUpdate??(()=>ir([])))();let a=cr(),l=e.output??process.stdout;return await fl(r,async(d)=>{if(d==="kimi-code"&&n==="install"){let c=await d5(e,a);if(c===null){l.write(`Cancelled: Kimi Code integration was not installed.
`);return}if(c==="plugin"){l.write(`${l5(a)}
`);return}}let s=await ve(Ul(n,d,a),{loadingMessage:`${n==="install"?"Installing":"Uninstalling"} ${b2(d)} integration…`,output:l});l.write(`${s}
`)}),0}catch(r){return console.error(Lr(r)),1}}function Lr(n){let t=n instanceof Error?n.message:String(n),e=typeof n==="object"&&n!==null&&"code"in n?n.code:null;if(e==="EACCES"||e==="EPERM")return`${t}
...
${b.red(h)}`);if(w)if(w.result.errors.length>0)G5(w.path,w.result.errors);else C5(w.path,w.result);if(f)return console.error(`
Config validation failed.`),1;return console.log(o?`
Configs valid with warnings.`:`
All configs valid.`),0}function ft(n,t){let e=`legacy ${n} config`;if(t==="cleanup")return`Warning: Legacy ${n} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${n} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${n} config is no longer supported. Fix or delete the ${e}, then run \`npx -y cc-safety-net rule migrate\`.`}function A5(n){if(H2(n)===null)return null;let t=W5(n);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:n.path,result:t}}function W5(n){let t=[],e=new Set,r=(H2(n)??[]).filter((a)=>!S5.has(a.name)).sort((a,l)=>a.name.localeCompare(l.name));if(r.length===0)return{errors:t,ruleNames:e};for(let a of r){if(!sn.test(a.name)){t.push(`rulebook directory names must match ${sn}: ${a.name}`);continue}if(a.kind!=="directory"){t.push(`${a.name} must be a rulebook directory`);continue}let l=m(n.scope,Q5(n.path,a.name,"rulebook.json")),d=g(l);if(d===null){t.push(`${a.name}/rulebook.json is required`);continue}try{let s;try{s=JSON.parse(d)}catch{t.push(`${a.name}/rulebook.json: invalid JSON`);continue}let c=e3(s);if(c.name!==a.name){t.push(`rulebook name "${c.name}" must match folder "${a.name}"`);continue}e.add(a.name)}catch(s){t.push(s instanceof Error?`${a.name}/rulebook.json: ${s.message}`:`${a.name}/rulebook.json: ${String(s)}`)}}return{errors:t,ruleNames:e}}function R5(){console.log(r3),console.log(X5)}function M5(n,t,e,r,a){if(console.log(`
...
✗ Legacy ${n.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),e.errors.length>0){console.error("  Errors:");let a=1;for(let l of e.errors)for(let d of l.split("; "))console.error(`    ${a}. ${d}`),a++;return}if(e.ruleNames.size>0){console.error("  Rules:");let a=1;for(let l of e.ruleNames)console.error(`    ${a}. ${r.get(l)??l}`),a++;return}console.error("  Rules: (none)")}function K5(n,t,e){l3(`${n} config`,t,e)}function C5(n,t){console.log(`
✓ GitHub source rules: ${n}`),console.log("  Rulebooks:");let e=1;for(let r of t.ruleNames)console.log(`    ${e}. ${r}`),e++}function G5(n,t){l3("GitHub source rules",n,t)}function l3(n,t,e){console.error(`
✗ ${n}: ${t}`),console.error("  Errors:");let r=1;for(let a of e)for(let l of a.split("; "))console.error(`    ${r}. ${l}`),r++}function U5(n){try{let t=g(n);if(t===null)return!1;let e=JSON.parse(t);if(e.$schema)return!1;return h2(n,JSON.stringify({$schema:Y5,...e},null,2)),!0}catch(t){if(t instanceof Z)throw t;return!1}}var d3=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),T5=new Set(["add","remove","list"]);async function c3(n){try{return await E5(n)}catch(t){if(t instanceof Z)return console.error(t.message),1;throw t}}async function E5(n){let t=P5(n),e=t.help?_5(t.positionals):null;if(e)return at(e),0;if(t.errors.length>0){for(let d of t.errors)console.error(d);return 1}let r=t.positionals[0];if(!r)return at(O2,console.error),1;let a=t.positionals[1],l={global:t.global,check:t.check};if(r==="init"){let d=U(l),s=d.configDir;n8(d.configTarget),s3(m(d.filesystemScope,Yn({...l,cacheConfigDir:s})));let c=O5(s,"example-rules","rulebook.json"),i=m(d.filesystemScope,c);if(t.example&&g(i)===null)Ct(i,"example-rules");let L=await A2(l);return Jn(L,"Rule config initialized."),L.ok?0:1}if(r==="add"){if(!a)return console.error("rule add requires a source"),1;let d=await At(a,l);return Jn(d,`Added rulebook source: ${a}`),d.ok?0:1}if(r==="remove"){if(!a)return console.error("rule remove requires a source"),1;let d=await Rt(a,{...l,deleteSource:t.deleteSource});return Jn(d,`Removed rulebook source: ${a}`),d.ok?0:1}if(r==="update"||r==="sync"){let d=await A2({...l,only:r==="update"?a:void 0});return Jn(d,t.check?"Rule config checked.":"Rule config synced."),d.ok?0:1}if(r==="list"){let d=o2(),s=P({});return El(d,{user:w2(d.userConfigPath,s.userScope),project:w2(d.projectConfigPath,s.projectScope)}),d.errors.length>0?1:0}if(r==="wrapper")return t8(t);if(r==="migrate")return Il({cleanup:t.cleanup,cwd:process.cwd()});if(r==="doc"){console.log(Ol);let d=await t3();if(d)console.error(d);return 0}if(r==="verify")return a3();return 1}function _5(n){if(n.length===0)return O2;let t=O2.subcommands.filter((r)=>r.usage.split(" ")[0]===n[0]);if(t.length===0)return null;if(n.length===1&&t.length>1)return{name:`rule ${n[0]}`,description:`Subcommands of rule ${n[0]}`,usage:`rule ${n[0]} <subcommand>`,subcommands:t,options:[]};let e=n.length===1?t[0]:t.find((r)=>r.usage.split(" ")[1]===n[1]);if(!e)return null;return{name:`rule ${n[0]}`,description:e.description,usage:`rule ${e.usage}`,options:[]}}function P5(n){let t=F({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},positionals:"list"},n),e={...t.flags,help:t.help,positionals:t.positionals,errors:t.errors};return N5(e),e}function N5(n){let[t]=n.positionals;if(t&&!d3.has(t))n.errors.push(`Unknown rule subcommand: ${t}`);if(n.deleteSource&&t!=="remove")if(t&&d3.has(t))n.errors.push(`Unknown option for rule ${t}: --delete-source`);else n.errors.push("--delete-source is only valid with 'rule remove'");if(n.cleanup&&t!=="migrate")n.errors.push(yt(t,"--cleanup"));if(n.example&&t!=="init")n.errors.push(yt(t,"--example"));if(t==="migrate"){if(n.global)n.errors.push(yt(t,"--global"));if(n.check)n.errors.push(yt(t,"--check"));if(n.positionals.length>1)n.errors.push(`Unexpected rule migrate argument: ${n.positionals[1]}`)}else if(t==="wrapper")I5(n);else if(n.positionals.length>2)n.errors.push(`Unexpected rule argument: ${n.positionals[2]}`);if(t==="list"&&n.global)n.errors.push("Unknown option for rule list: --global")}function yt(n,t){return n?`Unknown option for rule ${n}: ${t}`:`Unknown option for rule: ${t}`}function I5(n){let t=n.positionals[1],e=n.positionals[2];if(!t){n.errors.push("rule wrapper requires add, remove, or list");return}if(!T5.has(t)){n.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(e)n.errors.push(`Unexpected rule wrapper argument: ${e}`);return}if(!e){n.errors.push(`rule wrapper ${t} requires a command`);return}if(n.positionals.length>3)n.errors.push(`Unexpected rule wrapper argument: ${n.positionals[3]}`)}function n8(n){if(g(n)===null){Kt(n);return}let t=O(n);if(!t.config)return;T(n,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function t8(n){let t=n.positionals[1],e=n.positionals[2],r=U({global:n.global}).configTarget;if(t==="list"){let s=O(r);if(s.errors.length>0){for(let c of s.errors)console.error(c);return 1}return e8(s.config?.transparent_wrappers??[]),0}if(!e||!Ut.test(e))return console.error("transparent wrapper must match command pattern"),1;if(Ot(e))return console.error(`reserved command "${e}" cannot be a wrapper`),1;let a=O(r);if(a.errors.length>0){for(let s of a.errors)console.error(s);return 1}let l=a.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},d=t==="add"?[...new Set([...l.transparent_wrappers??[],e])]:(l.transparent_wrappers??[]).filter((s)=>s!==e);return T(r,{version:1,rules:l.rules,overrides:l.overrides??{},transparent_wrappers:d}),console.log(t==="add"?`Added transparent wrapper: ${e}`:`Removed transparent wrapper: ${e}`),0}function e8(n){if(n.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${n.length}):`);for(let t of n)console.log(`  - ${t}`)}import{homedir as i3}from"node:os";import{existsSync as r8,readFileSync as a8}from"node:fs";import{homedir as l8}from"node:os";import{join as d8}from"node:path";async function s8(){if(process.stdin.isTTY)return null;return(await ne(process.stdin).catch(()=>null))?.trim()||null}function c8(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return d8(l8(),".claude","settings.json")}function or(){let n=c8();if(!r8(n))return!1;try{let t=a8(n,"utf-8"),e=JSON.parse(t);if(!e.enabledPlugins)return!1;let r="cc-safety-net@cc-marketplace";if(!(r in e.enabledPlugins))return!1;return e.enabledPlugins[r]===!0}catch(t){if(un(D.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${n}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function vr(){let n=or(),t;if(!n)t="\uD83D\uDEE1️ CC Safety Net ❌";else{let r=W({cwd:process.cwd()}),a=r.policy,l=d2(a),d=Object.values($2(a,l.capabilities)).some((c)=>c.changesInherited);t=`\uD83D\uDEE1️ CC Safety Net ${{standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[d?"custom":l.effectiveLevel]}${l.worktreeMode?"\uD83C\uDF33":""}${r.state==="degraded"?"⚠️":""}`}let e=await s8();if(e&&!e.startsWith("{"))console.log(`${e} | ${t}`);else console.log(t)}function L3(){let n=W({cwd:process.cwd()}),t=n.policy,e=d2(t),r=!!process.env.NO_COLOR||!process.stdout.isTTY,a=Math.min(process.stdout.columns||80,100),l=r?"ok":"✔",d=r?"OFF":"✘",s=(p,f)=>{let o=`  ${p.padEnd(13)}${f}`;return(o.length>a?`${o.slice(0,a-1)}…`:o).replaceAll(d,b.red(d))},c=Object.values($2(t,e.capabilities)).some((p)=>p.changesInherited),i=on(),L={ready:b.green,degraded:b.yellow}[n.state],u=[...or()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...n.diagnostics],v=r?"-":"·";console.log([`${r?"":"\uD83D\uDEE1️  "}CC Safety Net — ${L(n.state)}`,"",s("Protection",`destructive ${t.destructiveCommandProtectionEnabled?l:d}   secrets ${t.secretProtection.enabled?l:d}`),s("Level",c?`${e.effectiveLevel} (customised)`:e.effectiveLevel),s("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),s("Policy",i.startsWith(i3())?`~${i.slice(i3().length)}`:i),...e.worktreeMode?[s("Worktree","relaxations active")]:[],"",...u.length===0?["  Everything configured is active."]:["  Not active",...u.flatMap((p)=>rt(p,"      ",a-6).map((f,o)=>o===0?`    ${v} ${f}`:f)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as z3}from"node:child_process";import{randomBytes as w8}from"node:crypto";import{createServer as x8}from"node:http";import{Writable as $8}from"node:stream";import{homedir as i8}from"node:os";var ht=500;function L8(n){let t=n.filter((a)=>a.decision!=="allow"),e=n.filter((a)=>a.decision==="allow"),r=Math.min(t.length,Math.max(ht-e.length,Math.ceil(ht/2)));return[...t.slice(0,r),...e.slice(0,ht-r)]}function p3(n,t=s2()){if(t)x2(t);let e=(o)=>new Date(o.getFullYear(),o.getMonth(),o.getDate()).getTime(),r=e(new Date),a=new Date(r);a.setDate(a.getDate()-(n-1));let l=a.getTime(),d=[],s={count:0};for(let o of t?u2(t,s):[])for(let y of an(o,s)){if(!y||typeof y.ts!=="string"||typeof y.command!=="string")continue;let x=new Date(y.ts).getTime();if(!Number.isFinite(x))continue;if(x>=l)d.push(y)}d.sort((o,y)=>new Date(y.ts).getTime()-new Date(o.ts).getTime());let c=Array.from({length:n},()=>0),i=Array.from({length:n},()=>0),L={},u={},v={},p=0,f=0;for(let o of d){let y=o.agent||"unknown";L[y]=(L[y]??0)+1;let x=Math.round((r-e(new Date(o.ts)))/86400000),w=n-1-x,h=x>=0&&x<n;if(h)i[w]=(i[w]??0)+1;if(o.decision!=="allow"){if(p++,o.ruleId)u[o.ruleId]=(u[o.ruleId]??0)+1;let J=Z2(o.segment||o.command);if(J)v[J]=(v[J]??0)+1;if(o.failureStage)f++;if(h)c[w]=(c[w]??0)+1}}return{days:n,logsDir:t,homeDir:i8(),totalInWindow:d.length,truncated:d.length>ht,unreadable:s.count,counts:{blocked:p,allowed:d.length-p,agents:L,blockedByDay:c,analyzedByDay:i,rules:u,commands:v,errors:f},entries:L8(d).sort((o,y)=>new Date(y.ts).getTime()-new Date(o.ts).getTime())}}import{spawn as p8}from"node:child_process";import{existsSync as u3,statSync as u8}from"node:fs";import{delimiter as o8,join as v8}from"node:path";var b8=120000,wt="Choose the project folder",f8=`try
  return POSIX path of (choose folder with prompt "${wt}")
on error number -128
  return ""
end try`,y8=`Add-Type -AssemblyName System.Windows.Forms
$dialog = New-Object System.Windows.Forms.FolderBrowserDialog
$dialog.Description = '${wt}'
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,o3=[{binary:"zenity",args:["--file-selection","--directory",`--title=${wt}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",wt]}],v3=(n,t)=>(t.PATH??"").split(o8).some((e)=>e.length>0&&u3(v8(e,n)));function b3(n,t){if(n==="darwin"||n==="win32")return!0;if(n!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return o3.some((e)=>v3(e.binary,t))}function h8(n,t){if(n==="darwin")return{cmd:"osascript",args:["-e",f8]};if(n==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",y8]};let e=o3.find((r)=>v3(r.binary,t));return e?{cmd:e.binary,args:e.args}:null}function f3(n=process.platform,t=process.env){let e=h8(n,t);if(!e)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let a=p8(e.cmd,e.args,{env:t,stdio:["ignore","pipe","pipe"]}),l="",d=!1,s=(i)=>{if(d)return;d=!0,clearTimeout(c),r(i)},c=setTimeout(()=>{a.kill(),s({error:"The folder dialog timed out"})},b8);a.stdout.on("data",(i)=>{l+=i.toString()}),a.on("error",()=>s({error:`Could not open the folder dialog (${e.cmd})`})),a.on("close",()=>{let i=l.trim().replace(/\/+$/,"");if(!i)return s({cancelled:!0});if(!u3(i)||!u8(i).isDirectory())return s({error:"That selection is not a folder on disk"});s({path:i})})})}var y3=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var h3='<script id="ccsn-data" type="application/json">';function w3(n){return y3.replace(h3,()=>h3+JSON.stringify({token:n}).replaceAll("<","\\u003c"))}var $t="kenryu42/cc-safety-net",g8=`https://github.com/${$t}`,yr=1e4,m8=7;async function B3(n,t={}){let e=F({label:"gui",booleans:{noOpen:["--no-open"]}},n),r=t.log??console.log,a=t.error??console.error;if(e.errors.length>0){for(let d of e.errors)a(d);return a("Usage: cc-safety-net gui [--no-open]"),1}let l=await D8(t);if(r(`CC Safety Net policy GUI: ${l.url}`),!e.flags.noOpen)try{await(t.openBrowser??Z8)(l.url)}catch(d){a(`Failed to open browser: ${d instanceof Error?d.message:String(d)}`),a(`Open this URL manually: ${l.url}`)}if(t.keepAlive===!1)return await l.close(),0;return await J8(l),0}async function D8(n={}){let t=n.token??w8(24).toString("base64url"),e=x8((l,d)=>{k8(l,d,t,n)});await new Promise((l,d)=>{e.once("error",d),e.listen(0,"127.0.0.1",()=>{e.off("error",d),l()})});let a=`http://127.0.0.1:${e.address().port}`;return{origin:a,token:t,url:`${a}/?token=${encodeURIComponent(t)}`,close:()=>B8(e)}}async function k8(n,t,e,r){let a=new URL(n.url??"/","http://127.0.0.1");if(n.method==="GET"&&a.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!F8(n,a,e)){k(t,403,{error:"Forbidden"});return}if(n.method==="GET"&&a.pathname==="/"){z8(t,w3(e));return}if(n.method==="GET"&&a.pathname==="/api/policy"){let l=m3(r);k(t,200,{...l,configState:vn(W(r)),destructiveCommandRules:Ln,secretPatterns:$3,version:j(),preview:l.errors.length>0?null:k3(l.policy)});return}if(n.method==="POST"&&a.pathname==="/api/policy/preview"){let l=await xt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=D3(l.value);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/policy/explain"){let l=await xt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value;if(d===null||typeof d.command!=="string"){k(t,400,{errors:["command must be a string"]});return}let s=Pt(d.policy);if(s.length>0){k(t,400,{errors:s});return}k(t,200,q8(d.command,d.policy,r));return}if(n.method==="POST"&&a.pathname==="/api/policy"){let l=await xt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=br(l.value,r);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/reset"){k(t,200,br(g3,r));return}if(n.method==="POST"&&a.pathname==="/api/repair"){k(t,200,q3(r));return}if(n.method==="GET"&&a.pathname==="/api/activity"){let l=K2(r),d=j8(a.searchParams.get("days"),l);if(d===null){k(t,400,{error:`days must be an integer between 1 and ${l}`});return}k(t,200,p3(d,r.activityLogsDir));return}if(n.method==="POST"&&a.pathname==="/api/rules/choose-directory"){k(t,200,await f3());return}if(n.method==="GET"&&a.pathname==="/api/rules"){let l=o2(r),d=new Map(l.rules.map((s)=>[s.name,s]));k(t,200,{projectPath:r.cwd??process.cwd(),canPickDirectory:b3(process.platform,process.env),rulebooks:l.rulebooks.map((s)=>({source:s.source,spec:s.spec,name:s.name,version:s.version,rules:s.rules.flatMap((c)=>{let i=d.get(c);if(!i)return[];return[{name:i.name,command:i.command,subcommand:i.subcommand,block_args:i.block_args,reason:i.reason}]})})),errors:l.errors,warnings:l.warnings});return}if(n.method==="GET"&&a.pathname==="/api/star/context"){k(t,200,await(r.fetchStarContext??(()=>A8({logsDir:r.activityLogsDir})))());return}if(n.method==="POST"&&a.pathname==="/api/star"){let l=await(r.starRepo??Q8)();k(t,200,l.ok?{ok:!0}:{ok:!1,fallbackUrl:g8});return}if(n.method==="GET"&&a.pathname==="/api/integrations"){k(t,200,await(r.fetchIntegrations??Y8)());return}if(n.method==="GET"&&a.pathname==="/api/health"){k(t,200,await(r.fetchHealth??S8)());return}if(n.method==="POST"&&(a.pathname==="/api/install"||a.pathname==="/api/uninstall")){let l=await xt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value?.target;if(typeof d!=="string"||!G.some((c)=>c.target===d)){k(t,400,{error:"unknown target"});return}let s=a.pathname==="/api/install"?"install":"uninstall";k(t,200,await(r.runIntegration??H8)(s,d));return}k(t,404,{error:"Not found"})}function q8(n,t,e){let r=st(t),a=W(e),l=pn({rules:a.policy.rules,transparentWrappers:a.policy.transparentWrappers,safety:F3(r.safety),worktreeMode:r.workflow.worktree_mode,destructiveCommandProtectionEnabled:r.destructive_command_protection.enabled,destructiveCommandRuleOverrides:r.destructive_command_protection.overrides,destructiveCommandAllowPaths:r.destructive_command_protection.allow_paths,secretProtection:{enabled:r.secret_protection.enabled,disabledRules:[...j3(r.secret_protection.overrides)],denyPaths:r.secret_protection.deny_paths}});return V2(n,{policySnapshot:l,cwd:e.cwd,userConfigDir:e.userConfigDir})}function j8(n,t){if(n===null)return Math.min(m8,t);let e=Number(n);if(!Number.isInteger(e)||e<1||e>t)return null;return e}function F8(n,t,e){if(t.searchParams.get("token")!==e)return!1;if(n.method!=="POST")return!0;return n.headers["x-cc-safety-net-token"]===e}async function xt(n){let t=[];for await(let e of n)t.push(e);try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(e){return{ok:!1,error:`Invalid JSON: ${e instanceof Error?e.message:String(e)}`}}}function z8(n,t){n.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),n.end(t)}function k(n,t,e){n.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),n.end(JSON.stringify(e))}function B8(n){return new Promise((t,e)=>{n.close((r)=>r?e(r):t())})}function J8(n){return new Promise((t)=>{let e=()=>{process.off("SIGINT",r),process.off("SIGTERM",r)},r=()=>{e(),n.close().then(t)};process.once("SIGINT",r),process.once("SIGTERM",r)})}function Z8(n){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",e=process.platform==="win32"?["/c","start","",n]:[n];return new Promise((r,a)=>{let l=z3(t,e,{detached:!0,stdio:"ignore"}),d=(c)=>{l.off("spawn",s),a(c)},s=()=>{l.off("error",d),l.unref(),r()};l.once("error",d),l.once("spawn",s)})}async function Q8(n="gh",t=yr){return{ok:await fr(n,["api","-X","PUT",`/user/starred/${$t}`],t)===0}}var X8={amp:"ampVersion","antigravity-cli":"antigravityCliVersion","claude-code":"claudeCodeVersion",codex:"codexCliVersion","copilot-cli":"copilotCliVersion",cursor:"cursorVersion","gemini-cli":"geminiCliVersion","hermes-agent":"hermesAgentVersion","kimi-code":"kimiCodeVersion",openclaw:"openClawVersion",opencode:"openCodeVersion",pi:"piCliVersion"};async function Y8(n={}){let t=await wn(n.fetcher),e=J3(t,n.homeDir);return{targets:i2.map((r)=>{let a=e.find((l)=>l.platform===r.id);return{target:r.id,label:v2(r.id),version:t[X8[r.id]],status:a?.configured?"active":a?.detected?"disabled":a?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function J3(n,t){return I2(process.cwd(),{homeDir:t,ampPluginListOutput:n.ampPluginListOutput,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.copilotCliVersion})}async function S8(n={}){let[t,e]=await Promise.all([wn(n.fetcher),(n.checkUpdates??T2)()]);return{hooks:J3(t,n.homeDir).filter((r)=>r.detected).map((r)=>({platform:r.platform,label:v2(r.platform),configured:r.configured})),update:{currentVersion:e.currentVersion,latestVersion:e.latestVersion??null,updateAvailable:e.updateAvailable}}}var x3=Promise.resolve();function H8(n,t,e={}){let r=async()=>{let l=[],d=console.log,s=console.error;console.log=(...c)=>l.push(c.map(String).join(" ")),console.error=console.log;try{return{ok:await Bn(n,[],{selectTargets:async()=>[t],output:new $8({write(i,L,u){u()}}),...e})===0,output:l.join(`
`)}}finally{console.log=d,console.error=s}},a=x3.then(r);return x3=a.then(()=>{return},()=>{return}),a}async function A8(n={}){let[t,e,r]=await Promise.all([W8(n.command),R8(n.fetchRepo),Promise.resolve(Mn(K2(),n.logsDir).totalBlocked)]);return{starred:t,starCount:e,blockedTotal:r}}async function W8(n="gh",t=yr){if(await fr(n,["auth","status"],t)!==0)return null;let e=await fr(n,["api",`/user/starred/${$t}`],t);if(e===0)return!0;if(e===null)return null;return!1}function fr(n,t,e){return new Promise((r)=>{let a=z3(n,t,{stdio:"ignore",windowsHide:!0}),l=!1,d,s=(c)=>{if(l)return;if(l=!0,d)clearTimeout(d);r(c)};a.once("error",()=>s(null)),a.once("close",s),d=setTimeout(()=>{a.kill(),s(null)},e)})}async function R8(n=fetch){try{let t=await n(`https://api.github.com/repos/${$t}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(yr)});if(!t.ok)return null;let e=await t.json();return typeof e.stargazers_count==="number"?e.stargazers_count:null}catch{return null}}function M8(n){if(n[0]!=="help")return!1;let t=n[1];if(!t)Ce(),process.exit(0);if(Fn(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var V8={hook:async(n)=>{let t=W1(n);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),Fn("hook",console.error),process.exit(1)},install:async(n)=>{process.exit(await Bn("install",n))},update:async(n)=>{process.exit(await ir(n))},uninstall:async(n)=>{process.exit(await Bn("uninstall",n))},rule:async(n)=>{process.exit(await c3(n))},status:async(n)=>{if(r2(F({label:"status"},n).errors))process.exit(1);L3()},statusline:async(n)=>{let t=F({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},n);if(t.errors.length===0&&t.flags.claudeCode){await vr();return}if(r2(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");Fn("statusline",console.error),process.exit(1)},doctor:async(n)=>{let t=We(n);if(!t)process.exit(1);let e=await J0({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(e)},logs:async(n)=>{process.exit(await c1(n))},gui:async(n)=>{process.exit(await B3(n))},explain:async(n)=>{let t=Re(n);if(!t)process.exit(1);let e=V2(t.command,{cwd:t.cwd}),r=!!process.env.NO_COLOR||!process.stdout.isTTY;if(t.json)console.log(Ke(e));else console.log(Ve(e,{asciiOnly:r}));process.exit(0)}};async function K8(){let n=process.argv.slice(2),t=F({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},n);if(M8(n))return;let e=n[0],r=e?Rn(e):void 0;if(t.help&&r&&r.name!=="rule")Fn(r.name),process.exit(0);if(!e||t.help&&!r)Ce(),process.exit(0);if(t.flags.version)W0(),process.exit(0);if(r){await V8[r.name](n.slice(1));return}let a=R1(e);if(a){await a.run();return}if(e==="--statusline"){await vr();return}console.error(e.startsWith("-")?`Unknown option: ${e}`:`Unknown command: ${e}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}K8().catch((n)=>{console.error("CC Safety Net error:",n),process.exit(1)});
