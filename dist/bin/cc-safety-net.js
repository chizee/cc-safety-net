#!/usr/bin/env node
import{b as li,c as ci,d as q,e as di,f as mr,g as ot,h as Fe,i as $r,j as he,k as vs,l as Ur,m as pn,n as bs,o as Ls,p as fn}from"../chunks/index-7r9n883m.js";import{$a as Dr,A as tt,Aa as ks,Ab as At,B as me,Ba as ge,Bb as xs,C as Pa,Ca as Et,D as Vi,Da as Mr,E as Se,Ea as jr,F as cn,Fa as ts,G as wt,Ga as ns,H as vr,Ha as hi,I as $e,Ia as nt,J as xe,Ja as rs,K as Oe,Ka as os,L as te,La as Sr,M as br,Ma as Rr,Na as zi,O as re,Oa as kr,P as Ne,Pa as fe,Qa as Ki,R as oe,Ra as Ni,S as Dt,Sa as Fi,T as _d,Ta as Qd,U as De,Ua as vi,V as U,Va as bi,W as Ce,Wa as Tt,Xa as Li,Y as ve,Ya as dn,Z as W,Za as wi,_ as Is,_a as B,aa as He,ab as Ir,ba as mn,bb as _r,ca as $t,cb as K,da as Ci,db as eu,ea as Si,eb as Pe,fa as Pt,fb as tu,ga as Me,gb as tn,ha as Or,hb as nu,ia as Ri,ib as ru,ja as Di,jb as ou,ka as ye,kb as un,la as ws,lb as we,ma as Gr,mb as iu,na as Cs,nb as su,oa as Ss,ob as is,pa as Nr,pb as ss,qa as Zi,qb as as,ra as mi,rb as ls,s as _t,sa as Xi,sb as kt,t as Yi,ta as Qi,tb as Re,u as M,ua as es,ub as J,v as wr,va as Fr,vb as Ji,w as x,wa as gi,wb as Cr,x as Lt,xa as Pi,xb as St,y as w,ya as C,yb as V,z as ne,za as Hr,zb as It}from"../chunks/index-s8h8p9va.js";var fu=["-h","--help"];function E(e,t){let n=Object.entries(e.booleans??{}),r=Object.entries(e.values??{}),o=Object.entries(e.lists??{}),i=Object.fromEntries(n.map(([g])=>[g,!1])),s={},a=Object.fromEntries(o.map(([g])=>[g,[]])),l=[],c=[],d=!1,m=-1;for(let[g,u]of t.entries()){if(g<=m)continue;if(u==="--"){l.push(...t.slice(g+1));break}if(fu.includes(u)){d=!0;continue}let p=n.find(([,L])=>L.includes(u));if(p){i[p[0]]=!0;continue}let f=r.find(([,L])=>L.includes(u));if(f){let L=t[g+1];if(L===void 0||L.startsWith("-")){c.push(`${u} requires a value`);continue}s[f[0]]=L,m=g+1;continue}let b=o.find(([,L])=>L.includes(u));if(b){let L=t.slice(g+1),h=L.findIndex((v)=>v.startsWith("-")),S=L.slice(0,h===-1?L.length:h);if(S.length===0){c.push(`${u} requires at least one value`);continue}a[b[0]]=[...a[b[0]]??[],...S],m=g+S.length;continue}if(u.startsWith("-")){c.push(`Unknown option for ${e.label}: ${u}`);continue}if(e.positionals==="tail"){l.push(...t.slice(g));break}l.push(u)}if(e.positionals!=="list"&&e.positionals!=="tail")c.push(...l.map((g)=>`Unexpected argument for ${e.label}: ${g}`));return{flags:i,values:s,lists:a,positionals:l,help:d,errors:c}}function ue(e){for(let t of e)console.error(t);return e.length>0}import{readdirSync as pp,statSync as ds,unlinkSync as fp}from"node:fs";import{basename as us,dirname as mp,join as gp,resolve as hp}from"node:path";function N(e){return Array.from(e,(t)=>{let n=t.charCodeAt(0);if(n<=31||n>=127&&n<=159)return`\\x${n.toString(16).padStart(2,"0")}`;return t}).join("")}var dr=(e)=>{let t=Date.now()-new Date(e).getTime();if(!Number.isFinite(t))return"";let n=Math.floor(t/60000),r=Math.floor(n/60),o=Math.floor(r/24);if(o>0)return`${o}d ago`;if(r>0)return`${r}h ago`;if(n>0)return`${n}m ago`;return"just now"},Qe=(e)=>{let t=(e??"").trim().split(/\s+/).filter((o)=>o&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(o)),n=t[0]?.split("/").pop();if(!n)return null;let r=t[1];return r&&/^[a-z][a-z0-9-]*$/.test(r)?`${n} ${r}`:n};import{existsSync as mu,readdirSync as gu,readFileSync as hu}from"node:fs";import{join as yu}from"node:path";function ke(e,t){try{return gu(e,{withFileTypes:!0,encoding:"utf8"}).flatMap((n)=>{let r=yu(e,n.name);if(n.isDirectory())return ke(r,t);if(n.name.endsWith(".jsonl"))return[r];return[]})}catch{if(t&&mu(e))t.count++;return[]}}function ur(e){let t=(o)=>`${o.sessionId}
${Qe(o.segment||o.command)}`,n=e.filter((o)=>o.decision!=="allow"),r=n.filter((o)=>o.sessionId).reduce((o,i)=>o.set(t(i),(o.get(t(i))??0)+1),new Map);return new Set(n.filter((o)=>o.failureStage||(r.get(t(o))??0)>=2))}var vu=["segment","reason","sessionId","decision","agent","ruleId","failureStage"];function bu(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e;if(typeof t.ts!=="string"||typeof t.command!=="string")return!1;return vu.every((n)=>t[n]===void 0||typeof t[n]==="string")}function _e(e,t){try{return hu(e,"utf-8").split(`
`).filter(Boolean).flatMap((n)=>{try{let r=JSON.parse(n);if(!bu(r)){if(t)t.count++;return[]}return[r]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as op}from"node:path";var Lu=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function ui(e){let t=0,n={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(r){e.record({kind:"step",scope:"global",step:r})},recordSegment(r,o=n.currentSegmentIndex){if(o===void 0)return;e.record({kind:"step",scope:"segment",segmentIndex:o,step:r})}};return n}function pi(e={}){let t=[],n=e.maxEvents??512,r={maxTextLength:e.maxTextLength??2048,maxListLength:e.maxListLength??128,maxObjectProperties:e.maxObjectProperties??e.maxListLength??128,maxDepth:e.maxDepth??16},o=0,i,s=new Set;return{record(a){if(i)return;try{if(!a||t.length>=n){o++;return}t.push(fr(wu(a,r,s)))}catch{o++}},finish(a){if(i)return i;try{i=fr({events:Object.freeze(t),droppedEvents:o,terminal:ku(a,r,s)})}catch{o++,i=Object.freeze({events:Object.freeze(t),droppedEvents:o,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,r.maxTextLength),segment:"trace unavailable".slice(0,r.maxTextLength)})})}return i}}}function wu(e,t,n){if(e.kind!=="step")throw TypeError("invalid trace event");let{scope:r,step:o}=e;rn(o,n,t);let i=et(o,t,n);if(r==="global")return{kind:"step",scope:"global",step:i};if(r!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:e.segmentIndex,step:i}}function ku(e,t,n){let r=e.result;if(r==="allowed")return Object.freeze({result:"allowed"});if(r!=="blocked")throw TypeError("invalid trace terminal");let o=e.ruleId;return Object.freeze({result:"blocked",reason:et(e.reason,t,n),segment:et(e.segment,t,n),...o?{ruleId:et(o,t,n)}:{}})}function rn(e,t,n,r=0,o=new WeakSet){if(typeof e==="string"){let a=e.slice(0,n.maxTextLength);if(!mr(a))return;for(let l of di(a))for(let c of l.match(/[^\s"'()$]+/g)??[])t.add(fi(c));return}if(!e||typeof e!=="object"||r>=n.maxDepth||o.has(e))return;if(o.add(e),Array.isArray(e)){let a=Math.min(e.length,n.maxListLength);for(let l=0;l<a;l++)rn(e[l],t,n,r+1,o);return}let i=0,s=new Set;for(let a in e){if(!Object.hasOwn(e,a))continue;if(i>=n.maxObjectProperties)break;i++,rn(a,t,n);let l=pr(a,n,t);if(s.has(l))continue;s.add(l),rn(e[a],t,n,r+1,o)}}function et(e,t,n,r=0,o=new WeakSet){if(typeof e==="string")return pr(e,t,n);if(!e||typeof e!=="object")return e;if(r>=t.maxDepth)return;if(o.has(e))return;if(o.add(e),Array.isArray(e)){let a=[],l=Math.min(e.length,t.maxListLength);for(let c=0;c<l;c++)a.push(et(e[c],t,n,r+1,o));return a}let i={},s=0;for(let a in e){if(!Object.hasOwn(e,a))continue;if(s>=t.maxObjectProperties)break;s++;let l=pr(a,t,n);if(Object.hasOwn(i,l))continue;Object.defineProperty(i,l,{value:et(e[a],t,n,r+1,o),enumerable:!0,configurable:!0,writable:!0})}return i}function pr(e,t,n){let r=e.slice(0,t.maxTextLength),o=mr(r)?ci(r):r,i=n.size>0?Cu(o,n):o;return(xu(i)?li(i):i).slice(0,t.maxTextLength)}function xu(e){return e.includes("PRIVATE KEY")||e.includes("://")||e.includes("eyJ")||e.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(e)||e.length>=14&&Lu.some((t)=>e.includes(t))||e.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(e)}function Cu(e,t){return e.replace(/[^\s"'()$]+/g,(n)=>t.has(fi(n))?"<redacted>":n)}function fi(e){let t=2166136261,n=2166136261;for(let r=0;r<e.length;r++)t=Math.imul(t^e.charCodeAt(r),16777619),n=Math.imul(n^e.charCodeAt(e.length-r-1),16777619);return`${t>>>0}:${n>>>0}:${e.length}`}function fr(e){if(e&&typeof e==="object"&&!Object.isFrozen(e)){for(let t of Object.values(e))fr(t);Object.freeze(e)}return e}function yi(e,t,n){let r=n??mi(),o=r.getCommandProgram(e,t.shell??"auto"),i=pi(),s=ui(i),a=o.dialect==="powershell"?r.getCommandProgram(e,"posix"):o,l=gi(a);s.recordGlobal({type:"parse",input:e,segments:l.map((m)=>[...m])});let c=hi(e,{...t,analyzePartialProgram:!0,trace:s},o,r),d=s.getNextSegmentIndex();if(c&&d>0&&d<l.length)s.recordSegment({type:"segment-skipped",index:d,reason:"prior-segment-blocked"},d);return Object.freeze({decision:c,trace:i.finish(c?{result:"blocked",reason:c.reason,segment:c.evidence.find((m)=>m.kind==="command")?.segment??e,...c.ruleId?{ruleId:c.ruleId}:{}}:{result:"allowed"}),program:o})}import{resolve as Su}from"node:path";function gr(e){let t=vi().safeParse(e);return{errors:t.success?[]:Li(t.error.issues),ruleNames:new Set(bi(e).map((n)=>n.toLowerCase()))}}function hr(e){let t=ki(e);if(!t.ok)return t.result;return gr(t.parsed)}function ki(e){let t=[],n=new Set;try{let r=typeof e==="string"?Lt(e):e,o=w(r);if(o===null)return t.push(`File not found: ${r.path}`),{ok:!1,result:{errors:t,ruleNames:n}};if(!o.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:n}};return{ok:!0,parsed:JSON.parse(o)}}catch(r){if(r instanceof M)return t.push(r.message),{ok:!1,result:{errors:t,ruleNames:n}};let o=r instanceof Error?r.message:String(r);return t.push(r instanceof SyntaxError?"Invalid JSON":o),{ok:!1,result:{errors:t,ruleNames:n}}}}function xi(e){return Su(e??process.cwd(),".safety-net.json")}function pe(e){let t=ki(e);if(!t.ok)return t.result;let n=wi(t.parsed);return{errors:n.errors,ruleNames:n.sources}}import{join as Pr,resolve as Fu}from"node:path";import{dirname as sn}from"node:path";var Ru="custom.";function on(e){if(e.rulebook_version!==2)return[];let t=e.rules.map((n)=>({name:n.name,command:n.command,block_args:[],match:n.match,reason:n.reason,intent:n.intent}));return(e.tests??[]).flatMap((n,r)=>{let o=yr(Di(n.command));if(o.length===0)return[`tests[${r}]: could not parse fixture command: ${n.command}`];let i=o.reduce((s,a)=>s??Pi(a,t)?.id.slice(Ru.length),void 0);if(n.expect==="blocked"){if(i===n.rule)return[];let s=i?`"${i}" matched first`:"no rule matched";return[`tests[${r}]: expected "${n.rule}" to block "${n.command}" but ${s}`]}return i?[`tests[${r}]: expected "${n.command}" to be allowed but "${i}" matched`]:[]})}function yr(e){return e.nodes.flatMap((t)=>{if(t.kind==="group"||t.kind==="function")return yr(t.body);if(t.kind!=="command")return[];let n=Ri(Si(t.dialect,t.words)).words.map(Ci);return[...n.length>0?[n]:[],...t.nested.flatMap((r)=>yr(r))]})}var Du=/^([A-Za-z0-9_.-]+)\/([A-Za-z0-9_.-]+)#(.+)$/;function Ai(e,t){let n=Ii(e.rules,t);if(n.length>0)return{ok:!0,specs:n};return Ti(e.rules,t)}function Ei(e,t){let n=Ii(e,t);if(n.length>0)return{ok:!0,specs:n};let r=Au(e,t);if(r.length>0)return{ok:!0,specs:r};let o=Eu(e,t);if(!o.ok)return o;if(o.specs.length>0)return{ok:!0,specs:o.specs};return Ti(e,t)}function Ti(e,t){let n=e.filter((r)=>Lr(r)?.name===t);if(n.length===1)return{ok:!0,specs:n};return Pu(t,n)}function Pu(e,t){return{ok:!1,result:{ok:!1,errors:t.length===0?[`No configured rulebook matches ${e}`]:[`Ambiguous rulebook match ${e}: ${t.join(", ")}`],warnings:[],entries:[]}}}function Ii(e,t){return e.filter((n)=>n===t)}function Au(e,t){let n=t.match(Du),r=n?.[1],o=n?.[2],i=n?.[3];if(!r||!o||!i||!Oe(i))return[];return _i(e,(s)=>s.owner===r&&s.repo===o&&s.ref===i)}function Eu(e,t){if(!xe(t))return{ok:!0,specs:[]};let[n,r]=t.split("/"),o=_i(e,(s)=>s.owner===n&&s.repo===r);if(new Set(o.map((s)=>Lr(s)?.ref).filter((s)=>!!s)).size<2)return{ok:!0,specs:o};return{ok:!1,result:{ok:!1,errors:[`Multiple refs are configured for ${t}. Use an explicit ref:`,`  cc-safety-net rule remove ${t}#<ref>`],warnings:[],entries:[]}}}function Lr(e){try{return $e(e)}catch{return null}}function _i(e,t){return e.filter((n)=>{let r=Lr(n);return r?t(r):!1})}var Hi=Object.freeze({timeoutMs:15000,metadataBytes:524288,commitBytes:262144,treeBytes:16777216,rawBytes:4194304});async function $i(e,t,n,r=wr(sn(sn(t)),"rules policy"),o=fe()){if(te(e))return $u(e,o);return _u(e,t,n,r)}async function Mi(e,t,n,r,o,i,s){if(!te(e))return $i(e,t,n,r,o);let a=i?null:Tu(e,t,r);if(a)return a;if(!i&&!s)throw Error(`${e} is not vendored; run rule update ${e} to vendor it`);return $i(e,t,n,r,o)}function Tu(e,t,n=wr(sn(sn(t)),"rules policy")){let r=$e(e),o=Ce(t,r.name),i=w(x(n,o));if(i===null)return null;let s=kt(xr(i,`Invalid rulebook ${o}.`));if(s.name!==r.name)throw Error(`rulebook name "${s.name}" in ${o} must match "${r.name}"`);return{spec:e,rulebook:s,content:i}}async function ji(e,t={}){if(!xe(e))throw Error(`Invalid GitHub repository source: ${e}`);let[n,r]=e.split("/");if(!n||!r)throw Error(`Invalid GitHub repository source: ${e}`);if(t.ref!==void 0&&!Oe(t.ref))throw Error(`GitHub rulebook refs must use valid path segments: ${t.ref}`);let o=t.operation??fe(),i=t.ref??await Iu(n,r,e,o),s=await Gi(n,r,i,e,o),a=await an(`https://api.github.com/repos/${n}/${r}/git/trees/${s}?recursive=1`,"tree",o),l=a.response;if(!l.ok)throw Error(`Failed to inspect ${e}: GitHub tree returned ${l.status}`);let c=JSON.parse(a.content);if(!Array.isArray(c?.tree))throw Error(`Failed to inspect ${e}: unexpected GitHub tree response`);let d=c.tree,m=[...new Set(d.flatMap((g)=>{if(!g||typeof g!=="object")return[];let u=g;if(u.type!=="blob"||typeof u.path!=="string")return[];let p=u.path.match(vr);return p?.[1]?[p[1]]:[]}))].sort();if(m.length===0)throw Error(`No rulebooks found in ${e} under ${wt}/`);return{source:e,owner:n,repo:r,ref:i,commit:s,names:m}}async function Iu(e,t,n,r){let o=await an(`https://api.github.com/repos/${e}/${t}`,"metadata",r),i=o.response;if(!i.ok)throw Error(`Failed to inspect ${n}: GitHub returned ${i.status}`);let a=JSON.parse(o.content)?.default_branch;if(typeof a!=="string"||a==="")throw Error(`Failed to inspect ${n}: missing default branch`);if(!Oe(a))throw Error(`GitHub returned an invalid default branch: ${a}`);return a}function _u(e,t,n,r){br(e);let o=Ce(t,e),i=w(x(r,o));if(i===null)throw Error(`Rulebook source not found: ${e}`);let s=Ui(xr(i,"Invalid local rulebook source."));if(s.name!==e)throw Error(`rulebook name "${s.name}" must match local source "${e}"`);return{spec:e,rulebook:s,content:i}}async function $u(e,t){let n=$e(e),r=await Gi(n.owner,n.repo,n.ref,e,t),o=await an(`https://raw.githubusercontent.com/${n.owner}/${n.repo}/${r}/${n.path}`,"raw",t),i=o.response;if(!i.ok)throw Error(`Failed to fetch ${e}: GitHub raw returned ${i.status}`);let s=o.content,a=Ui(xr(s,"Invalid GitHub rulebook response."));if(a.name!==n.name)throw Error(`rulebook name "${a.name}" must match GitHub source "${n.name}"`);return{spec:e,rulebook:a,content:s}}function Ui(e){let t=kt(e),n=on(t);if(n.length>0)throw Error(n.join("; "));return t}function xr(e,t){try{return JSON.parse(e)}catch{throw Error(t)}}async function Gi(e,t,n,r,o){let i=await an(`https://api.github.com/repos/${e}/${t}/commits/${encodeURIComponent(n)}`,"commit",o),s=i.response;if(!s.ok)throw Error(`Failed to resolve ${r}: GitHub returned ${s.status}`);let a=JSON.parse(i.content);if(typeof a?.sha!=="string"||a.sha==="")throw Error(`Failed to resolve commit for ${r}`);return a.sha}async function Ou(e,t,n={}){if(n.signal?.aborted)throw n.signal.reason;let r=n.budget??kr(),o=new AbortController,i=()=>o.abort(n.signal?.reason);n.signal?.addEventListener("abort",i,{once:!0});let s=!1,a=setTimeout(()=>{if(o.signal.aborted)return;s=!0,o.abort()},n.timeoutMs??Hi.timeoutMs);try{if(n.signal?.aborted)throw n.signal.reason;Ni(r);let l=await(n.fetch??fetch)(e,{signal:o.signal,redirect:"error"});if(!l.ok)return Bi(l),{response:l,content:""};return{response:l,content:await Nu(l,t,r,()=>o.abort())}}catch(l){if(s)throw Error("GitHub request timed out",{cause:l});if(n.signal?.aborted)throw n.signal.reason;throw l}finally{clearTimeout(a),n.signal?.removeEventListener("abort",i)}}function an(e,t,n){return Ou(n.resolveUrl?.(e)??e,t,{budget:n.budget,signal:n.controller.signal})}async function Nu(e,t,n=kr(),r){let o=Hi[`${t}Bytes`],i=Number(e.headers.get("content-length"));if(Number.isFinite(i)&&i>o)throw Bi(e),Error(`GitHub ${t} response exceeds ${o} bytes`);if(!e.body)return"";let s=e.body.getReader(),a=[],l=0;while(!0){let c=await s.read();if(c.done)break;try{Fi(n,c.value.byteLength)}catch(d){throw r?.(),Oi(s),d}if(l+=c.value.byteLength,l>o)throw r?.(),Oi(s),Error(`GitHub ${t} response exceeds ${o} bytes`);a.push(Buffer.from(c.value))}return Buffer.concat(a,l).toString("utf-8")}function Bi(e){if(!e.body)return;qi(()=>e.body?.cancel())}function Oi(e){qi(()=>e.cancel())}function qi(e){try{Promise.resolve(e()).catch(()=>{})}catch{}}async function Rt(e={}){let t=Er(e);return Hu(t,await ln(t,fe()))}function Hu(e,t){if(!t.ok)return t;let n=U(e),r=[...new Set(J(n.configPath,n.filesystemScope))];if(r.length===0)return t;return{ok:!1,errors:r,warnings:t.warnings,entries:t.entries}}async function ln(e,t,n={},r=new Set,o=new Set){try{let i=U(e),s=Dr(i.configTarget);if(!s.ok)return s.result;let a=s.config;if(e.check)return ep(a,i,e);let l=e.only?Ai(a,e.only):{ok:!0,specs:a.rules};if(!l.ok)return l.result;let c=new Set([...e.refresh?l.specs:[],...r]),d=(v)=>Mi(v,i.configDir,e,i.filesystemScope,t,c.has(v),!e.refresh||c.has(v)),m=await Wu(a.rules,e.refresh?(v)=>d(v).then((R)=>({ok:!0,item:R})).catch((R)=>{if(Ki(R))throw R;return{ok:!1,spec:v,message:R instanceof Error?R.message:String(R)}}):async(v)=>({ok:!0,item:await d(v)}),t),g=m.filter((v)=>!v.ok),u=m.filter((v)=>v.ok).map((v)=>v.item),p=u.flatMap((v)=>Mu(v,a.rules)),f=u.flatMap((v)=>ju(v,o,i)),b=new Set([...p,...f].map((v)=>v.spec)),L=[...g,...p,...f],h=[],S=Gu(h,()=>u.flatMap((v)=>b.has(v.spec)||L.length>0&&o.has(v.spec)?[]:Uu(v,i,n,h)));return{ok:L.length===0,errors:L.map((v)=>`Failed to update ${v.spec}: ${v.message}`),warnings:[],entries:u.map(qu),changes:S}}catch(i){return Ct(i)}}function Mu(e,t){if(!te(e.spec))return[];let n=Cr(e.spec),r=t.filter((o)=>o!==e.spec&&Cr(o).toLowerCase()===n.toLowerCase());if(r.length===0)return[];return[{ok:!1,spec:e.spec,message:`rulebook name "${n}" is also claimed by ${r.join(", ")}; rename one of them`}]}function ju(e,t,n){if(!t.has(e.spec)||!te(e.spec))return[];let r=Ce(n.configDir,e.rulebook.name),o=w(x(n.filesystemScope,r));if(o===null||o===e.content)return[];return[{ok:!1,spec:e.spec,message:`${r} already exists and no configured source claims it; remove or rename the file, then re-run rule add`}]}function Uu(e,t,n,r){if(!te(e.spec))return[];let o=Ce(t.configDir,e.rulebook.name),i=x(t.filesystemScope,o),s=w(i);if(s===e.content)return[];return r?.push({target:i,previous:s}),ne(i,e.content,void 0,n._testAfterPolicyRename),Bu(e,s)}function Gu(e,t){try{return t()}catch(n){for(let r of[...e].reverse()){if(r.previous===null){me(r.target);continue}ne(r.target,r.previous)}throw n}}function Bu(e,t){if(t===null)return[`Vendored ${e.spec} (${e.rulebook.version})`];let n=St(t),r="problem"in n?null:n.rulebook,o=new Map(r?.rules.map((s)=>[s.name,JSON.stringify(s)])??[]),i=new Set(e.rulebook.rules.map((s)=>s.name));return[`Updated ${e.spec} (${r?.version??"unreadable"} -> ${e.rulebook.version})`,...[...i].filter((s)=>!o.has(s)).map((s)=>`  + ${s}`),...[...o.keys()].filter((s)=>!i.has(s)).map((s)=>`  - ${s}`),...e.rulebook.rules.filter((s)=>{let a=o.get(s.name);return a!==void 0&&a!==JSON.stringify(s)}).map((s)=>`  ~ ${s.name}`)]}function qu(e){return{spec:e.spec,name:e.rulebook.name,version:e.rulebook.version,ruleCount:e.rulebook.rules.length}}async function Ar(e,t={}){return Vu(e,Zu(t),fe())}async function Vu(e,t,n,r={}){let o=null,i=!1;try{let s=U(t),a=w(s.configTarget);o={target:s.configTarget,content:a};let l=Dr(s.configTarget);if(!l.ok)return l.result;let c=l.config,d=xe(e);zu(e,t,d);let m=d?await ji(e,{ref:t.ref,operation:n}):null,g=m?Ku(m,t.rulebooks):[],u=m?g.map((h)=>Ju(c.rules,m,h)??`${e}#${m.ref}/${h}`):[e],p=u.filter((h)=>!c.rules.includes(h)),f=[...c.rules,...p];if(f.length>Sr)return Yu();if(f.length!==c.rules.length)i=!0,K(s.configTarget,{version:1,rules:f,overrides:c.overrides??{},transparent_wrappers:c.transparent_wrappers??[]},void 0,r._testAfterPolicyRename);let b=await ln(t,n,r,new Set(p),new Set(p));if(!b.ok)xt(s.configTarget,a);if(!b.ok||!m)return b;let L=g.filter((h,S)=>p.includes(u[S]??""));return{...b,add:{source:e,ref:m.ref,selected:g,added:L,alreadyConfigured:g.filter((h)=>!L.includes(h)),commits:p.length>0?[m.commit]:[]}}}catch(s){if(i&&o)try{xt(o.target,o.content)}catch(a){return Ct(a)}return Ct(s)}}function zu(e,t,n){if(!n&&t.rulebooks!==void 0)throw Error("--only can only select rulebooks from an owner/repo source");if(!n&&t.ref)throw Error(`--ref can only select a ref for an owner/repo source: ${e}`);if(t.rulebooks?.length===0)throw Error("--only requires at least one rulebook name");let r=t.rulebooks?.filter((o)=>!Se.test(o))??[];if(r.length>0)throw Error(`Invalid rulebook names: ${r.join(", ")}`)}function Ku(e,t){let n=t?[...new Set(t)]:e.names,r=n.filter((o)=>!e.names.includes(o));if(r.length>0)throw Error(`Rulebooks not found in ${e.source} at ${e.ref}: ${r.join(", ")}
Available rulebooks: ${e.names.join(", ")}`);return n}function Ju(e,t,n){let r=`${t.source}#${t.ref}/${n}`;if(e.includes(r))return r;let o=`${t.source}#${t.commit}/${n}`;return e.find((i)=>i===o)}async function Wu(e,t,n=fe()){if(e.length>Sr)throw Error(Rr);let r=Array(e.length),o=0,i,s=Array.from({length:Math.min(e.length,zi.concurrency)},async()=>{while(!i){let a=o;if(a>=e.length)return;o++;try{r[a]=await t(e[a],a,n.controller.signal)}catch(l){if(!i)i={value:l},o=e.length,n.controller.abort(l);return}}});if(await Promise.all(s),i)throw i.value;return r}function Yu(){return{ok:!1,errors:[Rr],warnings:[],entries:[]}}function Er(e){return{cwd:e.cwd,userConfigDir:e.userConfigDir,userConfigPath:e.userConfigPath,projectConfigPath:e.projectConfigPath,global:e.global,check:e.check,only:e.only,refresh:e.refresh}}function Zu(e){return{...Er(e),ref:e.ref,rulebooks:e.rulebooks}}function Xu(e){return{...Er(e),deleteSource:e.deleteSource}}async function Tr(e,t={}){try{return await Qu(e,Xu(t),{})}catch(n){return Ct(n)}}async function Qu(e,t,n){let r=U(t),o=B(r.configTarget);if(o.errors.length>0)return{ok:!1,errors:o.errors,warnings:[],entries:[]};if(!o.config)return{ok:!1,errors:[`No config found at ${r.configPath}`],warnings:[],entries:[]};let i=Ei(o.config.rules,e);if(!i.ok)return i.result;let s=t.deleteSource?tp(r.configDir,i.specs,r.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let a=w(r.configTarget);if(a===null)return Ct(Error("Rules config is unavailable."));try{K(r.configTarget,{version:1,rules:o.config.rules.filter((d)=>!i.specs.includes(d)),overrides:o.config.overrides??{},transparent_wrappers:o.config.transparent_wrappers??[]},void 0,n._testAfterPolicyRename)}catch(d){throw xt(r.configTarget,a),d}let l=await ln(t,fe(),n);if(!l.ok)return xt(r.configTarget,a),l;let c=np(s.dirs,n,r.filesystemScope);if(!c.ok){xt(r.configTarget,a);let d=await ln(t,fe(),n);if(!d.ok)return{ok:!1,errors:[...c.result.errors,...d.errors],warnings:d.warnings,entries:d.entries};return c.result}return l}async function ep(e,t,n){let r=Ji(e,t.configDir,n.global?"user":"project",t.filesystemScope);return{ok:r.errors.length===0&&r.warnings.length===0,errors:[...r.errors,...r.warnings],warnings:[],entries:r.entries}}function tp(e,t,n){let r=t.flatMap((a)=>Se.test(a)?[]:["--delete-source can only delete local rulebook sources"]),o=t.map((a)=>Pr(e,a)),i=r.length>0?[]:o.flatMap((a)=>Wi(a,n)),s=[...r,...i];return s.length>0?{ok:!1,result:{ok:!1,errors:s,warnings:[],entries:[]}}:{ok:!0,dirs:o}}function Wi(e,t){let n=Fu(e),r=x(t,n),o=tt(r);if(!o)return[`Local rulebook source directory not found: ${e}`];let i=o.find((s)=>s.name==="rulebook.json");if(!i)return[`Local rulebook source directory is missing rulebook.json: ${e}`];if(i.kind!=="file")throw new M(t.label);if(w(x(t,Pr(n,"rulebook.json"))),o.length>1)return[`Local rulebook source directory contains extra files: ${e}. delete manually if you really want to remove the directory.`];return[]}function np(e,t,n){let r=e.flatMap((o)=>{try{if(!tt(x(n,o)))return[];let i=Wi(o,n);if(i.length>0)return i;return rp(o,t,n),[]}catch(i){return[`Failed to delete local rulebook source ${o}: ${i instanceof Error?i.message:String(i)}`]}});return r.length>0?{ok:!1,result:{ok:!1,errors:r,warnings:[],entries:[]}}:{ok:!0}}function rp(e,t,n){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(e);return}me(x(n,Pr(e,cn))),Vi(x(n,e))}function xt(e,t){if(t===null){me(e);return}ne(e,t)}function Ct(e){return{ok:!1,errors:[e instanceof Error?e.message:String(e)],warnings:[],entries:[]}}function rt(e,t){let n=sp(t),r=ts(n),o={effectiveLevel:r.effectiveLevel,selectedPreset:n.policySnapshot.policy.safety.level??"standard",...n.policySnapshot.policyScopes?{safetyPresetScope:n.policySnapshot.policyScopes.levelScope}:{},effectiveCapabilities:r.effectiveCapabilities,destructiveCommandRuleOverrides:n.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:i,configValid:s}=ip({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!e||!e.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:i,configValid:s,...o};let a=ap(e,n);if(a)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",rule:a.rule,matched:!0,reason:a.reason}]}]},result:"blocked",reason:q(a.reason),segment:q(a.target),...a.ruleId?{ruleId:q(a.ruleId)}:{},configSource:i,configValid:s,...o};let l=yi(e,n),c=l.decision,d=c?.ruleId??lp(e,n),m=Pt.find((u)=>u.id===d&&u.activationCapability),g=m?r.policy.effectiveDestructiveCommandRules[m.id]:void 0;return{trace:dp(l.trace),result:c?"blocked":"allowed",reason:c?q(c.reason):void 0,segment:c?q(c.evidence.find((u)=>u.kind==="command")?.segment??e):void 0,ruleId:c?.ruleId?q(c.ruleId):void 0,customRule:cp(up(c?.ruleId,n.policySnapshot)),configSource:i,configValid:s,...o,...m&&g?{ruleActivation:{id:m.id,...g}}:{}}}function ip(e){let t=re(e?.cwd),n=e?.userConfigPath??oe(e),r=De({cwd:e?.cwd,userConfigDir:e?.userConfigDir,userConfigPath:e?.userConfigPath});try{if(w(r.projectConfigTarget)!==null){if(pe(r.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(o){if(o instanceof M)return{configSource:t,configValid:!1};throw o}try{if(w(r.userConfigTarget)!==null){let o=pe(r.userConfigTarget);return{configSource:n,configValid:o.errors.length===0}}return{configSource:null,configValid:!0}}catch(o){if(o instanceof M)return{configSource:n,configValid:!1};throw o}}function sp(e){let t=op(e?.cwd??process.cwd()),n=e?.policySnapshot??V({cwd:t,userConfigDir:e?.userConfigDir}),r=ge(n.policy);return{cwd:t,effectiveCwd:t,policySnapshot:n,environment:Yi(),protectedGitMetadata:es([t]),effectiveCapabilities:r.capabilities,strict:e?.strict??r.strict,paranoidRm:r.paranoidRm,paranoidInterpreters:r.paranoidInterpreters,worktreeMode:r.worktreeMode}}function ap(e,t){let n=t.cwd??process.cwd(),r=Zi(nt("",{command:e},{kind:"command",shell:"posix"},{executionCwd:n,configCwd:n},e)),o=ss(r);if(o)return{reason:is,target:o.target,ruleId:"policy-protection",rule:"policy-protection:findPolicyConfigMutationTargetInSemanticFacts"};let i=os(r);if(i)return{reason:rs,target:i.target,ruleId:"policy-apply-protection",rule:"policy-apply-protection:findPolicyApplyInvocationInSemanticFacts"};let s=Qi(r,t.protectedGitMetadata);if(s)return{reason:Xi,target:s.target,ruleId:"git-metadata-protection",rule:"git-metadata-protection:findGitMetadataMutationTargetInSemanticFacts"};let a=t.policySnapshot.policy,l=a.secretProtection.enabled===!1?null:ls(r,a.secretProtection,{strict:t.strict});if(l)return{reason:as,target:l.target,ruleId:l.ruleId,rule:"secret-protection:findSensitiveTargetInSemanticFacts"};return null}function lp(e,t){let n=t.policySnapshot.policy,r=At({...n,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...n.destructiveCommandRuleOverrides,...Object.fromEntries(Pt.flatMap((o)=>o.activationCapability?[[o.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return ns(e,{...t,policySnapshot:r,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function cp(e){if(!e)return;return{id:q(e.id),...e.rulebook?{rulebook:{name:q(e.rulebook.name),version:q(e.rulebook.version)}}:{},...e.source?{source:q(e.source)}:{},...e.override?{override:{type:"reason",reason:q(e.override.reason)}}:{}}}function dp(e){let t=e.events.flatMap((r)=>r.kind==="step"&&r.scope==="global"?[r.step]:[]),n=new Map;for(let r of e.events){if(r.kind!=="step"||r.scope!=="segment")continue;let o=n.get(r.segmentIndex)??{index:r.segmentIndex,steps:[]};o.steps.push(r.step),n.set(r.segmentIndex,o)}return{steps:t,segments:[...n.values()]}}function up(e,t){let n=e?.replace(/^custom\./,"");if(!n||!t.policy.rules.some((r)=>r.name===n))return;return t.ruleMetadata[n]??Object.freeze({id:n})}function yp(e){let t=ot(),n=E({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},e);if(ue(n.errors))return null;if(n.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(n.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let r=n.values.limit===void 0?20:cs(n.values.limit);if(r===null)return console.error("--limit must be a positive number"),null;let o=n.values.since===void 0?Math.min(30,t):cs(n.values.since);if(o===null||o>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let i={limit:r,limitExplicit:n.values.limit!==void 0,since:o,sinceExplicit:n.values.since!==void 0,all:n.flags.all,json:n.flags.json,suspect:n.flags.suspect,pruneLegacy:n.flags.pruneLegacy,dryRun:n.flags.dryRun,id:n.values.id,agent:n.values.agent,rule:n.values.rule,session:n.values.session,project:n.values.project===void 0?void 0:hp(n.values.project)};if(i.id&&(i.agent!==void 0||i.rule!==void 0||i.session!==void 0||i.project!==void 0||i.suspect||i.sinceExplicit||i.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(i.pruneLegacy&&(i.id!==void 0||i.agent!==void 0||i.rule!==void 0||i.session!==void 0||i.project!==void 0||i.suspect||i.all||i.sinceExplicit||i.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(i.dryRun&&!i.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return i}async function ps(e,t={}){let n=yp(e);if(!n)return 1;let r=t.logsDir??he();if(n.pruneLegacy)return vp(r,n.json,n.dryRun);if(!r)return console.log(n.json?"[]":n.id?`No retained audit log entry found for id ${N(n.id)}.`:"No audit log entries found."),0;Fe(r);let o={count:0},i=ke(r,o).flatMap((d)=>_e(d,o).map((m)=>({entry:m,file:d})));if(o.count>0)console.error(`warning: ${o.count} audit log ${o.count===1?"source":"sources"} could not be read; these results are incomplete`);if(n.id)return kp(i,n,t.timeZone);let s=Date.now()-n.since*24*60*60*1000,a=i.filter((d)=>xp(d,n,r,s)),l=n.suspect?ur(a.map((d)=>d.entry)):null,c=(l?a.filter((d)=>l.has(d.entry)):a).sort((d,m)=>Date.parse(m.entry.ts)-Date.parse(d.entry.ts)).slice(0,n.limit);if(n.json)return console.log(JSON.stringify(c.map((d)=>d.entry),null,2)),0;if(c.length===0)return console.log("No audit log entries found."),0;for(let d of c)console.log(Rp(d.entry,t.timeZone));return 0}function vp(e,t,n){let r=e?Lp(e).map((a)=>gp(e,a)):[];if(n)return bp(r,t);let o=[],i=0,s=0;for(let a of r){let l=ds(a,{throwIfNoEntry:!1})?.size??0,c=wp(a);if(c){o.push(`${us(a)}: ${c}`);continue}i++,s+=l}if(t)return console.log(JSON.stringify({removedFiles:i,removedBytes:s,failedFiles:o.length})),o.length===0?0:1;console.log(i===0&&o.length===0?"No legacy audit log files found.":`Removed ${i} legacy audit log ${i===1?"file":"files"} (${fs(s)}).`);for(let a of o)console.error(`Could not remove ${N(a)}`);if(console.log("Nested v2 audit logs were not changed."),i>0)console.log("This deletion cannot be undone.");return o.length===0?0:1}function bp(e,t){let n=e.reduce((r,o)=>r+(ds(o,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:e.length,bytes:n})),0;if(console.log(e.length===0?"No legacy audit log files found.":`Would remove ${e.length} legacy audit log ${e.length===1?"file":"files"} (${fs(n)}).`),console.log("Nested v2 audit logs are not included."),e.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function Lp(e){try{return pp(e,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function wp(e){try{return fp(e),null}catch(t){return t instanceof Error?t.message:String(t)}}function fs(e){let t=["B","KiB","MiB","GiB"],n=Math.min(Math.floor(Math.log2(Math.max(e,1))/10),t.length-1);return`${Math.round(e/1024**n*10)/10} ${t[n]}`}function kp(e,t,n){let r=e.filter((i)=>i.entry.id===t.id);if(r.length>1)return console.error(`Multiple audit log entries found for id ${N(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(r.map((i)=>i.entry),null,2)),0;let o=r[0];if(!o)return console.log(`No retained audit log entry found for id ${N(t.id??"")}.`),0;return console.log(Dp(o.entry,n)),0}function xp(e,t,n,r){if(!t.all&&e.entry.decision==="allow")return!1;if(Date.parse(e.entry.ts)<r)return!1;if(t.agent!==void 0&&e.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&e.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!Cp(e,n,t.session))return!1;if(t.project!==void 0&&!Sp(e.entry.cwd,t.project))return!1;return!0}function Cp(e,t,n){if(e.entry.sessionId===n)return!0;return mp(e.file)===t&&us(e.file,".jsonl")===n}function Sp(e,t){if(!e)return!1;return e===t||e.startsWith(`${t}/`)}function Rp(e,t){let n=N(e.id??"-"),r=N(e.decision??"deny"),o=e.cwd?`  [${N(e.cwd)}]`:"",i=e.segment||e.command,s=i===e.command?"":"↳ ",a=i.length>50?`${i.slice(0,50)}…`:i;return`${n.padEnd(16)}  ${N(ms(e.ts,t))}  ${r.padEnd(5)}  ${N(e.agent??"-").padEnd(15)}  ${N(e.ruleId??"-").padEnd(20)}  ${s}${N(a)}${o}`}function Dp(e,t){let n=(o)=>N(o===void 0||o===null||o===""?"-":o),r=e.shape?`${e.agent??"-"} (shape: ${e.shape})`:e.agent??"-";return[`id:        ${n(e.id)}`,`ts:        ${n(ms(e.ts,t))}`,`decision:  ${n(e.decision)}`,`agent:     ${n(r)}`,`level:     ${n(e.level)}`,`tool:      ${n(e.toolName)}`,`rule:      ${n(e.ruleId)}`,`intent:    ${n(e.intent)}`,`stage:     ${n(e.failureStage)}`,`error:     ${n(e.errorCode)}`,`session:   ${n(e.sessionId)}`,`cwd:       ${n(e.cwd)}`,`version:   ${n(e.v)}`,`truncated: ${n(e.truncated===!0?"yes":void 0)}`,`reason:    ${n(e.reason)}`,`command:   ${n(e.command)}`,`segment:   ${n(e.segment)}`].join(`
`)}function ms(e,t){let n=new Date(e);if(Number.isNaN(n.getTime()))return e;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(n)}function cs(e){let t=Number(e);return Number.isFinite(t)&&t>0?t:null}var gs={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var hs={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var ys={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as Rs,join as Hp,relative as Mp}from"node:path";var Pp=8388608;function Ap(e,t){console.log(JSON.stringify(e(bs(t))))}async function Ep(e){let t;try{t=(await Br(process.stdin)).trim()}catch{e({reason:"Failed to parse hook input JSON."});return}if(!t){e({reason:"Missing hook input JSON."});return}return qr(t,e,"Failed to parse hook input JSON.")}async function Br(e){let t=[],n=0;for await(let r of e){let o=typeof r==="string"?Buffer.from(r,"utf-8"):Buffer.from(r.buffer,r.byteOffset,r.byteLength);if(n+=o.byteLength,n>Pp)throw Tp(e),Error("hook input byte limit exceeded");t.push(o)}return Buffer.concat(t,n).toString("utf-8")}function Tp(e){let t=e.destroy??e.cancel;if(!t)return;try{Promise.resolve(t.call(e)).catch(()=>{})}catch{}}function qr(e,t,n){try{return JSON.parse(e)}catch{t({reason:n});return}}function F(e,t){let n=t.get(e);return n?{kind:"command",shell:n}:{kind:ws(e)}}function ie(e,t,n,r){let o=e===void 0?process.cwd():e,i=typeof o==="string"&&o.trim()!==""?W([o]):void 0;if(i)return{configCwd:i,executionCwd:i};return I(r,t,n,Op(o)),null}function I(e,t,n,r){let o;try{o=Gr(t)}catch(i){if(!(i instanceof ye))throw i}e(pn({command:o,segment:r,toolName:n}))}async function Ip(e){let t=await Ep(e.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){I(e.outputDeny);return}if(!e.isSupported(t))return;let n=e.getAgent?.(t)??e.agent,r=e.agent===n?void 0:e.agent,o=Fp(t),i=(u,p)=>{vs(u,()=>e.getSessionId(t),{agent:n,shape:r,toolName:p,cwd:o}),e.outputDeny(u)},s=e.getToolName(t);if(typeof s!=="string"||s.trim()===""){I((u)=>i(u),Np(t));return}let a=s,l=(u)=>i(u,a),c;try{c=e.getToolInput(t,a,l)}catch(u){if(!(u instanceof ye))throw u;I(l,void 0,a);return}if(!c.ok)return;let d=e.getContext(t,c.input,a,l);if(!d)return;let m;try{m=Gr(c.input)}catch(u){if(!(u instanceof ye))throw u;I(l,void 0,a);return}let g=nt(a,c.input,c.route,d,m??null);try{let u=fn(g,{guard:{auditAllowed:ks(),dependencies:e.guardDependencies},audit:{agent:n,shape:r,getSessionId:()=>e.getSessionId(t)}}),p=Ur(u,{includeEvidence:!0,toolName:u.stage==="command-analysis"?void 0:a});if(p){e.outputDeny(p);return}e.outputAllow?.()}catch(u){if(!(u instanceof xs))throw u;_p(u);let p=Ur(u.evaluation,{includeEvidence:!0,toolName:u.evaluation.stage==="command-analysis"?void 0:a});if(p)e.outputDeny(p);return}}function _p(e){if(!Et(C.debug))return;console.error(`CC Safety Net debug: ${$p(e.stage)}: ${Ls(e.cause)}`)}function $p(e){if(e==="policy-protection")return"hook policy protection failed";if(e==="config-load")return"hook config loading failed";if(e==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function Op(e){return typeof e==="string"?e:void 0}function Np(e){if(!e||typeof e!=="object"||Array.isArray(e))return;if(Object.hasOwn(e,"tool_input"))return e.tool_input;let t=e.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function Fp(e){if(!e||typeof e!=="object"||Array.isArray(e))return null;let t=e.cwd;if(typeof t==="string")return t;let n=e.toolCall;if(!n||typeof n!=="object"||Array.isArray(n))return null;let r=n.args;if(!r||typeof r!=="object"||Array.isArray(r))return null;let o=r.Cwd;return typeof o==="string"?o:null}async function H(e){let t=(o)=>Ap(e.createDenyOutput,o),n=e.createAllowOutput;await Ip({...e,outputDeny:t,outputAllow:n?()=>console.log(JSON.stringify(n())):void 0})}function Ot(e){return Hp(e,".gemini","config","hooks.json")}var jp=new Map([["run_command","auto"]]),Up=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function Ds(e){return F(e,jp)}async function Ps(){await H({agent:"antigravity-cli",createDenyOutput:(e)=>({decision:"deny",reason:e}),isSupported:()=>!0,getToolName:(e)=>e.toolCall?.name,getToolInput:(e,t)=>({ok:!0,input:zp(e.toolCall?.args,t),route:Ds(t)}),getContext:Gp,getSessionId:(e)=>e.conversationId})}function Gp(e,t,n,r){let i=Vp(e).flatMap((c)=>{let d=W([c]);return d?[d]:[]});if(!i[0])return je(r,t,n),null;if(n!=="run_command"){let c;try{c=Bp(t,n,i)}catch(d){if(d instanceof ye)return je(r,void 0,n),null;if(!(d instanceof He))throw d;return je(r,t,n),null}if(!c)return je(r,t,n),null;return{configCwd:c,executionCwd:c}}let s=e.toolCall?.args;if(!s||!Object.hasOwn(s,"Cwd"))return{configCwd:i[0],executionCwd:i[0]};let a=s.Cwd;if(typeof a!=="string"||a.trim()==="")return je(r,t,n),null;let l=ve(a,i);if(l){let c=As(l,i);if(!c)return je(r,t,n,a),null;return{configCwd:c,executionCwd:l}}return je(r,t,n,a),null}function Bp(e,t,n){let r=Ds(t),o=[...Cs(e,Up),...r.kind==="patch"?Ss(e):[]].filter(Rs),i=mn(),s=new Set(o.flatMap((a)=>{let l=As($t(a,_t,i),n);return l?[l]:[]}));if(s.size>1)return null;return[...s][0]??n[0]??null}function As(e,t){return t.filter((n)=>qp(e,n)).reduce((n,r)=>r.length>n.length?r:n,"")||null}function qp(e,t){let n=Mp(t,e);return n===""||!n.startsWith("..")&&!Rs(n)}function je(e,t,n,r){let o=t&&typeof t==="object"?t.command:void 0;e(pn({command:typeof o==="string"?o:void 0,segment:r,toolName:n}))}function Vp(e){if(e.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(e.workspacePaths)?e.workspacePaths.filter((n)=>typeof n==="string"&&n.trim()!==""):[];return W(t)?t:[]}function zp(e,t){if(!e)return;if(t!=="run_command")return e;return{...e,command:typeof e.CommandLine==="string"&&e.CommandLine!==""?e.CommandLine:void 0}}var Nt=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",artifactKind:"hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",artifactKind:"plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",artifactKind:"plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",artifactKind:"plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",artifactKind:"extension",probeCommand:["gemini","--version"]}},{id:"grok-build",displayName:"Grok Build",doctorOrder:8,runtime:{order:6,flags:["-gb","--grok-build"],description:"Run as Grok Build PreToolUse hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--grok-build",artifactKind:"hook config",probeCommand:["grok","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:9,runtime:{order:7,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--hermes-agent",artifactKind:"plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:10,runtime:{order:8,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:10,flag:"--kimi-code",artifactKind:"hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:11,install:{order:11,flag:"--openclaw",artifactKind:"plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:12,install:{order:12,flag:"--opencode",artifactKind:"plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:13,install:{order:13,flag:"--pi",artifactKind:"package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",artifactKind:"hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",artifactKind:"plugin",probeCommand:["amp","--version"]}}],gn=Nt.slice().sort((e,t)=>e.doctorOrder-t.doctorOrder).map((e)=>e.id),Es=Nt.filter((e)=>("runtime"in e)).slice().sort((e,t)=>e.runtime.order-t.runtime.order).map((e)=>({id:e.id,displayName:"displayName"in e.runtime?e.runtime.displayName:e.displayName,flags:e.runtime.flags,legacyFlags:"legacyFlags"in e.runtime?e.runtime.legacyFlags:[],description:e.runtime.description,legacyTopLevelFlags:e.runtime.legacyTopLevelFlags})),Y=Nt.slice().sort((e,t)=>e.install.order-t.install.order).map((e)=>({id:e.id,...e.install})).map(({order:e,...t})=>t),Av=Object.fromEntries(Nt.map((e)=>[e.id,e.displayName]));function P(e){return Nt.find((t)=>t.id===e)?.displayName??e}import{homedir as Kp}from"node:os";import{isAbsolute as Ts,join as Vr}from"node:path";function _s(e){if(e!==void 0&&e!==null&&typeof e!=="string")return"unknown";if(typeof e==="string"&&!Ts(e))return"unknown";try{let t=mn(),n=typeof e==="string"&&e?$t(e,_t,t):void 0,r=process.env.HOME||Kp(),o=[["codex",process.env.CODEX_HOME||Vr(r,".codex")],["copilot-cli",process.env.COPILOT_HOME||Vr(r,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||Vr(r,".claude")]],i=n?o.flatMap(([s,a])=>{if(!Ts(a))return[];return Is(n,$t(a,_t,t))?[s]:[]}):[];if(i.length===1)return i[0]??"unknown";if(i.length>1)return"unknown"}catch(t){if(t instanceof He)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var zr="PreToolUse",$s="BeforeTool",Os="pre_tool_call",Kr="PreToolUse";var Jp=new Map([["Bash","posix"],["PowerShell","powershell"]]);function Wp(e){return F(e,Jp)}async function Ns(){await H({agent:"claude-code",getAgent:(e)=>_s(e.transcript_path),createDenyOutput:(e)=>({hookSpecificOutput:{hookEventName:zr,permissionDecision:"deny",permissionDecisionReason:e}}),isSupported:(e)=>e.hook_event_name===zr,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:Wp(t)}),getContext:(e,t,n,r)=>ie(e.cwd,t,n,r),getSessionId:(e)=>e.session_id})}var Yp=new Map([["bash","auto"],["Bash","auto"],["powershell","powershell"],["PowerShell","powershell"]]);function Zp(e){return F(e,Yp)}async function Fs(){await H({agent:"copilot-cli",createDenyOutput:(e)=>({permissionDecision:"deny",permissionDecisionReason:e}),isSupported:()=>!0,getToolName:(e)=>e.toolName,getToolInput:(e,t,n)=>{if(typeof e.toolArgs!=="string")return n({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let r=qr(e.toolArgs,n,"Failed to parse toolArgs JSON.");if(r===void 0)return{ok:!1};return{ok:!0,input:r,route:Zp(t)}},getContext:(e,t,n,r)=>ie(e.cwd,t,n,r),getSessionId:(e)=>typeof e.sessionId==="string"&&e.sessionId.trim()?e.sessionId:void 0})}var Xp=new Map([["Shell","auto"]]);function Qp(e){return F(e,Xp)}async function Hs(){await H({agent:"cursor",createDenyOutput:(e)=>({permission:"deny",user_message:e,agent_message:e}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:Qp(t)}),getContext:e2,getSessionId:(e)=>e.conversation_id})}function e2(e,t,n,r){let o=t2(e);if(!o[0])return I(r,t,n),null;let i=ve(r2(e.cwd),o);if(!i)return I(r,t,n,typeof e.cwd==="string"?e.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:i,executionCwd:i};if(!Object.hasOwn(t,"working_directory"))return{configCwd:i,executionCwd:i};let s=t.working_directory;if(typeof s!=="string"||s.trim()==="")return I(r,t,n),null;let a=ve(s,o);if(!a)return I(r,t,n,s),null;return{configCwd:i,executionCwd:a}}function t2(e){return n2(e).flatMap((t)=>{let n=W([t]);return n?[n]:[]})}function n2(e){if(e.workspace_roots===void 0)return typeof e.cwd==="string"&&e.cwd.trim()!==""?[e.cwd]:[];if(!Array.isArray(e.workspace_roots))return[];return e.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function r2(e){return typeof e==="string"&&e.trim()!==""?e:"."}var o2=new Map([["run_shell_command","auto"]]);function i2(e){return F(e,o2)}async function Ms(){await H({agent:"gemini-cli",createDenyOutput:(e)=>({decision:"deny",reason:e,systemMessage:e}),isSupported:(e)=>e.hook_event_name===$s,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:i2(t)}),getContext:(e,t,n,r)=>ie(e.cwd,t,n,r),getSessionId:(e)=>e.session_id})}var s2=new Map([["run_terminal_command","auto"]]);function a2(e){return F(e,s2)}async function js(){await H({agent:"grok-build",createDenyOutput:(e)=>({decision:"deny",reason:e}),createAllowOutput:()=>({decision:"allow"}),isSupported:()=>!0,getToolName:(e)=>e.toolName,getToolInput:(e,t,n)=>{if(e.toolInputTruncated===!0)return I(n,e.toolInput,t),{ok:!1};return{ok:!0,input:e.toolInput,route:a2(t)}},getContext:l2,getSessionId:(e)=>e.sessionId})}function l2(e,t,n,r){let o=W(c2(e));if(!o)return I(r,t,n),null;let i=ve(d2(e.cwd),[o]);if(!i)return I(r,t,n,typeof e.cwd==="string"?e.cwd:void 0),null;return{configCwd:i,executionCwd:i}}function c2(e){let t=e.workspaceRoot===void 0?e.cwd:e.workspaceRoot;return typeof t==="string"&&t.trim()!==""?[t]:[]}function d2(e){return typeof e==="string"&&e.trim()!==""?e:"."}import{resolve as u2}from"node:path";var p2=new Map([["terminal","posix"]]);async function Us(){await H({agent:"hermes-agent",createDenyOutput:(e)=>({action:"block",message:e}),isSupported:(e)=>e.hook_event_name===Os,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:F(t,p2)}),getContext:f2,getSessionId:(e)=>e.session_id})}function f2(e,t,n,r){let o=ie(e.cwd,t,n,r);if(!o)return null;if(!t||typeof t!=="object"||Array.isArray(t))return o;if(!Object.hasOwn(t,"workdir"))return o;let i=t.workdir;if(typeof i!=="string"||i.trim()==="")return I(r,t,n),null;let s=W([u2(o.configCwd,i)]);if(!s)return I(r,t,n,i),null;return{...o,executionCwd:s}}var Gs=new Map([["Bash","posix"]]);function m2(e){return F(e,Gs)}async function Bs(){await H({agent:"kimi-code",createDenyOutput:(e)=>({hookSpecificOutput:{hookEventName:Kr,permissionDecision:"deny",permissionDecisionReason:e}}),isSupported:(e)=>e.hook_event_name===Kr,getToolName:(e)=>e.tool_name,getToolInput:(e,t)=>({ok:!0,input:e.tool_input,route:m2(t)}),getContext:(e,t,n,r)=>{let o=ie(e.cwd,t,n,r);if(!o)return null;let i=e.tool_input;if(!Gs.has(n)||!i||!Object.hasOwn(i,"cwd"))return o;let s=i.cwd;if(typeof s!=="string"||s.trim()==="")return I(r,t,n),null;let a=ve(s,[o.configCwd]);if(!a)return I(r,t,n,s),null;return{configCwd:o.configCwd,executionCwd:a}},getSessionId:(e)=>e.session_id})}var g2={"antigravity-cli":Ps,"claude-code":Ns,"copilot-cli":Fs,cursor:Hs,"gemini-cli":Ms,"grok-build":js,"hermes-agent":Us,"kimi-code":Bs},it=Es.map((e)=>({...e,run:g2[e.id]}));function qs(e){let t=E({label:"hook",booleans:Object.fromEntries(it.map((r)=>[r.id,[...r.flags,...r.legacyFlags]]))},e);if(t.errors.length>0)return;let n=it.filter((r)=>t.flags[r.id]);return n.length===1?n[0]:void 0}function Vs(e){return it.find((t)=>t.legacyTopLevelFlags.some((n)=>n===e))}var h2=it.map((e)=>({flags:e.flags.join(", "),description:e.description})),y2=it.flatMap((e)=>e.flags.map((t)=>`cc-safety-net hook ${t}`)),zs={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...h2,{flags:"-h, --help",description:"Show this help"}],examples:y2};var Ks={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...Y.map((e)=>({flags:e.flag,description:`Install ${P(e.id)} ${e.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...Y.map((e)=>`cc-safety-net install ${e.flag}`)]},Js={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...Y.map((e)=>({flags:e.flag,description:`Uninstall ${P(e.id)} ${e.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...Y.map((e)=>`cc-safety-net uninstall ${e.flag}`)]},Ws={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var Ys={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var hn={name:"policy",description:"Check and apply project or user policy proposals",usage:"policy <subcommand>",subcommands:[{usage:"check <file>",description:"Validate a policy proposal and print its diff"},{usage:"apply <file>",description:"Apply a proposal after confirming in a terminal"}],options:[{flags:"-g, --global",description:"Use the user-scope policy instead of the project one"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net policy check proposal.json","cc-safety-net policy apply proposal.json","cc-safety-net policy apply proposal.json --global"]};var Jr=[{flags:"--ref",argument:"<ref>",description:"Use a branch, tag, or commit"},{flags:"--only",argument:"<rulebook...>",description:"Add only these repository rulebooks"},{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"-h, --help",description:"Show this help"}],Wr=["cc-safety-net rule add project-rules","cc-safety-net rule add acme/safety-rules","cc-safety-net rule add acme/safety-rules --only aws gcloud","cc-safety-net rule add acme/safety-rules --ref v2 --only aws"],st={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source> [--ref <ref>] [--only <rulebook...>]",description:"Add rulebook sources and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Re-fetch and vendor remote rulebooks"},{usage:"sync",description:"Deprecated: migrate lock and cache leftovers"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},...Jr.slice(0,2),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk",...Wr,"cc-safety-net rule update","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var Zs={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var Xs={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var yn=[Zs,gs,Ys,hs,st,hn,Ks,Ws,Js,zs,ys,Xs];function v2(e){return e.aliases??[]}function vn(e){let t=e.toLowerCase();return yn.find((n)=>n.name.toLowerCase()===t||v2(n).some((r)=>r.toLowerCase()===t))}import{basename as b2}from"node:path";function bn(e=7,t=he()){let n=Date.now()-e*24*60*60*1000,r=[],o=new Set,i=0,s,a,l,c;if(t)Fe(t);let d={count:0},m=t?ke(t,d):[];for(let u of m)for(let p of _e(u,d)){if(p.decision==="allow")continue;let f=new Date(p.ts).getTime();if(f>=n){if(i++,o.add(p.sessionId??b2(u,".jsonl")),a===void 0||f<=a)s=p.ts,a=f;if(c===void 0||f>c)l=p.ts,c=f;L2(r,p,f)}}let g=r.map((u)=>({timestamp:u.ts,command:u.command,reason:u.reason,relativeTime:dr(new Date(u.ts))}));return{totalBlocked:i,sessionCount:o.size,recentEntries:g,oldestEntry:s,newestEntry:l,unreadable:d.count}}function L2(e,t,n){let r=e.findIndex((o)=>n>new Date(o.ts).getTime());if(r===-1){if(e.length<3)e.push(t);return}if(e.splice(r,0,t),e.length>3)e.pop()}import{dirname as w2}from"node:path";function Qs(e,t,n){let r;try{if(w(t)===null)return{path:e,exists:!1,valid:!1,ruleCount:0};r=pe(t),r.errors.push(...J(e,n))}catch(o){if(!(o instanceof M))throw o;r={errors:[o.message],ruleNames:new Set}}return{path:e,exists:!0,valid:r.errors.length===0,ruleCount:r.ruleNames.size,...r.errors.length>0?{errors:r.errors}:{}}}function k2(e,t){return{source:t,name:e.name,command:e.command,subcommand:e.subcommand,blockArgs:[...e.block_args],reason:e.reason}}function ea(e,t){let n=t?.userConfigPath??oe(),r=t?.projectConfigPath??re(e),o=w2(n),i=Re({cwd:e,userConfigPath:n,projectConfigPath:r,userConfigDir:o}),s=De({cwd:e,userConfigPath:n,projectConfigPath:r,userConfigDir:o}),a=new Map(i.rulebooks.flatMap((l)=>l.rules.map((c)=>[c,l.source])));return{userConfig:Qs(n,s.userConfigTarget,s.userScope),projectConfig:Qs(r,s.projectConfigTarget,s.projectScope),effectiveRules:i.rules.map((l)=>k2(l,a.get(l.name)??"project")),shadowedRules:[]}}var x2=[{flag:C.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:C.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:C.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:C.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:C.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:C.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:C.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:C.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function ta(){return[...x2.map((e)=>({name:e.flag.name,value:Mr(e.flag),isSet:jr(e.flag),legacyName:e.flag.legacyName,legacyValue:e.flag.legacyName?process.env[e.flag.legacyName]:void 0,legacyIsSet:e.flag.legacyName?process.env[e.flag.legacyName]!==void 0:void 0,description:e.description,defaultBehavior:e.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var na={error:0,warning:1,info:2},C2=["policy","config","audit"];function S2(e){return e.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var R2=[{derive:(e)=>e.hooks.length>0&&e.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(e)=>e.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let n=P(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${n} inspection failed`,detail:`Doctor could not verify the ${n} integration configuration.`,fixHint:`Correct the reported ${n} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(e)=>e.userConfig.exists&&!e.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:e.userConfig.path}]:[]},{derive:(e)=>e.projectConfig.exists&&!e.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:e.projectConfig.path}]:[]},{derive:(e)=>e.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${e.configState.reason}`,fixHint:"Fix the file named in the reason, or run `cc-safety-net rule update` to vendor a remote source, then rerun doctor."}]:[]},{derive:(e)=>e.v2Leftovers&&e.v2Leftovers.length>0?[{checkId:"config.v2-leftovers",severity:"info",title:"Rulebook lock and cache leftovers detected",detail:`Files an earlier version left behind are no longer read: ${e.v2Leftovers.join(", ")}.`,fixHint:"Run `cc-safety-net rule sync` (add `--global` for user scope) to migrate them, then rerun doctor."}]:[]},{derive:(e)=>{let t=e.environment.find((n)=>n.name==="CC_SAFETY_NET_AUDIT_SCOPE");return Hr(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...C2.map((e)=>({derive:(t)=>t.posture.directories.filter((n)=>n.kind===e&&n.status==="unsafe").map((n)=>({checkId:`posture.${e}-directory-unsafe`,severity:"error",title:`${e[0]?.toUpperCase()}${e.slice(1)} directory is unsafe`,detail:`The ${e} directory ${S2(n.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...n.path?{path:n.path}:{}}))})),{derive:(e)=>{let t=[...e.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function ra(e){return R2.flatMap((t,n)=>t.derive(e).map((r,o)=>({finding:r,catalogOrder:n,occurrence:o}))).sort((t,n)=>na[t.finding.severity]-na[n.finding.severity]||t.catalogOrder-n.catalogOrder||t.occurrence-n.occurrence).map((t)=>t.finding)}function se(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var D2=(e)=>se()?`\x1B[32m${e}\x1B[0m`:e,P2=(e)=>se()?`\x1B[33m${e}\x1B[0m`:e,A2=(e)=>se()?`\x1B[34m${e}\x1B[0m`:e,E2=(e)=>se()?`\x1B[35m${e}\x1B[0m`:e,T2=(e)=>se()?`\x1B[36m${e}\x1B[0m`:e,I2=(e)=>se()?`\x1B[31m${e}\x1B[0m`:e,_2=(e)=>se()?`\x1B[2m${e}\x1B[0m`:e,$2=(e)=>se()?`\x1B[1m${e}\x1B[0m`:e,y={green:D2,yellow:P2,blue:A2,magenta:E2,cyan:T2,red:I2,dim:_2,bold:$2},O2="\x1B[0m",N2=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function F2(e){let t=e;return()=>(t=(t*1664525+1013904223)%4294967296,t/4294967296)}function H2(e){let t=[...N2],n=F2(e);for(let r=t.length-1;r>0;r--){let o=Math.floor(n()*(r+1)),i=t[r];t[r]=t[o],t[o]=i}return t}function M2(e,t=0){if(!se())return"";let n=H2(t);return`\x1B[38;5;${n[e%n.length]}m`}function oa(e,t,n=0){if(!se())return`"${e}"`;return`${M2(t,n)}"${e}"${O2}`}function Ln(e){return e==="default"?"built-in default":`${e} policy`}var j2=new RegExp("\x1B\\[[0-9;]*m","g"),Yr=(e)=>e.replace(j2,"").length;function Ue(e){let t=(e.headers??e.rows[0]??[]).map((s,a)=>{let l=Math.max(...e.rows.map((c)=>Yr(c[a]??"")));return Math.max(Yr(s),l)}),n=(s,a)=>s+" ".repeat(Math.max(0,a-Yr(s))),r=(s,a)=>a[0]+t.map((l)=>s.repeat(l+2)).join(a[1])+a[2],o=(s)=>`│ ${s.map((a,l)=>n(a,t[l]??0)).join(" │ ")} │`,i=e.headers?[`   ${o(e.headers)}`,`   ${r("─",["├","┼","┤"])}`]:[];return[`   ${r("─",["┌","┬","┐"])}`,...i,...e.rows.map((s)=>`   ${o(s)}`),`   ${r("─",["└","┴","┘"])}`].join(`
`)}function ia(e){let t=[];t.push("Hook Integration"),t.push(U2(e));let n=[],r=[];for(let o of e){let i=P(o.platform);if(o.errors&&o.errors.length>0)for(let s of o.errors)if(o.configured)n.push({platform:i,message:s});else r.push({platform:i,message:s})}for(let o of n)t.push(`   Warning (${o.platform}): ${o.message}`);for(let o of r)t.push(y.red(`   Error (${o.platform}): ${o.message}`));return t.join(`
`)}function U2(e){let t=["Platform","Discovery","Configuration","Inspection"],n=e.map((r)=>{let o=P(r.platform);if(r.inspectionStatus==="not-inspected"){let l=y.dim("Not inspected");return[o,l,l,l]}let i=r.detected?y.green("Detected"):r.inspectionStatus==="failed"?y.red("Unknown"):y.dim("Not detected"),s=r.configured?y.green("Configured"):r.detected?y.yellow("Not configured"):r.inspectionStatus==="failed"?y.red("Unknown"):y.dim("Not applicable"),a=r.inspectionStatus==="verified"?y.green("Verified"):r.inspectionStatus==="failed"?y.red("Failed"):y.dim("Not applicable");return[o,i,s,a]});return Ue({headers:t,rows:n})}function sa(e){let n=["Guard Engine Verification",`   Synthetic self-test: ${e.failed>0?y.red(`${e.passed}/${e.total} FAIL`):y.green(`${e.passed}/${e.total} passed`)}`],r=e.results.filter((o)=>!o.passed);if(r.length>0){n.push(""),n.push(y.red("   Failures:"));for(let o of r)n.push(y.red(`   • ${o.description}`)),n.push(y.red(`     expected ${o.expected}, got ${o.actual}`))}return n.join(`
`)}function G2(e){if(e.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],n=e.map((r)=>[r.source,r.name,r.subcommand?`${r.command} ${r.subcommand}`:r.command,r.blockArgs.join(", ")]);return Ue({headers:t,rows:n})}function aa(e){let t=[];if(t.push("Configuration"),t.push(B2(e.userConfig,e.projectConfig)),t.push(""),e.effectiveRules.length>0)t.push(`   Effective rules (${e.effectiveRules.length} total):`),t.push(G2(e.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let n of e.shadowedRules)t.push(""),t.push(`   Note: Project rule "${n.name}" shadows user rule with same name`);return t.join(`
`)}function B2(e,t){let n=["Scope","Status"],r=(i)=>{if(!i.exists)return y.dim("N/A");if(!i.valid)return y.red(`Invalid (${i.errors?.[0]??"unknown error"})`);return y.green("Configured")},o=[["User",r(e)],["Project",r(t)]];return Ue({headers:n,rows:o})}function la(e){let t=[];return t.push("Environment"),t.push(q2(e)),t.join(`
`)}function ca(e){let t=e.effectiveSafety.policyScopes,n=["Effective Safety",`   Selected preset: ${e.effectiveSafety.selectedPreset}${t?` (${Ln(t.levelScope)})`:""}`,`   Effective: ${e.effectiveSafety.level}`],r=[["fail_closed","fail_closed"],["paranoid_rm","paranoid_rm"],["paranoid_interpreters","paranoid_interpreters"]];for(let[o,i]of r){let s=e.effectiveSafety.capabilities[o],a=s.enabled?y.green("ON"):y.dim("OFF"),l=s.sources.length>0?` (${s.sources.join(", ")})`:"";n.push(`   ${i}: ${a} via ${s.source}${l}`)}if(t&&t.weakenings.length>0){n.push("   Project policy deltas:");for(let o of t.weakenings)n.push(`      ${o}`)}n.push(`   Stored rule customizations: ${e.effectiveSafety.ruleCounts.stored}`),n.push(`   Effective rule customizations: ${e.effectiveSafety.ruleCounts.effective}`);for(let[o,i]of Object.entries(e.effectiveSafety.ruleOverrides))n.push(`   ${o}: ${i}`);return n.join(`
`)}function da(e){let t=["Findings"];if(e.length===0)return t.push("   No findings from inspected doctor facts."),t.join(`
`);for(let n of e){let r=`[${n.severity.toUpperCase()}] ${n.checkId}: ${N(n.title)}`,o=n.severity==="error"?y.red:n.severity==="warning"?y.yellow:y.blue;if(t.push(`   ${o(r)}`),t.push(`      ${N(n.detail)}`),n.path)t.push(`      Path: ${N(n.path)}`);if(n.fixHint)t.push(`      Fix: ${N(n.fixHint)}`)}return t.join(`
`)}function q2(e){let t=["Variable","Status","Legacy"],n=e.map((r)=>{let o=r.isSet?y.green("✓"):y.dim("✗"),i=r.legacyName&&r.legacyIsSet?`${r.legacyName} ${y.green("✓")}`:r.legacyName??"";return[r.name,o,i]});return Ue({headers:t,rows:n})}function ua(e){let t=[];if(e.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${e.totalBlocked} blocked / ${e.sessionCount} sessions)`),t.push(V2(e.recentEntries));if(e.unreadable>0)t.push(`   Warning: ${e.unreadable} audit log ${e.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function V2(e){let t=["Time","Command"],n=e.map((r)=>{let o=N(r.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),i=o.length>40?`${o.slice(0,37)}...`:o;return[r.relativeTime,i]});return Ue({headers:t,rows:n})}function pa(e){let t=[];if(t.push("Update Check"),e.latestVersion===null&&!e.error)return t.push(wn([["Status",y.dim("Skipped")],["Installed",e.currentVersion]])),t.join(`
`);if(e.error)return t.push(wn([["Status",`${y.yellow("⚠")} Error`],["Installed",e.currentVersion],["Error",y.dim(e.error)]])),t.join(`
`);if(e.updateAvailable)return t.push(wn([["Status",`${y.yellow("⚠")} Update Available`],["Current",e.currentVersion],["Latest",y.green(e.latestVersion??"")]])),t.push(""),t.push("   Run: bunx cc-safety-net@latest doctor"),t.push("   Or:  npx cc-safety-net@latest doctor"),t.join(`
`);return t.push(wn([["Status",`${y.green("✓")} Up to date`],["Version",e.currentVersion]])),t.join(`
`)}function wn(e){return Ue({rows:e})}function fa(e){let t=[];return t.push("System Info"),t.push(z2(e)),t.join(`
`)}function z2(e){let t=["Component","Version"],n=(i)=>{if(i===null)return y.dim("not found");return i},o=[{label:"cc-safety-net",value:e.version},...gn.map((i)=>({label:P(i),value:e.versions[i]??null})),{label:"Node.js",value:e.nodeVersion},{label:"npm",value:e.npmVersion},{label:"Bun",value:e.bunVersion},{label:"Platform",value:e.platform}].map((i)=>[i.label,n(i.value)]);return Ue({headers:t,rows:o})}function ma(e){if(e.findings.length===0)return y.green(`
...
${e.findings.length} ${r}: ${n.join(", ")}.`;if(t.error>0)return y.red(o);if(t.warning>0)return y.yellow(o);return y.blue(o)}import{lstatSync as K2}from"node:fs";import{dirname as Zr}from"node:path";function Xr(e,t){try{let n=K2(t);if(n.isSymbolicLink())return{kind:e,path:t,status:"unsafe",issues:["symlink"]};if(!n.isDirectory())return{kind:e,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:e,path:t,status:"unknown",issues:[]};let r=[...n.uid!==process.getuid()?["ownership"]:[],...(n.mode&18)!==0?["permissions"]:[]];return{kind:e,path:t,status:r.length>0?"unsafe":"safe",issues:r}}catch(n){if(typeof n==="object"&&n!==null&&"code"in n&&n.code==="ENOENT")return{kind:e,path:t,status:"not-applicable",issues:[]};return{kind:e,path:t,status:"unknown",issues:[]}}}function ga(e){let t=he();return{directories:[Xr("policy",Zr(Zr(e))),Xr("config",Zr(e)),...t?[Xr("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as J2}from"node:child_process";import{existsSync as ha}from"node:fs";import{delimiter as W2,extname as Y2,join as Z2}from"node:path";import{stripVTControlCharacters as ya}from"node:util";var ba="2.2.2",X2=5000,Q2="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function _(){return ba}function Qr(e,t){let n=e[t];if(n)return n;let r=Object.keys(e).find((o)=>o.toLowerCase()===t.toLowerCase()&&!!e[o]);return r?e[r]:n}function ef(e){return(Qr(e,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function tf(e,t){let n=Y2(e)?[e]:[...ef(t).map((r)=>`${e}${r}`),e];if(e.includes("/")||e.includes("\\"))return n.find((r)=>ha(r))??e;return(Qr(t,"PATH")??"").split(W2).flatMap((r)=>n.map((o)=>Z2(r,o))).find((r)=>ha(r))??e}function va(e){if(!/[\s"&|<>^]/.test(e))return e;return`"${e.replace(/"/g,'""')}"`}function Ge(e,t){let[n,...r]=e,o=t[Q2]==="win32"?"win32":process.platform;if(!n||o!=="win32")return{cmd:n??"",args:r};let i=tf(n,t);if(!/\.(?:bat|cmd)$/i.test(i))return{cmd:i,args:r};return{cmd:Qr(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",va(i),...r.map(va)].join(" ")]}}var at=async(e,t=X2)=>{let n=await nf(e,{timeoutMs:t});if(n.code!==0)return null;return ya(n.stdout).trim()||ya(n.stderr).trim()||null};function nf(e,t){let[n,...r]=e;if(!n)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((o)=>{try{let i=Ge([n,...r],process.env),s=J2(i.cmd,i.args,{stdio:["ignore","pipe","pipe"]}),a=!1,l="",c="";s.stdout.on("data",(g)=>{l+=g.toString()}),s.stderr.on("data",(g)=>{c+=g.toString()});let d=(g)=>{if(a)return;a=!0,clearTimeout(m),o(g)},m=setTimeout(()=>{s.kill(),d({code:null,stdout:l,stderr:c})},t.timeoutMs);s.on("close",(g)=>{d({code:g,stdout:l,stderr:c})}),s.on("error",()=>{d({code:null,stdout:l,stderr:c})})}catch{o({code:null,stdout:"",stderr:""})}})}function kn(e){if(!e)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(e);if(t)return t[1]??null;let n=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(e);if(n)return n[1]??null;return e.split(`
`)[0]?.trim()||null}async function Ft(e=at){let[t,n,r,o,i,s]=await Promise.all([Promise.all(Y.map(async(a)=>[a.id,kn(await e([...a.probeCommand]))])),e(["codex","plugin","list"],30000),e(["amp","plugins","list"],30000),e(["node","--version"]),e(["npm","--version"]),e(["bun","--version"])]);return{version:ba,versions:Object.fromEntries(t),codexPluginListOutput:n,ampPluginListOutput:r,nodeVersion:kn(o),npmVersion:kn(i),bunVersion:kn(s),platform:`${process.platform} ${process.arch}`}}function eo(e,t){if(t==="dev")return!1;let n=e.split(".").map(Number),r=t.split(".").map(Number),[o=0,i=0,s=0]=n,[a=0,l=0,c=0]=r;if(o!==a)return o>a;if(i!==l)return i>l;return s>c}async function Ae(){let e=_(),t=new AbortController,n=setTimeout(()=>t.abort(),3000);try{let r=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!r.ok)return{currentVersion:e,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${r.status}`};let o=await r.json(),i=eo(o.version,e);return{currentVersion:e,latestVersion:o.version,updateAvailable:i}}catch(r){return{currentVersion:e,latestVersion:null,updateAvailable:!1,error:r instanceof Error?r.message:"Network error"}}finally{clearTimeout(n)}}import*as Da from"node:readline";var xa=(e)=>`\x1B[${e}B`,rf=(e)=>`\x1B[${e}A`;var La=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function of(e){return new Promise((t)=>setTimeout(t,e))}function sf(e,t,n){if(!n)return t(e);if(n.aborted)return Promise.resolve();return new Promise((r,o)=>{let i=()=>n.removeEventListener("abort",s),s=()=>{i(),r()};n.addEventListener("abort",s,{once:!0}),t(e).then(()=>{i(),r()},(a)=>{i(),o(a)})})}function Ht(e,t){return e&&e>0?e:t}function xn(e){return Math.max(0,Math.min(1,e))}function lt(e){return Math.max(0,Math.min(255,Math.round(e)))}function to(e){return e<=0.0031308?12.92*e:1.055*e**0.4166666666666667-0.055}function af(e,t,n){let r=n*Math.PI/180,o=t*Math.cos(r),i=t*Math.sin(r),s=(e+0.3963377774*o+0.2158037573*i)**3,a=(e-0.1055613458*o-0.0638541728*i)**3,l=(e-0.0894841775*o-1.291485548*i)**3;return{blue:lt(to(xn(-0.0041960863*s-0.7034186147*a+1.707614701*l))*255),green:lt(to(xn(-1.2684380046*s+2.6097574011*a-0.3413193965*l))*255),red:lt(to(xn(4.0767416621*s-3.3077115913*a+0.2309699292*l))*255)}}function no(e,t){let n=(t*e*180/Math.PI%360+360)%360;return af(0.72,0.15,n)}function Ca(e,t=0.1){let n=no(t,e);return`\x1B[38;2;${n.red};${n.green};${n.blue}m`}function lf(e,t){return{blue:lt(e.blue+(255-e.blue)*t),green:lt(e.green+(255-e.green)*t),red:lt(e.red+(255-e.red)*t)}}function Sa(e,t,n){let r=Math.imul(e+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(n+374761393,2654435761),o=r^r>>>15,i=Math.imul(o,739982445),s=i^i>>>12,a=Math.imul(s,695872825);return((a^a>>>15)>>>0)/4294967296}function cf(e,t,n){let r=Math.floor(Sa(e,t,n)*La.length);return La[r]??"░"}function wa(e){let t=xn(e);return t*t*t*(t*(t*6-15)+10)}function df(e){if(e.length===0)return"";let t=[],n=!1,r="";for(let o of e){let i=`${o.red};${o.green};${o.blue}`;if(o.bold!==n)t.push(o.bold?"\x1B[1m":"\x1B[22m"),n=o.bold;if(i!==r)t.push(`\x1B[38;2;${i}m`),r=i;t.push(o.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function uf(e,t,n,r,o){return e.map((i,s)=>({...no(n,r+t+s/o),bold:!1,character:i}))}function pf(e,t,n,r,o,i,s,a){let l=Math.max(1,r*0.75),c=Math.min(1,n/l),d=o*wa(c),m=Math.max(0,(n-l)/Math.max(1,r-l)),g=(1-wa(n/r))*a*2,u=0.35*Math.max(0,1-m*2),p=c>=1,f=Math.min(e.length,Math.ceil(d+2+1));return e.slice(0,f).map((b,L)=>{let h=no(i,s+t+L/a+g),S=L+Sa(t,L,7919)*2-1;if(S>d+2)return{...h,bold:!1,character:" "};let v=d-S,R=0.8*Math.exp(-(v*v)/12.5),ee=Math.min(0.9,R+u),nn=!p&&S>d-4;return{...lf(h,ee),bold:ee>0.3,character:nn?cf(t,L,n):b}})}function ka(e){return`\x1B[?2026h${e.map((t,n)=>`\x1B8${n>0?xa(n):""}${df(t)}`).join("")}\x1B[?2026l`}async function ro(e,t={}){if(!e)return;let n=t.output??process.stdout,r=t.sleep??of,o=Ht(t.frequency,0.1),i=t.seed??0,s=Ht(t.speed,40),a=Ht(t.spread,3),l=Ht(t.frameRate,60),c=Math.max(1,Math.floor(Ht(t.duration,12))),d=e.split(`
...
`.repeat(d.length-1)}${rf(d.length-1)}`:""}\x1B7`);try{for(let f=1;f<=u;f+=1){if(t.signal?.aborted)break;n.write(ka(d.map((b,L)=>pf(b,L,f,u,m,o,i,a)))),await sf(p,r,t.signal)}}finally{if(n.write(ka(d.map((f,b)=>uf(f,b,o,i,a)))),n.write("\x1B8"),d.length>1)n.write(xa(d.length-1));n.write(`
\x1B[0m\x1B[?25h`)}}var Ra=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function ff(e){return Boolean(e.isTTY)}async function Mt(e={}){let t=e.output??process.stdout;if(!ff(t))return;let n=e.input??process.stdin,r={duration:e.duration,frequency:e.frequency,output:t,seed:e.seed??Math.random()*8192,sleep:e.sleep,speed:e.speed,spread:e.spread};if(!n.isTTY||typeof n.setRawMode!=="function"){await ro(Ra,r);return}let o=new AbortController,i=n.readableFlowing===!0,s=n.isRaw===!0,a=!1,l=(c,d)=>{if(d.ctrl&&d.name==="c")a=!0;if(a||d.name==="return"||d.name==="enter")o.abort()};Da.emitKeypressEvents(n),n.on("keypress",l),n.setRawMode(!0),n.resume();try{await ro(Ra,{...r,signal:o.signal})}finally{if(n.off("keypress",l),n.setRawMode(s),!i)n.pause()}if(!a)return;if(e.onInterrupt){e.onInterrupt();return}process.kill(process.pid,"SIGINT")}import{createHash as mf}from"node:crypto";import{existsSync as Aa}from"node:fs";import{dirname as Cn,join as Ea}from"node:path";var gf="`cc-safety-net rule sync` is deprecated: rulebooks are live files that need no synchronization. This run only migrates the lock and cache an earlier version left behind.",hf="cache",yf="rulebooks";function Ta(e={}){let t=U(e),n=x(t.filesystemScope,_a(t.configDir)),r=w(t.lockTarget);if(console.log(gf),r===null&&!Aa(n.path))return console.log(`No v2 lock or cache leftovers found in ${Cn(t.configDir)}; nothing to migrate.`),0;let o=kf(r),i=B(t.configTarget);if(!i.config&&(w(t.configTarget)!==null||o.size>0))return console.error(`Cannot migrate: the rules config in ${Cn(t.configDir)} is missing or unreadable while v2 leftovers remain. Restore rule.json, then re-run rule sync.`),1;let s=i.config?.rules??[];for(let a of s.flatMap((l)=>vf(l,o,t,n,e.global===!0)))console.log(a);return me(t.lockTarget),Pa(n),console.log(`Removed the v2 lock and cache under ${Cn(t.configDir)}.`),0}function Ia(e){return[...new Set([{cwd:e},{cwd:e,global:!0}].flatMap((t)=>{let n=U(t);return[n.lockPath,_a(n.configDir)]}))].filter((t)=>Aa(t))}function vf(e,t,n,r,o){if(!te(e))return[];let i=$e(e).name,s=x(n.filesystemScope,Ce(n.configDir,i)),a=w(s);if(a!==null&&bf(a,i))return[];let l=t.get(e),c=l?Lf(l,i,r.path,n.filesystemScope):null;if(c===null)return[`Could not migrate ${e} from the v2 cache. Run \`cc-safety-net rule update ${e}${o?" --global":""}\` to vendor it.`];if(ne(s,c),a!==null)return[`Restored ${e} from the v2 cache over an invalid file.`];return[`Vendored ${e} from the v2 cache.`]}function bf(e,t){let n=St(e);return!("problem"in n)&&n.rulebook.name===t}function Lf(e,t,n,r){let o=Ea(n,yf,`${wf(e)}--${e.digest.replace("sha256:","").slice(0,12)}`,cn),i=w(x(r,o));if(i===null||Sf(i)!==e.digest)return null;let s=St(i);if("problem"in s||s.rulebook.name!==t)return null;return i}function _a(e){return Ea(Cn(e),hf)}function wf(e){return([e.owner,e.repo,e.display_ref,e.name].every((r)=>typeof r==="string"&&r!=="")?`${e.owner}/${e.repo}#${e.display_ref}/${e.name}`:e.spec).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"rulebook"}function kf(e){let t=e===null?null:Cf(e),n=$a(t)&&Array.isArray(t.rulebooks)?t.rulebooks:[];return new Map(n.filter(xf).map((r)=>[r.spec,r]))}function xf(e){return $a(e)&&typeof e.spec==="string"&&typeof e.digest==="string"}function $a(e){return!!e&&typeof e==="object"}function Cf(e){try{return JSON.parse(e)}catch{return null}}function Sf(e){return`sha256:${mf("sha256").update(e).digest("hex")}`}var Oa="\r\x1B[2K",Rf="\x1B[?25l",Df="\x1B[39m",Pf="\x1B[?25h",Af=100,Ef=0.55,Tf=80,Na=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function If(e){return new Promise((t)=>setTimeout(t,e))}async function Sn(e,t={}){let n=t.output??process.stdout;if(!n.isTTY)return e;let r=t.sleep??If,o=!1,i=e.then((a)=>(o=!0,a),(a)=>{throw o=!0,a});if(await Promise.race([i.then(()=>!0),r(Af).then(()=>!1)]))return i;n.write(Rf);try{for(let a=0;!o;a+=1)n.write(`${Oa}${Ca(a*Ef)}${Na[a%Na.length]}${Df} ${t.loadingMessage??"Loading…"}`),await Promise.race([i,r(Tf)]);return await i}finally{n.write(`${Oa}${Pf}`)}}async function jt(e,t,n,r={}){let o=t();if(e)await n();if(e&&o.ready)await Sn(o.ready,r);return o.finish()}import{homedir as ag}from"node:os";import{stripVTControlCharacters as _f}from"node:util";var Rn="amp plugins list",$f=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function Fa(e){if(!e.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=_f(e.ampPluginListOutput).split(`
`).map((n)=>$f.exec(n)?.[1]).find((n)=>n!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:Rn,configPath:Rn,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:Rn,configPath:Rn}}import{existsSync as Of,readFileSync as Nf}from"node:fs";var Ff=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function Hf(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];return Object.values(e).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t,r=n.PreToolUse;if(!Array.isArray(r))return[];return r.flatMap((o)=>{if(!o||typeof o!=="object"||Array.isArray(o))return[];let i=o.hooks;if(!Array.isArray(i))return[];return i.flatMap((s)=>{if(!s||typeof s!=="object"||Array.isArray(s))return[];let a=s.command;if(typeof a!=="string"||!Ff.test(a))return[];return[{command:a,enabled:n.enabled!==!1}]})})})}function Ha(e){let t=Ot(e.homeDir);if(!Of(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let n;try{n=Hf(JSON.parse(Nf(t,"utf-8")))}catch(r){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${r instanceof Error?r.message:String(r)}`]}}if(n.some((r)=>r.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(n.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as Ma}from"node:path";import{existsSync as Mf,lstatSync as jf,readFileSync as Uf}from"node:fs";function ae(e,t=(n)=>n){if(!Mf(e))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(Uf(e,"utf-8")))}}catch{return{kind:"unreadable"}}}function T(e){try{return jf(e)}catch{return}}function Dn(e,t){let n=T(t);if(!n)return{platform:e,status:"n/a",configPath:t};if(!n.isSymbolicLink()&&n.isDirectory())return;return{platform:e,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function k(e,t){return typeof e==="object"&&e!==null?e[t]:void 0}var oo="cc-safety-net@cc-marketplace";function ja(e){return Ma(e,".claude","plugins","installed_plugins.json")}function Ua(e,t){let n=k(k(e,"plugins"),t);return Array.isArray(n)&&n.length>0}function Pn(e,t){let n=ae(ja(e));return n.kind==="ok"&&Ua(n.value,t)}function io(e){let t=ja(e),n=ae(t);if(n.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(n.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!Ua(n.value,oo))return{platform:"claude-code",status:"n/a"};let r=Ma(e,".claude","settings.json"),o=ae(r);if(o.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(o.kind==="ok"&&k(k(o.value,"enabledPlugins"),oo)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:r,errors:[`${oo} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function Ga(e){return io(e.homeDir)}function Ba(e){if(!e.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=e.codexPluginListOutput.split(`
`).find((n)=>n.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed,"))return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as In,readdirSync as Gf,readFileSync as Bf}from"node:fs";import{join as j}from"node:path";var le="cc-safety-net@cc-marketplace",An=["cc-marketplace","cc-safety-net"],qa=["_direct","copilot-safety-net"],Va=["cc-marketplace","safety-net"],za="safety-net@cc-marketplace";function En(e,t){let n=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${n}([^a-z0-9-]|$)`,"m").test(e??"")}function Ka(e){return En(e,"cc-safety-net@cc-marketplace")}function Ja(e){return En(e,"cc-marketplace")}function Wa(e){return En(e,"copilot-safety-net")}function Ya(e){return En(e,"safety-net@cc-marketplace")}function z(e){let t="",n=0,r=!1,o=!1,i=-1;while(n<e.length){let s=e[n],a=e[n+1];if(o){t+=s,o=!1,n++;continue}if(s==='"'&&!r){r=!0,i=-1,t+=s,n++;continue}if(s==='"'&&r){r=!1,t+=s,n++;continue}if(s==="\\"&&r){o=!0,t+=s,n++;continue}if(r){t+=s,n++;continue}if(s==="/"&&a==="/"){while(n<e.length&&e[n]!==`
`)n++;continue}if(s==="/"&&a==="*"){n+=2;while(n<e.length-1){if(e[n]==="*"&&e[n+1]==="/"){n+=2;break}n++}continue}if(s===","){i=t.length,t+=s,n++;continue}if(s==="}"||s==="]"){if(i!==-1){let l=t.slice(i+1);if(/^\s*$/.test(l))t=t.slice(0,i)+l}i=-1,t+=s,n++;continue}if(!/\s/.test(s))i=-1;t+=s,n++}return t}function so(e){if(!e?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(e)}function Xa(e,t){if(!e)return null;let n=e.match(/(\d+)\.(\d+)\.(\d+)/);if(!n)return null;let r=[Number(n[1]),Number(n[2]),Number(n[3])];for(let o=0;o<t.length;o++){let i=r[o]??0,s=t[o]??0;if(i!==s)return i>s}return!0}function qf(e){return Xa(e,[0,0,422])}function Vf(e){return Xa(e,[1,0,8])}function Ut(e){return process.env.COPILOT_HOME||j(e,".copilot")}function ao(e){return(e.hooks?.preToolUse??[]).some((n)=>{if(n.type!=="command")return!1;return so(n.command)||so(n.bash)||so(n.powershell)})}function Tn(e){return e===void 0||typeof e==="string"}function zf(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e;if(t.disableAllHooks!==void 0&&typeof t.disableAllHooks!=="boolean")return!1;if(t.hooks===void 0)return!0;if(!t.hooks||typeof t.hooks!=="object"||Array.isArray(t.hooks))return!1;let n=t.hooks.preToolUse;if(n===void 0)return!0;return Array.isArray(n)&&n.every((r)=>r!==null&&typeof r==="object"&&!Array.isArray(r)&&Tn(r.type)&&Tn(r.command)&&Tn(r.bash)&&Tn(r.powershell))}function lo(e,t){try{let n=JSON.parse(z(Bf(e,"utf-8")));if(!zf(n)){t?.push(`Invalid hook config ${e}: hooks.preToolUse must be an array of hook objects`);return}return n}catch(n){t?.push(`Failed to parse ${e}: ${n instanceof Error?n.message:String(n)}`);return}}function Qa(e,t){try{return Gf(e).filter((n)=>n.endsWith(".json")).sort((n,r)=>n.localeCompare(r))}catch(n){return t?.push(`Failed to read ${e}: ${n instanceof Error?n.message:String(n)}`),[]}}function Kf(e,t){if(!In(e))return[];let n=[];for(let r of Qa(e,t)){let o=j(e,r),i=lo(o,t);if(i&&ao(i))n.push(o)}return n}function ct(e,t){if(!In(e))return;let n=lo(e,t);if(!n)return;return{path:e,config:n}}function Za(e,t,n,r){if(t){e.push(`GitHub Copilot CLI ${t} does not support ${n}; requires ${r}+`);return}e.push(`GitHub Copilot CLI version unavailable; skipping ${n} because it requires ${r}+`)}function Jf(e){for(let t of e){if(t?.config.disableAllHooks===!0)return t.path;if(t?.config.disableAllHooks===!1)return}return}function Wf(e,t,n,r){let o=Ut(e),i=j(t,".github","hooks"),s=j(o,"hooks"),a=j(t,".github","copilot"),l=j(t,".claude"),c=Vf(n),d=c===!0?r:void 0,m=[ct(j(a,"settings.local.json"),d),ct(j(a,"settings.json"),d),ct(j(l,"settings.local.json"),d),ct(j(l,"settings.json"),d)],g=[ct(j(o,"settings.json"),d),ct(j(o,"config.json"),d)];if(c!==!1){let v=Jf([...m,...g]);if(v){if(c===null)r.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${v} as active`);return{activeConfigPaths:[],disabledBy:v}}}let u=Kf(i,r),p=qf(n),f=p===!0?r:void 0,b=In(s)?Qa(s,f):[],L=[];for(let v of b){let R=j(s,v),ee=lo(R,f);if(ee&&ao(ee))L.push(R)}if(p!==!0&&L.length>0)Za(r,n,`user hook files in ${s}`,"0.0.422"),L.length=0;let h=[];for(let v of[...m,...g]){if(!v)continue;if(!ao(v.config))continue;if(c===!0){h.push(v);continue}Za(r,n,"inline hook definitions in Copilot config files","1.0.8");break}let S=(v)=>v.filter((R)=>!!R&&h.includes(R)).map((R)=>R.path);return{activeConfigPaths:[...S(m),...u,...S(g),...L]}}function el(e){let t=[],n=Wf(e.homeDir,e.cwd,e.copilotCliVersion,t);if(n.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:n.disabledBy,configPaths:[n.disabledBy],errors:t.length>0?t:void 0};let r=Ut(e.homeDir),o=j(r,"installed-plugins",...An),i=In(o),s=j(r,"settings.json"),a=ae(s,z);if(i&&a.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(i&&a.kind==="ok"&&k(k(a.value,"enabledPlugins"),le)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:s,errors:[`${le} is installed but not enabled in Copilot CLI`]};if(i||n.activeConfigPaths.length>0){let l=i,c=n.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:l?"plugin config":"hook config",configPath:c??(l?o:void 0),configPaths:n.activeConfigPaths.length>0?n.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as im,readFileSync as sm}from"node:fs";import{existsSync as tl,mkdirSync as Xf,readFileSync as Qf}from"node:fs";import{dirname as em,join as tm}from"node:path";import{renameSync as Yf,writeFileSync as Zf}from"node:fs";function O(e,t){let n=`${e}.${process.pid}.tmp`;Zf(n,t),Yf(n,e)}var Gt="npx -y cc-safety-net hook --cursor",nl=30;function $n(e){return tm(e,".cursor","hooks.json")}function Be(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function co(){return{command:Gt,timeout:nl,failClosed:!0}}function _n(e){return Be(e)&&e.command===Gt}function nm(e){return Object.keys(e).length===3&&e.command===Gt&&e.timeout===nl&&e.failClosed===!0}function rm(e){try{return JSON.parse(Qf(e,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${e}: ${t.message}`);throw t}}function rl(e){let t=rm(e);if(!Be(t))throw Error(`Cursor hooks config ${e} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${e} must set "version": 1`);if(t.hooks!==void 0&&!Be(t.hooks))throw Error(`Cursor hooks config ${e} "hooks" must be an object`);let n=Be(t.hooks)?t.hooks.preToolUse:void 0;if(n!==void 0&&!Array.isArray(n))throw Error(`Cursor hooks config ${e} "hooks.preToolUse" must be an array`);return t}function ol(e){let t=Be(e.hooks)?e.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function om(e){if(!e.some(_n))return[...e,co()];return e.reduce((t,n)=>{if(!_n(n))return t.result.push(n),t;if(!t.inserted)t.result.push(co()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function il(e,t,n){let r=Be(t.hooks)?t.hooks:{},o={...t,hooks:{...r,preToolUse:n}};O(e,`${JSON.stringify(o,null,2)}
`)}function sl(e){let t=$n(e);if(!tl(t))return Xf(em(t),{recursive:!0}),O(t,`${JSON.stringify({version:1,hooks:{preToolUse:[co()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let n=rl(t),r=ol(n),o=r.filter(_n);if(Be(n.hooks)&&Array.isArray(n.hooks.preToolUse)&&o.length===1&&o[0]!==void 0&&nm(o[0]))return{path:t,alreadyInstalled:!0};return il(t,n,om(r)),{path:t,alreadyInstalled:!1}}function al(e){let t=$n(e);if(!tl(t))return{path:t,alreadyInstalled:!1};let n=rl(t),r=ol(n),o=r.filter((i)=>!_n(i));if(o.length===r.length)return{path:t,alreadyInstalled:!1};return il(t,n,o),{path:t,alreadyInstalled:!0}}function am(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];let t=e.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t.preToolUse;if(!Array.isArray(n))return[];return n.filter((r)=>!!r&&typeof r==="object"&&!Array.isArray(r)&&r.command===Gt)}function lm(e){let t=[];if(e.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let n=e[0];if(n&&n.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(n&&n.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function ll(e){let t=$n(e.homeDir);if(!im(t))return{platform:"cursor",status:"n/a",configPath:t};let n;try{n=JSON.parse(sm(t,"utf-8"))}catch(i){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=am(n);if(r.length===0)return{platform:"cursor",status:"n/a",configPath:t};let o=lm(r);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{existsSync as cm}from"node:fs";import{join as uo}from"node:path";var po="gemini-safety-net";function fo(e){let t=uo(e,".gemini","extensions"),n=uo(t,po);if(!cm(n))return{platform:"gemini-cli",status:"n/a"};let r=uo(t,"extension-enablement.json"),o=ae(r);if(o.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let i=o.kind==="ok"?k(k(o.value,po),"overrides"):void 0;if(Array.isArray(i)&&i.some((a)=>typeof a==="string"&&a.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:r,errors:[`${po} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:n}}function cl(e){return fo(e.homeDir)}import{existsSync as fm,readFileSync as mm}from"node:fs";import{existsSync as ul,mkdirSync as dm,readFileSync as pl,rmSync as um}from"node:fs";import{dirname as pm,join as dl}from"node:path";var Bt="npx -y cc-safety-net hook --grok-build",Fn=30;function Hn(e){return dl(process.env.GROK_HOME??dl(e,".grok"),"hooks","cc-safety-net.json")}function qe(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function On(){return{hooks:[{type:"command",command:Bt,timeout:Fn}]}}function fl(e){return qe(e)&&e.command===Bt}function ml(e){return e.flatMap((t)=>{if(!qe(t)||!Array.isArray(t.hooks))return[t];let n=t.hooks.filter((r)=>!fl(r));if(n.length===t.hooks.length)return[t];return n.length===0?[]:[{...t,hooks:n}]})}function gl(e){try{let t=JSON.parse(e);return qe(t)?t:null}catch{return null}}function hl(e){let t=qe(e.hooks)?e.hooks.PreToolUse:void 0;return Array.isArray(t)?t:[]}function Nn(e,t,n){let r=qe(t.hooks)?t.hooks:{};O(e,`${JSON.stringify({...t,hooks:{...r,PreToolUse:n}},null,2)}
`)}function yl(e){let t=Hn(e);if(!ul(t))return dm(pm(t),{recursive:!0}),Nn(t,{},[On()]),{path:t,alreadyInstalled:!1};let n=gl(pl(t,"utf-8"));if(!n)return Nn(t,{},[On()]),{path:t,alreadyInstalled:!1};let r=hl(n),o=r.filter((i)=>qe(i)&&Array.isArray(i.hooks)&&i.hooks.some(fl));if(o.length===1&&JSON.stringify(o[0])===JSON.stringify(On()))return{path:t,alreadyInstalled:!0};return Nn(t,n,[...ml(r),On()]),{path:t,alreadyInstalled:!1}}function vl(e){let t=Hn(e);if(!ul(t))return{path:t,alreadyInstalled:!1};let n=gl(pl(t,"utf-8"));if(!n)return{path:t,alreadyInstalled:!1};let r=hl(n),o=ml(r);if(JSON.stringify(o)===JSON.stringify(r))return{path:t,alreadyInstalled:!1};let i=qe(n.hooks)?n.hooks:{};if(o.length===0&&Object.keys(n).length===1&&Object.keys(i).length===1)return um(t),{path:t,alreadyInstalled:!0};return Nn(t,n,o),{path:t,alreadyInstalled:!0}}function qt(e){return!!e&&typeof e==="object"&&!Array.isArray(e)}function gm(e){if(!qt(e)||!qt(e.hooks))return[];let t=e.hooks.PreToolUse;if(!Array.isArray(t))return[];return t.filter((n)=>qt(n)&&Array.isArray(n.hooks)&&n.hooks.some((r)=>qt(r)&&r.command===Bt))}function hm(e){let n=(Array.isArray(e.hooks)?e.hooks.filter(qt):[]).find((r)=>r.command===Bt);return[...e.matcher===void 0||e.matcher===""||e.matcher==="*"?[]:['Managed hook has a "matcher" that narrows coverage; reinstall to repair'],...n?.type==="command"?[]:['Managed hook "type" is not "command"; reinstall to repair'],...n?.timeout===Fn?[]:[`Managed hook "timeout" is not ${Fn}; reinstall to repair`]]}function bl(e){let t=Hn(e.homeDir);if(!fm(t))return{platform:"grok-build",status:"n/a",configPath:t};let n;try{n=JSON.parse(mm(t,"utf-8"))}catch(i){return{platform:"grok-build",status:"n/a",configPath:t,errors:[`Failed to parse Grok Build hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=gm(n)[0];if(!r)return{platform:"grok-build",status:"n/a",configPath:t};let o=hm(r);return{platform:"grok-build",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{readFileSync as Pl}from"node:fs";import{join as Al}from"node:path";var Z="cc-safety-net",Ll="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function wl(e){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${e}
`}function ym(e){return`${wl(e)}name: cc-safety-net
version: "${e}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function vm(e){return`${wl(e)}"""CC Safety Net guard for Hermes Agent.
...
`}function Vt(e){return[{name:"__init__.py",content:vm(e)},{name:"plugin.yaml",content:ym(e)}]}import{mkdirSync as bm,readdirSync as Lm,readFileSync as wm,rmSync as mo}from"node:fs";import{join as Ve}from"node:path";var km="__pycache__";function go(e){let t=process.env.HERMES_HOME?.trim();return t?t:Ve(e,".hermes")}function ho(e){return Ve(go(e),"plugins",Z)}function yo(e){return e.startsWith(Ll)}function vo(e,t){let n=ho(e),r=T(n);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${n}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return n}function kl(e,t){let n=T(e);if(!n)return;if(n.isSymbolicLink()||!n.isFile())throw Error(`Refusing to ${t} ${e}: not a regular file. Move or remove it.`);let r=wm(e,"utf-8");if(!yo(r))throw Error(`Refusing to ${t} unmanaged file at ${e}. Move or remove it.`);return r}function xl(e){let t=vo(e,"install"),n=Vt(_());if(n.map((o)=>kl(Ve(t,o.name),"overwrite")).every((o,i)=>o===n[i]?.content))return{path:t,alreadyInstalled:!0};return bm(t,{recursive:!0}),n.forEach((o)=>{O(Ve(t,o.name),o.content)}),{path:t,alreadyInstalled:!1}}function bo(e){let t=vo(e,"remove");if(!T(t))return[];return Vt(_()).filter((n)=>kl(Ve(t,n.name),"remove")!==void 0)}function Cl(e){let t=vo(e,"remove");if(!T(t))return{path:t,alreadyInstalled:!1};let n=bo(e);if(n.forEach((r)=>{mo(Ve(t,r.name))}),mo(Ve(t,km),{recursive:!0,force:!0}),Lm(t).length===0)mo(t,{recursive:!0});return{path:t,alreadyInstalled:n.length>0}}var Mn="hermes-agent",Sl=/^([^\s#][^:]*):/,xm=/^\s+([A-Za-z_][\w-]*):/,Rl=/^\s+-\s*(.*)$/;function Cm(e){return e.trim().replace(/^(["'])(.*)\1$/,"$2")}function Sm(e){let t=e.split(/\r?\n/),n=t.findIndex((i)=>Sl.exec(i)?.[1]?.trim()==="plugins");if(n===-1)return[];let r=t.slice(n+1),o=r.findIndex((i)=>Sl.test(i));return o===-1?r:r.slice(0,o)}function Dl(e,t){let n=Sm(e),r=n.findIndex((s)=>xm.exec(s)?.[1]===t);if(r===-1)return[];let o=n.slice(r+1),i=o.findIndex((s)=>!Rl.test(s));return(i===-1?o:o.slice(0,i)).map((s)=>Cm(Rl.exec(s)?.[1]??""))}function Rm(e){try{return Pl(Al(go(e),"config.yaml"),"utf-8")}catch{return}}function Lo(e){let t=Rm(e)??"";return Dl(t,"enabled").includes(Z)&&!Dl(t,"disabled").includes(Z)}function El(e){return/^# version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function Dm(e,t){let n=T(e);if(!n)return{error:`${t.name} is missing from ${e}; run install --hermes-agent`};if(n.isSymbolicLink()||!n.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{let r=Pl(e,"utf-8");if(!yo(r))return{error:`Unmanaged ${t.name} occupies ${e}; move or remove it`};if(El(r)===_()&&r!==t.content)return{error:`Modified ${t.name} occupies ${e}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${e}: ${r instanceof Error?r.message:String(r)}`}}}function Tl(e){let t=ho(e.homeDir),n=Dn(Mn,t);if(n)return n;let r=Vt(_()).map((a)=>Dm(Al(t,a.name),a)),o=r.flatMap((a)=>("error"in a)?[a.error]:[]);if(o.length>0)return{platform:Mn,status:"n/a",configPath:t,errors:o};let i=r.some((a)=>("content"in a)&&El(a.content)!==_()),s=i?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!Lo(e.homeDir))return{platform:Mn,status:"disabled",method:"plugin directory",configPath:t,errors:[`${Z} is not enabled in Hermes; run \`hermes plugins enable ${Z}\``,...s]};return{platform:Mn,status:"configured",method:"plugin directory",configPath:t,errors:i?s:void 0}}import{existsSync as Pm,readFileSync as Am}from"node:fs";import{join as Il}from"node:path";var Em=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function Tm(e){return Il(process.env.KIMI_CODE_HOME||Il(e,".kimi-code"),"config.toml")}function zt(e){let t=Tm(e.homeDir);if(!Pm(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!Em.test(Am(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(n){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${n instanceof Error?n.message:String(n)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as Gl}from"node:fs";import{join as Jt}from"node:path";var A="cc-safety-net",X="index.js",dt="openclaw.plugin.json",ut="package.json";var jn="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as $m,lstatSync as Om,readdirSync as Nm,readFileSync as Fm}from"node:fs";import{dirname as Ol,join as Ee}from"node:path";import{fileURLToPath as Hm}from"node:url";import{spawn as Im}from"node:child_process";function _m(e){return e.join(" ")}function wo(e,t,n){return[`Failed to run ${_m(e)}${t===null?"":` (exit ${t})`}.`,n.trim()].filter(Boolean).join(`
`)}function ko(e){let t={stdout:"",stderr:""};return e.stdout.setEncoding("utf-8"),e.stderr.setEncoding("utf-8"),e.stdout.on("data",(n)=>{t.stdout+=n}),e.stderr.on("data",(n)=>{t.stderr+=n}),t}function ce(e,t){return new Promise((n,r)=>{let o=Ge([...e],process.env),i=Im(o.cmd,o.args,{stdio:["ignore","pipe","pipe"]}),s=ko(i),a=()=>[s.stdout,s.stderr].filter(Boolean).join(`
`),l=t?.timeoutMs??120000,c=setTimeout(()=>{i.kill(),r(Error(wo(e,null,`Timed out after ${l}ms.
${a()}`.trim())))},l);i.on("error",(d)=>{clearTimeout(c),r(Error(wo(e,null,`${d.message}
${a()}`.trim())))}),i.on("close",(d)=>{if(clearTimeout(c),d!==0){r(Error(wo(e,d,a())));return}n(t?.stdoutOnly?s.stdout:a())})})}async function xo(e){for(let t of e)await ce(t)}async function _l(e){for(let t of e)try{await ce(t)}catch(n){console.warn(n instanceof Error?n.message:String(n))}}var $l=Ee("openclaw",A),Mm=[X,dt,ut];function Co(e,t){if(e==="~")return t;if(e.startsWith("~/")||e.startsWith("~\\"))return Ee(t,e.slice(2));return e}function Nl(e){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return Co(t,e);let n=process.env.OPENCLAW_CONFIG_PATH?.trim();return n?Ol(Co(n,e)):Ee(e,".openclaw")}function Fl(e){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?Co(t,e):Ee(Nl(e),"openclaw.json")}function So(e){return Ee(Nl(e),"extensions",A)}function jm(e){let t=Nm(e);if(t.length===0)return!0;if(t.some((o)=>!Mm.includes(o)))return!1;let n=Ee(e,X),r=T(n);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&Fm(n,"utf-8").startsWith(jn)}function Ro(e){let t=So(e),n=T(t);if(!n)return;if(!n.isSymbolicLink()&&n.isDirectory()&&jm(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function Hl(){let e=Ol(Hm(import.meta.url));return[Ee(e,"..",$l),Ee(e,"..","..","..","dist",$l)]}function Do(e=Hl()){return e.find((t)=>$m(t)&&Om(t).isDirectory())}function Um(e=Hl()){let t=Do(e);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function Ml(e=Um()){return[["openclaw","plugins","install",e,"--force"],["openclaw","plugins","enable",A]]}function Gm(e){let t=(()=>{try{return JSON.parse(e)}catch{return}})(),n=k(k(t,"plugin"),"status");return typeof n==="string"?n:void 0}async function jl(){let e=Gm(await ce(["openclaw","plugins","inspect",A,"--runtime","--json"],{stdoutOnly:!0}));if(e==="loaded")return;throw Error(`${e===void 0?`The ${A} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${A} plugin with status "${e}".`} Run \`openclaw plugins inspect ${A} --runtime\` for details.`)}var Un="openclaw",Kt=`run \`openclaw plugins enable ${A}\``;function pt(e,t){let n=Jt(e,t),r=T(n);if(!r)return{error:`${t} is missing from ${n}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{return{content:Gl(n,"utf-8")}}catch(o){return{error:`Failed to read ${n}: ${o instanceof Error?o.message:String(o)}`}}}function Bl(e){try{return JSON.parse(z(e))}catch{return}}function Bm(e){let t=pt(e,dt);if("error"in t)return t.error;if(k(Bl(t.content),"id")===A)return;return`${Jt(e,dt)} is not a valid ${A} manifest; run install --openclaw`}function qm(e){let t=pt(e,ut);if("error"in t)return t.error;let n=k(k(Bl(t.content),"openclaw"),"extensions");if(Array.isArray(n)&&n.includes(`./${X}`))return;return`${Jt(e,ut)} does not point OpenClaw at ${X}; run install --openclaw`}function Ul(e){return Array.isArray(e)?e.filter((t)=>typeof t==="string"):[]}function Vm(e){let t=Fl(e);if(!T(t))return`${A} is not enabled; ${Kt}`;let n=(()=>{try{return JSON.parse(z(Gl(t,"utf-8")))}catch{return}})();if(n===void 0)return`Failed to read ${t}; fix it, then ${Kt}`;let r=k(n,"plugins");if(k(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let o=k(k(k(r,"entries"),A),"enabled");if(Ul(k(r,"deny")).includes(A)||o===!1)return`${A} is disabled in ${t}; ${Kt}`;let i=Ul(k(r,"allow"));if(i.length>0&&!i.includes(A))return`plugins.allow in ${t} does not list ${A}; add it, then ${Kt}`;if(i.includes(A)||o===!0)return;return`${A} is not enabled; ${Kt}`}function ql(e){return/^\/\/ version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function zm(e,t,n){if(n===void 0)return[];let r=pt(n,X);if("error"in r||ql(r.content)!==t)return[];return[X,dt,ut].flatMap((o)=>{let i=pt(e,o),s=pt(n,o);if("error"in i||"error"in s||i.content===s.content)return[];return[`Modified ${o} occupies ${Jt(e,o)}; run install --openclaw to restore it`]})}function Vl(e){let t=So(e.homeDir),n=Dn(Un,t);if(n)return n;let r=pt(t,X),i=["error"in r?r.error:r.content.startsWith(jn)?void 0:`Unmanaged ${X} occupies ${Jt(t,X)}; move or remove it`,Bm(t),qm(t)].filter((d)=>d!==void 0),s="content"in r?ql(r.content):void 0,a=i.length>0?i:zm(t,s,Do());if(a.length>0)return{platform:Un,status:"n/a",configPath:t,errors:a};let l=s===_()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],c=Vm(e.homeDir);if(c)return{platform:Un,status:"disabled",method:"plugin directory",configPath:t,errors:[c,...l]};return{platform:Un,status:"configured",method:"plugin directory",configPath:t,errors:l.length>0?l:void 0}}import{existsSync as rg,readFileSync as og}from"node:fs";import{join as ig}from"node:path";import{existsSync as Po,readFileSync as Yl,rmSync as Jm}from"node:fs";import{join as be}from"node:path";import{pathToFileURL as Wm}from"node:url";function zl(e){return e!==void 0&&/\s/.test(e)}function Km(e,t,n){let r=t+1,o=!1;while(r<e.length){let i=e[r];if(o){o=!1,r++;continue}if(i==="\\"){o=!0,r++;continue}if(i==='"')return r+1;r++}throw Error(n)}function Gn(e,t,n){let r=e[t],o=r==="["?"]":"}",i=0,s=t;while(s<e.length){let a=n.skipComment?.(e,s)??s;if(a!==s){s=a;continue}if(e[s]==='"'){s=Km(e,s,n.stringError);continue}if(e[s]===r)i++;if(e[s]===o){if(i--,i===0)return s}s++}throw Error(n.bracketError)}function Kl(e,t){let n=e.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(e.slice(n))?.[0]??""}function Bn(e,t){let{start:n,end:r,end:o}=t;while(zl(e[o]))o++;if(e[o]===","){if(r=o+1,e[r]===`
`)r++;return`${e.slice(0,n)}${e.slice(r)}`}o=t.start-1;while(zl(e[o]))o--;if(e[o]===","){n=o;let i=e.lastIndexOf(`
`,n-1);if(i!==-1&&/^\s*$/.test(e.slice(i+1,n)))n=i}return`${e.slice(0,n)}${e.slice(r)}`}var qn="cc-safety-net",Zl=`${qn}@latest`,Xl=["opencode.json","opencode.jsonc"],Jl="CCSafetyNetPlugin";function Vn(e){return be(process.env.XDG_CONFIG_HOME||be(e,".config"),"opencode")}function Ym(e){return be(Vn(e),Xl[0])}function Zm(e){return Xl.map((t)=>be(Vn(e),t))}function Ql(e){return be(process.env.XDG_CACHE_HOME||be(e,".cache"),"opencode","packages",Zl)}function Ao(e){Jm(Ql(e),{recursive:!0,force:!0})}async function ec(e){let t=be(Ql(e),"node_modules",qn),n=be(t,"package.json");if(!Po(n))throw Error(`The OpenCode plugin cache at ${t} is missing its package, so OpenCode would load nothing and fail open. Run \`opencode plugin -g -f ${Zl}\` for details.`);let r=k(JSON.parse(Yl(n,"utf-8")),"main");if(typeof r!=="string")throw Error(`The cached OpenCode plugin at ${t} declares no "main" entry.`);let o=be(t,r);if(typeof(await import(Wm(o).href))[Jl]==="function")return;throw Error(`The cached OpenCode plugin at ${o} does not export a callable ${Jl}, so OpenCode would load nothing and fail open.`)}function zn(e,t){if(e[t]==="/"&&e[t+1]==="/"){let n=e.indexOf(`
`,t+2);return n===-1?e.length:n+1}if(e[t]==="/"&&e[t+1]==="*"){let n=e.indexOf("*/",t+2);return n===-1?e.length:n+2}return t}function Wl(e,t){let n=t;while(n<e.length){if(/\s/.test(e[n]??"")){n++;continue}let r=zn(e,n);if(r===n)return n;n=r}return n}function tc(e,t){let n=t+1,r=!1;while(n<e.length){if(r){r=!1,n++;continue}if(e[n]==="\\"){r=!0,n++;continue}if(e[n]==='"')return n+1;n++}throw Error("Unterminated string in OpenCode config")}function nc(e,t,n){return JSON.parse(e.slice(t,n))}function Xm(e,t){return Gn(e,t,{skipComment:zn,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function Qm(e){let t=0,n=0;while(n<e.length){let r=zn(e,n);if(r!==n){n=r;continue}if(e[n]==='"'){let o=tc(e,n);if(t===1&&nc(e,n,o)==="plugin"){let i=Wl(e,o),s=Wl(e,i+1);if(e[i]===":"&&e[s]==="[")return{start:s,end:Xm(e,s)}}n=o;continue}if(e[n]==="{"||e[n]==="[")t++;if(e[n]==="}"||e[n]==="]")t--;n++}return}function eg(e,t){let n=[],r=t.start+1;while(r<t.end){let o=zn(e,r);if(o!==r){r=o;continue}if(e[r]==='"'){let i=tc(e,r),s=nc(e,r,i);if(typeof s==="string"&&s.includes(qn))n.push({start:r,end:i});r=i;continue}r++}return n}function rc(e,t){try{return JSON.parse(z(e))}catch(n){if(n instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${n.message}`);throw n}}function tg(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e.plugin;if(!Array.isArray(t))return!1;return t.some((n)=>typeof n==="string"&&n.includes(qn))}function ng(e,t){let n=Qm(e);if(!n)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let r=[...eg(e,n)].reverse().reduce(Bn,e);return rc(r,t),r}function oc(e){Ao(e);let t=Zm(e),n=t.find((o)=>Po(o)),r=[];for(let o of t){if(!Po(o))continue;try{let i=Yl(o,"utf-8");if(!tg(rc(i,o)))continue;return O(o,ng(i,o)),{path:o,alreadyInstalled:!0}}catch(i){r.push(i instanceof Error?i.message:String(i))}}if(r.length>0)throw Error(r.join(`
`));return{path:n??Ym(e),alreadyInstalled:!1}}function ic(e){let t=[],n=Vn(e.homeDir),r=["opencode.json","opencode.jsonc"];for(let o of r){let i=ig(n,o);if(rg(i))try{let s=og(i,"utf-8"),a=z(s);if((JSON.parse(a).plugin??[]).some((m)=>m.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:i,errors:t.length>0?t:void 0}}catch(s){t.push(`Failed to parse ${o}: ${s instanceof Error?s.message:String(s)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as sg}from"node:path";function Eo(e){return sg(e,".pi","agent","settings.json")}function To(e){if(typeof e!=="string")return!1;return e==="npm:cc-safety-net"||e.startsWith("npm:cc-safety-net@")}function sc(e){let t=Eo(e.homeDir),n=ae(t);if(n.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(n.kind==="missing")return{platform:"pi",status:"n/a"};let r=k(n.value,"packages");if(!Array.isArray(r))return{platform:"pi",status:"n/a"};let o=r.find((a)=>To(typeof a==="string"?a:k(a,"source")));if(o===void 0)return{platform:"pi",status:"n/a"};let i=k(o,"extensions");if(Array.isArray(i)&&i.some((a)=>typeof a==="string"&&a.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var lg={amp:Fa,"antigravity-cli":Ha,"claude-code":Ga,codex:Ba,"copilot-cli":el,cursor:ll,"gemini-cli":cl,"grok-build":bl,"hermes-agent":Tl,"kimi-code":zt,openclaw:Vl,opencode:ic,pi:sc};function ft(e,t){let n={...t,cwd:e,homeDir:t?.homeDir??ag()};return gn.map((r)=>cg(lg[r](n)))}function cg(e){if(e.status==="not-inspected")return{platform:e.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:e.platform,detected:e.status!=="n/a",configured:e.status==="configured",inspectionStatus:e.status!=="n/a"?"verified":e.errors&&e.errors.length>0?"failed":"not-applicable",method:e.method,configPath:e.configPath,configPaths:e.configPaths,errors:e.errors}}import{tmpdir as dg}from"node:os";import{join as ug}from"node:path";var pg=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),fg=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([]),allowPaths:Object.freeze([])})})}),mg={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}}};function ac(){let e=ug(dg(),"cc-safety-net-self-test"),t=pg.map((n)=>{let r=fn(nt("self-test",{command:n.command},{kind:"command",shell:"auto"},{configCwd:e,executionCwd:e},n.command),{guard:{dependencies:{loadPolicySnapshot:()=>fg,getModes:()=>mg,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),o=n.expectBlocked?"blocked":"allowed",i=r.decision.kind==="deny"?"blocked":"allowed";return{command:n.command,description:n.description,expected:o,actual:i,passed:o===i,reason:r.decision.kind==="deny"?r.decision.reason:void 0,ruleId:r.decision.kind==="deny"?r.decision.ruleId:void 0}});return{passed:t.filter((n)=>n.passed).length,failed:t.filter((n)=>!n.passed).length,total:t.length,results:t}}function Io(e){let t=E({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},e);if(ue(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function lc(e={}){let t=await jt(!e.json,()=>{let n=gg(e);return{ready:n,finish:()=>n}},()=>Mt(),{loadingMessage:"Checking system status…"});if(e.json)console.log(JSON.stringify(t,null,2));else hg(t);return t.engineSelfTest.failed>0||t.findings.some((n)=>n.severity==="error")?1:0}async function gg(e){let t=e.cwd??process.cwd(),n=await Ft(),r=ft(t,{ampPluginListOutput:n.ampPluginListOutput,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.versions["copilot-cli"]}),o=ea(t),i=ta(),s=V({cwd:t}),a=s.policy,l=ge(a),c=Me(a,l.capabilities),d=bn(7),m=Ia(t),g=e.skipUpdateCheck?{currentVersion:_(),latestVersion:null,updateAvailable:!1}:await Ae(),u={hooks:r,engineSelfTest:ac(),userConfig:o.userConfig,projectConfig:o.projectConfig,configState:It(s),effectiveRules:o.effectiveRules,shadowedRules:o.shadowedRules,environment:i,effectiveSafety:{selectedPreset:a.safety.level??"standard",level:l.effectiveLevel,capabilities:l.capabilities,ruleOverrides:a.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(c).filter(([,p])=>p.source==="rule_override"&&p.override==="off"&&p.inheritedEnabled&&p.changesInherited).map(([p])=>p),ruleCounts:{stored:Object.keys(a.destructiveCommandRuleOverrides).length,effective:Object.values(c).filter((p)=>p.changesInherited).length},...s.policyScopes?{policyScopes:s.policyScopes}:{}},...m.length>0?{v2Leftovers:m}:{},posture:ga(o.userConfig.path),activity:d,update:g,system:n};return{...u,findings:ra(u)}}function hg(e){console.log(),console.log(ia(e.hooks)),console.log(),console.log(sa(e.engineSelfTest)),console.log(),console.log(aa(e)),console.log(),console.log(la(e.environment)),console.log(),console.log(ca(e)),console.log(),console.log(da(e.findings)),console.log(),console.log(ua(e.activity)),console.log(),console.log(fa(e.system)),console.log(),console.log(pa(e.update)),console.log(ma(e))}import{existsSync as yg}from"node:fs";var vg=/^[A-Za-z0-9_@%+=:,./-]+$/,cc="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function _o(e){let t=E({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},e);if(ue(t.errors))return console.error(cc),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!yg(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let n=t.positionals.length===1?t.positionals[0]:t.positionals.map((r)=>vg.test(r)?r:`'${r.replaceAll("'","'\\''")}'`).join(" ");if(!n)return console.error("Error: No command provided"),console.error(cc),null;return{json:t.flags.json,cwd:t.values.cwd,command:n}}function dc(e){if(e)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function uc(e,t){let r=t-18;return[`${e.dtl}${e.dh.repeat(t)}${e.dtr}`,`${e.dv}  Command Analysis${" ".repeat(r)}${e.dv}`,`${e.dbl}${e.dh.repeat(t)}${e.dbr}`]}function $o(e){return JSON.stringify(e)}function pc(e,t=0){return`[${e.map((r,o)=>oa(r,o,t)).join(",")}]`}function Wt(e,t,n=70){let r=e.split(" "),o=[],i="";for(let s of r)if(i&&i.length+s.length+1>n)o.push(i),i=s;else i=i?`${i} ${s}`:s;if(i)o.push(i);return o.map((s,a)=>a===0?s:`${t}${s}`)}function fc(e,t,n){let r=[];switch(e.type){case"parse":return null;case"env-strip":return r.push(""),r.push(`STEP ${t} ${n.h} Strip environment variables`),r.push(`  Removed: ${e.envVars.map((o)=>`${o}=<redacted>`).join(", ")}`),r.push(`  Tokens:  ${$o(e.output)}`),{lines:r,incrementStep:!0};case"leading-tokens-stripped":return r.push(""),r.push(`STEP ${t} ${n.h} Strip wrappers`),r.push(`  Removed: ${e.removed.join(", ")}`),r.push(`  Tokens:  ${$o(e.output)}`),{lines:r,incrementStep:!0};case"shell-wrapper":return r.push(""),r.push(`STEP ${t} ${n.h} Detect shell wrapper`),r.push(`  Wrapper: ${e.wrapper} -c`),r.push(`  Inner:   ${e.innerCommand}`),{lines:r,incrementStep:!0};case"interpreter":{if(r.push(""),r.push(`STEP ${t} ${n.h} Detect interpreter`),r.push(`  Interpreter: ${e.interpreter}`),r.push(`  Code:        ${e.codeArg}`),e.paranoidBlocked)r.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:r,incrementStep:!0}}case"busybox":return r.push(""),r.push(`STEP ${t} ${n.h} Busybox wrapper`),r.push(`  Subcommand: ${e.subcommand}`),{lines:r,incrementStep:!0};case"transparent-wrapper":return r.push(""),r.push(`STEP ${t} ${n.h} Transparent wrapper`),r.push(`  Wrapper: ${e.wrapper}`),r.push(`  Tokens:  ${$o(e.output)}`),{lines:r,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{if(r.push(""),r.push(`STEP ${t} ${n.h} Match rules`),r.push(`  Rule:   ${e.rule}()`),e.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}case"worktree-relaxation":return r.push(""),r.push(`STEP ${t} ${n.h} Worktree relaxation`),r.push(`  Mode:   ${C.worktree.name}`),r.push(`  Git cwd: ${e.gitCwd}`),r.push("  Result: Allowed local discard in linked worktree"),{lines:r,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(e.embeddedCommandFound)return r.push(""),r.push(`STEP ${t} ${n.h} Fallback scan`),r.push(`  Found: ${e.embeddedCommandFound}`),{lines:r,incrementStep:!0};return null}case"custom-rules-check":{if(e.rulesChecked){if(r.push(""),r.push(`STEP ${t} ${n.h} Custom rules`),e.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(e.matched)return r.push(""),r.push(`STEP ${t} ${n.h} Dangerous text check`),r.push(`  Token:  ${e.token}`),r.push("  Result: MATCHED"),{lines:r,incrementStep:!0};return null}case"strict-unparseable":return r.push(""),r.push(`STEP ${t} ${n.h} Strict mode check`),r.push(`  Command: ${e.rawCommand}`),r.push("  Result:  ✗ UNPARSEABLE"),{lines:r,incrementStep:!0};case"segment-skipped":return null;case"error":return r.push(""),r.push(`ERROR: ${e.message}`),{lines:r,incrementStep:!1};default:return e}}function Oo(e,t){let n=dc(t?.asciiOnly??!1),r=58,o=[],i=1;o.push(...uc(n,58)),o.push("");let s=e.trace.steps.find((p)=>p.type==="error");if(s&&s.type==="error"){o.push("ERROR"),o.push(`  ${s.message}`),o.push(""),o.push("RESULT"),o.push(`  Status: ${e.result==="blocked"?y.red("BLOCKED"):y.green("ALLOWED")}`),o.push(""),o.push("CONFIG");let p=e.configSource??"none";return o.push(`  Path: ${p}`),o.join(`
`)}let a=e.trace.steps.find((p)=>p.type==="parse");if(a&&a.type==="parse"){o.push("INPUT"),o.push(`  ${a.input}`),o.push(""),o.push(`STEP ${i} ${n.h} Split shell commands`),i++;for(let p=0;p<a.segments.length;p++){let f=a.segments[p];if(f){let b=Math.random();o.push(`  Segment ${p+1}: ${pc(f,b)}`)}}}let l=e.trace.segments,c=l.length>1;for(let p of l){if(c){o.push("");let h="";if(a&&a.type==="parse"){let cr=a.segments[p.index];if(cr)h=cr.join(" ")}let S=54,v=h,R=` Segment ${p.index+1}: `,ee=" ";if(h){if(R.length+h.length+ee.length>S){let pu=S-R.length-ee.length;v=`${h.substring(0,pu-1)}…`}}let nn=h?`${R}${v}${ee}`:` Segment ${p.index+1} `,du=h?`${R}${y.cyan(v)}${ee}`:nn,si=58-nn.length,ai=Math.floor(si/2),uu=si-ai;o.push(`${n.sh.repeat(ai)}${du}${n.sh.repeat(uu)}`)}if(p.steps.find((h)=>h.type==="segment-skipped")){o.push(""),o.push("  (skipped — prior segment blocked)");continue}let b=!1,L=!1;for(let h of p.steps){let S=fc(h,i,n);if(S){if(L=!0,h.type==="recurse"){o.push("");let v=" RECURSING ",R=58-v.length-4;o.push(`  ${n.tl}${n.h}${v}${n.h.repeat(R)}`),o.push(`  ${n.v}`),b=!0;continue}for(let v of S.lines)if(b)o.push(`  ${n.v} ${v}`);else o.push(v);if(S.incrementStep)i++}}if(b)o.push(`  ${n.v}`),o.push(`  ${n.bl}${n.h.repeat(56)}`),b=!1;if(!L)o.push(""),o.push(`  ${y.green("✓")} Allowed (no matching rules)`)}if(o.push(""),o.push("RESULT"),e.result==="blocked"){if(o.push(`  Status: ${y.red("BLOCKED")}`),e.customRule){if(o.push(`  Rule: ${e.customRule.id}`),e.customRule.rulebook)o.push(`  Rulebook: ${e.customRule.rulebook.name} ${e.customRule.rulebook.version}`);if(e.customRule.source)o.push(`  Source: ${e.customRule.source}`);if(e.customRule.override)o.push(`  Override: reason ${e.customRule.override.reason}`)}if(e.reason){let p=Wt(e.reason,"          ");o.push(`  Reason: ${p[0]}`);for(let f=1;f<p.length;f++)o.push(p[f]??"")}}else o.push(`  Status: ${y.green("ALLOWED")}`);o.push(""),o.push("CONFIG");let d=e.configSource??"none",m=e.configValid?"":" (invalid)";o.push(`  Path: ${d}${m}`);let g=e.safetyPresetScope;o.push(`  Safety preset: ${e.selectedPreset??"standard"}${g?` (${Ln(g)})`:""}`),o.push(`  Effective capabilities: ${e.effectiveLevel}`);let u=Object.entries(e.destructiveCommandRuleOverrides??{});if(o.push(`  Rule customizations: ${u.length}`),e.ruleActivation)o.push(`  Rule activation: ${e.ruleActivation.id} — ${e.ruleActivation.enabled?"on":"off"} via ${e.ruleActivation.source}`);return o.join(`
`)}function No(e){return JSON.stringify(e,null,2)}function mc(e){return new Promise((t)=>{process.stdout.write(`${e}
`,()=>t())})}async function gc(e){let t=_o(e);if(!t)return 1;try{let n=rt(t.command,{cwd:t.cwd}),r=!!process.env.NO_COLOR||!process.stdout.isTTY;return await mc(t.json?No(n):Oo(n,{asciiOnly:r})),0}catch(n){if(!(n instanceof Nr)&&!(n instanceof He)&&!(n instanceof ye))throw n;if(t.json)return await mc(JSON.stringify({error:n.message})),1;return console.error(n.message),1}}var hc="2.2.2",Q="  ",ze="cc-safety-net";function yc(e){return e.argument?`${e.flags} ${e.argument}`:e.flags}function bg(e){return Math.max(...e.map((t)=>yc(t).length))}function Lg(e){return Math.max(...e.map((t)=>t.usage.length))}function wg(e){return Math.max(...e.map((t)=>`${ze} ${t.usage}`.length))}function kg(e,t){let n=`${ze} ${e.usage}`;return`${Q}${n.padEnd(t+2)}${e.description}`}function Le(e,t){return`${Q}${e.padEnd(Math.max(40,e.length+2))}${t}`}function mt(e,t=console.log){let n=[];if(n.push(`${ze} ${e.name}`),n.push(""),n.push(`${Q}${e.description}`),n.push(""),n.push("USAGE:"),n.push(`${Q}${ze} ${e.usage}`),n.push(""),e.subcommands&&e.subcommands.length>0){n.push("SUBCOMMANDS:");let r=Lg(e.subcommands);for(let o of e.subcommands)n.push(`${Q}${o.usage.padEnd(r+2)}${o.description}`);n.push("")}if(e.options.length>0){n.push("OPTIONS:");let r=bg(e.options);for(let o of e.options){let i=yc(o),s=o.default?`${o.description} (default: ${o.default})`:o.description;n.push(`${Q}${i.padEnd(r+2)}${s}`)}n.push("")}if(e.examples&&e.examples.length>0){n.push("EXAMPLES:");for(let r of e.examples)n.push(`${Q}${r}`)}t(n.join(`
`))}function Fo(){let e=wg(yn),t=[];t.push(`${ze} v${hc}`),t.push(""),t.push("Blocks destructive commands and secret access."),t.push(""),t.push("COMMANDS:");for(let n of yn)t.push(kg(n,e));t.push(""),t.push("GLOBAL OPTIONS:"),t.push(`${Q}-h, --help       Show help (use with command for command-specific help)`),t.push(`${Q}-V, --version    Show version`),t.push(""),t.push("HELP:"),t.push(`${Q}${ze} help <command>     Show help for a specific command`),t.push(`${Q}${ze} <command> --help   Show help for a specific command`),t.push(""),t.push("ENVIRONMENT VARIABLES:"),t.push(Le(`${C.level.name}=standard|strict|paranoid`,"Set session safety level")),t.push(Le(`${C.worktree.name}=1`,"Allow local git discards in linked worktrees")),t.push(Le(`${C.debug.name}=1`,"Print diagnostic messages to stderr")),t.push(Le(`${C.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),t.push(Le("CC_SAFETY_NET_HOME","Override rule config home directory")),t.push(""),t.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),t.push(Le(`${C.strict.name}=1`,"Force safety.overrides.fail_closed on")),t.push(Le(`${C.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),t.push(Le(`${C.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),t.push(Le(`${C.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),t.push(""),t.push("Documentation:        https://ccsafetynet.com/docs"),console.log(t.join(`
`))}function vc(){console.log(hc)}function Yt(e,t=console.log){let n=vn(e);if(!n)return!1;if(n.name.toLowerCase()!==e.toLowerCase())return!1;return mt(n,t),!0}import{existsSync as Wo,readFileSync as dd}from"node:fs";import{homedir as b1,tmpdir as L1}from"node:os";import{join as Ko}from"node:path";import*as Te from"node:readline";function xg(e){return e==="install"?"Install":"Uninstall"}function Cg(e){return e==="install"?"Installing":"Uninstalling"}function Sg(e){return e==="install"?"into":"from"}function wc(e){return e?.available===!0}function Rg(e,t){let n=new Set(t);return e.filter((r)=>n.has(r.target)).map((r)=>r.target)}function bc(e,t,n){if(e.length===0||e.every((r)=>!r.available))return t;return Array.from({length:e.length},(r,o)=>o+1).map((r)=>(t+r*n+e.length)%e.length).find((r)=>wc(e[r]))}function Dg(e,t,n){if(n.ctrl&&n.name==="c")return"interrupt";if(n.name==="escape"||t==="q")return"abort";if(e==="install"&&(t==="u"||t==="U"))return"update";if(n.name==="up"||t==="k")return"up";if(n.name==="down"||t==="j")return"down";if(n.name==="space"||t===" ")return"toggle";if(n.name==="return"||n.name==="enter")return"confirm";return null}function Pg(e){return{cursor:e.findIndex((t)=>t.available),selected:[]}}function Ag(e,t,n){if(n==="confirm"||n==="update"||n==="abort"||n==="interrupt")return{state:e,done:n};if(n==="up")return{state:{...e,cursor:bc(t,e.cursor,-1)}};if(n==="down")return{state:{...e,cursor:bc(t,e.cursor,1)}};let r=t[e.cursor];if(!wc(r))return{state:e};let o=e.selected.includes(r.target)?e.selected.filter((i)=>i!==r.target):Rg(t,[...e.selected,r.target]);return{state:{...e,selected:o}}}var kc="◉",xc="◯",Cc=">",Sc=" ";function Eg(e,t,n,r={}){let o=r.color!==!1,i=o?y.dim:(l)=>l,s=o?y.green:(l)=>l,a=o?y.bold:(l)=>l;return["",`${xg(e)} CC Safety Net ${Sg(e)}:`,"",...t.map((l,c)=>{let d=n.selected.includes(l.target),m=c===n.cursor,g=d?kc:xc,u=m?Cc:Sc,p=l.available?"":` (${l.unavailableReason??"not installed"})`,f=`${g} ${l.label}${p}`,b=!l.available?i(f):d?s(f):m?a(f):f;return`${u} ${b}`}),"",e==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((l)=>l.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${e}. q/Esc: close`].join(`
`)}var Lc=["global-hook","plugin"];function Tg(e,t,n={}){let r=n.color!==!1?y.bold:(i)=>i;return["","Install the Kimi Code integration as:","",...[`Global hook — ${t?"already installed; selecting it reports the current state":"write the hook into ~/.kimi-code/config.toml now"}`,"Native Kimi plugin — print the steps to run inside Kimi Code"].map((i,s)=>{let a=s===e,l=`${a?kc:xc} ${i}`;return`${a?Cc:Sc} ${a?r(l):l}`}),"","Enter: confirm  Up/Down: move  q/Esc: cancel"].join(`
`)}function Rc(e){let{input:t,output:n}=e;Te.emitKeypressEvents(t);let r=t.isRaw===!0;t.setRawMode(!0),t.resume();let o=0,i=()=>{if(o===0)return;Te.moveCursor(n,0,-o),Te.cursorTo(n,0),Te.clearScreenDown(n)},s=()=>{i();let a=e.render();n.write(`${a}
`),o=a.split(`
`).length};return new Promise((a)=>{let l=(d)=>{t.off("keypress",c),t.setRawMode(r),t.pause(),i(),a(d)};function c(d,m){e.onKey(d,m,{finish:l,draw:s})}t.on("keypress",c),s()})}function Dc(e={}){let t=0;return Rc({input:e.input??process.stdin,output:e.output??process.stdout,render:()=>Tg(t,e.globalHookInstalled===!0),onKey:(n,r,o)=>{if(r.ctrl&&r.name==="c"){o.finish(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(r.name==="escape"||n==="q")return o.finish(null);if(r.name==="return"||r.name==="enter")return o.finish(Lc[t]);if(r.name==="up"||r.name==="down"||n==="k"||n==="j")t=(t+1)%Lc.length,o.draw()}})}function Ho(e=process.stdin,t=process.stdout){return Boolean(e.isTTY&&t.isTTY&&typeof e.setRawMode==="function")}function Pc(e,t,n={}){let r=n.output??process.stdout,o=Pg(t);return Rc({input:n.input??process.stdin,output:r,render:()=>Eg(e,t,o),onKey:(i,s,a)=>{let l=Dg(e,i,s);if(!l)return;let c=Ag(o,t,l);if(o=c.state,c.done==="interrupt"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(c.done==="abort")return a.finish(null);if(c.done==="update")return a.finish("update");if(c.done==="confirm"){if(o.selected.length===0){r.write("\x07"),a.draw();return}a.finish([...o.selected]),r.write(`${Cg(e)} selected integrations...
`);return}a.draw()}})}import{existsSync as Ec,lstatSync as _g,mkdirSync as $g,mkdtempSync as Og,readdirSync as Ng,readFileSync as ht,rmSync as Jn}from"node:fs";import{tmpdir as Fg}from"node:os";import{basename as Hg,dirname as Mg,join as G}from"node:path";import{fileURLToPath as jg}from"node:url";var Mo="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp",Ke="cc-safety-net",Je="cc-safety-net/index.ts";import{spawn as Ig}from"node:child_process";var jo=(e,t)=>{let n=Ge([...e],process.env);return new Promise((r)=>{let o=Ig(n.cmd,n.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),i=ko(o),s=!1,a=setTimeout(()=>{s=!0,o.kill()},120000);o.on("error",(l)=>{clearTimeout(a),r({status:null,errorCode:l.code,stdout:i.stdout,stderr:[l.message,i.stderr].filter(Boolean).join(`
`)})}),o.on("close",(l)=>{clearTimeout(a),r({status:s?null:l,errorCode:s?"ETIMEDOUT":void 0,stdout:i.stdout,stderr:i.stderr})})})};var gt="cc-safety-net.ts",Ac=G("amp",Je);function Ug(e){return G(e,".config","amp","plugins","cc-safety-net.ts")}function Gg(){let e=Mg(jg(import.meta.url));return[G(e,"..",Ac),G(e,"..","..","..","dist",Ac)]}function Bg(e=Gg()){let t=e.find((n)=>Ec(n)&&_g(n).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function Tc(e){try{return JSON.parse(e)}catch{return}}function Wn(e){return e.subarray(0,Buffer.byteLength(Mo)).toString("utf-8")===Mo}async function Zt(e,t,n){let r=await e(t,n);if(r.status===0)return r;throw Error([`Failed to run ${t.join(" ")}${r.status===null?"":` (exit ${r.status})`}.`,[r.stdout,r.stderr].filter(Boolean).join(`
`).trim()].filter(Boolean).join(`
`))}async function Ic(e){let t=await e(["amp","plugins","repositories","--json"]);if(t.status===null)throw Error(`${t.errorCode==="ENOENT"?'Amp CLI not found. Install the amp CLI, sign in with "amp login", and rerun install --amp.':`amp plugins repositories --json did not finish (${t.errorCode??"terminated"}). Check that the amp CLI responds and rerun install --amp.`}
...
`)}`.trim());let n=Tc(t.stdout),r=(Array.isArray(n)?n:[]).filter((o)=>k(o,"scope")==="user"&&k(o,"exists")===!0&&k(o,"viewerCanWrite")===!0).map((o)=>k(o,"cloneRef")).find((o)=>typeof o==="string"&&o.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}async function _c(e,t){let n=Og(G(Fg(),"cc-safety-net-amp-"));try{return await Zt(e,["amp","clone","user-plugins",n]),await t(n)}finally{Jn(n,{recursive:!0,force:!0})}}function Uo(e){return`rerun ${e==="overwrite"?"install":"uninstall"} --amp`}function $c(e,t,n){let r=G(e,t),o=T(r);if(!o)return;if(o.isSymbolicLink()||!o.isFile())throw Error(`Refusing to ${n} ${t} in your Amp personal plugins repository: not a regular file. Remove it there and ${Uo(n)}.`);let i=ht(r);if(Wn(i))return i;throw Error(`Refusing to ${n} unmanaged file ${t} in your Amp personal plugins repository. Remove it there and ${Uo(n)}.`)}function Oc(e,t){let n=G(e,Ke),r=T(n);if(!r)return;if(r.isSymbolicLink()||!r.isDirectory())throw Error(`Refusing to ${t} ${Ke} in your Amp personal plugins repository: not a regular directory. Remove it there and ${Uo(t)}.`);return $c(e,Je,t)}function qg(e){let t=G(e,gt),n=T(t);if(!n||n.isSymbolicLink()||!n.isFile())return;let r=ht(t);return Wn(r)?r:void 0}async function Nc(e,t,n,r){if(await Zt(e,n,t),(await Zt(e,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await Zt(e,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",r],t),await Zt(e,["git","push","origin","HEAD"],t),!0}function Kn(e,t){Vg(e,t),zg(e,t)}function Fc(e,t){if(t==="keep")return;throw Error(`Local Amp plugin ${e} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function Vg(e,t){let n=Ug(e),r=T(n);if(!r)return;if(!r.isSymbolicLink()&&r.isFile()&&Wn(ht(n))){Jn(n);return}Fc(n,t)}function zg(e,t){let n=G(e,".config","amp","plugins",Ke),r=T(n);if(!r)return;if(!r.isSymbolicLink()&&r.isDirectory()&&Kg(n)){Jn(n,{recursive:!0});return}Fc(n,t)}function Kg(e){let t=Hg(Je);if(Ng(e).join("\x00")!==t)return!1;let n=G(e,t),r=T(n);return!!r&&!r.isSymbolicLink()&&r.isFile()&&Wn(ht(n))}function Jg(){let e=Pe();if(!Ec(e))return"";let t=Tc(ht(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(we(t))};
`}async function Hc(e,t=Bg(),n=jo){let r=Buffer.concat([ht(t),Buffer.from(Jg(),"utf-8")]),o=await Ic(n);return _c(n,async(i)=>{let s=`${o}/${Ke}`,a=Oc(i,"overwrite"),l=$c(i,gt,"overwrite");if(a?.equals(r)&&!l)return Kn(e,"fail"),{path:s,alreadyInstalled:!0};if($g(G(i,Ke),{recursive:!0}),O(G(i,Je),r),l)Jn(G(i,gt));let c=await Nc(n,i,["git","add","--",Je,...l?[gt]:[]],`chore: update cc-safety-net plugin to v${_()}`);return Kn(e,"fail"),{path:s,alreadyInstalled:!c}})}async function Mc(e,t=jo){let n=await Ic(t);return _c(t,async(r)=>{let o=Oc(r,"remove"),i=qg(r),s=`${n}/${i&&!o?gt:Ke}`;if(!o&&!i)return Kn(e,"keep"),{path:s,alreadyInstalled:!1};return await Nc(t,r,["git","rm","--",...o?[Je]:[],...i?[gt]:[]],`chore: remove cc-safety-net plugin v${_()}`),Kn(e,"keep"),{path:s,alreadyInstalled:!0}})}import{existsSync as jc,mkdirSync as Wg,readFileSync as Yg}from"node:fs";import{dirname as Zg}from"node:path";var Go="npx -y cc-safety-net hook --agy-cli",We="cc-safety-net";function Ye(e){return Boolean(e)&&typeof e==="object"&&!Array.isArray(e)}function Zn(){return{PreToolUse:[{hooks:[{type:"command",command:Go,timeout:30}]}]}}function Uc(e){try{let t=JSON.parse(Yg(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${e}: ${t.message}`);throw t}}function Gc(e){let t=e[We];if(t===void 0){let r=Zn();return e[We]=r,{definition:r,preToolUse:r.PreToolUse??[]}}if(!Ye(t))throw Error(`Antigravity hooks config entry "${We}" must be an object`);let n=Array.isArray(t.PreToolUse)?t.PreToolUse:[];return t.PreToolUse=n,{definition:t,preToolUse:n}}function Bc(e){if(!Array.isArray(e.PreToolUse))return!1;return e.PreToolUse.some((t)=>Ye(t)&&Array.isArray(t.hooks)&&t.hooks.some((n)=>Ye(n)&&n.command===Go))}function Xg(e){return Object.values(e).some((t)=>Ye(t)&&t.enabled!==!1&&Bc(t))}function Qg(e){if(e[We]===void 0)return!1;let t=Gc(e);if(t.definition.enabled!==!1||!Bc(t.definition))return!1;return t.definition.enabled=!0,!0}function e1(e){if(e[We]===void 0){e[We]=Zn();return}let t=Gc(e);t.definition.enabled=!0,t.preToolUse.push(Zn().PreToolUse?.[0]??{hooks:[]})}function t1(e){let t=!1;for(let n of Object.values(e)){if(!Ye(n)||!Array.isArray(n.PreToolUse))continue;n.PreToolUse=n.PreToolUse.flatMap((r)=>{if(!Ye(r)||!Array.isArray(r.hooks))return[r];let o=r.hooks.filter((i)=>!Ye(i)||i.command!==Go);if(o.length!==r.hooks.length)t=!0;return o.length===0?[]:[{...r,hooks:o}]})}return t}function Yn(e,t){O(e,`${JSON.stringify(t,null,2)}
`)}function qc(e){let t=Ot(e);if(Wg(Zg(t),{recursive:!0}),!jc(t))return Yn(t,{[We]:Zn()}),{path:t,alreadyInstalled:!1};let n=Uc(t);if(Xg(n))return{path:t,alreadyInstalled:!0};if(Qg(n))return Yn(t,n),{path:t,alreadyInstalled:!1};return e1(n),Yn(t,n),{path:t,alreadyInstalled:!1}}function Vc(e){let t=Ot(e);if(!jc(t))return{path:t,alreadyInstalled:!1};let n=Uc(t);if(!t1(n))return{path:t,alreadyInstalled:!1};return Yn(t,n),{path:t,alreadyInstalled:!0}}import{existsSync as n1,readdirSync as r1,rmSync as o1}from"node:fs";import{join as i1}from"node:path";function zc(e,t=process.platform,n){if(!n1(e))return;let r=t==="win32"?/^bunx-\d+-cc-safety-net@/:new RegExp(`^bunx-${process.getuid?.()??0}-cc-safety-net@`);r1(e).filter((o)=>o!==n&&r.test(o)).forEach((o)=>{o1(i1(e,o),{recursive:!0,force:!0})})}import{spawn as s1}from"node:child_process";var de=Y.map((e)=>({target:e.id,flag:e.flag,label:P(e.id),probeCommand:e.probeCommand}));function Bo(e){let t=new Set(e);return de.map((n)=>n.target).filter((n)=>t.has(n))}async function Kc(e,t){for(let n of e)await t(n)}var a1=5000;function qo(e){return new Promise((t)=>{let n=Ge([...e],process.env),r=s1(n.cmd,n.args,{env:process.env,stdio:"ignore"}),o=!1,i=(a)=>{if(o)return;o=!0,clearTimeout(s),t(a)},s=setTimeout(()=>{r.kill(),i(!1)},a1);r.on("error",()=>i(!1)),r.on("close",(a)=>i(a===0))})}function Jc(e=qo,t={}){let n=new Set(t.configuredTargets??[]);return Promise.all(de.map(async(r)=>({target:r.target,flag:r.flag,label:r.label,...Yc(t.action,await e(r.probeCommand),n.has(r.target))})))}function Wc(e,t){let n=new Set(t.configuredTargets??[]);return e.map((r)=>({...r,...Yc(t.action,r.available,n.has(r.target))}))}function Yc(e,t,n){if(e==="uninstall")return n?{available:!0}:{available:!1,unavailableReason:"not installed"};if(e==="install"&&n)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as Zc,readdirSync as l1,rmSync as c1}from"node:fs";import{join as yt}from"node:path";function Xn(e,t=process.platform){let n=yt(process.env.npm_config_cache||(t==="win32"?yt(process.env.LOCALAPPDATA||yt(e,"AppData","Local"),"npm-cache"):yt(e,".npm")),"_npx");if(!Zc(n))return;l1(n).filter((r)=>Zc(yt(n,r,"node_modules","cc-safety-net"))).forEach((r)=>{c1(yt(n,r),{recursive:!0,force:!0})})}import{existsSync as Qc,mkdirSync as d1,readFileSync as ed}from"node:fs";import{dirname as u1,join as Xc}from"node:path";var Xt="npx -y cc-safety-net hook --kimi-code",Vo=`[[hooks]]
event = "PreToolUse"
command = "${Xt}"`,zo=`{ event = "PreToolUse", command = "${Xt}" }`;function td(e){return Xc(process.env.KIMI_CODE_HOME??Xc(e,".kimi-code"),"config.toml")}function p1(e){return e.split(`
...
`)}function f1(e,t){if(e[t]!=="#")return t;let n=e.indexOf(`
`,t+1);return n===-1?e.length:n+1}function m1(e,t){return Gn(e,t,{skipComment:f1,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function nd(e){let t=!1,n=0;while(n<e.length){let r=e.indexOf(`
`,n),o=r===-1?e.length:r,i=e.slice(n,o);if(/^\s*\[/.test(i))t=!0;if(!t){let s=/^(\s*)hooks\s*=\s*\[/.exec(i);if(s){let a=n+s[0].lastIndexOf("[");return{start:a,end:m1(e,a)}}}n=r===-1?e.length:r+1}return}function g1(e,t){let n=e.slice(0,t.end).trimEnd(),r=Kl(e,t.end),o=r===""?"     ":`${r}  `,i=!n.endsWith("[")&&!n.endsWith(",");return`${n}${i?",":""}
${o}${zo}${e.slice(t.end)}`}function h1(e){let t=nd(e);if(t&&e.slice(t.start+1,t.end).trim())return g1(e,t);let n=p1(e).trimEnd();if(n==="")return`${Vo}
`;return`${n}

${Vo}
`}function y1(e){return e.split(/(?=^\s*\[)/m).filter((n)=>!/^\s*\[\[hooks]]\s*$/m.test(n)||!n.includes(Xt)).join("").trimEnd()}function v1(e,t){let n=e.indexOf(zo,t.start);if(n===-1||n>t.end)return e;return Bn(e,{start:n,end:n+zo.length})}function rd(e){let t=td(e);if(d1(u1(t),{recursive:!0}),!Qc(t))return O(t,`${Vo}
`),{path:t,alreadyInstalled:!1};let n=ed(t,"utf-8");if(n.includes(Xt))return{path:t,alreadyInstalled:!0};return O(t,h1(n)),{path:t,alreadyInstalled:!1}}function od(e){let t=td(e);if(!Qc(t))return{path:t,alreadyInstalled:!1};let n=ed(t,"utf-8");if(!n.includes(Xt))return{path:t,alreadyInstalled:!1};let r=nd(n),o=r?v1(n,r):`${y1(n)}
`;return O(t,o),{path:t,alreadyInstalled:!0}}var Jo="safety-net@cc-marketplace",id=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]),sd=new Set(["antigravity-cli","cursor","grok-build","hermes-agent","kimi-code"]);function Yo(e){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(e??"")}function ud(e){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(e??"")}function w1(e){return/^Marketplace `cc-marketplace`\s*$/m.test(e??"")}var pd={"claude-code":{installCommands:(e)=>{let t=Pn(e,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...io(e).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:Pn(e,Jo)?[["claude","plugin","uninstall",Jo]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:async(e,t)=>{let n=t??await ce(["codex","plugin","list"]),r=ud(n);return{commands:[r||w1(n)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:Yo(n)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:r}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:async()=>{let e=await ce(["copilot","plugin","list"]),t=[...Wa(e)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...Ya(e)?[["copilot","plugin","uninstall",za]]:[]];if(Ka(e))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",le]],cleanupCommands:t,update:!0};return{commands:[Ja(await ce(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",le]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(e)=>{let t=fo(e);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:Ro,installCommands:()=>({commands:Ml()}),uninstallCommands:[["openclaw","plugins","uninstall",A,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:Ao,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function er(){return process.env.HOME??b1()}function fd(e,t=(n)=>n){try{let n=JSON.parse(t(dd(e,"utf-8")));if(!n||typeof n!=="object"||Array.isArray(n))throw Error(`Settings file ${e} must be a JSON object`);return n}catch(n){if(n instanceof SyntaxError)throw Error(`Failed to parse ${e}: ${n.message}`);throw n}}function k1(e){let t=Ko(Ut(e),"settings.json");if(!Wo(t))return;let n=fd(t,z),r=n.enabledPlugins;if(!r||typeof r!=="object"||Array.isArray(r))return;if(r[le]!==!1)return;let o=dd(t,"utf-8"),i=o.replace(new RegExp(`("${le}"\\s*:\\s*)false`),"$1true");return r[le]=!0,O(t,i!==o?i:`${JSON.stringify(n,null,2)}
`),`Enabled ${le} plugin in ${t}`}function x1(e){let t=Eo(e);if(!Wo(t))return;let n=fd(t);if(!Array.isArray(n.packages))return;let r=n.packages.find((o)=>!!o&&typeof o==="object"&&!Array.isArray(o)&&To(o.source)&&("extensions"in o));if(!r)return;return delete r.extensions,O(t,`${JSON.stringify(n,null,2)}
`),`Enabled npm:cc-safety-net extensions in ${t}`}function ad(e,t){let n=E({label:t,booleans:Object.fromEntries(de.map((i)=>[i.target,[i.flag]]))},e),r=n.errors[0];if(r)throw Error(r);let o=de.filter((i)=>n.flags[i.target]).map((i)=>i.target);if(o.length!==1)throw Error(`Choose exactly one ${t} target: ${de.map((i)=>i.flag).join(", ")}`);return o[0]}async function md(e=er(),t=at){let[n,r,o]=await Promise.all([t(["amp","plugins","list"],30000),t(["codex","plugin","list"],30000),t(["copilot","--binary-version"])]);return{codexPluginListOutput:r,hooks:ft(process.cwd(),{homeDir:e,ampPluginListOutput:n,codexPluginListOutput:r,copilotCliVersion:o})}}async function C1(e,t=at){let n=await md(er(),t);return n.hooks.filter((r)=>e==="install"?r.configured:r.detected||r.inspectionStatus==="not-inspected").filter((r)=>r.platform!=="codex"||!Yo(n.codexPluginListOutput)||ud(n.codexPluginListOutput)).map((r)=>r.platform)}function S1(e,t,n){if(t.length>0)return{finish:async()=>[ad(t,e)]};if(!n.selectTargets&&!Ho(n.input,n.output))return{finish:async()=>[ad(t,e)]};let r=n.detectConfiguredTargets??(()=>C1(e,n.fetchVersion)),o=Promise.all([Jc(n.probeTargets),r()]);return{ready:o,finish:async()=>{let[i,s]=await o,a=Wc(i,{action:e,configuredTargets:s}),l=n.selectTargets?await n.selectTargets(e,cd(e,a)):await Pc(e,cd(e,a),{input:n.input,output:n.output});if(l==="update")return l;if(!l||l.length===0)return null;return Bo(l)}}}async function Ze(e,t,n=!1,r){let o=pd[e];o.beforeInstall?.(t);let i=typeof o.installCommands==="function"?await o.installCommands(t,r):{commands:o.installCommands};return await xo(i.commands),await _l(i.cleanupCommands??[]),[`${i.update||n?"Updated":"Installed"} ${P(e)} integration`,o.postInstallMessage].filter(Boolean).join(`
`)}async function vt(e){let t=pd[e];if(!t.uninstallCommands)throw Error(`${P(e)} uninstall is not supported`);return await xo(t.uninstallCommands),`Uninstalled ${P(e)} integration`}function R1(e){let t=oc(e);return t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`}var D1={"antigravity-cli":{install:qc,uninstall:Vc},cursor:{install:sl,uninstall:al},"grok-build":{install:yl,uninstall:vl},"kimi-code":{install:rd,uninstall:od}};function Ie(e,t,n,r=!1){if(e==="install"&&!r)Xn(n);let o=D1[t][e](n),i=P(t),s=e!=="install"?"Uninstalled":r?"Updated":"Installed";return e==="install"&&o.alreadyInstalled?r?`${i} hook up to date in ${o.path}`:`${i} hook already installed in ${o.path}`:e==="uninstall"&&!o.alreadyInstalled?`${i} hook not installed in ${o.path}`:`${s} ${i} hook ${e==="install"?"in":"from"} ${o.path}`}var P1={amp:{install:Hc,uninstall:Mc,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:xl,uninstall:Cl,afterInstall:async(e)=>{let t=Lo(e);return await ce(["hermes","plugins","enable",Z,"--no-allow-tool-override"]),!t},beforeUninstall:async(e)=>{bo(e);try{await ce(["hermes","plugins","disable",Z])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
Removing the plugin files anyway; ${Z} may still be listed in the Hermes config.`)}},restartNote:"Restart Hermes to apply the change."}};async function Qn(e,t,n,r=!1){let o=P1[t];if(e==="uninstall")await o.beforeUninstall?.(n);let i=e==="install"?await o.install(n):await o.uninstall(n),s=e==="install"&&await o.afterInstall?.(n),a=P(t),l=!s&&(e==="install"&&i.alreadyInstalled||e==="uninstall"&&!i.alreadyInstalled);return[l?e==="install"?`${a} plugin ${r?"up to date":"already installed"} at ${i.path}`:`${a} plugin not installed at ${i.path}`:`${e!=="install"?"Uninstalled":r?"Updated":"Installed"} ${a} plugin ${e==="install"?"at":"from"} ${i.path}`,l?void 0:o.restartNote].filter(Boolean).join(`
`)}var A1={amp:{install:(e,t)=>Qn("install","amp",e,t),uninstall:(e)=>Qn("uninstall","amp",e)},"antigravity-cli":{install:(e,t)=>Ie("install","antigravity-cli",e,t),uninstall:(e)=>Ie("uninstall","antigravity-cli",e)},"claude-code":{install:(e,t)=>Ze("claude-code",e,t),uninstall:()=>vt("claude-code")},codex:{install:(e,t,n)=>Ze("codex",e,t,n),uninstall:()=>vt("codex")},"copilot-cli":{install:async(e,t)=>[await Ze("copilot-cli",e,t),k1(e)].filter(Boolean).join(`
`),uninstall:()=>vt("copilot-cli")},cursor:{install:(e,t)=>Ie("install","cursor",e,t),uninstall:(e)=>Ie("uninstall","cursor",e)},"gemini-cli":{install:(e,t)=>Ze("gemini-cli",e,t),uninstall:()=>vt("gemini-cli")},"grok-build":{install:(e,t)=>Ie("install","grok-build",e,t),uninstall:(e)=>Ie("uninstall","grok-build",e)},"hermes-agent":{install:(e,t)=>{if(!t)Xn(e);return Qn("install","hermes-agent",e,t)},uninstall:(e)=>Qn("uninstall","hermes-agent",e)},"kimi-code":{install:(e,t)=>Ie("install","kimi-code",e,t),uninstall:(e)=>Ie("uninstall","kimi-code",e)},openclaw:{install:async(e,t)=>{let n=await Ze("openclaw",e,t);return await jl(),n},uninstall:(e)=>(Ro(e),vt("openclaw"))},opencode:{install:async(e,t)=>{let n=await Ze("opencode",e,t);return await ec(e),n},uninstall:(e)=>R1(e)},pi:{install:async(e,t)=>[await Ze("pi",e,t),x1(e)].filter(Boolean).join(`
`),uninstall:()=>vt("pi")}},ld=["Install CC Safety Net as a native Kimi Code plugin:","","  1. Start Kimi Code and run: /plugins install https://github.com/kenryu42/cc-safety-net","     Confirm the trust prompt; it defaults to cancel.","  2. Run /reload, or start a new session.","","Note: Kimi Code hooks are fail-open. When the hook process cannot start, crashes, or times","out, Kimi Code allows the tool call."].join(`
`);function E1(e){if(zt({homeDir:e,cwd:process.cwd()}).status!=="configured")return ld;return[ld,"",y.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function cd(e,t){return t.map((n)=>e==="install"&&n.target==="kimi-code"&&n.unavailableReason==="already installed"?{...n,available:!0,unavailableReason:void 0,label:`${n.label} (global hook installed)`}:n)}function T1(e,t){if(e.selectKimiInstallMethod)return e.selectKimiInstallMethod();if(!Ho(e.input,e.output))return Promise.resolve("global-hook");return Dc({input:e.input,output:e.output,globalHookInstalled:zt({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function gd(e,t,n,r=!1,o){return A1[t][e](n,r,o)}function I1(e){let t=E({label:"update"},e).errors[0];if(t)throw Error(t)}async function _1(e,t=at){let n=await md(e,t),r=Ko(Ut(e),"installed-plugins");return{targets:Bo([...n.hooks.filter((i)=>i.platform!=="copilot-cli"&&i.detected).map((i)=>i.platform),...[An,Va,qa].flatMap((i)=>Wo(Ko(r,...i))?["copilot-cli"]:[]),...Pn(e,Jo)?["claude-code"]:[],...Yo(n.codexPluginListOutput)?["codex"]:[]]),codexPluginListOutput:n.codexPluginListOutput}}async function $1(e){let t=er(),n=e.output??process.stdout,r=(e.scriptPath??process.argv[1]??"").split(/[\\/]/),o=r.find((u)=>/^bunx-\d+-/.test(u)),i=o!==void 0||r.includes("_npx")?null:(e.checkLatestVersion??Ae)(),s=async()=>{let u=i&&await i;if(u?.updateAvailable)n.write(`
...
`)},a=_1(t,e.fetchVersion??at).then(async(u)=>{let p=new Set(u.targets);return{targets:u.targets,codexPluginListOutput:u.codexPluginListOutput,available:new Map(await Promise.all(de.filter((f)=>p.has(f.target)&&id.has(f.target)).map(async(f)=>[f.target,await qo(f.probeCommand)])))}}),l=await jt(e.showBanner??!0,()=>({ready:a,finish:()=>a}),()=>Mt({input:e.input??process.stdin,output:n}),{loadingMessage:"Checking installed integrations…",output:n}),c=await Promise.resolve().then(()=>(zc(L1(),process.platform,o),null)).catch((u)=>Qt(u));if(l.targets.length===0){if(n.write("No installed integrations found. Run `cc-safety-net install` to set one up.\n"),c!==null)console.error(c);return await s(),c===null?0:1}let d=l.targets.some((u)=>sd.has(u))?await Promise.resolve().then(()=>(Xn(t),null)).catch((u)=>Qt(u)):null,m=await Sn(Promise.all(l.targets.map((u)=>{if(id.has(u)&&!l.available.get(u))return Promise.resolve({message:`${P(u)} not found; skipped`,failed:!1});if(d!==null&&sd.has(u))return Promise.resolve({message:d,failed:!0});return gd("install",u,t,!0,l.codexPluginListOutput).then((p)=>({message:p,failed:!1}),(p)=>({message:Qt(p),failed:!0}))})),{loadingMessage:`Updating ${l.targets.length} integration${l.targets.length===1?"":"s"}…`,output:n}),g=c===null?m:[...m,{message:c,failed:!0}];return g.forEach((u)=>{u.failed?console.error(u.message):n.write(`${u.message}
`)}),await s(),g.some((u)=>u.failed)?1:0}function Zo(e,t={}){return Promise.resolve().then(()=>I1(e)).then(()=>$1(t)).catch((n)=>(console.error(Qt(n)),1))}async function en(e,t,n={}){try{let r=await jt(!0,()=>S1(e,t,n),()=>Mt({input:n.input??process.stdin,output:n.output??process.stdout}),{loadingMessage:e==="install"?"Checking available integrations…":"Checking installed integrations…",output:n.output??process.stdout});if(!r)return(n.output??process.stdout).write(`Cancelled: nothing was ${e}ed.
`),0;if(r==="update")return(n.runUpdate??(()=>Zo([],{fetchVersion:n.fetchVersion,input:n.input,output:n.output,showBanner:!1})))();let o=er(),i=n.output??process.stdout;return await Kc(r,async(s)=>{if(s==="kimi-code"&&e==="install"){let l=await T1(n,o);if(l===null){i.write(`Cancelled: Kimi Code integration was not installed.
`);return}if(l==="plugin"){i.write(`${E1(o)}
`);return}}let a=await Sn(gd(e,s,o),{loadingMessage:`${e==="install"?"Installing":"Uninstalling"} ${P(s)} integration…`,output:i});i.write(`${a}
`)}),0}catch(r){return console.error(Qt(r)),1}}function Qt(e){let t=e instanceof Error?e.message:String(e),n=typeof e==="object"&&e!==null&&"code"in e?e.code:null;if(n==="EACCES"||n==="EPERM")return`${t}
...
Check that every parent path component is a directory.`;return t}import{existsSync as Ld,mkdirSync as O1,readFileSync as N1}from"node:fs";import{dirname as F1}from"node:path";import{createInterface as H1}from"node:readline";var hd=new Set(["check","apply"]),yd="(unset)";async function wd(e,t={}){let n=E({label:"policy",booleans:{global:["-g","--global"]},positionals:"list"},e),r=n.positionals[0],o=[...n.errors,...r&&!hd.has(r)?[`Unknown policy subcommand: ${r}`]:[],...r&&hd.has(r)&&!n.positionals[1]?[`policy ${r} requires a file`]:[],...n.positionals.slice(2).map((u)=>`Unexpected policy argument: ${u}`)];if(o.length>0){for(let u of o)console.error(u);return 1}let i=n.positionals[1];if(!r||!i)return mt(hn,console.error),1;let s=n.flags.global?Pe():Ne(t.cwd??process.cwd()),a=tr(i),l=[...a.errors,...Tt(a.value).map((u)=>`${i}: ${u}`),...!n.flags.global&&kd(a.value)&&a.value.audit!==void 0?[`${i}: audit settings are user scope only; remove the audit section from a project proposal`]:[]];if(l.length>0){for(let u of l)console.error(u);return 1}let c=we(a.value);if(console.log(`Scope: ${n.flags.global?"user":"project"} (${s})`),console.log(`Proposal: ${i}`),n.flags.global)vd(we(tr(s).value),c,!0);if(!n.flags.global){let u=U1();console.log("Effective policy (user + project merged):"),vd(dn(u,un(tr(s).value).policy).policy,dn(u,un(a.value).policy).policy,!1)}if(r==="check")return 0;let d=t.input??process.stdin,m=t.output??process.stdout;if(!d.isTTY||!m.isTTY)return console.error("policy apply confirms interactively; run this yourself in a terminal:"),console.error(`  cc-safety-net policy apply ${i}${n.flags.global?" --global":""}`),1;if(!await M1(`Apply this policy to ${s}? [y/N] `,d,m))return console.log("Cancelled; nothing was written."),0;return j1(s,a.value,c,n.flags.global),console.log(`Policy applied: ${s}`),0}function M1(e,t,n){let r=H1({input:t,output:n,terminal:!1});return new Promise((o)=>{r.once("close",()=>o(!1)),r.question(e,(i)=>{o(/^y(es)?$/i.test(i.trim())),r.close()})})}function j1(e,t,n,r){if(r){tn(n);return}let o=kd(t)?t:{};O1(F1(e),{recursive:!0}),K(e,{version:n.version,...Object.fromEntries(["safety","workflow","destructive_command_protection","secret_protection"].filter((i)=>o[i]!==void 0).map((i)=>[i,o[i]]))})}function U1(){let e=Pe();if(Ld(e))return we(tr(e).value);return we(globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__)}function tr(e){if(!Ld(e))return{errors:[`${e}: file not found`]};try{return{value:JSON.parse(N1(e,"utf-8")),errors:[]}}catch(t){let n=t instanceof Error?t.message:String(t);return{errors:[`${e}: ${t instanceof SyntaxError?`Invalid JSON: ${n}`:n}`]}}}function vd(e,t,n){let r=bd(e,n),o=bd(t,n),i=[...new Set([...Object.keys(r),...Object.keys(o)])].flatMap((s)=>r[s]===o[s]?[]:[`  ${s}: ${r[s]??yd} -> ${o[s]??yd}`]);if(i.length===0){console.log("No changes.");return}console.log(`Changes (${i.length}):`);for(let s of i)console.log(s)}function bd(e,t){return{"safety.level":e.safety.level,...Xo("safety.overrides",e.safety.overrides),"workflow.worktree_mode":String(e.workflow.worktree_mode),"destructive_command_protection.enabled":String(e.destructive_command_protection.enabled),...Xo("destructive_command_protection.overrides",e.destructive_command_protection.overrides),"destructive_command_protection.allow_paths":Qo(e.destructive_command_protection.allow_paths),"secret_protection.enabled":String(e.secret_protection.enabled),...Xo("secret_protection.overrides",e.secret_protection.overrides),"secret_protection.deny_paths":Qo(e.secret_protection.deny_paths),"secret_protection.allow_paths":Qo(e.secret_protection.allow_paths),...t?{"audit.retention_days":String(e.audit.retention_days)}:{}}}function Xo(e,t){return Object.fromEntries(Object.entries(t).flatMap(([n,r])=>r===void 0?[]:[[`${e}.${n}`,String(r)]]))}function Qo(e){return e.length===0?"(none)":e.join(", ")}function kd(e){return!!e&&typeof e==="object"&&!Array.isArray(e)}import{join as kh}from"node:path";var xd="# Custom Rules Reference\n\nAgent reference for generating CC Safety Net rulebook configuration.\n\n## Config Locations\n\n| Scope | Config path | Rulebook path | Priority |\n|-------|-------------|---------------|----------|\n| User | `~/.cc-safety-net/rules/rule.json` | `~/.cc-safety-net/rules/<rulebook-name>/rulebook.json` | First |\n| Project | `.cc-safety-net/rules/rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` | Second |\n| GitHub source | Listed in a local `rule.json` | Vendored into the consumer's `<rulebook-name>/rulebook.json` by `rule add` | Source order |\n\nEvery rulebook is a live file: the runtime reads it on each tool call, so an edit applies to the next command with no publishing step.\n\nUser scope is evaluated before project scope; within a scope, sources apply in `rules` array order. A duplicate active rulebook name keeps the first claim and ignores the later rulebook with a warning, so a user-scoped name shadows a project-scoped one.\n\nUse `cc-safety-net rule init` to create an inert local config. Use `--global` for user scope. Use `cc-safety-net rule init --example` to also create an inactive example rulebook. `CC_SAFETY_NET_HOME` overrides the `~/.cc-safety-net` user root.\n\nLegacy inline `.safety-net.json` and `~/.cc-safety-net/config.json` files are not loaded at runtime. Convert them with `cc-safety-net rule migrate`.\n\n## rule.json Schema\n\n```json\n{\n  \"version\": 1,\n  \"rules\": [\"project-rules\", \"owner/repo#main/team-rules\"],\n  \"overrides\": {\n    \"project-rules/block-docker-system-prune\": {\n      \"reason\": \"Use targeted Docker cleanup commands.\"\n    },\n    \"team-rules/block-npm-global\": \"off\"\n  },\n  \"transparent_wrappers\": [\"rtk\"]\n}\n```\n\n- `version`: Required. Must be `1`.\n- `$schema`: Optional. `cc-safety-net rule verify` inserts it into a valid `rule.json` that lacks it.\n- `rules`: Optional array of rulebook source strings. Missing `rules` is treated as `[]`.\n- `overrides`: Optional object keyed by `<rulebook-name>/<rule-name>`.\n- `overrides` values are either `\"off\"` to disable a rule or an object with a required `reason` (replacement block reason) and an optional `intent` (one of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain`).\n- A project override cannot target a user-scoped rule: only that override is ignored, the user rule keeps its configured state, and `rule verify` reports the diagnostic as a failure.\n- `transparent_wrappers`: Optional array of command names that transparently execute a visible child command.\n- Transparent wrappers have no built-in defaults. Configure only wrappers you intentionally trust, such as `\"rtk\"`.\n- Use `cc-safety-net rule wrapper add rtk` to configure RTK without manually editing `rule.json`.\n\n## Rulebook Sources\n\n- Local sources are bare rulebook names such as `project-rules`; the rulebook file is `.cc-safety-net/rules/project-rules/rulebook.json`.\n- Run `cc-safety-net rule add owner/repo` to add every rulebook currently present on the repository's default branch.\n- Use `--only` to select one or more rulebooks while preserving their order: `cc-safety-net rule add owner/repo --only aws gcloud`.\n- Use `--ref` to select a branch, tag, or commit instead of the default branch: `cc-safety-net rule add owner/repo --ref v2 --only aws`.\n- GitHub sources are stored in canonical form as `owner/repo#ref/<rulebook-name>`. That form remains valid in `rule.json` and as direct CLI input.\n- GitHub refs may contain `/`-separated path segments, such as `feature/rulebook-v2`.\n- The GitHub source name, the repository directory name, and the rulebook `name` must match exactly.\n- Rulebook source strings must be unique in a config.\n\n## rulebook.json Schema\n\n```json\n{\n  \"rulebook_version\": 1,\n  \"name\": \"project-rules\",\n  \"version\": \"1.0.0\",\n  \"description\": \"Project-specific CC Safety Net rules.\",\n  \"author\": \"project\",\n  \"allowed_commands\": [\"docker\"],\n  \"rules\": [\n    {\n      \"name\": \"block-docker-system-prune\",\n      \"command\": \"docker\",\n      \"subcommand\": \"system\",\n      \"block_args\": [\"prune\"],\n      \"reason\": \"Use targeted cleanup instead.\"\n    }\n  ],\n  \"tests\": [\n    {\n      \"command\": \"docker system prune\",\n      \"expect\": \"blocked\",\n      \"rule\": \"block-docker-system-prune\"\n    },\n    {\n      \"command\": \"docker ps\",\n      \"expect\": \"allowed\"\n    }\n  ]\n}\n```\n\n### Rulebook Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `rulebook_version` | Yes | Must be `1` or `2` |\n| `name` | Yes | `^[a-zA-Z][a-zA-Z0-9_-]{0,63}$` |\n| `version` | Yes | Non-empty string |\n| `description` | No | Free text; not type-checked at runtime |\n| `author` | No | Free text; not type-checked at runtime |\n| `allowed_commands` | Yes | Unique command names matching `^[a-zA-Z][a-zA-Z0-9_-]*$` |\n| `rules` | Yes | Array of rule objects |\n| `tests` | No | Array of fixtures |\n\n### Rule Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `name` | Yes | Unique within the rulebook (case-insensitive); same pattern as rulebook `name` |\n| `command` | Yes | Must be listed in `allowed_commands`; basename only, not path |\n| `subcommand` | No | Same pattern as `command`; omit to match any subcommand |\n| `intent` | No | One of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain` |\n| `block_args` | Yes | Non-empty array of non-empty strings |\n| `reason` | Yes | Non-empty string, max 256 chars |\n\n### Rule Fields (`rulebook_version` 2)\n\nVersion 2 replaces `subcommand` and `block_args` with an exact-token `match` object. Version 1 rulebooks keep their fields and their behavior; a client that does not support version 2 rejects the rulebook instead of applying broader version 1 semantics.\n\n```json\n{\n  \"name\": \"block-terraform-apply-destroy\",\n  \"command\": \"terraform\",\n  \"match\": {\n    \"command_path\": [\"apply\"],\n    \"any_args\": [\"-destroy\", \"--destroy\"]\n  },\n  \"reason\": \"Review a destroy plan first with 'terraform plan -destroy'.\",\n  \"intent\": \"use_alternative\"\n}\n```\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `name` | Yes | Same as version 1 |\n| `command` | Yes | Same as version 1 |\n| `match.command_path` | Yes | Non-empty array of non-empty command words |\n| `match.any_args` | No | Non-empty array of unique non-empty argument tokens |\n| `match.exclude_args` | No | Non-empty array of unique non-empty argument tokens |\n| `intent` | No | Same as version 1 |\n| `reason` | Yes | Same as version 1 |\n\n### Matching Behavior (`rulebook_version` 2)\n\n- **Command**: Normalized to lowercase basename, as in version 1.\n- **Command path**: After recognized global options and their values are skipped, the next command words must equal `command_path` exactly. AWS, gcloud, and Azure CLI value-taking global options are built in; Terraform's `-chdir=dir` is `=`-joined and is skipped with its own token.\n- **Unrecognized options**: A token starting with `-` that is not a recognized global option is skipped without consuming a value, so an unlisted value-taking option with a separate value (`--newflag value`) makes the rule miss. This fails open deliberately; document such gaps in the rulebook.\n- **`any_args`**: At least one listed token must appear literally among the arguments.\n- **`exclude_args`**: Any listed token appearing literally among the arguments prevents the match, which is how a safe preview such as `aws s3 rm --dryrun` stays allowed.\n- **No short-option expansion**: Arguments compare as exact tokens, so list every accepted spelling (`\"-destroy\"` and `\"--destroy\"`).\n- **Literal and case-sensitive**: No regex, glob, or substring matching. The first matching rule wins.\n- Release channels are separate rules: `gcloud beta compute instances delete` needs its own `command_path`.\n\n### Test Fixture Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `command` | Yes | Non-empty shell command string |\n| `expect` | Yes | `\"blocked\"` or `\"allowed\"` |\n| `rule` | Required for blocked fixtures | Rule name expected to block the command |\n\nFixtures are optional documentation of intended behavior. Version 1 fixtures are shape-validated only. Version 2 fixtures are evaluated against the rulebook's own rules when a source is fetched by `rule add` or `rule update`, and by `rule verify`; a failing fixture rejects that source before it is written. Loading a rulebook does not re-evaluate fixtures. CC Safety Net never executes fixture commands; they are analyzer inputs only.\n\n## Matching Behavior\n\nThe subcommand, argument, and option rules below describe `rulebook_version` 1 rules; version 2 rules match as described in Matching Behavior (`rulebook_version` 2). Execution order and transparent wrappers apply to both.\n\n- **Command**: Normalized to lowercase basename with any trailing `.exe` removed (`/usr/bin/git` → `git`).\n- **Subcommand**: The first command token after recognized Git and Docker global options and their values; `--` ends option parsing. An unrecognized option without `=` may consume the following token as its value.\n- **Arguments**: Each `block_args` value is compared literally against every command token, including expanded short options. The command is blocked if **any** item matches.\n- **Short options**: Expanded (`-Ap` matches `-A`).\n- **Long options**: Exact match (`--all-files` does not match `--all`).\n- **Execution order**: Built-in rules first, then custom rulebooks. Custom rules only add restrictions.\n- **Transparent wrappers**: A configured wrapper such as `rtk` lets `rtk git commit` be analyzed as `git commit` only when `git` is protected by built-in analyzers or active custom rules. `rtk -- git commit` is also supported.\n\n## Workflow\n\n1. Run `cc-safety-net rule init` or create `rule.json` manually.\n2. Optionally run `cc-safety-net rule init --example` to create an inactive example rulebook.\n3. Use `cc-safety-net rule wrapper add rtk` for trusted transparent wrappers.\n4. Run `cc-safety-net rule add <source>` after creating or choosing a rulebook source; add `--only <rulebook...>` or `--ref <ref>` for repository selection. The command adds the selected sources and syncs them.\n5. Edit a local rulebook whenever you like: the edit is enforced on the next command, so there is nothing to run afterwards.\n6. Run `cc-safety-net rule update [source]` to re-fetch remote sources and rewrite the vendored copies; the command prints what changed. A source with an ordinary update failure keeps its vendored copy while the other selected sources still update. Resource-limit failures remain fatal for the whole update.\n7. Run `cc-safety-net rule verify` to validate config, local rulebooks, and shareable GitHub-source rulebook directories in the current repository (it does not fetch remote content).\n8. Run `cc-safety-net rule list` to inspect active rulebooks and transparent wrappers.\n\nA missing or invalid rulebook file makes that source inactive, and an unreadable or invalid `rule.json` makes every source in its scope inactive. Inactive sources stop applying their rules while other custom rules and all built-in protections stay active. Fix the file named in the diagnostic, or run `cc-safety-net rule update` when a remote source has not been vendored yet. Run `cc-safety-net status` to see degraded sources.\n";function nr(e,t){if(!e.ok){Pd(e);return}Ad(e),Rd(e,t)}function Sd(e,t){if(!e.add){nr(e,`Added rulebook source: ${t}`);return}if(!e.ok){Pd(e);return}if(Ad(e),e.add.added.length>0)console.log(`Added ${e.add.added.length} ${e.add.added.length===1?"rulebook":"rulebooks"} from ${e.add.source} at ${e.add.ref}:`),e.add.added.forEach((n)=>{console.log(`  - ${n}`)});if(e.add.alreadyConfigured.length>0)console.log(`Rulebooks already configured from ${e.add.source} at ${e.add.ref}: ${e.add.alreadyConfigured.join(", ")}`);if(e.add.commits.length>0)console.log(`Vendored at ${e.add.commits.map((n)=>n.slice(0,7)).join(", ")}.`);Rd(e,"Rule config synced.")}function Rd(e,t){for(let n of e.changes??[])console.log(n);console.log(t),console.log(""),G1(e.entries)}function G1(e){if(e.length===0){console.log("Active rulebooks: (none)");return}console.log(`Active rulebooks (${e.length}):`);for(let t of e)console.log(`  - ${t.name} ${t.version} (${B1(t.ruleCount)})`),console.log(`    Source: ${t.spec}`)}function B1(e){return`${e} ${e===1?"rule":"rules"}`}function Dd(e){Xe("Active sources",e.rulebooks,(t)=>[`[${t.source}] ${t.name} ${t.version}`,`  Source: ${t.spec}`]),Xe("Active rules",e.rules,(t)=>[`[${q1(e,t.name)}] ${t.name}`,`  Command: ${t.subcommand?`${t.command} ${t.subcommand}`:t.command}`,`  Block args: ${t.block_args.join(", ")}`,`  Reason: ${t.reason}`]),Xe("Disabled rules",Cd(e,"off"),(t)=>[t.key]),Xe("Reason overrides",Cd(e,"reason"),(t)=>[t.key,`  Reason: ${t.value.reason}`]),Xe("Transparent wrappers",e.transparent_wrappers,(t)=>[t]),Xe("Issues",e.errors,(t)=>[t]),Xe("Warnings",e.warnings,(t)=>[t])}function Xe(e,t,n){if(t.length===0){console.log(`${e}: (none)`);return}console.log(`${e} (${t.length}):`);for(let r of t){let[o,...i]=n(r);console.log(`  - ${o}`);for(let s of i)console.log(`    ${s}`)}}function q1(e,t){return e.rulebooks.find((n)=>n.rules.includes(t))?.source??"project"}function Cd(e,t){return Object.entries({...e.userConfig?.overrides??{},...e.projectConfig?.overrides??{}}).filter((n)=>{if(t==="off")return n[1]==="off";return!!n[1]&&typeof n[1]==="object"}).map(([n,r])=>({key:n,value:r}))}function Pd(e){for(let t of e.errors)console.error(t)}function Ad(e){if(!e.warnings||e.warnings.length===0)return;for(let t of e.warnings)console.warn(t)}import{dirname as Ed,join as rr}from"node:path";var V1=".safety-net.json",z1="~/.cc-safety-net/config.json";async function $d(e){return[await Td({legacyPath:_d({cwd:e.cwd}),configPath:re(e.cwd),defaultRulebookName:"project-rules",migratedFrom:V1,cleanup:e.cleanup,syncOptions:{cwd:e.cwd}}),await Td({legacyPath:Dt(),configPath:oe(),defaultRulebookName:"user-rules",migratedFrom:z1,cleanup:e.cleanup,syncOptions:{cwd:e.cwd,global:!0}})].every((n)=>n)?0:1}async function Td(e){let t=U(e.syncOptions),n=x(t.filesystemScope,e.legacyPath),r=w(n);if(r===null)return console.log(`No legacy config found at ${e.legacyPath}`),!0;let o=J1(r);if(!o.ok){for(let g of o.errors)console.error(g);return!1}let i=B(t.configTarget);if(i.errors.length>0){for(let g of i.errors)console.error(g);return!1}let s=i.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},a=W1(Ed(e.configPath),s.rules,e.defaultRulebookName,e.migratedFrom,t.filesystemScope),l=rr(Ed(e.configPath),a,"rulebook.json"),c=x(t.filesystemScope,l),d=[Id(t.configTarget),Id(c)],m=await K1(e,t.configTarget,c,a,o.config.rules,s.rules.includes(a)?s.rules:[...s.rules,a],s.overrides??{},s.transparent_wrappers??[]);if(!m.ok){X1(d);for(let g of m.errors)console.error(g);return!1}if(!e.cleanup)return console.log(`Migrated legacy config at ${e.legacyPath}. Legacy file is no longer used.`),!0;if(!Z1(t.configTarget,c,a,e.migratedFrom,o.config.rules))return console.error(`Migration cleanup verification failed for ${e.legacyPath}`),!1;return me(n),console.log(`Deleted legacy config at ${e.legacyPath}`),!0}async function K1(e,t,n,r,o,i,s,a){try{return K(t,{version:1,rules:i,overrides:s,transparent_wrappers:a}),K(n,Y1(r,e.migratedFrom,o)),await Rt(e.syncOptions)}catch(l){return{ok:!1,errors:[l instanceof Error?l.message:String(l)]}}}function J1(e){try{let t=JSON.parse(e),n=gr(t);if(n.errors.length>0)return{ok:!1,errors:n.errors};return{ok:!0,config:{version:1,rules:t.rules??[]}}}catch{return{ok:!1,errors:["Invalid JSON"]}}}function W1(e,t,n,r,o){let i=t.find((s)=>Q1(x(o,rr(e,s,"rulebook.json")))===r);if(i)return i;if(w(x(o,rr(e,n,"rulebook.json")))===null)return n;for(let s=2;;s++){let a=`${n}-${s}`;if(w(x(o,rr(e,a,"rulebook.json")))===null)return a}}function Y1(e,t,n){return{rulebook_version:1,name:e,version:"1.0.0",description:"Migrated CC Safety Net rules.",author:"project",migrated_from:t,allowed_commands:[...new Set(n.map((r)=>r.command))],rules:n,tests:n.map((r)=>({command:[r.command,r.subcommand,r.block_args[0]].filter(Boolean).join(" "),expect:"blocked",rule:r.name}))}}function Z1(e,t,n,r,o){if(!B(e).config?.rules.includes(n))return!1;try{let s=w(t);if(s===null)return!1;let a=JSON.parse(s);return a.migrated_from===r&&JSON.stringify(a.rules)===JSON.stringify(o)}catch{return!1}}function Id(e){return{target:e,content:w(e)}}function X1(e){for(let t of e){if(t.content===null){me(t.target);continue}ne(t.target,t.content)}}function Q1(e){let t=w(e);if(t===null)return null;try{let n=JSON.parse(t);return typeof n.migrated_from==="string"?n.migrated_from:null}catch{return null}}import{mkdir as eh,readFile as th,writeFile as nh}from"node:fs/promises";import{dirname as rh,join as oh}from"node:path";var ih=86400000,sh=604800000;async function Nd(e=Date.now()){if(process.env.CC_SAFETY_NET_NO_UPDATE_CHECK)return null;let t=$r();if(!t)return null;let n=oh(t,".cc-safety-net","update-check.json"),r=await ah(n,e);if(!r.lastCheck||e-r.lastCheck>ih){let s=await Ae();if(r.lastCheck=e,s.latestVersion)r.latestVersion=s.latestVersion;if(!await Od(n,r))return null;if(s.error)return null}let o=r.latestVersion,i=_();if(!o||!eo(o,i))return null;if(r.notifiedVersion===o&&r.notifiedAt!==void 0&&e-r.notifiedAt<sh)return null;if(r.notifiedVersion=o,r.notifiedAt=e,!await Od(n,r))return null;return`UPDATE_AVAILABLE: cc-safety-net v${o} is available (running v${i}). Ask the user once whether to run \`npx -y cc-safety-net@latest update\`; continue the current task either way and do not raise this again.`}async function ah(e,t){let n=await th(e,"utf8").then((i)=>JSON.parse(i)).catch(()=>{return});if(!n||typeof n!=="object"||Array.isArray(n))return{};let r=n,o=(i)=>typeof i==="number"&&Number.isFinite(i)&&i<=t?i:void 0;return{lastCheck:o(r.lastCheck),latestVersion:typeof r.latestVersion==="string"?r.latestVersion:void 0,notifiedVersion:typeof r.notifiedVersion==="string"?r.notifiedVersion:void 0,notifiedAt:o(r.notifiedAt)}}async function Od(e,t){return eh(rh(e),{recursive:!0,mode:448}).then(()=>nh(e,JSON.stringify(t),{mode:384})).then(()=>!0).catch(()=>!1)}import{join as lh,resolve as ei}from"node:path";var Fd="CC Safety Net Config",ch="═".repeat(Fd.length),dh="https://raw.githubusercontent.com/kenryu42/cc-safety-net/main/assets/cc-safety-net.schema.json",uh=new Set(["rule.json","rule.lock","cache"]);function Hd(e={}){try{return ph(e)}catch(t){if(t instanceof M)return console.error(t.message),1;throw t}}function ph(e){let t=e.cwd??process.cwd(),n=e.userConfigPath??oe(),r=e.projectConfigPath??re(t),o=e.legacyUserConfigPath??Dt(),i=e.legacyProjectConfigPath??xi(t),s=ei(t,wt),a=De({cwd:t,userConfigPath:n,projectConfigPath:r}),l=De({cwd:t}),c=x(a.userScope,n),d=x(a.projectScope,r),m=e.legacyUserConfigPath?Lt(e.legacyUserConfigPath,"user policy"):x(l.userScope,o),g=e.legacyProjectConfigPath?Lt(e.legacyProjectConfigPath,"project policy"):x(l.projectScope,i),u=!1,p=!1,f=[],b=[],L=fh(x(l.projectScope,s));if(gh(),w(c)!==null){let h=pe(c);if(h.errors.push(...J(n,a.userScope)),f.push({scope:"User",path:n,result:h,schema:"rules",target:c}),h.errors.length>0)u=!0}if(w(m)!==null)if(p=!0,w(c)!==null)b.push(or("user","cleanup"));else{let h=hr(m);if(f.push({scope:"User",path:o,result:h,schema:"legacy",inactive:!0,target:m}),b.push(or("user",h.errors.length>0?"fix-or-delete":"migrate")),h.errors.length>0)u=!0}if(w(d)!==null){let h=pe(d);if(h.errors.push(...J(r,a.projectScope)),f.push({scope:"Project",path:ei(r),result:h,schema:"rules",target:d}),h.errors.length>0)u=!0;if(w(g)!==null)p=!0,b.push(or("project","cleanup"))}else if(w(g)!==null){p=!0,u=!0;let h=hr(g);f.push({scope:"Project",path:ei(i),result:h,schema:"legacy",inactive:!0,target:g}),b.push(or("project",h.errors.length>0?"fix-or-delete":"migrate"))}if(L?.result.errors.length)u=!0;if(f.length===0&&!L)return console.log(`
No config files found. Using built-in rules only.`),0;for(let h of f)if(h.inactive)yh(h.scope,h.path,h.result);else if(h.result.errors.length>0)vh(h.scope,h.path,h.result.errors);else{if(h.schema==="rules"&&wh(h.target))console.log(`
Added $schema to ${h.scope.toLowerCase()} config.`);hh(h.scope,h.path,h.result,h.schema)}for(let h of b)console.error(`
${y.red(h)}`);if(L)if(L.result.errors.length>0)Lh(L.path,L.result.errors);else bh(L.path,L.result);if(u)return console.error(`
Config validation failed.`),1;return console.log(p?`
Configs valid with warnings.`:`
All configs valid.`),0}function or(e,t){let n=`legacy ${e} config`;if(t==="cleanup")return`Warning: Legacy ${e} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${e} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${e} config is no longer supported. Fix or delete the ${n}, then run \`npx -y cc-safety-net rule migrate\`.`}function fh(e){if(tt(e)===null)return null;let t=mh(e);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:e.path,result:t}}function mh(e){let t=[],n=new Set,r=(tt(e)??[]).filter((o)=>!uh.has(o.name)).sort((o,i)=>o.name.localeCompare(i.name));if(r.length===0)return{errors:t,ruleNames:n};for(let o of r){if(!Se.test(o.name)){t.push(`rulebook directory names must match ${Se}: ${o.name}`);continue}if(o.kind!=="directory"){t.push(`${o.name} must be a rulebook directory`);continue}let i=x(e.scope,lh(e.path,o.name,"rulebook.json")),s=w(i);if(s===null){t.push(`${o.name}/rulebook.json is required`);continue}try{let a;try{a=JSON.parse(s)}catch{t.push(`${o.name}/rulebook.json: invalid JSON`);continue}let l=kt(a);if(l.name!==o.name){t.push(`rulebook name "${l.name}" must match folder "${o.name}"`);continue}let c=on(l);if(c.length>0){t.push(...c.map((d)=>`${o.name}/rulebook.json: ${d}`));continue}n.add(o.name)}catch(a){t.push(a instanceof Error?`${o.name}/rulebook.json: ${a.message}`:`${o.name}/rulebook.json: ${String(a)}`)}}return{errors:t,ruleNames:n}}function gh(){console.log(Fd),console.log(ch)}function hh(e,t,n,r){if(console.log(`
✓ ${e} config: ${t}`),console.log(`  Schema: ${r==="rules"?"rulebook sources":"legacy inline rules"}`),n.ruleNames.size>0){console.log(`  ${r==="rules"?"Sources":"Rules"}:`);let o=1;for(let i of n.ruleNames)console.log(`    ${o}. ${i}`),o++}else console.log(`  ${r==="rules"?"Sources":"Rules"}: (none)`)}function yh(e,t,n){if(console.error(`
✗ Legacy ${e.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),n.errors.length>0){console.error("  Errors:");let r=1;for(let o of n.errors)for(let i of o.split("; "))console.error(`    ${r}. ${i}`),r++;return}if(n.ruleNames.size>0){console.error("  Rules:");let r=1;for(let o of n.ruleNames)console.error(`    ${r}. ${o}`),r++;return}console.error("  Rules: (none)")}function vh(e,t,n){Md(`${e} config`,t,n)}function bh(e,t){console.log(`
✓ GitHub source rules: ${e}`),console.log("  Rulebooks:");let n=1;for(let r of t.ruleNames)console.log(`    ${n}. ${r}`),n++}function Lh(e,t){Md("GitHub source rules",e,t)}function Md(e,t,n){console.error(`
✗ ${e}: ${t}`),console.error("  Errors:");let r=1;for(let o of n)for(let i of o.split("; "))console.error(`    ${r}. ${i}`),r++}function wh(e){try{let t=w(e);if(t===null)return!1;let n=JSON.parse(t);if(n.$schema)return!1;return ne(e,JSON.stringify({$schema:dh,...n},null,2)),!0}catch(t){if(t instanceof M)throw t;return!1}}var jd=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),xh=new Set(["add","remove","list"]);async function Ud(e){try{return await Ch(e)}catch(t){if(t instanceof M)return console.error(t.message),1;throw t}}async function Ch(e){let t=Rh(e),n=t.help?Sh(t.positionals):null;if(n)return mt(n),0;if(t.errors.length>0){for(let s of t.errors)console.error(s);return 1}let r=t.positionals[0];if(!r)return mt(st,console.error),1;let o=t.positionals[1],i={global:t.global};if(r==="init"){let s=U(i);Eh(s.configTarget);let a=kh(s.configDir,"example-rules","rulebook.json"),l=x(s.filesystemScope,a);if(t.example&&w(l)===null)_r(l,"example-rules");let c=J(s.configPath,s.filesystemScope);for(let d of c)console.error(d);if(c.length>0)return 1;return console.log("Rule config initialized."),0}if(r==="add"){if(!o)return console.error("rule add requires a source"),1;let s=await Ar(o,{...i,ref:t.ref,rulebooks:t.only.length>0?t.only:void 0});return Sd(s,o),s.ok?0:1}if(r==="remove"){if(!o)return console.error("rule remove requires a source"),1;let s=await Tr(o,{...i,deleteSource:t.deleteSource});return nr(s,`Removed rulebook source: ${o}`),s.ok?0:1}if(r==="update"){let s=await Rt({...i,only:o,refresh:!0});return nr(s,"Rule config synced."),s.ok?0:1}if(r==="sync")return Ta({global:t.global});if(r==="list"){let s=Re();return Dd(s),s.errors.length>0?1:0}if(r==="wrapper")return Th(t);if(r==="migrate")return $d({cleanup:t.cleanup,cwd:process.cwd()});if(r==="doc"){console.log(xd);let s=await Nd();if(s)console.error(s);return 0}if(r==="verify")return Hd();return 1}function Sh(e){if(e.length===0)return st;let t=st.subcommands.filter((r)=>r.usage.split(" ")[0]===e[0]);if(t.length===0)return null;if(e.length===1&&t.length>1)return{name:`rule ${e[0]}`,description:`Subcommands of rule ${e[0]}`,usage:`rule ${e[0]} <subcommand>`,subcommands:t,options:[]};let n=e.length===1?t[0]:t.find((r)=>r.usage.split(" ")[1]===e[1]);if(!n)return null;return{name:`rule ${e[0]}`,description:n.description,usage:`rule ${n.usage}`,options:e[0]==="add"?Jr:[],examples:e[0]==="add"?Wr:void 0}}function Rh(e){let t=E({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},values:{ref:["--ref"]},lists:{only:["--only"]},positionals:"list"},e),n={...t.flags,ref:t.values.ref,only:t.lists.only??[],help:t.help,positionals:t.positionals,errors:t.errors};return Dh(n),n}function Dh(e){let[t]=e.positionals;if(t&&!jd.has(t))e.errors.push(`Unknown rule subcommand: ${t}`);if(e.deleteSource&&t!=="remove")if(t&&jd.has(t))e.errors.push(`Unknown option for rule ${t}: --delete-source`);else e.errors.push("--delete-source is only valid with 'rule remove'");if(e.check&&t)e.errors.push(bt(t,"--check"));if(e.cleanup&&t!=="migrate")e.errors.push(bt(t,"--cleanup"));if(e.example&&t!=="init")e.errors.push(bt(t,"--example"));if(e.ref&&t!=="add")e.errors.push(bt(t,"--ref"));if(e.only.length>0&&t!=="add")e.errors.push(bt(t,"--only"));if(t==="add")Ph(e);if(t==="migrate"){if(e.global)e.errors.push(bt(t,"--global"));if(e.positionals.length>1)e.errors.push(`Unexpected rule migrate argument: ${e.positionals[1]}`)}else if(t==="wrapper")Ah(e);else if(e.positionals.length>2)e.errors.push(`Unexpected rule argument: ${e.positionals[2]}`);if(t==="list"&&e.global)e.errors.push("Unknown option for rule list: --global")}function Ph(e){let t=e.positionals[1];if(!t&&e.only.length>0){e.errors.push("rule add requires owner/repo before --only");return}if(!t)return;if((e.ref||e.only.length>0)&&!xe(t)){if(e.ref)e.errors.push(`--ref can only select a ref for an owner/repo source: ${t}`);if(e.only.length>0)e.errors.push("--only can only select rulebooks from an owner/repo source");return}if(e.ref&&!Oe(e.ref))e.errors.push(`--ref must use valid path segments: ${e.ref}`);let n=e.only.filter((r)=>!Se.test(r));if(n.length>0)e.errors.push(`Invalid rulebook names: ${n.join(", ")}`)}function bt(e,t){return e?`Unknown option for rule ${e}: ${t}`:`Unknown option for rule: ${t}`}function Ah(e){let t=e.positionals[1],n=e.positionals[2];if(!t){e.errors.push("rule wrapper requires add, remove, or list");return}if(!xh.has(t)){e.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(n)e.errors.push(`Unexpected rule wrapper argument: ${n}`);return}if(!n){e.errors.push(`rule wrapper ${t} requires a command`);return}if(e.positionals.length>3)e.errors.push(`Unexpected rule wrapper argument: ${e.positionals[3]}`)}function Eh(e){if(w(e)===null){Ir(e);return}let t=B(e);if(!t.config)return;K(e,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function Th(e){let t=e.positionals[1],n=e.positionals[2],r=U({global:e.global}).configTarget;if(t==="list"){let a=B(r);if(a.errors.length>0){for(let l of a.errors)console.error(l);return 1}return Ih(a.config?.transparent_wrappers??[]),0}if(!n||!Or.test(n))return console.error("transparent wrapper must match command pattern"),1;if(Fr(n))return console.error(`reserved command "${n}" cannot be a wrapper`),1;let o=B(r);if(o.errors.length>0){for(let a of o.errors)console.error(a);return 1}let i=o.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},s=t==="add"?[...new Set([...i.transparent_wrappers??[],n])]:(i.transparent_wrappers??[]).filter((a)=>a!==n);return K(r,{version:1,rules:i.rules,overrides:i.overrides??{},transparent_wrappers:s}),console.log(t==="add"?`Added transparent wrapper: ${n}`:`Removed transparent wrapper: ${n}`),0}function Ih(e){if(e.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${e.length}):`);for(let t of e)console.log(`  - ${t}`)}import{homedir as ri}from"node:os";import{sep as Mh}from"node:path";import{existsSync as _h,readFileSync as $h}from"node:fs";import{homedir as Oh}from"node:os";import{join as Nh}from"node:path";async function Fh(e){if(e.isTTY)return null;return(await Br(e).catch(()=>null))?.trim()||null}function Hh(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return Nh(Oh(),".claude","settings.json")}function ti(){let e=Hh();if(!_h(e))return!1;try{let t=$h(e,"utf-8"),n=JSON.parse(t);if(!n.enabledPlugins)return!1;let r="cc-safety-net@cc-marketplace";if(!(r in n.enabledPlugins))return!1;return n.enabledPlugins[r]===!0}catch(t){if(Et(C.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${e}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function ni(e=process.stdin){let t=ti(),n;if(!t)n="\uD83D\uDEE1️ CC Safety Net ❌";else{let o=V({cwd:process.cwd()}),i=o.policy,s=ge(i),a=Object.values(Me(i,s.capabilities)).some((d)=>d.changesInherited),l={standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[a?"custom":s.effectiveLevel],c=(o.policyScopes?.weakenings.length??0)>0?"\uD83D\uDD3B":"";n=`\uD83D\uDEE1️ CC Safety Net ${l}${s.worktreeMode?"\uD83C\uDF33":""}${c}${o.state==="degraded"?"⚠️":""}`}let r=await Fh(e);if(r&&!r.startsWith("{"))console.log(`${r} | ${n}`);else console.log(n)}function Gd(){let e=V({cwd:process.cwd()}),t=e.policy,n=ge(t),r=!!process.env.NO_COLOR||!process.stdout.isTTY,o=Math.min(process.stdout.columns||80,100),i=r?"ok":"✔",s=r?"OFF":"✘",a=(p,f)=>{let b=`  ${p.padEnd(13)}${f}`;return(b.length>o?`${b.slice(0,o-1)}…`:b).replaceAll(s,y.red(s))},l=Object.values(Me(t,n.capabilities)).some((p)=>p.changesInherited),c=(p)=>p===ri()||p.startsWith(`${ri()}${Mh}`)?`~${p.slice(ri().length)}`:p,d={ready:y.green,degraded:y.yellow}[e.state],m=e.policyScopes?.weakenings??[],g=[...ti()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...e.diagnostics],u=r?"-":"·";console.log([`${r?"":"\uD83D\uDEE1️  "}CC Safety Net — ${d(e.state)}`,"",a("Protection",`destructive ${t.destructiveCommandProtectionEnabled?i:s}   secrets ${t.secretProtection.enabled?i:s}`),a("Level",l?`${n.effectiveLevel} (customised)`:n.effectiveLevel),a("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),a("Policy",c(Pe())),...e.policyScopes?[a("Project",c(Ne()))]:[],...n.worktreeMode?[a("Worktree","relaxations active")]:[],"",...m.length===0?[]:["  Project policy",...m.flatMap((p)=>Wt(p,"      ",o-6).map((f,b)=>b===0?`    ${f}`:f)),""],...g.length===0?["  Everything configured is active."]:["  Not active",...g.flatMap((p)=>Wt(p,"      ",o-6).map((f,b)=>b===0?`    ${u} ${f}`:f)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as au}from"node:child_process";import{randomBytes as Yh}from"node:crypto";import{createServer as Zh}from"node:http";import{Writable as Xh}from"node:stream";import{homedir as jh}from"node:os";var ir=500;function Uh(e){let t=e.filter((o)=>o.decision!=="allow"),n=e.filter((o)=>o.decision==="allow"),r=Math.min(t.length,Math.max(ir-n.length,Math.ceil(ir/2)));return[...t.slice(0,r),...n.slice(0,ir-r)]}function Bd(e,t=he()){if(t)Fe(t);let n=(f)=>new Date(f.getFullYear(),f.getMonth(),f.getDate()).getTime(),r=n(new Date),o=new Date(r);o.setDate(o.getDate()-(e-1));let i=o.getTime(),s=[],a={count:0};for(let f of t?ke(t,a):[])for(let b of _e(f,a)){if(!b||typeof b.ts!=="string"||typeof b.command!=="string")continue;let L=new Date(b.ts).getTime();if(!Number.isFinite(L))continue;if(L>=i)s.push(b)}s.sort((f,b)=>new Date(b.ts).getTime()-new Date(f.ts).getTime());let l=Array.from({length:e},()=>0),c=Array.from({length:e},()=>0),d={},m={},g={},u=0,p=0;for(let f of s){let b=f.agent||"unknown";d[b]=(d[b]??0)+1;let L=Math.round((r-n(new Date(f.ts)))/86400000),h=e-1-L,S=L>=0&&L<e;if(S)c[h]=(c[h]??0)+1;if(f.decision!=="allow"){if(u++,f.ruleId)m[f.ruleId]=(m[f.ruleId]??0)+1;let v=Qe(f.segment||f.command);if(v)g[v]=(g[v]??0)+1;if(f.failureStage)p++;if(S)l[h]=(l[h]??0)+1}}return{days:e,logsDir:t,homeDir:jh(),totalInWindow:s.length,truncated:s.length>ir,unreadable:a.count,counts:{blocked:u,allowed:s.length-u,agents:d,blockedByDay:l,analyzedByDay:c,rules:m,commands:g,errors:p},entries:Uh(s).sort((f,b)=>new Date(b.ts).getTime()-new Date(f.ts).getTime())}}import{spawn as Gh}from"node:child_process";import{existsSync as Bh,statSync as qd}from"node:fs";import{delimiter as qh,join as Vh}from"node:path";var zh=120000,sr="Choose the project folder",Kh=`try
  return POSIX path of (choose folder with prompt "${sr}")
on error number -128
  return ""
end try`,Jh=`Add-Type -AssemblyName System.Windows.Forms
$dialog = New-Object System.Windows.Forms.FolderBrowserDialog
$dialog.Description = '${sr}'
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,Vd=[{binary:"zenity",args:["--file-selection","--directory",`--title=${sr}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",sr]}],zd=(e,t)=>(t.PATH??"").split(qh).some((n)=>{if(n.length===0)return!1;try{let r=qd(Vh(n,e));return r.isFile()&&(r.mode&73)!==0}catch{return!1}});function Kd(e,t){if(e==="darwin"||e==="win32")return!0;if(e!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return Vd.some((n)=>zd(n.binary,t))}function Wh(e,t){if(e==="darwin")return{cmd:"osascript",args:["-e",Kh]};if(e==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",Jh]};let n=Vd.find((r)=>zd(r.binary,t));return n?{cmd:n.binary,args:n.args}:null}function Jd(e=process.platform,t=process.env){let n=Wh(e,t);if(!n)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let o=Gh(n.cmd,n.args,{env:t,stdio:["ignore","pipe","pipe"]}),i="",s=!1,a=(c)=>{if(s)return;s=!0,clearTimeout(l),r(c)},l=setTimeout(()=>{o.kill(),a({error:"The folder dialog timed out"})},zh);o.stdout.on("data",(c)=>{i+=c.toString()}),o.on("error",()=>a({error:`Could not open the folder dialog (${n.cmd})`})),o.on("close",()=>{let c=i.trim().replace(/\/+$/,"");if(!c)return a({cancelled:!0});if(!Bh(c)||!qd(c).isDirectory())return a({error:"That selection is not a folder on disk"});a({path:c})})})}var Wd=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var Yd='<script id="ccsn-data" type="application/json">';function Zd(e){return Wd.replace(Yd,()=>Yd+JSON.stringify({token:e}).replaceAll("<","\\u003c"))}var lr="kenryu42/cc-safety-net",Qh=`https://github.com/${lr}`,ii=1e4,e0=7;async function lu(e,t={}){let n=E({label:"gui",booleans:{noOpen:["--no-open"]}},e),r=t.log??console.log,o=t.error??console.error;if(n.errors.length>0){for(let s of n.errors)o(s);return o("Usage: cc-safety-net gui [--no-open]"),1}let i=await t0(t);if(r(`CC Safety Net policy GUI: ${i.url}`),!n.flags.noOpen)try{await(t.openBrowser??d0)(i.url)}catch(s){o(`Failed to open browser: ${s instanceof Error?s.message:String(s)}`),o(`Open this URL manually: ${i.url}`)}if(t.keepAlive===!1)return await i.close(),0;return await c0(i),0}async function t0(e={}){let t=Yh(24).toString("base64url"),n=Zh((i,s)=>{n0(i,s,t,e)});await new Promise((i,s)=>{n.once("error",s),n.listen(0,"127.0.0.1",()=>{n.off("error",s),i()})});let o=`http://127.0.0.1:${n.address().port}`;return{origin:o,token:t,url:`${o}/?token=${encodeURIComponent(t)}`,close:()=>l0(n)}}async function n0(e,t,n,r){let o=new URL(e.url??"/","http://127.0.0.1");if(e.method==="GET"&&o.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!i0(e,o,n)){D(t,403,{error:"Forbidden"});return}if(e.method==="GET"&&o.pathname==="/"){a0(t,Zd(n));return}if(e.method==="GET"&&o.pathname==="/api/policy"){let i=tu(r),s=V(r);D(t,200,{...i,configState:It(s),...s.policyScopes?{projectPolicy:{path:Ne(r.cwd),weakenings:s.policyScopes.weakenings}}:{},destructiveCommandRules:Pt,secretPatterns:Qd,version:_(),preview:i.errors.length>0?null:ru(i.policy)});return}if(e.method==="POST"&&o.pathname==="/api/policy/preview"){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=nu(i.value);D(t,s.errors.length>0?400:200,s);return}if(e.method==="POST"&&o.pathname==="/api/policy/explain"){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=i.value;if(s===null||typeof s.command!=="string"){D(t,400,{errors:["command must be a string"]});return}let a=Tt(s.policy);if(a.length>0){D(t,400,{errors:a});return}D(t,200,r0(s.command,s.policy,r));return}if(e.method==="POST"&&o.pathname==="/api/policy"){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=tn(i.value,r);D(t,s.errors.length>0?400:200,s);return}if(e.method==="POST"&&o.pathname==="/api/reset"){D(t,200,tn(eu,r));return}if(e.method==="POST"&&o.pathname==="/api/repair"){D(t,200,ou(r));return}if(e.method==="GET"&&o.pathname==="/api/activity"){let i=ot(r),s=o0(o.searchParams.get("days"),i);if(s===null){D(t,400,{error:`days must be an integer between 1 and ${i}`});return}D(t,200,Bd(s,r.activityLogsDir));return}if(e.method==="POST"&&o.pathname==="/api/rules/choose-directory"){D(t,200,await Jd());return}if(e.method==="GET"&&o.pathname==="/api/rules"){let i=Re(r),s=new Map(i.rules.map((a)=>[a.name,a]));D(t,200,{projectPath:r.cwd??process.cwd(),canPickDirectory:Kd(process.platform,process.env),rulebooks:i.rulebooks.map((a)=>({source:a.source,spec:a.spec,name:a.name,version:a.version,rules:a.rules.flatMap((l)=>{let c=s.get(l);if(!c)return[];return[{name:c.name,command:c.command,subcommand:c.subcommand,block_args:c.block_args,reason:c.reason}]})})),errors:i.errors,warnings:i.warnings});return}if(e.method==="GET"&&o.pathname==="/api/star/context"){D(t,200,await(r.fetchStarContext??(()=>g0({logsDir:r.activityLogsDir})))());return}if(e.method==="POST"&&o.pathname==="/api/star"){let i=await(r.starRepo??u0)();D(t,200,i.ok?{ok:!0}:{ok:!1,fallbackUrl:Qh});return}if(e.method==="GET"&&o.pathname==="/api/integrations"){D(t,200,await(r.fetchIntegrations??p0)());return}if(e.method==="GET"&&o.pathname==="/api/health"){D(t,200,await(r.fetchHealth??f0)());return}if(e.method==="POST"&&(o.pathname==="/api/install"||o.pathname==="/api/uninstall")){let i=await ar(e);if(!i.ok){D(t,i.status,{errors:[i.error]});return}let s=i.value?.target;if(typeof s!=="string"||!de.some((l)=>l.target===s)){D(t,400,{error:"unknown target"});return}let a=o.pathname==="/api/install"?"install":"uninstall";D(t,200,await(r.runIntegration??m0)(a,s));return}D(t,404,{error:"Not found"})}function r0(e,t,n){let r=we(t),o=V(n),i=At({rules:o.policy.rules,transparentWrappers:o.policy.transparentWrappers,safety:su(r.safety),worktreeMode:r.workflow.worktree_mode,destructiveCommandProtectionEnabled:r.destructive_command_protection.enabled,destructiveCommandRuleOverrides:r.destructive_command_protection.overrides,destructiveCommandAllowPaths:r.destructive_command_protection.allow_paths,secretProtection:{enabled:r.secret_protection.enabled,disabledRules:iu(r.secret_protection.overrides),denyPaths:r.secret_protection.deny_paths,allowPaths:r.secret_protection.allow_paths}});return rt(e,{policySnapshot:i,cwd:n.cwd,userConfigDir:n.userConfigDir})}function o0(e,t){if(e===null)return Math.min(e0,t);let n=Number(e);if(!Number.isInteger(n)||n<1||n>t)return null;return n}function i0(e,t,n){if(t.searchParams.get("token")!==n)return!1;if(e.method!=="POST")return!0;return e.headers["x-cc-safety-net-token"]===n}var s0=1048576;async function ar(e){let t=[],n=0;for await(let r of e){let o=r;if(n+=o.byteLength,n>s0)return{ok:!1,status:413,error:"Request body is too large"};t.push(o)}try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(r){return{ok:!1,status:400,error:`Invalid JSON: ${r instanceof Error?r.message:String(r)}`}}}function a0(e,t){e.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),e.end(t)}function D(e,t,n){e.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),e.end(JSON.stringify(n))}function l0(e){return new Promise((t,n)=>{e.close((r)=>r?n(r):t())})}function c0(e){return new Promise((t)=>{let n=()=>{process.off("SIGINT",r),process.off("SIGTERM",r)},r=()=>{n(),e.close().then(t)};process.once("SIGINT",r),process.once("SIGTERM",r)})}function d0(e){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",n=process.platform==="win32"?["/c","start","",e]:[e];return new Promise((r,o)=>{let i=au(t,n,{detached:!0,stdio:"ignore"}),s=(l)=>{i.off("spawn",a),o(l)},a=()=>{i.off("error",s),i.unref(),r()};i.once("error",s),i.once("spawn",a)})}async function u0(e="gh",t=ii){return{ok:await oi(e,["api","-X","PUT",`/user/starred/${lr}`],t)===0}}async function p0(e={}){let t=await Ft(e.fetcher),n=cu(t,e.homeDir);return{targets:Y.map((r)=>{let o=n.find((i)=>i.platform===r.id);return{target:r.id,label:P(r.id),version:t.versions[r.id]??null,status:o?.configured?"active":o?.detected?"disabled":o?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function cu(e,t){return ft(process.cwd(),{homeDir:t,ampPluginListOutput:e.ampPluginListOutput,codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.versions["copilot-cli"]})}async function f0(e={}){let[t,n]=await Promise.all([Ft(e.fetcher),(e.checkUpdates??Ae)()]);return{hooks:cu(t,e.homeDir).filter((r)=>r.detected).map((r)=>({platform:r.platform,label:P(r.platform),configured:r.configured})),update:{currentVersion:n.currentVersion,latestVersion:n.latestVersion??null,updateAvailable:n.updateAvailable}}}var Xd=Promise.resolve();function m0(e,t,n={}){let r=async()=>{let i=[],s=console.log,a=console.error;console.log=(...l)=>i.push(l.map(String).join(" ")),console.error=console.log;try{return{ok:await en(e,[],{selectTargets:async()=>[t],output:new Xh({write(c,d,m){i.push(String(c).replace(/\n$/,"")),m()}}),...n})===0,output:i.join(`
`)}}finally{console.log=s,console.error=a}},o=Xd.then(r);return Xd=o.then(()=>{return},()=>{return}),o}async function g0(e={}){let[t,n,r]=await Promise.all([h0(e.command),y0(e.fetchRepo),Promise.resolve(bn(ot(),e.logsDir).totalBlocked)]);return{starred:t,starCount:n,blockedTotal:r}}async function h0(e="gh",t=ii){if(await oi(e,["auth","status"],t)!==0)return null;let n=await oi(e,["api",`/user/starred/${lr}`],t);if(n===0)return!0;if(n===null)return null;return!1}function oi(e,t,n){return new Promise((r)=>{let o=au(e,t,{stdio:"ignore",windowsHide:!0}),i=!1,s,a=(l)=>{if(i)return;if(i=!0,s)clearTimeout(s);r(l)};o.once("error",()=>a(null)),o.once("close",a),s=setTimeout(()=>{o.kill(),a(null)},n)})}async function y0(e=fetch){try{let t=await e(`https://api.github.com/repos/${lr}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(ii)});if(!t.ok)return null;let n=await t.json();return typeof n.stargazers_count==="number"?n.stargazers_count:null}catch{return null}}function v0(e){if(e[0]!=="help")return!1;let t=e[1];if(!t)Fo(),process.exit(0);if(Yt(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var b0={hook:async(e)=>{let t=qs(e);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),Yt("hook",console.error),process.exit(1)},install:async(e)=>{process.exit(await en("install",e))},update:async(e)=>{process.exit(await Zo(e))},uninstall:async(e)=>{process.exit(await en("uninstall",e))},rule:async(e)=>{process.exit(await Ud(e))},policy:async(e)=>{process.exit(await wd(e))},status:async(e)=>{if(ue(E({label:"status"},e).errors))process.exit(1);Gd()},statusline:async(e)=>{let t=E({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},e);if(t.errors.length===0&&t.flags.claudeCode){await ni();return}if(ue(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");Yt("statusline",console.error),process.exit(1)},doctor:async(e)=>{let t=Io(e);if(!t)process.exit(1);let n=await lc({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(n)},logs:async(e)=>{process.exit(await ps(e))},gui:async(e)=>{process.exit(await lu(e))},explain:async(e)=>{process.exit(await gc(e))}};async function L0(){let e=process.argv.slice(2),t=E({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},e);if(v0(e))return;let n=e[0],r=n?vn(n):void 0;if(t.help&&r&&r.name!=="rule")Yt(r.name),process.exit(0);if(!n||t.help&&!r)Fo(),process.exit(0);if(t.flags.version)vc(),process.exit(0);if(r){await b0[r.name](e.slice(1));return}let o=Vs(n);if(o){await o.run();return}if(n==="--statusline"){await ni();return}console.error(n.startsWith("-")?`Unknown option: ${n}`:`Unknown command: ${n}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}L0().catch((e)=>{console.error("CC Safety Net error:",e),process.exit(1)});
