...
`)}function Dn(e){return Ve({rows:e})}function wa(e){let t=[];return t.push("System Info"),t.push(Q2(e)),t.join(`
`)}function Q2(e){let t=["Component","Version"],n=(i)=>{if(i===null)return y.dim("not found");return i},o=[{label:"cc-safety-net",value:e.version},...wn.map((i)=>({label:P(i),value:e.versions[i]??null})),{label:"Node.js",value:e.nodeVersion},{label:"npm",value:e.npmVersion},{label:"Bun",value:e.bunVersion},{label:"Platform",value:e.platform}].map((i)=>[i.label,n(i.value)]);return Ve({headers:t,rows:o})}function ka(e){if(e.findings.length===0)return y.green(`
...
`.repeat(d.length-1)}${uf(d.length-1)}`:""}\x1B7`);try{for(let f=1;f<=u;f+=1){if(t.signal?.aborted)break;n.write(Ea(d.map((b,L)=>bf(b,L,f,u,m,o,i,a)))),await ff(p,r,t.signal)}}finally{if(n.write(Ea(d.map((f,b)=>vf(f,b,o,i,a)))),n.write("\x1B8"),d.length>1)n.write(_a(d.length-1));n.write(`
\x1B[0m\x1B[?25h`)}}var $a=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function Lf(e){return Boolean(e.isTTY)}async function zt(e={}){let t=e.output??process.stdout;if(!Lf(t))return;let n=e.input??process.stdin,r={duration:e.duration,frequency:e.frequency,output:t,seed:e.seed??Math.random()*8192,sleep:e.sleep,speed:e.speed,spread:e.spread};if(!n.isTTY||typeof n.setRawMode!=="function"){await lo($a,r);return}let o=new AbortController,i=n.readableFlowing===!0,s=n.isRaw===!0,a=!1,l=(c,d)=>{if(d.ctrl&&d.name==="c")a=!0;if(a||d.name==="return"||d.name==="enter")o.abort()};Oa.emitKeypressEvents(n),n.on("keypress",l),n.setRawMode(!0),n.resume();try{await lo($a,{...r,signal:o.signal})}finally{if(n.off("keypress",l),n.setRawMode(s),!i)n.pause()}if(!a)return;if(e.onInterrupt){e.onInterrupt();return}process.kill(process.pid,"SIGINT")}import{createHash as wf}from"node:crypto";import{existsSync as Fa}from"node:fs";import{dirname as En,join as Na}from"node:path";var kf="`cc-safety-net rule sync` is deprecated: rulebooks are live files that need no synchronization. This run only migrates the lock and cache an earlier version left behind.",xf="cache",Cf="rulebooks";function Ha(e={}){let t=U(e),n=x(t.filesystemScope,Ua(t.configDir)),r=w(t.lockTarget);if(console.log(kf),r===null&&!Fa(n.path))return console.log(`No v2 lock or cache leftovers found in ${En(t.configDir)}; nothing to migrate.`),0;let o=Af(r),i=q(t.configTarget);if(!i.config&&(w(t.configTarget)!==null||o.size>0))return console.error(`Cannot migrate: the rules config in ${En(t.configDir)} is missing or unreadable while v2 leftovers remain. Restore rule.json, then re-run rule sync.`),1;let s=i.config?.rules??[];for(let a of s.flatMap((l)=>Sf(l,o,t,n,e.global===!0)))console.log(a);return he(t.lockTarget),ja(n),console.log(`Removed the v2 lock and cache under ${En(t.configDir)}.`),0}function Ma(e){return[...new Set([{cwd:e},{cwd:e,global:!0}].flatMap((t)=>{let n=U(t);return[n.lockPath,Ua(n.configDir)]}))].filter((t)=>Fa(t))}function Sf(e,t,n,r,o){if(!re(e))return[];let i=Fe(e).name,s=x(n.filesystemScope,Re(n.configDir,i)),a=w(s);if(a!==null&&Rf(a,i))return[];let l=t.get(e),c=l?Df(l,i,r.path,n.filesystemScope):null;if(c===null)return[`Could not migrate ${e} from the v2 cache. Run \`cc-safety-net rule update ${e}${o?" --global":""}\` to vendor it.`];if(B(s,c),a!==null)return[`Restored ${e} from the v2 cache over an invalid file.`];return[`Vendored ${e} from the v2 cache.`]}function Rf(e,t){let n=_t(e);return!("problem"in n)&&n.rulebook.name===t}function Df(e,t,n,r){let o=Na(n,Cf,`${Pf(e)}--${e.digest.replace("sha256:","").slice(0,12)}`,yn),i=w(x(r,o));if(i===null||Tf(i)!==e.digest)return null;let s=_t(i);if("problem"in s||s.rulebook.name!==t)return null;return i}function Ua(e){return Na(En(e),xf)}function Pf(e){return([e.owner,e.repo,e.display_ref,e.name].every((r)=>typeof r==="string"&&r!=="")?`${e.owner}/${e.repo}#${e.display_ref}/${e.name}`:e.spec).toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"rulebook"}function Af(e){let t=e===null?null:_f(e),n=Ga(t)&&Array.isArray(t.rulebooks)?t.rulebooks:[];return new Map(n.filter(Ef).map((r)=>[r.spec,r]))}function Ef(e){return Ga(e)&&typeof e.spec==="string"&&typeof e.digest==="string"}function Ga(e){return!!e&&typeof e==="object"}function _f(e){try{return JSON.parse(e)}catch{return null}}function Tf(e){return`sha256:${wf("sha256").update(e).digest("hex")}`}var Ba="\r\x1B[2K",If="\x1B[?25l",$f="\x1B[39m",Of="\x1B[?25h",jf=100,Ff=0.55,Nf=80,qa=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function Hf(e){return new Promise((t)=>setTimeout(t,e))}async function _n(e,t={}){let n=t.output??process.stdout;if(!n.isTTY)return e;let r=t.sleep??Hf,o=!1,i=e.then((a)=>(o=!0,a),(a)=>{throw o=!0,a});if(await Promise.race([i.then(()=>!0),r(jf).then(()=>!1)]))return i;n.write(If);try{for(let a=0;!o;a+=1)n.write(`${Ba}${Ta(a*Ff)}${qa[a%qa.length]}${$f} ${t.loadingMessage??"Loading…"}`),await Promise.race([i,r(Nf)]);return await i}finally{n.write(`${Ba}${Of}`)}}async function Jt(e,t,n,r={}){let o=t();if(e)await n();if(e&&o.ready)await _n(o.ready,r);return o.finish()}import{homedir as mg}from"node:os";import{stripVTControlCharacters as Mf}from"node:util";var Tn="amp plugins list",Uf=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function Va(e){if(!e.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=Mf(e.ampPluginListOutput).split(`
`).map((n)=>Uf.exec(n)?.[1]).find((n)=>n!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:Tn,configPath:Tn,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:Tn,configPath:Tn}}import{existsSync as Gf,readFileSync as Bf}from"node:fs";var qf=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function Vf(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];return Object.values(e).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t,r=n.PreToolUse;if(!Array.isArray(r))return[];return r.flatMap((o)=>{if(!o||typeof o!=="object"||Array.isArray(o))return[];let i=o.hooks;if(!Array.isArray(i))return[];return i.flatMap((s)=>{if(!s||typeof s!=="object"||Array.isArray(s))return[];let a=s.command;if(typeof a!=="string"||!qf.test(a))return[];return[{command:a,enabled:n.enabled!==!1}]})})})}function za(e){let t=Gt(e.homeDir);if(!Gf(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let n;try{n=Vf(JSON.parse(Bf(t,"utf-8")))}catch(r){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${r instanceof Error?r.message:String(r)}`]}}if(n.some((r)=>r.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(n.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as Ja}from"node:path";import{existsSync as zf,lstatSync as Jf,readFileSync as Kf}from"node:fs";function ce(e,t=(n)=>n){if(!zf(e))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(Kf(e,"utf-8")))}}catch{return{kind:"unreadable"}}}function _(e){try{return Jf(e)}catch{return}}function In(e,t){let n=_(t);if(!n)return{platform:e,status:"n/a",configPath:t};if(!n.isSymbolicLink()&&n.isDirectory())return;return{platform:e,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function k(e,t){return typeof e==="object"&&e!==null?e[t]:void 0}var co="cc-safety-net@cc-marketplace";function Ka(e){return Ja(e,".claude","plugins","installed_plugins.json")}function Wa(e,t){let n=k(k(e,"plugins"),t);return Array.isArray(n)&&n.length>0}function $n(e,t){let n=ce(Ka(e));return n.kind==="ok"&&Wa(n.value,t)}function uo(e){let t=Ka(e),n=ce(t);if(n.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(n.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!Wa(n.value,co))return{platform:"claude-code",status:"n/a"};let r=Ja(e,".claude","settings.json"),o=ce(r);if(o.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(o.kind==="ok"&&k(k(o.value,"enabledPlugins"),co)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:r,errors:[`${co} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function Ya(e){return uo(e.homeDir)}function Za(e){if(!e.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=e.codexPluginListOutput.split(`
`).find((n)=>n.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed,"))return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as Nn,readdirSync as Wf,readFileSync as Yf}from"node:fs";import{join as M}from"node:path";var de="cc-safety-net@cc-marketplace",On=["cc-marketplace","cc-safety-net"],Xa=["_direct","copilot-safety-net"],Qa=["cc-marketplace","safety-net"],el="safety-net@cc-marketplace";function jn(e,t){let n=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${n}([^a-z0-9-]|$)`,"m").test(e??"")}function tl(e){return jn(e,"cc-safety-net@cc-marketplace")}function nl(e){return jn(e,"cc-marketplace")}function rl(e){return jn(e,"copilot-safety-net")}function ol(e){return jn(e,"safety-net@cc-marketplace")}function J(e){let t="",n=0,r=!1,o=!1,i=-1;while(n<e.length){let s=e[n],a=e[n+1];if(o){t+=s,o=!1,n++;continue}if(s==='"'&&!r){r=!0,i=-1,t+=s,n++;continue}if(s==='"'&&r){r=!1,t+=s,n++;continue}if(s==="\\"&&r){o=!0,t+=s,n++;continue}if(r){t+=s,n++;continue}if(s==="/"&&a==="/"){while(n<e.length&&e[n]!==`
`)n++;continue}if(s==="/"&&a==="*"){n+=2;while(n<e.length-1){if(e[n]==="*"&&e[n+1]==="/"){n+=2;break}n++}continue}if(s===","){i=t.length,t+=s,n++;continue}if(s==="}"||s==="]"){if(i!==-1){let l=t.slice(i+1);if(/^\s*$/.test(l))t=t.slice(0,i)+l}i=-1,t+=s,n++;continue}if(!/\s/.test(s))i=-1;t+=s,n++}return t}function po(e){if(!e?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(e)}function sl(e,t){if(!e)return null;let n=e.match(/(\d+)\.(\d+)\.(\d+)/);if(!n)return null;let r=[Number(n[1]),Number(n[2]),Number(n[3])];for(let o=0;o<t.length;o++){let i=r[o]??0,s=t[o]??0;if(i!==s)return i>s}return!0}function Zf(e){return sl(e,[0,0,422])}function Xf(e){return sl(e,[1,0,8])}function Kt(e){return process.env.COPILOT_HOME||M(e,".copilot")}function fo(e){return(e.hooks?.preToolUse??[]).some((n)=>{if(n.type!=="command")return!1;return po(n.command)||po(n.bash)||po(n.powershell)})}function Fn(e){return e===void 0||typeof e==="string"}function Qf(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e;if(t.disableAllHooks!==void 0&&typeof t.disableAllHooks!=="boolean")return!1;if(t.hooks===void 0)return!0;if(!t.hooks||typeof t.hooks!=="object"||Array.isArray(t.hooks))return!1;let n=t.hooks.preToolUse;if(n===void 0)return!0;return Array.isArray(n)&&n.every((r)=>r!==null&&typeof r==="object"&&!Array.isArray(r)&&Fn(r.type)&&Fn(r.command)&&Fn(r.bash)&&Fn(r.powershell))}function mo(e,t){try{let n=JSON.parse(J(Yf(e,"utf-8")));if(!Qf(n)){t?.push(`Invalid hook config ${e}: hooks.preToolUse must be an array of hook objects`);return}return n}catch(n){t?.push(`Failed to parse ${e}: ${n instanceof Error?n.message:String(n)}`);return}}function al(e,t){try{return Wf(e).filter((n)=>n.endsWith(".json")).sort((n,r)=>n.localeCompare(r))}catch(n){return t?.push(`Failed to read ${e}: ${n instanceof Error?n.message:String(n)}`),[]}}function em(e,t){if(!Nn(e))return[];let n=[];for(let r of al(e,t)){let o=M(e,r),i=mo(o,t);if(i&&fo(i))n.push(o)}return n}function mt(e,t){if(!Nn(e))return;let n=mo(e,t);if(!n)return;return{path:e,config:n}}function il(e,t,n,r){if(t){e.push(`GitHub Copilot CLI ${t} does not support ${n}; requires ${r}+`);return}e.push(`GitHub Copilot CLI version unavailable; skipping ${n} because it requires ${r}+`)}function tm(e){for(let t of e){if(t?.config.disableAllHooks===!0)return t.path;if(t?.config.disableAllHooks===!1)return}return}function nm(e,t,n,r){let o=Kt(e),i=M(t,".github","hooks"),s=M(o,"hooks"),a=M(t,".github","copilot"),l=M(t,".claude"),c=Xf(n),d=c===!0?r:void 0,m=[mt(M(a,"settings.local.json"),d),mt(M(a,"settings.json"),d),mt(M(l,"settings.local.json"),d),mt(M(l,"settings.json"),d)],g=[mt(M(o,"settings.json"),d),mt(M(o,"config.json"),d)];if(c!==!1){let v=tm([...m,...g]);if(v){if(c===null)r.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${v} as active`);return{activeConfigPaths:[],disabledBy:v}}}let u=em(i,r),p=Zf(n),f=p===!0?r:void 0,b=Nn(s)?al(s,f):[],L=[];for(let v of b){let D=M(s,v),ne=mo(D,f);if(ne&&fo(ne))L.push(D)}if(p!==!0&&L.length>0)il(r,n,`user hook files in ${s}`,"0.0.422"),L.length=0;let h=[];for(let v of[...m,...g]){if(!v)continue;if(!fo(v.config))continue;if(c===!0){h.push(v);continue}il(r,n,"inline hook definitions in Copilot config files","1.0.8");break}let R=(v)=>v.filter((D)=>!!D&&h.includes(D)).map((D)=>D.path);return{activeConfigPaths:[...R(m),...u,...R(g),...L]}}function ll(e){let t=[],n=nm(e.homeDir,e.cwd,e.copilotCliVersion,t);if(n.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:n.disabledBy,configPaths:[n.disabledBy],errors:t.length>0?t:void 0};let r=Kt(e.homeDir),o=M(r,"installed-plugins",...On),i=Nn(o),s=M(r,"settings.json"),a=ce(s,J);if(i&&a.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(i&&a.kind==="ok"&&k(k(a.value,"enabledPlugins"),de)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:s,errors:[`${de} is installed but not enabled in Copilot CLI`]};if(i||n.activeConfigPaths.length>0){let l=i,c=n.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:l?"plugin config":"hook config",configPath:c??(l?o:void 0),configPaths:n.activeConfigPaths.length>0?n.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as pm,readFileSync as fm}from"node:fs";import{existsSync as cl,mkdirSync as im,readFileSync as sm}from"node:fs";import{dirname as am,join as lm}from"node:path";import{renameSync as rm,writeFileSync as om}from"node:fs";function O(e,t){let n=`${e}.${process.pid}.tmp`;om(n,t),rm(n,e)}var Wt="npx -y cc-safety-net hook --cursor",dl=30;function Mn(e){return lm(e,".cursor","hooks.json")}function Je(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function go(){return{command:Wt,timeout:dl,failClosed:!0}}function Hn(e){return Je(e)&&e.command===Wt}function cm(e){return Object.keys(e).length===3&&e.command===Wt&&e.timeout===dl&&e.failClosed===!0}function dm(e){try{return JSON.parse(sm(e,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${e}: ${t.message}`);throw t}}function ul(e){let t=dm(e);if(!Je(t))throw Error(`Cursor hooks config ${e} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${e} must set "version": 1`);if(t.hooks!==void 0&&!Je(t.hooks))throw Error(`Cursor hooks config ${e} "hooks" must be an object`);let n=Je(t.hooks)?t.hooks.preToolUse:void 0;if(n!==void 0&&!Array.isArray(n))throw Error(`Cursor hooks config ${e} "hooks.preToolUse" must be an array`);return t}function pl(e){let t=Je(e.hooks)?e.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function um(e){if(!e.some(Hn))return[...e,go()];return e.reduce((t,n)=>{if(!Hn(n))return t.result.push(n),t;if(!t.inserted)t.result.push(go()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function fl(e,t,n){let r=Je(t.hooks)?t.hooks:{},o={...t,hooks:{...r,preToolUse:n}};O(e,`${JSON.stringify(o,null,2)}
`)}function ml(e){let t=Mn(e);if(!cl(t))return im(am(t),{recursive:!0}),O(t,`${JSON.stringify({version:1,hooks:{preToolUse:[go()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let n=ul(t),r=pl(n),o=r.filter(Hn);if(Je(n.hooks)&&Array.isArray(n.hooks.preToolUse)&&o.length===1&&o[0]!==void 0&&cm(o[0]))return{path:t,alreadyInstalled:!0};return fl(t,n,um(r)),{path:t,alreadyInstalled:!1}}function gl(e){let t=Mn(e);if(!cl(t))return{path:t,alreadyInstalled:!1};let n=ul(t),r=pl(n),o=r.filter((i)=>!Hn(i));if(o.length===r.length)return{path:t,alreadyInstalled:!1};return fl(t,n,o),{path:t,alreadyInstalled:!0}}function mm(e){if(!e||typeof e!=="object"||Array.isArray(e))return[];let t=e.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let n=t.preToolUse;if(!Array.isArray(n))return[];return n.filter((r)=>!!r&&typeof r==="object"&&!Array.isArray(r)&&r.command===Wt)}function gm(e){let t=[];if(e.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let n=e[0];if(n&&n.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(n&&n.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function hl(e){let t=Mn(e.homeDir);if(!pm(t))return{platform:"cursor",status:"n/a",configPath:t};let n;try{n=JSON.parse(fm(t,"utf-8"))}catch(i){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=mm(n);if(r.length===0)return{platform:"cursor",status:"n/a",configPath:t};let o=gm(r);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{existsSync as hm}from"node:fs";import{join as ho}from"node:path";var yo="gemini-safety-net";function vo(e){let t=ho(e,".gemini","extensions"),n=ho(t,yo);if(!hm(n))return{platform:"gemini-cli",status:"n/a"};let r=ho(t,"extension-enablement.json"),o=ce(r);if(o.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let i=o.kind==="ok"?k(k(o.value,yo),"overrides"):void 0;if(Array.isArray(i)&&i.some((a)=>typeof a==="string"&&a.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:r,errors:[`${yo} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:n}}function yl(e){return vo(e.homeDir)}import{existsSync as Lm,readFileSync as wm}from"node:fs";import{existsSync as bl,mkdirSync as ym,readFileSync as Ll,rmSync as vm}from"node:fs";import{dirname as bm,join as vl}from"node:path";var Yt="npx -y cc-safety-net hook --grok-build",Bn=30;function qn(e){return vl(process.env.GROK_HOME??vl(e,".grok"),"hooks","cc-safety-net.json")}function Ke(e){return typeof e==="object"&&e!==null&&!Array.isArray(e)}function Un(){return{hooks:[{type:"command",command:Yt,timeout:Bn}]}}function wl(e){return Ke(e)&&e.command===Yt}function kl(e){return e.flatMap((t)=>{if(!Ke(t)||!Array.isArray(t.hooks))return[t];let n=t.hooks.filter((r)=>!wl(r));if(n.length===t.hooks.length)return[t];return n.length===0?[]:[{...t,hooks:n}]})}function xl(e){try{let t=JSON.parse(e);return Ke(t)?t:null}catch{return null}}function Cl(e){let t=Ke(e.hooks)?e.hooks.PreToolUse:void 0;return Array.isArray(t)?t:[]}function Gn(e,t,n){let r=Ke(t.hooks)?t.hooks:{};O(e,`${JSON.stringify({...t,hooks:{...r,PreToolUse:n}},null,2)}
`)}function Sl(e){let t=qn(e);if(!bl(t))return ym(bm(t),{recursive:!0}),Gn(t,{},[Un()]),{path:t,alreadyInstalled:!1};let n=xl(Ll(t,"utf-8"));if(!n)return Gn(t,{},[Un()]),{path:t,alreadyInstalled:!1};let r=Cl(n),o=r.filter((i)=>Ke(i)&&Array.isArray(i.hooks)&&i.hooks.some(wl));if(o.length===1&&JSON.stringify(o[0])===JSON.stringify(Un()))return{path:t,alreadyInstalled:!0};return Gn(t,n,[...kl(r),Un()]),{path:t,alreadyInstalled:!1}}function Rl(e){let t=qn(e);if(!bl(t))return{path:t,alreadyInstalled:!1};let n=xl(Ll(t,"utf-8"));if(!n)return{path:t,alreadyInstalled:!1};let r=Cl(n),o=kl(r);if(JSON.stringify(o)===JSON.stringify(r))return{path:t,alreadyInstalled:!1};let i=Ke(n.hooks)?n.hooks:{};if(o.length===0&&Object.keys(n).length===1&&Object.keys(i).length===1)return vm(t),{path:t,alreadyInstalled:!0};return Gn(t,n,o),{path:t,alreadyInstalled:!0}}function Zt(e){return!!e&&typeof e==="object"&&!Array.isArray(e)}function km(e){if(!Zt(e)||!Zt(e.hooks))return[];let t=e.hooks.PreToolUse;if(!Array.isArray(t))return[];return t.filter((n)=>Zt(n)&&Array.isArray(n.hooks)&&n.hooks.some((r)=>Zt(r)&&r.command===Yt))}function xm(e){let n=(Array.isArray(e.hooks)?e.hooks.filter(Zt):[]).find((r)=>r.command===Yt);return[...e.matcher===void 0||e.matcher===""||e.matcher==="*"?[]:['Managed hook has a "matcher" that narrows coverage; reinstall to repair'],...n?.type==="command"?[]:['Managed hook "type" is not "command"; reinstall to repair'],...n?.timeout===Bn?[]:[`Managed hook "timeout" is not ${Bn}; reinstall to repair`]]}function Dl(e){let t=qn(e.homeDir);if(!Lm(t))return{platform:"grok-build",status:"n/a",configPath:t};let n;try{n=JSON.parse(wm(t,"utf-8"))}catch(i){return{platform:"grok-build",status:"n/a",configPath:t,errors:[`Failed to parse Grok Build hooks config ${t}: ${i instanceof Error?i.message:String(i)}`]}}let r=km(n)[0];if(!r)return{platform:"grok-build",status:"n/a",configPath:t};let o=xm(r);return{platform:"grok-build",status:"configured",method:"hook config",configPath:t,errors:o.length>0?o:void 0}}import{readFileSync as jl}from"node:fs";import{join as Fl}from"node:path";var Q="cc-safety-net",Pl="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function Al(e){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${e}
`}function Cm(e){return`${Al(e)}name: cc-safety-net
version: "${e}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function Sm(e){return`${Al(e)}"""CC Safety Net guard for Hermes Agent.
...
`}function Xt(e){return[{name:"__init__.py",content:Sm(e)},{name:"plugin.yaml",content:Cm(e)}]}import{mkdirSync as Rm,readdirSync as Dm,readFileSync as Pm,rmSync as bo}from"node:fs";import{join as We}from"node:path";var Am="__pycache__";function Lo(e){let t=process.env.HERMES_HOME?.trim();return t?t:We(e,".hermes")}function wo(e){return We(Lo(e),"plugins",Q)}function ko(e){return e.startsWith(Pl)}function xo(e,t){let n=wo(e),r=_(n);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${n}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return n}function El(e,t){let n=_(e);if(!n)return;if(n.isSymbolicLink()||!n.isFile())throw Error(`Refusing to ${t} ${e}: not a regular file. Move or remove it.`);let r=Pm(e,"utf-8");if(!ko(r))throw Error(`Refusing to ${t} unmanaged file at ${e}. Move or remove it.`);return r}function _l(e){let t=xo(e,"install"),n=Xt(I());if(n.map((o)=>El(We(t,o.name),"overwrite")).every((o,i)=>o===n[i]?.content))return{path:t,alreadyInstalled:!0};return Rm(t,{recursive:!0}),n.forEach((o)=>{O(We(t,o.name),o.content)}),{path:t,alreadyInstalled:!1}}function Co(e){let t=xo(e,"remove");if(!_(t))return[];return Xt(I()).filter((n)=>El(We(t,n.name),"remove")!==void 0)}function Tl(e){let t=xo(e,"remove");if(!_(t))return{path:t,alreadyInstalled:!1};let n=Co(e);if(n.forEach((r)=>{bo(We(t,r.name))}),bo(We(t,Am),{recursive:!0,force:!0}),Dm(t).length===0)bo(t,{recursive:!0});return{path:t,alreadyInstalled:n.length>0}}var Vn="hermes-agent",Il=/^([^\s#][^:]*):/,Em=/^\s+([A-Za-z_][\w-]*):/,$l=/^\s+-\s*(.*)$/;function _m(e){return e.trim().replace(/^(["'])(.*)\1$/,"$2")}function Tm(e){let t=e.split(/\r?\n/),n=t.findIndex((i)=>Il.exec(i)?.[1]?.trim()==="plugins");if(n===-1)return[];let r=t.slice(n+1),o=r.findIndex((i)=>Il.test(i));return o===-1?r:r.slice(0,o)}function Ol(e,t){let n=Tm(e),r=n.findIndex((s)=>Em.exec(s)?.[1]===t);if(r===-1)return[];let o=n.slice(r+1),i=o.findIndex((s)=>!$l.test(s));return(i===-1?o:o.slice(0,i)).map((s)=>_m($l.exec(s)?.[1]??""))}function Im(e){try{return jl(Fl(Lo(e),"config.yaml"),"utf-8")}catch{return}}function So(e){let t=Im(e)??"";return Ol(t,"enabled").includes(Q)&&!Ol(t,"disabled").includes(Q)}function Nl(e){return/^# version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function $m(e,t){let n=_(e);if(!n)return{error:`${t.name} is missing from ${e}; run install --hermes-agent`};if(n.isSymbolicLink()||!n.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{let r=jl(e,"utf-8");if(!ko(r))return{error:`Unmanaged ${t.name} occupies ${e}; move or remove it`};if(Nl(r)===I()&&r!==t.content)return{error:`Modified ${t.name} occupies ${e}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${e}: ${r instanceof Error?r.message:String(r)}`}}}function Hl(e){let t=wo(e.homeDir),n=In(Vn,t);if(n)return n;let r=Xt(I()).map((a)=>$m(Fl(t,a.name),a)),o=r.flatMap((a)=>("error"in a)?[a.error]:[]);if(o.length>0)return{platform:Vn,status:"n/a",configPath:t,errors:o};let i=r.some((a)=>("content"in a)&&Nl(a.content)!==I()),s=i?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!So(e.homeDir))return{platform:Vn,status:"disabled",method:"plugin directory",configPath:t,errors:[`${Q} is not enabled in Hermes; run \`hermes plugins enable ${Q}\``,...s]};return{platform:Vn,status:"configured",method:"plugin directory",configPath:t,errors:i?s:void 0}}import{existsSync as Om,readFileSync as jm}from"node:fs";import{join as Ml}from"node:path";var Fm=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function Nm(e){return Ml(process.env.KIMI_CODE_HOME||Ml(e,".kimi-code"),"config.toml")}function Qt(e){let t=Nm(e.homeDir);if(!Om(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!Fm.test(jm(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(n){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${n instanceof Error?n.message:String(n)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as Yl}from"node:fs";import{join as tn}from"node:path";var A="cc-safety-net",ee="index.js",gt="openclaw.plugin.json",ht="package.json";var zn="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as Um,lstatSync as Gm,readdirSync as Bm,readFileSync as qm}from"node:fs";import{dirname as Bl,join as Ie}from"node:path";import{fileURLToPath as Vm}from"node:url";import{spawn as Hm}from"node:child_process";function Mm(e){return e.join(" ")}function Ro(e,t,n){return[`Failed to run ${Mm(e)}${t===null?"":` (exit ${t})`}.`,n.trim()].filter(Boolean).join(`
...
${a()}`.trim())))}),i.on("close",(d)=>{if(clearTimeout(c),d!==0){r(Error(Ro(e,d,a())));return}n(t?.stdoutOnly?s.stdout:a())})})}async function Po(e){for(let t of e)await ue(t)}async function Ul(e){for(let t of e)try{await ue(t)}catch(n){console.warn(n instanceof Error?n.message:String(n))}}var Gl=Ie("openclaw",A),zm=[ee,gt,ht];function Ao(e,t){if(e==="~")return t;if(e.startsWith("~/")||e.startsWith("~\\"))return Ie(t,e.slice(2));return e}function ql(e){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return Ao(t,e);let n=process.env.OPENCLAW_CONFIG_PATH?.trim();return n?Bl(Ao(n,e)):Ie(e,".openclaw")}function Vl(e){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?Ao(t,e):Ie(ql(e),"openclaw.json")}function Eo(e){return Ie(ql(e),"extensions",A)}function Jm(e){let t=Bm(e);if(t.length===0)return!0;if(t.some((o)=>!zm.includes(o)))return!1;let n=Ie(e,ee),r=_(n);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&qm(n,"utf-8").startsWith(zn)}function _o(e){let t=Eo(e),n=_(t);if(!n)return;if(!n.isSymbolicLink()&&n.isDirectory()&&Jm(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function zl(){let e=Bl(Vm(import.meta.url));return[Ie(e,"..",Gl),Ie(e,"..","..","..","dist",Gl)]}function To(e=zl()){return e.find((t)=>Um(t)&&Gm(t).isDirectory())}function Km(e=zl()){let t=To(e);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function Jl(e=Km()){return[["openclaw","plugins","install",e,"--force"],["openclaw","plugins","enable",A]]}function Wm(e){let t=(()=>{try{return JSON.parse(e)}catch{return}})(),n=k(k(t,"plugin"),"status");return typeof n==="string"?n:void 0}async function Kl(){let e=Wm(await ue(["openclaw","plugins","inspect",A,"--runtime","--json"],{stdoutOnly:!0}));if(e==="loaded")return;throw Error(`${e===void 0?`The ${A} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${A} plugin with status "${e}".`} Run \`openclaw plugins inspect ${A} --runtime\` for details.`)}var Jn="openclaw",en=`run \`openclaw plugins enable ${A}\``;function yt(e,t){let n=tn(e,t),r=_(n);if(!r)return{error:`${t} is missing from ${n}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{return{content:Yl(n,"utf-8")}}catch(o){return{error:`Failed to read ${n}: ${o instanceof Error?o.message:String(o)}`}}}function Zl(e){try{return JSON.parse(J(e))}catch{return}}function Ym(e){let t=yt(e,gt);if("error"in t)return t.error;if(k(Zl(t.content),"id")===A)return;return`${tn(e,gt)} is not a valid ${A} manifest; run install --openclaw`}function Zm(e){let t=yt(e,ht);if("error"in t)return t.error;let n=k(k(Zl(t.content),"openclaw"),"extensions");if(Array.isArray(n)&&n.includes(`./${ee}`))return;return`${tn(e,ht)} does not point OpenClaw at ${ee}; run install --openclaw`}function Wl(e){return Array.isArray(e)?e.filter((t)=>typeof t==="string"):[]}function Xm(e){let t=Vl(e);if(!_(t))return`${A} is not enabled; ${en}`;let n=(()=>{try{return JSON.parse(J(Yl(t,"utf-8")))}catch{return}})();if(n===void 0)return`Failed to read ${t}; fix it, then ${en}`;let r=k(n,"plugins");if(k(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let o=k(k(k(r,"entries"),A),"enabled");if(Wl(k(r,"deny")).includes(A)||o===!1)return`${A} is disabled in ${t}; ${en}`;let i=Wl(k(r,"allow"));if(i.length>0&&!i.includes(A))return`plugins.allow in ${t} does not list ${A}; add it, then ${en}`;if(i.includes(A)||o===!0)return;return`${A} is not enabled; ${en}`}function Xl(e){return/^\/\/ version:\s*(.+)$/m.exec(e)?.[1]?.trim()}function Qm(e,t,n){if(n===void 0)return[];let r=yt(n,ee);if("error"in r||Xl(r.content)!==t)return[];return[ee,gt,ht].flatMap((o)=>{let i=yt(e,o),s=yt(n,o);if("error"in i||"error"in s||i.content===s.content)return[];return[`Modified ${o} occupies ${tn(e,o)}; run install --openclaw to restore it`]})}function Ql(e){let t=Eo(e.homeDir),n=In(Jn,t);if(n)return n;let r=yt(t,ee),i=["error"in r?r.error:r.content.startsWith(zn)?void 0:`Unmanaged ${ee} occupies ${tn(t,ee)}; move or remove it`,Ym(t),Zm(t)].filter((d)=>d!==void 0),s="content"in r?Xl(r.content):void 0,a=i.length>0?i:Qm(t,s,To());if(a.length>0)return{platform:Jn,status:"n/a",configPath:t,errors:a};let l=s===I()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],c=Xm(e.homeDir);if(c)return{platform:Jn,status:"disabled",method:"plugin directory",configPath:t,errors:[c,...l]};return{platform:Jn,status:"configured",method:"plugin directory",configPath:t,errors:l.length>0?l:void 0}}import{existsSync as dg,readFileSync as ug}from"node:fs";import{join as pg}from"node:path";import{existsSync as Io,readFileSync as oc,rmSync as tg}from"node:fs";import{join as ke}from"node:path";import{pathToFileURL as ng}from"node:url";function ec(e){return e!==void 0&&/\s/.test(e)}function eg(e,t,n){let r=t+1,o=!1;while(r<e.length){let i=e[r];if(o){o=!1,r++;continue}if(i==="\\"){o=!0,r++;continue}if(i==='"')return r+1;r++}throw Error(n)}function Kn(e,t,n){let r=e[t],o=r==="["?"]":"}",i=0,s=t;while(s<e.length){let a=n.skipComment?.(e,s)??s;if(a!==s){s=a;continue}if(e[s]==='"'){s=eg(e,s,n.stringError);continue}if(e[s]===r)i++;if(e[s]===o){if(i--,i===0)return s}s++}throw Error(n.bracketError)}function tc(e,t){let n=e.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(e.slice(n))?.[0]??""}function Wn(e,t){let{start:n,end:r,end:o}=t;while(ec(e[o]))o++;if(e[o]===","){if(r=o+1,e[r]===`
`)r++;return`${e.slice(0,n)}${e.slice(r)}`}o=t.start-1;while(ec(e[o]))o--;if(e[o]===","){n=o;let i=e.lastIndexOf(`
`,n-1);if(i!==-1&&/^\s*$/.test(e.slice(i+1,n)))n=i}return`${e.slice(0,n)}${e.slice(r)}`}var Yn="cc-safety-net",ic=`${Yn}@latest`,sc=["opencode.json","opencode.jsonc"],nc="CCSafetyNetPlugin";function Zn(e){return ke(process.env.XDG_CONFIG_HOME||ke(e,".config"),"opencode")}function rg(e){return ke(Zn(e),sc[0])}function og(e){return sc.map((t)=>ke(Zn(e),t))}function ac(e){return ke(process.env.XDG_CACHE_HOME||ke(e,".cache"),"opencode","packages",ic)}function $o(e){tg(ac(e),{recursive:!0,force:!0})}async function lc(e){let t=ke(ac(e),"node_modules",Yn),n=ke(t,"package.json");if(!Io(n))throw Error(`The OpenCode plugin cache at ${t} is missing its package, so OpenCode would load nothing and fail open. Run \`opencode plugin -g -f ${ic}\` for details.`);let r=k(JSON.parse(oc(n,"utf-8")),"main");if(typeof r!=="string")throw Error(`The cached OpenCode plugin at ${t} declares no "main" entry.`);let o=ke(t,r);if(typeof(await import(ng(o).href))[nc]==="function")return;throw Error(`The cached OpenCode plugin at ${o} does not export a callable ${nc}, so OpenCode would load nothing and fail open.`)}function Xn(e,t){if(e[t]==="/"&&e[t+1]==="/"){let n=e.indexOf(`
`,t+2);return n===-1?e.length:n+1}if(e[t]==="/"&&e[t+1]==="*"){let n=e.indexOf("*/",t+2);return n===-1?e.length:n+2}return t}function rc(e,t){let n=t;while(n<e.length){if(/\s/.test(e[n]??"")){n++;continue}let r=Xn(e,n);if(r===n)return n;n=r}return n}function cc(e,t){let n=t+1,r=!1;while(n<e.length){if(r){r=!1,n++;continue}if(e[n]==="\\"){r=!0,n++;continue}if(e[n]==='"')return n+1;n++}throw Error("Unterminated string in OpenCode config")}function dc(e,t,n){return JSON.parse(e.slice(t,n))}function ig(e,t){return Kn(e,t,{skipComment:Xn,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function sg(e){let t=0,n=0;while(n<e.length){let r=Xn(e,n);if(r!==n){n=r;continue}if(e[n]==='"'){let o=cc(e,n);if(t===1&&dc(e,n,o)==="plugin"){let i=rc(e,o),s=rc(e,i+1);if(e[i]===":"&&e[s]==="[")return{start:s,end:ig(e,s)}}n=o;continue}if(e[n]==="{"||e[n]==="[")t++;if(e[n]==="}"||e[n]==="]")t--;n++}return}function ag(e,t){let n=[],r=t.start+1;while(r<t.end){let o=Xn(e,r);if(o!==r){r=o;continue}if(e[r]==='"'){let i=cc(e,r),s=dc(e,r,i);if(typeof s==="string"&&s.includes(Yn))n.push({start:r,end:i});r=i;continue}r++}return n}function uc(e,t){try{return JSON.parse(J(e))}catch(n){if(n instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${n.message}`);throw n}}function lg(e){if(!e||typeof e!=="object"||Array.isArray(e))return!1;let t=e.plugin;if(!Array.isArray(t))return!1;return t.some((n)=>typeof n==="string"&&n.includes(Yn))}function cg(e,t){let n=sg(e);if(!n)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let r=[...ag(e,n)].reverse().reduce(Wn,e);return uc(r,t),r}function pc(e){$o(e);let t=og(e),n=t.find((o)=>Io(o)),r=[];for(let o of t){if(!Io(o))continue;try{let i=oc(o,"utf-8");if(!lg(uc(i,o)))continue;return O(o,cg(i,o)),{path:o,alreadyInstalled:!0}}catch(i){r.push(i instanceof Error?i.message:String(i))}}if(r.length>0)throw Error(r.join(`
`));return{path:n??rg(e),alreadyInstalled:!1}}function fc(e){let t=[],n=Zn(e.homeDir),r=["opencode.json","opencode.jsonc"];for(let o of r){let i=pg(n,o);if(dg(i))try{let s=ug(i,"utf-8"),a=J(s);if((JSON.parse(a).plugin??[]).some((m)=>m.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:i,errors:t.length>0?t:void 0}}catch(s){t.push(`Failed to parse ${o}: ${s instanceof Error?s.message:String(s)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as fg}from"node:path";function Oo(e){return fg(e,".pi","agent","settings.json")}function jo(e){if(typeof e!=="string")return!1;return e==="npm:cc-safety-net"||e.startsWith("npm:cc-safety-net@")}function mc(e){let t=Oo(e.homeDir),n=ce(t);if(n.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(n.kind==="missing")return{platform:"pi",status:"n/a"};let r=k(n.value,"packages");if(!Array.isArray(r))return{platform:"pi",status:"n/a"};let o=r.find((a)=>jo(typeof a==="string"?a:k(a,"source")));if(o===void 0)return{platform:"pi",status:"n/a"};let i=k(o,"extensions");if(Array.isArray(i)&&i.some((a)=>typeof a==="string"&&a.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var gg={amp:Va,"antigravity-cli":za,"claude-code":Ya,codex:Za,"copilot-cli":ll,cursor:hl,"gemini-cli":yl,"grok-build":Dl,"hermes-agent":Hl,"kimi-code":Qt,openclaw:Ql,opencode:fc,pi:mc};function vt(e,t){let n={...t,cwd:e,homeDir:t?.homeDir??mg()};return wn.map((r)=>hg(gg[r](n)))}function hg(e){if(e.status==="not-inspected")return{platform:e.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:e.platform,detected:e.status!=="n/a",configured:e.status==="configured",inspectionStatus:e.status!=="n/a"?"verified":e.errors&&e.errors.length>0?"failed":"not-applicable",method:e.method,configPath:e.configPath,configPaths:e.configPaths,errors:e.errors}}import{tmpdir as yg}from"node:os";import{join as vg}from"node:path";var bg=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),Lg=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([]),allowPaths:Object.freeze([])})})}),wg={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}}};function gc(){let e=vg(yg(),"cc-safety-net-self-test"),t=bg.map((n)=>{let r=bn(st("self-test",{command:n.command},{kind:"command",shell:"auto"},{configCwd:e,executionCwd:e},n.command),{guard:{dependencies:{loadPolicySnapshot:()=>Lg,getModes:()=>wg,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),o=n.expectBlocked?"blocked":"allowed",i=r.decision.kind==="deny"?"blocked":"allowed";return{command:n.command,description:n.description,expected:o,actual:i,passed:o===i,reason:r.decision.kind==="deny"?r.decision.reason:void 0,ruleId:r.decision.kind==="deny"?r.decision.ruleId:void 0}});return{passed:t.filter((n)=>n.passed).length,failed:t.filter((n)=>!n.passed).length,total:t.length,results:t}}function Fo(e){let t=E({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},e);if(fe(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function hc(e={}){let t=await Jt(!e.json,()=>{let n=kg(e);return{ready:n,finish:()=>n}},()=>zt(),{loadingMessage:"Checking system status…"});if(e.json)console.log(JSON.stringify(t,null,2));else xg(t);return t.engineSelfTest.failed>0||t.findings.some((n)=>n.severity==="error")?1:0}async function kg(e){let t=e.cwd??process.cwd(),n=await qt(),r=vt(t,{ampPluginListOutput:n.ampPluginListOutput,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.versions["copilot-cli"]}),o=la(t),i=ca(),s=z({cwd:t}),a=s.policy,l=ye(a),c=Ue(a,l.capabilities),d=Sn(7),m=Ma(t),g=e.skipUpdateCheck?{currentVersion:I(),latestVersion:null,updateAvailable:!1}:await Te(),u={hooks:r,engineSelfTest:gc(),userConfig:o.userConfig,projectConfig:o.projectConfig,configState:Ht(s),effectiveRules:o.effectiveRules,shadowedRules:o.shadowedRules,environment:i,effectiveSafety:{selectedPreset:a.safety.level??"standard",level:l.effectiveLevel,capabilities:l.capabilities,ruleOverrides:a.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(c).filter(([,p])=>p.source==="rule_override"&&p.override==="off"&&p.inheritedEnabled&&p.changesInherited).map(([p])=>p),ruleCounts:{stored:Object.keys(a.destructiveCommandRuleOverrides).length,effective:Object.values(c).filter((p)=>p.changesInherited).length},...s.policyScopes?{policyScopes:s.policyScopes}:{}},...m.length>0?{v2Leftovers:m}:{},posture:xa(o.userConfig.path),activity:d,update:g,system:n};return{...u,findings:ua(u)}}function xg(e){console.log(),console.log(fa(e.hooks)),console.log(),console.log(ma(e.engineSelfTest)),console.log(),console.log(ga(e)),console.log(),console.log(ha(e.environment)),console.log(),console.log(ya(e)),console.log(),console.log(va(e.findings)),console.log(),console.log(ba(e.activity)),console.log(),console.log(wa(e.system)),console.log(),console.log(La(e.update)),console.log(ka(e))}import{existsSync as Cg}from"node:fs";var Sg=/^[A-Za-z0-9_@%+=:,./-]+$/,yc="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function No(e){let t=E({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},e);if(fe(t.errors))return console.error(yc),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!Cg(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let n=t.positionals.length===1?t.positionals[0]:t.positionals.map((r)=>Sg.test(r)?r:`'${r.replaceAll("'","'\\''")}'`).join(" ");if(!n)return console.error("Error: No command provided"),console.error(yc),null;return{json:t.flags.json,cwd:t.values.cwd,command:n}}function vc(e){if(e)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function bc(e,t){let r=t-18;return[`${e.dtl}${e.dh.repeat(t)}${e.dtr}`,`${e.dv}  Command Analysis${" ".repeat(r)}${e.dv}`,`${e.dbl}${e.dh.repeat(t)}${e.dbr}`]}function Ho(e){return JSON.stringify(e)}function Lc(e,t=0){return`[${e.map((r,o)=>pa(r,o,t)).join(",")}]`}function nn(e,t,n=70){let r=e.split(" "),o=[],i="";for(let s of r)if(i&&i.length+s.length+1>n)o.push(i),i=s;else i=i?`${i} ${s}`:s;if(i)o.push(i);return o.map((s,a)=>a===0?s:`${t}${s}`)}function wc(e,t,n){let r=[];switch(e.type){case"parse":return null;case"env-strip":return r.push(""),r.push(`STEP ${t} ${n.h} Strip environment variables`),r.push(`  Removed: ${e.envVars.map((o)=>`${o}=<redacted>`).join(", ")}`),r.push(`  Tokens:  ${Ho(e.output)}`),{lines:r,incrementStep:!0};case"leading-tokens-stripped":return r.push(""),r.push(`STEP ${t} ${n.h} Strip wrappers`),r.push(`  Removed: ${e.removed.join(", ")}`),r.push(`  Tokens:  ${Ho(e.output)}`),{lines:r,incrementStep:!0};case"shell-wrapper":return r.push(""),r.push(`STEP ${t} ${n.h} Detect shell wrapper`),r.push(`  Wrapper: ${e.wrapper} -c`),r.push(`  Inner:   ${e.innerCommand}`),{lines:r,incrementStep:!0};case"interpreter":{if(r.push(""),r.push(`STEP ${t} ${n.h} Detect interpreter`),r.push(`  Interpreter: ${e.interpreter}`),r.push(`  Code:        ${e.codeArg}`),e.paranoidBlocked)r.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:r,incrementStep:!0}}case"busybox":return r.push(""),r.push(`STEP ${t} ${n.h} Busybox wrapper`),r.push(`  Subcommand: ${e.subcommand}`),{lines:r,incrementStep:!0};case"transparent-wrapper":return r.push(""),r.push(`STEP ${t} ${n.h} Transparent wrapper`),r.push(`  Wrapper: ${e.wrapper}`),r.push(`  Tokens:  ${Ho(e.output)}`),{lines:r,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{if(r.push(""),r.push(`STEP ${t} ${n.h} Match rules`),r.push(`  Rule:   ${e.rule}()`),e.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}case"worktree-relaxation":return r.push(""),r.push(`STEP ${t} ${n.h} Worktree relaxation`),r.push(`  Mode:   ${S.worktree.name}`),r.push(`  Git cwd: ${e.gitCwd}`),r.push("  Result: Allowed local discard in linked worktree"),{lines:r,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(e.embeddedCommandFound)return r.push(""),r.push(`STEP ${t} ${n.h} Fallback scan`),r.push(`  Found: ${e.embeddedCommandFound}`),{lines:r,incrementStep:!0};return null}case"custom-rules-check":{if(e.rulesChecked){if(r.push(""),r.push(`STEP ${t} ${n.h} Custom rules`),e.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(e.matched)return r.push(""),r.push(`STEP ${t} ${n.h} Dangerous text check`),r.push(`  Token:  ${e.token}`),r.push("  Result: MATCHED"),{lines:r,incrementStep:!0};return null}case"strict-unparseable":return r.push(""),r.push(`STEP ${t} ${n.h} Strict mode check`),r.push(`  Command: ${e.rawCommand}`),r.push("  Result:  ✗ UNPARSEABLE"),{lines:r,incrementStep:!0};case"segment-skipped":return null;case"error":return r.push(""),r.push(`ERROR: ${e.message}`),{lines:r,incrementStep:!1};default:return e}}function Mo(e,t){let n=vc(t?.asciiOnly??!1),r=58,o=[],i=1;o.push(...bc(n,58)),o.push("");let s=e.trace.steps.find((p)=>p.type==="error");if(s&&s.type==="error"){o.push("ERROR"),o.push(`  ${s.message}`),o.push(""),o.push("RESULT"),o.push(`  Status: ${e.result==="blocked"?y.red("BLOCKED"):y.green("ALLOWED")}`),o.push(""),o.push("CONFIG");let p=e.configSource??"none";return o.push(`  Path: ${p}`),o.join(`
`)}let a=e.trace.steps.find((p)=>p.type==="parse");if(a&&a.type==="parse"){o.push("INPUT"),o.push(`  ${a.input}`),o.push(""),o.push(`STEP ${i} ${n.h} Split shell commands`),i++;for(let p=0;p<a.segments.length;p++){let f=a.segments[p];if(f){let b=Math.random();o.push(`  Segment ${p+1}: ${Lc(f,b)}`)}}}let l=e.trace.segments,c=l.length>1;for(let p of l){if(c){o.push("");let h="";if(a&&a.type==="parse"){let fr=a.segments[p.index];if(fr)h=fr.join(" ")}let R=54,v=h,D=` Segment ${p.index+1}: `,ne=" ";if(h){if(D.length+h.length+ne.length>R){let yu=R-D.length-ne.length;v=`${h.substring(0,yu-1)}…`}}let un=h?`${D}${v}${ne}`:` Segment ${p.index+1} `,gu=h?`${D}${y.cyan(v)}${ne}`:un,pi=58-un.length,fi=Math.floor(pi/2),hu=pi-fi;o.push(`${n.sh.repeat(fi)}${gu}${n.sh.repeat(hu)}`)}if(p.steps.find((h)=>h.type==="segment-skipped")){o.push(""),o.push("  (skipped — prior segment blocked)");continue}let b=!1,L=!1;for(let h of p.steps){let R=wc(h,i,n);if(R){if(L=!0,h.type==="recurse"){o.push("");let v=" RECURSING ",D=58-v.length-4;o.push(`  ${n.tl}${n.h}${v}${n.h.repeat(D)}`),o.push(`  ${n.v}`),b=!0;continue}for(let v of R.lines)if(b)o.push(`  ${n.v} ${v}`);else o.push(v);if(R.incrementStep)i++}}if(b)o.push(`  ${n.v}`),o.push(`  ${n.bl}${n.h.repeat(56)}`),b=!1;if(!L)o.push(""),o.push(`  ${y.green("✓")} Allowed (no matching rules)`)}if(o.push(""),o.push("RESULT"),e.result==="blocked"){if(o.push(`  Status: ${y.red("BLOCKED")}`),e.customRule){if(o.push(`  Rule: ${e.customRule.id}`),e.customRule.rulebook)o.push(`  Rulebook: ${e.customRule.rulebook.name} ${e.customRule.rulebook.version}`);if(e.customRule.source)o.push(`  Source: ${e.customRule.source}`);if(e.customRule.override)o.push(`  Override: reason ${e.customRule.override.reason}`)}if(e.reason){let p=nn(e.reason,"          ");o.push(`  Reason: ${p[0]}`);for(let f=1;f<p.length;f++)o.push(p[f]??"")}}else o.push(`  Status: ${y.green("ALLOWED")}`);o.push(""),o.push("CONFIG");let d=e.configSource??"none",m=e.configValid?"":" (invalid)";o.push(`  Path: ${d}${m}`);let g=e.safetyPresetScope;o.push(`  Safety preset: ${e.selectedPreset??"standard"}${g?` (${Rn(g)})`:""}`),o.push(`  Effective capabilities: ${e.effectiveLevel}`);let u=Object.entries(e.destructiveCommandRuleOverrides??{});if(o.push(`  Rule customizations: ${u.length}`),e.ruleActivation)o.push(`  Rule activation: ${e.ruleActivation.id} — ${e.ruleActivation.enabled?"on":"off"} via ${e.ruleActivation.source}`);return o.join(`
`)}function Uo(e){return JSON.stringify(e,null,2)}function kc(e){return new Promise((t)=>{process.stdout.write(`${e}
`,()=>t())})}async function xc(e){let t=No(e);if(!t)return 1;try{let n=at(t.command,{cwd:t.cwd}),r=!!process.env.NO_COLOR||!process.stdout.isTTY;return await kc(t.json?Uo(n):Mo(n,{asciiOnly:r})),0}catch(n){if(!(n instanceof Ur)&&!(n instanceof Me)&&!(n instanceof Le))throw n;if(t.json)return await kc(JSON.stringify({error:n.message})),1;return console.error(n.message),1}}var Cc="2.2.2",te="  ",Ye="cc-safety-net";function Sc(e){return e.argument?`${e.flags} ${e.argument}`:e.flags}function Rg(e){return Math.max(...e.map((t)=>Sc(t).length))}function Dg(e){return Math.max(...e.map((t)=>t.usage.length))}function Pg(e){return Math.max(...e.map((t)=>`${Ye} ${t.usage}`.length))}function Ag(e,t){let n=`${Ye} ${e.usage}`;return`${te}${n.padEnd(t+2)}${e.description}`}function xe(e,t){return`${te}${e.padEnd(Math.max(40,e.length+2))}${t}`}function bt(e,t=console.log){let n=[];if(n.push(`${Ye} ${e.name}`),n.push(""),n.push(`${te}${e.description}`),n.push(""),n.push("USAGE:"),n.push(`${te}${Ye} ${e.usage}`),n.push(""),e.subcommands&&e.subcommands.length>0){n.push("SUBCOMMANDS:");let r=Dg(e.subcommands);for(let o of e.subcommands)n.push(`${te}${o.usage.padEnd(r+2)}${o.description}`);n.push("")}if(e.options.length>0){n.push("OPTIONS:");let r=Rg(e.options);for(let o of e.options){let i=Sc(o),s=o.default?`${o.description} (default: ${o.default})`:o.description;n.push(`${te}${i.padEnd(r+2)}${s}`)}n.push("")}if(e.examples&&e.examples.length>0){n.push("EXAMPLES:");for(let r of e.examples)n.push(`${te}${r}`)}t(n.join(`
`))}function Go(){let e=Pg(xn),t=[];t.push(`${Ye} v${Cc}`),t.push(""),t.push("Blocks destructive commands and secret access."),t.push(""),t.push("COMMANDS:");for(let n of xn)t.push(Ag(n,e));t.push(""),t.push("GLOBAL OPTIONS:"),t.push(`${te}-h, --help       Show help (use with command for command-specific help)`),t.push(`${te}-V, --version    Show version`),t.push(""),t.push("HELP:"),t.push(`${te}${Ye} help <command>     Show help for a specific command`),t.push(`${te}${Ye} <command> --help   Show help for a specific command`),t.push(""),t.push("ENVIRONMENT VARIABLES:"),t.push(xe(`${S.level.name}=standard|strict|paranoid`,"Set session safety level")),t.push(xe(`${S.worktree.name}=1`,"Allow local git discards in linked worktrees")),t.push(xe(`${S.debug.name}=1`,"Print diagnostic messages to stderr")),t.push(xe(`${S.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),t.push(xe("CC_SAFETY_NET_HOME","Override rule config home directory")),t.push(""),t.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),t.push(xe(`${S.strict.name}=1`,"Force safety.overrides.fail_closed on")),t.push(xe(`${S.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),t.push(xe(`${S.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),t.push(xe(`${S.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),t.push(""),t.push("Documentation:        https://ccsafetynet.com/docs"),console.log(t.join(`
`))}function Rc(){console.log(Cc)}function rn(e,t=console.log){let n=Cn(e);if(!n)return!1;if(n.name.toLowerCase()!==e.toLowerCase())return!1;return bt(n,t),!0}import{existsSync as ei,readFileSync as vd}from"node:fs";import{homedir as Rh,tmpdir as Dh}from"node:os";import{join as Xo}from"node:path";import*as $e from"node:readline";function Eg(e){return e==="install"?"Install":"Uninstall"}function _g(e){return e==="install"?"Installing":"Uninstalling"}function Tg(e){return e==="install"?"into":"from"}function Ac(e){return e?.available===!0}function Ig(e,t){let n=new Set(t);return e.filter((r)=>n.has(r.target)).map((r)=>r.target)}function Dc(e,t,n){if(e.length===0||e.every((r)=>!r.available))return t;return Array.from({length:e.length},(r,o)=>o+1).map((r)=>(t+r*n+e.length)%e.length).find((r)=>Ac(e[r]))}function $g(e,t,n){if(n.ctrl&&n.name==="c")return"interrupt";if(n.name==="escape"||t==="q")return"abort";if(e==="install"&&(t==="u"||t==="U"))return"update";if(n.name==="up"||t==="k")return"up";if(n.name==="down"||t==="j")return"down";if(n.name==="space"||t===" ")return"toggle";if(n.name==="return"||n.name==="enter")return"confirm";return null}function Og(e){return{cursor:e.findIndex((t)=>t.available),selected:[]}}function jg(e,t,n){if(n==="confirm"||n==="update"||n==="abort"||n==="interrupt")return{state:e,done:n};if(n==="up")return{state:{...e,cursor:Dc(t,e.cursor,-1)}};if(n==="down")return{state:{...e,cursor:Dc(t,e.cursor,1)}};let r=t[e.cursor];if(!Ac(r))return{state:e};let o=e.selected.includes(r.target)?e.selected.filter((i)=>i!==r.target):Ig(t,[...e.selected,r.target]);return{state:{...e,selected:o}}}var Ec="◉",_c="◯",Tc=">",Ic=" ";function Fg(e,t,n,r={}){let o=r.color!==!1,i=o?y.dim:(l)=>l,s=o?y.green:(l)=>l,a=o?y.bold:(l)=>l;return["",`${Eg(e)} CC Safety Net ${Tg(e)}:`,"",...t.map((l,c)=>{let d=n.selected.includes(l.target),m=c===n.cursor,g=d?Ec:_c,u=m?Tc:Ic,p=l.available?"":` (${l.unavailableReason??"not installed"})`,f=`${g} ${l.label}${p}`,b=!l.available?i(f):d?s(f):m?a(f):f;return`${u} ${b}`}),"",e==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((l)=>l.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${e}. q/Esc: close`].join(`
`)}var Pc=["global-hook","plugin"];function Ng(e,t,n={}){let r=n.color!==!1?y.bold:(i)=>i;return["","Install the Kimi Code integration as:","",...[`Global hook — ${t?"already installed; selecting it reports the current state":"write the hook into ~/.kimi-code/config.toml now"}`,"Native Kimi plugin — print the steps to run inside Kimi Code"].map((i,s)=>{let a=s===e,l=`${a?Ec:_c} ${i}`;return`${a?Tc:Ic} ${a?r(l):l}`}),"","Enter: confirm  Up/Down: move  q/Esc: cancel"].join(`
`)}function $c(e){let{input:t,output:n}=e;$e.emitKeypressEvents(t);let r=t.isRaw===!0;t.setRawMode(!0),t.resume();let o=0,i=()=>{if(o===0)return;$e.moveCursor(n,0,-o),$e.cursorTo(n,0),$e.clearScreenDown(n)},s=()=>{i();let a=e.render();n.write(`${a}
`),o=a.split(`
`).length};return new Promise((a)=>{let l=(d)=>{t.off("keypress",c),t.setRawMode(r),t.pause(),i(),a(d)};function c(d,m){e.onKey(d,m,{finish:l,draw:s})}t.on("keypress",c),s()})}function Oc(e={}){let t=0;return $c({input:e.input??process.stdin,output:e.output??process.stdout,render:()=>Ng(t,e.globalHookInstalled===!0),onKey:(n,r,o)=>{if(r.ctrl&&r.name==="c"){o.finish(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(r.name==="escape"||n==="q")return o.finish(null);if(r.name==="return"||r.name==="enter")return o.finish(Pc[t]);if(r.name==="up"||r.name==="down"||n==="k"||n==="j")t=(t+1)%Pc.length,o.draw()}})}function Bo(e=process.stdin,t=process.stdout){return Boolean(e.isTTY&&t.isTTY&&typeof e.setRawMode==="function")}function jc(e,t,n={}){let r=n.output??process.stdout,o=Og(t);return $c({input:n.input??process.stdin,output:r,render:()=>Fg(e,t,o),onKey:(i,s,a)=>{let l=$g(e,i,s);if(!l)return;let c=jg(o,t,l);if(o=c.state,c.done==="interrupt"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(c.done==="abort")return a.finish(null);if(c.done==="update")return a.finish("update");if(c.done==="confirm"){if(o.selected.length===0){r.write("\x07"),a.draw();return}a.finish([...o.selected]),r.write(`${_g(e)} selected integrations...
`);return}a.draw()}})}import{existsSync as Nc,lstatSync as Mg,mkdirSync as Ug,mkdtempSync as Gg,readdirSync as Bg,readFileSync as wt,rmSync as er}from"node:fs";import{tmpdir as qg}from"node:os";import{basename as Vg,dirname as zg,join as G}from"node:path";import{fileURLToPath as Jg}from"node:url";var qo="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp",Ze="cc-safety-net",Xe="cc-safety-net/index.ts";import{spawn as Hg}from"node:child_process";var Vo=(e,t)=>{let n=ze([...e],process.env);return new Promise((r)=>{let o=Hg(n.cmd,n.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),i=Do(o),s=!1,a=setTimeout(()=>{s=!0,o.kill()},120000);o.on("error",(l)=>{clearTimeout(a),r({status:null,errorCode:l.code,stdout:i.stdout,stderr:[l.message,i.stderr].filter(Boolean).join(`
`)})}),o.on("close",(l)=>{clearTimeout(a),r({status:s?null:l,errorCode:s?"ETIMEDOUT":void 0,stdout:i.stdout,stderr:i.stderr})})})};var Lt="cc-safety-net.ts",Fc=G("amp",Xe);function Kg(e){return G(e,".config","amp","plugins","cc-safety-net.ts")}function Wg(){let e=zg(Jg(import.meta.url));return[G(e,"..",Fc),G(e,"..","..","..","dist",Fc)]}function Yg(e=Wg()){let t=e.find((n)=>Nc(n)&&Mg(n).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function Hc(e){try{return JSON.parse(e)}catch{return}}function tr(e){return e.subarray(0,Buffer.byteLength(qo)).toString("utf-8")===qo}async function on(e,t,n){let r=await e(t,n);if(r.status===0)return r;throw Error([`Failed to run ${t.join(" ")}${r.status===null?"":` (exit ${r.status})`}.`,[r.stdout,r.stderr].filter(Boolean).join(`
`).trim()].filter(Boolean).join(`
`))}async function Mc(e){let t=await e(["amp","plugins","repositories","--json"]);if(t.status===null)throw Error(`${t.errorCode==="ENOENT"?'Amp CLI not found. Install the amp CLI, sign in with "amp login", and rerun install --amp.':`amp plugins repositories --json did not finish (${t.errorCode??"terminated"}). Check that the amp CLI responds and rerun install --amp.`}
...
`)}`.trim());let n=Hc(t.stdout),r=(Array.isArray(n)?n:[]).filter((o)=>k(o,"scope")==="user"&&k(o,"exists")===!0&&k(o,"viewerCanWrite")===!0).map((o)=>k(o,"cloneRef")).find((o)=>typeof o==="string"&&o.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}async function Uc(e,t){let n=Gg(G(qg(),"cc-safety-net-amp-"));try{return await on(e,["amp","clone","user-plugins",n]),await t(n)}finally{er(n,{recursive:!0,force:!0})}}function zo(e){return`rerun ${e==="overwrite"?"install":"uninstall"} --amp`}function Gc(e,t,n){let r=G(e,t),o=_(r);if(!o)return;if(o.isSymbolicLink()||!o.isFile())throw Error(`Refusing to ${n} ${t} in your Amp personal plugins repository: not a regular file. Remove it there and ${zo(n)}.`);let i=wt(r);if(tr(i))return i;throw Error(`Refusing to ${n} unmanaged file ${t} in your Amp personal plugins repository. Remove it there and ${zo(n)}.`)}function Bc(e,t){let n=G(e,Ze),r=_(n);if(!r)return;if(r.isSymbolicLink()||!r.isDirectory())throw Error(`Refusing to ${t} ${Ze} in your Amp personal plugins repository: not a regular directory. Remove it there and ${zo(t)}.`);return Gc(e,Xe,t)}function Zg(e){let t=G(e,Lt),n=_(t);if(!n||n.isSymbolicLink()||!n.isFile())return;let r=wt(t);return tr(r)?r:void 0}async function qc(e,t,n,r){if(await on(e,n,t),(await on(e,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await on(e,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",r],t),await on(e,["git","push","origin","HEAD"],t),!0}function Qn(e,t){Xg(e,t),Qg(e,t)}function Vc(e,t){if(t==="keep")return;throw Error(`Local Amp plugin ${e} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function Xg(e,t){let n=Kg(e),r=_(n);if(!r)return;if(!r.isSymbolicLink()&&r.isFile()&&tr(wt(n))){er(n);return}Vc(n,t)}function Qg(e,t){let n=G(e,".config","amp","plugins",Ze),r=_(n);if(!r)return;if(!r.isSymbolicLink()&&r.isDirectory()&&eh(n)){er(n,{recursive:!0});return}Vc(n,t)}function eh(e){let t=Vg(Xe);if(Bg(e).join("\x00")!==t)return!1;let n=G(e,t),r=_(n);return!!r&&!r.isSymbolicLink()&&r.isFile()&&tr(wt(n))}function th(){let e=ve();if(!Nc(e))return"";let t=Hc(wt(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(Y(t))};
`}async function zc(e,t=Yg(),n=Vo){let r=Buffer.concat([wt(t),Buffer.from(th(),"utf-8")]),o=await Mc(n);return Uc(n,async(i)=>{let s=`${o}/${Ze}`,a=Bc(i,"overwrite"),l=Gc(i,Lt,"overwrite");if(a?.equals(r)&&!l)return Qn(e,"fail"),{path:s,alreadyInstalled:!0};if(Ug(G(i,Ze),{recursive:!0}),O(G(i,Xe),r),l)er(G(i,Lt));let c=await qc(n,i,["git","add","--",Xe,...l?[Lt]:[]],`chore: update cc-safety-net plugin to v${I()}`);return Qn(e,"fail"),{path:s,alreadyInstalled:!c}})}async function Jc(e,t=Vo){let n=await Mc(t);return Uc(t,async(r)=>{let o=Bc(r,"remove"),i=Zg(r),s=`${n}/${i&&!o?Lt:Ze}`;if(!o&&!i)return Qn(e,"keep"),{path:s,alreadyInstalled:!1};return await qc(t,r,["git","rm","--",...o?[Xe]:[],...i?[Lt]:[]],`chore: remove cc-safety-net plugin v${I()}`),Qn(e,"keep"),{path:s,alreadyInstalled:!0}})}import{existsSync as Kc,mkdirSync as nh,readFileSync as rh}from"node:fs";import{dirname as oh}from"node:path";var Jo="npx -y cc-safety-net hook --agy-cli",Qe="cc-safety-net";function et(e){return Boolean(e)&&typeof e==="object"&&!Array.isArray(e)}function rr(){return{PreToolUse:[{hooks:[{type:"command",command:Jo,timeout:30}]}]}}function Wc(e){try{let t=JSON.parse(rh(e,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${e}: ${t.message}`);throw t}}function Yc(e){let t=e[Qe];if(t===void 0){let r=rr();return e[Qe]=r,{definition:r,preToolUse:r.PreToolUse??[]}}if(!et(t))throw Error(`Antigravity hooks config entry "${Qe}" must be an object`);let n=Array.isArray(t.PreToolUse)?t.PreToolUse:[];return t.PreToolUse=n,{definition:t,preToolUse:n}}function Zc(e){if(!Array.isArray(e.PreToolUse))return!1;return e.PreToolUse.some((t)=>et(t)&&Array.isArray(t.hooks)&&t.hooks.some((n)=>et(n)&&n.command===Jo))}function ih(e){return Object.values(e).some((t)=>et(t)&&t.enabled!==!1&&Zc(t))}function sh(e){if(e[Qe]===void 0)return!1;let t=Yc(e);if(t.definition.enabled!==!1||!Zc(t.definition))return!1;return t.definition.enabled=!0,!0}function ah(e){if(e[Qe]===void 0){e[Qe]=rr();return}let t=Yc(e);t.definition.enabled=!0,t.preToolUse.push(rr().PreToolUse?.[0]??{hooks:[]})}function lh(e){let t=!1;for(let n of Object.values(e)){if(!et(n)||!Array.isArray(n.PreToolUse))continue;n.PreToolUse=n.PreToolUse.flatMap((r)=>{if(!et(r)||!Array.isArray(r.hooks))return[r];let o=r.hooks.filter((i)=>!et(i)||i.command!==Jo);if(o.length!==r.hooks.length)t=!0;return o.length===0?[]:[{...r,hooks:o}]})}return t}function nr(e,t){O(e,`${JSON.stringify(t,null,2)}
`)}function Xc(e){let t=Gt(e);if(nh(oh(t),{recursive:!0}),!Kc(t))return nr(t,{[Qe]:rr()}),{path:t,alreadyInstalled:!1};let n=Wc(t);if(ih(n))return{path:t,alreadyInstalled:!0};if(sh(n))return nr(t,n),{path:t,alreadyInstalled:!1};return ah(n),nr(t,n),{path:t,alreadyInstalled:!1}}function Qc(e){let t=Gt(e);if(!Kc(t))return{path:t,alreadyInstalled:!1};let n=Wc(t);if(!lh(n))return{path:t,alreadyInstalled:!1};return nr(t,n),{path:t,alreadyInstalled:!0}}import{existsSync as ch,readdirSync as dh,rmSync as uh}from"node:fs";import{join as ph}from"node:path";function ed(e,t=process.platform,n){if(!ch(e))return;let r=t==="win32"?/^bunx-\d+-cc-safety-net@/:new RegExp(`^bunx-${process.getuid?.()??0}-cc-safety-net@`);dh(e).filter((o)=>o!==n&&r.test(o)).forEach((o)=>{uh(ph(e,o),{recursive:!0,force:!0})})}import{spawn as fh}from"node:child_process";var pe=X.map((e)=>({target:e.id,flag:e.flag,label:P(e.id),probeCommand:e.probeCommand}));function Ko(e){let t=new Set(e);return pe.map((n)=>n.target).filter((n)=>t.has(n))}async function td(e,t){for(let n of e)await t(n)}var mh=5000;function Wo(e){return new Promise((t)=>{let n=ze([...e],process.env),r=fh(n.cmd,n.args,{env:process.env,stdio:"ignore"}),o=!1,i=(a)=>{if(o)return;o=!0,clearTimeout(s),t(a)},s=setTimeout(()=>{r.kill(),i(!1)},mh);r.on("error",()=>i(!1)),r.on("close",(a)=>i(a===0))})}function nd(e=Wo,t={}){let n=new Set(t.configuredTargets??[]);return Promise.all(pe.map(async(r)=>({target:r.target,flag:r.flag,label:r.label,...od(t.action,await e(r.probeCommand),n.has(r.target))})))}function rd(e,t){let n=new Set(t.configuredTargets??[]);return e.map((r)=>({...r,...od(t.action,r.available,n.has(r.target))}))}function od(e,t,n){if(e==="uninstall")return n?{available:!0}:{available:!1,unavailableReason:"not installed"};if(e==="install"&&n)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as id,readdirSync as gh,rmSync as hh}from"node:fs";import{join as kt}from"node:path";function or(e,t=process.platform){let n=kt(process.env.npm_config_cache||(t==="win32"?kt(process.env.LOCALAPPDATA||kt(e,"AppData","Local"),"npm-cache"):kt(e,".npm")),"_npx");if(!id(n))return;gh(n).filter((r)=>id(kt(n,r,"node_modules","cc-safety-net"))).forEach((r)=>{hh(kt(n,r),{recursive:!0,force:!0})})}import{existsSync as ad,mkdirSync as yh,readFileSync as ld}from"node:fs";import{dirname as vh,join as sd}from"node:path";var sn="npx -y cc-safety-net hook --kimi-code",Yo=`[[hooks]]
event = "PreToolUse"
command = "${sn}"`,Zo=`{ event = "PreToolUse", command = "${sn}" }`;function cd(e){return sd(process.env.KIMI_CODE_HOME??sd(e,".kimi-code"),"config.toml")}function bh(e){return e.split(`
...
`,t+1);return n===-1?e.length:n+1}function wh(e,t){return Kn(e,t,{skipComment:Lh,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function dd(e){let t=!1,n=0;while(n<e.length){let r=e.indexOf(`
`,n),o=r===-1?e.length:r,i=e.slice(n,o);if(/^\s*\[/.test(i))t=!0;if(!t){let s=/^(\s*)hooks\s*=\s*\[/.exec(i);if(s){let a=n+s[0].lastIndexOf("[");return{start:a,end:wh(e,a)}}}n=r===-1?e.length:r+1}return}function kh(e,t){let n=e.slice(0,t.end).trimEnd(),r=tc(e,t.end),o=r===""?"     ":`${r}  `,i=!n.endsWith("[")&&!n.endsWith(",");return`${n}${i?",":""}
${o}${Zo}${e.slice(t.end)}`}function xh(e){let t=dd(e);if(t&&e.slice(t.start+1,t.end).trim())return kh(e,t);let n=bh(e).trimEnd();if(n==="")return`${Yo}
`;return`${n}

${Yo}
`}function Ch(e){return e.split(/(?=^\s*\[)/m).filter((n)=>!/^\s*\[\[hooks]]\s*$/m.test(n)||!n.includes(sn)).join("").trimEnd()}function Sh(e,t){let n=e.indexOf(Zo,t.start);if(n===-1||n>t.end)return e;return Wn(e,{start:n,end:n+Zo.length})}function ud(e){let t=cd(e);if(yh(vh(t),{recursive:!0}),!ad(t))return O(t,`${Yo}
`),{path:t,alreadyInstalled:!1};let n=ld(t,"utf-8");if(n.includes(sn))return{path:t,alreadyInstalled:!0};return O(t,xh(n)),{path:t,alreadyInstalled:!1}}function pd(e){let t=cd(e);if(!ad(t))return{path:t,alreadyInstalled:!1};let n=ld(t,"utf-8");if(!n.includes(sn))return{path:t,alreadyInstalled:!1};let r=dd(n),o=r?Sh(n,r):`${Ch(n)}
`;return O(t,o),{path:t,alreadyInstalled:!0}}var Qo="safety-net@cc-marketplace",fd=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]),md=new Set(["antigravity-cli","cursor","grok-build","hermes-agent","kimi-code"]);function ti(e){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(e??"")}function bd(e){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(e??"")}function Ph(e){return/^Marketplace `cc-marketplace`\s*$/m.test(e??"")}var Ld={"claude-code":{installCommands:(e)=>{let t=$n(e,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...uo(e).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:$n(e,Qo)?[["claude","plugin","uninstall",Qo]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:async(e,t)=>{let n=t??await ue(["codex","plugin","list"]),r=bd(n);return{commands:[r||Ph(n)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:ti(n)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:r}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:async()=>{let e=await ue(["copilot","plugin","list"]),t=[...rl(e)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...ol(e)?[["copilot","plugin","uninstall",el]]:[]];if(tl(e))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",de]],cleanupCommands:t,update:!0};return{commands:[nl(await ue(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",de]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(e)=>{let t=vo(e);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:_o,installCommands:()=>({commands:Jl()}),uninstallCommands:[["openclaw","plugins","uninstall",A,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:$o,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function sr(){return process.env.HOME??Rh()}function wd(e,t=(n)=>n){try{let n=JSON.parse(t(vd(e,"utf-8")));if(!n||typeof n!=="object"||Array.isArray(n))throw Error(`Settings file ${e} must be a JSON object`);return n}catch(n){if(n instanceof SyntaxError)throw Error(`Failed to parse ${e}: ${n.message}`);throw n}}function Ah(e){let t=Xo(Kt(e),"settings.json");if(!ei(t))return;let n=wd(t,J),r=n.enabledPlugins;if(!r||typeof r!=="object"||Array.isArray(r))return;if(r[de]!==!1)return;let o=vd(t,"utf-8"),i=o.replace(new RegExp(`("${de}"\\s*:\\s*)false`),"$1true");return r[de]=!0,O(t,i!==o?i:`${JSON.stringify(n,null,2)}
`),`Enabled ${de} plugin in ${t}`}function Eh(e){let t=Oo(e);if(!ei(t))return;let n=wd(t);if(!Array.isArray(n.packages))return;let r=n.packages.find((o)=>!!o&&typeof o==="object"&&!Array.isArray(o)&&jo(o.source)&&("extensions"in o));if(!r)return;return delete r.extensions,O(t,`${JSON.stringify(n,null,2)}
`),`Enabled npm:cc-safety-net extensions in ${t}`}function gd(e,t){let n=E({label:t,booleans:Object.fromEntries(pe.map((i)=>[i.target,[i.flag]]))},e),r=n.errors[0];if(r)throw Error(r);let o=pe.filter((i)=>n.flags[i.target]).map((i)=>i.target);if(o.length!==1)throw Error(`Choose exactly one ${t} target: ${pe.map((i)=>i.flag).join(", ")}`);return o[0]}async function kd(e=sr(),t=pt){let[n,r,o]=await Promise.all([t(["amp","plugins","list"],30000),t(["codex","plugin","list"],30000),t(["copilot","--binary-version"])]);return{codexPluginListOutput:r,hooks:vt(process.cwd(),{homeDir:e,ampPluginListOutput:n,codexPluginListOutput:r,copilotCliVersion:o})}}async function _h(e,t=pt){let n=await kd(sr(),t);return n.hooks.filter((r)=>e==="install"?r.configured:r.detected||r.inspectionStatus==="not-inspected").filter((r)=>r.platform!=="codex"||!ti(n.codexPluginListOutput)||bd(n.codexPluginListOutput)).map((r)=>r.platform)}function Th(e,t,n){if(t.length>0)return{finish:async()=>[gd(t,e)]};if(!n.selectTargets&&!Bo(n.input,n.output))return{finish:async()=>[gd(t,e)]};let r=n.detectConfiguredTargets??(()=>_h(e,n.fetchVersion)),o=Promise.all([nd(n.probeTargets),r()]);return{ready:o,finish:async()=>{let[i,s]=await o,a=rd(i,{action:e,configuredTargets:s}),l=n.selectTargets?await n.selectTargets(e,yd(e,a)):await jc(e,yd(e,a),{input:n.input,output:n.output});if(l==="update")return l;if(!l||l.length===0)return null;return Ko(l)}}}async function tt(e,t,n=!1,r){let o=Ld[e];o.beforeInstall?.(t);let i=typeof o.installCommands==="function"?await o.installCommands(t,r):{commands:o.installCommands};return await Po(i.commands),await Ul(i.cleanupCommands??[]),[`${i.update||n?"Updated":"Installed"} ${P(e)} integration`,o.postInstallMessage].filter(Boolean).join(`
`)}async function xt(e){let t=Ld[e];if(!t.uninstallCommands)throw Error(`${P(e)} uninstall is not supported`);return await Po(t.uninstallCommands),`Uninstalled ${P(e)} integration`}function Ih(e){let t=pc(e);return t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`}var $h={"antigravity-cli":{install:Xc,uninstall:Qc},cursor:{install:ml,uninstall:gl},"grok-build":{install:Sl,uninstall:Rl},"kimi-code":{install:ud,uninstall:pd}};function Oe(e,t,n,r=!1){if(e==="install"&&!r)or(n);let o=$h[t][e](n),i=P(t),s=e!=="install"?"Uninstalled":r?"Updated":"Installed";return e==="install"&&o.alreadyInstalled?r?`${i} hook up to date in ${o.path}`:`${i} hook already installed in ${o.path}`:e==="uninstall"&&!o.alreadyInstalled?`${i} hook not installed in ${o.path}`:`${s} ${i} hook ${e==="install"?"in":"from"} ${o.path}`}var Oh={amp:{install:zc,uninstall:Jc,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:_l,uninstall:Tl,afterInstall:async(e)=>{let t=So(e);return await ue(["hermes","plugins","enable",Q,"--no-allow-tool-override"]),!t},beforeUninstall:async(e)=>{Co(e);try{await ue(["hermes","plugins","disable",Q])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
...
`)}var jh={amp:{install:(e,t)=>ir("install","amp",e,t),uninstall:(e)=>ir("uninstall","amp",e)},"antigravity-cli":{install:(e,t)=>Oe("install","antigravity-cli",e,t),uninstall:(e)=>Oe("uninstall","antigravity-cli",e)},"claude-code":{install:(e,t)=>tt("claude-code",e,t),uninstall:()=>xt("claude-code")},codex:{install:(e,t,n)=>tt("codex",e,t,n),uninstall:()=>xt("codex")},"copilot-cli":{install:async(e,t)=>[await tt("copilot-cli",e,t),Ah(e)].filter(Boolean).join(`
`),uninstall:()=>xt("copilot-cli")},cursor:{install:(e,t)=>Oe("install","cursor",e,t),uninstall:(e)=>Oe("uninstall","cursor",e)},"gemini-cli":{install:(e,t)=>tt("gemini-cli",e,t),uninstall:()=>xt("gemini-cli")},"grok-build":{install:(e,t)=>Oe("install","grok-build",e,t),uninstall:(e)=>Oe("uninstall","grok-build",e)},"hermes-agent":{install:(e,t)=>{if(!t)or(e);return ir("install","hermes-agent",e,t)},uninstall:(e)=>ir("uninstall","hermes-agent",e)},"kimi-code":{install:(e,t)=>Oe("install","kimi-code",e,t),uninstall:(e)=>Oe("uninstall","kimi-code",e)},openclaw:{install:async(e,t)=>{let n=await tt("openclaw",e,t);return await Kl(),n},uninstall:(e)=>(_o(e),xt("openclaw"))},opencode:{install:async(e,t)=>{let n=await tt("opencode",e,t);return await lc(e),n},uninstall:(e)=>Ih(e)},pi:{install:async(e,t)=>[await tt("pi",e,t),Eh(e)].filter(Boolean).join(`
`),uninstall:()=>xt("pi")}},hd=["Install CC Safety Net as a native Kimi Code plugin:","","  1. Start Kimi Code and run: /plugins install https://github.com/kenryu42/cc-safety-net","     Confirm the trust prompt; it defaults to cancel.","  2. Run /reload, or start a new session.","","Note: Kimi Code hooks are fail-open. When the hook process cannot start, crashes, or times","out, Kimi Code allows the tool call."].join(`
`);function Fh(e){if(Qt({homeDir:e,cwd:process.cwd()}).status!=="configured")return hd;return[hd,"",y.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function yd(e,t){return t.map((n)=>e==="install"&&n.target==="kimi-code"&&n.unavailableReason==="already installed"?{...n,available:!0,unavailableReason:void 0,label:`${n.label} (global hook installed)`}:n)}function Nh(e,t){if(e.selectKimiInstallMethod)return e.selectKimiInstallMethod();if(!Bo(e.input,e.output))return Promise.resolve("global-hook");return Oc({input:e.input,output:e.output,globalHookInstalled:Qt({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function xd(e,t,n,r=!1,o){return jh[t][e](n,r,o)}function Hh(e){let t=E({label:"update"},e).errors[0];if(t)throw Error(t)}async function Mh(e,t=pt){let n=await kd(e,t),r=Xo(Kt(e),"installed-plugins");return{targets:Ko([...n.hooks.filter((i)=>i.platform!=="copilot-cli"&&i.detected).map((i)=>i.platform),...[On,Qa,Xa].flatMap((i)=>ei(Xo(r,...i))?["copilot-cli"]:[]),...$n(e,Qo)?["claude-code"]:[],...ti(n.codexPluginListOutput)?["codex"]:[]]),codexPluginListOutput:n.codexPluginListOutput}}async function Uh(e){let t=sr(),n=e.output??process.stdout,r=(e.scriptPath??process.argv[1]??"").split(/[\\/]/),o=r.find((u)=>/^bunx-\d+-/.test(u)),i=o!==void 0||r.includes("_npx")?null:(e.checkLatestVersion??Te)(),s=async()=>{let u=i&&await i;if(u?.updateAvailable)n.write(`
...
`)},a=Mh(t,e.fetchVersion??pt).then(async(u)=>{let p=new Set(u.targets);return{targets:u.targets,codexPluginListOutput:u.codexPluginListOutput,available:new Map(await Promise.all(pe.filter((f)=>p.has(f.target)&&fd.has(f.target)).map(async(f)=>[f.target,await Wo(f.probeCommand)])))}}),l=await Jt(e.showBanner??!0,()=>({ready:a,finish:()=>a}),()=>zt({input:e.input??process.stdin,output:n}),{loadingMessage:"Checking installed integrations…",output:n}),c=await Promise.resolve().then(()=>(ed(Dh(),process.platform,o),null)).catch((u)=>an(u));if(l.targets.length===0){if(n.write("No installed integrations found. Run `cc-safety-net install` to set one up.\n"),c!==null)console.error(c);return await s(),c===null?0:1}let d=l.targets.some((u)=>md.has(u))?await Promise.resolve().then(()=>(or(t),null)).catch((u)=>an(u)):null,m=await _n(Promise.all(l.targets.map((u)=>{if(fd.has(u)&&!l.available.get(u))return Promise.resolve({message:`${P(u)} not found; skipped`,failed:!1});if(d!==null&&md.has(u))return Promise.resolve({message:d,failed:!0});return xd("install",u,t,!0,l.codexPluginListOutput).then((p)=>({message:p,failed:!1}),(p)=>({message:an(p),failed:!0}))})),{loadingMessage:`Updating ${l.targets.length} integration${l.targets.length===1?"":"s"}…`,output:n}),g=c===null?m:[...m,{message:c,failed:!0}];return g.forEach((u)=>{u.failed?console.error(u.message):n.write(`${u.message}
`)}),await s(),g.some((u)=>u.failed)?1:0}function ni(e,t={}){return Promise.resolve().then(()=>Hh(e)).then(()=>Uh(t)).catch((n)=>(console.error(an(n)),1))}async function ln(e,t,n={}){try{let r=await Jt(!0,()=>Th(e,t,n),()=>zt({input:n.input??process.stdin,output:n.output??process.stdout}),{loadingMessage:e==="install"?"Checking available integrations…":"Checking installed integrations…",output:n.output??process.stdout});if(!r)return(n.output??process.stdout).write(`Cancelled: nothing was ${e}ed.
`),0;if(r==="update")return(n.runUpdate??(()=>ni([],{fetchVersion:n.fetchVersion,input:n.input,output:n.output,showBanner:!1})))();let o=sr(),i=n.output??process.stdout;return await td(r,async(s)=>{if(s==="kimi-code"&&e==="install"){let l=await Nh(n,o);if(l===null){i.write(`Cancelled: Kimi Code integration was not installed.
`);return}if(l==="plugin"){i.write(`${Fh(o)}
`);return}}let a=await _n(xd(e,s,o),{loadingMessage:`${e==="install"?"Installing":"Uninstalling"} ${P(s)} integration…`,output:i});i.write(`${a}
...
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,Yd=[{binary:"zenity",args:["--file-selection","--directory",`--title=${ur}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",ur]}],Zd=(e,t)=>(t.PATH??"").split(Yy).some((n)=>{if(n.length===0)return!1;try{let r=Wd(Zy(n,e));return r.isFile()&&(r.mode&73)!==0}catch{return!1}});function ai(e,t){if(e==="darwin"||e==="win32")return!0;if(e!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return Yd.some((n)=>Zd(n.binary,t))}function t0(e,t){if(e==="darwin")return{cmd:"osascript",args:["-e",Qy]};if(e==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",e0]};let n=Yd.find((r)=>Zd(r.binary,t));return n?{cmd:n.binary,args:n.args}:null}function li(e=process.platform,t=process.env){let n=t0(e,t);if(!n)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let o=Ky(n.cmd,n.args,{env:t,stdio:["ignore","pipe","pipe"]}),i="",s=!1,a=(c)=>{if(s)return;s=!0,clearTimeout(l),r(c)},l=setTimeout(()=>{o.kill(),a({error:"The folder dialog timed out"})},Xy);o.stdout.on("data",(c)=>{i+=c.toString()}),o.on("error",()=>a({error:`Could not open the folder dialog (${n.cmd})`})),o.on("close",()=>{let c=i.trim().replace(/\/+$/,"");if(!c)return a({cancelled:!0});if(!Wy(c)||!Wd(c).isDirectory())return a({error:"That selection is not a folder on disk"});a({path:c})})})}var Xd=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
var refreshPolicyPreview = async () => {
  ...
  const result = await requestPolicyPreview(effectivePreviewPolicy(collectFormPolicy(), projectDraft && projectDraft.baseline));
...
var runCommandTest = async () => {
  ...
  const result = await requestJson("/api/policy/explain", {
    ...
    body: JSON.stringify({
      command,
      policy: effectivePreviewPolicy(collectFormPolicy(), projectDraft && projectDraft.baseline)
    })
  });
...
`;var Qd='<script id="ccsn-data" type="application/json">';function eu(e){return Xd.replace(Qd,()=>Qd+JSON.stringify({token:e}).replaceAll("<","\\u003c"))}var pr="kenryu42/cc-safety-net",s0=`https://github.com/${pr}`,ui=1e4,a0=7,l0="The project draft directory changed; reload the draft before applying.",c0="audit settings are user scope only; remove the audit section from a project proposal";async function fu(e,t={}){let n=E({label:"gui",booleans:{noOpen:["--no-open"]}},e),r=t.log??console.log,o=t.error??console.error;if(n.errors.length>0){for(let s of n.errors)o(s);return o("Usage: cc-safety-net gui [--no-open]"),1}let i=await d0(t);if(r(`CC Safety Net policy GUI: ${i.url}`),!n.flags.noOpen)try{await(t.openBrowser??w0)(i.url)}catch(s){o(`Failed to open browser: ${s instanceof Error?s.message:String(s)}`),o(`Open this URL manually: ${i.url}`)}if(t.keepAlive===!1)return await i.close(),0;return await L0(i),0}async function d0(e={}){let t=n0(24).toString("base64url"),n={dir:null,revision:0},r=o0((s,a)=>{u0(s,a,t,e,n)});await new Promise((s,a)=>{r.once("error",a),r.listen(0,"127.0.0.1",()=>{r.off("error",a),s()})});let i=`http://127.0.0.1:${r.address().port}`;return{origin:i,token:t,url:`${i}/?token=${encodeURIComponent(t)}`,close:()=>b0(r)}}async function u0(e,t,n,r,o){let i=new URL(e.url??"/","http://127.0.0.1");if(e.method==="GET"&&i.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!h0(e,i,n)){C(t,403,{error:"Forbidden"});return}if(e.method==="GET"&&i.pathname==="/"){v0(t,eu(n));return}if(e.method==="GET"&&i.pathname==="/api/policy"){let s=su(r),a=z(r);C(t,200,{...s,configState:Ht(a),...a.policyScopes?{projectPolicy:{path:se(r.cwd),weakenings:a.policyScopes.weakenings}}:{},destructiveCommandRules:$t,secretPatterns:ou,version:I(),preview:s.errors.length>0?null:lu(s.policy)});return}if(e.method==="POST"&&i.pathname==="/api/policy/preview"){let s=await dn(e);if(!s.ok){C(t,s.status,{errors:[s.error]});return}let a=au(s.value);C(t,a.errors.length>0?400:200,a);return}if(e.method==="POST"&&i.pathname==="/api/policy/explain"){let s=await dn(e);if(!s.ok){C(t,s.status,{errors:[s.error]});return}let a=s.value;if(a===null||typeof a.command!=="string"){C(t,400,{errors:["command must be a string"]});return}let l=Ee(a.policy);if(l.length>0){C(t,400,{errors:l});return}C(t,200,m0(a.command,a.policy,r));return}if(e.method==="POST"&&i.pathname==="/api/policy"){let s=await dn(e);if(!s.ok){C(t,s.status,{errors:[s.error]});return}let a=cn(s.value,r);C(t,a.errors.length>0?400:200,a);return}if(e.method==="POST"&&i.pathname==="/api/reset"){C(t,200,cn(iu,r));return}if(e.method==="POST"&&i.pathname==="/api/repair"){C(t,200,cu(r));return}if(e.method==="POST"&&i.pathname==="/api/policy/project/choose-directory"){let s=await(r.chooseDirectory??li)();if("path"in s)o.dir=s.path,o.revision+=1;C(t,200,{dir:ci(o,r),revision:o.revision,cancelled:"cancelled"in s,..."error"in s?{error:s.error}:{}});return}if(e.method==="GET"&&i.pathname==="/api/policy/project"){let s=ci(o,r),a=tu(s),l=lt(r);C(t,200,{dir:s,path:se(s),revision:o.revision,exists:a.exists,baseline:l.baseline,userPolicyDiagnostics:l.diagnostics,projection:a.projection,projectionDiagnostics:a.diagnostics,canPickDirectory:ai(process.platform,process.env)});return}if(e.method==="POST"&&i.pathname==="/api/policy/project/diff"){let s=await nu(e,t,o,r);if(!s)return;let a=tu(s.dir),l=lt(r).baseline,c=Ge(l,Be(s.proposal).policy);C(t,200,{rows:jt(Ge(l,a.projection).policy,c.policy,!1),weakenings:c.weakenings,existingFileDiagnostics:a.diagnostics,errors:[]});return}if(e.method==="POST"&&i.pathname==="/api/policy/project/apply"){let s=await nu(e,t,o,r);if(!s)return;let a=f0(s.dir,s.proposal);C(t,a.errors.length>0?500:200,a);return}if(e.method==="GET"&&i.pathname==="/api/activity"){let s=ct(r),a=g0(i.searchParams.get("days"),s);if(a===null){C(t,400,{error:`days must be an integer between 1 and ${s}`});return}C(t,200,Kd(a,r.activityLogsDir));return}if(e.method==="POST"&&i.pathname==="/api/rules/choose-directory"){C(t,200,await li());return}if(e.method==="GET"&&i.pathname==="/api/rules"){let s=Pe(r),a=new Map(s.rules.map((l)=>[l.name,l]));C(t,200,{projectPath:r.cwd??process.cwd(),canPickDirectory:ai(process.platform,process.env),rulebooks:s.rulebooks.map((l)=>({source:l.source,spec:l.spec,name:l.name,version:l.version,rules:l.rules.flatMap((c)=>{let d=a.get(c);if(!d)return[];return[{name:d.name,command:d.command,subcommand:d.subcommand,block_args:d.block_args,reason:d.reason}]})})),errors:s.errors,warnings:s.warnings});return}if(e.method==="GET"&&i.pathname==="/api/star/context"){C(t,200,await(r.fetchStarContext??(()=>R0({logsDir:r.activityLogsDir})))());return}if(e.method==="POST"&&i.pathname==="/api/star"){let s=await(r.starRepo??k0)();C(t,200,s.ok?{ok:!0}:{ok:!1,fallbackUrl:s0});return}if(e.method==="GET"&&i.pathname==="/api/integrations"){C(t,200,await(r.fetchIntegrations??x0)());return}if(e.method==="GET"&&i.pathname==="/api/health"){C(t,200,await(r.fetchHealth??C0)());return}if(e.method==="POST"&&(i.pathname==="/api/install"||i.pathname==="/api/uninstall")){let s=await dn(e);if(!s.ok){C(t,s.status,{errors:[s.error]});return}let a=s.value?.target;if(typeof a!=="string"||!pe.some((c)=>c.target===a)){C(t,400,{error:"unknown target"});return}let l=i.pathname==="/api/install"?"install":"uninstall";C(t,200,await(r.runIntegration??S0)(l,a));return}C(t,404,{error:"Not found"})}function ci(e,t){return e.dir??t.cwd??process.cwd()}function tu(e){let t=se(e),n=r0(t),r=n?_e(t):{value:void 0,errors:[]},o=Be(r.value);return{exists:n,projection:o.policy,diagnostics:[...r.errors,...o.diagnostics]}}async function nu(e,t,n,r){let o=ci(n,r),i=n.revision,s=await dn(e);if(!s.ok)return C(t,s.status,{errors:[s.error]}),null;let a=s.value;if(typeof a?.revision!=="number")return C(t,400,{errors:["revision must be a number"]}),null;if(a.revision!==i)return C(t,409,{errors:[l0]}),null;let l=p0(a.proposal);if(l.length>0)return C(t,400,{errors:l}),null;return{dir:o,proposal:a.proposal}}function p0(e){let t=Ee(e);if(t.length>0)return t;return e?.audit===void 0?[]:[c0]}function f0(e,t){let n=se(e),r=Ft(t,Y(t));try{return B(x(Rt(e,"project policy"),n),`${JSON.stringify(r,null,2)}
`),{path:n,errors:[]}}catch(o){return{path:n,errors:[o instanceof Error?o.message:String(o)]}}}function m0(e,t,n){let r=Y(t),o=z(n),i=Ot({rules:o.policy.rules,transparentWrappers:o.policy.transparentWrappers,safety:uu(r.safety),worktreeMode:r.workflow.worktree_mode,destructiveCommandProtectionEnabled:r.destructive_command_protection.enabled,destructiveCommandRuleOverrides:r.destructive_command_protection.overrides,destructiveCommandAllowPaths:r.destructive_command_protection.allow_paths,secretProtection:{enabled:r.secret_protection.enabled,disabledRules:du(r.secret_protection.overrides),denyPaths:r.secret_protection.deny_paths,allowPaths:r.secret_protection.allow_paths}});return at(e,{policySnapshot:i,cwd:n.cwd,userConfigDir:n.userConfigDir})}function g0(e,t){if(e===null)return Math.min(a0,t);let n=Number(e);if(!Number.isInteger(n)||n<1||n>t)return null;return n}function h0(e,t,n){if(t.searchParams.get("token")!==n)return!1;if(e.method!=="POST")return!0;return e.headers["x-cc-safety-net-token"]===n}var y0=1048576;async function dn(e){let t=[],n=0;for await(let r of e){let o=r;if(n+=o.byteLength,n>y0)return{ok:!1,status:413,error:"Request body is too large"};t.push(o)}try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(r){return{ok:!1,status:400,error:`Invalid JSON: ${r instanceof Error?r.message:String(r)}`}}}function v0(e,t){e.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),e.end(t)}function C(e,t,n){e.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),e.end(JSON.stringify(n))}function b0(e){return new Promise((t,n)=>{e.close((r)=>r?n(r):t())})}function L0(e){return new Promise((t)=>{let n=()=>{process.off("SIGINT",r),process.off("SIGTERM",r)},r=()=>{n(),e.close().then(t)};process.once("SIGINT",r),process.once("SIGTERM",r)})}function w0(e){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",n=process.platform==="win32"?["/c","start","",e]:[e];return new Promise((r,o)=>{let i=pu(t,n,{detached:!0,stdio:"ignore"}),s=(l)=>{i.off("spawn",a),o(l)},a=()=>{i.off("error",s),i.unref(),r()};i.once("error",s),i.once("spawn",a)})}async function k0(e="gh",t=ui){return{ok:await di(e,["api","-X","PUT",`/user/starred/${pr}`],t)===0}}async function x0(e={}){let t=await qt(e.fetcher),n=mu(t,e.homeDir);return{targets:X.map((r)=>{let o=n.find((i)=>i.platform===r.id);return{target:r.id,label:P(r.id),version:t.versions[r.id]??null,status:o?.configured?"active":o?.detected?"disabled":o?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function mu(e,t){return vt(process.cwd(),{homeDir:t,ampPluginListOutput:e.ampPluginListOutput,codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.versions["copilot-cli"]})}async function C0(e={}){let[t,n]=await Promise.all([qt(e.fetcher),(e.checkUpdates??Te)()]);return{hooks:mu(t,e.homeDir).filter((r)=>r.detected).map((r)=>({platform:r.platform,label:P(r.platform),configured:r.configured})),update:{currentVersion:n.currentVersion,latestVersion:n.latestVersion??null,updateAvailable:n.updateAvailable}}}var ru=Promise.resolve();function S0(e,t,n={}){let r=async()=>{let i=[],s=console.log,a=console.error;console.log=(...l)=>i.push(l.map(String).join(" ")),console.error=console.log;try{return{ok:await ln(e,[],{selectTargets:async()=>[t],output:new i0({write(c,d,m){i.push(String(c).replace(/\n$/,"")),m()}}),...n})===0,output:i.join(`
`)}}finally{console.log=s,console.error=a}},o=ru.then(r);return ru=o.then(()=>{return},()=>{return}),o}async function R0(e={}){let[t,n,r]=await Promise.all([D0(e.command),P0(e.fetchRepo),Promise.resolve(Sn(ct(),e.logsDir).totalBlocked)]);return{starred:t,starCount:n,blockedTotal:r}}async function D0(e="gh",t=ui){if(await di(e,["auth","status"],t)!==0)return null;let n=await di(e,["api",`/user/starred/${pr}`],t);if(n===0)return!0;if(n===null)return null;return!1}function di(e,t,n){return new Promise((r)=>{let o=pu(e,t,{stdio:"ignore",windowsHide:!0}),i=!1,s,a=(l)=>{if(i)return;if(i=!0,s)clearTimeout(s);r(l)};o.once("error",()=>a(null)),o.once("close",a),s=setTimeout(()=>{o.kill(),a(null)},n)})}async function P0(e=fetch){try{let t=await e(`https://api.github.com/repos/${pr}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(ui)});if(!t.ok)return null;let n=await t.json();return typeof n.stargazers_count==="number"?n.stargazers_count:null}catch{return null}}function A0(e){if(e[0]!=="help")return!1;let t=e[1];if(!t)Go(),process.exit(0);if(rn(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var E0={hook:async(e)=>{let t=Xs(e);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),rn("hook",console.error),process.exit(1)},install:async(e)=>{process.exit(await ln("install",e))},update:async(e)=>{process.exit(await ni(e))},uninstall:async(e)=>{process.exit(await ln("uninstall",e))},rule:async(e)=>{process.exit(await zd(e))},policy:async(e)=>{process.exit(await Dd(e))},status:async(e)=>{if(fe(E({label:"status"},e).errors))process.exit(1);Jd()},statusline:async(e)=>{let t=E({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},e);if(t.errors.length===0&&t.flags.claudeCode){await ii();return}if(fe(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");rn("statusline",console.error),process.exit(1)},doctor:async(e)=>{let t=Fo(e);if(!t)process.exit(1);let n=await hc({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(n)},logs:async(e)=>{process.exit(await Ls(e))},gui:async(e)=>{process.exit(await fu(e))},explain:async(e)=>{process.exit(await xc(e))}};async function _0(){let e=process.argv.slice(2),t=E({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},e);if(A0(e))return;let n=e[0],r=n?Cn(n):void 0;if(t.help&&r&&r.name!=="rule")rn(r.name),process.exit(0);if(!n||t.help&&!r)Go(),process.exit(0);if(t.flags.version)Rc(),process.exit(0);if(r){await E0[r.name](e.slice(1));return}let o=Qs(n);if(o){await o.run();return}if(n==="--statusline"){await ii();return}console.error(n.startsWith("-")?`Unknown option: ${n}`:`Unknown command: ${n}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}_0().catch((e)=>{console.error("CC Safety Net error:",e),process.exit(1)});
