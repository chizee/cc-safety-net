#!/usr/bin/env node
import{$ as ae,$a as Cr,A as un,Aa as Zr,B as n3,Ba as ee,C as P,Ca as Qr,D as C,Da as Xr,E as Ot,Ea as O,F as Ht,Fa as Kt,G as Wn,Ga as Tt,H as At,Ha as _t,I as U2,Ia as T,J as $2,Ja as m3,K as Et,Ka as fn,L as s2,La as k3,M as b1,Ma as fr,N as re,Na as q3,O as Rn,Oa as j3,P as f1,Pa as z3,Q as h1,Qa as Lt,R as Mn,Ra as F3,S as Vn,Sa as B3,T as yn,Ta as e1,U as wn,Ua as r1,V as _r,Va as a1,W as vn,Wa as l1,X as g2,Xa as a3,Y as Pt,Ya as Gr,Z as C2,Za as Ur,_ as y1,_a as Mt,aa as $1,ab as Or,b as $r,ba as g1,bb as v2,c as gr,ca as Er,cb as x2,d as A,da as jr,db as l2,e as Dr,ea as Pr,eb as Tr,f as Qt,fa as Ir,fb as W,g as Q,ga as Nr,gb as hn,h as D,ha as It,hb as on,i as cn,ia as zr,ib as x1,j as g,ja as m,jb as m2,k as w2,ka as Nt,kb as c2,l as Ar,la as w1,lb as B1,m as W2,ma as d2,mb as Kn,n as Ln,na as bn,o as L3,oa as ne,p as St,pa as te,q as Wr,qa as n1,r as pn,ra as t1,s as Rr,sa as Fr,t as Ct,ta as V2,u as Kr,ua as Wt,v as Mr,va as Rt,w as _,wa as Vr,x as E,xa as H2,y as K2,ya as D3,z as M2,za as Jr}from"../chunks/index-e9e5za60.js";var S3=["-h","--help"];function z(n,t){let e=Object.entries(n.booleans??{}),r=Object.entries(n.values??{}),a=Object.fromEntries(e.map(([i])=>[i,!1])),l={},d=[],s=[],c=!1,L=-1;for(let[i,u]of t.entries()){if(i<=L)continue;if(u==="--"){d.push(...t.slice(i+1));break}if(S3.includes(u)){c=!0;continue}let o=e.find(([,f])=>f.includes(u));if(o){a[o[0]]=!0;continue}let p=r.find(([,f])=>f.includes(u));if(p){let f=t[i+1];if(f===void 0||f.startsWith("-")){s.push(`${u} requires a value`);continue}l[p[0]]=f,L=i+1;continue}if(u.startsWith("-")){s.push(`Unknown option for ${n.label}: ${u}`);continue}if(n.positionals==="tail"){d.push(...t.slice(i));break}d.push(u)}if(n.positionals!=="list"&&n.positionals!=="tail")s.push(...d.map((i)=>`Unexpected argument for ${n.label}: ${i}`));return{flags:a,values:l,positionals:d,help:c,errors:s}}function r2(n){for(let t of n)console.error(t);return n.length>0}import{readdirSync as $d,statSync as s1,unlinkSync as gd}from"node:fs";import{basename as c1,dirname as Dd,join as md,resolve as kd}from"node:path";function F(n){return Array.from(n,(t)=>{let e=t.charCodeAt(0);if(e<=31||e>=127&&e<=159)return`\\x${e.toString(16).padStart(2,"0")}`;return t}).join("")}var Ft=(n)=>{let t=Date.now()-new Date(n).getTime();if(!Number.isFinite(t))return"";let e=Math.floor(t/60000),r=Math.floor(e/60),a=Math.floor(r/24);if(a>0)return`${a}d ago`;if(r>0)return`${r}h ago`;if(e>0)return`${e}m ago`;return"just now"},X2=(n)=>{let t=(n??"").trim().split(/\s+/).filter((a)=>a&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(a)),e=t[0]?.split("/").pop();if(!e)return null;let r=t[1];return r&&/^[a-z][a-z0-9-]*$/.test(r)?`${e} ${r}`:e};import{existsSync as H3,readdirSync as A3,readFileSync as W3}from"node:fs";import{join as R3}from"node:path";function u2(n,t){try{return A3(n,{withFileTypes:!0,encoding:"utf8"}).flatMap((e)=>{let r=R3(n,e.name);if(e.isDirectory())return u2(r,t);if(e.name.endsWith(".jsonl"))return[r];return[]})}catch{if(t&&H3(n))t.count++;return[]}}function Bt(n){let t=(a)=>`${a.sessionId}
${X2(a.segment||a.command)}`,e=n.filter((a)=>a.decision!=="allow"),r=e.filter((a)=>a.sessionId).reduce((a,l)=>a.set(t(l),(a.get(t(l))??0)+1),new Map);return new Set(e.filter((a)=>a.failureStage||(r.get(t(a))??0)>=2))}function sn(n,t){try{return W3(n,"utf-8").split(`
`).filter(Boolean).flatMap((e)=>{try{return[JSON.parse(e)]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as vd}from"node:path";var K3=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function mr(n){let t=0,e={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(r){n.record({kind:"step",scope:"global",step:r})},recordSegment(r,a=e.currentSegmentIndex){if(a===void 0)return;n.record({kind:"step",scope:"segment",segmentIndex:a,step:r})}};return e}function kr(n={}){let t=[],e=n.maxEvents??512,r={maxTextLength:n.maxTextLength??2048,maxListLength:n.maxListLength??128,maxObjectProperties:n.maxObjectProperties??n.maxListLength??128,maxDepth:n.maxDepth??16},a=0,l,d=new Set;return{record(s){if(l)return;try{if(!s||t.length>=e){a++;return}t.push(Zt(M3(s,r,d)))}catch{a++}},finish(s){if(l)return l;try{l=Zt({events:Object.freeze(t),droppedEvents:a,terminal:V3(s,r,d)})}catch{a++,l=Object.freeze({events:Object.freeze(t),droppedEvents:a,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,r.maxTextLength),segment:"trace unavailable".slice(0,r.maxTextLength)})})}return l}}}function M3(n,t,e){if(n.kind!=="step")throw TypeError("invalid trace event");let{scope:r,step:a}=n;Sn(a,e,t);let l=Y2(a,t,e);if(r==="global")return{kind:"step",scope:"global",step:l};if(r!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:n.segmentIndex,step:l}}function V3(n,t,e){let r=n.result;if(r==="allowed")return Object.freeze({result:"allowed"});if(r!=="blocked")throw TypeError("invalid trace terminal");let a=n.ruleId;return Object.freeze({result:"blocked",reason:Y2(n.reason,t,e),segment:Y2(n.segment,t,e),...a?{ruleId:Y2(a,t,e)}:{}})}function Sn(n,t,e,r=0,a=new WeakSet){if(typeof n==="string"){let s=n.slice(0,e.maxTextLength);if(!Qt(s))return;for(let c of Dr(s))for(let L of c.match(/[^\s"'()$]+/g)??[])t.add(qr(L));return}if(!n||typeof n!=="object"||r>=e.maxDepth||a.has(n))return;if(a.add(n),Array.isArray(n)){let s=Math.min(n.length,e.maxListLength);for(let c=0;c<s;c++)Sn(n[c],t,e,r+1,a);return}let l=0,d=new Set;for(let s in n){if(!Object.hasOwn(n,s))continue;if(l>=e.maxObjectProperties)break;l++,Sn(s,t,e);let c=Jt(s,e,t);if(d.has(c))continue;d.add(c),Sn(n[s],t,e,r+1,a)}}function Y2(n,t,e,r=0,a=new WeakSet){if(typeof n==="string")return Jt(n,t,e);if(!n||typeof n!=="object")return n;if(r>=t.maxDepth)return;if(a.has(n))return;if(a.add(n),Array.isArray(n)){let s=[],c=Math.min(n.length,t.maxListLength);for(let L=0;L<c;L++)s.push(Y2(n[L],t,e,r+1,a));return s}let l={},d=0;for(let s in n){if(!Object.hasOwn(n,s))continue;if(d>=t.maxObjectProperties)break;d++;let c=Jt(s,t,e);if(Object.hasOwn(l,c))continue;Object.defineProperty(l,c,{value:Y2(n[s],t,e,r+1,a),enumerable:!0,configurable:!0,writable:!0})}return l}function Jt(n,t,e){let r=n.slice(0,t.maxTextLength),a=Qt(r)?gr(r):r,l=e.size>0?U3(a,e):a;return(G3(l)?$r(l):l).slice(0,t.maxTextLength)}function G3(n){return n.includes("PRIVATE KEY")||n.includes("://")||n.includes("eyJ")||n.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(n)||n.length>=14&&K3.some((t)=>n.includes(t))||n.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(n)}function U3(n,t){return n.replace(/[^\s"'()$]+/g,(e)=>t.has(qr(e))?"<redacted>":e)}function qr(n){let t=2166136261,e=2166136261;for(let r=0;r<n.length;r++)t=Math.imul(t^n.charCodeAt(r),16777619),e=Math.imul(e^n.charCodeAt(n.length-r-1),16777619);return`${t>>>0}:${e>>>0}:${n.length}`}function Zt(n){if(n&&typeof n==="object"&&!Object.isFrozen(n)){for(let t of Object.values(n))Zt(t);Object.freeze(n)}return n}function Br(n,t,e,r){let a=r??jr(),l=e??a.getCommandProgram(n,t.shell??"auto"),d=kr(),s=mr(d),c=l.dialect==="powershell"?a.getCommandProgram(n,"posix"):l,L=zr(c);s.recordGlobal({type:"parse",input:n,segments:L.map((o)=>[...o])});let i=Fr(n,{...t,analyzePartialProgram:!0,trace:s},l,a),u=s.getNextSegmentIndex();if(i&&u>0&&u<L.length)s.recordSegment({type:"segment-skipped",index:u,reason:"prior-segment-blocked"},u);return Object.freeze({decision:i,trace:d.finish(i?{result:"blocked",reason:i.reason,segment:i.evidence.find((o)=>o.kind==="command")?.segment??n,...i.ruleId?{ruleId:i.ruleId}:{}}:{result:"allowed"}),program:l})}import{resolve as C3}from"node:path";function Xt(n){let t=Jr().safeParse(n);return{errors:t.success?[]:Qr(t.error.issues),ruleNames:new Set(Zr(n).map((e)=>e.toLowerCase()))}}function Yt(n){let t=Yr(n);if(!t.ok)return t.result;return Xt(t.parsed)}function Yr(n){let t=[],e=new Set;try{let r=typeof n==="string"?cn(n):n,a=g(r);if(a===null)return t.push(`File not found: ${r.path}`),{ok:!1,result:{errors:t,ruleNames:e}};if(!a.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:e}};return{ok:!0,parsed:JSON.parse(a)}}catch(r){if(r instanceof Q)return t.push(r.message),{ok:!1,result:{errors:t,ruleNames:e}};let a=r instanceof Error?r.message:String(r);return t.push(r instanceof SyntaxError?"Invalid JSON":a),{ok:!1,result:{errors:t,ruleNames:e}}}}function Sr(n){return C3(n??process.cwd(),".safety-net.json")}function a2(n){let t=Yr(n);if(!t.ok)return t.result;let e=Xr(t.parsed);return{errors:e.errors,ruleNames:e.sources}}import{isAbsolute as O3,join as Hn,relative as T3,resolve as Hr,sep as _3}from"node:path";async function R2(n={}){let t=Gt(n);return E3(t,await An(t,H2()))}function E3(n,t){if(!t.ok)return t;let e=C(n),r=[...new Set(l2(e.configPath,e.lockPath,n,e.filesystemScope))];if(r.length===0)return t;return{ok:!1,errors:r,warnings:t.warnings,entries:t.entries}}async function An(n,t,e,r={}){let a=null,l=!1;try{let d=C(n),s=Kt(d.configTarget);if(!s.ok)return s.result;let c=s.config;if(n.check)return ed(c,d,n);a={target:d.lockTarget,content:g(d.lockTarget)};let L=Mt(d.lockTarget);if(L.errors.some((h)=>h.startsWith("Unable to access ")))return{ok:!1,errors:L.errors,warnings:[],entries:[]};if(n.only&&L.errors.length>0)return{ok:!1,errors:L.errors,warnings:[],entries:[]};let i=L.errors.length>0?null:L.lock,u=n.only?Gr(c,i,n.only):{ok:!0,specs:c.rules};if(!u.ok)return u.result;if(n.only&&!i&&u.specs.length<c.rules.length)return{ok:!1,errors:[`No lockfile available for partial update; run ${Mr}`],warnings:[],entries:[]};let o=(await I3(u.specs,(h)=>Cr(h,d.configDir,n,i,d.filesystemScope,t),t)).map((h)=>rd(h,i,e));for(let h of o)dd(h.content,h.entry,d.configDir,n,d.filesystemScope);let p=n.only?ad(c,i,o):o.map((h)=>h.entry);l=!0,T(d.lockTarget,{version:1,rulebooks:p},void 0,r._testAfterPolicyRename);let f=new Map(o.map((h)=>[h.entry.spec,h.rulebook.rules.length])),v=sd(p,d.configDir,n,d.filesystemScope,r);return{ok:!0,errors:[],warnings:v,entries:p.map((h)=>ld(h,f))}}catch(d){if(l&&a)try{S2(a.target,a.content)}catch(s){return A2(s)}return A2(d)}}async function Vt(n,t={}){return P3(n,Gt(t),H2())}async function P3(n,t,e,r={}){let a=null,l=!1;try{let d=C(t),s=g(d.configTarget);a={target:d.configTarget,content:s};let c=Kt(d.configTarget);if(!c.ok)return c.result;let L=c.config,i=Kr(n)?await Or(n,e):[{spec:n}],u=i.map((f)=>f.spec),o=[...new Set([...L.rules,...u])];if(o.length>Wt)return N3();if(o.length!==L.rules.length)l=!0,T(d.configTarget,{version:1,rules:o,overrides:L.overrides??{},transparent_wrappers:L.transparent_wrappers??[]},void 0,r._testAfterPolicyRename);let p=await An(t,e,new Map(i.filter((f)=>!!f.display_ref).map((f)=>[f.spec,f.display_ref])),r);if(!p.ok)S2(d.configTarget,s);return p}catch(d){if(l&&a)try{S2(a.target,a.content)}catch(s){return A2(s)}return A2(d)}}async function I3(n,t,e=H2()){if(n.length>Wt)throw Error(Rt);let r=Array(n.length),a=0,l,d=Array.from({length:Math.min(n.length,Vr.concurrency)},async()=>{while(!l){let s=a;if(s>=n.length)return;a++;try{r[s]=await t(n[s],s,e.controller.signal)}catch(c){if(!l)l={value:c},a=n.length,e.controller.abort(c);return}}});if(await Promise.all(d),l)throw l.value;return r}function N3(){return{ok:!1,errors:[Rt],warnings:[],entries:[]}}function Gt(n){return{cwd:n.cwd,cacheConfigDir:n.cacheConfigDir,userConfigDir:n.userConfigDir,userConfigPath:n.userConfigPath,projectConfigPath:n.projectConfigPath,global:n.global,check:n.check,only:n.only,refresh:n.refresh}}function nd(n){return{...Gt(n),deleteSource:n.deleteSource}}async function Ut(n,t={}){try{return await td(n,nd(t),{})}catch(e){return A2(e)}}async function td(n,t,e){let r=C(t),a=O(r.configTarget);if(a.errors.length>0)return{ok:!1,errors:a.errors,warnings:[],entries:[]};if(!a.config)return{ok:!1,errors:[`No config found at ${r.configPath}`],warnings:[],entries:[]};let l=Mt(r.lockTarget);if(l.errors.length>0)return{ok:!1,errors:l.errors,warnings:[],entries:[]};let d=Ur(a.config.rules,l.lock,n);if(!d.ok)return d.result;let s=t.deleteSource?cd(r.configDir,d.specs,l.lock,r.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let c=g(r.configTarget);if(c===null)return A2(Error("Rules config is unavailable."));try{T(r.configTarget,{version:1,rules:a.config.rules.filter((u)=>!d.specs.includes(u)),overrides:a.config.overrides??{},transparent_wrappers:a.config.transparent_wrappers??[]},void 0,e._testAfterPolicyRename)}catch(u){throw S2(r.configTarget,c),u}let L=await An(t,H2(),void 0,e);if(!L.ok)return S2(r.configTarget,c),L;let i=id(s.dirs,e,r.filesystemScope);if(!i.ok){S2(r.configTarget,c);let u=await An(t,H2(),void 0,e);if(!u.ok)return{ok:!1,errors:[...i.result.errors,...u.errors],warnings:u.warnings,entries:u.entries};return i.result}return L}async function ed(n,t,e){let r=Tr(n,t.lockPath,t.configDir,e,e.global?"user":"project",t.filesystemScope);return{ok:r.errors.length===0&&r.warnings.length===0,errors:[...r.errors,...r.warnings],warnings:[],entries:r.entries}}function rd(n,t,e){let r=t?.rulebooks.find((l)=>l.spec===n.entry.spec&&l.kind==="github"),a=e?.get(n.entry.spec)??(r?.kind==="github"?r.display_ref:void 0);if(!a||n.entry.kind!=="github")return n;return{...n,entry:{...n.entry,display_ref:a}}}function ad(n,t,e){let r=new Set(n.rules),a=new Set(t?.rulebooks.map((d)=>d.spec)??[]),l=new Map(e.map((d)=>[d.entry.spec,d.entry]));return[...(t?.rulebooks.filter((d)=>r.has(d.spec))??[]).map((d)=>l.get(d.spec)??d),...e.filter((d)=>!a.has(d.entry.spec)).map((d)=>d.entry)]}function ld(n,t){return{...n,ruleCount:t.get(n.spec)}}function dd(n,t,e,r,a){let l=Ht(t,At(e,r));w2(D(a,l),n)}function sd(n,t,e,r,a){let l=At(t,e),d=Wn(l),s=D(r,d),c=W2(s);if(!c)return[];let L=n.map((u)=>D(r,Ht(u,l))),i=c.filter((u)=>u.kind==="directory").map((u)=>({directory:D(r,Hn(d,u.name)),identity:D(r,Hn(d,u.name,Rr))})).filter((u)=>!L.some((o)=>Ar(u.identity,o))).map((u)=>u.directory);for(let u of i)Wr(u);return i.flatMap((u)=>{try{return pd(u,a),[]}catch{return["Unable to prune rules policy cache safely."]}})}function cd(n,t,e,r){let a=new Map(e?.rulebooks.map((L)=>[L.spec,L])??[]),l=t.flatMap((L)=>{let i=a.get(L);if(!i)return pn.test(L)?[]:["--delete-source can only delete local rulebook sources"];return i.kind==="local-directory"?[]:["--delete-source can only delete local rulebook sources"]}),d=t.map((L)=>{let i=a.get(L);return Hn(n,i?.kind==="local-directory"?i.path:L)}),s=l.length>0?[]:d.flatMap((L)=>Ld(n,L,r)),c=[...l,...s];return c.length>0?{ok:!1,result:{ok:!1,errors:c,warnings:[],entries:[]}}:{ok:!0,dirs:d}}function Ld(n,t,e){let r=Hr(n),a=Hr(t),l=T3(r,a);if(l===""||l===".."||l.startsWith(`..${_3}`)||O3(l))return[`Refusing to delete local rulebook source outside ${n}: ${t}`];let d=D(e,a),s=W2(d);if(!s)return[`Local rulebook source directory not found: ${t}`];let c=s.find((L)=>L.name==="rulebook.json");if(!c)return[`Local rulebook source directory is missing rulebook.json: ${t}`];if(c.kind!=="file")throw new Q(e.label);if(g(D(e,Hn(a,"rulebook.json"))),s.length>1)return[`Local rulebook source directory contains extra files: ${t}. delete manually if you really want to remove the directory.`];return[]}function id(n,t,e){let r=n.flatMap((a)=>{try{return ud(D(e,a),t),[]}catch(l){return[`Failed to delete local rulebook source ${a}: ${l instanceof Error?l.message:String(l)}`]}});return r.length>0?{ok:!1,result:{ok:!1,errors:r,warnings:[],entries:[]}}:{ok:!0}}function pd(n,t){if(t._testPruneRulebookCacheDir){t._testPruneRulebookCacheDir(n.path);return}St(n)}function ud(n,t){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(n.path);return}St(n)}function S2(n,t){if(t===null){Ln(n);return}w2(n,t)}function A2(n){return{ok:!1,errors:[n instanceof Error?n.message:String(n)],warnings:[],entries:[]}}function G2(n,t){let e=bd(t),r=n1(e),a={effectiveLevel:r.effectiveLevel,selectedPreset:e.policySnapshot.policy.safety.level??"standard",effectiveCapabilities:r.effectiveCapabilities,destructiveCommandRuleOverrides:e.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:l,configValid:d}=od({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!n||!n.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:l,configValid:d,...a};let s=fd(n,e);if(s)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",ruleModule:s.ruleModule,ruleFunction:s.ruleFunction,matched:!0,reason:s.reason}]}]},result:"blocked",reason:A(s.reason),segment:A(s.target),...s.ruleId?{ruleId:A(s.ruleId)}:{},configSource:l,configValid:d,...a};let c=Br(n,e),L=c.decision,i=L?.ruleId??hd(n,e),u=vn.find((p)=>p.id===i&&p.activationCapability),o=u?r.policy.effectiveDestructiveCommandRules[u.id]:void 0;return{trace:wd(c.trace),result:L?"blocked":"allowed",reason:L?A(L.reason):void 0,segment:L?A(L.evidence.find((p)=>p.kind==="command")?.segment??n):void 0,ruleId:L?.ruleId?A(L.ruleId):void 0,customRule:yd(xd(L?.ruleId,e.policySnapshot)),configSource:l,configValid:d,...a,...u&&o?{ruleActivation:{id:u.id,...o}}:{}}}function od(n){let t=_(n?.cwd),e=n?.userConfigPath??E(n),r=P({cwd:n?.cwd,userConfigDir:n?.userConfigDir,userConfigPath:n?.userConfigPath});try{if(g(r.projectConfigTarget)!==null){if(a2(r.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(a){if(a instanceof Q)return{configSource:t,configValid:!1};throw a}try{if(g(r.userConfigTarget)!==null){let a=a2(r.userConfigTarget);return{configSource:e,configValid:a.errors.length===0}}return{configSource:null,configValid:!0}}catch(a){if(a instanceof Q)return{configSource:e,configValid:!1};throw a}}function bd(n){let t=vd(n?.cwd??process.cwd()),e=n?.policySnapshot??W({cwd:t,userConfigDir:n?.userConfigDir}),r=d2(e.policy);return{cwd:t,effectiveCwd:t,policySnapshot:e,environment:_r(),protectedGitMetadata:Nr(t),effectiveCapabilities:r.capabilities,strict:n?.strict??r.strict,paranoidRm:r.paranoidRm,paranoidInterpreters:r.paranoidInterpreters,worktreeMode:r.worktreeMode}}function fd(n,t){let e=t.cwd??process.cwd(),r=Er(V2("",{command:n},{kind:"command",shell:"posix"},{executionCwd:e,configCwd:e},n)),a=r1(r);if(a)return{reason:e1,target:a.target,ruleId:"policy-protection",ruleModule:"policy-protection",ruleFunction:"findPolicyConfigMutationTarget"};let l=Ir(r,t.protectedGitMetadata);if(l)return{reason:Pr,target:l.target,ruleId:"git-metadata-protection",ruleModule:"git-metadata-protection",ruleFunction:"findGitMetadataMutationTarget"};let d=t.policySnapshot.policy,s=d.secretProtection.enabled===!1?null:l1(r,d.secretProtection,{strict:t.strict});if(s)return{reason:a1,target:s.target,ruleId:s.ruleId,ruleModule:"secret-protection",ruleFunction:"findSensitiveTarget"};return null}function hd(n,t){let e=t.policySnapshot.policy,r=on({...e,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...e.destructiveCommandRuleOverrides,...Object.fromEntries(vn.flatMap((a)=>a.activationCapability?[[a.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return t1(n,{...t,policySnapshot:r,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function yd(n){if(!n)return;return{id:A(n.id),...n.rulebook?{rulebook:{name:A(n.rulebook.name),version:A(n.rulebook.version)}}:{},...n.source?{source:A(n.source)}:{},...n.override?{override:{type:"reason",reason:A(n.override.reason)}}:{}}}function wd(n){let t=n.events.flatMap((r)=>r.kind==="step"&&r.scope==="global"?[r.step]:[]),e=new Map;for(let r of n.events){if(r.kind!=="step"||r.scope!=="segment")continue;let a=e.get(r.segmentIndex)??{index:r.segmentIndex,steps:[]};a.steps.push(r.step),e.set(r.segmentIndex,a)}return{steps:t,segments:[...e.values()]}}function xd(n,t){let e=n?.replace(/^custom\./,"");if(!e||!t.policy.rules.some((r)=>r.name===e))return;return t.ruleMetadata[e]??Object.freeze({id:e})}function qd(n){let t=U2(),e=z({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},n);if(r2(e.errors))return null;if(e.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(e.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let r=e.values.limit===void 0?20:d1(e.values.limit);if(r===null)return console.error("--limit must be a positive number"),null;let a=e.values.since===void 0?Math.min(30,t):d1(e.values.since);if(a===null||a>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let l={limit:r,limitExplicit:e.values.limit!==void 0,since:a,sinceExplicit:e.values.since!==void 0,all:e.flags.all,json:e.flags.json,suspect:e.flags.suspect,pruneLegacy:e.flags.pruneLegacy,dryRun:e.flags.dryRun,id:e.values.id,agent:e.values.agent,rule:e.values.rule,session:e.values.session,project:e.values.project===void 0?void 0:kd(e.values.project)};if(l.id&&(l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.sinceExplicit||l.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(l.pruneLegacy&&(l.id!==void 0||l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.all||l.sinceExplicit||l.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(l.dryRun&&!l.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return l}async function L1(n,t={}){let e=qd(n);if(!e)return 1;let r=t.logsDir??s2();if(e.pruneLegacy)return jd(r,e.json,e.dryRun);if(!r)return console.log(e.json?"[]":e.id?`No retained audit log entry found for id ${F(e.id)}.`:"No audit log entries found."),0;$2(r);let a={count:0},l=u2(r,a).flatMap((i)=>sn(i,a).map((u)=>({entry:u,file:i})));if(a.count>0)console.error(`warning: ${a.count} audit log ${a.count===1?"source":"sources"} could not be read; these results are incomplete`);if(e.id)return Jd(l,e,t.timeZone);let d=Date.now()-e.since*24*60*60*1000,s=l.filter((i)=>Zd(i,e,r,d)),c=e.suspect?Bt(s.map((i)=>i.entry)):null,L=(c?s.filter((i)=>c.has(i.entry)):s).sort((i,u)=>Date.parse(u.entry.ts)-Date.parse(i.entry.ts)).slice(0,e.limit);if(e.json)return console.log(JSON.stringify(L.map((i)=>i.entry),null,2)),0;if(L.length===0)return console.log("No audit log entries found."),0;for(let i of L)console.log(Yd(i.entry,t.timeZone));return 0}function jd(n,t,e){let r=n?Fd(n).map((s)=>md(n,s)):[];if(e)return zd(r,t);let a=[],l=0,d=0;for(let s of r){let c=s1(s,{throwIfNoEntry:!1})?.size??0,L=Bd(s);if(L){a.push(`${c1(s)}: ${L}`);continue}l++,d+=c}if(t)return console.log(JSON.stringify({removedFiles:l,removedBytes:d,failedFiles:a.length})),a.length===0?0:1;console.log(l===0&&a.length===0?"No legacy audit log files found.":`Removed ${l} legacy audit log ${l===1?"file":"files"} (${i1(d)}).`);for(let s of a)console.error(`Could not remove ${F(s)}`);if(console.log("Nested v2 audit logs were not changed."),l>0)console.log("This deletion cannot be undone.");return a.length===0?0:1}function zd(n,t){let e=n.reduce((r,a)=>r+(s1(a,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:n.length,bytes:e})),0;if(console.log(n.length===0?"No legacy audit log files found.":`Would remove ${n.length} legacy audit log ${n.length===1?"file":"files"} (${i1(e)}).`),console.log("Nested v2 audit logs are not included."),n.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function Fd(n){try{return $d(n,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function Bd(n){try{return gd(n),null}catch(t){return t instanceof Error?t.message:String(t)}}function i1(n){let t=["B","KiB","MiB","GiB"],e=Math.min(Math.floor(Math.log2(Math.max(n,1))/10),t.length-1);return`${Math.round(n/1024**e*10)/10} ${t[e]}`}function Jd(n,t,e){let r=n.filter((l)=>l.entry.id===t.id);if(r.length>1)return console.error(`Multiple audit log entries found for id ${F(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(r.map((l)=>l.entry),null,2)),0;let a=r[0];if(!a)return console.log(`No retained audit log entry found for id ${F(t.id??"")}.`),0;return console.log(Sd(a.entry,e)),0}function Zd(n,t,e,r){if(!t.all&&n.entry.decision==="allow")return!1;if(Date.parse(n.entry.ts)<r)return!1;if(t.agent!==void 0&&n.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&n.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!Qd(n,e,t.session))return!1;if(t.project!==void 0&&!Xd(n.entry.cwd,t.project))return!1;return!0}function Qd(n,t,e){if(n.entry.sessionId===e)return!0;return Dd(n.file)===t&&c1(n.file,".jsonl")===e}function Xd(n,t){if(!n)return!1;return n===t||n.startsWith(`${t}/`)}function Yd(n,t){let e=F(n.id??"-"),r=F(n.decision??"deny"),a=n.cwd?`  [${F(n.cwd)}]`:"",l=n.segment||n.command,d=l===n.command?"":"↳ ",s=l.length>50?`${l.slice(0,50)}…`:l;return`${e.padEnd(16)}  ${F(p1(n.ts,t))}  ${r.padEnd(5)}  ${F(n.agent??"-").padEnd(15)}  ${F(n.ruleId??"-").padEnd(20)}  ${d}${F(s)}${a}`}function Sd(n,t){let e=(a)=>F(a===void 0||a===null||a===""?"-":a),r=n.shape?`${n.agent??"-"} (shape: ${n.shape})`:n.agent??"-";return[`id:        ${e(n.id)}`,`ts:        ${e(p1(n.ts,t))}`,`decision:  ${e(n.decision)}`,`agent:     ${e(r)}`,`level:     ${e(n.level)}`,`tool:      ${e(n.toolName)}`,`rule:      ${e(n.ruleId)}`,`intent:    ${e(n.intent)}`,`stage:     ${e(n.failureStage)}`,`error:     ${e(n.errorCode)}`,`session:   ${e(n.sessionId)}`,`cwd:       ${e(n.cwd)}`,`version:   ${e(n.v)}`,`truncated: ${e(n.truncated===!0?"yes":void 0)}`,`reason:    ${e(n.reason)}`,`command:   ${e(n.command)}`,`segment:   ${e(n.segment)}`].join(`
`)}function p1(n,t){let e=new Date(n);if(Number.isNaN(e.getTime()))return n;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(e)}function d1(n){let t=Number(n);return Number.isFinite(t)&&t>0?t:null}var u1={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var v1={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var o1={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as D1,relative as Od}from"node:path";var Hd=8388608;function Ad(n,t){console.log(JSON.stringify(n(f1(t))))}async function Wd(n){let t;try{t=(await le(process.stdin)).trim()}catch{n({reason:"Failed to parse hook input JSON."});return}if(!t){n({reason:"Missing hook input JSON."});return}return de(t,n,"Failed to parse hook input JSON.")}async function le(n){let t=[],e=0;for await(let r of n){let a=typeof r==="string"?Buffer.from(r,"utf-8"):Buffer.from(r.buffer,r.byteOffset,r.byteLength);if(e+=a.byteLength,e>Hd)throw Rd(n),Error("hook input byte limit exceeded");t.push(a)}return Buffer.concat(t,e).toString("utf-8")}function Rd(n){let t=n.destroy??n.cancel;if(!t)return;try{Promise.resolve(t.call(n)).catch(()=>{})}catch{}}function de(n,t,e){try{return JSON.parse(n)}catch{t({reason:e});return}}function Y(n,t){let e=t.get(n);return e?{kind:"command",shell:e}:{kind:y1(n)}}function I(n,t,e,r){let a=n===void 0?process.cwd():n,l=typeof a==="string"&&a.trim()!==""?c2([a]):void 0;if(l)return{configCwd:l,executionCwd:l};return Z(r,t,e,Gd(a)),null}function Z(n,t,e,r){let a;try{a=ae(t)}catch(l){if(!(l instanceof C2))throw l}n(Rn({command:a,segment:r,toolName:e}))}async function Kd(n){let t=await Wd(n.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){Z(n.outputDeny);return}if(!n.isSupported(t))return;let e=n.getAgent?.(t)??n.agent,r=n.agent===e?void 0:n.agent,a=Cd(t),l=(p,f)=>{b1(p,()=>n.getSessionId(t),{agent:e,shape:r,toolName:f,cwd:a}),n.outputDeny(p)},d=n.getToolName(t);if(typeof d!=="string"||d.trim()===""){Z((p)=>l(p),Ud(t));return}let s=d,c=(p)=>l(p,s),L;try{L=n.getToolInput(t,s,c)}catch(p){if(!(p instanceof C2))throw p;Z(c,void 0,s);return}if(!L.ok)return;let i=n.getContext(t,L.input,s,c);if(!i)return;let u;try{u=ae(L.input)}catch(p){if(!(p instanceof C2))throw p;Z(c,void 0,s);return}let o=V2(s,L.input,L.route,i,u??null);try{let p=Kn(o,{guard:{auditAllowed:w1(),dependencies:n.guardDependencies},audit:{agent:e,shape:r,getSessionId:()=>n.getSessionId(t)}}),f=re(p,{includeEvidence:!0,toolName:p.stage==="command-analysis"?void 0:s});if(f){n.outputDeny(f);return}n.outputAllow?.()}catch(p){if(!(p instanceof x1))throw p;Md(p);let f=re(p.evaluation,{includeEvidence:!0,toolName:p.evaluation.stage==="command-analysis"?void 0:s});if(f)n.outputDeny(f);return}}function Md(n){if(!bn(m.debug))return;console.error(`CC Safety Net debug: ${Vd(n.stage)}: ${h1(n.cause)}`)}function Vd(n){if(n==="policy-protection")return"hook policy protection failed";if(n==="config-load")return"hook config loading failed";if(n==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function Gd(n){return typeof n==="string"?n:void 0}function Ud(n){if(!n||typeof n!=="object"||Array.isArray(n))return;if(Object.hasOwn(n,"tool_input"))return n.tool_input;let t=n.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function Cd(n){if(!n||typeof n!=="object"||Array.isArray(n))return null;let t=n.cwd;if(typeof t==="string")return t;let e=n.toolCall;if(!e||typeof e!=="object"||Array.isArray(e))return null;let r=e.args;if(!r||typeof r!=="object"||Array.isArray(r))return null;let a=r.Cwd;return typeof a==="string"?a:null}async function S(n){let t=(a)=>Ad(n.createDenyOutput,a),e=n.createAllowOutput;await Kd({...n,outputDeny:t,outputAllow:e?()=>console.log(JSON.stringify(e())):void 0})}var Td=new Map([["run_command","auto"]]),_d=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function m1(n){return Y(n,Td)}async function k1(){await S({agent:"antigravity-cli",createDenyOutput:(n)=>({decision:"deny",reason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolCall?.name,getToolInput:(n,t)=>({ok:!0,input:ns(n.toolCall?.args,t),route:m1(t)}),getContext:Ed,getSessionId:(n)=>n.conversationId})}function Ed(n,t,e,r){let l=Nd(n).flatMap((L)=>{let i=c2([L]);return i?[i]:[]});if(!l[0])return D2(r,t,e),null;if(e!=="run_command"){let L;try{L=Pd(t,e,l)}catch(i){if(i instanceof C2)return D2(r,void 0,e),null;if(!(i instanceof Mn))throw i;return D2(r,t,e),null}if(!L)return D2(r,t,e),null;return{configCwd:L,executionCwd:L,policyConfigCwds:l}}let d=n.toolCall?.args;if(!d||!Object.hasOwn(d,"Cwd"))return{configCwd:l[0],executionCwd:l[0],policyConfigCwds:l};let s=d.Cwd;if(typeof s!=="string"||s.trim()==="")return D2(r,t,e),null;let c=m2(s,l);if(c){let L=q1(c,l);if(!L)return D2(r,t,e,s),null;return{configCwd:L,executionCwd:c,policyConfigCwds:l}}return D2(r,t,e,s),null}function Pd(n,t,e){let r=m1(t),a=[...$1(n,_d),...r.kind==="patch"?g1(n):[]].filter(D1),l=Vn(),d=new Set(a.flatMap((s)=>{let c=q1(yn(s,wn,l),e);return c?[c]:[]}));if(d.size>1)return null;return[...d][0]??e[0]??null}function q1(n,t){return t.filter((e)=>Id(n,e)).reduce((e,r)=>r.length>e.length?r:e,"")||null}function Id(n,t){let e=Od(t,n);return e===""||!e.startsWith("..")&&!D1(e)}function D2(n,t,e,r){let a=t&&typeof t==="object"?t.command:void 0;n(Rn({command:typeof a==="string"?a:void 0,segment:r,toolName:e}))}function Nd(n){if(n.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(n.workspacePaths)?n.workspacePaths.filter((e)=>typeof e==="string"&&e.trim()!==""):[];return c2(t)?t:[]}function ns(n,t){if(!n)return;if(t!=="run_command")return n;return{...n,command:typeof n.CommandLine==="string"&&n.CommandLine!==""?n.CommandLine:void 0}}var O2=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",installLabel:"Antigravity CLI",helpTarget:"Antigravity CLI hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",installLabel:"Claude Code",helpTarget:"Claude Code plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",installLabel:"Codex",helpTarget:"Codex plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",installLabel:"GitHub Copilot CLI",helpTarget:"GitHub Copilot CLI plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",installLabel:"Gemini CLI",helpTarget:"Gemini CLI extension",probeCommand:["gemini","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:8,runtime:{order:6,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--hermes-agent",installLabel:"Hermes Agent",helpTarget:"Hermes Agent plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:9,runtime:{order:7,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--kimi-code",installLabel:"Kimi Code",helpTarget:"Kimi Code hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:10,install:{order:10,flag:"--openclaw",installLabel:"OpenClaw",helpTarget:"OpenClaw plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:11,install:{order:11,flag:"--opencode",installLabel:"OpenCode",helpTarget:"OpenCode plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:12,install:{order:12,flag:"--pi",installLabel:"Pi",helpTarget:"Pi package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",installLabel:"Cursor",helpTarget:"Cursor hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",installLabel:"Amp Code",helpTarget:"Amp Code plugin",probeCommand:["amp","--version"]}}],j1=O2.slice().sort((n,t)=>n.doctorOrder-t.doctorOrder).map((n)=>n.id),z1=O2.filter((n)=>("runtime"in n)).slice().sort((n,t)=>n.runtime.order-t.runtime.order).map((n)=>({id:n.id,displayName:"displayName"in n.runtime?n.runtime.displayName:n.displayName,flags:n.runtime.flags,legacyFlags:"legacyFlags"in n.runtime?n.runtime.legacyFlags:[],description:n.runtime.description,legacyTopLevelFlags:n.runtime.legacyTopLevelFlags})),L2=O2.slice().sort((n,t)=>n.install.order-t.install.order).map((n)=>({id:n.id,...n.install})).map(({order:n,...t})=>t),B6=Object.fromEntries(O2.map((n)=>[n.id,n.displayName]));function o2(n){return O2.find((t)=>t.id===n)?.displayName??n}function b2(n){return O2.find((t)=>t.id===n)?.install.installLabel??n}import{homedir as ts}from"node:os";import{isAbsolute as F1,join as se}from"node:path";function J1(n){if(n!==void 0&&n!==null&&!F1(n))return"unknown";try{let t=Vn(),e=n?yn(n,wn,t):void 0,r=process.env.HOME||ts(),a=[["codex",process.env.CODEX_HOME||se(r,".codex")],["copilot-cli",process.env.COPILOT_HOME||se(r,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||se(r,".claude")]],l=e?a.flatMap(([d,s])=>{if(!F1(s))return[];return B1(e,yn(s,wn,t))?[d]:[]}):[];if(l.length===1)return l[0]??"unknown";if(l.length>1)return"unknown"}catch(t){if(t instanceof Mn)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var ce="PreToolUse",Z1="BeforeTool",Q1="pre_tool_call",Le="PreToolUse";var es=new Map([["Bash","posix"],["PowerShell","powershell"]]);function rs(n){return Y(n,es)}async function X1(){await S({agent:"claude-code",getAgent:(n)=>J1(n.transcript_path),createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:ce,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===ce,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:rs(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}var as=new Map([["bash","auto"],["Bash","auto"],["powershell","powershell"],["PowerShell","powershell"]]);function ls(n){return Y(n,as)}async function Y1(){await S({agent:"copilot-cli",createDenyOutput:(n)=>({permissionDecision:"deny",permissionDecisionReason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolName,getToolInput:(n,t,e)=>{if(typeof n.toolArgs!=="string")return e({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let r=de(n.toolArgs,e,"Failed to parse toolArgs JSON.");if(r===void 0)return{ok:!1};return{ok:!0,input:r,route:ls(t)}},getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>typeof n.sessionId==="string"&&n.sessionId.trim()?n.sessionId:void 0})}var ds=new Map([["Shell","auto"]]);function ss(n){return Y(n,ds)}async function S1(){await S({agent:"cursor",createDenyOutput:(n)=>({permission:"deny",user_message:n,agent_message:n}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:ss(t)}),getContext:cs,getSessionId:(n)=>n.conversation_id})}function cs(n,t,e,r){let a=Ls(n);if(!a[0])return Z(r,t,e),null;let l=m2(ps(n.cwd),a);if(!l)return Z(r,t,e,typeof n.cwd==="string"?n.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:l,executionCwd:l,policyConfigCwds:a};if(!Object.hasOwn(t,"working_directory"))return{configCwd:l,executionCwd:l,policyConfigCwds:a};let d=t.working_directory;if(typeof d!=="string"||d.trim()==="")return Z(r,t,e),null;let s=m2(d,a);if(!s)return Z(r,t,e,d),null;return{configCwd:l,executionCwd:s,policyConfigCwds:a}}function Ls(n){return is(n).flatMap((t)=>{let e=c2([t]);return e?[e]:[]})}function is(n){if(n.workspace_roots===void 0)return typeof n.cwd==="string"&&n.cwd.trim()!==""?[n.cwd]:[];if(!Array.isArray(n.workspace_roots))return[];return n.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function ps(n){return typeof n==="string"&&n.trim()!==""?n:"."}var us=new Map([["run_shell_command","auto"]]);function vs(n){return Y(n,us)}async function H1(){await S({agent:"gemini-cli",createDenyOutput:(n)=>({decision:"deny",reason:n,systemMessage:n}),isSupported:(n)=>n.hook_event_name===Z1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:vs(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}import{resolve as os}from"node:path";var bs=new Map([["terminal","posix"]]);async function A1(){await S({agent:"hermes-agent",createDenyOutput:(n)=>({action:"block",message:n}),isSupported:(n)=>n.hook_event_name===Q1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Y(t,bs)}),getContext:fs,getSessionId:(n)=>n.session_id})}function fs(n,t,e,r){let a=I(n.cwd,t,e,r);if(!a)return null;if(!t||typeof t!=="object"||Array.isArray(t))return a;if(!Object.hasOwn(t,"workdir"))return a;let l=t.workdir;if(typeof l!=="string"||l.trim()==="")return Z(r,t,e),null;let d=c2([os(a.configCwd,l)]);if(!d)return Z(r,t,e,l),null;return{...a,executionCwd:d}}var W1=new Map([["Bash","posix"]]);function hs(n){return Y(n,W1)}async function R1(){await S({agent:"kimi-code",createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:Le,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===Le,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:hs(t)}),getContext:(n,t,e,r)=>{let a=I(n.cwd,t,e,r);if(!a)return null;let l=n.tool_input;if(!W1.has(e)||!l||!Object.hasOwn(l,"cwd"))return a;let d=l.cwd;if(typeof d!=="string"||d.trim()==="")return Z(r,t,e),null;let s=m2(d,[a.configCwd]);if(!s)return Z(r,t,e,d),null;return{configCwd:a.configCwd,executionCwd:s}},getSessionId:(n)=>n.session_id})}var ys={"antigravity-cli":k1,"claude-code":X1,"copilot-cli":Y1,cursor:S1,"gemini-cli":H1,"hermes-agent":A1,"kimi-code":R1},T2=z1.map((n)=>({...n,run:ys[n.id]}));function K1(n){let t=z({label:"hook",booleans:Object.fromEntries(T2.map((r)=>[r.id,[...r.flags,...r.legacyFlags]]))},n);if(t.errors.length>0)return;let e=T2.filter((r)=>t.flags[r.id]);return e.length===1?e[0]:void 0}function M1(n){return T2.find((t)=>t.legacyTopLevelFlags.some((e)=>e===n))}var ws=T2.map((n)=>({flags:n.flags.join(", "),description:n.description})),xs=T2.flatMap((n)=>n.flags.map((t)=>`cc-safety-net hook ${t}`)),V1={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...ws,{flags:"-h, --help",description:"Show this help"}],examples:xs};var G1={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...L2.map((n)=>({flags:n.flag,description:`Install ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...L2.map((n)=>`cc-safety-net install ${n.flag}`)]},U1={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...L2.map((n)=>({flags:n.flag,description:`Uninstall ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...L2.map((n)=>`cc-safety-net uninstall ${n.flag}`)]},C1={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var O1={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var _2={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source>",description:"Add a rulebook source and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Refresh rulebook lock/cache state"},{usage:"sync",description:"Sync configured rulebooks"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk","cc-safety-net rule add project-rules","cc-safety-net rule sync","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var T1={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var _1={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var E1=[T1,u1,O1,v1,_2,G1,C1,U1,V1,o1,_1];function $s(n){return n.aliases??[]}function gs(n){return!n.hidden}function Gn(n){let t=n.toLowerCase();return E1.find((e)=>e.name.toLowerCase()===t||$s(e).some((r)=>r.toLowerCase()===t))}function P1(){return E1.filter(gs)}import{readFileSync as Ds}from"node:fs";import{basename as ms}from"node:path";function Un(n=7,t=s2()){let e=Date.now()-n*24*60*60*1000,r=[],a=new Set,l=0,d,s,c,L;if(t)$2(t);let i={count:0},u=t?u2(t,i):[];for(let p of u)try{let v=Ds(p,"utf-8").trim().split(`
`).filter(Boolean);for(let h of v)try{let x=JSON.parse(h);if(x.decision==="allow")continue;let w=new Date(x.ts).getTime();if(w>=e){if(l++,a.add(x.sessionId??ms(p,".jsonl")),s===void 0||w<=s)d=x.ts,s=w;if(L===void 0||w>L)c=x.ts,L=w;ks(r,x,w)}}catch{i.count++}}catch{i.count++}let o=r.map((p)=>({timestamp:p.ts,command:p.command,reason:p.reason,relativeTime:Ft(new Date(p.ts))}));return{totalBlocked:l,sessionCount:a.size,recentEntries:o,oldestEntry:d,newestEntry:c,unreadable:i.count}}function ks(n,t,e){let r=n.findIndex((a)=>e>new Date(a.ts).getTime());if(r===-1){if(n.length<3)n.push(t);return}if(n.splice(r,0,t),n.length>3)n.pop()}import{dirname as qs}from"node:path";function I1(n,t,e,r,a){let l;try{if(g(r)===null)return{path:n,exists:!1,valid:!1,ruleCount:0};l=a2(r),l.errors.push(...l2(n,t,{userConfigDir:e},a))}catch(d){if(!(d instanceof Q))throw d;l={errors:[d.message],ruleNames:new Set}}return{path:n,exists:!0,valid:l.errors.length===0,ruleCount:l.ruleNames.size,...l.errors.length>0?{errors:l.errors}:{}}}function js(n,t){return{source:t,name:n.name,command:n.command,subcommand:n.subcommand,blockArgs:[...n.block_args],reason:n.reason}}function N1(n,t){let e=t?.userConfigPath??E(),r=t?.projectConfigPath??_(n),a=qs(e),l=v2({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),d=P({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),s=new Map(l.rulebooks.flatMap((c)=>c.rules.map((L)=>[L,c.source])));return{userConfig:I1(e,K2({userConfigPath:e}),a,d.userConfigTarget,d.userScope),projectConfig:I1(r,M2(r),a,d.projectConfigTarget,d.projectScope),effectiveRules:l.rules.map((c)=>js(c,s.get(c.name)??"project")),shadowedRules:[]}}var zs=[{flag:m.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:m.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:m.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:m.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:m.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:m.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:m.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:m.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function na(){return[...zs.map((n)=>({name:n.flag.name,value:ne(n.flag),isSet:te(n.flag),legacyName:n.flag.legacyName,legacyValue:n.flag.legacyName?process.env[n.flag.legacyName]:void 0,legacyIsSet:n.flag.legacyName?process.env[n.flag.legacyName]!==void 0:void 0,description:n.description,defaultBehavior:n.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var ta={error:0,warning:1,info:2},Fs=["policy","config","audit"];function Bs(n){return n.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var Js=[{derive:(n)=>n.hooks.length>0&&n.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(n)=>n.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let e=o2(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${e} inspection failed`,detail:`Doctor could not verify the ${e} integration configuration.`,fixHint:`Correct the reported ${e} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(n)=>n.userConfig.exists&&!n.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.userConfig.path}]:[]},{derive:(n)=>n.projectConfig.exists&&!n.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.projectConfig.path}]:[]},{derive:(n)=>n.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${n.configState.reason}`,fixHint:"Correct the named source, run `cc-safety-net rule sync` for a rule source, then rerun doctor."}]:[]},{derive:(n)=>{let t=n.environment.find((e)=>e.name==="CC_SAFETY_NET_AUDIT_SCOPE");return Nt(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...Fs.map((n)=>({derive:(t)=>t.posture.directories.filter((e)=>e.kind===n&&e.status==="unsafe").map((e)=>({checkId:`posture.${n}-directory-unsafe`,severity:"error",title:`${n[0]?.toUpperCase()}${n.slice(1)} directory is unsafe`,detail:`The ${n} directory ${Bs(e.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...e.path?{path:e.path}:{}}))})),{derive:(n)=>{let t=[...n.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function ea(n){return Js.flatMap((t,e)=>t.derive(n).map((r,a)=>({finding:r,catalogOrder:e,occurrence:a}))).sort((t,e)=>ta[t.finding.severity]-ta[e.finding.severity]||t.catalogOrder-e.catalogOrder||t.occurrence-e.occurrence).map((t)=>t.finding)}function N(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var Zs=(n)=>N()?`\x1B[32m${n}\x1B[0m`:n,Qs=(n)=>N()?`\x1B[33m${n}\x1B[0m`:n,Xs=(n)=>N()?`\x1B[34m${n}\x1B[0m`:n,Ys=(n)=>N()?`\x1B[35m${n}\x1B[0m`:n,Ss=(n)=>N()?`\x1B[36m${n}\x1B[0m`:n,Hs=(n)=>N()?`\x1B[31m${n}\x1B[0m`:n,As=(n)=>N()?`\x1B[2m${n}\x1B[0m`:n,Ws=(n)=>N()?`\x1B[1m${n}\x1B[0m`:n,b={green:Zs,yellow:Qs,blue:Xs,magenta:Ys,cyan:Ss,red:Hs,dim:As,bold:Ws},Rs="\x1B[0m",Ks=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function Ms(n){let t=n;return()=>{return t=(t*1664525+1013904223)%4294967296,t/4294967296}}function Vs(n){let t=[...Ks],e=Ms(n);for(let r=t.length-1;r>0;r--){let a=Math.floor(e()*(r+1)),l=t[r];t[r]=t[a],t[a]=l}return t}function Gs(n,t=0){if(!N())return"";let e=Vs(t);return`\x1B[38;5;${e[n%e.length]}m`}function ra(n,t,e=0){if(!N())return`"${n}"`;return`${Gs(t,e)}"${n}"${Rs}`}var Us=new RegExp("\x1B\\[[0-9;]*m","g"),ie=(n)=>n.replace(Us,"").length;function k2(n){let t=(n.headers??n.rows[0]??[]).map((d,s)=>{let c=Math.max(...n.rows.map((L)=>ie(L[s]??"")));return Math.max(ie(d),c)}),e=(d,s)=>d+" ".repeat(Math.max(0,s-ie(d))),r=(d,s)=>s[0]+t.map((c)=>d.repeat(c+2)).join(s[1])+s[2],a=(d)=>`│ ${d.map((s,c)=>e(s,t[c]??0)).join(" │ ")} │`,l=n.headers?[`   ${a(n.headers)}`,`   ${r("─",["├","┼","┤"])}`]:[];return[`   ${r("─",["┌","┬","┐"])}`,...l,...n.rows.map((d)=>`   ${a(d)}`),`   ${r("─",["└","┴","┘"])}`].join(`
`)}function aa(n){let t=[];t.push("Hook Integration"),t.push(Cs(n));let e=[],r=[];for(let a of n){let l=o2(a.platform);if(a.errors&&a.errors.length>0)for(let d of a.errors)if(a.configured)e.push({platform:l,message:d});else r.push({platform:l,message:d})}for(let a of e)t.push(`   Warning (${a.platform}): ${a.message}`);for(let a of r)t.push(b.red(`   Error (${a.platform}): ${a.message}`));return t.join(`
`)}function Cs(n){let t=["Platform","Discovery","Configuration","Inspection"],e=n.map((r)=>{let a=o2(r.platform);if(r.inspectionStatus==="not-inspected"){let c=b.dim("Not inspected");return[a,c,c,c]}let l=r.detected?b.green("Detected"):r.inspectionStatus==="failed"?b.red("Unknown"):b.dim("Not detected"),d=r.configured?b.green("Configured"):r.detected?b.yellow("Not configured"):r.inspectionStatus==="failed"?b.red("Unknown"):b.dim("Not applicable"),s=r.inspectionStatus==="verified"?b.green("Verified"):r.inspectionStatus==="failed"?b.red("Failed"):b.dim("Not applicable");return[a,l,d,s]});return k2({headers:t,rows:e})}function la(n){let e=["Guard Engine Verification",`   Synthetic self-test: ${n.failed>0?b.red(`${n.passed}/${n.total} FAIL`):b.green(`${n.passed}/${n.total} passed`)}`],r=n.results.filter((a)=>!a.passed);if(r.length>0){e.push(""),e.push(b.red("   Failures:"));for(let a of r)e.push(b.red(`   • ${a.description}`)),e.push(b.red(`     expected ${a.expected}, got ${a.actual}`))}return e.join(`
`)}function Os(n){if(n.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],e=n.map((r)=>[r.source,r.name,r.subcommand?`${r.command} ${r.subcommand}`:r.command,r.blockArgs.join(", ")]);return k2({headers:t,rows:e})}function da(n){let t=[];if(t.push("Configuration"),t.push(Ts(n.userConfig,n.projectConfig)),t.push(""),n.effectiveRules.length>0)t.push(`   Effective rules (${n.effectiveRules.length} total):`),t.push(Os(n.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let e of n.shadowedRules)t.push(""),t.push(`   Note: Project rule "${e.name}" shadows user rule with same name`);return t.join(`
`)}function Ts(n,t){let e=["Scope","Status"],r=(l)=>{if(!l.exists)return b.dim("N/A");if(!l.valid)return b.red(`Invalid (${l.errors?.[0]??"unknown error"})`);return b.green("Configured")},a=[["User",r(n)],["Project",r(t)]];return k2({headers:e,rows:a})}function sa(n){let t=[];return t.push("Environment"),t.push(_s(n)),t.join(`
`)}function ca(n){let t=["Effective Safety",`   Selected preset: ${n.effectiveSafety.selectedPreset}`,`   Effective: ${n.effectiveSafety.level}`],e=[["fail_closed","fail_closed"],["paranoid_rm","paranoid_rm"],["paranoid_interpreters","paranoid_interpreters"]];for(let[r,a]of e){let l=n.effectiveSafety.capabilities[r],d=l.enabled?b.green("ON"):b.dim("OFF"),s=l.sources.length>0?` (${l.sources.join(", ")})`:"";t.push(`   ${a}: ${d} via ${l.source}${s}`)}t.push(`   Stored rule customizations: ${n.effectiveSafety.ruleCounts.stored}`),t.push(`   Effective rule customizations: ${n.effectiveSafety.ruleCounts.effective}`);for(let[r,a]of Object.entries(n.effectiveSafety.ruleOverrides))t.push(`   ${r}: ${a}`);return t.join(`
`)}function La(n){let t=["Findings"];if(n.length===0)return t.push("   No findings from inspected doctor facts."),t.join(`
`);for(let e of n){let r=`[${e.severity.toUpperCase()}] ${e.checkId}: ${F(e.title)}`,a=e.severity==="error"?b.red:e.severity==="warning"?b.yellow:b.blue;if(t.push(`   ${a(r)}`),t.push(`      ${F(e.detail)}`),e.path)t.push(`      Path: ${F(e.path)}`);if(e.fixHint)t.push(`      Fix: ${F(e.fixHint)}`)}return t.join(`
`)}function _s(n){let t=["Variable","Status","Legacy"],e=n.map((r)=>{let a=r.isSet?b.green("✓"):b.dim("✗"),l=r.legacyName&&r.legacyIsSet?`${r.legacyName} ${b.green("✓")}`:r.legacyName??"";return[r.name,a,l]});return k2({headers:t,rows:e})}function ia(n){let t=[];if(n.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${n.totalBlocked} blocked / ${n.sessionCount} sessions)`),t.push(Es(n.recentEntries));if(n.unreadable>0)t.push(`   Warning: ${n.unreadable} audit log ${n.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function Es(n){let t=["Time","Command"],e=n.map((r)=>{let a=F(r.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),l=a.length>40?`${a.slice(0,37)}...`:a;return[r.relativeTime,l]});return k2({headers:t,rows:e})}function pa(n){let t=[];if(t.push("Update Check"),n.latestVersion===null&&!n.error)return t.push(Cn([["Status",b.dim("Skipped")],["Installed",n.currentVersion]])),t.join(`
`);if(n.error)return t.push(Cn([["Status",`${b.yellow("⚠")} Error`],["Installed",n.currentVersion],["Error",b.dim(n.error)]])),t.join(`
`);if(n.updateAvailable)return t.push(Cn([["Status",`${b.yellow("⚠")} Update Available`],["Current",n.currentVersion],["Latest",b.green(n.latestVersion??"")]])),t.push(""),t.push("   Run: bunx cc-safety-net@latest doctor"),t.push("   Or:  npx cc-safety-net@latest doctor"),t.join(`
`);return t.push(Cn([["Status",`${b.green("✓")} Up to date`],["Version",n.currentVersion]])),t.join(`
`)}function Cn(n){return k2({rows:n})}function ua(n){let t=[];return t.push("System Info"),t.push(Ps(n)),t.join(`
`)}function Ps(n){let t=["Component","Version"],e=(l)=>{if(l===null)return b.dim("not found");return l},a=[{label:"cc-safety-net",value:n.version},{label:"Claude Code",value:n.claudeCodeVersion},{label:"Amp Code",value:n.ampVersion},{label:"Antigravity CLI",value:n.antigravityCliVersion},{label:"Codex",value:n.codexCliVersion},{label:"Cursor",value:n.cursorVersion},{label:"Gemini CLI",value:n.geminiCliVersion},{label:"GitHub Copilot CLI",value:n.copilotCliVersion},{label:"Hermes Agent",value:n.hermesAgentVersion},{label:"Kimi Code",value:n.kimiCodeVersion},{label:"OpenClaw",value:n.openClawVersion},{label:"OpenCode",value:n.openCodeVersion},{label:"Pi",value:n.piCliVersion},{label:"Node.js",value:n.nodeVersion},{label:"npm",value:n.npmVersion},{label:"Bun",value:n.bunVersion},{label:"Platform",value:n.platform}].map((l)=>[l.label,e(l.value)]);return k2({headers:t,rows:a})}function va(n){if(n.findings.length===0)return b.green(`
...
`}function jn(n){return[{name:"__init__.py",content:rL(n)},{name:"plugin.yaml",content:eL(n)}]}import{mkdirSync as aL,readdirSync as lL,readFileSync as dL,rmSync as ze}from"node:fs";import{join as j2}from"node:path";var sL="__pycache__";function Fe(n){let t=process.env.HERMES_HOME?.trim();return t?t:j2(n,".hermes")}function Be(n){return j2(Fe(n),"plugins",M)}function Je(n){return n.startsWith(e0)}function Ze(n,t){let e=Be(n),r=H(e);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${e}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return e}function a0(n,t){let e=H(n);if(!e)return;if(e.isSymbolicLink()||!e.isFile())throw Error(`Refusing to ${t} ${n}: not a regular file. Move or remove it.`);let r=dL(n,"utf-8");if(!Je(r))throw Error(`Refusing to ${t} unmanaged file at ${n}. Move or remove it.`);return r}function l0(n){let t=Ze(n,"install"),e=jn(j());if(e.map((a)=>a0(j2(t,a.name),"overwrite")).every((a,l)=>a===e[l]?.content))return{path:t,alreadyInstalled:!0};return aL(t,{recursive:!0}),e.forEach((a)=>{B(j2(t,a.name),a.content)}),{path:t,alreadyInstalled:!1}}function Qe(n){let t=Ze(n,"remove");if(!H(t))return[];return jn(j()).filter((e)=>a0(j2(t,e.name),"remove")!==void 0)}function d0(n){let t=Ze(n,"remove");if(!H(t))return{path:t,alreadyInstalled:!1};let e=Qe(n);if(e.forEach((r)=>{ze(j2(t,r.name))}),ze(j2(t,sL),{recursive:!0,force:!0}),lL(t).length===0)ze(t,{recursive:!0});return{path:t,alreadyInstalled:e.length>0}}var rt="hermes-agent",s0=/^([^\s#][^:]*):/,cL=/^\s+([A-Za-z_][\w-]*):/,c0=/^\s+-\s*(.*)$/;function LL(n){return n.trim().replace(/^(["'])(.*)\1$/,"$2")}function iL(n){let t=n.split(/\r?\n/),e=t.findIndex((l)=>s0.exec(l)?.[1]?.trim()==="plugins");if(e===-1)return[];let r=t.slice(e+1),a=r.findIndex((l)=>s0.test(l));return a===-1?r:r.slice(0,a)}function L0(n,t){let e=iL(n),r=e.findIndex((d)=>cL.exec(d)?.[1]===t);if(r===-1)return[];let a=e.slice(r+1),l=a.findIndex((d)=>!c0.test(d));return(l===-1?a:a.slice(0,l)).map((d)=>LL(c0.exec(d)?.[1]??""))}function pL(n){try{return i0(p0(Fe(n),"config.yaml"),"utf-8")}catch{return}}function Xe(n){let t=pL(n)??"";return L0(t,"enabled").includes(M)&&!L0(t,"disabled").includes(M)}function u0(n){return/^# version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function uL(n,t){let e=H(n);if(!e)return{error:`${t.name} is missing from ${n}; run install --hermes-agent`};if(e.isSymbolicLink()||!e.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{let r=i0(n,"utf-8");if(!Je(r))return{error:`Unmanaged ${t.name} occupies ${n}; move or remove it`};if(u0(r)===j()&&r!==t.content)return{error:`Modified ${t.name} occupies ${n}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${n}: ${r instanceof Error?r.message:String(r)}`}}}function v0(n){let t=Be(n.homeDir),e=En(rt,t);if(e)return e;let r=jn(j()).map((s)=>uL(p0(t,s.name),s)),a=r.flatMap((s)=>("error"in s)?[s.error]:[]);if(a.length>0)return{platform:rt,status:"n/a",configPath:t,errors:a};let l=r.some((s)=>("content"in s)&&u0(s.content)!==j()),d=l?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!Xe(n.homeDir))return{platform:rt,status:"disabled",method:"plugin directory",configPath:t,errors:[`${M} is not enabled in Hermes; run \`hermes plugins enable ${M}\``,...d]};return{platform:rt,status:"configured",method:"plugin directory",configPath:t,errors:l?d:void 0}}import{existsSync as vL,readFileSync as oL}from"node:fs";import{join as o0}from"node:path";var bL=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function fL(n){return o0(process.env.KIMI_CODE_HOME||o0(n,".kimi-code"),"config.toml")}function zn(n){let t=fL(n.homeDir);if(!vL(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!bL.test(oL(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(e){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${e instanceof Error?e.message:String(e)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as m0}from"node:fs";import{join as Bn}from"node:path";var q="cc-safety-net",V="index.js",N2="openclaw.plugin.json",nn="package.json";var at="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as wL,lstatSync as xL,readdirSync as $L,readFileSync as gL}from"node:fs";import{dirname as h0,join as z2}from"node:path";import{fileURLToPath as DL}from"node:url";import{spawn as hL}from"node:child_process";function yL(n){return n.join(" ")}function Ye(n,t,e){return[`Failed to run ${yL(n)}${t===null?"":` (exit ${t})`}.`,e.trim()].filter(Boolean).join(`
...
${s()}`.trim())))}),l.on("close",(i)=>{if(clearTimeout(L),i!==0){r(Error(Ye(n,i,s())));return}e(t?.stdoutOnly?d.stdout:s())})})}async function He(n){for(let t of n)await e2(t)}async function b0(n){for(let t of n)try{await e2(t)}catch(e){console.warn(e instanceof Error?e.message:String(e))}}var f0=z2("openclaw",q),mL=[V,N2,nn];function y0(n){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return t;let e=process.env.OPENCLAW_CONFIG_PATH?.trim();return e?h0(e):z2(n,".openclaw")}function w0(n){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?t:z2(y0(n),"openclaw.json")}function Ae(n){return z2(y0(n),"extensions",q)}function kL(n){let t=$L(n);if(t.length===0)return!0;if(t.some((a)=>!mL.includes(a)))return!1;let e=z2(n,V),r=H(e);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&gL(e,"utf-8").startsWith(at)}function We(n){let t=Ae(n),e=H(t);if(!e)return;if(!e.isSymbolicLink()&&e.isDirectory()&&kL(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function x0(){let n=h0(DL(import.meta.url));return[z2(n,"..",f0),z2(n,"..","..","..","dist",f0)]}function Re(n=x0()){return n.find((t)=>wL(t)&&xL(t).isDirectory())}function qL(n=x0()){let t=Re(n);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function $0(n=qL()){return[["openclaw","plugins","install",n,"--force"],["openclaw","plugins","enable",q]]}function jL(n){let t=(()=>{try{return JSON.parse(n)}catch{return}})(),e=$($(t,"plugin"),"status");return typeof e==="string"?e:void 0}async function g0(){let n=jL(await e2(["openclaw","plugins","inspect",q,"--runtime","--json"],{stdoutOnly:!0}));if(n==="loaded")return;throw Error(`${n===void 0?`The ${q} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${q} plugin with status "${n}".`} Run \`openclaw plugins inspect ${q} --runtime\` for details.`)}var lt="openclaw",Fn=`run \`openclaw plugins enable ${q}\``;function tn(n,t){let e=Bn(n,t),r=H(e);if(!r)return{error:`${t} is missing from ${e}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{return{content:m0(e,"utf-8")}}catch(a){return{error:`Failed to read ${e}: ${a instanceof Error?a.message:String(a)}`}}}function k0(n){try{return JSON.parse(R(n))}catch{return}}function zL(n){let t=tn(n,N2);if("error"in t)return t.error;if($(k0(t.content),"id")===q)return;return`${Bn(n,N2)} is not a valid ${q} manifest; run install --openclaw`}function FL(n){let t=tn(n,nn);if("error"in t)return t.error;let e=$($(k0(t.content),"openclaw"),"extensions");if(Array.isArray(e)&&e.includes(`./${V}`))return;return`${Bn(n,nn)} does not point OpenClaw at ${V}; run install --openclaw`}function D0(n){return Array.isArray(n)?n.filter((t)=>typeof t==="string"):[]}function BL(n){let t=w0(n);if(!H(t))return`${q} is not enabled; ${Fn}`;let e=(()=>{try{return JSON.parse(R(m0(t,"utf-8")))}catch{return}})();if(e===void 0)return`Failed to read ${t}; fix it, then ${Fn}`;let r=$(e,"plugins");if($(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let a=$($($(r,"entries"),q),"enabled");if(D0($(r,"deny")).includes(q)||a===!1)return`${q} is disabled in ${t}; ${Fn}`;let l=D0($(r,"allow"));if(l.length>0&&!l.includes(q))return`plugins.allow in ${t} does not list ${q}; add it, then ${Fn}`;if(l.includes(q)||a===!0)return;return`${q} is not enabled; ${Fn}`}function q0(n){return/^\/\/ version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function JL(n,t,e){if(e===void 0)return[];let r=tn(e,V);if("error"in r||q0(r.content)!==t)return[];return[V,N2,nn].flatMap((a)=>{let l=tn(n,a),d=tn(e,a);if("error"in l||"error"in d||l.content===d.content)return[];return[`Modified ${a} occupies ${Bn(n,a)}; run install --openclaw to restore it`]})}function j0(n){let t=Ae(n.homeDir),e=En(lt,t);if(e)return e;let r=tn(t,V),l=["error"in r?r.error:r.content.startsWith(at)?void 0:`Unmanaged ${V} occupies ${Bn(t,V)}; move or remove it`,zL(t),FL(t)].filter((i)=>i!==void 0),d="content"in r?q0(r.content):void 0,s=l.length>0?l:JL(t,d,Re());if(s.length>0)return{platform:lt,status:"n/a",configPath:t,errors:s};let c=d===j()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],L=BL(n.homeDir);if(L)return{platform:lt,status:"disabled",method:"plugin directory",configPath:t,errors:[L,...c]};return{platform:lt,status:"configured",method:"plugin directory",configPath:t,errors:c.length>0?c:void 0}}import{existsSync as ZL,readFileSync as QL}from"node:fs";import{join as z0}from"node:path";function F0(n){let t=[],e=z0(n.homeDir,".config","opencode"),r=["opencode.json","opencode.jsonc"];for(let a of r){let l=z0(e,a);if(ZL(l))try{let d=QL(l,"utf-8"),s=R(d);if((JSON.parse(s).plugin??[]).some((u)=>u.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:l,errors:t.length>0?t:void 0}}catch(d){t.push(`Failed to parse ${a}: ${d instanceof Error?d.message:String(d)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as XL}from"node:path";function Ke(n){return XL(n,".pi","agent","settings.json")}function Me(n){if(typeof n!=="string")return!1;return n==="npm:cc-safety-net"||n.startsWith("npm:cc-safety-net@")}function B0(n){let t=Ke(n.homeDir),e=n2(t);if(e.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(e.kind==="missing")return{platform:"pi",status:"n/a"};let r=$(e.value,"packages");if(!Array.isArray(r))return{platform:"pi",status:"n/a"};let a=r.find((s)=>Me(typeof s==="string"?s:$(s,"source")));if(a===void 0)return{platform:"pi",status:"n/a"};let l=$(a,"extensions");if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var SL={amp:Fa,"antigravity-cli":Ba,"claude-code":Xa,codex:Ya,"copilot-cli":Ca,cursor:n0,"gemini-cli":t0,"hermes-agent":v0,"kimi-code":zn,openclaw:j0,opencode:F0,pi:B0};function en(n,t){let e={...t,cwd:n,homeDir:t?.homeDir??YL()};return j1.map((r)=>HL(SL[r](e)))}function HL(n){if(n.status==="not-inspected")return{platform:n.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:n.platform,detected:n.status!=="n/a",configured:n.status==="configured",inspectionStatus:n.status!=="n/a"?"verified":n.errors&&n.errors.length>0?"failed":"not-applicable",method:n.method,configPath:n.configPath,configPaths:n.configPaths,errors:n.errors}}import{tmpdir as AL}from"node:os";import{join as WL}from"node:path";var RL=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),KL=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([]),allowPaths:Object.freeze([])})})}),ML={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}},sources:{failClosed:[],paranoidRm:[],paranoidInterpreters:[],worktreeMode:[]}};function J0(){let n=WL(AL(),"cc-safety-net-self-test"),t=RL.map((e)=>{let r=Kn(V2("self-test",{command:e.command},{kind:"command",shell:"auto"},{configCwd:n,executionCwd:n},e.command),{guard:{dependencies:{loadPolicySnapshot:()=>KL,getModes:()=>ML,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),a=e.expectBlocked?"blocked":"allowed",l=r.decision.kind==="deny"?"blocked":"allowed";return{command:e.command,description:e.description,expected:a,actual:l,passed:a===l,reason:r.decision.kind==="deny"?r.decision.reason:void 0,ruleId:r.decision.kind==="deny"?r.decision.ruleId:void 0}});return{passed:t.filter((e)=>e.passed).length,failed:t.filter((e)=>!e.passed).length,total:t.length,results:t}}function Ve(n){let t=z({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},n);if(r2(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function Z0(n={}){let t=await Dn(!n.json,()=>{let e=VL(n);return{ready:e,finish:()=>e}},()=>gn(),{loadingMessage:"Checking system status…"});if(n.json)console.log(JSON.stringify(t,null,2));else UL(t);return GL(t.hooks,t.engineSelfTest,{userConfig:t.userConfig,projectConfig:t.projectConfig})?1:0}async function VL(n){let t=n.cwd??process.cwd(),e=await xn(),r=en(t,{ampPluginListOutput:e.ampPluginListOutput,codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.copilotCliVersion}),a=N1(t),l=na(),d=W({cwd:t}),s=d.policy,c=d2(s),L=g2(s,c.capabilities),i=Un(7),u=n.skipUpdateCheck?{currentVersion:j(),latestVersion:null,updateAvailable:!1}:await P2(),o={hooks:r,engineSelfTest:J0(),userConfig:a.userConfig,projectConfig:a.projectConfig,configState:hn(d),effectiveRules:a.effectiveRules,shadowedRules:a.shadowedRules,environment:l,effectiveSafety:{selectedPreset:s.safety.level??"standard",level:c.effectiveLevel,capabilities:c.capabilities,ruleOverrides:s.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(L).filter(([,p])=>p.source==="rule_override"&&p.override==="off"&&p.inheritedEnabled&&p.changesInherited).map(([p])=>p),ruleCounts:{stored:Object.keys(s.destructiveCommandRuleOverrides).length,effective:Object.values(L).filter((p)=>p.changesInherited).length}},posture:oa(a.userConfig.path),activity:i,update:u,system:e};return{...o,findings:ea(o)}}function GL(n,t,e){return n.length>0&&n.every((r)=>!r.configured)||n.some((r)=>r.inspectionStatus==="failed")||t.failed>0||e.userConfig.exists&&!e.userConfig.valid||e.projectConfig.exists&&!e.projectConfig.valid}function UL(n){console.log(),console.log(aa(n.hooks)),console.log(),console.log(la(n.engineSelfTest)),console.log(),console.log(da(n)),console.log(),console.log(sa(n.environment)),console.log(),console.log(ca(n)),console.log(),console.log(La(n.findings)),console.log(),console.log(ia(n.activity)),console.log(),console.log(ua(n.system)),console.log(),console.log(pa(n.update)),console.log(va(n))}import{existsSync as CL}from"node:fs";var OL=/^[A-Za-z0-9_@%+=:,./-]+$/,Q0="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function Ge(n){let t=z({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},n);if(r2(t.errors))return console.error(Q0),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!CL(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let e=t.positionals.length===1?t.positionals[0]:t.positionals.map((r)=>OL.test(r)?r:`'${r.replaceAll("'","'\\''")}'`).join(" ");if(!e)return console.error("Error: No command provided"),console.error(Q0),null;return{json:t.flags.json,cwd:t.values.cwd,command:e}}function X0(n){if(n)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function Y0(n,t){let r=t-18;return[`${n.dtl}${n.dh.repeat(t)}${n.dtr}`,`${n.dv}  Command Analysis${" ".repeat(r)}${n.dv}`,`${n.dbl}${n.dh.repeat(t)}${n.dbr}`]}function Ue(n){return JSON.stringify(n)}function S0(n,t=0){return`[${n.map((r,a)=>ra(r,a,t)).join(",")}]`}function dt(n,t,e=70){let r=n.split(" "),a=[],l="";for(let d of r)if(l&&l.length+d.length+1>e)a.push(l),l=d;else l=l?`${l} ${d}`:d;if(l)a.push(l);return a.map((d,s)=>s===0?d:`${t}${d}`)}function H0(n,t,e){let r=[];switch(n.type){case"parse":return null;case"env-strip":{r.push(""),r.push(`STEP ${t} ${e.h} Strip environment variables`);let a=Object.keys(n.envVars);return r.push(`  Removed: ${a.map((l)=>`${l}=<redacted>`).join(", ")}`),r.push(`  Tokens:  ${Ue(n.output)}`),{lines:r,incrementStep:!0}}case"leading-tokens-stripped":return r.push(""),r.push(`STEP ${t} ${e.h} Strip wrappers`),r.push(`  Removed: ${n.removed.join(", ")}`),r.push(`  Tokens:  ${Ue(n.output)}`),{lines:r,incrementStep:!0};case"shell-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Detect shell wrapper`),r.push(`  Wrapper: ${n.wrapper} -c`),r.push(`  Inner:   ${n.innerCommand}`),{lines:r,incrementStep:!0};case"interpreter":{if(r.push(""),r.push(`STEP ${t} ${e.h} Detect interpreter`),r.push(`  Interpreter: ${n.interpreter}`),r.push(`  Code:        ${n.codeArg}`),n.paranoidBlocked)r.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:r,incrementStep:!0}}case"busybox":return r.push(""),r.push(`STEP ${t} ${e.h} Busybox wrapper`),r.push(`  Subcommand: ${n.subcommand}`),{lines:r,incrementStep:!0};case"transparent-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Transparent wrapper`),r.push(`  Wrapper: ${n.wrapper}`),r.push(`  Tokens:  ${Ue(n.output)}`),{lines:r,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{r.push(""),r.push(`STEP ${t} ${e.h} Match rules`);let a=`${n.ruleModule}:${n.ruleFunction}()`;if(r.push(`  Rule:   ${a}`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}case"worktree-relaxation":return r.push(""),r.push(`STEP ${t} ${e.h} Worktree relaxation`),r.push(`  Mode:   ${m.worktree.name}`),r.push(`  Git cwd: ${n.gitCwd}`),r.push("  Result: Allowed local discard in linked worktree"),{lines:r,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(n.embeddedCommandFound)return r.push(""),r.push(`STEP ${t} ${e.h} Fallback scan`),r.push(`  Found: ${n.embeddedCommandFound}`),{lines:r,incrementStep:!0};return null}case"custom-rules-check":{if(n.rulesChecked){if(r.push(""),r.push(`STEP ${t} ${e.h} Custom rules`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(n.matched)return r.push(""),r.push(`STEP ${t} ${e.h} Dangerous text check`),r.push(`  Token:  ${n.token}`),r.push("  Result: MATCHED"),{lines:r,incrementStep:!0};return null}case"strict-unparseable":return r.push(""),r.push(`STEP ${t} ${e.h} Strict mode check`),r.push(`  Command: ${n.rawCommand}`),r.push("  Result:  ✗ UNPARSEABLE"),{lines:r,incrementStep:!0};case"segment-skipped":return null;case"error":return r.push(""),r.push(`ERROR: ${n.message}`),{lines:r,incrementStep:!1};default:return null}}function Ce(n,t){let e=X0(t?.asciiOnly??!1),r=58,a=[],l=1;a.push(...Y0(e,58)),a.push("");let d=n.trace.steps.find((p)=>p.type==="error");if(d&&d.type==="error"){a.push("ERROR"),a.push(`  ${d.message}`),a.push(""),a.push("RESULT"),a.push(`  Status: ${n.result==="blocked"?b.red("BLOCKED"):b.green("ALLOWED")}`),a.push(""),a.push("CONFIG");let p=n.configSource??"none";return a.push(`  Path: ${p}`),a.join(`
`)}let s=n.trace.steps.find((p)=>p.type==="parse");if(s&&s.type==="parse"){a.push("INPUT"),a.push(`  ${s.input}`),a.push(""),a.push(`STEP ${l} ${e.h} Split shell commands`),l++;for(let p=0;p<s.segments.length;p++){let f=s.segments[p];if(f){let v=Math.random();a.push(`  Segment ${p+1}: ${S0(f,v)}`)}}}let c=n.trace.segments,L=c.length>1;for(let p of c){if(L){a.push("");let x="";if(s&&s.type==="parse"){let zt=s.segments[p.index];if(zt)x=zt.join(" ")}let w=54,y=x,J=` Segment ${p.index+1}: `,Q2=" ";if(x){if(J.length+x.length+Q2.length>w){let Y3=w-J.length-Q2.length;y=`${x.substring(0,Y3-1)}…`}}let dn=x?`${J}${y}${Q2}`:` Segment ${p.index+1} `,jt=x?`${J}${b.cyan(y)}${Q2}`:dn,wr=58-dn.length,xr=Math.floor(wr/2),X3=wr-xr;a.push(`${e.sh.repeat(xr)}${jt}${e.sh.repeat(X3)}`)}if(p.steps.find((x)=>x.type==="segment-skipped")){a.push(""),a.push("  (skipped — prior segment blocked)");continue}let v=!1,h=!1;for(let x of p.steps){let w=H0(x,l,e);if(w){if(h=!0,x.type==="recurse"){a.push("");let y=" RECURSING ",J=58-y.length-4;a.push(`  ${e.tl}${e.h}${y}${e.h.repeat(J)}`),a.push(`  ${e.v}`),v=!0;continue}for(let y of w.lines)if(v)a.push(`  ${e.v} ${y}`);else a.push(y);if(w.incrementStep)l++}}if(v)a.push(`  ${e.v}`),a.push(`  ${e.bl}${e.h.repeat(56)}`),v=!1;if(!h)a.push(""),a.push(`  ${b.green("✓")} Allowed (no matching rules)`)}if(a.push(""),a.push("RESULT"),n.result==="blocked"){if(a.push(`  Status: ${b.red("BLOCKED")}`),n.customRule){if(a.push(`  Rule: ${n.customRule.id}`),n.customRule.rulebook)a.push(`  Rulebook: ${n.customRule.rulebook.name} ${n.customRule.rulebook.version}`);if(n.customRule.source)a.push(`  Source: ${n.customRule.source}`);if(n.customRule.override)a.push(`  Override: reason ${n.customRule.override.reason}`)}if(n.reason){let p=dt(n.reason,"          ");a.push(`  Reason: ${p[0]}`);for(let f=1;f<p.length;f++)a.push(p[f]??"")}}else a.push(`  Status: ${b.green("ALLOWED")}`);a.push(""),a.push("CONFIG");let i=n.configSource??"none",u=n.configValid?"":" (invalid)";a.push(`  Path: ${i}${u}`),a.push(`  Safety preset: ${n.selectedPreset??"standard"}`),a.push(`  Effective capabilities: ${n.effectiveLevel}`);let o=Object.entries(n.destructiveCommandRuleOverrides??{});if(a.push(`  Rule customizations: ${o.length}`),n.ruleActivation)a.push(`  Rule activation: ${n.ruleActivation.id} — ${n.ruleActivation.enabled?"on":"off"} via ${n.ruleActivation.source}`);return a.join(`
`)}function Oe(n){return JSON.stringify(n,null,2)}var A0="2.0.6",G="  ",F2="cc-safety-net";function W0(n){return n.argument?`${n.flags} ${n.argument}`:n.flags}function TL(n){return Math.max(...n.map((t)=>W0(t).length))}function _L(n){return Math.max(...n.map((t)=>t.usage.length))}function EL(n){return Math.max(...n.map((t)=>`${F2} ${t.usage}`.length))}function PL(n,t){let e=`${F2} ${n.usage}`;return`${G}${e.padEnd(t+2)}${n.description}`}function i2(n,t){return`${G}${n.padEnd(Math.max(40,n.length+2))}${t}`}function st(n,t=console.log){let e=[];if(e.push(`${F2} ${n.name}`),e.push(""),e.push(`${G}${n.description}`),e.push(""),e.push("USAGE:"),e.push(`${G}${F2} ${n.usage}`),e.push(""),n.subcommands&&n.subcommands.length>0){e.push("SUBCOMMANDS:");let r=_L(n.subcommands);for(let a of n.subcommands)e.push(`${G}${a.usage.padEnd(r+2)}${a.description}`);e.push("")}if(n.options.length>0){e.push("OPTIONS:");let r=TL(n.options);for(let a of n.options){let l=W0(a),d=a.default?`${a.description} (default: ${a.default})`:a.description;e.push(`${G}${l.padEnd(r+2)}${d}`)}e.push("")}if(n.examples&&n.examples.length>0){e.push("EXAMPLES:");for(let r of n.examples)e.push(`${G}${r}`)}t(e.join(`
`))}function Te(){let n=P1(),t=EL(n),e=[];e.push(`${F2} v${A0}`),e.push(""),e.push("Blocks destructive commands and secret access."),e.push(""),e.push("COMMANDS:");for(let r of n)e.push(PL(r,t));e.push(""),e.push("GLOBAL OPTIONS:"),e.push(`${G}-h, --help       Show help (use with command for command-specific help)`),e.push(`${G}-V, --version    Show version`),e.push(""),e.push("HELP:"),e.push(`${G}${F2} help <command>     Show help for a specific command`),e.push(`${G}${F2} <command> --help   Show help for a specific command`),e.push(""),e.push("ENVIRONMENT VARIABLES:"),e.push(i2(`${m.level.name}=standard|strict|paranoid`,"Set session safety level")),e.push(i2(`${m.worktree.name}=1`,"Allow local git discards in linked worktrees")),e.push(i2(`${m.debug.name}=1`,"Print diagnostic messages to stderr")),e.push(i2(`${m.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),e.push(i2("CC_SAFETY_NET_HOME","Override rule config home directory")),e.push(""),e.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),e.push(i2(`${m.strict.name}=1`,"Force safety.overrides.fail_closed on")),e.push(i2(`${m.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),e.push(i2(`${m.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),e.push(i2(`${m.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),e.push(""),e.push("Documentation:        https://ccsafetynet.com/docs"),console.log(e.join(`
`))}function R0(){console.log(A0)}function Jn(n,t=console.log){let e=Gn(n);if(!e)return!1;if(e.hidden||e.name.toLowerCase()!==n.toLowerCase())return!1;return st(e,t),!0}import{existsSync as Lr,readFileSync as Vl}from"node:fs";import{homedir as Ei}from"node:os";import{join as sr}from"node:path";import*as h2 from"node:readline";function IL(n){return n==="install"?"Install":"Uninstall"}function NL(n){return n==="install"?"Installing":"Uninstalling"}function ni(n){return n==="install"?"into":"from"}function V0(n){return n?.available===!0}function ti(n,t){let e=new Set(t);return n.filter((r)=>e.has(r.target)).map((r)=>r.target)}function K0(n,t,e){if(n.length===0||n.every((r)=>!r.available))return t;return Array.from({length:n.length},(r,a)=>a+1).map((r)=>(t+r*e+n.length)%n.length).find((r)=>V0(n[r]))}function ei(n,t,e){if(e.ctrl&&e.name==="c")return"interrupt";if(e.name==="escape"||t==="q")return"abort";if(n==="install"&&(t==="u"||t==="U"))return"update";if(e.name==="up"||t==="k")return"up";if(e.name==="down"||t==="j")return"down";if(e.name==="space"||t===" ")return"toggle";if(e.name==="return"||e.name==="enter")return"confirm";return null}function ri(n){return{cursor:n.findIndex((t)=>t.available),selected:[]}}function ai(n,t,e){if(e==="confirm"||e==="update"||e==="abort"||e==="interrupt")return{state:n,done:e};if(e==="up")return{state:{...n,cursor:K0(t,n.cursor,-1)}};if(e==="down")return{state:{...n,cursor:K0(t,n.cursor,1)}};let r=t[n.cursor];if(!V0(r))return{state:n};let a=n.selected.includes(r.target)?n.selected.filter((l)=>l!==r.target):ti(t,[...n.selected,r.target]);return{state:{...n,selected:a}}}var G0="◉",U0="◯",C0=">",O0=" ";function li(n,t,e,r={}){let a=r.color!==!1,l=a?b.dim:(c)=>c,d=a?b.green:(c)=>c,s=a?b.bold:(c)=>c;return["",`${IL(n)} CC Safety Net ${ni(n)}:`,"",...t.map((c,L)=>{let i=e.selected.includes(c.target),u=L===e.cursor,o=i?G0:U0,p=u?C0:O0,f=c.available?"":` (${c.unavailableReason??"not installed"})`,v=`${o} ${c.label}${f}`,h=!c.available?l(v):i?d(v):u?s(v):v;return`${p} ${h}`}),"",n==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((c)=>c.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${n}. q/Esc: close`].join(`
`)}var M0=["global-hook","plugin"];function di(n,t,e={}){let r=e.color!==!1?b.bold:(l)=>l;return["","Install the Kimi Code integration as:","",...[`Global hook — ${t?"already installed; selecting it reports the current state":"write the hook into ~/.kimi-code/config.toml now"}`,"Native Kimi plugin — print the steps to run inside Kimi Code"].map((l,d)=>{let s=d===n,c=`${s?G0:U0} ${l}`;return`${s?C0:O0} ${s?r(c):c}`}),"","Enter: confirm  Up/Down: move  q/Esc: cancel"].join(`
`)}function T0(n){let{input:t,output:e}=n;h2.emitKeypressEvents(t);let r=t.isRaw===!0;t.setRawMode(!0),t.resume();let a=0,l=()=>{if(a===0)return;h2.moveCursor(e,0,-a),h2.cursorTo(e,0),h2.clearScreenDown(e)},d=()=>{l();let s=n.render();e.write(`${s}
`),a=s.split(`
`).length};return new Promise((s)=>{let c=(i)=>{t.off("keypress",L),t.setRawMode(r),t.pause(),l(),s(i)};function L(i,u){n.onKey(i,u,{finish:c,draw:d})}t.on("keypress",L),d()})}function _0(n={}){let t=0;return T0({input:n.input??process.stdin,output:n.output??process.stdout,render:()=>di(t,n.globalHookInstalled===!0),onKey:(e,r,a)=>{if(r.ctrl&&r.name==="c"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(r.name==="escape"||e==="q")return a.finish(null);if(r.name==="return"||r.name==="enter")return a.finish(M0[t]);if(r.name==="up"||r.name==="down"||e==="k"||e==="j")t=(t+1)%M0.length,a.draw()}})}function _e(n=process.stdin,t=process.stdout){return Boolean(n.isTTY&&t.isTTY&&typeof n.setRawMode==="function")}function E0(n,t,e={}){let r=e.output??process.stdout,a=ri(t);return T0({input:e.input??process.stdin,output:r,render:()=>li(n,t,a),onKey:(l,d,s)=>{let c=ei(n,l,d);if(!c)return;let L=ai(a,t,c);if(a=L.state,L.done==="interrupt"){s.finish(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(L.done==="abort")return s.finish(null);if(L.done==="update")return s.finish("update");if(L.done==="confirm"){if(a.selected.length===0){r.write("\x07"),s.draw();return}s.finish([...a.selected]),r.write(`${NL(n)} selected integrations...
`);return}s.draw()}})}import{existsSync as I0,lstatSync as N0,mkdtempSync as ci,readFileSync as it,rmSync as nl}from"node:fs";import{tmpdir as Li}from"node:os";import{dirname as ii,join as B2}from"node:path";import{fileURLToPath as pi}from"node:url";var Ee="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp";import{spawn as si}from"node:child_process";var Pe=(n,t)=>{let e=f2([...n],process.env);return new Promise((r)=>{let a=si(e.cmd,e.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),l=Se(a),d=!1,s=setTimeout(()=>{d=!0,a.kill()},120000);a.on("error",(c)=>{clearTimeout(s),r({status:null,errorCode:c.code,stdout:l.stdout,stderr:[c.message,l.stderr].filter(Boolean).join(`
`)})}),a.on("close",(c)=>{clearTimeout(s),r({status:d?null:c,errorCode:d?"ETIMEDOUT":void 0,stdout:l.stdout,stderr:l.stderr})})})};var P0=B2("amp","cc-safety-net.ts"),p2="cc-safety-net.ts";function ui(n){return B2(n,".config","amp","plugins",p2)}function vi(){let n=ii(pi(import.meta.url));return[B2(n,"..",P0),B2(n,"..","..","..","dist",P0)]}function oi(n=vi()){let t=n.find((e)=>I0(e)&&N0(e).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function tl(n){try{return N0(n)}catch{return}}function el(n){try{return JSON.parse(n)}catch{return}}function rl(n){return n.subarray(0,Buffer.byteLength(Ee)).toString("utf-8")===Ee}async function Zn(n,t,e){let r=await n(t,e);if(r.status===0)return r;throw Error([`Failed to run ${t.join(" ")}${r.status===null?"":` (exit ${r.status})`}.`,[r.stdout,r.stderr].filter(Boolean).join(`
`).trim()].filter(Boolean).join(`
`))}async function al(n){let t=await n(["amp","plugins","repositories","--json"]);if(t.status===null)throw Error(`${t.errorCode==="ENOENT"?'Amp CLI not found. Install the amp CLI, sign in with "amp login", and rerun install --amp.':`amp plugins repositories --json did not finish (${t.errorCode??"terminated"}). Check that the amp CLI responds and rerun install --amp.`}
...
`)}`.trim());let e=el(t.stdout),r=(Array.isArray(e)?e:[]).filter((a)=>$(a,"scope")==="user"&&$(a,"exists")===!0&&$(a,"viewerCanWrite")===!0).map((a)=>$(a,"cloneRef")).find((a)=>typeof a==="string"&&a.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}async function ll(n,t){let e=ci(B2(Li(),"cc-safety-net-amp-"));try{return await Zn(n,["amp","clone","user-plugins",e]),await t(e)}finally{nl(e,{recursive:!0,force:!0})}}function dl(n,t){let e=B2(n,p2),r=tl(e);if(!r)return;if(r.isSymbolicLink()||!r.isFile())throw Error(`Refusing to ${t} ${p2} in your Amp personal plugins repository: not a regular file. Remove it there and rerun install --amp.`);let a=it(e);if(rl(a))return a;throw Error(`Refusing to ${t} unmanaged file ${p2} in your Amp personal plugins repository. Remove it there and rerun install --amp.`)}async function sl(n,t,e,r){if(await Zn(n,e,t),(await Zn(n,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await Zn(n,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",r],t),await Zn(n,["git","push","origin","HEAD"],t),!0}function ct(n,t){let e=ui(n),r=tl(e);if(!r)return;if(!r.isSymbolicLink()&&r.isFile()&&rl(it(e))){nl(e);return}if(t==="keep")return;throw Error(`Local Amp plugin ${e} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function bi(){let n=fn();if(!I0(n))return"";let t=el(it(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(Lt(t))};
`}async function cl(n,t=oi(),e=Pe){let r=Buffer.concat([it(t),Buffer.from(bi(),"utf-8")]),a=await al(e);return ll(e,async(l)=>{let d=`${a}/${p2}`;if(dl(l,"overwrite")?.equals(r))return ct(n,"fail"),{path:d,alreadyInstalled:!0};B(B2(l,p2),r);let s=await sl(e,l,["git","add",p2],`chore: update cc-safety-net plugin to v${j()}`);return ct(n,"fail"),{path:d,alreadyInstalled:!s}})}async function Ll(n,t=Pe){let e=await al(t);return ll(t,async(r)=>{let a=`${e}/${p2}`;if(!dl(r,"remove"))return ct(n,"keep"),{path:a,alreadyInstalled:!1};return await sl(t,r,["git","rm",p2],`chore: remove cc-safety-net plugin v${j()}`),ct(n,"keep"),{path:a,alreadyInstalled:!0}})}import{existsSync as il,mkdirSync as fi,readFileSync as hi}from"node:fs";import{dirname as yi}from"node:path";var Ie="npx -y cc-safety-net hook --agy-cli",y2="cc-safety-net";function ut(){return{PreToolUse:[{hooks:[{type:"command",command:Ie,timeout:30}]}]}}function pl(n){try{let t=JSON.parse(hi(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${n}: ${t.message}`);throw t}}function ul(n){let t=n[y2];if(t===void 0)return n[y2]=ut(),n[y2];if(!t||typeof t!=="object"||Array.isArray(t))throw Error(`Antigravity hooks config entry "${y2}" must be an object`);if(!Array.isArray(t.PreToolUse))t.PreToolUse=[];return t}function vl(n){if(!Array.isArray(n.PreToolUse))return!1;return n.PreToolUse.some((t)=>Array.isArray(t.hooks)&&t.hooks.some((e)=>e.command===Ie))}function wi(n){return Object.values(n).some((t)=>t.enabled!==!1&&vl(t))}function xi(n){if(n[y2]===void 0)return!1;let t=ul(n);if(t.enabled!==!1||!vl(t))return!1;return t.enabled=!0,!0}function $i(n){if(n[y2]===void 0){n[y2]=ut();return}let t=ul(n);t.PreToolUse??=[],t.enabled=!0,t.PreToolUse.push(ut().PreToolUse?.[0]??{hooks:[]})}function gi(n){let t=!1;for(let e of Object.values(n)){if(!Array.isArray(e.PreToolUse))continue;e.PreToolUse=e.PreToolUse.flatMap((r)=>{if(!Array.isArray(r.hooks))return[r];let a=r.hooks.filter((l)=>l.command!==Ie);if(a.length!==r.hooks.length)t=!0;return a.length===0?[]:[{...r,hooks:a}]})}return t}function pt(n,t){B(n,`${JSON.stringify(t,null,2)}
`)}function ol(n){let t=mn(n);if(fi(yi(t),{recursive:!0}),!il(t))return pt(t,{[y2]:ut()}),{path:t,alreadyInstalled:!1};let e=pl(t);if(wi(e))return{path:t,alreadyInstalled:!0};if(xi(e))return pt(t,e),{path:t,alreadyInstalled:!1};return $i(e),pt(t,e),{path:t,alreadyInstalled:!1}}function bl(n){let t=mn(n);if(!il(t))return{path:t,alreadyInstalled:!1};let e=pl(t);if(!gi(e))return{path:t,alreadyInstalled:!1};return pt(t,e),{path:t,alreadyInstalled:!0}}import{spawn as Di,spawnSync as mi}from"node:child_process";var U=L2.map((n)=>({target:n.id,flag:n.flag,label:n.installLabel,probeCommand:n.probeCommand})),fl=new Map(U.map((n)=>[n.flag,n.target]));function Ne(n){let t=new Set(n);return U.map((e)=>e.target).filter((e)=>t.has(e))}async function hl(n,t){for(let e of n)await t(e)}var yl=5000;function ki(n){let t=f2([...n],process.env),e=mi(t.cmd,t.args,{env:process.env,stdio:"ignore",timeout:yl});return!e.error&&e.status===0}function tr(n){return new Promise((t)=>{let e=f2([...n],process.env),r=Di(e.cmd,e.args,{env:process.env,stdio:"ignore"}),a=!1,l=(s)=>{if(a)return;a=!0,clearTimeout(d),t(s)},d=setTimeout(()=>{r.kill(),l(!1)},yl);r.on("error",()=>l(!1)),r.on("close",(s)=>l(s===0))})}function qi(n=ki,t={}){let e=new Set(t.configuredTargets??[]);if(t.async)return Promise.all(U.map(async(a)=>({target:a.target,flag:a.flag,label:a.label,...nr(t.action,await n(a.probeCommand),e.has(a.target))})));let r=n;return U.map((a)=>({target:a.target,flag:a.flag,label:a.label,...nr(t.action,r(a.probeCommand),e.has(a.target))}))}function wl(n=tr,t={}){return qi(n,{...t,async:!0})}function xl(n,t){let e=new Set(t.configuredTargets??[]);return n.map((r)=>({...r,...nr(t.action,r.available,e.has(r.target))}))}function nr(n,t,e){if(n==="uninstall")return e?{available:!0}:{available:!1,unavailableReason:"not installed"};if(n==="install"&&e)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as $l,readdirSync as ji,rmSync as zi}from"node:fs";import{join as rn}from"node:path";function vt(n,t=process.platform){let e=rn(process.env.npm_config_cache||(t==="win32"?rn(process.env.LOCALAPPDATA||rn(n,"AppData","Local"),"npm-cache"):rn(n,".npm")),"_npx");if(!$l(e))return;ji(e).filter((r)=>$l(rn(e,r,"node_modules","cc-safety-net"))).forEach((r)=>{zi(rn(e,r),{recursive:!0,force:!0})})}import{existsSync as kl,mkdirSync as Bi,readFileSync as ql}from"node:fs";import{dirname as Ji,join as ml}from"node:path";function gl(n){return n!==void 0&&/\s/.test(n)}function Fi(n,t,e){let r=t+1,a=!1;while(r<n.length){let l=n[r];if(a){a=!1,r++;continue}if(l==="\\"){a=!0,r++;continue}if(l==='"')return r+1;r++}throw Error(e)}function ot(n,t,e){let r=n[t],a=r==="["?"]":"}",l=0,d=t;while(d<n.length){let s=e.skipComment?.(n,d)??d;if(s!==d){d=s;continue}if(n[d]==='"'){d=Fi(n,d,e.stringError);continue}if(n[d]===r)l++;if(n[d]===a){if(l--,l===0)return d}d++}throw Error(e.bracketError)}function Dl(n,t){let e=n.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(n.slice(e))?.[0]??""}function bt(n,t){let{start:e,end:r,end:a}=t;while(gl(n[a]))a++;if(n[a]===","){if(r=a+1,n[r]===`
`)r++;return`${n.slice(0,e)}${n.slice(r)}`}a=t.start-1;while(gl(n[a]))a--;if(n[a]===","){e=a;let l=n.lastIndexOf(`
`,e-1);if(l!==-1&&/^\s*$/.test(n.slice(l+1,e)))e=l}return`${n.slice(0,e)}${n.slice(r)}`}var Qn="npx -y cc-safety-net hook --kimi-code",er=`[[hooks]]
event = "PreToolUse"
command = "${Qn}"`,rr=`{ event = "PreToolUse", command = "${Qn}" }`;function jl(n){return ml(process.env.KIMI_CODE_HOME??ml(n,".kimi-code"),"config.toml")}function Zi(n){return n.split(`
...
`,t+1);return e===-1?n.length:e+1}function Xi(n,t){return ot(n,t,{skipComment:Qi,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function zl(n){let t=!1,e=0;while(e<n.length){let r=n.indexOf(`
`,e),a=r===-1?n.length:r,l=n.slice(e,a);if(/^\s*\[/.test(l))t=!0;if(!t){let d=/^(\s*)hooks\s*=\s*\[/.exec(l);if(d){let s=e+d[0].lastIndexOf("[");return{start:s,end:Xi(n,s)}}}e=r===-1?n.length:r+1}return}function Yi(n,t){let e=n.slice(0,t.end).trimEnd(),r=Dl(n,t.end),a=r===""?"     ":`${r}  `,l=!e.endsWith("[")&&!e.endsWith(",");return`${e}${l?",":""}
${a}${rr}${n.slice(t.end)}`}function Si(n){let t=zl(n);if(t&&n.slice(t.start+1,t.end).trim())return Yi(n,t);let e=Zi(n).trimEnd();if(e==="")return`${er}
`;return`${e}

${er}
`}function Hi(n){return n.split(/(?=^\s*\[)/m).filter((e)=>!/^\s*\[\[hooks]]\s*$/m.test(e)||!e.includes(Qn)).join("").trimEnd()}function Ai(n,t){let e=n.indexOf(rr,t.start);if(e===-1||e>t.end)return n;return bt(n,{start:e,end:e+rr.length})}function Fl(n){let t=jl(n);if(Bi(Ji(t),{recursive:!0}),!kl(t))return B(t,`${er}
`),{path:t,alreadyInstalled:!1};let e=ql(t,"utf-8");if(e.includes(Qn))return{path:t,alreadyInstalled:!0};return B(t,Si(e)),{path:t,alreadyInstalled:!1}}function Bl(n){let t=jl(n);if(!kl(t))return{path:t,alreadyInstalled:!1};let e=ql(t,"utf-8");if(!e.includes(Qn))return{path:t,alreadyInstalled:!1};let r=zl(e),a=r?Ai(e,r):`${Hi(e)}
`;return B(t,a),{path:t,alreadyInstalled:!0}}import{existsSync as Jl,readFileSync as Wi,rmSync as Ri}from"node:fs";import{join as ar}from"node:path";var lr="cc-safety-net",Ki=`${lr}@latest`,Ql=["opencode.json","opencode.jsonc"];function Mi(n){return ar(n,".config","opencode",Ql[0])}function Vi(n){return Ql.map((t)=>ar(n,".config","opencode",t))}function Gi(n){return ar(n,".cache","opencode","packages",Ki)}function dr(n){Ri(Gi(n),{recursive:!0,force:!0})}function ft(n,t){if(n[t]==="/"&&n[t+1]==="/"){let e=n.indexOf(`
`,t+2);return e===-1?n.length:e+1}if(n[t]==="/"&&n[t+1]==="*"){let e=n.indexOf("*/",t+2);return e===-1?n.length:e+2}return t}function Zl(n,t){let e=t;while(e<n.length){if(/\s/.test(n[e]??"")){e++;continue}let r=ft(n,e);if(r===e)return e;e=r}return e}function Xl(n,t){let e=t+1,r=!1;while(e<n.length){if(r){r=!1,e++;continue}if(n[e]==="\\"){r=!0,e++;continue}if(n[e]==='"')return e+1;e++}throw Error("Unterminated string in OpenCode config")}function Yl(n,t,e){return JSON.parse(n.slice(t,e))}function Ui(n,t){return ot(n,t,{skipComment:ft,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function Ci(n){let t=0,e=0;while(e<n.length){let r=ft(n,e);if(r!==e){e=r;continue}if(n[e]==='"'){let a=Xl(n,e);if(t===1&&Yl(n,e,a)==="plugin"){let l=Zl(n,a),d=Zl(n,l+1);if(n[l]===":"&&n[d]==="[")return{start:d,end:Ui(n,d)}}e=a;continue}if(n[e]==="{"||n[e]==="[")t++;if(n[e]==="}"||n[e]==="]")t--;e++}return}function Oi(n,t){let e=[],r=t.start+1;while(r<t.end){let a=ft(n,r);if(a!==r){r=a;continue}if(n[r]==='"'){let l=Xl(n,r),d=Yl(n,r,l);if(typeof d==="string"&&d.includes(lr))e.push({start:r,end:l});r=l;continue}r++}return e}function Sl(n,t){try{return JSON.parse(R(n))}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${e.message}`);throw e}}function Ti(n){if(!n||typeof n!=="object"||Array.isArray(n))return!1;let t=n.plugin;if(!Array.isArray(t))return!1;return t.some((e)=>typeof e==="string"&&e.includes(lr))}function _i(n,t){let e=Ci(n);if(!e)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let r=[...Oi(n,e)].reverse().reduce(bt,n);return Sl(r,t),r}function Hl(n){dr(n);let t=Vi(n),e=t.find((a)=>Jl(a)),r=[];for(let a of t){if(!Jl(a))continue;try{let l=Wi(a,"utf-8");if(!Ti(Sl(l,a)))continue;return B(a,_i(l,a)),{path:a,alreadyInstalled:!0}}catch(l){r.push(l instanceof Error?l.message:String(l))}}if(r.length>0)throw Error(r.join(`
`));return{path:e??Mi(n),alreadyInstalled:!1}}var cr="safety-net@cc-marketplace",Al=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]),Wl=new Set(["antigravity-cli","cursor","hermes-agent","kimi-code"]);function ir(n){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(n??"")}function Gl(n){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(n??"")}function Pi(n){return/^Marketplace `cc-marketplace`\s*$/m.test(n??"")}var Ul={"claude-code":{installCommands:(n)=>{let t=Pn(n,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...we(n).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:Pn(n,cr)?[["claude","plugin","uninstall",cr]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:async(n,t)=>{let e=t??await e2(["codex","plugin","list"]),r=Gl(e);return{commands:[r||Pi(e)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:ir(e)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:r}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:async()=>{let n=await e2(["copilot","plugin","list"]),t=[...Ka(n)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...Ma(n)?[["copilot","plugin","uninstall",Aa]]:[]];if(Wa(n))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",t2]],cleanupCommands:t,update:!0};return{commands:[Ra(await e2(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",t2]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(n)=>{let t=je(n);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:We,installCommands:()=>({commands:$0()}),uninstallCommands:[["openclaw","plugins","uninstall",q,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:dr,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function wt(){return process.env.HOME??Ei()}function Cl(n,t=(e)=>e){try{let e=JSON.parse(t(Vl(n,"utf-8")));if(!e||typeof e!=="object"||Array.isArray(e))throw Error(`Settings file ${n} must be a JSON object`);return e}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse ${n}: ${e.message}`);throw e}}function Ii(n){let t=sr(kn(n),"settings.json");if(!Lr(t))return;let e=Cl(t,R),r=e.enabledPlugins;if(!r||typeof r!=="object"||Array.isArray(r))return;if(r[t2]!==!1)return;let a=Vl(t,"utf-8"),l=a.replace(new RegExp(`("${t2}"\\s*:\\s*)false`),"$1true");return r[t2]=!0,B(t,l!==a?l:`${JSON.stringify(e,null,2)}
...
`),`Enabled npm:cc-safety-net extensions in ${t}`}function Rl(n,t){let e=z({label:t,booleans:Object.fromEntries(U.map((l)=>[l.target,[l.flag]]))},n),r=e.errors[0];if(r)throw Error(r);let a=U.filter((l)=>e.flags[l.target]).map((l)=>l.target);if(a.length!==1)throw Error(`Choose exactly one ${t} target: ${[...fl.keys()].join(", ")}`);return a[0]}async function Ol(n=wt(),t=E2){let[e,r,a]=await Promise.all([t(["amp","plugins","list"],30000),t(["codex","plugin","list"],30000),t(["copilot","--binary-version"])]);return{codexPluginListOutput:r,hooks:en(process.cwd(),{homeDir:n,ampPluginListOutput:e,codexPluginListOutput:r,copilotCliVersion:a})}}async function n5(n,t=E2){let e=await Ol(wt(),t);return e.hooks.filter((r)=>n==="install"?r.configured:r.detected||r.inspectionStatus==="not-inspected").filter((r)=>r.platform!=="codex"||!ir(e.codexPluginListOutput)||Gl(e.codexPluginListOutput)).map((r)=>r.platform)}function t5(n,t,e){if(t.length>0)return{finish:async()=>[Rl(t,n)]};if(!e.selectTargets&&!_e(e.input,e.output))return{finish:async()=>[Rl(t,n)]};let r=e.detectConfiguredTargets??(()=>n5(n,e.fetchVersion)),a=Promise.all([wl(e.probeTargets),r()]);return{ready:a,finish:async()=>{let[l,d]=await a,s=xl(l,{action:n,configuredTargets:d}),c=e.selectTargets?await e.selectTargets(n,Ml(n,s)):await E0(n,Ml(n,s),{input:e.input,output:e.output});if(c==="update")return c;if(!c||c.length===0)return null;return Ne(c)}}}async function J2(n,t,e=!1,r){let a=Ul[n];a.beforeInstall?.(t);let l=typeof a.installCommands==="function"?await a.installCommands(t,r):{commands:a.installCommands};return await He(l.commands),await b0(l.cleanupCommands??[]),[`${l.update||e?"Updated":"Installed"} ${b2(n)} integration`,a.postInstallMessage].filter(Boolean).join(`
`)}async function an(n){let t=Ul[n];if(!t.uninstallCommands)throw Error(`${b2(n)} uninstall is not supported`);return await He(t.uninstallCommands),`Uninstalled ${b2(n)} integration`}function e5(n){let t=Hl(n);return t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`}var r5={"antigravity-cli":{install:ol,uninstall:bl},cursor:{install:Ia,uninstall:Na},"kimi-code":{install:Fl,uninstall:Bl}};function ln(n,t,e,r=!1){if(n==="install"&&!r)vt(e);let a=r5[t][n](e),l=b2(t),d=n!=="install"?"Uninstalled":r?"Updated":"Installed";return n==="install"&&a.alreadyInstalled?r?`${l} hook up to date in ${a.path}`:`${l} hook already installed in ${a.path}`:n==="uninstall"&&!a.alreadyInstalled?`${l} hook not installed in ${a.path}`:`${d} ${l} hook ${n==="install"?"in":"from"} ${a.path}`}var a5={amp:{install:cl,uninstall:Ll,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:l0,uninstall:d0,afterInstall:async(n)=>{let t=Xe(n);return await e2(["hermes","plugins","enable",M,"--no-allow-tool-override"]),!t},beforeUninstall:async(n)=>{Qe(n);try{await e2(["hermes","plugins","disable",M])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
...
`)}var l5={amp:{install:(n,t)=>ht("install","amp",n,t),uninstall:(n)=>ht("uninstall","amp",n)},"antigravity-cli":{install:(n,t)=>ln("install","antigravity-cli",n,t),uninstall:(n)=>ln("uninstall","antigravity-cli",n)},"claude-code":{install:(n,t)=>J2("claude-code",n,t),uninstall:()=>an("claude-code")},codex:{install:(n,t,e)=>J2("codex",n,t,e),uninstall:()=>an("codex")},"copilot-cli":{install:async(n,t)=>[await J2("copilot-cli",n,t),Ii(n)].filter(Boolean).join(`
`),uninstall:()=>an("copilot-cli")},cursor:{install:(n,t)=>ln("install","cursor",n,t),uninstall:(n)=>ln("uninstall","cursor",n)},"gemini-cli":{install:(n,t)=>J2("gemini-cli",n,t),uninstall:()=>an("gemini-cli")},"hermes-agent":{install:(n,t)=>{if(!t)vt(n);return ht("install","hermes-agent",n,t)},uninstall:(n)=>ht("uninstall","hermes-agent",n)},"kimi-code":{install:(n,t)=>ln("install","kimi-code",n,t),uninstall:(n)=>ln("uninstall","kimi-code",n)},openclaw:{install:async(n,t)=>{let e=await J2("openclaw",n,t);return await g0(),e},uninstall:(n)=>{return We(n),an("openclaw")}},opencode:{install:(n,t)=>J2("opencode",n,t),uninstall:(n)=>e5(n)},pi:{install:async(n,t)=>[await J2("pi",n,t),Ni(n)].filter(Boolean).join(`
`),uninstall:()=>an("pi")}},Kl=["Install CC Safety Net as a native Kimi Code plugin:","","  1. Start Kimi Code and run: /plugins install https://github.com/kenryu42/cc-safety-net","     Confirm the trust prompt; it defaults to cancel.","  2. Run /reload, or start a new session.","","Note: Kimi Code hooks are fail-open. When the hook process cannot start, crashes, or times","out, Kimi Code allows the tool call."].join(`
`);function d5(n){if(zn({homeDir:n,cwd:process.cwd()}).status!=="configured")return Kl;return[Kl,"",b.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function Ml(n,t){return t.map((e)=>n==="install"&&e.target==="kimi-code"&&e.unavailableReason==="already installed"?{...e,available:!0,unavailableReason:void 0,label:`${e.label} (global hook installed)`}:e)}function s5(n,t){if(n.selectKimiInstallMethod)return n.selectKimiInstallMethod();if(!_e(n.input,n.output))return Promise.resolve("global-hook");return _0({input:n.input,output:n.output,globalHookInstalled:zn({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function Tl(n,t,e,r=!1,a){return l5[t][n](e,r,a)}function c5(n){let t=z({label:"update"},n).errors[0];if(t)throw Error(t)}async function L5(n,t=E2){let e=await Ol(n,t),r=sr(kn(n),"installed-plugins");return{targets:Ne([...e.hooks.filter((l)=>l.platform!=="copilot-cli"&&l.detected).map((l)=>l.platform),...[In,Ha,Sa].flatMap((l)=>Lr(sr(r,...l))?["copilot-cli"]:[]),...Pn(n,cr)?["claude-code"]:[],...ir(e.codexPluginListOutput)?["codex"]:[]]),codexPluginListOutput:e.codexPluginListOutput}}async function i5(n){let t=wt(),e=n.output??process.stdout,r=L5(t,n.fetchVersion??E2).then(async(s)=>{let c=new Set(s.targets);return{targets:s.targets,codexPluginListOutput:s.codexPluginListOutput,available:new Map(await Promise.all(U.filter((L)=>c.has(L.target)&&Al.has(L.target)).map(async(L)=>[L.target,await tr(L.probeCommand)])))}}),a=await Dn(n.showBanner??!0,()=>({ready:r,finish:()=>r}),()=>gn({input:n.input??process.stdin,output:e}),{loadingMessage:"Checking installed integrations…",output:e});if(a.targets.length===0)return e.write("No installed integrations found. Run `cc-safety-net install` to set one up.\n"),0;let l=a.targets.some((s)=>Wl.has(s))?await Promise.resolve().then(()=>{return vt(t),null}).catch((s)=>yt(s)):null,d=await Tn(Promise.all(a.targets.map((s)=>{if(Al.has(s)&&!a.available.get(s))return Promise.resolve({message:`${b2(s)} not found; skipped`,failed:!1});if(l!==null&&Wl.has(s))return Promise.resolve({message:l,failed:!0});return Tl("install",s,t,!0,a.codexPluginListOutput).then((c)=>({message:c,failed:!1}),(c)=>({message:yt(c),failed:!0}))})),{loadingMessage:`Updating ${a.targets.length} integration${a.targets.length===1?"":"s"}…`,output:e});return d.forEach((s)=>{s.failed?console.error(s.message):e.write(`${s.message}
...
`),0;if(r==="update")return(e.runUpdate??(()=>pr([],{fetchVersion:e.fetchVersion,input:e.input,output:e.output,showBanner:!1})))();let a=wt(),l=e.output??process.stdout;return await hl(r,async(d)=>{if(d==="kimi-code"&&n==="install"){let c=await s5(e,a);if(c===null){l.write(`Cancelled: Kimi Code integration was not installed.
`);return}if(c==="plugin"){l.write(`${d5(a)}
`);return}}let s=await Tn(Tl(n,d,a),{loadingMessage:`${n==="install"?"Installing":"Uninstalling"} ${b2(d)} integration…`,output:l});l.write(`${s}
...
${b.red(y)}`);if(w)if(w.result.errors.length>0)C5(w.path,w.result.errors);else U5(w.path,w.result);if(f)return console.error(`
Config validation failed.`),1;return console.log(v?`
Configs valid with warnings.`:`
All configs valid.`),0}function $t(n,t){let e=`legacy ${n} config`;if(t==="cleanup")return`Warning: Legacy ${n} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${n} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${n} config is no longer supported. Fix or delete the ${e}, then run \`npx -y cc-safety-net rule migrate\`.`}function W5(n){if(W2(n)===null)return null;let t=R5(n);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:n.path,result:t}}function R5(n){let t=[],e=new Set,r=(W2(n)??[]).filter((a)=>!H5.has(a.name)).sort((a,l)=>a.name.localeCompare(l.name));if(r.length===0)return{errors:t,ruleNames:e};for(let a of r){if(!pn.test(a.name)){t.push(`rulebook directory names must match ${pn}: ${a.name}`);continue}if(a.kind!=="directory"){t.push(`${a.name} must be a rulebook directory`);continue}let l=D(n.scope,X5(n.path,a.name,"rulebook.json")),d=g(l);if(d===null){t.push(`${a.name}/rulebook.json is required`);continue}try{let s;try{s=JSON.parse(d)}catch{t.push(`${a.name}/rulebook.json: invalid JSON`);continue}let c=a3(s);if(c.name!==a.name){t.push(`rulebook name "${c.name}" must match folder "${a.name}"`);continue}e.add(a.name)}catch(s){t.push(s instanceof Error?`${a.name}/rulebook.json: ${s.message}`:`${a.name}/rulebook.json: ${String(s)}`)}}return{errors:t,ruleNames:e}}function K5(){console.log(l3),console.log(Y5)}function M5(n,t,e,r,a){if(console.log(`
...
✗ Legacy ${n.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),e.errors.length>0){console.error("  Errors:");let a=1;for(let l of e.errors)for(let d of l.split("; "))console.error(`    ${a}. ${d}`),a++;return}if(e.ruleNames.size>0){console.error("  Rules:");let a=1;for(let l of e.ruleNames)console.error(`    ${a}. ${r.get(l)??l}`),a++;return}console.error("  Rules: (none)")}function G5(n,t,e){s3(`${n} config`,t,e)}function U5(n,t){console.log(`
✓ GitHub source rules: ${n}`),console.log("  Rulebooks:");let e=1;for(let r of t.ruleNames)console.log(`    ${e}. ${r}`),e++}function C5(n,t){s3("GitHub source rules",n,t)}function s3(n,t,e){console.error(`
✗ ${n}: ${t}`),console.error("  Errors:");let r=1;for(let a of e)for(let l of a.split("; "))console.error(`    ${r}. ${l}`),r++}function O5(n){try{let t=g(n);if(t===null)return!1;let e=JSON.parse(t);if(e.$schema)return!1;return w2(n,JSON.stringify({$schema:S5,...e},null,2)),!0}catch(t){if(t instanceof Q)throw t;return!1}}var c3=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),_5=new Set(["add","remove","list"]);async function i3(n){try{return await E5(n)}catch(t){if(t instanceof Q)return console.error(t.message),1;throw t}}async function E5(n){let t=I5(n),e=t.help?P5(t.positionals):null;if(e)return st(e),0;if(t.errors.length>0){for(let d of t.errors)console.error(d);return 1}let r=t.positionals[0];if(!r)return st(_2,console.error),1;let a=t.positionals[1],l={global:t.global,check:t.check};if(r==="init"){let d=C(l),s=d.configDir;t8(d.configTarget),L3(D(d.filesystemScope,Wn({...l,cacheConfigDir:s})));let c=T5(s,"example-rules","rulebook.json"),L=D(d.filesystemScope,c);if(t.example&&g(L)===null)_t(L,"example-rules");let i=await R2(l);return Yn(i,"Rule config initialized."),i.ok?0:1}if(r==="add"){if(!a)return console.error("rule add requires a source"),1;let d=await Vt(a,l);return Yn(d,`Added rulebook source: ${a}`),d.ok?0:1}if(r==="remove"){if(!a)return console.error("rule remove requires a source"),1;let d=await Ut(a,{...l,deleteSource:t.deleteSource});return Yn(d,`Removed rulebook source: ${a}`),d.ok?0:1}if(r==="update"||r==="sync"){let d=await R2({...l,only:r==="update"?a:void 0});return Yn(d,t.check?"Rule config checked.":"Rule config synced."),d.ok?0:1}if(r==="list"){let d=v2(),s=P({});return Pl(d,{user:x2(d.userConfigPath,s.userScope),project:x2(d.projectConfigPath,s.projectScope)}),d.errors.length>0?1:0}if(r==="wrapper")return e8(t);if(r==="migrate")return t3({cleanup:t.cleanup,cwd:process.cwd()});if(r==="doc"){console.log(_l);let d=await r3();if(d)console.error(d);return 0}if(r==="verify")return d3();return 1}function P5(n){if(n.length===0)return _2;let t=_2.subcommands.filter((r)=>r.usage.split(" ")[0]===n[0]);if(t.length===0)return null;if(n.length===1&&t.length>1)return{name:`rule ${n[0]}`,description:`Subcommands of rule ${n[0]}`,usage:`rule ${n[0]} <subcommand>`,subcommands:t,options:[]};let e=n.length===1?t[0]:t.find((r)=>r.usage.split(" ")[1]===n[1]);if(!e)return null;return{name:`rule ${n[0]}`,description:e.description,usage:`rule ${e.usage}`,options:[]}}function I5(n){let t=z({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},positionals:"list"},n),e={...t.flags,help:t.help,positionals:t.positionals,errors:t.errors};return N5(e),e}function N5(n){let[t]=n.positionals;if(t&&!c3.has(t))n.errors.push(`Unknown rule subcommand: ${t}`);if(n.deleteSource&&t!=="remove")if(t&&c3.has(t))n.errors.push(`Unknown option for rule ${t}: --delete-source`);else n.errors.push("--delete-source is only valid with 'rule remove'");if(n.cleanup&&t!=="migrate")n.errors.push(gt(t,"--cleanup"));if(n.example&&t!=="init")n.errors.push(gt(t,"--example"));if(t==="migrate"){if(n.global)n.errors.push(gt(t,"--global"));if(n.check)n.errors.push(gt(t,"--check"));if(n.positionals.length>1)n.errors.push(`Unexpected rule migrate argument: ${n.positionals[1]}`)}else if(t==="wrapper")n8(n);else if(n.positionals.length>2)n.errors.push(`Unexpected rule argument: ${n.positionals[2]}`);if(t==="list"&&n.global)n.errors.push("Unknown option for rule list: --global")}function gt(n,t){return n?`Unknown option for rule ${n}: ${t}`:`Unknown option for rule: ${t}`}function n8(n){let t=n.positionals[1],e=n.positionals[2];if(!t){n.errors.push("rule wrapper requires add, remove, or list");return}if(!_5.has(t)){n.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(e)n.errors.push(`Unexpected rule wrapper argument: ${e}`);return}if(!e){n.errors.push(`rule wrapper ${t} requires a command`);return}if(n.positionals.length>3)n.errors.push(`Unexpected rule wrapper argument: ${n.positionals[3]}`)}function t8(n){if(g(n)===null){Tt(n);return}let t=O(n);if(!t.config)return;T(n,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function e8(n){let t=n.positionals[1],e=n.positionals[2],r=C({global:n.global}).configTarget;if(t==="list"){let s=O(r);if(s.errors.length>0){for(let c of s.errors)console.error(c);return 1}return r8(s.config?.transparent_wrappers??[]),0}if(!e||!Pt.test(e))return console.error("transparent wrapper must match command pattern"),1;if(It(e))return console.error(`reserved command "${e}" cannot be a wrapper`),1;let a=O(r);if(a.errors.length>0){for(let s of a.errors)console.error(s);return 1}let l=a.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},d=t==="add"?[...new Set([...l.transparent_wrappers??[],e])]:(l.transparent_wrappers??[]).filter((s)=>s!==e);return T(r,{version:1,rules:l.rules,overrides:l.overrides??{},transparent_wrappers:d}),console.log(t==="add"?`Added transparent wrapper: ${e}`:`Removed transparent wrapper: ${e}`),0}function r8(n){if(n.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${n.length}):`);for(let t of n)console.log(`  - ${t}`)}import{homedir as p3}from"node:os";import{existsSync as a8,readFileSync as l8}from"node:fs";import{homedir as d8}from"node:os";import{join as s8}from"node:path";async function c8(n){if(n.isTTY)return null;return(await le(n).catch(()=>null))?.trim()||null}function L8(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return s8(d8(),".claude","settings.json")}function or(){let n=L8();if(!a8(n))return!1;try{let t=l8(n,"utf-8"),e=JSON.parse(t);if(!e.enabledPlugins)return!1;let r="cc-safety-net@cc-marketplace";if(!(r in e.enabledPlugins))return!1;return e.enabledPlugins[r]===!0}catch(t){if(bn(m.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${n}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function br(n=process.stdin){let t=or(),e;if(!t)e="\uD83D\uDEE1️ CC Safety Net ❌";else{let a=W({cwd:process.cwd()}),l=a.policy,d=d2(l),s=Object.values(g2(l,d.capabilities)).some((L)=>L.changesInherited);e=`\uD83D\uDEE1️ CC Safety Net ${{standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[s?"custom":d.effectiveLevel]}${d.worktreeMode?"\uD83C\uDF33":""}${a.state==="degraded"?"⚠️":""}`}let r=await c8(n);if(r&&!r.startsWith("{"))console.log(`${r} | ${e}`);else console.log(e)}function u3(){let n=W({cwd:process.cwd()}),t=n.policy,e=d2(t),r=!!process.env.NO_COLOR||!process.stdout.isTTY,a=Math.min(process.stdout.columns||80,100),l=r?"ok":"✔",d=r?"OFF":"✘",s=(p,f)=>{let v=`  ${p.padEnd(13)}${f}`;return(v.length>a?`${v.slice(0,a-1)}…`:v).replaceAll(d,b.red(d))},c=Object.values(g2(t,e.capabilities)).some((p)=>p.changesInherited),L=fn(),i={ready:b.green,degraded:b.yellow}[n.state],u=[...or()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...n.diagnostics],o=r?"-":"·";console.log([`${r?"":"\uD83D\uDEE1️  "}CC Safety Net — ${i(n.state)}`,"",s("Protection",`destructive ${t.destructiveCommandProtectionEnabled?l:d}   secrets ${t.secretProtection.enabled?l:d}`),s("Level",c?`${e.effectiveLevel} (customised)`:e.effectiveLevel),s("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),s("Policy",L.startsWith(p3())?`~${L.slice(p3().length)}`:L),...e.worktreeMode?[s("Worktree","relaxations active")]:[],"",...u.length===0?["  Everything configured is active."]:["  Not active",...u.flatMap((p)=>dt(p,"      ",a-6).map((f,v)=>v===0?`    ${o} ${f}`:f)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as J3}from"node:child_process";import{randomBytes as x8}from"node:crypto";import{createServer as $8}from"node:http";import{Writable as g8}from"node:stream";import{homedir as i8}from"node:os";var Dt=500;function p8(n){let t=n.filter((a)=>a.decision!=="allow"),e=n.filter((a)=>a.decision==="allow"),r=Math.min(t.length,Math.max(Dt-e.length,Math.ceil(Dt/2)));return[...t.slice(0,r),...e.slice(0,Dt-r)]}function v3(n,t=s2()){if(t)$2(t);let e=(v)=>new Date(v.getFullYear(),v.getMonth(),v.getDate()).getTime(),r=e(new Date),a=new Date(r);a.setDate(a.getDate()-(n-1));let l=a.getTime(),d=[],s={count:0};for(let v of t?u2(t,s):[])for(let h of sn(v,s)){if(!h||typeof h.ts!=="string"||typeof h.command!=="string")continue;let x=new Date(h.ts).getTime();if(!Number.isFinite(x))continue;if(x>=l)d.push(h)}d.sort((v,h)=>new Date(h.ts).getTime()-new Date(v.ts).getTime());let c=Array.from({length:n},()=>0),L=Array.from({length:n},()=>0),i={},u={},o={},p=0,f=0;for(let v of d){let h=v.agent||"unknown";i[h]=(i[h]??0)+1;let x=Math.round((r-e(new Date(v.ts)))/86400000),w=n-1-x,y=x>=0&&x<n;if(y)L[w]=(L[w]??0)+1;if(v.decision!=="allow"){if(p++,v.ruleId)u[v.ruleId]=(u[v.ruleId]??0)+1;let J=X2(v.segment||v.command);if(J)o[J]=(o[J]??0)+1;if(v.failureStage)f++;if(y)c[w]=(c[w]??0)+1}}return{days:n,logsDir:t,homeDir:i8(),totalInWindow:d.length,truncated:d.length>Dt,unreadable:s.count,counts:{blocked:p,allowed:d.length-p,agents:i,blockedByDay:c,analyzedByDay:L,rules:u,commands:o,errors:f},entries:p8(d).sort((v,h)=>new Date(h.ts).getTime()-new Date(v.ts).getTime())}}import{spawn as u8}from"node:child_process";import{existsSync as o3,statSync as v8}from"node:fs";import{delimiter as o8,join as b8}from"node:path";var f8=120000,mt="Choose the project folder",h8=`try
...
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,b3=[{binary:"zenity",args:["--file-selection","--directory",`--title=${mt}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",mt]}],f3=(n,t)=>(t.PATH??"").split(o8).some((e)=>e.length>0&&o3(b8(e,n)));function h3(n,t){if(n==="darwin"||n==="win32")return!0;if(n!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return b3.some((e)=>f3(e.binary,t))}function w8(n,t){if(n==="darwin")return{cmd:"osascript",args:["-e",h8]};if(n==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",y8]};let e=b3.find((r)=>f3(r.binary,t));return e?{cmd:e.binary,args:e.args}:null}function y3(n=process.platform,t=process.env){let e=w8(n,t);if(!e)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let a=u8(e.cmd,e.args,{env:t,stdio:["ignore","pipe","pipe"]}),l="",d=!1,s=(L)=>{if(d)return;d=!0,clearTimeout(c),r(L)},c=setTimeout(()=>{a.kill(),s({error:"The folder dialog timed out"})},f8);a.stdout.on("data",(L)=>{l+=L.toString()}),a.on("error",()=>s({error:`Could not open the folder dialog (${e.cmd})`})),a.on("close",()=>{let L=l.trim().replace(/\/+$/,"");if(!L)return s({cancelled:!0});if(!o3(L)||!v8(L).isDirectory())return s({error:"That selection is not a folder on disk"});s({path:L})})})}var w3=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
