...
`)}function _s(n){let t=["Variable","Status","Legacy"],e=n.map((r)=>{let a=r.isSet?b.green("✓"):b.dim("✗"),l=r.legacyName&&r.legacyIsSet?`${r.legacyName} ${b.green("✓")}`:r.legacyName??"";return[r.name,a,l]});return m2({headers:t,rows:e})}function ia(n){let t=[];if(n.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${n.totalBlocked} blocked / ${n.sessionCount} sessions)`),t.push(Es(n.recentEntries));if(n.unreadable>0)t.push(`   Warning: ${n.unreadable} audit log ${n.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function Es(n){let t=["Time","Command"],e=n.map((r)=>{let a=z(r.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),l=a.length>40?`${a.slice(0,37)}...`:a;return[r.relativeTime,l]});return m2({headers:t,rows:e})}function La(n){let t=[];if(t.push("Update Check"),n.latestVersion===null&&!n.error)return t.push(Un([["Status",b.dim("Skipped")],["Installed",n.currentVersion]])),t.join(`
...
`)}`.trim());let e=tl(t.stdout),r=(Array.isArray(e)?e:[]).filter((a)=>$(a,"scope")==="user"&&$(a,"exists")===!0&&$(a,"viewerCanWrite")===!0).map((a)=>$(a,"cloneRef")).find((a)=>typeof a==="string"&&a.length>0);if(!r)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return r}async function al(n,t){let e=cL(z2(iL(),"cc-safety-net-amp-"));try{return await Zn(n,["amp","clone","user-plugins",e]),await t(e)}finally{N0(e,{recursive:!0,force:!0})}}function ll(n,t){let e=z2(n,p2),r=nl(e);if(!r)return;if(r.isSymbolicLink()||!r.isFile())throw Error(`Refusing to ${t} ${p2} in your Amp personal plugins repository: not a regular file. Remove it there and rerun install --amp.`);let a=Lt(e);if(el(a))return a;throw Error(`Refusing to ${t} unmanaged file ${p2} in your Amp personal plugins repository. Remove it there and rerun install --amp.`)}async function dl(n,t,e,r){if(await Zn(n,e,t),(await Zn(n,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await Zn(n,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",r],t),await Zn(n,["git","push","origin","HEAD"],t),!0}function ct(n,t){let e=uL(n),r=nl(e);if(!r)return;if(!r.isSymbolicLink()&&r.isFile()&&el(Lt(e))){N0(e);return}if(t==="keep")return;throw Error(`Local Amp plugin ${e} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function bL(){let n=bn();if(!P0(n))return"";let t=tl(Lt(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(it(t))};
`}async function sl(n,t=vL(),e=Pe){let r=Buffer.concat([Lt(t),Buffer.from(bL(),"utf-8")]),a=await rl(e);return al(e,async(l)=>{let d=`${a}/${p2}`;if(ll(l,"overwrite")?.equals(r))return ct(n,"fail"),{path:d,alreadyInstalled:!0};B(z2(l,p2),r);let s=await dl(e,l,["git","add",p2],`chore: update cc-safety-net plugin to v${j()}`);return ct(n,"fail"),{path:d,alreadyInstalled:!s}})}async function cl(n,t=Pe){let e=await rl(t);return al(t,async(r)=>{let a=`${e}/${p2}`;if(!ll(r,"remove"))return ct(n,"keep"),{path:a,alreadyInstalled:!1};return await dl(t,r,["git","rm",p2],`chore: remove cc-safety-net plugin v${j()}`),ct(n,"keep"),{path:a,alreadyInstalled:!0}})}import{existsSync as il,mkdirSync as fL,readFileSync as hL}from"node:fs";import{dirname as yL}from"node:path";var Ie="npx -y cc-safety-net hook --agy-cli",y2="cc-safety-net";function ut(){return{PreToolUse:[{hooks:[{type:"command",command:Ie,timeout:30}]}]}}function Ll(n){try{let t=JSON.parse(hL(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${n}: ${t.message}`);throw t}}function pl(n){let t=n[y2];if(t===void 0)return n[y2]=ut(),n[y2];if(!t||typeof t!=="object"||Array.isArray(t))throw Error(`Antigravity hooks config entry "${y2}" must be an object`);if(!Array.isArray(t.PreToolUse))t.PreToolUse=[];return t}function ul(n){if(!Array.isArray(n.PreToolUse))return!1;return n.PreToolUse.some((t)=>Array.isArray(t.hooks)&&t.hooks.some((e)=>e.command===Ie))}function wL(n){return Object.values(n).some((t)=>t.enabled!==!1&&ul(t))}function xL(n){if(n[y2]===void 0)return!1;let t=pl(n);if(t.enabled!==!1||!ul(t))return!1;return t.enabled=!0,!0}function $L(n){if(n[y2]===void 0){n[y2]=ut();return}let t=pl(n);t.PreToolUse??=[],t.enabled=!0,t.PreToolUse.push(ut().PreToolUse?.[0]??{hooks:[]})}function gL(n){let t=!1;for(let e of Object.values(n)){if(!Array.isArray(e.PreToolUse))continue;e.PreToolUse=e.PreToolUse.flatMap((r)=>{if(!Array.isArray(r.hooks))return[r];let a=r.hooks.filter((l)=>l.command!==Ie);if(a.length!==r.hooks.length)t=!0;return a.length===0?[]:[{...r,hooks:a}]})}return t}function pt(n,t){B(n,`${JSON.stringify(t,null,2)}
`)}function ol(n){let t=mn(n);if(fL(yL(t),{recursive:!0}),!il(t))return pt(t,{[y2]:ut()}),{path:t,alreadyInstalled:!1};let e=Ll(t);if(wL(e))return{path:t,alreadyInstalled:!0};if(xL(e))return pt(t,e),{path:t,alreadyInstalled:!1};return $L(e),pt(t,e),{path:t,alreadyInstalled:!1}}function vl(n){let t=mn(n);if(!il(t))return{path:t,alreadyInstalled:!1};let e=Ll(t);if(!gL(e))return{path:t,alreadyInstalled:!1};return pt(t,e),{path:t,alreadyInstalled:!0}}import{spawn as DL,spawnSync as mL}from"node:child_process";var C=i2.map((n)=>({target:n.id,flag:n.flag,label:n.installLabel,probeCommand:n.probeCommand})),bl=new Map(C.map((n)=>[n.flag,n.target]));function Ne(n){let t=new Set(n);return C.map((e)=>e.target).filter((e)=>t.has(e))}async function fl(n,t){for(let e of n)await t(e)}var hl=5000;function kL(n){let t=f2([...n],process.env),e=mL(t.cmd,t.args,{env:process.env,stdio:"ignore",timeout:hl});return!e.error&&e.status===0}function tr(n){return new Promise((t)=>{let e=f2([...n],process.env),r=DL(e.cmd,e.args,{env:process.env,stdio:"ignore"}),a=!1,l=(s)=>{if(a)return;a=!0,clearTimeout(d),t(s)},d=setTimeout(()=>{r.kill(),l(!1)},hl);r.on("error",()=>l(!1)),r.on("close",(s)=>l(s===0))})}function qL(n=kL,t={}){let e=new Set(t.configuredTargets??[]);if(t.async)return Promise.all(C.map(async(a)=>({target:a.target,flag:a.flag,label:a.label,...nr(t.action,await n(a.probeCommand),e.has(a.target))})));let r=n;return C.map((a)=>({target:a.target,flag:a.flag,label:a.label,...nr(t.action,r(a.probeCommand),e.has(a.target))}))}function yl(n=tr,t={}){return qL(n,{...t,async:!0})}function wl(n,t){let e=new Set(t.configuredTargets??[]);return n.map((r)=>({...r,...nr(t.action,r.available,e.has(r.target))}))}function nr(n,t,e){if(n==="uninstall")return e?{available:!0}:{available:!1,unavailableReason:"not installed"};if(n==="install"&&e)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as xl,readdirSync as jL,rmSync as FL}from"node:fs";import{join as en}from"node:path";function ot(n,t=process.platform){let e=en(process.env.npm_config_cache||(t==="win32"?en(process.env.LOCALAPPDATA||en(n,"AppData","Local"),"npm-cache"):en(n,".npm")),"_npx");if(!xl(e))return;jL(e).filter((r)=>xl(en(e,r,"node_modules","cc-safety-net"))).forEach((r)=>{FL(en(e,r),{recursive:!0,force:!0})})}import{existsSync as ml,mkdirSync as BL,readFileSync as kl}from"node:fs";import{dirname as JL,join as Dl}from"node:path";function $l(n){return n!==void 0&&/\s/.test(n)}function zL(n,t,e){let r=t+1,a=!1;while(r<n.length){let l=n[r];if(a){a=!1,r++;continue}if(l==="\\"){a=!0,r++;continue}if(l==='"')return r+1;r++}throw Error(e)}function vt(n,t,e){let r=n[t],a=r==="["?"]":"}",l=0,d=t;while(d<n.length){let s=e.skipComment?.(n,d)??d;if(s!==d){d=s;continue}if(n[d]==='"'){d=zL(n,d,e.stringError);continue}if(n[d]===r)l++;if(n[d]===a){if(l--,l===0)return d}d++}throw Error(e.bracketError)}function gl(n,t){let e=n.lastIndexOf(`
...
event = "PreToolUse"
command = "${Qn}"`,rr=`{ event = "PreToolUse", command = "${Qn}" }`;function ql(n){return Dl(process.env.KIMI_CODE_HOME??Dl(n,".kimi-code"),"config.toml")}function ZL(n){return n.split(`
