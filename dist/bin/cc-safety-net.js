#!/usr/bin/env node
import{$ as b1,$a as Pt,A as on,Aa as Kr,B as Ll,Ba as Vr,C as N,Ca as v1,D as T,Da as Ar,E as r1,Ea as Mr,F as Ct,Fa as _,G as Mn,Ga as Et,H as Ot,Ha as e1,I as T2,Ia as a1,J as g2,Ja as E,K as l1,Ka as Zl,L as i2,La as wn,M as me,Ma as Ql,N as u1,Na as kr,O as Gn,Oa as Xl,P as ke,Pa as Yl,Q as qe,Qa as Hl,R as m2,Ra as xt,S as Cn,Sa as Sl,T as $n,Ta as Wl,U as Dn,Ua as pe,V as ae,Va as ve,W as fn,Wa as ue,X as k2,Xa as be,Y as d1,Ya as vl,Z as p2,Za as Nr,_ as je,_a as ne,aa as Be,ab as te,b as Br,ba as Je,bb as re,c as Jr,ca as s1,cb as h2,d as V,da as le,db as D2,e as Zr,ea as Hr,eb as L2,f as At,fa as de,fb as ee,g as Y,ga as se,gb as A,h as m,ha as Le,hb as xn,i as vn,ia as L1,ib as hn,j as D,ja as Sr,jb as Fe,k as $2,ka as k,kb as j2,l as Or,la as c1,lb as v2,m as A2,ma as ze,mb as We,n as un,na as c2,nb as Un,o as hl,oa as yn,p as Ut,pa as i1,q as Tr,qa as p1,r as bn,ra as ce,s as _r,sa as ie,t as t1,ta as Wr,u as Er,ua as C2,v as Pr,va as Tt,w as P,wa as _t,x as I,xa as Ir,y as G2,ya as K2,z as U2,za as Jl}from"../chunks/index-fes796z9.js";var Gl=["-h","--help"];function J(n,t){let r=Object.entries(n.booleans??{}),e=Object.entries(n.values??{}),a=Object.fromEntries(r.map(([i])=>[i,!1])),l={},d=[],s=[],L=!1,c=-1;for(let[i,v]of t.entries()){if(i<=c)continue;if(v==="--"){d.push(...t.slice(i+1));break}if(Gl.includes(v)){L=!0;continue}let b=r.find(([,f])=>f.includes(v));if(b){a[b[0]]=!0;continue}let p=e.find(([,f])=>f.includes(v));if(p){let f=t[i+1];if(f===void 0||f.startsWith("-")){s.push(`${v} requires a value`);continue}l[p[0]]=f,c=i+1;continue}if(v.startsWith("-")){s.push(`Unknown option for ${n.label}: ${v}`);continue}if(n.positionals==="tail"){d.push(...t.slice(i));break}d.push(v)}if(n.positionals!=="list"&&n.positionals!=="tail")s.push(...d.map((i)=>`Unexpected argument for ${n.label}: ${i}`));return{flags:a,values:l,positionals:d,help:L,errors:s}}function d2(n){for(let t of n)console.error(t);return n.length>0}import{readdirSync as Fd,statSync as fe,unlinkSync as Bd}from"node:fs";import{basename as he,dirname as Jd,join as Zd,resolve as Qd}from"node:path";function Z(n){return Array.from(n,(t)=>{let r=t.charCodeAt(0);if(r<=31||r>=127&&r<=159)return`\\x${r.toString(16).padStart(2,"0")}`;return t}).join("")}var Wt=(n)=>{let t=Date.now()-new Date(n).getTime();if(!Number.isFinite(t))return"";let r=Math.floor(t/60000),e=Math.floor(r/60),a=Math.floor(e/24);if(a>0)return`${a}d ago`;if(e>0)return`${e}h ago`;if(r>0)return`${r}m ago`;return"just now"},S2=(n)=>{let t=(n??"").trim().split(/\s+/).filter((a)=>a&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(a)),r=t[0]?.split("/").pop();if(!r)return null;let e=t[1];return e&&/^[a-z][a-z0-9-]*$/.test(e)?`${r} ${e}`:r};import{existsSync as Ul,readdirSync as Cl,readFileSync as Ol}from"node:fs";import{join as Tl}from"node:path";function f2(n,t){try{return Cl(n,{withFileTypes:!0,encoding:"utf8"}).flatMap((r)=>{let e=Tl(n,r.name);if(r.isDirectory())return f2(e,t);if(r.name.endsWith(".jsonl"))return[e];return[]})}catch{if(t&&Ul(n))t.count++;return[]}}function Rt(n){let t=(a)=>`${a.sessionId}
${S2(a.segment||a.command)}`,r=n.filter((a)=>a.decision!=="allow"),e=r.filter((a)=>a.sessionId).reduce((a,l)=>a.set(t(l),(a.get(t(l))??0)+1),new Map);return new Set(r.filter((a)=>a.failureStage||(e.get(t(a))??0)>=2))}function pn(n,t){try{return Ol(n,"utf-8").split(`
`).filter(Boolean).flatMap((r)=>{try{return[JSON.parse(r)]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as $d}from"node:path";var _l=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function Qr(n){let t=0,r={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(e){n.record({kind:"step",scope:"global",step:e})},recordSegment(e,a=r.currentSegmentIndex){if(a===void 0)return;n.record({kind:"step",scope:"segment",segmentIndex:a,step:e})}};return r}function Xr(n={}){let t=[],r=n.maxEvents??512,e={maxTextLength:n.maxTextLength??2048,maxListLength:n.maxListLength??128,maxObjectProperties:n.maxObjectProperties??n.maxListLength??128,maxDepth:n.maxDepth??16},a=0,l,d=new Set;return{record(s){if(l)return;try{if(!s||t.length>=r){a++;return}t.push(Vt(El(s,e,d)))}catch{a++}},finish(s){if(l)return l;try{l=Vt({events:Object.freeze(t),droppedEvents:a,terminal:Pl(s,e,d)})}catch{a++,l=Object.freeze({events:Object.freeze(t),droppedEvents:a,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,e.maxTextLength),segment:"trace unavailable".slice(0,e.maxTextLength)})})}return l}}}function El(n,t,r){if(n.kind!=="step")throw TypeError("invalid trace event");let{scope:e,step:a}=n;Kn(a,r,t);let l=W2(a,t,r);if(e==="global")return{kind:"step",scope:"global",step:l};if(e!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:n.segmentIndex,step:l}}function Pl(n,t,r){let e=n.result;if(e==="allowed")return Object.freeze({result:"allowed"});if(e!=="blocked")throw TypeError("invalid trace terminal");let a=n.ruleId;return Object.freeze({result:"blocked",reason:W2(n.reason,t,r),segment:W2(n.segment,t,r),...a?{ruleId:W2(a,t,r)}:{}})}function Kn(n,t,r,e=0,a=new WeakSet){if(typeof n==="string"){let s=n.slice(0,r.maxTextLength);if(!At(s))return;for(let L of Zr(s))for(let c of L.match(/[^\s"'()$]+/g)??[])t.add(Yr(c));return}if(!n||typeof n!=="object"||e>=r.maxDepth||a.has(n))return;if(a.add(n),Array.isArray(n)){let s=Math.min(n.length,r.maxListLength);for(let L=0;L<s;L++)Kn(n[L],t,r,e+1,a);return}let l=0,d=new Set;for(let s in n){if(!Object.hasOwn(n,s))continue;if(l>=r.maxObjectProperties)break;l++,Kn(s,t,r);let L=Kt(s,r,t);if(d.has(L))continue;d.add(L),Kn(n[s],t,r,e+1,a)}}function W2(n,t,r,e=0,a=new WeakSet){if(typeof n==="string")return Kt(n,t,r);if(!n||typeof n!=="object")return n;if(e>=t.maxDepth)return;if(a.has(n))return;if(a.add(n),Array.isArray(n)){let s=[],L=Math.min(n.length,t.maxListLength);for(let c=0;c<L;c++)s.push(W2(n[c],t,r,e+1,a));return s}let l={},d=0;for(let s in n){if(!Object.hasOwn(n,s))continue;if(d>=t.maxObjectProperties)break;d++;let L=Kt(s,t,r);if(Object.hasOwn(l,L))continue;Object.defineProperty(l,L,{value:W2(n[s],t,r,e+1,a),enumerable:!0,configurable:!0,writable:!0})}return l}function Kt(n,t,r){let e=n.slice(0,t.maxTextLength),a=At(e)?Jr(e):e,l=r.size>0?Nl(a,r):a;return(Il(l)?Br(l):l).slice(0,t.maxTextLength)}function Il(n){return n.includes("PRIVATE KEY")||n.includes("://")||n.includes("eyJ")||n.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(n)||n.length>=14&&_l.some((t)=>n.includes(t))||n.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(n)}function Nl(n,t){return n.replace(/[^\s"'()$]+/g,(r)=>t.has(Yr(r))?"<redacted>":r)}function Yr(n){let t=2166136261,r=2166136261;for(let e=0;e<n.length;e++)t=Math.imul(t^n.charCodeAt(e),16777619),r=Math.imul(r^n.charCodeAt(n.length-e-1),16777619);return`${t>>>0}:${r>>>0}:${n.length}`}function Vt(n){if(n&&typeof n==="object"&&!Object.isFrozen(n)){for(let t of Object.values(n))Vt(t);Object.freeze(n)}return n}function Rr(n,t,r){let e=r??Hr(),a=e.getCommandProgram(n,t.shell??"auto"),l=Xr(),d=Qr(l),s=a.dialect==="powershell"?e.getCommandProgram(n,"posix"):a,L=Sr(s);d.recordGlobal({type:"parse",input:n,segments:L.map((v)=>[...v])});let c=Wr(n,{...t,analyzePartialProgram:!0,trace:d},a,e),i=d.getNextSegmentIndex();if(c&&i>0&&i<L.length)d.recordSegment({type:"segment-skipped",index:i,reason:"prior-segment-blocked"},i);return Object.freeze({decision:c,trace:l.finish(c?{result:"blocked",reason:c.reason,segment:c.evidence.find((v)=>v.kind==="command")?.segment??n,...c.ruleId?{ruleId:c.ruleId}:{}}:{result:"allowed"}),program:a})}import{resolve as nd}from"node:path";function Mt(n){let t=Kr().safeParse(n);return{errors:t.success?[]:Ar(t.error.issues),ruleNames:new Set(Vr(n).map((r)=>r.toLowerCase()))}}function Gt(n){let t=Gr(n);if(!t.ok)return t.result;return Mt(t.parsed)}function Gr(n){let t=[],r=new Set;try{let e=typeof n==="string"?vn(n):n,a=D(e);if(a===null)return t.push(`File not found: ${e.path}`),{ok:!1,result:{errors:t,ruleNames:r}};if(!a.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:r}};return{ok:!0,parsed:JSON.parse(a)}}catch(e){if(e instanceof Y)return t.push(e.message),{ok:!1,result:{errors:t,ruleNames:r}};let a=e instanceof Error?e.message:String(e);return t.push(e instanceof SyntaxError?"Invalid JSON":a),{ok:!1,result:{errors:t,ruleNames:r}}}}function Ur(n){return nd(n??process.cwd(),".safety-net.json")}function s2(n){let t=Gr(n);if(!t.ok)return t.result;let r=Mr(t.parsed);return{errors:r.errors,ruleNames:r.sources}}import{isAbsolute as td,join as Vn,relative as rd,resolve as Cr,sep as ed}from"node:path";async function M2(n={}){let t=Nt(n);return ad(t,await An(t,K2()))}function ad(n,t){if(!t.ok)return t;let r=T(n),e=[...new Set(L2(r.configPath,r.lockPath,n,r.filesystemScope))];if(e.length===0)return t;return{ok:!1,errors:e,warnings:t.warnings,entries:t.entries}}async function An(n,t,r,e={}){let a=null,l=!1;try{let d=T(n),s=Et(d.configTarget);if(!s.ok)return s.result;let L=s.config;if(n.check)return id(L,d,n);a={target:d.lockTarget,content:D(d.lockTarget)};let c=Pt(d.lockTarget);if(c.errors.some((y)=>y.startsWith("Unable to access ")))return{ok:!1,errors:c.errors,warnings:[],entries:[]};if(n.only&&c.errors.length>0)return{ok:!1,errors:c.errors,warnings:[],entries:[]};let i=c.errors.length>0?null:c.lock,v=n.only?Nr(L,i,n.only):{ok:!0,specs:L.rules};if(!v.ok)return v.result;if(n.only&&!i&&v.specs.length<L.rules.length)return{ok:!1,errors:[`No lockfile available for partial update; run ${Pr}`],warnings:[],entries:[]};let b=(await dd(v.specs,(y)=>te(y,d.configDir,n,i,d.filesystemScope,t),t)).map((y)=>pd(y,i,r));for(let y of b)bd(y.content,y.entry,d.configDir,n,d.filesystemScope);let p=n.only?vd(L,i,b):b.map((y)=>y.entry);l=!0,E(d.lockTarget,{version:1,rulebooks:p},void 0,e._testAfterPolicyRename);let f=new Map(b.map((y)=>[y.entry.spec,y.rulebook.rules.length])),u=od(p,d.configDir,n,d.filesystemScope,e);return{ok:!0,errors:[],warnings:u,entries:p.map((y)=>ud(y,f))}}catch(d){if(l&&a)try{R2(a.target,a.content)}catch(s){return V2(s)}return V2(d)}}async function It(n,t={}){return ld(n,Nt(t),K2())}async function ld(n,t,r,e={}){let a=null,l=!1;try{let d=T(t),s=D(d.configTarget);a={target:d.configTarget,content:s};let L=Et(d.configTarget);if(!L.ok)return L.result;let c=L.config,i=Er(n)?await re(n,r):[{spec:n}],v=i.map((f)=>f.spec),b=[...new Set([...c.rules,...v])];if(b.length>Tt)return sd();if(b.length!==c.rules.length)l=!0,E(d.configTarget,{version:1,rules:b,overrides:c.overrides??{},transparent_wrappers:c.transparent_wrappers??[]},void 0,e._testAfterPolicyRename);let p=await An(t,r,new Map(i.filter((f)=>!!f.display_ref).map((f)=>[f.spec,f.display_ref])),e);if(!p.ok)R2(d.configTarget,s);return p}catch(d){if(l&&a)try{R2(a.target,a.content)}catch(s){return V2(s)}return V2(d)}}async function dd(n,t,r=K2()){if(n.length>Tt)throw Error(_t);let e=Array(n.length),a=0,l,d=Array.from({length:Math.min(n.length,Ir.concurrency)},async()=>{while(!l){let s=a;if(s>=n.length)return;a++;try{e[s]=await t(n[s],s,r.controller.signal)}catch(L){if(!l)l={value:L},a=n.length,r.controller.abort(L);return}}});if(await Promise.all(d),l)throw l.value;return e}function sd(){return{ok:!1,errors:[_t],warnings:[],entries:[]}}function Nt(n){return{cwd:n.cwd,cacheConfigDir:n.cacheConfigDir,userConfigDir:n.userConfigDir,userConfigPath:n.userConfigPath,projectConfigPath:n.projectConfigPath,global:n.global,check:n.check,only:n.only,refresh:n.refresh}}function Ld(n){return{...Nt(n),deleteSource:n.deleteSource}}async function n1(n,t={}){try{return await cd(n,Ld(t),{})}catch(r){return V2(r)}}async function cd(n,t,r){let e=T(t),a=_(e.configTarget);if(a.errors.length>0)return{ok:!1,errors:a.errors,warnings:[],entries:[]};if(!a.config)return{ok:!1,errors:[`No config found at ${e.configPath}`],warnings:[],entries:[]};let l=Pt(e.lockTarget);if(l.errors.length>0)return{ok:!1,errors:l.errors,warnings:[],entries:[]};let d=ne(a.config.rules,l.lock,n);if(!d.ok)return d.result;let s=t.deleteSource?fd(e.configDir,d.specs,l.lock,e.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let L=D(e.configTarget);if(L===null)return V2(Error("Rules config is unavailable."));try{E(e.configTarget,{version:1,rules:a.config.rules.filter((v)=>!d.specs.includes(v)),overrides:a.config.overrides??{},transparent_wrappers:a.config.transparent_wrappers??[]},void 0,r._testAfterPolicyRename)}catch(v){throw R2(e.configTarget,L),v}let c=await An(t,K2(),void 0,r);if(!c.ok)return R2(e.configTarget,L),c;let i=yd(s.dirs,r,e.filesystemScope);if(!i.ok){R2(e.configTarget,L);let v=await An(t,K2(),void 0,r);if(!v.ok)return{ok:!1,errors:[...i.result.errors,...v.errors],warnings:v.warnings,entries:v.entries};return i.result}return c}async function id(n,t,r){let e=ee(n,t.lockPath,t.configDir,r,r.global?"user":"project",t.filesystemScope);return{ok:e.errors.length===0&&e.warnings.length===0,errors:[...e.errors,...e.warnings],warnings:[],entries:e.entries}}function pd(n,t,r){let e=t?.rulebooks.find((l)=>l.spec===n.entry.spec&&l.kind==="github"),a=r?.get(n.entry.spec)??(e?.kind==="github"?e.display_ref:void 0);if(!a||n.entry.kind!=="github")return n;return{...n,entry:{...n.entry,display_ref:a}}}function vd(n,t,r){let e=new Set(n.rules),a=new Set(t?.rulebooks.map((d)=>d.spec)??[]),l=new Map(r.map((d)=>[d.entry.spec,d.entry]));return[...(t?.rulebooks.filter((d)=>e.has(d.spec))??[]).map((d)=>l.get(d.spec)??d),...r.filter((d)=>!a.has(d.entry.spec)).map((d)=>d.entry)]}function ud(n,t){return{...n,ruleCount:t.get(n.spec)}}function bd(n,t,r,e,a){let l=Ct(t,Ot(r,e));$2(m(a,l),n)}function od(n,t,r,e,a){let l=Ot(t,r),d=Mn(l),s=m(e,d),L=A2(s);if(!L)return[];let c=n.map((v)=>m(e,Ct(v,l))),i=L.filter((v)=>v.kind==="directory").map((v)=>({directory:m(e,Vn(d,v.name)),identity:m(e,Vn(d,v.name,_r))})).filter((v)=>!c.some((b)=>Or(v.identity,b))).map((v)=>v.directory);for(let v of i)Tr(v);return i.flatMap((v)=>{try{return wd(v,a),[]}catch{return["Unable to prune rules policy cache safely."]}})}function fd(n,t,r,e){let a=new Map(r?.rulebooks.map((c)=>[c.spec,c])??[]),l=t.flatMap((c)=>{let i=a.get(c);if(!i)return bn.test(c)?[]:["--delete-source can only delete local rulebook sources"];return i.kind==="local-directory"?[]:["--delete-source can only delete local rulebook sources"]}),d=t.map((c)=>{let i=a.get(c);return Vn(n,i?.kind==="local-directory"?i.path:c)}),s=l.length>0?[]:d.flatMap((c)=>hd(n,c,e)),L=[...l,...s];return L.length>0?{ok:!1,result:{ok:!1,errors:L,warnings:[],entries:[]}}:{ok:!0,dirs:d}}function hd(n,t,r){let e=Cr(n),a=Cr(t),l=rd(e,a);if(l===""||l===".."||l.startsWith(`..${ed}`)||td(l))return[`Refusing to delete local rulebook source outside ${n}: ${t}`];let d=m(r,a),s=A2(d);if(!s)return[`Local rulebook source directory not found: ${t}`];let L=s.find((c)=>c.name==="rulebook.json");if(!L)return[`Local rulebook source directory is missing rulebook.json: ${t}`];if(L.kind!=="file")throw new Y(r.label);if(D(m(r,Vn(a,"rulebook.json"))),s.length>1)return[`Local rulebook source directory contains extra files: ${t}. delete manually if you really want to remove the directory.`];return[]}function yd(n,t,r){let e=n.flatMap((a)=>{try{return xd(m(r,a),t),[]}catch(l){return[`Failed to delete local rulebook source ${a}: ${l instanceof Error?l.message:String(l)}`]}});return e.length>0?{ok:!1,result:{ok:!1,errors:e,warnings:[],entries:[]}}:{ok:!0}}function wd(n,t){if(t._testPruneRulebookCacheDir){t._testPruneRulebookCacheDir(n.path);return}Ut(n)}function xd(n,t){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(n.path);return}Ut(n)}function R2(n,t){if(t===null){un(n);return}$2(n,t)}function V2(n){return{ok:!1,errors:[n instanceof Error?n.message:String(n)],warnings:[],entries:[]}}function O2(n,t){let r=gd(t),e=ce(r),a={effectiveLevel:e.effectiveLevel,selectedPreset:r.policySnapshot.policy.safety.level??"standard",effectiveCapabilities:e.effectiveCapabilities,destructiveCommandRuleOverrides:r.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:l,configValid:d}=Dd({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!n||!n.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:l,configValid:d,...a};let s=md(n,r);if(s)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",rule:s.rule,matched:!0,reason:s.reason}]}]},result:"blocked",reason:V(s.reason),segment:V(s.target),...s.ruleId?{ruleId:V(s.ruleId)}:{},configSource:l,configValid:d,...a};let L=Rr(n,r),c=L.decision,i=c?.ruleId??kd(n,r),v=fn.find((p)=>p.id===i&&p.activationCapability),b=v?e.policy.effectiveDestructiveCommandRules[v.id]:void 0;return{trace:jd(L.trace),result:c?"blocked":"allowed",reason:c?V(c.reason):void 0,segment:c?V(c.evidence.find((p)=>p.kind==="command")?.segment??n):void 0,ruleId:c?.ruleId?V(c.ruleId):void 0,customRule:qd(zd(c?.ruleId,r.policySnapshot)),configSource:l,configValid:d,...a,...v&&b?{ruleActivation:{id:v.id,...b}}:{}}}function Dd(n){let t=P(n?.cwd),r=n?.userConfigPath??I(n),e=N({cwd:n?.cwd,userConfigDir:n?.userConfigDir,userConfigPath:n?.userConfigPath});try{if(D(e.projectConfigTarget)!==null){if(s2(e.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(a){if(a instanceof Y)return{configSource:t,configValid:!1};throw a}try{if(D(e.userConfigTarget)!==null){let a=s2(e.userConfigTarget);return{configSource:r,configValid:a.errors.length===0}}return{configSource:null,configValid:!0}}catch(a){if(a instanceof Y)return{configSource:r,configValid:!1};throw a}}function gd(n){let t=$d(n?.cwd??process.cwd()),r=n?.policySnapshot??A({cwd:t,userConfigDir:n?.userConfigDir}),e=c2(r.policy);return{cwd:t,effectiveCwd:t,policySnapshot:r,environment:ae(),protectedGitMetadata:Le(t),effectiveCapabilities:e.capabilities,strict:n?.strict??e.strict,paranoidRm:e.paranoidRm,paranoidInterpreters:e.paranoidInterpreters,worktreeMode:e.worktreeMode}}function md(n,t){let r=t.cwd??process.cwd(),e=le(C2("",{command:n},{kind:"command",shell:"posix"},{executionCwd:r,configCwd:r},n)),a=ve(e);if(a)return{reason:pe,target:a.target,ruleId:"policy-protection",rule:"policy-protection:findPolicyConfigMutationTargetInSemanticFacts"};let l=se(e,t.protectedGitMetadata);if(l)return{reason:de,target:l.target,ruleId:"git-metadata-protection",rule:"git-metadata-protection:findGitMetadataMutationTargetInSemanticFacts"};let d=t.policySnapshot.policy,s=d.secretProtection.enabled===!1?null:be(e,d.secretProtection,{strict:t.strict});if(s)return{reason:ue,target:s.target,ruleId:s.ruleId,rule:"secret-protection:findSensitiveTargetInSemanticFacts"};return null}function kd(n,t){let r=t.policySnapshot.policy,e=hn({...r,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...r.destructiveCommandRuleOverrides,...Object.fromEntries(fn.flatMap((a)=>a.activationCapability?[[a.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return ie(n,{...t,policySnapshot:e,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function qd(n){if(!n)return;return{id:V(n.id),...n.rulebook?{rulebook:{name:V(n.rulebook.name),version:V(n.rulebook.version)}}:{},...n.source?{source:V(n.source)}:{},...n.override?{override:{type:"reason",reason:V(n.override.reason)}}:{}}}function jd(n){let t=n.events.flatMap((e)=>e.kind==="step"&&e.scope==="global"?[e.step]:[]),r=new Map;for(let e of n.events){if(e.kind!=="step"||e.scope!=="segment")continue;let a=r.get(e.segmentIndex)??{index:e.segmentIndex,steps:[]};a.steps.push(e.step),r.set(e.segmentIndex,a)}return{steps:t,segments:[...r.values()]}}function zd(n,t){let r=n?.replace(/^custom\./,"");if(!r||!t.policy.rules.some((e)=>e.name===r))return;return t.ruleMetadata[r]??Object.freeze({id:r})}function Xd(n){let t=T2(),r=J({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},n);if(d2(r.errors))return null;if(r.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(r.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let e=r.values.limit===void 0?20:oe(r.values.limit);if(e===null)return console.error("--limit must be a positive number"),null;let a=r.values.since===void 0?Math.min(30,t):oe(r.values.since);if(a===null||a>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let l={limit:e,limitExplicit:r.values.limit!==void 0,since:a,sinceExplicit:r.values.since!==void 0,all:r.flags.all,json:r.flags.json,suspect:r.flags.suspect,pruneLegacy:r.flags.pruneLegacy,dryRun:r.flags.dryRun,id:r.values.id,agent:r.values.agent,rule:r.values.rule,session:r.values.session,project:r.values.project===void 0?void 0:Qd(r.values.project)};if(l.id&&(l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.sinceExplicit||l.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(l.pruneLegacy&&(l.id!==void 0||l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.all||l.sinceExplicit||l.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(l.dryRun&&!l.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return l}async function ye(n,t={}){let r=Xd(n);if(!r)return 1;let e=t.logsDir??i2();if(r.pruneLegacy)return Yd(e,r.json,r.dryRun);if(!e)return console.log(r.json?"[]":r.id?`No retained audit log entry found for id ${Z(r.id)}.`:"No audit log entries found."),0;g2(e);let a={count:0},l=f2(e,a).flatMap((i)=>pn(i,a).map((v)=>({entry:v,file:i})));if(a.count>0)console.error(`warning: ${a.count} audit log ${a.count===1?"source":"sources"} could not be read; these results are incomplete`);if(r.id)return Rd(l,r,t.timeZone);let d=Date.now()-r.since*24*60*60*1000,s=l.filter((i)=>Kd(i,r,e,d)),L=r.suspect?Rt(s.map((i)=>i.entry)):null,c=(L?s.filter((i)=>L.has(i.entry)):s).sort((i,v)=>Date.parse(v.entry.ts)-Date.parse(i.entry.ts)).slice(0,r.limit);if(r.json)return console.log(JSON.stringify(c.map((i)=>i.entry),null,2)),0;if(c.length===0)return console.log("No audit log entries found."),0;for(let i of c)console.log(Md(i.entry,t.timeZone));return 0}function Yd(n,t,r){let e=n?Sd(n).map((s)=>Zd(n,s)):[];if(r)return Hd(e,t);let a=[],l=0,d=0;for(let s of e){let L=fe(s,{throwIfNoEntry:!1})?.size??0,c=Wd(s);if(c){a.push(`${he(s)}: ${c}`);continue}l++,d+=L}if(t)return console.log(JSON.stringify({removedFiles:l,removedBytes:d,failedFiles:a.length})),a.length===0?0:1;console.log(l===0&&a.length===0?"No legacy audit log files found.":`Removed ${l} legacy audit log ${l===1?"file":"files"} (${we(d)}).`);for(let s of a)console.error(`Could not remove ${Z(s)}`);if(console.log("Nested v2 audit logs were not changed."),l>0)console.log("This deletion cannot be undone.");return a.length===0?0:1}function Hd(n,t){let r=n.reduce((e,a)=>e+(fe(a,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:n.length,bytes:r})),0;if(console.log(n.length===0?"No legacy audit log files found.":`Would remove ${n.length} legacy audit log ${n.length===1?"file":"files"} (${we(r)}).`),console.log("Nested v2 audit logs are not included."),n.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function Sd(n){try{return Fd(n,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function Wd(n){try{return Bd(n),null}catch(t){return t instanceof Error?t.message:String(t)}}function we(n){let t=["B","KiB","MiB","GiB"],r=Math.min(Math.floor(Math.log2(Math.max(n,1))/10),t.length-1);return`${Math.round(n/1024**r*10)/10} ${t[r]}`}function Rd(n,t,r){let e=n.filter((l)=>l.entry.id===t.id);if(e.length>1)return console.error(`Multiple audit log entries found for id ${Z(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(e.map((l)=>l.entry),null,2)),0;let a=e[0];if(!a)return console.log(`No retained audit log entry found for id ${Z(t.id??"")}.`),0;return console.log(Gd(a.entry,r)),0}function Kd(n,t,r,e){if(!t.all&&n.entry.decision==="allow")return!1;if(Date.parse(n.entry.ts)<e)return!1;if(t.agent!==void 0&&n.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&n.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!Vd(n,r,t.session))return!1;if(t.project!==void 0&&!Ad(n.entry.cwd,t.project))return!1;return!0}function Vd(n,t,r){if(n.entry.sessionId===r)return!0;return Jd(n.file)===t&&he(n.file,".jsonl")===r}function Ad(n,t){if(!n)return!1;return n===t||n.startsWith(`${t}/`)}function Md(n,t){let r=Z(n.id??"-"),e=Z(n.decision??"deny"),a=n.cwd?`  [${Z(n.cwd)}]`:"",l=n.segment||n.command,d=l===n.command?"":"↳ ",s=l.length>50?`${l.slice(0,50)}…`:l;return`${r.padEnd(16)}  ${Z(xe(n.ts,t))}  ${e.padEnd(5)}  ${Z(n.agent??"-").padEnd(15)}  ${Z(n.ruleId??"-").padEnd(20)}  ${d}${Z(s)}${a}`}function Gd(n,t){let r=(a)=>Z(a===void 0||a===null||a===""?"-":a),e=n.shape?`${n.agent??"-"} (shape: ${n.shape})`:n.agent??"-";return[`id:        ${r(n.id)}`,`ts:        ${r(xe(n.ts,t))}`,`decision:  ${r(n.decision)}`,`agent:     ${r(e)}`,`level:     ${r(n.level)}`,`tool:      ${r(n.toolName)}`,`rule:      ${r(n.ruleId)}`,`intent:    ${r(n.intent)}`,`stage:     ${r(n.failureStage)}`,`error:     ${r(n.errorCode)}`,`session:   ${r(n.sessionId)}`,`cwd:       ${r(n.cwd)}`,`version:   ${r(n.v)}`,`truncated: ${r(n.truncated===!0?"yes":void 0)}`,`reason:    ${r(n.reason)}`,`command:   ${r(n.command)}`,`segment:   ${r(n.segment)}`].join(`
`)}function xe(n,t){let r=new Date(n);if(Number.isNaN(r.getTime()))return n;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(r)}function oe(n){let t=Number(n);return Number.isFinite(t)&&t>0?t:null}var $e={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var De={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var ge={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as Ze,join as ts,relative as rs}from"node:path";var Ud=8388608;function Cd(n,t){console.log(JSON.stringify(n(ke(t))))}async function Od(n){let t;try{t=(await o1(process.stdin)).trim()}catch{n({reason:"Failed to parse hook input JSON."});return}if(!t){n({reason:"Missing hook input JSON."});return}return f1(t,n,"Failed to parse hook input JSON.")}async function o1(n){let t=[],r=0;for await(let e of n){let a=typeof e==="string"?Buffer.from(e,"utf-8"):Buffer.from(e.buffer,e.byteOffset,e.byteLength);if(r+=a.byteLength,r>Ud)throw Td(n),Error("hook input byte limit exceeded");t.push(a)}return Buffer.concat(t,r).toString("utf-8")}function Td(n){let t=n.destroy??n.cancel;if(!t)return;try{Promise.resolve(t.call(n)).catch(()=>{})}catch{}}function f1(n,t,r){try{return JSON.parse(n)}catch{t({reason:r});return}}function W(n,t){let r=t.get(n);return r?{kind:"command",shell:r}:{kind:je(n)}}function n2(n,t,r,e){let a=n===void 0?process.cwd():n,l=typeof a==="string"&&a.trim()!==""?v2([a]):void 0;if(l)return{configCwd:l,executionCwd:l};return X(e,t,r,Id(a)),null}function X(n,t,r,e){let a;try{a=b1(t)}catch(l){if(!(l instanceof p2))throw l}n(Gn({command:a,segment:e,toolName:r}))}async function _d(n){let t=await Od(n.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){X(n.outputDeny);return}if(!n.isSupported(t))return;let r=n.getAgent?.(t)??n.agent,e=n.agent===r?void 0:n.agent,a=ns(t),l=(p,f)=>{me(p,()=>n.getSessionId(t),{agent:r,shape:e,toolName:f,cwd:a}),n.outputDeny(p)},d=n.getToolName(t);if(typeof d!=="string"||d.trim()===""){X((p)=>l(p),Nd(t));return}let s=d,L=(p)=>l(p,s),c;try{c=n.getToolInput(t,s,L)}catch(p){if(!(p instanceof p2))throw p;X(L,void 0,s);return}if(!c.ok)return;let i=n.getContext(t,c.input,s,L);if(!i)return;let v;try{v=b1(c.input)}catch(p){if(!(p instanceof p2))throw p;X(L,void 0,s);return}let b=C2(s,c.input,c.route,i,v??null);try{let p=Un(b,{guard:{auditAllowed:ze(),dependencies:n.guardDependencies},audit:{agent:r,shape:e,getSessionId:()=>n.getSessionId(t)}}),f=u1(p,{includeEvidence:!0,toolName:p.stage==="command-analysis"?void 0:s});if(f){n.outputDeny(f);return}n.outputAllow?.()}catch(p){if(!(p instanceof Fe))throw p;Ed(p);let f=u1(p.evaluation,{includeEvidence:!0,toolName:p.evaluation.stage==="command-analysis"?void 0:s});if(f)n.outputDeny(f);return}}function Ed(n){if(!yn(k.debug))return;console.error(`CC Safety Net debug: ${Pd(n.stage)}: ${qe(n.cause)}`)}function Pd(n){if(n==="policy-protection")return"hook policy protection failed";if(n==="config-load")return"hook config loading failed";if(n==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function Id(n){return typeof n==="string"?n:void 0}function Nd(n){if(!n||typeof n!=="object"||Array.isArray(n))return;if(Object.hasOwn(n,"tool_input"))return n.tool_input;let t=n.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function ns(n){if(!n||typeof n!=="object"||Array.isArray(n))return null;let t=n.cwd;if(typeof t==="string")return t;let r=n.toolCall;if(!r||typeof r!=="object"||Array.isArray(r))return null;let e=r.args;if(!e||typeof e!=="object"||Array.isArray(e))return null;let a=e.Cwd;return typeof a==="string"?a:null}async function R(n){let t=(a)=>Cd(n.createDenyOutput,a),r=n.createAllowOutput;await _d({...n,outputDeny:t,outputAllow:r?()=>console.log(JSON.stringify(r())):void 0})}function gn(n){return ts(n,".gemini","config","hooks.json")}var es=new Map([["run_command","auto"]]),as=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function Qe(n){return W(n,es)}async function Xe(){await R({agent:"antigravity-cli",createDenyOutput:(n)=>({decision:"deny",reason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolCall?.name,getToolInput:(n,t)=>({ok:!0,input:cs(n.toolCall?.args,t),route:Qe(t)}),getContext:ls,getSessionId:(n)=>n.conversationId})}function ls(n,t,r,e){let l=Ls(n).flatMap((c)=>{let i=v2([c]);return i?[i]:[]});if(!l[0])return q2(e,t,r),null;if(r!=="run_command"){let c;try{c=ds(t,r,l)}catch(i){if(i instanceof p2)return q2(e,void 0,r),null;if(!(i instanceof m2))throw i;return q2(e,t,r),null}if(!c)return q2(e,t,r),null;return{configCwd:c,executionCwd:c}}let d=n.toolCall?.args;if(!d||!Object.hasOwn(d,"Cwd"))return{configCwd:l[0],executionCwd:l[0]};let s=d.Cwd;if(typeof s!=="string"||s.trim()==="")return q2(e,t,r),null;let L=j2(s,l);if(L){let c=Ye(L,l);if(!c)return q2(e,t,r,s),null;return{configCwd:c,executionCwd:L}}return q2(e,t,r,s),null}function ds(n,t,r){let e=Qe(t),a=[...Be(n,as),...e.kind==="patch"?Je(n):[]].filter(Ze),l=Cn(),d=new Set(a.flatMap((s)=>{let L=Ye($n(s,Dn,l),r);return L?[L]:[]}));if(d.size>1)return null;return[...d][0]??r[0]??null}function Ye(n,t){return t.filter((r)=>ss(n,r)).reduce((r,e)=>e.length>r.length?e:r,"")||null}function ss(n,t){let r=rs(t,n);return r===""||!r.startsWith("..")&&!Ze(r)}function q2(n,t,r,e){let a=t&&typeof t==="object"?t.command:void 0;n(Gn({command:typeof a==="string"?a:void 0,segment:e,toolName:r}))}function Ls(n){if(n.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(n.workspacePaths)?n.workspacePaths.filter((r)=>typeof r==="string"&&r.trim()!==""):[];return v2(t)?t:[]}function cs(n,t){if(!n)return;if(t!=="run_command")return n;return{...n,command:typeof n.CommandLine==="string"&&n.CommandLine!==""?n.CommandLine:void 0}}var mn=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",artifactKind:"hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",artifactKind:"plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",artifactKind:"plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",artifactKind:"plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",artifactKind:"extension",probeCommand:["gemini","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:8,runtime:{order:6,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--hermes-agent",artifactKind:"plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:9,runtime:{order:7,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--kimi-code",artifactKind:"hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:10,install:{order:10,flag:"--openclaw",artifactKind:"plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:11,install:{order:11,flag:"--opencode",artifactKind:"plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:12,install:{order:12,flag:"--pi",artifactKind:"package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",artifactKind:"hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",artifactKind:"plugin",probeCommand:["amp","--version"]}}],On=mn.slice().sort((n,t)=>n.doctorOrder-t.doctorOrder).map((n)=>n.id),He=mn.filter((n)=>("runtime"in n)).slice().sort((n,t)=>n.runtime.order-t.runtime.order).map((n)=>({id:n.id,displayName:"displayName"in n.runtime?n.runtime.displayName:n.displayName,flags:n.runtime.flags,legacyFlags:"legacyFlags"in n.runtime?n.runtime.legacyFlags:[],description:n.runtime.description,legacyTopLevelFlags:n.runtime.legacyTopLevelFlags})),G=mn.slice().sort((n,t)=>n.install.order-t.install.order).map((n)=>({id:n.id,...n.install})).map(({order:n,...t})=>t),G6=Object.fromEntries(mn.map((n)=>[n.id,n.displayName]));function j(n){return mn.find((t)=>t.id===n)?.displayName??n}import{homedir as is}from"node:os";import{isAbsolute as Se,join as h1}from"node:path";function Re(n){if(n!==void 0&&n!==null&&!Se(n))return"unknown";try{let t=Cn(),r=n?$n(n,Dn,t):void 0,e=process.env.HOME||is(),a=[["codex",process.env.CODEX_HOME||h1(e,".codex")],["copilot-cli",process.env.COPILOT_HOME||h1(e,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||h1(e,".claude")]],l=r?a.flatMap(([d,s])=>{if(!Se(s))return[];return We(r,$n(s,Dn,t))?[d]:[]}):[];if(l.length===1)return l[0]??"unknown";if(l.length>1)return"unknown"}catch(t){if(t instanceof m2)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var y1="PreToolUse",Ke="BeforeTool",Ve="pre_tool_call",w1="PreToolUse";var ps=new Map([["Bash","posix"],["PowerShell","powershell"]]);function vs(n){return W(n,ps)}async function Ae(){await R({agent:"claude-code",getAgent:(n)=>Re(n.transcript_path),createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:y1,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===y1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:vs(t)}),getContext:(n,t,r,e)=>n2(n.cwd,t,r,e),getSessionId:(n)=>n.session_id})}var us=new Map([["bash","auto"],["Bash","auto"],["powershell","powershell"],["PowerShell","powershell"]]);function bs(n){return W(n,us)}async function Me(){await R({agent:"copilot-cli",createDenyOutput:(n)=>({permissionDecision:"deny",permissionDecisionReason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolName,getToolInput:(n,t,r)=>{if(typeof n.toolArgs!=="string")return r({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let e=f1(n.toolArgs,r,"Failed to parse toolArgs JSON.");if(e===void 0)return{ok:!1};return{ok:!0,input:e,route:bs(t)}},getContext:(n,t,r,e)=>n2(n.cwd,t,r,e),getSessionId:(n)=>typeof n.sessionId==="string"&&n.sessionId.trim()?n.sessionId:void 0})}var os=new Map([["Shell","auto"]]);function fs(n){return W(n,os)}async function Ge(){await R({agent:"cursor",createDenyOutput:(n)=>({permission:"deny",user_message:n,agent_message:n}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:fs(t)}),getContext:hs,getSessionId:(n)=>n.conversation_id})}function hs(n,t,r,e){let a=ys(n);if(!a[0])return X(e,t,r),null;let l=j2(xs(n.cwd),a);if(!l)return X(e,t,r,typeof n.cwd==="string"?n.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:l,executionCwd:l};if(!Object.hasOwn(t,"working_directory"))return{configCwd:l,executionCwd:l};let d=t.working_directory;if(typeof d!=="string"||d.trim()==="")return X(e,t,r),null;let s=j2(d,a);if(!s)return X(e,t,r,d),null;return{configCwd:l,executionCwd:s}}function ys(n){return ws(n).flatMap((t)=>{let r=v2([t]);return r?[r]:[]})}function ws(n){if(n.workspace_roots===void 0)return typeof n.cwd==="string"&&n.cwd.trim()!==""?[n.cwd]:[];if(!Array.isArray(n.workspace_roots))return[];return n.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function xs(n){return typeof n==="string"&&n.trim()!==""?n:"."}var $s=new Map([["run_shell_command","auto"]]);function Ds(n){return W(n,$s)}async function Ue(){await R({agent:"gemini-cli",createDenyOutput:(n)=>({decision:"deny",reason:n,systemMessage:n}),isSupported:(n)=>n.hook_event_name===Ke,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Ds(t)}),getContext:(n,t,r,e)=>n2(n.cwd,t,r,e),getSessionId:(n)=>n.session_id})}import{resolve as gs}from"node:path";var ms=new Map([["terminal","posix"]]);async function Ce(){await R({agent:"hermes-agent",createDenyOutput:(n)=>({action:"block",message:n}),isSupported:(n)=>n.hook_event_name===Ve,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:W(t,ms)}),getContext:ks,getSessionId:(n)=>n.session_id})}function ks(n,t,r,e){let a=n2(n.cwd,t,r,e);if(!a)return null;if(!t||typeof t!=="object"||Array.isArray(t))return a;if(!Object.hasOwn(t,"workdir"))return a;let l=t.workdir;if(typeof l!=="string"||l.trim()==="")return X(e,t,r),null;let d=v2([gs(a.configCwd,l)]);if(!d)return X(e,t,r,l),null;return{...a,executionCwd:d}}var Oe=new Map([["Bash","posix"]]);function qs(n){return W(n,Oe)}async function Te(){await R({agent:"kimi-code",createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:w1,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===w1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:qs(t)}),getContext:(n,t,r,e)=>{let a=n2(n.cwd,t,r,e);if(!a)return null;let l=n.tool_input;if(!Oe.has(r)||!l||!Object.hasOwn(l,"cwd"))return a;let d=l.cwd;if(typeof d!=="string"||d.trim()==="")return X(e,t,r),null;let s=j2(d,[a.configCwd]);if(!s)return X(e,t,r,d),null;return{configCwd:a.configCwd,executionCwd:s}},getSessionId:(n)=>n.session_id})}var js={"antigravity-cli":Xe,"claude-code":Ae,"copilot-cli":Me,cursor:Ge,"gemini-cli":Ue,"hermes-agent":Ce,"kimi-code":Te},_2=He.map((n)=>({...n,run:js[n.id]}));function _e(n){let t=J({label:"hook",booleans:Object.fromEntries(_2.map((e)=>[e.id,[...e.flags,...e.legacyFlags]]))},n);if(t.errors.length>0)return;let r=_2.filter((e)=>t.flags[e.id]);return r.length===1?r[0]:void 0}function Ee(n){return _2.find((t)=>t.legacyTopLevelFlags.some((r)=>r===n))}var zs=_2.map((n)=>({flags:n.flags.join(", "),description:n.description})),Fs=_2.flatMap((n)=>n.flags.map((t)=>`cc-safety-net hook ${t}`)),Pe={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...zs,{flags:"-h, --help",description:"Show this help"}],examples:Fs};var Ie={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...G.map((n)=>({flags:n.flag,description:`Install ${j(n.id)} ${n.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...G.map((n)=>`cc-safety-net install ${n.flag}`)]},Ne={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...G.map((n)=>({flags:n.flag,description:`Uninstall ${j(n.id)} ${n.artifactKind}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...G.map((n)=>`cc-safety-net uninstall ${n.flag}`)]},na={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var ta={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var E2={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source>",description:"Add a rulebook source and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Refresh rulebook lock/cache state"},{usage:"sync",description:"Sync configured rulebooks"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk","cc-safety-net rule add project-rules","cc-safety-net rule sync","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var ra={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var ea={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var Tn=[ra,$e,ta,De,E2,Ie,na,Ne,Pe,ge,ea];function Bs(n){return n.aliases??[]}function _n(n){let t=n.toLowerCase();return Tn.find((r)=>r.name.toLowerCase()===t||Bs(r).some((e)=>e.toLowerCase()===t))}import{readFileSync as Js}from"node:fs";import{basename as Zs}from"node:path";function En(n=7,t=i2()){let r=Date.now()-n*24*60*60*1000,e=[],a=new Set,l=0,d,s,L,c;if(t)g2(t);let i={count:0},v=t?f2(t,i):[];for(let p of v)try{let u=Js(p,"utf-8").trim().split(`
`).filter(Boolean);for(let y of u)try{let w=JSON.parse(y);if(w.decision==="allow")continue;let $=new Date(w.ts).getTime();if($>=r){if(l++,a.add(w.sessionId??Zs(p,".jsonl")),s===void 0||$<=s)d=w.ts,s=$;if(c===void 0||$>c)L=w.ts,c=$;Qs(e,w,$)}}catch{i.count++}}catch{i.count++}let b=e.map((p)=>({timestamp:p.ts,command:p.command,reason:p.reason,relativeTime:Wt(new Date(p.ts))}));return{totalBlocked:l,sessionCount:a.size,recentEntries:b,oldestEntry:d,newestEntry:L,unreadable:i.count}}function Qs(n,t,r){let e=n.findIndex((a)=>r>new Date(a.ts).getTime());if(e===-1){if(n.length<3)n.push(t);return}if(n.splice(e,0,t),n.length>3)n.pop()}import{dirname as Xs}from"node:path";function aa(n,t,r,e,a){let l;try{if(D(e)===null)return{path:n,exists:!1,valid:!1,ruleCount:0};l=s2(e),l.errors.push(...L2(n,t,{userConfigDir:r},a))}catch(d){if(!(d instanceof Y))throw d;l={errors:[d.message],ruleNames:new Set}}return{path:n,exists:!0,valid:l.errors.length===0,ruleCount:l.ruleNames.size,...l.errors.length>0?{errors:l.errors}:{}}}function Ys(n,t){return{source:t,name:n.name,command:n.command,subcommand:n.subcommand,blockArgs:[...n.block_args],reason:n.reason}}function la(n,t){let r=t?.userConfigPath??I(),e=t?.projectConfigPath??P(n),a=Xs(r),l=h2({cwd:n,userConfigPath:r,projectConfigPath:e,userConfigDir:a}),d=N({cwd:n,userConfigPath:r,projectConfigPath:e,userConfigDir:a}),s=new Map(l.rulebooks.flatMap((L)=>L.rules.map((c)=>[c,L.source])));return{userConfig:aa(r,G2({userConfigPath:r}),a,d.userConfigTarget,d.userScope),projectConfig:aa(e,U2(e),a,d.projectConfigTarget,d.projectScope),effectiveRules:l.rules.map((L)=>Ys(L,s.get(L.name)??"project")),shadowedRules:[]}}var Hs=[{flag:k.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:k.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:k.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:k.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:k.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:k.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:k.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:k.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function da(){return[...Hs.map((n)=>({name:n.flag.name,value:i1(n.flag),isSet:p1(n.flag),legacyName:n.flag.legacyName,legacyValue:n.flag.legacyName?process.env[n.flag.legacyName]:void 0,legacyIsSet:n.flag.legacyName?process.env[n.flag.legacyName]!==void 0:void 0,description:n.description,defaultBehavior:n.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var sa={error:0,warning:1,info:2},Ss=["policy","config","audit"];function Ws(n){return n.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var Rs=[{derive:(n)=>n.hooks.length>0&&n.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(n)=>n.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let r=j(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${r} inspection failed`,detail:`Doctor could not verify the ${r} integration configuration.`,fixHint:`Correct the reported ${r} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(n)=>n.userConfig.exists&&!n.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.userConfig.path}]:[]},{derive:(n)=>n.projectConfig.exists&&!n.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.projectConfig.path}]:[]},{derive:(n)=>n.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${n.configState.reason}`,fixHint:"Correct the named source, run `cc-safety-net rule sync` for a rule source, then rerun doctor."}]:[]},{derive:(n)=>{let t=n.environment.find((r)=>r.name==="CC_SAFETY_NET_AUDIT_SCOPE");return c1(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...Ss.map((n)=>({derive:(t)=>t.posture.directories.filter((r)=>r.kind===n&&r.status==="unsafe").map((r)=>({checkId:`posture.${n}-directory-unsafe`,severity:"error",title:`${n[0]?.toUpperCase()}${n.slice(1)} directory is unsafe`,detail:`The ${n} directory ${Ws(r.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...r.path?{path:r.path}:{}}))})),{derive:(n)=>{let t=[...n.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function La(n){return Rs.flatMap((t,r)=>t.derive(n).map((e,a)=>({finding:e,catalogOrder:r,occurrence:a}))).sort((t,r)=>sa[t.finding.severity]-sa[r.finding.severity]||t.catalogOrder-r.catalogOrder||t.occurrence-r.occurrence).map((t)=>t.finding)}function t2(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var Ks=(n)=>t2()?`\x1B[32m${n}\x1B[0m`:n,Vs=(n)=>t2()?`\x1B[33m${n}\x1B[0m`:n,As=(n)=>t2()?`\x1B[34m${n}\x1B[0m`:n,Ms=(n)=>t2()?`\x1B[35m${n}\x1B[0m`:n,Gs=(n)=>t2()?`\x1B[36m${n}\x1B[0m`:n,Us=(n)=>t2()?`\x1B[31m${n}\x1B[0m`:n,Cs=(n)=>t2()?`\x1B[2m${n}\x1B[0m`:n,Os=(n)=>t2()?`\x1B[1m${n}\x1B[0m`:n,o={green:Ks,yellow:Vs,blue:As,magenta:Ms,cyan:Gs,red:Us,dim:Cs,bold:Os},Ts="\x1B[0m",_s=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function Es(n){let t=n;return()=>{return t=(t*1664525+1013904223)%4294967296,t/4294967296}}function Ps(n){let t=[..._s],r=Es(n);for(let e=t.length-1;e>0;e--){let a=Math.floor(r()*(e+1)),l=t[e];t[e]=t[a],t[a]=l}return t}function Is(n,t=0){if(!t2())return"";let r=Ps(t);return`\x1B[38;5;${r[n%r.length]}m`}function ca(n,t,r=0){if(!t2())return`"${n}"`;return`${Is(t,r)}"${n}"${Ts}`}var Ns=new RegExp("\x1B\\[[0-9;]*m","g"),x1=(n)=>n.replace(Ns,"").length;function z2(n){let t=(n.headers??n.rows[0]??[]).map((d,s)=>{let L=Math.max(...n.rows.map((c)=>x1(c[s]??"")));return Math.max(x1(d),L)}),r=(d,s)=>d+" ".repeat(Math.max(0,s-x1(d))),e=(d,s)=>s[0]+t.map((L)=>d.repeat(L+2)).join(s[1])+s[2],a=(d)=>`│ ${d.map((s,L)=>r(s,t[L]??0)).join(" │ ")} │`,l=n.headers?[`   ${a(n.headers)}`,`   ${e("─",["├","┼","┤"])}`]:[];return[`   ${e("─",["┌","┬","┐"])}`,...l,...n.rows.map((d)=>`   ${a(d)}`),`   ${e("─",["└","┴","┘"])}`].join(`
`)}function ia(n){let t=[];t.push("Hook Integration"),t.push(nL(n));let r=[],e=[];for(let a of n){let l=j(a.platform);if(a.errors&&a.errors.length>0)for(let d of a.errors)if(a.configured)r.push({platform:l,message:d});else e.push({platform:l,message:d})}for(let a of r)t.push(`   Warning (${a.platform}): ${a.message}`);for(let a of e)t.push(o.red(`   Error (${a.platform}): ${a.message}`));return t.join(`
`)}function nL(n){let t=["Platform","Discovery","Configuration","Inspection"],r=n.map((e)=>{let a=j(e.platform);if(e.inspectionStatus==="not-inspected"){let L=o.dim("Not inspected");return[a,L,L,L]}let l=e.detected?o.green("Detected"):e.inspectionStatus==="failed"?o.red("Unknown"):o.dim("Not detected"),d=e.configured?o.green("Configured"):e.detected?o.yellow("Not configured"):e.inspectionStatus==="failed"?o.red("Unknown"):o.dim("Not applicable"),s=e.inspectionStatus==="verified"?o.green("Verified"):e.inspectionStatus==="failed"?o.red("Failed"):o.dim("Not applicable");return[a,l,d,s]});return z2({headers:t,rows:r})}function pa(n){let r=["Guard Engine Verification",`   Synthetic self-test: ${n.failed>0?o.red(`${n.passed}/${n.total} FAIL`):o.green(`${n.passed}/${n.total} passed`)}`],e=n.results.filter((a)=>!a.passed);if(e.length>0){r.push(""),r.push(o.red("   Failures:"));for(let a of e)r.push(o.red(`   • ${a.description}`)),r.push(o.red(`     expected ${a.expected}, got ${a.actual}`))}return r.join(`
`)}function tL(n){if(n.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],r=n.map((e)=>[e.source,e.name,e.subcommand?`${e.command} ${e.subcommand}`:e.command,e.blockArgs.join(", ")]);return z2({headers:t,rows:r})}function va(n){let t=[];if(t.push("Configuration"),t.push(rL(n.userConfig,n.projectConfig)),t.push(""),n.effectiveRules.length>0)t.push(`   Effective rules (${n.effectiveRules.length} total):`),t.push(tL(n.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let r of n.shadowedRules)t.push(""),t.push(`   Note: Project rule "${r.name}" shadows user rule with same name`);return t.join(`
`)}function rL(n,t){let r=["Scope","Status"],e=(l)=>{if(!l.exists)return o.dim("N/A");if(!l.valid)return o.red(`Invalid (${l.errors?.[0]??"unknown error"})`);return o.green("Configured")},a=[["User",e(n)],["Project",e(t)]];return z2({headers:r,rows:a})}function ua(n){let t=[];return t.push("Environment"),t.push(eL(n)),t.join(`
`)}function ba(n){let t=["Effective Safety",`   Selected preset: ${n.effectiveSafety.selectedPreset}`,`   Effective: ${n.effectiveSafety.level}`],r=[["fail_closed","fail_closed"],["paranoid_rm","paranoid_rm"],["paranoid_interpreters","paranoid_interpreters"]];for(let[e,a]of r){let l=n.effectiveSafety.capabilities[e],d=l.enabled?o.green("ON"):o.dim("OFF"),s=l.sources.length>0?` (${l.sources.join(", ")})`:"";t.push(`   ${a}: ${d} via ${l.source}${s}`)}t.push(`   Stored rule customizations: ${n.effectiveSafety.ruleCounts.stored}`),t.push(`   Effective rule customizations: ${n.effectiveSafety.ruleCounts.effective}`);for(let[e,a]of Object.entries(n.effectiveSafety.ruleOverrides))t.push(`   ${e}: ${a}`);return t.join(`
`)}function oa(n){let t=["Findings"];if(n.length===0)return t.push("   No findings from inspected doctor facts."),t.join(`
...
`)}function eL(n){let t=["Variable","Status","Legacy"],r=n.map((e)=>{let a=e.isSet?o.green("✓"):o.dim("✗"),l=e.legacyName&&e.legacyIsSet?`${e.legacyName} ${o.green("✓")}`:e.legacyName??"";return[e.name,a,l]});return z2({headers:t,rows:r})}function fa(n){let t=[];if(n.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${n.totalBlocked} blocked / ${n.sessionCount} sessions)`),t.push(aL(n.recentEntries));if(n.unreadable>0)t.push(`   Warning: ${n.unreadable} audit log ${n.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function aL(n){let t=["Time","Command"],r=n.map((e)=>{let a=Z(e.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),l=a.length>40?`${a.slice(0,37)}...`:a;return[e.relativeTime,l]});return z2({headers:t,rows:r})}function ha(n){let t=[];if(t.push("Update Check"),n.latestVersion===null&&!n.error)return t.push(Pn([["Status",o.dim("Skipped")],["Installed",n.currentVersion]])),t.join(`
`);if(n.error)return t.push(Pn([["Status",`${o.yellow("⚠")} Error`],["Installed",n.currentVersion],["Error",o.dim(n.error)]])),t.join(`
`);if(n.updateAvailable)return t.push(Pn([["Status",`${o.yellow("⚠")} Update Available`],["Current",n.currentVersion],["Latest",o.green(n.latestVersion??"")]])),t.push(""),t.push("   Run: bunx cc-safety-net@latest doctor"),t.push("   Or:  npx cc-safety-net@latest doctor"),t.join(`
`);return t.push(Pn([["Status",`${o.green("✓")} Up to date`],["Version",n.currentVersion]])),t.join(`
`)}function Pn(n){return z2({rows:n})}function ya(n){let t=[];return t.push("System Info"),t.push(lL(n)),t.join(`
`)}function lL(n){let t=["Component","Version"],r=(l)=>{if(l===null)return o.dim("not found");return l},a=[{label:"cc-safety-net",value:n.version},...On.map((l)=>({label:j(l),value:n.versions[l]??null})),{label:"Node.js",value:n.nodeVersion},{label:"npm",value:n.npmVersion},{label:"Bun",value:n.bunVersion},{label:"Platform",value:n.platform}].map((l)=>[l.label,r(l.value)]);return z2({headers:t,rows:a})}function wa(n){if(n.findings.length===0)return o.green(`
...
${n.findings.length} ${e}: ${r.join(", ")}.`;if(t.error>0)return o.red(a);if(t.warning>0)return o.yellow(a);return o.blue(a)}import{lstatSync as dL}from"node:fs";import{dirname as $1}from"node:path";function D1(n,t){try{let r=dL(t);if(r.isSymbolicLink())return{kind:n,path:t,status:"unsafe",issues:["symlink"]};if(!r.isDirectory())return{kind:n,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:n,path:t,status:"unknown",issues:[]};let e=[...r.uid!==process.getuid()?["ownership"]:[],...(r.mode&18)!==0?["permissions"]:[]];return{kind:n,path:t,status:e.length>0?"unsafe":"safe",issues:e}}catch(r){if(typeof r==="object"&&r!==null&&"code"in r&&r.code==="ENOENT")return{kind:n,path:t,status:"not-applicable",issues:[]};return{kind:n,path:t,status:"unknown",issues:[]}}}function xa(n){let t=i2();return{directories:[D1("policy",$1($1(n))),D1("config",$1(n)),...t?[D1("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as sL}from"node:child_process";import{existsSync as $a}from"node:fs";import{delimiter as LL,extname as cL,join as iL}from"node:path";import{stripVTControlCharacters as Da}from"node:util";var ma="2.0.8",pL=5000,vL="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function B(){return ma}function g1(n,t){let r=n[t];if(r)return r;let e=Object.keys(n).find((a)=>a.toLowerCase()===t.toLowerCase()&&!!n[a]);return e?n[e]:r}function uL(n){return(g1(n,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function bL(n,t){let r=cL(n)?[n]:[...uL(t).map((e)=>`${n}${e}`),n];if(n.includes("/")||n.includes("\\"))return r.find((e)=>$a(e))??n;return(g1(t,"PATH")??"").split(LL).flatMap((e)=>r.map((a)=>iL(e,a))).find((e)=>$a(e))??n}function ga(n){if(!/[\s"&|<>^]/.test(n))return n;return`"${n.replace(/"/g,'""')}"`}function F2(n,t){let[r,...e]=n,a=t[vL]==="win32"?"win32":process.platform;if(!r||a!=="win32")return{cmd:r??"",args:e};let l=bL(r,t);if(!/\.(?:bat|cmd)$/i.test(l))return{cmd:l,args:e};return{cmd:g1(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",ga(l),...e.map(ga)].join(" ")]}}var P2=async(n,t=pL)=>{let r=await oL(n,{timeoutMs:t});if(r.code!==0)return null;return Da(r.stdout).trim()||Da(r.stderr).trim()||null};function oL(n,t){let[r,...e]=n;if(!r)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((a)=>{try{let l=F2([r,...e],process.env),d=sL(l.cmd,l.args,{stdio:["ignore","pipe","pipe"]}),s=!1,L="",c="";d.stdout.on("data",(b)=>{L+=b.toString()}),d.stderr.on("data",(b)=>{c+=b.toString()});let i=(b)=>{if(s)return;s=!0,clearTimeout(v),a(b)},v=setTimeout(()=>{d.kill(),i({code:null,stdout:L,stderr:c})},t.timeoutMs);d.on("close",(b)=>{i({code:b,stdout:L,stderr:c})}),d.on("error",()=>{i({code:null,stdout:L,stderr:c})})}catch{a({code:null,stdout:"",stderr:""})}})}function In(n){if(!n)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(n);if(t)return t[1]??null;let r=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(n);if(r)return r[1]??null;return n.split(`
`)[0]?.trim()||null}async function kn(n=P2){let[t,r,e,a,l,d]=await Promise.all([Promise.all(G.map(async(s)=>[s.id,In(await n([...s.probeCommand]))])),n(["codex","plugin","list"],30000),n(["amp","plugins","list"],30000),n(["node","--version"]),n(["npm","--version"]),n(["bun","--version"])]);return{version:ma,versions:Object.fromEntries(t),codexPluginListOutput:r,ampPluginListOutput:e,nodeVersion:In(a),npmVersion:In(l),bunVersion:In(d),platform:`${process.platform} ${process.arch}`}}function m1(n,t){if(t==="dev")return!1;let r=n.split(".").map(Number),e=t.split(".").map(Number),[a=0,l=0,d=0]=r,[s=0,L=0,c=0]=e;if(a!==s)return a>s;if(l!==L)return l>L;return d>c}async function I2(){let n=B(),t=new AbortController,r=setTimeout(()=>t.abort(),3000);try{let e=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!e.ok)return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${e.status}`};let a=await e.json(),l=m1(a.version,n);return{currentVersion:n,latestVersion:a.version,updateAvailable:l}}catch(e){return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:e instanceof Error?e.message:"Network error"}}finally{clearTimeout(r)}}import*as Za from"node:readline";var za=(n)=>`\x1B[${n}B`,fL=(n)=>`\x1B[${n}A`;var ka=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function hL(n){return new Promise((t)=>setTimeout(t,n))}function yL(n,t,r){if(!r)return t(n);if(r.aborted)return Promise.resolve();return new Promise((e,a)=>{let l=()=>r.removeEventListener("abort",d),d=()=>{l(),e()};r.addEventListener("abort",d,{once:!0}),t(n).then(()=>{l(),e()},(s)=>{l(),a(s)})})}function qn(n,t){return n&&n>0?n:t}function Nn(n){return Math.max(0,Math.min(1,n))}function N2(n){return Math.max(0,Math.min(255,Math.round(n)))}function k1(n){return n<=0.0031308?12.92*n:1.055*n**0.4166666666666667-0.055}function wL(n,t,r){let e=r*Math.PI/180,a=t*Math.cos(e),l=t*Math.sin(e),d=(n+0.3963377774*a+0.2158037573*l)**3,s=(n-0.1055613458*a-0.0638541728*l)**3,L=(n-0.0894841775*a-1.291485548*l)**3;return{blue:N2(k1(Nn(-0.0041960863*d-0.7034186147*s+1.707614701*L))*255),green:N2(k1(Nn(-1.2684380046*d+2.6097574011*s-0.3413193965*L))*255),red:N2(k1(Nn(4.0767416621*d-3.3077115913*s+0.2309699292*L))*255)}}function q1(n,t){let r=(t*n*180/Math.PI%360+360)%360;return wL(0.72,0.15,r)}function Fa(n,t=0.1){let r=q1(t,n);return`\x1B[38;2;${r.red};${r.green};${r.blue}m`}function xL(n,t){return{blue:N2(n.blue+(255-n.blue)*t),green:N2(n.green+(255-n.green)*t),red:N2(n.red+(255-n.red)*t)}}function Ba(n,t,r){let e=Math.imul(n+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(r+374761393,2654435761),a=e^e>>>15,l=Math.imul(a,739982445),d=l^l>>>12,s=Math.imul(d,695872825);return((s^s>>>15)>>>0)/4294967296}function $L(n,t,r){let e=Math.floor(Ba(n,t,r)*ka.length);return ka[e]??"░"}function qa(n){let t=Nn(n);return t*t*t*(t*(t*6-15)+10)}function DL(n){if(n.length===0)return"";let t=[],r=!1,e="";for(let a of n){let l=`${a.red};${a.green};${a.blue}`;if(a.bold!==r)t.push(a.bold?"\x1B[1m":"\x1B[22m"),r=a.bold;if(l!==e)t.push(`\x1B[38;2;${l}m`),e=l;t.push(a.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function gL(n,t,r,e,a){return n.map((l,d)=>({...q1(r,e+t+d/a),bold:!1,character:l}))}function mL(n,t,r,e,a,l,d,s){let L=Math.max(1,e*0.75),c=Math.min(1,r/L),i=a*qa(c),v=Math.max(0,(r-L)/Math.max(1,e-L)),b=(1-qa(r/e))*s*2,p=0.35*Math.max(0,1-v*2),f=c>=1,u=Math.min(n.length,Math.ceil(i+2+1));return n.slice(0,u).map((y,w)=>{let $=q1(l,d+t+w/s+b),h=w+Ba(t,w,7919)*2-1;if(h>i+2)return{...$,bold:!1,character:" "};let g=i-h,S=0.8*Math.exp(-(g*g)/12.5),o2=Math.min(0.9,S+p),Ht=!f&&h>i-4;return{...xL($,o2),bold:o2>0.3,character:Ht?$L(t,w,r):y}})}function ja(n){return`\x1B[?2026h${n.map((t,r)=>`\x1B8${r>0?za(r):""}${DL(t)}`).join("")}\x1B[?2026l`}async function j1(n,t={}){if(!n)return;let r=t.output??process.stdout,e=t.sleep??hL,a=qn(t.frequency,0.1),l=t.seed??0,d=qn(t.speed,40),s=qn(t.spread,3),L=qn(t.frameRate,60),c=Math.max(1,Math.floor(qn(t.duration,12))),i=n.split(`
...
`.repeat(i.length-1)}${fL(i.length-1)}`:""}\x1B7`);try{for(let u=1;u<=p;u+=1){if(t.signal?.aborted)break;r.write(ja(i.map((y,w)=>mL(y,w,u,p,v,a,l,s)))),await yL(f,e,t.signal)}}finally{if(r.write(ja(i.map((u,y)=>gL(u,y,a,l,s)))),r.write("\x1B8"),i.length>1)r.write(za(i.length-1));r.write(`
\x1B[0m\x1B[?25h`)}}var Ja=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function kL(n){return Boolean(n.isTTY)}async function jn(n={}){let t=n.output??process.stdout;if(!kL(t))return;let r=n.input??process.stdin,e={duration:n.duration,frequency:n.frequency,output:t,seed:n.seed??Math.random()*8192,sleep:n.sleep,speed:n.speed,spread:n.spread};if(!r.isTTY||typeof r.setRawMode!=="function"){await j1(Ja,e);return}let a=new AbortController,l=r.readableFlowing===!0,d=r.isRaw===!0,s=!1,L=(c,i)=>{if(i.ctrl&&i.name==="c")s=!0;if(s||i.name==="return"||i.name==="enter")a.abort()};Za.emitKeypressEvents(r),r.on("keypress",L),r.setRawMode(!0),r.resume();try{await j1(Ja,{...e,signal:a.signal})}finally{if(r.off("keypress",L),r.setRawMode(d),!l)r.pause()}if(!s)return;if(n.onInterrupt){n.onInterrupt();return}process.kill(process.pid,"SIGINT")}var Qa="\r\x1B[2K",qL="\x1B[?25l",jL="\x1B[39m",zL="\x1B[?25h",FL=100,BL=0.55,JL=80,Xa=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function ZL(n){return new Promise((t)=>setTimeout(t,n))}async function nt(n,t={}){let r=t.output??process.stdout;if(!r.isTTY)return n;let e=t.sleep??ZL,a=!1,l=n.then((s)=>{return a=!0,s},(s)=>{throw a=!0,s});if(await Promise.race([l.then(()=>!0),e(FL).then(()=>!1)]))return l;r.write(qL);try{for(let s=0;!a;s+=1)r.write(`${Qa}${Fa(s*BL)}${Xa[s%Xa.length]}${jL} ${t.loadingMessage??"Loading…"}`),await Promise.race([l,e(JL)]);return await l}finally{r.write(`${Qa}${zL}`)}}async function zn(n,t,r,e={}){let a=t();if(n)await r();if(n&&a.ready)await nt(a.ready,e);return a.finish()}import{homedir as Nc}from"node:os";import{stripVTControlCharacters as QL}from"node:util";var tt="amp plugins list",XL=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function Ya(n){if(!n.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=QL(n.ampPluginListOutput).split(`
`).map((r)=>XL.exec(r)?.[1]).find((r)=>r!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:tt,configPath:tt,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:tt,configPath:tt}}import{existsSync as YL,readFileSync as HL}from"node:fs";var SL=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function WL(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];return Object.values(n).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let r=t,e=r.PreToolUse;if(!Array.isArray(e))return[];return e.flatMap((a)=>{if(!a||typeof a!=="object"||Array.isArray(a))return[];let l=a.hooks;if(!Array.isArray(l))return[];return l.flatMap((d)=>{if(!d||typeof d!=="object"||Array.isArray(d))return[];let s=d.command;if(typeof s!=="string"||!SL.test(s))return[];return[{command:s,enabled:r.enabled!==!1}]})})})}function Ha(n){let t=gn(n.homeDir);if(!YL(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let r;try{r=WL(JSON.parse(HL(t,"utf-8")))}catch(e){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${e instanceof Error?e.message:String(e)}`]}}if(r.some((e)=>e.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(r.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as Sa}from"node:path";import{existsSync as RL,lstatSync as KL,readFileSync as VL}from"node:fs";function r2(n,t=(r)=>r){if(!RL(n))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(VL(n,"utf-8")))}}catch{return{kind:"unreadable"}}}function F(n){try{return KL(n)}catch{return}}function rt(n,t){let r=F(t);if(!r)return{platform:n,status:"n/a",configPath:t};if(!r.isSymbolicLink()&&r.isDirectory())return;return{platform:n,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function x(n,t){return typeof n==="object"&&n!==null?n[t]:void 0}var z1="cc-safety-net@cc-marketplace";function Wa(n){return Sa(n,".claude","plugins","installed_plugins.json")}function Ra(n,t){let r=x(x(n,"plugins"),t);return Array.isArray(r)&&r.length>0}function et(n,t){let r=r2(Wa(n));return r.kind==="ok"&&Ra(r.value,t)}function F1(n){let t=Wa(n),r=r2(t);if(r.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(r.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!Ra(r.value,z1))return{platform:"claude-code",status:"n/a"};let e=Sa(n,".claude","settings.json"),a=r2(e);if(a.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(a.kind==="ok"&&x(x(a.value,"enabledPlugins"),z1)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:e,errors:[`${z1} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function Ka(n){return F1(n.homeDir)}function Va(n){if(!n.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=n.codexPluginListOutput.split(`
`).find((r)=>r.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed,"))return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as dt,readdirSync as AL,readFileSync as ML}from"node:fs";import{join as H}from"node:path";var e2="cc-safety-net@cc-marketplace",at=["cc-marketplace","cc-safety-net"],Aa=["_direct","copilot-safety-net"],Ma=["cc-marketplace","safety-net"],Ga="safety-net@cc-marketplace";function lt(n,t){let r=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${r}([^a-z0-9-]|$)`,"m").test(n??"")}function Ua(n){return lt(n,"cc-safety-net@cc-marketplace")}function Ca(n){return lt(n,"cc-marketplace")}function Oa(n){return lt(n,"copilot-safety-net")}function Ta(n){return lt(n,"safety-net@cc-marketplace")}function M(n){let t="",r=0,e=!1,a=!1,l=-1;while(r<n.length){let d=n[r],s=n[r+1];if(a){t+=d,a=!1,r++;continue}if(d==='"'&&!e){e=!0,l=-1,t+=d,r++;continue}if(d==='"'&&e){e=!1,t+=d,r++;continue}if(d==="\\"&&e){a=!0,t+=d,r++;continue}if(e){t+=d,r++;continue}if(d==="/"&&s==="/"){while(r<n.length&&n[r]!==`
`)r++;continue}if(d==="/"&&s==="*"){r+=2;while(r<n.length-1){if(n[r]==="*"&&n[r+1]==="/"){r+=2;break}r++}continue}if(d===","){l=t.length,t+=d,r++;continue}if(d==="}"||d==="]"){if(l!==-1){let L=t.slice(l+1);if(/^\s*$/.test(L))t=t.slice(0,l)+L}l=-1,t+=d,r++;continue}if(!/\s/.test(d))l=-1;t+=d,r++}return t}function B1(n){if(!n?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(n)}function Ea(n,t){if(!n)return null;let r=n.match(/(\d+)\.(\d+)\.(\d+)/);if(!r)return null;let e=[Number(r[1]),Number(r[2]),Number(r[3])];for(let a=0;a<t.length;a++){let l=e[a]??0,d=t[a]??0;if(l!==d)return l>d}return!0}function GL(n){return Ea(n,[0,0,422])}function UL(n){return Ea(n,[1,0,8])}function Fn(n){return process.env.COPILOT_HOME||H(n,".copilot")}function J1(n){return(n.hooks?.preToolUse??[]).some((r)=>{if(r.type!=="command")return!1;return B1(r.command)||B1(r.bash)||B1(r.powershell)})}function Z1(n,t){try{return JSON.parse(M(ML(n,"utf-8")))}catch(r){t?.push(`Failed to parse ${n}: ${r instanceof Error?r.message:String(r)}`);return}}function Pa(n,t){try{return AL(n).filter((r)=>r.endsWith(".json")).sort((r,e)=>r.localeCompare(e))}catch(r){return t?.push(`Failed to read ${n}: ${r instanceof Error?r.message:String(r)}`),[]}}function CL(n,t){if(!dt(n))return[];let r=[];for(let e of Pa(n,t)){let a=H(n,e),l=Z1(a,t);if(l&&J1(l))r.push(a)}return r}function nn(n,t){if(!dt(n))return;let r=Z1(n,t);if(!r)return;return{path:n,config:r}}function _a(n,t,r,e){if(t){n.push(`GitHub Copilot CLI ${t} does not support ${r}; requires ${e}+`);return}n.push(`GitHub Copilot CLI version unavailable; skipping ${r} because it requires ${e}+`)}function OL(n){for(let t of n){if(t?.config.disableAllHooks===!0)return t.path;if(t?.config.disableAllHooks===!1)return}return}function TL(n,t,r,e){let a=Fn(n),l=H(t,".github","hooks"),d=H(a,"hooks"),s=H(t,".github","copilot"),L=H(t,".claude"),c=UL(r),i=c===!0?e:void 0,v=[nn(H(s,"settings.local.json"),i),nn(H(s,"settings.json"),i),nn(H(L,"settings.local.json"),i),nn(H(L,"settings.json"),i)],b=[nn(H(a,"settings.json"),i),nn(H(a,"config.json"),i)];if(c!==!1){let g=OL([...v,...b]);if(g){if(c===null)e.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${g} as active`);return{activeConfigPaths:[],disabledBy:g}}}let p=CL(l,e),f=GL(r),u=f===!0?e:void 0,y=dt(d)?Pa(d,u):[],w=[];for(let g of y){let S=H(d,g),o2=Z1(S,u);if(o2&&J1(o2))w.push(S)}if(f!==!0&&w.length>0)_a(e,r,`user hook files in ${d}`,"0.0.422"),w.length=0;let $=[];for(let g of[...v,...b]){if(!g)continue;if(!J1(g.config))continue;if(c===!0){$.push(g);continue}_a(e,r,"inline hook definitions in Copilot config files","1.0.8");break}let h=(g)=>g.filter((S)=>!!S&&$.includes(S)).map((S)=>S.path);return{activeConfigPaths:[...h(v),...p,...h(b),...w]}}function Ia(n){let t=[],r=TL(n.homeDir,n.cwd,n.copilotCliVersion,t);if(r.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:r.disabledBy,configPaths:[r.disabledBy],errors:t.length>0?t:void 0};let e=Fn(n.homeDir),a=H(e,"installed-plugins",...at),l=dt(a),d=H(e,"settings.json"),s=r2(d,M);if(l&&s.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(l&&s.kind==="ok"&&x(x(s.value,"enabledPlugins"),e2)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:d,errors:[`${e2} is installed but not enabled in Copilot CLI`]};if(l||r.activeConfigPaths.length>0){let L=l,c=r.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:L?"plugin config":"hook config",configPath:c??(L?a:void 0),configPaths:r.activeConfigPaths.length>0?r.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as ac,readFileSync as lc}from"node:fs";import{existsSync as Na,mkdirSync as PL,readFileSync as IL}from"node:fs";import{dirname as NL,join as nc}from"node:path";import{renameSync as _L,writeFileSync as EL}from"node:fs";function Q(n,t){let r=`${n}.${process.pid}.tmp`;EL(r,t),_L(r,n)}var Bn="npx -y cc-safety-net hook --cursor",n0=30;function Lt(n){return nc(n,".cursor","hooks.json")}function B2(n){return typeof n==="object"&&n!==null&&!Array.isArray(n)}function Q1(){return{command:Bn,timeout:n0,failClosed:!0}}function st(n){return B2(n)&&n.command===Bn}function tc(n){return Object.keys(n).length===3&&n.command===Bn&&n.timeout===n0&&n.failClosed===!0}function rc(n){try{return JSON.parse(IL(n,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${n}: ${t.message}`);throw t}}function t0(n){let t=rc(n);if(!B2(t))throw Error(`Cursor hooks config ${n} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${n} must set "version": 1`);if(t.hooks!==void 0&&!B2(t.hooks))throw Error(`Cursor hooks config ${n} "hooks" must be an object`);let r=B2(t.hooks)?t.hooks.preToolUse:void 0;if(r!==void 0&&!Array.isArray(r))throw Error(`Cursor hooks config ${n} "hooks.preToolUse" must be an array`);return t}function r0(n){let t=B2(n.hooks)?n.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function ec(n){if(!n.some(st))return[...n,Q1()];return n.reduce((t,r)=>{if(!st(r))return t.result.push(r),t;if(!t.inserted)t.result.push(Q1()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function e0(n,t,r){let e=B2(t.hooks)?t.hooks:{},a={...t,hooks:{...e,preToolUse:r}};Q(n,`${JSON.stringify(a,null,2)}
`)}function a0(n){let t=Lt(n);if(!Na(t))return PL(NL(t),{recursive:!0}),Q(t,`${JSON.stringify({version:1,hooks:{preToolUse:[Q1()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let r=t0(t),e=r0(r),a=e.filter(st);if(B2(r.hooks)&&Array.isArray(r.hooks.preToolUse)&&a.length===1&&a[0]!==void 0&&tc(a[0]))return{path:t,alreadyInstalled:!0};return e0(t,r,ec(e)),{path:t,alreadyInstalled:!1}}function l0(n){let t=Lt(n);if(!Na(t))return{path:t,alreadyInstalled:!1};let r=t0(t),e=r0(r),a=e.filter((l)=>!st(l));if(a.length===e.length)return{path:t,alreadyInstalled:!1};return e0(t,r,a),{path:t,alreadyInstalled:!0}}function dc(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];let t=n.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let r=t.preToolUse;if(!Array.isArray(r))return[];return r.filter((e)=>!!e&&typeof e==="object"&&!Array.isArray(e)&&e.command===Bn)}function sc(n){let t=[];if(n.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let r=n[0];if(r&&r.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(r&&r.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function d0(n){let t=Lt(n.homeDir);if(!ac(t))return{platform:"cursor",status:"n/a",configPath:t};let r;try{r=JSON.parse(lc(t,"utf-8"))}catch(l){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${l instanceof Error?l.message:String(l)}`]}}let e=dc(r);if(e.length===0)return{platform:"cursor",status:"n/a",configPath:t};let a=sc(e);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:a.length>0?a:void 0}}import{existsSync as Lc}from"node:fs";import{join as X1}from"node:path";var Y1="gemini-safety-net";function H1(n){let t=X1(n,".gemini","extensions"),r=X1(t,Y1);if(!Lc(r))return{platform:"gemini-cli",status:"n/a"};let e=X1(t,"extension-enablement.json"),a=r2(e);if(a.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let l=a.kind==="ok"?x(x(a.value,Y1),"overrides"):void 0;if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:e,errors:[`${Y1} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:r}}function s0(n){return H1(n.homeDir)}import{readFileSync as f0}from"node:fs";import{join as h0}from"node:path";var U="cc-safety-net",L0="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function c0(n){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${n}
`}function cc(n){return`${c0(n)}name: cc-safety-net
version: "${n}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function ic(n){return`${c0(n)}"""CC Safety Net guard for Hermes Agent.
...
`}function Jn(n){return[{name:"__init__.py",content:ic(n)},{name:"plugin.yaml",content:cc(n)}]}import{mkdirSync as pc,readdirSync as vc,readFileSync as uc,rmSync as S1}from"node:fs";import{join as J2}from"node:path";var bc="__pycache__";function W1(n){let t=process.env.HERMES_HOME?.trim();return t?t:J2(n,".hermes")}function R1(n){return J2(W1(n),"plugins",U)}function K1(n){return n.startsWith(L0)}function V1(n,t){let r=R1(n),e=F(r);if(e&&(e.isSymbolicLink()||!e.isDirectory()))throw Error(`Refusing to ${t} ${r}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return r}function i0(n,t){let r=F(n);if(!r)return;if(r.isSymbolicLink()||!r.isFile())throw Error(`Refusing to ${t} ${n}: not a regular file. Move or remove it.`);let e=uc(n,"utf-8");if(!K1(e))throw Error(`Refusing to ${t} unmanaged file at ${n}. Move or remove it.`);return e}function p0(n){let t=V1(n,"install"),r=Jn(B());if(r.map((a)=>i0(J2(t,a.name),"overwrite")).every((a,l)=>a===r[l]?.content))return{path:t,alreadyInstalled:!0};return pc(t,{recursive:!0}),r.forEach((a)=>{Q(J2(t,a.name),a.content)}),{path:t,alreadyInstalled:!1}}function A1(n){let t=V1(n,"remove");if(!F(t))return[];return Jn(B()).filter((r)=>i0(J2(t,r.name),"remove")!==void 0)}function v0(n){let t=V1(n,"remove");if(!F(t))return{path:t,alreadyInstalled:!1};let r=A1(n);if(r.forEach((e)=>{S1(J2(t,e.name))}),S1(J2(t,bc),{recursive:!0,force:!0}),vc(t).length===0)S1(t,{recursive:!0});return{path:t,alreadyInstalled:r.length>0}}var ct="hermes-agent",u0=/^([^\s#][^:]*):/,oc=/^\s+([A-Za-z_][\w-]*):/,b0=/^\s+-\s*(.*)$/;function fc(n){return n.trim().replace(/^(["'])(.*)\1$/,"$2")}function hc(n){let t=n.split(/\r?\n/),r=t.findIndex((l)=>u0.exec(l)?.[1]?.trim()==="plugins");if(r===-1)return[];let e=t.slice(r+1),a=e.findIndex((l)=>u0.test(l));return a===-1?e:e.slice(0,a)}function o0(n,t){let r=hc(n),e=r.findIndex((d)=>oc.exec(d)?.[1]===t);if(e===-1)return[];let a=r.slice(e+1),l=a.findIndex((d)=>!b0.test(d));return(l===-1?a:a.slice(0,l)).map((d)=>fc(b0.exec(d)?.[1]??""))}function yc(n){try{return f0(h0(W1(n),"config.yaml"),"utf-8")}catch{return}}function M1(n){let t=yc(n)??"";return o0(t,"enabled").includes(U)&&!o0(t,"disabled").includes(U)}function y0(n){return/^# version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function wc(n,t){let r=F(n);if(!r)return{error:`${t.name} is missing from ${n}; run install --hermes-agent`};if(r.isSymbolicLink()||!r.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{let e=f0(n,"utf-8");if(!K1(e))return{error:`Unmanaged ${t.name} occupies ${n}; move or remove it`};if(y0(e)===B()&&e!==t.content)return{error:`Modified ${t.name} occupies ${n}; run install --hermes-agent to restore it`};return{content:e}}catch(e){return{error:`Failed to read ${n}: ${e instanceof Error?e.message:String(e)}`}}}function w0(n){let t=R1(n.homeDir),r=rt(ct,t);if(r)return r;let e=Jn(B()).map((s)=>wc(h0(t,s.name),s)),a=e.flatMap((s)=>("error"in s)?[s.error]:[]);if(a.length>0)return{platform:ct,status:"n/a",configPath:t,errors:a};let l=e.some((s)=>("content"in s)&&y0(s.content)!==B()),d=l?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!M1(n.homeDir))return{platform:ct,status:"disabled",method:"plugin directory",configPath:t,errors:[`${U} is not enabled in Hermes; run \`hermes plugins enable ${U}\``,...d]};return{platform:ct,status:"configured",method:"plugin directory",configPath:t,errors:l?d:void 0}}import{existsSync as xc,readFileSync as $c}from"node:fs";import{join as x0}from"node:path";var Dc=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function gc(n){return x0(process.env.KIMI_CODE_HOME||x0(n,".kimi-code"),"config.toml")}function Zn(n){let t=gc(n.homeDir);if(!xc(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!Dc.test($c(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(r){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${r instanceof Error?r.message:String(r)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as B0}from"node:fs";import{join as Xn}from"node:path";var z="cc-safety-net",C="index.js",tn="openclaw.plugin.json",rn="package.json";var it="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as qc,lstatSync as jc,readdirSync as zc,readFileSync as Fc}from"node:fs";import{dirname as g0,join as y2}from"node:path";import{fileURLToPath as Bc}from"node:url";import{spawn as mc}from"node:child_process";function kc(n){return n.join(" ")}function G1(n,t,r){return[`Failed to run ${kc(n)}${t===null?"":` (exit ${t})`}.`,r.trim()].filter(Boolean).join(`
`)}function U1(n){let t={stdout:"",stderr:""};return n.stdout.setEncoding("utf-8"),n.stderr.setEncoding("utf-8"),n.stdout.on("data",(r)=>{t.stdout+=r}),n.stderr.on("data",(r)=>{t.stderr+=r}),t}function a2(n,t){return new Promise((r,e)=>{let a=F2([...n],process.env),l=mc(a.cmd,a.args,{stdio:["ignore","pipe","pipe"]}),d=U1(l),s=()=>[d.stdout,d.stderr].filter(Boolean).join(`
`),L=t?.timeoutMs??120000,c=setTimeout(()=>{l.kill(),e(Error(G1(n,null,`Timed out after ${L}ms.
${s()}`.trim())))},L);l.on("error",(i)=>{clearTimeout(c),e(Error(G1(n,null,`${i.message}
${s()}`.trim())))}),l.on("close",(i)=>{if(clearTimeout(c),i!==0){e(Error(G1(n,i,s())));return}r(t?.stdoutOnly?d.stdout:s())})})}async function C1(n){for(let t of n)await a2(t)}async function $0(n){for(let t of n)try{await a2(t)}catch(r){console.warn(r instanceof Error?r.message:String(r))}}var D0=y2("openclaw",z),Jc=[C,tn,rn];function O1(n,t){if(n==="~")return t;if(n.startsWith("~/")||n.startsWith("~\\"))return y2(t,n.slice(2));return n}function m0(n){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return O1(t,n);let r=process.env.OPENCLAW_CONFIG_PATH?.trim();return r?g0(O1(r,n)):y2(n,".openclaw")}function k0(n){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?O1(t,n):y2(m0(n),"openclaw.json")}function T1(n){return y2(m0(n),"extensions",z)}function Zc(n){let t=zc(n);if(t.length===0)return!0;if(t.some((a)=>!Jc.includes(a)))return!1;let r=y2(n,C),e=F(r);return e!==void 0&&!e.isSymbolicLink()&&e.isFile()&&Fc(r,"utf-8").startsWith(it)}function _1(n){let t=T1(n),r=F(t);if(!r)return;if(!r.isSymbolicLink()&&r.isDirectory()&&Zc(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function q0(){let n=g0(Bc(import.meta.url));return[y2(n,"..",D0),y2(n,"..","..","..","dist",D0)]}function E1(n=q0()){return n.find((t)=>qc(t)&&jc(t).isDirectory())}function Qc(n=q0()){let t=E1(n);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function j0(n=Qc()){return[["openclaw","plugins","install",n,"--force"],["openclaw","plugins","enable",z]]}function Xc(n){let t=(()=>{try{return JSON.parse(n)}catch{return}})(),r=x(x(t,"plugin"),"status");return typeof r==="string"?r:void 0}async function z0(){let n=Xc(await a2(["openclaw","plugins","inspect",z,"--runtime","--json"],{stdoutOnly:!0}));if(n==="loaded")return;throw Error(`${n===void 0?`The ${z} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${z} plugin with status "${n}".`} Run \`openclaw plugins inspect ${z} --runtime\` for details.`)}var pt="openclaw",Qn=`run \`openclaw plugins enable ${z}\``;function en(n,t){let r=Xn(n,t),e=F(r);if(!e)return{error:`${t} is missing from ${r}; run install --openclaw`};if(e.isSymbolicLink()||!e.isFile())return{error:`${r} is a symlink or not a regular file; move or remove it`};try{return{content:B0(r,"utf-8")}}catch(a){return{error:`Failed to read ${r}: ${a instanceof Error?a.message:String(a)}`}}}function J0(n){try{return JSON.parse(M(n))}catch{return}}function Yc(n){let t=en(n,tn);if("error"in t)return t.error;if(x(J0(t.content),"id")===z)return;return`${Xn(n,tn)} is not a valid ${z} manifest; run install --openclaw`}function Hc(n){let t=en(n,rn);if("error"in t)return t.error;let r=x(x(J0(t.content),"openclaw"),"extensions");if(Array.isArray(r)&&r.includes(`./${C}`))return;return`${Xn(n,rn)} does not point OpenClaw at ${C}; run install --openclaw`}function F0(n){return Array.isArray(n)?n.filter((t)=>typeof t==="string"):[]}function Sc(n){let t=k0(n);if(!F(t))return`${z} is not enabled; ${Qn}`;let r=(()=>{try{return JSON.parse(M(B0(t,"utf-8")))}catch{return}})();if(r===void 0)return`Failed to read ${t}; fix it, then ${Qn}`;let e=x(r,"plugins");if(x(e,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let a=x(x(x(e,"entries"),z),"enabled");if(F0(x(e,"deny")).includes(z)||a===!1)return`${z} is disabled in ${t}; ${Qn}`;let l=F0(x(e,"allow"));if(l.length>0&&!l.includes(z))return`plugins.allow in ${t} does not list ${z}; add it, then ${Qn}`;if(l.includes(z)||a===!0)return;return`${z} is not enabled; ${Qn}`}function Z0(n){return/^\/\/ version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function Wc(n,t,r){if(r===void 0)return[];let e=en(r,C);if("error"in e||Z0(e.content)!==t)return[];return[C,tn,rn].flatMap((a)=>{let l=en(n,a),d=en(r,a);if("error"in l||"error"in d||l.content===d.content)return[];return[`Modified ${a} occupies ${Xn(n,a)}; run install --openclaw to restore it`]})}function Q0(n){let t=T1(n.homeDir),r=rt(pt,t);if(r)return r;let e=en(t,C),l=["error"in e?e.error:e.content.startsWith(it)?void 0:`Unmanaged ${C} occupies ${Xn(t,C)}; move or remove it`,Yc(t),Hc(t)].filter((i)=>i!==void 0),d="content"in e?Z0(e.content):void 0,s=l.length>0?l:Wc(t,d,E1());if(s.length>0)return{platform:pt,status:"n/a",configPath:t,errors:s};let L=d===B()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],c=Sc(n.homeDir);if(c)return{platform:pt,status:"disabled",method:"plugin directory",configPath:t,errors:[c,...L]};return{platform:pt,status:"configured",method:"plugin directory",configPath:t,errors:L.length>0?L:void 0}}import{existsSync as _c,readFileSync as Ec}from"node:fs";import{join as Pc}from"node:path";import{existsSync as P1,readFileSync as W0,rmSync as Kc}from"node:fs";import{join as u2}from"node:path";import{pathToFileURL as Vc}from"node:url";function X0(n){return n!==void 0&&/\s/.test(n)}function Rc(n,t,r){let e=t+1,a=!1;while(e<n.length){let l=n[e];if(a){a=!1,e++;continue}if(l==="\\"){a=!0,e++;continue}if(l==='"')return e+1;e++}throw Error(r)}function vt(n,t,r){let e=n[t],a=e==="["?"]":"}",l=0,d=t;while(d<n.length){let s=r.skipComment?.(n,d)??d;if(s!==d){d=s;continue}if(n[d]==='"'){d=Rc(n,d,r.stringError);continue}if(n[d]===e)l++;if(n[d]===a){if(l--,l===0)return d}d++}throw Error(r.bracketError)}function Y0(n,t){let r=n.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(n.slice(r))?.[0]??""}function ut(n,t){let{start:r,end:e,end:a}=t;while(X0(n[a]))a++;if(n[a]===","){if(e=a+1,n[e]===`
`)e++;return`${n.slice(0,r)}${n.slice(e)}`}a=t.start-1;while(X0(n[a]))a--;if(n[a]===","){r=a;let l=n.lastIndexOf(`
`,r-1);if(l!==-1&&/^\s*$/.test(n.slice(l+1,r)))r=l}return`${n.slice(0,r)}${n.slice(e)}`}var bt="cc-safety-net",R0=`${bt}@latest`,K0=["opencode.json","opencode.jsonc"],H0="CCSafetyNetPlugin";function ot(n){return u2(process.env.XDG_CONFIG_HOME||u2(n,".config"),"opencode")}function Ac(n){return u2(ot(n),K0[0])}function Mc(n){return K0.map((t)=>u2(ot(n),t))}function V0(n){return u2(process.env.XDG_CACHE_HOME||u2(n,".cache"),"opencode","packages",R0)}function I1(n){Kc(V0(n),{recursive:!0,force:!0})}async function A0(n){let t=u2(V0(n),"node_modules",bt),r=u2(t,"package.json");if(!P1(r))throw Error(`The OpenCode plugin cache at ${t} is missing its package, so OpenCode would load nothing and fail open. Run \`opencode plugin -g -f ${R0}\` for details.`);let e=x(JSON.parse(W0(r,"utf-8")),"main");if(typeof e!=="string")throw Error(`The cached OpenCode plugin at ${t} declares no "main" entry.`);let a=u2(t,e);if(typeof(await import(Vc(a).href))[H0]==="function")return;throw Error(`The cached OpenCode plugin at ${a} does not export a callable ${H0}, so OpenCode would load nothing and fail open.`)}function ft(n,t){if(n[t]==="/"&&n[t+1]==="/"){let r=n.indexOf(`
`,t+2);return r===-1?n.length:r+1}if(n[t]==="/"&&n[t+1]==="*"){let r=n.indexOf("*/",t+2);return r===-1?n.length:r+2}return t}function S0(n,t){let r=t;while(r<n.length){if(/\s/.test(n[r]??"")){r++;continue}let e=ft(n,r);if(e===r)return r;r=e}return r}function M0(n,t){let r=t+1,e=!1;while(r<n.length){if(e){e=!1,r++;continue}if(n[r]==="\\"){e=!0,r++;continue}if(n[r]==='"')return r+1;r++}throw Error("Unterminated string in OpenCode config")}function G0(n,t,r){return JSON.parse(n.slice(t,r))}function Gc(n,t){return vt(n,t,{skipComment:ft,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function Uc(n){let t=0,r=0;while(r<n.length){let e=ft(n,r);if(e!==r){r=e;continue}if(n[r]==='"'){let a=M0(n,r);if(t===1&&G0(n,r,a)==="plugin"){let l=S0(n,a),d=S0(n,l+1);if(n[l]===":"&&n[d]==="[")return{start:d,end:Gc(n,d)}}r=a;continue}if(n[r]==="{"||n[r]==="[")t++;if(n[r]==="}"||n[r]==="]")t--;r++}return}function Cc(n,t){let r=[],e=t.start+1;while(e<t.end){let a=ft(n,e);if(a!==e){e=a;continue}if(n[e]==='"'){let l=M0(n,e),d=G0(n,e,l);if(typeof d==="string"&&d.includes(bt))r.push({start:e,end:l});e=l;continue}e++}return r}function U0(n,t){try{return JSON.parse(M(n))}catch(r){if(r instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${r.message}`);throw r}}function Oc(n){if(!n||typeof n!=="object"||Array.isArray(n))return!1;let t=n.plugin;if(!Array.isArray(t))return!1;return t.some((r)=>typeof r==="string"&&r.includes(bt))}function Tc(n,t){let r=Uc(n);if(!r)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let e=[...Cc(n,r)].reverse().reduce(ut,n);return U0(e,t),e}function C0(n){I1(n);let t=Mc(n),r=t.find((a)=>P1(a)),e=[];for(let a of t){if(!P1(a))continue;try{let l=W0(a,"utf-8");if(!Oc(U0(l,a)))continue;return Q(a,Tc(l,a)),{path:a,alreadyInstalled:!0}}catch(l){e.push(l instanceof Error?l.message:String(l))}}if(e.length>0)throw Error(e.join(`
`));return{path:r??Ac(n),alreadyInstalled:!1}}function O0(n){let t=[],r=ot(n.homeDir),e=["opencode.json","opencode.jsonc"];for(let a of e){let l=Pc(r,a);if(_c(l))try{let d=Ec(l,"utf-8"),s=M(d);if((JSON.parse(s).plugin??[]).some((v)=>v.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:l,errors:t.length>0?t:void 0}}catch(d){t.push(`Failed to parse ${a}: ${d instanceof Error?d.message:String(d)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as Ic}from"node:path";function N1(n){return Ic(n,".pi","agent","settings.json")}function nr(n){if(typeof n!=="string")return!1;return n==="npm:cc-safety-net"||n.startsWith("npm:cc-safety-net@")}function T0(n){let t=N1(n.homeDir),r=r2(t);if(r.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(r.kind==="missing")return{platform:"pi",status:"n/a"};let e=x(r.value,"packages");if(!Array.isArray(e))return{platform:"pi",status:"n/a"};let a=e.find((s)=>nr(typeof s==="string"?s:x(s,"source")));if(a===void 0)return{platform:"pi",status:"n/a"};let l=x(a,"extensions");if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var ni={amp:Ya,"antigravity-cli":Ha,"claude-code":Ka,codex:Va,"copilot-cli":Ia,cursor:d0,"gemini-cli":s0,"hermes-agent":w0,"kimi-code":Zn,openclaw:Q0,opencode:O0,pi:T0};function an(n,t){let r={...t,cwd:n,homeDir:t?.homeDir??Nc()};return On.map((e)=>ti(ni[e](r)))}function ti(n){if(n.status==="not-inspected")return{platform:n.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:n.platform,detected:n.status!=="n/a",configured:n.status==="configured",inspectionStatus:n.status!=="n/a"?"verified":n.errors&&n.errors.length>0?"failed":"not-applicable",method:n.method,configPath:n.configPath,configPaths:n.configPaths,errors:n.errors}}import{tmpdir as ri}from"node:os";import{join as ei}from"node:path";var ai=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),li=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([]),allowPaths:Object.freeze([])})})}),di={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}}};function _0(){let n=ei(ri(),"cc-safety-net-self-test"),t=ai.map((r)=>{let e=Un(C2("self-test",{command:r.command},{kind:"command",shell:"auto"},{configCwd:n,executionCwd:n},r.command),{guard:{dependencies:{loadPolicySnapshot:()=>li,getModes:()=>di,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),a=r.expectBlocked?"blocked":"allowed",l=e.decision.kind==="deny"?"blocked":"allowed";return{command:r.command,description:r.description,expected:a,actual:l,passed:a===l,reason:e.decision.kind==="deny"?e.decision.reason:void 0,ruleId:e.decision.kind==="deny"?e.decision.ruleId:void 0}});return{passed:t.filter((r)=>r.passed).length,failed:t.filter((r)=>!r.passed).length,total:t.length,results:t}}function tr(n){let t=J({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},n);if(d2(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function E0(n={}){let t=await zn(!n.json,()=>{let r=si(n);return{ready:r,finish:()=>r}},()=>jn(),{loadingMessage:"Checking system status…"});if(n.json)console.log(JSON.stringify(t,null,2));else ci(t);return Li(t.hooks,t.engineSelfTest,{userConfig:t.userConfig,projectConfig:t.projectConfig})?1:0}async function si(n){let t=n.cwd??process.cwd(),r=await kn(),e=an(t,{ampPluginListOutput:r.ampPluginListOutput,codexPluginListOutput:r.codexPluginListOutput,copilotCliVersion:r.versions["copilot-cli"]}),a=la(t),l=da(),d=A({cwd:t}),s=d.policy,L=c2(s),c=k2(s,L.capabilities),i=En(7),v=n.skipUpdateCheck?{currentVersion:B(),latestVersion:null,updateAvailable:!1}:await I2(),b={hooks:e,engineSelfTest:_0(),userConfig:a.userConfig,projectConfig:a.projectConfig,configState:xn(d),effectiveRules:a.effectiveRules,shadowedRules:a.shadowedRules,environment:l,effectiveSafety:{selectedPreset:s.safety.level??"standard",level:L.effectiveLevel,capabilities:L.capabilities,ruleOverrides:s.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(c).filter(([,p])=>p.source==="rule_override"&&p.override==="off"&&p.inheritedEnabled&&p.changesInherited).map(([p])=>p),ruleCounts:{stored:Object.keys(s.destructiveCommandRuleOverrides).length,effective:Object.values(c).filter((p)=>p.changesInherited).length}},posture:xa(a.userConfig.path),activity:i,update:v,system:r};return{...b,findings:La(b)}}function Li(n,t,r){return n.length>0&&n.every((e)=>!e.configured)||n.some((e)=>e.inspectionStatus==="failed")||t.failed>0||r.userConfig.exists&&!r.userConfig.valid||r.projectConfig.exists&&!r.projectConfig.valid}function ci(n){console.log(),console.log(ia(n.hooks)),console.log(),console.log(pa(n.engineSelfTest)),console.log(),console.log(va(n)),console.log(),console.log(ua(n.environment)),console.log(),console.log(ba(n)),console.log(),console.log(oa(n.findings)),console.log(),console.log(fa(n.activity)),console.log(),console.log(ya(n.system)),console.log(),console.log(ha(n.update)),console.log(wa(n))}import{existsSync as ii}from"node:fs";var pi=/^[A-Za-z0-9_@%+=:,./-]+$/,P0="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function rr(n){let t=J({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},n);if(d2(t.errors))return console.error(P0),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!ii(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let r=t.positionals.length===1?t.positionals[0]:t.positionals.map((e)=>pi.test(e)?e:`'${e.replaceAll("'","'\\''")}'`).join(" ");if(!r)return console.error("Error: No command provided"),console.error(P0),null;return{json:t.flags.json,cwd:t.values.cwd,command:r}}function I0(n){if(n)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function N0(n,t){let e=t-18;return[`${n.dtl}${n.dh.repeat(t)}${n.dtr}`,`${n.dv}  Command Analysis${" ".repeat(e)}${n.dv}`,`${n.dbl}${n.dh.repeat(t)}${n.dbr}`]}function er(n){return JSON.stringify(n)}function n3(n,t=0){return`[${n.map((e,a)=>ca(e,a,t)).join(",")}]`}function ht(n,t,r=70){let e=n.split(" "),a=[],l="";for(let d of e)if(l&&l.length+d.length+1>r)a.push(l),l=d;else l=l?`${l} ${d}`:d;if(l)a.push(l);return a.map((d,s)=>s===0?d:`${t}${d}`)}function t3(n,t,r){let e=[];switch(n.type){case"parse":return null;case"env-strip":return e.push(""),e.push(`STEP ${t} ${r.h} Strip environment variables`),e.push(`  Removed: ${n.envVars.map((a)=>`${a}=<redacted>`).join(", ")}`),e.push(`  Tokens:  ${er(n.output)}`),{lines:e,incrementStep:!0};case"leading-tokens-stripped":return e.push(""),e.push(`STEP ${t} ${r.h} Strip wrappers`),e.push(`  Removed: ${n.removed.join(", ")}`),e.push(`  Tokens:  ${er(n.output)}`),{lines:e,incrementStep:!0};case"shell-wrapper":return e.push(""),e.push(`STEP ${t} ${r.h} Detect shell wrapper`),e.push(`  Wrapper: ${n.wrapper} -c`),e.push(`  Inner:   ${n.innerCommand}`),{lines:e,incrementStep:!0};case"interpreter":{if(e.push(""),e.push(`STEP ${t} ${r.h} Detect interpreter`),e.push(`  Interpreter: ${n.interpreter}`),e.push(`  Code:        ${n.codeArg}`),n.paranoidBlocked)e.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:e,incrementStep:!0}}case"busybox":return e.push(""),e.push(`STEP ${t} ${r.h} Busybox wrapper`),e.push(`  Subcommand: ${n.subcommand}`),{lines:e,incrementStep:!0};case"transparent-wrapper":return e.push(""),e.push(`STEP ${t} ${r.h} Transparent wrapper`),e.push(`  Wrapper: ${n.wrapper}`),e.push(`  Tokens:  ${er(n.output)}`),{lines:e,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{if(e.push(""),e.push(`STEP ${t} ${r.h} Match rules`),e.push(`  Rule:   ${n.rule}()`),n.matched)e.push("  Result: MATCHED");else e.push("  Result: No match");return{lines:e,incrementStep:!0}}case"worktree-relaxation":return e.push(""),e.push(`STEP ${t} ${r.h} Worktree relaxation`),e.push(`  Mode:   ${k.worktree.name}`),e.push(`  Git cwd: ${n.gitCwd}`),e.push("  Result: Allowed local discard in linked worktree"),{lines:e,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(n.embeddedCommandFound)return e.push(""),e.push(`STEP ${t} ${r.h} Fallback scan`),e.push(`  Found: ${n.embeddedCommandFound}`),{lines:e,incrementStep:!0};return null}case"custom-rules-check":{if(n.rulesChecked){if(e.push(""),e.push(`STEP ${t} ${r.h} Custom rules`),n.matched)e.push("  Result: MATCHED");else e.push("  Result: No match");return{lines:e,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(n.matched)return e.push(""),e.push(`STEP ${t} ${r.h} Dangerous text check`),e.push(`  Token:  ${n.token}`),e.push("  Result: MATCHED"),{lines:e,incrementStep:!0};return null}case"strict-unparseable":return e.push(""),e.push(`STEP ${t} ${r.h} Strict mode check`),e.push(`  Command: ${n.rawCommand}`),e.push("  Result:  ✗ UNPARSEABLE"),{lines:e,incrementStep:!0};case"segment-skipped":return null;case"error":return e.push(""),e.push(`ERROR: ${n.message}`),{lines:e,incrementStep:!1};default:return null}}function ar(n,t){let r=I0(t?.asciiOnly??!1),e=58,a=[],l=1;a.push(...N0(r,58)),a.push("");let d=n.trace.steps.find((p)=>p.type==="error");if(d&&d.type==="error"){a.push("ERROR"),a.push(`  ${d.message}`),a.push(""),a.push("RESULT"),a.push(`  Status: ${n.result==="blocked"?o.red("BLOCKED"):o.green("ALLOWED")}`),a.push(""),a.push("CONFIG");let p=n.configSource??"none";return a.push(`  Path: ${p}`),a.join(`
`)}let s=n.trace.steps.find((p)=>p.type==="parse");if(s&&s.type==="parse"){a.push("INPUT"),a.push(`  ${s.input}`),a.push(""),a.push(`STEP ${l} ${r.h} Split shell commands`),l++;for(let p=0;p<s.segments.length;p++){let f=s.segments[p];if(f){let u=Math.random();a.push(`  Segment ${p+1}: ${n3(f,u)}`)}}}let L=n.trace.segments,c=L.length>1;for(let p of L){if(c){a.push("");let w="";if(s&&s.type==="parse"){let St=s.segments[p.index];if(St)w=St.join(" ")}let $=54,h=w,g=` Segment ${p.index+1}: `,S=" ";if(w){if(g.length+w.length+S.length>$){let Ml=$-g.length-S.length;h=`${w.substring(0,Ml-1)}…`}}let o2=w?`${g}${h}${S}`:` Segment ${p.index+1} `,Ht=w?`${g}${o.cyan(h)}${S}`:o2,zr=58-o2.length,Fr=Math.floor(zr/2),Al=zr-Fr;a.push(`${r.sh.repeat(Fr)}${Ht}${r.sh.repeat(Al)}`)}if(p.steps.find((w)=>w.type==="segment-skipped")){a.push(""),a.push("  (skipped — prior segment blocked)");continue}let u=!1,y=!1;for(let w of p.steps){let $=t3(w,l,r);if($){if(y=!0,w.type==="recurse"){a.push("");let h=" RECURSING ",g=58-h.length-4;a.push(`  ${r.tl}${r.h}${h}${r.h.repeat(g)}`),a.push(`  ${r.v}`),u=!0;continue}for(let h of $.lines)if(u)a.push(`  ${r.v} ${h}`);else a.push(h);if($.incrementStep)l++}}if(u)a.push(`  ${r.v}`),a.push(`  ${r.bl}${r.h.repeat(56)}`),u=!1;if(!y)a.push(""),a.push(`  ${o.green("✓")} Allowed (no matching rules)`)}if(a.push(""),a.push("RESULT"),n.result==="blocked"){if(a.push(`  Status: ${o.red("BLOCKED")}`),n.customRule){if(a.push(`  Rule: ${n.customRule.id}`),n.customRule.rulebook)a.push(`  Rulebook: ${n.customRule.rulebook.name} ${n.customRule.rulebook.version}`);if(n.customRule.source)a.push(`  Source: ${n.customRule.source}`);if(n.customRule.override)a.push(`  Override: reason ${n.customRule.override.reason}`)}if(n.reason){let p=ht(n.reason,"          ");a.push(`  Reason: ${p[0]}`);for(let f=1;f<p.length;f++)a.push(p[f]??"")}}else a.push(`  Status: ${o.green("ALLOWED")}`);a.push(""),a.push("CONFIG");let i=n.configSource??"none",v=n.configValid?"":" (invalid)";a.push(`  Path: ${i}${v}`),a.push(`  Safety preset: ${n.selectedPreset??"standard"}`),a.push(`  Effective capabilities: ${n.effectiveLevel}`);let b=Object.entries(n.destructiveCommandRuleOverrides??{});if(a.push(`  Rule customizations: ${b.length}`),n.ruleActivation)a.push(`  Rule activation: ${n.ruleActivation.id} — ${n.ruleActivation.enabled?"on":"off"} via ${n.ruleActivation.source}`);return a.join(`
`)}function lr(n){return JSON.stringify(n,null,2)}function r3(n){return new Promise((t)=>{process.stdout.write(`${n}
`,()=>t())})}async function e3(n){let t=rr(n);if(!t)return 1;try{let r=O2(t.command,{cwd:t.cwd}),e=!!process.env.NO_COLOR||!process.stdout.isTTY;return await r3(t.json?lr(r):ar(r,{asciiOnly:e})),0}catch(r){if(!(r instanceof s1)&&!(r instanceof m2)&&!(r instanceof p2))throw r;if(t.json)return await r3(JSON.stringify({error:r.message})),1;return console.error(r.message),1}}var a3="2.0.8",O="  ",Z2="cc-safety-net";function l3(n){return n.argument?`${n.flags} ${n.argument}`:n.flags}function vi(n){return Math.max(...n.map((t)=>l3(t).length))}function ui(n){return Math.max(...n.map((t)=>t.usage.length))}function bi(n){return Math.max(...n.map((t)=>`${Z2} ${t.usage}`.length))}function oi(n,t){let r=`${Z2} ${n.usage}`;return`${O}${r.padEnd(t+2)}${n.description}`}function b2(n,t){return`${O}${n.padEnd(Math.max(40,n.length+2))}${t}`}function yt(n,t=console.log){let r=[];if(r.push(`${Z2} ${n.name}`),r.push(""),r.push(`${O}${n.description}`),r.push(""),r.push("USAGE:"),r.push(`${O}${Z2} ${n.usage}`),r.push(""),n.subcommands&&n.subcommands.length>0){r.push("SUBCOMMANDS:");let e=ui(n.subcommands);for(let a of n.subcommands)r.push(`${O}${a.usage.padEnd(e+2)}${a.description}`);r.push("")}if(n.options.length>0){r.push("OPTIONS:");let e=vi(n.options);for(let a of n.options){let l=l3(a),d=a.default?`${a.description} (default: ${a.default})`:a.description;r.push(`${O}${l.padEnd(e+2)}${d}`)}r.push("")}if(n.examples&&n.examples.length>0){r.push("EXAMPLES:");for(let e of n.examples)r.push(`${O}${e}`)}t(r.join(`
`))}function dr(){let n=bi(Tn),t=[];t.push(`${Z2} v${a3}`),t.push(""),t.push("Blocks destructive commands and secret access."),t.push(""),t.push("COMMANDS:");for(let r of Tn)t.push(oi(r,n));t.push(""),t.push("GLOBAL OPTIONS:"),t.push(`${O}-h, --help       Show help (use with command for command-specific help)`),t.push(`${O}-V, --version    Show version`),t.push(""),t.push("HELP:"),t.push(`${O}${Z2} help <command>     Show help for a specific command`),t.push(`${O}${Z2} <command> --help   Show help for a specific command`),t.push(""),t.push("ENVIRONMENT VARIABLES:"),t.push(b2(`${k.level.name}=standard|strict|paranoid`,"Set session safety level")),t.push(b2(`${k.worktree.name}=1`,"Allow local git discards in linked worktrees")),t.push(b2(`${k.debug.name}=1`,"Print diagnostic messages to stderr")),t.push(b2(`${k.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),t.push(b2("CC_SAFETY_NET_HOME","Override rule config home directory")),t.push(""),t.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),t.push(b2(`${k.strict.name}=1`,"Force safety.overrides.fail_closed on")),t.push(b2(`${k.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),t.push(b2(`${k.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),t.push(b2(`${k.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),t.push(""),t.push("Documentation:        https://ccsafetynet.com/docs"),console.log(t.join(`
`))}function d3(){console.log(a3)}function Yn(n,t=console.log){let r=_n(n);if(!r)return!1;if(r.name.toLowerCase()!==n.toLowerCase())return!1;return yt(r,t),!0}import{existsSync as yr,readFileSync as P3}from"node:fs";import{homedir as L5}from"node:os";import{join as fr}from"node:path";import*as w2 from"node:readline";function fi(n){return n==="install"?"Install":"Uninstall"}function hi(n){return n==="install"?"Installing":"Uninstalling"}function yi(n){return n==="install"?"into":"from"}function c3(n){return n?.available===!0}function wi(n,t){let r=new Set(t);return n.filter((e)=>r.has(e.target)).map((e)=>e.target)}function s3(n,t,r){if(n.length===0||n.every((e)=>!e.available))return t;return Array.from({length:n.length},(e,a)=>a+1).map((e)=>(t+e*r+n.length)%n.length).find((e)=>c3(n[e]))}function xi(n,t,r){if(r.ctrl&&r.name==="c")return"interrupt";if(r.name==="escape"||t==="q")return"abort";if(n==="install"&&(t==="u"||t==="U"))return"update";if(r.name==="up"||t==="k")return"up";if(r.name==="down"||t==="j")return"down";if(r.name==="space"||t===" ")return"toggle";if(r.name==="return"||r.name==="enter")return"confirm";return null}function $i(n){return{cursor:n.findIndex((t)=>t.available),selected:[]}}function Di(n,t,r){if(r==="confirm"||r==="update"||r==="abort"||r==="interrupt")return{state:n,done:r};if(r==="up")return{state:{...n,cursor:s3(t,n.cursor,-1)}};if(r==="down")return{state:{...n,cursor:s3(t,n.cursor,1)}};let e=t[n.cursor];if(!c3(e))return{state:n};let a=n.selected.includes(e.target)?n.selected.filter((l)=>l!==e.target):wi(t,[...n.selected,e.target]);return{state:{...n,selected:a}}}var i3="◉",p3="◯",v3=">",u3=" ";function gi(n,t,r,e={}){let a=e.color!==!1,l=a?o.dim:(L)=>L,d=a?o.green:(L)=>L,s=a?o.bold:(L)=>L;return["",`${fi(n)} CC Safety Net ${yi(n)}:`,"",...t.map((L,c)=>{let i=r.selected.includes(L.target),v=c===r.cursor,b=i?i3:p3,p=v?v3:u3,f=L.available?"":` (${L.unavailableReason??"not installed"})`,u=`${b} ${L.label}${f}`,y=!L.available?l(u):i?d(u):v?s(u):u;return`${p} ${y}`}),"",n==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((L)=>L.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${n}. q/Esc: close`].join(`
`)}var L3=["global-hook","plugin"];function mi(n,t,r={}){let e=r.color!==!1?o.bold:(l)=>l;return["","Install the Kimi Code integration as:","",...[`Global hook — ${t?"already installed; selecting it reports the current state":"write the hook into ~/.kimi-code/config.toml now"}`,"Native Kimi plugin — print the steps to run inside Kimi Code"].map((l,d)=>{let s=d===n,L=`${s?i3:p3} ${l}`;return`${s?v3:u3} ${s?e(L):L}`}),"","Enter: confirm  Up/Down: move  q/Esc: cancel"].join(`
`)}function b3(n){let{input:t,output:r}=n;w2.emitKeypressEvents(t);let e=t.isRaw===!0;t.setRawMode(!0),t.resume();let a=0,l=()=>{if(a===0)return;w2.moveCursor(r,0,-a),w2.cursorTo(r,0),w2.clearScreenDown(r)},d=()=>{l();let s=n.render();r.write(`${s}
`),a=s.split(`
`).length};return new Promise((s)=>{let L=(i)=>{t.off("keypress",c),t.setRawMode(e),t.pause(),l(),s(i)};function c(i,v){n.onKey(i,v,{finish:L,draw:d})}t.on("keypress",c),d()})}function o3(n={}){let t=0;return b3({input:n.input??process.stdin,output:n.output??process.stdout,render:()=>mi(t,n.globalHookInstalled===!0),onKey:(r,e,a)=>{if(e.ctrl&&e.name==="c"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(e.name==="escape"||r==="q")return a.finish(null);if(e.name==="return"||e.name==="enter")return a.finish(L3[t]);if(e.name==="up"||e.name==="down"||r==="k"||r==="j")t=(t+1)%L3.length,a.draw()}})}function sr(n=process.stdin,t=process.stdout){return Boolean(n.isTTY&&t.isTTY&&typeof n.setRawMode==="function")}function f3(n,t,r={}){let e=r.output??process.stdout,a=$i(t);return b3({input:r.input??process.stdin,output:e,render:()=>gi(n,t,a),onKey:(l,d,s)=>{let L=xi(n,l,d);if(!L)return;let c=Di(a,t,L);if(a=c.state,c.done==="interrupt"){s.finish(null),(r.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(c.done==="abort")return s.finish(null);if(c.done==="update")return s.finish("update");if(c.done==="confirm"){if(a.selected.length===0){e.write("\x07"),s.draw();return}s.finish([...a.selected]),e.write(`${hi(n)} selected integrations...
`);return}s.draw()}})}import{existsSync as y3,lstatSync as qi,mkdirSync as ji,mkdtempSync as zi,readdirSync as Fi,readFileSync as dn,rmSync as $t}from"node:fs";import{tmpdir as Bi}from"node:os";import{basename as Ji,dirname as Zi,join as K}from"node:path";import{fileURLToPath as Qi}from"node:url";var Lr="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp",Q2="cc-safety-net",X2="cc-safety-net/index.ts";import{spawn as ki}from"node:child_process";var cr=(n,t)=>{let r=F2([...n],process.env);return new Promise((e)=>{let a=ki(r.cmd,r.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),l=U1(a),d=!1,s=setTimeout(()=>{d=!0,a.kill()},120000);a.on("error",(L)=>{clearTimeout(s),e({status:null,errorCode:L.code,stdout:l.stdout,stderr:[L.message,l.stderr].filter(Boolean).join(`
`)})}),a.on("close",(L)=>{clearTimeout(s),e({status:d?null:L,errorCode:d?"ETIMEDOUT":void 0,stdout:l.stdout,stderr:l.stderr})})})};var ln="cc-safety-net.ts",h3=K("amp",X2);function Xi(n){return K(n,".config","amp","plugins","cc-safety-net.ts")}function Yi(){let n=Zi(Qi(import.meta.url));return[K(n,"..",h3),K(n,"..","..","..","dist",h3)]}function Hi(n=Yi()){let t=n.find((r)=>y3(r)&&qi(r).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function w3(n){try{return JSON.parse(n)}catch{return}}function Dt(n){return n.subarray(0,Buffer.byteLength(Lr)).toString("utf-8")===Lr}async function Hn(n,t,r){let e=await n(t,r);if(e.status===0)return e;throw Error([`Failed to run ${t.join(" ")}${e.status===null?"":` (exit ${e.status})`}.`,[e.stdout,e.stderr].filter(Boolean).join(`
`).trim()].filter(Boolean).join(`
`))}async function x3(n){let t=await n(["amp","plugins","repositories","--json"]);if(t.status===null)throw Error(`${t.errorCode==="ENOENT"?'Amp CLI not found. Install the amp CLI, sign in with "amp login", and rerun install --amp.':`amp plugins repositories --json did not finish (${t.errorCode??"terminated"}). Check that the amp CLI responds and rerun install --amp.`}
...
`)}`.trim());let r=w3(t.stdout),e=(Array.isArray(r)?r:[]).filter((a)=>x(a,"scope")==="user"&&x(a,"exists")===!0&&x(a,"viewerCanWrite")===!0).map((a)=>x(a,"cloneRef")).find((a)=>typeof a==="string"&&a.length>0);if(!e)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return e}async function $3(n,t){let r=zi(K(Bi(),"cc-safety-net-amp-"));try{return await Hn(n,["amp","clone","user-plugins",r]),await t(r)}finally{$t(r,{recursive:!0,force:!0})}}function ir(n){return`rerun ${n==="overwrite"?"install":"uninstall"} --amp`}function D3(n,t,r){let e=K(n,t),a=F(e);if(!a)return;if(a.isSymbolicLink()||!a.isFile())throw Error(`Refusing to ${r} ${t} in your Amp personal plugins repository: not a regular file. Remove it there and ${ir(r)}.`);let l=dn(e);if(Dt(l))return l;throw Error(`Refusing to ${r} unmanaged file ${t} in your Amp personal plugins repository. Remove it there and ${ir(r)}.`)}function g3(n,t){let r=K(n,Q2),e=F(r);if(!e)return;if(e.isSymbolicLink()||!e.isDirectory())throw Error(`Refusing to ${t} ${Q2} in your Amp personal plugins repository: not a regular directory. Remove it there and ${ir(t)}.`);return D3(n,X2,t)}function Si(n){let t=K(n,ln),r=F(t);if(!r||r.isSymbolicLink()||!r.isFile())return;let e=dn(t);return Dt(e)?e:void 0}async function m3(n,t,r,e){if(await Hn(n,r,t),(await Hn(n,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await Hn(n,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",e],t),await Hn(n,["git","push","origin","HEAD"],t),!0}function wt(n,t){Wi(n,t),Ri(n,t)}function k3(n,t){if(t==="keep")return;throw Error(`Local Amp plugin ${n} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function Wi(n,t){let r=Xi(n),e=F(r);if(!e)return;if(!e.isSymbolicLink()&&e.isFile()&&Dt(dn(r))){$t(r);return}k3(r,t)}function Ri(n,t){let r=K(n,".config","amp","plugins",Q2),e=F(r);if(!e)return;if(!e.isSymbolicLink()&&e.isDirectory()&&Ki(r)){$t(r,{recursive:!0});return}k3(r,t)}function Ki(n){let t=Ji(X2);if(Fi(n).join("\x00")!==t)return!1;let r=K(n,t),e=F(r);return!!e&&!e.isSymbolicLink()&&e.isFile()&&Dt(dn(r))}function Vi(){let n=wn();if(!y3(n))return"";let t=w3(dn(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(xt(t))};
`}async function q3(n,t=Hi(),r=cr){let e=Buffer.concat([dn(t),Buffer.from(Vi(),"utf-8")]),a=await x3(r);return $3(r,async(l)=>{let d=`${a}/${Q2}`,s=g3(l,"overwrite"),L=D3(l,ln,"overwrite");if(s?.equals(e)&&!L)return wt(n,"fail"),{path:d,alreadyInstalled:!0};if(ji(K(l,Q2),{recursive:!0}),Q(K(l,X2),e),L)$t(K(l,ln));let c=await m3(r,l,["git","add","--",X2,...L?[ln]:[]],`chore: update cc-safety-net plugin to v${B()}`);return wt(n,"fail"),{path:d,alreadyInstalled:!c}})}async function j3(n,t=cr){let r=await x3(t);return $3(t,async(e)=>{let a=g3(e,"remove"),l=Si(e),d=`${r}/${l&&!a?ln:Q2}`;if(!a&&!l)return wt(n,"keep"),{path:d,alreadyInstalled:!1};return await m3(t,e,["git","rm","--",...a?[X2]:[],...l?[ln]:[]],`chore: remove cc-safety-net plugin v${B()}`),wt(n,"keep"),{path:d,alreadyInstalled:!0}})}import{existsSync as z3,mkdirSync as Ai,readFileSync as Mi}from"node:fs";import{dirname as Gi}from"node:path";var pr="npx -y cc-safety-net hook --agy-cli",x2="cc-safety-net";function mt(){return{PreToolUse:[{hooks:[{type:"command",command:pr,timeout:30}]}]}}function F3(n){try{let t=JSON.parse(Mi(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${n}: ${t.message}`);throw t}}function B3(n){let t=n[x2];if(t===void 0)return n[x2]=mt(),n[x2];if(!t||typeof t!=="object"||Array.isArray(t))throw Error(`Antigravity hooks config entry "${x2}" must be an object`);if(!Array.isArray(t.PreToolUse))t.PreToolUse=[];return t}function J3(n){if(!Array.isArray(n.PreToolUse))return!1;return n.PreToolUse.some((t)=>Array.isArray(t.hooks)&&t.hooks.some((r)=>r.command===pr))}function Ui(n){return Object.values(n).some((t)=>t.enabled!==!1&&J3(t))}function Ci(n){if(n[x2]===void 0)return!1;let t=B3(n);if(t.enabled!==!1||!J3(t))return!1;return t.enabled=!0,!0}function Oi(n){if(n[x2]===void 0){n[x2]=mt();return}let t=B3(n);t.PreToolUse??=[],t.enabled=!0,t.PreToolUse.push(mt().PreToolUse?.[0]??{hooks:[]})}function Ti(n){let t=!1;for(let r of Object.values(n)){if(!Array.isArray(r.PreToolUse))continue;r.PreToolUse=r.PreToolUse.flatMap((e)=>{if(!Array.isArray(e.hooks))return[e];let a=e.hooks.filter((l)=>l.command!==pr);if(a.length!==e.hooks.length)t=!0;return a.length===0?[]:[{...e,hooks:a}]})}return t}function gt(n,t){Q(n,`${JSON.stringify(t,null,2)}
`)}function Z3(n){let t=gn(n);if(Ai(Gi(t),{recursive:!0}),!z3(t))return gt(t,{[x2]:mt()}),{path:t,alreadyInstalled:!1};let r=F3(t);if(Ui(r))return{path:t,alreadyInstalled:!0};if(Ci(r))return gt(t,r),{path:t,alreadyInstalled:!1};return Oi(r),gt(t,r),{path:t,alreadyInstalled:!1}}function Q3(n){let t=gn(n);if(!z3(t))return{path:t,alreadyInstalled:!1};let r=F3(t);if(!Ti(r))return{path:t,alreadyInstalled:!1};return gt(t,r),{path:t,alreadyInstalled:!0}}import{spawn as _i}from"node:child_process";var l2=G.map((n)=>({target:n.id,flag:n.flag,label:j(n.id),probeCommand:n.probeCommand}));function vr(n){let t=new Set(n);return l2.map((r)=>r.target).filter((r)=>t.has(r))}async function X3(n,t){for(let r of n)await t(r)}var Ei=5000;function ur(n){return new Promise((t)=>{let r=F2([...n],process.env),e=_i(r.cmd,r.args,{env:process.env,stdio:"ignore"}),a=!1,l=(s)=>{if(a)return;a=!0,clearTimeout(d),t(s)},d=setTimeout(()=>{e.kill(),l(!1)},Ei);e.on("error",()=>l(!1)),e.on("close",(s)=>l(s===0))})}function Y3(n=ur,t={}){let r=new Set(t.configuredTargets??[]);return Promise.all(l2.map(async(e)=>({target:e.target,flag:e.flag,label:e.label,...S3(t.action,await n(e.probeCommand),r.has(e.target))})))}function H3(n,t){let r=new Set(t.configuredTargets??[]);return n.map((e)=>({...e,...S3(t.action,e.available,r.has(e.target))}))}function S3(n,t,r){if(n==="uninstall")return r?{available:!0}:{available:!1,unavailableReason:"not installed"};if(n==="install"&&r)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as W3,readdirSync as Pi,rmSync as Ii}from"node:fs";import{join as sn}from"node:path";function kt(n,t=process.platform){let r=sn(process.env.npm_config_cache||(t==="win32"?sn(process.env.LOCALAPPDATA||sn(n,"AppData","Local"),"npm-cache"):sn(n,".npm")),"_npx");if(!W3(r))return;Pi(r).filter((e)=>W3(sn(r,e,"node_modules","cc-safety-net"))).forEach((e)=>{Ii(sn(r,e),{recursive:!0,force:!0})})}import{existsSync as K3,mkdirSync as Ni,readFileSync as V3}from"node:fs";import{dirname as n5,join as R3}from"node:path";var Sn="npx -y cc-safety-net hook --kimi-code",br=`[[hooks]]
event = "PreToolUse"
command = "${Sn}"`,or=`{ event = "PreToolUse", command = "${Sn}" }`;function A3(n){return R3(process.env.KIMI_CODE_HOME??R3(n,".kimi-code"),"config.toml")}function t5(n){return n.split(`
...
`)}function r5(n,t){if(n[t]!=="#")return t;let r=n.indexOf(`
`,t+1);return r===-1?n.length:r+1}function e5(n,t){return vt(n,t,{skipComment:r5,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function M3(n){let t=!1,r=0;while(r<n.length){let e=n.indexOf(`
`,r),a=e===-1?n.length:e,l=n.slice(r,a);if(/^\s*\[/.test(l))t=!0;if(!t){let d=/^(\s*)hooks\s*=\s*\[/.exec(l);if(d){let s=r+d[0].lastIndexOf("[");return{start:s,end:e5(n,s)}}}r=e===-1?n.length:e+1}return}function a5(n,t){let r=n.slice(0,t.end).trimEnd(),e=Y0(n,t.end),a=e===""?"     ":`${e}  `,l=!r.endsWith("[")&&!r.endsWith(",");return`${r}${l?",":""}
${a}${or}${n.slice(t.end)}`}function l5(n){let t=M3(n);if(t&&n.slice(t.start+1,t.end).trim())return a5(n,t);let r=t5(n).trimEnd();if(r==="")return`${br}
`;return`${r}

${br}
`}function d5(n){return n.split(/(?=^\s*\[)/m).filter((r)=>!/^\s*\[\[hooks]]\s*$/m.test(r)||!r.includes(Sn)).join("").trimEnd()}function s5(n,t){let r=n.indexOf(or,t.start);if(r===-1||r>t.end)return n;return ut(n,{start:r,end:r+or.length})}function G3(n){let t=A3(n);if(Ni(n5(t),{recursive:!0}),!K3(t))return Q(t,`${br}
`),{path:t,alreadyInstalled:!1};let r=V3(t,"utf-8");if(r.includes(Sn))return{path:t,alreadyInstalled:!0};return Q(t,l5(r)),{path:t,alreadyInstalled:!1}}function U3(n){let t=A3(n);if(!K3(t))return{path:t,alreadyInstalled:!1};let r=V3(t,"utf-8");if(!r.includes(Sn))return{path:t,alreadyInstalled:!1};let e=M3(r),a=e?s5(r,e):`${d5(r)}
`;return Q(t,a),{path:t,alreadyInstalled:!0}}var hr="safety-net@cc-marketplace",C3=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]),O3=new Set(["antigravity-cli","cursor","hermes-agent","kimi-code"]);function wr(n){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(n??"")}function I3(n){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(n??"")}function c5(n){return/^Marketplace `cc-marketplace`\s*$/m.test(n??"")}var N3={"claude-code":{installCommands:(n)=>{let t=et(n,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...F1(n).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:et(n,hr)?[["claude","plugin","uninstall",hr]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:async(n,t)=>{let r=t??await a2(["codex","plugin","list"]),e=I3(r);return{commands:[e||c5(r)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:wr(r)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:e}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:async()=>{let n=await a2(["copilot","plugin","list"]),t=[...Oa(n)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...Ta(n)?[["copilot","plugin","uninstall",Ga]]:[]];if(Ua(n))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",e2]],cleanupCommands:t,update:!0};return{commands:[Ca(await a2(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",e2]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(n)=>{let t=H1(n);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:_1,installCommands:()=>({commands:j0()}),uninstallCommands:[["openclaw","plugins","uninstall",z,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:I1,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function zt(){return process.env.HOME??L5()}function nl(n,t=(r)=>r){try{let r=JSON.parse(t(P3(n,"utf-8")));if(!r||typeof r!=="object"||Array.isArray(r))throw Error(`Settings file ${n} must be a JSON object`);return r}catch(r){if(r instanceof SyntaxError)throw Error(`Failed to parse ${n}: ${r.message}`);throw r}}function i5(n){let t=fr(Fn(n),"settings.json");if(!yr(t))return;let r=nl(t,M),e=r.enabledPlugins;if(!e||typeof e!=="object"||Array.isArray(e))return;if(e[e2]!==!1)return;let a=P3(t,"utf-8"),l=a.replace(new RegExp(`("${e2}"\\s*:\\s*)false`),"$1true");return e[e2]=!0,Q(t,l!==a?l:`${JSON.stringify(r,null,2)}
`),`Enabled ${e2} plugin in ${t}`}function p5(n){let t=N1(n);if(!yr(t))return;let r=nl(t);if(!Array.isArray(r.packages))return;let e=r.packages.find((a)=>!!a&&typeof a==="object"&&!Array.isArray(a)&&nr(a.source)&&("extensions"in a));if(!e)return;return delete e.extensions,Q(t,`${JSON.stringify(r,null,2)}
`),`Enabled npm:cc-safety-net extensions in ${t}`}function T3(n,t){let r=J({label:t,booleans:Object.fromEntries(l2.map((l)=>[l.target,[l.flag]]))},n),e=r.errors[0];if(e)throw Error(e);let a=l2.filter((l)=>r.flags[l.target]).map((l)=>l.target);if(a.length!==1)throw Error(`Choose exactly one ${t} target: ${l2.map((l)=>l.flag).join(", ")}`);return a[0]}async function tl(n=zt(),t=P2){let[r,e,a]=await Promise.all([t(["amp","plugins","list"],30000),t(["codex","plugin","list"],30000),t(["copilot","--binary-version"])]);return{codexPluginListOutput:e,hooks:an(process.cwd(),{homeDir:n,ampPluginListOutput:r,codexPluginListOutput:e,copilotCliVersion:a})}}async function v5(n,t=P2){let r=await tl(zt(),t);return r.hooks.filter((e)=>n==="install"?e.configured:e.detected||e.inspectionStatus==="not-inspected").filter((e)=>e.platform!=="codex"||!wr(r.codexPluginListOutput)||I3(r.codexPluginListOutput)).map((e)=>e.platform)}function u5(n,t,r){if(t.length>0)return{finish:async()=>[T3(t,n)]};if(!r.selectTargets&&!sr(r.input,r.output))return{finish:async()=>[T3(t,n)]};let e=r.detectConfiguredTargets??(()=>v5(n,r.fetchVersion)),a=Promise.all([Y3(r.probeTargets),e()]);return{ready:a,finish:async()=>{let[l,d]=await a,s=H3(l,{action:n,configuredTargets:d}),L=r.selectTargets?await r.selectTargets(n,E3(n,s)):await f3(n,E3(n,s),{input:r.input,output:r.output});if(L==="update")return L;if(!L||L.length===0)return null;return vr(L)}}}async function Y2(n,t,r=!1,e){let a=N3[n];a.beforeInstall?.(t);let l=typeof a.installCommands==="function"?await a.installCommands(t,e):{commands:a.installCommands};return await C1(l.commands),await $0(l.cleanupCommands??[]),[`${l.update||r?"Updated":"Installed"} ${j(n)} integration`,a.postInstallMessage].filter(Boolean).join(`
`)}async function Ln(n){let t=N3[n];if(!t.uninstallCommands)throw Error(`${j(n)} uninstall is not supported`);return await C1(t.uninstallCommands),`Uninstalled ${j(n)} integration`}function b5(n){let t=C0(n);return t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`}var o5={"antigravity-cli":{install:Z3,uninstall:Q3},cursor:{install:a0,uninstall:l0},"kimi-code":{install:G3,uninstall:U3}};function cn(n,t,r,e=!1){if(n==="install"&&!e)kt(r);let a=o5[t][n](r),l=j(t),d=n!=="install"?"Uninstalled":e?"Updated":"Installed";return n==="install"&&a.alreadyInstalled?e?`${l} hook up to date in ${a.path}`:`${l} hook already installed in ${a.path}`:n==="uninstall"&&!a.alreadyInstalled?`${l} hook not installed in ${a.path}`:`${d} ${l} hook ${n==="install"?"in":"from"} ${a.path}`}var f5={amp:{install:q3,uninstall:j3,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:p0,uninstall:v0,afterInstall:async(n)=>{let t=M1(n);return await a2(["hermes","plugins","enable",U,"--no-allow-tool-override"]),!t},beforeUninstall:async(n)=>{A1(n);try{await a2(["hermes","plugins","disable",U])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
Removing the plugin files anyway; ${U} may still be listed in the Hermes config.`)}},restartNote:"Restart Hermes to apply the change."}};async function qt(n,t,r,e=!1){let a=f5[t];if(n==="uninstall")await a.beforeUninstall?.(r);let l=n==="install"?await a.install(r):await a.uninstall(r),d=n==="install"&&await a.afterInstall?.(r),s=j(t),L=!d&&(n==="install"&&l.alreadyInstalled||n==="uninstall"&&!l.alreadyInstalled);return[L?n==="install"?`${s} plugin ${e?"up to date":"already installed"} at ${l.path}`:`${s} plugin not installed at ${l.path}`:`${n!=="install"?"Uninstalled":e?"Updated":"Installed"} ${s} plugin ${n==="install"?"at":"from"} ${l.path}`,L?void 0:a.restartNote].filter(Boolean).join(`
`)}var h5={amp:{install:(n,t)=>qt("install","amp",n,t),uninstall:(n)=>qt("uninstall","amp",n)},"antigravity-cli":{install:(n,t)=>cn("install","antigravity-cli",n,t),uninstall:(n)=>cn("uninstall","antigravity-cli",n)},"claude-code":{install:(n,t)=>Y2("claude-code",n,t),uninstall:()=>Ln("claude-code")},codex:{install:(n,t,r)=>Y2("codex",n,t,r),uninstall:()=>Ln("codex")},"copilot-cli":{install:async(n,t)=>[await Y2("copilot-cli",n,t),i5(n)].filter(Boolean).join(`
`),uninstall:()=>Ln("copilot-cli")},cursor:{install:(n,t)=>cn("install","cursor",n,t),uninstall:(n)=>cn("uninstall","cursor",n)},"gemini-cli":{install:(n,t)=>Y2("gemini-cli",n,t),uninstall:()=>Ln("gemini-cli")},"hermes-agent":{install:(n,t)=>{if(!t)kt(n);return qt("install","hermes-agent",n,t)},uninstall:(n)=>qt("uninstall","hermes-agent",n)},"kimi-code":{install:(n,t)=>cn("install","kimi-code",n,t),uninstall:(n)=>cn("uninstall","kimi-code",n)},openclaw:{install:async(n,t)=>{let r=await Y2("openclaw",n,t);return await z0(),r},uninstall:(n)=>{return _1(n),Ln("openclaw")}},opencode:{install:async(n,t)=>{let r=await Y2("opencode",n,t);return await A0(n),r},uninstall:(n)=>b5(n)},pi:{install:async(n,t)=>[await Y2("pi",n,t),p5(n)].filter(Boolean).join(`
`),uninstall:()=>Ln("pi")}},_3=["Install CC Safety Net as a native Kimi Code plugin:","","  1. Start Kimi Code and run: /plugins install https://github.com/kenryu42/cc-safety-net","     Confirm the trust prompt; it defaults to cancel.","  2. Run /reload, or start a new session.","","Note: Kimi Code hooks are fail-open. When the hook process cannot start, crashes, or times","out, Kimi Code allows the tool call."].join(`
`);function y5(n){if(Zn({homeDir:n,cwd:process.cwd()}).status!=="configured")return _3;return[_3,"",o.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function E3(n,t){return t.map((r)=>n==="install"&&r.target==="kimi-code"&&r.unavailableReason==="already installed"?{...r,available:!0,unavailableReason:void 0,label:`${r.label} (global hook installed)`}:r)}function w5(n,t){if(n.selectKimiInstallMethod)return n.selectKimiInstallMethod();if(!sr(n.input,n.output))return Promise.resolve("global-hook");return o3({input:n.input,output:n.output,globalHookInstalled:Zn({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function rl(n,t,r,e=!1,a){return h5[t][n](r,e,a)}function x5(n){let t=J({label:"update"},n).errors[0];if(t)throw Error(t)}async function $5(n,t=P2){let r=await tl(n,t),e=fr(Fn(n),"installed-plugins");return{targets:vr([...r.hooks.filter((l)=>l.platform!=="copilot-cli"&&l.detected).map((l)=>l.platform),...[at,Ma,Aa].flatMap((l)=>yr(fr(e,...l))?["copilot-cli"]:[]),...et(n,hr)?["claude-code"]:[],...wr(r.codexPluginListOutput)?["codex"]:[]]),codexPluginListOutput:r.codexPluginListOutput}}async function D5(n){let t=zt(),r=n.output??process.stdout,e=$5(t,n.fetchVersion??P2).then(async(s)=>{let L=new Set(s.targets);return{targets:s.targets,codexPluginListOutput:s.codexPluginListOutput,available:new Map(await Promise.all(l2.filter((c)=>L.has(c.target)&&C3.has(c.target)).map(async(c)=>[c.target,await ur(c.probeCommand)])))}}),a=await zn(n.showBanner??!0,()=>({ready:e,finish:()=>e}),()=>jn({input:n.input??process.stdin,output:r}),{loadingMessage:"Checking installed integrations…",output:r});if(a.targets.length===0)return r.write("No installed integrations found. Run `cc-safety-net install` to set one up.\n"),0;let l=a.targets.some((s)=>O3.has(s))?await Promise.resolve().then(()=>{return kt(t),null}).catch((s)=>jt(s)):null,d=await nt(Promise.all(a.targets.map((s)=>{if(C3.has(s)&&!a.available.get(s))return Promise.resolve({message:`${j(s)} not found; skipped`,failed:!1});if(l!==null&&O3.has(s))return Promise.resolve({message:l,failed:!0});return rl("install",s,t,!0,a.codexPluginListOutput).then((L)=>({message:L,failed:!1}),(L)=>({message:jt(L),failed:!0}))})),{loadingMessage:`Updating ${a.targets.length} integration${a.targets.length===1?"":"s"}…`,output:r});return d.forEach((s)=>{s.failed?console.error(s.message):r.write(`${s.message}
`)}),d.some((s)=>s.failed)?1:0}function xr(n,t={}){return Promise.resolve().then(()=>x5(n)).then(()=>D5(t)).catch((r)=>{return console.error(jt(r)),1})}async function Wn(n,t,r={}){try{let e=await zn(!0,()=>u5(n,t,r),()=>jn({input:r.input??process.stdin,output:r.output??process.stdout}),{loadingMessage:n==="install"?"Checking available integrations…":"Checking installed integrations…",output:r.output??process.stdout});if(!e)return(r.output??process.stdout).write(`Cancelled: nothing was ${n}ed.
`),0;if(e==="update")return(r.runUpdate??(()=>xr([],{fetchVersion:r.fetchVersion,input:r.input,output:r.output,showBanner:!1})))();let a=zt(),l=r.output??process.stdout;return await X3(e,async(d)=>{if(d==="kimi-code"&&n==="install"){let L=await w5(r,a);if(L===null){l.write(`Cancelled: Kimi Code integration was not installed.
`);return}if(L==="plugin"){l.write(`${y5(a)}
`);return}}let s=await nt(rl(n,d,a),{loadingMessage:`${n==="install"?"Installing":"Uninstalling"} ${j(d)} integration…`,output:l});l.write(`${s}
`)}),0}catch(e){return console.error(jt(e)),1}}function jt(n){let t=n instanceof Error?n.message:String(n),r=typeof n==="object"&&n!==null&&"code"in n?n.code:null;if(r==="EACCES"||r==="EPERM")return`${t}
...
Check that every parent path component is a directory.`;return t}import{join as d8}from"node:path";var el="# Custom Rules Reference\n\nAgent reference for generating CC Safety Net rulebook configuration.\n\n## Config Locations\n\n| Scope | Config path | Rulebook path | Cache path | Priority |\n|-------|-------------|---------------|------------|----------|\n| User | `~/.cc-safety-net/rules/rule.json` | `~/.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `~/.cc-safety-net/cache/rulebooks/` | First |\n| Project | `.cc-safety-net/rules/rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `.cc-safety-net/cache/rulebooks/` | Second |\n| GitHub source | Listed in a local `rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` in the source repository | Consumer local cache | Source order |\n\nUser scope is evaluated before project scope; within a scope, sources apply in `rules` array order. A duplicate active rulebook name keeps the first claim and ignores the later rulebook with a warning, so a user-scoped name shadows a project-scoped one.\n\nUse `cc-safety-net rule init` to create an inert local config. Use `--global` for user scope. Use `cc-safety-net rule init --example` to also create an inactive example rulebook. `CC_SAFETY_NET_HOME` overrides the `~/.cc-safety-net` user root.\n\nLegacy inline `.safety-net.json` and `~/.cc-safety-net/config.json` files are not loaded at runtime. Convert them with `cc-safety-net rule migrate`.\n\n## rule.json Schema\n\n```json\n{\n  \"version\": 1,\n  \"rules\": [\"project-rules\", \"owner/repo#main/team-rules\"],\n  \"overrides\": {\n    \"project-rules/block-docker-system-prune\": {\n      \"reason\": \"Use targeted Docker cleanup commands.\"\n    },\n    \"team-rules/block-npm-global\": \"off\"\n  },\n  \"transparent_wrappers\": [\"rtk\"]\n}\n```\n\n- `version`: Required. Must be `1`.\n- `$schema`: Optional. `cc-safety-net rule verify` inserts it into a valid `rule.json` that lacks it.\n- `rules`: Optional array of rulebook source strings. Missing `rules` is treated as `[]`.\n- `overrides`: Optional object keyed by `<rulebook-name>/<rule-name>`.\n- `overrides` values are either `\"off\"` to disable a rule or an object with a required `reason` (replacement block reason) and an optional `intent` (one of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain`).\n- A project override cannot target a user-scoped rule: only that override is ignored, the user rule keeps its configured state, and `rule sync`/`rule verify` report the diagnostic as a failure.\n- `transparent_wrappers`: Optional array of command names that transparently execute a visible child command.\n- Transparent wrappers have no built-in defaults. Configure only wrappers you intentionally trust, such as `\"rtk\"`.\n- Use `cc-safety-net rule wrapper add rtk` to configure RTK without manually editing `rule.json`.\n\n## Rulebook Sources\n\n- Local sources are bare rulebook names such as `project-rules`; the rulebook file is `.cc-safety-net/rules/project-rules/rulebook.json`.\n- GitHub sources use `owner/repo#ref/<rulebook-name>`.\n- GitHub refs must be one path segment, such as a tag, SHA, or branch name without `/`.\n- The GitHub source name, the repository directory name, and the rulebook `name` must match exactly.\n- Rulebook source strings must be unique in a config.\n\n## rulebook.json Schema\n\n```json\n{\n  \"rulebook_version\": 1,\n  \"name\": \"project-rules\",\n  \"version\": \"1.0.0\",\n  \"description\": \"Project-specific CC Safety Net rules.\",\n  \"author\": \"project\",\n  \"allowed_commands\": [\"docker\"],\n  \"rules\": [\n    {\n      \"name\": \"block-docker-system-prune\",\n      \"command\": \"docker\",\n      \"subcommand\": \"system\",\n      \"block_args\": [\"prune\"],\n      \"reason\": \"Use targeted cleanup instead.\"\n    }\n  ],\n  \"tests\": [\n    {\n      \"command\": \"docker system prune\",\n      \"expect\": \"blocked\",\n      \"rule\": \"block-docker-system-prune\"\n    },\n    {\n      \"command\": \"docker ps\",\n      \"expect\": \"allowed\"\n    }\n  ]\n}\n```\n\n### Rulebook Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `rulebook_version` | Yes | Must be `1` |\n| `name` | Yes | `^[a-zA-Z][a-zA-Z0-9_-]{0,63}$` |\n| `version` | Yes | Non-empty string |\n| `description` | No | Free text; not type-checked at runtime |\n| `author` | No | Free text; not type-checked at runtime |\n| `allowed_commands` | Yes | Unique command names matching `^[a-zA-Z][a-zA-Z0-9_-]*$` |\n| `rules` | Yes | Array of rule objects |\n| `tests` | No | Array of fixtures |\n\n### Rule Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `name` | Yes | Unique within the rulebook (case-insensitive); same pattern as rulebook `name` |\n| `command` | Yes | Must be listed in `allowed_commands`; basename only, not path |\n| `subcommand` | No | Same pattern as `command`; omit to match any subcommand |\n| `intent` | No | One of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain` |\n| `block_args` | Yes | Non-empty array of non-empty strings |\n| `reason` | Yes | Non-empty string, max 256 chars |\n\n### Test Fixture Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `command` | Yes | Non-empty shell command string |\n| `expect` | Yes | `\"blocked\"` or `\"allowed\"` |\n| `rule` | Required for blocked fixtures | Rule name expected to block the command |\n\nFixtures are optional documentation of intended behavior. Fixtures are shape-validated only; CC Safety Net does not execute them.\n\n## Matching Behavior\n\n- **Command**: Normalized to lowercase basename with any trailing `.exe` removed (`/usr/bin/git` → `git`).\n- **Subcommand**: The first command token after recognized Git and Docker global options and their values; `--` ends option parsing. An unrecognized option without `=` may consume the following token as its value.\n- **Arguments**: Each `block_args` value is compared literally against every command token, including expanded short options. The command is blocked if **any** item matches.\n- **Short options**: Expanded (`-Ap` matches `-A`).\n- **Long options**: Exact match (`--all-files` does not match `--all`).\n- **Execution order**: Built-in rules first, then custom rulebooks. Custom rules only add restrictions.\n- **Transparent wrappers**: A configured wrapper such as `rtk` lets `rtk git commit` be analyzed as `git commit` only when `git` is protected by built-in analyzers or active custom rules. `rtk -- git commit` is also supported.\n\n## Workflow\n\n1. Run `cc-safety-net rule init` or create `rule.json` manually.\n2. Optionally run `cc-safety-net rule init --example` to create an inactive example rulebook.\n3. Use `cc-safety-net rule wrapper add rtk` for trusted transparent wrappers.\n4. Run `cc-safety-net rule add <source>` after creating or choosing a rulebook source; it adds the source and syncs it.\n5. Run `cc-safety-net rule sync` after manual `rule.json` changes or local rulebook edits.\n6. Run `cc-safety-net rule verify` to validate config, lock/cache state, local rulebooks, and shareable GitHub-source rulebook directories in the current repository (it does not fetch remote content).\n7. Run `cc-safety-net rule list` to inspect active rulebooks and transparent wrappers.\n\nAn edited or invalid local rulebook keeps its last synced, digest-verified cached version enforced until `cc-safety-net rule sync` validates the edit. A missing lock entry or cache, a cache digest mismatch, or an invalid cached rulebook makes that source inactive; a missing lockfile or an unreadable or invalid `rule.json` makes every source in its scope inactive. Inactive sources stop applying their rules while other custom rules and all built-in protections stay active. Repair the reported condition, then run `cc-safety-net rule sync`. Run `cc-safety-net status` to see degraded sources.\n";function Rn(n,t){if(!n.ok){q5(n);return}j5(n),console.log(t),console.log("Rule config synced."),console.log(""),g5(n.entries)}function g5(n){if(n.length===0){console.log("Active rulebooks: (none)");return}console.log(`Active rulebooks (${n.length}):`);for(let t of n)console.log(`  - ${t.name} ${t.version} (${m5(t.ruleCount??0)})`),console.log(`    Source: ${r1(t)}`)}function m5(n){return`${n} ${n===1?"rule":"rules"}`}function ll(n,t){H2("Active sources",n.rulebooks,(r)=>[`[${r.source}] ${r.name} ${r.version}`,`  Source: ${t[r.source].get(r.spec)??r.spec}`]),H2("Active rules",n.rules,(r)=>[`[${k5(n,r.name)}] ${r.name}`,`  Command: ${r.subcommand?`${r.command} ${r.subcommand}`:r.command}`,`  Block args: ${r.block_args.join(", ")}`,`  Reason: ${r.reason}`]),H2("Disabled rules",al(n,"off"),(r)=>[r.key]),H2("Reason overrides",al(n,"reason"),(r)=>[r.key,`  Reason: ${r.value.reason}`]),H2("Transparent wrappers",n.transparent_wrappers,(r)=>[r]),H2("Issues",n.errors,(r)=>[r]),H2("Warnings",n.warnings,(r)=>[r])}function H2(n,t,r){if(t.length===0){console.log(`${n}: (none)`);return}console.log(`${n} (${t.length}):`);for(let e of t){let[a,...l]=r(e);console.log(`  - ${a}`);for(let d of l)console.log(`    ${d}`)}}function k5(n,t){return n.rulebooks.find((r)=>r.rules.includes(t))?.source??"project"}function al(n,t){return Object.entries({...n.userConfig?.overrides??{},...n.projectConfig?.overrides??{}}).filter((r)=>{if(t==="off")return r[1]==="off";return!!r[1]&&typeof r[1]==="object"}).map(([r,e])=>({key:r,value:e}))}function q5(n){for(let t of n.errors)console.error(t)}function j5(n){if(!n.warnings||n.warnings.length===0)return;for(let t of n.warnings)console.warn(t)}import{dirname as dl,join as Ft}from"node:path";var z5=".safety-net.json",F5="~/.cc-safety-net/config.json";async function cl(n){return[await sl({legacyPath:Ll({cwd:n.cwd}),configPath:P(n.cwd),defaultRulebookName:"project-rules",migratedFrom:z5,cleanup:n.cleanup,syncOptions:{cwd:n.cwd}}),await sl({legacyPath:on(),configPath:I(),defaultRulebookName:"user-rules",migratedFrom:F5,cleanup:n.cleanup,syncOptions:{cwd:n.cwd,global:!0}})].every((r)=>r)?0:1}async function sl(n){let t=T(n.syncOptions),r=m(t.filesystemScope,n.legacyPath),e=D(r);if(e===null)return console.log(`No legacy config found at ${n.legacyPath}`),!0;let a=J5(e);if(!a.ok){for(let b of a.errors)console.error(b);return!1}let l=_(t.configTarget);if(l.errors.length>0){for(let b of l.errors)console.error(b);return!1}let d=l.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},s=Z5(dl(n.configPath),d.rules,n.defaultRulebookName,n.migratedFrom,t.filesystemScope),L=Ft(dl(n.configPath),s,"rulebook.json"),c=m(t.filesystemScope,L),i=[$r(t.configTarget),$r(c),$r(t.lockTarget)],v=await B5(n,t.configTarget,c,s,a.config.rules,d.rules.includes(s)?d.rules:[...d.rules,s],d.overrides??{},d.transparent_wrappers??[]);if(!v.ok){Y5(i);for(let b of v.errors)console.error(b);return!1}if(!n.cleanup)return console.log(`Migrated legacy config at ${n.legacyPath}. Legacy file is no longer used.`),!0;if(!X5(t.configTarget,c,s,n.migratedFrom,a.config.rules))return console.error(`Migration cleanup verification failed for ${n.legacyPath}`),!1;return un(r),console.log(`Deleted legacy config at ${n.legacyPath}`),!0}async function B5(n,t,r,e,a,l,d,s){try{return E(t,{version:1,rules:l,overrides:d,transparent_wrappers:s}),E(r,Q5(e,n.migratedFrom,a)),await M2(n.syncOptions)}catch(L){return{ok:!1,errors:[L instanceof Error?L.message:String(L)]}}}function J5(n){try{let t=JSON.parse(n),r=Mt(t);if(r.errors.length>0)return{ok:!1,errors:r.errors};return{ok:!0,config:{version:1,rules:t.rules??[]}}}catch{return{ok:!1,errors:["Invalid JSON"]}}}function Z5(n,t,r,e,a){let l=t.find((d)=>H5(m(a,Ft(n,d,"rulebook.json")))===e);if(l)return l;if(D(m(a,Ft(n,r,"rulebook.json")))===null)return r;for(let d=2;;d++){let s=`${r}-${d}`;if(D(m(a,Ft(n,s,"rulebook.json")))===null)return s}}function Q5(n,t,r){return{rulebook_version:1,name:n,version:"1.0.0",description:"Migrated CC Safety Net rules.",author:"project",migrated_from:t,allowed_commands:[...new Set(r.map((e)=>e.command))],rules:r,tests:r.map((e)=>({command:[e.command,e.subcommand,e.block_args[0]].filter(Boolean).join(" "),expect:"blocked",rule:e.name}))}}function X5(n,t,r,e,a){if(!_(n).config?.rules.includes(r))return!1;try{let d=D(t);if(d===null)return!1;let s=JSON.parse(d);return s.migrated_from===e&&JSON.stringify(s.rules)===JSON.stringify(a)}catch{return!1}}function $r(n){return{target:n,content:D(n)}}function Y5(n){for(let t of n){if(t.content===null){un(t.target);continue}$2(t.target,t.content)}}function H5(n){let t=D(n);if(t===null)return null;try{let r=JSON.parse(t);return typeof r.migrated_from==="string"?r.migrated_from:null}catch{return null}}import{mkdir as S5,readFile as W5,writeFile as R5}from"node:fs/promises";import{dirname as K5,join as V5}from"node:path";var A5=86400000,M5=604800000;async function pl(n=Date.now()){if(process.env.CC_SAFETY_NET_NO_UPDATE_CHECK)return null;let t=l1();if(!t)return null;let r=V5(t,".cc-safety-net","update-check.json"),e=await G5(r,n);if(!e.lastCheck||n-e.lastCheck>A5){let d=await I2();if(e.lastCheck=n,d.latestVersion)e.latestVersion=d.latestVersion;if(!await il(r,e))return null;if(d.error)return null}let a=e.latestVersion,l=B();if(!a||!m1(a,l))return null;if(e.notifiedVersion===a&&e.notifiedAt!==void 0&&n-e.notifiedAt<M5)return null;if(e.notifiedVersion=a,e.notifiedAt=n,!await il(r,e))return null;return`UPDATE_AVAILABLE: cc-safety-net v${a} is available (running v${l}). Ask the user once whether to run \`npx -y cc-safety-net@latest update\`; continue the current task either way and do not raise this again.`}async function G5(n,t){let r=await W5(n,"utf8").then((l)=>JSON.parse(l)).catch(()=>{return});if(!r||typeof r!=="object"||Array.isArray(r))return{};let e=r,a=(l)=>typeof l==="number"&&Number.isFinite(l)&&l<=t?l:void 0;return{lastCheck:a(e.lastCheck),latestVersion:typeof e.latestVersion==="string"?e.latestVersion:void 0,notifiedVersion:typeof e.notifiedVersion==="string"?e.notifiedVersion:void 0,notifiedAt:a(e.notifiedAt)}}async function il(n,t){return S5(K5(n),{recursive:!0,mode:448}).then(()=>R5(n,JSON.stringify(t),{mode:384})).then(()=>!0).catch(()=>!1)}import{dirname as U5,join as C5,resolve as Dr}from"node:path";var ul="CC Safety Net Config",O5="═".repeat(ul.length),T5="https://raw.githubusercontent.com/kenryu42/cc-safety-net/main/assets/cc-safety-net.schema.json",_5=new Set(["rule.json","rule.lock","cache"]);function bl(n={}){try{return E5(n)}catch(t){if(t instanceof Y)return console.error(t.message),1;throw t}}function E5(n){let t=n.cwd??process.cwd(),r=n.userConfigPath??I(),e=n.projectConfigPath??P(t),a=n.legacyUserConfigPath??on(),l=n.legacyProjectConfigPath??Ur(t),d=Dr(t,t1),s=U5(r),L=N({cwd:t,userConfigPath:r,projectConfigPath:e}),c=N({cwd:t}),i=m(L.userScope,r),v=m(L.projectScope,e),b=n.legacyUserConfigPath?vn(n.legacyUserConfigPath,"user policy"):m(c.userScope,a),p=n.legacyProjectConfigPath?vn(n.legacyProjectConfigPath,"project policy"):m(c.projectScope,l),f=!1,u=!1,y=[],w=[],$=P5(m(c.projectScope,d));if(N5(),D(i)!==null){let h=s2(i);if(h.errors.push(...L2(r,G2({userConfigDir:s}),{userConfigDir:s},L.userScope)),y.push({scope:"User",path:r,result:h,schema:"rules",sourceDisplayMap:D2(r,L.userScope),target:i}),h.errors.length>0)f=!0}if(D(b)!==null)if(u=!0,D(i)!==null)w.push(Bt("user","cleanup"));else{let h=Gt(b);if(y.push({scope:"User",path:a,result:h,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:b}),w.push(Bt("user",h.errors.length>0?"fix-or-delete":"migrate")),h.errors.length>0)f=!0}if(D(v)!==null){let h=s2(v);if(h.errors.push(...L2(e,U2(e),{userConfigDir:s},L.projectScope)),y.push({scope:"Project",path:Dr(e),result:h,schema:"rules",sourceDisplayMap:D2(e,L.projectScope),target:v}),h.errors.length>0)f=!0;if(D(p)!==null)u=!0,w.push(Bt("project","cleanup"))}else if(D(p)!==null){u=!0,f=!0;let h=Gt(p);y.push({scope:"Project",path:Dr(l),result:h,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:p}),w.push(Bt("project",h.errors.length>0?"fix-or-delete":"migrate"))}if($?.result.errors.length)f=!0;if(y.length===0&&!$)return console.log(`
No config files found. Using built-in rules only.`),0;for(let h of y)if(h.inactive)t8(h.scope,h.path,h.result,h.sourceDisplayMap);else if(h.result.errors.length>0)r8(h.scope,h.path,h.result.errors);else{if(h.schema==="rules"&&l8(h.target))console.log(`
Added $schema to ${h.scope.toLowerCase()} config.`);n8(h.scope,h.path,h.result,h.schema,h.sourceDisplayMap)}for(let h of w)console.error(`
${o.red(h)}`);if($)if($.result.errors.length>0)a8($.path,$.result.errors);else e8($.path,$.result);if(f)return console.error(`
Config validation failed.`),1;return console.log(u?`
Configs valid with warnings.`:`
All configs valid.`),0}function Bt(n,t){let r=`legacy ${n} config`;if(t==="cleanup")return`Warning: Legacy ${n} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${n} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${n} config is no longer supported. Fix or delete the ${r}, then run \`npx -y cc-safety-net rule migrate\`.`}function P5(n){if(A2(n)===null)return null;let t=I5(n);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:n.path,result:t}}function I5(n){let t=[],r=new Set,e=(A2(n)??[]).filter((a)=>!_5.has(a.name)).sort((a,l)=>a.name.localeCompare(l.name));if(e.length===0)return{errors:t,ruleNames:r};for(let a of e){if(!bn.test(a.name)){t.push(`rulebook directory names must match ${bn}: ${a.name}`);continue}if(a.kind!=="directory"){t.push(`${a.name} must be a rulebook directory`);continue}let l=m(n.scope,C5(n.path,a.name,"rulebook.json")),d=D(l);if(d===null){t.push(`${a.name}/rulebook.json is required`);continue}try{let s;try{s=JSON.parse(d)}catch{t.push(`${a.name}/rulebook.json: invalid JSON`);continue}let L=vl(s);if(L.name!==a.name){t.push(`rulebook name "${L.name}" must match folder "${a.name}"`);continue}r.add(a.name)}catch(s){t.push(s instanceof Error?`${a.name}/rulebook.json: ${s.message}`:`${a.name}/rulebook.json: ${String(s)}`)}}return{errors:t,ruleNames:r}}function N5(){console.log(ul),console.log(O5)}function n8(n,t,r,e,a){if(console.log(`
✓ ${n} config: ${t}`),console.log(`  Schema: ${e==="rules"?"rulebook sources":"legacy inline rules"}`),r.ruleNames.size>0){console.log(`  ${e==="rules"?"Sources":"Rules"}:`);let l=1;for(let d of r.ruleNames)console.log(`    ${l}. ${a.get(d)??d}`),l++}else console.log(`  ${e==="rules"?"Sources":"Rules"}: (none)`)}function t8(n,t,r,e){if(console.error(`
✗ Legacy ${n.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),r.errors.length>0){console.error("  Errors:");let a=1;for(let l of r.errors)for(let d of l.split("; "))console.error(`    ${a}. ${d}`),a++;return}if(r.ruleNames.size>0){console.error("  Rules:");let a=1;for(let l of r.ruleNames)console.error(`    ${a}. ${e.get(l)??l}`),a++;return}console.error("  Rules: (none)")}function r8(n,t,r){ol(`${n} config`,t,r)}function e8(n,t){console.log(`
✓ GitHub source rules: ${n}`),console.log("  Rulebooks:");let r=1;for(let e of t.ruleNames)console.log(`    ${r}. ${e}`),r++}function a8(n,t){ol("GitHub source rules",n,t)}function ol(n,t,r){console.error(`
✗ ${n}: ${t}`),console.error("  Errors:");let e=1;for(let a of r)for(let l of a.split("; "))console.error(`    ${e}. ${l}`),e++}function l8(n){try{let t=D(n);if(t===null)return!1;let r=JSON.parse(t);if(r.$schema)return!1;return $2(n,JSON.stringify({$schema:T5,...r},null,2)),!0}catch(t){if(t instanceof Y)throw t;return!1}}var fl=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),s8=new Set(["add","remove","list"]);async function yl(n){try{return await L8(n)}catch(t){if(t instanceof Y)return console.error(t.message),1;throw t}}async function L8(n){let t=i8(n),r=t.help?c8(t.positionals):null;if(r)return yt(r),0;if(t.errors.length>0){for(let d of t.errors)console.error(d);return 1}let e=t.positionals[0];if(!e)return yt(E2,console.error),1;let a=t.positionals[1],l={global:t.global,check:t.check};if(e==="init"){let d=T(l),s=d.configDir;u8(d.configTarget),hl(m(d.filesystemScope,Mn({...l,cacheConfigDir:s})));let L=d8(s,"example-rules","rulebook.json"),c=m(d.filesystemScope,L);if(t.example&&D(c)===null)a1(c,"example-rules");let i=await M2(l);return Rn(i,"Rule config initialized."),i.ok?0:1}if(e==="add"){if(!a)return console.error("rule add requires a source"),1;let d=await It(a,l);return Rn(d,`Added rulebook source: ${a}`),d.ok?0:1}if(e==="remove"){if(!a)return console.error("rule remove requires a source"),1;let d=await n1(a,{...l,deleteSource:t.deleteSource});return Rn(d,`Removed rulebook source: ${a}`),d.ok?0:1}if(e==="update"||e==="sync"){let d=await M2({...l,only:e==="update"?a:void 0});return Rn(d,t.check?"Rule config checked.":"Rule config synced."),d.ok?0:1}if(e==="list"){let d=h2(),s=N({});return ll(d,{user:D2(d.userConfigPath,s.userScope),project:D2(d.projectConfigPath,s.projectScope)}),d.errors.length>0?1:0}if(e==="wrapper")return b8(t);if(e==="migrate")return cl({cleanup:t.cleanup,cwd:process.cwd()});if(e==="doc"){console.log(el);let d=await pl();if(d)console.error(d);return 0}if(e==="verify")return bl();return 1}function c8(n){if(n.length===0)return E2;let t=E2.subcommands.filter((e)=>e.usage.split(" ")[0]===n[0]);if(t.length===0)return null;if(n.length===1&&t.length>1)return{name:`rule ${n[0]}`,description:`Subcommands of rule ${n[0]}`,usage:`rule ${n[0]} <subcommand>`,subcommands:t,options:[]};let r=n.length===1?t[0]:t.find((e)=>e.usage.split(" ")[1]===n[1]);if(!r)return null;return{name:`rule ${n[0]}`,description:r.description,usage:`rule ${r.usage}`,options:[]}}function i8(n){let t=J({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},positionals:"list"},n),r={...t.flags,help:t.help,positionals:t.positionals,errors:t.errors};return p8(r),r}function p8(n){let[t]=n.positionals;if(t&&!fl.has(t))n.errors.push(`Unknown rule subcommand: ${t}`);if(n.deleteSource&&t!=="remove")if(t&&fl.has(t))n.errors.push(`Unknown option for rule ${t}: --delete-source`);else n.errors.push("--delete-source is only valid with 'rule remove'");if(n.cleanup&&t!=="migrate")n.errors.push(Jt(t,"--cleanup"));if(n.example&&t!=="init")n.errors.push(Jt(t,"--example"));if(t==="migrate"){if(n.global)n.errors.push(Jt(t,"--global"));if(n.check)n.errors.push(Jt(t,"--check"));if(n.positionals.length>1)n.errors.push(`Unexpected rule migrate argument: ${n.positionals[1]}`)}else if(t==="wrapper")v8(n);else if(n.positionals.length>2)n.errors.push(`Unexpected rule argument: ${n.positionals[2]}`);if(t==="list"&&n.global)n.errors.push("Unknown option for rule list: --global")}function Jt(n,t){return n?`Unknown option for rule ${n}: ${t}`:`Unknown option for rule: ${t}`}function v8(n){let t=n.positionals[1],r=n.positionals[2];if(!t){n.errors.push("rule wrapper requires add, remove, or list");return}if(!s8.has(t)){n.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(r)n.errors.push(`Unexpected rule wrapper argument: ${r}`);return}if(!r){n.errors.push(`rule wrapper ${t} requires a command`);return}if(n.positionals.length>3)n.errors.push(`Unexpected rule wrapper argument: ${n.positionals[3]}`)}function u8(n){if(D(n)===null){e1(n);return}let t=_(n);if(!t.config)return;E(n,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function b8(n){let t=n.positionals[1],r=n.positionals[2],e=T({global:n.global}).configTarget;if(t==="list"){let s=_(e);if(s.errors.length>0){for(let L of s.errors)console.error(L);return 1}return o8(s.config?.transparent_wrappers??[]),0}if(!r||!d1.test(r))return console.error("transparent wrapper must match command pattern"),1;if(L1(r))return console.error(`reserved command "${r}" cannot be a wrapper`),1;let a=_(e);if(a.errors.length>0){for(let s of a.errors)console.error(s);return 1}let l=a.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},d=t==="add"?[...new Set([...l.transparent_wrappers??[],r])]:(l.transparent_wrappers??[]).filter((s)=>s!==r);return E(e,{version:1,rules:l.rules,overrides:l.overrides??{},transparent_wrappers:d}),console.log(t==="add"?`Added transparent wrapper: ${r}`:`Removed transparent wrapper: ${r}`),0}function o8(n){if(n.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${n.length}):`);for(let t of n)console.log(`  - ${t}`)}import{homedir as wl}from"node:os";import{existsSync as f8,readFileSync as h8}from"node:fs";import{homedir as y8}from"node:os";import{join as w8}from"node:path";async function x8(n){if(n.isTTY)return null;return(await o1(n).catch(()=>null))?.trim()||null}function $8(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return w8(y8(),".claude","settings.json")}function gr(){let n=$8();if(!f8(n))return!1;try{let t=h8(n,"utf-8"),r=JSON.parse(t);if(!r.enabledPlugins)return!1;let e="cc-safety-net@cc-marketplace";if(!(e in r.enabledPlugins))return!1;return r.enabledPlugins[e]===!0}catch(t){if(yn(k.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${n}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function mr(n=process.stdin){let t=gr(),r;if(!t)r="\uD83D\uDEE1️ CC Safety Net ❌";else{let a=A({cwd:process.cwd()}),l=a.policy,d=c2(l),s=Object.values(k2(l,d.capabilities)).some((c)=>c.changesInherited);r=`\uD83D\uDEE1️ CC Safety Net ${{standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[s?"custom":d.effectiveLevel]}${d.worktreeMode?"\uD83C\uDF33":""}${a.state==="degraded"?"⚠️":""}`}let e=await x8(n);if(e&&!e.startsWith("{"))console.log(`${e} | ${r}`);else console.log(r)}function xl(){let n=A({cwd:process.cwd()}),t=n.policy,r=c2(t),e=!!process.env.NO_COLOR||!process.stdout.isTTY,a=Math.min(process.stdout.columns||80,100),l=e?"ok":"✔",d=e?"OFF":"✘",s=(p,f)=>{let u=`  ${p.padEnd(13)}${f}`;return(u.length>a?`${u.slice(0,a-1)}…`:u).replaceAll(d,o.red(d))},L=Object.values(k2(t,r.capabilities)).some((p)=>p.changesInherited),c=wn(),i={ready:o.green,degraded:o.yellow}[n.state],v=[...gr()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...n.diagnostics],b=e?"-":"·";console.log([`${e?"":"\uD83D\uDEE1️  "}CC Safety Net — ${i(n.state)}`,"",s("Protection",`destructive ${t.destructiveCommandProtectionEnabled?l:d}   secrets ${t.secretProtection.enabled?l:d}`),s("Level",L?`${r.effectiveLevel} (customised)`:r.effectiveLevel),s("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),s("Policy",c.startsWith(wl())?`~${c.slice(wl().length)}`:c),...r.worktreeMode?[s("Worktree","relaxations active")]:[],"",...v.length===0?["  Everything configured is active."]:["  Not active",...v.flatMap((p)=>ht(p,"      ",a-6).map((f,u)=>u===0?`    ${b} ${f}`:f)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as Rl}from"node:child_process";import{randomBytes as Z8}from"node:crypto";import{createServer as Q8}from"node:http";import{Writable as X8}from"node:stream";import{homedir as D8}from"node:os";var Zt=500;function g8(n){let t=n.filter((a)=>a.decision!=="allow"),r=n.filter((a)=>a.decision==="allow"),e=Math.min(t.length,Math.max(Zt-r.length,Math.ceil(Zt/2)));return[...t.slice(0,e),...r.slice(0,Zt-e)]}function $l(n,t=i2()){if(t)g2(t);let r=(u)=>new Date(u.getFullYear(),u.getMonth(),u.getDate()).getTime(),e=r(new Date),a=new Date(e);a.setDate(a.getDate()-(n-1));let l=a.getTime(),d=[],s={count:0};for(let u of t?f2(t,s):[])for(let y of pn(u,s)){if(!y||typeof y.ts!=="string"||typeof y.command!=="string")continue;let w=new Date(y.ts).getTime();if(!Number.isFinite(w))continue;if(w>=l)d.push(y)}d.sort((u,y)=>new Date(y.ts).getTime()-new Date(u.ts).getTime());let L=Array.from({length:n},()=>0),c=Array.from({length:n},()=>0),i={},v={},b={},p=0,f=0;for(let u of d){let y=u.agent||"unknown";i[y]=(i[y]??0)+1;let w=Math.round((e-r(new Date(u.ts)))/86400000),$=n-1-w,h=w>=0&&w<n;if(h)c[$]=(c[$]??0)+1;if(u.decision!=="allow"){if(p++,u.ruleId)v[u.ruleId]=(v[u.ruleId]??0)+1;let g=S2(u.segment||u.command);if(g)b[g]=(b[g]??0)+1;if(u.failureStage)f++;if(h)L[$]=(L[$]??0)+1}}return{days:n,logsDir:t,homeDir:D8(),totalInWindow:d.length,truncated:d.length>Zt,unreadable:s.count,counts:{blocked:p,allowed:d.length-p,agents:i,blockedByDay:L,analyzedByDay:c,rules:v,commands:b,errors:f},entries:g8(d).sort((u,y)=>new Date(y.ts).getTime()-new Date(u.ts).getTime())}}import{spawn as m8}from"node:child_process";import{existsSync as Dl,statSync as k8}from"node:fs";import{delimiter as q8,join as j8}from"node:path";var z8=120000,Qt="Choose the project folder",F8=`try
  return POSIX path of (choose folder with prompt "${Qt}")
on error number -128
  return ""
end try`,B8=`Add-Type -AssemblyName System.Windows.Forms
$dialog = New-Object System.Windows.Forms.FolderBrowserDialog
$dialog.Description = '${Qt}'
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,gl=[{binary:"zenity",args:["--file-selection","--directory",`--title=${Qt}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",Qt]}],ml=(n,t)=>(t.PATH??"").split(q8).some((r)=>r.length>0&&Dl(j8(r,n)));function kl(n,t){if(n==="darwin"||n==="win32")return!0;if(n!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return gl.some((r)=>ml(r.binary,t))}function J8(n,t){if(n==="darwin")return{cmd:"osascript",args:["-e",F8]};if(n==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",B8]};let r=gl.find((e)=>ml(e.binary,t));return r?{cmd:r.binary,args:r.args}:null}function ql(n=process.platform,t=process.env){let r=J8(n,t);if(!r)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((e)=>{let a=m8(r.cmd,r.args,{env:t,stdio:["ignore","pipe","pipe"]}),l="",d=!1,s=(c)=>{if(d)return;d=!0,clearTimeout(L),e(c)},L=setTimeout(()=>{a.kill(),s({error:"The folder dialog timed out"})},z8);a.stdout.on("data",(c)=>{l+=c.toString()}),a.on("error",()=>s({error:`Could not open the folder dialog (${r.cmd})`})),a.on("close",()=>{let c=l.trim().replace(/\/+$/,"");if(!c)return s({cancelled:!0});if(!Dl(c)||!k8(c).isDirectory())return s({error:"That selection is not a folder on disk"});s({path:c})})})}var jl=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var zl='<script id="ccsn-data" type="application/json">';function Fl(n){return jl.replace(zl,()=>zl+JSON.stringify({token:n}).replaceAll("<","\\u003c"))}var Yt="kenryu42/cc-safety-net",Y8=`https://github.com/${Yt}`,jr=1e4,H8=7;async function Kl(n,t={}){let r=J({label:"gui",booleans:{noOpen:["--no-open"]}},n),e=t.log??console.log,a=t.error??console.error;if(r.errors.length>0){for(let d of r.errors)a(d);return a("Usage: cc-safety-net gui [--no-open]"),1}let l=await S8(t);if(e(`CC Safety Net policy GUI: ${l.url}`),!r.flags.noOpen)try{await(t.openBrowser??U8)(l.url)}catch(d){a(`Failed to open browser: ${d instanceof Error?d.message:String(d)}`),a(`Open this URL manually: ${l.url}`)}if(t.keepAlive===!1)return await l.close(),0;return await G8(l),0}async function S8(n={}){let t=Z8(24).toString("base64url"),r=Q8((l,d)=>{W8(l,d,t,n)});await new Promise((l,d)=>{r.once("error",d),r.listen(0,"127.0.0.1",()=>{r.off("error",d),l()})});let a=`http://127.0.0.1:${r.address().port}`;return{origin:a,token:t,url:`${a}/?token=${encodeURIComponent(t)}`,close:()=>M8(r)}}async function W8(n,t,r,e){let a=new URL(n.url??"/","http://127.0.0.1");if(n.method==="GET"&&a.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!V8(n,a,r)){q(t,403,{error:"Forbidden"});return}if(n.method==="GET"&&a.pathname==="/"){A8(t,Fl(r));return}if(n.method==="GET"&&a.pathname==="/api/policy"){let l=Ql(e);q(t,200,{...l,configState:xn(A(e)),destructiveCommandRules:fn,secretPatterns:Jl,version:B(),preview:l.errors.length>0?null:Yl(l.policy)});return}if(n.method==="POST"&&a.pathname==="/api/policy/preview"){let l=await Xt(n);if(!l.ok){q(t,400,{errors:[l.error]});return}let d=Xl(l.value);q(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/policy/explain"){let l=await Xt(n);if(!l.ok){q(t,400,{errors:[l.error]});return}let d=l.value;if(d===null||typeof d.command!=="string"){q(t,400,{errors:["command must be a string"]});return}let s=v1(d.policy);if(s.length>0){q(t,400,{errors:s});return}q(t,200,R8(d.command,d.policy,e));return}if(n.method==="POST"&&a.pathname==="/api/policy"){let l=await Xt(n);if(!l.ok){q(t,400,{errors:[l.error]});return}let d=kr(l.value,e);q(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/reset"){q(t,200,kr(Zl,e));return}if(n.method==="POST"&&a.pathname==="/api/repair"){q(t,200,Hl(e));return}if(n.method==="GET"&&a.pathname==="/api/activity"){let l=T2(e),d=K8(a.searchParams.get("days"),l);if(d===null){q(t,400,{error:`days must be an integer between 1 and ${l}`});return}q(t,200,$l(d,e.activityLogsDir));return}if(n.method==="POST"&&a.pathname==="/api/rules/choose-directory"){q(t,200,await ql());return}if(n.method==="GET"&&a.pathname==="/api/rules"){let l=h2(e),d=new Map(l.rules.map((s)=>[s.name,s]));q(t,200,{projectPath:e.cwd??process.cwd(),canPickDirectory:kl(process.platform,process.env),rulebooks:l.rulebooks.map((s)=>({source:s.source,spec:s.spec,name:s.name,version:s.version,rules:s.rules.flatMap((L)=>{let c=d.get(L);if(!c)return[];return[{name:c.name,command:c.command,subcommand:c.subcommand,block_args:c.block_args,reason:c.reason}]})})),errors:l.errors,warnings:l.warnings});return}if(n.method==="GET"&&a.pathname==="/api/star/context"){q(t,200,await(e.fetchStarContext??(()=>E8({logsDir:e.activityLogsDir})))());return}if(n.method==="POST"&&a.pathname==="/api/star"){let l=await(e.starRepo??C8)();q(t,200,l.ok?{ok:!0}:{ok:!1,fallbackUrl:Y8});return}if(n.method==="GET"&&a.pathname==="/api/integrations"){q(t,200,await(e.fetchIntegrations??O8)());return}if(n.method==="GET"&&a.pathname==="/api/health"){q(t,200,await(e.fetchHealth??T8)());return}if(n.method==="POST"&&(a.pathname==="/api/install"||a.pathname==="/api/uninstall")){let l=await Xt(n);if(!l.ok){q(t,400,{errors:[l.error]});return}let d=l.value?.target;if(typeof d!=="string"||!l2.some((L)=>L.target===d)){q(t,400,{error:"unknown target"});return}let s=a.pathname==="/api/install"?"install":"uninstall";q(t,200,await(e.runIntegration??_8)(s,d));return}q(t,404,{error:"Not found"})}function R8(n,t,r){let e=xt(t),a=A(r),l=hn({rules:a.policy.rules,transparentWrappers:a.policy.transparentWrappers,safety:Wl(e.safety),worktreeMode:e.workflow.worktree_mode,destructiveCommandProtectionEnabled:e.destructive_command_protection.enabled,destructiveCommandRuleOverrides:e.destructive_command_protection.overrides,destructiveCommandAllowPaths:e.destructive_command_protection.allow_paths,secretProtection:{enabled:e.secret_protection.enabled,disabledRules:Sl(e.secret_protection.overrides),denyPaths:e.secret_protection.deny_paths,allowPaths:e.secret_protection.allow_paths}});return O2(n,{policySnapshot:l,cwd:r.cwd,userConfigDir:r.userConfigDir})}function K8(n,t){if(n===null)return Math.min(H8,t);let r=Number(n);if(!Number.isInteger(r)||r<1||r>t)return null;return r}function V8(n,t,r){if(t.searchParams.get("token")!==r)return!1;if(n.method!=="POST")return!0;return n.headers["x-cc-safety-net-token"]===r}async function Xt(n){let t=[];for await(let r of n)t.push(r);try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(r){return{ok:!1,error:`Invalid JSON: ${r instanceof Error?r.message:String(r)}`}}}function A8(n,t){n.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),n.end(t)}function q(n,t,r){n.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),n.end(JSON.stringify(r))}function M8(n){return new Promise((t,r)=>{n.close((e)=>e?r(e):t())})}function G8(n){return new Promise((t)=>{let r=()=>{process.off("SIGINT",e),process.off("SIGTERM",e)},e=()=>{r(),n.close().then(t)};process.once("SIGINT",e),process.once("SIGTERM",e)})}function U8(n){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",r=process.platform==="win32"?["/c","start","",n]:[n];return new Promise((e,a)=>{let l=Rl(t,r,{detached:!0,stdio:"ignore"}),d=(L)=>{l.off("spawn",s),a(L)},s=()=>{l.off("error",d),l.unref(),e()};l.once("error",d),l.once("spawn",s)})}async function C8(n="gh",t=jr){return{ok:await qr(n,["api","-X","PUT",`/user/starred/${Yt}`],t)===0}}async function O8(n={}){let t=await kn(n.fetcher),r=Vl(t,n.homeDir);return{targets:G.map((e)=>{let a=r.find((l)=>l.platform===e.id);return{target:e.id,label:j(e.id),version:t.versions[e.id]??null,status:a?.configured?"active":a?.detected?"disabled":a?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function Vl(n,t){return an(process.cwd(),{homeDir:t,ampPluginListOutput:n.ampPluginListOutput,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.versions["copilot-cli"]})}async function T8(n={}){let[t,r]=await Promise.all([kn(n.fetcher),(n.checkUpdates??I2)()]);return{hooks:Vl(t,n.homeDir).filter((e)=>e.detected).map((e)=>({platform:e.platform,label:j(e.platform),configured:e.configured})),update:{currentVersion:r.currentVersion,latestVersion:r.latestVersion??null,updateAvailable:r.updateAvailable}}}var Bl=Promise.resolve();function _8(n,t,r={}){let e=async()=>{let l=[],d=console.log,s=console.error;console.log=(...L)=>l.push(L.map(String).join(" ")),console.error=console.log;try{return{ok:await Wn(n,[],{selectTargets:async()=>[t],output:new X8({write(c,i,v){l.push(String(c).replace(/\n$/,"")),v()}}),...r})===0,output:l.join(`
`)}}finally{console.log=d,console.error=s}},a=Bl.then(e);return Bl=a.then(()=>{return},()=>{return}),a}async function E8(n={}){let[t,r,e]=await Promise.all([P8(n.command),I8(n.fetchRepo),Promise.resolve(En(T2(),n.logsDir).totalBlocked)]);return{starred:t,starCount:r,blockedTotal:e}}async function P8(n="gh",t=jr){if(await qr(n,["auth","status"],t)!==0)return null;let r=await qr(n,["api",`/user/starred/${Yt}`],t);if(r===0)return!0;if(r===null)return null;return!1}function qr(n,t,r){return new Promise((e)=>{let a=Rl(n,t,{stdio:"ignore",windowsHide:!0}),l=!1,d,s=(L)=>{if(l)return;if(l=!0,d)clearTimeout(d);e(L)};a.once("error",()=>s(null)),a.once("close",s),d=setTimeout(()=>{a.kill(),s(null)},r)})}async function I8(n=fetch){try{let t=await n(`https://api.github.com/repos/${Yt}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(jr)});if(!t.ok)return null;let r=await t.json();return typeof r.stargazers_count==="number"?r.stargazers_count:null}catch{return null}}function N8(n){if(n[0]!=="help")return!1;let t=n[1];if(!t)dr(),process.exit(0);if(Yn(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var n4={hook:async(n)=>{let t=_e(n);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),Yn("hook",console.error),process.exit(1)},install:async(n)=>{process.exit(await Wn("install",n))},update:async(n)=>{process.exit(await xr(n))},uninstall:async(n)=>{process.exit(await Wn("uninstall",n))},rule:async(n)=>{process.exit(await yl(n))},status:async(n)=>{if(d2(J({label:"status"},n).errors))process.exit(1);xl()},statusline:async(n)=>{let t=J({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},n);if(t.errors.length===0&&t.flags.claudeCode){await mr();return}if(d2(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");Yn("statusline",console.error),process.exit(1)},doctor:async(n)=>{let t=tr(n);if(!t)process.exit(1);let r=await E0({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(r)},logs:async(n)=>{process.exit(await ye(n))},gui:async(n)=>{process.exit(await Kl(n))},explain:async(n)=>{process.exit(await e3(n))}};async function t4(){let n=process.argv.slice(2),t=J({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},n);if(N8(n))return;let r=n[0],e=r?_n(r):void 0;if(t.help&&e&&e.name!=="rule")Yn(e.name),process.exit(0);if(!r||t.help&&!e)dr(),process.exit(0);if(t.flags.version)d3(),process.exit(0);if(e){await n4[e.name](n.slice(1));return}let a=Ee(r);if(a){await a.run();return}if(r==="--statusline"){await mr();return}console.error(r.startsWith("-")?`Unknown option: ${r}`:`Unknown command: ${r}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}t4().catch((n)=>{console.error("CC Safety Net error:",n),process.exit(1)});
