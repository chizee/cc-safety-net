#!/usr/bin/env node
import{$ as Ut,$a as Qr,A as ln,Aa as xr,B as Dl,Ba as Kt,C as P,Ca as mr,D as U,Da as gr,E as Qt,Ea as O,F as Dt,Fa as Ft,G as Jn,Ga as Xt,H as kt,Ha as Yt,I as C2,Ia as T,J as y2,Ja as Tl,K as Rt,Ka as Vt,L as d2,La as _l,M as ra,Ma as ar,N as Gt,Na as El,O as Sn,Oa as Pl,P as aa,Pa as Il,Q as la,Qa as Nl,R as Qn,Ra as nd,S as Xn,Sa as td,T as on,Ta as Vr,U as un,Ua as Gr,V as Rr,Va as Ur,W as dn,Wa as Or,X as w2,Xa as Fl,Y as At,Ya as Sr,Z as M2,Za as Zr,_ as da,_a as zt,aa as ca,ab as Xr,b as cr,ba as La,bb as u2,c as Lr,ca as Ar,cb as h2,d as A,da as br,db as a2,e as or,ea as Hr,eb as Yr,f as xt,fa as Cr,fb as H,g as S,ga as Mr,gb as Ln,h as $,ha as Ht,hb as sn,i as en,ia as fr,ib as ia,j as m,ja as D,jb as pn,k as f2,ka as Ct,kb as s2,l as qr,la as sa,lb as ya,m as Q2,ma as l2,mb as Zn,n as rn,na as cn,o as Zl,oa as Mt,p as $t,pa as Wt,q as jr,qa as Wr,r as an,ra as Kr,s as Fr,sa as hr,t as Zt,ta as A2,u as zr,ua as qt,v as Br,va as jt,w as _,wa as Jr,x as E,xa as S2,y as Y2,ya as Ol,z as R2,za as wr}from"../chunks/index-5kxvmeyn.js";var sd=["-h","--help"];function j(n,t){let e=Object.entries(n.booleans??{}),r=Object.entries(n.values??{}),a=Object.fromEntries(e.map(([L])=>[L,!1])),l={},d=[],s=[],i=!1,c=-1;for(let[L,u]of t.entries()){if(L<=c)continue;if(u==="--"){d.push(...t.slice(L+1));break}if(sd.includes(u)){i=!0;continue}let p=e.find(([,b])=>b.includes(u));if(p){a[p[0]]=!0;continue}let o=r.find(([,b])=>b.includes(u));if(o){let b=t[L+1];if(b===void 0||b.startsWith("-")){s.push(`${u} requires a value`);continue}l[o[0]]=b,c=L+1;continue}if(u.startsWith("-")){s.push(`Unknown option for ${n.label}: ${u}`);continue}if(n.positionals==="tail"){d.push(...t.slice(L));break}d.push(u)}if(n.positionals!=="list"&&n.positionals!=="tail")s.push(...d.map((L)=>`Unexpected argument for ${n.label}: ${L}`));return{flags:a,values:l,positionals:d,help:i,errors:s}}function e2(n){for(let t of n)console.error(t);return n.length>0}import{readdirSync as Ud,statSync as _r,unlinkSync as Od}from"node:fs";import{basename as Er,dirname as Td,join as _d,resolve as Ed}from"node:path";function F(n){return Array.from(n,(t)=>{let e=t.charCodeAt(0);if(e<=31||e>=127&&e<=159)return`\\x${e.toString(16).padStart(2,"0")}`;return t}).join("")}import{existsSync as id,readdirSync as cd,readFileSync as Ld}from"node:fs";import{join as od}from"node:path";function o2(n,t){try{return cd(n,{withFileTypes:!0,encoding:"utf8"}).flatMap((e)=>{let r=od(n,e.name);if(e.isDirectory())return o2(r,t);if(e.name.endsWith(".jsonl"))return[r];return[]})}catch{if(t&&id(n))t.count++;return[]}}function jn(n){let t=n.trim().split(/\s+/).filter((a)=>a&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(a)),e=t[0]?.split("/").pop();if(!e)return null;let r=t[1];return r&&/^[a-z][a-z0-9-]*$/.test(r)?`${e} ${r}`:e}function ht(n){let t=(a)=>`${a.sessionId}
${jn(a.segment||a.command)}`,e=n.filter((a)=>a.decision!=="allow"),r=e.filter((a)=>a.sessionId).reduce((a,l)=>a.set(t(l),(a.get(t(l))??0)+1),new Map);return new Set(e.filter((a)=>a.failureStage||(r.get(t(a))??0)>=2))}function tn(n,t){try{return Ld(n,"utf-8").split(`
`).filter(Boolean).flatMap((e)=>{try{return[JSON.parse(e)]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as Ad}from"node:path";var ud=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function ur(n){let t=0,e={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(r){n.record({kind:"step",scope:"global",step:r})},recordSegment(r,a=e.currentSegmentIndex){if(a===void 0)return;n.record({kind:"step",scope:"segment",segmentIndex:a,step:r})}};return e}function pr(n={}){let t=[],e=n.maxEvents??512,r={maxTextLength:n.maxTextLength??2048,maxListLength:n.maxListLength??128,maxObjectProperties:n.maxObjectProperties??n.maxListLength??128,maxDepth:n.maxDepth??16},a=0,l,d=new Set;return{record(s){if(l)return;try{if(!s||t.length>=e){a++;return}t.push(wt(pd(s,r,d)))}catch{a++}},finish(s){if(l)return l;try{l=wt({events:Object.freeze(t),droppedEvents:a,terminal:vd(s,r,d)})}catch{a++,l=Object.freeze({events:Object.freeze(t),droppedEvents:a,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,r.maxTextLength),segment:"trace unavailable".slice(0,r.maxTextLength)})})}return l}}}function pd(n,t,e){if(n.kind!=="step")throw TypeError("invalid trace event");let{scope:r,step:a}=n;Fn(a,e,t);let l=B2(a,t,e);if(r==="global")return{kind:"step",scope:"global",step:l};if(r!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:n.segmentIndex,step:l}}function vd(n,t,e){let r=n.result;if(r==="allowed")return Object.freeze({result:"allowed"});if(r!=="blocked")throw TypeError("invalid trace terminal");let a=n.ruleId;return Object.freeze({result:"blocked",reason:B2(n.reason,t,e),segment:B2(n.segment,t,e),...a?{ruleId:B2(a,t,e)}:{}})}function Fn(n,t,e,r=0,a=new WeakSet){if(typeof n==="string"){let s=n.slice(0,e.maxTextLength);if(!xt(s))return;for(let i of or(s))for(let c of i.match(/[^\s"'()$]+/g)??[])t.add(vr(c));return}if(!n||typeof n!=="object"||r>=e.maxDepth||a.has(n))return;if(a.add(n),Array.isArray(n)){let s=Math.min(n.length,e.maxListLength);for(let i=0;i<s;i++)Fn(n[i],t,e,r+1,a);return}let l=0,d=new Set;for(let s in n){if(!Object.hasOwn(n,s))continue;if(l>=e.maxObjectProperties)break;l++,Fn(s,t,e);let i=yt(s,e,t);if(d.has(i))continue;d.add(i),Fn(n[s],t,e,r+1,a)}}function B2(n,t,e,r=0,a=new WeakSet){if(typeof n==="string")return yt(n,t,e);if(!n||typeof n!=="object")return n;if(r>=t.maxDepth)return;if(a.has(n))return;if(a.add(n),Array.isArray(n)){let s=[],i=Math.min(n.length,t.maxListLength);for(let c=0;c<i;c++)s.push(B2(n[c],t,e,r+1,a));return s}let l={},d=0;for(let s in n){if(!Object.hasOwn(n,s))continue;if(d>=t.maxObjectProperties)break;d++;let i=yt(s,t,e);if(Object.hasOwn(l,i))continue;Object.defineProperty(l,i,{value:B2(n[s],t,e,r+1,a),enumerable:!0,configurable:!0,writable:!0})}return l}function yt(n,t,e){let r=n.slice(0,t.maxTextLength),a=xt(r)?Lr(r):r,l=e.size>0?fd(a,e):a;return(bd(l)?cr(l):l).slice(0,t.maxTextLength)}function bd(n){return n.includes("PRIVATE KEY")||n.includes("://")||n.includes("eyJ")||n.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(n)||n.length>=14&&ud.some((t)=>n.includes(t))||n.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(n)}function fd(n,t){return n.replace(/[^\s"'()$]+/g,(e)=>t.has(vr(e))?"<redacted>":e)}function vr(n){let t=2166136261,e=2166136261;for(let r=0;r<n.length;r++)t=Math.imul(t^n.charCodeAt(r),16777619),e=Math.imul(e^n.charCodeAt(n.length-r-1),16777619);return`${t>>>0}:${e>>>0}:${n.length}`}function wt(n){if(n&&typeof n==="object"&&!Object.isFrozen(n)){for(let t of Object.values(n))wt(t);Object.freeze(n)}return n}function yr(n,t,e,r){let a=r??br(),l=e??a.getCommandProgram(n,t.shell??"auto"),d=pr(),s=ur(d),i=l.dialect==="powershell"?a.getCommandProgram(n,"posix"):l,c=fr(i);s.recordGlobal({type:"parse",input:n,segments:c.map((p)=>[...p])});let L=hr(n,{...t,analyzePartialProgram:!0,trace:s},l,a),u=s.getNextSegmentIndex();if(L&&u>0&&u<c.length)s.recordSegment({type:"segment-skipped",index:u,reason:"prior-segment-blocked"},u);return Object.freeze({decision:L,trace:d.finish(L?{result:"blocked",reason:L.reason,segment:L.evidence.find((p)=>p.kind==="command")?.segment??n,...L.ruleId?{ruleId:L.ruleId}:{}}:{result:"allowed"}),program:l})}import{resolve as hd}from"node:path";function mt(n){let t=wr().safeParse(n);return{errors:t.success?[]:mr(t.error.issues),ruleNames:new Set(xr(n).map((e)=>e.toLowerCase()))}}function gt(n){let t=$r(n);if(!t.ok)return t.result;return mt(t.parsed)}function $r(n){let t=[],e=new Set;try{let r=typeof n==="string"?en(n):n,a=m(r);if(a===null)return t.push(`File not found: ${r.path}`),{ok:!1,result:{errors:t,ruleNames:e}};if(!a.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:e}};return{ok:!0,parsed:JSON.parse(a)}}catch(r){return t.push(r instanceof S?r.message:"Invalid JSON"),{ok:!1,result:{errors:t,ruleNames:e}}}}function Dr(n){return hd(n??process.cwd(),".safety-net.json")}function r2(n){let t=$r(n);if(!t.ok)return t.result;let e=gr(t.parsed);return{errors:e.errors,ruleNames:e.sources}}import{isAbsolute as yd,join as zn,relative as wd,resolve as kr,sep as xd}from"node:path";async function X2(n={}){let t=Jt(n);return md(t,await Bn(t,S2()))}function md(n,t){if(!t.ok)return t;let e=U(n),r=[...new Set(a2(e.configPath,e.lockPath,n,e.filesystemScope))];if(r.length===0)return t;return{ok:!1,errors:r,warnings:t.warnings,entries:t.entries}}async function Bn(n,t,e,r={}){let a=null,l=!1;try{let d=U(n),s=Ft(d.configTarget);if(!s.ok)return s.result;let i=s.config;if(n.check)return jd(i,d,n);a={target:d.lockTarget,content:m(d.lockTarget)};let c=zt(d.lockTarget);if(c.errors.some((f)=>f.startsWith("Unable to access ")))return{ok:!1,errors:c.errors,warnings:[],entries:[]};if(n.only&&c.errors.length>0)return{ok:!1,errors:c.errors,warnings:[],entries:[]};let L=c.errors.length>0?null:c.lock,u=n.only?Sr(i,L,n.only):{ok:!0,specs:i.rules};if(!u.ok)return u.result;if(n.only&&!L&&u.specs.length<i.rules.length)return{ok:!1,errors:[`No lockfile available for partial update; run ${Br}`],warnings:[],entries:[]};let p=(await $d(u.specs,(f)=>Qr(f,d.configDir,n,L,d.filesystemScope,t),t)).map((f)=>Fd(f,L,e));for(let f of p)Jd(f.content,f.entry,d.configDir,n,d.filesystemScope);let o=n.only?zd(i,L,p):p.map((f)=>f.entry);l=!0,T(d.lockTarget,{version:1,rulebooks:o},void 0,r._testAfterPolicyRename);let b=new Map(p.map((f)=>[f.entry.spec,f.rulebook.rules.length])),v=Sd(o,d.configDir,n,d.filesystemScope,r);return{ok:!0,errors:[],warnings:v,entries:o.map((f)=>Bd(f,b))}}catch(d){if(l&&a)try{J2(a.target,a.content)}catch(s){return Z2(s)}return Z2(d)}}async function Bt(n,t={}){return gd(n,Jt(t),S2())}async function gd(n,t,e,r={}){let a=null,l=!1;try{let d=U(t),s=m(d.configTarget);a={target:d.configTarget,content:s};let i=Ft(d.configTarget);if(!i.ok)return i.result;let c=i.config,L=zr(n)?await Xr(n,e):[{spec:n}],u=L.map((b)=>b.spec),p=[...new Set([...c.rules,...u])];if(p.length>qt)return Dd();if(p.length!==c.rules.length)l=!0,T(d.configTarget,{version:1,rules:p,overrides:c.overrides??{},transparent_wrappers:c.transparent_wrappers??[]},void 0,r._testAfterPolicyRename);let o=await Bn(t,e,new Map(L.filter((b)=>!!b.display_ref).map((b)=>[b.spec,b.display_ref])),r);if(!o.ok)J2(d.configTarget,s);return o}catch(d){if(l&&a)try{J2(a.target,a.content)}catch(s){return Z2(s)}return Z2(d)}}async function $d(n,t,e=S2()){if(n.length>qt)throw Error(jt);let r=Array(n.length),a=0,l,d=Array.from({length:Math.min(n.length,Jr.concurrency)},async()=>{while(!l){let s=a;if(s>=n.length)return;a++;try{r[s]=await t(n[s],s,e.controller.signal)}catch(i){if(!l)l={value:i},a=n.length,e.controller.abort(i);return}}});if(await Promise.all(d),l)throw l.value;return r}function Dd(){return{ok:!1,errors:[jt],warnings:[],entries:[]}}function Jt(n){return{cwd:n.cwd,cacheConfigDir:n.cacheConfigDir,userConfigDir:n.userConfigDir,userConfigPath:n.userConfigPath,projectConfigPath:n.projectConfigPath,global:n.global,check:n.check,only:n.only,refresh:n.refresh}}function kd(n){return{...Jt(n),deleteSource:n.deleteSource}}async function St(n,t={}){try{return await qd(n,kd(t),{})}catch(e){return Z2(e)}}async function qd(n,t,e){let r=U(t),a=O(r.configTarget);if(a.errors.length>0)return{ok:!1,errors:a.errors,warnings:[],entries:[]};if(!a.config)return{ok:!1,errors:[`No config found at ${r.configPath}`],warnings:[],entries:[]};let l=zt(r.lockTarget);if(l.errors.length>0)return{ok:!1,errors:l.errors,warnings:[],entries:[]};let d=Zr(a.config.rules,l.lock,n);if(!d.ok)return d.result;let s=t.deleteSource?Zd(r.configDir,d.specs,l.lock,r.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let i=m(r.configTarget);if(i===null)return Z2(Error("Rules config is unavailable."));try{T(r.configTarget,{version:1,rules:a.config.rules.filter((u)=>!d.specs.includes(u)),overrides:a.config.overrides??{},transparent_wrappers:a.config.transparent_wrappers??[]},void 0,e._testAfterPolicyRename)}catch(u){throw J2(r.configTarget,i),u}let c=await Bn(t,S2(),void 0,e);if(!c.ok)return J2(r.configTarget,i),c;let L=Xd(s.dirs,e,r.filesystemScope);if(!L.ok){J2(r.configTarget,i);let u=await Bn(t,S2(),void 0,e);if(!u.ok)return{ok:!1,errors:[...L.result.errors,...u.errors],warnings:u.warnings,entries:u.entries};return L.result}return c}async function jd(n,t,e){let r=Yr(n,t.lockPath,t.configDir,e,e.global?"user":"project",t.filesystemScope);return{ok:r.errors.length===0&&r.warnings.length===0,errors:[...r.errors,...r.warnings],warnings:[],entries:r.entries}}function Fd(n,t,e){let r=t?.rulebooks.find((l)=>l.spec===n.entry.spec&&l.kind==="github"),a=e?.get(n.entry.spec)??(r?.kind==="github"?r.display_ref:void 0);if(!a||n.entry.kind!=="github")return n;return{...n,entry:{...n.entry,display_ref:a}}}function zd(n,t,e){let r=new Set(n.rules),a=new Set(t?.rulebooks.map((d)=>d.spec)??[]),l=new Map(e.map((d)=>[d.entry.spec,d.entry]));return[...(t?.rulebooks.filter((d)=>r.has(d.spec))??[]).map((d)=>l.get(d.spec)??d),...e.filter((d)=>!a.has(d.entry.spec)).map((d)=>d.entry)]}function Bd(n,t){return{...n,ruleCount:t.get(n.spec)}}function Jd(n,t,e,r,a){let l=Dt(t,kt(e,r));f2($(a,l),n)}function Sd(n,t,e,r,a){let l=kt(t,e),d=Jn(l),s=$(r,d),i=Q2(s);if(!i)return[];let c=n.map((u)=>$(r,Dt(u,l))),L=i.filter((u)=>u.kind==="directory").map((u)=>({directory:$(r,zn(d,u.name)),identity:$(r,zn(d,u.name,Fr))})).filter((u)=>!c.some((p)=>qr(u.identity,p))).map((u)=>u.directory);for(let u of L)jr(u);return L.flatMap((u)=>{try{return Yd(u,a),[]}catch{return["Unable to prune rules policy cache safely."]}})}function Zd(n,t,e,r){let a=new Map(e?.rulebooks.map((c)=>[c.spec,c])??[]),l=t.flatMap((c)=>{let L=a.get(c);if(!L)return an.test(c)?[]:["--delete-source can only delete local rulebook sources"];return L.kind==="local-directory"?[]:["--delete-source can only delete local rulebook sources"]}),d=t.map((c)=>{let L=a.get(c);return zn(n,L?.kind==="local-directory"?L.path:c)}),s=l.length>0?[]:d.flatMap((c)=>Qd(n,c,r)),i=[...l,...s];return i.length>0?{ok:!1,result:{ok:!1,errors:i,warnings:[],entries:[]}}:{ok:!0,dirs:d}}function Qd(n,t,e){let r=kr(n),a=kr(t),l=wd(r,a);if(l===""||l===".."||l.startsWith(`..${xd}`)||yd(l))return[`Refusing to delete local rulebook source outside ${n}: ${t}`];let d=$(e,a),s=Q2(d);if(!s)return[`Local rulebook source directory not found: ${t}`];let i=s.find((c)=>c.name==="rulebook.json");if(!i)return[`Local rulebook source directory is missing rulebook.json: ${t}`];if(i.kind!=="file")throw new S(e.label);if(m($(e,zn(a,"rulebook.json"))),s.length>1)return[`Local rulebook source directory contains extra files: ${t}. delete manually if you really want to remove the directory.`];return[]}function Xd(n,t,e){let r=n.flatMap((a)=>{try{return Rd($(e,a),t),[]}catch(l){return[`Failed to delete local rulebook source ${a}: ${l instanceof Error?l.message:String(l)}`]}});return r.length>0?{ok:!1,result:{ok:!1,errors:r,warnings:[],entries:[]}}:{ok:!0}}function Yd(n,t){if(t._testPruneRulebookCacheDir){t._testPruneRulebookCacheDir(n.path);return}$t(n)}function Rd(n,t){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(n.path);return}$t(n)}function J2(n,t){if(t===null){rn(n);return}f2(n,t)}function Z2(n){return{ok:!1,errors:[n instanceof Error?n.message:String(n)],warnings:[],entries:[]}}function H2(n,t){let e=Cd(t),r=Wr(e),a={effectiveLevel:r.effectiveLevel,selectedPreset:e.policySnapshot.policy.safety.level??"standard",effectiveCapabilities:r.effectiveCapabilities,destructiveCommandRuleOverrides:e.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:l,configValid:d}=Hd({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!n||!n.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:l,configValid:d,...a};let s=Md(n,e);if(s)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",ruleModule:s.ruleModule,ruleFunction:s.ruleFunction,matched:!0,reason:s.reason}]}]},result:"blocked",reason:A(s.reason),segment:A(s.target),...s.ruleId?{ruleId:A(s.ruleId)}:{},configSource:l,configValid:d,...a};let i=yr(n,e),c=i.decision,L=c?.ruleId??Wd(n,e),u=dn.find((o)=>o.id===L&&o.activationCapability),p=u?r.policy.effectiveDestructiveCommandRules[u.id]:void 0;return{trace:Vd(i.trace),result:c?"blocked":"allowed",reason:c?A(c.reason):void 0,segment:c?A(c.evidence.find((o)=>o.kind==="command")?.segment??n):void 0,ruleId:c?.ruleId?A(c.ruleId):void 0,customRule:Kd(Gd(c?.ruleId,e.policySnapshot)),configSource:l,configValid:d,...a,...u&&p?{ruleActivation:{id:u.id,...p}}:{}}}function Hd(n){let t=_(n?.cwd),e=n?.userConfigPath??E(n),r=P({cwd:n?.cwd,userConfigDir:n?.userConfigDir,userConfigPath:n?.userConfigPath});try{if(m(r.projectConfigTarget)!==null){if(r2(r.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(a){if(a instanceof S)return{configSource:t,configValid:!1};throw a}try{if(m(r.userConfigTarget)!==null){let a=r2(r.userConfigTarget);return{configSource:e,configValid:a.errors.length===0}}return{configSource:null,configValid:!0}}catch(a){if(a instanceof S)return{configSource:e,configValid:!1};throw a}}function Cd(n){let t=Ad(n?.cwd??process.cwd()),e=n?.policySnapshot??H({cwd:t,userConfigDir:n?.userConfigDir}),r=l2(e.policy);return{cwd:t,effectiveCwd:t,policySnapshot:e,environment:Rr(),protectedGitMetadata:Mr(t),effectiveCapabilities:r.capabilities,strict:n?.strict??r.strict,paranoidRm:r.paranoidRm,paranoidInterpreters:r.paranoidInterpreters,worktreeMode:r.worktreeMode}}function Md(n,t){let e=t.cwd??process.cwd(),r=Ar(A2("",{command:n},{kind:"command",shell:"posix"},{executionCwd:e,configCwd:e},n)),a=Gr(r);if(a)return{reason:Vr,target:a.target,ruleId:"policy-protection",ruleModule:"policy-protection",ruleFunction:"findPolicyConfigMutationTarget"};let l=Cr(r,t.protectedGitMetadata);if(l)return{reason:Hr,target:l.target,ruleId:"git-metadata-protection",ruleModule:"git-metadata-protection",ruleFunction:"findGitMetadataMutationTarget"};let d=t.policySnapshot.policy,s=d.secretProtection.enabled===!1?null:Or(r,d.secretProtection,{strict:t.strict});if(s)return{reason:Ur,target:s.target,ruleId:s.ruleId,ruleModule:"secret-protection",ruleFunction:"findSensitiveTarget"};return null}function Wd(n,t){let e=t.policySnapshot.policy,r=sn({...e,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...e.destructiveCommandRuleOverrides,...Object.fromEntries(dn.flatMap((a)=>a.activationCapability?[[a.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return Kr(n,{...t,policySnapshot:r,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function Kd(n){if(!n)return;return{id:A(n.id),...n.rulebook?{rulebook:{name:A(n.rulebook.name),version:A(n.rulebook.version)}}:{},...n.source?{source:A(n.source)}:{},...n.override?{override:{type:"reason",reason:A(n.override.reason)}}:{}}}function Vd(n){let t=n.events.flatMap((r)=>r.kind==="step"&&r.scope==="global"?[r.step]:[]),e=new Map;for(let r of n.events){if(r.kind!=="step"||r.scope!=="segment")continue;let a=e.get(r.segmentIndex)??{index:r.segmentIndex,steps:[]};a.steps.push(r.step),e.set(r.segmentIndex,a)}return{steps:t,segments:[...e.values()]}}function Gd(n,t){let e=n?.replace(/^custom\./,"");if(!e||!t.policy.rules.some((r)=>r.name===e))return;return t.ruleMetadata[e]??Object.freeze({id:e})}function Pd(n){let t=C2(),e=j({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},n);if(e2(e.errors))return null;if(e.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(e.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let r=e.values.limit===void 0?20:Tr(e.values.limit);if(r===null)return console.error("--limit must be a positive number"),null;let a=e.values.since===void 0?Math.min(30,t):Tr(e.values.since);if(a===null||a>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let l={limit:r,limitExplicit:e.values.limit!==void 0,since:a,sinceExplicit:e.values.since!==void 0,all:e.flags.all,json:e.flags.json,suspect:e.flags.suspect,pruneLegacy:e.flags.pruneLegacy,dryRun:e.flags.dryRun,id:e.values.id,agent:e.values.agent,rule:e.values.rule,session:e.values.session,project:e.values.project===void 0?void 0:Ed(e.values.project)};if(l.id&&(l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.sinceExplicit||l.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(l.pruneLegacy&&(l.id!==void 0||l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.all||l.sinceExplicit||l.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(l.dryRun&&!l.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return l}async function Pr(n,t={}){let e=Pd(n);if(!e)return 1;let r=t.logsDir??d2();if(e.pruneLegacy)return Id(r,e.json,e.dryRun);if(!r)return console.log(e.json?"[]":e.id?`No retained audit log entry found for id ${F(e.id)}.`:"No audit log entries found."),0;y2(r);let a={count:0},l=o2(r,a).flatMap((L)=>tn(L,a).map((u)=>({entry:u,file:L})));if(a.count>0)console.error(`warning: ${a.count} audit log ${a.count===1?"source":"sources"} could not be read; these results are incomplete`);if(e.id)return es(l,e,t.timeZone);let d=Date.now()-e.since*24*60*60*1000,s=l.filter((L)=>rs(L,e,r,d)),i=e.suspect?ht(s.map((L)=>L.entry)):null,c=(i?s.filter((L)=>i.has(L.entry)):s).sort((L,u)=>Date.parse(u.entry.ts)-Date.parse(L.entry.ts)).slice(0,e.limit);if(e.json)return console.log(JSON.stringify(c.map((L)=>L.entry),null,2)),0;if(c.length===0)return console.log("No audit log entries found."),0;for(let L of c)console.log(ds(L.entry,t.timeZone));return 0}function Id(n,t,e){let r=n?ns(n).map((s)=>_d(n,s)):[];if(e)return Nd(r,t);let a=[],l=0,d=0;for(let s of r){let i=_r(s,{throwIfNoEntry:!1})?.size??0,c=ts(s);if(c){a.push(`${Er(s)}: ${c}`);continue}l++,d+=i}if(t)return console.log(JSON.stringify({removedFiles:l,removedBytes:d,failedFiles:a.length})),a.length===0?0:1;console.log(l===0&&a.length===0?"No legacy audit log files found.":`Removed ${l} legacy audit log ${l===1?"file":"files"} (${Ir(d)}).`);for(let s of a)console.error(`Could not remove ${F(s)}`);if(console.log("Nested v2 audit logs were not changed."),l>0)console.log("This deletion cannot be undone.");return a.length===0?0:1}function Nd(n,t){let e=n.reduce((r,a)=>r+(_r(a,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:n.length,bytes:e})),0;if(console.log(n.length===0?"No legacy audit log files found.":`Would remove ${n.length} legacy audit log ${n.length===1?"file":"files"} (${Ir(e)}).`),console.log("Nested v2 audit logs are not included."),n.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function ns(n){try{return Ud(n,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function ts(n){try{return Od(n),null}catch(t){return t instanceof Error?t.message:String(t)}}function Ir(n){let t=["B","KiB","MiB","GiB"],e=Math.min(Math.floor(Math.log2(Math.max(n,1))/10),t.length-1);return`${Math.round(n/1024**e*10)/10} ${t[e]}`}function es(n,t,e){let r=n.filter((l)=>l.entry.id===t.id);if(r.length>1)return console.error(`Multiple audit log entries found for id ${F(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(r.map((l)=>l.entry),null,2)),0;let a=r[0];if(!a)return console.log(`No retained audit log entry found for id ${F(t.id??"")}.`),0;return console.log(ss(a.entry,e)),0}function rs(n,t,e,r){if(!t.all&&n.entry.decision==="allow")return!1;if(Date.parse(n.entry.ts)<r)return!1;if(t.agent!==void 0&&n.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&n.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!as(n,e,t.session))return!1;if(t.project!==void 0&&!ls(n.entry.cwd,t.project))return!1;return!0}function as(n,t,e){if(n.entry.sessionId===e)return!0;return Td(n.file)===t&&Er(n.file,".jsonl")===e}function ls(n,t){if(!n)return!1;return n===t||n.startsWith(`${t}/`)}function ds(n,t){let e=F(n.id??"-"),r=F(n.decision??"deny"),a=n.cwd?`  [${F(n.cwd)}]`:"",l=n.segment||n.command,d=l===n.command?"":"↳ ",s=l.length>50?`${l.slice(0,50)}…`:l;return`${e.padEnd(16)}  ${F(Nr(n.ts,t))}  ${r.padEnd(5)}  ${F(n.agent??"-").padEnd(15)}  ${F(n.ruleId??"-").padEnd(20)}  ${d}${F(s)}${a}`}function ss(n,t){let e=(a)=>F(a===void 0||a===null||a===""?"-":a),r=n.shape?`${n.agent??"-"} (shape: ${n.shape})`:n.agent??"-";return[`id:        ${e(n.id)}`,`ts:        ${e(Nr(n.ts,t))}`,`decision:  ${e(n.decision)}`,`agent:     ${e(r)}`,`level:     ${e(n.level)}`,`tool:      ${e(n.toolName)}`,`rule:      ${e(n.ruleId)}`,`intent:    ${e(n.intent)}`,`stage:     ${e(n.failureStage)}`,`error:     ${e(n.errorCode)}`,`session:   ${e(n.sessionId)}`,`cwd:       ${e(n.cwd)}`,`version:   ${e(n.v)}`,`truncated: ${e(n.truncated===!0?"yes":void 0)}`,`reason:    ${e(n.reason)}`,`command:   ${e(n.command)}`,`segment:   ${e(n.segment)}`].join(`
`)}function Nr(n,t){let e=new Date(n);if(Number.isNaN(e.getTime()))return n;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(e)}function Tr(n){let t=Number(n);return Number.isFinite(t)&&t>0?t:null}var na={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var ta={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var ea={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as oa,relative as ys}from"node:path";var is=8388608;function cs(n,t){console.log(JSON.stringify(n(aa(t))))}async function Ls(n){let t;try{t=(await Ot(process.stdin)).trim()}catch{n({reason:"Failed to parse hook input JSON."});return}if(!t){n({reason:"Missing hook input JSON."});return}return Tt(t,n,"Failed to parse hook input JSON.")}async function Ot(n){let t=[],e=0;for await(let r of n){let a=typeof r==="string"?Buffer.from(r,"utf-8"):Buffer.from(r.buffer,r.byteOffset,r.byteLength);if(e+=a.byteLength,e>is)throw os(n),Error("hook input byte limit exceeded");t.push(a)}return Buffer.concat(t,e).toString("utf-8")}function os(n){let t=n.destroy??n.cancel;if(!t)return;try{Promise.resolve(t.call(n)).catch(()=>{})}catch{}}function Tt(n,t,e){try{return JSON.parse(n)}catch{t({reason:e});return}}function Q(n,t){let e=t.get(n);return e?{kind:"command",shell:e}:{kind:da(n)}}function I(n,t,e,r){let a=n===void 0?process.cwd():n,l=typeof a==="string"&&a.trim()!==""?s2([a]):void 0;if(l)return{configCwd:l,executionCwd:l};return R(r,t,e,bs(a)),null}function R(n,t,e,r){let a;try{a=Ut(t)}catch(l){if(!(l instanceof M2))throw l}n(Sn({command:a,segment:r,toolName:e}))}async function us(n){let t=await Ls(n.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){R(n.outputDeny);return}if(!n.isSupported(t))return;let e=n.getAgent?.(t)??n.agent,r=n.agent===e?void 0:n.agent,a=hs(t),l=(o,b)=>{ra(o,()=>n.getSessionId(t),{agent:e,shape:r,toolName:b,cwd:a}),n.outputDeny(o)},d=n.getToolName(t);if(typeof d!=="string"||d.trim()===""){R((o)=>l(o),fs(t));return}let s=d,i=(o)=>l(o,s),c;try{c=n.getToolInput(t,s,i)}catch(o){if(!(o instanceof M2))throw o;R(i,void 0,s);return}if(!c.ok)return;let L=n.getContext(t,c.input,s,i);if(!L)return;let u;try{u=Ut(c.input)}catch(o){if(!(o instanceof M2))throw o;R(i,void 0,s);return}let p=A2(s,c.input,c.route,L,u??null);try{let o=Zn(p,{guard:{auditAllowed:sa(),dependencies:n.guardDependencies},audit:{agent:e,shape:r,getSessionId:()=>n.getSessionId(t)}}),b=Gt(o,{includeEvidence:!0,toolName:o.stage==="command-analysis"?void 0:s});if(b){n.outputDeny(b);return}n.outputAllow?.()}catch(o){if(!(o instanceof ia))throw o;ps(o);let b=Gt(o.evaluation,{includeEvidence:!0,toolName:o.evaluation.stage==="command-analysis"?void 0:s});if(b)n.outputDeny(b);return}}function ps(n){if(!cn(D.debug))return;console.error(`CC Safety Net debug: ${vs(n.stage)}: ${la(n.cause)}`)}function vs(n){if(n==="policy-protection")return"hook policy protection failed";if(n==="config-load")return"hook config loading failed";if(n==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function bs(n){return typeof n==="string"?n:void 0}function fs(n){if(!n||typeof n!=="object"||Array.isArray(n))return;if(Object.hasOwn(n,"tool_input"))return n.tool_input;let t=n.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function hs(n){if(!n||typeof n!=="object"||Array.isArray(n))return null;let t=n.cwd;if(typeof t==="string")return t;let e=n.toolCall;if(!e||typeof e!=="object"||Array.isArray(e))return null;let r=e.args;if(!r||typeof r!=="object"||Array.isArray(r))return null;let a=r.Cwd;return typeof a==="string"?a:null}async function X(n){let t=(a)=>cs(n.createDenyOutput,a),e=n.createAllowOutput;await us({...n,outputDeny:t,outputAllow:e?()=>console.log(JSON.stringify(e())):void 0})}var ws=new Map([["run_command","auto"]]),xs=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function ua(n){return Q(n,ws)}async function pa(){await X({agent:"antigravity-cli",createDenyOutput:(n)=>({decision:"deny",reason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolCall?.name,getToolInput:(n,t)=>({ok:!0,input:ks(n.toolCall?.args,t),route:ua(t)}),getContext:ms,getSessionId:(n)=>n.conversationId})}function ms(n,t,e,r){let l=Ds(n).flatMap((c)=>{let L=s2([c]);return L?[L]:[]});if(!l[0])return x2(r,t,e),null;if(e!=="run_command"){let c;try{c=gs(t,e,l)}catch(L){if(L instanceof M2)return x2(r,void 0,e),null;if(!(L instanceof Qn))throw L;return x2(r,t,e),null}if(!c)return x2(r,t,e),null;return{configCwd:c,executionCwd:c,policyConfigCwds:l}}let d=n.toolCall?.args;if(!d||!Object.hasOwn(d,"Cwd"))return{configCwd:l[0],executionCwd:l[0],policyConfigCwds:l};let s=d.Cwd;if(typeof s!=="string"||s.trim()==="")return x2(r,t,e),null;let i=pn(s,l);if(i){let c=va(i,l);if(!c)return x2(r,t,e,s),null;return{configCwd:c,executionCwd:i,policyConfigCwds:l}}return x2(r,t,e,s),null}function gs(n,t,e){let r=ua(t),a=[...ca(n,xs),...r.kind==="patch"?La(n):[]].filter(oa),l=Xn(),d=new Set(a.flatMap((s)=>{let i=va(on(s,un,l),e);return i?[i]:[]}));if(d.size>1)return null;return[...d][0]??e[0]??null}function va(n,t){return t.filter((e)=>$s(n,e)).reduce((e,r)=>r.length>e.length?r:e,"")||null}function $s(n,t){let e=ys(t,n);return e===""||!e.startsWith("..")&&!oa(e)}function x2(n,t,e,r){let a=t&&typeof t==="object"?t.command:void 0;n(Sn({command:typeof a==="string"?a:void 0,segment:r,toolName:e}))}function Ds(n){if(n.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(n.workspacePaths)?n.workspacePaths.filter((e)=>typeof e==="string"&&e.trim()!==""):[];return s2(t)?t:[]}function ks(n,t){if(!n)return;if(t!=="run_command")return n;return{...n,command:typeof n.CommandLine==="string"&&n.CommandLine!==""?n.CommandLine:void 0}}var W2=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",installLabel:"Antigravity CLI",helpTarget:"Antigravity CLI hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",installLabel:"Claude Code",helpTarget:"Claude Code plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",installLabel:"Codex",helpTarget:"Codex plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",installLabel:"GitHub Copilot CLI",helpTarget:"GitHub Copilot CLI plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",installLabel:"Gemini CLI",helpTarget:"Gemini CLI extension",probeCommand:["gemini","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:8,runtime:{order:6,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--hermes-agent",installLabel:"Hermes Agent",helpTarget:"Hermes Agent plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:9,runtime:{order:7,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--kimi-code",installLabel:"Kimi Code",helpTarget:"Kimi Code hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:10,install:{order:10,flag:"--openclaw",installLabel:"OpenClaw",helpTarget:"OpenClaw plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:11,install:{order:11,flag:"--opencode",installLabel:"OpenCode",helpTarget:"OpenCode plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:12,install:{order:12,flag:"--pi",installLabel:"Pi",helpTarget:"Pi package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",installLabel:"Cursor",helpTarget:"Cursor hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",installLabel:"Amp Code",helpTarget:"Amp Code plugin",probeCommand:["amp","--version"]}}],ba=W2.slice().sort((n,t)=>n.doctorOrder-t.doctorOrder).map((n)=>n.id),fa=W2.filter((n)=>("runtime"in n)).slice().sort((n,t)=>n.runtime.order-t.runtime.order).map((n)=>({id:n.id,displayName:"displayName"in n.runtime?n.runtime.displayName:n.displayName,flags:n.runtime.flags,legacyFlags:"legacyFlags"in n.runtime?n.runtime.legacyFlags:[],description:n.runtime.description,legacyTopLevelFlags:n.runtime.legacyTopLevelFlags})),i2=W2.slice().sort((n,t)=>n.install.order-t.install.order).map((n)=>({id:n.id,...n.install})).map(({order:n,...t})=>t),n5=Object.fromEntries(W2.map((n)=>[n.id,n.displayName]));function p2(n){return W2.find((t)=>t.id===n)?.displayName??n}function m2(n){return W2.find((t)=>t.id===n)?.install.installLabel??n}import{homedir as qs}from"node:os";import{isAbsolute as ha,join as _t}from"node:path";function wa(n){if(n!==void 0&&n!==null&&!ha(n))return"unknown";try{let t=Xn(),e=n?on(n,un,t):void 0,r=process.env.HOME||qs(),a=[["codex",process.env.CODEX_HOME||_t(r,".codex")],["copilot-cli",process.env.COPILOT_HOME||_t(r,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||_t(r,".claude")]],l=e?a.flatMap(([d,s])=>{if(!ha(s))return[];return ya(e,on(s,un,t))?[d]:[]}):[];if(l.length===1)return l[0]??"unknown";if(l.length>1)return"unknown"}catch(t){if(t instanceof Qn)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var Et="PreToolUse",xa="BeforeTool",ma="pre_tool_call",Pt="PreToolUse";var js=new Map([["Bash","posix"],["PowerShell","powershell"]]);function Fs(n){return Q(n,js)}async function ga(){await X({agent:"claude-code",getAgent:(n)=>wa(n.transcript_path),createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:Et,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===Et,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Fs(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}var zs=new Map([["bash","auto"],["Bash","auto"]]);function Bs(n){return Q(n,zs)}async function $a(){await X({agent:"copilot-cli",createDenyOutput:(n)=>({permissionDecision:"deny",permissionDecisionReason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolName,getToolInput:(n,t,e)=>{if(typeof n.toolArgs!=="string")return e({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let r=Tt(n.toolArgs,e,"Failed to parse toolArgs JSON.");if(r===void 0)return{ok:!1};return{ok:!0,input:r,route:Bs(t)}},getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>typeof n.sessionId==="string"&&n.sessionId.trim()?n.sessionId:void 0})}var Js=new Map([["Shell","auto"]]);function Ss(n){return Q(n,Js)}async function Da(){await X({agent:"cursor",createDenyOutput:(n)=>({permission:"deny",user_message:n,agent_message:n}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Ss(t)}),getContext:Zs,getSessionId:(n)=>n.conversation_id})}function Zs(n,t,e,r){let a=Qs(n);if(!a[0])return R(r,t,e),null;let l=pn(Ys(n.cwd),a);if(!l)return R(r,t,e,typeof n.cwd==="string"?n.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:l,executionCwd:l,policyConfigCwds:a};if(!Object.hasOwn(t,"working_directory"))return{configCwd:l,executionCwd:l,policyConfigCwds:a};let d=t.working_directory;if(typeof d!=="string"||d.trim()==="")return R(r,t,e),null;let s=pn(d,a);if(!s)return R(r,t,e,d),null;return{configCwd:l,executionCwd:s,policyConfigCwds:a}}function Qs(n){return Xs(n).flatMap((t)=>{let e=s2([t]);return e?[e]:[]})}function Xs(n){if(n.workspace_roots===void 0)return typeof n.cwd==="string"&&n.cwd.trim()!==""?[n.cwd]:[];if(!Array.isArray(n.workspace_roots))return[];return n.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function Ys(n){return typeof n==="string"&&n.trim()!==""?n:"."}var Rs=new Map([["run_shell_command","auto"]]);function As(n){return Q(n,Rs)}async function ka(){await X({agent:"gemini-cli",createDenyOutput:(n)=>({decision:"deny",reason:n,systemMessage:n}),isSupported:(n)=>n.hook_event_name===xa,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:As(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}import{resolve as Hs}from"node:path";var Cs=new Map([["terminal","posix"]]);async function qa(){await X({agent:"hermes-agent",createDenyOutput:(n)=>({action:"block",message:n}),isSupported:(n)=>n.hook_event_name===ma,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Q(t,Cs)}),getContext:Ms,getSessionId:(n)=>n.session_id})}function Ms(n,t,e,r){let a=I(n.cwd,t,e,r);if(!a)return null;if(!t||typeof t!=="object"||Array.isArray(t))return a;if(!Object.hasOwn(t,"workdir"))return a;let l=t.workdir;if(typeof l!=="string"||l.trim()==="")return R(r,t,e),null;let d=s2([Hs(a.configCwd,l)]);if(!d)return R(r,t,e,l),null;return{...a,executionCwd:d}}var Ws=new Map([["Bash","posix"]]);function Ks(n){return Q(n,Ws)}async function ja(){await X({agent:"kimi-code",createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:Pt,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===Pt,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Ks(t)}),getContext:(n,t,e,r)=>I(n.cwd,t,e,r),getSessionId:(n)=>n.session_id})}var Vs={"antigravity-cli":pa,"claude-code":ga,"copilot-cli":$a,cursor:Da,"gemini-cli":ka,"hermes-agent":qa,"kimi-code":ja},K2=fa.map((n)=>({...n,run:Vs[n.id]}));function Fa(n){let t=j({label:"hook",booleans:Object.fromEntries(K2.map((r)=>[r.id,[...r.flags,...r.legacyFlags]]))},n);if(t.errors.length>0)return;let e=K2.filter((r)=>t.flags[r.id]);return e.length===1?e[0]:void 0}function za(n){return K2.find((t)=>t.legacyTopLevelFlags.some((e)=>e===n))}var Gs=K2.map((n)=>({flags:n.flags.join(", "),description:n.description})),Us=K2.flatMap((n)=>n.flags.map((t)=>`cc-safety-net hook ${t}`)),Ba={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...Gs,{flags:"-h, --help",description:"Show this help"}],examples:Us};var Ja={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...i2.map((n)=>({flags:n.flag,description:`Install ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...i2.map((n)=>`cc-safety-net install ${n.flag}`)]},Sa={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...i2.map((n)=>({flags:n.flag,description:`Uninstall ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...i2.map((n)=>`cc-safety-net uninstall ${n.flag}`)]},Za={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var Qa={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var V2={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source>",description:"Add a rulebook source and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Refresh rulebook lock/cache state"},{usage:"sync",description:"Sync configured rulebooks"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk","cc-safety-net rule add project-rules","cc-safety-net rule sync","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var Xa={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var Ya={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var Ra=[Xa,na,Qa,ta,V2,Ja,Za,Sa,Ba,ea,Ya];function Os(n){return n.aliases??[]}function Ts(n){return!n.hidden}function Yn(n){let t=n.toLowerCase();return Ra.find((e)=>e.name.toLowerCase()===t||Os(e).some((r)=>r.toLowerCase()===t))}function Aa(){return Ra.filter(Ts)}import{readFileSync as _s}from"node:fs";import{basename as Es}from"node:path";function Ps(n){let t=Date.now()-n.getTime(),e=Math.floor(t/60000),r=Math.floor(t/3600000),a=Math.floor(r/24);if(a>0)return`${a}d ago`;if(r>0)return`${r}h ago`;if(e>0)return`${e}m ago`;return"just now"}function Rn(n=7,t=d2()){let e=Date.now()-n*24*60*60*1000,r=[],a=new Set,l=0,d,s,i,c;if(t)y2(t);let L={count:0},u=t?o2(t,L):[];for(let o of u)try{let v=_s(o,"utf-8").trim().split(`
`).filter(Boolean);for(let f of v)try{let w=JSON.parse(f);if(w.decision==="allow")continue;let x=new Date(w.ts).getTime();if(x>=e){if(l++,a.add(w.sessionId??Es(o,".jsonl")),s===void 0||x<=s)d=w.ts,s=x;if(c===void 0||x>c)i=w.ts,c=x;Is(r,w,x)}}catch{L.count++}}catch{L.count++}let p=r.map((o)=>({timestamp:o.ts,command:o.command,reason:o.reason,relativeTime:Ps(new Date(o.ts))}));return{totalBlocked:l,sessionCount:a.size,recentEntries:p,oldestEntry:d,newestEntry:i,unreadable:L.count}}function Is(n,t,e){let r=n.findIndex((a)=>e>new Date(a.ts).getTime());if(r===-1){if(n.length<3)n.push(t);return}if(n.splice(r,0,t),n.length>3)n.pop()}import{dirname as Ns}from"node:path";function Ha(n,t,e,r,a){let l;try{if(m(r)===null)return{path:n,exists:!1,valid:!1,ruleCount:0};l=r2(r),l.errors.push(...a2(n,t,{userConfigDir:e},a))}catch(d){if(!(d instanceof S))throw d;l={errors:[d.message],ruleNames:new Set}}return{path:n,exists:!0,valid:l.errors.length===0,ruleCount:l.ruleNames.size,...l.errors.length>0?{errors:l.errors}:{}}}function n3(n,t){return{source:t,name:n.name,command:n.command,subcommand:n.subcommand,blockArgs:[...n.block_args],reason:n.reason}}function Ca(n,t){let e=t?.userConfigPath??E(),r=t?.projectConfigPath??_(n),a=Ns(e),l=u2({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),d=P({cwd:n,userConfigPath:e,projectConfigPath:r,userConfigDir:a}),s=new Map(l.rulebooks.flatMap((i)=>i.rules.map((c)=>[c,i.source])));return{userConfig:Ha(e,Y2({userConfigPath:e}),a,d.userConfigTarget,d.userScope),projectConfig:Ha(r,R2(r),a,d.projectConfigTarget,d.projectScope),effectiveRules:l.rules.map((i)=>n3(i,s.get(i.name)??"project")),shadowedRules:[]}}var t3=[{flag:D.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:D.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:D.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:D.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:D.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:D.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:D.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:D.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function Ma(){return[...t3.map((n)=>({name:n.flag.name,value:Mt(n.flag),isSet:Wt(n.flag),legacyName:n.flag.legacyName,legacyValue:n.flag.legacyName?process.env[n.flag.legacyName]:void 0,legacyIsSet:n.flag.legacyName?process.env[n.flag.legacyName]!==void 0:void 0,description:n.description,defaultBehavior:n.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var Wa={error:0,warning:1,info:2},e3=["policy","config","audit"];function r3(n){return n.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var a3=[{derive:(n)=>n.hooks.length>0&&n.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(n)=>n.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let e=p2(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${e} inspection failed`,detail:`Doctor could not verify the ${e} integration configuration.`,fixHint:`Correct the reported ${e} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(n)=>n.userConfig.exists&&!n.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.userConfig.path}]:[]},{derive:(n)=>n.projectConfig.exists&&!n.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.projectConfig.path}]:[]},{derive:(n)=>n.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${n.configState.reason}`,fixHint:"Correct the named source, run `cc-safety-net rule sync` for a rule source, then rerun doctor."}]:[]},{derive:(n)=>{let t=n.environment.find((e)=>e.name==="CC_SAFETY_NET_AUDIT_SCOPE");return Ct(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...e3.map((n)=>({derive:(t)=>t.posture.directories.filter((e)=>e.kind===n&&e.status==="unsafe").map((e)=>({checkId:`posture.${n}-directory-unsafe`,severity:"error",title:`${n[0]?.toUpperCase()}${n.slice(1)} directory is unsafe`,detail:`The ${n} directory ${r3(e.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...e.path?{path:e.path}:{}}))})),{derive:(n)=>{let t=[...n.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function Ka(n){return a3.flatMap((t,e)=>t.derive(n).map((r,a)=>({finding:r,catalogOrder:e,occurrence:a}))).sort((t,e)=>Wa[t.finding.severity]-Wa[e.finding.severity]||t.catalogOrder-e.catalogOrder||t.occurrence-e.occurrence).map((t)=>t.finding)}function N(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var l3=(n)=>N()?`\x1B[32m${n}\x1B[0m`:n,d3=(n)=>N()?`\x1B[33m${n}\x1B[0m`:n,s3=(n)=>N()?`\x1B[34m${n}\x1B[0m`:n,i3=(n)=>N()?`\x1B[35m${n}\x1B[0m`:n,c3=(n)=>N()?`\x1B[36m${n}\x1B[0m`:n,L3=(n)=>N()?`\x1B[31m${n}\x1B[0m`:n,o3=(n)=>N()?`\x1B[2m${n}\x1B[0m`:n,u3=(n)=>N()?`\x1B[1m${n}\x1B[0m`:n,h={green:l3,yellow:d3,blue:s3,magenta:i3,cyan:c3,red:L3,dim:o3,bold:u3},p3="\x1B[0m",v3=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function b3(n){let t=n;return()=>{return t=(t*1664525+1013904223)%4294967296,t/4294967296}}function f3(n){let t=[...v3],e=b3(n);for(let r=t.length-1;r>0;r--){let a=Math.floor(e()*(r+1)),l=t[r];t[r]=t[a],t[a]=l}return t}function h3(n,t=0){if(!N())return"";let e=f3(t);return`\x1B[38;5;${e[n%e.length]}m`}function Va(n,t,e=0){if(!N())return`"${n}"`;return`${h3(t,e)}"${n}"${p3}`}var y3=new RegExp("\x1B\\[[0-9;]*m","g"),It=(n)=>n.replace(y3,"").length;function g2(n){let t=(n.headers??n.rows[0]??[]).map((d,s)=>{let i=Math.max(...n.rows.map((c)=>It(c[s]??"")));return Math.max(It(d),i)}),e=(d,s)=>d+" ".repeat(Math.max(0,s-It(d))),r=(d,s)=>s[0]+t.map((i)=>d.repeat(i+2)).join(s[1])+s[2],a=(d)=>`│ ${d.map((s,i)=>e(s,t[i]??0)).join(" │ ")} │`,l=n.headers?[`   ${a(n.headers)}`,`   ${r("─",["├","┼","┤"])}`]:[];return[`   ${r("─",["┌","┬","┐"])}`,...l,...n.rows.map((d)=>`   ${a(d)}`),`   ${r("─",["└","┴","┘"])}`].join(`
`)}function Ga(n){let t=[];t.push("Hook Integration"),t.push(w3(n));let e=[],r=[];for(let a of n){let l=p2(a.platform);if(a.errors&&a.errors.length>0)for(let d of a.errors)if(a.configured)e.push({platform:l,message:d});else r.push({platform:l,message:d})}for(let a of e)t.push(`   Warning (${a.platform}): ${a.message}`);for(let a of r)t.push(h.red(`   Error (${a.platform}): ${a.message}`));return t.join(`
`)}function w3(n){let t=["Platform","Discovery","Configuration","Inspection"],e=n.map((r)=>{let a=p2(r.platform);if(r.inspectionStatus==="not-inspected"){let i=h.dim("Not inspected");return[a,i,i,i]}let l=r.detected?h.green("Detected"):r.inspectionStatus==="failed"?h.red("Unknown"):h.dim("Not detected"),d=r.configured?h.green("Configured"):r.detected?h.yellow("Not configured"):r.inspectionStatus==="failed"?h.red("Unknown"):h.dim("Not applicable"),s=r.inspectionStatus==="verified"?h.green("Verified"):r.inspectionStatus==="failed"?h.red("Failed"):h.dim("Not applicable");return[a,l,d,s]});return g2({headers:t,rows:e})}function Ua(n){let e=["Guard Engine Verification",`   Synthetic self-test: ${n.failed>0?h.red(`${n.passed}/${n.total} FAIL`):h.green(`${n.passed}/${n.total} passed`)}`],r=n.results.filter((a)=>!a.passed);if(r.length>0){e.push(""),e.push(h.red("   Failures:"));for(let a of r)e.push(h.red(`   • ${a.description}`)),e.push(h.red(`     expected ${a.expected}, got ${a.actual}`))}return e.join(`
`)}function x3(n){if(n.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],e=n.map((r)=>[r.source,r.name,r.subcommand?`${r.command} ${r.subcommand}`:r.command,r.blockArgs.join(", ")]);return g2({headers:t,rows:e})}function Oa(n){let t=[];if(t.push("Configuration"),t.push(m3(n.userConfig,n.projectConfig)),t.push(""),n.effectiveRules.length>0)t.push(`   Effective rules (${n.effectiveRules.length} total):`),t.push(x3(n.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let e of n.shadowedRules)t.push(""),t.push(`   Note: Project rule "${e.name}" shadows user rule with same name`);return t.join(`
`)}function m3(n,t){let e=["Scope","Status"],r=(l)=>{if(!l.exists)return h.dim("N/A");if(!l.valid)return h.red(`Invalid (${l.errors?.[0]??"unknown error"})`);return h.green("Configured")},a=[["User",r(n)],["Project",r(t)]];return g2({headers:e,rows:a})}function Ta(n){let t=[];return t.push("Environment"),t.push(g3(n)),t.join(`
...
`)}function Ea(n){let t=["Findings"];if(n.length===0)return t.push("   No findings from inspected doctor facts."),t.join(`
...
`)}function g3(n){let t=["Variable","Status","Legacy"],e=n.map((r)=>{let a=r.isSet?h.green("✓"):h.dim("✗"),l=r.legacyName&&r.legacyIsSet?`${r.legacyName} ${h.green("✓")}`:r.legacyName??"";return[r.name,a,l]});return g2({headers:t,rows:e})}function Pa(n){let t=[];if(n.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${n.totalBlocked} blocked / ${n.sessionCount} sessions)`),t.push($3(n.recentEntries));if(n.unreadable>0)t.push(`   Warning: ${n.unreadable} audit log ${n.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function $3(n){let t=["Time","Command"],e=n.map((r)=>{let a=F(r.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),l=a.length>40?`${a.slice(0,37)}...`:a;return[r.relativeTime,l]});return g2({headers:t,rows:e})}function Ia(n){let t=[];if(t.push("Update Check"),n.latestVersion===null&&!n.error)return t.push(An([["Status",h.dim("Skipped")],["Installed",n.currentVersion]])),t.join(`
...
${n.findings.length} ${r}: ${e.join(", ")}.`;if(t.error>0)return h.red(a);if(t.warning>0)return h.yellow(a);return h.blue(a)}import{lstatSync as k3}from"node:fs";import{dirname as Nt}from"node:path";function ne(n,t){try{let e=k3(t);if(e.isSymbolicLink())return{kind:n,path:t,status:"unsafe",issues:["symlink"]};if(!e.isDirectory())return{kind:n,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:n,path:t,status:"unknown",issues:[]};let r=[...e.uid!==process.getuid()?["ownership"]:[],...(e.mode&18)!==0?["permissions"]:[]];return{kind:n,path:t,status:r.length>0?"unsafe":"safe",issues:r}}catch(e){if(typeof e==="object"&&e!==null&&"code"in e&&e.code==="ENOENT")return{kind:n,path:t,status:"not-applicable",issues:[]};return{kind:n,path:t,status:"unknown",issues:[]}}}function t1(n){let t=d2();return{directories:[ne("policy",Nt(Nt(n))),ne("config",Nt(n)),...t?[ne("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as q3}from"node:child_process";import{existsSync as e1}from"node:fs";import{delimiter as j3,extname as F3,join as z3}from"node:path";import{stripVTControlCharacters as r1}from"node:util";var l1="1.0.6",B3=5000,J3="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function z(){return l1}function te(n,t){let e=n[t];if(e)return e;let r=Object.keys(n).find((a)=>a.toLowerCase()===t.toLowerCase()&&!!n[a]);return r?n[r]:e}function S3(n){return(te(n,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function Z3(n,t){let e=F3(n)?[n]:[...S3(t).map((r)=>`${n}${r}`),n];if(n.includes("/")||n.includes("\\"))return e.find((r)=>e1(r))??n;return(te(t,"PATH")??"").split(j3).flatMap((r)=>e.map((a)=>z3(r,a))).find((r)=>e1(r))??n}function a1(n){if(!/[\s"&|<>^]/.test(n))return n;return`"${n.replace(/"/g,'""')}"`}function Q3(n,t){let[e,...r]=n,a=t[J3]==="win32"?"win32":process.platform;if(!e||a!=="win32")return{cmd:e??"",args:r};let l=Z3(e,t);if(!/\.(?:bat|cmd)$/i.test(l))return{cmd:l,args:r};return{cmd:te(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",a1(l),...r.map(a1)].join(" ")]}}var Hn=async(n,t=B3)=>{let e=await X3(n,{timeoutMs:t});if(e.code!==0)return null;return r1(e.stdout).trim()||r1(e.stderr).trim()||null};function X3(n,t){let[e,...r]=n;if(!e)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((a)=>{try{let l=Q3([e,...r],process.env),d=q3(l.cmd,l.args,{stdio:["ignore","pipe","pipe"]}),s=!1,i="",c="";d.stdout.on("data",(p)=>{i+=p.toString()}),d.stderr.on("data",(p)=>{c+=p.toString()});let L=(p)=>{if(s)return;s=!0,clearTimeout(u),a(p)},u=setTimeout(()=>{d.kill(),L({code:null,stdout:i,stderr:c})},t.timeoutMs);d.on("close",(p)=>{L({code:p,stdout:i,stderr:c})}),d.on("error",()=>{L({code:null,stdout:i,stderr:c})})}catch{a({code:null,stdout:"",stderr:""})}})}function Z(n){if(!n)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(n);if(t)return t[1]??null;let e=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(n);if(e)return e[1]??null;return n.split(`
`)[0]?.trim()||null}async function vn(n=Hn){let[t,e,r,a,l,d,s,i,c,L,u,p,o,b,v,f]=await Promise.all([n(["claude","--version"]),n(["agy","--version"]),n(["opencode","--version"]),n(["codex","--version"]),n(["codex","plugin","list"]),n(["gemini","--version"]),n(["copilot","--binary-version"]),n(["hermes","--version"]),n(["kimi","--version"]),n(["openclaw","--version"]),n(["pi","--version"]),n(["cursor","--version"]),n(["amp","--version"]),n(["node","--version"]),n(["npm","--version"]),n(["bun","--version"])]);return{version:l1,claudeCodeVersion:Z(t),antigravityCliVersion:Z(e),openCodeVersion:Z(r),codexCliVersion:Z(a),codexPluginListOutput:l,geminiCliVersion:Z(d),copilotCliVersion:Z(s),hermesAgentVersion:Z(i),kimiCodeVersion:Z(c),openClawVersion:Z(L),piCliVersion:Z(u),cursorVersion:Z(p),ampVersion:Z(o),nodeVersion:Z(b),npmVersion:Z(v),bunVersion:Z(f),platform:`${process.platform} ${process.arch}`}}function ee(n,t){if(t==="dev")return!1;let e=n.split(".").map(Number),r=t.split(".").map(Number),[a=0,l=0,d=0]=e,[s=0,i=0,c=0]=r;if(a!==s)return a>s;if(l!==i)return l>i;return d>c}async function G2(){let n=z(),t=new AbortController,e=setTimeout(()=>t.abort(),3000);try{let r=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!r.ok)return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${r.status}`};let a=await r.json(),l=ee(a.version,n);return{currentVersion:n,latestVersion:a.version,updateAvailable:l}}catch(r){return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:r instanceof Error?r.message:"Network error"}}finally{clearTimeout(e)}}import*as p1 from"node:readline";var c1=(n)=>`\x1B[${n}B`,Y3=(n)=>`\x1B[${n}A`;var d1=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function R3(n){return new Promise((t)=>setTimeout(t,n))}function A3(n,t,e){if(!e)return t(n);if(e.aborted)return Promise.resolve();return new Promise((r,a)=>{let l=()=>e.removeEventListener("abort",d),d=()=>{l(),r()};e.addEventListener("abort",d,{once:!0}),t(n).then(()=>{l(),r()},(s)=>{l(),a(s)})})}function bn(n,t){return n&&n>0?n:t}function Cn(n){return Math.max(0,Math.min(1,n))}function U2(n){return Math.max(0,Math.min(255,Math.round(n)))}function re(n){return n<=0.0031308?12.92*n:1.055*n**0.4166666666666667-0.055}function H3(n,t,e){let r=e*Math.PI/180,a=t*Math.cos(r),l=t*Math.sin(r),d=(n+0.3963377774*a+0.2158037573*l)**3,s=(n-0.1055613458*a-0.0638541728*l)**3,i=(n-0.0894841775*a-1.291485548*l)**3;return{blue:U2(re(Cn(-0.0041960863*d-0.7034186147*s+1.707614701*i))*255),green:U2(re(Cn(-1.2684380046*d+2.6097574011*s-0.3413193965*i))*255),red:U2(re(Cn(4.0767416621*d-3.3077115913*s+0.2309699292*i))*255)}}function ae(n,t){let e=(t*n*180/Math.PI%360+360)%360;return H3(0.72,0.15,e)}function L1(n,t=0.1){let e=ae(t,n);return`\x1B[38;2;${e.red};${e.green};${e.blue}m`}function C3(n,t){return{blue:U2(n.blue+(255-n.blue)*t),green:U2(n.green+(255-n.green)*t),red:U2(n.red+(255-n.red)*t)}}function o1(n,t,e){let r=Math.imul(n+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(e+374761393,2654435761),a=r^r>>>15,l=Math.imul(a,739982445),d=l^l>>>12,s=Math.imul(d,695872825);return((s^s>>>15)>>>0)/4294967296}function M3(n,t,e){let r=Math.floor(o1(n,t,e)*d1.length);return d1[r]??"░"}function s1(n){let t=Cn(n);return t*t*t*(t*(t*6-15)+10)}function W3(n){if(n.length===0)return"";let t=[],e=!1,r="";for(let a of n){let l=`${a.red};${a.green};${a.blue}`;if(a.bold!==e)t.push(a.bold?"\x1B[1m":"\x1B[22m"),e=a.bold;if(l!==r)t.push(`\x1B[38;2;${l}m`),r=l;t.push(a.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function K3(n,t,e,r,a){return n.map((l,d)=>({...ae(e,r+t+d/a),bold:!1,character:l}))}function V3(n,t,e,r,a,l,d,s){let i=Math.max(1,r*0.75),c=Math.min(1,e/i),L=a*s1(c),u=Math.max(0,(e-i)/Math.max(1,r-i)),p=(1-s1(e/r))*s*2,o=0.35*Math.max(0,1-u*2),b=c>=1,v=Math.min(n.length,Math.ceil(L+2+1));return n.slice(0,v).map((f,w)=>{let x=ae(l,d+t+w/s+p),y=w+o1(t,w,7919)*2-1;if(y>L+2)return{...x,bold:!1,character:" "};let J=L-y,z2=0.8*Math.exp(-(J*J)/12.5),nn=Math.min(0.9,z2+o),bt=!b&&y>L-4;return{...C3(x,nn),bold:nn>0.3,character:bt?M3(t,w,e):f}})}function i1(n){return`\x1B[?2026h${n.map((t,e)=>`\x1B8${e>0?c1(e):""}${W3(t)}`).join("")}\x1B[?2026l`}async function le(n,t={}){if(!n)return;let e=t.output??process.stdout,r=t.sleep??R3,a=bn(t.frequency,0.1),l=t.seed??0,d=bn(t.speed,40),s=bn(t.spread,3),i=bn(t.frameRate,60),c=Math.max(1,Math.floor(bn(t.duration,12))),L=n.split(`
...
`.repeat(L.length-1)}${Y3(L.length-1)}`:""}\x1B7`);try{for(let v=1;v<=o;v+=1){if(t.signal?.aborted)break;e.write(i1(L.map((f,w)=>V3(f,w,v,o,u,a,l,s)))),await A3(b,r,t.signal)}}finally{if(e.write(i1(L.map((v,f)=>K3(v,f,a,l,s)))),e.write("\x1B8"),L.length>1)e.write(c1(L.length-1));e.write(`
\x1B[0m\x1B[?25h`)}}var u1=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function G3(n){return Boolean(n.isTTY)}async function Mn(n={}){let t=n.output??process.stdout;if(!G3(t))return;let e=n.input??process.stdin,r={duration:n.duration,frequency:n.frequency,output:t,seed:n.seed??Math.random()*8192,sleep:n.sleep,speed:n.speed,spread:n.spread};if(!e.isTTY||typeof e.setRawMode!=="function"){await le(u1,r);return}let a=new AbortController,l=e.readableFlowing===!0,d=e.isRaw===!0,s=!1,i=(c,L)=>{if(L.ctrl&&L.name==="c")s=!0;if(s||L.name==="return"||L.name==="enter")a.abort()};p1.emitKeypressEvents(e),e.on("keypress",i),e.setRawMode(!0),e.resume();try{await le(u1,{...r,signal:a.signal})}finally{if(e.off("keypress",i),e.setRawMode(d),!l)e.pause()}if(!s)return;if(n.onInterrupt){n.onInterrupt();return}process.kill(process.pid,"SIGINT")}var v1="\r\x1B[2K",U3="\x1B[?25l",O3="\x1B[39m",T3="\x1B[?25h",_3=100,E3=0.55,P3=80,b1=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function I3(n){return new Promise((t)=>setTimeout(t,n))}async function N3(n,t){let e=t.output??process.stdout;if(!e.isTTY){await n;return}let r=t.sleep??I3,a=!1,l=n.then((s)=>{return a=!0,s},(s)=>{throw a=!0,s});if(await Promise.race([l.then(()=>!0),r(_3).then(()=>!1)]))return;e.write(U3);try{for(let s=0;!a;s+=1)e.write(`${v1}${L1(s*E3)}${b1[s%b1.length]}${O3} ${t.loadingMessage??"Loading…"}`),await Promise.race([l,r(P3)]);await l}finally{e.write(`${v1}${T3}`)}}async function Wn(n,t,e,r={}){let a=t();if(n)await e();if(n&&a.ready)await N3(a.ready,r);return a.finish()}import{homedir as hc}from"node:os";import{lstatSync as ii,readFileSync as ci}from"node:fs";var fn="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp";import{existsSync as ei,lstatSync as h1,mkdirSync as ri,readFileSync as de,rmSync as ai}from"node:fs";import{dirname as y1,join as Kn}from"node:path";import{fileURLToPath as li}from"node:url";import{renameSync as ni,writeFileSync as ti}from"node:fs";function B(n,t){let e=`${n}.${process.pid}.tmp`;ti(e,t),ni(e,n)}var f1=Kn("amp","cc-safety-net.ts");function Vn(n){return Kn(n,".config","amp","plugins","cc-safety-net.ts")}function di(){let n=y1(li(import.meta.url));return[Kn(n,"..",f1),Kn(n,"..","..","..","dist",f1)]}function si(n=di()){let t=n.find((e)=>ei(e)&&h1(e).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function w1(n){try{return h1(n)}catch{return}}function x1(n){return n.subarray(0,Buffer.byteLength(fn)).toString("utf-8")===fn}function m1(n,t=si()){let e=de(t),r=Vn(n),a=w1(r);if(!a)return ri(y1(r),{recursive:!0}),B(r,e),{path:r,alreadyInstalled:!1};if(a.isSymbolicLink()||!a.isFile())throw Error(`Refusing to overwrite ${r}: not a regular file. Move or remove it and rerun install --amp.`);let l=de(r);if(l.equals(e))return{path:r,alreadyInstalled:!0};if(x1(l))return B(r,e),{path:r,alreadyInstalled:!1};throw Error(`Refusing to overwrite unmanaged file at ${r}. Move or remove it and rerun install --amp.`)}function g1(n){let t=Vn(n),e=w1(t);if(!e)return{path:t,alreadyInstalled:!1};if(e.isSymbolicLink()||!e.isFile())throw Error(`Refusing to remove ${t}: not a regular file. Move or remove it manually.`);if(!x1(de(t)))throw Error(`Refusing to remove unmanaged file at ${t}. Move or remove it manually.`);return ai(t),{path:t,alreadyInstalled:!0}}function Li(n){return/^\/\/ version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function $1(n){let t=Vn(n.homeDir),e=(()=>{try{return ii(t)}catch{return}})();if(!e)return{platform:"amp",status:"n/a",configPath:t};if(e.isSymbolicLink()||!e.isFile())return{platform:"amp",status:"n/a",configPath:t,errors:[`${t} is a symlink or not a regular file; move or remove it before installing`]};let r;try{r=ci(t,"utf-8")}catch(l){return{platform:"amp",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${l instanceof Error?l.message:String(l)}`]}}if(!r.startsWith(fn))return{platform:"amp",status:"n/a",configPath:t,errors:[`Unmanaged file occupies ${t}; move or remove it before installing`]};let a=Li(r)!==z();return{platform:"amp",status:"configured",method:"plugin file",configPath:t,errors:a?["Installed Amp plugin is outdated; run install --amp to update"]:void 0}}import{existsSync as ui,readFileSync as pi}from"node:fs";import{join as oi}from"node:path";function hn(n){return oi(n,".gemini","config","hooks.json")}var vi=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function bi(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];return Object.values(n).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let e=t,r=e.PreToolUse;if(!Array.isArray(r))return[];return r.flatMap((a)=>{if(!a||typeof a!=="object"||Array.isArray(a))return[];let l=a.hooks;if(!Array.isArray(l))return[];return l.flatMap((d)=>{if(!d||typeof d!=="object"||Array.isArray(d))return[];let s=d.command;if(typeof s!=="string"||!vi.test(s))return[];return[{command:s,enabled:e.enabled!==!1}]})})})}function D1(n){let t=hn(n.homeDir);if(!ui(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let e;try{e=bi(JSON.parse(pi(t,"utf-8")))}catch(r){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${r instanceof Error?r.message:String(r)}`]}}if(e.some((r)=>r.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(e.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as k1}from"node:path";import{existsSync as fi,lstatSync as hi,readFileSync as yi}from"node:fs";function n2(n,t=(e)=>e){if(!fi(n))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(yi(n,"utf-8")))}}catch{return{kind:"unreadable"}}}function Y(n){try{return hi(n)}catch{return}}function Gn(n,t){let e=Y(t);if(!e)return{platform:n,status:"n/a",configPath:t};if(!e.isSymbolicLink()&&e.isDirectory())return;return{platform:n,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function g(n,t){return typeof n==="object"&&n!==null?n[t]:void 0}var se="cc-safety-net@cc-marketplace";function q1(n){return k1(n,".claude","plugins","installed_plugins.json")}function j1(n,t){let e=g(g(n,"plugins"),t);return Array.isArray(e)&&e.length>0}function Un(n,t){let e=n2(q1(n));return e.kind==="ok"&&j1(e.value,t)}function ie(n){let t=q1(n),e=n2(t);if(e.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(e.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!j1(e.value,se))return{platform:"claude-code",status:"n/a"};let r=k1(n,".claude","settings.json"),a=n2(r);if(a.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(a.kind==="ok"&&g(g(a.value,"enabledPlugins"),se)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:r,errors:[`${se} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function F1(n){return ie(n.homeDir)}function z1(n){if(!n.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=n.codexPluginListOutput.split(`
`).find((e)=>e.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as Tn,readdirSync as wi,readFileSync as xi}from"node:fs";import{join as M}from"node:path";var t2="cc-safety-net@cc-marketplace",On=["cc-marketplace","cc-safety-net"],B1=["_direct","copilot-safety-net"];function ce(n,t){let e=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${e}([^a-z0-9-]|$)`,"m").test(n??"")}function J1(n){return ce(n,"cc-safety-net@cc-marketplace")}function S1(n){return ce(n,"cc-marketplace")}function Z1(n){return ce(n,"copilot-safety-net")}function C(n){let t="",e=0,r=!1,a=!1,l=-1;while(e<n.length){let d=n[e],s=n[e+1];if(a){t+=d,a=!1,e++;continue}if(d==='"'&&!r){r=!0,l=-1,t+=d,e++;continue}if(d==='"'&&r){r=!1,t+=d,e++;continue}if(d==="\\"&&r){a=!0,t+=d,e++;continue}if(r){t+=d,e++;continue}if(d==="/"&&s==="/"){while(e<n.length&&n[e]!==`
`)e++;continue}if(d==="/"&&s==="*"){e+=2;while(e<n.length-1){if(n[e]==="*"&&n[e+1]==="/"){e+=2;break}e++}continue}if(d===","){l=t.length,t+=d,e++;continue}if(d==="}"||d==="]"){if(l!==-1){let i=t.slice(l+1);if(/^\s*$/.test(i))t=t.slice(0,l)+i}l=-1,t+=d,e++;continue}if(!/\s/.test(d))l=-1;t+=d,e++}return t}function Le(n){if(!n?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(n)}function X1(n,t){if(!n)return null;let e=n.match(/(\d+)\.(\d+)\.(\d+)/);if(!e)return null;let r=[Number(e[1]),Number(e[2]),Number(e[3])];for(let a=0;a<t.length;a++){let l=r[a]??0,d=t[a]??0;if(l!==d)return l>d}return!0}function mi(n){return X1(n,[0,0,422])}function gi(n){return X1(n,[1,0,8])}function yn(n){return process.env.COPILOT_HOME||M(n,".copilot")}function ue(n){return(n.hooks?.preToolUse??[]).some((e)=>{if(e.type!=="command")return!1;return Le(e.command)||Le(e.bash)||Le(e.powershell)})}function pe(n,t){try{return JSON.parse(C(xi(n,"utf-8")))}catch(e){t?.push(`Failed to parse ${n}: ${e instanceof Error?e.message:String(e)}`);return}}function Y1(n,t){try{return wi(n).filter((e)=>e.endsWith(".json")).sort((e,r)=>e.localeCompare(r))}catch(e){return t?.push(`Failed to read ${n}: ${e instanceof Error?e.message:String(e)}`),[]}}function $i(n,t){if(!Tn(n))return[];let e=[];for(let r of Y1(n,t)){let a=M(n,r),l=pe(a,t);if(l&&ue(l))e.push(a)}return e}function oe(n,t){if(!Tn(n))return;let e=pe(n,t);if(!e)return;return{path:n,config:e}}function Q1(n,t,e,r){if(t){n.push(`GitHub Copilot CLI ${t} does not support ${e}; requires ${r}+`);return}n.push(`GitHub Copilot CLI version unavailable; skipping ${e} because it requires ${r}+`)}function Di(n){let t=[n.localSettings,n.repoSettings,n.userConfig];for(let e of t){if(e?.config.disableAllHooks===!0)return e.path;if(e?.config.disableAllHooks===!1)return}return}function ki(n,t,e,r){let a=yn(n),l=M(t,".github","hooks"),d=M(a,"hooks"),s=M(t,".github","copilot"),i=gi(e),c=i===!0?r:void 0,L={userConfig:oe(M(a,"config.json"),c),repoSettings:oe(M(s,"settings.json"),c),localSettings:oe(M(s,"settings.local.json"),c)};if(i!==!1){let x=Di(L);if(x){if(i===null)r.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${x} as active`);return{activeConfigPaths:[],disabledBy:x}}}let u=$i(l,r),p=mi(e),o=p===!0?r:void 0,b=Tn(d)?Y1(d,o):[],v=[];for(let x of b){let y=M(d,x),J=pe(y,o);if(J&&ue(J))v.push(y)}if(p!==!0&&v.length>0)Q1(r,e,`user hook files in ${d}`,"0.0.422"),v.length=0;let f=[],w=[L.localSettings,L.repoSettings,L.userConfig];for(let x of w){if(!x)continue;if(!ue(x.config))continue;if(i===!0){f.push(x.path);continue}Q1(r,e,"inline hook definitions in Copilot config files","1.0.8");break}return{activeConfigPaths:[...f.filter((x)=>x.endsWith("settings.local.json")),...f.filter((x)=>x.endsWith("settings.json")),...u,...f.filter((x)=>x.endsWith("config.json")),...v]}}function R1(n){let t=[],e=ki(n.homeDir,n.cwd,n.copilotCliVersion,t);if(e.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:e.disabledBy,configPaths:[e.disabledBy],errors:t.length>0?t:void 0};let r=yn(n.homeDir),a=M(r,"installed-plugins",...On),l=Tn(a),d=M(r,"settings.json"),s=n2(d,C);if(l&&s.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(l&&s.kind==="ok"&&g(g(s.value,"enabledPlugins"),t2)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:d,errors:[`${t2} is installed but not enabled in Copilot CLI`]};if(l||e.activeConfigPaths.length>0){let i=l,c=e.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:i?"plugin config":"hook config",configPath:c??(i?a:void 0),configPaths:e.activeConfigPaths.length>0?e.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as Zi,readFileSync as Qi}from"node:fs";import{existsSync as A1,mkdirSync as qi,readFileSync as ji}from"node:fs";import{dirname as Fi,join as zi}from"node:path";var wn="npx -y cc-safety-net hook --cursor",H1=30;function En(n){return zi(n,".cursor","hooks.json")}function $2(n){return typeof n==="object"&&n!==null&&!Array.isArray(n)}function ve(){return{command:wn,timeout:H1,failClosed:!0}}function _n(n){return $2(n)&&n.command===wn}function Bi(n){return Object.keys(n).length===3&&n.command===wn&&n.timeout===H1&&n.failClosed===!0}function Ji(n){try{return JSON.parse(ji(n,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${n}: ${t.message}`);throw t}}function C1(n){let t=Ji(n);if(!$2(t))throw Error(`Cursor hooks config ${n} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${n} must set "version": 1`);if(t.hooks!==void 0&&!$2(t.hooks))throw Error(`Cursor hooks config ${n} "hooks" must be an object`);let e=$2(t.hooks)?t.hooks.preToolUse:void 0;if(e!==void 0&&!Array.isArray(e))throw Error(`Cursor hooks config ${n} "hooks.preToolUse" must be an array`);return t}function M1(n){let t=$2(n.hooks)?n.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function Si(n){if(!n.some(_n))return[...n,ve()];return n.reduce((t,e)=>{if(!_n(e))return t.result.push(e),t;if(!t.inserted)t.result.push(ve()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function W1(n,t,e){let r=$2(t.hooks)?t.hooks:{},a={...t,hooks:{...r,preToolUse:e}};B(n,`${JSON.stringify(a,null,2)}
`)}function K1(n){let t=En(n);if(!A1(t))return qi(Fi(t),{recursive:!0}),B(t,`${JSON.stringify({version:1,hooks:{preToolUse:[ve()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let e=C1(t),r=M1(e),a=r.filter(_n);if($2(e.hooks)&&Array.isArray(e.hooks.preToolUse)&&a.length===1&&a[0]!==void 0&&Bi(a[0]))return{path:t,alreadyInstalled:!0};return W1(t,e,Si(r)),{path:t,alreadyInstalled:!1}}function V1(n){let t=En(n);if(!A1(t))return{path:t,alreadyInstalled:!1};let e=C1(t),r=M1(e),a=r.filter((l)=>!_n(l));if(a.length===r.length)return{path:t,alreadyInstalled:!1};return W1(t,e,a),{path:t,alreadyInstalled:!0}}function Xi(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];let t=n.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let e=t.preToolUse;if(!Array.isArray(e))return[];return e.filter((r)=>!!r&&typeof r==="object"&&!Array.isArray(r)&&r.command===wn)}function Yi(n){let t=[];if(n.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let e=n[0];if(e&&e.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(e&&e.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function G1(n){let t=En(n.homeDir);if(!Zi(t))return{platform:"cursor",status:"n/a",configPath:t};let e;try{e=JSON.parse(Qi(t,"utf-8"))}catch(l){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${l instanceof Error?l.message:String(l)}`]}}let r=Xi(e);if(r.length===0)return{platform:"cursor",status:"n/a",configPath:t};let a=Yi(r);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:a.length>0?a:void 0}}import{existsSync as Ri}from"node:fs";import{join as be}from"node:path";var fe="gemini-safety-net";function he(n){let t=be(n,".gemini","extensions"),e=be(t,fe);if(!Ri(e))return{platform:"gemini-cli",status:"n/a"};let r=be(t,"extension-enablement.json"),a=n2(r);if(a.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let l=a.kind==="ok"?g(g(a.value,fe),"overrides"):void 0;if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:r,errors:[`${fe} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:e}}function U1(n){return he(n.homeDir)}import{readFileSync as t0}from"node:fs";import{join as e0}from"node:path";var W="cc-safety-net",O1="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function T1(n){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${n}
`}function Ai(n){return`${T1(n)}name: cc-safety-net
version: "${n}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function Hi(n){return`${T1(n)}"""CC Safety Net guard for Hermes Agent.
...
`}function xn(n){return[{name:"__init__.py",content:Hi(n)},{name:"plugin.yaml",content:Ai(n)}]}import{mkdirSync as Ci,readdirSync as Mi,readFileSync as Wi,rmSync as ye}from"node:fs";import{join as D2}from"node:path";var Ki="__pycache__";function we(n){let t=process.env.HERMES_HOME?.trim();return t?t:D2(n,".hermes")}function xe(n){return D2(we(n),"plugins",W)}function me(n){return n.startsWith(O1)}function ge(n,t){let e=xe(n),r=Y(e);if(r&&(r.isSymbolicLink()||!r.isDirectory()))throw Error(`Refusing to ${t} ${e}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return e}function _1(n,t){let e=Y(n);if(!e)return;if(e.isSymbolicLink()||!e.isFile())throw Error(`Refusing to ${t} ${n}: not a regular file. Move or remove it.`);let r=Wi(n,"utf-8");if(!me(r))throw Error(`Refusing to ${t} unmanaged file at ${n}. Move or remove it.`);return r}function E1(n){let t=ge(n,"install"),e=xn(z());if(e.map((a)=>_1(D2(t,a.name),"overwrite")).every((a,l)=>a===e[l]?.content))return{path:t,alreadyInstalled:!0};return Ci(t,{recursive:!0}),e.forEach((a)=>{B(D2(t,a.name),a.content)}),{path:t,alreadyInstalled:!1}}function $e(n){let t=ge(n,"remove");if(!Y(t))return[];return xn(z()).filter((e)=>_1(D2(t,e.name),"remove")!==void 0)}function P1(n){let t=ge(n,"remove");if(!Y(t))return{path:t,alreadyInstalled:!1};let e=$e(n);if(e.forEach((r)=>{ye(D2(t,r.name))}),ye(D2(t,Ki),{recursive:!0,force:!0}),Mi(t).length===0)ye(t,{recursive:!0});return{path:t,alreadyInstalled:e.length>0}}var Pn="hermes-agent",I1=/^([^\s#][^:]*):/,Vi=/^\s+([A-Za-z_][\w-]*):/,N1=/^\s+-\s*(.*)$/;function Gi(n){return n.trim().replace(/^(["'])(.*)\1$/,"$2")}function Ui(n){let t=n.split(/\r?\n/),e=t.findIndex((l)=>I1.exec(l)?.[1]?.trim()==="plugins");if(e===-1)return[];let r=t.slice(e+1),a=r.findIndex((l)=>I1.test(l));return a===-1?r:r.slice(0,a)}function n0(n,t){let e=Ui(n),r=e.findIndex((d)=>Vi.exec(d)?.[1]===t);if(r===-1)return[];let a=e.slice(r+1),l=a.findIndex((d)=>!N1.test(d));return(l===-1?a:a.slice(0,l)).map((d)=>Gi(N1.exec(d)?.[1]??""))}function Oi(n){try{return t0(e0(we(n),"config.yaml"),"utf-8")}catch{return}}function De(n){let t=Oi(n)??"";return n0(t,"enabled").includes(W)&&!n0(t,"disabled").includes(W)}function r0(n){return/^# version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function Ti(n,t){let e=Y(n);if(!e)return{error:`${t.name} is missing from ${n}; run install --hermes-agent`};if(e.isSymbolicLink()||!e.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{let r=t0(n,"utf-8");if(!me(r))return{error:`Unmanaged ${t.name} occupies ${n}; move or remove it`};if(r0(r)===z()&&r!==t.content)return{error:`Modified ${t.name} occupies ${n}; run install --hermes-agent to restore it`};return{content:r}}catch(r){return{error:`Failed to read ${n}: ${r instanceof Error?r.message:String(r)}`}}}function a0(n){let t=xe(n.homeDir),e=Gn(Pn,t);if(e)return e;let r=xn(z()).map((s)=>Ti(e0(t,s.name),s)),a=r.flatMap((s)=>("error"in s)?[s.error]:[]);if(a.length>0)return{platform:Pn,status:"n/a",configPath:t,errors:a};let l=r.some((s)=>("content"in s)&&r0(s.content)!==z()),d=l?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!De(n.homeDir))return{platform:Pn,status:"disabled",method:"plugin directory",configPath:t,errors:[`${W} is not enabled in Hermes; run \`hermes plugins enable ${W}\``,...d]};return{platform:Pn,status:"configured",method:"plugin directory",configPath:t,errors:l?d:void 0}}import{existsSync as _i,readFileSync as Ei}from"node:fs";import{join as l0}from"node:path";var Pi=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function Ii(n){return l0(process.env.KIMI_CODE_HOME||l0(n,".kimi-code"),"config.toml")}function d0(n){let t=Ii(n.homeDir);if(!_i(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!Pi.test(Ei(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(e){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${e instanceof Error?e.message:String(e)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as f0}from"node:fs";import{join as gn}from"node:path";var q="cc-safety-net",K="index.js",O2="openclaw.plugin.json",T2="package.json";var In="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as tc,lstatSync as ec,readdirSync as rc,readFileSync as ac}from"node:fs";import{dirname as c0,join as k2}from"node:path";import{fileURLToPath as lc}from"node:url";import{spawnSync as Ni}from"node:child_process";function nc(n){return n.join(" ")}function s0(n,t,e){return[`Failed to run ${nc(n)}${t===null?"":` (exit ${t})`}.`,e.trim()].filter(Boolean).join(`
`)}function c2(n,t){let e=Ni(n[0],n.slice(1),{encoding:"utf-8",stdio:"pipe"}),r=[e.stdout,e.stderr].filter(Boolean).join(`
`);if(e.error)throw Error(s0(n,null,`${e.error.message}
${r}`.trim()));if(e.status!==0)throw Error(s0(n,e.status,r));return t?.stdoutOnly?e.stdout:r}function ke(n){n.forEach((t)=>{c2(t)})}var i0=k2("openclaw",q),dc=[K,O2,T2];function L0(n){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return t;let e=process.env.OPENCLAW_CONFIG_PATH?.trim();return e?c0(e):k2(n,".openclaw")}function o0(n){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?t:k2(L0(n),"openclaw.json")}function qe(n){return k2(L0(n),"extensions",q)}function sc(n){let t=rc(n);if(t.length===0)return!0;if(t.some((a)=>!dc.includes(a)))return!1;let e=k2(n,K),r=Y(e);return r!==void 0&&!r.isSymbolicLink()&&r.isFile()&&ac(e,"utf-8").startsWith(In)}function je(n){let t=qe(n),e=Y(t);if(!e)return;if(!e.isSymbolicLink()&&e.isDirectory()&&sc(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function u0(){let n=c0(lc(import.meta.url));return[k2(n,"..",i0),k2(n,"..","..","..","dist",i0)]}function Fe(n=u0()){return n.find((t)=>tc(t)&&ec(t).isDirectory())}function ic(n=u0()){let t=Fe(n);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function p0(n=ic()){return[["openclaw","plugins","install",n,"--force"],["openclaw","plugins","enable",q]]}function cc(n){let t=(()=>{try{return JSON.parse(n)}catch{return}})(),e=g(g(t,"plugin"),"status");return typeof e==="string"?e:void 0}function v0(){let n=cc(c2(["openclaw","plugins","inspect",q,"--runtime","--json"],{stdoutOnly:!0}));if(n==="loaded")return;throw Error(`${n===void 0?`The ${q} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${q} plugin with status "${n}".`} Run \`openclaw plugins inspect ${q} --runtime\` for details.`)}var Nn="openclaw",mn=`run \`openclaw plugins enable ${q}\``;function _2(n,t){let e=gn(n,t),r=Y(e);if(!r)return{error:`${t} is missing from ${e}; run install --openclaw`};if(r.isSymbolicLink()||!r.isFile())return{error:`${e} is a symlink or not a regular file; move or remove it`};try{return{content:f0(e,"utf-8")}}catch(a){return{error:`Failed to read ${e}: ${a instanceof Error?a.message:String(a)}`}}}function h0(n){try{return JSON.parse(C(n))}catch{return}}function Lc(n){let t=_2(n,O2);if("error"in t)return t.error;if(g(h0(t.content),"id")===q)return;return`${gn(n,O2)} is not a valid ${q} manifest; run install --openclaw`}function oc(n){let t=_2(n,T2);if("error"in t)return t.error;let e=g(g(h0(t.content),"openclaw"),"extensions");if(Array.isArray(e)&&e.includes(`./${K}`))return;return`${gn(n,T2)} does not point OpenClaw at ${K}; run install --openclaw`}function b0(n){return Array.isArray(n)?n.filter((t)=>typeof t==="string"):[]}function uc(n){let t=o0(n);if(!Y(t))return`${q} is not enabled; ${mn}`;let e=(()=>{try{return JSON.parse(C(f0(t,"utf-8")))}catch{return}})();if(e===void 0)return`Failed to read ${t}; fix it, then ${mn}`;let r=g(e,"plugins");if(g(r,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let a=g(g(g(r,"entries"),q),"enabled");if(b0(g(r,"deny")).includes(q)||a===!1)return`${q} is disabled in ${t}; ${mn}`;let l=b0(g(r,"allow"));if(l.length>0&&!l.includes(q))return`plugins.allow in ${t} does not list ${q}; add it, then ${mn}`;if(l.includes(q)||a===!0)return;return`${q} is not enabled; ${mn}`}function y0(n){return/^\/\/ version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function pc(n,t,e){if(e===void 0)return[];let r=_2(e,K);if("error"in r||y0(r.content)!==t)return[];return[K,O2,T2].flatMap((a)=>{let l=_2(n,a),d=_2(e,a);if("error"in l||"error"in d||l.content===d.content)return[];return[`Modified ${a} occupies ${gn(n,a)}; run install --openclaw to restore it`]})}function w0(n){let t=qe(n.homeDir),e=Gn(Nn,t);if(e)return e;let r=_2(t,K),l=["error"in r?r.error:r.content.startsWith(In)?void 0:`Unmanaged ${K} occupies ${gn(t,K)}; move or remove it`,Lc(t),oc(t)].filter((L)=>L!==void 0),d="content"in r?y0(r.content):void 0,s=l.length>0?l:pc(t,d,Fe());if(s.length>0)return{platform:Nn,status:"n/a",configPath:t,errors:s};let i=d===z()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],c=uc(n.homeDir);if(c)return{platform:Nn,status:"disabled",method:"plugin directory",configPath:t,errors:[c,...i]};return{platform:Nn,status:"configured",method:"plugin directory",configPath:t,errors:i.length>0?i:void 0}}import{existsSync as vc,readFileSync as bc}from"node:fs";import{join as x0}from"node:path";function m0(n){let t=[],e=x0(n.homeDir,".config","opencode"),r=["opencode.json","opencode.jsonc"];for(let a of r){let l=x0(e,a);if(vc(l))try{let d=bc(l,"utf-8"),s=C(d);if((JSON.parse(s).plugin??[]).some((u)=>u.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:l,errors:t.length>0?t:void 0}}catch(d){t.push(`Failed to parse ${a}: ${d instanceof Error?d.message:String(d)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as fc}from"node:path";function ze(n){return fc(n,".pi","agent","settings.json")}function Be(n){if(typeof n!=="string")return!1;return n==="npm:cc-safety-net"||n.startsWith("npm:cc-safety-net@")}function g0(n){let t=ze(n.homeDir),e=n2(t);if(e.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(e.kind==="missing")return{platform:"pi",status:"n/a"};let r=g(e.value,"packages");if(!Array.isArray(r))return{platform:"pi",status:"n/a"};let a=r.find((s)=>Be(typeof s==="string"?s:g(s,"source")));if(a===void 0)return{platform:"pi",status:"n/a"};let l=g(a,"extensions");if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var yc={amp:$1,"antigravity-cli":D1,"claude-code":F1,codex:z1,"copilot-cli":R1,cursor:G1,"gemini-cli":U1,"hermes-agent":a0,"kimi-code":d0,openclaw:w0,opencode:m0,pi:g0};function E2(n,t){let e={...t,cwd:n,homeDir:t?.homeDir??hc()};return ba.map((r)=>wc(yc[r](e)))}function wc(n){if(n.status==="not-inspected")return{platform:n.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:n.platform,detected:n.status!=="n/a",configured:n.status==="configured",inspectionStatus:n.status!=="n/a"?"verified":n.errors&&n.errors.length>0?"failed":"not-applicable",method:n.method,configPath:n.configPath,configPaths:n.configPaths,errors:n.errors}}import{tmpdir as xc}from"node:os";import{join as mc}from"node:path";var gc=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),$c=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([])})})}),Dc={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}},sources:{failClosed:[],paranoidRm:[],paranoidInterpreters:[],worktreeMode:[]}};function $0(){let n=mc(xc(),"cc-safety-net-self-test"),t=gc.map((e)=>{let r=Zn(A2("self-test",{command:e.command},{kind:"command",shell:"auto"},{configCwd:n,executionCwd:n},e.command),{guard:{dependencies:{loadPolicySnapshot:()=>$c,getModes:()=>Dc,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),a=e.expectBlocked?"blocked":"allowed",l=r.decision.kind==="deny"?"blocked":"allowed";return{command:e.command,description:e.description,expected:a,actual:l,passed:a===l,reason:r.decision.kind==="deny"?r.decision.reason:void 0,ruleId:r.decision.kind==="deny"?r.decision.ruleId:void 0}});return{passed:t.filter((e)=>e.passed).length,failed:t.filter((e)=>!e.passed).length,total:t.length,results:t}}function Je(n){let t=j({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},n);if(e2(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function D0(n={}){let t=await Wn(!n.json,()=>{let e=kc(n);return{ready:e,finish:()=>e}},()=>Mn(),{loadingMessage:"Checking system status…"});if(n.json)console.log(JSON.stringify(t,null,2));else jc(t);return qc(t.hooks,t.engineSelfTest,{userConfig:t.userConfig,projectConfig:t.projectConfig})?1:0}async function kc(n){let t=n.cwd??process.cwd(),e=await vn(),r=E2(t,{codexPluginListOutput:e.codexPluginListOutput,copilotCliVersion:e.copilotCliVersion}),a=Ca(t),l=Ma(),d=H({cwd:t}),s=d.policy,i=l2(s),c=w2(s,i.capabilities),L=Rn(7),u=n.skipUpdateCheck?{currentVersion:z(),latestVersion:null,updateAvailable:!1}:await G2(),p={hooks:r,engineSelfTest:$0(),userConfig:a.userConfig,projectConfig:a.projectConfig,configState:Ln(d),effectiveRules:a.effectiveRules,shadowedRules:a.shadowedRules,environment:l,effectiveSafety:{selectedPreset:s.safety.level??"standard",level:i.effectiveLevel,capabilities:i.capabilities,ruleOverrides:s.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(c).filter(([,o])=>o.source==="rule_override"&&o.override==="off"&&o.inheritedEnabled&&o.changesInherited).map(([o])=>o),ruleCounts:{stored:Object.keys(s.destructiveCommandRuleOverrides).length,effective:Object.values(c).filter((o)=>o.changesInherited).length}},posture:t1(a.userConfig.path),activity:L,update:u,system:e};return{...p,findings:Ka(p)}}function qc(n,t,e){return n.length>0&&n.every((r)=>!r.configured)||n.some((r)=>r.inspectionStatus==="failed")||t.failed>0||e.userConfig.exists&&!e.userConfig.valid||e.projectConfig.exists&&!e.projectConfig.valid}function jc(n){console.log(),console.log(Ga(n.hooks)),console.log(),console.log(Ua(n.engineSelfTest)),console.log(),console.log(Oa(n)),console.log(),console.log(Ta(n.environment)),console.log(),console.log(_a(n)),console.log(),console.log(Ea(n.findings)),console.log(),console.log(Pa(n.activity)),console.log(),console.log(Na(n.system)),console.log(),console.log(Ia(n.update)),console.log(n1(n))}import{existsSync as Fc}from"node:fs";var zc=/^[A-Za-z0-9_@%+=:,./-]+$/,k0="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function Se(n){let t=j({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},n);if(e2(t.errors))return console.error(k0),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!Fc(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let e=t.positionals.length===1?t.positionals[0]:t.positionals.map((r)=>zc.test(r)?r:`'${r.replaceAll("'","'\\''")}'`).join(" ");if(!e)return console.error("Error: No command provided"),console.error(k0),null;return{json:t.flags.json,cwd:t.values.cwd,command:e}}function q0(n){if(n)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function j0(n,t){let r=t-18;return[`${n.dtl}${n.dh.repeat(t)}${n.dtr}`,`${n.dv}  Command Analysis${" ".repeat(r)}${n.dv}`,`${n.dbl}${n.dh.repeat(t)}${n.dbr}`]}function Ze(n){return JSON.stringify(n)}function F0(n,t=0){return`[${n.map((r,a)=>Va(r,a,t)).join(",")}]`}function nt(n,t,e=70){let r=n.split(" "),a=[],l="";for(let d of r)if(l&&l.length+d.length+1>e)a.push(l),l=d;else l=l?`${l} ${d}`:d;if(l)a.push(l);return a.map((d,s)=>s===0?d:`${t}${d}`)}function z0(n,t,e){let r=[];switch(n.type){case"parse":return null;case"env-strip":{r.push(""),r.push(`STEP ${t} ${e.h} Strip environment variables`);let a=Object.keys(n.envVars);return r.push(`  Removed: ${a.map((l)=>`${l}=<redacted>`).join(", ")}`),r.push(`  Tokens:  ${Ze(n.output)}`),{lines:r,incrementStep:!0}}case"leading-tokens-stripped":return r.push(""),r.push(`STEP ${t} ${e.h} Strip wrappers`),r.push(`  Removed: ${n.removed.join(", ")}`),r.push(`  Tokens:  ${Ze(n.output)}`),{lines:r,incrementStep:!0};case"shell-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Detect shell wrapper`),r.push(`  Wrapper: ${n.wrapper} -c`),r.push(`  Inner:   ${n.innerCommand}`),{lines:r,incrementStep:!0};case"interpreter":{if(r.push(""),r.push(`STEP ${t} ${e.h} Detect interpreter`),r.push(`  Interpreter: ${n.interpreter}`),r.push(`  Code:        ${n.codeArg}`),n.paranoidBlocked)r.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:r,incrementStep:!0}}case"busybox":return r.push(""),r.push(`STEP ${t} ${e.h} Busybox wrapper`),r.push(`  Subcommand: ${n.subcommand}`),{lines:r,incrementStep:!0};case"transparent-wrapper":return r.push(""),r.push(`STEP ${t} ${e.h} Transparent wrapper`),r.push(`  Wrapper: ${n.wrapper}`),r.push(`  Tokens:  ${Ze(n.output)}`),{lines:r,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{r.push(""),r.push(`STEP ${t} ${e.h} Match rules`);let a=`${n.ruleModule}:${n.ruleFunction}()`;if(r.push(`  Rule:   ${a}`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}case"worktree-relaxation":return r.push(""),r.push(`STEP ${t} ${e.h} Worktree relaxation`),r.push(`  Mode:   ${D.worktree.name}`),r.push(`  Git cwd: ${n.gitCwd}`),r.push("  Result: Allowed local discard in linked worktree"),{lines:r,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(n.embeddedCommandFound)return r.push(""),r.push(`STEP ${t} ${e.h} Fallback scan`),r.push(`  Found: ${n.embeddedCommandFound}`),{lines:r,incrementStep:!0};return null}case"custom-rules-check":{if(n.rulesChecked){if(r.push(""),r.push(`STEP ${t} ${e.h} Custom rules`),n.matched)r.push("  Result: MATCHED");else r.push("  Result: No match");return{lines:r,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(n.matched)return r.push(""),r.push(`STEP ${t} ${e.h} Dangerous text check`),r.push(`  Token:  ${n.token}`),r.push("  Result: MATCHED"),{lines:r,incrementStep:!0};return null}case"strict-unparseable":return r.push(""),r.push(`STEP ${t} ${e.h} Strict mode check`),r.push(`  Command: ${n.rawCommand}`),r.push("  Result:  ✗ UNPARSEABLE"),{lines:r,incrementStep:!0};case"segment-skipped":return null;case"error":return r.push(""),r.push(`ERROR: ${n.message}`),{lines:r,incrementStep:!1};default:return null}}function Qe(n,t){let e=q0(t?.asciiOnly??!1),r=58,a=[],l=1;a.push(...j0(e,58)),a.push("");let d=n.trace.steps.find((o)=>o.type==="error");if(d&&d.type==="error"){a.push("ERROR"),a.push(`  ${d.message}`),a.push(""),a.push("RESULT"),a.push(`  Status: ${n.result==="blocked"?h.red("BLOCKED"):h.green("ALLOWED")}`),a.push(""),a.push("CONFIG");let o=n.configSource??"none";return a.push(`  Path: ${o}`),a.join(`
`)}let s=n.trace.steps.find((o)=>o.type==="parse");if(s&&s.type==="parse"){a.push("INPUT"),a.push(`  ${s.input}`),a.push(""),a.push(`STEP ${l} ${e.h} Split shell commands`),l++;for(let o=0;o<s.segments.length;o++){let b=s.segments[o];if(b){let v=Math.random();a.push(`  Segment ${o+1}: ${F0(b,v)}`)}}}let i=n.trace.segments,c=i.length>1;for(let o of i){if(c){a.push("");let w="";if(s&&s.type==="parse"){let ft=s.segments[o.index];if(ft)w=ft.join(" ")}let x=54,y=w,J=` Segment ${o.index+1}: `,z2=" ";if(w){if(J.length+w.length+z2.length>x){let dd=x-J.length-z2.length;y=`${w.substring(0,dd-1)}…`}}let nn=w?`${J}${y}${z2}`:` Segment ${o.index+1} `,bt=w?`${J}${h.cyan(y)}${z2}`:nn,sr=58-nn.length,ir=Math.floor(sr/2),ld=sr-ir;a.push(`${e.sh.repeat(ir)}${bt}${e.sh.repeat(ld)}`)}if(o.steps.find((w)=>w.type==="segment-skipped")){a.push(""),a.push("  (skipped — prior segment blocked)");continue}let v=!1,f=!1;for(let w of o.steps){let x=z0(w,l,e);if(x){if(f=!0,w.type==="recurse"){a.push("");let y=" RECURSING ",J=58-y.length-4;a.push(`  ${e.tl}${e.h}${y}${e.h.repeat(J)}`),a.push(`  ${e.v}`),v=!0;continue}for(let y of x.lines)if(v)a.push(`  ${e.v} ${y}`);else a.push(y);if(x.incrementStep)l++}}if(v)a.push(`  ${e.v}`),a.push(`  ${e.bl}${e.h.repeat(56)}`),v=!1;if(!f)a.push(""),a.push(`  ${h.green("✓")} Allowed (no matching rules)`)}if(a.push(""),a.push("RESULT"),n.result==="blocked"){if(a.push(`  Status: ${h.red("BLOCKED")}`),n.customRule){if(a.push(`  Rule: ${n.customRule.id}`),n.customRule.rulebook)a.push(`  Rulebook: ${n.customRule.rulebook.name} ${n.customRule.rulebook.version}`);if(n.customRule.source)a.push(`  Source: ${n.customRule.source}`);if(n.customRule.override)a.push(`  Override: reason ${n.customRule.override.reason}`)}if(n.reason){let o=nt(n.reason,"          ");a.push(`  Reason: ${o[0]}`);for(let b=1;b<o.length;b++)a.push(o[b]??"")}}else a.push(`  Status: ${h.green("ALLOWED")}`);a.push(""),a.push("CONFIG");let L=n.configSource??"none",u=n.configValid?"":" (invalid)";a.push(`  Path: ${L}${u}`),a.push(`  Safety preset: ${n.selectedPreset??"standard"}`),a.push(`  Effective capabilities: ${n.effectiveLevel}`);let p=Object.entries(n.destructiveCommandRuleOverrides??{});if(a.push(`  Rule customizations: ${p.length}`),n.ruleActivation)a.push(`  Rule activation: ${n.ruleActivation.id} — ${n.ruleActivation.enabled?"on":"off"} via ${n.ruleActivation.source}`);return a.join(`
`)}function Xe(n){return JSON.stringify(n,null,2)}var B0="1.0.6",V="  ",q2="cc-safety-net";function J0(n){return n.argument?`${n.flags} ${n.argument}`:n.flags}function Bc(n){return Math.max(...n.map((t)=>J0(t).length))}function Jc(n){return Math.max(...n.map((t)=>t.usage.length))}function Sc(n){return Math.max(...n.map((t)=>`${q2} ${t.usage}`.length))}function Zc(n,t){let e=`${q2} ${n.usage}`;return`${V}${e.padEnd(t+2)}${n.description}`}function L2(n,t){return`${V}${n.padEnd(Math.max(40,n.length+2))}${t}`}function tt(n,t=console.log){let e=[];if(e.push(`${q2} ${n.name}`),e.push(""),e.push(`${V}${n.description}`),e.push(""),e.push("USAGE:"),e.push(`${V}${q2} ${n.usage}`),e.push(""),n.subcommands&&n.subcommands.length>0){e.push("SUBCOMMANDS:");let r=Jc(n.subcommands);for(let a of n.subcommands)e.push(`${V}${a.usage.padEnd(r+2)}${a.description}`);e.push("")}if(n.options.length>0){e.push("OPTIONS:");let r=Bc(n.options);for(let a of n.options){let l=J0(a),d=a.default?`${a.description} (default: ${a.default})`:a.description;e.push(`${V}${l.padEnd(r+2)}${d}`)}e.push("")}if(n.examples&&n.examples.length>0){e.push("EXAMPLES:");for(let r of n.examples)e.push(`${V}${r}`)}t(e.join(`
`))}function Ye(){let n=Aa(),t=Sc(n),e=[];e.push(`${q2} v${B0}`),e.push(""),e.push("Blocks destructive commands and secret access."),e.push(""),e.push("COMMANDS:");for(let r of n)e.push(Zc(r,t));e.push(""),e.push("GLOBAL OPTIONS:"),e.push(`${V}-h, --help       Show help (use with command for command-specific help)`),e.push(`${V}-V, --version    Show version`),e.push(""),e.push("HELP:"),e.push(`${V}${q2} help <command>     Show help for a specific command`),e.push(`${V}${q2} <command> --help   Show help for a specific command`),e.push(""),e.push("ENVIRONMENT VARIABLES:"),e.push(L2(`${D.level.name}=standard|strict|paranoid`,"Set session safety level")),e.push(L2(`${D.worktree.name}=1`,"Allow local git discards in linked worktrees")),e.push(L2(`${D.debug.name}=1`,"Print diagnostic messages to stderr")),e.push(L2(`${D.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),e.push(L2("CC_SAFETY_NET_HOME","Override rule config home directory")),e.push(""),e.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),e.push(L2(`${D.strict.name}=1`,"Force safety.overrides.fail_closed on")),e.push(L2(`${D.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),e.push(L2(`${D.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),e.push(L2(`${D.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),e.push(""),e.push("Documentation:        https://ccsafetynet.com/docs"),console.log(e.join(`
`))}function S0(){console.log(B0)}function $n(n,t=console.log){let e=Yn(n);if(!e)return!1;if(e.hidden||e.name.toLowerCase()!==n.toLowerCase())return!1;return tt(e,t),!0}import{existsSync as Ee,readFileSync as ul}from"node:fs";import{homedir as qL}from"node:os";import{join as Te}from"node:path";import*as v2 from"node:readline";function Qc(n){return n==="install"?"Install":"Uninstall"}function Xc(n){return n==="install"?"Installing":"Uninstalling"}function Yc(n){return n==="install"?"into":"from"}function Q0(n){return n?.available===!0}function Rc(n,t){let e=new Set(t);return n.filter((r)=>e.has(r.target)).map((r)=>r.target)}function Z0(n,t,e){if(n.length===0||n.every((r)=>!r.available))return t;return Array.from({length:n.length},(r,a)=>a+1).map((r)=>(t+r*e+n.length)%n.length).find((r)=>Q0(n[r]))}function Ac(n,t,e){if(e.ctrl&&e.name==="c")return"interrupt";if(e.name==="escape"||t==="q")return"abort";if(n==="install"&&(t==="u"||t==="U"))return"update";if(e.name==="up"||t==="k")return"up";if(e.name==="down"||t==="j")return"down";if(e.name==="space"||t===" ")return"toggle";if(e.name==="return"||e.name==="enter")return"confirm";return null}function Hc(n){return{cursor:n.findIndex((t)=>t.available),selected:[]}}function Cc(n,t,e){if(e==="confirm"||e==="update"||e==="abort"||e==="interrupt")return{state:n,done:e};if(e==="up")return{state:{...n,cursor:Z0(t,n.cursor,-1)}};if(e==="down")return{state:{...n,cursor:Z0(t,n.cursor,1)}};let r=t[n.cursor];if(!Q0(r))return{state:n};let a=n.selected.includes(r.target)?n.selected.filter((l)=>l!==r.target):Rc(t,[...n.selected,r.target]);return{state:{...n,selected:a}}}var Mc="◉",Wc="◯",Kc=">",Vc=" ";function Gc(n,t,e,r={}){let a=r.color!==!1,l=a?h.dim:(i)=>i,d=a?h.green:(i)=>i,s=a?h.bold:(i)=>i;return["",`${Qc(n)} CC Safety Net ${Yc(n)}:`,"",...t.map((i,c)=>{let L=e.selected.includes(i.target),u=c===e.cursor,p=L?Mc:Wc,o=u?Kc:Vc,b=i.available?"":` (${i.unavailableReason??"not installed"})`,v=`${p} ${i.label}${b}`,f=!i.available?l(v):L?d(v):u?s(v):v;return`${o} ${f}`}),"",n==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((i)=>i.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${n}. q/Esc: close`].join(`
`)}function X0(n=process.stdin,t=process.stdout){return Boolean(n.isTTY&&t.isTTY&&typeof n.setRawMode==="function")}function Y0(n,t,e={}){let r=e.input??process.stdin,a=e.output??process.stdout,l=Hc(t);v2.emitKeypressEvents(r);let d=r.isRaw===!0;r.setRawMode(!0),r.resume();let s=0,i=()=>{if(s===0)return;v2.moveCursor(a,0,-s),v2.cursorTo(a,0),v2.clearScreenDown(a)},c=()=>{i();let L=Gc(n,t,l);a.write(`${L}
`),s=L.split(`
...
`);L(b)};function o(b,v){let f=Ac(n,b,v);if(!f)return;let w=Cc(l,t,f);if(l=w.state,w.done==="interrupt"){p(null),(e.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(w.done==="abort"){p(null);return}if(w.done==="update"){p("update");return}if(w.done==="confirm"){if(l.selected.length===0){a.write("\x07"),c();return}p([...l.selected]);return}c()}r.on("keypress",o),c()})}import{existsSync as R0,mkdirSync as Uc,readFileSync as Oc}from"node:fs";import{dirname as Tc}from"node:path";var Re="npx -y cc-safety-net hook --agy-cli",b2="cc-safety-net";function rt(){return{PreToolUse:[{hooks:[{type:"command",command:Re,timeout:30}]}]}}function A0(n){try{let t=JSON.parse(Oc(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${n}: ${t.message}`);throw t}}function H0(n){let t=n[b2];if(t===void 0)return n[b2]=rt(),n[b2];if(!t||typeof t!=="object"||Array.isArray(t))throw Error(`Antigravity hooks config entry "${b2}" must be an object`);if(!Array.isArray(t.PreToolUse))t.PreToolUse=[];return t}function C0(n){if(!Array.isArray(n.PreToolUse))return!1;return n.PreToolUse.some((t)=>Array.isArray(t.hooks)&&t.hooks.some((e)=>e.command===Re))}function _c(n){return Object.values(n).some((t)=>t.enabled!==!1&&C0(t))}function Ec(n){if(n[b2]===void 0)return!1;let t=H0(n);if(t.enabled!==!1||!C0(t))return!1;return t.enabled=!0,!0}function Pc(n){if(n[b2]===void 0){n[b2]=rt();return}let t=H0(n);t.PreToolUse??=[],t.enabled=!0,t.PreToolUse.push(rt().PreToolUse?.[0]??{hooks:[]})}function Ic(n){let t=!1;for(let e of Object.values(n)){if(!Array.isArray(e.PreToolUse))continue;e.PreToolUse=e.PreToolUse.flatMap((r)=>{if(!Array.isArray(r.hooks))return[r];let a=r.hooks.filter((l)=>l.command!==Re);if(a.length!==r.hooks.length)t=!0;return a.length===0?[]:[{...r,hooks:a}]})}return t}function et(n,t){B(n,`${JSON.stringify(t,null,2)}
`)}function M0(n){let t=hn(n);if(Uc(Tc(t),{recursive:!0}),!R0(t))return et(t,{[b2]:rt()}),{path:t,alreadyInstalled:!1};let e=A0(t);if(_c(e))return{path:t,alreadyInstalled:!0};if(Ec(e))return et(t,e),{path:t,alreadyInstalled:!1};return Pc(e),et(t,e),{path:t,alreadyInstalled:!1}}function W0(n){let t=hn(n);if(!R0(t))return{path:t,alreadyInstalled:!1};let e=A0(t);if(!Ic(e))return{path:t,alreadyInstalled:!1};return et(t,e),{path:t,alreadyInstalled:!0}}import{spawn as Nc,spawnSync as nL}from"node:child_process";var G=i2.map((n)=>({target:n.id,flag:n.flag,label:n.installLabel,probeCommand:n.probeCommand})),K0=new Map(G.map((n)=>[n.flag,n.target]));function Ae(n){let t=new Set(n);return G.map((e)=>e.target).filter((e)=>t.has(e))}function He(n,t){n.forEach(t)}var V0=5000;function tL(n){let t=nL(n[0],n.slice(1),{env:process.env,stdio:"ignore",timeout:V0});return!t.error&&t.status===0}function Me(n){return new Promise((t)=>{let e=Nc(n[0],n.slice(1),{env:process.env,stdio:"ignore"}),r=!1,a=(d)=>{if(r)return;r=!0,clearTimeout(l),t(d)},l=setTimeout(()=>{e.kill(),a(!1)},V0);e.on("error",()=>a(!1)),e.on("close",(d)=>a(d===0))})}function eL(n=tL,t={}){let e=new Set(t.configuredTargets??[]);if(t.async)return Promise.all(G.map(async(a)=>({target:a.target,flag:a.flag,label:a.label,...Ce(t.action,await n(a.probeCommand),e.has(a.target))})));let r=n;return G.map((a)=>({target:a.target,flag:a.flag,label:a.label,...Ce(t.action,r(a.probeCommand),e.has(a.target))}))}function G0(n=Me,t={}){return eL(n,{...t,async:!0})}function U0(n,t){let e=new Set(t.configuredTargets??[]);return n.map((r)=>({...r,...Ce(t.action,r.available,e.has(r.target))}))}function Ce(n,t,e){if(n==="uninstall")return e?{available:!0}:{available:!1,unavailableReason:"not installed"};if(n==="install"&&e)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as O0,readdirSync as rL,rmSync as aL}from"node:fs";import{join as P2}from"node:path";function We(n,t=process.platform){let e=P2(process.env.npm_config_cache||(t==="win32"?P2(process.env.LOCALAPPDATA||P2(n,"AppData","Local"),"npm-cache"):P2(n,".npm")),"_npx");if(!O0(e))return;rL(e).filter((r)=>O0(P2(e,r,"node_modules","cc-safety-net"))).forEach((r)=>{aL(P2(e,r),{recursive:!0,force:!0})})}import{existsSync as P0,mkdirSync as dL,readFileSync as I0}from"node:fs";import{dirname as sL,join as E0}from"node:path";function T0(n){return n!==void 0&&/\s/.test(n)}function lL(n,t,e){let r=t+1,a=!1;while(r<n.length){let l=n[r];if(a){a=!1,r++;continue}if(l==="\\"){a=!0,r++;continue}if(l==='"')return r+1;r++}throw Error(e)}function at(n,t,e){let r=n[t],a=r==="["?"]":"}",l=0,d=t;while(d<n.length){let s=e.skipComment?.(n,d)??d;if(s!==d){d=s;continue}if(n[d]==='"'){d=lL(n,d,e.stringError);continue}if(n[d]===r)l++;if(n[d]===a){if(l--,l===0)return d}d++}throw Error(e.bracketError)}function _0(n,t){let e=n.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(n.slice(e))?.[0]??""}function lt(n,t){let{start:e,end:r,end:a}=t;while(T0(n[a]))a++;if(n[a]===","){if(r=a+1,n[r]===`
`)r++;return`${n.slice(0,e)}${n.slice(r)}`}a=t.start-1;while(T0(n[a]))a--;if(n[a]===","){e=a;let l=n.lastIndexOf(`
`,e-1);if(l!==-1&&/^\s*$/.test(n.slice(l+1,e)))e=l}return`${n.slice(0,e)}${n.slice(r)}`}var Dn="npx -y cc-safety-net hook --kimi-code",Ke=`[[hooks]]
event = "PreToolUse"
command = "${Dn}"`,Ve=`{ event = "PreToolUse", command = "${Dn}" }`;function N0(n){return E0(process.env.KIMI_CODE_HOME??E0(n,".kimi-code"),"config.toml")}function iL(n){return n.split(`
...
`,t+1);return e===-1?n.length:e+1}function LL(n,t){return at(n,t,{skipComment:cL,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function nl(n){let t=!1,e=0;while(e<n.length){let r=n.indexOf(`
`,e),a=r===-1?n.length:r,l=n.slice(e,a);if(/^\s*\[/.test(l))t=!0;if(!t){let d=/^(\s*)hooks\s*=\s*\[/.exec(l);if(d){let s=e+d[0].lastIndexOf("[");return{start:s,end:LL(n,s)}}}e=r===-1?n.length:r+1}return}function oL(n,t){let e=n.slice(0,t.end).trimEnd(),r=_0(n,t.end),a=r===""?"     ":`${r}  `,l=!e.endsWith("[")&&!e.endsWith(",");return`${e}${l?",":""}
${a}${Ve}${n.slice(t.end)}`}function uL(n){let t=nl(n);if(t&&n.slice(t.start+1,t.end).trim())return oL(n,t);let e=iL(n).trimEnd();if(e==="")return`${Ke}
`;return`${e}

${Ke}
`}function pL(n){return n.split(/(?=^\s*\[)/m).filter((e)=>!/^\s*\[\[hooks]]\s*$/m.test(e)||!e.includes(Dn)).join("").trimEnd()}function vL(n,t){let e=n.indexOf(Ve,t.start);if(e===-1||e>t.end)return n;return lt(n,{start:e,end:e+Ve.length})}function tl(n){let t=N0(n);if(dL(sL(t),{recursive:!0}),!P0(t))return B(t,`${Ke}
`),{path:t,alreadyInstalled:!1};let e=I0(t,"utf-8");if(e.includes(Dn))return{path:t,alreadyInstalled:!0};return B(t,uL(e)),{path:t,alreadyInstalled:!1}}function el(n){let t=N0(n);if(!P0(t))return{path:t,alreadyInstalled:!1};let e=I0(t,"utf-8");if(!e.includes(Dn))return{path:t,alreadyInstalled:!1};let r=nl(e),a=r?vL(e,r):`${pL(e)}
`;return B(t,a),{path:t,alreadyInstalled:!0}}import{existsSync as rl,readFileSync as bL,rmSync as fL}from"node:fs";import{join as Ge}from"node:path";var Ue="cc-safety-net",hL=`${Ue}@latest`,ll=["opencode.json","opencode.jsonc"];function yL(n){return Ge(n,".config","opencode",ll[0])}function wL(n){return ll.map((t)=>Ge(n,".config","opencode",t))}function xL(n){return Ge(n,".cache","opencode","packages",hL)}function Oe(n){fL(xL(n),{recursive:!0,force:!0})}function dt(n,t){if(n[t]==="/"&&n[t+1]==="/"){let e=n.indexOf(`
`,t+2);return e===-1?n.length:e+1}if(n[t]==="/"&&n[t+1]==="*"){let e=n.indexOf("*/",t+2);return e===-1?n.length:e+2}return t}function al(n,t){let e=t;while(e<n.length){if(/\s/.test(n[e]??"")){e++;continue}let r=dt(n,e);if(r===e)return e;e=r}return e}function dl(n,t){let e=t+1,r=!1;while(e<n.length){if(r){r=!1,e++;continue}if(n[e]==="\\"){r=!0,e++;continue}if(n[e]==='"')return e+1;e++}throw Error("Unterminated string in OpenCode config")}function sl(n,t,e){return JSON.parse(n.slice(t,e))}function mL(n,t){return at(n,t,{skipComment:dt,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function gL(n){let t=0,e=0;while(e<n.length){let r=dt(n,e);if(r!==e){e=r;continue}if(n[e]==='"'){let a=dl(n,e);if(t===1&&sl(n,e,a)==="plugin"){let l=al(n,a),d=al(n,l+1);if(n[l]===":"&&n[d]==="[")return{start:d,end:mL(n,d)}}e=a;continue}if(n[e]==="{"||n[e]==="[")t++;if(n[e]==="}"||n[e]==="]")t--;e++}return}function $L(n,t){let e=[],r=t.start+1;while(r<t.end){let a=dt(n,r);if(a!==r){r=a;continue}if(n[r]==='"'){let l=dl(n,r),d=sl(n,r,l);if(typeof d==="string"&&d.includes(Ue))e.push({start:r,end:l});r=l;continue}r++}return e}function il(n,t){try{return JSON.parse(C(n))}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${e.message}`);throw e}}function DL(n){if(!n||typeof n!=="object"||Array.isArray(n))return!1;let t=n.plugin;if(!Array.isArray(t))return!1;return t.some((e)=>typeof e==="string"&&e.includes(Ue))}function kL(n,t){let e=gL(n);if(!e)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let r=[...$L(n,e)].reverse().reduce(lt,n);return il(r,t),r}function cl(n){Oe(n);let t=wL(n),e=t.find((a)=>rl(a)),r=[];for(let a of t){if(!rl(a))continue;try{let l=bL(a,"utf-8");if(!DL(il(l,a)))continue;return B(a,kL(l,a)),{path:a,alreadyInstalled:!0}}catch(l){r.push(l instanceof Error?l.message:String(l))}}if(r.length>0)throw Error(r.join(`
`));return{path:e??yL(n),alreadyInstalled:!1}}var _e="safety-net@cc-marketplace",Ll=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]);function Pe(n){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(n??"")}function pl(n){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(n??"")}var vl={"claude-code":{installCommands:(n)=>{let t=Un(n,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...ie(n).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[],...Un(n,_e)?[["claude","plugin","uninstall",_e]]:[]],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:()=>{let n=c2(["codex","plugin","list"]),t=pl(n);return{commands:[...t?[["codex","plugin","marketplace","upgrade","cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]]:[["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],...Pe(n)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[]],update:t}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:()=>{let n=c2(["copilot","plugin","list"]),t=Z1(n)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[];if(J1(n))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",t2],...t],update:!0};return{commands:[...S1(c2(["copilot","plugin","marketplace","list"]))?[]:[["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"]],["copilot","plugin","install",t2],...t]}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(n)=>{let t=he(n);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:je,installCommands:()=>({commands:p0()}),uninstallCommands:[["openclaw","plugins","uninstall",q,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:Oe,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function Ie(){return process.env.HOME??qL()}function bl(n,t=(e)=>e){try{let e=JSON.parse(t(ul(n,"utf-8")));if(!e||typeof e!=="object"||Array.isArray(e))throw Error(`Settings file ${n} must be a JSON object`);return e}catch(e){if(e instanceof SyntaxError)throw Error(`Failed to parse ${n}: ${e.message}`);throw e}}function jL(n){let t=Te(yn(n),"settings.json");if(!Ee(t))return;let e=bl(t,C),r=e.enabledPlugins;if(!r||typeof r!=="object"||Array.isArray(r))return;if(r[t2]!==!1)return;let a=ul(t,"utf-8"),l=a.replace(new RegExp(`("${t2}"\\s*:\\s*)false`),"$1true");r[t2]=!0,B(t,l!==a?l:`${JSON.stringify(e,null,2)}
`),console.log(`Enabled ${t2} plugin in ${t}`)}function FL(n){let t=ze(n);if(!Ee(t))return;let e=bl(t);if(!Array.isArray(e.packages))return;let r=e.packages.find((a)=>!!a&&typeof a==="object"&&!Array.isArray(a)&&Be(a.source)&&("extensions"in a));if(!r)return;delete r.extensions,B(t,`${JSON.stringify(e,null,2)}
`),console.log(`Enabled npm:cc-safety-net extensions in ${t}`)}function ol(n,t){let e=j({label:t,booleans:Object.fromEntries(G.map((l)=>[l.target,[l.flag]]))},n),r=e.errors[0];if(r)throw Error(r);let a=G.filter((l)=>e.flags[l.target]).map((l)=>l.target);if(a.length!==1)throw Error(`Choose exactly one ${t} target: ${[...K0.keys()].join(", ")}`);return a[0]}async function fl(n=Ie()){let[t,e]=await Promise.all([Hn(["codex","plugin","list"]),Hn(["copilot","--binary-version"])]);return{codexPluginListOutput:t,hooks:E2(process.cwd(),{homeDir:n,codexPluginListOutput:t,copilotCliVersion:e})}}async function zL(n){let t=await fl();return t.hooks.filter((e)=>n==="install"?e.configured:e.detected||e.inspectionStatus==="not-inspected").filter((e)=>e.platform!=="codex"||!Pe(t.codexPluginListOutput)||pl(t.codexPluginListOutput)).map((e)=>e.platform)}function BL(n,t,e){if(t.length>0)return{finish:async()=>[ol(t,n)]};if(!e.selectTargets&&!X0(e.input,e.output))return{finish:async()=>[ol(t,n)]};let r=e.detectConfiguredTargets??(()=>zL(n)),a=Promise.all([G0(e.probeTargets),r()]);return{ready:a,finish:async()=>{let[l,d]=await a,s=U0(l,{action:n,configuredTargets:d}),i=e.selectTargets?await e.selectTargets(n,s):await Y0(n,s,{input:e.input,output:e.output});if(i==="update")return i;if(!i||i.length===0)return null;return Ae(i)}}}function j2(n,t,e=!1){let r=vl[n];r.beforeInstall?.(t);let a=typeof r.installCommands==="function"?r.installCommands(t):{commands:r.installCommands};ke(a.commands),console.log([`${a.update||e?"Updated":"Installed"} ${m2(n)} integration`,r.postInstallMessage].filter(Boolean).join(`
`))}function I2(n){let t=vl[n];if(!t.uninstallCommands)throw Error(`${m2(n)} uninstall is not supported`);ke(t.uninstallCommands),console.log(`Uninstalled ${m2(n)} integration`)}function JL(n){let t=cl(n);console.log(t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`)}var SL={"antigravity-cli":{install:M0,uninstall:W0},cursor:{install:K1,uninstall:V1},"kimi-code":{install:tl,uninstall:el}};function N2(n,t,e,r=!1){if(n==="install")We(e);let a=SL[t][n](e),l=m2(t),d=n!=="install"?"Uninstalled":r?"Updated":"Installed";console.log(n==="install"&&a.alreadyInstalled?r?`${l} hook up to date in ${a.path}`:`${l} hook already installed in ${a.path}`:n==="uninstall"&&!a.alreadyInstalled?`${l} hook not installed in ${a.path}`:`${d} ${l} hook ${n==="install"?"in":"from"} ${a.path}`)}var ZL={amp:{install:m1,uninstall:g1,restartNote:'Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:E1,uninstall:P1,afterInstall:(n)=>{let t=De(n);return c2(["hermes","plugins","enable",W,"--no-allow-tool-override"]),!t},beforeUninstall:(n)=>{$e(n);try{c2(["hermes","plugins","disable",W])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
...
`))}var QL={amp:{install:(n,t)=>st("install","amp",n,t),uninstall:(n)=>st("uninstall","amp",n)},"antigravity-cli":{install:(n,t)=>N2("install","antigravity-cli",n,t),uninstall:(n)=>N2("uninstall","antigravity-cli",n)},"claude-code":{install:(n,t)=>j2("claude-code",n,t),uninstall:()=>I2("claude-code")},codex:{install:(n,t)=>j2("codex",n,t),uninstall:()=>I2("codex")},"copilot-cli":{install:(n,t)=>{j2("copilot-cli",n,t),jL(n)},uninstall:()=>I2("copilot-cli")},cursor:{install:(n,t)=>N2("install","cursor",n,t),uninstall:(n)=>N2("uninstall","cursor",n)},"gemini-cli":{install:(n,t)=>j2("gemini-cli",n,t),uninstall:()=>I2("gemini-cli")},"hermes-agent":{install:(n,t)=>{We(n),st("install","hermes-agent",n,t)},uninstall:(n)=>st("uninstall","hermes-agent",n)},"kimi-code":{install:(n,t)=>N2("install","kimi-code",n,t),uninstall:(n)=>N2("uninstall","kimi-code",n)},openclaw:{install:(n,t)=>{j2("openclaw",n,t),v0()},uninstall:(n)=>{je(n),I2("openclaw")}},opencode:{install:(n,t)=>j2("opencode",n,t),uninstall:(n)=>JL(n)},pi:{install:(n,t)=>{j2("pi",n,t),FL(n)},uninstall:()=>I2("pi")}};function hl(n,t,e,r=!1){QL[t][n](e,r)}function XL(n){let t=j({label:"update"},n).errors[0];if(t)throw Error(t)}async function YL(n){let t=await fl(n),e=Te(yn(n),"installed-plugins");return Ae([...t.hooks.filter((r)=>r.platform!=="copilot-cli"&&r.detected).map((r)=>r.platform),...[On,B1].flatMap((r)=>Ee(Te(e,...r))?["copilot-cli"]:[]),...Un(n,_e)?["claude-code"]:[],...Pe(t.codexPluginListOutput)?["codex"]:[]])}async function RL(){let n=Ie(),t=await YL(n);if(t.length===0){console.log("No installed integrations found. Run `cc-safety-net install` to set one up.");return}let e=new Set(t),r=new Map(await Promise.all(G.filter((a)=>e.has(a.target)&&Ll.has(a.target)).map(async(a)=>[a.target,await Me(a.probeCommand)])));He(t,(a)=>{if(Ll.has(a)&&!r.get(a)){console.log(`${m2(a)} not found; skipped`);return}hl("install",a,n,!0)})}function Ne(n){return Promise.resolve().then(()=>XL(n)).then(RL).then(()=>0).catch((t)=>{return console.error(yl(t)),1})}async function kn(n,t,e={}){try{let r=await Wn(!0,()=>BL(n,t,e),()=>Mn({input:e.input??process.stdin,output:e.output??process.stdout}),{loadingMessage:n==="install"?"Checking available integrations…":"Checking installed integrations…",output:e.output??process.stdout});if(!r)return(e.output??process.stdout).write(`Cancelled: nothing was ${n}ed.
`),0;if(r==="update")return(e.runUpdate??(()=>Ne([])))();let a=Ie();return He(r,(l)=>hl(n,l,a)),0}catch(r){return console.error(yl(r)),1}}function yl(n){let t=n instanceof Error?n.message:String(n),e=typeof n==="object"&&n!==null&&"code"in n?n.code:null;if(e==="EACCES"||e==="EPERM")return`${t}
...
All configs valid.`),0}function ct(n,t){let e=`legacy ${n} config`;if(t==="cleanup")return`Warning: Legacy ${n} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${n} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${n} config is no longer supported. Fix or delete the ${e}, then run \`npx -y cc-safety-net rule migrate\`.`}function po(n){if(Q2(n)===null)return null;let t=vo(n);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:n.path,result:t}}function vo(n){let t=[],e=new Set,r=(Q2(n)??[]).filter((a)=>!oo.has(a.name)).sort((a,l)=>a.name.localeCompare(l.name));if(r.length===0)return{errors:t,ruleNames:e};for(let a of r){if(!an.test(a.name)){t.push(`rulebook directory names must match ${an}: ${a.name}`);continue}if(a.kind!=="directory"){t.push(`${a.name} must be a rulebook directory`);continue}let l=$(n.scope,io(n.path,a.name,"rulebook.json")),d=m(l);if(d===null){t.push(`${a.name}/rulebook.json is required`);continue}try{let s;try{s=JSON.parse(d)}catch{t.push(`${a.name}/rulebook.json: invalid JSON`);continue}let i=Fl(s);if(i.name!==a.name){t.push(`rulebook name "${i.name}" must match folder "${a.name}"`);continue}e.add(a.name)}catch(s){t.push(s instanceof Error?`${a.name}/rulebook.json: ${s.message}`:`${a.name}/rulebook.json: ${String(s)}`)}}return{errors:t,ruleNames:e}}function bo(){console.log(zl),console.log(co)}function fo(n,t,e,r,a){if(console.log(`
...
✗ Legacy ${n.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),e.errors.length>0){console.error("  Errors:");let a=1;for(let l of e.errors)for(let d of l.split("; "))console.error(`    ${a}. ${d}`),a++;return}if(e.ruleNames.size>0){console.error("  Rules:");let a=1;for(let l of e.ruleNames)console.error(`    ${a}. ${r.get(l)??l}`),a++;return}console.error("  Rules: (none)")}function yo(n,t,e){Jl(`${n} config`,t,e)}function wo(n,t){console.log(`
✓ GitHub source rules: ${n}`),console.log("  Rulebooks:");let e=1;for(let r of t.ruleNames)console.log(`    ${e}. ${r}`),e++}function xo(n,t){Jl("GitHub source rules",n,t)}function Jl(n,t,e){console.error(`
✗ ${n}: ${t}`),console.error("  Errors:");let r=1;for(let a of e)for(let l of a.split("; "))console.error(`    ${r}. ${l}`),r++}function mo(n){try{let t=m(n);if(t===null)return!1;let e=JSON.parse(t);if(e.$schema)return!1;return f2(n,JSON.stringify({$schema:Lo,...e},null,2)),!0}catch(t){if(t instanceof S)throw t;return!1}}var Sl=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),$o=new Set(["add","remove","list"]);async function Ql(n){try{return await Do(n)}catch(t){if(t instanceof S)return console.error(t.message),1;throw t}}async function Do(n){let t=qo(n),e=t.help?ko(t.positionals):null;if(e)return tt(e),0;if(t.errors.length>0){for(let d of t.errors)console.error(d);return 1}let r=t.positionals[0];if(!r)return tt(V2,console.error),1;let a=t.positionals[1],l={global:t.global,check:t.check};if(r==="init"){let d=U(l),s=d.configDir;zo(d.configTarget),Zl($(d.filesystemScope,Jn({...l,cacheConfigDir:s})));let i=go(s,"example-rules","rulebook.json"),c=$(d.filesystemScope,i);if(t.example&&m(c)===null)Yt(c,"example-rules");let L=await X2(l);return qn(L,"Rule config initialized."),L.ok?0:1}if(r==="add"){if(!a)return console.error("rule add requires a source"),1;let d=await Bt(a,l);return qn(d,`Added rulebook source: ${a}`),d.ok?0:1}if(r==="remove"){if(!a)return console.error("rule remove requires a source"),1;let d=await St(a,{...l,deleteSource:t.deleteSource});return qn(d,`Removed rulebook source: ${a}`),d.ok?0:1}if(r==="update"||r==="sync"){let d=await X2({...l,only:r==="update"?a:void 0});return qn(d,t.check?"Rule config checked.":"Rule config synced."),d.ok?0:1}if(r==="list"){let d=u2(),s=P({});return ml(d,{user:h2(d.userConfigPath,s.userScope),project:h2(d.projectConfigPath,s.projectScope)}),d.errors.length>0?1:0}if(r==="wrapper")return Bo(t);if(r==="migrate")return kl({cleanup:t.cleanup,cwd:process.cwd()});if(r==="doc"){console.log(wl);let d=await jl();if(d)console.error(d);return 0}if(r==="verify")return Bl();return 1}function ko(n){if(n.length===0)return V2;let t=V2.subcommands.filter((r)=>r.usage.split(" ")[0]===n[0]);if(t.length===0)return null;if(n.length===1&&t.length>1)return{name:`rule ${n[0]}`,description:`Subcommands of rule ${n[0]}`,usage:`rule ${n[0]} <subcommand>`,subcommands:t,options:[]};let e=n.length===1?t[0]:t.find((r)=>r.usage.split(" ")[1]===n[1]);if(!e)return null;return{name:`rule ${n[0]}`,description:e.description,usage:`rule ${e.usage}`,options:[]}}function qo(n){let t=j({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},positionals:"list"},n),e={...t.flags,help:t.help,positionals:t.positionals,errors:t.errors};return jo(e),e}function jo(n){let[t]=n.positionals;if(t&&!Sl.has(t))n.errors.push(`Unknown rule subcommand: ${t}`);if(n.deleteSource&&t!=="remove")if(t&&Sl.has(t))n.errors.push(`Unknown option for rule ${t}: --delete-source`);else n.errors.push("--delete-source is only valid with 'rule remove'");if(n.cleanup&&t!=="migrate")n.errors.push(Lt(t,"--cleanup"));if(n.example&&t!=="init")n.errors.push(Lt(t,"--example"));if(t==="migrate"){if(n.global)n.errors.push(Lt(t,"--global"));if(n.check)n.errors.push(Lt(t,"--check"));if(n.positionals.length>1)n.errors.push(`Unexpected rule migrate argument: ${n.positionals[1]}`)}else if(t==="wrapper")Fo(n);else if(n.positionals.length>2)n.errors.push(`Unexpected rule argument: ${n.positionals[2]}`);if(t==="list"&&n.global)n.errors.push("Unknown option for rule list: --global")}function Lt(n,t){return n?`Unknown option for rule ${n}: ${t}`:`Unknown option for rule: ${t}`}function Fo(n){let t=n.positionals[1],e=n.positionals[2];if(!t){n.errors.push("rule wrapper requires add, remove, or list");return}if(!$o.has(t)){n.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(e)n.errors.push(`Unexpected rule wrapper argument: ${e}`);return}if(!e){n.errors.push(`rule wrapper ${t} requires a command`);return}if(n.positionals.length>3)n.errors.push(`Unexpected rule wrapper argument: ${n.positionals[3]}`)}function zo(n){if(m(n)===null){Xt(n);return}let t=O(n);if(!t.config)return;T(n,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function Bo(n){let t=n.positionals[1],e=n.positionals[2],r=U({global:n.global}).configTarget;if(t==="list"){let s=O(r);if(s.errors.length>0){for(let i of s.errors)console.error(i);return 1}return Jo(s.config?.transparent_wrappers??[]),0}if(!e||!At.test(e))return console.error("transparent wrapper must match command pattern"),1;if(Ht(e))return console.error(`reserved command "${e}" cannot be a wrapper`),1;let a=O(r);if(a.errors.length>0){for(let s of a.errors)console.error(s);return 1}let l=a.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},d=t==="add"?[...new Set([...l.transparent_wrappers??[],e])]:(l.transparent_wrappers??[]).filter((s)=>s!==e);return T(r,{version:1,rules:l.rules,overrides:l.overrides??{},transparent_wrappers:d}),console.log(t==="add"?`Added transparent wrapper: ${e}`:`Removed transparent wrapper: ${e}`),0}function Jo(n){if(n.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${n.length}):`);for(let t of n)console.log(`  - ${t}`)}import{homedir as Xl}from"node:os";import{existsSync as So,readFileSync as Zo}from"node:fs";import{homedir as Qo}from"node:os";import{join as Xo}from"node:path";async function Yo(){if(process.stdin.isTTY)return null;return(await Ot(process.stdin).catch(()=>null))?.trim()||null}function Ro(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return Xo(Qo(),".claude","settings.json")}function er(){let n=Ro();if(!So(n))return!1;try{let t=Zo(n,"utf-8"),e=JSON.parse(t);if(!e.enabledPlugins)return!1;let r="cc-safety-net@cc-marketplace";if(!(r in e.enabledPlugins))return!1;return e.enabledPlugins[r]===!0}catch(t){if(cn(D.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${n}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function rr(){let n=er(),t;if(!n)t="\uD83D\uDEE1️ CC Safety Net ❌";else{let r=H({cwd:process.cwd()}),a=r.policy,l=l2(a),d=Object.values(w2(a,l.capabilities)).some((i)=>i.changesInherited);t=`\uD83D\uDEE1️ CC Safety Net ${{standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[d?"custom":l.effectiveLevel]}${l.worktreeMode?"\uD83C\uDF33":""}${r.state==="degraded"?"⚠️":""}`}let e=await Yo();if(e&&!e.startsWith("{"))console.log(`${e} | ${t}`);else console.log(t)}function Yl(){let n=H({cwd:process.cwd()}),t=n.policy,e=l2(t),r=!!process.env.NO_COLOR||!process.stdout.isTTY,a=Math.min(process.stdout.columns||80,100),l=r?"ok":"✔",d=r?"OFF":"✘",s=(o,b)=>{let v=`  ${o.padEnd(13)}${b}`;return(v.length>a?`${v.slice(0,a-1)}…`:v).replaceAll(d,h.red(d))},i=Object.values(w2(t,e.capabilities)).some((o)=>o.changesInherited),c=Vt(),L={ready:h.green,degraded:h.yellow}[n.state],u=[...er()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...n.diagnostics],p=r?"-":"·";console.log([`${r?"":"\uD83D\uDEE1️  "}CC Safety Net — ${L(n.state)}`,"",s("Protection",`destructive ${t.destructiveCommandProtectionEnabled?l:d}   secrets ${t.secretProtection.enabled?l:d}`),s("Level",i?`${e.effectiveLevel} (customised)`:e.effectiveLevel),s("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),s("Policy",c.startsWith(Xl())?`~${c.slice(Xl().length)}`:c),...e.worktreeMode?[s("Worktree","relaxations active")]:[],"",...u.length===0?["  Everything configured is active."]:["  Not active",...u.flatMap((o)=>nt(o,"      ",a-6).map((b,v)=>v===0?`    ${p} ${b}`:b)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as ed}from"node:child_process";import{randomBytes as To}from"node:crypto";import{createServer as _o}from"node:http";import{Writable as Eo}from"node:stream";import{homedir as Ao}from"node:os";var ot=500;function Ho(n){let t=n.filter((a)=>a.decision!=="allow"),e=n.filter((a)=>a.decision==="allow"),r=Math.min(t.length,Math.max(ot-e.length,Math.ceil(ot/2)));return[...t.slice(0,r),...e.slice(0,ot-r)]}function Rl(n,t=d2()){if(t)y2(t);let e=(v)=>new Date(v.getFullYear(),v.getMonth(),v.getDate()).getTime(),r=e(new Date),a=new Date(r);a.setDate(a.getDate()-(n-1));let l=a.getTime(),d=[],s={count:0};for(let v of t?o2(t,s):[])for(let f of tn(v,s)){if(!f||typeof f.ts!=="string"||typeof f.command!=="string")continue;let w=new Date(f.ts).getTime();if(!Number.isFinite(w))continue;if(w>=l)d.push(f)}d.sort((v,f)=>new Date(f.ts).getTime()-new Date(v.ts).getTime());let i=Array.from({length:n},()=>0),c=Array.from({length:n},()=>0),L={},u={},p={},o=0,b=0;for(let v of d){let f=v.agent||"unknown";L[f]=(L[f]??0)+1;let w=Math.round((r-e(new Date(v.ts)))/86400000),x=n-1-w,y=w>=0&&w<n;if(y)c[x]=(c[x]??0)+1;if(v.decision!=="allow"){if(o++,v.ruleId)u[v.ruleId]=(u[v.ruleId]??0)+1;let J=jn(v.segment||v.command);if(J)p[J]=(p[J]??0)+1;if(v.failureStage)b++;if(y)i[x]=(i[x]??0)+1}}return{days:n,logsDir:t,homeDir:Ao(),totalInWindow:d.length,truncated:d.length>ot,unreadable:s.count,counts:{blocked:o,allowed:d.length-o,agents:L,blockedByDay:i,analyzedByDay:c,rules:u,commands:p,errors:b},entries:Ho(d).sort((v,f)=>new Date(f.ts).getTime()-new Date(v.ts).getTime())}}import{spawn as Co}from"node:child_process";import{existsSync as Al,statSync as Mo}from"node:fs";import{delimiter as Wo,join as Ko}from"node:path";var Vo=120000,ut="Choose the project folder",Go=`try
...
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,Hl=[{binary:"zenity",args:["--file-selection","--directory",`--title=${ut}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",ut]}],Cl=(n,t)=>(t.PATH??"").split(Wo).some((e)=>e.length>0&&Al(Ko(e,n)));function Ml(n,t){if(n==="darwin"||n==="win32")return!0;if(n!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return Hl.some((e)=>Cl(e.binary,t))}function Oo(n,t){if(n==="darwin")return{cmd:"osascript",args:["-e",Go]};if(n==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",Uo]};let e=Hl.find((r)=>Cl(r.binary,t));return e?{cmd:e.binary,args:e.args}:null}function Wl(n=process.platform,t=process.env){let e=Oo(n,t);if(!e)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((r)=>{let a=Co(e.cmd,e.args,{env:t,stdio:["ignore","pipe","pipe"]}),l="",d=!1,s=(c)=>{if(d)return;d=!0,clearTimeout(i),r(c)},i=setTimeout(()=>{a.kill(),s({error:"The folder dialog timed out"})},Vo);a.stdout.on("data",(c)=>{l+=c.toString()}),a.on("error",()=>s({error:`Could not open the folder dialog (${e.cmd})`})),a.on("close",()=>{let c=l.trim().replace(/\/+$/,"");if(!c)return s({cancelled:!0});if(!Al(c)||!Mo(c).isDirectory())return s({error:"That selection is not a folder on disk"});s({path:c})})})}var Kl=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var Vl='<script id="ccsn-data" type="application/json">';function Gl(n){return Kl.replace(Vl,()=>Vl+JSON.stringify({token:n}).replaceAll("<","\\u003c"))}var vt="kenryu42/cc-safety-net",Po=`https://github.com/${vt}`,dr=1e4,Io=7;async function rd(n,t={}){let e=j({label:"gui",booleans:{noOpen:["--no-open"]}},n),r=t.log??console.log,a=t.error??console.error;if(e.errors.length>0){for(let d of e.errors)a(d);return a("Usage: cc-safety-net gui [--no-open]"),1}let l=await No(t);if(r(`CC Safety Net policy GUI: ${l.url}`),!e.flags.noOpen)try{await(t.openBrowser??su)(l.url)}catch(d){a(`Failed to open browser: ${d instanceof Error?d.message:String(d)}`),a(`Open this URL manually: ${l.url}`)}if(t.keepAlive===!1)return await l.close(),0;return await du(l),0}async function No(n={}){let t=n.token??To(24).toString("base64url"),e=_o((l,d)=>{nu(l,d,t,n)});await new Promise((l,d)=>{e.once("error",d),e.listen(0,"127.0.0.1",()=>{e.off("error",d),l()})});let a=`http://127.0.0.1:${e.address().port}`;return{origin:a,token:t,url:`${a}/?token=${encodeURIComponent(t)}`,close:()=>lu(e)}}async function nu(n,t,e,r){let a=new URL(n.url??"/","http://127.0.0.1");if(n.method==="GET"&&a.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!ru(n,a,e)){k(t,403,{error:"Forbidden"});return}if(n.method==="GET"&&a.pathname==="/"){au(t,Gl(e));return}if(n.method==="GET"&&a.pathname==="/api/policy"){let l=_l(r);k(t,200,{...l,configState:Ln(H(r)),destructiveCommandRules:dn,secretPatterns:Ol,version:z(),preview:l.errors.length>0?null:Pl(l.policy)});return}if(n.method==="POST"&&a.pathname==="/api/policy/preview"){let l=await pt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=El(l.value);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/policy/explain"){let l=await pt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value;if(d===null||typeof d.command!=="string"){k(t,400,{errors:["command must be a string"]});return}let s=Kt(d.policy);if(s.length>0){k(t,400,{errors:s});return}k(t,200,tu(d.command,d.policy,r));return}if(n.method==="POST"&&a.pathname==="/api/policy"){let l=await pt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=ar(l.value,r);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/reset"){k(t,200,ar(Tl,r));return}if(n.method==="POST"&&a.pathname==="/api/repair"){k(t,200,Il(r));return}if(n.method==="GET"&&a.pathname==="/api/activity"){let l=C2(r),d=eu(a.searchParams.get("days"),l);if(d===null){k(t,400,{error:`days must be an integer between 1 and ${l}`});return}k(t,200,Rl(d,r.activityLogsDir));return}if(n.method==="POST"&&a.pathname==="/api/rules/choose-directory"){k(t,200,await Wl());return}if(n.method==="GET"&&a.pathname==="/api/rules"){let l=u2(r),d=new Map(l.rules.map((s)=>[s.name,s]));k(t,200,{projectPath:r.cwd??process.cwd(),canPickDirectory:Ml(process.platform,process.env),rulebooks:l.rulebooks.map((s)=>({source:s.source,spec:s.spec,name:s.name,version:s.version,rules:s.rules.flatMap((i)=>{let c=d.get(i);if(!c)return[];return[{name:c.name,command:c.command,subcommand:c.subcommand,block_args:c.block_args,reason:c.reason}]})})),errors:l.errors,warnings:l.warnings});return}if(n.method==="GET"&&a.pathname==="/api/star/context"){k(t,200,await(r.fetchStarContext??(()=>pu({logsDir:r.activityLogsDir})))());return}if(n.method==="POST"&&a.pathname==="/api/star"){let l=await(r.starRepo??iu)();k(t,200,l.ok?{ok:!0}:{ok:!1,fallbackUrl:Po});return}if(n.method==="GET"&&a.pathname==="/api/integrations"){k(t,200,await(r.fetchIntegrations??Lu)());return}if(n.method==="GET"&&a.pathname==="/api/health"){k(t,200,await(r.fetchHealth??ou)());return}if(n.method==="POST"&&(a.pathname==="/api/install"||a.pathname==="/api/uninstall")){let l=await pt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value?.target;if(typeof d!=="string"||!G.some((i)=>i.target===d)){k(t,400,{error:"unknown target"});return}let s=a.pathname==="/api/install"?"install":"uninstall";k(t,200,await(r.runIntegration??uu)(s,d));return}k(t,404,{error:"Not found"})}function tu(n,t,e){let r=Nl(t),a=H(e),l=sn({rules:a.policy.rules,transparentWrappers:a.policy.transparentWrappers,safety:td(r.safety),worktreeMode:r.workflow.worktree_mode,destructiveCommandProtectionEnabled:r.destructive_command_protection.enabled,destructiveCommandRuleOverrides:r.destructive_command_protection.overrides,destructiveCommandAllowPaths:r.destructive_command_protection.allow_paths,secretProtection:{enabled:r.secret_protection.enabled,disabledRules:[...nd(r.secret_protection.overrides)],denyPaths:r.secret_protection.deny_paths}});return H2(n,{policySnapshot:l,cwd:e.cwd,userConfigDir:e.userConfigDir})}function eu(n,t){if(n===null)return Math.min(Io,t);let e=Number(n);if(!Number.isInteger(e)||e<1||e>t)return null;return e}function ru(n,t,e){if(t.searchParams.get("token")!==e)return!1;if(n.method!=="POST")return!0;return n.headers["x-cc-safety-net-token"]===e}async function pt(n){let t=[];for await(let e of n)t.push(e);try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(e){return{ok:!1,error:`Invalid JSON: ${e instanceof Error?e.message:String(e)}`}}}function au(n,t){n.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),n.end(t)}function k(n,t,e){n.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),n.end(JSON.stringify(e))}function lu(n){return new Promise((t,e)=>{n.close((r)=>r?e(r):t())})}function du(n){return new Promise((t)=>{let e=()=>{process.off("SIGINT",r),process.off("SIGTERM",r)},r=()=>{e(),n.close().then(t)};process.once("SIGINT",r),process.once("SIGTERM",r)})}function su(n){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",e=process.platform==="win32"?["/c","start","",n]:[n];return new Promise((r,a)=>{let l=ed(t,e,{detached:!0,stdio:"ignore"}),d=(i)=>{l.off("spawn",s),a(i)},s=()=>{l.off("error",d),l.unref(),r()};l.once("error",d),l.once("spawn",s)})}async function iu(n="gh",t=dr){return{ok:await lr(n,["api","-X","PUT",`/user/starred/${vt}`],t)===0}}var cu={amp:"ampVersion","antigravity-cli":"antigravityCliVersion","claude-code":"claudeCodeVersion",codex:"codexCliVersion","copilot-cli":"copilotCliVersion",cursor:"cursorVersion","gemini-cli":"geminiCliVersion","hermes-agent":"hermesAgentVersion","kimi-code":"kimiCodeVersion",openclaw:"openClawVersion",opencode:"openCodeVersion",pi:"piCliVersion"};async function Lu(n={}){let t=await vn(n.fetcher),e=ad(t,n.homeDir);return{targets:i2.map((r)=>{let a=e.find((l)=>l.platform===r.id);return{target:r.id,label:p2(r.id),version:t[cu[r.id]],status:a?.configured?"active":a?.detected?"disabled":a?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function ad(n,t){return E2(process.cwd(),{homeDir:t,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.copilotCliVersion})}async function ou(n={}){let[t,e]=await Promise.all([vn(n.fetcher),(n.checkUpdates??G2)()]);return{hooks:ad(t,n.homeDir).filter((r)=>r.detected).map((r)=>({platform:r.platform,label:p2(r.platform),configured:r.configured})),update:{currentVersion:e.currentVersion,latestVersion:e.latestVersion??null,updateAvailable:e.updateAvailable}}}var Ul=Promise.resolve();function uu(n,t,e={}){let r=async()=>{let l=[],d=console.log,s=console.error;console.log=(...i)=>l.push(i.map(String).join(" ")),console.error=console.log;try{return{ok:await kn(n,[],{selectTargets:async()=>[t],output:new Eo({write(c,L,u){u()}}),...e})===0,output:l.join(`
`)}}finally{console.log=d,console.error=s}},a=Ul.then(r);return Ul=a.then(()=>{return},()=>{return}),a}async function pu(n={}){let[t,e,r]=await Promise.all([vu(n.command),bu(n.fetchRepo),Promise.resolve(Rn(C2(),n.logsDir).totalBlocked)]);return{starred:t,starCount:e,blockedTotal:r}}async function vu(n="gh",t=dr){if(await lr(n,["auth","status"],t)!==0)return null;let e=await lr(n,["api",`/user/starred/${vt}`],t);if(e===0)return!0;if(e===null)return null;return!1}function lr(n,t,e){return new Promise((r)=>{let a=ed(n,t,{stdio:"ignore",windowsHide:!0}),l=!1,d,s=(i)=>{if(l)return;if(l=!0,d)clearTimeout(d);r(i)};a.once("error",()=>s(null)),a.once("close",s),d=setTimeout(()=>{a.kill(),s(null)},e)})}async function bu(n=fetch){try{let t=await n(`https://api.github.com/repos/${vt}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout(dr)});if(!t.ok)return null;let e=await t.json();return typeof e.stargazers_count==="number"?e.stargazers_count:null}catch{return null}}function fu(n){if(n[0]!=="help")return!1;let t=n[1];if(!t)Ye(),process.exit(0);if($n(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var hu={hook:async(n)=>{let t=Fa(n);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),$n("hook",console.error),process.exit(1)},install:async(n)=>{process.exit(await kn("install",n))},update:async(n)=>{process.exit(await Ne(n))},uninstall:async(n)=>{process.exit(await kn("uninstall",n))},rule:async(n)=>{process.exit(await Ql(n))},status:async(n)=>{if(e2(j({label:"status"},n).errors))process.exit(1);Yl()},statusline:async(n)=>{let t=j({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},n);if(t.errors.length===0&&t.flags.claudeCode){await rr();return}if(e2(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");$n("statusline",console.error),process.exit(1)},doctor:async(n)=>{let t=Je(n);if(!t)process.exit(1);let e=await D0({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(e)},logs:async(n)=>{process.exit(await Pr(n))},gui:async(n)=>{process.exit(await rd(n))},explain:async(n)=>{let t=Se(n);if(!t)process.exit(1);let e=H2(t.command,{cwd:t.cwd}),r=!!process.env.NO_COLOR||!process.stdout.isTTY;if(t.json)console.log(Xe(e));else console.log(Qe(e,{asciiOnly:r}));process.exit(0)}};async function yu(){let n=process.argv.slice(2),t=j({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},n);if(fu(n))return;let e=n[0],r=e?Yn(e):void 0;if(t.help&&r&&r.name!=="rule")$n(r.name),process.exit(0);if(!e||t.help&&!r)Ye(),process.exit(0);if(t.flags.version)S0(),process.exit(0);if(r){await hu[r.name](n.slice(1));return}let a=za(e);if(a){await a.run();return}if(e==="--statusline"){await rr();return}console.error(e.startsWith("-")?`Unknown option: ${e}`:`Unknown command: ${e}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}yu().catch((n)=>{console.error("CC Safety Net error:",n),process.exit(1)});
