...
<body>
  ...
  <script>
    ...
    const safetyLevels = {
      standard: ['Standard', 'Blocks recognizable destructive Git and filesystem commands. Recommended for normal coding.'],
      strict: ['Strict', 'Standard, plus blocks dynamic or unparseable commands the analyzer cannot verify safely. Occasional false positives on advanced shell.'],
