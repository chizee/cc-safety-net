...
`);return}}let s=await vr(Ul(n,d,a),{loadingMessage:`${n==="install"?"Installing":"Uninstalling"} ${b2(d)} integration…`,output:l,sleep:r.sleep});l.write(`${s}
