#!/usr/bin/env node
import{$ as sr,$a as _e,A as vn,Aa as Ye,B as d3,Ba as lr,C as P,Ca as Se,D as C,Da as He,E as Et,Ea as T,F as Rt,Fa as Gt,G as Rn,Ga as Pt,H as Kt,Ha as It,I as C2,Ia as O,J as D2,Ja as B3,K as Nt,Ka as yn,L as s2,La as J3,M as h1,Ma as we,N as dr,Na as Z3,O as Kn,Oa as Q3,P as w1,Pa as X3,Q as x1,Qa as bt,R as Vn,Ra as Y3,S as Gn,Sa as S3,T as wn,Ta as l1,U as xn,Ua as d1,V as Ie,Va as s1,W as on,Wa as c1,X as m2,Xa as i3,Y as nr,Ya as Te,Z as T2,Za as Oe,_ as $1,_a as Ut,aa as m1,ab as Ee,b as me,ba as k1,bb as o2,c as ke,ca as Ne,cb as g2,d as A,da as Be,db as l2,e as qe,ea as n1,eb as Pe,f as St,fa as t1,fb as W,g as Q,ga as r1,gb as hn,h as D,ha as tr,hb as bn,i as Ln,ia as Je,ib as D1,j as g,ja as m,jb as q2,k as $2,ka as rr,kb as c2,l as Ke,la as g1,lb as Q1,m as R2,ma as d2,mb as Mn,n as pn,na as fn,o as b3,oa as er,p as Wt,pa as ar,q as Me,qa as e1,r as un,ra as a1,s as Ve,sa as Ze,t as _t,ta as G2,u as Ge,ua as Mt,v as Ue,va as Vt,w as _,wa as Ce,x as E,xa as A2,y as M2,ya as F3,z as V2,za as Xe}from"../chunks/index-e9e5za60.js";var M3=["-h","--help"];function z(n,t){let r=Object.entries(n.booleans??{}),e=Object.entries(n.values??{}),a=Object.fromEntries(r.map(([i])=>[i,!1])),l={},d=[],s=[],c=!1,L=-1;for(let[i,u]of t.entries()){if(i<=L)continue;if(u==="--"){d.push(...t.slice(i+1));break}if(M3.includes(u)){c=!0;continue}let o=r.find(([,f])=>f.includes(u));if(o){a[o[0]]=!0;continue}let p=e.find(([,f])=>f.includes(u));if(p){let f=t[i+1];if(f===void 0||f.startsWith("-")){s.push(`${u} requires a value`);continue}l[p[0]]=f,L=i+1;continue}if(u.startsWith("-")){s.push(`Unknown option for ${n.label}: ${u}`);continue}if(n.positionals==="tail"){d.push(...t.slice(i));break}d.push(u)}if(n.positionals!=="list"&&n.positionals!=="tail")s.push(...d.map((i)=>`Unexpected argument for ${n.label}: ${i}`));return{flags:a,values:l,positionals:d,help:c,errors:s}}function e2(n){for(let t of n)console.error(t);return n.length>0}import{readdirSync as jd,statSync as i1,unlinkSync as zd}from"node:fs";import{basename as p1,dirname as Fd,join as Bd,resolve as Jd}from"node:path";function F(n){return Array.from(n,(t)=>{let r=t.charCodeAt(0);if(r<=31||r>=127&&r<=159)return`\\x${r.toString(16).padStart(2,"0")}`;return t}).join("")}var Zt=(n)=>{let t=Date.now()-new Date(n).getTime();if(!Number.isFinite(t))return"";let r=Math.floor(t/60000),e=Math.floor(r/60),a=Math.floor(e/24);if(a>0)return`${a}d ago`;if(e>0)return`${e}h ago`;if(r>0)return`${r}m ago`;return"just now"},Y2=(n)=>{let t=(n??"").trim().split(/\s+/).filter((a)=>a&&!/^[A-Za-z_][A-Za-z0-9_]*=/.test(a)),r=t[0]?.split("/").pop();if(!r)return null;let e=t[1];return e&&/^[a-z][a-z0-9-]*$/.test(e)?`${r} ${e}`:r};import{existsSync as V3,readdirSync as G3,readFileSync as U3}from"node:fs";import{join as C3}from"node:path";function v2(n,t){try{return G3(n,{withFileTypes:!0,encoding:"utf8"}).flatMap((r)=>{let e=C3(n,r.name);if(r.isDirectory())return v2(e,t);if(r.name.endsWith(".jsonl"))return[e];return[]})}catch{if(t&&V3(n))t.count++;return[]}}function Qt(n){let t=(a)=>`${a.sessionId}
${Y2(a.segment||a.command)}`,r=n.filter((a)=>a.decision!=="allow"),e=r.filter((a)=>a.sessionId).reduce((a,l)=>a.set(t(l),(a.get(t(l))??0)+1),new Map);return new Set(r.filter((a)=>a.failureStage||(e.get(t(a))??0)>=2))}function cn(n,t){try{return U3(n,"utf-8").split(`
`).filter(Boolean).flatMap((r)=>{try{return[JSON.parse(r)]}catch{if(t)t.count++;return[]}})}catch{if(t)t.count++;return[]}}import{resolve as wd}from"node:path";var T3=["AKIA","ASIA","ghp_","gho_","ghu_","ghs_","ghr_","github_pat_","glpat-","xox","npm_","pypi-","rk_","sk-","sk_","gsk_","xai-","pplx-","bastn_","tgp_v1_","flp_","wfr_","fw_","fwp_","tp-","psk-"];function je(n){let t=0,r={allocateSegment(){return t++},getNextSegmentIndex(){return t},recordGlobal(e){n.record({kind:"step",scope:"global",step:e})},recordSegment(e,a=r.currentSegmentIndex){if(a===void 0)return;n.record({kind:"step",scope:"segment",segmentIndex:a,step:e})}};return r}function ze(n={}){let t=[],r=n.maxEvents??512,e={maxTextLength:n.maxTextLength??2048,maxListLength:n.maxListLength??128,maxObjectProperties:n.maxObjectProperties??n.maxListLength??128,maxDepth:n.maxDepth??16},a=0,l,d=new Set;return{record(s){if(l)return;try{if(!s||t.length>=r){a++;return}t.push(Yt(O3(s,e,d)))}catch{a++}},finish(s){if(l)return l;try{l=Yt({events:Object.freeze(t),droppedEvents:a,terminal:_3(s,e,d)})}catch{a++,l=Object.freeze({events:Object.freeze(t),droppedEvents:a,terminal:Object.freeze({result:"blocked",reason:"trace unavailable".slice(0,e.maxTextLength),segment:"trace unavailable".slice(0,e.maxTextLength)})})}return l}}}function O3(n,t,r){if(n.kind!=="step")throw TypeError("invalid trace event");let{scope:e,step:a}=n;Hn(a,r,t);let l=S2(a,t,r);if(e==="global")return{kind:"step",scope:"global",step:l};if(e!=="segment")throw TypeError("invalid trace event scope");return{kind:"step",scope:"segment",segmentIndex:n.segmentIndex,step:l}}function _3(n,t,r){let e=n.result;if(e==="allowed")return Object.freeze({result:"allowed"});if(e!=="blocked")throw TypeError("invalid trace terminal");let a=n.ruleId;return Object.freeze({result:"blocked",reason:S2(n.reason,t,r),segment:S2(n.segment,t,r),...a?{ruleId:S2(a,t,r)}:{}})}function Hn(n,t,r,e=0,a=new WeakSet){if(typeof n==="string"){let s=n.slice(0,r.maxTextLength);if(!St(s))return;for(let c of qe(s))for(let L of c.match(/[^\s"'()$]+/g)??[])t.add(Fe(L));return}if(!n||typeof n!=="object"||e>=r.maxDepth||a.has(n))return;if(a.add(n),Array.isArray(n)){let s=Math.min(n.length,r.maxListLength);for(let c=0;c<s;c++)Hn(n[c],t,r,e+1,a);return}let l=0,d=new Set;for(let s in n){if(!Object.hasOwn(n,s))continue;if(l>=r.maxObjectProperties)break;l++,Hn(s,t,r);let c=Xt(s,r,t);if(d.has(c))continue;d.add(c),Hn(n[s],t,r,e+1,a)}}function S2(n,t,r,e=0,a=new WeakSet){if(typeof n==="string")return Xt(n,t,r);if(!n||typeof n!=="object")return n;if(e>=t.maxDepth)return;if(a.has(n))return;if(a.add(n),Array.isArray(n)){let s=[],c=Math.min(n.length,t.maxListLength);for(let L=0;L<c;L++)s.push(S2(n[L],t,r,e+1,a));return s}let l={},d=0;for(let s in n){if(!Object.hasOwn(n,s))continue;if(d>=t.maxObjectProperties)break;d++;let c=Xt(s,t,r);if(Object.hasOwn(l,c))continue;Object.defineProperty(l,c,{value:S2(n[s],t,r,e+1,a),enumerable:!0,configurable:!0,writable:!0})}return l}function Xt(n,t,r){let e=n.slice(0,t.maxTextLength),a=St(e)?ke(e):e,l=r.size>0?P3(a,r):a;return(E3(l)?me(l):l).slice(0,t.maxTextLength)}function E3(n){return n.includes("PRIVATE KEY")||n.includes("://")||n.includes("eyJ")||n.includes(":")&&/(?:authorization|cookie|x-api-key|api-key|(?:^|\s)(?:-u|--user)(?:\s|=))/i.test(n)||n.length>=14&&T3.some((t)=>n.includes(t))||n.length>=49&&/\b[a-f0-9]{32}\.[A-Za-z0-9]{16}\b/.test(n)}function P3(n,t){return n.replace(/[^\s"'()$]+/g,(r)=>t.has(Fe(r))?"<redacted>":r)}function Fe(n){let t=2166136261,r=2166136261;for(let e=0;e<n.length;e++)t=Math.imul(t^n.charCodeAt(e),16777619),r=Math.imul(r^n.charCodeAt(n.length-e-1),16777619);return`${t>>>0}:${r>>>0}:${n.length}`}function Yt(n){if(n&&typeof n==="object"&&!Object.isFrozen(n)){for(let t of Object.values(n))Yt(t);Object.freeze(n)}return n}function Qe(n,t,r,e){let a=e??Be(),l=r??a.getCommandProgram(n,t.shell??"auto"),d=ze(),s=je(d),c=l.dialect==="powershell"?a.getCommandProgram(n,"posix"):l,L=Je(c);s.recordGlobal({type:"parse",input:n,segments:L.map((o)=>[...o])});let i=Ze(n,{...t,analyzePartialProgram:!0,trace:s},l,a),u=s.getNextSegmentIndex();if(i&&u>0&&u<L.length)s.recordSegment({type:"segment-skipped",index:u,reason:"prior-segment-blocked"},u);return Object.freeze({decision:i,trace:d.finish(i?{result:"blocked",reason:i.reason,segment:i.evidence.find((o)=>o.kind==="command")?.segment??n,...i.ruleId?{ruleId:i.ruleId}:{}}:{result:"allowed"}),program:l})}import{resolve as I3}from"node:path";function Ht(n){let t=Xe().safeParse(n);return{errors:t.success?[]:Se(t.error.issues),ruleNames:new Set(Ye(n).map((r)=>r.toLowerCase()))}}function At(n){let t=Ae(n);if(!t.ok)return t.result;return Ht(t.parsed)}function Ae(n){let t=[],r=new Set;try{let e=typeof n==="string"?Ln(n):n,a=g(e);if(a===null)return t.push(`File not found: ${e.path}`),{ok:!1,result:{errors:t,ruleNames:r}};if(!a.trim())return t.push("Config file is empty"),{ok:!1,result:{errors:t,ruleNames:r}};return{ok:!0,parsed:JSON.parse(a)}}catch(e){if(e instanceof Q)return t.push(e.message),{ok:!1,result:{errors:t,ruleNames:r}};let a=e instanceof Error?e.message:String(e);return t.push(e instanceof SyntaxError?"Invalid JSON":a),{ok:!1,result:{errors:t,ruleNames:r}}}}function We(n){return I3(n??process.cwd(),".safety-net.json")}function a2(n){let t=Ae(n);if(!t.ok)return t.result;let r=He(t.parsed);return{errors:r.errors,ruleNames:r.sources}}import{isAbsolute as N3,join as An,relative as nd,resolve as Re,sep as td}from"node:path";async function K2(n={}){let t=Tt(n);return rd(t,await Wn(t,A2()))}function rd(n,t){if(!t.ok)return t;let r=C(n),e=[...new Set(l2(r.configPath,r.lockPath,n,r.filesystemScope))];if(e.length===0)return t;return{ok:!1,errors:e,warnings:t.warnings,entries:t.entries}}async function Wn(n,t,r,e={}){let a=null,l=!1;try{let d=C(n),s=Gt(d.configTarget);if(!s.ok)return s.result;let c=s.config;if(n.check)return cd(c,d,n);a={target:d.lockTarget,content:g(d.lockTarget)};let L=Ut(d.lockTarget);if(L.errors.some((y)=>y.startsWith("Unable to access ")))return{ok:!1,errors:L.errors,warnings:[],entries:[]};if(n.only&&L.errors.length>0)return{ok:!1,errors:L.errors,warnings:[],entries:[]};let i=L.errors.length>0?null:L.lock,u=n.only?Te(c,i,n.only):{ok:!0,specs:c.rules};if(!u.ok)return u.result;if(n.only&&!i&&u.specs.length<c.rules.length)return{ok:!1,errors:[`No lockfile available for partial update; run ${Ue}`],warnings:[],entries:[]};let o=(await ad(u.specs,(y)=>_e(y,d.configDir,n,i,d.filesystemScope,t),t)).map((y)=>Ld(y,i,r));for(let y of o)ud(y.content,y.entry,d.configDir,n,d.filesystemScope);let p=n.only?id(c,i,o):o.map((y)=>y.entry);l=!0,O(d.lockTarget,{version:1,rulebooks:p},void 0,e._testAfterPolicyRename);let f=new Map(o.map((y)=>[y.entry.spec,y.rulebook.rules.length])),v=vd(p,d.configDir,n,d.filesystemScope,e);return{ok:!0,errors:[],warnings:v,entries:p.map((y)=>pd(y,f))}}catch(d){if(l&&a)try{H2(a.target,a.content)}catch(s){return W2(s)}return W2(d)}}async function Ct(n,t={}){return ed(n,Tt(t),A2())}async function ed(n,t,r,e={}){let a=null,l=!1;try{let d=C(t),s=g(d.configTarget);a={target:d.configTarget,content:s};let c=Gt(d.configTarget);if(!c.ok)return c.result;let L=c.config,i=Ge(n)?await Ee(n,r):[{spec:n}],u=i.map((f)=>f.spec),o=[...new Set([...L.rules,...u])];if(o.length>Mt)return ld();if(o.length!==L.rules.length)l=!0,O(d.configTarget,{version:1,rules:o,overrides:L.overrides??{},transparent_wrappers:L.transparent_wrappers??[]},void 0,e._testAfterPolicyRename);let p=await Wn(t,r,new Map(i.filter((f)=>!!f.display_ref).map((f)=>[f.spec,f.display_ref])),e);if(!p.ok)H2(d.configTarget,s);return p}catch(d){if(l&&a)try{H2(a.target,a.content)}catch(s){return W2(s)}return W2(d)}}async function ad(n,t,r=A2()){if(n.length>Mt)throw Error(Vt);let e=Array(n.length),a=0,l,d=Array.from({length:Math.min(n.length,Ce.concurrency)},async()=>{while(!l){let s=a;if(s>=n.length)return;a++;try{e[s]=await t(n[s],s,r.controller.signal)}catch(c){if(!l)l={value:c},a=n.length,r.controller.abort(c);return}}});if(await Promise.all(d),l)throw l.value;return e}function ld(){return{ok:!1,errors:[Vt],warnings:[],entries:[]}}function Tt(n){return{cwd:n.cwd,cacheConfigDir:n.cacheConfigDir,userConfigDir:n.userConfigDir,userConfigPath:n.userConfigPath,projectConfigPath:n.projectConfigPath,global:n.global,check:n.check,only:n.only,refresh:n.refresh}}function dd(n){return{...Tt(n),deleteSource:n.deleteSource}}async function Ot(n,t={}){try{return await sd(n,dd(t),{})}catch(r){return W2(r)}}async function sd(n,t,r){let e=C(t),a=T(e.configTarget);if(a.errors.length>0)return{ok:!1,errors:a.errors,warnings:[],entries:[]};if(!a.config)return{ok:!1,errors:[`No config found at ${e.configPath}`],warnings:[],entries:[]};let l=Ut(e.lockTarget);if(l.errors.length>0)return{ok:!1,errors:l.errors,warnings:[],entries:[]};let d=Oe(a.config.rules,l.lock,n);if(!d.ok)return d.result;let s=t.deleteSource?od(e.configDir,d.specs,l.lock,e.filesystemScope):{ok:!0,dirs:[]};if(!s.ok)return s.result;let c=g(e.configTarget);if(c===null)return W2(Error("Rules config is unavailable."));try{O(e.configTarget,{version:1,rules:a.config.rules.filter((u)=>!d.specs.includes(u)),overrides:a.config.overrides??{},transparent_wrappers:a.config.transparent_wrappers??[]},void 0,r._testAfterPolicyRename)}catch(u){throw H2(e.configTarget,c),u}let L=await Wn(t,A2(),void 0,r);if(!L.ok)return H2(e.configTarget,c),L;let i=fd(s.dirs,r,e.filesystemScope);if(!i.ok){H2(e.configTarget,c);let u=await Wn(t,A2(),void 0,r);if(!u.ok)return{ok:!1,errors:[...i.result.errors,...u.errors],warnings:u.warnings,entries:u.entries};return i.result}return L}async function cd(n,t,r){let e=Pe(n,t.lockPath,t.configDir,r,r.global?"user":"project",t.filesystemScope);return{ok:e.errors.length===0&&e.warnings.length===0,errors:[...e.errors,...e.warnings],warnings:[],entries:e.entries}}function Ld(n,t,r){let e=t?.rulebooks.find((l)=>l.spec===n.entry.spec&&l.kind==="github"),a=r?.get(n.entry.spec)??(e?.kind==="github"?e.display_ref:void 0);if(!a||n.entry.kind!=="github")return n;return{...n,entry:{...n.entry,display_ref:a}}}function id(n,t,r){let e=new Set(n.rules),a=new Set(t?.rulebooks.map((d)=>d.spec)??[]),l=new Map(r.map((d)=>[d.entry.spec,d.entry]));return[...(t?.rulebooks.filter((d)=>e.has(d.spec))??[]).map((d)=>l.get(d.spec)??d),...r.filter((d)=>!a.has(d.entry.spec)).map((d)=>d.entry)]}function pd(n,t){return{...n,ruleCount:t.get(n.spec)}}function ud(n,t,r,e,a){let l=Rt(t,Kt(r,e));$2(D(a,l),n)}function vd(n,t,r,e,a){let l=Kt(t,r),d=Rn(l),s=D(e,d),c=R2(s);if(!c)return[];let L=n.map((u)=>D(e,Rt(u,l))),i=c.filter((u)=>u.kind==="directory").map((u)=>({directory:D(e,An(d,u.name)),identity:D(e,An(d,u.name,Ve))})).filter((u)=>!L.some((o)=>Ke(u.identity,o))).map((u)=>u.directory);for(let u of i)Me(u);return i.flatMap((u)=>{try{return yd(u,a),[]}catch{return["Unable to prune rules policy cache safely."]}})}function od(n,t,r,e){let a=new Map(r?.rulebooks.map((L)=>[L.spec,L])??[]),l=t.flatMap((L)=>{let i=a.get(L);if(!i)return un.test(L)?[]:["--delete-source can only delete local rulebook sources"];return i.kind==="local-directory"?[]:["--delete-source can only delete local rulebook sources"]}),d=t.map((L)=>{let i=a.get(L);return An(n,i?.kind==="local-directory"?i.path:L)}),s=l.length>0?[]:d.flatMap((L)=>bd(n,L,e)),c=[...l,...s];return c.length>0?{ok:!1,result:{ok:!1,errors:c,warnings:[],entries:[]}}:{ok:!0,dirs:d}}function bd(n,t,r){let e=Re(n),a=Re(t),l=nd(e,a);if(l===""||l===".."||l.startsWith(`..${td}`)||N3(l))return[`Refusing to delete local rulebook source outside ${n}: ${t}`];let d=D(r,a),s=R2(d);if(!s)return[`Local rulebook source directory not found: ${t}`];let c=s.find((L)=>L.name==="rulebook.json");if(!c)return[`Local rulebook source directory is missing rulebook.json: ${t}`];if(c.kind!=="file")throw new Q(r.label);if(g(D(r,An(a,"rulebook.json"))),s.length>1)return[`Local rulebook source directory contains extra files: ${t}. delete manually if you really want to remove the directory.`];return[]}function fd(n,t,r){let e=n.flatMap((a)=>{try{return hd(D(r,a),t),[]}catch(l){return[`Failed to delete local rulebook source ${a}: ${l instanceof Error?l.message:String(l)}`]}});return e.length>0?{ok:!1,result:{ok:!1,errors:e,warnings:[],entries:[]}}:{ok:!0}}function yd(n,t){if(t._testPruneRulebookCacheDir){t._testPruneRulebookCacheDir(n.path);return}Wt(n)}function hd(n,t){if(t._testDeleteLocalSourceDir){t._testDeleteLocalSourceDir(n.path);return}Wt(n)}function H2(n,t){if(t===null){pn(n);return}$2(n,t)}function W2(n){return{ok:!1,errors:[n instanceof Error?n.message:String(n)],warnings:[],entries:[]}}function U2(n,t){let r=$d(t),e=e1(r),a={effectiveLevel:e.effectiveLevel,selectedPreset:r.policySnapshot.policy.safety.level??"standard",effectiveCapabilities:e.effectiveCapabilities,destructiveCommandRuleOverrides:r.policySnapshot.policy.destructiveCommandRuleOverrides},{configSource:l,configValid:d}=xd({cwd:t?.cwd,userConfigDir:t?.userConfigDir});if(!n||!n.trim())return{trace:{steps:[{type:"error",message:"No command provided"}],segments:[]},result:"allowed",configSource:l,configValid:d,...a};let s=gd(n,r);if(s)return{trace:{steps:[],segments:[{index:0,steps:[{type:"rule-check",ruleModule:s.ruleModule,ruleFunction:s.ruleFunction,matched:!0,reason:s.reason}]}]},result:"blocked",reason:A(s.reason),segment:A(s.target),...s.ruleId?{ruleId:A(s.ruleId)}:{},configSource:l,configValid:d,...a};let c=Qe(n,r),L=c.decision,i=L?.ruleId??Dd(n,r),u=on.find((p)=>p.id===i&&p.activationCapability),o=u?e.policy.effectiveDestructiveCommandRules[u.id]:void 0;return{trace:kd(c.trace),result:L?"blocked":"allowed",reason:L?A(L.reason):void 0,segment:L?A(L.evidence.find((p)=>p.kind==="command")?.segment??n):void 0,ruleId:L?.ruleId?A(L.ruleId):void 0,customRule:md(qd(L?.ruleId,r.policySnapshot)),configSource:l,configValid:d,...a,...u&&o?{ruleActivation:{id:u.id,...o}}:{}}}function xd(n){let t=_(n?.cwd),r=n?.userConfigPath??E(n),e=P({cwd:n?.cwd,userConfigDir:n?.userConfigDir,userConfigPath:n?.userConfigPath});try{if(g(e.projectConfigTarget)!==null){if(a2(e.projectConfigTarget).errors.length===0)return{configSource:t,configValid:!0};return{configSource:t,configValid:!1}}}catch(a){if(a instanceof Q)return{configSource:t,configValid:!1};throw a}try{if(g(e.userConfigTarget)!==null){let a=a2(e.userConfigTarget);return{configSource:r,configValid:a.errors.length===0}}return{configSource:null,configValid:!0}}catch(a){if(a instanceof Q)return{configSource:r,configValid:!1};throw a}}function $d(n){let t=wd(n?.cwd??process.cwd()),r=n?.policySnapshot??W({cwd:t,userConfigDir:n?.userConfigDir}),e=d2(r.policy);return{cwd:t,effectiveCwd:t,policySnapshot:r,environment:Ie(),protectedGitMetadata:r1(t),effectiveCapabilities:e.capabilities,strict:n?.strict??e.strict,paranoidRm:e.paranoidRm,paranoidInterpreters:e.paranoidInterpreters,worktreeMode:e.worktreeMode}}function gd(n,t){let r=t.cwd??process.cwd(),e=Ne(G2("",{command:n},{kind:"command",shell:"posix"},{executionCwd:r,configCwd:r},n)),a=d1(e);if(a)return{reason:l1,target:a.target,ruleId:"policy-protection",ruleModule:"policy-protection",ruleFunction:"findPolicyConfigMutationTarget"};let l=t1(e,t.protectedGitMetadata);if(l)return{reason:n1,target:l.target,ruleId:"git-metadata-protection",ruleModule:"git-metadata-protection",ruleFunction:"findGitMetadataMutationTarget"};let d=t.policySnapshot.policy,s=d.secretProtection.enabled===!1?null:c1(e,d.secretProtection,{strict:t.strict});if(s)return{reason:s1,target:s.target,ruleId:s.ruleId,ruleModule:"secret-protection",ruleFunction:"findSensitiveTarget"};return null}function Dd(n,t){let r=t.policySnapshot.policy,e=bn({...r,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:{...r.destructiveCommandRuleOverrides,...Object.fromEntries(on.flatMap((a)=>a.activationCapability?[[a.id,"on"]]:[]))}},t.policySnapshot.state==="degraded"?{diagnostics:t.policySnapshot.diagnostics,reason:t.policySnapshot.reason}:void 0);return a1(n,{...t,policySnapshot:e,strict:!0,paranoidRm:!0,paranoidInterpreters:!0})?.ruleId}function md(n){if(!n)return;return{id:A(n.id),...n.rulebook?{rulebook:{name:A(n.rulebook.name),version:A(n.rulebook.version)}}:{},...n.source?{source:A(n.source)}:{},...n.override?{override:{type:"reason",reason:A(n.override.reason)}}:{}}}function kd(n){let t=n.events.flatMap((e)=>e.kind==="step"&&e.scope==="global"?[e.step]:[]),r=new Map;for(let e of n.events){if(e.kind!=="step"||e.scope!=="segment")continue;let a=r.get(e.segmentIndex)??{index:e.segmentIndex,steps:[]};a.steps.push(e.step),r.set(e.segmentIndex,a)}return{steps:t,segments:[...r.values()]}}function qd(n,t){let r=n?.replace(/^custom\./,"");if(!r||!t.policy.rules.some((e)=>e.name===r))return;return t.ruleMetadata[r]??Object.freeze({id:r})}function Zd(n){let t=C2(),r=z({label:"logs",booleans:{all:["--all"],suspect:["--suspect"],json:["--json"],pruneLegacy:["--prune-legacy"],dryRun:["--dry-run"]},values:{id:["--id"],limit:["--limit"],since:["--since"],agent:["--agent"],rule:["--rule"],session:["--session"],project:["--project"]}},n);if(e2(r.errors))return null;if(r.values.id!==void 0&&!/^[a-f0-9]{16}$/.test(r.values.id))return console.error("--id must be 16 hexadecimal characters"),null;let e=r.values.limit===void 0?20:L1(r.values.limit);if(e===null)return console.error("--limit must be a positive number"),null;let a=r.values.since===void 0?Math.min(30,t):L1(r.values.since);if(a===null||a>t)return console.error(`--since must be a positive number of days no greater than ${t}`),null;let l={limit:e,limitExplicit:r.values.limit!==void 0,since:a,sinceExplicit:r.values.since!==void 0,all:r.flags.all,json:r.flags.json,suspect:r.flags.suspect,pruneLegacy:r.flags.pruneLegacy,dryRun:r.flags.dryRun,id:r.values.id,agent:r.values.agent,rule:r.values.rule,session:r.values.session,project:r.values.project===void 0?void 0:Jd(r.values.project)};if(l.id&&(l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.sinceExplicit||l.limitExplicit))return console.error("--id cannot be combined with --agent, --rule, --session, --project, --suspect, --since, or --limit"),null;if(l.pruneLegacy&&(l.id!==void 0||l.agent!==void 0||l.rule!==void 0||l.session!==void 0||l.project!==void 0||l.suspect||l.all||l.sinceExplicit||l.limitExplicit))return console.error("--prune-legacy cannot be combined with --id, --agent, --rule, --session, --project, --suspect, --all, --since, or --limit"),null;if(l.dryRun&&!l.pruneLegacy)return console.error("--dry-run requires --prune-legacy"),null;return l}async function u1(n,t={}){let r=Zd(n);if(!r)return 1;let e=t.logsDir??s2();if(r.pruneLegacy)return Qd(e,r.json,r.dryRun);if(!e)return console.log(r.json?"[]":r.id?`No retained audit log entry found for id ${F(r.id)}.`:"No audit log entries found."),0;D2(e);let a={count:0},l=v2(e,a).flatMap((i)=>cn(i,a).map((u)=>({entry:u,file:i})));if(a.count>0)console.error(`warning: ${a.count} audit log ${a.count===1?"source":"sources"} could not be read; these results are incomplete`);if(r.id)return Hd(l,r,t.timeZone);let d=Date.now()-r.since*24*60*60*1000,s=l.filter((i)=>Ad(i,r,e,d)),c=r.suspect?Qt(s.map((i)=>i.entry)):null,L=(c?s.filter((i)=>c.has(i.entry)):s).sort((i,u)=>Date.parse(u.entry.ts)-Date.parse(i.entry.ts)).slice(0,r.limit);if(r.json)return console.log(JSON.stringify(L.map((i)=>i.entry),null,2)),0;if(L.length===0)return console.log("No audit log entries found."),0;for(let i of L)console.log(Kd(i.entry,t.timeZone));return 0}function Qd(n,t,r){let e=n?Yd(n).map((s)=>Bd(n,s)):[];if(r)return Xd(e,t);let a=[],l=0,d=0;for(let s of e){let c=i1(s,{throwIfNoEntry:!1})?.size??0,L=Sd(s);if(L){a.push(`${p1(s)}: ${L}`);continue}l++,d+=c}if(t)return console.log(JSON.stringify({removedFiles:l,removedBytes:d,failedFiles:a.length})),a.length===0?0:1;console.log(l===0&&a.length===0?"No legacy audit log files found.":`Removed ${l} legacy audit log ${l===1?"file":"files"} (${v1(d)}).`);for(let s of a)console.error(`Could not remove ${F(s)}`);if(console.log("Nested v2 audit logs were not changed."),l>0)console.log("This deletion cannot be undone.");return a.length===0?0:1}function Xd(n,t){let r=n.reduce((e,a)=>e+(i1(a,{throwIfNoEntry:!1})?.size??0),0);if(t)return console.log(JSON.stringify({dryRun:!0,files:n.length,bytes:r})),0;if(console.log(n.length===0?"No legacy audit log files found.":`Would remove ${n.length} legacy audit log ${n.length===1?"file":"files"} (${v1(r)}).`),console.log("Nested v2 audit logs are not included."),n.length>0)console.log("Run the same command without --dry-run to delete them.");return 0}function Yd(n){try{return jd(n,{withFileTypes:!0}).filter((t)=>t.isFile()&&t.name.endsWith(".jsonl")).map((t)=>t.name)}catch{return[]}}function Sd(n){try{return zd(n),null}catch(t){return t instanceof Error?t.message:String(t)}}function v1(n){let t=["B","KiB","MiB","GiB"],r=Math.min(Math.floor(Math.log2(Math.max(n,1))/10),t.length-1);return`${Math.round(n/1024**r*10)/10} ${t[r]}`}function Hd(n,t,r){let e=n.filter((l)=>l.entry.id===t.id);if(e.length>1)return console.error(`Multiple audit log entries found for id ${F(t.id??"")}.`),1;if(t.json)return console.log(JSON.stringify(e.map((l)=>l.entry),null,2)),0;let a=e[0];if(!a)return console.log(`No retained audit log entry found for id ${F(t.id??"")}.`),0;return console.log(Md(a.entry,r)),0}function Ad(n,t,r,e){if(!t.all&&n.entry.decision==="allow")return!1;if(Date.parse(n.entry.ts)<e)return!1;if(t.agent!==void 0&&n.entry.agent!==t.agent)return!1;if(t.rule!==void 0&&n.entry.ruleId!==t.rule)return!1;if(t.session!==void 0&&!Wd(n,r,t.session))return!1;if(t.project!==void 0&&!Rd(n.entry.cwd,t.project))return!1;return!0}function Wd(n,t,r){if(n.entry.sessionId===r)return!0;return Fd(n.file)===t&&p1(n.file,".jsonl")===r}function Rd(n,t){if(!n)return!1;return n===t||n.startsWith(`${t}/`)}function Kd(n,t){let r=F(n.id??"-"),e=F(n.decision??"deny"),a=n.cwd?`  [${F(n.cwd)}]`:"",l=n.segment||n.command,d=l===n.command?"":"↳ ",s=l.length>50?`${l.slice(0,50)}…`:l;return`${r.padEnd(16)}  ${F(o1(n.ts,t))}  ${e.padEnd(5)}  ${F(n.agent??"-").padEnd(15)}  ${F(n.ruleId??"-").padEnd(20)}  ${d}${F(s)}${a}`}function Md(n,t){let r=(a)=>F(a===void 0||a===null||a===""?"-":a),e=n.shape?`${n.agent??"-"} (shape: ${n.shape})`:n.agent??"-";return[`id:        ${r(n.id)}`,`ts:        ${r(o1(n.ts,t))}`,`decision:  ${r(n.decision)}`,`agent:     ${r(e)}`,`level:     ${r(n.level)}`,`tool:      ${r(n.toolName)}`,`rule:      ${r(n.ruleId)}`,`intent:    ${r(n.intent)}`,`stage:     ${r(n.failureStage)}`,`error:     ${r(n.errorCode)}`,`session:   ${r(n.sessionId)}`,`cwd:       ${r(n.cwd)}`,`version:   ${r(n.v)}`,`truncated: ${r(n.truncated===!0?"yes":void 0)}`,`reason:    ${r(n.reason)}`,`command:   ${r(n.command)}`,`segment:   ${r(n.segment)}`].join(`
`)}function o1(n,t){let r=new Date(n);if(Number.isNaN(r.getTime()))return n;return new Intl.DateTimeFormat("sv-SE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23",timeZone:t}).format(r)}function L1(n){let t=Number(n);return Number.isFinite(t)&&t>0?t:null}var b1={name:"doctor",aliases:["--doctor"],description:"Run diagnostic checks to verify installation and configuration",usage:"doctor [options]",options:[{flags:"--json",description:"Output diagnostics as JSON"},{flags:"--skip-update-check",description:"Skip npm registry version check"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net doctor","cc-safety-net doctor --json","cc-safety-net doctor --skip-update-check"]};var f1={name:"explain",description:"Show step-by-step analysis trace of how a command would be analyzed",usage:"explain [options] <command>",argument:"<command>",options:[{flags:"--json",description:"Output analysis as JSON"},{flags:"--cwd",argument:"<path>",description:"Use custom working directory"},{flags:"-h, --help",description:"Show this help"}],examples:['cc-safety-net explain "git reset --hard"','cc-safety-net explain --json "rm -rf /"','cc-safety-net explain --cwd /tmp "git status"']};var y1={name:"gui",description:"Open the local policy editor GUI",usage:"gui [options]",options:[{flags:"--no-open",description:"Print the URL without opening a browser"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net gui","cc-safety-net gui --no-open"]};import{isAbsolute as q1,relative as Nd}from"node:path";var Vd=8388608;function Gd(n,t){console.log(JSON.stringify(n(w1(t))))}async function Ud(n){let t;try{t=(await cr(process.stdin)).trim()}catch{n({reason:"Failed to parse hook input JSON."});return}if(!t){n({reason:"Missing hook input JSON."});return}return Lr(t,n,"Failed to parse hook input JSON.")}async function cr(n){let t=[],r=0;for await(let e of n){let a=typeof e==="string"?Buffer.from(e,"utf-8"):Buffer.from(e.buffer,e.byteOffset,e.byteLength);if(r+=a.byteLength,r>Vd)throw Cd(n),Error("hook input byte limit exceeded");t.push(a)}return Buffer.concat(t,r).toString("utf-8")}function Cd(n){let t=n.destroy??n.cancel;if(!t)return;try{Promise.resolve(t.call(n)).catch(()=>{})}catch{}}function Lr(n,t,r){try{return JSON.parse(n)}catch{t({reason:r});return}}function Y(n,t){let r=t.get(n);return r?{kind:"command",shell:r}:{kind:$1(n)}}function I(n,t,r,e){let a=n===void 0?process.cwd():n,l=typeof a==="string"&&a.trim()!==""?c2([a]):void 0;if(l)return{configCwd:l,executionCwd:l};return Z(e,t,r,Ed(a)),null}function Z(n,t,r,e){let a;try{a=sr(t)}catch(l){if(!(l instanceof T2))throw l}n(Kn({command:a,segment:e,toolName:r}))}async function Td(n){let t=await Ud(n.outputDeny);if(t===void 0)return;if(!t||typeof t!=="object"||Array.isArray(t)){Z(n.outputDeny);return}if(!n.isSupported(t))return;let r=n.getAgent?.(t)??n.agent,e=n.agent===r?void 0:n.agent,a=Id(t),l=(p,f)=>{h1(p,()=>n.getSessionId(t),{agent:r,shape:e,toolName:f,cwd:a}),n.outputDeny(p)},d=n.getToolName(t);if(typeof d!=="string"||d.trim()===""){Z((p)=>l(p),Pd(t));return}let s=d,c=(p)=>l(p,s),L;try{L=n.getToolInput(t,s,c)}catch(p){if(!(p instanceof T2))throw p;Z(c,void 0,s);return}if(!L.ok)return;let i=n.getContext(t,L.input,s,c);if(!i)return;let u;try{u=sr(L.input)}catch(p){if(!(p instanceof T2))throw p;Z(c,void 0,s);return}let o=G2(s,L.input,L.route,i,u??null);try{let p=Mn(o,{guard:{auditAllowed:g1(),dependencies:n.guardDependencies},audit:{agent:r,shape:e,getSessionId:()=>n.getSessionId(t)}}),f=dr(p,{includeEvidence:!0,toolName:p.stage==="command-analysis"?void 0:s});if(f){n.outputDeny(f);return}n.outputAllow?.()}catch(p){if(!(p instanceof D1))throw p;Od(p);let f=dr(p.evaluation,{includeEvidence:!0,toolName:p.evaluation.stage==="command-analysis"?void 0:s});if(f)n.outputDeny(f);return}}function Od(n){if(!fn(m.debug))return;console.error(`CC Safety Net debug: ${_d(n.stage)}: ${x1(n.cause)}`)}function _d(n){if(n==="policy-protection")return"hook policy protection failed";if(n==="config-load")return"hook config loading failed";if(n==="secret-protection")return"hook secret protection failed";return"hook analysis failed"}function Ed(n){return typeof n==="string"?n:void 0}function Pd(n){if(!n||typeof n!=="object"||Array.isArray(n))return;if(Object.hasOwn(n,"tool_input"))return n.tool_input;let t=n.toolCall;if(t&&typeof t==="object"&&!Array.isArray(t))return t.args;return}function Id(n){if(!n||typeof n!=="object"||Array.isArray(n))return null;let t=n.cwd;if(typeof t==="string")return t;let r=n.toolCall;if(!r||typeof r!=="object"||Array.isArray(r))return null;let e=r.args;if(!e||typeof e!=="object"||Array.isArray(e))return null;let a=e.Cwd;return typeof a==="string"?a:null}async function S(n){let t=(a)=>Gd(n.createDenyOutput,a),r=n.createAllowOutput;await Td({...n,outputDeny:t,outputAllow:r?()=>console.log(JSON.stringify(r())):void 0})}var ns=new Map([["run_command","auto"]]),ts=new Set(["absolutepath","directorypath","file_path","filepath","path","searchdirectory","searchpath","target_file","targetfile"]);function j1(n){return Y(n,ns)}async function z1(){await S({agent:"antigravity-cli",createDenyOutput:(n)=>({decision:"deny",reason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolCall?.name,getToolInput:(n,t)=>({ok:!0,input:ds(n.toolCall?.args,t),route:j1(t)}),getContext:rs,getSessionId:(n)=>n.conversationId})}function rs(n,t,r,e){let l=ls(n).flatMap((L)=>{let i=c2([L]);return i?[i]:[]});if(!l[0])return k2(e,t,r),null;if(r!=="run_command"){let L;try{L=es(t,r,l)}catch(i){if(i instanceof T2)return k2(e,void 0,r),null;if(!(i instanceof Vn))throw i;return k2(e,t,r),null}if(!L)return k2(e,t,r),null;return{configCwd:L,executionCwd:L,policyConfigCwds:l}}let d=n.toolCall?.args;if(!d||!Object.hasOwn(d,"Cwd"))return{configCwd:l[0],executionCwd:l[0],policyConfigCwds:l};let s=d.Cwd;if(typeof s!=="string"||s.trim()==="")return k2(e,t,r),null;let c=q2(s,l);if(c){let L=F1(c,l);if(!L)return k2(e,t,r,s),null;return{configCwd:L,executionCwd:c,policyConfigCwds:l}}return k2(e,t,r,s),null}function es(n,t,r){let e=j1(t),a=[...m1(n,ts),...e.kind==="patch"?k1(n):[]].filter(q1),l=Gn(),d=new Set(a.flatMap((s)=>{let c=F1(wn(s,xn,l),r);return c?[c]:[]}));if(d.size>1)return null;return[...d][0]??r[0]??null}function F1(n,t){return t.filter((r)=>as(n,r)).reduce((r,e)=>e.length>r.length?e:r,"")||null}function as(n,t){let r=Nd(t,n);return r===""||!r.startsWith("..")&&!q1(r)}function k2(n,t,r,e){let a=t&&typeof t==="object"?t.command:void 0;n(Kn({command:typeof a==="string"?a:void 0,segment:e,toolName:r}))}function ls(n){if(n.workspacePaths===void 0)return[process.cwd()];let t=Array.isArray(n.workspacePaths)?n.workspacePaths.filter((r)=>typeof r==="string"&&r.trim()!==""):[];return c2(t)?t:[]}function ds(n,t){if(!n)return;if(t!=="run_command")return n;return{...n,command:typeof n.CommandLine==="string"&&n.CommandLine!==""?n.CommandLine:void 0}}var O2=[{id:"antigravity-cli",displayName:"Antigravity CLI",doctorOrder:3,runtime:{order:1,flags:["-ac","--agy-cli"],description:"Run as Antigravity CLI PreToolUse hook",legacyTopLevelFlags:[]},install:{order:2,flag:"--agy-cli",installLabel:"Antigravity CLI",helpTarget:"Antigravity CLI hook config",probeCommand:["agy","--version"]}},{id:"claude-code",displayName:"Claude Code",doctorOrder:1,runtime:{order:2,displayName:"Coding CLI",flags:["-cc","--coding-cli"],legacyFlags:["--claude-code"],description:"Run as Coding CLI PreToolUse hook",legacyTopLevelFlags:["-cc","--claude-code"]},install:{order:3,flag:"--claude-code",installLabel:"Claude Code",helpTarget:"Claude Code plugin",probeCommand:["claude","--version"]}},{id:"codex",displayName:"Codex",doctorOrder:4,install:{order:4,flag:"--codex",installLabel:"Codex",helpTarget:"Codex plugin",probeCommand:["codex","--version"]}},{id:"copilot-cli",displayName:"GitHub Copilot CLI",doctorOrder:7,runtime:{order:5,flags:["-cp","--copilot-cli"],description:"Run as GitHub Copilot CLI PreToolUse hook",legacyTopLevelFlags:["-cp","--copilot-cli"]},install:{order:7,flag:"--copilot-cli",installLabel:"GitHub Copilot CLI",helpTarget:"GitHub Copilot CLI plugin",probeCommand:["copilot","--binary-version"]}},{id:"gemini-cli",displayName:"Gemini CLI",doctorOrder:6,runtime:{order:4,flags:["-gc","--gemini-cli"],description:"Run as Gemini CLI BeforeTool hook",legacyTopLevelFlags:["-gc","--gemini-cli"]},install:{order:6,flag:"--gemini-cli",installLabel:"Gemini CLI",helpTarget:"Gemini CLI extension",probeCommand:["gemini","--version"]}},{id:"hermes-agent",displayName:"Hermes Agent",doctorOrder:8,runtime:{order:6,flags:["-ha","--hermes-agent"],description:"Run as Hermes Agent pre_tool_call hook",legacyTopLevelFlags:[]},install:{order:8,flag:"--hermes-agent",installLabel:"Hermes Agent",helpTarget:"Hermes Agent plugin",probeCommand:["hermes","--version"]}},{id:"kimi-code",displayName:"Kimi Code",doctorOrder:9,runtime:{order:7,flags:["-kc","--kimi-code"],description:"Run as Kimi Code PreToolUse hook",legacyTopLevelFlags:[]},install:{order:9,flag:"--kimi-code",installLabel:"Kimi Code",helpTarget:"Kimi Code hook config",probeCommand:["kimi","--version"]}},{id:"openclaw",displayName:"OpenClaw",doctorOrder:10,install:{order:10,flag:"--openclaw",installLabel:"OpenClaw",helpTarget:"OpenClaw plugin",probeCommand:["openclaw","--version"]}},{id:"opencode",displayName:"OpenCode",doctorOrder:11,install:{order:11,flag:"--opencode",installLabel:"OpenCode",helpTarget:"OpenCode plugin",probeCommand:["opencode","--version"]}},{id:"pi",displayName:"Pi",doctorOrder:12,install:{order:12,flag:"--pi",installLabel:"Pi",helpTarget:"Pi package",probeCommand:["pi","--version"]}},{id:"cursor",displayName:"Cursor",doctorOrder:5,runtime:{order:3,flags:["-cu","--cursor"],description:"Run as Cursor preToolUse hook",legacyTopLevelFlags:[]},install:{order:5,flag:"--cursor",installLabel:"Cursor",helpTarget:"Cursor hook config",probeCommand:["cursor","--version"]}},{id:"amp",displayName:"Amp Code",doctorOrder:2,install:{order:1,flag:"--amp",installLabel:"Amp Code",helpTarget:"Amp Code plugin",probeCommand:["amp","--version"]}}],B1=O2.slice().sort((n,t)=>n.doctorOrder-t.doctorOrder).map((n)=>n.id),J1=O2.filter((n)=>("runtime"in n)).slice().sort((n,t)=>n.runtime.order-t.runtime.order).map((n)=>({id:n.id,displayName:"displayName"in n.runtime?n.runtime.displayName:n.displayName,flags:n.runtime.flags,legacyFlags:"legacyFlags"in n.runtime?n.runtime.legacyFlags:[],description:n.runtime.description,legacyTopLevelFlags:n.runtime.legacyTopLevelFlags})),L2=O2.slice().sort((n,t)=>n.install.order-t.install.order).map((n)=>({id:n.id,...n.install})).map(({order:n,...t})=>t),Y6=Object.fromEntries(O2.map((n)=>[n.id,n.displayName]));function b2(n){return O2.find((t)=>t.id===n)?.displayName??n}function f2(n){return O2.find((t)=>t.id===n)?.install.installLabel??n}import{homedir as ss}from"node:os";import{isAbsolute as Z1,join as ir}from"node:path";function X1(n){if(n!==void 0&&n!==null&&!Z1(n))return"unknown";try{let t=Gn(),r=n?wn(n,xn,t):void 0,e=process.env.HOME||ss(),a=[["codex",process.env.CODEX_HOME||ir(e,".codex")],["copilot-cli",process.env.COPILOT_HOME||ir(e,".copilot")],["claude-code",process.env.CLAUDE_CONFIG_DIR||ir(e,".claude")]],l=r?a.flatMap(([d,s])=>{if(!Z1(s))return[];return Q1(r,wn(s,xn,t))?[d]:[]}):[];if(l.length===1)return l[0]??"unknown";if(l.length>1)return"unknown"}catch(t){if(t instanceof Vn)return"unknown";return"unknown"}if(process.env.CLAUDECODE==="1"||Boolean(process.env.CLAUDE_CODE_ENTRYPOINT))return"claude-code";return"unknown"}var pr="PreToolUse",Y1="BeforeTool",S1="pre_tool_call",ur="PreToolUse";var cs=new Map([["Bash","posix"],["PowerShell","powershell"]]);function Ls(n){return Y(n,cs)}async function H1(){await S({agent:"claude-code",getAgent:(n)=>X1(n.transcript_path),createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:pr,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===pr,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Ls(t)}),getContext:(n,t,r,e)=>I(n.cwd,t,r,e),getSessionId:(n)=>n.session_id})}var is=new Map([["bash","auto"],["Bash","auto"],["powershell","powershell"],["PowerShell","powershell"]]);function ps(n){return Y(n,is)}async function A1(){await S({agent:"copilot-cli",createDenyOutput:(n)=>({permissionDecision:"deny",permissionDecisionReason:n}),isSupported:()=>!0,getToolName:(n)=>n.toolName,getToolInput:(n,t,r)=>{if(typeof n.toolArgs!=="string")return r({reason:"Failed to parse toolArgs JSON."}),{ok:!1};let e=Lr(n.toolArgs,r,"Failed to parse toolArgs JSON.");if(e===void 0)return{ok:!1};return{ok:!0,input:e,route:ps(t)}},getContext:(n,t,r,e)=>I(n.cwd,t,r,e),getSessionId:(n)=>typeof n.sessionId==="string"&&n.sessionId.trim()?n.sessionId:void 0})}var us=new Map([["Shell","auto"]]);function vs(n){return Y(n,us)}async function W1(){await S({agent:"cursor",createDenyOutput:(n)=>({permission:"deny",user_message:n,agent_message:n}),createAllowOutput:()=>({permission:"allow"}),isSupported:()=>!0,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:vs(t)}),getContext:os,getSessionId:(n)=>n.conversation_id})}function os(n,t,r,e){let a=bs(n);if(!a[0])return Z(e,t,r),null;let l=q2(ys(n.cwd),a);if(!l)return Z(e,t,r,typeof n.cwd==="string"?n.cwd:void 0),null;if(t===null||typeof t!=="object"||Array.isArray(t))return{configCwd:l,executionCwd:l,policyConfigCwds:a};if(!Object.hasOwn(t,"working_directory"))return{configCwd:l,executionCwd:l,policyConfigCwds:a};let d=t.working_directory;if(typeof d!=="string"||d.trim()==="")return Z(e,t,r),null;let s=q2(d,a);if(!s)return Z(e,t,r,d),null;return{configCwd:l,executionCwd:s,policyConfigCwds:a}}function bs(n){return fs(n).flatMap((t)=>{let r=c2([t]);return r?[r]:[]})}function fs(n){if(n.workspace_roots===void 0)return typeof n.cwd==="string"&&n.cwd.trim()!==""?[n.cwd]:[];if(!Array.isArray(n.workspace_roots))return[];return n.workspace_roots.filter((t)=>typeof t==="string"&&t.trim()!=="")}function ys(n){return typeof n==="string"&&n.trim()!==""?n:"."}var hs=new Map([["run_shell_command","auto"]]);function ws(n){return Y(n,hs)}async function R1(){await S({agent:"gemini-cli",createDenyOutput:(n)=>({decision:"deny",reason:n,systemMessage:n}),isSupported:(n)=>n.hook_event_name===Y1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:ws(t)}),getContext:(n,t,r,e)=>I(n.cwd,t,r,e),getSessionId:(n)=>n.session_id})}import{resolve as xs}from"node:path";var $s=new Map([["terminal","posix"]]);async function K1(){await S({agent:"hermes-agent",createDenyOutput:(n)=>({action:"block",message:n}),isSupported:(n)=>n.hook_event_name===S1,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Y(t,$s)}),getContext:gs,getSessionId:(n)=>n.session_id})}function gs(n,t,r,e){let a=I(n.cwd,t,r,e);if(!a)return null;if(!t||typeof t!=="object"||Array.isArray(t))return a;if(!Object.hasOwn(t,"workdir"))return a;let l=t.workdir;if(typeof l!=="string"||l.trim()==="")return Z(e,t,r),null;let d=c2([xs(a.configCwd,l)]);if(!d)return Z(e,t,r,l),null;return{...a,executionCwd:d}}var M1=new Map([["Bash","posix"]]);function Ds(n){return Y(n,M1)}async function V1(){await S({agent:"kimi-code",createDenyOutput:(n)=>({hookSpecificOutput:{hookEventName:ur,permissionDecision:"deny",permissionDecisionReason:n}}),isSupported:(n)=>n.hook_event_name===ur,getToolName:(n)=>n.tool_name,getToolInput:(n,t)=>({ok:!0,input:n.tool_input,route:Ds(t)}),getContext:(n,t,r,e)=>{let a=I(n.cwd,t,r,e);if(!a)return null;let l=n.tool_input;if(!M1.has(r)||!l||!Object.hasOwn(l,"cwd"))return a;let d=l.cwd;if(typeof d!=="string"||d.trim()==="")return Z(e,t,r),null;let s=q2(d,[a.configCwd]);if(!s)return Z(e,t,r,d),null;return{configCwd:a.configCwd,executionCwd:s}},getSessionId:(n)=>n.session_id})}var ms={"antigravity-cli":z1,"claude-code":H1,"copilot-cli":A1,cursor:W1,"gemini-cli":R1,"hermes-agent":K1,"kimi-code":V1},_2=J1.map((n)=>({...n,run:ms[n.id]}));function G1(n){let t=z({label:"hook",booleans:Object.fromEntries(_2.map((e)=>[e.id,[...e.flags,...e.legacyFlags]]))},n);if(t.errors.length>0)return;let r=_2.filter((e)=>t.flags[e.id]);return r.length===1?r[0]:void 0}function U1(n){return _2.find((t)=>t.legacyTopLevelFlags.some((r)=>r===n))}var ks=_2.map((n)=>({flags:n.flags.join(", "),description:n.description})),qs=_2.flatMap((n)=>n.flags.map((t)=>`cc-safety-net hook ${t}`)),C1={name:"hook",description:"Run as an agent CLI hook (reads JSON from stdin)",usage:"hook INTEGRATION_FLAG",options:[...ks,{flags:"-h, --help",description:"Show this help"}],examples:qs};var T1={name:"install",description:"Install CC Safety Net into a coding agent CLI",usage:"install [TARGET_FLAG]",options:[...L2.map((n)=>({flags:n.flag,description:`Install ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net install",...L2.map((n)=>`cc-safety-net install ${n.flag}`)]},O1={name:"uninstall",description:"Uninstall CC Safety Net from a coding agent CLI",usage:"uninstall [TARGET_FLAG]",options:[...L2.map((n)=>({flags:n.flag,description:`Uninstall ${n.helpTarget}`})),{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net uninstall",...L2.map((n)=>`cc-safety-net uninstall ${n.flag}`)]},_1={name:"update",description:"Update every installed CC Safety Net integration to the latest version",usage:"update",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net update"]};var E1={name:"logs",description:"Browse audit log entries recorded by hooks",usage:"logs [options]",options:[{flags:"--id",argument:"<id>",description:"Show one entry from retained history by its 16-character id (not guaranteed once it is older than the configured retention)"},{flags:"--limit",argument:"<n>",description:"Maximum entries to print",default:"20"},{flags:"--since",argument:"<days>",description:"Only include entries newer than this many days (max: the configured audit retention, 1-365)",default:"30"},{flags:"--agent",argument:"<name>",description:"Filter by agent name"},{flags:"--rule",argument:"<ruleId>",description:"Filter by rule id"},{flags:"--session",argument:"<id>",description:"Filter by session id"},{flags:"--project",argument:"<path>",description:"Filter by project path"},{flags:"--suspect",description:"Only denials that look like false positives"},{flags:"--all",description:"Include allow entries"},{flags:"--prune-legacy",description:"Permanently delete all legacy root-level logs; nested logs are untouched"},{flags:"--dry-run",description:"With --prune-legacy, report what would be deleted and delete nothing"},{flags:"--json",description:"Output entries as JSON"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net logs --id 3fa9c2d1a70e8b42","cc-safety-net logs --agent claude-code","cc-safety-net logs --project . --since 7","cc-safety-net logs --suspect --since 7","cc-safety-net logs --json","cc-safety-net logs --prune-legacy --dry-run","cc-safety-net logs --prune-legacy"]};var E2={name:"rule",description:"Manage CC Safety Net rule config and rulebook sources",usage:"rule <subcommand>",subcommands:[{usage:"init [--example]",description:"Create inert rule config"},{usage:"add <source>",description:"Add a rulebook source and sync"},{usage:"remove <source>",description:"Remove a rulebook source and sync"},{usage:"update [source]",description:"Refresh rulebook lock/cache state"},{usage:"sync",description:"Sync configured rulebooks"},{usage:"list",description:"List active rulebooks"},{usage:"wrapper add <command>",description:"Trust a transparent command wrapper"},{usage:"wrapper remove <command>",description:"Remove a transparent command wrapper"},{usage:"wrapper list",description:"List transparent command wrappers"},{usage:"migrate [--cleanup]",description:"Migrate legacy inline rules"},{usage:"doc",description:"Print the rulebook authoring guide"},{usage:"verify",description:"Validate rule config files"}],options:[{flags:"-g, --global",description:"Use user-scope rule config"},{flags:"--check",description:"Check without changing lock/cache state"},{flags:"--cleanup",description:"Delete legacy files after rule migrate verifies them"},{flags:"--delete-source",description:"Delete clean local source directory on remove"},{flags:"--example",description:"Create an inactive example rulebook with rule init"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net rule init","cc-safety-net rule init --example","cc-safety-net rule wrapper add rtk","cc-safety-net rule add project-rules","cc-safety-net rule sync","cc-safety-net rule migrate --cleanup","cc-safety-net rule verify"]};var P1={name:"status",description:"Show what the runtime is enforcing right now",usage:"status",options:[{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net status"]};var I1={name:"statusline",description:"Print status line with mode indicators for shell integration",usage:"statusline --claude-code",options:[{flags:"-cc, --claude-code",description:"Print status line for Claude Code"},{flags:"-h, --help",description:"Show this help"}],examples:["cc-safety-net statusline -cc","cc-safety-net statusline --claude-code"]};var N1=[P1,b1,E1,f1,E2,T1,_1,O1,C1,y1,I1];function js(n){return n.aliases??[]}function zs(n){return!n.hidden}function Un(n){let t=n.toLowerCase();return N1.find((r)=>r.name.toLowerCase()===t||js(r).some((e)=>e.toLowerCase()===t))}function na(){return N1.filter(zs)}import{readFileSync as Fs}from"node:fs";import{basename as Bs}from"node:path";function Cn(n=7,t=s2()){let r=Date.now()-n*24*60*60*1000,e=[],a=new Set,l=0,d,s,c,L;if(t)D2(t);let i={count:0},u=t?v2(t,i):[];for(let p of u)try{let v=Fs(p,"utf-8").trim().split(`
`).filter(Boolean);for(let y of v)try{let x=JSON.parse(y);if(x.decision==="allow")continue;let w=new Date(x.ts).getTime();if(w>=r){if(l++,a.add(x.sessionId??Bs(p,".jsonl")),s===void 0||w<=s)d=x.ts,s=w;if(L===void 0||w>L)c=x.ts,L=w;Js(e,x,w)}}catch{i.count++}}catch{i.count++}let o=e.map((p)=>({timestamp:p.ts,command:p.command,reason:p.reason,relativeTime:Zt(new Date(p.ts))}));return{totalBlocked:l,sessionCount:a.size,recentEntries:o,oldestEntry:d,newestEntry:c,unreadable:i.count}}function Js(n,t,r){let e=n.findIndex((a)=>r>new Date(a.ts).getTime());if(e===-1){if(n.length<3)n.push(t);return}if(n.splice(e,0,t),n.length>3)n.pop()}import{dirname as Zs}from"node:path";function ta(n,t,r,e,a){let l;try{if(g(e)===null)return{path:n,exists:!1,valid:!1,ruleCount:0};l=a2(e),l.errors.push(...l2(n,t,{userConfigDir:r},a))}catch(d){if(!(d instanceof Q))throw d;l={errors:[d.message],ruleNames:new Set}}return{path:n,exists:!0,valid:l.errors.length===0,ruleCount:l.ruleNames.size,...l.errors.length>0?{errors:l.errors}:{}}}function Qs(n,t){return{source:t,name:n.name,command:n.command,subcommand:n.subcommand,blockArgs:[...n.block_args],reason:n.reason}}function ra(n,t){let r=t?.userConfigPath??E(),e=t?.projectConfigPath??_(n),a=Zs(r),l=o2({cwd:n,userConfigPath:r,projectConfigPath:e,userConfigDir:a}),d=P({cwd:n,userConfigPath:r,projectConfigPath:e,userConfigDir:a}),s=new Map(l.rulebooks.flatMap((c)=>c.rules.map((L)=>[L,c.source])));return{userConfig:ta(r,M2({userConfigPath:r}),a,d.userConfigTarget,d.userScope),projectConfig:ta(e,V2(e),a,d.projectConfigTarget,d.projectScope),effectiveRules:l.rules.map((c)=>Qs(c,s.get(c.name)??"project")),shadowedRules:[]}}var Xs=[{flag:m.level,description:"Safety level preset: standard, strict, or paranoid",defaultBehavior:"standard"},{flag:m.strict,description:"Legacy; equivalent to safety.overrides.fail_closed",defaultBehavior:"permissive"},{flag:m.paranoid,description:"Legacy; equivalent to safety.overrides.paranoid_rm and paranoid_interpreters",defaultBehavior:"off"},{flag:m.paranoidRm,description:"Legacy; equivalent to safety.overrides.paranoid_rm",defaultBehavior:"off"},{flag:m.paranoidInterpreters,description:"Legacy; equivalent to safety.overrides.paranoid_interpreters",defaultBehavior:"off"},{flag:m.worktree,description:"Allow local git discards in linked worktrees",defaultBehavior:"off"},{flag:m.debug,description:"Print diagnostic messages to stderr",defaultBehavior:"off"},{flag:m.auditScope,description:"Command decisions recorded: all, or blocked (privacy-minimizing, denials only)",defaultBehavior:"all"}];function ea(){return[...Xs.map((n)=>({name:n.flag.name,value:er(n.flag),isSet:ar(n.flag),legacyName:n.flag.legacyName,legacyValue:n.flag.legacyName?process.env[n.flag.legacyName]:void 0,legacyIsSet:n.flag.legacyName?process.env[n.flag.legacyName]!==void 0:void 0,description:n.description,defaultBehavior:n.defaultBehavior})),{name:"CC_SAFETY_NET_HOME",value:process.env.CC_SAFETY_NET_HOME,isSet:process.env.CC_SAFETY_NET_HOME!==void 0,description:"Override user-scope config/cache directory",defaultBehavior:"~/.cc-safety-net"}]}var aa={error:0,warning:1,info:2},Ys=["policy","config","audit"];function Ss(n){return n.map((t)=>{if(t==="ownership")return"is not owned by the current user";if(t==="permissions")return"has unsafe permissions";if(t==="symlink")return"is a symbolic link";return"is not a directory"}).join(" and ")}var Hs=[{derive:(n)=>n.hooks.length>0&&n.hooks.every((t)=>!t.configured)?[{checkId:"integration.none-configured",severity:"error",title:"No integration configured",detail:"CC Safety Net is not connected to any supported coding-agent integration.",fixHint:"Run `cc-safety-net install` and configure at least one integration."}]:[]},{derive:(n)=>n.hooks.filter((t)=>t.inspectionStatus==="failed").map((t)=>{let r=b2(t.platform);return{checkId:"integration.inspection-failed",severity:"error",title:`${r} inspection failed`,detail:`Doctor could not verify the ${r} integration configuration.`,fixHint:`Correct the reported ${r} configuration error, then run \`cc-safety-net doctor\` again.`,integration:t.platform}})},{derive:(n)=>n.userConfig.exists&&!n.userConfig.valid?[{checkId:"config.user-invalid",severity:"error",title:"User configuration is invalid",detail:"Doctor could not load a valid user rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.userConfig.path}]:[]},{derive:(n)=>n.projectConfig.exists&&!n.projectConfig.valid?[{checkId:"config.project-invalid",severity:"error",title:"Project configuration is invalid",detail:"Doctor could not load a valid project rules configuration.",fixHint:"Run `cc-safety-net rule verify`, correct the reported error, then rerun doctor.",path:n.projectConfig.path}]:[]},{derive:(n)=>n.configState.state==="degraded"?[{checkId:"config.runtime-degraded",severity:"warning",title:"Runtime is enforcing a fallback configuration",detail:`The rejected candidate configuration is not active: ${n.configState.reason}`,fixHint:"Correct the named source, run `cc-safety-net rule sync` for a rule source, then rerun doctor."}]:[]},{derive:(n)=>{let t=n.environment.find((r)=>r.name==="CC_SAFETY_NET_AUDIT_SCOPE");return rr(t?.value)==="invalid"?[{checkId:"environment.audit-scope-invalid",severity:"warning",title:"Audit scope value is invalid",detail:"CC_SAFETY_NET_AUDIT_SCOPE is not `all` or `blocked`, so allowed command decisions are not recorded.",fixHint:"Set CC_SAFETY_NET_AUDIT_SCOPE to `all` or `blocked`, then restart the integration."}]:[]}},...Ys.map((n)=>({derive:(t)=>t.posture.directories.filter((r)=>r.kind===n&&r.status==="unsafe").map((r)=>({checkId:`posture.${n}-directory-unsafe`,severity:"error",title:`${n[0]?.toUpperCase()}${n.slice(1)} directory is unsafe`,detail:`The ${n} directory ${Ss(r.issues)}.`,fixHint:"Ensure this is a real directory owned by the current user with no group or other write access, then rerun doctor.",...r.path?{path:r.path}:{}}))})),{derive:(n)=>{let t=[...n.effectiveSafety.weakenedRuleOverrides].sort();return t.length>0?[{checkId:"posture.rule-overrides-weaken-preset",severity:"warning",title:"Rule overrides weaken the selected preset",detail:`Explicit overrides disable rules the resolved preset would enable: ${t.join(", ")}.`,fixHint:`Remove these \`off\` overrides or set them to \`on\`: ${t.join(", ")}.`}]:[]}}];function la(n){return Hs.flatMap((t,r)=>t.derive(n).map((e,a)=>({finding:e,catalogOrder:r,occurrence:a}))).sort((t,r)=>aa[t.finding.severity]-aa[r.finding.severity]||t.catalogOrder-r.catalogOrder||t.occurrence-r.occurrence).map((t)=>t.finding)}function N(){return Boolean(process.stdout.isTTY&&!process.env.NO_COLOR)}var As=(n)=>N()?`\x1B[32m${n}\x1B[0m`:n,Ws=(n)=>N()?`\x1B[33m${n}\x1B[0m`:n,Rs=(n)=>N()?`\x1B[34m${n}\x1B[0m`:n,Ks=(n)=>N()?`\x1B[35m${n}\x1B[0m`:n,Ms=(n)=>N()?`\x1B[36m${n}\x1B[0m`:n,Vs=(n)=>N()?`\x1B[31m${n}\x1B[0m`:n,Gs=(n)=>N()?`\x1B[2m${n}\x1B[0m`:n,Us=(n)=>N()?`\x1B[1m${n}\x1B[0m`:n,b={green:As,yellow:Ws,blue:Rs,magenta:Ks,cyan:Ms,red:Vs,dim:Gs,bold:Us},Cs="\x1B[0m",Ts=[39,82,198,226,208,51,196,46,201,214,93,154,220,27,49,190,200,33,129,227,45,160,63,118,123,202];function Os(n){let t=n;return()=>{return t=(t*1664525+1013904223)%4294967296,t/4294967296}}function _s(n){let t=[...Ts],r=Os(n);for(let e=t.length-1;e>0;e--){let a=Math.floor(r()*(e+1)),l=t[e];t[e]=t[a],t[a]=l}return t}function Es(n,t=0){if(!N())return"";let r=_s(t);return`\x1B[38;5;${r[n%r.length]}m`}function da(n,t,r=0){if(!N())return`"${n}"`;return`${Es(t,r)}"${n}"${Cs}`}var Ps=new RegExp("\x1B\\[[0-9;]*m","g"),vr=(n)=>n.replace(Ps,"").length;function j2(n){let t=(n.headers??n.rows[0]??[]).map((d,s)=>{let c=Math.max(...n.rows.map((L)=>vr(L[s]??"")));return Math.max(vr(d),c)}),r=(d,s)=>d+" ".repeat(Math.max(0,s-vr(d))),e=(d,s)=>s[0]+t.map((c)=>d.repeat(c+2)).join(s[1])+s[2],a=(d)=>`│ ${d.map((s,c)=>r(s,t[c]??0)).join(" │ ")} │`,l=n.headers?[`   ${a(n.headers)}`,`   ${e("─",["├","┼","┤"])}`]:[];return[`   ${e("─",["┌","┬","┐"])}`,...l,...n.rows.map((d)=>`   ${a(d)}`),`   ${e("─",["└","┴","┘"])}`].join(`
`)}function sa(n){let t=[];t.push("Hook Integration"),t.push(Is(n));let r=[],e=[];for(let a of n){let l=b2(a.platform);if(a.errors&&a.errors.length>0)for(let d of a.errors)if(a.configured)r.push({platform:l,message:d});else e.push({platform:l,message:d})}for(let a of r)t.push(`   Warning (${a.platform}): ${a.message}`);for(let a of e)t.push(b.red(`   Error (${a.platform}): ${a.message}`));return t.join(`
`)}function Is(n){let t=["Platform","Discovery","Configuration","Inspection"],r=n.map((e)=>{let a=b2(e.platform);if(e.inspectionStatus==="not-inspected"){let c=b.dim("Not inspected");return[a,c,c,c]}let l=e.detected?b.green("Detected"):e.inspectionStatus==="failed"?b.red("Unknown"):b.dim("Not detected"),d=e.configured?b.green("Configured"):e.detected?b.yellow("Not configured"):e.inspectionStatus==="failed"?b.red("Unknown"):b.dim("Not applicable"),s=e.inspectionStatus==="verified"?b.green("Verified"):e.inspectionStatus==="failed"?b.red("Failed"):b.dim("Not applicable");return[a,l,d,s]});return j2({headers:t,rows:r})}function ca(n){let r=["Guard Engine Verification",`   Synthetic self-test: ${n.failed>0?b.red(`${n.passed}/${n.total} FAIL`):b.green(`${n.passed}/${n.total} passed`)}`],e=n.results.filter((a)=>!a.passed);if(e.length>0){r.push(""),r.push(b.red("   Failures:"));for(let a of e)r.push(b.red(`   • ${a.description}`)),r.push(b.red(`     expected ${a.expected}, got ${a.actual}`))}return r.join(`
`)}function Ns(n){if(n.length===0)return"   (no custom rules)";let t=["Source","Name","Command","Block Args"],r=n.map((e)=>[e.source,e.name,e.subcommand?`${e.command} ${e.subcommand}`:e.command,e.blockArgs.join(", ")]);return j2({headers:t,rows:r})}function La(n){let t=[];if(t.push("Configuration"),t.push(nc(n.userConfig,n.projectConfig)),t.push(""),n.effectiveRules.length>0)t.push(`   Effective rules (${n.effectiveRules.length} total):`),t.push(Ns(n.effectiveRules));else t.push("   Effective rules: (none - using built-in rules only)");for(let r of n.shadowedRules)t.push(""),t.push(`   Note: Project rule "${r.name}" shadows user rule with same name`);return t.join(`
`)}function nc(n,t){let r=["Scope","Status"],e=(l)=>{if(!l.exists)return b.dim("N/A");if(!l.valid)return b.red(`Invalid (${l.errors?.[0]??"unknown error"})`);return b.green("Configured")},a=[["User",e(n)],["Project",e(t)]];return j2({headers:r,rows:a})}function ia(n){let t=[];return t.push("Environment"),t.push(tc(n)),t.join(`
...
`);for(let r of n){let e=`[${r.severity.toUpperCase()}] ${r.checkId}: ${F(r.title)}`,a=r.severity==="error"?b.red:r.severity==="warning"?b.yellow:b.blue;if(t.push(`   ${a(e)}`),t.push(`      ${F(r.detail)}`),r.path)t.push(`      Path: ${F(r.path)}`);if(r.fixHint)t.push(`      Fix: ${F(r.fixHint)}`)}return t.join(`
`)}function tc(n){let t=["Variable","Status","Legacy"],r=n.map((e)=>{let a=e.isSet?b.green("✓"):b.dim("✗"),l=e.legacyName&&e.legacyIsSet?`${e.legacyName} ${b.green("✓")}`:e.legacyName??"";return[e.name,a,l]});return j2({headers:t,rows:r})}function va(n){let t=[];if(n.totalBlocked===0)t.push("Recent Activity"),t.push("   No blocked commands in the last 7 days"),t.push("   Tip: This is normal for new installations");else t.push(`Recent Activity · last 7 days (${n.totalBlocked} blocked / ${n.sessionCount} sessions)`),t.push(rc(n.recentEntries));if(n.unreadable>0)t.push(`   Warning: ${n.unreadable} audit log ${n.unreadable===1?"source":"sources"} could not be read; this summary is incomplete`);return t.join(`
`)}function rc(n){let t=["Time","Command"],r=n.map((e)=>{let a=F(e.command.replace(/\r\n|\r|\n/g," ↵ ").replace(/\t/g," ")),l=a.length>40?`${a.slice(0,37)}...`:a;return[e.relativeTime,l]});return j2({headers:t,rows:r})}function oa(n){let t=[];if(t.push("Update Check"),n.latestVersion===null&&!n.error)return t.push(Tn([["Status",b.dim("Skipped")],["Installed",n.currentVersion]])),t.join(`
`);if(n.error)return t.push(Tn([["Status",`${b.yellow("⚠")} Error`],["Installed",n.currentVersion],["Error",b.dim(n.error)]])),t.join(`
`);if(n.updateAvailable)return t.push(Tn([["Status",`${b.yellow("⚠")} Update Available`],["Current",n.currentVersion],["Latest",b.green(n.latestVersion??"")]])),t.push(""),t.push("   Run: bunx cc-safety-net@latest doctor"),t.push("   Or:  npx cc-safety-net@latest doctor"),t.join(`
`);return t.push(Tn([["Status",`${b.green("✓")} Up to date`],["Version",n.currentVersion]])),t.join(`
`)}function Tn(n){return j2({rows:n})}function ba(n){let t=[];return t.push("System Info"),t.push(ec(n)),t.join(`
`)}function ec(n){let t=["Component","Version"],r=(l)=>{if(l===null)return b.dim("not found");return l},a=[{label:"cc-safety-net",value:n.version},{label:"Claude Code",value:n.claudeCodeVersion},{label:"Amp Code",value:n.ampVersion},{label:"Antigravity CLI",value:n.antigravityCliVersion},{label:"Codex",value:n.codexCliVersion},{label:"Cursor",value:n.cursorVersion},{label:"Gemini CLI",value:n.geminiCliVersion},{label:"GitHub Copilot CLI",value:n.copilotCliVersion},{label:"Hermes Agent",value:n.hermesAgentVersion},{label:"Kimi Code",value:n.kimiCodeVersion},{label:"OpenClaw",value:n.openClawVersion},{label:"OpenCode",value:n.openCodeVersion},{label:"Pi",value:n.piCliVersion},{label:"Node.js",value:n.nodeVersion},{label:"npm",value:n.npmVersion},{label:"Bun",value:n.bunVersion},{label:"Platform",value:n.platform}].map((l)=>[l.label,r(l.value)]);return j2({headers:t,rows:a})}function fa(n){if(n.findings.length===0)return b.green(`
...
${n.findings.length} ${e}: ${r.join(", ")}.`;if(t.error>0)return b.red(a);if(t.warning>0)return b.yellow(a);return b.blue(a)}import{lstatSync as ac}from"node:fs";import{dirname as or}from"node:path";function br(n,t){try{let r=ac(t);if(r.isSymbolicLink())return{kind:n,path:t,status:"unsafe",issues:["symlink"]};if(!r.isDirectory())return{kind:n,path:t,status:"unsafe",issues:["not-directory"]};if(process.platform==="win32"||typeof process.getuid!=="function")return{kind:n,path:t,status:"unknown",issues:[]};let e=[...r.uid!==process.getuid()?["ownership"]:[],...(r.mode&18)!==0?["permissions"]:[]];return{kind:n,path:t,status:e.length>0?"unsafe":"safe",issues:e}}catch(r){if(typeof r==="object"&&r!==null&&"code"in r&&r.code==="ENOENT")return{kind:n,path:t,status:"not-applicable",issues:[]};return{kind:n,path:t,status:"unknown",issues:[]}}}function ya(n){let t=s2();return{directories:[br("policy",or(or(n))),br("config",or(n)),...t?[br("audit",t)]:[{kind:"audit",status:"unknown",issues:[]}]]}}import{spawn as lc}from"node:child_process";import{existsSync as ha}from"node:fs";import{delimiter as dc,extname as sc,join as cc}from"node:path";import{stripVTControlCharacters as wa}from"node:util";var $a="2.0.6",Lc=5000,ic="_CC_SAFETY_NET_TEST_SPAWN_PLATFORM";function j(){return $a}function fr(n,t){let r=n[t];if(r)return r;let e=Object.keys(n).find((a)=>a.toLowerCase()===t.toLowerCase()&&!!n[a]);return e?n[e]:r}function pc(n){return(fr(n,"PATHEXT")||".COM;.EXE;.BAT;.CMD").split(";").filter((t)=>t.length>0)}function uc(n,t){let r=sc(n)?[n]:[...pc(t).map((e)=>`${n}${e}`),n];if(n.includes("/")||n.includes("\\"))return r.find((e)=>ha(e))??n;return(fr(t,"PATH")??"").split(dc).flatMap((e)=>r.map((a)=>cc(e,a))).find((e)=>ha(e))??n}function xa(n){if(!/[\s"&|<>^]/.test(n))return n;return`"${n.replace(/"/g,'""')}"`}function y2(n,t){let[r,...e]=n,a=t[ic]==="win32"?"win32":process.platform;if(!r||a!=="win32")return{cmd:r??"",args:e};let l=uc(r,t);if(!/\.(?:bat|cmd)$/i.test(l))return{cmd:l,args:e};return{cmd:fr(t,"COMSPEC")??"cmd.exe",args:["/d","/c",["call",xa(l),...e.map(xa)].join(" ")]}}var P2=async(n,t=Lc)=>{let r=await vc(n,{timeoutMs:t});if(r.code!==0)return null;return wa(r.stdout).trim()||wa(r.stderr).trim()||null};function vc(n,t){let[r,...e]=n;if(!r)return Promise.resolve({code:null,stdout:"",stderr:""});return new Promise((a)=>{try{let l=y2([r,...e],process.env),d=lc(l.cmd,l.args,{stdio:["ignore","pipe","pipe"]}),s=!1,c="",L="";d.stdout.on("data",(o)=>{c+=o.toString()}),d.stderr.on("data",(o)=>{L+=o.toString()});let i=(o)=>{if(s)return;s=!0,clearTimeout(u),a(o)},u=setTimeout(()=>{d.kill(),i({code:null,stdout:c,stderr:L})},t.timeoutMs);d.on("close",(o)=>{i({code:o,stdout:c,stderr:L})}),d.on("error",()=>{i({code:null,stdout:c,stderr:L})})}catch{a({code:null,stdout:"",stderr:""})}})}function X(n){if(!n)return null;let t=/Claude Code\s+(\d+\.\d+\.\d+)/i.exec(n);if(t)return t[1]??null;let r=/v?(\d+\.\d+\.\d+(?:-[a-zA-Z0-9.]+)?)/i.exec(n);if(r)return r[1]??null;return n.split(`
`)[0]?.trim()||null}async function $n(n=P2){let[t,r,e,a,l,d,s,c,L,i,u,o,p,f,v,y,x]=await Promise.all([n(["claude","--version"]),n(["agy","--version"]),n(["opencode","--version"]),n(["codex","--version"]),n(["codex","plugin","list"]),n(["gemini","--version"]),n(["copilot","--binary-version"]),n(["hermes","--version"]),n(["kimi","--version"]),n(["openclaw","--version"]),n(["pi","--version"]),n(["cursor","--version"]),n(["amp","--version"]),n(["amp","plugins","list"],30000),n(["node","--version"]),n(["npm","--version"]),n(["bun","--version"])]);return{version:$a,claudeCodeVersion:X(t),antigravityCliVersion:X(r),openCodeVersion:X(e),codexCliVersion:X(a),codexPluginListOutput:l,geminiCliVersion:X(d),copilotCliVersion:X(s),hermesAgentVersion:X(c),kimiCodeVersion:X(L),openClawVersion:X(i),piCliVersion:X(u),cursorVersion:X(o),ampVersion:X(p),ampPluginListOutput:f,nodeVersion:X(v),npmVersion:X(y),bunVersion:X(x),platform:`${process.platform} ${process.arch}`}}function yr(n,t){if(t==="dev")return!1;let r=n.split(".").map(Number),e=t.split(".").map(Number),[a=0,l=0,d=0]=r,[s=0,c=0,L=0]=e;if(a!==s)return a>s;if(l!==c)return l>c;return d>L}async function I2(){let n=j(),t=new AbortController,r=setTimeout(()=>t.abort(),3000);try{let e=await fetch("https://registry.npmjs.org/cc-safety-net/latest",{signal:t.signal});if(!e.ok)return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:`npm registry returned ${e.status}`};let a=await e.json(),l=yr(a.version,n);return{currentVersion:n,latestVersion:a.version,updateAvailable:l}}catch(e){return{currentVersion:n,latestVersion:null,updateAvailable:!1,error:e instanceof Error?e.message:"Network error"}}finally{clearTimeout(r)}}import*as Fa from"node:readline";var ka=(n)=>`\x1B[${n}B`,oc=(n)=>`\x1B[${n}A`;var ga=["░","▒","▓","╱","╲","┃","━","┏","┓","┗","┛","╋"];function bc(n){return new Promise((t)=>setTimeout(t,n))}function fc(n,t,r){if(!r)return t(n);if(r.aborted)return Promise.resolve();return new Promise((e,a)=>{let l=()=>r.removeEventListener("abort",d),d=()=>{l(),e()};r.addEventListener("abort",d,{once:!0}),t(n).then(()=>{l(),e()},(s)=>{l(),a(s)})})}function gn(n,t){return n&&n>0?n:t}function On(n){return Math.max(0,Math.min(1,n))}function N2(n){return Math.max(0,Math.min(255,Math.round(n)))}function hr(n){return n<=0.0031308?12.92*n:1.055*n**0.4166666666666667-0.055}function yc(n,t,r){let e=r*Math.PI/180,a=t*Math.cos(e),l=t*Math.sin(e),d=(n+0.3963377774*a+0.2158037573*l)**3,s=(n-0.1055613458*a-0.0638541728*l)**3,c=(n-0.0894841775*a-1.291485548*l)**3;return{blue:N2(hr(On(-0.0041960863*d-0.7034186147*s+1.707614701*c))*255),green:N2(hr(On(-1.2684380046*d+2.6097574011*s-0.3413193965*c))*255),red:N2(hr(On(4.0767416621*d-3.3077115913*s+0.2309699292*c))*255)}}function wr(n,t){let r=(t*n*180/Math.PI%360+360)%360;return yc(0.72,0.15,r)}function qa(n,t=0.1){let r=wr(t,n);return`\x1B[38;2;${r.red};${r.green};${r.blue}m`}function hc(n,t){return{blue:N2(n.blue+(255-n.blue)*t),green:N2(n.green+(255-n.green)*t),red:N2(n.red+(255-n.red)*t)}}function ja(n,t,r){let e=Math.imul(n+2654435769,2246822507)^Math.imul(t+3266489909,668265263)^Math.imul(r+374761393,2654435761),a=e^e>>>15,l=Math.imul(a,739982445),d=l^l>>>12,s=Math.imul(d,695872825);return((s^s>>>15)>>>0)/4294967296}function wc(n,t,r){let e=Math.floor(ja(n,t,r)*ga.length);return ga[e]??"░"}function Da(n){let t=On(n);return t*t*t*(t*(t*6-15)+10)}function xc(n){if(n.length===0)return"";let t=[],r=!1,e="";for(let a of n){let l=`${a.red};${a.green};${a.blue}`;if(a.bold!==r)t.push(a.bold?"\x1B[1m":"\x1B[22m"),r=a.bold;if(l!==e)t.push(`\x1B[38;2;${l}m`),e=l;t.push(a.character)}return`${t.join("")}\x1B[22m\x1B[39m`}function $c(n,t,r,e,a){return n.map((l,d)=>({...wr(r,e+t+d/a),bold:!1,character:l}))}function gc(n,t,r,e,a,l,d,s){let c=Math.max(1,e*0.75),L=Math.min(1,r/c),i=a*Da(L),u=Math.max(0,(r-c)/Math.max(1,e-c)),o=(1-Da(r/e))*s*2,p=0.35*Math.max(0,1-u*2),f=L>=1,v=Math.min(n.length,Math.ceil(i+2+1));return n.slice(0,v).map((y,x)=>{let w=wr(l,d+t+x/s+o),h=x+ja(t,x,7919)*2-1;if(h>i+2)return{...w,bold:!1,character:" "};let J=i-h,X2=0.8*Math.exp(-(J*J)/12.5),sn=Math.min(0.9,X2+p),Bt=!f&&h>i-4;return{...hc(w,sn),bold:sn>0.3,character:Bt?wc(t,x,r):y}})}function ma(n){return`\x1B[?2026h${n.map((t,r)=>`\x1B8${r>0?ka(r):""}${xc(t)}`).join("")}\x1B[?2026l`}async function xr(n,t={}){if(!n)return;let r=t.output??process.stdout,e=t.sleep??bc,a=gn(t.frequency,0.1),l=t.seed??0,d=gn(t.speed,40),s=gn(t.spread,3),c=gn(t.frameRate,60),L=Math.max(1,Math.floor(gn(t.duration,12))),i=n.split(`
`).map((v)=>Array.from(v)),u=Math.max(...i.map((v)=>v.length)),o=1000*L*i.filter((v)=>v.length>0).length/d,p=u>0?Math.max(1,Math.ceil(o/(1000/c))):0,f=p>0?o/p:0;r.write(`\x1B[?25l${i.length>1?`${`
`.repeat(i.length-1)}${oc(i.length-1)}`:""}\x1B7`);try{for(let v=1;v<=p;v+=1){if(t.signal?.aborted)break;r.write(ma(i.map((y,x)=>gc(y,x,v,p,u,a,l,s)))),await fc(f,e,t.signal)}}finally{if(r.write(ma(i.map((v,y)=>$c(v,y,a,l,s)))),r.write("\x1B8"),i.length>1)r.write(ka(i.length-1));r.write(`
\x1B[0m\x1B[?25h`)}}var za=["┏━┛┏━┛  ┏━┛┏━┃┏━┛┏━┛━┏┛┃ ┃  ┏━ ┏━┛━┏┛","┃  ┃    ━━┃┏━┃┏━┛┏━┛ ┃ ━┏┛  ┃ ┃┏━┛ ┃ ","━━┛━━┛  ━━┛┛ ┛┛  ━━┛ ┛  ┛   ┛ ┛━━┛ ┛ "].join(`
`);function Dc(n){return Boolean(n.isTTY)}async function Dn(n={}){let t=n.output??process.stdout;if(!Dc(t))return;let r=n.input??process.stdin,e={duration:n.duration,frequency:n.frequency,output:t,seed:n.seed??Math.random()*8192,sleep:n.sleep,speed:n.speed,spread:n.spread};if(!r.isTTY||typeof r.setRawMode!=="function"){await xr(za,e);return}let a=new AbortController,l=r.readableFlowing===!0,d=r.isRaw===!0,s=!1,c=(L,i)=>{if(i.ctrl&&i.name==="c")s=!0;if(s||i.name==="return"||i.name==="enter")a.abort()};Fa.emitKeypressEvents(r),r.on("keypress",c),r.setRawMode(!0),r.resume();try{await xr(za,{...e,signal:a.signal})}finally{if(r.off("keypress",c),r.setRawMode(d),!l)r.pause()}if(!s)return;if(n.onInterrupt){n.onInterrupt();return}process.kill(process.pid,"SIGINT")}var Ba="\r\x1B[2K",mc="\x1B[?25l",kc="\x1B[39m",qc="\x1B[?25h",jc=100,zc=0.55,Fc=80,Ja=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function Bc(n){return new Promise((t)=>setTimeout(t,n))}async function _n(n,t={}){let r=t.output??process.stdout;if(!r.isTTY)return n;let e=t.sleep??Bc,a=!1,l=n.then((s)=>{return a=!0,s},(s)=>{throw a=!0,s});if(await Promise.race([l.then(()=>!0),e(jc).then(()=>!1)]))return l;r.write(mc);try{for(let s=0;!a;s+=1)r.write(`${Ba}${qa(s*zc)}${Ja[s%Ja.length]}${kc} ${t.loadingMessage??"Loading…"}`),await Promise.race([l,e(Fc)]);return await l}finally{r.write(`${Ba}${qc}`)}}async function mn(n,t,r,e={}){let a=t();if(n)await r();if(n&&a.ready)await _n(a.ready,e);return a.finish()}import{homedir as IL}from"node:os";import{stripVTControlCharacters as Jc}from"node:util";var En="amp plugins list",Zc=/^\s*[✓✗]\s+cc-safety-net(?:\.ts)?\s+\(User Plugins\)\s+(\S+)\s*$/;function Za(n){if(!n.ampPluginListOutput)return{platform:"amp",status:"n/a"};let t=Jc(n.ampPluginListOutput).split(`
`).map((r)=>Zc.exec(r)?.[1]).find((r)=>r!==void 0);if(!t)return{platform:"amp",status:"n/a"};if(t!=="active")return{platform:"amp",status:"disabled",method:En,configPath:En,errors:[`Amp personal plugin cc-safety-net is ${t}; run "plugins: reload" in Amp or reinstall with install --amp`]};return{platform:"amp",status:"configured",method:En,configPath:En}}import{existsSync as Xc,readFileSync as Yc}from"node:fs";import{join as Qc}from"node:path";function kn(n){return Qc(n,".gemini","config","hooks.json")}var Sc=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*(?:--agy-cli|-ac)(\s|["']|$)/;function Hc(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];return Object.values(n).flatMap((t)=>{if(!t||typeof t!=="object"||Array.isArray(t))return[];let r=t,e=r.PreToolUse;if(!Array.isArray(e))return[];return e.flatMap((a)=>{if(!a||typeof a!=="object"||Array.isArray(a))return[];let l=a.hooks;if(!Array.isArray(l))return[];return l.flatMap((d)=>{if(!d||typeof d!=="object"||Array.isArray(d))return[];let s=d.command;if(typeof s!=="string"||!Sc.test(s))return[];return[{command:s,enabled:r.enabled!==!1}]})})})}function Qa(n){let t=kn(n.homeDir);if(!Xc(t))return{platform:"antigravity-cli",status:"n/a",configPath:t};let r;try{r=Hc(JSON.parse(Yc(t,"utf-8")))}catch(e){return{platform:"antigravity-cli",status:"n/a",configPath:t,errors:[`Failed to parse Antigravity hooks config ${t}: ${e instanceof Error?e.message:String(e)}`]}}if(r.some((e)=>e.enabled))return{platform:"antigravity-cli",status:"configured",method:"hook config",configPath:t};if(r.length>0)return{platform:"antigravity-cli",status:"disabled",method:"hook config",configPath:t};return{platform:"antigravity-cli",status:"n/a",configPath:t}}import{join as Xa}from"node:path";import{existsSync as Ac,lstatSync as Wc,readFileSync as Rc}from"node:fs";function n2(n,t=(r)=>r){if(!Ac(n))return{kind:"missing"};try{return{kind:"ok",value:JSON.parse(t(Rc(n,"utf-8")))}}catch{return{kind:"unreadable"}}}function H(n){try{return Wc(n)}catch{return}}function Pn(n,t){let r=H(t);if(!r)return{platform:n,status:"n/a",configPath:t};if(!r.isSymbolicLink()&&r.isDirectory())return;return{platform:n,status:"n/a",configPath:t,errors:[`${t} is a symlink or not a directory; move or remove it before installing`]}}function $(n,t){return typeof n==="object"&&n!==null?n[t]:void 0}var $r="cc-safety-net@cc-marketplace";function Ya(n){return Xa(n,".claude","plugins","installed_plugins.json")}function Sa(n,t){let r=$($(n,"plugins"),t);return Array.isArray(r)&&r.length>0}function In(n,t){let r=n2(Ya(n));return r.kind==="ok"&&Sa(r.value,t)}function gr(n){let t=Ya(n),r=n2(t);if(r.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(r.kind==="missing")return{platform:"claude-code",status:"n/a"};if(!Sa(r.value,$r))return{platform:"claude-code",status:"n/a"};let e=Xa(n,".claude","settings.json"),a=n2(e);if(a.kind==="unreadable")return{platform:"claude-code",status:"not-inspected"};if(!(a.kind==="ok"&&$($(a.value,"enabledPlugins"),$r)===!0))return{platform:"claude-code",status:"disabled",method:"plugin config",configPath:e,errors:[`${$r} is installed but not enabled in Claude Code`]};return{platform:"claude-code",status:"configured",method:"plugin config",configPath:t}}function Ha(n){return gr(n.homeDir)}function Aa(n){if(!n.codexPluginListOutput)return{platform:"codex",status:"n/a"};let t=n.codexPluginListOutput.split(`
`).find((r)=>r.includes("https://github.com/kenryu42/cc-safety-net.git"));if(!t)return{platform:"codex",status:"n/a"};if(!t.includes("installed, enabled"))return{platform:"codex",status:"disabled",method:"codex plugin list",configPath:"codex plugin list",errors:["Codex plugin line for https://github.com/kenryu42/cc-safety-net.git must contain installed, enabled."]};return{platform:"codex",status:"configured",method:"codex plugin list",configPath:"codex plugin list"}}import{existsSync as tt,readdirSync as Kc,readFileSync as Mc}from"node:fs";import{join as K}from"node:path";var t2="cc-safety-net@cc-marketplace",Nn=["cc-marketplace","cc-safety-net"],Wa=["_direct","copilot-safety-net"],Ra=["cc-marketplace","safety-net"],Ka="safety-net@cc-marketplace";function nt(n,t){let r=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(`(^|[^a-z0-9-])${r}([^a-z0-9-]|$)`,"m").test(n??"")}function Ma(n){return nt(n,"cc-safety-net@cc-marketplace")}function Va(n){return nt(n,"cc-marketplace")}function Ga(n){return nt(n,"copilot-safety-net")}function Ua(n){return nt(n,"safety-net@cc-marketplace")}function R(n){let t="",r=0,e=!1,a=!1,l=-1;while(r<n.length){let d=n[r],s=n[r+1];if(a){t+=d,a=!1,r++;continue}if(d==='"'&&!e){e=!0,l=-1,t+=d,r++;continue}if(d==='"'&&e){e=!1,t+=d,r++;continue}if(d==="\\"&&e){a=!0,t+=d,r++;continue}if(e){t+=d,r++;continue}if(d==="/"&&s==="/"){while(r<n.length&&n[r]!==`
`)r++;continue}if(d==="/"&&s==="*"){r+=2;while(r<n.length-1){if(n[r]==="*"&&n[r+1]==="/"){r+=2;break}r++}continue}if(d===","){l=t.length,t+=d,r++;continue}if(d==="}"||d==="]"){if(l!==-1){let c=t.slice(l+1);if(/^\s*$/.test(c))t=t.slice(0,l)+c}l=-1,t+=d,r++;continue}if(!/\s/.test(d))l=-1;t+=d,r++}return t}function Dr(n){if(!n?.includes("cc-safety-net"))return!1;return/(^|\s)hook\s+(?:[^\s]+\s+)*(--copilot-cli|-cp)(\s|$)/.test(n)}function Ta(n,t){if(!n)return null;let r=n.match(/(\d+)\.(\d+)\.(\d+)/);if(!r)return null;let e=[Number(r[1]),Number(r[2]),Number(r[3])];for(let a=0;a<t.length;a++){let l=e[a]??0,d=t[a]??0;if(l!==d)return l>d}return!0}function Vc(n){return Ta(n,[0,0,422])}function Gc(n){return Ta(n,[1,0,8])}function qn(n){return process.env.COPILOT_HOME||K(n,".copilot")}function kr(n){return(n.hooks?.preToolUse??[]).some((r)=>{if(r.type!=="command")return!1;return Dr(r.command)||Dr(r.bash)||Dr(r.powershell)})}function qr(n,t){try{return JSON.parse(R(Mc(n,"utf-8")))}catch(r){t?.push(`Failed to parse ${n}: ${r instanceof Error?r.message:String(r)}`);return}}function Oa(n,t){try{return Kc(n).filter((r)=>r.endsWith(".json")).sort((r,e)=>r.localeCompare(e))}catch(r){return t?.push(`Failed to read ${n}: ${r instanceof Error?r.message:String(r)}`),[]}}function Uc(n,t){if(!tt(n))return[];let r=[];for(let e of Oa(n,t)){let a=K(n,e),l=qr(a,t);if(l&&kr(l))r.push(a)}return r}function mr(n,t){if(!tt(n))return;let r=qr(n,t);if(!r)return;return{path:n,config:r}}function Ca(n,t,r,e){if(t){n.push(`GitHub Copilot CLI ${t} does not support ${r}; requires ${e}+`);return}n.push(`GitHub Copilot CLI version unavailable; skipping ${r} because it requires ${e}+`)}function Cc(n){let t=[n.localSettings,n.repoSettings,n.userConfig];for(let r of t){if(r?.config.disableAllHooks===!0)return r.path;if(r?.config.disableAllHooks===!1)return}return}function Tc(n,t,r,e){let a=qn(n),l=K(t,".github","hooks"),d=K(a,"hooks"),s=K(t,".github","copilot"),c=Gc(r),L=c===!0?e:void 0,i={userConfig:mr(K(a,"config.json"),L),repoSettings:mr(K(s,"settings.json"),L),localSettings:mr(K(s,"settings.local.json"),L)};if(c!==!1){let w=Cc(i);if(w){if(c===null)e.push(`GitHub Copilot CLI version unavailable; treating disableAllHooks in ${w} as active`);return{activeConfigPaths:[],disabledBy:w}}}let u=Uc(l,e),o=Vc(r),p=o===!0?e:void 0,f=tt(d)?Oa(d,p):[],v=[];for(let w of f){let h=K(d,w),J=qr(h,p);if(J&&kr(J))v.push(h)}if(o!==!0&&v.length>0)Ca(e,r,`user hook files in ${d}`,"0.0.422"),v.length=0;let y=[],x=[i.localSettings,i.repoSettings,i.userConfig];for(let w of x){if(!w)continue;if(!kr(w.config))continue;if(c===!0){y.push(w.path);continue}Ca(e,r,"inline hook definitions in Copilot config files","1.0.8");break}return{activeConfigPaths:[...y.filter((w)=>w.endsWith("settings.local.json")),...y.filter((w)=>w.endsWith("settings.json")),...u,...y.filter((w)=>w.endsWith("config.json")),...v]}}function _a(n){let t=[],r=Tc(n.homeDir,n.cwd,n.copilotCliVersion,t);if(r.disabledBy)return{platform:"copilot-cli",status:"disabled",method:"hook config",configPath:r.disabledBy,configPaths:[r.disabledBy],errors:t.length>0?t:void 0};let e=qn(n.homeDir),a=K(e,"installed-plugins",...Nn),l=tt(a),d=K(e,"settings.json"),s=n2(d,R);if(l&&s.kind==="unreadable")return{platform:"copilot-cli",status:"not-inspected"};if(l&&s.kind==="ok"&&$($(s.value,"enabledPlugins"),t2)===!1)return{platform:"copilot-cli",status:"disabled",method:"plugin config",configPath:d,errors:[`${t2} is installed but not enabled in Copilot CLI`]};if(l||r.activeConfigPaths.length>0){let c=l,L=r.activeConfigPaths[0];return{platform:"copilot-cli",status:"configured",method:c?"plugin config":"hook config",configPath:L??(c?a:void 0),configPaths:r.activeConfigPaths.length>0?r.activeConfigPaths:void 0,errors:t.length>0?t:void 0}}return{platform:"copilot-cli",status:"n/a",errors:t.length>0?t:void 0}}import{existsSync as eL,readFileSync as aL}from"node:fs";import{existsSync as Ea,mkdirSync as Ec,readFileSync as Pc}from"node:fs";import{dirname as Ic,join as Nc}from"node:path";import{renameSync as Oc,writeFileSync as _c}from"node:fs";function B(n,t){let r=`${n}.${process.pid}.tmp`;_c(r,t),Oc(r,n)}var jn="npx -y cc-safety-net hook --cursor",Pa=30;function et(n){return Nc(n,".cursor","hooks.json")}function z2(n){return typeof n==="object"&&n!==null&&!Array.isArray(n)}function jr(){return{command:jn,timeout:Pa,failClosed:!0}}function rt(n){return z2(n)&&n.command===jn}function nL(n){return Object.keys(n).length===3&&n.command===jn&&n.timeout===Pa&&n.failClosed===!0}function tL(n){try{return JSON.parse(Pc(n,"utf-8"))}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Cursor hooks config ${n}: ${t.message}`);throw t}}function Ia(n){let t=tL(n);if(!z2(t))throw Error(`Cursor hooks config ${n} must be a JSON object`);if(t.version!==1)throw Error(`Cursor hooks config ${n} must set "version": 1`);if(t.hooks!==void 0&&!z2(t.hooks))throw Error(`Cursor hooks config ${n} "hooks" must be an object`);let r=z2(t.hooks)?t.hooks.preToolUse:void 0;if(r!==void 0&&!Array.isArray(r))throw Error(`Cursor hooks config ${n} "hooks.preToolUse" must be an array`);return t}function Na(n){let t=z2(n.hooks)?n.hooks.preToolUse:void 0;return Array.isArray(t)?t:[]}function rL(n){if(!n.some(rt))return[...n,jr()];return n.reduce((t,r)=>{if(!rt(r))return t.result.push(r),t;if(!t.inserted)t.result.push(jr()),t.inserted=!0;return t},{result:[],inserted:!1}).result}function n0(n,t,r){let e=z2(t.hooks)?t.hooks:{},a={...t,hooks:{...e,preToolUse:r}};B(n,`${JSON.stringify(a,null,2)}
`)}function t0(n){let t=et(n);if(!Ea(t))return Ec(Ic(t),{recursive:!0}),B(t,`${JSON.stringify({version:1,hooks:{preToolUse:[jr()]}},null,2)}
`),{path:t,alreadyInstalled:!1};let r=Ia(t),e=Na(r),a=e.filter(rt);if(z2(r.hooks)&&Array.isArray(r.hooks.preToolUse)&&a.length===1&&a[0]!==void 0&&nL(a[0]))return{path:t,alreadyInstalled:!0};return n0(t,r,rL(e)),{path:t,alreadyInstalled:!1}}function r0(n){let t=et(n);if(!Ea(t))return{path:t,alreadyInstalled:!1};let r=Ia(t),e=Na(r),a=e.filter((l)=>!rt(l));if(a.length===e.length)return{path:t,alreadyInstalled:!1};return n0(t,r,a),{path:t,alreadyInstalled:!0}}function lL(n){if(!n||typeof n!=="object"||Array.isArray(n))return[];let t=n.hooks;if(!t||typeof t!=="object"||Array.isArray(t))return[];let r=t.preToolUse;if(!Array.isArray(r))return[];return r.filter((e)=>!!e&&typeof e==="object"&&!Array.isArray(e)&&e.command===jn)}function dL(n){let t=[];if(n.length>1)t.push("Multiple managed cc-safety-net hooks found; reinstall to collapse duplicates");let r=n[0];if(r&&r.failClosed!==!0)t.push('Managed hook is missing "failClosed": true; reinstall to repair');if(r&&r.timeout!==30)t.push('Managed hook "timeout" is not 30; reinstall to repair');return t}function e0(n){let t=et(n.homeDir);if(!eL(t))return{platform:"cursor",status:"n/a",configPath:t};let r;try{r=JSON.parse(aL(t,"utf-8"))}catch(l){return{platform:"cursor",status:"n/a",configPath:t,errors:[`Failed to parse Cursor hooks config ${t}: ${l instanceof Error?l.message:String(l)}`]}}let e=lL(r);if(e.length===0)return{platform:"cursor",status:"n/a",configPath:t};let a=dL(e);return{platform:"cursor",status:"configured",method:"hook config",configPath:t,errors:a.length>0?a:void 0}}import{existsSync as sL}from"node:fs";import{join as zr}from"node:path";var Fr="gemini-safety-net";function Br(n){let t=zr(n,".gemini","extensions"),r=zr(t,Fr);if(!sL(r))return{platform:"gemini-cli",status:"n/a"};let e=zr(t,"extension-enablement.json"),a=n2(e);if(a.kind==="unreadable")return{platform:"gemini-cli",status:"not-inspected"};let l=a.kind==="ok"?$($(a.value,Fr),"overrides"):void 0;if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("!")))return{platform:"gemini-cli",status:"disabled",method:"extension config",configPath:e,errors:[`${Fr} is disabled in Gemini CLI`]};return{platform:"gemini-cli",status:"configured",method:"extension config",configPath:r}}function a0(n){return Br(n.homeDir)}import{readFileSync as v0}from"node:fs";import{join as o0}from"node:path";var M="cc-safety-net",l0="# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent";function d0(n){return`# cc-safety-net managed Hermes Agent plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --hermes-agent
# version: ${n}
`}function cL(n){return`${d0(n)}name: cc-safety-net
version: "${n}"
description: "Block destructive commands and secret-file access before Hermes runs a tool."
author: "cc-safety-net"
provides_hooks:
  - pre_tool_call
`}function LL(n){return`${d0(n)}"""CC Safety Net guard for Hermes Agent.
...
`}function zn(n){return[{name:"__init__.py",content:LL(n)},{name:"plugin.yaml",content:cL(n)}]}import{mkdirSync as iL,readdirSync as pL,readFileSync as uL,rmSync as Jr}from"node:fs";import{join as F2}from"node:path";var vL="__pycache__";function Zr(n){let t=process.env.HERMES_HOME?.trim();return t?t:F2(n,".hermes")}function Qr(n){return F2(Zr(n),"plugins",M)}function Xr(n){return n.startsWith(l0)}function Yr(n,t){let r=Qr(n),e=H(r);if(e&&(e.isSymbolicLink()||!e.isDirectory()))throw Error(`Refusing to ${t} ${r}: not a regular directory. Move or remove it and rerun ${t==="install"?"install":"uninstall"} --hermes-agent.`);return r}function s0(n,t){let r=H(n);if(!r)return;if(r.isSymbolicLink()||!r.isFile())throw Error(`Refusing to ${t} ${n}: not a regular file. Move or remove it.`);let e=uL(n,"utf-8");if(!Xr(e))throw Error(`Refusing to ${t} unmanaged file at ${n}. Move or remove it.`);return e}function c0(n){let t=Yr(n,"install"),r=zn(j());if(r.map((a)=>s0(F2(t,a.name),"overwrite")).every((a,l)=>a===r[l]?.content))return{path:t,alreadyInstalled:!0};return iL(t,{recursive:!0}),r.forEach((a)=>{B(F2(t,a.name),a.content)}),{path:t,alreadyInstalled:!1}}function Sr(n){let t=Yr(n,"remove");if(!H(t))return[];return zn(j()).filter((r)=>s0(F2(t,r.name),"remove")!==void 0)}function L0(n){let t=Yr(n,"remove");if(!H(t))return{path:t,alreadyInstalled:!1};let r=Sr(n);if(r.forEach((e)=>{Jr(F2(t,e.name))}),Jr(F2(t,vL),{recursive:!0,force:!0}),pL(t).length===0)Jr(t,{recursive:!0});return{path:t,alreadyInstalled:r.length>0}}var at="hermes-agent",i0=/^([^\s#][^:]*):/,oL=/^\s+([A-Za-z_][\w-]*):/,p0=/^\s+-\s*(.*)$/;function bL(n){return n.trim().replace(/^(["'])(.*)\1$/,"$2")}function fL(n){let t=n.split(/\r?\n/),r=t.findIndex((l)=>i0.exec(l)?.[1]?.trim()==="plugins");if(r===-1)return[];let e=t.slice(r+1),a=e.findIndex((l)=>i0.test(l));return a===-1?e:e.slice(0,a)}function u0(n,t){let r=fL(n),e=r.findIndex((d)=>oL.exec(d)?.[1]===t);if(e===-1)return[];let a=r.slice(e+1),l=a.findIndex((d)=>!p0.test(d));return(l===-1?a:a.slice(0,l)).map((d)=>bL(p0.exec(d)?.[1]??""))}function yL(n){try{return v0(o0(Zr(n),"config.yaml"),"utf-8")}catch{return}}function Hr(n){let t=yL(n)??"";return u0(t,"enabled").includes(M)&&!u0(t,"disabled").includes(M)}function b0(n){return/^# version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function hL(n,t){let r=H(n);if(!r)return{error:`${t.name} is missing from ${n}; run install --hermes-agent`};if(r.isSymbolicLink()||!r.isFile())return{error:`${n} is a symlink or not a regular file; move or remove it`};try{let e=v0(n,"utf-8");if(!Xr(e))return{error:`Unmanaged ${t.name} occupies ${n}; move or remove it`};if(b0(e)===j()&&e!==t.content)return{error:`Modified ${t.name} occupies ${n}; run install --hermes-agent to restore it`};return{content:e}}catch(e){return{error:`Failed to read ${n}: ${e instanceof Error?e.message:String(e)}`}}}function f0(n){let t=Qr(n.homeDir),r=Pn(at,t);if(r)return r;let e=zn(j()).map((s)=>hL(o0(t,s.name),s)),a=e.flatMap((s)=>("error"in s)?[s.error]:[]);if(a.length>0)return{platform:at,status:"n/a",configPath:t,errors:a};let l=e.some((s)=>("content"in s)&&b0(s.content)!==j()),d=l?["Installed Hermes Agent plugin is outdated; run install --hermes-agent to update"]:[];if(!Hr(n.homeDir))return{platform:at,status:"disabled",method:"plugin directory",configPath:t,errors:[`${M} is not enabled in Hermes; run \`hermes plugins enable ${M}\``,...d]};return{platform:at,status:"configured",method:"plugin directory",configPath:t,errors:l?d:void 0}}import{existsSync as wL,readFileSync as xL}from"node:fs";import{join as y0}from"node:path";var $L=/cc-safety-net\s+hook\s+(?:[^\s]+\s+)*--kimi-code(\s|["']|$)/;function gL(n){return y0(process.env.KIMI_CODE_HOME||y0(n,".kimi-code"),"config.toml")}function Fn(n){let t=gL(n.homeDir);if(!wL(t))return{platform:"kimi-code",status:"n/a",configPath:t};try{if(!$L.test(xL(t,"utf-8")))return{platform:"kimi-code",status:"n/a",configPath:t}}catch(r){return{platform:"kimi-code",status:"n/a",configPath:t,errors:[`Failed to read ${t}: ${r instanceof Error?r.message:String(r)}`]}}return{platform:"kimi-code",status:"configured",method:"hook config",configPath:t}}import{readFileSync as j0}from"node:fs";import{join as Jn}from"node:path";var q="cc-safety-net",V="index.js",nn="openclaw.plugin.json",tn="package.json";var lt="// cc-safety-net managed OpenClaw plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --openclaw";import{existsSync as kL,lstatSync as qL,readdirSync as jL,readFileSync as zL}from"node:fs";import{dirname as x0,join as h2}from"node:path";import{fileURLToPath as FL}from"node:url";import{spawn as DL}from"node:child_process";function mL(n){return n.join(" ")}function Ar(n,t,r){return[`Failed to run ${mL(n)}${t===null?"":` (exit ${t})`}.`,r.trim()].filter(Boolean).join(`
`)}function Wr(n){let t={stdout:"",stderr:""};return n.stdout.setEncoding("utf-8"),n.stderr.setEncoding("utf-8"),n.stdout.on("data",(r)=>{t.stdout+=r}),n.stderr.on("data",(r)=>{t.stderr+=r}),t}function r2(n,t){return new Promise((r,e)=>{let a=y2([...n],process.env),l=DL(a.cmd,a.args,{stdio:["ignore","pipe","pipe"]}),d=Wr(l),s=()=>[d.stdout,d.stderr].filter(Boolean).join(`
`),c=t?.timeoutMs??120000,L=setTimeout(()=>{l.kill(),e(Error(Ar(n,null,`Timed out after ${c}ms.
${s()}`.trim())))},c);l.on("error",(i)=>{clearTimeout(L),e(Error(Ar(n,null,`${i.message}
${s()}`.trim())))}),l.on("close",(i)=>{if(clearTimeout(L),i!==0){e(Error(Ar(n,i,s())));return}r(t?.stdoutOnly?d.stdout:s())})})}async function Rr(n){for(let t of n)await r2(t)}async function h0(n){for(let t of n)try{await r2(t)}catch(r){console.warn(r instanceof Error?r.message:String(r))}}var w0=h2("openclaw",q),BL=[V,nn,tn];function Kr(n,t){if(n==="~")return t;if(n.startsWith("~/")||n.startsWith("~\\"))return h2(t,n.slice(2));return n}function $0(n){let t=process.env.OPENCLAW_STATE_DIR?.trim();if(t)return Kr(t,n);let r=process.env.OPENCLAW_CONFIG_PATH?.trim();return r?x0(Kr(r,n)):h2(n,".openclaw")}function g0(n){let t=process.env.OPENCLAW_CONFIG_PATH?.trim();return t?Kr(t,n):h2($0(n),"openclaw.json")}function Mr(n){return h2($0(n),"extensions",q)}function JL(n){let t=jL(n);if(t.length===0)return!0;if(t.some((a)=>!BL.includes(a)))return!1;let r=h2(n,V),e=H(r);return e!==void 0&&!e.isSymbolicLink()&&e.isFile()&&zL(r,"utf-8").startsWith(lt)}function Vr(n){let t=Mr(n),r=H(t);if(!r)return;if(!r.isSymbolicLink()&&r.isDirectory()&&JL(t))return;throw Error(`Refusing to modify ${t}: it does not hold a cc-safety-net managed OpenClaw plugin. Move or remove it, then run the command again.`)}function D0(){let n=x0(FL(import.meta.url));return[h2(n,"..",w0),h2(n,"..","..","..","dist",w0)]}function Gr(n=D0()){return n.find((t)=>kL(t)&&qL(t).isDirectory())}function ZL(n=D0()){let t=Gr(n);if(!t)throw Error("Packaged OpenClaw plugin directory not found. Reinstall cc-safety-net and try again.");return t}function m0(n=ZL()){return[["openclaw","plugins","install",n,"--force"],["openclaw","plugins","enable",q]]}function QL(n){let t=(()=>{try{return JSON.parse(n)}catch{return}})(),r=$($(t,"plugin"),"status");return typeof r==="string"?r:void 0}async function k0(){let n=QL(await r2(["openclaw","plugins","inspect",q,"--runtime","--json"],{stdoutOnly:!0}));if(n==="loaded")return;throw Error(`${n===void 0?`The ${q} plugin's load state could not be verified: OpenClaw's runtime inspect report was unreadable.`:`OpenClaw reports the ${q} plugin with status "${n}".`} Run \`openclaw plugins inspect ${q} --runtime\` for details.`)}var dt="openclaw",Bn=`run \`openclaw plugins enable ${q}\``;function rn(n,t){let r=Jn(n,t),e=H(r);if(!e)return{error:`${t} is missing from ${r}; run install --openclaw`};if(e.isSymbolicLink()||!e.isFile())return{error:`${r} is a symlink or not a regular file; move or remove it`};try{return{content:j0(r,"utf-8")}}catch(a){return{error:`Failed to read ${r}: ${a instanceof Error?a.message:String(a)}`}}}function z0(n){try{return JSON.parse(R(n))}catch{return}}function XL(n){let t=rn(n,nn);if("error"in t)return t.error;if($(z0(t.content),"id")===q)return;return`${Jn(n,nn)} is not a valid ${q} manifest; run install --openclaw`}function YL(n){let t=rn(n,tn);if("error"in t)return t.error;let r=$($(z0(t.content),"openclaw"),"extensions");if(Array.isArray(r)&&r.includes(`./${V}`))return;return`${Jn(n,tn)} does not point OpenClaw at ${V}; run install --openclaw`}function q0(n){return Array.isArray(n)?n.filter((t)=>typeof t==="string"):[]}function SL(n){let t=g0(n);if(!H(t))return`${q} is not enabled; ${Bn}`;let r=(()=>{try{return JSON.parse(R(j0(t,"utf-8")))}catch{return}})();if(r===void 0)return`Failed to read ${t}; fix it, then ${Bn}`;let e=$(r,"plugins");if($(e,"enabled")===!1)return`plugins.enabled is false in ${t}; no OpenClaw plugin loads`;let a=$($($(e,"entries"),q),"enabled");if(q0($(e,"deny")).includes(q)||a===!1)return`${q} is disabled in ${t}; ${Bn}`;let l=q0($(e,"allow"));if(l.length>0&&!l.includes(q))return`plugins.allow in ${t} does not list ${q}; add it, then ${Bn}`;if(l.includes(q)||a===!0)return;return`${q} is not enabled; ${Bn}`}function F0(n){return/^\/\/ version:\s*(.+)$/m.exec(n)?.[1]?.trim()}function HL(n,t,r){if(r===void 0)return[];let e=rn(r,V);if("error"in e||F0(e.content)!==t)return[];return[V,nn,tn].flatMap((a)=>{let l=rn(n,a),d=rn(r,a);if("error"in l||"error"in d||l.content===d.content)return[];return[`Modified ${a} occupies ${Jn(n,a)}; run install --openclaw to restore it`]})}function B0(n){let t=Mr(n.homeDir),r=Pn(dt,t);if(r)return r;let e=rn(t,V),l=["error"in e?e.error:e.content.startsWith(lt)?void 0:`Unmanaged ${V} occupies ${Jn(t,V)}; move or remove it`,XL(t),YL(t)].filter((i)=>i!==void 0),d="content"in e?F0(e.content):void 0,s=l.length>0?l:HL(t,d,Gr());if(s.length>0)return{platform:dt,status:"n/a",configPath:t,errors:s};let c=d===j()?[]:["Installed OpenClaw plugin is outdated; run install --openclaw to update"],L=SL(n.homeDir);if(L)return{platform:dt,status:"disabled",method:"plugin directory",configPath:t,errors:[L,...c]};return{platform:dt,status:"configured",method:"plugin directory",configPath:t,errors:c.length>0?c:void 0}}import{existsSync as OL,readFileSync as _L}from"node:fs";import{join as EL}from"node:path";import{existsSync as Ur,readFileSync as Y0,rmSync as WL}from"node:fs";import{join as i2}from"node:path";import{pathToFileURL as RL}from"node:url";function J0(n){return n!==void 0&&/\s/.test(n)}function AL(n,t,r){let e=t+1,a=!1;while(e<n.length){let l=n[e];if(a){a=!1,e++;continue}if(l==="\\"){a=!0,e++;continue}if(l==='"')return e+1;e++}throw Error(r)}function st(n,t,r){let e=n[t],a=e==="["?"]":"}",l=0,d=t;while(d<n.length){let s=r.skipComment?.(n,d)??d;if(s!==d){d=s;continue}if(n[d]==='"'){d=AL(n,d,r.stringError);continue}if(n[d]===e)l++;if(n[d]===a){if(l--,l===0)return d}d++}throw Error(r.bracketError)}function Z0(n,t){let r=n.lastIndexOf(`
`,t)+1;return/^[ \t]*/.exec(n.slice(r))?.[0]??""}function ct(n,t){let{start:r,end:e,end:a}=t;while(J0(n[a]))a++;if(n[a]===","){if(e=a+1,n[e]===`
`)e++;return`${n.slice(0,r)}${n.slice(e)}`}a=t.start-1;while(J0(n[a]))a--;if(n[a]===","){r=a;let l=n.lastIndexOf(`
`,r-1);if(l!==-1&&/^\s*$/.test(n.slice(l+1,r)))r=l}return`${n.slice(0,r)}${n.slice(e)}`}var Lt="cc-safety-net",S0=`${Lt}@latest`,H0=["opencode.json","opencode.jsonc"],Q0="CCSafetyNetPlugin";function it(n){return i2(process.env.XDG_CONFIG_HOME||i2(n,".config"),"opencode")}function KL(n){return i2(it(n),H0[0])}function ML(n){return H0.map((t)=>i2(it(n),t))}function A0(n){return i2(process.env.XDG_CACHE_HOME||i2(n,".cache"),"opencode","packages",S0)}function Cr(n){WL(A0(n),{recursive:!0,force:!0})}async function W0(n){let t=i2(A0(n),"node_modules",Lt),r=i2(t,"package.json");if(!Ur(r))throw Error(`The OpenCode plugin cache at ${t} is missing its package, so OpenCode would load nothing and fail open. Run \`opencode plugin -g -f ${S0}\` for details.`);let e=$(JSON.parse(Y0(r,"utf-8")),"main");if(typeof e!=="string")throw Error(`The cached OpenCode plugin at ${t} declares no "main" entry.`);let a=i2(t,e);if(typeof(await import(RL(a).href))[Q0]==="function")return;throw Error(`The cached OpenCode plugin at ${a} does not export a callable ${Q0}, so OpenCode would load nothing and fail open.`)}function pt(n,t){if(n[t]==="/"&&n[t+1]==="/"){let r=n.indexOf(`
`,t+2);return r===-1?n.length:r+1}if(n[t]==="/"&&n[t+1]==="*"){let r=n.indexOf("*/",t+2);return r===-1?n.length:r+2}return t}function X0(n,t){let r=t;while(r<n.length){if(/\s/.test(n[r]??"")){r++;continue}let e=pt(n,r);if(e===r)return r;r=e}return r}function R0(n,t){let r=t+1,e=!1;while(r<n.length){if(e){e=!1,r++;continue}if(n[r]==="\\"){e=!0,r++;continue}if(n[r]==='"')return r+1;r++}throw Error("Unterminated string in OpenCode config")}function K0(n,t,r){return JSON.parse(n.slice(t,r))}function VL(n,t){return st(n,t,{skipComment:pt,stringError:"Unterminated string in OpenCode config",bracketError:"Unmatched plugin array in OpenCode config"})}function GL(n){let t=0,r=0;while(r<n.length){let e=pt(n,r);if(e!==r){r=e;continue}if(n[r]==='"'){let a=R0(n,r);if(t===1&&K0(n,r,a)==="plugin"){let l=X0(n,a),d=X0(n,l+1);if(n[l]===":"&&n[d]==="[")return{start:d,end:VL(n,d)}}r=a;continue}if(n[r]==="{"||n[r]==="[")t++;if(n[r]==="}"||n[r]==="]")t--;r++}return}function UL(n,t){let r=[],e=t.start+1;while(e<t.end){let a=pt(n,e);if(a!==e){e=a;continue}if(n[e]==='"'){let l=R0(n,e),d=K0(n,e,l);if(typeof d==="string"&&d.includes(Lt))r.push({start:e,end:l});e=l;continue}e++}return r}function M0(n,t){try{return JSON.parse(R(n))}catch(r){if(r instanceof SyntaxError)throw Error(`Failed to parse OpenCode config ${t}: ${r.message}`);throw r}}function CL(n){if(!n||typeof n!=="object"||Array.isArray(n))return!1;let t=n.plugin;if(!Array.isArray(t))return!1;return t.some((r)=>typeof r==="string"&&r.includes(Lt))}function TL(n,t){let r=GL(n);if(!r)throw Error(`Failed to locate OpenCode plugin array in ${t}`);let e=[...UL(n,r)].reverse().reduce(ct,n);return M0(e,t),e}function V0(n){Cr(n);let t=ML(n),r=t.find((a)=>Ur(a)),e=[];for(let a of t){if(!Ur(a))continue;try{let l=Y0(a,"utf-8");if(!CL(M0(l,a)))continue;return B(a,TL(l,a)),{path:a,alreadyInstalled:!0}}catch(l){e.push(l instanceof Error?l.message:String(l))}}if(e.length>0)throw Error(e.join(`
`));return{path:r??KL(n),alreadyInstalled:!1}}function G0(n){let t=[],r=it(n.homeDir),e=["opencode.json","opencode.jsonc"];for(let a of e){let l=EL(r,a);if(OL(l))try{let d=_L(l,"utf-8"),s=R(d);if((JSON.parse(s).plugin??[]).some((u)=>u.includes("cc-safety-net")))return{platform:"opencode",status:"configured",method:"plugin array",configPath:l,errors:t.length>0?t:void 0}}catch(d){t.push(`Failed to parse ${a}: ${d instanceof Error?d.message:String(d)}`)}}return{platform:"opencode",status:"n/a",errors:t.length>0?t:void 0}}import{join as PL}from"node:path";function Tr(n){return PL(n,".pi","agent","settings.json")}function Or(n){if(typeof n!=="string")return!1;return n==="npm:cc-safety-net"||n.startsWith("npm:cc-safety-net@")}function U0(n){let t=Tr(n.homeDir),r=n2(t);if(r.kind==="unreadable")return{platform:"pi",status:"not-inspected"};if(r.kind==="missing")return{platform:"pi",status:"n/a"};let e=$(r.value,"packages");if(!Array.isArray(e))return{platform:"pi",status:"n/a"};let a=e.find((s)=>Or(typeof s==="string"?s:$(s,"source")));if(a===void 0)return{platform:"pi",status:"n/a"};let l=$(a,"extensions");if(Array.isArray(l)&&l.some((s)=>typeof s==="string"&&s.startsWith("-")))return{platform:"pi",status:"disabled",method:"package config",configPath:t,errors:["npm:cc-safety-net is installed but its extension is disabled in Pi settings"]};return{platform:"pi",status:"configured",method:"package config",configPath:t}}var NL={amp:Za,"antigravity-cli":Qa,"claude-code":Ha,codex:Aa,"copilot-cli":_a,cursor:e0,"gemini-cli":a0,"hermes-agent":f0,"kimi-code":Fn,openclaw:B0,opencode:G0,pi:U0};function en(n,t){let r={...t,cwd:n,homeDir:t?.homeDir??IL()};return B1.map((e)=>ni(NL[e](r)))}function ni(n){if(n.status==="not-inspected")return{platform:n.platform,detected:!1,configured:!1,inspectionStatus:"not-inspected"};return{platform:n.platform,detected:n.status!=="n/a",configured:n.status==="configured",inspectionStatus:n.status!=="n/a"?"verified":n.errors&&n.errors.length>0?"failed":"not-applicable",method:n.method,configPath:n.configPath,configPaths:n.configPaths,errors:n.errors}}import{tmpdir as ti}from"node:os";import{join as ri}from"node:path";var ei=Object.freeze([{command:"git reset --hard",description:"git reset --hard",expectBlocked:!0},{command:"rm -rf /",description:"rm -rf /",expectBlocked:!0},{command:"rm -rf ./node_modules",description:"rm in cwd (safe)",expectBlocked:!1}]),ai=Object.freeze({state:"ready",diagnostics:Object.freeze([]),ruleMetadata:Object.freeze({}),policy:Object.freeze({rules:Object.freeze([]),transparentWrappers:Object.freeze([]),safety:Object.freeze({}),worktreeMode:!1,destructiveCommandProtectionEnabled:!0,destructiveCommandRuleOverrides:Object.freeze({}),destructiveCommandAllowPaths:Object.freeze([]),secretProtection:Object.freeze({enabled:!0,disabledRules:Object.freeze([]),denyPaths:Object.freeze([]),allowPaths:Object.freeze([])})})}),li={strict:!1,paranoidRm:!1,paranoidInterpreters:!1,worktreeMode:!1,effectiveLevel:"standard",capabilities:{fail_closed:{enabled:!1,source:"preset",sources:[]},paranoid_rm:{enabled:!1,source:"preset",sources:[]},paranoid_interpreters:{enabled:!1,source:"preset",sources:[]}},sources:{failClosed:[],paranoidRm:[],paranoidInterpreters:[],worktreeMode:[]}};function C0(){let n=ri(ti(),"cc-safety-net-self-test"),t=ei.map((r)=>{let e=Mn(G2("self-test",{command:r.command},{kind:"command",shell:"auto"},{configCwd:n,executionCwd:n},r.command),{guard:{dependencies:{loadPolicySnapshot:()=>ai,getModes:()=>li,findPolicyMutation:()=>null}},audit:{agent:"self-test",getSessionId:()=>{return}}}),a=r.expectBlocked?"blocked":"allowed",l=e.decision.kind==="deny"?"blocked":"allowed";return{command:r.command,description:r.description,expected:a,actual:l,passed:a===l,reason:e.decision.kind==="deny"?e.decision.reason:void 0,ruleId:e.decision.kind==="deny"?e.decision.ruleId:void 0}});return{passed:t.filter((r)=>r.passed).length,failed:t.filter((r)=>!r.passed).length,total:t.length,results:t}}function _r(n){let t=z({label:"doctor",booleans:{json:["--json"],skipUpdateCheck:["--skip-update-check"]}},n);if(e2(t.errors))return null;return{json:t.flags.json,skipUpdateCheck:t.flags.skipUpdateCheck}}async function T0(n={}){let t=await mn(!n.json,()=>{let r=di(n);return{ready:r,finish:()=>r}},()=>Dn(),{loadingMessage:"Checking system status…"});if(n.json)console.log(JSON.stringify(t,null,2));else ci(t);return si(t.hooks,t.engineSelfTest,{userConfig:t.userConfig,projectConfig:t.projectConfig})?1:0}async function di(n){let t=n.cwd??process.cwd(),r=await $n(),e=en(t,{ampPluginListOutput:r.ampPluginListOutput,codexPluginListOutput:r.codexPluginListOutput,copilotCliVersion:r.copilotCliVersion}),a=ra(t),l=ea(),d=W({cwd:t}),s=d.policy,c=d2(s),L=m2(s,c.capabilities),i=Cn(7),u=n.skipUpdateCheck?{currentVersion:j(),latestVersion:null,updateAvailable:!1}:await I2(),o={hooks:e,engineSelfTest:C0(),userConfig:a.userConfig,projectConfig:a.projectConfig,configState:hn(d),effectiveRules:a.effectiveRules,shadowedRules:a.shadowedRules,environment:l,effectiveSafety:{selectedPreset:s.safety.level??"standard",level:c.effectiveLevel,capabilities:c.capabilities,ruleOverrides:s.destructiveCommandRuleOverrides,weakenedRuleOverrides:Object.entries(L).filter(([,p])=>p.source==="rule_override"&&p.override==="off"&&p.inheritedEnabled&&p.changesInherited).map(([p])=>p),ruleCounts:{stored:Object.keys(s.destructiveCommandRuleOverrides).length,effective:Object.values(L).filter((p)=>p.changesInherited).length}},posture:ya(a.userConfig.path),activity:i,update:u,system:r};return{...o,findings:la(o)}}function si(n,t,r){return n.length>0&&n.every((e)=>!e.configured)||n.some((e)=>e.inspectionStatus==="failed")||t.failed>0||r.userConfig.exists&&!r.userConfig.valid||r.projectConfig.exists&&!r.projectConfig.valid}function ci(n){console.log(),console.log(sa(n.hooks)),console.log(),console.log(ca(n.engineSelfTest)),console.log(),console.log(La(n)),console.log(),console.log(ia(n.environment)),console.log(),console.log(pa(n)),console.log(),console.log(ua(n.findings)),console.log(),console.log(va(n.activity)),console.log(),console.log(ba(n.system)),console.log(),console.log(oa(n.update)),console.log(fa(n))}import{existsSync as Li}from"node:fs";var ii=/^[A-Za-z0-9_@%+=:,./-]+$/,O0="Usage: cc-safety-net explain [--json] [--cwd <path>] <command>";function Er(n){let t=z({label:"explain",booleans:{json:["--json"]},values:{cwd:["--cwd"]},positionals:"tail"},n);if(e2(t.errors))return console.error(O0),console.error("Pass -- before a command that starts with dashes."),null;if(t.values.cwd!==void 0&&!Li(t.values.cwd))return console.error(`Error: --cwd path does not exist: ${t.values.cwd}`),null;let r=t.positionals.length===1?t.positionals[0]:t.positionals.map((e)=>ii.test(e)?e:`'${e.replaceAll("'","'\\''")}'`).join(" ");if(!r)return console.error("Error: No command provided"),console.error(O0),null;return{json:t.flags.json,cwd:t.values.cwd,command:r}}function _0(n){if(n)return{dh:"=",dv:"|",dtl:"+",dtr:"+",dbl:"+",dbr:"+",h:"-",v:"|",tl:"+",tr:"+",bl:"+",br:"+",sh:"="};return{dh:"═",dv:"║",dtl:"╔",dtr:"╗",dbl:"╚",dbr:"╝",h:"─",v:"│",tl:"┌",tr:"┐",bl:"└",br:"┘",sh:"━"}}function E0(n,t){let e=t-18;return[`${n.dtl}${n.dh.repeat(t)}${n.dtr}`,`${n.dv}  Command Analysis${" ".repeat(e)}${n.dv}`,`${n.dbl}${n.dh.repeat(t)}${n.dbr}`]}function Pr(n){return JSON.stringify(n)}function P0(n,t=0){return`[${n.map((e,a)=>da(e,a,t)).join(",")}]`}function ut(n,t,r=70){let e=n.split(" "),a=[],l="";for(let d of e)if(l&&l.length+d.length+1>r)a.push(l),l=d;else l=l?`${l} ${d}`:d;if(l)a.push(l);return a.map((d,s)=>s===0?d:`${t}${d}`)}function I0(n,t,r){let e=[];switch(n.type){case"parse":return null;case"env-strip":{e.push(""),e.push(`STEP ${t} ${r.h} Strip environment variables`);let a=Object.keys(n.envVars);return e.push(`  Removed: ${a.map((l)=>`${l}=<redacted>`).join(", ")}`),e.push(`  Tokens:  ${Pr(n.output)}`),{lines:e,incrementStep:!0}}case"leading-tokens-stripped":return e.push(""),e.push(`STEP ${t} ${r.h} Strip wrappers`),e.push(`  Removed: ${n.removed.join(", ")}`),e.push(`  Tokens:  ${Pr(n.output)}`),{lines:e,incrementStep:!0};case"shell-wrapper":return e.push(""),e.push(`STEP ${t} ${r.h} Detect shell wrapper`),e.push(`  Wrapper: ${n.wrapper} -c`),e.push(`  Inner:   ${n.innerCommand}`),{lines:e,incrementStep:!0};case"interpreter":{if(e.push(""),e.push(`STEP ${t} ${r.h} Detect interpreter`),e.push(`  Interpreter: ${n.interpreter}`),e.push(`  Code:        ${n.codeArg}`),n.paranoidBlocked)e.push("  Result:      ✗ BLOCKED (paranoid mode)");return{lines:e,incrementStep:!0}}case"busybox":return e.push(""),e.push(`STEP ${t} ${r.h} Busybox wrapper`),e.push(`  Subcommand: ${n.subcommand}`),{lines:e,incrementStep:!0};case"transparent-wrapper":return e.push(""),e.push(`STEP ${t} ${r.h} Transparent wrapper`),e.push(`  Wrapper: ${n.wrapper}`),e.push(`  Tokens:  ${Pr(n.output)}`),{lines:e,incrementStep:!0};case"recurse":return{lines:[],incrementStep:!1};case"rule-check":{e.push(""),e.push(`STEP ${t} ${r.h} Match rules`);let a=`${n.ruleModule}:${n.ruleFunction}()`;if(e.push(`  Rule:   ${a}`),n.matched)e.push("  Result: MATCHED");else e.push("  Result: No match");return{lines:e,incrementStep:!0}}case"worktree-relaxation":return e.push(""),e.push(`STEP ${t} ${r.h} Worktree relaxation`),e.push(`  Mode:   ${m.worktree.name}`),e.push(`  Git cwd: ${n.gitCwd}`),e.push("  Result: Allowed local discard in linked worktree"),{lines:e,incrementStep:!0};case"tmpdir-check":return null;case"fallback-scan":{if(n.embeddedCommandFound)return e.push(""),e.push(`STEP ${t} ${r.h} Fallback scan`),e.push(`  Found: ${n.embeddedCommandFound}`),{lines:e,incrementStep:!0};return null}case"custom-rules-check":{if(n.rulesChecked){if(e.push(""),e.push(`STEP ${t} ${r.h} Custom rules`),n.matched)e.push("  Result: MATCHED");else e.push("  Result: No match");return{lines:e,incrementStep:!0}}return null}case"cwd-change":return null;case"dangerous-text":{if(n.matched)return e.push(""),e.push(`STEP ${t} ${r.h} Dangerous text check`),e.push(`  Token:  ${n.token}`),e.push("  Result: MATCHED"),{lines:e,incrementStep:!0};return null}case"strict-unparseable":return e.push(""),e.push(`STEP ${t} ${r.h} Strict mode check`),e.push(`  Command: ${n.rawCommand}`),e.push("  Result:  ✗ UNPARSEABLE"),{lines:e,incrementStep:!0};case"segment-skipped":return null;case"error":return e.push(""),e.push(`ERROR: ${n.message}`),{lines:e,incrementStep:!1};default:return null}}function Ir(n,t){let r=_0(t?.asciiOnly??!1),e=58,a=[],l=1;a.push(...E0(r,58)),a.push("");let d=n.trace.steps.find((p)=>p.type==="error");if(d&&d.type==="error"){a.push("ERROR"),a.push(`  ${d.message}`),a.push(""),a.push("RESULT"),a.push(`  Status: ${n.result==="blocked"?b.red("BLOCKED"):b.green("ALLOWED")}`),a.push(""),a.push("CONFIG");let p=n.configSource??"none";return a.push(`  Path: ${p}`),a.join(`
`)}let s=n.trace.steps.find((p)=>p.type==="parse");if(s&&s.type==="parse"){a.push("INPUT"),a.push(`  ${s.input}`),a.push(""),a.push(`STEP ${l} ${r.h} Split shell commands`),l++;for(let p=0;p<s.segments.length;p++){let f=s.segments[p];if(f){let v=Math.random();a.push(`  Segment ${p+1}: ${P0(f,v)}`)}}}let c=n.trace.segments,L=c.length>1;for(let p of c){if(L){a.push("");let x="";if(s&&s.type==="parse"){let Jt=s.segments[p.index];if(Jt)x=Jt.join(" ")}let w=54,h=x,J=` Segment ${p.index+1}: `,X2=" ";if(x){if(J.length+x.length+X2.length>w){let K3=w-J.length-X2.length;h=`${x.substring(0,K3-1)}…`}}let sn=x?`${J}${h}${X2}`:` Segment ${p.index+1} `,Bt=x?`${J}${b.cyan(h)}${X2}`:sn,ge=58-sn.length,De=Math.floor(ge/2),R3=ge-De;a.push(`${r.sh.repeat(De)}${Bt}${r.sh.repeat(R3)}`)}if(p.steps.find((x)=>x.type==="segment-skipped")){a.push(""),a.push("  (skipped — prior segment blocked)");continue}let v=!1,y=!1;for(let x of p.steps){let w=I0(x,l,r);if(w){if(y=!0,x.type==="recurse"){a.push("");let h=" RECURSING ",J=58-h.length-4;a.push(`  ${r.tl}${r.h}${h}${r.h.repeat(J)}`),a.push(`  ${r.v}`),v=!0;continue}for(let h of w.lines)if(v)a.push(`  ${r.v} ${h}`);else a.push(h);if(w.incrementStep)l++}}if(v)a.push(`  ${r.v}`),a.push(`  ${r.bl}${r.h.repeat(56)}`),v=!1;if(!y)a.push(""),a.push(`  ${b.green("✓")} Allowed (no matching rules)`)}if(a.push(""),a.push("RESULT"),n.result==="blocked"){if(a.push(`  Status: ${b.red("BLOCKED")}`),n.customRule){if(a.push(`  Rule: ${n.customRule.id}`),n.customRule.rulebook)a.push(`  Rulebook: ${n.customRule.rulebook.name} ${n.customRule.rulebook.version}`);if(n.customRule.source)a.push(`  Source: ${n.customRule.source}`);if(n.customRule.override)a.push(`  Override: reason ${n.customRule.override.reason}`)}if(n.reason){let p=ut(n.reason,"          ");a.push(`  Reason: ${p[0]}`);for(let f=1;f<p.length;f++)a.push(p[f]??"")}}else a.push(`  Status: ${b.green("ALLOWED")}`);a.push(""),a.push("CONFIG");let i=n.configSource??"none",u=n.configValid?"":" (invalid)";a.push(`  Path: ${i}${u}`),a.push(`  Safety preset: ${n.selectedPreset??"standard"}`),a.push(`  Effective capabilities: ${n.effectiveLevel}`);let o=Object.entries(n.destructiveCommandRuleOverrides??{});if(a.push(`  Rule customizations: ${o.length}`),n.ruleActivation)a.push(`  Rule activation: ${n.ruleActivation.id} — ${n.ruleActivation.enabled?"on":"off"} via ${n.ruleActivation.source}`);return a.join(`
`)}function Nr(n){return JSON.stringify(n,null,2)}var N0="2.0.6",G="  ",B2="cc-safety-net";function nl(n){return n.argument?`${n.flags} ${n.argument}`:n.flags}function pi(n){return Math.max(...n.map((t)=>nl(t).length))}function ui(n){return Math.max(...n.map((t)=>t.usage.length))}function vi(n){return Math.max(...n.map((t)=>`${B2} ${t.usage}`.length))}function oi(n,t){let r=`${B2} ${n.usage}`;return`${G}${r.padEnd(t+2)}${n.description}`}function p2(n,t){return`${G}${n.padEnd(Math.max(40,n.length+2))}${t}`}function vt(n,t=console.log){let r=[];if(r.push(`${B2} ${n.name}`),r.push(""),r.push(`${G}${n.description}`),r.push(""),r.push("USAGE:"),r.push(`${G}${B2} ${n.usage}`),r.push(""),n.subcommands&&n.subcommands.length>0){r.push("SUBCOMMANDS:");let e=ui(n.subcommands);for(let a of n.subcommands)r.push(`${G}${a.usage.padEnd(e+2)}${a.description}`);r.push("")}if(n.options.length>0){r.push("OPTIONS:");let e=pi(n.options);for(let a of n.options){let l=nl(a),d=a.default?`${a.description} (default: ${a.default})`:a.description;r.push(`${G}${l.padEnd(e+2)}${d}`)}r.push("")}if(n.examples&&n.examples.length>0){r.push("EXAMPLES:");for(let e of n.examples)r.push(`${G}${e}`)}t(r.join(`
`))}function ne(){let n=na(),t=vi(n),r=[];r.push(`${B2} v${N0}`),r.push(""),r.push("Blocks destructive commands and secret access."),r.push(""),r.push("COMMANDS:");for(let e of n)r.push(oi(e,t));r.push(""),r.push("GLOBAL OPTIONS:"),r.push(`${G}-h, --help       Show help (use with command for command-specific help)`),r.push(`${G}-V, --version    Show version`),r.push(""),r.push("HELP:"),r.push(`${G}${B2} help <command>     Show help for a specific command`),r.push(`${G}${B2} <command> --help   Show help for a specific command`),r.push(""),r.push("ENVIRONMENT VARIABLES:"),r.push(p2(`${m.level.name}=standard|strict|paranoid`,"Set session safety level")),r.push(p2(`${m.worktree.name}=1`,"Allow local git discards in linked worktrees")),r.push(p2(`${m.debug.name}=1`,"Print diagnostic messages to stderr")),r.push(p2(`${m.auditScope.name}=all|blocked`,"Record all command decisions, or denials only")),r.push(p2("CC_SAFETY_NET_HOME","Override rule config home directory")),r.push(""),r.push("LEGACY ENVIRONMENT VARIABLES (STILL SUPPORTED):"),r.push(p2(`${m.strict.name}=1`,"Force safety.overrides.fail_closed on")),r.push(p2(`${m.paranoid.name}=1`,"Force paranoid_rm and paranoid_interpreters on")),r.push(p2(`${m.paranoidRm.name}=1`,"Force safety.overrides.paranoid_rm on")),r.push(p2(`${m.paranoidInterpreters.name}=1`,"Force safety.overrides.paranoid_interpreters on")),r.push(""),r.push("Documentation:        https://ccsafetynet.com/docs"),console.log(r.join(`
`))}function tl(){console.log(N0)}function Zn(n,t=console.log){let r=Un(n);if(!r)return!1;if(r.hidden||r.name.toLowerCase()!==n.toLowerCase())return!1;return vt(r,t),!0}import{existsSync as ue,readFileSync as _l}from"node:fs";import{homedir as t5}from"node:os";import{join as ie}from"node:path";import*as w2 from"node:readline";function bi(n){return n==="install"?"Install":"Uninstall"}function fi(n){return n==="install"?"Installing":"Uninstalling"}function yi(n){return n==="install"?"into":"from"}function al(n){return n?.available===!0}function hi(n,t){let r=new Set(t);return n.filter((e)=>r.has(e.target)).map((e)=>e.target)}function rl(n,t,r){if(n.length===0||n.every((e)=>!e.available))return t;return Array.from({length:n.length},(e,a)=>a+1).map((e)=>(t+e*r+n.length)%n.length).find((e)=>al(n[e]))}function wi(n,t,r){if(r.ctrl&&r.name==="c")return"interrupt";if(r.name==="escape"||t==="q")return"abort";if(n==="install"&&(t==="u"||t==="U"))return"update";if(r.name==="up"||t==="k")return"up";if(r.name==="down"||t==="j")return"down";if(r.name==="space"||t===" ")return"toggle";if(r.name==="return"||r.name==="enter")return"confirm";return null}function xi(n){return{cursor:n.findIndex((t)=>t.available),selected:[]}}function $i(n,t,r){if(r==="confirm"||r==="update"||r==="abort"||r==="interrupt")return{state:n,done:r};if(r==="up")return{state:{...n,cursor:rl(t,n.cursor,-1)}};if(r==="down")return{state:{...n,cursor:rl(t,n.cursor,1)}};let e=t[n.cursor];if(!al(e))return{state:n};let a=n.selected.includes(e.target)?n.selected.filter((l)=>l!==e.target):hi(t,[...n.selected,e.target]);return{state:{...n,selected:a}}}var ll="◉",dl="◯",sl=">",cl=" ";function gi(n,t,r,e={}){let a=e.color!==!1,l=a?b.dim:(c)=>c,d=a?b.green:(c)=>c,s=a?b.bold:(c)=>c;return["",`${bi(n)} CC Safety Net ${yi(n)}:`,"",...t.map((c,L)=>{let i=r.selected.includes(c.target),u=L===r.cursor,o=i?ll:dl,p=u?sl:cl,f=c.available?"":` (${c.unavailableReason??"not installed"})`,v=`${o} ${c.label}${f}`,y=!c.available?l(v):i?d(v):u?s(v):v;return`${p} ${y}`}),"",n==="install"?"Space: select  Enter: confirm  u: update installed  Up/Down: move  q/Esc: cancel":t.some((c)=>c.available)?"Space: select  Enter: confirm  Up/Down: move  q/Esc: cancel":`No selectable integrations found for ${n}. q/Esc: close`].join(`
`)}var el=["global-hook","plugin"];function Di(n,t,r={}){let e=r.color!==!1?b.bold:(l)=>l;return["","Install the Kimi Code integration as:","",...[`Global hook — ${t?"already installed; selecting it reports the current state":"write the hook into ~/.kimi-code/config.toml now"}`,"Native Kimi plugin — print the steps to run inside Kimi Code"].map((l,d)=>{let s=d===n,c=`${s?ll:dl} ${l}`;return`${s?sl:cl} ${s?e(c):c}`}),"","Enter: confirm  Up/Down: move  q/Esc: cancel"].join(`
`)}function Ll(n){let{input:t,output:r}=n;w2.emitKeypressEvents(t);let e=t.isRaw===!0;t.setRawMode(!0),t.resume();let a=0,l=()=>{if(a===0)return;w2.moveCursor(r,0,-a),w2.cursorTo(r,0),w2.clearScreenDown(r)},d=()=>{l();let s=n.render();r.write(`${s}
`),a=s.split(`
`).length};return new Promise((s)=>{let c=(i)=>{t.off("keypress",L),t.setRawMode(e),t.pause(),l(),s(i)};function L(i,u){n.onKey(i,u,{finish:c,draw:d})}t.on("keypress",L),d()})}function il(n={}){let t=0;return Ll({input:n.input??process.stdin,output:n.output??process.stdout,render:()=>Di(t,n.globalHookInstalled===!0),onKey:(r,e,a)=>{if(e.ctrl&&e.name==="c"){a.finish(null),(n.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(e.name==="escape"||r==="q")return a.finish(null);if(e.name==="return"||e.name==="enter")return a.finish(el[t]);if(e.name==="up"||e.name==="down"||r==="k"||r==="j")t=(t+1)%el.length,a.draw()}})}function te(n=process.stdin,t=process.stdout){return Boolean(n.isTTY&&t.isTTY&&typeof n.setRawMode==="function")}function pl(n,t,r={}){let e=r.output??process.stdout,a=xi(t);return Ll({input:r.input??process.stdin,output:e,render:()=>gi(n,t,a),onKey:(l,d,s)=>{let c=wi(n,l,d);if(!c)return;let L=$i(a,t,c);if(a=L.state,L.done==="interrupt"){s.finish(null),(r.onInterrupt??(()=>process.kill(process.pid,"SIGINT")))();return}if(L.done==="abort")return s.finish(null);if(L.done==="update")return s.finish("update");if(L.done==="confirm"){if(a.selected.length===0){e.write("\x07"),s.draw();return}s.finish([...a.selected]),e.write(`${fi(n)} selected integrations...
`);return}s.draw()}})}import{existsSync as vl,lstatSync as ol,mkdtempSync as ki,readFileSync as ft,rmSync as bl}from"node:fs";import{tmpdir as qi}from"node:os";import{dirname as ji,join as J2}from"node:path";import{fileURLToPath as zi}from"node:url";var re="// cc-safety-net managed Amp plugin. Do not edit. Reinstall with: npx -y cc-safety-net install --amp";import{spawn as mi}from"node:child_process";var ee=(n,t)=>{let r=y2([...n],process.env);return new Promise((e)=>{let a=mi(r.cmd,r.args,{cwd:t,stdio:["ignore","pipe","pipe"]}),l=Wr(a),d=!1,s=setTimeout(()=>{d=!0,a.kill()},120000);a.on("error",(c)=>{clearTimeout(s),e({status:null,errorCode:c.code,stdout:l.stdout,stderr:[c.message,l.stderr].filter(Boolean).join(`
`)})}),a.on("close",(c)=>{clearTimeout(s),e({status:d?null:c,errorCode:d?"ETIMEDOUT":void 0,stdout:l.stdout,stderr:l.stderr})})})};var ul=J2("amp","cc-safety-net.ts"),u2="cc-safety-net.ts";function Fi(n){return J2(n,".config","amp","plugins",u2)}function Bi(){let n=ji(zi(import.meta.url));return[J2(n,"..",ul),J2(n,"..","..","..","dist",ul)]}function Ji(n=Bi()){let t=n.find((r)=>vl(r)&&ol(r).isFile());if(!t)throw Error("Packaged Amp plugin artifact not found. Reinstall cc-safety-net and try again.");return t}function fl(n){try{return ol(n)}catch{return}}function yl(n){try{return JSON.parse(n)}catch{return}}function hl(n){return n.subarray(0,Buffer.byteLength(re)).toString("utf-8")===re}async function Qn(n,t,r){let e=await n(t,r);if(e.status===0)return e;throw Error([`Failed to run ${t.join(" ")}${e.status===null?"":` (exit ${e.status})`}.`,[e.stdout,e.stderr].filter(Boolean).join(`
`).trim()].filter(Boolean).join(`
`))}async function wl(n){let t=await n(["amp","plugins","repositories","--json"]);if(t.status===null)throw Error(`${t.errorCode==="ENOENT"?'Amp CLI not found. Install the amp CLI, sign in with "amp login", and rerun install --amp.':`amp plugins repositories --json did not finish (${t.errorCode??"terminated"}). Check that the amp CLI responds and rerun install --amp.`}
...
`)}`.trim());let r=yl(t.stdout),e=(Array.isArray(r)?r:[]).filter((a)=>$(a,"scope")==="user"&&$(a,"exists")===!0&&$(a,"viewerCanWrite")===!0).map((a)=>$(a,"cloneRef")).find((a)=>typeof a==="string"&&a.length>0);if(!e)throw Error('Your Amp account has no writable Personal Plugins repository. Sign in with "amp login", open Amp once to create it, and rerun install --amp.');return e}async function xl(n,t){let r=ki(J2(qi(),"cc-safety-net-amp-"));try{return await Qn(n,["amp","clone","user-plugins",r]),await t(r)}finally{bl(r,{recursive:!0,force:!0})}}function $l(n,t){let r=J2(n,u2),e=fl(r);if(!e)return;if(e.isSymbolicLink()||!e.isFile())throw Error(`Refusing to ${t} ${u2} in your Amp personal plugins repository: not a regular file. Remove it there and rerun install --amp.`);let a=ft(r);if(hl(a))return a;throw Error(`Refusing to ${t} unmanaged file ${u2} in your Amp personal plugins repository. Remove it there and rerun install --amp.`)}async function gl(n,t,r,e){if(await Qn(n,r,t),(await Qn(n,["git","status","--porcelain"],t)).stdout.trim()==="")return!1;return await Qn(n,["git","-c","commit.gpgsign=false","-c","user.name=cc-safety-net","-c","user.email=cc-safety-net@localhost","commit","-m",e],t),await Qn(n,["git","push","origin","HEAD"],t),!0}function ot(n,t){let r=Fi(n),e=fl(r);if(!e)return;if(!e.isSymbolicLink()&&e.isFile()&&hl(ft(r))){bl(r);return}if(t==="keep")return;throw Error(`Local Amp plugin ${r} is not a managed copy and masks the personal plugin. Remove it and rerun install --amp.`)}function Zi(){let n=yn();if(!vl(n))return"";let t=yl(ft(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))return"";return`;globalThis.__CC_SAFETY_NET_EMBEDDED_POLICY__ = ${JSON.stringify(bt(t))};
`}async function Dl(n,t=Ji(),r=ee){let e=Buffer.concat([ft(t),Buffer.from(Zi(),"utf-8")]),a=await wl(r);return xl(r,async(l)=>{let d=`${a}/${u2}`;if($l(l,"overwrite")?.equals(e))return ot(n,"fail"),{path:d,alreadyInstalled:!0};B(J2(l,u2),e);let s=await gl(r,l,["git","add",u2],`chore: update cc-safety-net plugin to v${j()}`);return ot(n,"fail"),{path:d,alreadyInstalled:!s}})}async function ml(n,t=ee){let r=await wl(t);return xl(t,async(e)=>{let a=`${r}/${u2}`;if(!$l(e,"remove"))return ot(n,"keep"),{path:a,alreadyInstalled:!1};return await gl(t,e,["git","rm",u2],`chore: remove cc-safety-net plugin v${j()}`),ot(n,"keep"),{path:a,alreadyInstalled:!0}})}import{existsSync as kl,mkdirSync as Qi,readFileSync as Xi}from"node:fs";import{dirname as Yi}from"node:path";var ae="npx -y cc-safety-net hook --agy-cli",x2="cc-safety-net";function ht(){return{PreToolUse:[{hooks:[{type:"command",command:ae,timeout:30}]}]}}function ql(n){try{let t=JSON.parse(Xi(n,"utf-8"));if(!t||typeof t!=="object"||Array.isArray(t))throw Error("Antigravity hooks config must be a JSON object");return t}catch(t){if(t instanceof SyntaxError)throw Error(`Failed to parse Antigravity hooks config ${n}: ${t.message}`);throw t}}function jl(n){let t=n[x2];if(t===void 0)return n[x2]=ht(),n[x2];if(!t||typeof t!=="object"||Array.isArray(t))throw Error(`Antigravity hooks config entry "${x2}" must be an object`);if(!Array.isArray(t.PreToolUse))t.PreToolUse=[];return t}function zl(n){if(!Array.isArray(n.PreToolUse))return!1;return n.PreToolUse.some((t)=>Array.isArray(t.hooks)&&t.hooks.some((r)=>r.command===ae))}function Si(n){return Object.values(n).some((t)=>t.enabled!==!1&&zl(t))}function Hi(n){if(n[x2]===void 0)return!1;let t=jl(n);if(t.enabled!==!1||!zl(t))return!1;return t.enabled=!0,!0}function Ai(n){if(n[x2]===void 0){n[x2]=ht();return}let t=jl(n);t.PreToolUse??=[],t.enabled=!0,t.PreToolUse.push(ht().PreToolUse?.[0]??{hooks:[]})}function Wi(n){let t=!1;for(let r of Object.values(n)){if(!Array.isArray(r.PreToolUse))continue;r.PreToolUse=r.PreToolUse.flatMap((e)=>{if(!Array.isArray(e.hooks))return[e];let a=e.hooks.filter((l)=>l.command!==ae);if(a.length!==e.hooks.length)t=!0;return a.length===0?[]:[{...e,hooks:a}]})}return t}function yt(n,t){B(n,`${JSON.stringify(t,null,2)}
`)}function Fl(n){let t=kn(n);if(Qi(Yi(t),{recursive:!0}),!kl(t))return yt(t,{[x2]:ht()}),{path:t,alreadyInstalled:!1};let r=ql(t);if(Si(r))return{path:t,alreadyInstalled:!0};if(Hi(r))return yt(t,r),{path:t,alreadyInstalled:!1};return Ai(r),yt(t,r),{path:t,alreadyInstalled:!1}}function Bl(n){let t=kn(n);if(!kl(t))return{path:t,alreadyInstalled:!1};let r=ql(t);if(!Wi(r))return{path:t,alreadyInstalled:!1};return yt(t,r),{path:t,alreadyInstalled:!0}}import{spawn as Ri,spawnSync as Ki}from"node:child_process";var U=L2.map((n)=>({target:n.id,flag:n.flag,label:n.installLabel,probeCommand:n.probeCommand})),Jl=new Map(U.map((n)=>[n.flag,n.target]));function le(n){let t=new Set(n);return U.map((r)=>r.target).filter((r)=>t.has(r))}async function Zl(n,t){for(let r of n)await t(r)}var Ql=5000;function Mi(n){let t=y2([...n],process.env),r=Ki(t.cmd,t.args,{env:process.env,stdio:"ignore",timeout:Ql});return!r.error&&r.status===0}function se(n){return new Promise((t)=>{let r=y2([...n],process.env),e=Ri(r.cmd,r.args,{env:process.env,stdio:"ignore"}),a=!1,l=(s)=>{if(a)return;a=!0,clearTimeout(d),t(s)},d=setTimeout(()=>{e.kill(),l(!1)},Ql);e.on("error",()=>l(!1)),e.on("close",(s)=>l(s===0))})}function Vi(n=Mi,t={}){let r=new Set(t.configuredTargets??[]);if(t.async)return Promise.all(U.map(async(a)=>({target:a.target,flag:a.flag,label:a.label,...de(t.action,await n(a.probeCommand),r.has(a.target))})));let e=n;return U.map((a)=>({target:a.target,flag:a.flag,label:a.label,...de(t.action,e(a.probeCommand),r.has(a.target))}))}function Xl(n=se,t={}){return Vi(n,{...t,async:!0})}function Yl(n,t){let r=new Set(t.configuredTargets??[]);return n.map((e)=>({...e,...de(t.action,e.available,r.has(e.target))}))}function de(n,t,r){if(n==="uninstall")return r?{available:!0}:{available:!1,unavailableReason:"not installed"};if(n==="install"&&r)return{available:!1,unavailableReason:"already installed"};if(!t)return{available:!1,unavailableReason:"CLI not installed"};return{available:!0}}import{existsSync as Sl,readdirSync as Gi,rmSync as Ui}from"node:fs";import{join as an}from"node:path";function wt(n,t=process.platform){let r=an(process.env.npm_config_cache||(t==="win32"?an(process.env.LOCALAPPDATA||an(n,"AppData","Local"),"npm-cache"):an(n,".npm")),"_npx");if(!Sl(r))return;Gi(r).filter((e)=>Sl(an(r,e,"node_modules","cc-safety-net"))).forEach((e)=>{Ui(an(r,e),{recursive:!0,force:!0})})}import{existsSync as Al,mkdirSync as Ci,readFileSync as Wl}from"node:fs";import{dirname as Ti,join as Hl}from"node:path";var Xn="npx -y cc-safety-net hook --kimi-code",ce=`[[hooks]]
event = "PreToolUse"
command = "${Xn}"`,Le=`{ event = "PreToolUse", command = "${Xn}" }`;function Rl(n){return Hl(process.env.KIMI_CODE_HOME??Hl(n,".kimi-code"),"config.toml")}function Oi(n){return n.split(`
...
`)}function _i(n,t){if(n[t]!=="#")return t;let r=n.indexOf(`
`,t+1);return r===-1?n.length:r+1}function Ei(n,t){return st(n,t,{skipComment:_i,stringError:"Unterminated string in Kimi Code config",bracketError:"Unmatched hooks array in Kimi Code config"})}function Kl(n){let t=!1,r=0;while(r<n.length){let e=n.indexOf(`
`,r),a=e===-1?n.length:e,l=n.slice(r,a);if(/^\s*\[/.test(l))t=!0;if(!t){let d=/^(\s*)hooks\s*=\s*\[/.exec(l);if(d){let s=r+d[0].lastIndexOf("[");return{start:s,end:Ei(n,s)}}}r=e===-1?n.length:e+1}return}function Pi(n,t){let r=n.slice(0,t.end).trimEnd(),e=Z0(n,t.end),a=e===""?"     ":`${e}  `,l=!r.endsWith("[")&&!r.endsWith(",");return`${r}${l?",":""}
${a}${Le}${n.slice(t.end)}`}function Ii(n){let t=Kl(n);if(t&&n.slice(t.start+1,t.end).trim())return Pi(n,t);let r=Oi(n).trimEnd();if(r==="")return`${ce}
`;return`${r}

${ce}
`}function Ni(n){return n.split(/(?=^\s*\[)/m).filter((r)=>!/^\s*\[\[hooks]]\s*$/m.test(r)||!r.includes(Xn)).join("").trimEnd()}function n5(n,t){let r=n.indexOf(Le,t.start);if(r===-1||r>t.end)return n;return ct(n,{start:r,end:r+Le.length})}function Ml(n){let t=Rl(n);if(Ci(Ti(t),{recursive:!0}),!Al(t))return B(t,`${ce}
`),{path:t,alreadyInstalled:!1};let r=Wl(t,"utf-8");if(r.includes(Xn))return{path:t,alreadyInstalled:!0};return B(t,Ii(r)),{path:t,alreadyInstalled:!1}}function Vl(n){let t=Rl(n);if(!Al(t))return{path:t,alreadyInstalled:!1};let r=Wl(t,"utf-8");if(!r.includes(Xn))return{path:t,alreadyInstalled:!1};let e=Kl(r),a=e?n5(r,e):`${Ni(r)}
`;return B(t,a),{path:t,alreadyInstalled:!0}}var pe="safety-net@cc-marketplace",Gl=new Set(["claude-code","codex","copilot-cli","gemini-cli","hermes-agent","openclaw","opencode","pi"]),Ul=new Set(["antigravity-cli","cursor","hermes-agent","kimi-code"]);function ve(n){return/^\s*safety-net@cc-marketplace[^a-z0-9-][^\n]*installed,/m.test(n??"")}function El(n){return/^\s*cc-safety-net[^a-z0-9-][^\n]*installed,/m.test(n??"")}function r5(n){return/^Marketplace `cc-marketplace`\s*$/m.test(n??"")}var Pl={"claude-code":{installCommands:(n)=>{let t=In(n,"cc-safety-net@cc-marketplace");return{commands:[...t?[["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","update","cc-safety-net@cc-marketplace"]]:[["claude","plugin","marketplace","add","kenryu42/cc-marketplace"],["claude","plugin","marketplace","update","cc-marketplace"],["claude","plugin","install","cc-safety-net@cc-marketplace"]],...gr(n).status==="disabled"?[["claude","plugin","enable","cc-safety-net@cc-marketplace"]]:[]],cleanupCommands:In(n,pe)?[["claude","plugin","uninstall",pe]]:[],update:t}},uninstallCommands:[["claude","plugin","uninstall","cc-safety-net@cc-marketplace"],["claude","plugin","marketplace","remove","cc-marketplace"]]},codex:{installCommands:async(n,t)=>{let r=t??await r2(["codex","plugin","list"]),e=El(r);return{commands:[e||r5(r)?["codex","plugin","marketplace","upgrade","cc-marketplace"]:["codex","plugin","marketplace","add","kenryu42/cc-marketplace"],["codex","plugin","add","cc-safety-net@cc-marketplace"]],cleanupCommands:ve(r)?[["codex","plugin","remove","safety-net@cc-marketplace"]]:[],update:e}},uninstallCommands:[["codex","plugin","remove","cc-safety-net@cc-marketplace"],["codex","plugin","marketplace","remove","cc-marketplace"]],postInstallMessage:"Start Codex, open `/hooks`, select the cc-safety-net PreToolUse hook, and press `t` to trust it."},"copilot-cli":{installCommands:async()=>{let n=await r2(["copilot","plugin","list"]),t=[...Ga(n)?[["copilot","plugin","uninstall","copilot-safety-net"]]:[],...Ua(n)?[["copilot","plugin","uninstall",Ka]]:[]];if(Ma(n))return{commands:[["copilot","plugin","marketplace","update","cc-marketplace"],["copilot","plugin","update",t2]],cleanupCommands:t,update:!0};return{commands:[Va(await r2(["copilot","plugin","marketplace","list"]))?["copilot","plugin","marketplace","update","cc-marketplace"]:["copilot","plugin","marketplace","add","kenryu42/cc-marketplace"],["copilot","plugin","install",t2]],cleanupCommands:t}},uninstallCommands:[["copilot","plugin","uninstall","cc-safety-net@cc-marketplace"],["copilot","plugin","marketplace","remove","cc-marketplace"]]},"gemini-cli":{installCommands:(n)=>{let t=Br(n);if(t.status==="configured")return{commands:[["gemini","extensions","update","gemini-safety-net"]],update:!0};if(t.status==="disabled")return{commands:[["gemini","extensions","update","gemini-safety-net"],["gemini","extensions","enable","gemini-safety-net"]],update:!0};return{commands:[["gemini","extensions","install","https://github.com/kenryu42/gemini-safety-net","--consent"]]}},uninstallCommands:[["gemini","extensions","uninstall","gemini-safety-net"]]},openclaw:{beforeInstall:Vr,installCommands:()=>({commands:m0()}),uninstallCommands:[["openclaw","plugins","uninstall",q,"--force"]],postInstallMessage:["Restart the OpenClaw Gateway to apply the change.","If plugins.allow is set in openclaw.json, it must also list cc-safety-net."].join(`
`)},opencode:{beforeInstall:Cr,installCommands:[["opencode","plugin","-g","-f","cc-safety-net@latest"]]},pi:{installCommands:[["pi","install","npm:cc-safety-net"]],uninstallCommands:[["pi","uninstall","npm:cc-safety-net"]]}};function gt(){return process.env.HOME??t5()}function Il(n,t=(r)=>r){try{let r=JSON.parse(t(_l(n,"utf-8")));if(!r||typeof r!=="object"||Array.isArray(r))throw Error(`Settings file ${n} must be a JSON object`);return r}catch(r){if(r instanceof SyntaxError)throw Error(`Failed to parse ${n}: ${r.message}`);throw r}}function e5(n){let t=ie(qn(n),"settings.json");if(!ue(t))return;let r=Il(t,R),e=r.enabledPlugins;if(!e||typeof e!=="object"||Array.isArray(e))return;if(e[t2]!==!1)return;let a=_l(t,"utf-8"),l=a.replace(new RegExp(`("${t2}"\\s*:\\s*)false`),"$1true");return e[t2]=!0,B(t,l!==a?l:`${JSON.stringify(r,null,2)}
`),`Enabled ${t2} plugin in ${t}`}function a5(n){let t=Tr(n);if(!ue(t))return;let r=Il(t);if(!Array.isArray(r.packages))return;let e=r.packages.find((a)=>!!a&&typeof a==="object"&&!Array.isArray(a)&&Or(a.source)&&("extensions"in a));if(!e)return;return delete e.extensions,B(t,`${JSON.stringify(r,null,2)}
`),`Enabled npm:cc-safety-net extensions in ${t}`}function Cl(n,t){let r=z({label:t,booleans:Object.fromEntries(U.map((l)=>[l.target,[l.flag]]))},n),e=r.errors[0];if(e)throw Error(e);let a=U.filter((l)=>r.flags[l.target]).map((l)=>l.target);if(a.length!==1)throw Error(`Choose exactly one ${t} target: ${[...Jl.keys()].join(", ")}`);return a[0]}async function Nl(n=gt(),t=P2){let[r,e,a]=await Promise.all([t(["amp","plugins","list"],30000),t(["codex","plugin","list"],30000),t(["copilot","--binary-version"])]);return{codexPluginListOutput:e,hooks:en(process.cwd(),{homeDir:n,ampPluginListOutput:r,codexPluginListOutput:e,copilotCliVersion:a})}}async function l5(n,t=P2){let r=await Nl(gt(),t);return r.hooks.filter((e)=>n==="install"?e.configured:e.detected||e.inspectionStatus==="not-inspected").filter((e)=>e.platform!=="codex"||!ve(r.codexPluginListOutput)||El(r.codexPluginListOutput)).map((e)=>e.platform)}function d5(n,t,r){if(t.length>0)return{finish:async()=>[Cl(t,n)]};if(!r.selectTargets&&!te(r.input,r.output))return{finish:async()=>[Cl(t,n)]};let e=r.detectConfiguredTargets??(()=>l5(n,r.fetchVersion)),a=Promise.all([Xl(r.probeTargets),e()]);return{ready:a,finish:async()=>{let[l,d]=await a,s=Yl(l,{action:n,configuredTargets:d}),c=r.selectTargets?await r.selectTargets(n,Ol(n,s)):await pl(n,Ol(n,s),{input:r.input,output:r.output});if(c==="update")return c;if(!c||c.length===0)return null;return le(c)}}}async function Z2(n,t,r=!1,e){let a=Pl[n];a.beforeInstall?.(t);let l=typeof a.installCommands==="function"?await a.installCommands(t,e):{commands:a.installCommands};return await Rr(l.commands),await h0(l.cleanupCommands??[]),[`${l.update||r?"Updated":"Installed"} ${f2(n)} integration`,a.postInstallMessage].filter(Boolean).join(`
`)}async function ln(n){let t=Pl[n];if(!t.uninstallCommands)throw Error(`${f2(n)} uninstall is not supported`);return await Rr(t.uninstallCommands),`Uninstalled ${f2(n)} integration`}function s5(n){let t=V0(n);return t.alreadyInstalled?`Uninstalled OpenCode plugin from ${t.path}`:`OpenCode plugin not installed in ${t.path}`}var c5={"antigravity-cli":{install:Fl,uninstall:Bl},cursor:{install:t0,uninstall:r0},"kimi-code":{install:Ml,uninstall:Vl}};function dn(n,t,r,e=!1){if(n==="install"&&!e)wt(r);let a=c5[t][n](r),l=f2(t),d=n!=="install"?"Uninstalled":e?"Updated":"Installed";return n==="install"&&a.alreadyInstalled?e?`${l} hook up to date in ${a.path}`:`${l} hook already installed in ${a.path}`:n==="uninstall"&&!a.alreadyInstalled?`${l} hook not installed in ${a.path}`:`${d} ${l} hook ${n==="install"?"in":"from"} ${a.path}`}var L5={amp:{install:Dl,uninstall:ml,restartNote:'Amp personal plugins apply to every Amp session, including Orb threads. Restart Amp or run "plugins: reload" to apply the change.'},"hermes-agent":{install:c0,uninstall:L0,afterInstall:async(n)=>{let t=Hr(n);return await r2(["hermes","plugins","enable",M,"--no-allow-tool-override"]),!t},beforeUninstall:async(n)=>{Sr(n);try{await r2(["hermes","plugins","disable",M])}catch(t){console.warn(`${t instanceof Error?t.message:String(t)}
Removing the plugin files anyway; ${M} may still be listed in the Hermes config.`)}},restartNote:"Restart Hermes to apply the change."}};async function xt(n,t,r,e=!1){let a=L5[t];if(n==="uninstall")await a.beforeUninstall?.(r);let l=n==="install"?await a.install(r):await a.uninstall(r),d=n==="install"&&await a.afterInstall?.(r),s=f2(t),c=!d&&(n==="install"&&l.alreadyInstalled||n==="uninstall"&&!l.alreadyInstalled);return[c?n==="install"?`${s} plugin ${e?"up to date":"already installed"} at ${l.path}`:`${s} plugin not installed at ${l.path}`:`${n!=="install"?"Uninstalled":e?"Updated":"Installed"} ${s} plugin ${n==="install"?"at":"from"} ${l.path}`,c?void 0:a.restartNote].filter(Boolean).join(`
`)}var i5={amp:{install:(n,t)=>xt("install","amp",n,t),uninstall:(n)=>xt("uninstall","amp",n)},"antigravity-cli":{install:(n,t)=>dn("install","antigravity-cli",n,t),uninstall:(n)=>dn("uninstall","antigravity-cli",n)},"claude-code":{install:(n,t)=>Z2("claude-code",n,t),uninstall:()=>ln("claude-code")},codex:{install:(n,t,r)=>Z2("codex",n,t,r),uninstall:()=>ln("codex")},"copilot-cli":{install:async(n,t)=>[await Z2("copilot-cli",n,t),e5(n)].filter(Boolean).join(`
`),uninstall:()=>ln("copilot-cli")},cursor:{install:(n,t)=>dn("install","cursor",n,t),uninstall:(n)=>dn("uninstall","cursor",n)},"gemini-cli":{install:(n,t)=>Z2("gemini-cli",n,t),uninstall:()=>ln("gemini-cli")},"hermes-agent":{install:(n,t)=>{if(!t)wt(n);return xt("install","hermes-agent",n,t)},uninstall:(n)=>xt("uninstall","hermes-agent",n)},"kimi-code":{install:(n,t)=>dn("install","kimi-code",n,t),uninstall:(n)=>dn("uninstall","kimi-code",n)},openclaw:{install:async(n,t)=>{let r=await Z2("openclaw",n,t);return await k0(),r},uninstall:(n)=>{return Vr(n),ln("openclaw")}},opencode:{install:async(n,t)=>{let r=await Z2("opencode",n,t);return await W0(n),r},uninstall:(n)=>s5(n)},pi:{install:async(n,t)=>[await Z2("pi",n,t),a5(n)].filter(Boolean).join(`
`),uninstall:()=>ln("pi")}},Tl=["Install CC Safety Net as a native Kimi Code plugin:","","  1. Start Kimi Code and run: /plugins install https://github.com/kenryu42/cc-safety-net","     Confirm the trust prompt; it defaults to cancel.","  2. Run /reload, or start a new session.","","Note: Kimi Code hooks are fail-open. When the hook process cannot start, crashes, or times","out, Kimi Code allows the tool call."].join(`
`);function p5(n){if(Fn({homeDir:n,cwd:process.cwd()}).status!=="configured")return Tl;return[Tl,"",b.red(["CAUTION: the global Kimi Code hook is installed and will run alongside the plugin.","After the plugin is active, remove it with: cc-safety-net uninstall --kimi-code"].join(`
`))].join(`
`)}function Ol(n,t){return t.map((r)=>n==="install"&&r.target==="kimi-code"&&r.unavailableReason==="already installed"?{...r,available:!0,unavailableReason:void 0,label:`${r.label} (global hook installed)`}:r)}function u5(n,t){if(n.selectKimiInstallMethod)return n.selectKimiInstallMethod();if(!te(n.input,n.output))return Promise.resolve("global-hook");return il({input:n.input,output:n.output,globalHookInstalled:Fn({homeDir:t,cwd:process.cwd()}).status==="configured"})}async function n3(n,t,r,e=!1,a){return i5[t][n](r,e,a)}function v5(n){let t=z({label:"update"},n).errors[0];if(t)throw Error(t)}async function o5(n,t=P2){let r=await Nl(n,t),e=ie(qn(n),"installed-plugins");return{targets:le([...r.hooks.filter((l)=>l.platform!=="copilot-cli"&&l.detected).map((l)=>l.platform),...[Nn,Ra,Wa].flatMap((l)=>ue(ie(e,...l))?["copilot-cli"]:[]),...In(n,pe)?["claude-code"]:[],...ve(r.codexPluginListOutput)?["codex"]:[]]),codexPluginListOutput:r.codexPluginListOutput}}async function b5(n){let t=gt(),r=n.output??process.stdout,e=o5(t,n.fetchVersion??P2).then(async(s)=>{let c=new Set(s.targets);return{targets:s.targets,codexPluginListOutput:s.codexPluginListOutput,available:new Map(await Promise.all(U.filter((L)=>c.has(L.target)&&Gl.has(L.target)).map(async(L)=>[L.target,await se(L.probeCommand)])))}}),a=await mn(n.showBanner??!0,()=>({ready:e,finish:()=>e}),()=>Dn({input:n.input??process.stdin,output:r}),{loadingMessage:"Checking installed integrations…",output:r});if(a.targets.length===0)return r.write("No installed integrations found. Run `cc-safety-net install` to set one up.\n"),0;let l=a.targets.some((s)=>Ul.has(s))?await Promise.resolve().then(()=>{return wt(t),null}).catch((s)=>$t(s)):null,d=await _n(Promise.all(a.targets.map((s)=>{if(Gl.has(s)&&!a.available.get(s))return Promise.resolve({message:`${f2(s)} not found; skipped`,failed:!1});if(l!==null&&Ul.has(s))return Promise.resolve({message:l,failed:!0});return n3("install",s,t,!0,a.codexPluginListOutput).then((c)=>({message:c,failed:!1}),(c)=>({message:$t(c),failed:!0}))})),{loadingMessage:`Updating ${a.targets.length} integration${a.targets.length===1?"":"s"}…`,output:r});return d.forEach((s)=>{s.failed?console.error(s.message):r.write(`${s.message}
`)}),d.some((s)=>s.failed)?1:0}function oe(n,t={}){return Promise.resolve().then(()=>v5(n)).then(()=>b5(t)).catch((r)=>{return console.error($t(r)),1})}async function Yn(n,t,r={}){try{let e=await mn(!0,()=>d5(n,t,r),()=>Dn({input:r.input??process.stdin,output:r.output??process.stdout}),{loadingMessage:n==="install"?"Checking available integrations…":"Checking installed integrations…",output:r.output??process.stdout});if(!e)return(r.output??process.stdout).write(`Cancelled: nothing was ${n}ed.
`),0;if(e==="update")return(r.runUpdate??(()=>oe([],{fetchVersion:r.fetchVersion,input:r.input,output:r.output,showBanner:!1})))();let a=gt(),l=r.output??process.stdout;return await Zl(e,async(d)=>{if(d==="kimi-code"&&n==="install"){let c=await u5(r,a);if(c===null){l.write(`Cancelled: Kimi Code integration was not installed.
`);return}if(c==="plugin"){l.write(`${p5(a)}
`);return}}let s=await _n(n3(n,d,a),{loadingMessage:`${n==="install"?"Installing":"Uninstalling"} ${f2(d)} integration…`,output:l});l.write(`${s}
`)}),0}catch(e){return console.error($t(e)),1}}function $t(n){let t=n instanceof Error?n.message:String(n),r=typeof n==="object"&&n!==null&&"code"in n?n.code:null;if(r==="EACCES"||r==="EPERM")return`${t}
...
Check that every parent path component is a directory.`;return t}import{join as N5}from"node:path";var t3="# Custom Rules Reference\n\nAgent reference for generating CC Safety Net rulebook configuration.\n\n## Config Locations\n\n| Scope | Config path | Rulebook path | Cache path | Priority |\n|-------|-------------|---------------|------------|----------|\n| User | `~/.cc-safety-net/rules/rule.json` | `~/.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `~/.cc-safety-net/cache/rulebooks/` | First |\n| Project | `.cc-safety-net/rules/rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` | `.cc-safety-net/cache/rulebooks/` | Second |\n| GitHub source | Listed in a local `rule.json` | `.cc-safety-net/rules/<rulebook-name>/rulebook.json` in the source repository | Consumer local cache | Source order |\n\nUser scope is evaluated before project scope; within a scope, sources apply in `rules` array order. A duplicate active rulebook name keeps the first claim and ignores the later rulebook with a warning, so a user-scoped name shadows a project-scoped one.\n\nUse `cc-safety-net rule init` to create an inert local config. Use `--global` for user scope. Use `cc-safety-net rule init --example` to also create an inactive example rulebook. `CC_SAFETY_NET_HOME` overrides the `~/.cc-safety-net` user root.\n\nLegacy inline `.safety-net.json` and `~/.cc-safety-net/config.json` files are not loaded at runtime. Convert them with `cc-safety-net rule migrate`.\n\n## rule.json Schema\n\n```json\n{\n  \"version\": 1,\n  \"rules\": [\"project-rules\", \"owner/repo#main/team-rules\"],\n  \"overrides\": {\n    \"project-rules/block-docker-system-prune\": {\n      \"reason\": \"Use targeted Docker cleanup commands.\"\n    },\n    \"team-rules/block-npm-global\": \"off\"\n  },\n  \"transparent_wrappers\": [\"rtk\"]\n}\n```\n\n- `version`: Required. Must be `1`.\n- `$schema`: Optional. `cc-safety-net rule verify` inserts it into a valid `rule.json` that lacks it.\n- `rules`: Optional array of rulebook source strings. Missing `rules` is treated as `[]`.\n- `overrides`: Optional object keyed by `<rulebook-name>/<rule-name>`.\n- `overrides` values are either `\"off\"` to disable a rule or an object with a required `reason` (replacement block reason) and an optional `intent` (one of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain`).\n- A project override cannot target a user-scoped rule: only that override is ignored, the user rule keeps its configured state, and `rule sync`/`rule verify` report the diagnostic as a failure.\n- `transparent_wrappers`: Optional array of command names that transparently execute a visible child command.\n- Transparent wrappers have no built-in defaults. Configure only wrappers you intentionally trust, such as `\"rtk\"`.\n- Use `cc-safety-net rule wrapper add rtk` to configure RTK without manually editing `rule.json`.\n\n## Rulebook Sources\n\n- Local sources are bare rulebook names such as `project-rules`; the rulebook file is `.cc-safety-net/rules/project-rules/rulebook.json`.\n- GitHub sources use `owner/repo#ref/<rulebook-name>`.\n- GitHub refs must be one path segment, such as a tag, SHA, or branch name without `/`.\n- The GitHub source name, the repository directory name, and the rulebook `name` must match exactly.\n- Rulebook source strings must be unique in a config.\n\n## rulebook.json Schema\n\n```json\n{\n  \"rulebook_version\": 1,\n  \"name\": \"project-rules\",\n  \"version\": \"1.0.0\",\n  \"description\": \"Project-specific CC Safety Net rules.\",\n  \"author\": \"project\",\n  \"allowed_commands\": [\"docker\"],\n  \"rules\": [\n    {\n      \"name\": \"block-docker-system-prune\",\n      \"command\": \"docker\",\n      \"subcommand\": \"system\",\n      \"block_args\": [\"prune\"],\n      \"reason\": \"Use targeted cleanup instead.\"\n    }\n  ],\n  \"tests\": [\n    {\n      \"command\": \"docker system prune\",\n      \"expect\": \"blocked\",\n      \"rule\": \"block-docker-system-prune\"\n    },\n    {\n      \"command\": \"docker ps\",\n      \"expect\": \"allowed\"\n    }\n  ]\n}\n```\n\n### Rulebook Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `rulebook_version` | Yes | Must be `1` |\n| `name` | Yes | `^[a-zA-Z][a-zA-Z0-9_-]{0,63}$` |\n| `version` | Yes | Non-empty string |\n| `description` | No | Free text; not type-checked at runtime |\n| `author` | No | Free text; not type-checked at runtime |\n| `allowed_commands` | Yes | Unique command names matching `^[a-zA-Z][a-zA-Z0-9_-]*$` |\n| `rules` | Yes | Array of rule objects |\n| `tests` | No | Array of fixtures |\n\n### Rule Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `name` | Yes | Unique within the rulebook (case-insensitive); same pattern as rulebook `name` |\n| `command` | Yes | Must be listed in `allowed_commands`; basename only, not path |\n| `subcommand` | No | Same pattern as `command`; omit to match any subcommand |\n| `intent` | No | One of `hard_stop`, `use_alternative`, `scope_down`, `manual_only`, `stop_and_explain` |\n| `block_args` | Yes | Non-empty array of non-empty strings |\n| `reason` | Yes | Non-empty string, max 256 chars |\n\n### Test Fixture Fields\n\n| Field | Required | Constraints |\n|-------|----------|-------------|\n| `command` | Yes | Non-empty shell command string |\n| `expect` | Yes | `\"blocked\"` or `\"allowed\"` |\n| `rule` | Required for blocked fixtures | Rule name expected to block the command |\n\nFixtures are optional documentation of intended behavior. Fixtures are shape-validated only; CC Safety Net does not execute them.\n\n## Matching Behavior\n\n- **Command**: Normalized to lowercase basename with any trailing `.exe` removed (`/usr/bin/git` → `git`).\n- **Subcommand**: The first command token after recognized Git and Docker global options and their values; `--` ends option parsing. An unrecognized option without `=` may consume the following token as its value.\n- **Arguments**: Each `block_args` value is compared literally against every command token, including expanded short options. The command is blocked if **any** item matches.\n- **Short options**: Expanded (`-Ap` matches `-A`).\n- **Long options**: Exact match (`--all-files` does not match `--all`).\n- **Execution order**: Built-in rules first, then custom rulebooks. Custom rules only add restrictions.\n- **Transparent wrappers**: A configured wrapper such as `rtk` lets `rtk git commit` be analyzed as `git commit` only when `git` is protected by built-in analyzers or active custom rules. `rtk -- git commit` is also supported.\n\n## Workflow\n\n1. Run `cc-safety-net rule init` or create `rule.json` manually.\n2. Optionally run `cc-safety-net rule init --example` to create an inactive example rulebook.\n3. Use `cc-safety-net rule wrapper add rtk` for trusted transparent wrappers.\n4. Run `cc-safety-net rule add <source>` after creating or choosing a rulebook source; it adds the source and syncs it.\n5. Run `cc-safety-net rule sync` after manual `rule.json` changes or local rulebook edits.\n6. Run `cc-safety-net rule verify` to validate config, lock/cache state, local rulebooks, and shareable GitHub-source rulebook directories in the current repository (it does not fetch remote content).\n7. Run `cc-safety-net rule list` to inspect active rulebooks and transparent wrappers.\n\nAn edited or invalid local rulebook keeps its last synced, digest-verified cached version enforced until `cc-safety-net rule sync` validates the edit. A missing lock entry or cache, a cache digest mismatch, or an invalid cached rulebook makes that source inactive; a missing lockfile or an unreadable or invalid `rule.json` makes every source in its scope inactive. Inactive sources stop applying their rules while other custom rules and all built-in protections stay active. Repair the reported condition, then run `cc-safety-net rule sync`. Run `cc-safety-net status` to see degraded sources.\n";function Sn(n,t){if(!n.ok){w5(n);return}x5(n),console.log(t),console.log("Rule config synced."),console.log(""),f5(n.entries)}function f5(n){if(n.length===0){console.log("Active rulebooks: (none)");return}console.log(`Active rulebooks (${n.length}):`);for(let t of n)console.log(`  - ${t.name} ${t.version} (${y5(t.ruleCount??0)})`),console.log(`    Source: ${Et(t)}`)}function y5(n){return`${n} ${n===1?"rule":"rules"}`}function e3(n,t){Q2("Active sources",n.rulebooks,(r)=>[`[${r.source}] ${r.name} ${r.version}`,`  Source: ${t[r.source].get(r.spec)??r.spec}`]),Q2("Active rules",n.rules,(r)=>[`[${h5(n,r.name)}] ${r.name}`,`  Command: ${r.subcommand?`${r.command} ${r.subcommand}`:r.command}`,`  Block args: ${r.block_args.join(", ")}`,`  Reason: ${r.reason}`]),Q2("Disabled rules",r3(n,"off"),(r)=>[r.key]),Q2("Reason overrides",r3(n,"reason"),(r)=>[r.key,`  Reason: ${r.value.reason}`]),Q2("Transparent wrappers",n.transparent_wrappers,(r)=>[r]),Q2("Issues",n.errors,(r)=>[r]),Q2("Warnings",n.warnings,(r)=>[r])}function Q2(n,t,r){if(t.length===0){console.log(`${n}: (none)`);return}console.log(`${n} (${t.length}):`);for(let e of t){let[a,...l]=r(e);console.log(`  - ${a}`);for(let d of l)console.log(`    ${d}`)}}function h5(n,t){return n.rulebooks.find((r)=>r.rules.includes(t))?.source??"project"}function r3(n,t){return Object.entries({...n.userConfig?.overrides??{},...n.projectConfig?.overrides??{}}).filter((r)=>{if(t==="off")return r[1]==="off";return!!r[1]&&typeof r[1]==="object"}).map(([r,e])=>({key:r,value:e}))}function w5(n){for(let t of n.errors)console.error(t)}function x5(n){if(!n.warnings||n.warnings.length===0)return;for(let t of n.warnings)console.warn(t)}import{dirname as a3,join as Dt}from"node:path";var $5=".safety-net.json",g5="~/.cc-safety-net/config.json";async function s3(n){return[await l3({legacyPath:d3({cwd:n.cwd}),configPath:_(n.cwd),defaultRulebookName:"project-rules",migratedFrom:$5,cleanup:n.cleanup,syncOptions:{cwd:n.cwd}}),await l3({legacyPath:vn(),configPath:E(),defaultRulebookName:"user-rules",migratedFrom:g5,cleanup:n.cleanup,syncOptions:{cwd:n.cwd,global:!0}})].every((r)=>r)?0:1}async function l3(n){let t=C(n.syncOptions),r=D(t.filesystemScope,n.legacyPath),e=g(r);if(e===null)return console.log(`No legacy config found at ${n.legacyPath}`),!0;let a=m5(e);if(!a.ok){for(let o of a.errors)console.error(o);return!1}let l=T(t.configTarget);if(l.errors.length>0){for(let o of l.errors)console.error(o);return!1}let d=l.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},s=k5(a3(n.configPath),d.rules,n.defaultRulebookName,n.migratedFrom,t.filesystemScope),c=Dt(a3(n.configPath),s,"rulebook.json"),L=D(t.filesystemScope,c),i=[be(t.configTarget),be(L),be(t.lockTarget)],u=await D5(n,t.configTarget,L,s,a.config.rules,d.rules.includes(s)?d.rules:[...d.rules,s],d.overrides??{},d.transparent_wrappers??[]);if(!u.ok){z5(i);for(let o of u.errors)console.error(o);return!1}if(!n.cleanup)return console.log(`Migrated legacy config at ${n.legacyPath}. Legacy file is no longer used.`),!0;if(!j5(t.configTarget,L,s,n.migratedFrom,a.config.rules))return console.error(`Migration cleanup verification failed for ${n.legacyPath}`),!1;return pn(r),console.log(`Deleted legacy config at ${n.legacyPath}`),!0}async function D5(n,t,r,e,a,l,d,s){try{return O(t,{version:1,rules:l,overrides:d,transparent_wrappers:s}),O(r,q5(e,n.migratedFrom,a)),await K2(n.syncOptions)}catch(c){return{ok:!1,errors:[c instanceof Error?c.message:String(c)]}}}function m5(n){try{let t=JSON.parse(n),r=Ht(t);if(r.errors.length>0)return{ok:!1,errors:r.errors};return{ok:!0,config:{version:1,rules:t.rules??[]}}}catch{return{ok:!1,errors:["Invalid JSON"]}}}function k5(n,t,r,e,a){let l=t.find((d)=>F5(D(a,Dt(n,d,"rulebook.json")))===e);if(l)return l;if(g(D(a,Dt(n,r,"rulebook.json")))===null)return r;for(let d=2;;d++){let s=`${r}-${d}`;if(g(D(a,Dt(n,s,"rulebook.json")))===null)return s}}function q5(n,t,r){return{rulebook_version:1,name:n,version:"1.0.0",description:"Migrated CC Safety Net rules.",author:"project",migrated_from:t,allowed_commands:[...new Set(r.map((e)=>e.command))],rules:r,tests:r.map((e)=>({command:[e.command,e.subcommand,e.block_args[0]].filter(Boolean).join(" "),expect:"blocked",rule:e.name}))}}function j5(n,t,r,e,a){if(!T(n).config?.rules.includes(r))return!1;try{let d=g(t);if(d===null)return!1;let s=JSON.parse(d);return s.migrated_from===e&&JSON.stringify(s.rules)===JSON.stringify(a)}catch{return!1}}function be(n){return{target:n,content:g(n)}}function z5(n){for(let t of n){if(t.content===null){pn(t.target);continue}$2(t.target,t.content)}}function F5(n){let t=g(n);if(t===null)return null;try{let r=JSON.parse(t);return typeof r.migrated_from==="string"?r.migrated_from:null}catch{return null}}import{mkdir as B5,readFile as J5,writeFile as Z5}from"node:fs/promises";import{dirname as Q5,join as X5}from"node:path";var Y5=86400000,S5=604800000;async function L3(n=Date.now()){if(process.env.CC_SAFETY_NET_NO_UPDATE_CHECK)return null;let t=Nt();if(!t)return null;let r=X5(t,".cc-safety-net","update-check.json"),e=await H5(r,n);if(!e.lastCheck||n-e.lastCheck>Y5){let d=await I2();if(e.lastCheck=n,d.latestVersion)e.latestVersion=d.latestVersion;if(!await c3(r,e))return null;if(d.error)return null}let a=e.latestVersion,l=j();if(!a||!yr(a,l))return null;if(e.notifiedVersion===a&&e.notifiedAt!==void 0&&n-e.notifiedAt<S5)return null;if(e.notifiedVersion=a,e.notifiedAt=n,!await c3(r,e))return null;return`UPDATE_AVAILABLE: cc-safety-net v${a} is available (running v${l}). Ask the user once whether to run \`npx -y cc-safety-net@latest update\`; continue the current task either way and do not raise this again.`}async function H5(n,t){let r=await J5(n,"utf8").then((l)=>JSON.parse(l)).catch(()=>{return});if(!r||typeof r!=="object"||Array.isArray(r))return{};let e=r,a=(l)=>typeof l==="number"&&Number.isFinite(l)&&l<=t?l:void 0;return{lastCheck:a(e.lastCheck),latestVersion:typeof e.latestVersion==="string"?e.latestVersion:void 0,notifiedVersion:typeof e.notifiedVersion==="string"?e.notifiedVersion:void 0,notifiedAt:a(e.notifiedAt)}}async function c3(n,t){return B5(Q5(n),{recursive:!0,mode:448}).then(()=>Z5(n,JSON.stringify(t),{mode:384})).then(()=>!0).catch(()=>!1)}import{dirname as A5,join as W5,resolve as fe}from"node:path";var p3="CC Safety Net Config",R5="═".repeat(p3.length),K5="https://raw.githubusercontent.com/kenryu42/cc-safety-net/main/assets/cc-safety-net.schema.json",M5=new Set(["rule.json","rule.lock","cache"]);function u3(n={}){try{return V5(n)}catch(t){if(t instanceof Q)return console.error(t.message),1;throw t}}function V5(n){let t=n.cwd??process.cwd(),r=n.userConfigPath??E(),e=n.projectConfigPath??_(t),a=n.legacyUserConfigPath??vn(),l=n.legacyProjectConfigPath??We(t),d=fe(t,_t),s=A5(r),c=P({cwd:t,userConfigPath:r,projectConfigPath:e}),L=P({cwd:t}),i=D(c.userScope,r),u=D(c.projectScope,e),o=n.legacyUserConfigPath?Ln(n.legacyUserConfigPath,"user policy"):D(L.userScope,a),p=n.legacyProjectConfigPath?Ln(n.legacyProjectConfigPath,"project policy"):D(L.projectScope,l),f=!1,v=!1,y=[],x=[],w=G5(D(L.projectScope,d));if(C5(),g(i)!==null){let h=a2(i);if(h.errors.push(...l2(r,M2({userConfigDir:s}),{userConfigDir:s},c.userScope)),y.push({scope:"User",path:r,result:h,schema:"rules",sourceDisplayMap:g2(r,c.userScope),target:i}),h.errors.length>0)f=!0}if(g(o)!==null)if(v=!0,g(i)!==null)x.push(mt("user","cleanup"));else{let h=At(o);if(y.push({scope:"User",path:a,result:h,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:o}),x.push(mt("user",h.errors.length>0?"fix-or-delete":"migrate")),h.errors.length>0)f=!0}if(g(u)!==null){let h=a2(u);if(h.errors.push(...l2(e,V2(e),{userConfigDir:s},c.projectScope)),y.push({scope:"Project",path:fe(e),result:h,schema:"rules",sourceDisplayMap:g2(e,c.projectScope),target:u}),h.errors.length>0)f=!0;if(g(p)!==null)v=!0,x.push(mt("project","cleanup"))}else if(g(p)!==null){v=!0,f=!0;let h=At(p);y.push({scope:"Project",path:fe(l),result:h,schema:"legacy",sourceDisplayMap:new Map,inactive:!0,target:p}),x.push(mt("project",h.errors.length>0?"fix-or-delete":"migrate"))}if(w?.result.errors.length)f=!0;if(y.length===0&&!w)return console.log(`
No config files found. Using built-in rules only.`),0;for(let h of y)if(h.inactive)O5(h.scope,h.path,h.result,h.sourceDisplayMap);else if(h.result.errors.length>0)_5(h.scope,h.path,h.result.errors);else{if(h.schema==="rules"&&I5(h.target))console.log(`
Added $schema to ${h.scope.toLowerCase()} config.`);T5(h.scope,h.path,h.result,h.schema,h.sourceDisplayMap)}for(let h of x)console.error(`
${b.red(h)}`);if(w)if(w.result.errors.length>0)P5(w.path,w.result.errors);else E5(w.path,w.result);if(f)return console.error(`
Config validation failed.`),1;return console.log(v?`
Configs valid with warnings.`:`
All configs valid.`),0}function mt(n,t){let r=`legacy ${n} config`;if(t==="cleanup")return`Warning: Legacy ${n} config is no longer needed. Run \`npx -y cc-safety-net rule migrate --cleanup\` to clean it up safely.`;if(t==="migrate")return`Warning: Legacy ${n} config is ignored by CC Safety Net. Run \`npx -y cc-safety-net rule migrate\`.`;return`Warning: Legacy ${n} config is no longer supported. Fix or delete the ${r}, then run \`npx -y cc-safety-net rule migrate\`.`}function G5(n){if(R2(n)===null)return null;let t=U5(n);if(t.ruleNames.size===0&&t.errors.length===0)return null;return{path:n.path,result:t}}function U5(n){let t=[],r=new Set,e=(R2(n)??[]).filter((a)=>!M5.has(a.name)).sort((a,l)=>a.name.localeCompare(l.name));if(e.length===0)return{errors:t,ruleNames:r};for(let a of e){if(!un.test(a.name)){t.push(`rulebook directory names must match ${un}: ${a.name}`);continue}if(a.kind!=="directory"){t.push(`${a.name} must be a rulebook directory`);continue}let l=D(n.scope,W5(n.path,a.name,"rulebook.json")),d=g(l);if(d===null){t.push(`${a.name}/rulebook.json is required`);continue}try{let s;try{s=JSON.parse(d)}catch{t.push(`${a.name}/rulebook.json: invalid JSON`);continue}let c=i3(s);if(c.name!==a.name){t.push(`rulebook name "${c.name}" must match folder "${a.name}"`);continue}r.add(a.name)}catch(s){t.push(s instanceof Error?`${a.name}/rulebook.json: ${s.message}`:`${a.name}/rulebook.json: ${String(s)}`)}}return{errors:t,ruleNames:r}}function C5(){console.log(p3),console.log(R5)}function T5(n,t,r,e,a){if(console.log(`
✓ ${n} config: ${t}`),console.log(`  Schema: ${e==="rules"?"rulebook sources":"legacy inline rules"}`),r.ruleNames.size>0){console.log(`  ${e==="rules"?"Sources":"Rules"}:`);let l=1;for(let d of r.ruleNames)console.log(`    ${l}. ${a.get(d)??d}`),l++}else console.log(`  ${e==="rules"?"Sources":"Rules"}: (none)`)}function O5(n,t,r,e){if(console.error(`
✗ Legacy ${n.toLowerCase()} config: ${t}`),console.error("  Schema: legacy inline rules"),console.error("  Status: ignored by CC Safety Net"),r.errors.length>0){console.error("  Errors:");let a=1;for(let l of r.errors)for(let d of l.split("; "))console.error(`    ${a}. ${d}`),a++;return}if(r.ruleNames.size>0){console.error("  Rules:");let a=1;for(let l of r.ruleNames)console.error(`    ${a}. ${e.get(l)??l}`),a++;return}console.error("  Rules: (none)")}function _5(n,t,r){v3(`${n} config`,t,r)}function E5(n,t){console.log(`
✓ GitHub source rules: ${n}`),console.log("  Rulebooks:");let r=1;for(let e of t.ruleNames)console.log(`    ${r}. ${e}`),r++}function P5(n,t){v3("GitHub source rules",n,t)}function v3(n,t,r){console.error(`
✗ ${n}: ${t}`),console.error("  Errors:");let e=1;for(let a of r)for(let l of a.split("; "))console.error(`    ${e}. ${l}`),e++}function I5(n){try{let t=g(n);if(t===null)return!1;let r=JSON.parse(t);if(r.$schema)return!1;return $2(n,JSON.stringify({$schema:K5,...r},null,2)),!0}catch(t){if(t instanceof Q)throw t;return!1}}var o3=new Set(["init","add","remove","update","sync","list","wrapper","migrate","doc","verify"]),n8=new Set(["add","remove","list"]);async function f3(n){try{return await t8(n)}catch(t){if(t instanceof Q)return console.error(t.message),1;throw t}}async function t8(n){let t=e8(n),r=t.help?r8(t.positionals):null;if(r)return vt(r),0;if(t.errors.length>0){for(let d of t.errors)console.error(d);return 1}let e=t.positionals[0];if(!e)return vt(E2,console.error),1;let a=t.positionals[1],l={global:t.global,check:t.check};if(e==="init"){let d=C(l),s=d.configDir;d8(d.configTarget),b3(D(d.filesystemScope,Rn({...l,cacheConfigDir:s})));let c=N5(s,"example-rules","rulebook.json"),L=D(d.filesystemScope,c);if(t.example&&g(L)===null)It(L,"example-rules");let i=await K2(l);return Sn(i,"Rule config initialized."),i.ok?0:1}if(e==="add"){if(!a)return console.error("rule add requires a source"),1;let d=await Ct(a,l);return Sn(d,`Added rulebook source: ${a}`),d.ok?0:1}if(e==="remove"){if(!a)return console.error("rule remove requires a source"),1;let d=await Ot(a,{...l,deleteSource:t.deleteSource});return Sn(d,`Removed rulebook source: ${a}`),d.ok?0:1}if(e==="update"||e==="sync"){let d=await K2({...l,only:e==="update"?a:void 0});return Sn(d,t.check?"Rule config checked.":"Rule config synced."),d.ok?0:1}if(e==="list"){let d=o2(),s=P({});return e3(d,{user:g2(d.userConfigPath,s.userScope),project:g2(d.projectConfigPath,s.projectScope)}),d.errors.length>0?1:0}if(e==="wrapper")return s8(t);if(e==="migrate")return s3({cleanup:t.cleanup,cwd:process.cwd()});if(e==="doc"){console.log(t3);let d=await L3();if(d)console.error(d);return 0}if(e==="verify")return u3();return 1}function r8(n){if(n.length===0)return E2;let t=E2.subcommands.filter((e)=>e.usage.split(" ")[0]===n[0]);if(t.length===0)return null;if(n.length===1&&t.length>1)return{name:`rule ${n[0]}`,description:`Subcommands of rule ${n[0]}`,usage:`rule ${n[0]} <subcommand>`,subcommands:t,options:[]};let r=n.length===1?t[0]:t.find((e)=>e.usage.split(" ")[1]===n[1]);if(!r)return null;return{name:`rule ${n[0]}`,description:r.description,usage:`rule ${r.usage}`,options:[]}}function e8(n){let t=z({label:"rule",booleans:{global:["-g","--global"],check:["--check"],cleanup:["--cleanup"],deleteSource:["--delete-source"],example:["--example"]},positionals:"list"},n),r={...t.flags,help:t.help,positionals:t.positionals,errors:t.errors};return a8(r),r}function a8(n){let[t]=n.positionals;if(t&&!o3.has(t))n.errors.push(`Unknown rule subcommand: ${t}`);if(n.deleteSource&&t!=="remove")if(t&&o3.has(t))n.errors.push(`Unknown option for rule ${t}: --delete-source`);else n.errors.push("--delete-source is only valid with 'rule remove'");if(n.cleanup&&t!=="migrate")n.errors.push(kt(t,"--cleanup"));if(n.example&&t!=="init")n.errors.push(kt(t,"--example"));if(t==="migrate"){if(n.global)n.errors.push(kt(t,"--global"));if(n.check)n.errors.push(kt(t,"--check"));if(n.positionals.length>1)n.errors.push(`Unexpected rule migrate argument: ${n.positionals[1]}`)}else if(t==="wrapper")l8(n);else if(n.positionals.length>2)n.errors.push(`Unexpected rule argument: ${n.positionals[2]}`);if(t==="list"&&n.global)n.errors.push("Unknown option for rule list: --global")}function kt(n,t){return n?`Unknown option for rule ${n}: ${t}`:`Unknown option for rule: ${t}`}function l8(n){let t=n.positionals[1],r=n.positionals[2];if(!t){n.errors.push("rule wrapper requires add, remove, or list");return}if(!n8.has(t)){n.errors.push(`Unknown rule wrapper action: ${t}`);return}if(t==="list"){if(r)n.errors.push(`Unexpected rule wrapper argument: ${r}`);return}if(!r){n.errors.push(`rule wrapper ${t} requires a command`);return}if(n.positionals.length>3)n.errors.push(`Unexpected rule wrapper argument: ${n.positionals[3]}`)}function d8(n){if(g(n)===null){Pt(n);return}let t=T(n);if(!t.config)return;O(n,{version:1,rules:t.config.rules,overrides:t.config.overrides??{},transparent_wrappers:t.config.transparent_wrappers??[]})}async function s8(n){let t=n.positionals[1],r=n.positionals[2],e=C({global:n.global}).configTarget;if(t==="list"){let s=T(e);if(s.errors.length>0){for(let c of s.errors)console.error(c);return 1}return c8(s.config?.transparent_wrappers??[]),0}if(!r||!nr.test(r))return console.error("transparent wrapper must match command pattern"),1;if(tr(r))return console.error(`reserved command "${r}" cannot be a wrapper`),1;let a=T(e);if(a.errors.length>0){for(let s of a.errors)console.error(s);return 1}let l=a.config??{version:1,rules:[],overrides:{},transparent_wrappers:[]},d=t==="add"?[...new Set([...l.transparent_wrappers??[],r])]:(l.transparent_wrappers??[]).filter((s)=>s!==r);return O(e,{version:1,rules:l.rules,overrides:l.overrides??{},transparent_wrappers:d}),console.log(t==="add"?`Added transparent wrapper: ${r}`:`Removed transparent wrapper: ${r}`),0}function c8(n){if(n.length===0){console.log("Transparent wrappers: (none)");return}console.log(`Transparent wrappers (${n.length}):`);for(let t of n)console.log(`  - ${t}`)}import{homedir as y3}from"node:os";import{existsSync as L8,readFileSync as i8}from"node:fs";import{homedir as p8}from"node:os";import{join as u8}from"node:path";async function v8(n){if(n.isTTY)return null;return(await cr(n).catch(()=>null))?.trim()||null}function o8(){if(process.env.CLAUDE_SETTINGS_PATH)return process.env.CLAUDE_SETTINGS_PATH;return u8(p8(),".claude","settings.json")}function ye(){let n=o8();if(!L8(n))return!1;try{let t=i8(n,"utf-8"),r=JSON.parse(t);if(!r.enabledPlugins)return!1;let e="cc-safety-net@cc-marketplace";if(!(e in r.enabledPlugins))return!1;return r.enabledPlugins[e]===!0}catch(t){if(fn(m.debug))console.error(`CC Safety Net debug: failed to read Claude settings: ${n}: ${t instanceof Error?t.message:String(t)}`);return!1}}async function he(n=process.stdin){let t=ye(),r;if(!t)r="\uD83D\uDEE1️ CC Safety Net ❌";else{let a=W({cwd:process.cwd()}),l=a.policy,d=d2(l),s=Object.values(m2(l,d.capabilities)).some((L)=>L.changesInherited);r=`\uD83D\uDEE1️ CC Safety Net ${{standard:"✅",strict:"\uD83D\uDD12",paranoid:"\uD83D\uDC41️",custom:"\uD83D\uDD27"}[s?"custom":d.effectiveLevel]}${d.worktreeMode?"\uD83C\uDF33":""}${a.state==="degraded"?"⚠️":""}`}let e=await v8(n);if(e&&!e.startsWith("{"))console.log(`${e} | ${r}`);else console.log(r)}function h3(){let n=W({cwd:process.cwd()}),t=n.policy,r=d2(t),e=!!process.env.NO_COLOR||!process.stdout.isTTY,a=Math.min(process.stdout.columns||80,100),l=e?"ok":"✔",d=e?"OFF":"✘",s=(p,f)=>{let v=`  ${p.padEnd(13)}${f}`;return(v.length>a?`${v.slice(0,a-1)}…`:v).replaceAll(d,b.red(d))},c=Object.values(m2(t,r.capabilities)).some((p)=>p.changesInherited),L=yn(),i={ready:b.green,degraded:b.yellow}[n.state],u=[...ye()?[]:["plugin cc-safety-net@cc-marketplace is disabled in Claude Code; nothing is enforced in Claude Code until it is re-enabled. Other integrations are not affected."],...n.diagnostics],o=e?"-":"·";console.log([`${e?"":"\uD83D\uDEE1️  "}CC Safety Net — ${i(n.state)}`,"",s("Protection",`destructive ${t.destructiveCommandProtectionEnabled?l:d}   secrets ${t.secretProtection.enabled?l:d}`),s("Level",c?`${r.effectiveLevel} (customised)`:r.effectiveLevel),s("Rules",t.rules.length===0?"none active":`${t.rules.length} active`),s("Policy",L.startsWith(y3())?`~${L.slice(y3().length)}`:L),...r.worktreeMode?[s("Worktree","relaxations active")]:[],"",...u.length===0?["  Everything configured is active."]:["  Not active",...u.flatMap((p)=>ut(p,"      ",a-6).map((f,v)=>v===0?`    ${o} ${f}`:f)),"","  Full report: cc-safety-net doctor"]].join(`
`))}import{spawn as H3}from"node:child_process";import{randomBytes as k8}from"node:crypto";import{createServer as q8}from"node:http";import{Writable as j8}from"node:stream";import{homedir as b8}from"node:os";var qt=500;function f8(n){let t=n.filter((a)=>a.decision!=="allow"),r=n.filter((a)=>a.decision==="allow"),e=Math.min(t.length,Math.max(qt-r.length,Math.ceil(qt/2)));return[...t.slice(0,e),...r.slice(0,qt-e)]}function w3(n,t=s2()){if(t)D2(t);let r=(v)=>new Date(v.getFullYear(),v.getMonth(),v.getDate()).getTime(),e=r(new Date),a=new Date(e);a.setDate(a.getDate()-(n-1));let l=a.getTime(),d=[],s={count:0};for(let v of t?v2(t,s):[])for(let y of cn(v,s)){if(!y||typeof y.ts!=="string"||typeof y.command!=="string")continue;let x=new Date(y.ts).getTime();if(!Number.isFinite(x))continue;if(x>=l)d.push(y)}d.sort((v,y)=>new Date(y.ts).getTime()-new Date(v.ts).getTime());let c=Array.from({length:n},()=>0),L=Array.from({length:n},()=>0),i={},u={},o={},p=0,f=0;for(let v of d){let y=v.agent||"unknown";i[y]=(i[y]??0)+1;let x=Math.round((e-r(new Date(v.ts)))/86400000),w=n-1-x,h=x>=0&&x<n;if(h)L[w]=(L[w]??0)+1;if(v.decision!=="allow"){if(p++,v.ruleId)u[v.ruleId]=(u[v.ruleId]??0)+1;let J=Y2(v.segment||v.command);if(J)o[J]=(o[J]??0)+1;if(v.failureStage)f++;if(h)c[w]=(c[w]??0)+1}}return{days:n,logsDir:t,homeDir:b8(),totalInWindow:d.length,truncated:d.length>qt,unreadable:s.count,counts:{blocked:p,allowed:d.length-p,agents:i,blockedByDay:c,analyzedByDay:L,rules:u,commands:o,errors:f},entries:f8(d).sort((v,y)=>new Date(y.ts).getTime()-new Date(v.ts).getTime())}}import{spawn as y8}from"node:child_process";import{existsSync as x3,statSync as h8}from"node:fs";import{delimiter as w8,join as x8}from"node:path";var $8=120000,jt="Choose the project folder",g8=`try
...
if ($dialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { [Console]::Out.Write($dialog.SelectedPath) }`,$3=[{binary:"zenity",args:["--file-selection","--directory",`--title=${jt}`]},{binary:"kdialog",args:["--getexistingdirectory",".","--title",jt]}],g3=(n,t)=>(t.PATH??"").split(w8).some((r)=>r.length>0&&x3(x8(r,n)));function D3(n,t){if(n==="darwin"||n==="win32")return!0;if(n!=="linux")return!1;if(!t.DISPLAY&&!t.WAYLAND_DISPLAY)return!1;return $3.some((r)=>g3(r.binary,t))}function m8(n,t){if(n==="darwin")return{cmd:"osascript",args:["-e",g8]};if(n==="win32")return{cmd:"powershell.exe",args:["-NoProfile","-STA","-Command",D8]};let r=$3.find((e)=>g3(e.binary,t));return r?{cmd:r.binary,args:r.args}:null}function m3(n=process.platform,t=process.env){let r=m8(n,t);if(!r)return Promise.resolve({error:"No folder dialog is available on this system"});return new Promise((e)=>{let a=y8(r.cmd,r.args,{env:t,stdio:["ignore","pipe","pipe"]}),l="",d=!1,s=(L)=>{if(d)return;d=!0,clearTimeout(c),e(L)},c=setTimeout(()=>{a.kill(),s({error:"The folder dialog timed out"})},$8);a.stdout.on("data",(L)=>{l+=L.toString()}),a.on("error",()=>s({error:`Could not open the folder dialog (${r.cmd})`})),a.on("close",()=>{let L=l.trim().replace(/\/+$/,"");if(!L)return s({cancelled:!0});if(!x3(L)||!h8(L).isDirectory())return s({error:"That selection is not a folder on disk"});s({path:L})})})}var k3=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
`;var q3='<script id="ccsn-data" type="application/json">';function j3(n){return k3.replace(q3,()=>q3+JSON.stringify({token:n}).replaceAll("<","\\u003c"))}var Ft="kenryu42/cc-safety-net",z8=`https://github.com/${Ft}`,$e=1e4,F8=7;async function A3(n,t={}){let r=z({label:"gui",booleans:{noOpen:["--no-open"]}},n),e=t.log??console.log,a=t.error??console.error;if(r.errors.length>0){for(let d of r.errors)a(d);return a("Usage: cc-safety-net gui [--no-open]"),1}let l=await B8(t);if(e(`CC Safety Net policy GUI: ${l.url}`),!r.flags.noOpen)try{await(t.openBrowser??A8)(l.url)}catch(d){a(`Failed to open browser: ${d instanceof Error?d.message:String(d)}`),a(`Open this URL manually: ${l.url}`)}if(t.keepAlive===!1)return await l.close(),0;return await H8(l),0}async function B8(n={}){let t=n.token??k8(24).toString("base64url"),r=q8((l,d)=>{J8(l,d,t,n)});await new Promise((l,d)=>{r.once("error",d),r.listen(0,"127.0.0.1",()=>{r.off("error",d),l()})});let a=`http://127.0.0.1:${r.address().port}`;return{origin:a,token:t,url:`${a}/?token=${encodeURIComponent(t)}`,close:()=>S8(r)}}async function J8(n,t,r,e){let a=new URL(n.url??"/","http://127.0.0.1");if(n.method==="GET"&&a.pathname==="/favicon.ico"){t.writeHead(204,{"cache-control":"no-store"}),t.end();return}if(!X8(n,a,r)){k(t,403,{error:"Forbidden"});return}if(n.method==="GET"&&a.pathname==="/"){Y8(t,j3(r));return}if(n.method==="GET"&&a.pathname==="/api/policy"){let l=J3(e);k(t,200,{...l,configState:hn(W(e)),destructiveCommandRules:on,secretPatterns:F3,version:j(),preview:l.errors.length>0?null:Q3(l.policy)});return}if(n.method==="POST"&&a.pathname==="/api/policy/preview"){let l=await zt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=Z3(l.value);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/policy/explain"){let l=await zt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value;if(d===null||typeof d.command!=="string"){k(t,400,{errors:["command must be a string"]});return}let s=lr(d.policy);if(s.length>0){k(t,400,{errors:s});return}k(t,200,Z8(d.command,d.policy,e));return}if(n.method==="POST"&&a.pathname==="/api/policy"){let l=await zt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=we(l.value,e);k(t,d.errors.length>0?400:200,d);return}if(n.method==="POST"&&a.pathname==="/api/reset"){k(t,200,we(B3,e));return}if(n.method==="POST"&&a.pathname==="/api/repair"){k(t,200,X3(e));return}if(n.method==="GET"&&a.pathname==="/api/activity"){let l=C2(e),d=Q8(a.searchParams.get("days"),l);if(d===null){k(t,400,{error:`days must be an integer between 1 and ${l}`});return}k(t,200,w3(d,e.activityLogsDir));return}if(n.method==="POST"&&a.pathname==="/api/rules/choose-directory"){k(t,200,await m3());return}if(n.method==="GET"&&a.pathname==="/api/rules"){let l=o2(e),d=new Map(l.rules.map((s)=>[s.name,s]));k(t,200,{projectPath:e.cwd??process.cwd(),canPickDirectory:D3(process.platform,process.env),rulebooks:l.rulebooks.map((s)=>({source:s.source,spec:s.spec,name:s.name,version:s.version,rules:s.rules.flatMap((c)=>{let L=d.get(c);if(!L)return[];return[{name:L.name,command:L.command,subcommand:L.subcommand,block_args:L.block_args,reason:L.reason}]})})),errors:l.errors,warnings:l.warnings});return}if(n.method==="GET"&&a.pathname==="/api/star/context"){k(t,200,await(e.fetchStarContext??(()=>G8({logsDir:e.activityLogsDir})))());return}if(n.method==="POST"&&a.pathname==="/api/star"){let l=await(e.starRepo??W8)();k(t,200,l.ok?{ok:!0}:{ok:!1,fallbackUrl:z8});return}if(n.method==="GET"&&a.pathname==="/api/integrations"){k(t,200,await(e.fetchIntegrations??K8)());return}if(n.method==="GET"&&a.pathname==="/api/health"){k(t,200,await(e.fetchHealth??M8)());return}if(n.method==="POST"&&(a.pathname==="/api/install"||a.pathname==="/api/uninstall")){let l=await zt(n);if(!l.ok){k(t,400,{errors:[l.error]});return}let d=l.value?.target;if(typeof d!=="string"||!U.some((c)=>c.target===d)){k(t,400,{error:"unknown target"});return}let s=a.pathname==="/api/install"?"install":"uninstall";k(t,200,await(e.runIntegration??V8)(s,d));return}k(t,404,{error:"Not found"})}function Z8(n,t,r){let e=bt(t),a=W(r),l=bn({rules:a.policy.rules,transparentWrappers:a.policy.transparentWrappers,safety:S3(e.safety),worktreeMode:e.workflow.worktree_mode,destructiveCommandProtectionEnabled:e.destructive_command_protection.enabled,destructiveCommandRuleOverrides:e.destructive_command_protection.overrides,destructiveCommandAllowPaths:e.destructive_command_protection.allow_paths,secretProtection:{enabled:e.secret_protection.enabled,disabledRules:[...Y3(e.secret_protection.overrides)],denyPaths:e.secret_protection.deny_paths,allowPaths:e.secret_protection.allow_paths}});return U2(n,{policySnapshot:l,cwd:r.cwd,userConfigDir:r.userConfigDir})}function Q8(n,t){if(n===null)return Math.min(F8,t);let r=Number(n);if(!Number.isInteger(r)||r<1||r>t)return null;return r}function X8(n,t,r){if(t.searchParams.get("token")!==r)return!1;if(n.method!=="POST")return!0;return n.headers["x-cc-safety-net-token"]===r}async function zt(n){let t=[];for await(let r of n)t.push(r);try{return{ok:!0,value:JSON.parse(Buffer.concat(t).toString("utf-8")||"{}")}}catch(r){return{ok:!1,error:`Invalid JSON: ${r instanceof Error?r.message:String(r)}`}}}function Y8(n,t){n.writeHead(200,{"content-type":"text/html; charset=utf-8","cache-control":"no-store"}),n.end(t)}function k(n,t,r){n.writeHead(t,{"content-type":"application/json; charset=utf-8","cache-control":"no-store"}),n.end(JSON.stringify(r))}function S8(n){return new Promise((t,r)=>{n.close((e)=>e?r(e):t())})}function H8(n){return new Promise((t)=>{let r=()=>{process.off("SIGINT",e),process.off("SIGTERM",e)},e=()=>{r(),n.close().then(t)};process.once("SIGINT",e),process.once("SIGTERM",e)})}function A8(n){let t=process.platform==="darwin"?"open":process.platform==="win32"?"cmd":"xdg-open",r=process.platform==="win32"?["/c","start","",n]:[n];return new Promise((e,a)=>{let l=H3(t,r,{detached:!0,stdio:"ignore"}),d=(c)=>{l.off("spawn",s),a(c)},s=()=>{l.off("error",d),l.unref(),e()};l.once("error",d),l.once("spawn",s)})}async function W8(n="gh",t=$e){return{ok:await xe(n,["api","-X","PUT",`/user/starred/${Ft}`],t)===0}}var R8={amp:"ampVersion","antigravity-cli":"antigravityCliVersion","claude-code":"claudeCodeVersion",codex:"codexCliVersion","copilot-cli":"copilotCliVersion",cursor:"cursorVersion","gemini-cli":"geminiCliVersion","hermes-agent":"hermesAgentVersion","kimi-code":"kimiCodeVersion",openclaw:"openClawVersion",opencode:"openCodeVersion",pi:"piCliVersion"};async function K8(n={}){let t=await $n(n.fetcher),r=W3(t,n.homeDir);return{targets:L2.map((e)=>{let a=r.find((l)=>l.platform===e.id);return{target:e.id,label:b2(e.id),version:t[R8[e.id]],status:a?.configured?"active":a?.detected?"disabled":a?.inspectionStatus==="not-inspected"?"not-inspected":"not-installed"}}),system:{version:t.version,nodeVersion:t.nodeVersion,platform:t.platform}}}function W3(n,t){return en(process.cwd(),{homeDir:t,ampPluginListOutput:n.ampPluginListOutput,codexPluginListOutput:n.codexPluginListOutput,copilotCliVersion:n.copilotCliVersion})}async function M8(n={}){let[t,r]=await Promise.all([$n(n.fetcher),(n.checkUpdates??I2)()]);return{hooks:W3(t,n.homeDir).filter((e)=>e.detected).map((e)=>({platform:e.platform,label:b2(e.platform),configured:e.configured})),update:{currentVersion:r.currentVersion,latestVersion:r.latestVersion??null,updateAvailable:r.updateAvailable}}}var z3=Promise.resolve();function V8(n,t,r={}){let e=async()=>{let l=[],d=console.log,s=console.error;console.log=(...c)=>l.push(c.map(String).join(" ")),console.error=console.log;try{return{ok:await Yn(n,[],{selectTargets:async()=>[t],output:new j8({write(L,i,u){u()}}),...r})===0,output:l.join(`
`)}}finally{console.log=d,console.error=s}},a=z3.then(e);return z3=a.then(()=>{return},()=>{return}),a}async function G8(n={}){let[t,r,e]=await Promise.all([U8(n.command),C8(n.fetchRepo),Promise.resolve(Cn(C2(),n.logsDir).totalBlocked)]);return{starred:t,starCount:r,blockedTotal:e}}async function U8(n="gh",t=$e){if(await xe(n,["auth","status"],t)!==0)return null;let r=await xe(n,["api",`/user/starred/${Ft}`],t);if(r===0)return!0;if(r===null)return null;return!1}function xe(n,t,r){return new Promise((e)=>{let a=H3(n,t,{stdio:"ignore",windowsHide:!0}),l=!1,d,s=(c)=>{if(l)return;if(l=!0,d)clearTimeout(d);e(c)};a.once("error",()=>s(null)),a.once("close",s),d=setTimeout(()=>{a.kill(),s(null)},r)})}async function C8(n=fetch){try{let t=await n(`https://api.github.com/repos/${Ft}`,{headers:{accept:"application/vnd.github+json"},signal:AbortSignal.timeout($e)});if(!t.ok)return null;let r=await t.json();return typeof r.stargazers_count==="number"?r.stargazers_count:null}catch{return null}}function T8(n){if(n[0]!=="help")return!1;let t=n[1];if(!t)ne(),process.exit(0);if(Zn(t))process.exit(0);console.error(`Unknown command: ${t}`),console.error("Run 'cc-safety-net --help' for available commands."),process.exit(1)}var O8={hook:async(n)=>{let t=G1(n);if(t){await t.run();return}console.error("hook requires exactly one integration flag. Try: cc-safety-net hook --kimi-code"),Zn("hook",console.error),process.exit(1)},install:async(n)=>{process.exit(await Yn("install",n))},update:async(n)=>{process.exit(await oe(n))},uninstall:async(n)=>{process.exit(await Yn("uninstall",n))},rule:async(n)=>{process.exit(await f3(n))},status:async(n)=>{if(e2(z({label:"status"},n).errors))process.exit(1);h3()},statusline:async(n)=>{let t=z({label:"statusline",booleans:{claudeCode:["-cc","--claude-code"]}},n);if(t.errors.length===0&&t.flags.claudeCode){await he();return}if(e2(t.errors),!t.flags.claudeCode)console.error("statusline requires --claude-code (-cc)");Zn("statusline",console.error),process.exit(1)},doctor:async(n)=>{let t=_r(n);if(!t)process.exit(1);let r=await T0({json:t.json,skipUpdateCheck:t.skipUpdateCheck});process.exit(r)},logs:async(n)=>{process.exit(await u1(n))},gui:async(n)=>{process.exit(await A3(n))},explain:async(n)=>{let t=Er(n);if(!t)process.exit(1);let r=U2(t.command,{cwd:t.cwd}),e=!!process.env.NO_COLOR||!process.stdout.isTTY;if(t.json)console.log(Nr(r));else console.log(Ir(r,{asciiOnly:e}));process.exit(0)}};async function _8(){let n=process.argv.slice(2),t=z({label:"cc-safety-net",booleans:{version:["-V","--version"]},positionals:"list"},n);if(T8(n))return;let r=n[0],e=r?Un(r):void 0;if(t.help&&e&&e.name!=="rule")Zn(e.name),process.exit(0);if(!r||t.help&&!e)ne(),process.exit(0);if(t.flags.version)tl(),process.exit(0);if(e){await O8[e.name](n.slice(1));return}let a=U1(r);if(a){await a.run();return}if(r==="--statusline"){await he();return}console.error(r.startsWith("-")?`Unknown option: ${r}`:`Unknown command: ${r}`),console.error("Run 'cc-safety-net --help' for usage."),process.exit(1)}_8().catch((n)=>{console.error("CC Safety Net error:",n),process.exit(1)});
