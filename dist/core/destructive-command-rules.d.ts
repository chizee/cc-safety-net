...
export declare function filterDestructiveCommandMatch(match: DestructiveCommandRuleMatch | null, config: Pick<Config, 'destructiveCommandProtectionEnabled' | 'disabledDestructiveCommandRules'> | undefined): DestructiveCommandRuleMatch | null;
