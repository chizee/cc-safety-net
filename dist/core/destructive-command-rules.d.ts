...
export declare const DESTRUCTIVE_COMMAND_RULE_METADATA: readonly [{
    ...
    readonly id: "shell.dynamic-structure";
    readonly category: "Execution";
    readonly label: "Dynamic command structure";
    readonly description: "Blocks guarded subcommands and options assembled from substitution output.";
    readonly intent: "stop_and_explain";
}, {
